/* ---------------------------------------------- oe/rep/bolpnpx.p 05/05 YSK */
/* PRINT P&P Xprint BOL      copied from Xprint                              */
/* -------------------------------------------------------------------------- */
...
for each xxreport where xxreport.term-id eq v-term-id,
  ...
  PUT "<R54><C45><#8><FROM><R+4><C+36><RECT> " 
    "<=8><R+1> Total Pallets                :" v-tot-palls 
    "<=8><R+3> Information Total Est Weight :" v-tot-wt /*fORM ">>,>>9.99"*/ .
