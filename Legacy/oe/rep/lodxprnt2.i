...
PUT "<FArial><=5><R+1><B><P27>  " tt-word-print.cust-name FORMAT "x(27)"   "</B>" SKIP.
...
PUT "<FArial><=7><R36><C2><B><P32>  " tt-word-print.cust-part-no FORMAT "x(15)"   "</B>" SKIP.
...
/*PUT "<FArial><=8><R45><C2><B><P30>  " tt-word-print.cust-part-no FORMAT "x(30)"   "</B>" SKIP.*/
...
PUT "<FArial><=9><R52><C2><B><P30>  " tt-word-print.i-no FORMAT "x(15)"   "</B>" SKIP.
