...
PUT "<FArial><=4><R12><C28><P22><B>" tt-word-print.ship-city FORMAT "x(15)" tt-word-print.ship-state FORMAT "x(2)" " " tt-word-print.ship-zip "</B>" .
...
PUT "<FArial><=6><R29><C46><B><P24>  " tt-word-print.cust-po-no FORMAT ">>>>>>>>>" "</B>" SKIP.
