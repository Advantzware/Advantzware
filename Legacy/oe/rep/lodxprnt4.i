...
ELSE DO:
        ...
        PUT UNFORMATTED   
         ...
         PUT "<R40><C3><#4><FROM><R40><C80><RECT><||3>" SKIP
        ...
        PUT "<FArial><=4><R41.2><C3><B><P24>  " tt-word-print.cust-name FORMAT "x(27)" "</B>" SKIP.
        
        PUT "<R48><C3><#5><FROM><R48><C80><RECT><||3>" SKIP
            "<R53><C3><FROM><R53><C80><LINE><||3>" SKIP 
            "<R48><C3><FROM><R50><C3><LINE><||3>" SKIP
            "<R51><C3><FROM><R53><C3><LINE><||3>" SKIP
            "<R48><C80><FROM><R53><C80><LINE><||3>" SKIP.
        ...
        PUT "<R56><C3><#5><FROM><R56><C80><RECT><||3>" SKIP
            "<R61><C3><FROM><R61><C80><LINE><||3>" SKIP 
            "<R56><C3><FROM><R59><C3><LINE><||3>" SKIP
            "<R60><C3><FROM><R61><C3><LINE><||3>" SKIP
            "<R56><C80><FROM><R61><C80><LINE><||3>" SKIP.
        
        PUT "<FArial><=5><R-2><B><p15> Item Name</B>" SKIP.
        PUT "<FArial><=5><R57><C3><B><P26>  " tt-word-print.i-name FORMAT "x(30)" "</B>" SKIP.
        
        PUT "<R64><C3><#5><FROM><R64><C80><RECT><||3>" SKIP
            "<R70><C3><FROM><R70><C80><LINE><||3>" SKIP  
            "<R64><C3><FROM><R70><C3><LINE><||3>" SKIP
            "<R64><C80><FROM><R70><C80><LINE><||3>" SKIP.
        
        PUT "<FArial><=5><R-2><B><p15> Finished Goods Item#</B>" SKIP.
        PUT "<FArial><=5><R65.5><C3><B><P26>  " tt-word-print.i-no FORMAT "x(15)" "</B>" SKIP.
        
        
        PUT "<R75><C3><#10><FROM><R75><C18><RECT><||3>" SKIP
            "<R80><C3><FROM><R80><C18><LINE><||3>" SKIP  
            "<R75><C3><FROM><R80><C3><LINE><||3>" SKIP
        ...
        PUT "<R75><C20><#11><FROM><R75><C29><RECT><||3>" SKIP
            ...
            "<R75><C20><FROM><R80><C20><LINE><||3>" SKIP
            "<R75><C29><FROM><R80><C29><LINE><||3>" SKIP.
        ...
        PUT "<R75><C35><#12><FROM><R75><C43><RECT><||3>" SKIP
            "<R80><C35><FROM><R80><C43><LINE><||3>" SKIP  
            "<R75><C35><FROM><R80><C35><LINE><||3>" SKIP
            "<R75><C43><FROM><R80><C43><LINE><||3>" SKIP.
        PUT "<FArial><=12><R76><C33.8><B><P24>  " tt-word-print.pcs "</B>" SKIP.
        
        
        PUT "<R75><C45><#13><FROM><R75><C62><RECT><||3>" SKIP
            "<R80><C45><FROM><R80><C62><LINE><||3>" SKIP  
            "<R75><C45><FROM><R80><C45><LINE><||3>" SKIP
            "<R75><C62><FROM><R80><C62><LINE><||3>" SKIP.
        ...
        PUT "<R75><C64><#14><FROM><R75><C80><RECT><||3>" SKIP
            "<R80><C64><FROM><R80><C80><LINE><||3>" SKIP  
            "<R75><C64><FROM><R80><C64><LINE><||3>" SKIP
            "<R75><C80><FROM><R80><C80><LINE><||3>" SKIP.
