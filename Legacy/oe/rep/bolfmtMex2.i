...
RUN XMLOutput (lXMLOutput,'',STRING(PAGE-NUM),'Página'). /* rstark 05181205 */

PUT
  "<FArial>"  
    "<P10><R1><C70><B>Page #:</B>" string(PAGE-NUM,">9")  SKIP 
  "<#1><P10><ADJUST=LPI><C50><B>Ley de embarque recta"  SKIP
  "<=1><R+1><C25></B>"            SKIP
  "<=1><R+3><C25><B><C50>Guía de carga #: " oe-bolh.bol-no   "</B>"
  "<C3><R-4><#1><R+9><C+45><IMAGE#1=" ls-full-img1 SKIP
  "<FCourier New>"
  "Cobrar a:" SPACE(30) "Envie a:"  SKIP
  ...
  "<=#3><R+4>Fecha  :                     " oe-bolh.bol-date        SKIP
  "<=#3><R+5>Hora del muelle del cliente_____________________" SKIP
  /*SKIP*/
  SKIP(1).
...
PUT
  ...
  "<FArial><=4><R+1><P10><ADJUST=LPI>        Fecha                   Flete a bordo                        Remolque #                                Portador                       Términos de transporte" SKIP 
  ...
  "<FArial><=5><C5>Ít #                               PO#                  Nombre del árticulo/Número de parte del cliente                       Por"
  "<FArial><=5><R+1><C3>Orden #                    Trabajo #                               Descripción del producto                           Unidad       unidad          Total         " SKIP(1)
  "<FCourier New>"                                  
  .
