      ...
      DO TRANSACTION:
           ...
           FIND FIRST tt-inv-line WHERE tt-inv-line.i-no = inv-line.i-no
                ...
                IF NOT AVAIL tt-inv-line THEN do:
                    ...
                    ASSIGN 
                        ...
                        tt-inv-line.po-no    = inv-line.po-no
        ...
        FOR EACH tt-inv-line NO-LOCK:                                                  
            ...
            PUT space(1) tt-inv-line.inv-qty format "->>>>>9" SPACE(1)                 
              ...
              tt-inv-line.po-no FORMAT "x(12)" SPACE(1)
              /*v-rel-po-no FORM "x(12)" SPACE(1)*/                                        
              tt-inv-line.part-no format "x(15)" SPACE(1)                              
              tt-inv-line.i-name  format "x(21)" SPACE(1)                              
              tt-inv-line.v-price   FORMAT ">>,>>9.9999" SPACE(1)                      
          ...
          do v-count = 1 to 2:
             v-part-info = if v-count eq 1 then tt-inv-line.part-dscr1
