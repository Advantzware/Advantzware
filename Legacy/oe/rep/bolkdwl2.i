 /* oe/rep/bolprm2.i for kdwillsx  */  
   ...
   put 
         ...
         "<=2><R+4>"SKIP
         v-comp-add1 AT 10 SKIP
         v-comp-add2 AT 10  SKIP
         v-comp-add3 AT 10 SKIP
         v-comp-add4 AT 10 "<FGCOLOR=" + trim(lv-other-color) + ">" FORM "x(15)" SKIP(1)
         "<FCourier New>"
