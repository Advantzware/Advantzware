/* ------------------------------------------ oe/rep/invprnts.p BV */
/* INVOICE PRINT  Program for N-K-1-INVPRINT = Printers (Loylang) - copy of Soule      */
/* ------------------------------------------------------------------------- */
