          ...
          v-beeler-lines = 0.
            do v = 1 to 3:
              v-part-info = if v eq 1 then inv-line.part-dscr1
                            ELSE if v eq 2 THEN inv-line.part-dscr2
            ...
            /* Find original release based on this inv-line via oe-boll and oe-rell*/
               FIND FIRST oe-boll WHERE oe-boll.company EQ inv-line.company
               ...
               IF AVAIL oe-boll THEN
                   FIND FIRST oe-rell WHERE oe-rell.company EQ oe-boll.company
               ...
               IF AVAIL oe-rell THEN
                   FIND FIRST oe-rel WHERE oe-rel.company = oe-rell.company
               ...
               IF AVAIL oe-rel THEN
                   v-ordered-qty = oe-rel.tot-qty.
               /* end of finding original release*/
...
/*            oe-rel.r-no = inv-line.r-no NO-LOCK:                    */
/*            ASSIGN v-ordered-qty = v-ordered-qty + oe-rel.tot-qty . */
/*        END.                                                        */
...
/* wfk - duplicated at bottom of form                */
