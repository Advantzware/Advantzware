...
PUT "<FArial><=5><R29><C3><B><P18>  " tt-word-print.i-no FORMAT "x(15)" "</B>" SKIP.
...
PUT "<FArial><=6><R29><C46><B><P14>  " tt-word-print.i-name FORMAT "x(30)"   "</B>" SKIP.
...
PUT   "<#=100><AT=7.6,0.8><FROM><AT=+.8,+4><BARCODE,TYPE=128B,CHECKSUM=NONE,VALUE= " tt-word-print.cust-part-no FORMAT "x(15)" ">"
    "<AT=7.3,1.5>" tt-word-print.cust-part-no FORMAT "x(15)" .
...
PUT   "<#=100><AT=7.6,5.8><FROM><AT=+.8,+2><BARCODE,TYPE=128B,CHECKSUM=NONE,VALUE= " tt-word-print.ord-qty ">"
    "<AT=7.3,5.9>" tt-word-print.ord-qty  .
...
PUT   "<#=100><AT=9.7,3.6><FROM><AT=+.8,+2><BARCODE,TYPE=128B,CHECKSUM=NONE,VALUE= " tt-word-print.cust-po-no FORMAT ">>>>>>>>>" ">"
    "<AT=9.4,3.7>" tt-word-print.cust-po-no FORMAT ">>>>>>>>>"  .
