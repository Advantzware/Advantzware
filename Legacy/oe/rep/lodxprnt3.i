...
PUT UNFORMATTED   
 ...
 PUT "<FArial><=9><R35> <B><P22> DESCRIPTION: "   "<C29>" tt-word-print.part-dscr1 FORMAT "x(30)"  "</B>" SKIP.
 ...
 PUT "<R54><C50><P25><FROM><R54><C73><LINE>".

 PUT "<FArial><=9><R51><C40> <B><P23> P.O #: "    "<C54>" tt-word-print.po-no FORMAT ">>>>>>>>>"  "</B>" SKIP.
