...
FORM header
  ...
  skip(1)
  v-fob at 4
  inv-head.terms-d FORM "x(30)" AT 32
  skip(3)
  inv-head.cust-no at 11            v-shipto  at 51 skip
...
form header
  ...
  inv-head.terms-d FORM "x(30)" AT 32
  skip(2)
  inv-head.cust-no at 11            v-shipto  at 51 
  v-cust[1]        at 11            v-ship[1] at 51 
  v-cust[2]        at 11            v-ship[2] at 51
  v-cust[3]        at 11            v-ship[3] at 51
  v-cust[4]        at 11            v-ship[4] at 51 
...
form header
  ...
  skip(1)
  "FOB:" v-fob
  "TERMS:" inv-head.terms-d FORM "x(30)"
  skip(2)
...
form " " to 80
    ...
    ELSE IF v-print-fmt = "CENTURY" OR v-print-fmt = "Colonial" THEN
        ASSIGN v-c-phone   = ""
               v-c-fax     = ""
               v-c-email   = "".
    else    
    ...
    for each report where report.term-id eq v-term-id no-lock,
      ...
      DO TRANSACTION:
       ...
       /*   if v-print-fmt eq "Valley" and avail oe-relh then
            wf.po-no = oe-relh.po-no. not any more task# 04140502*/
        end.
...
*/
        ...
        do:  /* T O T A L S */
          ...
          put skip(end-page + 1 - v-printline).
