...
PUT "<FArial><=4><R11><C45><P18><B>" company.NAME FORMAT "x(25)"  "</B>" SKIP.
PUT "<FArial><=4><R13><C5><P15><B>" tt-word-print.ship-add1 FORMAT "x(30)" "</B>" .
PUT "<FArial><=4><R13><C45><P15><B> Phone: " cPhone FORMAT "x(15)"  "</B>" SKIP(2).
PUT "<FArial><=4><R15><C5><P15><B>" tt-word-print.ship-city FORMAT "x(15)" tt-word-print.ship-state FORMAT "x(2)" " " tt-word-print.ship-zip "</B>" .
PUT "<FArial><=4><R15><C45><P15><B> Fax: " cFax FORMAT "x(15)" "</B>" SKIP(2).
...
PUT "<FArial><=6><R29><C4><B><P24>  " tt-word-print.cust-po-no FORMAT ">>>>>>>>>" "</B>" SKIP.
