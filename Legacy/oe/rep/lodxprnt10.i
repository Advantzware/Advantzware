...
ELSE DO:
        ...
        PUT UNFORMATTED   
         ...
         PUT "<R39><C3><#4><FROM><R39><C80><RECT><||3>" SKIP
            "<R45><C3><FROM><R45><C80><LINE><||3>" SKIP  
            "<R39><C3><FROM><R45><C3><LINE><||3>" SKIP
            "<R39><C80><FROM><R45><C80><LINE><||3>" SKIP.
        ...
        PUT "<R48><C3><#5><FROM><R48><C40><RECT><||3>" SKIP
        ...
        PUT "<R48><C45><#6><FROM><R48><C80><RECT><||3>" SKIP
            ...
            "<R48><C45><FROM><R53><C45><LINE><||3>" SKIP
            "<R48><C80><FROM><R53><C80><LINE><||3>" SKIP.
        
        PUT "<FArial><=6><R49.5><C46><B><P18>  " tt-word-print.cust-part-no FORMAT "x(15)"   "</B>" SKIP.
        
        PUT "<R56><C3><#7><FROM><R56><C40><RECT><||3>" SKIP
            "<R61><C3><FROM><R61><C40><LINE><||3>" SKIP 
            "<R56><C3><FROM><R61><C3><LINE><||3>" SKIP
            "<R56><C40><FROM><R61><C40><LINE><||3>" SKIP.
        
        PUT "<FArial><=7><R-2><B><p15> Job#                                                               Date </B>" SKIP.
        PUT "<FArial><=7><R57.5><C3><B><P20>  " tt-word-print.job-no FORMAT "x(6)" "-" STRING(tt-word-print.job-no2,"99")  "</B>" SKIP.
        
        
        PUT "<R56><C45><#8><FROM><R56><C80><RECT><||3>" SKIP
            "<R61><C45><FROM><R61><C80><LINE><||3>" SKIP 
            "<R56><C45><FROM><R61><C45><LINE><||3>" SKIP
        ...
        PUT "<R64><C3><#9><FROM><R64><C40><RECT><||3>" SKIP
            "<R74><C3><FROM><R74><C40><LINE><||3>" SKIP 
            "<R64><C3><FROM><R74><C3><LINE><||3>" SKIP
            "<R64><C40><FROM><R74><C40><LINE><||3>" SKIP.
        ...
        PUT "<R64><C45><#9><FROM><R64><C80><RECT><||3>" SKIP
            ...
            "<R64><C45><FROM><R74><C45><LINE><||3>" SKIP
            "<R64><C80><FROM><R74><C80><LINE><||3>" SKIP.
