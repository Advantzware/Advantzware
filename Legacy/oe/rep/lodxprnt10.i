...
PUT "<FArial><=4><R23><C3><B><P23> PO# " tt-word-print.cust-po-no FORMAT ">>>>>>>>>"   "</B>" SKIP.
...
PUT "<FArial><=5><R29><C3><B><P18>  " tt-word-print.cust-part-no FORMAT "x(15)"   "</B>" SKIP.
...
PUT "<FArial><=6><R29><C46><B><P18>  " tt-word-print.cust-part-no FORMAT "x(15)"   "</B>" SKIP.
...
PUT "<FArial><=7><R37><C3><B><P20>  " tt-word-print.job-no FORMAT "x(6)" "-" STRING(tt-word-print.job-no2,"99")  "</B>" SKIP.
...
PUT "<FArial><=8><R37><C45><B><P20>  " tt-word-print.due-date FORMAT "99/99/99"    "</B>" SKIP.

PUT   "<#=100><AT=7.6,0.6><FROM><AT=+.8,+3.1><BARCODE,TYPE=128B,CHECKSUM=NONE,VALUE= " tt-word-print.i-no FORMAT "x(30)"   ">"
    "<AT=7.3,1>" tt-word-print.i-no FORMAT "x(15)"   .
