...
PUT "<FArial>"  SKIP
  ...
  "<=4><R+3> " oe-bolh.bol-date SPACE(3) v-fob space(5) v-frt-class-dscr2 FORM "x(20)" space(5) carrier.dscr FORM "x(25)" v-frt-terms SKIP
  ...
  "<R24><C77.5><FROM><R26><C77.5><LINE>" SKIP 
