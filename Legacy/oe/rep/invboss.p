...
find first company where company.company eq cocode NO-LOCK. 
 ...
 END.
    ...
    for each report where report.term-id eq v-term-id no-lock,
      ...
      DO TRANSACTION:
          ...
          for each oe-boll
            ...
            do v = 1 to 3:
              ...
              if v-part-info ne "" OR (v = 1 AND inv-line.part-no <> "") OR (v = 1 AND inv-line.po-no <> "") OR (v = 1 AND v-inv-qty <> 0)  then do:
                 ...
                 ELSE          PUT SPACE(12) "Previous Invoice(s): " v-part-info SKIP.
                 v-printline = v-printline + 1.
              end.
            end.
            put skip(1).
        ...
        for each inv-misc no-lock where inv-misc.company = inv-head.company and
          ...
          put inv-misc.charge AT 10 inv-misc.dscr inv-misc.amt AT 77 SKIP.
          ASSIGN
    ...
    PUT "<R58><C57><#8><FROM><R+5><C+23><RECT> " 
