    ...
    IF LAST-OF(report.key-02) THEN DO:
      ...
      FOR EACH w2 BREAK BY w2.cases * w2.cas-cnt DESC:
        ...
        IF FIRST(w2.cases * w2.cas-cnt) THEN 
          PUT {1} oe-ordl.po-no
                  oe-ordl.part-dscr1  AT 16 FORM "x(20)" 
                  oe-ordl.i-name FORM "x(22)" AT 37 
                  itemfg.frt-class FORM "x(8)" AT 61  
/*                   oe-ordl.i-name FORM "x(22)" */
  ...
  ELSE DO:
     DISPLAY  {1}
          oe-ordl.po-no 
          oe-ordl.part-dscr1  AT 16 FORM "x(20)"
          oe-ordl.i-name FORM "x(30)" AT 37 
          itemfg.frt-class FORM "x(8)" AT 61  
          oe-boll.cases FORM "->>,>>>" "@" SPACE(0)
          oe-boll.qty-case FORM "->>>>>Z" SKIP
          v-job-no
          oe-boll.po-no AT 16 FORM "x(15)" SPACE(0)
