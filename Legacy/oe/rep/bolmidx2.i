 /* oe/rep/bolmidx2.i  */  
   ...
   put "<FArial>"  SKIP
          ...
          /*"<C1><#1><R+5><C+25>*/
          "<C2><R5><#1><R+7><C40><IMAGE#1=" ls-full-img1
        /*<IMAGE#1=" ls-full-img1 */ SKIP /* pacific package */             
         ...
         */
         ...
         lv-email AT 8 SKIP(1)*/
               ...
               SPACE(5) "<P15>" v-comp-name v-ship-name AT 45 skip
               SPACE(5) v-comp-addr[1] v-ship-addr[1] AT 40 SKIP
               SPACE(5) v-comp-addr[2] v-ship-addr[2] AT 40 SKIP
               SPACE(5) v-comp-addr3 v-ship-addr3 "<P14>" AT 40 SKIP
        "<R5><C50><#3>" SKIP
        "<FArial><P14><=#3>" /*<C-20><R-2> <B>Bill Of Lading</B> */ "<P10>" SKIP
                "<=#3><P15><B>BOL #: " oe-bolh.bol-no "<P10></B>" SKIP(1)
   ...
   IF lv-bolfmt-int = 1 THEN  PUT "<FArial><=5><R+1> Part#/Order#                      PO#/Job#             Finished Good#              Description                                       Units               Qty/Unit           <FCourier New>" SKIP(1).
                                 
  
                                                                                                                                                                  
                        ELSE  PUT "<FArial><=5><R+1> Part#                       PO#/Job#                       Finished Good#               Description                                        Units                  Qty/Unit          <FCourier New>" SKIP(1).
