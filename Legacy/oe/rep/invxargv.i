...
PUT "<FArial><P12><=#3><R-2> <B>Invoice#: " inv-head.inv-no "</B><P10>" SKIP
    ...
    "<=3><R+1> " inv-head.cust-no  space(7) string(PAGE-NUM - lv-pg-num,">>9") + " of " + string(lv-tot-pg) FORM "x(20)" 
...
PUT "<FArial><=4><R+1>    Ship Date           BOL#                  Ship Via                             Terms                     S.Person              Order#                FOB" SKIP
