...
&Scoped-Define ENABLED-FIELDS oe-bolh.ship-i[1] oe-bolh.ship-i[2] ~
...
DEFINE FRAME F-Main
     ...
     oe-bolh.ship-i[2] AT ROW 2.48 COL 4 NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 109 BY 1
     oe-bolh.ship-i[3] AT ROW 3.48 COL 4 NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 109 BY 1
     oe-bolh.ship-i[4] AT ROW 4.48 COL 4 NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 109 BY 1
...
/* SETTINGS FOR FILL-IN oe-bolh.ship-i[1] IN FRAME F-Main
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN oe-bolh.ship-i[2] IN FRAME F-Main
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN oe-bolh.ship-i[3] IN FRAME F-Main
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN oe-bolh.ship-i[4] IN FRAME F-Main
   ALIGN-L                                                              */
