...
oe-ordl.est-no oe-ord.cust-no oe-ord.bill-to oe-ord.po-no oe-ordl.job-no ~
oe-ordl.job-no2 oe-ordl.i-no 
...
DEFINE FRAME F-Main
     ...
     auto_find AT ROW 19.33 COL 99 COLON-ALIGNED HELP
...
and oe-ord.stat = ""W"""
     ...
     _FldNameList[4]   = ASI.oe-ord.cust-no
     _FldNameList[5]   = ASI.oe-ord.bill-to
     _FldNameList[6]   = ASI.oe-ord.po-no
...
------------------------------------------------------------------------------*/
  ...
  else apply "value-changed" to browse-order in frame {&frame-name}.
END PROCEDURE.
...
------------------------------------------------------------------------------*/
 ...
 lv-tmp-rowid = ROWID(oe-ord).
 {oe/j-ord.i}
 REPOSITION {&browse-name} TO ROWID lv-tmp-rowid.
