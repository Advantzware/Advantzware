...
&Scoped-Define ENABLED-OBJECTS RECT-1 btnStatus 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btnStatus V-table-Win
ON CHOOSE OF btnStatus IN FRAME F-Main /* Status */
DO:
...
/*      IF NOT ll THEN                                                   */
         RUN process-status IN WIDGET-HANDLE(char-hdl) (INPUT "Set").
   END.
END.
