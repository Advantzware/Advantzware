...
&Scoped-define INTERNAL-TABLES smanbugt

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH smanbugt OF sman WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH smanbugt OF sman WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main smanbugt
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main smanbugt
...
<FOREIGN-KEYS>
company||y|asi.smanbugt.company
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "asi.smanbugt OF asi.sman"
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "company" "smanbugt" "company"}
