...
DEFINE VARIABLE h_b-oerel AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Brwse Release|View Release' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 3.14 , 4.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = ?':U ,
             OUTPUT h_b-oerel ).
       RUN set-position IN h_b-oerel ( 4.81 , 6.00 ) NO-ERROR.
       /* Size in UIB:  ( 19.52 , 135.00 ) */

       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('2') NO-ERROR.

       /* Links to SmartNavBrowser h_b-oerel. */
       RUN add-link IN adm-broker-hdl ( h_p-navico , 'Navigation':U , h_b-oerel ).
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-oerel ).
       RUN set-position IN h_v-oerel ( 4.81 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 9.29 , 144.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-navico ).
       RUN set-position IN h_p-navico ( 14.33 , 12.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updsav ).
       RUN set-position IN h_p-updsav ( 14.33 , 87.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = ?':U ,
             OUTPUT h_b-oerell ).
       RUN set-position IN h_b-oerell ( 16.95 , 8.00 ) NO-ERROR.
       /* Size in UIB:  ( 5.71 , 126.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updsav-2 ).
       RUN set-position IN h_p-updsav-2 ( 17.43 , 135.00 ) NO-ERROR.
       RUN set-size IN h_p-updsav-2 ( 6.67 , 11.00 ) NO-ERROR.

       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('1') NO-ERROR.

       /* Links to SmartViewer h_v-oerel. */
       RUN add-link IN adm-broker-hdl ( h_b-oerell , 'Record':U , h_v-oerel ).
       RUN add-link IN adm-broker-hdl ( h_p-updsav , 'TableIO':U , h_v-oerel ).

       /* Links to SmartBrowser h_b-oerell. */
       RUN add-link IN adm-broker-hdl ( h_b-oerel , 'Record':U , h_b-oerell ).
       RUN add-link IN adm-broker-hdl ( h_p-updsav-2 , 'TableIO':U , h_b-oerell ).
