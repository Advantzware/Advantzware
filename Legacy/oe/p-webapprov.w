...
/*------------------------------------------------------------------------
  ...
  Note: copied from oe/v-hldapp.w to be only an approve function
...
DO:
  ...
  RUN get-link-handle IN adm-broker-hdl(THIS-PROCEDURE,"hold-approve-source",OUTPUT char-hdl).
