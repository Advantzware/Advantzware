...
&Scoped-Define ENABLED-FIELDS oe-rell.ord-no oe-relh.rel-date ~
oe-relh.cust-no oe-relh.release# 
&Scoped-define ENABLED-TABLES oe-rell oe-relh
&Scoped-define FIRST-ENABLED-TABLE oe-rell
&Scoped-define SECOND-ENABLED-TABLE oe-relh
&Scoped-Define ENABLED-OBJECTS RECT-1 
&Scoped-Define DISPLAYED-FIELDS oe-rell.ord-no oe-relh.rel-date ~
oe-relh.cust-no oe-relh.release# 
&Scoped-define DISPLAYED-TABLES oe-rell oe-relh
&Scoped-define FIRST-DISPLAYED-TABLE oe-rell
&Scoped-define SECOND-DISPLAYED-TABLE oe-relh
...
DEFINE FRAME F-Main
     ...
     oe-relh.rel-date AT ROW 1.71 COL 52.6 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
     oe-relh.cust-no AT ROW 1.71 COL 86 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 25 BY 1
     oe-relh.release# AT ROW 1.71 COL 124.6 COLON-ALIGNED FORMAT ">>>>>>9"
          VIEW-AS FILL-IN 
          SIZE 17 BY 1
