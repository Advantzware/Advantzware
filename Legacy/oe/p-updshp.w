...
DO:
  ...
  DEF BUFFER b-oe-rel FOR oe-rel.
      ...
      IF VALID-HANDLE(WIDGET-HANDLE(char-hdl)) THEN
          RUN get-record IN WIDGET-HANDLE(char-hdl) (OUTPUT v-rowid).
     ...
     DO WITH FRAME Panel-Frame:
        ...
        DO:
            IF v-rowid <> ? THEN 
             ...
             IF b-oe-rel.qty <> 0 THEN do: /*task 03211403 */
             FIND FIRST oe-rell WHERE oe-rell.company EQ b-oe-rel.company
                ...
                AND oe-ordl.ord-no EQ b-oe-rel.ord-no NO-LOCK:
                  ...
                  AND ROWID(oe-rel) NE rowid(b-oe-rel) EXCLUSIVE-LOCK:
                   ...
                   ASSIGN oe-rel.ship-i[1]  = b-oe-rel.ship-i[1]
                          ...
                          oe-rel.ship-i[4]  = b-oe-rel.ship-i[4] .
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE ship-button C-WIn 
PROCEDURE ship-button :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
