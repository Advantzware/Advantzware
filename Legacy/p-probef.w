...
&Scoped-Define ENABLED-OBJECTS Btn-Save Btn-Cancel Btn-Delete btn-view ~
btn-print btn-quote btn-whatif 
...
DEFINE FRAME Panel-Frame
     ...
     btn-view AT ROW 1.24 COL 29
     btn-print AT ROW 1.24 COL 42
     btn-quote AT ROW 1.24 COL 55
     btn-whatif AT ROW 1.24 COL 67
...
DO:
  DO WITH FRAME Panel-Frame:
      ...
      enable btn-view btn-print btn-quote btn-whatif
  ...
  /* Added by WinKit Migration tool 07.02.2016 21:11:08 */
...
DO:
  ...
  /* enable btn-cancel with frame {&frame-name}.
     btn-save:label = "&Save" .
     disable btn-DELETE btn-view btn-print btn-whatif
             with frame {&frame-name}.
    */
