...
&Scoped-Define ENABLED-OBJECTS RECT-41 RECT-6 RECT-7 RECT-8 as-of-date ~
tb_cust-list btnCustList begin_cust end_cust begin_cust-po end_cust-po ~
begin_slm end_slm tb_inc-zer tb_inc-cust fi_days-old tb_cust-pt rd_sort ~
rd_ascdsc rd-dest lv-ornt lines-per-page lv-font-no td-show-parm tb_excel ~
tb_runExcel fi_file btn-cancel btn-ok 
...
fi_days-old tb_cust-pt lbl_print rd_sort lbl_srt rd_ascdsc rd-dest lv-ornt ~
...
DEFINE VARIABLE rd_sort AS CHARACTER INITIAL "Order Date" 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
...
DEFINE FRAME FRAME-A
     as-of-date AT ROW 2.1 COL 27 COLON-ALIGNED
     tb_cust-list AT ROW 3.38 COL 30.4 WIDGET-ID 6
     btnCustList AT ROW 3.43 COL 62.4 WIDGET-ID 8
     begin_cust AT ROW 4.57 COL 27 COLON-ALIGNED HELP
          "Enter Beginning Customer Number"
     end_cust AT ROW 4.57 COL 70 COLON-ALIGNED HELP
          "Enter Ending Customer Number"
     begin_cust-po AT ROW 5.52 COL 27 COLON-ALIGNED HELP
          "Enter Beginning Customer PO Number"
     end_cust-po AT ROW 5.52 COL 70 COLON-ALIGNED HELP
          "Enter Ending Customer PO Number"
     begin_slm AT ROW 6.48 COL 27 COLON-ALIGNED HELP
          "Enter Beginning Sales Rep Number"
     end_slm AT ROW 6.48 COL 70 COLON-ALIGNED HELP
          "Enter Ending Sales Rep Number"
     tb_inc-zer AT ROW 8.43 COL 15.2
     tb_inc-cust AT ROW 9.29 COL 56.2 RIGHT-ALIGNED
     fi_days-old AT ROW 9.71 COL 78 COLON-ALIGNED
     tb_cust-pt AT ROW 10.14 COL 15.2
     lbl_print AT ROW 11.05 COL 16 COLON-ALIGNED NO-LABEL
     rd_sort AT ROW 11.05 COL 29.6 NO-LABEL
     lbl_srt AT ROW 11.95 COL 3 COLON-ALIGNED NO-LABEL
     rd_ascdsc AT ROW 12 COL 29.6 NO-LABEL
     rd-dest AT ROW 14.57 COL 6 NO-LABEL
     lv-ornt AT ROW 14.57 COL 29 NO-LABEL
     lines-per-page AT ROW 14.57 COL 82 COLON-ALIGNED
     lv-font-no AT ROW 16 COL 32 COLON-ALIGNED
     lv-font-name AT ROW 16.95 COL 26 COLON-ALIGNED NO-LABEL
     td-show-parm AT ROW 18.33 COL 28
     tb_excel AT ROW 19.33 COL 65.4 RIGHT-ALIGNED
     tb_runExcel AT ROW 19.33 COL 87.4 RIGHT-ALIGNED
     fi_file AT ROW 20.29 COL 43.4 COLON-ALIGNED HELP
          "Enter File Name"
     btn-cancel AT ROW 21.86 COL 61.4
     btn-ok AT ROW 21.95 COL 18
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 13.62 COL 4.6
     "Only Show QOH that is..." VIEW-AS TEXT
          SIZE 26 BY .62 AT ROW 8.76 COL 65
     "Selection Parameters" VIEW-AS TEXT
          SIZE 21 BY .71 AT ROW 1.24 COL 5
          BGCOLOR 2 
     RECT-41 AT ROW 8.19 COL 62
     RECT-6 AT ROW 13.48 COL 1
     RECT-7 AT ROW 13.38 COL 1
     RECT-8 AT ROW 1.05 COL 1
 ...
 /* security check need {methods/prgsecur.i} in definition section */
  ...
  ELSE
   ...
   END.
    ...
    {methods/setButton.i btn-cancel "Cancel"} /* added by script _nonAdm1Images.p on 03.28.2017 @ 10:43:32 am */
    {methods/setButton.i btn-ok "OK"} /* added by script _nonAdm1Images.p on 03.28.2017 @ 10:43:32 am */
...
------------------------------------------------------------------------------*/
  DISPLAY as-of-date tb_cust-list begin_cust end_cust begin_cust-po end_cust-po 
          begin_slm end_slm tb_inc-zer tb_inc-cust fi_days-old tb_cust-pt 
          lbl_print rd_sort lbl_srt rd_ascdsc rd-dest lv-ornt lines-per-page 
          lv-font-no lv-font-name td-show-parm tb_excel tb_runExcel fi_file 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE RECT-41 RECT-6 RECT-7 RECT-8 as-of-date tb_cust-list btnCustList 
         begin_cust end_cust begin_cust-po end_cust-po begin_slm end_slm 
         tb_inc-zer tb_inc-cust fi_days-old tb_cust-pt rd_sort rd_ascdsc 
