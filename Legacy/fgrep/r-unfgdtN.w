...
ASSIGN cTextListToSelect = "Customer,Item Description,Ship To,Item #," +
...
{sys/inc/ttRptSel.i}
ASSIGN cTextListToDefault  = "Customer,Item Description,Ship To,Item #," +
                           "Cust PO #,Qty Ord,Inv Date,Inv #,Qty Ship," +
                           "Issued BOL No,Issued BOL Qty,Available" .
...
rd_sort sl_avail sl_selected Btn_Def Btn_Add Btn_Remove btn_Up btn_down ~
...
DEFINE FRAME FRAME-A
     lbl_ord-stat AT ROW 2.19 COL 26 COLON-ALIGNED NO-LABEL
     rd_ord-stat AT ROW 2.19 COL 43 NO-LABEL
     begin_ord-date AT ROW 3.19 COL 26 COLON-ALIGNED
     end_ord-date AT ROW 3.19 COL 69 COLON-ALIGNED HELP
          "Enter Ending Order Date"
     begin_ord-no AT ROW 4.14 COL 26 COLON-ALIGNED HELP
          "Enter Beginning Order Number"
     end_ord-no AT ROW 4.14 COL 69 COLON-ALIGNED HELP
          "Enter Ending Order Number"
     tb_cust-list AT ROW 5.29 COL 29.4 WIDGET-ID 6
     btnCustList AT ROW 5.33 COL 61.4 WIDGET-ID 8
     begin_cust AT ROW 6.43 COL 26 COLON-ALIGNED HELP
          "Enter Beginning Customer Number"
     end_cust AT ROW 6.43 COL 69 COLON-ALIGNED HELP
          "Enter Ending Customer Number"
     begin_ship AT ROW 7.38 COL 26 COLON-ALIGNED HELP
          "Enter Beginning Ship-To Number"
     end_ship AT ROW 7.38 COL 69 COLON-ALIGNED HELP
          "Enter Ending Ship-To Number"
     begin_i-no AT ROW 8.33 COL 26 COLON-ALIGNED HELP
          "Enter Beginning Order Number"
     end_i-no AT ROW 8.33 COL 69 COLON-ALIGNED HELP
          "Enter Ending Item Number"
     begin_whse AT ROW 9.29 COL 26 COLON-ALIGNED HELP
          "Enter Beginning Warehouse"
     end_whse AT ROW 9.29 COL 69 COLON-ALIGNED HELP
          "Enter Ending Warehouse"
     lbl_sort AT ROW 10.71 COL 26 COLON-ALIGNED NO-LABEL
     rd_sort AT ROW 10.71 COL 35 NO-LABEL
     sl_avail AT ROW 13.1 COL 4 NO-LABEL WIDGET-ID 26
     sl_selected AT ROW 13.1 COL 59 NO-LABEL WIDGET-ID 28
     Btn_Def AT ROW 13.19 COL 40.6 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 56
     Btn_Add AT ROW 14.33 COL 40.6 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 32
     Btn_Remove AT ROW 15.52 COL 40.6 HELP
          "Remove Selected Table from Tables to Audit" WIDGET-ID 34
     btn_Up AT ROW 16.71 COL 40.6 WIDGET-ID 40
     btn_down AT ROW 17.91 COL 40.6 WIDGET-ID 42
     rd-dest AT ROW 20.52 COL 5 NO-LABEL
     lv-ornt AT ROW 20.52 COL 32 NO-LABEL
     lines-per-page AT ROW 20.52 COL 85 COLON-ALIGNED
     ...
     tb_excel AT ROW 24.95 COL 71 RIGHT-ALIGNED
     tb_runExcel AT ROW 25.05 COL 93 RIGHT-ALIGNED
     fi_file AT ROW 26 COL 49 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 27.86 COL 25
     btn-cancel AT ROW 27.86 COL 57
     "Available Columns" VIEW-AS TEXT
          SIZE 20 BY .95 AT ROW 12.14 COL 4.8 WIDGET-ID 38
     "Selected Columns(In Display Order)" VIEW-AS TEXT
          SIZE 34 BY .62 AT ROW 12.29 COL 59.2 WIDGET-ID 44
     "Selection Parameters" VIEW-AS TEXT
          SIZE 21 BY .71 AT ROW 1.24 COL 5
          BGCOLOR 2 
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 19.57 COL 2
     RECT-6 AT ROW 19.33 COL 1
...
DO:
   apply "close" to this-procedure.
    {Advantzware/WinKit/winkit-panel-triggerend.i} /* added by script _nonAdm1.p on 04.07.2017 @  2:06:36 pm */
END.
...
ON CLOSE OF THIS-PROCEDURE DO:
   RUN disable_UI.
   {Advantzware/WinKit/closewindow-nonadm.i} /* added by script _nonAdm1.p on 04.07.2017 @  2:06:36 pm */
END.
...
/* security check need {methods/prgsecur.i} in definition section */
  ...
  ELSE
   ...
   END.
    ...
    {Advantzware/WinKit/embedfinalize-nonadm.i} /* added by script _nonAdm1.p on 04.07.2017 @  2:06:36 pm */
    ...
    /*  IF tb_excel THEN DO:
     ...
     DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
       cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
            CASE cTmpField:    
                WHEN "cust"     THEN cVarValue = cust.NAME .
                WHEN "i-name"   THEN cvarValue = itemfg.i-name.
                WHEN "ship-to"  THEN cVarValue = shipto.ship-name .
                WHEN "i-no"     THEN cVarValue = oe-ordl.i-no .
                WHEN "cust-po"  THEN cVarValue = oe-rel.po-no.
                WHEN "qty-ord"  THEN cVarValue = STRING(oe-rel.qty,"->>>>>>>>9").
                WHEN "inv-dt"   THEN cvarValue = IF AVAIL ar-inv AND AVAIL ar-invl AND ar-inv.inv-date <> ? THEN STRING(ar-inv.inv-date) ELSE "".
                WHEN "inv"      THEN cVarValue = IF AVAIL ar-inv AND AVAIL ar-invl THEN STRING(ar-inv.inv-no) ELSE "".
                WHEN "qty-shp"  THEN cVarValue = IF avail ar-invl THEN STRING(ar-invl.ship-qty,"->>>>>>>>9") ELSE "".
                WHEN "bol-no"   THEN cvarValue = IF avail oe-bolh and (not oe-bolh.posted) THEN STRING(oe-bolh.bol-no) ELSE "".
                WHEN "bol-qty"  THEN cVarValue = IF avail oe-rell and avail oe-bolh AND (not oe-bolh.posted) THEN STRING(oe-rell.qty,"->>>>>>>>>>>>9") ELSE "".
                WHEN "avl"      THEN cVarValue = STRING(v-bal,"->>>>>>>>9") .
        ...
        if tt-report.key-03 ne v-first[3] then do:
         ...
         /* display "         Item Totals:"     when v-cust-sort
          ...
          down with frame detail. */
             ...
             DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
               cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                    CASE cTmpField:    
                        ...
                        WHEN "ship-to"  THEN cVarValue = "" .
                        WHEN "i-no"     THEN cVarValue = "" .
                        WHEN "cust-po"  THEN cVarValue = "" .
                        WHEN "qty-ord"  THEN cVarValue = STRING(v-ono[3],"->>>>>>>>9").
                        WHEN "inv-dt"   THEN cvarValue = "".
                        WHEN "inv"      THEN cVarValue = "".
                        WHEN "qty-shp"  THEN cVarValue = STRING(v-shp[3],"->>>>>>>>9") .
                        WHEN "bol-no"   THEN cvarValue = "".
                        WHEN "bol-qty"  THEN cVarValue = STRING(v-bol[3],"->>>>>>>>>>>>9").
                        WHEN "avl"      THEN cVarValue = STRING(v-bal,"->>>>>>>>9") .
            ...
            END.
            IF v-cust-sort THEN do:
                PUT UNFORMATTED "    Item Totals:" substring(cDisplay,17,300) SKIP.
            END.
            ELSE IF NOT v-cust-sort THEN DO:
                PUT UNFORMATTED "    Ship To Totals:" substring(cDisplay,20,300) SKIP.
            END.
        ...
        if tt-report.key-02 ne v-first[2] then do:
         ...
         /* display "      Ship To Totals:"     when v-cust-sort
          ...
          PUT SKIP str-line SKIP .
             ...
             DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
               cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                    CASE cTmpField:    
                        ...
                        WHEN "i-no"     THEN cVarValue = "" .
                        WHEN "cust-po"  THEN cVarValue = "" .
                        WHEN "qty-ord"  THEN cVarValue = STRING(v-ono[2],"->>>>>>>>9").
                        WHEN "inv-dt"   THEN cvarValue = "".
                        WHEN "inv"      THEN cVarValue = "".
                        WHEN "qty-shp"  THEN cVarValue = STRING(v-shp[2],"->>>>>>>>9") .
                        WHEN "bol-no"   THEN cvarValue = "".
                        WHEN "bol-qty"  THEN cVarValue = STRING(v-bol[2],"->>>>>>>>>>>>9").
                        WHEN "avl"      THEN cVarValue = STRING(v-bal,"->>>>>>>>9") .
            ...
            END.
            ELSE IF NOT v-cust-sort THEN DO:
                PUT UNFORMATTED "    Customer Totals:" substring(cDisplay,21,300) SKIP.
            END.
             ...
             DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
               cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                    CASE cTmpField:    
                        ...
                        WHEN "i-no"     THEN cVarValue = "" .
                        WHEN "cust-po"  THEN cVarValue = "" .
                        WHEN "qty-ord"  THEN cVarValue = STRING(v-ono[1],"->>>>>>>>9").
                        WHEN "inv-dt"   THEN cvarValue = "".
                        WHEN "inv"      THEN cVarValue = "".
                        WHEN "qty-shp"  THEN cVarValue = STRING(v-shp[1],"->>>>>>>>9") .
                        WHEN "bol-no"   THEN cvarValue = "".
                        WHEN "bol-qty"  THEN cVarValue = STRING(v-bol[1],"->>>>>>>>>>>>9").
                        WHEN "avl"      THEN cVarValue = STRING(v-bal,"->>>>>>>>9") .
             ...
             DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
               cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                    CASE cTmpField:    
                        ...
                        WHEN "i-no"     THEN cVarValue = "" .
                        WHEN "cust-po"  THEN cVarValue = "" .
                        WHEN "qty-ord"  THEN cVarValue = STRING(v-ono[4],"->>>>>>>>9").
                        WHEN "inv-dt"   THEN cvarValue = "".
                        WHEN "inv"      THEN cVarValue = "".
                        WHEN "qty-shp"  THEN cVarValue = STRING(v-shp[4],"->>>>>>>>9") .
                        WHEN "bol-no"   THEN cvarValue = "".
                        WHEN "bol-qty"  THEN cVarValue = STRING(v-bol[4],"->>>>>>>>>>>>9").
                        WHEN "avl"      THEN cVarValue = STRING(v-bal,"->>>>>>>>9") .
                    ...
                    cExcelDisplay = cExcelDisplay + quoter(cExcelVarValue) + ",". 
            END.
            PUT UNFORMATTED "    Grand Totals:" substring(cDisplay,18,300) SKIP.
