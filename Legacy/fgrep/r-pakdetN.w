...
ASSIGN cTextListToSelect = "Item#,Item Name,UOM,Sell Price,Qty OnHand,Value,Cust Part#,Weight," +
...
{sys/inc/ttRptSel.i}
ASSIGN cTextListToDefault  = "Item#,Item Name,UOM,Sell Price,Qty OnHand,Value,Cust Part#,Weight," +
                           "Cases/Pallet,Pack/Ctn" .
...
DEFINE FRAME FRAME-A
     ...
     begin_cust-no AT ROW 4.95 COL 23.4 COLON-ALIGNED HELP
          "Enter Beginning Customer Number"
     end_cust-no AT ROW 4.95 COL 66.4 COLON-ALIGNED HELP
          "Enter Ending Customer Number"
     begin_cat AT ROW 5.91 COL 23.4 COLON-ALIGNED HELP
          "Enter Beginning Category"
     end_cat AT ROW 5.91 COL 66.4 COLON-ALIGNED HELP
          "Enter Ending Order Number"
     tb_pg-brk AT ROW 7.19 COL 24.2
     tb_zero AT ROW 7.19 COL 45.4
     rd_sort AT ROW 8.38 COL 34 NO-LABEL
     sl_avail AT ROW 10.81 COL 3 NO-LABEL WIDGET-ID 26
     Btn_Def AT ROW 10.81 COL 39 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 56
     sl_selected AT ROW 10.81 COL 58.4 NO-LABEL WIDGET-ID 28
     Btn_Add AT ROW 11.81 COL 39 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 32
     Btn_Remove AT ROW 12.81 COL 39 HELP
          "Remove Selected Table from Tables to Audit" WIDGET-ID 34
     btn_Up AT ROW 13.86 COL 39 WIDGET-ID 40
     btn_down AT ROW 14.86 COL 39 WIDGET-ID 42
     rd-dest AT ROW 17.05 COL 4 NO-LABEL
     lv-ornt AT ROW 17.57 COL 31.8 NO-LABEL
     lines-per-page AT ROW 18.67 COL 86.4 COLON-ALIGNED
     lv-font-no AT ROW 19 COL 34.6 COLON-ALIGNED
     lv-font-name AT ROW 19.95 COL 29 COLON-ALIGNED NO-LABEL
     td-show-parm AT ROW 21.14 COL 31
     tb_excel AT ROW 21.86 COL 71 RIGHT-ALIGNED
     tb_runExcel AT ROW 21.86 COL 93 RIGHT-ALIGNED
     fi_file AT ROW 22.76 COL 49 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 24.33 COL 20
     btn-cancel AT ROW 24.33 COL 58
     "Available Columns" VIEW-AS TEXT
          SIZE 29 BY .62 AT ROW 10.1 COL 3.8 WIDGET-ID 38
     "Selection Parameters" VIEW-AS TEXT
          SIZE 21 BY .71 AT ROW 1.24 COL 2.2
          BGCOLOR 2 
     "Sort Options :" VIEW-AS TEXT
          SIZE 14 BY .62 AT ROW 8.52 COL 18.8 WIDGET-ID 6
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 16.43 COL 2
     "Selected Columns(In Display Order)" VIEW-AS TEXT
          SIZE 34 BY .62 AT ROW 10.1 COL 58.4 WIDGET-ID 44
...
DEF VAR str-line AS cha FORM "x(150)" NO-UNDO.
