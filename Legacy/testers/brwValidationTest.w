...
&Scoped-define FIELDS-IN-QUERY-br_table testType testName testDesc ~
testTable testField resultType testRequired testProcedure defaultResult ~
defaultResultDesc passResult passResultDesc failResult failResultDesc 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTable _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      testType FORMAT "x(8)":U
      testName FORMAT "x(24)":U
      testDesc FORMAT "x(60)":U
      testTable FORMAT "x(24)":U
      testField FORMAT "x(24)":U
      resultType FORMAT "x(8)":U
      testRequired FORMAT "yes/no":U
      testProcedure FORMAT "x(60)":U
      defaultResult FORMAT "x(16)":U
      defaultResultDesc FORMAT "x(60)":U
      passResult FORMAT "x(16)":U
      passResultDesc FORMAT "x(60)":U
      failResult FORMAT "x(16)":U
      failResultDesc FORMAT "x(60)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.testType
     _FldNameList[2]   = _<SDO>.rowObject.testName
     _FldNameList[3]   = _<SDO>.rowObject.testDesc
     _FldNameList[4]   = _<SDO>.rowObject.testTable
     _FldNameList[5]   = _<SDO>.rowObject.testField
     _FldNameList[6]   = _<SDO>.rowObject.resultType
     _FldNameList[7]   = _<SDO>.rowObject.testRequired
     _FldNameList[8]   = _<SDO>.rowObject.testProcedure
     _FldNameList[9]   = _<SDO>.rowObject.defaultResult
     _FldNameList[10]   = _<SDO>.rowObject.defaultResultDesc
     _FldNameList[11]   = _<SDO>.rowObject.passResult
     _FldNameList[12]   = _<SDO>.rowObject.passResultDesc
     _FldNameList[13]   = _<SDO>.rowObject.failResult
     _FldNameList[14]   = _<SDO>.rowObject.failResultDesc
