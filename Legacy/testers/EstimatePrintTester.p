    ...
    CASE ipcType:
        ...
        WHEN "CostCategory" THEN 
            DO:
                ...
                ASSIGN
                    ttEstCostCategory.rec_keyCostCategory  = ipcData[1]
                    ...
                    ttEstCostCategory.rec_keyCostGroup     = ipcData[5]
...
FOR EACH ttEstCostDetail NO-LOCK 
    ...
    FIRST ttEstCostCategory NO-LOCK 
        WHERE ttEstCostCategory.rec_keyCostCategory EQ ttEstCostDetail.rec_keyCostCategory
    :
    FIND FIRST ttEstCostSummary EXCLUSIVE-LOCK
        WHERE ttEstCostSummary.rec_keyScope EQ ttEstCostDetail.rec_keyForm
        AND ttEstCostSummary.rec_keyCostGroup EQ ttEstCostCategory.rec_keyCostGroup
        NO-ERROR.
    IF NOT AVAILABLE ttEstCostSummary THEN DO:
        CREATE ttEstCostSummary.
        ASSIGN 
            ttEstCostSummary.rec_keyCostSummary = fGetNextRecKey()
            ttEstCostSummary.rec_keyCostGroup = ttEstCostCategory.rec_keyCostGroup
            ttEstCostSummary.rec_keyScope = ttEstCostDetail.rec_keyForm
            .
    END.
END.        
