...
DO:
    {aoa/tDateOption.i &dateObject=svAsOfDate &btnCalendar=3}
END.
...
DO:
    {aoa/tDateOption.i &dateObject=svEndInvoiceDate &btnCalendar=2}
END.
...
DO:
    {aoa/tDateOption.i &dateObject=svStartInvoiceDate &btnCalendar=1}
END.
