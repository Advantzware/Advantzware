...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH ar-cashl WHERE TRUE /* Join to ar-inv incomplete */ ~
      AND ar-cashl.company = ar-inv.company ~
 AND ar-cashl.posted = yes ~
 AND ar-cashl.cust-no = ar-inv.cust-no ~
 AND ar-cashl.inv-no = ar-inv.inv-no NO-LOCK, ~
      EACH ar-cash WHERE ar-cash.c-no = ar-cashl.c-no ~
      AND ar-cash.c-no = ar-cashl.c-no NO-LOCK ~
    BY ar-inv.inv-no ~
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 18 BY 7.62.
...
/* Query rebuild information for BROWSE br_table
     ...
     _Options          = "NO-LOCK"
     _OrdList          = "ASI.ar-inv.inv-no|yes,ASI.ar-cashl.check-no|yes"
     _Where[1]         = "ASI.ar-cashl.company = ar-inv.company
 AND ASI.ar-cashl.posted = yes
 AND ASI.ar-cashl.cust-no = ar-inv.cust-no
 AND ASI.ar-cashl.inv-no = ar-inv.inv-no"
     _JoinCode[2]      = "ASI.ar-cash.c-no = ar-cashl.c-no"
     _Where[2]         = "ASI.ar-cash.c-no = ar-cashl.c-no"
