        ...
        ASSIGN cDisplay = ""
           ...
           cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                CASE cTmpField:
                    ...
                    WHEN "ptd-sf"   THEN cVarValue =  STRING(w-ptd-sqft,"->>>,>>9.999").
                    WHEN "ptd-amt"  THEN cVarValue =  STRING(w-ptd-amt,"->,>>>,>>9.99").
                    WHEN "ptd-msf"  THEN cVarValue =  STRING(w-ptd-msf,"->,>>>,>>9.99").
                    WHEN "ytd-sf"   THEN cVarValue = STRING(w-ytd-sqft,"->>>,>>9.999") .
                    WHEN "ytd-amt"  THEN cVarValue = STRING(w-ytd-amt,"->,>>>,>>9.99") .  
                    WHEN "ytd-msf"  THEN cVarValue = STRING(w-ytd-msf,"->,>>>,>>9.99") .
