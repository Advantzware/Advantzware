...
&Scoped-define FIELDS-IN-QUERY-br_table programID module prgmname prgtitle ~
menu_item popup 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTable _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      programID FORMAT ">>>>>9":U
      module FORMAT "x(8)":U
      prgmname FORMAT "X(10)":U
      prgtitle FORMAT "X(30)":U WIDTH 37
      menu_item FORMAT "yes/no":U VIEW-AS TOGGLE-BOX
      popup FORMAT "yes/no":U WIDTH 54.4 VIEW-AS TOGGLE-BOX
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 88 BY 6.67 FIT-LAST-COLUMN.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.programID
"programID" ? ? "integer" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   = _<SDO>.rowObject.module
     _FldNameList[3]   = _<SDO>.rowObject.prgmname
     _FldNameList[4]   > _<SDO>.rowObject.prgtitle
"prgtitle" ? ? "character" ? ? ? ? ? ? no ? no no "37" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > _<SDO>.rowObject.menu_item
"menu_item" ? ? "logical" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "TOGGLE-BOX" "?" ? ? 5 no 0 no no
     _FldNameList[6]   > _<SDO>.rowObject.popup
"popup" ? ? "logical" ? ? ? ? ? ? no ? no no "8.4" yes no no "U" "" "" "TOGGLE-BOX" "," ? ? 5 no 0 no no
