...
&Scoped-define DATA-FIELD-DEFS "n:/repository/legacy/sdo/sdoprogrammenu.i"
...
&Scoped-define FIELDS-IN-QUERY-br_table menuID shortname parentMenuID ~
menuPos prgrmsID menuText defMnemonic menuToolTip menuImage paramList ~
user_id 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTable _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      menuID FORMAT ">>>>>9":U
      shortname FORMAT "x(12)":U
      parentMenuID FORMAT ">>>>>9":U
      menuPos FORMAT ">>>>9":U
      prgrmsID FORMAT ">>>>>>9":U
      menuText FORMAT "x(48)":U
      defMnemonic FORMAT "x(8)":U
      menuToolTip FORMAT "x(32)":U
      menuImage FORMAT "x(60)":U
      paramList FORMAT "x(60)":U
      user_id FORMAT "X(8)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "n:\repository\legacy\sdo\sdoprogrammenu.w"
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.menuID
     _FldNameList[2]   = _<SDO>.rowObject.shortname
     _FldNameList[3]   = _<SDO>.rowObject.parentMenuID
     _FldNameList[4]   = _<SDO>.rowObject.menuPos
     _FldNameList[5]   = _<SDO>.rowObject.prgrmsID
     _FldNameList[6]   = _<SDO>.rowObject.menuText
     _FldNameList[7]   = _<SDO>.rowObject.defMnemonic
     _FldNameList[8]   = _<SDO>.rowObject.menuToolTip
     _FldNameList[9]   = _<SDO>.rowObject.menuImage
     _FldNameList[10]   = _<SDO>.rowObject.paramList
     _FldNameList[11]   = _<SDO>.rowObject.user_id
