...
5.	Exit to procedure editor and compile the program:   "COMPILE nosweat/mfvalad.p SAVE".
6.	Copy the runcode (mfvalad.r) to four locations:
...
DEFINE VARIABLE iphSmartMsg AS HANDLE NO-UNDO.
