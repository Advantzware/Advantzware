...
DEFINE WORKFILE wk-ptrs NO-UNDO
  FIELD menu-name AS CHARACTER
  FIELD smenu-ptr AS WIDGET-HANDLE.

DEFINE WORKFILE wk-items NO-UNDO
...
&Scoped-Define ENABLED-OBJECTS menu-items menu-names RECT-5 Btn_Build ~
RECT-2 Btn_Default Btn_Add_Menu program-names Btn_Reset Btn_Save RECT-1 ~
RECT-3 Btn_Cancel Btn_Up Btn_Down Btn_Add_Rule Btn_Add_Skip Btn_Left ~
...
------------------------------------------------------------------------------*/
  ...
  ENABLE menu-items menu-names RECT-5 Btn_Build RECT-2 Btn_Default Btn_Add_Menu 
         program-names Btn_Reset Btn_Save RECT-1 RECT-3 Btn_Cancel Btn_Up 
         Btn_Down Btn_Add_Rule Btn_Add_Skip Btn_Left Btn_Right Btn_Remove 
         Btn_Add_Program 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
