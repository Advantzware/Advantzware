...
/* ***************************  Definitions  ************************** */
{ src/adm/support/admhlp.i } /* ADM Help Defs */
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  RUN enable_UI.
  RUN Load_Image.
    {methods/setButton.i b_AddXT "Add"} /* added by script _nonAdm1Images.p on 03.28.2017 @ 10:43:41 am */
    {methods/setButton.i b_HelpXT "Help"} /* added by script _nonAdm1Images.p on 03.28.2017 @ 10:43:41 am */
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  DO:
    ASSIGN b_AddXT:LABEL = "Modify External Tables"
           ...
           IMAGE-3:HIDDEN = yes
           .  
    IF CAN-DO("SmartListObject,SmartEasyWindow",objtype) THEN
