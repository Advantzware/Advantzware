...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _XFTR "SmartEasyWindowWizard" W-Win _INLINE
/* Actions: adm/support/_wizard.w ? ? ? adm/support/_wizdel.p */
/* SmartEasyWindow Wizard
Welcome to the SmartEasyWindow Wizard! During the next few steps, the wizard will lead you through creating a SmartEasyWindow object. You will need to define External Tables. Press Next to proceed.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Browse <name>|View <name>' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
