...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Move Pending Job Resource - Scheduler"
         HEIGHT             = 28.57
         WIDTH              = 160
         MAX-HEIGHT         = 320
         MAX-WIDTH          = 320
...
ON END-ERROR OF W-Win /* Move Pending Job Resource - Scheduler */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Move Pending Job Resource - Scheduler */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-RESIZED OF W-Win /* Move Pending Job Resource - Scheduler */
DO:
  RUN winReSize.
END.
...
------------------------------------------------------------------------------*/
  ...
  moveResource = findProgram('{&viewers}/',ID,'/movePendingRes.w').
