...
&SCOPED-DEFINE h_Browse01 h_b-fguncm
...
DEFINE VARIABLE h_b-fguncm AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "FG Scheduled Shipments vs. Quantity On Hand"
         HEIGHT             = 24
         WIDTH              = 150
         MAX-HEIGHT         = 320
         MAX-WIDTH          = 320
...
ON END-ERROR OF W-Win /* FG Scheduled Shipments vs. Quantity On Hand */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* FG Scheduled Shipments vs. Quantity On Hand */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Sched vs QOH' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'fginq/b-fguncm.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-fguncm ).
       RUN set-position IN h_b-fguncm ( 4.57 , 2.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_b-fguncm , 'export-xl':U , h_export ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-fguncm ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
