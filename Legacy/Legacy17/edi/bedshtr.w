...
&Scoped-define INTERNAL-TABLES EDSHTran
...
EDSHTran.BOL-No EDSHTran.BOL-Adddate EDSHTran.Pro-Number EDSHTran.Ship-Date ~
EDSHTran.St-code EDSHTran.Tot-wght 
&Scoped-define ENABLED-FIELDS-IN-QUERY-Browser-Table 
&Scoped-define QUERY-STRING-Browser-Table FOR EACH EDSHTran WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Browser-Table OPEN QUERY Browser-Table FOR EACH EDSHTran WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Browser-Table EDSHTran
&Scoped-define FIRST-TABLE-IN-QUERY-Browser-Table EDSHTran
...
"BOL-Adddate" "BOL-Date" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     ...
     _FldNameList[8]   = asi.EDSHTran.Tot-wght
