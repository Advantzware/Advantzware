...
&SCOPED-DEFINE h_Object01 h_p-rmrcpt
    ...
    WHEN 1 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = Yes':U ,
             OUTPUT h_b-rcptd ).
       RUN set-position IN h_b-rcptd ( 4.81 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-rcptd ( 17.14 , 146.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'panels/p-rmrcpt.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Edge-Pixels = 2,
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-rmrcpt ,
             h_b-rcptd , 'AFTER':U ).
    END. /* Page 1 */
