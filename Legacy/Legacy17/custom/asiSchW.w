...
&Scoped-Define ENABLED-OBJECTS btRun btExit 
...
DEFINE FRAME DEFAULT-FRAME
     ...
     btRun AT ROW 3.62 COL 63 WIDGET-ID 2
     btExit AT ROW 3.62 COL 80 WIDGET-ID 4
...
END.
ELSE MESSAGE "asiSchW.wrx":U SKIP(1)
