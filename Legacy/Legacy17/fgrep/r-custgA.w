...
tb_inc-cust rd-dest lv-ornt lines-per-page lv-font-no td-show-parm tb_excel ~
tb_runExcel fi_file btn-ok btn-cancel 
&Scoped-Define DISPLAYED-OBJECTS tb_cust-list begin_cust end_cust ~
begin_cust-po end_cust-po begin_slm end_slm tb_inc-zer tb_inc-cust rd-dest ~
...
DEFINE FRAME FRAME-A
     tb_cust-list AT ROW 2.38 COL 31 WIDGET-ID 6
     btnCustList AT ROW 2.43 COL 63 WIDGET-ID 8
     begin_cust AT ROW 3.57 COL 27 COLON-ALIGNED HELP
          "Enter Beginning Customer Number"
     end_cust AT ROW 3.57 COL 70 COLON-ALIGNED HELP
          "Enter Ending Customer Number"
     begin_cust-po AT ROW 4.52 COL 27 COLON-ALIGNED HELP
          "Enter Beginning Customer PO Number"
     end_cust-po AT ROW 4.52 COL 70 COLON-ALIGNED HELP
          "Enter Ending Customer PO Number"
     begin_slm AT ROW 5.48 COL 27 COLON-ALIGNED HELP
          "Enter Beginning Sales Rep Number"
     end_slm AT ROW 5.48 COL 70 COLON-ALIGNED HELP
          "Enter Ending Sales Rep Number"
     tb_inc-zer AT ROW 7.62 COL 31
     tb_inc-cust AT ROW 8.57 COL 76 RIGHT-ALIGNED
     ...
     tb_excel AT ROW 16.24 COL 71 RIGHT-ALIGNED
     tb_runExcel AT ROW 16.24 COL 93 RIGHT-ALIGNED
     fi_file AT ROW 17.19 COL 49 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 19.81 COL 24
...
------------------------------------------------------------------------------*/
  DISPLAY tb_cust-list begin_cust end_cust begin_cust-po end_cust-po begin_slm 
          end_slm tb_inc-zer tb_inc-cust rd-dest lv-ornt lines-per-page 
