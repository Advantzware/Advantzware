...
ASSIGN cTextListToSelect = "FG ITEM NUMBER,DESCRIPTION,CUSTOMER,BEG BALANCE,"
                         + "ITEM CST,QTY PRODUCED,QTY SHIPPED,QTY ADJUSTED,"
                         + "QTY ONHAND,TOTAL VALUE"
       cFieldListToSelect = "i-no,dscr,cust,bg-bal," +
                            "itm-cst,qty-pro,qty-shp,qty-adj," +
                            "qty-oh,ttl-val"
       cFieldLength = "15,15,8,12," + "8,12,12,13," + "12,15" 
       cFieldType = "c,c,c,i," + "i,i,i,i," + "i,i" 
    .

{sys/inc/ttRptSel.i}
ASSIGN cTextListToDefault  = "FG ITEM NUMBER,DESCRIPTION,CUSTOMER,BEG BALANCE,"
                         + "ITEM CST,QTY PRODUCED,QTY SHIPPED,QTY ADJUSTED,"
                         + "QTY ONHAND,TOTAL VALUE" .
...
begin_whse end_whse begin_cust end_cust begin_i-no end_i-no tb_inc-cust ~
sl_avail Btn_Def sl_selected Btn_Add Btn_Remove btn_Up btn_down rd-dest ~
lv-ornt lines-per-page lv-font-no tb_excel tb_runExcel td-show-parm fi_file ~
btn-ok btn-cancel 
&Scoped-Define DISPLAYED-OBJECTS tb_cust-list begin_whse end_whse ~
begin_cust end_cust begin_i-no end_i-no tb_inc-cust sl_avail sl_selected ~
rd-dest lv-ornt lines-per-page lv-font-no lv-font-name tb_excel tb_runExcel ~
...
DEFINE FRAME FRAME-A
     ...
     btnCustList AT ROW 1.86 COL 61.4 WIDGET-ID 8
     begin_whse AT ROW 3.05 COL 27 COLON-ALIGNED HELP
          "Enter Beginning Warehouse"
     end_whse AT ROW 3.05 COL 70 COLON-ALIGNED HELP
          "Enter Ending Warehouse"
     begin_cust AT ROW 4 COL 27 COLON-ALIGNED HELP
          "Enter Beginning Customer Number"
     end_cust AT ROW 4 COL 70 COLON-ALIGNED HELP
          "Enter Ending Customer Number"
     begin_i-no AT ROW 4.95 COL 27 COLON-ALIGNED HELP
          "Enter Beginning Item Number"
     end_i-no AT ROW 4.95 COL 70 COLON-ALIGNED HELP
          "Enter Ending Item Number"
     tb_inc-cust AT ROW 6.05 COL 77 RIGHT-ALIGNED
     sl_avail AT ROW 8.19 COL 4 NO-LABEL WIDGET-ID 26
     Btn_Def AT ROW 8.19 COL 40.2 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 56
     sl_selected AT ROW 8.19 COL 59.4 NO-LABEL WIDGET-ID 28
     Btn_Add AT ROW 9.19 COL 40.2 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 32
     Btn_Remove AT ROW 10.19 COL 40.2 HELP
          "Remove Selected Table from Tables to Audit" WIDGET-ID 34
     btn_Up AT ROW 11.24 COL 40.2 WIDGET-ID 40
     btn_down AT ROW 12.24 COL 40.2 WIDGET-ID 42
     rd-dest AT ROW 17.48 COL 5 NO-LABEL
     lv-ornt AT ROW 17.71 COL 30 NO-LABEL
     lines-per-page AT ROW 17.71 COL 83 COLON-ALIGNED
     lv-font-no AT ROW 19.14 COL 33 COLON-ALIGNED
     lv-font-name AT ROW 20.1 COL 27 COLON-ALIGNED NO-LABEL
     tb_excel AT ROW 21.52 COL 68 RIGHT-ALIGNED
     tb_runExcel AT ROW 21.52 COL 90 RIGHT-ALIGNED
     td-show-parm AT ROW 22.14 COL 4.6
     fi_file AT ROW 22.48 COL 46 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 24.05 COL 19
     btn-cancel AT ROW 24.05 COL 57
     "Available Columns" VIEW-AS TEXT
          SIZE 29 BY .62 AT ROW 7.48 COL 4.8 WIDGET-ID 38
     "Selected Columns(In Display Order)" VIEW-AS TEXT
          SIZE 34 BY .62 AT ROW 7.43 COL 59 WIDGET-ID 44
     "Cost Shown is Average or Last Cost." VIEW-AS TEXT
          SIZE 75 BY 1.19 AT ROW 13.57 COL 20
          BGCOLOR 11 FGCOLOR 12 FONT 5
     "Finished Goods Control File." VIEW-AS TEXT
          SIZE 75 BY 1.19 AT ROW 15.24 COL 20
          BGCOLOR 11 FGCOLOR 12 FONT 5
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 16.76 COL 2
     "Please Note:" VIEW-AS TEXT
          SIZE 19 BY 1.19 AT ROW 13.57 COL 1
          BGCOLOR 11 FGCOLOR 12 FONT 5
     "Selection Parameters" VIEW-AS TEXT
          SIZE 21 BY .71 AT ROW 1.24 COL 5
          BGCOLOR 2 
     "Inventory Valuation Method is set in the" VIEW-AS TEXT
          SIZE 75 BY .71 AT ROW 14.52 COL 20
          BGCOLOR 11 FGCOLOR 12 FONT 5
     "text" VIEW-AS TEXT
          SIZE 19 BY 1.67 AT ROW 14.76 COL 1
          BGCOLOR 11 FGCOLOR 11 
     RECT-6 AT ROW 16.52 COL 1
     RECT-7 AT ROW 7.19 COL 1 WIDGET-ID 58
...
------------------------------------------------------------------------------*/
  DISPLAY tb_cust-list begin_whse end_whse begin_cust end_cust begin_i-no 
          end_i-no tb_inc-cust sl_avail sl_selected rd-dest lv-ornt 
          lines-per-page lv-font-no lv-font-name tb_excel tb_runExcel 
          td-show-parm fi_file 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE RECT-6 RECT-7 tb_cust-list btnCustList begin_whse end_whse begin_cust 
         end_cust begin_i-no end_i-no tb_inc-cust sl_avail Btn_Def sl_selected 
...
FOR each fg-bin where fg-bin.company = itemfg.company and
        ...
        DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
           cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                CASE cTmpField:             
                     ...
                     WHEN "bg-bal"   THEN cVarValue = STRING(itemfg.beg-bal,"->>>,>>>,>>9") .  
                     WHEN "itm-cst"  THEN cVarValue = STRING(v-cost,">>>9.99")  .              
                     WHEN "qty-pro"  THEN cVarValue = STRING(itemfg.q-prod-ytd,"->>>,>>>,>>9").
                     WHEN "qty-shp"  THEN cVarValue = STRING(itemfg.q-ship-ytd,"->>>,>>>,>>9").
                     WHEN "qty-adj"  THEN cVarValue = STRING(itemfg.q-adj-ytd,"->>>,>>>,>>9") .
                     WHEN "qty-oh"   THEN cVarValue = STRING(v-qty-onh,"->>>,>>>,>>9")  .      
                     WHEN "ttl-val"  THEN cVarValue = STRING(v-ext,"->>>,>>>,>>9.99") .        
    ...
    if last-of(itemfg.cust-no) and v-print then do:
        ...
        DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
           cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                CASE cTmpField:             
                     ...
                     WHEN "bg-bal"   THEN cVarValue = "" .
                     WHEN "itm-cst"  THEN cVarValue = "" .
                     WHEN "qty-pro"  THEN cVarValue = "" .
                     WHEN "qty-shp"  THEN cVarValue = "" .
                     WHEN "qty-adj"  THEN cVarValue = "" .
                     WHEN "qty-oh"   THEN cVarValue = "" .
                     WHEN "ttl-val"  THEN cVarValue = STRING(v-subext,"->>>,>>>,>>9.99") .        
        ...
        PUT UNFORMATTED "   Customer Totals" substring(cDisplay,19,300) SKIP. 
