...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES rm-bin
&Scoped-define FIRST-EXTERNAL-TABLE rm-bin
...
DEFINE FRAME F-Main
     rm-bin.loc-bin AT ROW 1.24 COL 25 COLON-ALIGNED
...
/* SETTINGS FOR FILL-IN rm-bin.loc-bin IN FRAME F-Main
   EXP-LABEL                                                            */
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "rm-bin"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "rm-bin"}
...
------------------------------------------------------------------------------*/
  ...
  {methods/viewers/create/rm-bin.i}
