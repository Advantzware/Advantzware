...
&Scoped-Define ENABLED-FIELDS reftable.dscr reftable.val[1] 
...
&Scoped-Define DISPLAYED-FIELDS reftable.code reftable.dscr reftable.val[1] 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,ROW-AVAILABLE,DISPLAY-FIELD,List-5,F1 */
&Scoped-define ADM-CREATE-FIELDS reftable.code 
...
DEFINE FRAME F-Main
     reftable.code AT ROW 1.95 COL 12 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 11.6 BY 1
     reftable.dscr AT ROW 1.95 COL 41 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 38 BY 1
     reftable.val[1] AT ROW 1.95 COL 94 COLON-ALIGNED
          LABEL "Stacks"
          VIEW-AS FILL-IN 
          SIZE 14 BY 1
...
/* SETTINGS FOR FILL-IN reftable.code IN FRAME F-Main
   NO-ENABLE 1                                                          */
/* SETTINGS FOR FILL-IN reftable.val[1] IN FRAME F-Main
   EXP-LABEL                                                            */
