...
DEFINE FRAME FRAME-A
     tb_cust-list AT ROW 1.71 COL 30.6 WIDGET-ID 6
     btnCustList AT ROW 1.76 COL 63.6 WIDGET-ID 8
     begin_cust-no AT ROW 3.14 COL 28 COLON-ALIGNED HELP
          "Enter Beginning Customer Number"
     end_cust-no AT ROW 3.14 COL 69 COLON-ALIGNED HELP
          "Enter Ending Customer Number"
     begin_ship AT ROW 4.1 COL 28 COLON-ALIGNED HELP
          "Enter Beginning Ship-to#"
     end_ship AT ROW 4.1 COL 69 COLON-ALIGNED HELP
          "Enter Ending Zip Code"
     begin_slsmn AT ROW 5.1 COL 28 COLON-ALIGNED HELP
          "Enter Beginning Sales Rep Number" WIDGET-ID 2
     end_slsmn AT ROW 5.1 COL 69 COLON-ALIGNED HELP
          "Enter Ending Sales Rep Number" WIDGET-ID 4
     begin_i-no AT ROW 6.1 COL 28 COLON-ALIGNED HELP
          "Enter Beginning Item Number"
     end_i-no AT ROW 6.1 COL 69 COLON-ALIGNED HELP
          "Enter Ending Customer Number"
     begin_inv-date AT ROW 7.1 COL 28 COLON-ALIGNED HELP
          "Enter Beginning Invoice Date"
     end_inv-date AT ROW 7.1 COL 69 COLON-ALIGNED HELP
          "Enter Ending Invoice Date"
     begin_po AT ROW 8.14 COL 28 COLON-ALIGNED HELP
          "Enter Beginning Po Number"
     end_po AT ROW 8.14 COL 69 COLON-ALIGNED HELP
          "Enter Ending Po#"
     lbl_cost AT ROW 9.57 COL 29 COLON-ALIGNED NO-LABEL
     rd_cost1 AT ROW 9.57 COL 38 NO-LABEL
     tb_fin-chg AT ROW 10.76 COL 35
     rd-dest AT ROW 13.62 COL 7 NO-LABEL
     ...
     tb_excel AT ROW 19.57 COL 50 RIGHT-ALIGNED
     tb_runExcel AT ROW 19.57 COL 71 RIGHT-ALIGNED
     fi_file AT ROW 20.38 COL 28 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 22.57 COL 19
     btn-cancel AT ROW 22.57 COL 57
     "Selection Parameters" VIEW-AS TEXT
          SIZE 21 BY .71 AT ROW 1.24 COL 5
          BGCOLOR 2 
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 12.86 COL 5
...
------------------------------------------------------------------------------*/
  DISPLAY tb_cust-list begin_cust-no end_cust-no begin_ship end_ship begin_slsmn 
          ...
          end_po lbl_cost rd_cost1 tb_fin-chg rd-dest lv-ornt lines-per-page 
