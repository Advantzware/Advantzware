...
&Scoped-Define ENABLED-OBJECTS RECT-10 btn-print 
...
ASSIGN 
       btn-print:PRIVATE-DATA IN FRAME F-Main     = 
                "panel-image".
...
DO:
    ...
    RUN get-link-handle IN adm-broker-hdl (THIS-PROCEDURE,"loadtag-target",OUTPUT char-hdl).
    IF VALID-HANDLE(WIDGET-HANDLE(char-hdl)) THEN
        RUN print-loadtag IN WIDGET-HANDLE(char-hdl).
...
/* ***************************  Main Block  *************************** */
  ...
  {methods/setButton.i btn-print "Print"}
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
     btn-print:SENSITIVE IN FRAME {&FRAME-NAME} = NO.
END PROCEDURE.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  btn-print:SENSITIVE IN FRAME {&FRAME-NAME} = YES.
END PROCEDURE.
