...
&Scoped-define INTERNAL-TABLES shift_break

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table shift_break.charge_code 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH shift_break OF shifts WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH shift_break OF shifts WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table shift_break
&Scoped-define FIRST-TABLE-IN-QUERY-br_table shift_break
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD disp-time B-table-Win 
FUNCTION disp-time RETURNS CHARACTER
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      shift_break.charge_code FORMAT "X(5)":U LABEL-BGCOLOR 14
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 11.8 BY 8.1
         BGCOLOR 8 FONT 0.
...
DEFINE FRAME F-Main
     ...
     fi_sortby AT ROW 7.48 COL 1 NO-LABEL WIDGET-ID 2
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION disp-time B-table-Win 
FUNCTION disp-time RETURNS CHARACTER
