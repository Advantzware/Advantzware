...
&Scoped-Define ENABLED-OBJECTS RECT-1 SL keystroke Btn_One_Up Btn_Page_Up ~
...
DEFINE BUTTON Btn_Select 
     ...
     SIZE 40 BY 2.38 TOOLTIP "SELECT MACHINE".
...
ON CHOOSE OF Btn_Select IN FRAME F-Main /* SELECT MACHINE */
DO:
  ASSIGN
