/* ------------------------------------------- cec/quote/quoprotg.p 10/02 YSK */
  ...
  ASSIGN
    ...
    DO:
       PUT "<P10><C1>All tooling (Print Dies, Cutting Dies, or Prepress) is additional unless specified.  Standard" SKIP
           "<C1>orders are plus or minus a 5% over/under run.  Pricing is subject to review of final artwork files" SKIP
           "<C1>and approved structure.  Prices are valid for 30 days unless otherwise specified. Storage charges"  SKIP
           "<C1>are extra." SKIP.
    ...
    DO:
       PUT "<P10><C1>All tooling included unless otherwise specified.  Prepress is additional.  Standard orders" SKIP
           "<C1>are plus or minus a 5% over/under run.  Pricing is subject to review of final artwork files" SKIP
           "<C1>and approved structure. Prices are valid for 30 days unless otherwise specified. Storage charges" SKIP
           "<C1>are extra." SKIP.
       v-printline = v-printline + 1.
    END.
    ...
    DO:
       PUT "<P10><C1>For Corrugated items, all tooling (Print Dies, Cutting Dies, or Prepress) is additional unless" SKIP
           ...
           "<C1>specified.  Standard orders are plus or minus a 5% over/under run.  Pricing is subject to" SKIP
           "<C1>review of final artwork files and approved structure.  Prices are valid for 30 days unless otherwise" SKIP
           "<C1>specified. Storage charges are extra." SKIP.
       v-printline = v-printline + 1.
    END.
   ...
   IF (ch-multi and (v-last or s-sep-page)) then do:
      ...
      DO:
         PUT "<P10><C1>All tooling (Print Dies, Cutting Dies, or Prepress) is additional unless specified.  Standard" SKIP
             "<C1>orders are plus or minus a 5% over/under run.  Pricing is subject to review of final artwork" SKIP
             "<C1>files and approved structure.  Prices are valid for 30 days unless otherwise specified. Storage" SKIP
             "<C1>charges are extra." SKIP.
         v-printline = v-printline + 1.
      END.
      ELSE IF s-note-mode EQ "Fold" THEN
      DO:
      ...
      DO:
         PUT "<P10><C1>For Corrugated items, all tooling (Print Dies, Cutting Dies, or Prepress) is additional unless" SKIP
             "<C1>specified.  For Folding items, all tooling is included, except Prepress is additional unless" SKIP
             "<C1>specified.  Standard orders are plus or minus a 5% over/under run.  Pricing is subject to" SKIP
             "<C1>review of final artwork files and approved structure.  Prices are valid for 30 days unless" SKIP 
             "<C1>otherwise specified. Storage charges are extra." SKIP.
