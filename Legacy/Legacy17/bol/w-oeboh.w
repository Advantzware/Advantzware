...
DEFINE VARIABLE h_b-oebolh AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v-blpost AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'bol/b-oebolh.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-oebolh ).
       RUN set-position IN h_b-oebolh ( 4.81 , 4.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'bol/v-oebolh.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-oebolh ).
       RUN set-position IN h_v-oebolh ( 4.81 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 8.10 , 128.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updsav-2 ).
       RUN set-position IN h_p-updsav-2 ( 4.81 , 133.00 ) NO-ERROR.
       RUN set-size IN h_p-updsav-2 ( 8.10 , 11.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'bol/b-oeboll.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-oeboll ).
       RUN set-position IN h_b-oeboll ( 13.38 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 8.81 , 143.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'bol/v-blpost.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-blpost ).
       RUN set-position IN h_v-blpost ( 22.43 , 95.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_b-oebolh , 'Record':U , h_v-oebolh ).
       RUN add-link IN adm-broker-hdl ( h_p-updsav-2 , 'TableIO':U , h_v-oebolh ).
       ...
       /* Links to SmartViewer h_v-blpost. */
       RUN add-link IN adm-broker-hdl ( h_v-oebolh , 'Record':U , h_v-blpost ).
