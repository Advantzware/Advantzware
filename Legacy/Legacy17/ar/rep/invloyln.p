...
DEF BUFFER bf-sold-arinvl FOR ar-invl .
  ...
  BREAK BY report.key-01
    ...
    IF ar-inv.sold-name <> "" 
     ...
     FIND FIRST oe-ord 
       ...
       ELSE
       DO:
           FIND FIRST bf-sold-arinvl WHERE bf-sold-arinvl.x-no EQ ar-inv.x-no  
                                  NO-LOCK NO-ERROR.
           IF AVAIL bf-sold-arinvl THEN
               FIND FIRST oe-ord 
               WHERE oe-ord.company EQ cocode
               AND oe-ord.ord-no  EQ bf-sold-arinvl.ord-no NO-LOCK NO-ERROR.
