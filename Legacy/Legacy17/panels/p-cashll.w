...
DEFINE VARIABLE add-disable   AS LOGICAL NO-UNDO INIT no.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE set-add-active C-WIn 
PROCEDURE set-add-active :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
&ENDIF
  ...
  ELSE IF panel-state = 'initial':U THEN DO:
    ...
    /* The panel is not actively changing any of its TABLEIO-TARGET(s). */  /*add-disable*/
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  APPLY 'ENTRY':U TO Btn-Add IN FRAME {&FRAME-NAME}.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE time-goes-by C-WIn 
PROCEDURE time-goes-by :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
