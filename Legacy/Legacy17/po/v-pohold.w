...
&Scoped-Define ENABLED-OBJECTS RECT-12 btn-hold 
...
ASSIGN 
       btn-hold:PRIVATE-DATA IN FRAME F-Main     = 
                "panel-image".
...
&Scoped-define SELF-NAME btn-hold
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn-hold V-table-Win
ON CHOOSE OF btn-hold IN FRAME F-Main /* Hold/Release */
DO:
...
------------------------------------------------------------------------------*/
  ...
  IF NOT v-can-update THEN
     btn-hold:SENSITIVE IN FRAME {&FRAME-NAME} = NO. 
END PROCEDURE.
