...
/*   "<=1><R+2>" "<FGCOLOR=" + TRIM(lv-comp-color) + ">" FORM "x(15)" */
  ...
  */    
    SKIP(5)
  "<FCourier New><B>"
  SPACE(3) "<B>" "Sold To:" "Ship To:" AT 55  "Contact:" AT 92 "</B><P10>" SKIP
  SPACE(4) "<B>" v-comp-name    "<P12>" v-ship-name    AT 44 v-cntct-nam FORMAT "x(22)" AT 75 "</B><P10>" SKIP
  SPACE(4) "<B>" v-comp-addr[1] "<P12>" v-ship-addr[1] AT 44 "</B><P10>" SKIP
  SPACE(4) "<B>" v-comp-addr[2] "<P12>" v-ship-addr[2] AT 44 TRIM(v-phone-num) FORMAT "x(15)" AT 75 "</B><P10>" SKIP
  SPACE(4) "<B>" v-comp-addr3   "<P12>" v-ship-addr3   AT 44 "</B><P10>" SKIP.

 /* IF TRIM(v-phone-num) NE "" AND
     TRIM(v-phone-num) NE "()"  
    THEN PUT "<P12><B>" TRIM(v-phone-num) FORMAT "x(15)" AT 39  "</B><P10>" SKIP. */
...
/*   "<FArial><=5><R+1> Order Qty / Part#            PO# / Job#                        Description                                              Units    Count         Total          P/C" SKIP(1) */
  "<FArial><=5><R+1> Customer Part #            PO# / Lot#                      Description                                      #Pal    Cases    Count         Total          P/C" SKIP(1)
  "<FCourier New>"                                  
  .
