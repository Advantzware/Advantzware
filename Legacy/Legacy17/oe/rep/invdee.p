         ...
         for each w-tax :
            ...
            */
            ...
            IF v-printline > 58 THEN DO:
               PUT "<R59><C65>Page " string(PAGE-NUM - lv-pg-num,">>9") + " of <#PAGES>" FORM "x(20)" .
               PAGE.
               v-printline = 0.
               {oe/rep/invdee.i}
            END.
...
*/          
    ...
    PUT "<R58><C58><#8><FROM><R+5><C+22><RECT> " 
        ...
        "<C65>Page "  string(PAGE-NUM - lv-pg-num,">>9") + " of <#PAGES>"  FORM "x(20)" .

   PUT /*"<FArial><R59><C1><P12><B> Comments </B> <P9> " SKIP*/
         "<R59><C1><FROM><R+4><C+35><RECT>"
         "<R59><C3><B>Please Remit To:"
         "<R60><C3>  Dee Paper Co, Inc."
         "<R61><C3>  100 Broomall St."
         "<R62><C3>  Chester, PA  19013.</B>".
