...
/*    if can-do("COD,CIA", oe-ord.terms) then v-terms = oe-ord.terms-d. */
  ...
  PUT "<R52><C40><#7><C-6>Shipper Signature"
      "<=7><C+10><FROM><R+2><C+20><RECT> " 
      "<R54><C50><#8><FROM><R+4><C+30><RECT> " 
...
PUT "<FBook Antiqua><R52><C1><P12><B>     Shipping Instructions: </B> <P9> " SKIP(1)
    ...
    "Page " AT 220 string(PAGE-NUM - lv-pg-num,">>9") + " of " + string(lv-tot-pg) FORM "x(20)" 
    ...
    "<C35><P6>   FREIGHT CODE NMFC 029280       CLASS 55" SKIP    
