...
{oe/rep/ackprfrm.i}
      ...
      for each oe-ordl
        ...
        v-prod-code = IF AVAIL itemfg THEN itemfg.prod-code ELSE "".
        put /*v-line FORM ">>>9" SPACE(3)*/
                v-part /*oe-ordl.i-no*/ AT 2  SPACE(1)             
...
*/
      ...
      PUT "<R54><C1>" v-whse-txt 
        ...
        "<R64><C1>" /*v-whse-txt*/ "<C65>Page "  string(PAGE-NUM - lv-pg-num,">>9") + " of " + string(lv-tot-pg) FORM "x(20)" 
        .
