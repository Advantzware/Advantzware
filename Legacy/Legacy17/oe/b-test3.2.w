...
&SCOPED-DEFINE dataGridInclude dataGrid\oe\b-test3.2.i
...
&Scoped-define FIELDS-IN-QUERY-br_table oe-ordl.i-no oe-ordl.job-no ~
oe-ordl.job-no2 oe-ordl.qty 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH oe-ordl OF oe-ord WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = asi.oe-ordl.i-no
     _FldNameList[2]   = asi.oe-ordl.job-no
     _FldNameList[3]   = asi.oe-ordl.job-no2
