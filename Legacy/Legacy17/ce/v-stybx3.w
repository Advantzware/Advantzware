...
DEFINE FRAME F-Main
     ...
     box-design-hdr.description AT ROW 1.24 COL 20 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 38 BY 1
     box-design-hdr.box-3d-image AT ROW 1.24 COL 76 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 67 BY 1
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  IF AVAIL box-design-hdr AND box-design-hdr.box-3d-image <> "" THEN
     OS-COMMAND SILENT VALUE("custom\mspaint.exe " + box-design-hdr.box-3d-image:SCREEN-VALUE IN FRAME {&FRAME-NAME} ).
