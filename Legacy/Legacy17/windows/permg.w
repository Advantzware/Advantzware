...
DEFINE VARIABLE h_permg AS HANDLE NO-UNDO.
DEFINE VARIABLE h_permg-2 AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Group Maintenance */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Group Maintenance */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Browse Group|View Group' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'browsers/permg.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_permg ).
       RUN set-position IN h_permg ( 4.81 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 19.52 , 145.00 ) */

       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('2') NO-ERROR.

       /* Links to SmartNavBrowser h_permg. */
       RUN add-link IN adm-broker-hdl ( h_p-navico , 'Navigation':U , h_permg ).

    END. /* Page 1 */

    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'viewers/permg.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = Yes':U ,
             OUTPUT h_permg-2 ).
       RUN set-position IN h_permg-2 ( 5.29 , 4.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_permg-2. */
       RUN add-link IN adm-broker-hdl ( h_p-updsav , 'TableIO':U , h_permg-2 ).
       RUN add-link IN adm-broker-hdl ( h_permg , 'Record':U , h_permg-2 ).
