  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'View Style|Formulas|Routing|Box Design|Box 3D Image' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( /*h_stylec-2*/ THIS-PROCEDURE , 'Record':U , h_q-styflt ).
    ...
    WHEN 3 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( /*h_stylec-2*/ h_q-styflt  , 'Record':U , h_routmtx2 ).
