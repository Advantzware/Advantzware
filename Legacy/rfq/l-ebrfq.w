...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-1 Dialog-Frame _STRUCTURED
  QUERY BROWSE-1 NO-LOCK DISPLAY
      eb.est-no FORMAT "x(5)":U COLUMN-FONT 2
...
"eb.est-no" ? ? "character" ? ? 2 ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > ASI.eb.cust-no
"eb.cust-no" ? ? "character" ? ? 2 ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[3]   > ASI.eb.part-dscr1
"eb.part-dscr1" ? ? "character" ? ? 2 ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[4]   > ASI.eb.part-no
"eb.part-no" ? ? "character" ? ? 2 ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[5]   > ASI.eb.stock-no
"eb.stock-no" "FG Item#" ? "character" ? ? 2 ? ? ? no ? no no ? yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE BROWSE-1 */
&ANALYZE-RESUME
