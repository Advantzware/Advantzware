...
do on error undo:
      ...
      tmpstore = style.formula[7].
         {sys/inc/kstyle.i &for=7 &l=xitem.len &w=xitem.wid &d=xitem.dep
            &k=xitem.k-wid &t=xitem.tuck &g=xitem.gluelap &b=xitem.fpanel
            &f=xitem.dust  &o=xitem.lock }

      tmpstore = style.formula[8].
         {sys/inc/kstyle.i &for=8 &l=xitem.len &w=xitem.wid &d=xitem.dep
            &k=xitem.k-len &t=xitem.tuck &g=xitem.gluelap &b=xitem.fpanel
            &f=xitem.dust  &o=xitem.lock }

      tmpstore = style.formula[9].
         {sys/inc/kstyle.i &for=9 &l=xitem.len &w=xitem.wid &d=xitem.dep
            &k=xitem.k-wid &t=xitem.tuck &g=xitem.gluelap &b=xitem.fpanel
            &f=xitem.dust  &o=xitem.lock }

      tmpstore = style.formula[10].
         {sys/inc/kstyle.i &for=10 &l=xitem.len &w=xitem.wid &d=xitem.dep
            &k=xitem.k-len &t=xitem.tuck &g=xitem.gluelap &b=xitem.fpanel
            &f=xitem.dust  &o=xitem.lock }

      tmpstore = style.formula[11].
         {sys/inc/kstyle.i &for=11 &l=xitem.len &w=xitem.wid &d=xitem.dep
            &k=xitem.k-wid &t=xitem.tuck &g=xitem.gluelap &b=xitem.fpanel
            &f=xitem.dust  &o=xitem.lock }

      tmpstore = style.formula[12].
         {sys/inc/kstyle.i &for=12 &l=xitem.len &w=xitem.wid &d=xitem.dep
            &k=xitem.k-wid &t=xitem.tuck &g=xitem.gluelap &b=xitem.fpanel
            &f=xitem.dust  &o=xitem.lock }
