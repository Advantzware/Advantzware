/* brsleave.i - trigger code for ROW-LEAVE trigger of SmartBrowse
   YSK 03/16/01  changed for return key in update mode */
...
DEFINE VARIABLE widget-parent AS HANDLE NO-UNDO.
  ...
  THEN DO:                                 /* If not a SmartPanel then do upd */
     ...
     /*   ===== commented to act like add YSK 03/16/01
      ...
      IF /*{&BROWSE-NAME}:CURRENT-ROW-MODIFIED  OR   YSK ===== */
         adm-brs-in-update or  /* === ysk==== */
