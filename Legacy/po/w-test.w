...
&Scoped-Define ENABLED-OBJECTS Btn_OK Btn_Cancel Btn_Help FILL-IN-1 
...
DEFINE FRAME D-Dialog
     ...
     FILL-IN-1 AT ROW 6.71 COL 13 COLON-ALIGNED
     SPACE(36.13) SKIP(4.57)
...
ASSIGN 
       FILL-IN-1:HIDDEN IN FRAME D-Dialog           = TRUE.
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-1 
      WITH FRAME D-Dialog.
  ENABLE Btn_OK Btn_Cancel Btn_Help FILL-IN-1 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
