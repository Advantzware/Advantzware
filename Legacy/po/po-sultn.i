/* ----------------------------------------------- po/po-sultn.i GDM 06030906  */
/* Purchase Order Print Program for N-K-1-POPRINT = ACPI                      */
/* -------------------------------------------------------------------------- */

PUT
    "<FArial>"   SKIP
    "<P14><C+39> <B>Purchase Order</B> <P10>" v-change-ord SKIP
    "<C3><R3><#1><R+50><C+37>" "<IMAGE#1=" ls-full-img1    SKIP      
    "<P10><=1><C3><R8>"
           v-comp-add1 SKIP. 
...
PUT "<FArial><=5><C7>Quantity                                                                                                                    Job#"
    "<=5><R+1> Line     Over/Under%     UOM  Our Item#/Cust part#/Desc/Vendor Item#      Adder         Machine        Cost     UOM  Ext Cost" SKIP(1).
