...
{sys/inc/varasgn.i}
&SCOPED-DEFINE browse2 po/j-po-ord.i
...
&Scoped-define FIELDS-IN-QUERY-Browser-Table po-ord.po-no po-ord.vend-no ~
po-ordl.i-no po-ordl.job-no po-ordl.job-no2 po-ordl.s-num po-ord.buyer ~
po-ord.due-date po-ord.printed po-ord.stat 
&Scoped-define ENABLED-FIELDS-IN-QUERY-Browser-Table 
&Scoped-define QUERY-STRING-Browser-Table FOR EACH po-ord WHERE ~{&KEY-PHRASE} ~
      AND po-ord.company = g_company NO-LOCK, ~
      EACH po-ordl WHERE po-ordl.company eq po-ord.company and ~
po-ordl.po-no eq po-ord.po-no OUTER-JOIN NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Browser-Table OPEN QUERY Browser-Table FOR EACH po-ord WHERE ~{&KEY-PHRASE} ~
      AND po-ord.company = g_company NO-LOCK, ~
      EACH po-ordl WHERE po-ordl.company eq po-ord.company and ~
po-ordl.po-no eq po-ord.po-no OUTER-JOIN NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Browser-Table po-ord po-ordl
&Scoped-define FIRST-TABLE-IN-QUERY-Browser-Table po-ord
&Scoped-define SECOND-TABLE-IN-QUERY-Browser-Table po-ordl
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      ...
      po-ord.buyer FORMAT "x(10)":U
      po-ord.due-date FORMAT "99/99/9999":U
      po-ord.printed FORMAT "Y/N":U
      po-ord.stat FORMAT "x":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE Browser-Table
     ...
     _Where[1]         = "ASI.po-ord.company = g_company"
...
"po-ordl.job-no2" "" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > ASI.po-ordl.s-num
"po-ordl.s-num" "Form#" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   = ASI.po-ord.buyer
     _FldNameList[8]   = ASI.po-ord.due-date
     _FldNameList[9]   = ASI.po-ord.printed
     _FldNameList[10]   = ASI.po-ord.stat
...
------------------------------------------------------------------------------*/
  ...
  FIND b-po-ordl WHERE ROWID(b-po-ordl) EQ ip-rowid NO-LOCK NO-ERROR.
