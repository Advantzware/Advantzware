/* po/po-cscga.i */  
  PUT
      ...
      PUT "<|3><R28><C1><#5><FROM><R30><C80><RECT>" SKIP    
          ...
          "<R28><C41.5><FROM><R30><C41.5><LINE>" SKIP  /*48*/
          "<R28><C55><FROM><R30><C55><LINE>" SKIP
          "<R28><C62><FROM><R30><C62><LINE>" SKIP
          "<R28><C68><FROM><R30><C68><LINE>" 
          "<R28><C72.5><FROM><R30><C72.5><LINE>" SKIP.

      PUT "<FArial><=5>                 Quantity".
      PUT "<=5><R+1> Line       Over/Under     UOM    Our Item/Description/Vendor Item           Adder                  Job#          Cost     UOM      Ext Cost" SKIP(1).
      PUT "<FCourier New>"          .
