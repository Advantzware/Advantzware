...
END. /* If a finished good */
/* This is to make call to Outbound API for adding purchase order line*/
RUN pCallAPIOutbound (
    ROWID(po-ord) /* Purchase Order ROWID */
    ).
APPLY "go" TO FRAME {&frame-name}.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pCallAPIOutbound Dialog-Frame 
