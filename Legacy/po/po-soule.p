...
print-po-blok:
 FOR EACH report WHERE report.term-id EQ v-term-id NO-LOCK,
     ...
     IF ip-multi-faxout AND 
        FIRST-OF(po-ord.vend-no) THEN DO:
     ...
     FOR EACH po-ordl WHERE
      ...
      IF po-ordl.dscr[1] NE "" OR 
        ...
        THEN DO:
          ...
          PUT po-ordl.dscr[1] FORMAT "x(52)" AT 7 
              " "
              v-adder[3]  
             SKIP.
      ...
      IF po-ordl.dscr[2] NE "" THEN DO:
        ...
        PUT po-ordl.dscr[2] FORMAT "x(52)" AT 7              
            " "
            v-adder[4] 
           SKIP.
      ...
      IF AVAIL itemfg THEN DO:                        
        ...
        IF TRIM(itemfg.part-dscr3) <> "" THEN DO:
          ...
          PUT itemfg.part-dscr3  AT 7 SKIP.
...
/*                                                   */
/*           PUT po-ordl.vend-i-no AT 7 SKIP.        */
/*           ASSIGN                                  */
/*           v-line-number = v-line-number + 1       */
/*           v-printline = v-printline + 1.          */
/*                                                   */
/*         END.                                      */
      ...
      IF v-vend-item <> "" THEN DO:
        ...
        PUT /*trim(po-ord.vend) AT 25 */ 
            "Item#: "   AT 7  
            v-vend-item       FORMAT  "x(15)" 
           SKIP.
      ...
      IF v-print-sn THEN DO:          
        ...
        IF lv-item-rec <> "" THEN
           RUN get-notes(lv-item-rec, "PO",2).
