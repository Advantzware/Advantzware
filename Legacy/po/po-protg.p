...
find first company where company.company eq cocode NO-LOCK. 
 ...
 v-tot-sqft = 0.
    ...
    FOR EACH report WHERE report.term-id EQ v-term-id NO-LOCK,
      ...
      IF v-po-type = "Drop Ship" THEN DO:
          FIND FIRST buf-vend WHERE 
                buf-vend.company = po-ord.company
                AND buf-vend.vend-no = po-ord.ship-id NO-LOCK NO-ERROR.
            IF AVAIL buf-vend THEN v-szip = buf-vend.postal.
      END.
      ...
      for each po-ordl WHERE
       ...
       IF AVAIL e-item THEN
        ...
        PUT po-ordl.LINE FORM ">>9"
            ...
            SPACE(1)
            v-job-no FORM "x(12)" AT 62 /*SPACE(1)*/
        ...
        /* gdm - 11040905 */
        /*IF TRIM(v-lstloc) NE "" OR po-ordl.dscr[1] NE "" THEN DO:*/
   ...
   assign
     ...
     DO i = 1 TO EXTENT(v-inst):
        ...
        if v-inst-lines gt 0 then do:
           ...
           PUT "<R-1>_______________________________________________________________________________________________"
           SKIP(1).
