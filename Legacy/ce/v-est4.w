...
{Advantzware\WinKit\admViewersUsing.i} /* added by script _admViewers.p on 04.07.2017 @  2:08:09 pm */
...
DEFINE FRAME F-Main
     ...
     ef.mis-snum[1] AT ROW 2.43 COL 2 NO-LABEL FORMAT ">>>"
          VIEW-AS FILL-IN 
          SIZE 7 BY 1
...
/* SETTINGS FOR FILL-IN fi_spec-qty-08 IN FRAME F-Main
   NO-ENABLE 2                                                          */
/* SETTINGS FOR FILL-IN ef.mis-bnum[1] IN FRAME F-Main
   EXP-FORMAT                                                           */
/* SETTINGS FOR FILL-IN ef.mis-bnum[2] IN FRAME F-Main
   EXP-FORMAT                                                           */
/* SETTINGS FOR FILL-IN ef.mis-bnum[3] IN FRAME F-Main
   EXP-FORMAT                                                           */
/* SETTINGS FOR FILL-IN ef.mis-bnum[4] IN FRAME F-Main
   EXP-FORMAT                                                           */
/* SETTINGS FOR FILL-IN ef.mis-bnum[5] IN FRAME F-Main
   EXP-FORMAT                                                           */
/* SETTINGS FOR FILL-IN ef.mis-bnum[6] IN FRAME F-Main
   EXP-FORMAT                                                           */
...
DO:
    ...
    case focus:name:
         when "spec-no" then do:
              run windows/l-item.w (ef.company, "1", "M", focus:screen-value, output char-val).
              if char-val <> "" then do:
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
DEF INPUT PARAMETER v-int AS INT NO-UNDO .
