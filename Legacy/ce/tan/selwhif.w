...
&Scoped-Define ENABLED-OBJECTS v-do-gsa Btn_OK Btn_Cancel RECT-23 
&Scoped-Define DISPLAYED-OBJECTS v-do-gsa 
...
DEFINE FRAME D-Dialog
     v-do-gsa AT ROW 2.43 COL 19
     Btn_OK AT ROW 5.52 COL 16
     Btn_Cancel AT ROW 5.52 COL 51
     RECT-23 AT ROW 1 COL 1
     "Selection" VIEW-AS TEXT
          SIZE 12 BY 1 AT ROW 1.24 COL 7
          FONT 6
     SPACE(60.99) SKIP(5.46)
...
------------------------------------------------------------------------------*/
  DISPLAY v-do-gsa 
      WITH FRAME D-Dialog.
  ENABLE v-do-gsa Btn_OK Btn_Cancel RECT-23 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
