...
for each est-prep                     
  ...
  if first-of(est-prep.est-no) AND NOT gEstSummaryOnly THEN 
  ...
  for each blk where blk.snum eq est-prep.s-num:
   ...
   assign
    ...
    xprep.amount = prep-tot
    xprep.mat = v-orig-prep-mat
    xprep.lab = v-orig-prep-lab
    .
