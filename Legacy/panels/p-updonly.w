...
/* ***************************  Main Block  *************************** */
  ...
  {methods/setButton.i Btn-Copy "Copy"} /* added by script _admTransPanels.p on 03.28.2017 @ 10:44:52 am */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE start-update C-WIn 
PROCEDURE start-update :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
