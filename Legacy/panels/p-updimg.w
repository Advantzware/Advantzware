...
&Scoped-Define ENABLED-OBJECTS Btn-Save Btn-Cancel btn-img btn-refresh 
...
DEFINE FRAME Panel-Frame
     ...
     btn-img AT ROW 1.24 COL 21
     btn-refresh AT ROW 1.24 COL 33
...
&Scoped-define SELF-NAME btn-img
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn-img C-WIn
ON CHOOSE OF btn-img IN FRAME Panel-Frame /* Image Update */
DO:
...
ON CHOOSE OF btn-refresh IN FRAME Panel-Frame /* Image Refresh */
DO:
     DEF VAR char-hdl AS cha NO-UNDO.
