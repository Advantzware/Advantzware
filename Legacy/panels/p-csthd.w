...
DEF VAR v-cust-x AS LOG NO-UNDO.
...
DO:
  ...
  /* Added by WinKit Migration tool 07.02.2016 23:08:34 */
     ...
     DO WITH FRAME Panel-Frame:
        ...
        DO:
           ...
           IF VALID-HANDLE(WIDGET-HANDLE(char-hdl)) THEN DO:
              RUN get-cust-no IN WIDGET-HANDLE(char-hdl) (OUTPUT v-cust-no,
                                                          OUTPUT v-cust-x).

             IF v-cust-x OR v-cust-no EQ "REMITO" THEN
              DO:
