...
DO:
  ...
  {methods/setButton.i Btn-Save "Save"} /* added by script _admTransPanels.p on 03.28.2017 @ 10:44:52 am */
...
DO:
  DO WITH FRAME Panel-Frame:
      ...
      {methods/setButton.i Btn-Save "Update"} /* added by script _admTransPanels.p on 03.28.2017 @ 10:44:52 am */
   END.
  {Advantzware/WinKit/winkit-panel-triggerend.i} /* added by script _admPanels.p on 03.28.2017 @ 10:44:45 am */
END.
...
/*    v-source-handle = WIDGET-HANDLE(char-hdl).                                               */
/*    IF INDEX(v-source-handle:NAME, "scanlbl") GT 0  THEN                                     */
/*      v-post-sec = YES.                                                                      */
  ...
  {methods/setButton.i Btn-Save "Update"} /* added by script _admTransPanels.p on 03.28.2017 @ 10:44:52 am */
  {methods/setButton.i Btn-Add "Add"} /* added by script _admTransPanels.p on 03.28.2017 @ 10:44:52 am */
  {methods/setButton.i Btn-Delete "Delete"} /* added by script _admTransPanels.p on 03.28.2017 @ 10:44:52 am */
  {methods/setButton.i Btn-Cancel "Cancel"} /* added by script _admTransPanels.p on 03.28.2017 @ 10:44:52 am */
...
&ENDIF
&IF LOOKUP("btn-post":U, "{&ENABLED-OBJECTS}":U," ":U) NE 0 &THEN
             btn-post:SENSITIVE = NO.
&ENDIF
...
&ENDIF
  ...
  END. /* panel-state = action-chosen */
   ...
   END.
  /*{custom/secpanel.i}*/
    IF NOT v-post-sec THEN Btn-post:SENSITIVE = NO.
END. /* DO WITH FRAME */
