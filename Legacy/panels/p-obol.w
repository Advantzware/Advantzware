...
&Scoped-Define ENABLED-OBJECTS btn-bol 
...
ON CHOOSE OF btn-bol IN FRAME Panel-Frame /* BOL/INV */
DO:
...
/*
RUN get-link-handle IN adm-broker-hdl (THIS-PROCEDURE, 'ordbol-TARGET':U, OUTPUT char-hdl).
