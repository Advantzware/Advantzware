...
Btn-Delete Btn-Cancel btn-selbin 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn-selbin C-WIn
ON CHOOSE OF btn-selbin IN FRAME Panel-Frame /* Select bins/tags */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE cancel-line C-WIn 
...
&ENDIF
&IF LOOKUP("btn-selbin":U, "{&ENABLED-OBJECTS}":U," ":U) NE 0 &THEN
             btn-selbin:SENSITIVE = NO.
&ENDIF
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE update-line C-WIn 
