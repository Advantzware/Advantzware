...
&Scoped-Define ENABLED-OBJECTS Btn-Save btn-refresh 
...
DEFINE FRAME Panel-Frame
     ...
     btn-refresh AT ROW 1.24 COL 12
...
ON CHOOSE OF btn-refresh IN FRAME Panel-Frame /* Refresh */
DO:
...
ON CHOOSE OF Btn-Save IN FRAME Panel-Frame /* Image Update */
DO:
    /*
...
DO WITH FRAME panel-frame: 
  Btn-Save:LABEL = /*label-string*/ "&Image Update".
END.
END PROCEDURE.
