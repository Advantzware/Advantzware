...
&Scoped-Define ENABLED-OBJECTS btnHTML 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btnHTML s-object
ON CHOOSE OF btnHTML IN FRAME F-Main /* HTML */
DO:
    {methods/run_link.i "CONTAINER-SOURCE" "capacityPage"}
END.
