...
DEFINE FRAME F-Main
     btn-img AT ROW 1.24 COL 2
     btn-refresh AT ROW 1.24 COL 18
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn-img V-table-Win
ON CHOOSE OF btn-img IN FRAME F-Main /* Image Update */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn-refresh V-table-Win
ON CHOOSE OF btn-refresh IN FRAME F-Main /* Image Refresh */
DO:
     DEF VAR char-hdl AS cha NO-UNDO.
