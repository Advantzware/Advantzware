...
Btn-Delete Btn-Cancel btn-alloc btn-sht-calc 
...
DEFINE FRAME Panel-Frame
     ...
     btn-alloc AT ROW 1.24 COL 56
     btn-sht-calc AT ROW 1.24 COL 72
...
DO:
    ...
    IF valid-handle(WIDGET-HANDLE(char-hdl)) THEN do:
      ...
      RUN run-alloc IN WIDGET-HANDLE(char-hdl) (YES) NO-ERROR.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE choose-copy C-WIn 
PROCEDURE choose-copy :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
&ENDIF
             ...
             ASSIGN btn-alloc:SENSITIVE = YES
                    btn-sht-calc:SENSITIVE = YES.
