...
ON CHOOSE OF Btn-run IN FRAME Panel-Frame /* Excute */
DO:
...
/* ***************************  Main Block  *************************** */
  ...
  {methods/setButton.i Btn-Copy "Copy"} /* added by script _admTransPanels.p on 03.28.2017 @ 10:44:50 am */
...
IF VALID-HANDLE(WIDGET-HANDLE(char-hdl)) THEN
  RUN is-this-saletool IN WIDGET-HANDLE(char-hdl) (OUTPUT ll-saletool).
