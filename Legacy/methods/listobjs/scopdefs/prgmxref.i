...
&{&DEFINETYPE}-define TABLENAME prgmxref
&{&DEFINETYPE}-define DBFIELD1 prgmxref.table_name
&{&DEFINETYPE}-define BEGINFLD1 begin_table_name
&{&DEFINETYPE}-define BEGIN-DEFAULT-1 yes
&{&DEFINETYPE}-define ENDFLD1 end_table_name
...
&{&DEFINETYPE}-define LISTORDER Table Name
...
&{&DEFINETYPE}-define SAVENAME prgmxref
