...
&{&DEFINETYPE}-define TABLENAME routing
&{&DEFINETYPE}-define DBFIELD1 routing.r-code
&{&DEFINETYPE}-define BEGINFLD1 begin_r-code
&{&DEFINETYPE}-define BEGIN-DEFAULT-1 yes
&{&DEFINETYPE}-define ENDFLD1 end_r-code
...
&{&DEFINETYPE}-define LISTORDER Routing Code
...
&{&DEFINETYPE}-define SAVENAME routing
