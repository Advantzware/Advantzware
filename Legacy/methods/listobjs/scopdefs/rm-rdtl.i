...
&{&DEFINETYPE}-define TABLENAME rm-rdtl
&{&DEFINETYPE}-define DATATYP1 INTEGER
&{&DEFINETYPE}-define DBFIELD1 rm-rdtl.r-no
&{&DEFINETYPE}-define BEGINFLD1 begin_r-no
&{&DEFINETYPE}-define BEGIN-DEFAULT-1 yes
&{&DEFINETYPE}-define ENDFLD1 end_r-no
...
&{&DEFINETYPE}-define SAVENAME rm-rdtl
