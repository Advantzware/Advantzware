...
&{&DEFINETYPE}-define BEGINFLD2 begin_procat
&{&DEFINETYPE}-define BEGIN-DEFAULT-2 yes
&{&DEFINETYPE}-define ENDFLD2 end_procat
&{&DEFINETYPE}-define END-DEFAULT-2 yes
&{&DEFINETYPE}-define DATATYP3 DATE
&{&DEFINETYPE}-define DBFIELD3 item.beg-date
&{&DEFINETYPE}-define BEGINFLD3 begin_date
&{&DEFINETYPE}-define BEGIN-DEFAULT-3 yes
&{&DEFINETYPE}-define ENDFLD3 end_date
&{&DEFINETYPE}-define END-DEFAULT-3 yes
&{&DEFINETYPE}-define DBFIELD4 item.loc
&{&DEFINETYPE}-define BEGINFLD4 begin_whse
&{&DEFINETYPE}-define BEGIN-DEFAULT-4 yes
&{&DEFINETYPE}-define ENDFLD4 end_whse
...
&{&DEFINETYPE}-define LISTORDER Item No,Category,Beg Bal Date,Primary Warehouse
...
&{&DEFINETYPE}-define SAVENAME rm-trans
