...
&{&DEFINETYPE}-define TABLENAME users
&{&DEFINETYPE}-define DBFIELD1 users.user_id
&{&DEFINETYPE}-define BEGINFLD1 begin_user_id
&{&DEFINETYPE}-define BEGIN-DEFAULT-1 yes
&{&DEFINETYPE}-define ENDFLD1 end_user_id
&{&DEFINETYPE}-define END-DEFAULT-1 yes
&{&DEFINETYPE}-define DBFIELD2 users.user_name
&{&DEFINETYPE}-define BEGINFLD2 begin_users_user_name
&{&DEFINETYPE}-define BEGIN-DEFAULT-2 yes
&{&DEFINETYPE}-define ENDFLD2 end_users_user_name
...
&{&DEFINETYPE}-define LISTORDER User ID's,User Name
...
&{&DEFINETYPE}-define SAVENAME users
