...
"description"
"Description"
"begin_statecod_description"
"yes"
"end_statecod_description"
"yes"
?
""
""
...
&{&DEFINETYPE}-define TABLENAME statecod
&{&DEFINETYPE}-define DBFIELD1 statecod.statecod
&{&DEFINETYPE}-define BEGINFLD1 begin_statecod
&{&DEFINETYPE}-define BEGIN-DEFAULT-1 yes
&{&DEFINETYPE}-define ENDFLD1 end_statecod
&{&DEFINETYPE}-define END-DEFAULT-1 yes
&{&DEFINETYPE}-define DBFIELD2 statecod.description
&{&DEFINETYPE}-define BEGINFLD2 begin_statecod_description
&{&DEFINETYPE}-define BEGIN-DEFAULT-2 yes
&{&DEFINETYPE}-define ENDFLD2 end_statecod_description
...
&{&DEFINETYPE}-define LISTORDER State Abbreviation,Description
...
&{&DEFINETYPE}-define SAVENAME statecod
