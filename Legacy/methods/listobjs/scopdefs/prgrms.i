...
&{&DEFINETYPE}-define TABLENAME prgrms
&{&DEFINETYPE}-define DBFIELD1 prgrms.prgmname
&{&DEFINETYPE}-define BEGINFLD1 begin_prgmname
&{&DEFINETYPE}-define BEGIN-DEFAULT-1 yes
&{&DEFINETYPE}-define ENDFLD1 end_prgmname
&{&DEFINETYPE}-define END-DEFAULT-1 yes
&{&DEFINETYPE}-define DBFIELD2 prgrms.prgtitle
&{&DEFINETYPE}-define BEGINFLD2 begin_prgrms_prgtitle
&{&DEFINETYPE}-define BEGIN-DEFAULT-2 yes
&{&DEFINETYPE}-define ENDFLD2 end_prgrms_prgtitle
...
&{&DEFINETYPE}-define LISTORDER Program,Title
...
&{&DEFINETYPE}-define SAVENAME prgrms
