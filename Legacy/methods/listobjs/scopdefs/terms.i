...
&{&DEFINETYPE}-define TABLENAME terms
&{&DEFINETYPE}-define DBFIELD1 terms.t-code
&{&DEFINETYPE}-define BEGINFLD1 begin_t-code
&{&DEFINETYPE}-define BEGIN-DEFAULT-1 yes
&{&DEFINETYPE}-define ENDFLD1 end_t-code
&{&DEFINETYPE}-define END-DEFAULT-1 yes
&{&DEFINETYPE}-define DBFIELD2 terms.dscr
&{&DEFINETYPE}-define BEGINFLD2 begin_terms_dscr
&{&DEFINETYPE}-define BEGIN-DEFAULT-2 yes
&{&DEFINETYPE}-define ENDFLD2 end_terms_dscr
...
&{&DEFINETYPE}-define LISTORDER Terms,Description
...
&{&DEFINETYPE}-define SAVENAME terms
