...
&{&DEFINETYPE}-define TABLENAME parmfile
&{&DEFINETYPE}-define DBFIELD1 parmfile.parmfile
&{&DEFINETYPE}-define BEGINFLD1 begin_parmfile
&{&DEFINETYPE}-define BEGIN-DEFAULT-1 yes
&{&DEFINETYPE}-define ENDFLD1 end_parmfile
...
&{&DEFINETYPE}-define LISTORDER Parameter File
...
&{&DEFINETYPE}-define SAVENAME parmfile
