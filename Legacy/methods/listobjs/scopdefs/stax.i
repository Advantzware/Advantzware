...
&{&DEFINETYPE}-define TABLENAME stax
&{&DEFINETYPE}-define DBFIELD1 stax.tax-group
&{&DEFINETYPE}-define BEGINFLD1 begin_tax-group
&{&DEFINETYPE}-define BEGIN-DEFAULT-1 yes
&{&DEFINETYPE}-define ENDFLD1 end_tax-group
...
&{&DEFINETYPE}-define SAVENAME stax
