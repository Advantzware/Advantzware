...
"description"
"Description"
"begin_titlcode_description"
"yes"
"end_titlcode_description"
"yes"
?
""
""
...
&{&DEFINETYPE}-define TABLENAME titlcode
&{&DEFINETYPE}-define DBFIELD1 titlcode.titlcode
&{&DEFINETYPE}-define BEGINFLD1 begin_titlcode
&{&DEFINETYPE}-define BEGIN-DEFAULT-1 yes
&{&DEFINETYPE}-define ENDFLD1 end_titlcode
&{&DEFINETYPE}-define END-DEFAULT-1 yes
&{&DEFINETYPE}-define DBFIELD2 titlcode.description
&{&DEFINETYPE}-define BEGINFLD2 begin_titlcode_description
&{&DEFINETYPE}-define BEGIN-DEFAULT-2 yes
&{&DEFINETYPE}-define ENDFLD2 end_titlcode_description
...
&{&DEFINETYPE}-define LISTORDER Title Code,Description
...
&{&DEFINETYPE}-define SAVENAME titlcode
