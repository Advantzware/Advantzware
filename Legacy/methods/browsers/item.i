...
&Global-define FLDNAME1 item.i-no
&Global-define FORMAT-1 X(10)
&Global-define SORTBY-1 BY {&FLDNAME1}
&Global-define IDXNAME1 USE-INDEX industry
&Global-define DESCRIP1 Item No
&Global-define FLDNAME2 item.i-name
&Global-define FORMAT-2 X(30)
&Global-define SORTBY-2 BY {&FLDNAME2} {&SORTBY-1}
&Global-define IDXNAME2 USE-INDEX item
&Global-define DESCRIP2 Name
&Global-define FLDNAME3 item.mat-type
&Global-define FORMAT-3 X
&Global-define SORTBY-3 BY {&FLDNAME3} {&SORTBY-2}
&Global-define IDXNAME3 USE-INDEX mat-type
&Global-define DESCRIP3 Mat'l Type
&Global-define FLDNAME4 item.procat
&Global-define FORMAT-4 X(5)
&Global-define SORTBY-4 BY {&FLDNAME4} {&SORTBY-2}
&Global-define IDXNAME4 USE-INDEX procat
