...
&Global-define FLDNAME1 ftpConfig.partner
&Global-define FORMAT-1 X(5)
&Global-define SORTBY-1 BY ftpConfig.partner 
&Global-define IDXNAME1 
&Global-define DESCRIP1 Partner
&Global-define FLDNAME2 ftpConfig.ediType
&Global-define FORMAT-2 X(6)
&Global-define SORTBY-2 BY ftpConfig.ediType
&Global-define DESCRIP2 EDI Type
&Global-define FLDNAME3 ftpConfig.ftpSite
&Global-define FORMAT-3 X(10)
&Global-define SORTBY-3 BY ftpConfig.ftpSite
&Global-define IDXNAME3 
&Global-define DESCRIP3 Ftp Site
