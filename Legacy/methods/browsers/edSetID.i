...
&Global-define FLDNAME1 edSetID.SetID
&Global-define FORMAT-1 X(5)
&Global-define SORTBY-1 BY edSetID.SetID 
&Global-define IDXNAME1 
&Global-define DESCRIP1 SetID
&Global-define FLDNAME2 edSetID.SetID
&Global-define FORMAT-2 X(6)
&Global-define SORTBY-2 BY edSetID.SetID
&Global-define DESCRIP2 SetID
&Global-define FLDNAME3 edSetID.setIDDescription
&Global-define FORMAT-3 X(20)
&Global-define SORTBY-3 BY edSetID.setIDDescription
&Global-define IDXNAME3 
&Global-define DESCRIP3 SetID Number
