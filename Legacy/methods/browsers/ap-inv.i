...
&Global-define FLDNAME2 ap-inv.inv-no
&Global-define FORMAT-2 X(12)
&Global-define SORTBY-2 BY {&FLDNAME2}
&Global-define IDXNAME2 
&Global-define DESCRIP2 Invoice No.
&Global-define FLDNAME3 ap-inv.posted
&Global-define DATATYP3 LOGICAL
&Global-define FORMAT-3 Y/N
&Global-define SORTBY-3 BY {&FLDNAME3}
&Global-define IDXNAME3 
&Global-define DESCRIP3 Posted
