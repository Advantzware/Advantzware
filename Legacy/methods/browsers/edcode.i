...
&Global-define FLDNAME1 edCode.partner
&Global-define FORMAT-1 X(5)
&Global-define SORTBY-1 BY edCode.partner 
&Global-define IDXNAME1 
&Global-define DESCRIP1 Partner
&Global-define FLDNAME2 edCode.SetId
&Global-define FORMAT-2 X(6)
&Global-define SORTBY-2 BY edCode.SetId 
&Global-define DESCRIP2 Set ID
&Global-define FLDNAME3 edCode.direction
&Global-define FORMAT-3 X
&Global-define SORTBY-3 BY edCode.direction
&Global-define IDXNAME3 
&Global-define DESCRIP3 Direction
