...
&Global-define FLDNAME1 string(edIVaddon.invoice-no)
&Global-define FORMAT-1 X(8)
&Global-define SORTBY-1 BY edIVaddon.invoice-no
&Global-define IDXNAME1 
&Global-define DESCRIP1 Invoice Num
&Global-define FLDNAME2 edIVaddon.partner
&Global-define FORMAT-2 X(10)
&Global-define SORTBY-2 BY edIVaddon.partner
&Global-define IDXNAME2 
&Global-define DESCRIP2 Partner
&Global-define FLDNAME3 STRING(edIVaddon.seq)
&Global-define FORMAT-3 x(8)
&Global-define SORTBY-3 BY edIVaddon.seq
&Global-define IDXNAME3 
&Global-define DESCRIP3 Sequence
