...
&Global-define FLDNAME1 edcatPrice.partner
&Global-define FORMAT-1 X(5)
&Global-define SORTBY-1 BY edcatPrice.partner 
&Global-define IDXNAME1 
&Global-define DESCRIP1 Partner
&Global-define FLDNAME2 edcatPrice.price-code
&Global-define FORMAT-2 X(4)
&Global-define SORTBY-2 BY edcatPrice.price-code
&Global-define DESCRIP2 Price Code
&Global-define FLDNAME3 edcatPrice.trade-class
&Global-define FORMAT-3 X(6)
&Global-define SORTBY-3 BY edcatPrice.trade-class
&Global-define IDXNAME3 
&Global-define DESCRIP3 Trade-Class
