...
&Global-define FLDNAME1 rm-rctd.r-no
...
&Global-define FLDNAME2 rm-rctd.tag
&Global-define FORMAT-2 X(8)
&Global-define SORTBY-2 BY {&FLDNAME2} BY {&FLDNAME1}
&Global-define IDXNAME2 
&Global-define DESCRIP2 Tag
&Global-define FLDNAME3 rm-rctd.rct-date
&Global-define DATATYP3 DATE
&Global-define FORMAT-3 99/99/9999
&Global-define SORTBY-3 BY {&FLDNAME3} BY {&FLDNAME1}
&Global-define IDXNAME3 
&Global-define DESCRIP3 Rcpt Date
&Global-define FLDNAME4 rm-rctd.po-no
&Global-define FORMAT-4 X(9)
&Global-define SORTBY-4 BY {&FLDNAME4} BY {&FLDNAME1}
&Global-define IDXNAME4 
&Global-define DESCRIP4 PO
&Global-define FLDNAME5 rm-rctd.i-no
&Global-define FORMAT-5 X(10)
&Global-define SORTBY-5 BY {&FLDNAME5} BY {&FLDNAME1}
&Global-define IDXNAME5 
&Global-define DESCRIP5 Item
&Global-define FLDNAME6 rm-rctd.loc
&Global-define FORMAT-6 X(5)
&Global-define SORTBY-6 BY {&FLDNAME6} BY {&FLDNAME1}
&Global-define IDXNAME6 
&Global-define DESCRIP6 Warehouse
