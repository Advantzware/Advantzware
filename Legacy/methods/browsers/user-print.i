...
&Global-define FLDNAME1 user-print.batch
&Global-define FORMAT-1 X(20)
&Global-define SORTBY-1 
&Global-define IDXNAME1 
&Global-define DESCRIP1 Batch
&Global-define FLDNAME2 user-print.frequency
&Global-define FORMAT-2 X(2)
&Global-define SORTBY-2 
&Global-define IDXNAME2 
&Global-define DESCRIP2 How Often?
&Global-define FLDNAME3 user-print.prog-title
&Global-define FORMAT-3 X(40)
&Global-define SORTBY-3 
&Global-define IDXNAME3 
&Global-define DESCRIP3 Title
&Global-define FLDNAME4 user-print.user-id
&Global-define FORMAT-4 X(8)
&Global-define SORTBY-4 
&Global-define IDXNAME4 
&Global-define DESCRIP4 User-Id
