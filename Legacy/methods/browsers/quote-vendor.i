...
&Global-define FLDNAME1 quote-vendor.q-no
&Global-define DATATYP1 INTEGER
&Global-define FORMAT-1 >>>>>
&Global-define SORTBY-1 BY quote-vendor.quo-date DESCENDING BY {&fldname1} DESCENDING BY quoteqty.qty
&Global-define IDXNAME1 
&Global-define DESCRIP1 Quote #
&Global-define FLDNAME2 quote-vendor.cust-no
&Global-define FORMAT-2 X(8)
&Global-define SORTBY-2 BY quote-vendor.quo-date DESCENDING BY {&fldname1} DESCENDING BY quoteqty.qty
&Global-define IDXNAME2 
&Global-define DESCRIP2 Cust #
&Global-define FLDNAME3 quote-vendor.quo-date
&Global-define DATATYP3 DATE
&Global-define FORMAT-3 99/99/99
&Global-define SORTBY-3 BY quote-vendor.quo-date DESCENDING BY {&fldname1} DESCENDING BY quoteqty.qty
&Global-define IDXNAME3 
&Global-define DESCRIP3 Quote Date
&Global-define FLDNAME4 quote-vendor.est-no
&Global-define FORMAT-4 X(5)
&Global-define SORTBY-4 BY quote-vendor.quo-date DESCENDING BY {&fldname1} DESCENDING BY quoteqty.qty
&Global-define IDXNAME4 
&Global-define DESCRIP4 Est #
&Global-define FLDNAME5 quote-vendor.rfq
&Global-define FORMAT-5 X(8)
&Global-define SORTBY-5 BY quote-vendor.quo-date DESCENDING BY {&fldname1} DESCENDING BY quoteqty.qty
