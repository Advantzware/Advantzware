...
&Global-define FLDNAME1 ttCons.fTag
&Global-define FORMAT-1 X(23)
&Global-define SORTBY-1 BY {&FLDNAME1}
&Global-define IDXNAME1 
&Global-define DESCRIP1 FROM Tag No
&Global-define FLDNAME2 ttCons.fRfidtag
&Global-define FORMAT-2 X(12)
&Global-define SORTBY-2 BY {&FLDNAME2} {&SORTBY-1}
&Global-define IDXNAME2 
&Global-define DESCRIP2 FROM RFID Tag NO
