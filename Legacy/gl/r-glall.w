...
beg_acct-5 end_acct-5 rd-dest lines-per-page lv-font-no td-show-parm btn-ok ~
...
------------------------------------------------------------------------------*/
  ...
  ENABLE tran-date tb_pre beg_acct-1 end_acct-1 beg_acct-2 end_acct-2 
         ...
         rd-dest lines-per-page lv-font-no td-show-parm btn-ok btn-cancel 
         RECT-11 RECT-6 RECT-7 
      WITH FRAME FRAME-A IN WINDOW C-Win.
