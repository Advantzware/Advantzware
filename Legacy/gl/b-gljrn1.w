...
&SCOPED-DEFINE browse2 gl/j-gljrn.i
...
&Scoped-define FIELDS-IN-QUERY-Browser-Table gl-jrn.journal gl-jrn.tr-date ~
gl-jrn.period gl-jrn.tdeb gl-jrn.tcred gl-jrn.tr-amt gl-jrn.reverse ~
gl-jrn.from-reverse 
...
and gl-jrn.recur eq no NO-LOCK ~
    ~{&SORTBY-PHRASE}
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      ...
      gl-jrn.tr-date COLUMN-LABEL "Date" FORMAT "99/99/9999":U
            WIDTH 14.2
      gl-jrn.period COLUMN-LABEL "Period" FORMAT "99":U WIDTH 8.2
      ...
      gl-jrn.reverse COLUMN-LABEL "" FORMAT "R/":U WIDTH 2
      gl-jrn.from-reverse COLUMN-LABEL "" FORMAT "PR/":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 111 BY 18.1
         FONT 2.
...
"gl-jrn.journal" "Jrnl #" ? "integer" ? ? ? ? ? ? no ? no no "9.2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > ASI.gl-jrn.tr-date
"gl-jrn.tr-date" "Date" ? "date" ? ? ? ? ? ? no ? no no "14.2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > ASI.gl-jrn.period
"gl-jrn.period" "Period" ? "integer" ? ? ? ? ? ? no ? no no "8.2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"gl-jrn.tr-amt" ? ? "decimal" ? ? ? ? ? ? no ? no no "24.2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > ASI.gl-jrn.reverse
"gl-jrn.reverse" "" "R/" "logical" ? ? ? ? ? ? no ? no no "2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > ASI.gl-jrn.from-reverse
"gl-jrn.from-reverse" "" "PR/" "logical" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
