...
&Scoped-Define ENABLED-OBJECTS in-file-name btn-ok btn-cancel RECT-7 
&Scoped-Define DISPLAYED-OBJECTS in-file-name 
...
------------------------------------------------------------------------------*/
  DISPLAY in-file-name 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE in-file-name btn-ok btn-cancel RECT-7 
      WITH FRAME FRAME-A IN WINDOW C-Win.
...
/*  DO:
  ...
  */
  ...
  repeat:
      IMPORT lv-input.
      CREATE tt-act.
      ASSIGN tt-act.act-num = ENTRY(1,lv-input).
  ...
  FOR EACH tt-act:
    ...
    IF AVAIL account THEN DO:
       DO i = 1 TO 13:
          ASSIGN account.bud[i] = tt-act.bud[i].
       END.
