...
&Scoped-Define ENABLED-FIELDS eb.part-no eb.part-dscr1 eb.style eb.procat 
...
&Scoped-Define DISPLAYED-FIELDS eb.part-no eb.part-dscr1 eb.style eb.procat 
...
DEFINE FRAME F-Main
     eb.part-no AT ROW 1.71 COL 19 COLON-ALIGNED
          LABEL "Customer Part #"
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     eb.part-dscr1 AT ROW 1.71 COL 39 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 38 BY 1
     eb.style AT ROW 1.71 COL 90 COLON-ALIGNED
          LABEL "Style"
          VIEW-AS FILL-IN 
          SIZE 6.8 BY 1
     eb.procat AT ROW 1.71 COL 113 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 8 BY 1
