...
DO:
  ...
  IF VALID-HANDLE(WIDGET-HANDLE(char-hdl)) THEN
    run hide-page in widget-handle(char-hdl).
  ...
  CASE adm-current-page: 
    ...
    WHEN 2 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-estc ).
       RUN set-position IN h_p-estc ( 20.52 , 62.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_q-jobest ).
       RUN set-position IN h_q-jobest ( 19.81 , 4.00 ) NO-ERROR.
    ...
    WHEN 3 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-est ).
       RUN set-position IN h_v-est ( 2.91 , 1.80 ) NO-ERROR.
    ...
    WHEN 4 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-layouf ).
       RUN set-position IN h_p-layouf ( 21.71 , 19.00 ) NO-ERROR.
    ...
    WHEN 5 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-inkpak ).
       RUN set-position IN h_p-inkpak ( 21.71 , 25.00 ) NO-ERROR.
    ...
    WHEN 6 THEN DO:
       ...
       RUN set-size IN h_p-estprp ( 8.10 , 15.00 ) NO-ERROR.
    ...
    WHEN 7 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updc&c ).
       RUN set-position IN h_p-updc&c ( 6.95 , 118.00 ) NO-ERROR.
       RUN set-size IN h_p-updc&c ( 12.86 , 26.00 ) NO-ERROR.
    ...
    WHEN 8 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-boxdee ).
       RUN set-position IN h_v-boxdee ( 3.14 , 4.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_pv-grap2 ).
       RUN set-position IN h_pv-grap2 ( 20.52 , 137.00 ) NO-ERROR.
    ...
    WHEN 9 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-probe ).
       RUN set-position IN h_p-probe ( 19.81 , 16.00 ) NO-ERROR.
       RUN set-size IN h_p-probe ( 1.91 , 121.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute AFTER standard behavior.    */
  /* Initial page was blank on start, so changing pages to refresh it */
  RUN select-page (1).
  RUN select-page (3).
  RUN select-page (2).
END PROCEDURE.
