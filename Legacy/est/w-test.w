  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Brws Est|Estimate|Specs|Layout|Inks/Pack|Prep/Route|Misc/Farm|Box Design|Quote|Print' + ',
                     FOLDER-TAB-TYPE = 2':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'cec/b-estlst.w':U ,
             INPUT  FRAME est:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-estlst ).
       RUN set-position IN h_b-estlst ( 4.81 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 19.52 , 145.00 ) */

       /* Links to SmartNavBrowser h_b-estlst. */
       RUN add-link IN adm-broker-hdl ( h_b-estlst , 'Record':U , THIS-PROCEDURE ).

    END. /* Page 1 */

    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'cec/b-test.w':U ,
             INPUT  FRAME est:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-test ).
       RUN set-position IN h_b-test ( 5.05 , 3.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updsav-2 ).
       RUN set-position IN h_p-updsav-2 ( 21.95 , 44.00 ) NO-ERROR.
       RUN set-size IN h_p-updsav-2 ( 2.14 , 56.00 ) NO-ERROR.

       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('1,8') NO-ERROR.

       /* Links to SmartNavBrowser h_b-test. */
       RUN add-link IN adm-broker-hdl ( h_b-estlst , 'Record':U , h_b-test ).
       RUN add-link IN adm-broker-hdl ( h_p-navico , 'Navigation':U , h_b-test ).
    ...
    WHEN 3 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-rfqsiz ).
       RUN set-position IN h_p-rfqsiz ( 22.19 , 41.00 ) NO-ERROR.
    ...
    WHEN 4 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-layout ).
       RUN set-position IN h_p-layout ( 22.67 , 32.00 ) NO-ERROR.
       RUN set-size IN h_p-layout ( 1.91 , 77.00 ) NO-ERROR.
    ...
    WHEN 5 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-inkpak ).
       RUN set-position IN h_p-inkpak ( 22.67 , 45.00 ) NO-ERROR.
       RUN set-size IN h_p-inkpak ( 1.76 , 72.00 ) NO-ERROR.
    ...
    WHEN 6 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_vi-est-4 ).
       RUN set-position IN h_vi-est-4 ( 4.81 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.91 , 146.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = Yes':U ,
             OUTPUT h_b-estprp ).
       RUN set-position IN h_b-estprp ( 7.19 , 6.00 ) NO-ERROR.
       /* Size in UIB:  ( 7.86 , 123.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updsav-3 ).
       RUN set-position IN h_p-updsav-3 ( 7.43 , 134.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = Yes':U ,
             OUTPUT h_b-estop ).
       RUN set-position IN h_b-estop ( 16.00 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 7.14 , 129.00 ) */
       ...
       RUN add-link IN adm-broker-hdl ( h_b-estlst , 'Record':U , h_vi-est-4 ).
    ...
    WHEN 7 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updcan ).
       RUN set-position IN h_p-updcan ( 7.43 , 116.00 ) NO-ERROR.
       RUN set-size IN h_p-updcan ( 6.43 , 19.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-est4. */
       RUN add-link IN adm-broker-hdl ( h_p-updcan , 'TableIO':U , h_v-est4 ).
    ...
    WHEN 8 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-navico ).
       RUN set-position IN h_p-navico ( 22.43 , 19.00 ) NO-ERROR.
       RUN set-size IN h_p-navico ( 1.91 , 29.80 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-estbox ).
       RUN set-position IN h_p-estbox ( 22.43 , 64.00 ) NO-ERROR.
       RUN set-size IN h_p-estbox ( 2.00 , 63.60 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_q-boxdes ).
       RUN set-position IN h_q-boxdes ( 7.43 , 2.00 ) NO-ERROR.
    ...
    WHEN 10 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_probe ).
       RUN set-position IN h_probe ( 7.29 , 3.80 ) NO-ERROR.
       /* Size in UIB:  ( 13.10 , 143.00 ) */
