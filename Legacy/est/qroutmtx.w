...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH routing-mtx OF style WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main routing-mtx
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main routing-mtx
