...
eb.bl-qty eb.yrprice eb.num-wid eb.num-len eb.num-up ef.f-coat ef.f-coat-p ~
ef.f-col ef.f-pass eb.yld-qty eb.cust-% 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-1 ef.f-coat ef.f-coat-p ~
ef.f-col ef.f-pass eb.yld-qty eb.cust-% 
&Scoped-define ENABLED-TABLES-IN-QUERY-BROWSE-1 ef eb
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BROWSE-1 ef
&Scoped-define SECOND-ENABLED-TABLE-IN-QUERY-BROWSE-1 eb
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-1 Dialog-Frame _STRUCTURED
  QUERY BROWSE-1 NO-LOCK DISPLAY
      ...
      eb.bl-qty COLUMN-LABEL "Request!Qty" FORMAT ">>>>>>9":U
      eb.yrprice COLUMN-LABEL "Price" FORMAT "Y/R":U WIDTH 6
      eb.num-wid FORMAT ">9":U WIDTH 9.2
      eb.num-len FORMAT ">9":U
      eb.num-up FORMAT ">>9":U WIDTH 11.2
      ef.f-coat COLUMN-LABEL "Form!Coatings" FORMAT ">9":U
      ef.f-coat-p COLUMN-LABEL "Form!Coating Passes" FORMAT ">9":U
      ef.f-col COLUMN-LABEL "Form!Colors" FORMAT ">9":U
      ef.f-pass COLUMN-LABEL "Form!Passes" FORMAT ">9":U
      eb.yld-qty COLUMN-LABEL "Form!Plate Changes" FORMAT "9":U
      eb.cust-% COLUMN-LABEL "Form!Fountain Changes" FORMAT "9":U
  ENABLE
      ef.f-coat
      ef.f-coat-p
      ef.f-col
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 145 BY 10
...
DEFINE FRAME Dialog-Frame
     ...
     Btn_OK AT ROW 12.43 COL 36
     Btn_Cancel AT ROW 12.43 COL 81
     SPACE(50.59) SKIP(1.04)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Estimate Tandem"
...
"eb.bl-qty" "Request!Qty" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[5]   > ASI.eb.yrprice
"eb.yrprice" "Price" ? "logical" ? ? ? ? ? ? no ? no no "6" yes no no "U" "" ""
     _FldNameList[6]   > ASI.eb.num-wid
"eb.num-wid" ? ? "integer" ? ? ? ? ? ? no ? no no "9.2" yes no no "U" "" ""
     _FldNameList[7]   = ASI.eb.num-len
     _FldNameList[8]   > ASI.eb.num-up
"eb.num-up" ? ? "integer" ? ? ? ? ? ? no ? no no "11.2" yes no no "U" "" ""
     _FldNameList[9]   > ASI.ef.f-coat
"ef.f-coat" "Form!Coatings" ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[10]   > ASI.ef.f-coat-p
"ef.f-coat-p" "Form!Coating Passes" ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[11]   > ASI.ef.f-col
"ef.f-col" "Form!Colors" ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[12]   > ASI.ef.f-pass
"ef.f-pass" "Form!Passes" ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[13]   > ASI.eb.yld-qty
"eb.yld-qty" "Form!Plate Changes" "9" "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[14]   > ASI.eb.cust-%
"eb.cust-%" "Form!Fountain Changes" "9" "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE BROWSE-1 */
&ANALYZE-RESUME
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Estimate Tandem */
DO:
