...
DEFINE VARIABLE iQtyPer1    AS INTEGER   FORMAT "->,>>>,>>9":U INITIAL 0 
    VIEW-AS FILL-IN 
    SIZE 12.6 BY 1
    BGCOLOR 15 FONT 1 NO-UNDO.

DEFINE VARIABLE iQtyPer2    AS INTEGER   FORMAT "->,>>>,>>9":U INITIAL 0 
    VIEW-AS FILL-IN 
    SIZE 12.6 BY 1
    BGCOLOR 15 FONT 1 NO-UNDO.

DEFINE VARIABLE iQtyPer3    AS INTEGER   FORMAT "->,>>>,>>9":U INITIAL 0 
    VIEW-AS FILL-IN 
    SIZE 12.6 BY 1
    BGCOLOR 15 FONT 1 NO-UNDO.

DEFINE VARIABLE iQtyPer4    AS INTEGER   FORMAT "->,>>>,>>9":U INITIAL 0 
    VIEW-AS FILL-IN 
    SIZE 12.6 BY 1
    BGCOLOR 15 FONT 1 NO-UNDO.

DEFINE VARIABLE iQtyPer5    AS INTEGER   FORMAT "->,>>>,>>9":U INITIAL 0 
    VIEW-AS FILL-IN 
    SIZE 12.6 BY 1
    BGCOLOR 15 FONT 1 NO-UNDO.
...
DEFINE FRAME D-Dialog
    ...
    cCostUom AT ROW 5.19 COL 92.8 COLON-ALIGNED WIDGET-ID 240
    ...
    dEaCost1 AT ROW 7.38 COL 49.2 COLON-ALIGNED NO-LABELS WIDGET-ID 266
    iQtyPer1 AT ROW 7.38 COL 62.8 COLON-ALIGNED NO-LABELS WIDGET-ID 276
    ...
    dEaCost2 AT ROW 8.48 COL 49.2 COLON-ALIGNED NO-LABELS WIDGET-ID 268
    iQtyPer2 AT ROW 8.48 COL 62.8 COLON-ALIGNED NO-LABELS WIDGET-ID 280
    ...
    dEaCost3 AT ROW 9.57 COL 49.2 COLON-ALIGNED NO-LABELS WIDGET-ID 270
    iQtyPer3 AT ROW 9.57 COL 62.8 COLON-ALIGNED NO-LABELS WIDGET-ID 282
    ...
    dEaCost4 AT ROW 10.71 COL 49.2 COLON-ALIGNED NO-LABELS WIDGET-ID 272
    iQtyPer4 AT ROW 10.71 COL 62.8 COLON-ALIGNED NO-LABELS WIDGET-ID 284
    ...
    dEaCost5 AT ROW 11.86 COL 49.2 COLON-ALIGNED NO-LABELS WIDGET-ID 274 
    iQtyPer5 AT ROW 11.86 COL 62.8 COLON-ALIGNED NO-LABELS WIDGET-ID 286 
    ...
    SIZE 12 BY 1 AT ROW 6.38 COL 51.4 WIDGET-ID 264
...
DEFINE FRAME D-Dialog
    ...
    SIZE 12 BY 1 AT ROW 6.38 COL 65 WIDGET-ID 278
    ...
    SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
    FGCOLOR 1 FONT 6
    TITLE "New Miscellanceous Product Estimate - Cost Details "
    CANCEL-BUTTON Btn_Cancel.
