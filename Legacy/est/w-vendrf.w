...
DEFINE VARIABLE h_vp-vprmt-3 AS HANDLE NO-UNDO.
...
MESSAGE "here vendrf" VIEW-AS ALERT-BOX.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 2 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'est/vp-vprmt.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_vp-vprmt-3 ).
       RUN set-position IN h_vp-vprmt-3 ( 15.05 , 107.00 ) NO-ERROR.
