  ...
  CASE adm-current-page: 
    ...
    WHEN 2 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updsav-2 ).
       RUN set-position IN h_p-updsav-2 ( 21.95 , 60.00 ) NO-ERROR.
       RUN set-size IN h_p-updsav-2 ( 1.91 , 61.00 ) NO-ERROR.
    ...
    WHEN 5 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-naveb-2 ).
       RUN set-position IN h_v-naveb-2 ( 22.67 , 12.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.43 , 42.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-inkpak ).
       RUN set-position IN h_p-inkpak ( 22.67 , 68.00 ) NO-ERROR.
    ...
    WHEN 7 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updc&c ).
       RUN set-position IN h_p-updc&c ( 8.62 , 117.00 ) NO-ERROR.
       RUN set-size IN h_p-updc&c ( 11.19 , 23.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-navef-2 ).
       RUN set-position IN h_v-navef-2 ( 22.91 , 108.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.43 , 42.00 ) */
    ...
    WHEN 8 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-estbox ).
       RUN set-position IN h_p-estbox ( 23.10 , 44.80 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-box23d ).
       RUN set-position IN h_p-box23d ( 23.10 , 83.20 ) NO-ERROR.
       RUN set-size IN h_p-box23d ( 1.43 , 16.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-bximg2 ).
       RUN set-position IN h_p-bximg2 ( 23.10 , 99.80 ) NO-ERROR.
       RUN set-size IN h_p-bximg2 ( 1.43 , 34.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_pv-grap2 ).
       RUN set-position IN h_pv-grap2 ( 23.10 , 134.80 ) NO-ERROR.
       ...
       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('2,9,3') NO-ERROR.
    ...
    WHEN 9 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_probe ).
       RUN set-position IN h_probe ( 7.43 , 4.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-probe ).
       RUN set-position IN h_p-probe ( 21.48 , 11.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_vp-box ).
       RUN set-position IN h_vp-box ( 21.48 , 127.00 ) NO-ERROR.
