...
DEFINE VARIABLE h_b-multib AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updcan AS HANDLE NO-UNDO.

/* ************************  Frame Definitions  *********************** */

DEFINE FRAME D-Dialog
     SPACE(112.00) SKIP(20.05)
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = Yes':U ,
             OUTPUT h_b-multib ).
       RUN set-position IN h_b-multib ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_b-multib ( 17.14 , 112.00 ) NO-ERROR.
       ...
       /* Links to SmartBrowser h_b-multib. */
       RUN add-link IN adm-broker-hdl ( h_p-updcan , 'TableIO':U , h_b-multib ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'Record':U , h_b-multib ).
