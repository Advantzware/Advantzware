...
DEFINE BUFFER bf2-ef  FOR ef.
DEFINE BUFFER bf-item FOR ITEM.
DEFINE VARIABLE tmp-b-qty     AS DECIMAL   NO-UNDO.
DEFINE VARIABLE tot-b-qty     AS DECIMAL   NO-UNDO.
DEFINE VARIABLE calc-b-uom    AS CHARACTER NO-UNDO.
DEFINE VARIABLE calc-save-qty AS DECIMAL   NO-UNDO.
DEFINE VARIABLE v-vend-no     AS CHARACTER NO-UNDO.
DEFINE VARIABLE ceboard-log   AS LOG       NO-UNDO.
