...
~{&useIndexPhrase} NO-LOCK, ~
      ...
      WHERE quoteitm.part-no BEGINS fi_part-no  ~
and quoteitm.part-dscr1 BEGINS fi_item-decr OUTER-JOIN NO-LOCK ~
    ~{&SORTBY-PHRASE}
...
&SCOPED-DEFINE openQuery ~
  OPEN QUERY {&BROWSE-NAME} ~
    FOR EACH quotehd NO-LOCK ~
        ...
        WHERE quoteitm.part-no BEGINS fi_part-no ~
            AND quoteitm.part-dscr1 BEGINS fi_item-decr {&SORTBY-PHRASE}.
