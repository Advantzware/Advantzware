...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH eb WHERE eb.company = itemfg.company ~
  AND eb.est-no = itemfg.est-no NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "ASI.eb WHERE ASI.itemfg <external> ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _JoinCode[1]      = "ASI.eb.company = ASI.itemfg.company
  AND ASI.eb.est-no = ASI.itemfg.est-no"
