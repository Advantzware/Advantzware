...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Add Prep */
DO:  
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updcan ).
       RUN set-position IN h_p-updcan ( 19.10 , 53.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_p-updcan , 'TableIO':U , h_prep ).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE get-code D-Dialog 
PROCEDURE get-code :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
  DEF INPUT-OUTPUT PARAM io-code2 LIKE io-code1 NO-UNDO.
