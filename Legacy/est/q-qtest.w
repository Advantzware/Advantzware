...
&scoped-define sortby-phrase by quotehd.q-no descending
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH quotehd WHERE of est NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH quotehd WHERE of est NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main quotehd
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main quotehd
...
<FOREIGN-KEYS>
company||y|ASI.quotehd.company
Carrier||y|ASI.quotehd.Carrier
q-no||y|ASI.quotehd.q-no
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "company,Carrier,q-no"':U).
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "company" "quotehd" "company"}
  {src/adm/template/sndkycas.i "Carrier" "quotehd" "Carrier"}
  {src/adm/template/sndkycas.i "q-no" "quotehd" "q-no"}
