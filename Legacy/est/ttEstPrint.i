...
/* ***************************  Definitions  ************************** */
DEFINE {1} TEMP-TABLE ttEstHeader LIKE estCostHeader /*Master Print*/
...
DEFINE {1} TEMP-TABLE ttEstItem LIKE estCostItem
/*    FIELD rec_key AS CHARACTER                        */
/*    FIELD company AS CHARACTER                        */
...
DEFINE {1} TEMP-TABLE ttEstForm LIKE estCostForm
/*    FIELD rec_key AS CHARACTER                                            */
/*    FIELD company AS CHARACTER                                            */
...
DEFINE {1} TEMP-TABLE ttEstMisc LIKE estCostMisc
/*    FIELD rec_key AS CHARACTER                                                                */
/*    FIELD company AS CHARACTER                                                                */
...
/*    FIELD lIsPrep AS LOGICAL                                                                  */
    .
DEFINE {1} TEMP-TABLE ttEstMaterial LIKE estCostMaterial
/*    FIELD rec_key AS CHARACTER                                                    */
/*    FIELD company AS CHARACTER                                                    */
...
DEFINE {1} TEMP-TABLE ttEstOperation LIKE estCostOperation
/*    FIELD rec_key AS CHARACTER                                                                  */
/*    FIELD company AS CHARACTER                                                                  */
...
DEFINE {1} TEMP-TABLE ttEstCostDetail LIKE estCostDetail
/*    FIELD rec_key AS CHARACTER                                      */
...
DEFINE {1} TEMP-TABLE ttEstCostSummary LIKE estCostSummary
/*    FIELD rec_key AS CHARACTER                      */
...
DEFINE {1} TEMP-TABLE ttEstCostCategory LIKE estCostCategory
//    FIELD rec_key AS CHARACTER 
//    FIELD estCostCategoryID AS CHARACTER
//    FIELD estCostGroupID AS CHARACTER 
...
DEFINE {1} TEMP-TABLE ttEstCostGroup LIKE  estCostGroup
//    FIELD rec_key AS CHARACTER 
//    FIELD estCostGroupID AS CHARACTER 
//    FIELD cGroupDescription AS CHARACTER 
//    FIELD cGroupLabel AS CHARACTER 
//    FIELD iSequence AS INTEGER 
//      FIELD estCostGroupLevelID AS INTEGER
    .
    
//DEFINE {1} TEMP-TABLE ttEstCostGroupLevel LIKE estCostGroupLevel 
    .    
