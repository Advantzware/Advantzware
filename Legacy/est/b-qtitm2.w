...
&Scoped-define FIELDS-IN-QUERY-Browser-Table quoteitm.part-no ~
quoteitm.part-dscr1 quoteitm.qty quoteitm.style quoteitm.uom quoteitm.size ~
quoteitm.price 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      quoteitm.part-no COLUMN-LABEL "Cust Part#"
      quoteitm.part-dscr1
      quoteitm.qty
      quoteitm.style COLUMN-LABEL "Style"
      quoteitm.uom
      quoteitm.size
      quoteitm.price
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 123 BY 5
         FONT 2.
...
DEFINE FRAME F-Main
     ...
     browse-order AT ROW 6.24 COL 5 HELP
          "Select Browser Sort Order" NO-LABEL
     auto_find AT ROW 6.24 COL 69 COLON-ALIGNED HELP
          "Enter Auto Find Value"
     Btn_Clear_Find AT ROW 6.24 COL 110 HELP
          "CLEAR AUTO FIND Value"
     RECT-4 AT ROW 6 COL 1
     "By:" VIEW-AS TEXT
          SIZE 4 BY 1 AT ROW 6.24 COL 1
...
"quoteitm.part-no" "Cust Part#" ? "character" ? ? ? ? ? ? no ?
     _FldNameList[2]   = ASI.quoteitm.part-dscr1
     _FldNameList[3]   = ASI.quoteitm.qty
     _FldNameList[4]   > ASI.quoteitm.style
"quoteitm.style" "Style" ? "character" ? ? ? ? ? ? no ?
     _FldNameList[5]   = ASI.quoteitm.uom
     _FldNameList[6]   = ASI.quoteitm.size
     _FldNameList[7]   = ASI.quoteitm.price
...
------------------------------------------------------------------------------*/
  ...
  find last quoteitm use-index q-line where quoteitm.company = quotehd.company
                                        and quoteitm.loc = quotehd.loc
                                        and quoteitm.q-no = quotehd.q-no
                 no-lock no-error.
  li-next-line = if avail quoteitm then quoteitm.line + 1 else 1.
