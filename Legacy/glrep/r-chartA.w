...
&Scoped-Define ENABLED-OBJECTS RECT-6 RECT-7 lv-ornt lines-per-page rd-dest ~
lv-font-no tb_excel tb_runExcel td-show-parm fi_file btn-ok btn-cancel 
&Scoped-Define DISPLAYED-OBJECTS lv-ornt lines-per-page rd-dest lv-font-no ~
...
------------------------------------------------------------------------------*/
  DISPLAY lv-ornt lines-per-page rd-dest lv-font-no lv-font-name tb_excel 
          tb_runExcel td-show-parm fi_file 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE RECT-6 RECT-7 lv-ornt lines-per-page rd-dest lv-font-no tb_excel 
