...
&Scoped-Define ENABLED-OBJECTS begin_cust end_cust begin_acct end_acct ~
begin_pdate end_pdate rd-dest lv-ornt lines-per-page lv-font-no ~
td-show-parm btn-ok btn-cancel RECT-6 RECT-7 
&Scoped-Define DISPLAYED-OBJECTS begin_cust end_cust begin_acct end_acct ~
begin_pdate end_pdate rd-dest lv-ornt lines-per-page lv-font-no ~
...
DEFINE FRAME FRAME-A
     begin_cust AT ROW 3.14 COL 19 COLON-ALIGNED HELP
          "Enter Beginning Customer Number"
     end_cust AT ROW 3.14 COL 64 COLON-ALIGNED HELP
          "Enter Ending Customer Number"
     begin_acct AT ROW 4.33 COL 19 COLON-ALIGNED HELP
          "Enter Beginning Account Number"
     end_acct AT ROW 4.33 COL 64 COLON-ALIGNED HELP
          "Enter Ending Account Number"
     begin_pdate AT ROW 5.52 COL 19 COLON-ALIGNED HELP
          "Enter Ending Posting Date"
     end_pdate AT ROW 5.52 COL 64 COLON-ALIGNED HELP
          "Enter Ending Posting Date"
...
ON END-ERROR OF C-Win /* GL Accounts by Customer */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* GL Accounts by Customer */
DO:
...
ON LEAVE OF begin_pdate IN FRAME FRAME-A /* Beginning Date */
DO:
.
END.
...
------------------------------------------------------------------------------*/
  DISPLAY begin_cust end_cust begin_acct end_acct begin_pdate end_pdate rd-dest 
          lv-ornt lines-per-page lv-font-no lv-font-name td-show-parm 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE begin_cust end_cust begin_acct end_acct begin_pdate end_pdate rd-dest 
