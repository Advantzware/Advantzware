...
end_date tb_by-invdt begin_account end_account rd-dest lv-ornt ~
...
tb_by-invdt begin_account end_account rd-dest lv-ornt ~
...
DEFINE FRAME FRAME-A
     ...
     tb_by-invdt AT ROW 5.86 COL 26.2
     begin_account AT ROW 7.1 COL 24.2 COLON-ALIGNED HELP
          "Enter Beginning General Ledger Account Number" WIDGET-ID 4
     end_account AT ROW 7.1 COL 66 COLON-ALIGNED HELP
          "Enter Ending General Ledger Account Number" WIDGET-ID 6
     sl_avail AT ROW 9.76 COL 4.8 NO-LABEL WIDGET-ID 26
     Btn_Def AT ROW 9.76 COL 40.8 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 56
     sl_selected AT ROW 9.76 COL 60.2 NO-LABEL WIDGET-ID 28
     ...
     rd-dest AT ROW 16.76 COL 7 NO-LABEL
     lv-ornt AT ROW 17 COL 31 NO-LABEL
...
ASSIGN 
       ...
       end_account:PRIVATE-DATA IN FRAME FRAME-A     = 
                "parm".
...
------------------------------------------------------------------------------*/
  DISPLAY begin_vend end_vend begin_date end_date tb_by-invdt  
...
DEF VAR lv-gtotal AS DEC EXTENT 2 NO-UNDO.
            ...
            DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
               cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                    CASE cTmpField:             
                         ...
                         WHEN "dscr"            THEN cVarValue = STRING(ap-invl.dscr,"x(30)").
