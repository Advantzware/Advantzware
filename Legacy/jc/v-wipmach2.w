...
&Scoped-Define ENABLED-OBJECTS RECT-39 RECT-40 
&Scoped-Define DISPLAYED-FIELDS wiptag.tag-no wiptag.rm-i-no ~
wiptag.rm-i-name wiptag-mch.m-code wiptag.fg-i-no wiptag.fg-i-name ~
wiptag.wip-warehouse wiptag.wip-rm-bin wiptag-mch.spare-char-1 ~
wiptag.job-no wiptag.job-no2 wiptag.form-no wiptag.blank-no wiptag.n-out ~
wiptag.num-up wiptag.pallet-count wiptag-mch.produced-qty wiptag.rm-tag-no ~
wiptag.crt-userid wiptag.upd-userid wiptag.spare-char-1 wiptag.crt-date ~
wiptag.upd-date wiptag.tag-date 
...
&Scoped-Define DISPLAYED-OBJECTS fi_m-dscr fi_created-time fi_updated-time ~
fi_tag-time fi_sht-width fi_sht-length fi_mach-completed 
...
DEFINE FRAME F-Main
     ...
     wiptag.rm-i-no AT ROW 1.67 COL 78.2 COLON-ALIGNED WIDGET-ID 142
          VIEW-AS FILL-IN 
          SIZE 25 BY 1 NO-TAB-STOP 
     wiptag.rm-i-name AT ROW 1.67 COL 104 COLON-ALIGNED NO-LABEL WIDGET-ID 140
          VIEW-AS FILL-IN 
          SIZE 34 BY 1 NO-TAB-STOP 
     wiptag-mch.m-code AT ROW 3.14 COL 20 COLON-ALIGNED WIDGET-ID 164
          LABEL "Machine Code"
          VIEW-AS FILL-IN 
          SIZE 12 BY 1
     fi_m-dscr AT ROW 3.14 COL 32.6 COLON-ALIGNED NO-LABEL WIDGET-ID 166 NO-TAB-STOP 
     wiptag.fg-i-no AT ROW 3.14 COL 78.2 COLON-ALIGNED WIDGET-ID 126
          VIEW-AS FILL-IN 
          SIZE 25 BY 1 NO-TAB-STOP 
     wiptag.fg-i-name AT ROW 3.14 COL 104 COLON-ALIGNED NO-LABEL WIDGET-ID 124
          VIEW-AS FILL-IN 
          SIZE 34 BY 1 NO-TAB-STOP 
     wiptag.wip-warehouse AT ROW 5.24 COL 16.8 COLON-ALIGNED WIDGET-ID 160
          LABEL "WIP Whs"
          VIEW-AS FILL-IN 
          SIZE 13.2 BY 1 NO-TAB-STOP 
     wiptag.wip-rm-bin AT ROW 5.24 COL 43.4 COLON-ALIGNED WIDGET-ID 158
          LABEL "WIP Bin"
          VIEW-AS FILL-IN 
          SIZE 14.2 BY 1 NO-TAB-STOP 
     wiptag.rm-whs AT ROW 5.24 COL 74 COLON-ALIGNED WIDGET-ID 144
          LABEL "RM Whs"
          VIEW-AS FILL-IN 
          SIZE 12.8 BY 1
     wiptag.rm-bin AT ROW 5.24 COL 99.8 COLON-ALIGNED WIDGET-ID 138
          VIEW-AS FILL-IN 
          SIZE 14.6 BY 1 NO-TAB-STOP 
     wiptag-mch.spare-char-1 AT ROW 5.24 COL 121.6 COLON-ALIGNED HELP
          "" WIDGET-ID 202
          LABEL "Shift" FORMAT "x(2)"
          VIEW-AS FILL-IN 
          SIZE 10 BY 1 TOOLTIP "Machine production shift"
     wiptag.job-no AT ROW 6.71 COL 16.8 COLON-ALIGNED WIDGET-ID 130
          LABEL "Job #"
          VIEW-AS FILL-IN 
          SIZE 13.2 BY 1 NO-TAB-STOP 
     wiptag.job-no2 AT ROW 6.71 COL 31.6 COLON-ALIGNED NO-LABEL WIDGET-ID 132
          VIEW-AS FILL-IN 
          SIZE 4.4 BY 1 NO-TAB-STOP 
     wiptag.form-no AT ROW 6.71 COL 49.6 COLON-ALIGNED WIDGET-ID 128
          LABEL "Form #"
          VIEW-AS FILL-IN 
          SIZE 5.6 BY 1 NO-TAB-STOP 
     wiptag.blank-no AT ROW 6.71 COL 68 COLON-ALIGNED WIDGET-ID 120
          LABEL "Blank"
          VIEW-AS FILL-IN 
          SIZE 4.4 BY 1 NO-TAB-STOP 
     wiptag.n-out AT ROW 6.71 COL 85.2 COLON-ALIGNED WIDGET-ID 134
          LABEL "# Out"
          VIEW-AS FILL-IN 
          SIZE 4.4 BY 1 NO-TAB-STOP 
     wiptag.num-up AT ROW 6.71 COL 101.2 COLON-ALIGNED WIDGET-ID 136
          VIEW-AS FILL-IN 
          SIZE 5.6 BY 1 NO-TAB-STOP 
     wiptag.pallet-count AT ROW 8.38 COL 26.6 COLON-ALIGNED WIDGET-ID 168
          LABEL "Qty(Pallet Count)"
          VIEW-AS FILL-IN 
          SIZE 14 BY 1 NO-TAB-STOP 
     wiptag-mch.produced-qty AT ROW 8.38 COL 72.2 COLON-ALIGNED WIDGET-ID 200
          VIEW-AS FILL-IN 
          SIZE 28 BY 1 TOOLTIP "The qty produced at the machine."
     wiptag.rm-tag-no AT ROW 9.81 COL 18 COLON-ALIGNED WIDGET-ID 170
          LABEL "RM Tag#"
          VIEW-AS FILL-IN 
          SIZE 31 BY 1 NO-TAB-STOP 
     wiptag.crt-userid AT ROW 9.81 COL 72.2 COLON-ALIGNED WIDGET-ID 122
          LABEL "Created User"
          VIEW-AS FILL-IN 
...
DEFINE FRAME F-Main
     wiptag.upd-userid AT ROW 9.81 COL 112.2 COLON-ALIGNED WIDGET-ID 156
          LABEL "Updated User"
          VIEW-AS FILL-IN 
          SIZE 11.6 BY 1 NO-TAB-STOP 
     wiptag.spare-char-1 AT ROW 11.33 COL 18 COLON-ALIGNED HELP
          "" WIDGET-ID 174
          LABEL "RM Tag#" FORMAT "x(20)"
          VIEW-AS FILL-IN 
          SIZE 31 BY 1 TOOLTIP "2nd RM Tag used."
     wiptag.crt-date AT ROW 11.33 COL 72.2 COLON-ALIGNED WIDGET-ID 172
          LABEL "Created Date"
          VIEW-AS FILL-IN 
          SIZE 16 BY 1 NO-TAB-STOP 
     wiptag.upd-date AT ROW 11.33 COL 112.2 COLON-ALIGNED WIDGET-ID 152
          VIEW-AS FILL-IN 
          SIZE 16 BY 1 NO-TAB-STOP 
     wiptag.tag-date AT ROW 12.86 COL 18 COLON-ALIGNED WIDGET-ID 146
          LABEL "Tag Date"
          VIEW-AS FILL-IN 
          SIZE 16 BY 1 NO-TAB-STOP 
     fi_created-time AT ROW 12.86 COL 72.2 COLON-ALIGNED WIDGET-ID 194 NO-TAB-STOP 
     fi_updated-time AT ROW 12.86 COL 112.2 COLON-ALIGNED WIDGET-ID 198 NO-TAB-STOP 
     fi_tag-time AT ROW 14.48 COL 18 COLON-ALIGNED WIDGET-ID 196 NO-TAB-STOP 
     fi_sht-width AT ROW 14.48 COL 52.8 COLON-ALIGNED WIDGET-ID 190 NO-TAB-STOP 
     fi_sht-length AT ROW 14.48 COL 85 COLON-ALIGNED WIDGET-ID 192 NO-TAB-STOP 
     fi_mach-completed AT ROW 14.48 COL 121.6 COLON-ALIGNED WIDGET-ID 188 NO-TAB-STOP 
     RECT-39 AT ROW 1.24 COL 2 WIDGET-ID 62
     RECT-40 AT ROW 4.81 COL 2 WIDGET-ID 76
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1 SCROLLABLE 
         FONT 6.
