...
cust rd_print begin_slsmn end_slsmn tb_zer-col rd-dest lv-ornt ~
...
rd_print begin_slsmn end_slsmn tb_zer-col rd-dest lv-ornt lines-per-page ~
...
DEFINE FRAME FRAME-A
     ...
     td-show-parm AT ROW 18.91 COL 30
