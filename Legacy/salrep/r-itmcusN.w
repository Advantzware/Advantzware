...
ASSIGN cTextListToSelect = "Customer,Cust Name,Contact Name,Phone,Fax,FG Item,Item Name,Cust PO#," +
                          "Ship To,Ship Date,Invoice#,Order#,UOM,Qty Ordered,Qty Shipped,Price,GP %,SRep1,SName1,SRep2,SName2,SRep3,SName3" 
...
{sys/inc/ttRptSel.i}
ASSIGN cTextListToDefault  = "Customer,Contact Name,Phone,Fax,FG Item,Cust PO#," +
                          "Ship To,Ship Date,Invoice#,Order#,UOM,Qty Ordered,Qty Shipped,Price,GP %"  .
...
begin_cust-no end_cust-no begin_ship end_ship begin_slsmn end_slsmn ~
begin_i-no end_i-no begin_inv-date end_inv-date begin_po end_po rd_cost1 ~
tb_fin-chg tb_skip sl_avail Btn_Def sl_selected Btn_Add Btn_Remove btn_Up ~
...
begin_ship end_ship begin_slsmn end_slsmn begin_i-no end_i-no ~
begin_inv-date end_inv-date begin_po end_po lbl_cost rd_cost1 tb_fin-chg ~
tb_skip sl_avail sl_selected rd-dest lv-ornt lines-per-page lv-font-no ~
...
DEFINE VARIABLE fi_file AS CHARACTER FORMAT "X(30)" INITIAL "c:~\tmp~\r-itmcus.csv" 
...
DEFINE VARIABLE tb_skip AS LOGICAL INITIAL no 
     LABEL "____  Skip Line?" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME FRAME-A
     tb_cust-list AT ROW 1.24 COL 30.4 WIDGET-ID 6
     btnCustList AT ROW 1.29 COL 63.4 WIDGET-ID 8
     begin_cust-no AT ROW 2.38 COL 28 COLON-ALIGNED HELP
          "Enter Beginning Customer Number"
     end_cust-no AT ROW 2.38 COL 69 COLON-ALIGNED HELP
          "Enter Ending Customer Number"
     begin_ship AT ROW 3.33 COL 28 COLON-ALIGNED HELP
          "Enter Beginning Ship-to#"
     end_ship AT ROW 3.33 COL 69 COLON-ALIGNED HELP
          "Enter Ending Zip Code"
     begin_slsmn AT ROW 4.33 COL 28 COLON-ALIGNED HELP
          "Enter Beginning Sales Rep Number" WIDGET-ID 2
     end_slsmn AT ROW 4.33 COL 69 COLON-ALIGNED HELP
          "Enter Ending Sales Rep Number" WIDGET-ID 4
     begin_i-no AT ROW 5.33 COL 28 COLON-ALIGNED HELP
          "Enter Beginning Item Number"
     end_i-no AT ROW 5.33 COL 69 COLON-ALIGNED HELP
          "Enter Ending Customer Number"
     begin_inv-date AT ROW 6.33 COL 28 COLON-ALIGNED HELP
          "Enter Beginning Invoice Date"
     end_inv-date AT ROW 6.33 COL 69 COLON-ALIGNED HELP
          "Enter Ending Invoice Date"
     begin_po AT ROW 7.38 COL 28 COLON-ALIGNED HELP
          "Enter Beginning Po Number"
     end_po AT ROW 7.38 COL 69 COLON-ALIGNED HELP
          "Enter Ending Po#"
     lbl_cost AT ROW 8.67 COL 29 COLON-ALIGNED NO-LABEL
     rd_cost1 AT ROW 8.71 COL 38 NO-LABEL
     tb_fin-chg AT ROW 9.91 COL 31.2
     tb_skip AT ROW 9.91 COL 62.8 WIDGET-ID 58
     sl_avail AT ROW 11.95 COL 4.4 NO-LABEL WIDGET-ID 26
     Btn_Def AT ROW 11.95 COL 40.4 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 56
     sl_selected AT ROW 11.95 COL 59.8 NO-LABEL WIDGET-ID 28
     Btn_Add AT ROW 12.95 COL 40.4 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 32
     Btn_Remove AT ROW 13.95 COL 40.4 HELP
          "Remove Selected Table from Tables to Audit" WIDGET-ID 34
     btn_Up AT ROW 15 COL 40.4 WIDGET-ID 40
     btn_down AT ROW 16 COL 40.4 WIDGET-ID 42
     rd-dest AT ROW 18.24 COL 7 NO-LABEL
     lv-ornt AT ROW 18.38 COL 31 NO-LABEL
     lines-per-page AT ROW 18.38 COL 84 COLON-ALIGNED
     lv-font-no AT ROW 20.29 COL 34 COLON-ALIGNED
     lv-font-name AT ROW 21.24 COL 28 COLON-ALIGNED NO-LABEL
     td-show-parm AT ROW 22.43 COL 30
     tb_excel AT ROW 24.1 COL 50 RIGHT-ALIGNED
     tb_runExcel AT ROW 24.1 COL 71 RIGHT-ALIGNED
     fi_file AT ROW 24.91 COL 28 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 26.71 COL 19
     btn-cancel AT ROW 26.71 COL 57
     "Available Columns" VIEW-AS TEXT
          SIZE 29 BY .62 AT ROW 11.24 COL 5.2 WIDGET-ID 38
     ...
     "Selected Columns(In Display Order)" VIEW-AS TEXT
          SIZE 34 BY .62 AT ROW 11.24 COL 59.8 WIDGET-ID 44
     RECT-6 AT ROW 17.76 COL 2
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Sales Analysis By Cust/Item/PO"
         HEIGHT             = 27.67
         WIDTH              = 96.2
         MAX-HEIGHT         = 33.29
         MAX-WIDTH          = 204.8
...
ASSIGN 
       tb_skip:PRIVATE-DATA IN FRAME FRAME-A     = 
                "parm".
...
ON END-ERROR OF C-Win /* Sales Analysis By Cust/Item/PO */
...
DO:
   apply "close" to this-procedure.
    {Advantzware/WinKit/winkit-panel-triggerend.i} /* added by script _nonAdm1.p on 03.28.2017 @ 10:43:12 am */
END.
...
&Scoped-define SELF-NAME tb_skip
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tb_skip C-Win
ON VALUE-CHANGED OF tb_skip IN FRAME FRAME-A /* ____  Skip Line? */
DO:
  assign {&self-name}.
END.
...
ON CLOSE OF THIS-PROCEDURE DO:
   RUN disable_UI.
   {Advantzware/WinKit/closewindow-nonadm.i} /* added by script _nonAdm1.p on 03.28.2017 @ 10:43:12 am */
END.
...
/* security check need {methods/prgsecur.i} in definition section */
  ...
  RUN sys/inc/CustListForm.p ( "HR11",cocode, 
                               OUTPUT ou-log,
                               OUTPUT ou-cust-int) .
  ...
  ELSE
   ...
   END.
    ...
    {Advantzware/WinKit/embedfinalize-nonadm.i} /* added by script _nonAdm1.p on 03.28.2017 @ 10:43:12 am */
...
------------------------------------------------------------------------------*/
  DISPLAY tb_cust-list begin_cust-no end_cust-no begin_ship end_ship begin_slsmn 
          end_slsmn begin_i-no end_i-no begin_inv-date end_inv-date begin_po 
          end_po lbl_cost rd_cost1 tb_fin-chg tb_skip sl_avail sl_selected 
          rd-dest lv-ornt lines-per-page lv-font-no lv-font-name td-show-parm 
          tb_excel tb_runExcel fi_file 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE RECT-6 RECT-7 tb_cust-list btnCustList begin_cust-no end_cust-no 
         begin_ship end_ship begin_slsmn end_slsmn begin_i-no end_i-no 
         begin_inv-date end_inv-date begin_po end_po rd_cost1 tb_fin-chg 
         tb_skip sl_avail Btn_Def sl_selected Btn_Add Btn_Remove btn_Up 
...
def var fship as ch init "".
def var tship like fcust init "zzzzzzzz".
def var fitem like itemfg.i-no init " ".
def var titem like fitem init "zzzzzzzzzzzzzzzzzzz".
...
DEF VAR f-po AS CHAR init "".
DEF VAR t-po LIKE f-po init "zzzzzzzz".
def var v-inc-fc as log init no.

def var v-date like ar-inv.inv-date.
def var v-ord  like ar-invl.ord-no.
def var v-pric like ar-invl.unit-pr.
def var v-uom  like ar-invl.pr-uom.

def var v-sman-no as   char format "x(3)" no-undo.
def var v-qty     as   int extent 10.
def var v-amt     as   dec extent 5.
def var v-cst     as   dec extent 5.
def var v-exc     as   log.
def var v-hdr     as   char extent 10.

def var v-pct as dec format "99.99" no-undo.
def var v-fac as int no-undo.
def var v-ship like ar-inv.ship-id no-undo.
DEF VAR v-cust LIKE cust.cust-no NO-UNDO.
DEF VAR v-cnam LIKE cust.name NO-UNDO.
DEF VAR v-cont LIKE cust.contact NO-UNDO.
DEF VAR v-phn# LIKE cust.fax NO-UNDO.
DEF VAR v-fax# LIKE cust.fax NO-UNDO.
DEF VAR v-i-no LIKE itemfg.i-no NO-UNDO.
DEF VAR v-inam LIKE itemfg.i-name NO-UNDO.
DEF VAR v-prof AS DEC NO-UNDO.
def var v-cost1 AS CHAR NO-UNDO.
DEF VAR lv-r-no LIKE oe-retl.r-no NO-UNDO.
DEF VAR lv-type AS CHAR NO-UNDO.
DEF VAR v-skip-l AS LOG INIT NO NO-UNDO.
DEF VAR v-sname AS CHAR EXTENT 3 NO-UNDO .
...
FORM "FG Item#:"
    ...
    WITH NO-BOX FRAME itemx NO-LABELS STREAM-IO WIDTH 132.*/

FORM tt-report.key-04       FORMAT "x(15)"
                            COLUMN-LABEL "Cust PO#"
     tt-report.key-05       FORMAT "x(8)"
...
DEF VAR cslist AS cha NO-UNDO.
 FOR EACH ttRptSelected BY ttRptSelected.DisplayOrder:
   ...
   ASSIGN str-tit4 = str-tit4 + 
        ...
        IF LOOKUP(ttRptSelected.TextList, "Qty Ordered,Qty Shipped,GP %") <> 0    THEN
         ASSIGN
...
IF tb_excel THEN DO:
  ...
  /*excelheader = "Cust PO#,Ship To,Ship Date,Invoice#,Order#,UOM,Qty Ordered,"
              + "Qty Shipped,Price,GP %".*/
