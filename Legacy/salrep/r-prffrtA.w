...
end_inv-date lbl_cost rd_cost lbl_sort rd_sort tb_prep tb_fin-chg rd-dest ~
...
DEFINE FRAME FRAME-A
     ...
     lbl_sort AT ROW 8.62 COL 26 COLON-ALIGNED NO-LABEL
     rd_sort AT ROW 8.62 COL 38 NO-LABEL
     tb_prep AT ROW 9.81 COL 38
     tb_fin-chg AT ROW 10.76 COL 38
...
------------------------------------------------------------------------------*/
  DISPLAY begin_cust-no end_cust-no begin_fg-cat end_fg-cat begin_i-no end_i-no 
          ...
          lbl_sort rd_sort tb_prep tb_fin-chg rd-dest lv-ornt lines-per-page 
  ...
  ENABLE RECT-6 RECT-7 begin_cust-no end_cust-no begin_fg-cat end_fg-cat 
         ...
         rd_cost rd_sort tb_prep tb_fin-chg rd-dest lv-ornt lines-per-page 
