...
end_slsmn begin_cust-no end_cust-no begin_date end_date rs-category ~
begin_fg-cat end_fg-cat tg_disp_cents tg_disp_msf rd_sortby tg_disp_tons ~
...
end_fg-cat begin_prolin end_prolin tg_disp_cents tg_disp_msf rd_sortby ~
tg_disp_tons tg_display-zero rd-dest lv-ornt lines-per-page lv-font-no ~
...
DEFINE FRAME FRAME-A
     ...
     begin_cust-no AT ROW 4.24 COL 26 COLON-ALIGNED HELP
          "Enter Beginning Customer Number"
     end_cust-no AT ROW 4.24 COL 67 COLON-ALIGNED HELP
          "Enter Ending Customer Number"
     begin_date AT ROW 5.24 COL 26 COLON-ALIGNED HELP
          "Enter Start Invoice Date"
     end_date AT ROW 5.24 COL 67 COLON-ALIGNED HELP
          "Enter End Invoice Date"
     rs-category AT ROW 6.48 COL 28 NO-LABEL
     begin_fg-cat AT ROW 7.33 COL 26.2 COLON-ALIGNED HELP
          "Enter Beginning Product Category"
     end_fg-cat AT ROW 7.33 COL 67.2 COLON-ALIGNED HELP
          "Enter Ending Product Category"
     begin_prolin AT ROW 8.33 COL 26.2 COLON-ALIGNED HELP
          "Enter Beginning Product Category"
     end_prolin AT ROW 8.33 COL 67.2 COLON-ALIGNED HELP
          "Enter Ending Product Category"
     tg_disp_cents AT ROW 9.48 COL 49.2
     tg_disp_msf AT ROW 10.43 COL 49.2
     rd_sortby AT ROW 10.76 COL 5 NO-LABEL WIDGET-ID 2
     tg_disp_tons AT ROW 11.38 COL 49.2
     tg_display-zero AT ROW 12.24 COL 49.2
     rd-dest AT ROW 14.57 COL 6 NO-LABEL
     lv-ornt AT ROW 15.05 COL 31 NO-LABEL
     lines-per-page AT ROW 15.05 COL 84 COLON-ALIGNED
     lv-font-no AT ROW 16.14 COL 34 COLON-ALIGNED
     lv-font-name AT ROW 17.1 COL 28 COLON-ALIGNED NO-LABEL
     td-show-parm AT ROW 18.76 COL 30
     tb_excel AT ROW 20.05 COL 67.4 RIGHT-ALIGNED
     tb_runExcel AT ROW 20.05 COL 89.4 RIGHT-ALIGNED
     fi_file AT ROW 21.14 COL 45.4 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 22.91 COL 19
     btn-cancel AT ROW 22.91 COL 57
     "Sort By:" VIEW-AS TEXT
          SIZE 24 BY .71 AT ROW 10 COL 5 WIDGET-ID 6
     "(Excel Only)" VIEW-AS TEXT
          SIZE 13.4 BY .62 AT ROW 10.52 COL 68.6
     "Selection Parameters" VIEW-AS TEXT
          SIZE 21 BY .71 AT ROW 1.24 COL 5
          BGCOLOR 2 
     "(Excel Only)" VIEW-AS TEXT
          SIZE 14.4 BY .62 AT ROW 11.43 COL 68.6
...
------------------------------------------------------------------------------*/
   ...
   for EACH cust FIELDS(cust-no sman NAME) where
...
------------------------------------------------------------------------------*/
   ...
   DO v-count = 1 TO v-ytd-period:
      ...
      FOR EACH smanbcst WHERE
          ...
          smanbcst.cust GE begin_cust-no AND
...
------------------------------------------------------------------------------*/
  DISPLAY rs_detail begin_slsmn end_slsmn begin_cust-no end_cust-no begin_date 
          end_date rs-category begin_fg-cat end_fg-cat begin_prolin end_prolin 
          tg_disp_cents tg_disp_msf rd_sortby tg_disp_tons tg_display-zero 
          rd-dest lv-ornt lines-per-page lv-font-no lv-font-name td-show-parm 
          tb_excel tb_runExcel fi_file 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE RECT-6 RECT-7 rs_detail begin_slsmn end_slsmn begin_cust-no 
         end_cust-no begin_date end_date rs-category begin_fg-cat end_fg-cat 
         tg_disp_cents tg_disp_msf rd_sortby tg_disp_tons tg_display-zero 
