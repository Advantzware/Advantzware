...
ASSIGN cTextListToSelect = "Cust#,Cust Name,City,State,Zip Code," + 
...
{sys/inc/ttRptSel.i}
ASSIGN cTextListToDefault  = "Cust#,Cust Name,City,State,Zip Code," + 
                             "Sales $".
...
DEFINE FRAME FRAME-A
     tb_cust-list AT ROW 1.19 COL 30.6 WIDGET-ID 6
     btnCustList AT ROW 1.24 COL 63.6 WIDGET-ID 8
     begin_cust-no AT ROW 2.24 COL 28 COLON-ALIGNED HELP
          "Enter Beginning Customer Number"
     end_cust-no AT ROW 2.24 COL 69 COLON-ALIGNED HELP
          "Enter Ending Customer Number"
     begin_zip AT ROW 3.19 COL 28 COLON-ALIGNED HELP
          "Enter Beginning Zip Code"
     end_zip AT ROW 3.19 COL 69 COLON-ALIGNED HELP
          "Enter Ending Zip Code"
     begin_inv-date AT ROW 4.14 COL 28 COLON-ALIGNED HELP
          "Enter Beginning Invoice Date"
     end_inv-date AT ROW 4.14 COL 69 COLON-ALIGNED HELP
          "Enter Ending Invoice Date"
     begin_sstate AT ROW 5.05 COL 28 COLON-ALIGNED HELP
          "Enter Beginning Customer Number" WIDGET-ID 58
     end_sstate AT ROW 5.1 COL 69 COLON-ALIGNED HELP
          "Enter Ending Customer Number" WIDGET-ID 60
     tb_fin-chg AT ROW 6.33 COL 36.2
     sl_avail AT ROW 8.14 COL 3.8 NO-LABEL WIDGET-ID 26
     sl_selected AT ROW 8.14 COL 60 NO-LABEL WIDGET-ID 28
     Btn_Def AT ROW 8.19 COL 39.2 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 56
     Btn_Add AT ROW 9.14 COL 39.2 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 32
     Btn_Remove AT ROW 10.1 COL 39.2 HELP
          "Remove Selected Table from Tables to Audit" WIDGET-ID 34
     btn_Up AT ROW 11.05 COL 39.2 WIDGET-ID 40
     btn_down AT ROW 12 COL 39.2 WIDGET-ID 42
     rd-dest AT ROW 14.29 COL 6 NO-LABEL
     lv-ornt AT ROW 14.52 COL 31 NO-LABEL
     lines-per-page AT ROW 14.52 COL 84 COLON-ALIGNED
     lv-font-no AT ROW 16.43 COL 34 COLON-ALIGNED
     lv-font-name AT ROW 17.43 COL 28 COLON-ALIGNED NO-LABEL
     td-show-parm AT ROW 18.62 COL 30
     tb_excel AT ROW 20.1 COL 50 RIGHT-ALIGNED
     tb_runExcel AT ROW 20.1 COL 71 RIGHT-ALIGNED
     fi_file AT ROW 20.91 COL 28 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 22.48 COL 19
     btn-cancel AT ROW 22.48 COL 57
     "Available Columns" VIEW-AS TEXT
          SIZE 29 BY .62 AT ROW 7.48 COL 4.2 WIDGET-ID 38
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 13.33 COL 5
     "Selection Parameters" VIEW-AS TEXT
          SIZE 21 BY .71 AT ROW 1.24 COL 5
          BGCOLOR 2 
     "Selected Columns(In Display Order)" VIEW-AS TEXT
          SIZE 34 BY .62 AT ROW 7.48 COL 59.8 WIDGET-ID 44
     RECT-6 AT ROW 13.29 COL 2
     RECT-7 AT ROW 1 COL 2
     RECT-8 AT ROW 7.33 COL 2 WIDGET-ID 62
...
def var fsstate as ch init "".
def var tsstate like fsstate init "zz".
...
DEF VAR v-carrier AS CHAR NO-UNDO.
DEF VAR v-sstate AS CHAR NO-UNDO.
  ...
  for each tt-report where tt-report.term-id eq "",
   ...
   IF AVAIL ar-invl THEN
    ...
    IF AVAIL shipto THEN do:
        ASSIGN v-sstate = shipto.ship-state .
    END.
    ...
    DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
       cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
            CASE cTmpField:             
                 ...
                 WHEN "sal-tot" THEN cVarValue = string(v-tot[1],"->,>>>,>>>,>>9.99").
                 WHEN "carr" THEN cVarValue = string(v-carrier).
                 WHEN "ssate" THEN cVarValue = STRING(v-sstate).
     ...
     DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
       cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
            CASE cTmpField:
                ...
                WHEN "state" THEN cVarValue = "".
                WHEN "zip"      THEN cVarValue = "".
                WHEN "sal-tot" THEN cVarValue = string(v-tot[2],"->,>>>,>>>,>>9.99").
                WHEN "carr" THEN cVarValue = "".
                WHEN "ssate" THEN cVarValue = "".
            END CASE.
            cExcelVarValue = cVarValue.  
            cDisplay = cDisplay + cVarValue +
                       FILL(" ",int(entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldLength)) + 1 - LENGTH(cVarValue)).             
