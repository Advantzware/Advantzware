...
tb_fin-chg sl_avail sl_selected lv-ornt lines-per-page rd-dest lv-font-no ~
...
------------------------------------------------------------------------------*/
  DISPLAY begin_cust-no end_cust-no begin_cust-type end_cust-type begin_ship-to 
          ...
          end_inv-date lbl_sort rd_sort tb_disprice tb_fin-chg sl_avail 
  ...
  ENABLE RECT-6 RECT-7 begin_cust-no end_cust-no begin_cust-type end_cust-type 
         ...
         begin_inv-date end_inv-date rd_sort tb_disprice tb_fin-chg sl_avail 
