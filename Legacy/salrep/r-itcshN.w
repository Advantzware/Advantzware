...
DEFINE FRAME FRAME-A
     ...
     end_cust-no AT ROW 2.81 COL 69 COLON-ALIGNED HELP
          "Enter Ending Customer Number"
     begin_ship AT ROW 3.81 COL 28 COLON-ALIGNED HELP
          "Enter Beginning Ship-to#"
     end_ship AT ROW 3.81 COL 69 COLON-ALIGNED HELP
          "Enter Ending Zip Code"
     begin_slmn AT ROW 4.76 COL 28 COLON-ALIGNED HELP
          "Enter Beginning Sales Rep#"
     end_slmn AT ROW 4.76 COL 69 COLON-ALIGNED HELP
          "Enter Ending Sales Rep#"
     tgChooseSalesReps AT ROW 5.81 COL 30 WIDGET-ID 156
     begin_i-no AT ROW 6.67 COL 28 COLON-ALIGNED HELP
          "Enter Beginning Item Number"
     end_i-no AT ROW 6.67 COL 69 COLON-ALIGNED HELP
          "Enter Ending Customer Number"
     begin_inv-date AT ROW 7.62 COL 28 COLON-ALIGNED HELP
...
def var v-part-no    like cust.name format "x(21)" no-undo.
