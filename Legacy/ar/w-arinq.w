...
DEFINE VARIABLE h_b-arlinq AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Brws Invoices|View Invoice' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'ar/b-arinq.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-arinq ).
       RUN set-position IN h_b-arinq ( 4.81 , 4.00 ) NO-ERROR.
       RUN set-size IN h_b-arinq ( 19.52 , 145.00 ) NO-ERROR.

       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('2') NO-ERROR.

       /* Links to SmartNavBrowser h_b-arinq. */
       RUN add-link IN adm-broker-hdl ( h_p-navico , 'Navigation':U , h_b-arinq ).
    ...
    WHEN 2 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'ar/b-arlinq.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-arlinq ).
       RUN set-position IN h_b-arlinq ( 13.62 , 4.00 ) NO-ERROR.
       RUN set-size IN h_b-arlinq ( 8.10 , 145.00 ) NO-ERROR.
       ...
       /* Links to SmartNavBrowser h_b-arlinq. */
       RUN add-link IN adm-broker-hdl ( h_b-arinq , 'Record':U , h_b-arlinq ).
