...
PUT "<P10><R15><C1><#2>"
            ...
            SPACE(6) ar-inv.cust-name v-shipto-name AT 71 skip
            SPACE(6) ar-inv.addr[1]   v-shipto-addr[1] AT 71 SKIP
            SPACE(6) ar-inv.addr[2]  v-shipto-addr[2] AT 71 SKIP
...
PUT "<P10><=#3>" SKIP
    ...
    "<=3><R+5> " cust.contact FORM "x(22)"  ar-inv.inv-date.
...
PUT "<=5><R+1> Customer PO#   Ship  Order Item#/CustPart#        Description           Price   UOM    Amount" SKIP(1).
