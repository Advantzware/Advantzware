/* ------------------------------------------ ar/rep/invcolrx.p 08040901 GDM */
...
def var v-shipto-code as char format "x(8)" NO-UNDO.
    ...
    for each report where report.term-id eq v-term-id no-lock,
     ...
     ELSE DO:
         ...
         IF AVAIL shipto THEN
             assign  v-shipto-code = shipto.ship-id
...
*/
  ...
  */
        ...
        {custom/notesprt.i ar-inv v-notes 4}
