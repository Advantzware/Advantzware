      ...
      ELSE
       ...
       find first stax {sys/ref/stax1W.i}
        ...
        FIND FIRST sman WHERE sman.company = cocode  
                          AND sman.sman = v-salesman NO-LOCK NO-ERROR.
        IF AVAIL sman THEN
            v-salesman-name = sman.sname.
        ...
        do:
           ...
           ASSIGN
              ...
              v-bol-no    = IF AVAIL oe-bolh THEN oe-bolh.bol-no ELSE ar-invl.bol-no.
        end.
