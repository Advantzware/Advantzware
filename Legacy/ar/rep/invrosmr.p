...
def var v-case-cnt as char format "x(80)" extent 10 NO-UNDO.
...
ASSIGN ls-image1 = "images\IPI_2.jpg"
       ls-image2 = "".
...
def var v-addr1    as char format "x(30)" NO-UNDO.
 ...
 */
 ...
 {ar/rep/invrosmr.i}  /* xprint form */
        ...
        for each ar-invl no-lock where ar-invl.x-no = ar-inv.x-no:
          ...
          */
          ...
          for each oe-boll no-lock where oe-boll.company = ar-invl.company
                        ...
                        AND oe-boll.po-no = ar-invl.po-no
    ...
    v-inv-total = /*ar-inv.net + ar-inv.tax-amt + v-inv-freight*/
