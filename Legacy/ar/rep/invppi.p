/* ---------------------------------------------- ar/rep/invppi.p  */
/* PRINT INVOICE   Xprint Standard Form  for Preferred           */
/* -------------------------------------------------------------------------- */
...
*/
            ...
            do v = 1 to 2:
              ...
              if v-part-info ne "" OR ar-invl.part-no <> "" then do:
                 IF v = 1 THEN PUT SPACE(30) ar-invl.part-no SPACE(1) v-part-info SKIP.
...
*/      
    ...
    PUT "<R56><C1><FROM><R+6><C+35><RECT>"
        "<R56><C3><B>Please Remit To:"
        "<R57><C3>  Preferred Packaging, Inc."
        "<R58><C3>  1810 S. Elm Street"
        "<R59><C3>  P.O. Box 7579"
        "<R60><C3>  High Point, NC 27264-7579"
        "<R61><C3>Phone: 336-884-0792</B>".
