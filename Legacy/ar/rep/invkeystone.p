...
ASSIGN ls-image1 = "images\keystone.jpg"
...
ELSE lv-comp-color = "BLACK".
 ...
 END.
    ...
    PUT "<R58><C56><#8><FROM><R+6><C+25><RECT> " 
        "<=8> Sub Total       :" v-subtot-lines FORM "$->>>,>>9.99"
        "<=8><R+1> Freight         :" v-inv-freight FORM "$->>>,>>9.99"
        "<=8><R+2> " v-bot-lab[1] 
        "<=8><R+3> " v-bot-lab[2]
        "<=8><R+4> " v-bot-lab[3]
        "<=8><R+5> Grand Total(USD):" v-subtot-lines + v-t-tax[1] + v-t-tax[2] + v-t-tax[3] + v-inv-freight FORM "$->>>,>>9.99" .
