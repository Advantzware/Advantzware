...
subjectWhereBrowse btnBegins btnAND btnOR btnEQ btnNE btnLT btnUndo btnGT ~
...
btnMultiply btnDivide btnYes btnResults btnNo btnDate cUseIndex findType ~
btnDec subjectTableBrowse btnInt columnSearch columnMatches btnStr ~
subjectColumnBrowse btnSubstr btnCalcField cParameter btnOpen btnClose ~
...
btnUndo btnGT fieldSearch fieldMatches paramSetSearch paramSetMatches btnLE ~
...
------------------------------------------------------------------------------*/
  ...
  ENABLE btnSave btnCreateDefaults btnSubjectParamSet btnNow btnOuterJoin 
         ...
         btnBegins btnAND btnOR btnEQ btnNE btnLT btnUndo btnGT fieldSearch 
         ...
         btnDivide btnYes btnResults btnNo btnDate cUseIndex findType btnDec 
         subjectTableBrowse btnInt columnSearch columnMatches btnStr 
         subjectColumnBrowse btnSubstr btnCalcField cParameter btnOpen btnClose 
         cConstant btnPeriod btnDouble btnComma btnSingle queryStr btnSyntax 
         btnAddSelections btnGroupCalc btnAddUseIndex btnRemoveUseIndex 
