...
&Scoped-define ttTempTable ttOrdersBookedByOrderNo 
...
PROCEDURE pBusinessLogic:
    ...
    FOR EACH oe-ord NO-LOCK
        ...
        WHERE bOEOrdl.company EQ cCompany
        ...
        FOR EACH oe-ordl NO-LOCK
            ...
            ASSIGN
                ...
                dExtPrice = 0
                .
            IF iQtyLft LT 0 THEN
            iQtyLft = 0.
            FIND FIRST itemfg NO-LOCK
                 WHERE itemfg.company EQ cCompany
                   AND itemfg.i-no    EQ oe-ordl.i-no
                 NO-ERROR.
            RUN GetPriceTotal IN hdPriceProcs (
                oe-ordl.qty,
                oe-ordl.price,
                oe-ordl.pr-uom,
            ...
            IF oe-ordl.po-no-po NE 0 THEN DO:
                ...
                ASSIGN
                    ...
                    .
               RUN pCalcPOMSF (cCompany,OUTPUT dOrderedMSF).
