...
&Scoped-define ttTempTable ttCashReceiptBySalesRepName 
...
PROCEDURE pBusinessLogic:
    ...
    FOR EACH cust NO-LOCK
        ...
        FOR EACH ar-cash NO-LOCK
            WHERE ar-cash.company    EQ cCompany
    ...
    FOR EACH tt-report NO-LOCK:
        FIND FIRST tt-report-inv NO-LOCK
             WHERE tt-report-inv.inv-no  EQ tt-report.inv-no 
