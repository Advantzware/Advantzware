...
&Scoped-Define ENABLED-OBJECTS RECT-40 btn-add btn-copy btn-import 
...
DEFINE FRAME F-Main
     ...
     btn-copy AT ROW 2.67 COL 2
     btn-import AT ROW 4.14 COL 2
...
ASSIGN 
       btn-import:PRIVATE-DATA IN FRAME F-Main     = 
                "panel-image".
...
ON CHOOSE OF btn-add IN FRAME F-Main /* Add Periods */
DO:
...
ON CHOOSE OF btn-copy IN FRAME F-Main /* Copy Periods */
DO:
   def var char-hdl as cha no-undo.   
   RUN get-link-handle IN adm-broker-hdl (THIS-PROCEDURE,'copy-source':U,OUTPUT char-hdl).
...
ON CHOOSE OF btn-import IN FRAME F-Main /* Import Budgets */
DO:
   def var char-hdl as cha no-undo.   
   RUN get-link-handle IN adm-broker-hdl (THIS-PROCEDURE,'copy-source':U,OUTPUT char-hdl).
