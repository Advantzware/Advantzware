...
DEFINE FRAME F-Main
     mstd.board-cal[1] AT ROW 2.19 COL 6 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     mstd.spd-reduc[1] AT ROW 2.19 COL 23 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 4.8 BY 1
     mstd.board-cal[2] AT ROW 3.19 COL 6 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     mstd.spd-reduc[2] AT ROW 3.19 COL 23 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 4.8 BY 1
     mstd.spd-reduc[3] AT ROW 4.14 COL 23 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 4.8 BY 1
     mstd.board-cal[3] AT ROW 4.19 COL 6 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     mstd.board-cal[4] AT ROW 5.19 COL 6 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     mstd.spd-reduc[4] AT ROW 5.29 COL 23 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 4.8 BY 1
     mstd.board-cal[5] AT ROW 6.19 COL 6 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     mstd.spd-reduc[5] AT ROW 6.29 COL 23 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 4.8 BY 1
     mstd.board-cal[6] AT ROW 7.19 COL 6 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     mstd.spd-reduc[6] AT ROW 7.29 COL 23 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 4.8 BY 1
     mstd.board-cal[7] AT ROW 8.19 COL 6 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     mstd.spd-reduc[7] AT ROW 8.29 COL 23 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 4.8 BY 1
     mstd.board-cal[8] AT ROW 9.19 COL 6 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     mstd.spd-reduc[8] AT ROW 9.29 COL 23 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 4.8 BY 1
     mstd.board-cal[9] AT ROW 10.19 COL 6 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     mstd.spd-reduc[9] AT ROW 10.29 COL 23 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 4.8 BY 1
     "Speed Reduction" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 1.24 COL 20
     "Box Depth" VIEW-AS TEXT
          SIZE 12 BY .62 AT ROW 1.24 COL 7
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1 SCROLLABLE 
         TITLE "REPRODUCTION BY DEPTH".
