...
&Scoped-Define ENABLED-OBJECTS btn-re-seq 
...
DEFINE BUTTON btn-re-seq 
     LABEL "Proceed &Re-Sequence" 
     SIZE 36 BY 2.38
     FONT 6.
...
&Scoped-define SELF-NAME btn-re-seq
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn-re-seq V-table-Win
ON CHOOSE OF btn-re-seq IN FRAME F-Main /* Proceed Re-Sequence */
DO:
