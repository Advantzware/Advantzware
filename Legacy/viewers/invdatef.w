...
&Scoped-Define ENABLED-FIELDS ar-inv.inv-date ar-inv.ord-date ~
ar-inv.due-date ar-inv.pay-date 
&Scoped-define ENABLED-TABLES ar-inv
&Scoped-define FIRST-ENABLED-TABLE ar-inv
&Scoped-Define ENABLED-OBJECTS RECT-1 
&Scoped-Define DISPLAYED-FIELDS ar-inv.inv-date ar-inv.ord-date ~
ar-inv.due-date ar-inv.pay-date 
...
DEFINE FRAME F-Main
     ar-inv.inv-date AT ROW 1.71 COL 15 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
     ar-inv.ord-date AT ROW 3.14 COL 15 COLON-ALIGNED
          LABEL "Order Date"
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
     ar-inv.due-date AT ROW 4.57 COL 15 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
     ar-inv.pay-date AT ROW 6 COL 15 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
...
/* SETTINGS FOR FILL-IN ar-inv.ord-date IN FRAME F-Main
   EXP-LABEL                                                            */
...
------------------------------------------------------------------------------*/
  ...
  if avail ar-ledger then
    assign
     ar-ledger.tr-date  = ar-inv.inv-date
