...
&Scoped-Define ENABLED-OBJECTS btn-movecol 
...
&Scoped-define SELF-NAME btn-movecol
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn-movecol V-table-Win
ON CHOOSE OF btn-movecol IN FRAME F-Main
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE hide-icon V-table-Win 
PROCEDURE hide-icon :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
btn-movecol:HIDDEN IN FRAME {&FRAME-NAME} = TRUE.
END PROCEDURE.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
btn-movecol:SENSITIVE IN FRAME F-Main = FALSE.
END PROCEDURE.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
btn-movecol:SENSITIVE IN FRAME F-Main = TRUE.
END PROCEDURE.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE show-icon V-table-Win 
PROCEDURE show-icon :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
btn-movecol:HIDDEN IN FRAME {&FRAME-NAME} = FALSE.
END PROCEDURE.
