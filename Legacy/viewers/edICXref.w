...
DEFINE FRAME F-Main
     EDICXref.Partner AT ROW 4.1 COL 21 COLON-ALIGNED WIDGET-ID 8
          VIEW-AS FILL-IN 
          SIZE 8 BY 1
     EDICXref.Item-no AT ROW 5.14 COL 21 COLON-ALIGNED WIDGET-ID 6
          LABEL "Item Number"
          VIEW-AS FILL-IN 
          SIZE 21.2 BY 1
     EDICXref.Cust-item-no AT ROW 6.14 COL 21 COLON-ALIGNED WIDGET-ID 4
          LABEL "Cust Item No"
          VIEW-AS FILL-IN 
          SIZE 38 BY 1
...
/* SETTINGS FOR FILL-IN EDICXref.Cust-item-no IN FRAME F-Main
   EXP-LABEL                                                            */
/* SETTINGS FOR FILL-IN EDICXref.Item-no IN FRAME F-Main
   EXP-LABEL                                                            */
