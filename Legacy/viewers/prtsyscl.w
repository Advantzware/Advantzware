...
&Scoped-Define ENABLED-OBJECTS Select_list 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Select_list V-table-Win
ON CHOOSE OF Select_list IN FRAME F-Main
DO:
    DEF VAR char-hdl AS cha NO-UNDO.

    RUN get-link-handle IN adm-broker-hdl (THIS-PROCEDURE,'getInfo-target':U,OUTPUT char-hdl).
    IF VALID-HANDLE (adm-broker-hdl) THEN DO:
       RUN print-sys-ctl IN WIDGET-HANDLE(char-hdl).
