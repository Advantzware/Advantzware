...
listname = "p-updven." .
    DEF VAR lPriceChangeSec AS LOG NO-UNDO.
...
RUN methods/prgsecur.p
    (INPUT listname, /* Set in definitions */
     ...
     OUTPUT lPriceChangeSec, /* Allowed? Yes/NO */
     OUTPUT lAccessClose, /* used in template/windows.i  */
     OUTPUT cAccessList). /* list 1's and 0's indicating yes or no to run, create, update, delete */
    v-can-update = lPriceChangeSec.
/* {methods/prgsecd2.i} */
...
&Scoped-Define ENABLED-OBJECTS RECT-25 btn-price 
...
ON CHOOSE OF btn-price IN FRAME F-Main /* Price Change */
DO:
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
    IF NOT v-can-update THEN btn-price:SENSITIVE = NO.
  END.
END PROCEDURE.
