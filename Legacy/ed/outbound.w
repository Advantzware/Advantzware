...
DEF VAR status_msg AS CHAR NO-UNDO FORMAT 'x(15)' EXTENT 10
  LABEL "Status".
  */
def var fill_date as date.
def var fill_time as int no-undo.
...
ws_print-opt1 setid_list partner_list ws_status top-debug1 btn-ok ~
btn-cancel 
&Scoped-Define DISPLAYED-OBJECTS ws_company1 ws_test-prod ws_print-opt1 ~
setid_list partner_list ws_status top-debug1 
...
DEFINE FRAME FRAME-A
     ...
     top-debug1 AT ROW 11.71 COL 15 WIDGET-ID 10
     btn-ok AT ROW 15.76 COL 23
