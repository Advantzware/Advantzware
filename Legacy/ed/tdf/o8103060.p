...
ASSIGN
  ...
  "TDS,025,CAD,026,SAC,027,ISS,028,CTT,029"
  ctt_count_segment_list = "IT1".
CASE ws_partner:
WHEN "SEARS" OR WHEN "SEARS" THEN
ASSIGN
  partner_segment_list = "000,ST,BIG,REF,N1,ITD,DTM,PID,IT1,SAC,TDS,SAC,CTT,SE".
OTHERWISE ASSIGN
...
DO:
  ...
  DO:
    ASSIGN
      ref_qual = "19"           /* in 3020 this was REF SD 9810 CAH */
