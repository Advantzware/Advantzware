  ...
  REPEAT:
    ...
    */
    ...
    DO:
      ...
      DO:
        ...
        DO:
          ...
          then shipto_store_number = ordering_store_number.
          if ordering_store_number <= ""
          and shipto_store_number > ""
          then ordering_store_number = shipto_store_number.
      ...
      DO:
        ...
        DO:
          ASSIGN
            {rc/substr.i  quantity_ordered        32 9 INTEGER}
            {rc/substr.i  unit_of_measure         41 2}
            {rc/substr.i  unit_price              43 14 DECIMAL}
            {rc/substr.i  customer_item_number    57 13}
            {rc/substr.i  item_description        70 20}
            .
          CREATE edpoline.
          ASSIGN
    ...
    DO:    /* header rec types accum into variables */
      ...
      DO:
        ASSIGN
          {rc/substr.i    purchase_order_number       5 14}
          {rc/substr.i    purchase_order_date         19 6}
          {rc/substr.i    department_number           44 3}
          {rc/substr.i    vendor_number               35 9}
          {rc/substr.i    sales_division              47 3}
          /*
...
----*----1----*----2----*----3----*----4----*----5----*----6----*----7----*----8
12345678901234567890123456789012345678901234567890123456789012345678901234567890
*****FEDER850003020                                    FEDER
16  TR-00000284551970514          800111111
30                                            7103HSQ
40                             60       CT14.84         71M8K
*****FEDER850003020                                    FEDER
16  TR-00000284552970514          800111111
30                                            7103HSQ
40                             10       CT19.17         71M1K
40                             15       CT22.37         71M12Y
40                             50       CT10.26         71M9K
40                             15       CT18.95         71M3K
40                             20       CT13.55         71M11Y
40                             25       CT14.21         71M13K
40                             15       CT19.6          71M14Y
40                             15       CT15.35         71M16Y
*/
