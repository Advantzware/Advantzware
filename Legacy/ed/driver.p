...
1.  Added update of ws_print-opt to toggle printing in tdf parse programs.
2.  Changed name of s-err file from chris.err to edi_dbg.txt.
...
DISPLAY ws_company ws_direction
  WITH FRAME f-view.
UPDATE
  ws_company ws_test-prod ws_print-opt top-debug 
  WITH FRAME f-view.
UPDATE
