...
btnFirst btnLast btnNext btnPrevious RECT-26 RECT-29 bt-change ls-jobno ~
cb-jobno2 cb-formno cb-blankno ls-tag br-table 
...
------------------------------------------------------------------------------*/
  ...
  ENABLE bt-exit btnKeyboard-2 btnNumPad btnKeyboard btnFirst btnLast btnNext 
         btnPrevious RECT-26 RECT-29 bt-change ls-jobno cb-jobno2 cb-formno 
         cb-blankno ls-tag br-table 
      WITH FRAME F-Main IN WINDOW W-Win.
