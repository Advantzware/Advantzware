...
begin_rm-no end_rm-no begin_vend end_vend select-mat rd-dest lv-ornt ~
...
DEFINE FRAME FRAME-A
     ...
     lines-per-page AT ROW 14.81 COL 85 COLON-ALIGNED
     ...
     tb_runExcel AT ROW 19.57 COL 91 RIGHT-ALIGNED
     ...
     "Output Destination" VIEW-AS TEXT
          SIZE 19 BY .71 AT ROW 13.86 COL 2
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
 ...
 /* security check need {methods/prgsecur.i} in definition section */
  ...
  END.
    ...
    {methods/setButton.i btn-cancel "Cancel"} /* added by script _nonAdm1Images.p on 03.28.2017 @ 10:43:52 am */
    {methods/setButton.i btn-ok "OK"} /* added by script _nonAdm1Images.p on 03.28.2017 @ 10:43:52 am */
...
------------------------------------------------------------------------------*/
  DISPLAY begin_date end_date begin_rm-no end_rm-no begin_vend end_vend 
          select-mat rd-dest lv-ornt lines-per-page lv-font-no lv-font-name 
          td-show-parm tb_excel tb_runExcel fi_file 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE RECT-6 RECT-7 begin_date end_date begin_rm-no end_rm-no begin_vend 
         end_vend select-mat rd-dest lv-ornt lines-per-page lv-font-no 
