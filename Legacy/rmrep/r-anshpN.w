...
tb_sumcat sl_avail sl_selected rd-dest lv-ornt lines-per-page lv-font-no ~
...
DEFINE FRAME FRAME-A
     ...
     end_vend AT ROW 5.05 COL 69 COLON-ALIGNED HELP
          "Enter Endng Vendor"
     begin_cust-no AT ROW 6 COL 28 COLON-ALIGNED HELP
          "Enter Beginng Vendor" WIDGET-ID 58
     end_cust-no AT ROW 6 COL 69 COLON-ALIGNED HELP
          "Enter Endng Vendor" WIDGET-ID 60
     tb_receipts AT ROW 7.76 COL 29.6
     tb_adjustments AT ROW 7.76 COL 52.4
     tb_issues AT ROW 8.71 COL 29.6
     tb_counts AT ROW 8.71 COL 52.4
     tb_transfers AT ROW 9.67 COL 29.6
     tb_sumcat AT ROW 9.91 COL 60.6 WIDGET-ID 62
     sl_avail AT ROW 12.1 COL 4.4 NO-LABEL WIDGET-ID 26
     Btn_Def AT ROW 12.1 COL 40.4 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 56
     sl_selected AT ROW 12.1 COL 59.8 NO-LABEL WIDGET-ID 28
     Btn_Add AT ROW 13.1 COL 40.4 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 32
     Btn_Remove AT ROW 14.1 COL 40.4 HELP
          "Remove Selected Table from Tables to Audit" WIDGET-ID 34
     btn_Up AT ROW 15.14 COL 40.4 WIDGET-ID 40
     btn_down AT ROW 16.19 COL 40.4 WIDGET-ID 42
     ...
     "Available Columns" VIEW-AS TEXT
          SIZE 29 BY .62 AT ROW 11.19 COL 5.4 WIDGET-ID 38
     "Selected Columns(In Display Order)" VIEW-AS TEXT
          SIZE 34 BY .62 AT ROW 11.29 COL 60 WIDGET-ID 44
     "Transaction Types" VIEW-AS TEXT
          SIZE 20 BY 1.19 AT ROW 7.29 COL 6.2
          FGCOLOR 9 
     "Selection Parameters" VIEW-AS TEXT
          SIZE 21 BY .71 AT ROW 1.24 COL 5
          BGCOLOR 2 
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 17.43 COL 1.8
...
ASSIGN 
       tb_sumcat:PRIVATE-DATA IN FRAME FRAME-A     = 
                "parm".
                   ...
                   DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
                      cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                           CASE cTmpField:             
                                ...
                                WHEN "cat-desc-val" THEN cVarValue = ""   .
