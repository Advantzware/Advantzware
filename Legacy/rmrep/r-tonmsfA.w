...
tb_issues tb_transfers tb_adjustments tb_counts rd-dest lv-ornt ~
...
end_procat begin_date end_date begin_vend end_vend tb_receipts tb_issues ~
tb_transfers tb_adjustments tb_counts rd-dest lv-ornt lines-per-page ~
...
DEFINE FRAME FRAME-A
     ...
     end_vend AT ROW 5.05 COL 69 COLON-ALIGNED HELP
          "Enter Endng Vendor"
     tb_receipts AT ROW 7.43 COL 40
     tb_issues AT ROW 8.38 COL 40
     tb_transfers AT ROW 9.33 COL 40
     tb_adjustments AT ROW 10.29 COL 40
     tb_counts AT ROW 11.24 COL 40
     rd-dest AT ROW 14.1 COL 6 NO-LABEL
     lv-ornt AT ROW 14.1 COL 30 NO-LABEL
     lines-per-page AT ROW 14.1 COL 83 COLON-ALIGNED
     ...
     tb_excel AT ROW 19.71 COL 30 WIDGET-ID 2
     tb_runExcel AT ROW 19.71 COL 55 WIDGET-ID 4
     fi_file AT ROW 20.76 COL 28 COLON-ALIGNED HELP
          "Enter File Name" WIDGET-ID 6
     btn-ok AT ROW 23.43 COL 27
     btn-cancel AT ROW 23.43 COL 59
     "Transaction Types" VIEW-AS TEXT
          SIZE 20 BY 1.19 AT ROW 6.24 COL 36
          FGCOLOR 9 
...
------------------------------------------------------------------------------*/
  DISPLAY begin_rm-no end_rm-no begin_procat end_procat begin_date end_date 
          begin_vend end_vend tb_receipts tb_issues tb_transfers tb_adjustments 
          tb_counts rd-dest lv-ornt lines-per-page lv-font-no lv-font-name 
          td-show-parm tb_excel tb_runExcel fi_file 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE RECT-6 RECT-7 begin_rm-no end_rm-no begin_procat end_procat begin_date 
         end_date begin_vend end_vend tb_receipts tb_issues tb_transfers 
         tb_adjustments tb_counts rd-dest lv-ornt lines-per-page lv-font-no 
