...
DO:
  chCtrlFrame:Calendar:VISIBLE = IF chCtrlFrame:Calendar:VISIBLE THEN FALSE ELSE TRUE.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL CtrlFrame W-Win OCX.Click
...
ASSIGN
v-DAY:SCREEN-VALUE = STRING(chCtrlFrame:Calendar:DAY)
v-MONTH:SCREEN-VALUE = STRING(chCtrlFrame:Calendar:MONTH)
v-YEAR:SCREEN-VALUE = STRING(chCtrlFrame:Calendar:YEAR)
cb-YEAR:SCREEN-VALUE = STRING(chCtrlFrame:Calendar:YEAR)
v-date = DATE(v-month:SCREEN-VALUE + "/" + v-day:SCREEN-VALUE + "/" + v-year:SCREEN-VALUE).
DISP v-date .
END.
...
END.
ELSE MESSAGE "w-calen.wrx":U SKIP(1)
...
------------------------------------------------------------------------------*/
  DISPLAY cb-year v-year v-month v-day v-date 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE cb-year v-year v-month v-day v-date BUTTON-1 RECT-3 
      WITH FRAME F-Main IN WINDOW W-Win.
