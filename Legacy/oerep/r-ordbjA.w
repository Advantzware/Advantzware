...
end_slmn rd_sort rd_jstat tb_break rd_ostat rd_prt-baldue tb_under ~
...
lbl_jstat rd_jstat tb_break lbl_ostat rd_ostat lbl_prt-baldue-2 ~
lbl_prt-baldue-4 rd_prt-baldue tb_under fi_days-old tb_job-qty as-of-date ~
...
------------------------------------------------------------------------------*/
  DISPLAY begin_cust-no end_cust-no begin_ord-date end_ord-date begin_po-no 
          ...
          tb_break lbl_ostat rd_ostat lbl_prt-baldue-2 lbl_prt-baldue-4 
          rd_prt-baldue tb_under fi_days-old tb_job-qty as-of-date tb_0-bal 
  ...
  ENABLE RECT-6 RECT-7 RECT-8 begin_cust-no end_cust-no begin_ord-date 
         ...
         rd_jstat tb_break rd_ostat rd_prt-baldue tb_under fi_days-old 
