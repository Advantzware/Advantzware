...
begin_date end_date RECT-6 begin_carr RECT-7 end_carr begin_cat RECT-16 ~
end_cat tb_scheduled RECT-17 tb_late tb_invoiceable RECT-18 tb_actual ~
tb_backordered tb_posted tb_invoice tb_completed tb_subt rd_sort tb_comps ~
tb_prt-qoh tb_prt-last rd_print2 tg-print-due rs-item-option rd_print3 ~
lv-ornt rd-dest lines-per-page lv-font-no td-show-parm tb_excel tb_runExcel ~
fi_file btn-ok btn-cancel RECT-19 RECT-20 RECT-21 
...
tb_completed tb_subt rd_sort tb_comps tb_prt-qoh tb_prt-last rd_print2 ~
tg-print-due rs-item-option rd_print3 lv-ornt rd-dest lines-per-page ~
...
DEFINE VARIABLE rd_print2 AS CHARACTER INITIAL "MSF/Style" 
     VIEW-AS RADIO-SET VERTICAL
     RADIO-BUTTONS 
          "MSF/Style", "MSF/Style",
"Pallet Qty", "Pallet Qty"
     SIZE 14.8 BY 1.67 NO-UNDO.

DEFINE VARIABLE rd_print3 AS CHARACTER INITIAL "FG Item#" 
     VIEW-AS RADIO-SET VERTICAL
     RADIO-BUTTONS 
          "FG Item#", "FG Item#",
"Expand Desc to 30", "Expand Desc to 30"
     SIZE 22.8 BY 1.46 NO-UNDO.
...
DEFINE VARIABLE tb_comps AS LOGICAL INITIAL no 
...
DEFINE VARIABLE tb_prt-last AS LOGICAL INITIAL no 
     LABEL "Print Last Ship Date?" 
     VIEW-AS TOGGLE-BOX
     SIZE 25 BY 1 NO-UNDO.

DEFINE VARIABLE tb_prt-qoh AS LOGICAL INITIAL no 
...
DEFINE FRAME FRAME-A
     begin_cust-no AT ROW 1.91 COL 26 COLON-ALIGNED HELP
          "Enter Beginning Customer Number"
     end_cust-no AT ROW 1.91 COL 69 COLON-ALIGNED HELP
          "Enter Ending Customer Number"
     begin_ord-no AT ROW 2.86 COL 26 COLON-ALIGNED HELP
          "Enter Beginning Order Number"
     end_ord-no AT ROW 2.86 COL 69 COLON-ALIGNED HELP
          "Enter Ending Order Number"
     begin_i-no AT ROW 3.81 COL 26 COLON-ALIGNED HELP
          "Enter Beginning Order Number"
     end_i-no AT ROW 3.81 COL 69 COLON-ALIGNED HELP
          "Enter Ending Item Number"
     begin_loc AT ROW 4.76 COL 26 COLON-ALIGNED HELP
          "Enter Beginning Warehouse"
     end_loc AT ROW 4.76 COL 69 COLON-ALIGNED HELP
          "Enter Ending Warehouse"
     begin_slsmn AT ROW 5.71 COL 26 COLON-ALIGNED HELP
          "Enter Beginning Sales Rep Number"
     end_slsmn AT ROW 5.71 COL 69 COLON-ALIGNED HELP
          "Enter Ending Sales Rep Number"
     begin_date AT ROW 6.67 COL 26 COLON-ALIGNED HELP
          "Enter Beginning Date"
     end_date AT ROW 6.67 COL 69 COLON-ALIGNED HELP
          "Enter Ending Date"
     begin_carr AT ROW 7.62 COL 26 COLON-ALIGNED HELP
          "Enter Beginning Carrier Number"
     end_carr AT ROW 7.62 COL 69 COLON-ALIGNED HELP
          "Enter Ending Carrier Number"
     begin_cat AT ROW 8.62 COL 26 COLON-ALIGNED HELP
          "Enter Beginning Product Category"
     end_cat AT ROW 8.62 COL 69 COLON-ALIGNED HELP
          "Enter Ending Product Category"
     tb_scheduled AT ROW 11.57 COL 2.6
     tb_late AT ROW 12.48 COL 2.6
     tb_invoiceable AT ROW 13.38 COL 2.6
     tb_actual AT ROW 14.29 COL 2.6
     tb_backordered AT ROW 15.19 COL 2.6
     tb_posted AT ROW 16.1 COL 2.6
     tb_invoice AT ROW 17 COL 2.6
     tb_completed AT ROW 18 COL 2.6
     tb_subt AT ROW 11.24 COL 28.2
     rd_sort AT ROW 12.43 COL 28 NO-LABEL
     tb_comps AT ROW 10.76 COL 58.2
     tb_prt-qoh AT ROW 11.67 COL 58.2
     tb_prt-last AT ROW 12.52 COL 58.2
     rd_print2 AT ROW 13.62 COL 58.2 NO-LABEL
     tg-print-due AT ROW 13.48 COL 76
     rs-item-option AT ROW 15.62 COL 58.2 NO-LABEL
     rd_print3 AT ROW 17.29 COL 58.2 NO-LABEL
     lv-ornt AT ROW 20.05 COL 28 NO-LABEL
     rd-dest AT ROW 20.19 COL 5.6 NO-LABEL
     lines-per-page AT ROW 21.29 COL 57.8 COLON-ALIGNED
     lv-font-no AT ROW 21.38 COL 33 COLON-ALIGNED
     td-show-parm AT ROW 21.48 COL 69
     lv-font-name AT ROW 22.67 COL 27 COLON-ALIGNED NO-LABEL
     tb_excel AT ROW 24.14 COL 69.8 RIGHT-ALIGNED
     tb_runExcel AT ROW 24.14 COL 91.6 RIGHT-ALIGNED
     fi_file AT ROW 25.1 COL 47.8 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 26.86 COL 22
     btn-cancel AT ROW 26.86 COL 58
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 19.24 COL 2
     "Sort Options:" VIEW-AS TEXT
          SIZE 13 BY .71 AT ROW 10.05 COL 28 WIDGET-ID 6
     "Print Options:" VIEW-AS TEXT
          SIZE 13 BY .71 AT ROW 10.05 COL 57.2 WIDGET-ID 10
     "Release Types:" VIEW-AS TEXT
          SIZE 15 BY .71 AT ROW 10.05 COL 2
...
DEFINE FRAME FRAME-A
     RECT-16 AT ROW 9.81 COL 1.2 WIDGET-ID 2
     RECT-17 AT ROW 9.81 COL 26.4 WIDGET-ID 4
     RECT-18 AT ROW 9.81 COL 56 WIDGET-ID 8
     RECT-19 AT ROW 13.57 COL 57 WIDGET-ID 12
     RECT-20 AT ROW 15.52 COL 57 WIDGET-ID 14
     RECT-21 AT ROW 17.19 COL 57 WIDGET-ID 16
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1.6 ROW 1.24
         SIZE 94.4 BY 27.33.
...
ASSIGN 
       rd_print3:PRIVATE-DATA IN FRAME FRAME-A     = 
                "parm".
...
ASSIGN 
       tb_comps:PRIVATE-DATA IN FRAME FRAME-A     = 
                "parm".
...
ASSIGN 
       tb_prt-last:PRIVATE-DATA IN FRAME FRAME-A     = 
                "parm".

ASSIGN 
       tb_prt-qoh:PRIVATE-DATA IN FRAME FRAME-A     = 
                "parm".
...
DO:
   apply "close" to this-procedure.
    {Advantzware/WinKit/winkit-panel-triggerend.i} /* added by script _nonAdm1.p on 03.28.2017 @ 10:43:03 am */
END.
...
&Scoped-define SELF-NAME rd_print3
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL rd_print3 C-Win
ON VALUE-CHANGED OF rd_print3 IN FRAME FRAME-A
DO:
  assign {&self-name}.
END.
...
&Scoped-define SELF-NAME tb_comps
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tb_comps C-Win
ON VALUE-CHANGED OF tb_comps IN FRAME FRAME-A /* Print Components? */
DO:
  assign {&self-name}.
END.
...
&Scoped-define SELF-NAME tb_prt-last
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tb_prt-last C-Win
ON VALUE-CHANGED OF tb_prt-last IN FRAME FRAME-A /* Print Last Ship Date? */
DO:
  assign {&self-name}.
  IF {&self-name} THEN ASSIGN lv-ornt:SCREEN-VALUE = "L"
...
&Scoped-define SELF-NAME tb_prt-qoh
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tb_prt-qoh C-Win
ON VALUE-CHANGED OF tb_prt-qoh IN FRAME FRAME-A /* Print Qty On-Hand? */
DO:
  assign {&self-name}.
  IF {&self-name} THEN ASSIGN lv-ornt:SCREEN-VALUE = "L"
                              lv-font-no:SCREEN-VALUE ="12".
...
ON CLOSE OF THIS-PROCEDURE DO:
   RUN disable_UI.
   {Advantzware/WinKit/closewindow-nonadm.i} /* added by script _nonAdm1.p on 03.28.2017 @ 10:43:03 am */
END.
...
/* security check need {methods/prgsecur.i} in definition section */
  ...
  END.
    ...
    {methods/setButton.i btn-cancel "Cancel"} /* added by script _nonAdm1Images.p on 03.28.2017 @ 10:43:46 am */
    {methods/setButton.i btn-ok "OK"} /* added by script _nonAdm1Images.p on 03.28.2017 @ 10:43:46 am */
    {Advantzware/WinKit/embedfinalize-nonadm.i} /* added by script _nonAdm1.p on 03.28.2017 @ 10:43:03 am */
...
------------------------------------------------------------------------------*/
  DISPLAY begin_cust-no end_cust-no begin_ord-no end_ord-no begin_i-no end_i-no 
          ...
          rd_sort tb_comps tb_prt-qoh tb_prt-last rd_print2 tg-print-due 
          rs-item-option rd_print3 lv-ornt rd-dest lines-per-page lv-font-no 
  ...
  ENABLE begin_cust-no end_cust-no begin_ord-no end_ord-no begin_i-no end_i-no 
         begin_loc end_loc begin_slsmn end_slsmn begin_date end_date RECT-6 
         begin_carr RECT-7 end_carr begin_cat RECT-16 end_cat tb_scheduled 
         RECT-17 tb_late tb_invoiceable RECT-18 tb_actual tb_backordered 
         tb_posted tb_invoice tb_completed tb_subt rd_sort tb_comps tb_prt-qoh 
         tb_prt-last rd_print2 tg-print-due rs-item-option rd_print3 lv-ornt 
