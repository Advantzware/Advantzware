...
------------------------------------------------------------------------------*/
   ...
   IF (v-print-bol AND v-print-fmt <> "SouthPak-XL" AND v-print-fmt <> "Prystup-Excel") OR
      (NOT v-print-bol AND v-coc-fmt <> "Unipak-XL" AND v-coc-fmt <> "ACPI" AND v-coc-fmt <> "CCC" AND v-coc-fmt <> "CCCWPP") THEN
      case rd-dest:
  ...
  IF IS-xprint-form THEN DO:
      ...
      CASE rd-dest:
          ...
          WHEN 5 THEN do:
              ...
              ELSE IF v-print-fmt EQ "Carded" THEN PUT "<PREVIEW><LEFT=4mm><PDF-LEFT=4mm><PDF-OUTPUT=" + lv-pdf-file + ".pdf>" FORM "x(180)".
...
/*IF IS-xprint-form THEN */  DO:
    CASE rd-dest:
        WHEN 1 THEN do:
             IF v-print-fmt EQ "CCC" OR  v-print-fmt EQ "CCCWPP" OR v-print-fmt EQ "Carded" THEN
                 PUT  "<PRINTER?><LEFT=4mm>".
             ELSE
                PUT  "<PRINTER?>".
        END.
  ...
  do:
    ...
    IF IS-xprint-form THEN DO:
      IF v-print-fmt = "Century"                     /*<PDF-LEFT=5mm><PDF-TOP=10mm>*/
        ...
        ELSE IF v-print-fmt EQ "Carded" THEN PUT "<PREVIEW><LEFT=4mm><PDF-LEFT=4mm><PDF-OUTPUT=" + lv-pdf-file + vcBOLNums + ".pdf>" FORM "x(180)".
