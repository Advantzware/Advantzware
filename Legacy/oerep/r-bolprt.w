...
/* security check need {methods/prgsecur.i} in definition section */
  ...
  IF v-print-fmt EQ "XPRINT"   OR
     ...
     v-print-fmt EQ "bolfmt 10-CAN"   OR
  ...
  DO WITH FRAME {&FRAME-NAME}:
    ...
    IF LOOKUP(v-print-fmt,"SouthPak,Xprint,bolfmt 1,bolfmt 10,bolfmt 10-CAN,Lakeside,Soule,SouleMed,Accordbc,Protagon,Xprint2,bolfmt 2,bolfmt 20,Chillicothe,NSTOCK,Frankstn,Fibre,Ottpkg,Consbox,CapitolBC,ContSrvc,CapCityIN,Axis,Allwest,COLOR,AllPkg2,Loylang,Printers,Printers2,PEACHTREE,PeachTreeBC,Multicell") LE 0 THEN DO:
