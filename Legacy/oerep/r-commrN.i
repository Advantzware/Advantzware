       ...
       DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
         ...
         ELSE DO: 
            ...
            CASE cTmpField: 
                 ...
                 WHEN "basis" THEN cVarValue = IF AVAIL sman THEN string(sman.commbasis,"x(1)") ELSE "".
                 WHEN "ttl-cst" THEN cVarValue = IF AVAIL ar-invl THEN string(ar-invl.cost,"->>>,>>>,>>9.99") ELSE "". 
         ...
         DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
           cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
              ...
              CASE cTmpField:
                   ...
                   WHEN "amt" THEN cVarValue = string(v-tot-samt[1],"->>>>>>>9.99").
                   WHEN "cash-date" THEN cVarValue = "".
                   WHEN "amtp" THEN cVarValue = string(v-tot-pamt[1],"->>>>>>>9.99").
                   WHEN "delta" THEN cVarValue = string(v-tot-damt[1],"->>>>>>>9.99") .
                   WHEN "v-gp" THEN cVarValue = string(v-gp,"->>>>>>>9.99").
                   WHEN "v-comm" THEN cVarValue = string(v-comm,"->>>9.99") .
                   WHEN "v-camt" THEN cVarValue = string(v-tot-camt[1],"->>>>>>>9.99").
                   WHEN "basis" THEN cVarValue = "".
         ...
         DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
           cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
              ...
              CASE cTmpField:
                   ...
                   WHEN "ord-no" THEN cVarValue = "" .
                   WHEN "qty" THEN cVarValue = "".
                   WHEN "amt" THEN cVarValue = string(v-tot-samt[2],"->>>>>>>9.99").
                   WHEN "cash-date" THEN cVarValue = "".
                   WHEN "amtp" THEN cVarValue = string(v-tot-pamt[2],"->>>>>>>9.99").
                   WHEN "delta" THEN cVarValue = string(v-tot-damt[2],"->>>>>>>9.99") .
                   WHEN "v-gp" THEN cVarValue = string(v-gp,"->>>>>>>9.99").
                   WHEN "v-comm" THEN cVarValue = string(v-comm,"->>>9.99") .
         ...
         DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
           cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
              ...
              CASE cTmpField:
                   ...
                   WHEN "ord-no" THEN cVarValue = "" .
                   WHEN "qty" THEN cVarValue = "".
                   WHEN "amt" THEN cVarValue = string(v-tot-samt[3],"->>>>>>>9.99").
                   WHEN "cash-date" THEN cVarValue = "".
                   WHEN "amtp" THEN cVarValue = string(v-tot-pamt[3],"->>>>>>>9.99").
                   WHEN "delta" THEN cVarValue = string(v-tot-damt[3],"->>>>>>>9.99") .
                   WHEN "v-gp" THEN cVarValue = string(v-gp,"->>>>>>>9.99").
                   WHEN "v-comm" THEN cVarValue = string(v-comm,"->>>9.99") .
