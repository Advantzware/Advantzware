...
rd_inv rd_gp tb_prep tb_detailed tb_calc lv-ornt lines-per-page rd-dest ~
lv-font-no td-show-parm tb_excel tb_runExcel fi_file btn-ok btn-cancel 
&Scoped-Define DISPLAYED-OBJECTS begin_date end_date begin_slsmn end_slsmn ~
tb_cust-list begin_cust-no end_cust-no lbl_inv rd_inv lbl_delta rd_gp ~
tb_prep tb_detailed tb_calc lv-ornt lines-per-page rd-dest lv-font-no ~
...
DEFINE VARIABLE fi_file AS CHARACTER FORMAT "X(30)" INITIAL "c:~\tmp~\r-commcr.csv" 
     LABEL "If Yes, File Name" 
     VIEW-AS FILL-IN 
     SIZE 43 BY 1
     FGCOLOR 9 .

DEFINE VARIABLE lbl_delta AS CHARACTER FORMAT "X(256)":U INITIAL "Show?" 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE rd_gp AS CHARACTER 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "Delta", "Delta",
...
DEFINE FRAME FRAME-A
     begin_date AT ROW 2.52 COL 24 COLON-ALIGNED HELP
          "Enter Beginning Date"
     end_date AT ROW 2.52 COL 67 COLON-ALIGNED HELP
          "Enter Ending Date"
     begin_slsmn AT ROW 3.71 COL 24 COLON-ALIGNED HELP
          "Enter Beginning Sales Rep Number"
     end_slsmn AT ROW 3.71 COL 67 COLON-ALIGNED HELP
          "Enter Ending Sales Rep Number"
     tb_cust-list AT ROW 5.14 COL 26.2 WIDGET-ID 6
     btnCustList AT ROW 5.24 COL 59.6 WIDGET-ID 8
     begin_cust-no AT ROW 6.43 COL 24 COLON-ALIGNED HELP
          "Enter Beginning Customer Number"
     end_cust-no AT ROW 6.43 COL 67 COLON-ALIGNED HELP
          "Enter Ending Customer Number"
     lbl_inv AT ROW 8.38 COL 23 NO-LABEL
     rd_inv AT ROW 8.38 COL 40 NO-LABEL
     lbl_delta AT ROW 9.48 COL 21 COLON-ALIGNED NO-LABEL WIDGET-ID 8
     rd_gp AT ROW 9.57 COL 40 NO-LABEL
     tb_prep AT ROW 10.52 COL 40
     tb_detailed AT ROW 10.57 COL 23
     tb_calc AT ROW 11.71 COL 23
     lv-ornt AT ROW 13.71 COL 31 NO-LABEL
     lines-per-page AT ROW 13.71 COL 84 COLON-ALIGNED
     rd-dest AT ROW 14.14 COL 6 NO-LABEL
     lv-font-no AT ROW 14.95 COL 34 COLON-ALIGNED
     lv-font-name AT ROW 15.91 COL 28 COLON-ALIGNED NO-LABEL
     td-show-parm AT ROW 17.38 COL 30
     tb_excel AT ROW 18.95 COL 67.8 RIGHT-ALIGNED
     tb_runExcel AT ROW 18.95 COL 89.8 RIGHT-ALIGNED
     fi_file AT ROW 19.81 COL 45.8 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 21.48 COL 23
     btn-cancel AT ROW 21.48 COL 59
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 13.19 COL 4
...
/* SETTINGS FOR FILL-IN lbl_delta IN FRAME FRAME-A
   NO-ENABLE                                                            */
ASSIGN 
       lbl_delta:PRIVATE-DATA IN FRAME FRAME-A     = 
                "rd_gp".
...
/* SETTINGS FOR FILL-IN lv-font-name IN FRAME FRAME-A
   NO-ENABLE                                                            */
ASSIGN 
       rd_gp:PRIVATE-DATA IN FRAME FRAME-A     = 
                "parm".

ASSIGN 
       rd_inv:PRIVATE-DATA IN FRAME FRAME-A     = 
                "parm".

ASSIGN 
       tb_calc:PRIVATE-DATA IN FRAME FRAME-A     = 
                "parm".
...
&Scoped-define SELF-NAME rd_gp
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL rd_gp C-Win
ON VALUE-CHANGED OF rd_gp IN FRAME FRAME-A
DO:
  ASSIGN {&self-name}.
END.
...
/* security check need {methods/prgsecur.i} in definition section */
  ...
  DO WITH FRAME {&FRAME-NAME}:
    {methods/setButton.i btn-cancel "Cancel"} /* added by script _nonAdm1Images2.p on 04.07.2017 @  2:07:38 pm */
    {methods/setButton.i btn-ok "OK"} /* added by script _nonAdm1Images2.p on 04.07.2017 @  2:07:38 pm */
    {custom/usrprint.i}
...
------------------------------------------------------------------------------*/
  DISPLAY begin_date end_date begin_slsmn end_slsmn tb_cust-list begin_cust-no 
          end_cust-no lbl_inv rd_inv lbl_delta rd_gp tb_prep tb_detailed tb_calc 
          lv-ornt lines-per-page rd-dest lv-font-no lv-font-name td-show-parm 
          tb_excel tb_runExcel fi_file 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE RECT-6 RECT-7 begin_date end_date begin_slsmn end_slsmn tb_cust-list 
         btnCustList begin_cust-no end_cust-no rd_inv rd_gp tb_prep tb_detailed 
         tb_calc lv-ornt lines-per-page rd-dest lv-font-no td-show-parm 
...
DEF VAR v-amtd      LIKE ar-invl.amt.
...
DEF VAR ld-slsp     AS   DEC NO-UNDO.

DEF VAR v-tot-samt  AS   DEC FORMAT "->>>>>>>9.99" EXTENT 3.
DEF VAR v-tot-pamt  AS   DEC FORMAT "->>>>>>>9.99" EXTENT 3.
