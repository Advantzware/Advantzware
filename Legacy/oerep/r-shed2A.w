...
rd_qty tgl_custpart tg_set-comp-order rd-dest lv-ornt lines-per-page ~
lv-font-no td-show-parm tb_excel tb_runExcel fi_file btn-ok btn-cancel ~
RECT-6 RECT-7 RECT-9 RECT-10 
...
DEFINE VARIABLE tgl_custpart AS LOGICAL INITIAL no 
     LABEL "Cust Part #" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME FRAME-A
     ...
     end_date AT ROW 6.48 COL 70 COLON-ALIGNED HELP
          "Enter Ending Date"
     tb_scheduled AT ROW 8.86 COL 3
     tb_actual AT ROW 9.52 COL 3
     tb_late AT ROW 10.24 COL 3
     tb_backordered AT ROW 10.95 COL 3
     tb_invoiceable AT ROW 11.67 COL 3
     tb_posted AT ROW 8.86 COL 18
     tb_invoice AT ROW 9.52 COL 18
     tb_completed AT ROW 10.24 COL 18
     rd_sort AT ROW 8.86 COL 37.8 NO-LABEL
     tgl_notes AT ROW 8.86 COL 62.4
     fl_spcCd AT ROW 9.57 COL 72.2 COLON-ALIGNED
     rd_qty AT ROW 10.52 COL 62.2 NO-LABEL
     tgl_custpart AT ROW 11.81 COL 62.8
     tg_set-comp-order AT ROW 12.71 COL 62.8 WIDGET-ID 2
     rd-dest AT ROW 14.57 COL 3.2 NO-LABEL
     lv-ornt AT ROW 15.24 COL 29 NO-LABEL
     lines-per-page AT ROW 15.24 COL 82 COLON-ALIGNED
     lv-font-no AT ROW 16.95 COL 32 COLON-ALIGNED
     lv-font-name AT ROW 18.1 COL 26.6 COLON-ALIGNED NO-LABEL
     td-show-parm AT ROW 19.14 COL 28.6
     tb_excel AT ROW 20 COL 48.6 RIGHT-ALIGNED
     tb_runExcel AT ROW 20 COL 70.6 RIGHT-ALIGNED
     fi_file AT ROW 20.95 COL 26.6 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 22.33 COL 19
     btn-cancel AT ROW 22.33 COL 57
     "Print Options:" VIEW-AS TEXT
          SIZE 15 BY .71 AT ROW 7.81 COL 61.4
     "Sort Options:" VIEW-AS TEXT
          SIZE 15 BY .71 AT ROW 7.81 COL 35.2
     "Release Types:" VIEW-AS TEXT
          SIZE 15 BY .71 AT ROW 7.81 COL 2.8
     ...
     RECT-9 AT ROW 7.86 COL 59.2
     RECT-10 AT ROW 7.86 COL 33.6
...
ASSIGN
       RECT-6:PRIVATE-DATA IN FRAME FRAME-A     = 
                "ribbon-button".
...
------------------------------------------------------------------------------*/
  DISPLAY begin_cust-no end_cust-no begin_ship end_ship begin_ord-no end_ord-no 
          ...
          tb_invoice tb_completed rd_sort tgl_notes fl_spcCd rd_qty tgl_custpart 
          tg_set-comp-order rd-dest lv-ornt lines-per-page lv-font-no 
