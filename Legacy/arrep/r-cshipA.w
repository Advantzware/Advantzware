...
DEFINE FRAME FRAME-A
     tb_cust-list AT ROW 3.71 COL 34.8 WIDGET-ID 6
     btnCustList AT ROW 3.76 COL 67.2 WIDGET-ID 8
     begin_cust-no AT ROW 5.43 COL 27 COLON-ALIGNED HELP
          "Enter Beginning Customer Number"
     end_cust-no AT ROW 5.43 COL 66 COLON-ALIGNED HELP
     ...
     td-show-parm AT ROW 14.76 COL 30
     tb_excel AT ROW 16.76 COL 50 RIGHT-ALIGNED
     tb_runExcel AT ROW 16.76 COL 71 RIGHT-ALIGNED
     fi_file AT ROW 17.57 COL 28 COLON-ALIGNED HELP
          "Enter File Name"
...
DO:
   apply "close" to this-procedure.
    {Advantzware/WinKit/winkit-panel-triggerend.i} /* added by script _nonAdm1.p on 03.28.2017 @ 10:42:42 am */
END.
...
ON CLOSE OF THIS-PROCEDURE DO:
   RUN disable_UI.
   {Advantzware/WinKit/closewindow-nonadm.i} /* added by script _nonAdm1.p on 03.28.2017 @ 10:42:42 am */
END.
...
/* security check need {methods/prgsecur.i} in definition section */
  ...
  IF ou-log AND ou-cust-int = 0 THEN do:
   ...
   END.
    ...
    {Advantzware/WinKit/embedfinalize-nonadm.i} /* added by script _nonAdm1.p on 03.28.2017 @ 10:42:42 am */
...
------------------------------------------------------------------------------*/
  DISPLAY tb_cust-list begin_cust-no end_cust-no rd-dest lv-ornt lines-per-page 
