...
ASSIGN cTextListToSelect = "Company,Location,Carrier,Carr Desc.,Delivery Zone,Del Zone Desc," +
...
{sys/inc/ttRptSel.i}
ASSIGN cTextListToDefault  = "Company,Location,Carrier,Carr Desc.,Delivery Zone,Del Zone Desc," +
                           "Zip Code,Minimum Rate" .
...
DEFINE FRAME FRAME-A
     ...
     sl_avail AT ROW 6.91 COL 4.8 NO-LABEL WIDGET-ID 26
     Btn_Def AT ROW 6.91 COL 40.8 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 56
     sl_selected AT ROW 6.91 COL 60.2 NO-LABEL WIDGET-ID 28
     ...
     td-show-parm AT ROW 17.19 COL 30.4
     ...
     fi_file AT ROW 19.91 COL 28.2 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 22.05 COL 21
     btn-cancel AT ROW 22.05 COL 57
     "Available Columns" VIEW-AS TEXT
          SIZE 29 BY .62 AT ROW 6.19 COL 5.6 WIDGET-ID 38
...
ASSIGN 
       end_carr-no:PRIVATE-DATA IN FRAME FRAME-A     = 
                "parm".
...
DO:
   apply "close" to this-procedure.
    {Advantzware/WinKit/winkit-panel-triggerend.i} /* added by script _nonAdm1.p on 03.28.2017 @ 10:42:41 am */
END.
...
ON CLOSE OF THIS-PROCEDURE DO:
   RUN disable_UI.
   {Advantzware/WinKit/closewindow-nonadm.i} /* added by script _nonAdm1.p on 03.28.2017 @ 10:42:41 am */
END.
...
/* security check need {methods/prgsecur.i} in definition section */
  ...
  END.
    ...
    {methods/setButton.i btn-cancel "Cancel"} /* added by script _nonAdm1Images.p on 03.28.2017 @ 10:43:27 am */
    {methods/setButton.i btn-ok "OK"} /* added by script _nonAdm1Images.p on 03.28.2017 @ 10:43:27 am */
    {Advantzware/WinKit/embedfinalize-nonadm.i} /* added by script _nonAdm1.p on 03.28.2017 @ 10:42:41 am */
...
def var fcarr as ch initial "000000" NO-UNDO.
def var tcarr like fcarr initial "ZZZZZZ" NO-UNDO.
def var detailed as logical format "Yes/No" initial NO NO-UNDO.
...
ASSIGN var-print-four-spaces = YES.
  ...
  for each carr-mtx
    ...
    */
      ...
      ASSIGN var-print-four-spaces = NO.
      ASSIGN cDisplay = ""
                   cTmpField = ""
                   cVarValue = ""
                   cExcelDisplay = ""
            ...
            DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
               cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                    CASE cTmpField:             
                         WHEN "comp"    THEN cVarValue = string(carrier.company) .
                         WHEN "loc"   THEN cVarValue = string(carrier.loc).
                         WHEN "carr"   THEN cVarValue = STRING(carrier.carrier).
                         WHEN "carr-desc"  THEN cVarValue = STRING(carrier.dscr ,"x(25)") .
                         WHEN "del-zon"   THEN cVarValue = STRING(carr-mtx.del-zone) .
                         WHEN "del-zon-desc"  THEN cVarValue = STRING(carr-mtx.del-dscr,"x(20)") .
                         WHEN "zip-code"   THEN cVarValue = STRING(carr-mtx.del-zip,"x(11)") .
                         WHEN "min-rat"  THEN cVarValue = STRING(carr-mtx.min-rate,">,>>>,>>9.99") .
  ...
  END.
    IF var-print-four-spaces THEN DO:
        ASSIGN cDisplay = ""
                   cTmpField = ""
                   cVarValue = ""
                   cExcelDisplay = ""
            ...
            DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
               cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                    CASE cTmpField:             
                         ...
                         WHEN "carr"   THEN cVarValue = STRING(carrier.carrier).
                         WHEN "carr-desc"  THEN cVarValue = STRING(carrier.dscr ,"x(25)") .
                         WHEN "del-zon"   THEN cVarValue = "" .
                         WHEN "del-zon-desc"  THEN cVarValue = "" .
                         WHEN "zip-code"   THEN cVarValue = "" .
                         WHEN "min-rate"  THEN cVarValue = "" .
