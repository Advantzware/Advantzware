...
end_slsmn tb_active tb_inactive rd_sort rd-dest lv-ornt lines-per-page ~
...
begin_cust-type end_cust-type begin_slsmn end_slsmn tb_active tb_inactive ~
...
DEFINE FRAME FRAME-A
     ...
     tb_active AT ROW 7.43 COL 56 RIGHT-ALIGNED
     tb_inactive AT ROW 8.62 COL 57 RIGHT-ALIGNED
     lbl_sort AT ROW 10.05 COL 29 COLON-ALIGNED NO-LABEL
     rd_sort AT ROW 10.05 COL 38 NO-LABEL
     ...
     tb_show-parm AT ROW 17.67 COL 31
     tb_excel AT ROW 19.19 COL 51 RIGHT-ALIGNED
     tb_runExcel AT ROW 19.19 COL 73.2 RIGHT-ALIGNED
     fi_file AT ROW 20.05 COL 29 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 21.52 COL 24
     btn-cancel AT ROW 21.52 COL 56
...
/* security check need {methods/prgsecur.i} in definition section */
  ...
  RUN sys/inc/CustListForm.p ( "AR12",cocode, 
                               OUTPUT ou-log,
                               OUTPUT ou-cust-int) .
...
------------------------------------------------------------------------------*/
  DISPLAY tb_cust-list begin_cust-no end_cust-no begin_cust-type end_cust-type 
          begin_slsmn end_slsmn tb_active tb_inactive lbl_sort rd_sort rd-dest 
  ...
  ENABLE RECT-6 RECT-7 tb_cust-list btnCustList begin_cust-no end_cust-no 
         begin_cust-type end_cust-type begin_slsmn end_slsmn tb_active 
         tb_inactive rd_sort rd-dest lv-ornt lines-per-page lv-font-no 
