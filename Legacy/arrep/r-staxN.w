...
ASSIGN cTextListToSelect = "Group,Code,Description,Rate,G/L Account#"
...
{sys/inc/ttRptSel.i}
ASSIGN cTextListToDefault  = "Group,Code,Description,Rate,G/L Account#" .
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE VARIABLE fi_file AS CHARACTER FORMAT "X(30)" INITIAL "c:~\tmp~\r-stax.csv" 
...
DEFINE FRAME FRAME-A
     ...
     sl_avail AT ROW 5.19 COL 4.4 NO-LABEL WIDGET-ID 26
     Btn_Def AT ROW 5.19 COL 40.4 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 56
     sl_selected AT ROW 5.19 COL 59.8 NO-LABEL WIDGET-ID 28
     Btn_Add AT ROW 6.19 COL 40.4 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 32
     Btn_Remove AT ROW 7.19 COL 40.4 HELP
          "Remove Selected Table from Tables to Audit" WIDGET-ID 34
     btn_Up AT ROW 8.24 COL 40.4 WIDGET-ID 40
     btn_down AT ROW 9.24 COL 40.4 WIDGET-ID 42
     rd-dest AT ROW 11.71 COL 8 NO-LABEL
     ...
     "Selected Columns(In Display Order)" VIEW-AS TEXT
          SIZE 34 BY .62 AT ROW 4.48 COL 59.8 WIDGET-ID 44
     ...
     "Available Columns" VIEW-AS TEXT
          SIZE 29 BY .62 AT ROW 4.48 COL 5.2 WIDGET-ID 38
...
ASSIGN 
       end_stax-gr:PRIVATE-DATA IN FRAME FRAME-A     = 
                "parm".
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
 ...
 RUN enable_UI.
  ...
  END.
    ...
    {methods/setButton.i btn-cancel "Cancel"} /* added by script _nonAdm1Images.p on 03.28.2017 @ 10:43:29 am */
    {methods/setButton.i btn-ok "OK"} /* added by script _nonAdm1Images.p on 03.28.2017 @ 10:43:29 am */
...
------------------------------------------------------------------------------*/
  DISPLAY begin_stax-gr end_stax-gr sl_avail sl_selected rd-dest lv-ornt 
...
def var ftax as CHAR NO-UNDO.
def var ttax like ftax NO-UNDO.
def var i as int NO-UNDO.
DEF VAR l-codes-exist AS LOGICAL NO-UNDO.
...
DEF VAR v-tax-code AS CHA NO-UNDO.
DEF VAR v-tax-dscr AS CHA NO-UNDO.
DEF VAR v-tax-rate AS DEC NO-UNDO.
DEF VAR v-tax-acc  AS CHA NO-UNDO.
     ...
     /*    DISPLAY stax.tax-code1[i]
         ...
         DO j = 1 TO NUM-ENTRIES(cSelectedlist):                             
            cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(j,cSelectedList)), cFieldListToSelect).
                 CASE cTmpField: 
                      WHEN "grp"    THEN cVarValue = IF i = 1 THEN STRING(stax.tax-group) ELSE "" .
                      WHEN "cod"    THEN cVarValue = string(stax.tax-code1[i]) .
                      WHEN "dscr"   THEN cVarValue = string(stax.tax-dscr1[i]) .
                      WHEN "rate"   THEN cVarValue = string(stax.tax-rate1[i],">>>9.99999") .
                      WHEN "act"    THEN cVarValue = string(stax.tax-acc1[i]) .
