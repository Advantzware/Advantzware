...
end_date rd_sort lv-ornt lines-per-page rd-dest lv-font-no td-show-parm ~
tb_excel tb_runExcel fi_file btn-ok btn-cancel 
&Scoped-Define DISPLAYED-OBJECTS begin_cust end_cust begin_date end_date ~
lbl_sort rd_sort lv-ornt lines-per-page rd-dest lv-font-no lv-font-name ~
...
DEFINE FRAME FRAME-A
     ...
     begin_date AT ROW 3.86 COL 28 COLON-ALIGNED HELP
          "Enter Beginning Receipt Date"
     end_date AT ROW 3.86 COL 71 COLON-ALIGNED HELP
...
------------------------------------------------------------------------------*/
  DISPLAY begin_cust end_cust begin_date end_date lbl_sort rd_sort lv-ornt 
          lines-per-page rd-dest lv-font-no lv-font-name td-show-parm tb_excel 
          tb_runExcel fi_file 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE RECT-6 RECT-7 begin_cust end_cust begin_date end_date rd_sort lv-ornt 
