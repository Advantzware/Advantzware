...
end_cust begin_date end_date tb_reprint tb_posted tb_export ~
rd-dest td-show-parm tb_batchmail tb_email-orig tb_AttachBOL btn-ok ~
btn-cancel 
&Scoped-Define DISPLAYED-OBJECTS begin_inv end_inv begin_cust end_cust ~
begin_date end_date tb_reprint tb_posted tb_export lv-ornt ~
lines-per-page rd-dest lv-font-no lv-font-name td-show-parm tb_batchmail ~
tb_email-orig tb_AttachBOL 
...
DEFINE FRAME FRAME-A
     ...
     tb_batchmail AT ROW 18.62 COL 57 WIDGET-ID 22
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    */
    ...
    IF LOOKUP(v-print-fmt,"PremierX,Coburn,Axis,BlueRx,ColoniaX,ABC,knight,knight1,Central,Rosmar,ACPI,ColorX,ColonialLot#,Carded,CCCFGLot,CCCFGL3,Peachtreefgl3,Peachtree,PremierS") > 0 THEN 
    DO:
        ASSIGN 
...
/*------------------------------------------------------------------------------
    ...
    DO:
        ...
        FOR EACH  b1-ar-inv
            ...
            FIRST b2-cust OF b1-ar-inv WHERE (b2-cust.log-field[1] OR NOT tb_Batchmail ) NO-LOCK                    
        ...
        FOR EACH b1-inv-head
            ...
            AND (b2-cust.log-field[1] OR NOT tb_Batchmail )
            ...
            DO:
                ...
                vSoldToNo = "".
                IF b1-inv-head.multi-invoice THEN 
                DO: 
...
------------------------------------------------------------------------------*/
  DISPLAY begin_inv end_inv begin_cust end_cust begin_date end_date tb_reprint 
          tb_posted tb_export tb_BatchMail lv-ornt lines-per-page rd-dest 
          lv-font-no lv-font-name td-show-parm tb_batchmail tb_email-orig 
          tb_AttachBOL 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE RECT-6 RECT-7 begin_inv end_inv begin_cust end_cust begin_date 
         end_date tb_reprint tb_posted tb_export tb_BatchMail rd-dest 
         td-show-parm tb_batchmail tb_email-orig tb_AttachBOL btn-ok 
         btn-cancel 
      WITH FRAME FRAME-A IN WINDOW C-Win.
               ...
               INDEX(vcHoldStats, buf-inv-head.stat) EQ 0 AND 
                    ...
                    DO:
                        ...
                        ASSIGN 
                            vSoldToNo = ""
                            vShipToNo = "".
                        IF buf-inv-head.multi-invoice THEN 
                        DO: 
                            FIND FIRST b2-inv-head 
    ...
    FOR EACH ar-inv
        ...
        */
        ...
        FOR EACH ar-invl NO-LOCK 
            ...
            IF FIRST-OF(ar-invl.bol-no) THEN 
            DO:    
