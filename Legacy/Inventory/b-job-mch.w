...
/*------------------------------------------------------------------------
  ...
  File: inventory\b-job-mch.w

  Description: SmartBrowser for job-mch table
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY {&SELF-NAME} FOR EACH job-mch WHERE job-mch.company = job.company ~   AND job-mch.job = job.job ~   AND job-mch.job-no = job.job-no ~   AND job-mch.job-no2 = job.job-no2 ~ USE-INDEX line-idx NO-LOCK     ~{&SORTBY-PHRASE}.
...
/* Query rebuild information for BROWSE br_table
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH job-mch
WHERE job-mch.company = job.company ~
