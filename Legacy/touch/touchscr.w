...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "AdvantzWare Touch Screen"
         HEIGHT             = 12.95
         WIDTH              = 124
         MAX-HEIGHT         = 12.95
         MAX-WIDTH          = 124
...
ON END-ERROR OF W-Win /* AdvantzWare Touch Screen */
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'touch/touchfrm.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_touchfrm ).
       RUN set-position IN h_touchfrm ( 1.00 , 1.00 ) NO-ERROR.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Close_Touch_Screen W-Win 
PROCEDURE Close_Touch_Screen :
/*------------------------------------------------------------------------------
  Purpose:     apply close to this window
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Set_Title W-Win 
PROCEDURE Set_Title :
/*------------------------------------------------------------------------------
  Purpose:     set window title
  Parameters:  INPUT window title
  Notes:       
------------------------------------------------------------------------------*/
  DEFINE INPUT PARAMETER window_title AS CHARACTER NO-UNDO.

  /* stub to change title to different language using REPLACE(window_title)
