...
btn-sht-calc btn-stds btn-copy 
...
DEFINE FRAME Panel-Frame
     ...
     btn-sht-calc AT ROW 1.24 COL 47
     btn-stds AT ROW 1.24 COL 62
     btn-copy AT ROW 1.24 COL 77
...
DO:
  DO WITH FRAME Panel-Frame:
     ...
     btn-save:label = "&Save" .
     assign btn-auto-calc:sensitive = no
...
DO:
  DO WITH FRAME Panel-Frame:
      add-active = no.
      assign btn-auto-calc:sensitive = yes
...
DO:
  DO WITH FRAME Panel-Frame:
     ...
     enable btn-cancel with frame {&frame-name}.
     btn-save:label = "&Save" .
     disable btn-sht-calc btn-auto-calc btn-bom with frame {&frame-name}.
