...
&Scoped-define QUERY-STRING-Browser-Table FOR EACH prep WHERE ~{&KEY-PHRASE} ~
    ...
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Browser-Table OPEN QUERY Browser-Table FOR EACH prep WHERE ~{&KEY-PHRASE} ~
      AND prep.company = gcompany NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Browser-Table prep
&Scoped-define FIRST-TABLE-IN-QUERY-Browser-Table prep
