...
&Scoped-define ENABLED-FIELDS-IN-QUERY-Browser-Table reftable.code ~
reftable.dscr reftable.val[1] reftable.code2 
...
DEFINE QUERY Browser-Table FOR 
      reftable
    FIELDS(reftable.code
      reftable.dscr
      reftable.val[1]
      reftable.code2) SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      reftable.code FORMAT "x(8)":U
      reftable.dscr FORMAT "x(30)":U
      reftable.val[1] COLUMN-LABEL "Thickness" FORMAT ">>9.9999":U
      reftable.code2 COLUMN-LABEL "SW/DW/TW" FORMAT "X(2)":U
  ENABLE
      reftable.code
      reftable.dscr
      reftable.val[1]
...
/* Query rebuild information for BROWSE Browser-Table
     ...
     _TblOptList       = "USED"
     _Where[1]         = "ASI.reftable.reftable = ""FLUTE""
 AND ASI.reftable.company = """"
 AND ASI.reftable.loc = """""
     _FldNameList[1]   > ASI.reftable.code
"reftable.code" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > ASI.reftable.dscr
"reftable.dscr" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[3]   > ASI.reftable.val[1]
"reftable.val[1]" "Thickness" ">>9.9999" "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[4]   > ASI.reftable.code2
"reftable.code2" "SW/DW/TW" "X(2)" "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
...
------------------------------------------------------------------------------*/
  ...
  assign reftable.company = ""
         reftable.loc = ""
         reftable.reftable = "FLUTE" .
