...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH usr-menu ~
      WHERE usr-menu.user_id = userid('nosweat') NO-LOCK ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      usr-menu.menu-num COLUMN-FONT 0
      usr-menu.descrip COLUMN-FONT 0
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 82 BY 17.14
         FONT 0.
...
/* Query rebuild information for BROWSE br_table
     ...
     _Options          = "NO-LOCK"
     _OrdList          = "ASI.usr-menu.menu-num|yes"
     _Where[1]         = "ASI.usr-menu.user_id = userid('nosweat')"
     _FldNameList[1]   > ASI.usr-menu.menu-num
"menu-num" ? ? "integer" ? ? 0 ? ? ? no ?
     _FldNameList[2]   > ASI.usr-menu.descrip
"descrip" ? ? "character" ? ? 0 ? ? ? no ?
