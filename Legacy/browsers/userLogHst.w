...
DEFINE VARIABLE fiEndingDate AS DATE FORMAT "99/99/9999":U 
     LABEL "Ending Date" 
     VIEW-AS FILL-IN 
     SIZE 16 BY 1
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE fiStartingDate AS DATE FORMAT "99/99/9999":U 
     LABEL "Starting Date" 
     VIEW-AS FILL-IN 
     SIZE 16 BY 1
     BGCOLOR 15  NO-UNDO.
...
/* BROWSE-TAB Browser-Table btSearch F-Main */
ASSIGN 
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
    ASSIGN fiStartingDate fiEndingDate.
    ASSIGN
           dtStartDate = DATETIME(fiStartingDate)
           dtEndDate   = DATETIME(fiEndingDate).
  END.
