...
&Scoped-define INTERNAL-TABLES phone rec_key prgmxref
...
phone.fax_ctry_code phone.fax_city_code phone.fax rec_key.table_name ~
prgmxref.prgmname 
&Scoped-define ENABLED-FIELDS-IN-QUERY-Browser-Table 
&Scoped-define QUERY-STRING-Browser-Table FOR EACH phone WHERE ~{&KEY-PHRASE} ~
      AND attention CONTAINS word_search OR word_search = '' NO-LOCK, ~
      EACH rec_key OF phone NO-LOCK, ~
...
&Scoped-define OPEN-QUERY-Browser-Table OPEN QUERY Browser-Table FOR EACH phone WHERE ~{&KEY-PHRASE} ~
      ...
      EACH prgmxref OF rec_key NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Browser-Table phone rec_key prgmxref
...
&Scoped-Define ENABLED-OBJECTS Btn_Run Btn_Search Browser-Table ~
  word_search 
