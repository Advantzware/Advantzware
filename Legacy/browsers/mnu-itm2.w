...
&Scoped-Define ENABLED-OBJECTS RECT-41 br_table btn-clear lv-search 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      mnu-item.menu-num
      mnu-item.descrip COLUMN-LABEL "Program!Description"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* BROWSE-TAB br_table RECT-41 F-Main */
ASSIGN 
...
"mnu-item.descrip" "Program!Description" ? "character" ? ? ? ? ? ? no ?
