...
DEF VAR ip-header_value AS cha NO-UNDO.
...
and notes.note_group = ip-header_value NO-LOCK ~
    ~{&SORTBY-PHRASE}
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      ...
      notes.note_title FORMAT "X(60)":U
...
DEFINE FRAME F-Main
     ...
     auto_find AT ROW 17.91 COL 58 COLON-ALIGNED HELP
...
and ASI.notes.note_group = ip-header_value"
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute PRIOR to standard behavior. */
   {methods/run_link.i "CONTAINER-SOURCE" "Get-ip-header_value" "(OUTPUT ip-header_value)"}
