...
&Scoped-define INTERNAL-TABLES scoreType
...
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-Browser-Table scoreType
&Scoped-define QUERY-STRING-Browser-Table FOR EACH scoreType WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Browser-Table OPEN QUERY Browser-Table FOR EACH scoreType WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Browser-Table scoreType
&Scoped-define FIRST-TABLE-IN-QUERY-Browser-Table scoreType
...
DEFINE QUERY Browser-Table FOR 
      scoreType
    FIELDS(scoreType.scoreType
      scoreType.description) SCROLLING.
&ANALYZE-RESUME
