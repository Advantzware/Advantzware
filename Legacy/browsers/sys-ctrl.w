...
&Scoped-define QUERY-STRING-Browser-Table FOR EACH sys-ctrl WHERE ~{&KEY-PHRASE} ~
    ...
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Browser-Table OPEN QUERY Browser-Table FOR EACH sys-ctrl WHERE ~{&KEY-PHRASE} ~
      AND sys-ctrl.company = g_company NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Browser-Table sys-ctrl
&Scoped-define FIRST-TABLE-IN-QUERY-Browser-Table sys-ctrl
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      ...
      sys-ctrl.module COLUMN-LABEL "Sys!Mod" FORMAT "x(5)":U WIDTH 4
            LABEL-BGCOLOR 14
      sys-ctrl.int-fld COLUMN-LABEL "Int!Val" FORMAT "->,>>>,>>9":U
            WIDTH 6.2 LABEL-BGCOLOR 14
      sys-ctrl.dec-fld COLUMN-LABEL "Dec!val" FORMAT "->>,>>9.99":U
            WIDTH 8.2 LABEL-BGCOLOR 14
      sys-ctrl.char-fld COLUMN-LABEL "Character!Value" FORMAT "x(9)":U
...
DEFINE FRAME F-Main
     ...
     fi_sortby AT ROW 18.86 COL 84 COLON-ALIGNED NO-LABEL
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE print-sys-ctl B-table-Win 
PROCEDURE print-sys-ctl :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
RUN windows/r-sysctl.w(INPUT sys-ctrl.NAME,
                       INPUT sys-ctrl.module). 
