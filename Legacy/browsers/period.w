...
/* Connected Databases 
          asi              PROGRESS
*/
&Scoped-define WINDOW-NAME B-table-Win
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CUSTOM _DEFINITIONS B-table-Win 
/*------------------------------------------------------------------------

  File:  browsers/period.w
...
&Scoped-define QUERY-STRING-Browser-Table FOR EACH period OF company WHERE ~{&KEY-PHRASE} ~
      AND ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Browser-Table OPEN QUERY Browser-Table FOR EACH period OF company WHERE ~{&KEY-PHRASE} ~
      AND ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      ...
      period.pst FORMAT "99/99/9999":U
      period.pend FORMAT "99/99/9999":U
      period.pstat FORMAT "Open/Closed":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 86 BY 16.19
         FONT 2.
...
&ANALYZE-RESUME
ASSIGN B-table-Win = CURRENT-WINDOW.
