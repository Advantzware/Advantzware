...
ON END-ERROR OF W-Win /* zMessage */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* zMessage */
    DO:
        ...
        WHEN 0 THEN 
            DO:
                ...
                RUN init-object IN THIS-PROCEDURE (
                    ...
                    INPUT  'FOLDER-LABELS = ':U + 'Browse Message|View Message' + ',
                     FOLDER-TAB-TYPE = 1':U ,
                    OUTPUT h_folder ).
        ...
        WHEN 2 THEN 
            DO:
                ...
                RUN init-object IN THIS-PROCEDURE (
                    ...
                    OUTPUT h_p-updsav ).
                RUN set-position IN h_p-updsav ( 20.57 , 68.00 ) NO-ERROR.
