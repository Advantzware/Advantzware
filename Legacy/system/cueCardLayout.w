...
DEFINE VARIABLE cOrientation AS CHARACTER NO-UNDO INITIAL
    "nav_up_left,nav_up,nav_up_right,nav_right,nav_down_right,nav_down,nav_down_left,nav_left".
DEFINE VARIABLE iPosition    AS INTEGER   NO-UNDO.
DEFINE VARIABLE cPosition    AS CHARACTER NO-UNDO INITIAL
    "arrow_join,arrow_up_left,arrow_up,arrow_up_right,arrow_right,arrow_down_right,arrow_down,arrow_down_left,arrow_left".
...
&Scoped-Define ENABLED-OBJECTS positionImage arrowImage nextCue prevCue ~
cCueText dontShowAgain gotIt 
&Scoped-Define DISPLAYED-OBJECTS cCueText dontShowAgain gotIt 
...
DEFINE VARIABLE cCueText AS CHARACTER 
     VIEW-AS EDITOR
     SIZE 44 BY 10.48 NO-UNDO.

DEFINE IMAGE arrowImage
     FILENAME "Graphics/48x48/nav_up_left.png":U TRANSPARENT
     SIZE 10 BY 2.38.

DEFINE IMAGE nextCue
     FILENAME "Graphics/48x48/navigate_right.png":U TRANSPARENT
     SIZE 10 BY 2.38.
...
DEFINE IMAGE prevCue
     FILENAME "Graphics/48x48/navigate_left.png":U TRANSPARENT
     SIZE 10 BY 2.38.
...
DEFINE FRAME DEFAULT-FRAME
     cCueText AT ROW 3.62 COL 12 NO-LABEL WIDGET-ID 10
     dontShowAgain AT ROW 14.33 COL 22 WIDGET-ID 38
     gotIt AT ROW 15.29 COL 29 WIDGET-ID 16
     RECT-1 AT ROW 1 COL 1 WIDGET-ID 42
     positionImage AT ROW 3.86 COL 4 WIDGET-ID 44
     arrowImage AT ROW 1.24 COL 2 WIDGET-ID 2
     nextCue AT ROW 14.1 COL 46 WIDGET-ID 12
     prevCue AT ROW 14.1 COL 12 WIDGET-ID 14
...
DO:
    ...
    iOrientation = 1.
    arrowImage:LOAD-IMAGE("Graphics\48x48\" + ENTRY(iOrientation,cOrientation) + ".png").
END.
...
------------------------------------------------------------------------------*/
  DISPLAY cCueText dontShowAgain gotIt 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE positionImage arrowImage nextCue prevCue cCueText dontShowAgain gotIt 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
...
------------------------------------------------------------------------------*/
    ...
    DO WHILE VALID-HANDLE(hWidget):
        IF hWidget:TYPE NE "Rectangle" THEN
        ASSIGN 
