...
IF SSPostFGConTags-log THEN DO:
  ...
  wid-hdl = WIDGET-HANDLE(char-hdl) NO-ERROR.

  /* auto-post does not exist in b-rcptd.w */
  IF VALID-HANDLE(wid-hdl) AND NOT INDEX(wid-hdl:NAME, "b-rcptd") GT 0 
      AND NOT INDEX(wid-hdl:NAME, "b-trans") GT 0 
      AND NOT INDEX(wid-hdl:NAME, "b-trnss") GT 0 THEN DO:
