...
ASSIGN cTextListToSelect = "MACHINE,PROMISED/JOB DATE,CUSTOMER,CUSTOMER PART #,JOB #,"
...
{sys/inc/ttRptSel.i}
ASSIGN cTextListToDefault  = "MACHINE,PROMISED/JOB DATE,CUSTOMER,CUSTOMER PART #,JOB #,"
                   + "TOTAL KICKS,KICKS REMAINING,MSF BALANCE,SHEET SIZE,BOARD RECE." .
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME FRAME-A
     ...
     end_job-no2 AT ROW 5.05 COL 78 COLON-ALIGNED HELP
          "Enter Ending Job Number"
     sl_avail AT ROW 7.48 COL 4.6 NO-LABEL WIDGET-ID 26
     Btn_Def AT ROW 7.48 COL 40.6 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 56
     sl_selected AT ROW 7.48 COL 60 NO-LABEL WIDGET-ID 28
     ...
     rd-dest AT ROW 14.33 COL 7 NO-LABEL
     ...
     td-show-parm AT ROW 18.1 COL 30.6
     tb_excel AT ROW 20.1 COL 50.6 RIGHT-ALIGNED
     tb_runExcel AT ROW 20.1 COL 71.6 RIGHT-ALIGNED
     fi_file AT ROW 20.91 COL 28.6 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 22.76 COL 19
     btn-cancel AT ROW 22.76 COL 56
     "Selected Columns(In Display Order)" VIEW-AS TEXT
          SIZE 34 BY .62 AT ROW 6.76 COL 60 WIDGET-ID 44
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 13.62 COL 5
     "Selection Parameters" VIEW-AS TEXT
          SIZE 21 BY .71 AT ROW 1.24 COL 5
     "Available Columns" VIEW-AS TEXT
          SIZE 29 BY .62 AT ROW 6.62 COL 5.4 WIDGET-ID 38
...
DO:
   apply "close" to this-procedure.
    {Advantzware/WinKit/winkit-panel-triggerend.i} /* added by script _nonAdm1.p on 04.07.2017 @  2:06:51 pm */
END.
...
ON CLOSE OF THIS-PROCEDURE DO:
   RUN disable_UI.
   {Advantzware/WinKit/closewindow-nonadm.i} /* added by script _nonAdm1.p on 04.07.2017 @  2:06:51 pm */
END.
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
 ...
 /* security check need {methods/prgsecur.i} in definition section */
  ...
  DO WITH FRAME {&FRAME-NAME}:
    {methods/setButton.i btn-cancel "Cancel"} /* added by script _nonAdm1Images2.p on 04.07.2017 @  2:07:41 pm */
    {methods/setButton.i btn-ok "OK"} /* added by script _nonAdm1Images2.p on 04.07.2017 @  2:07:41 pm */
    {custom/usrprint.i}
    RUN DisplaySelectionList2.
    APPLY "entry" TO begin_date.
  END.

    {Advantzware/WinKit/embedfinalize-nonadm.i} /* added by script _nonAdm1.p on 04.07.2017 @  2:06:51 pm */
...
DEF VAR str-tit4 AS cha FORM "x(140)" NO-UNDO.
DEF VAR str-tit5 AS cha FORM "x(140)" NO-UNDO.
DEF VAR str-line AS cha FORM "x(140)" NO-UNDO.
            ...
            DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
               cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                    CASE cTmpField:             
                         ...
                         WHEN "pro-jdt"       THEN cVarValue = IF v-date NE ? THEN STRING(v-date) ELSE "".
                         WHEN "cust"            THEN cVarValue = STRING(tt-report.key-03).
                         WHEN "cust-part"   THEN cVarValue = STRING(tt-report.key-04) .
                         WHEN "job"        THEN cVarValue = STRING(v-job) .
                         WHEN "ttl-kck"     THEN cVarValue = STRING(v-t-qty[1],"->>>,>>>,>>9") .
                         WHEN "kck-remn"   THEN cVarValue = STRING(v-t-rem[1],"->>>,>>>,>>9").
                         WHEN "msf-bal"     THEN cVarValue = STRING(v-t-msf[1],"->>,>>9.9999") .
                         WHEN "shet-siz"    THEN cVarValue = STRING(v-sheet) .
                         WHEN "brd-rec"         THEN cVarValue = STRING(v-mat-qty,"->>>,>>>,>>9") .
            ...
            DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
               cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                    CASE cTmpField:             
                         ...
                         WHEN "pro-jdt"       THEN cVarValue = "".
                         WHEN "cust"            THEN cVarValue = "" .
                         WHEN "cust-part"   THEN cVarValue = "" .
                         WHEN "job"        THEN cVarValue = "" .
                         WHEN "ttl-kck"     THEN cVarValue = STRING(v-t-qty[2],"->>>,>>>,>>9").
                         WHEN "kck-remn"   THEN cVarValue = STRING(v-t-rem[2],"->>>,>>>,>>9")  .
                         WHEN "msf-bal"     THEN cVarValue = STRING(v-t-msf[2],"->>,>>9.9999")  .
                         WHEN "shet-siz"    THEN cVarValue = "" .
                         WHEN "brd-rec"         THEN cVarValue = "" .
