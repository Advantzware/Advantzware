...
&Scoped-Define ENABLED-OBJECTS begin_mach end_mach begin_date end_date ~
...
DEFINE FRAME FRAME-A
     ...
     begin_date AT ROW 4.33 COL 26 COLON-ALIGNED
     end_date AT ROW 4.33 COL 64 COLON-ALIGNED HELP
          "Enter Ending Due Date"
     lv-ornt AT ROW 7.19 COL 31 NO-LABEL
     lines-per-page AT ROW 7.19 COL 84 COLON-ALIGNED
     rd-dest AT ROW 8.14 COL 6 NO-LABEL
     lv-font-no AT ROW 8.62 COL 35 COLON-ALIGNED
     lv-font-name AT ROW 9.81 COL 29 COLON-ALIGNED NO-LABEL
     tb_excel AT ROW 11.24 COL 68 RIGHT-ALIGNED
     tb_runExcel AT ROW 11.24 COL 90 RIGHT-ALIGNED
     td-show-parm AT ROW 12.19 COL 6
     fi_file AT ROW 12.19 COL 46 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 14.81 COL 25
     btn-cancel AT ROW 14.81 COL 57
     RECT-6 AT ROW 6.24 COL 1
     RECT-7 AT ROW 1 COL 1
     "Selection Parameters" VIEW-AS TEXT
          SIZE 21 BY .71 AT ROW 1.24 COL 5
          BGCOLOR 2 
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY 1 AT ROW 6.71 COL 3
...
RUN est/rc-seq.p (OUTPUT lv-rc-seq).
  ...
  FOR EACH mch-act NO-LOCK
      ...
      {custom/statusMsg.i "'Processing Customer # ' + string(mch-act.m-code)"} 
