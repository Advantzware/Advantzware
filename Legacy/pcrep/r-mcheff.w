...
IF tb_excel THEN DO:
   ...
   */
   ...
   excelheader3 = "Machine,Date,Time,Time,Time,Time,Job#,Blank,Hours,Hours,Received,Received,Quantity,Quantity,Received,Deviation,Produced,Waste,per line,Per Hr,Efficiency,Efficiency,Shift#,Item Code,Item Name,LinearFT/Hr".
