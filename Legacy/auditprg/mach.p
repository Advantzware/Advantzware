/* mach.p - generated 12/09/2005 - 15:42:48 by NoSweat */
...
DO:
  ...
  END.
END.
IF NOT v_field_changed OR ttbl_mach1.daily-prod-hours NE ttbl_mach2.daily-prod-hours OR action NE "UPDATE" THEN
DO:
  PUT STREAM s-audit-rpt UNFORMATTED "?: " AT 3 ttbl_mach1.daily-prod-hours FORMAT "->,>>>,>>9" " (daily-prod-hours)".
  IF action = "UPDATE" THEN
  DO:
    IF ttbl_mach1.daily-prod-hours NE ttbl_mach2.daily-prod-hours THEN
    PUT STREAM s-audit-rpt UNFORMATTED "*" AT 1.
    PUT STREAM s-audit-rpt UNFORMATTED "?: " AT 3 ttbl_mach2.daily-prod-hours FORMAT "->,>>>,>>9".
  END.
END.
DO i = 1 TO 4:
...
DO:
  ...
  END.
END.
IF NOT v_field_changed OR ttbl_mach1.gang-jobs NE ttbl_mach2.gang-jobs OR action NE "UPDATE" THEN
DO:
  PUT STREAM s-audit-rpt UNFORMATTED "Gang Jobs?: " AT 3 ttbl_mach1.gang-jobs FORMAT "yes/no" " (gang-jobs)".
  IF action = "UPDATE" THEN
  DO:
    IF ttbl_mach1.gang-jobs NE ttbl_mach2.gang-jobs THEN
    PUT STREAM s-audit-rpt UNFORMATTED "*" AT 1.
    PUT STREAM s-audit-rpt UNFORMATTED "Gang Jobs?: " AT 3 ttbl_mach2.gang-jobs FORMAT "yes/no".
  END.
END.
...
END.
DO i = 1 TO 20:
IF NOT v_field_changed OR ttbl_mach1.max-pan-fb[i] NE ttbl_mach2.max-pan-fb[i] OR action NE "UPDATE" THEN
DO:
  PUT STREAM s-audit-rpt UNFORMATTED "Max Panel FB[" AT 3 i "]: " ttbl_mach1.max-pan-fb[i] FORMAT ">>9.99999" " (max-pan-fb[" i "])".
  IF action = "UPDATE" THEN
  DO:
    IF ttbl_mach1.max-pan-fb[i] NE ttbl_mach2.max-pan-fb[i] THEN
    PUT STREAM s-audit-rpt UNFORMATTED "*" AT 1.
    PUT STREAM s-audit-rpt UNFORMATTED "Max Panel FB[" AT 3 i "]: " ttbl_mach2.max-pan-fb[i] FORMAT ">>9.99999".
  END.
END.
END.
IF NOT v_field_changed OR ttbl_mach1.max-pan-l NE ttbl_mach2.max-pan-l OR action NE "UPDATE" THEN
DO:
  PUT STREAM s-audit-rpt UNFORMATTED "Max Panel FB: " AT 3 ttbl_mach1.max-pan-l FORMAT ">>9.99999" " (max-pan-l)".
  IF action = "UPDATE" THEN
  DO:
    IF ttbl_mach1.max-pan-l NE ttbl_mach2.max-pan-l THEN
    PUT STREAM s-audit-rpt UNFORMATTED "*" AT 1.
    PUT STREAM s-audit-rpt UNFORMATTED "Max Panel FB: " AT 3 ttbl_mach2.max-pan-l FORMAT ">>9.99999".
  END.
END.
DO i = 1 TO 20:
IF NOT v_field_changed OR ttbl_mach1.max-pan-ss[i] NE ttbl_mach2.max-pan-ss[i] OR action NE "UPDATE" THEN
DO:
  PUT STREAM s-audit-rpt UNFORMATTED "Max Panel SS[" AT 3 i "]: " ttbl_mach1.max-pan-ss[i] FORMAT ">>9.99999" " (max-pan-ss[" i "])".
  IF action = "UPDATE" THEN
  DO:
    IF ttbl_mach1.max-pan-ss[i] NE ttbl_mach2.max-pan-ss[i] THEN
    PUT STREAM s-audit-rpt UNFORMATTED "*" AT 1.
    PUT STREAM s-audit-rpt UNFORMATTED "Max Panel SS[" AT 3 i "]: " ttbl_mach2.max-pan-ss[i] FORMAT ">>9.99999".
  END.
END.
END.
IF NOT v_field_changed OR ttbl_mach1.max-pan-w NE ttbl_mach2.max-pan-w OR action NE "UPDATE" THEN
DO:
  PUT STREAM s-audit-rpt UNFORMATTED "Max Panel SS: " AT 3 ttbl_mach1.max-pan-w FORMAT ">>9.99999" " (max-pan-w)".
  IF action = "UPDATE" THEN
  DO:
    IF ttbl_mach1.max-pan-w NE ttbl_mach2.max-pan-w THEN
    PUT STREAM s-audit-rpt UNFORMATTED "*" AT 1.
    PUT STREAM s-audit-rpt UNFORMATTED "Max Panel SS: " AT 3 ttbl_mach2.max-pan-w FORMAT ">>9.99999".
  END.
END.
...
DO:
  ...
  END.
END.
IF NOT v_field_changed OR ttbl_mach1.metric NE ttbl_mach2.metric OR action NE "UPDATE" THEN
DO:
  PUT STREAM s-audit-rpt UNFORMATTED "?: " AT 3 ttbl_mach1.metric FORMAT "yes/no" " (metric)".
  IF action = "UPDATE" THEN
  DO:
    IF ttbl_mach1.metric NE ttbl_mach2.metric THEN
    PUT STREAM s-audit-rpt UNFORMATTED "*" AT 1.
    PUT STREAM s-audit-rpt UNFORMATTED "?: " AT 3 ttbl_mach2.metric FORMAT "yes/no".
  END.
END.
...
END.
DO i = 1 TO 20:
IF NOT v_field_changed OR ttbl_mach1.min-pan-fb[i] NE ttbl_mach2.min-pan-fb[i] OR action NE "UPDATE" THEN
DO:
  PUT STREAM s-audit-rpt UNFORMATTED "Max Panel SS[" AT 3 i "]: " ttbl_mach1.min-pan-fb[i] FORMAT ">>9.99999" " (min-pan-fb[" i "])".
  IF action = "UPDATE" THEN
  DO:
    IF ttbl_mach1.min-pan-fb[i] NE ttbl_mach2.min-pan-fb[i] THEN
    PUT STREAM s-audit-rpt UNFORMATTED "*" AT 1.
    PUT STREAM s-audit-rpt UNFORMATTED "Max Panel SS[" AT 3 i "]: " ttbl_mach2.min-pan-fb[i] FORMAT ">>9.99999".
  END.
END.
END.
IF NOT v_field_changed OR ttbl_mach1.min-pan-l NE ttbl_mach2.min-pan-l OR action NE "UPDATE" THEN
DO:
  PUT STREAM s-audit-rpt UNFORMATTED "Min Panel FB: " AT 3 ttbl_mach1.min-pan-l FORMAT ">>9.99999" " (min-pan-l)".
  IF action = "UPDATE" THEN
  DO:
    IF ttbl_mach1.min-pan-l NE ttbl_mach2.min-pan-l THEN
    PUT STREAM s-audit-rpt UNFORMATTED "*" AT 1.
    PUT STREAM s-audit-rpt UNFORMATTED "Min Panel FB: " AT 3 ttbl_mach2.min-pan-l FORMAT ">>9.99999".
  END.
END.
DO i = 1 TO 20:
IF NOT v_field_changed OR ttbl_mach1.min-pan-ss[i] NE ttbl_mach2.min-pan-ss[i] OR action NE "UPDATE" THEN
DO:
  PUT STREAM s-audit-rpt UNFORMATTED "Min Panel SS[" AT 3 i "]: " ttbl_mach1.min-pan-ss[i] FORMAT ">>9.99999" " (min-pan-ss[" i "])".
  IF action = "UPDATE" THEN
  DO:
    IF ttbl_mach1.min-pan-ss[i] NE ttbl_mach2.min-pan-ss[i] THEN
    PUT STREAM s-audit-rpt UNFORMATTED "*" AT 1.
    PUT STREAM s-audit-rpt UNFORMATTED "Min Panel SS[" AT 3 i "]: " ttbl_mach2.min-pan-ss[i] FORMAT ">>9.99999".
  END.
END.
END.
IF NOT v_field_changed OR ttbl_mach1.min-pan-w NE ttbl_mach2.min-pan-w OR action NE "UPDATE" THEN
DO:
  PUT STREAM s-audit-rpt UNFORMATTED "Min Panel SS: " AT 3 ttbl_mach1.min-pan-w FORMAT ">>9.99999" " (min-pan-w)".
  IF action = "UPDATE" THEN
  DO:
    IF ttbl_mach1.min-pan-w NE ttbl_mach2.min-pan-w THEN
    PUT STREAM s-audit-rpt UNFORMATTED "*" AT 1.
    PUT STREAM s-audit-rpt UNFORMATTED "Min Panel SS: " AT 3 ttbl_mach2.min-pan-w FORMAT ">>9.99999".
  END.
END.
...
DO:
  ...
  END.
END.
IF NOT v_field_changed OR ttbl_mach1.sch-m-code NE ttbl_mach2.sch-m-code OR action NE "UPDATE" THEN
DO:
  PUT STREAM s-audit-rpt UNFORMATTED "Schedule Machine: " AT 3 ttbl_mach1.sch-m-code " (sch-m-code)".
  IF action = "UPDATE" THEN
  DO:
    IF ttbl_mach1.sch-m-code NE ttbl_mach2.sch-m-code THEN
    PUT STREAM s-audit-rpt UNFORMATTED "*" AT 1.
    PUT STREAM s-audit-rpt UNFORMATTED "Schedule Machine: " AT 3 ttbl_mach2.sch-m-code.
  END.
END.
