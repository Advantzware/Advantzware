...
DEFINE VARIABLE h_b-prdlin AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b-prodct AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v-prodln AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Browse <name>|viewer|Prod Category' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'fg/b-prdlin.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-prdlin ).
       RUN set-position IN h_b-prdlin ( 4.81 , 6.00 ) NO-ERROR.
       /* Size in UIB:  ( 19.52 , 105.00 ) */

       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('2') NO-ERROR.

       /* Links to SmartNavBrowser h_b-prdlin. */
       RUN add-link IN adm-broker-hdl ( h_p-navico , 'Navigation':U , h_b-prdlin ).
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Initial-Lock = EXCLUSIVE-LOCK,
                     ...
                     Create-On-Add = ?':U ,
             OUTPUT h_v-prodln ).
       RUN set-position IN h_v-prodln ( 5.05 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 16.62 , 144.00 ) */
       ...
       /* Links to SmartViewer h_v-prodln. */
       RUN add-link IN adm-broker-hdl ( h_b-prdlin , 'Record':U , h_v-prodln ).
       RUN add-link IN adm-broker-hdl ( h_p-updsav , 'TableIO':U , h_v-prodln ).

    END. /* Page 2 */

    WHEN 3 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'fg/b-prodct.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-prodct ).
       RUN set-position IN h_b-prodct ( 4.57 , 5.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updsav-2 ).
       RUN set-position IN h_p-updsav-2 ( 20.52 , 81.00 ) NO-ERROR.
