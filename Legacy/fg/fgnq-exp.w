...
ASSIGN cTextListToSelect = "Item#,Vendor PO#,Job#,Job#2,TR Date,TR Code,Warehouse,Bin,Quantity,Tag#,Cost/M,Pallets,Qty/Pallet,Tot-wt"

      cFieldListToSelect = "ino,vend,job,job2,date,code,ware,bin,qty,tag,cost,palt,qty-plt,tot" .
{sys/inc/ttRptSel.i}

    ASSIGN cTextListToDefault  = "Item#,Vendor PO#,Job#,Job#2,TR Date,TR Code,Warehouse,Bin,Quantity,Tag#,Cost/M,Pallets,Qty/Pallet,Tot-wt" .
...
begin_vend end_vend Btn_Def sl_avail sl_selected Btn_Add Btn_Remove btn_Up btn_down ~
...
DEFINE FRAME rd-fgnq-exp
     ...
     begin_vend AT ROW 5.43 COL 28 COLON-ALIGNED HELP
          "Enter Beginning Customer Number" WIDGET-ID 146
     end_vend AT ROW 5.43 COL 71 COLON-ALIGNED HELP
...
------------------------------------------------------------------------------*/
  DISPLAY begin_i-no end_i-no begin_vend end_vend sl_avail sl_selected tb_excel 
          tb_runExcel fi_file 
      WITH FRAME rd-fgnq-exp.
  ENABLE RECT-6 RECT-7 RECT-8 begin_i-no end_i-no begin_vend end_vend Btn_Def sl_avail 
    ...
    FOR EACH fg-rcpth WHERE fg-rcpth.company EQ cocode
       ...
       FOR EACH ttRptSelected:
         /* IF LOOKUP(ttRptSelected.TextList, "Contact,Title,Email") <> 0    THEN do: */
              ...
              IF ttRptSelected.TextList = "Pallets" THEN do:
              ...
              END.
              IF ttRptSelected.TextList = "Qty/Pallet" THEN do:
                  find first fg-bin
                      where fg-bin.company eq cocode
                     and fg-bin.i-no    eq fg-rcpth.i-no
                     and fg-bin.job-no  eq fg-rcpth.job-no
