...
e-itemfg-vend.vend-no e-itemfg-vend.setup 
&Scoped-define ENABLED-FIELDS-IN-QUERY-Browser-Table 
&Scoped-define QUERY-STRING-Browser-Table FOR EACH e-itemfg WHERE e-itemfg.company = itemfg.company ~
  AND e-itemfg.i-no = itemfg.i-no NO-LOCK, ~
      EACH e-itemfg-vend OF e-itemfg OUTER-JOIN NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Browser-Table OPEN QUERY Browser-Table FOR EACH e-itemfg WHERE e-itemfg.company = itemfg.company ~
  AND e-itemfg.i-no = itemfg.i-no NO-LOCK, ~
      EACH e-itemfg-vend OF e-itemfg OUTER-JOIN NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      e-itemfg.i-no FORMAT "x(10)":U
      e-itemfg-vend.vend-no FORMAT "x(8)":U
      e-itemfg-vend.setup FORMAT ">>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 60 BY 18.1
         FONT 2.
...
DEFINE FRAME F-Main
     ...
     auto_find AT ROW 19.33 COL 30 COLON-ALIGNED HELP
...
/* Query rebuild information for BROWSE Browser-Table
     _TblList          = "ASI.e-itemfg WHERE ASI.itemfg ...,ASI.e-itemfg-vend OF ASI.e-itemfg"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = "USED, OUTER"
     _JoinCode[1]      = "ASI.e-itemfg.company = ASI.itemfg.company
  AND ASI.e-itemfg.i-no = ASI.itemfg.i-no"
     _FldNameList[1]   = ASI.e-itemfg.i-no
     _FldNameList[2]   = ASI.e-itemfg-vend.vend-no
     _FldNameList[3]   = ASI.e-itemfg-vend.setup
