...
&Scoped-Define ENABLED-OBJECTS begin_date end_date begin_loc end_loc ~
tb_sort t-receipt t-issue t-trans t-adj t-phy tb_total rd-dest lv-ornt ~
lines-per-page lv-font-no td-show-parm btn-ok btn-cancel RECT-17 RECT-6 
...
DEFINE FRAME FRAME-A
     ...
     tb_sort AT ROW 5.76 COL 44
     t-receipt AT ROW 7.91 COL 44
     t-issue AT ROW 8.86 COL 44
     t-trans AT ROW 9.81 COL 44
     t-adj AT ROW 10.52 COL 44
     t-phy AT ROW 11.48 COL 44
     tb_total AT ROW 12.91 COL 44
     ...
     "Transaction Types" VIEW-AS TEXT
          SIZE 22 BY .62 AT ROW 7.19 COL 31
          FONT 6
...
DO:
  assign rd-dest
         begin_date END_date
         begin_loc END_loc
         t-receipt t-issue t-trans t-adj t-phy tb_total tb_sort.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE begin_date end_date begin_loc end_loc tb_sort t-receipt t-issue 
         t-trans t-adj t-phy tb_total rd-dest lv-ornt lines-per-page lv-font-no 
         td-show-parm btn-ok btn-cancel RECT-17 RECT-6 
      WITH FRAME FRAME-A IN WINDOW C-Win.
...
form header                                                                                           
  "ITEM" at 2 "DESCRIPTION" at 17 "FROM" at 60 "QTY" at 107 "SALES" at 127
   skip
  "DATE" at 12   "TY" at 19 "TAG #" at 26 "JOB #" at 36
  "P.O. #" at 44 "VENDOR" at 51                                   
    "BIN" at 60  "CASES" at 71
  "QTY/CASE" at 78  "UOM" at 90 "TOTAL" at 106 "VALUE" at 127
 fill("=",131) format "x(131)"
with frame f-top PAGE-TOP no-box no-labels STREAM-IO width 132.                                                 

       form
           fg-rctd.rct-date at 10 space(1)
           v-tran-type
           fg-rctd.tag
           fg-rctd.job-no space(0) "-" space(0)
           fg-rctd.job-no2 format "99" space(2)
           fg-rctd.po-no       at 44   format "x(6)"                                                         
           po-ord.vend-no       at 51                                                              
           fg-rctd.loc-bin      at 60
           fg-rctd.cases        to 75
           fg-rctd.qty-case     to 85
           fg-rctd.pur-uom     format "x(3)" at 90          
           v-tot-qty            format "->>>,>>>,>>9"  at 99
       /*
           fg-rctd.t-qty        format "->>>,>>>,>>9"  at 99
       */
           v-fg-value           format "->,>>>,>>9.99" to 130
       with frame detail no-box no-labels down STREAM-IO width 132.
       ...
       */  
           v-fg-value           format "->,>>>,>>9.99" to 130
       with frame pdetail no-box no-labels down STREAM-IO width 132.
...
*/
      ...
      if v-tran-type begins "T" then
         put "TO: " at 56 fg-rctd.loc2 fg-rctd.loc-bin2 skip(1).
         
      if last-of(report.key-02) and v-pr-tots then do:                                             
        put "Total Adjustment: " at 76 v-totadj skip.                         
    ...
    if v-pr-tots then                                                                         
    put skip "--------------" to 105 skip "Grand Total Adjustment: " to 93 v-grd-totadj  skip. 
