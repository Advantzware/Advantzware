...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      ...
      fg-rctd.loc COLUMN-LABEL "Whse" FORMAT "x(5)":U WIDTH 6
      fg-rctd.loc-bin COLUMN-LABEL "Bin" FORMAT "x(8)":U WIDTH 9
...
"fg-rctd.i-no" ? "X(15)" "character" ? ? ? ? ? ? yes ? no no "18" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"fg-rctd.job-no" ? ? "character" ? ? ? ? ? ? yes ? no no "8" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"fg-rctd.loc" "Whse" ? "character" ? ? ? ? ? ? yes ? no no "6" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > asi.fg-rctd.loc-bin
"fg-rctd.loc-bin" "Bin" ? "character" ? ? ? ? ? ? yes ? no no "9" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
