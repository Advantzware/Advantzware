...
------------------------------------------------------------------------------*/
    ...
    fGenerateInclude(hFrame,"InitAll").
                    ...
                    CASE ipcType:
                        ...
                        WHEN "DynFunc" THEN DO:
                            ...
                            PUT UNFORMATTED
                                ...
                                .
                        END. /* dynfunc */
                        WHEN "InitAll" THEN DO:
                            IF hChild:NAME BEGINS "svAll" THEN
                            PUT UNFORMATTED
                                "    IF " REPLACE(hChild:NAME,"sv",ENTRY(idx,cPreFix)) " THEN" SKIP
                                "    ASSIGN" SKIP
                                "        cStart" REPLACE(hChild:NAME,"svAll","") " = CHR(32)" SKIP
                                "        cEnd" REPLACE(hChild:NAME,"svAll","") "   = CHR(255)" SKIP
                                "        ." SKIP(1)
                                .
