...
DEFINE TEMP-TABLE ttFinishedGoodsExport NO-UNDO
    ...
    FIELD itemNo             AS CHARACTER LABEL "Item #"               FORMAT "x(15)"
    ...
    FIELD categoryDescr1     AS CHARACTER LABEL "Description"          FORMAT "x(30)"
    FIELD categoryDescr2     AS CHARACTER LABEL "Description2"         FORMAT "x(30)"
    FIELD categoryDescr3     AS CHARACTER LABEL "Description3"         FORMAT "x(30)"
    FIELD stockCust          AS CHARACTER LABEL "Stock/Custom"         FORMAT "x(8)"
    FIELD die                AS CHARACTER LABEL "Die #"                FORMAT "x(15)"
    FIELD plate              AS CHARACTER LABEL "Plate #"              FORMAT "x(15)"
    FIELD upc                AS CHARACTER LABEL "UPC #"                FORMAT "x(15)"
    FIELD cad                AS CHARACTER LABEL "Cad #"                FORMAT "x(15)"
    FIELD qualitySpc         AS CHARACTER LABEL "Quality/SPC #"        FORMAT "x(15)"
    FIELD stocked            AS LOGICAL   LABEL "Stocked"              FORMAT "x(3)"
    ...
    FIELD vendor1Item        AS CHARACTER LABEL "Vendor 1 Item #"      FORMAT "x(15)"
    FIELD vendor2            AS CHARACTER LABEL "Vendor 1"             FORMAT "x(8)"
    FIELD vendor2Item        AS CHARACTER LABEL "Vendor 1 Item #"      FORMAT "x(15)"
    FIELD stocked2           AS LOGICAL   LABEL "Stocked"              FORMAT "x(3)"
