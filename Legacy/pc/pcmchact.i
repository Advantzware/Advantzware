...
DEFINE VARIABLE lv-cmp-job-found AS LOG     NO-UNDO.
...
IF AVAILABLE job THEN DO:
    ...
    IF v-tspost-val NE "Actual" THEN DO:
    ...
    IF AVAILABLE b-job-mch THEN lv-rowid = ROWID(b-job-mch).
    ELSE DO:
        CREATE job-mch.
        ...
        ELSE DO:
            ASSIGN 
                job-mch.company  = pc-prdd.company
    ...
    IF pc-prdd.complete THEN DO:
        ...
        IF AVAILABLE b-job-mch THEN DO:
