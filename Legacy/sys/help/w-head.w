...
&SCOPED-DEFINE h_Browse01 h_b-head
...
DEFINE VARIABLE h_b-head AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* ASI Help Maintenance */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* ASI Help Maintenance */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Browse Help|View Help' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-head ).
       RUN set-position IN h_b-head ( 4.57 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-head ( 19.52 , 145.00 ) NO-ERROR.
