  ...
  ----------------------------------------------------------------------*/
    ...
    ELSE DO:        
        ...
        ASSIGN
            ...
            ioplcRequestData = REPLACE(ioplcRequestData, "TBD13", cCalcAddress)
            ioplcRequestData = REPLACE(ioplcRequestData, "TBD12", STRING(oe-relh.ship-id))
            ...
            ioplcRequestData = REPLACE(ioplcRequestData, "TBD8", STRING(oe-relh.cust-no))
            ioplcRequestData = REPLACE(ioplcRequestData, "TBD7", reqDate)
            ioplcRequestData = REPLACE(ioplcRequestData, "TBD6", STRING(oe-relh.rel-date))
            ioplcRequestData = REPLACE(ioplcRequestData, "TBD5", docStatus)
            ioplcRequestData = REPLACE(ioplcRequestData, "TBD4", STRING(oe-relh.release#))
            ioplcRequestData = REPLACE(ioplcRequestData, "TBD3", STRING(oe-relh.r-no))
            ioplcRequestData = REPLACE(ioplcRequestData, "TBD2", docType)
            ioplcRequestData = REPLACE(ioplcRequestData, "TBD1", oe-relh.company)
            .
