...
DEFINE VARIABLE h_b-recysk AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Check Reconcl' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'ap/b-recysk.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-recysk ).
       RUN set-position IN h_b-recysk ( 5.05 , 4.00 ) NO-ERROR.
       RUN set-size IN h_b-recysk ( 19.05 , 145.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-recysk ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
