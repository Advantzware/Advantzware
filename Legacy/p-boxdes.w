...
Btn-Delete Btn-Cancel Btn-wscore Btn-lscore 
...
DEFINE FRAME Panel-Frame
     ...
     Btn-wscore AT ROW 1.29 COL 56
     Btn-lscore AT ROW 1.29 COL 65
...
DO:
  ...
  /* Added by WinKit Migration tool 07.02.2016 21:10:46 */
...
&Scoped-define SELF-NAME Btn-lscore
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Btn-lscore C-WIn
ON CHOOSE OF Btn-lscore IN FRAME Panel-Frame /* Lscore */
DO:
   def var char-hdl as cha no-undo.
   run get-link-handle in adm-broker-hdl (this-procedure, "wscore-target", output char-hdl).
   RUN update-lscore in widget-handle(char-hdl) .
...
&Scoped-define SELF-NAME Btn-wscore
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Btn-wscore C-WIn
ON CHOOSE OF Btn-wscore IN FRAME Panel-Frame /* Wscore */
DO:
   def var char-hdl as cha no-undo.
   run get-link-handle in adm-broker-hdl (this-procedure, "wscore-target", output char-hdl).
   RUN update-wscore in widget-handle(char-hdl) .
