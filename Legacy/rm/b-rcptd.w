    ...
    DO:
        ...
        DO:
            ...
            DO:
                ...
                IF AVAIL rm-rctd AND rm-rctd.qty NE DEC(rm-rctd.qty:SCREEN-VALUE IN BROWSE {&browse-name}) THEN
...
PROCEDURE local-update-record :
    ...
    RUN validate-qty-over NO-ERROR .
    IF ERROR-STATUS:ERROR THEN RETURN ERROR.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE validate-qty-over B-table-Win 
PROCEDURE validate-qty-over :
    /*------------------------------------------------------------------------------
      Purpose:     
      Parameters:  <none>
      Notes:       
