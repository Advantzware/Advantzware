...
DEFINE INPUT PARAMETER ipModule AS CHARACTER NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "RM Inquiry <Title Supplied from Calling Module>"
         HEIGHT             = 24
         WIDTH              = 150
         MAX-HEIGHT         = 24
         MAX-WIDTH          = 150
...
ON END-ERROR OF W-Win /* RM Inquiry <Title Supplied from Calling Module> */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* RM Inquiry <Title Supplied from Calling Module> */
DO:
...
{&WINDOW-NAME}:TITLE = ipTitle.
FIND item WHERE ROWID(item) EQ ipRowID NO-LOCK NO-ERROR.
    ...
    WHEN 1 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
           ...
           &ENDIF
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_rm-ibin ).
       RUN set-position IN h_rm-ibin ( 4.81 , 2.00 ) NO-ERROR.
       RUN set-size IN h_rm-ibin ( 16.67 , 145.00 ) NO-ERROR.

       /* Links to SmartNavBrowser h_rm-ibin. */
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'Record':U , h_rm-ibin ).
