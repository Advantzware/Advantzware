...
rm-rctd.barcode rm-rctd.po-no rm-rctd.i-no rm-rctd.i-name rm-rctd.job-no ~
rm-rctd.job-no2 rm-rctd.loc rm-rctd.loc-bin 
...
"rct-date" ? ? "date" ? ? ? ? ? ? yes ?
     _FldNameList[2]   > JOBS.rm-rctd.barcode
...
"i-name" ? ? "character" ? ? ? ? ? ? yes ?
     _FldNameList[6]   > JOBS.rm-rctd.job-no
"job-no" ? ? "character" ? ? ? ? ? ? yes ?
     _FldNameList[7]   > JOBS.rm-rctd.job-no2
"job-no2" ? ? "integer" ? ? ? ? ? ? yes ?
     _FldNameList[8]   > JOBS.rm-rctd.loc
"loc" ? ? "character" ? ? ? ? ? ? yes ?
     _FldNameList[9]   > JOBS.rm-rctd.loc-bin
"loc-bin" ? ? "character" ? ? ? ? ? ? yes ?
