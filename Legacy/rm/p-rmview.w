...
DEFINE VARIABLE lhhistblnk AS HANDLE NO-UNDO.
...
DO:  	
  ...
  /* Check if history tab blank, show an error message */
  IF VALID-HANDLE(lhhistblnk) THEN do:				/*Task# 06021403 */
      RUN histblnkmsg IN lhhistblnk.	     
       IF RETURN-VALUE EQ "ERROR" THEN RETURN NO-APPLY. 
  end. 
...
/* ***************************  Main Block  *************************** */
  ...
  {methods/setButton.i Btn-Add "Add"} /* added by script _admTransPanels.p on 04.07.2017 @  2:09:02 pm */
  {methods/setButton.i Btn-Copy "Copy"} /* added by script _admTransPanels.p on 04.07.2017 @  2:09:02 pm */
  {methods/setButton.i Btn-Delete "Delete"} /* added by script _admTransPanels.p on 04.07.2017 @  2:09:02 pm */
...
/*--------------------------------------------------------------------------
  ...
  IF RETURN-VALUE <> 'DESIGN':U THEN DO:
	...
	RUN get-link-handle IN adm-broker-hdl(THIS-PROCEDURE,'TABLEIO-TARGET':U,OUTPUT char-hdl).
     lhhistblnk = WIDGET-HANDLE(char-hdl).
  END.
