...
&Scoped-Define ENABLED-OBJECTS RECT-1 RECT-2 list-order begin_tax-group ~
end_tax-group 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_tax-group end_tax-group ~
F1 F-3 
...
DEFINE VARIABLE begin_tax-group AS CHARACTER FORMAT "X(10)" 
     LABEL "Beginning  Tax Group" 
     VIEW-AS FILL-IN 
     SIZE 15.6 BY 1.

DEFINE VARIABLE end_tax-group AS CHARACTER FORMAT "X(10)" 
...
DEFINE FRAME F-Main
     ...
     begin_tax-group AT ROW 4.81 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Tax Group"
     end_tax-group AT ROW 6.71 COL 45 COLON-ALIGNED HELP
          "Enter Ending Tax Group"
     F1 AT ROW 4.81 COL 63 NO-LABEL
     F-3 AT ROW 6.71 COL 63 NO-LABEL
