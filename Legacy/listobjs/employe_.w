...
&Scoped-Define ENABLED-OBJECTS RECT-1 RECT-2 list-order begin_employee ~
end_employee show-rates show-login-logout show-machines show-emp-notes 
&Scoped-Define DISPLAYED-OBJECTS list-order selected-company begin_employee ~
begin_employee_last_name begin_employee_soc_sec end_employee show-rates ~
end_employee_last_name show-login-logout show-machines end_employee_soc_sec ~
show-emp-notes F1 F-2 F-5 F-3 F-4 F-6 

/* Custom List Definitions                                              */
/* List-1,List-2,List-3,List-4,List-5,F1                                */
&Scoped-define F1 F1 F-2 F-5 F-3 F-4 F-6 
...
DEFINE VARIABLE begin_employee_soc_sec AS CHARACTER FORMAT "XXX-XX-XXXX":U 
     LABEL "Beginning Social Security #" 
     VIEW-AS FILL-IN 
     SIZE 18 BY 1.
...
DEFINE VARIABLE end_employee_last_name AS CHARACTER FORMAT "X(30)" 
     LABEL "Ending Last Name" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE end_employee_soc_sec AS CHARACTER FORMAT "XXX-XX-XXXX":U 
     LABEL "Ending Social Security #" 
     VIEW-AS FILL-IN 
     SIZE 18 BY 1.
...
DEFINE FRAME F-Main
     ...
     begin_employee AT ROW 4.57 COL 34 COLON-ALIGNED HELP
          "Enter Beginning Employee"
     begin_employee_last_name AT ROW 5.76 COL 34 COLON-ALIGNED HELP
          "Enter Beginning Last Name"
     begin_employee_soc_sec AT ROW 6.95 COL 34 COLON-ALIGNED HELP
          "Enter Beginning Social Security #"
     end_employee AT ROW 8.14 COL 34 COLON-ALIGNED HELP
          "Enter Ending Employee"
     show-rates AT ROW 8.62 COL 84 HELP
          "Select to Show Employee Rate"
     end_employee_last_name AT ROW 9.33 COL 34 COLON-ALIGNED HELP
          "Enter Ending Last Name"
     show-login-logout AT ROW 9.33 COL 84 HELP
          "Select to Show Employee Rate"
     show-machines AT ROW 10.05 COL 84 HELP
          "Select to Show Assigned Machines"
     end_employee_soc_sec AT ROW 10.52 COL 34 COLON-ALIGNED HELP
          "Enter Ending Social Security #"
     show-emp-notes AT ROW 10.76 COL 84 HELP
          "Select to Show Employee Rate"
     F1 AT ROW 4.57 COL 47 NO-LABEL
     F-2 AT ROW 5.76 COL 80 NO-LABEL
     F-5 AT ROW 6.95 COL 54 NO-LABEL
     F-3 AT ROW 8.14 COL 47 NO-LABEL
     F-4 AT ROW 9.33 COL 80 NO-LABEL
     F-6 AT ROW 10.52 COL 54 NO-LABEL
...
/* SETTINGS FOR FILL-IN begin_employee_last_name IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN begin_employee_soc_sec IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN end_employee_last_name IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN end_employee_soc_sec IN FRAME F-Main
   NO-ENABLE                                                            */
...
ASSIGN 
       show-emp-notes:PRIVATE-DATA IN FRAME F-Main     = 
                "save".

ASSIGN 
       show-login-logout:PRIVATE-DATA IN FRAME F-Main     = 
                "save".

ASSIGN 
       show-machines:PRIVATE-DATA IN FRAME F-Main     = 
                "save".

ASSIGN 
       show-rates:PRIVATE-DATA IN FRAME F-Main     = 
                "save".
