...
&Scoped-Define ENABLED-OBJECTS RECT-2 RECT-1 list-order begin_mat_type ~
end_mat_type 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_mat_type begin_mat_dscr ~
end_mat_type end_mat_dscr F1 F-2 F-3 F-4 
...
DEFINE VARIABLE begin_mat_dscr AS CHARACTER FORMAT "X(30)" 
     LABEL "Beginning Description" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE begin_mat_type AS CHARACTER FORMAT "X(5)" 
     LABEL "Beginning  Material Type" 
     VIEW-AS FILL-IN 
     SIZE 11 BY 1.

DEFINE VARIABLE end_mat_dscr AS CHARACTER FORMAT "X(30)" 
     LABEL "Ending Description" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE end_mat_type AS CHARACTER FORMAT "X(5)" 
...
DEFINE FRAME F-Main
     ...
     begin_mat_type AT ROW 4.81 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Material Type"
     begin_mat_dscr AT ROW 6 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Description"
     end_mat_type AT ROW 8.14 COL 45 COLON-ALIGNED HELP
          "Enter Ending Material Type"
     end_mat_dscr AT ROW 9.33 COL 45 COLON-ALIGNED HELP
...
/* SETTINGS FOR FILL-IN begin_mat_dscr IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN end_mat_dscr IN FRAME F-Main
   NO-ENABLE                                                            */
