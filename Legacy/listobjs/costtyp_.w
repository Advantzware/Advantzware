...
&Scoped-Define ENABLED-OBJECTS RECT-2 RECT-1 list-order begin_cost-type ~
end_cost-type 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_cost-type ~
begin_costtype_descr end_cost-type end_costtype_descr F1 F-2 F-3 F-4 
...
DEFINE VARIABLE begin_cost-type AS CHARACTER FORMAT "X(3)" 
     LABEL "Beginning  Cost Type" 
     VIEW-AS FILL-IN 
     SIZE 7 BY 1.

DEFINE VARIABLE begin_costtype_descr AS CHARACTER FORMAT "X(30)" 
     LABEL "Beginning Description" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE end_cost-type AS CHARACTER FORMAT "X(3)" 
     LABEL "Ending Cost Type" 
     VIEW-AS FILL-IN 
     SIZE 7 BY 1.

DEFINE VARIABLE end_costtype_descr AS CHARACTER FORMAT "X(30)" 
...
DEFINE FRAME F-Main
     ...
     begin_cost-type AT ROW 4.81 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Cost Type"
     begin_costtype_descr AT ROW 6 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Description"
     end_cost-type AT ROW 8.14 COL 45 COLON-ALIGNED HELP
          "Enter Ending Cost Type"
     end_costtype_descr AT ROW 9.33 COL 45 COLON-ALIGNED HELP
...
/* SETTINGS FOR FILL-IN begin_costtype_descr IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN end_costtype_descr IN FRAME F-Main
   NO-ENABLE                                                            */
