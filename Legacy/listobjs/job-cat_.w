...
&Scoped-Define ENABLED-OBJECTS RECT-2 RECT-1 list-order begin_cat end_cat 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_cat begin_job-cat_dscr ~
end_cat end_job-cat_dscr F1 F-2 F-3 F-4 
...
DEFINE VARIABLE begin_cat AS CHARACTER FORMAT "X(3)" 
     LABEL "Beginning  Job Category" 
     VIEW-AS FILL-IN 
     SIZE 7 BY 1.

DEFINE VARIABLE begin_job-cat_dscr AS CHARACTER FORMAT "X(30)" 
     LABEL "Beginning Description" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE end_cat AS CHARACTER FORMAT "X(3)" 
     LABEL "Ending Job Category" 
     VIEW-AS FILL-IN 
     SIZE 7 BY 1.

DEFINE VARIABLE end_job-cat_dscr AS CHARACTER FORMAT "X(30)" 
...
DEFINE FRAME F-Main
     ...
     begin_cat AT ROW 4.81 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Job Category"
     begin_job-cat_dscr AT ROW 6 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Description"
     end_cat AT ROW 8.14 COL 45 COLON-ALIGNED HELP
          "Enter Ending Job Category"
     end_job-cat_dscr AT ROW 9.33 COL 45 COLON-ALIGNED HELP
...
/* SETTINGS FOR FILL-IN begin_job-cat_dscr IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN end_job-cat_dscr IN FRAME F-Main
   NO-ENABLE                                                            */
