...
&Scoped-Define ENABLED-OBJECTS RECT-1 list-order RECT-2 begin_titlcode ~
end_titlcode 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_titlcode ~
begin_titlcode_description end_titlcode end_titlcode_description F1 F-2 F-3 ~
F-4 
...
DEFINE VARIABLE begin_titlcode AS CHARACTER FORMAT "X(10)" 
     LABEL "Beginning  Title Code" 
     VIEW-AS FILL-IN 
     SIZE 15.6 BY 1.

DEFINE VARIABLE begin_titlcode_description AS CHARACTER FORMAT "X(30)" 
     LABEL "Beginning Description" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE end_titlcode AS CHARACTER FORMAT "X(10)" 
     LABEL "Ending Title Code" 
     VIEW-AS FILL-IN 
     SIZE 15.6 BY 1.

DEFINE VARIABLE end_titlcode_description AS CHARACTER FORMAT "X(30)" 
...
DEFINE FRAME F-Main
     ...
     begin_titlcode AT ROW 4.81 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Title Code"
     begin_titlcode_description AT ROW 6 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Description"
     end_titlcode AT ROW 8.14 COL 45 COLON-ALIGNED HELP
          "Enter Ending Title Code"
     end_titlcode_description AT ROW 9.33 COL 45 COLON-ALIGNED HELP
...
/* SETTINGS FOR FILL-IN begin_titlcode_description IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN end_titlcode_description IN FRAME F-Main
   NO-ENABLE                                                            */
