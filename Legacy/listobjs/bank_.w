...
&Scoped-Define ENABLED-OBJECTS RECT-2 RECT-1 list-order begin_bank-code ~
end_bank-code 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_bank-code ~
begin_bank_bank-name end_bank-code end_bank_bank-name F1 F-2 F-3 F-4 
...
DEFINE VARIABLE begin_bank-code AS CHARACTER FORMAT "X(8)" 
     LABEL "Beginning Bank" 
     VIEW-AS FILL-IN 
     SIZE 15.6 BY 1.

DEFINE VARIABLE begin_bank_bank-name AS CHARACTER FORMAT "X(30)" 
     LABEL "Beginning Bank Name" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE end_bank-code AS CHARACTER FORMAT "X(8)" 
     LABEL "Ending Bank" 
     VIEW-AS FILL-IN 
     SIZE 15.6 BY 1.

DEFINE VARIABLE end_bank_bank-name AS CHARACTER FORMAT "X(30)" 
     LABEL "Ending Bank Name" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.
...
DEFINE FRAME F-Main
     ...
     begin_bank-code AT ROW 4.81 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Bank"
     begin_bank_bank-name AT ROW 6 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Bank Name"
     end_bank-code AT ROW 8.14 COL 45 COLON-ALIGNED HELP
          "Enter Ending Bank"
     end_bank_bank-name AT ROW 9.33 COL 45 COLON-ALIGNED HELP
          "Enter Ending Bank Name"
...
/* SETTINGS FOR FILL-IN begin_bank_bank-name IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN end_bank_bank-name IN FRAME F-Main
   NO-ENABLE                                                            */
