...
&Scoped-Define ENABLED-OBJECTS RECT-2 RECT-1 list-order begin_dept end_dept 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_dept begin_dept_dscr ~
end_dept end_dept_dscr F1 F-2 F-3 F-4 
...
DEFINE VARIABLE begin_dept_dscr AS CHARACTER FORMAT "X(30)" 
     LABEL "Beginning Description" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE end_dept AS CHARACTER FORMAT "X(2)" 
     LABEL "Ending Department" 
     VIEW-AS FILL-IN 
     SIZE 5 BY 1.

DEFINE VARIABLE end_dept_dscr AS CHARACTER FORMAT "X(30)" 
...
DEFINE FRAME F-Main
     ...
     begin_dept AT ROW 4.81 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Department"
     begin_dept_dscr AT ROW 6 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Description"
     end_dept AT ROW 8.14 COL 45 COLON-ALIGNED HELP
          "Enter Ending Department"
     end_dept_dscr AT ROW 9.33 COL 45 COLON-ALIGNED HELP
...
/* SETTINGS FOR FILL-IN begin_dept_dscr IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN end_dept_dscr IN FRAME F-Main
   NO-ENABLE                                                            */
