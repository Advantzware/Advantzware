...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* ZOHO CRM */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pGetAuthToken Dialog-Frame 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pGetConnection Dialog-Frame 
