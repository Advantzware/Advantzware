...
&Scoped-Define ENABLED-OBJECTS RECT-1 list-order RECT-2 begin_user_id ~
end_user_id 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_user_id ~
begin_users_user_name end_user_id end_users_user_name F1 F-2 F-3 F-4 
...
DEFINE VARIABLE begin_users_user_name AS CHARACTER FORMAT "X(30)" 
     LABEL "Beginning User Name" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE begin_user_id AS CHARACTER FORMAT "X(10)" 
     LABEL "Beginning  User ID" 
     VIEW-AS FILL-IN 
     SIZE 15.6 BY 1.

DEFINE VARIABLE end_users_user_name AS CHARACTER FORMAT "X(30)" 
     LABEL "Ending User Name" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE end_user_id AS CHARACTER FORMAT "X(10)" 
...
DEFINE FRAME F-Main
     ...
     begin_user_id AT ROW 4.81 COL 45 COLON-ALIGNED HELP
          "Enter Beginning User ID"
     begin_users_user_name AT ROW 6 COL 45 COLON-ALIGNED HELP
          "Enter Beginning User Name"
     end_user_id AT ROW 8.14 COL 45 COLON-ALIGNED HELP
          "Enter Ending User ID"
     end_users_user_name AT ROW 9.33 COL 45 COLON-ALIGNED HELP
          "Enter Ending User Name"
...
/* SETTINGS FOR FILL-IN begin_users_user_name IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN end_users_user_name IN FRAME F-Main
   NO-ENABLE                                                            */
