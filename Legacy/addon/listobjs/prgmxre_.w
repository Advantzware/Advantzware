...
&Scoped-Define ENABLED-OBJECTS RECT-1 list-order RECT-2 begin_table_name ~
end_table_name 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_table_name end_table_name ~
F1 F-3 
...
DEFINE VARIABLE begin_table_name AS CHARACTER FORMAT "X(10)" 
     LABEL "Beginning Table Name" 
     VIEW-AS FILL-IN 
     SIZE 15.6 BY 1.

DEFINE VARIABLE end_table_name AS CHARACTER FORMAT "X(10)" 
     LABEL "Ending Table Name" 
     VIEW-AS FILL-IN 
     SIZE 15.6 BY 1.
...
DEFINE FRAME F-Main
     ...
     begin_table_name AT ROW 6 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Table Name"
     end_table_name AT ROW 7.43 COL 45 COLON-ALIGNED HELP
          "Enter Ending Table Name"
     F1 AT ROW 6 COL 63 NO-LABEL
     F-3 AT ROW 7.43 COL 63 NO-LABEL
