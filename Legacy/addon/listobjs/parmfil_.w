...
&Scoped-Define ENABLED-OBJECTS RECT-1 list-order RECT-2 begin_parmfile ~
end_parmfile 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_parmfile end_parmfile F1 ~
F-3 
...
DEFINE VARIABLE begin_parmfile AS CHARACTER FORMAT "X(40)" 
     LABEL "Beginning  Parameter File" 
     VIEW-AS FILL-IN 
     SIZE 42 BY 1.

DEFINE VARIABLE end_parmfile AS CHARACTER FORMAT "X(40)" 
     LABEL "Ending Parameter File" 
     VIEW-AS FILL-IN 
     SIZE 42 BY 1.
...
DEFINE FRAME F-Main
     ...
     begin_parmfile AT ROW 5.76 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Parameter File"
     end_parmfile AT ROW 7.19 COL 45 COLON-ALIGNED HELP
          "Enter Ending Parameter File"
     F1 AT ROW 5.76 COL 89 NO-LABEL
     F-3 AT ROW 7.19 COL 89 NO-LABEL
