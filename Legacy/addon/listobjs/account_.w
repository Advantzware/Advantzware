...
&Scoped-Define ENABLED-OBJECTS RECT-2 RECT-1 list-order begin_actnum ~
end_actnum 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_actnum begin_account_dscr ~
end_actnum end_account_dscr F1 F-2 F-3 F-4 
...
DEFINE VARIABLE begin_account_dscr AS CHARACTER FORMAT "X(30)" 
     LABEL "Beginning Account Description" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE begin_actnum AS CHARACTER FORMAT "X(10)" 
     LABEL "Beginning Account" 
     VIEW-AS FILL-IN 
     SIZE 15.6 BY 1.

DEFINE VARIABLE end_account_dscr AS CHARACTER FORMAT "X(30)" 
     LABEL "Ending Account Description" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE end_actnum AS CHARACTER FORMAT "X(10)" 
...
DEFINE FRAME F-Main
     ...
     begin_actnum AT ROW 4.81 COL 45 COLON-ALIGNED HELP
          "Enter Beginning <Name>"
     begin_account_dscr AT ROW 6 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Description"
     end_actnum AT ROW 8.14 COL 45 COLON-ALIGNED HELP
          "Enter Ending <Name>"
     end_account_dscr AT ROW 9.33 COL 45 COLON-ALIGNED HELP
