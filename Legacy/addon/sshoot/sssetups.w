...
DEFINE FRAME DEFAULT-FRAME
     btn-count AT ROW 1.24 COL 2
     btn-post AT ROW 3.38 COL 2
...
ON END-ERROR OF C-Win /* Setup  Menu */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Setup  Menu */
DO:
...
&Scoped-define SELF-NAME btn-count
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn-count C-Win
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  APPLY "entry" TO btn-count.
    ...
    {methods/setButton.i btn-count "Setup"} /* added by script _nonAdm1Images.p on 03.28.2017 @ 10:43:22 am */
    {methods/setButton.i btn-post "Post"} /* added by script _nonAdm1Images.p on 03.28.2017 @ 10:43:22 am */
