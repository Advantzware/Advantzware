...
lv-font-no td-show-parm rd-dest begin_shift end_shift RECT-2 RECT-6 
&Scoped-Define DISPLAYED-OBJECTS lv-ornt lines-per-page lv-font-no ~
td-show-parm lv-font-name rd-dest selected-company begin_shift end_shift 
...
DEFINE FRAME FRAME-A
     ...
     begin_shift AT ROW 5.52 COL 37 COLON-ALIGNED HELP
          "Enter Beginning Shift"
     end_shift AT ROW 7.19 COL 37 COLON-ALIGNED HELP
          "Enter Ending Shift"
...
/* security check need {methods/prgsecur.i} in definition section */
  ...
  DO WITH FRAME {&frame-name}:
    {methods/setButton.i btn-cancel "Cancel"} /* added by script _nonAdm1Images2.p on 04.07.2017 @  2:07:21 pm */
    {methods/setButton.i btn-ok "OK"} /* added by script _nonAdm1Images2.p on 04.07.2017 @  2:07:21 pm */
    {custom/usrprint.i}
  END.
  {methods/nowait.i}
...
------------------------------------------------------------------------------*/
  DISPLAY lv-ornt lines-per-page lv-font-no td-show-parm lv-font-name rd-dest 
          selected-company begin_shift end_shift 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE btn-ok btn-cancel lv-ornt lines-per-page lv-font-no td-show-parm 
         rd-dest begin_shift end_shift RECT-2 RECT-6 
      WITH FRAME FRAME-A IN WINDOW C-Win.
