...
DEFINE VARIABLE fi_file AS CHARACTER FORMAT "X(30)" INITIAL "c:~\tmp~\r-daysum.csv" 
...
DEFINE FRAME FRAME-A
     begin_employee AT ROW 3.86 COL 25 COLON-ALIGNED HELP
          "Enter Beginning Employee"
     end_employee AT ROW 3.86 COL 68 COLON-ALIGNED HELP
...
------------------------------------------------------------------------------*/
  DISPLAY begin_employee end_employee begin_job-no begin_job-no2 end_job-no 
          end_job-no2 begin-date end-date rd-dest lv-ornt lines-per-page 
