...
DEFINE VARIABLE fi_file AS CHARACTER FORMAT "X(30)" INITIAL "c:~\tmp~\r-mchchg.csv" 
...
DEFINE FRAME FRAME-A
     ...
     tb_excel AT ROW 17.29 COL 31.4
     tb_runExcel AT ROW 17.33 COL 90 RIGHT-ALIGNED
     fi_file AT ROW 18.48 COL 29.6 COLON-ALIGNED HELP
          "Enter File Name"
...
/*==== Report main body procedure ================================*/
  ...
  DO:
      ...
      ASSIGN excelheader = "Machine,Description,Sequence,Charge,Category,Description".
