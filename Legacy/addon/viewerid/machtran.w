...
{Advantzware\WinKit\admViewersUsing.i} /* added by script _admViewers.p on 04.07.2017 @  2:08:05 pm */

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CUSTOM _DEFINITIONS V-table-Win 
/*------------------------------------------------------------------------

  File: viewerid/machtran.w
...
&Scoped-Define ENABLED-FIELDS machtran.job_number machtran.job_sub ~
machtran.form_number machtran.blank_number machtran.pass_sequence ~
machtran.charge_code machtran.shift 
&Scoped-define FIELD-PAIRS~
 ~{&FP1}job_number ~{&FP2}job_number ~{&FP3}~
 ~{&FP1}job_sub ~{&FP2}job_sub ~{&FP3}~
 ~{&FP1}form_number ~{&FP2}form_number ~{&FP3}~
 ~{&FP1}blank_number ~{&FP2}blank_number ~{&FP3}~
 ~{&FP1}pass_sequence ~{&FP2}pass_sequence ~{&FP3}~
 ~{&FP1}charge_code ~{&FP2}charge_code ~{&FP3}~
 ~{&FP1}shift ~{&FP2}shift ~{&FP3}
&Scoped-define ENABLED-TABLES machtran
&Scoped-define FIRST-ENABLED-TABLE machtran
&Scoped-Define ENABLED-OBJECTS RECT-1 
&Scoped-Define DISPLAYED-FIELDS machtran.job_number machtran.job_sub ~
machtran.form_number machtran.blank_number machtran.pass_sequence ~
machtran.charge_code machtran.shift 
...
DEFINE FRAME F-Main
     ...
     machtran.charge_code AT ROW 1.71 COL 119 COLON-ALIGNED
          ...
          SIZE 8 BY 1
          BGCOLOR 15 FONT 4
     machtran.shift AT ROW 1.71 COL 135 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 3.2 BY 1
          BGCOLOR 15 FONT 4
