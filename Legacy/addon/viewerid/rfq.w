...
&Scoped-Define ENABLED-FIELDS rfq.rfq-no rfq.cust-no rfq.req-date 
&Scoped-define ENABLED-TABLES rfq
&Scoped-define FIRST-ENABLED-TABLE rfq
&Scoped-Define ENABLED-OBJECTS RECT-1 
&Scoped-Define DISPLAYED-FIELDS rfq.rfq-no rfq.cust-no rfq.req-date 
...
DEFINE FRAME F-Main
     rfq.rfq-no AT ROW 1.48 COL 17 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 14 BY 1
          FONT 6
     rfq.cust-no AT ROW 1.48 COL 52 COLON-ALIGNED
          LABEL "Customer #"
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
          FONT 6
     rfq.req-date AT ROW 1.48 COL 93 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
          FONT 6
...
/* SETTINGS FOR FILL-IN rfq.cust-no IN FRAME F-Main
   EXP-LABEL                                                            */
