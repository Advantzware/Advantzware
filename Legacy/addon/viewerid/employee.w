...
employee.last_name employee.soc_sec 
...
DEFINE FRAME F-Main
     employee.employee AT ROW 1.71 COL 10 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 8 BY 1
          BGCOLOR 15 FONT 4
     employee.first_name AT ROW 1.71 COL 33 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 14 BY 1
          BGCOLOR 15 FONT 4
     employee.last_name AT ROW 1.71 COL 62 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
          BGCOLOR 15 FONT 4
     employee.soc_sec AT ROW 1.71 COL 104 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 15.2 BY 1
          BGCOLOR 15 FONT 4
...
/* SETTINGS FOR FILL-IN employee.employee IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN employee.first_name IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN employee.last_name IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN employee.soc_sec IN FRAME F-Main
   NO-ENABLE                                                            */
