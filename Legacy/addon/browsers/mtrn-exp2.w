...
DEFINE INPUT PARAMETER piMchFrom AS CHAR NO-UNDO.
DEFINE INPUT PARAMETER piMchTo AS CHAR NO-UNDO.
...
ASSIGN cTextListToSelect = "Machine,Job,Sub,Form,Blk,Pass,Charge,Start Date,Log In,End Date,Shift,Log Out,Run,Total"
...
{sys/inc/ttRptSel.i}
    ...
    ASSIGN cTextListToDefault  = "Machine,Job,Sub,Form,Blk,Pass,Charge,Start Date,Log In,End Date,Shift,Log Out,Run,Total" .
...
begin_job begin_job2 end_job end_job2 sl_avail sl_selected tb_excel ~
tb_runExcel fi_file 
...
DEFINE FRAME rd-exlexp
     begin_date AT ROW 3.24 COL 26 COLON-ALIGNED HELP
          "Enter Beginning Due Date" WIDGET-ID 112
     end_date AT ROW 3.19 COL 69 COLON-ALIGNED HELP
          "Enter Ending Due Date" WIDGET-ID 114
     begin_mch AT ROW 4.33 COL 26 COLON-ALIGNED HELP
          "Enter Beginning Vendor Item Number" WIDGET-ID 104
     end_mch AT ROW 4.33 COL 69 COLON-ALIGNED HELP
          "Enter Ending Vendor Item Number" WIDGET-ID 106
     begin_job AT ROW 5.48 COL 26 COLON-ALIGNED HELP
          "Enter Beginning Job Number" WIDGET-ID 108
     begin_job2 AT ROW 5.48 COL 39.2 COLON-ALIGNED HELP
          "Enter Beginning Job Number" NO-LABEL WIDGET-ID 116
     end_job AT ROW 5.48 COL 69 COLON-ALIGNED HELP
          "Enter Ending Job Number" WIDGET-ID 110
     end_job2 AT ROW 5.48 COL 82 COLON-ALIGNED HELP
...
ON HELP OF FRAME rd-exlexp /* Export Employee Transactions to Excel */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL rd-exlexp rd-exlexp
ON WINDOW-CLOSE OF FRAME rd-exlexp /* Export Employee Transactions to Excel */
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY begin_date end_date begin_mch end_mch begin_job begin_job2 end_job 
          end_job2 sl_avail sl_selected tb_excel tb_runExcel fi_file 
...
FOR EACH machtran WHERE machtran.company = cocode
    ...
    FOR EACH ttRptSelected:
        ...
        IF lookup(ttRptSelected.FieldList,"strt-time,end-time,ttl-time") EQ 0 THEN do:
