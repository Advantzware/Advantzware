...
&Scoped-define OPEN-QUERY-Browser-Table OPEN QUERY Browser-Table FOR EACH statecod WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Browser-Table statecod
&Scoped-define FIRST-TABLE-IN-QUERY-Browser-Table statecod
...
DEFINE FRAME F-Main
     ...
     Btn_Clear_Find AT ROW 19.33 COL 48 HELP
