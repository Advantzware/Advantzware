...
&scoped-define SORTBY-2 BY tt-note.note_title
&scoped-define fld-name-1 tt-note.note_date
&scoped-define fld-name-2 tt-note.note_title
...
&Scoped-define INTERNAL-TABLES tt-note

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table tt-note.note_title tt-note.note_date tt-note.note-src   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table   
&Scoped-define SELF-NAME br_table
&Scoped-define QUERY-STRING-br_table FOR EACH tt-note ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY {&SELF-NAME} FOR EACH tt-note ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table tt-note
&Scoped-define FIRST-TABLE-IN-QUERY-br_table tt-note
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _FREEFORM
  QUERY br_table NO-LOCK DISPLAY
      tt-note.note_title                     LABEL-BGCOLOR 14
      tt-note.note_date form "99/99/9999"    LABEL-BGCOLOR 14
      tt-note.note-src label "Note From"     LABEL-BGCOLOR 14
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 136 BY 7.86
         FONT 2.
...
DEFINE FRAME F-Main
     ...
     fi_sortby AT ROW 9 COL 33.6 COLON-ALIGNED NO-LABEL WIDGET-ID 2
...
/* Query rebuild information for BROWSE br_table
     _START_FREEFORM
      OPEN QUERY {&SELF-NAME} FOR EACH tt-note ~{&SORTBY-PHRASE}
     _END_FREEFORM
...
DO:
  ...
  run get-link-handle in adm-broker-hdl (this-procedure, "note-text-target", output char-hdl).
  if valid-handle(widget-handle(char-hdl)) then run disp-text in widget-handle(char-hdl) (tt-note.note_text) .
END.
...
------------------------------------------------------------------------------*/
  ...
  run get-link-handle in adm-broker-hdl (this-procedure, "note-text-target", output char-hdl).
  if avail tt-note then do:
     if valid-handle(widget-handle(char-hdl)) then run disp-text in widget-handle(char-hdl) (tt-note.note_text) .
  end.   
  else if valid-handle(widget-handle(char-hdl)) then run disp-text in widget-handle(char-hdl) ("") .
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "tt-note"}
