...
&Scoped-define INTERNAL-TABLES note rec_key prgmxref

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE Browser-Table                                 */
&Scoped-define FIELDS-IN-QUERY-Browser-Table note.note_date ~
STRING(note.note_time,'HH:MM:SS am') @ notetime note.note_title ~
rec_key.table_name prgmxref.prgmname 
&Scoped-define ENABLED-FIELDS-IN-QUERY-Browser-Table 
&Scoped-define FIELD-PAIRS-IN-QUERY-Browser-Table
&Scoped-define OPEN-QUERY-Browser-Table OPEN QUERY Browser-Table FOR EACH note WHERE ~{&KEY-PHRASE} ~
      AND note.note_text CONTAINS word_search OR word_search = '' NO-LOCK, ~
      EACH rec_key OF note NO-LOCK, ~
      EACH prgmxref OF rec_key NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Browser-Table note rec_key prgmxref
&Scoped-define FIRST-TABLE-IN-QUERY-Browser-Table note


/* Definitions for FRAME F-Main                                         */

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS Browser-Table RECT-4 auto_find Btn_Search ~
word_search Btn_Run 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      note.note_date
      STRING(note.note_time,'HH:MM:SS am') @ notetime COLUMN-LABEL "Note Time" FORMAT "X(11)"
      note.note_title
      rec_key.table_name
      prgmxref.prgmname
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 147 BY 16.43
         FONT 2.
...
/* Query rebuild information for BROWSE Browser-Table
     _TblList          = "NOSWEAT.note,NOSWEAT.rec_key OF NOSWEAT.note,NOSWEAT.prgmxref OF NOSWEAT.rec_key"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = "USED,,"
     _Where[1]         = "note.note_text CONTAINS word_search OR word_search = ''"
     _FldNameList[1]   = NOSWEAT.note.note_date
     _FldNameList[2]   > "_<CALC>"
"STRING(note.note_time,'HH:MM:SS am') @ notetime" "Note Time" "X(11)" ? ? ? ? ? ? ? no ?
     _FldNameList[3]   = NOSWEAT.note.note_title
