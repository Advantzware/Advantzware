...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _FREEFORM
  QUERY br_table NO-LOCK DISPLAY
      tt-note.note_title tt-note.note_date form "99/99/9999"
      tt-note.note-src label "Note From"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
  ...
  for each bf-machemp where bf-machemp.employee = employee.employee no-lock:
