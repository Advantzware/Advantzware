...
&scoped-define SORTBY-1 BY itemfg.upc-no
&scoped-define SORTBY-2 BY itemfg.i-name
&scoped-define fld-name-1 itemfg.upc-no
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-1 itemfg.upc-no itemfg.i-no ~
itemfg.i-name 
...
DEFINE FRAME Dialog-Frame
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         TITLE "Finished Good Information (UPC#)".
...
/* Query rebuild information for BROWSE BROWSE-1
     ...
     _FldNameList[1]   = ASI.itemfg.upc-no
     _FldNameList[2]   = ASI.itemfg.i-no
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Finished Good Information (UPC#) */
DO:
...
DO:
   op-char-val = itemfg.upc-no:screen-value in browse {&browse-name} + "," +
