...
loadtag.i-name loadtag.loc loadtag.loc-bin loadtag.po-no loadtag.qty ~
loadtag.qty-case loadtag.pallet-count 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-1 
&Scoped-define QUERY-STRING-BROWSE-1 FOR EACH loadtag WHERE ~{&KEY-PHRASE} ~
      AND loadtag.company GE loadtag.company ~
AND loadtag.i-no GE loadtag.i-no ~
AND loadtag.item-type EQ YES NO-LOCK, ~
...
/* Query rebuild information for BROWSE BROWSE-1
     ...
     _TblOptList       = ", FIRST"
     _Where[1]         = "ASI.loadtag.company GE ASI.loadtag.company
AND ASI.loadtag.i-no GE ASI.loadtag.i-no
AND ASI.loadtag.item-type EQ YES"
...
"loadtag.po-no" "PO#" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > ASI.loadtag.qty
"loadtag.qty" "Qty" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   = ASI.loadtag.qty-case
     _FldNameList[9]   = ASI.loadtag.pallet-count
     _Query            is OPENED
*/  /* BROWSE BROWSE-1 */
&ANALYZE-RESUME
