  ...
  CASE adm-current-page: 
    ...
    WHEN 2 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updsav-3 ).
       RUN set-position IN h_p-updsav-3 ( 21.95 , 65.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_p-updsav-3 , 'TableIO':U , h_machemp ).
    ...
    WHEN 4 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updsav-4 ).
       RUN set-position IN h_p-updsav-4 ( 16.48 , 104.00 ) NO-ERROR.
       RUN set-size IN h_p-updsav-4 ( 3.10 , 44.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_p-updsav-4 , 'TableIO':U , h_emplog2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_employe2 ,
             h_folder , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_emplog2-2 ,
             h_employe2 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_emplog2 ,
             h_emplog2-2 , 'AFTER':U ).
    ...
    WHEN 5 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_machemp1 , 'Record':U , h_machemp3 ).
    ...
    WHEN 6 THEN DO:
       ...
       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_allnotes ,
             h_folder , 'AFTER':U ).
