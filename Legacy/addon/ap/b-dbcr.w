...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      ...
      ap-pay.check-no COLUMN-LABEL "Memo Number" FORMAT "9999999999":U
            WIDTH 19.2
...
/* Query rebuild information for BROWSE Browser-Table
 ...
 AND ASI.ap-pay.memo = TRUE
 AND ASI.ap-pay.posted = FALSE"
     _FldNameList[1]   > ASI.ap-pay.vend-no
"ap-pay.vend-no" "Vendor#" ? "character" ? ? ? ? ? ? no ? no no "17.2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   = ASI.vend.name
     _FldNameList[3]   > ASI.ap-pay.check-no
"ap-pay.check-no" "Memo Number" "9999999999" "integer" ? ? ? ? ? ? no ? no no "19.2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > ASI.ap-pay.check-date
"ap-pay.check-date" "Memo Date" ? "date" ? ? ? ? ? ? no ? no no "18.2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
