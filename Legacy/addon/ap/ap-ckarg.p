/***************************************************************************\
*****************************************************************************
**  Program: ap\ap-ckarg.p  copied from ap-chks.p
**       By: Yoosun Kim
** Descript: Argrove format check.
**
*****************************************************************************
\***************************************************************************/
  ...
  for each ap-chk
    ...
    if ll = max-per-chk / 2 and v-left and not last-of(ap-sel.vend-no) then do:
      ...
      display skip(12)
        ...
        with WIDTH 100 frame u no-box no-labels no-attr-space.
        ...
        for each wrk-chk:
          ...
          if ll eq max-per-chk / 2 and v-left and
            ...
            display skip(12)
                  ...
                  " V V      O   O       I       D   D"  at 10 skip
                  "  V        OOO       III      DDDD "  at 10 skip(8)
                  with WIDTH 100 frame m no-box no-labels no-attr-space.
