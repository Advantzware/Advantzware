...
DEFINE TEMP-TABLE oe-ord NO-UNDO LIKE ASI.oe-ord.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + '&Brws Order#|View &Order|View &Item|&Shipping Inf|&FG Item Info' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
