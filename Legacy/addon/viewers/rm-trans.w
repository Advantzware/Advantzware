...
DEFINE FRAME F-Main
     rm-rcpt.trans-date AT ROW 1.48 COL 20 COLON-ALIGNED
          LABEL "Transfer Date"
          VIEW-AS FILL-IN 
          SIZE 11.6 BY 1
          BGCOLOR 15 FONT 4
     rm-rcpt.i-no AT ROW 1.48 COL 46 COLON-ALIGNED
          LABEL "Item #"
          VIEW-AS FILL-IN 
          SIZE 14 BY 1
          BGCOLOR 15 FONT 4
     rm-rcpt_i-name AT ROW 1.48 COL 64 COLON-ALIGNED NO-LABEL
     BUTTON-1 AT ROW 1 COL 116
     F1 AT ROW 1.48 COL 62 NO-LABEL
...
------------------------------------------------------------------------------*/
  ...
  {methods/viewers/create/rm-trans.i}
