...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES empmach
&Scoped-define FIRST-EXTERNAL-TABLE empmach


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR empmach.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS empmach.machine empmach.gl_account 
&Scoped-define ENABLED-TABLES empmach
&Scoped-define FIRST-ENABLED-TABLE empmach
&Scoped-Define ENABLED-OBJECTS RECT-1 
&Scoped-Define DISPLAYED-FIELDS empmach.machine empmach.gl_account 
&Scoped-define DISPLAYED-TABLES empmach
&Scoped-define FIRST-DISPLAYED-TABLE empmach
&Scoped-Define DISPLAYED-OBJECTS mach_m-dscr F1 F-2 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,ROW-AVAILABLE,DISPLAY-FIELD,List-5,F1 */
&Scoped-define DISPLAY-FIELD empmach.machine 
...
DEFINE FRAME F-Main
     empmach.machine AT ROW 1.24 COL 11 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 10.2 BY 1
          BGCOLOR 15 FONT 4
     mach_m-dscr AT ROW 1.24 COL 23 COLON-ALIGNED NO-LABEL
     empmach.gl_account AT ROW 2.43 COL 16 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 33 BY 1
          BGCOLOR 15 FONT 4
     F1 AT ROW 1.24 COL 23 NO-LABEL
     F-2 AT ROW 2.43 COL 51 NO-LABEL
...
/* SETTINGS FOR FILL-IN empmach.machine IN FRAME F-Main
   4                                                                    */
...
ON ENTRY OF empmach.gl_account IN FRAME F-Main /* G/L Account */
DO:
  {custom/actentry.i}
END.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "empmach"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "empmach"}
...
------------------------------------------------------------------------------*/
  ...
  {methods/viewers/create/empmach.i}
