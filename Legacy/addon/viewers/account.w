...
&Scoped-Define ENABLED-FIELDS account.actnum account.dscr account.type ~
account.cyr-open account.lyr-open 
&Scoped-define FIELD-PAIRS~
 ~{&FP1}actnum ~{&FP2}actnum ~{&FP3}~
 ~{&FP1}dscr ~{&FP2}dscr ~{&FP3}~
 ~{&FP1}type ~{&FP2}type ~{&FP3}~
 ~{&FP1}cyr-open ~{&FP2}cyr-open ~{&FP3}~
 ~{&FP1}lyr-open ~{&FP2}lyr-open ~{&FP3}
&Scoped-define ENABLED-TABLES account
&Scoped-define FIRST-ENABLED-TABLE account
&Scoped-Define ENABLED-OBJECTS RECT-1 
&Scoped-Define DISPLAYED-FIELDS account.actnum account.dscr account.type ~
account.cyr-open account.lyr-open 
...
DEFINE FRAME F-Main
     account.actnum AT ROW 3.14 COL 27 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
          BGCOLOR 15 FONT 4
     account.dscr AT ROW 4.14 COL 27 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 56 BY 1
          BGCOLOR 15 FONT 4
     account.type AT ROW 5.14 COL 27 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 3.2 BY 1
          BGCOLOR 15 FONT 4
     account.cyr-open AT ROW 6.14 COL 27 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 24.8 BY 1
          BGCOLOR 15 FONT 4
     account.lyr-open AT ROW 7.14 COL 27 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 24.8 BY 1
          BGCOLOR 15 FONT 4
     F1 AT ROW 3.14 COL 61 NO-LABEL
