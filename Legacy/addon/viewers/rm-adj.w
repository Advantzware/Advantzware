...
{Advantzware\WinKit\admViewersUsing.i} /* added by script _admViewers.p on 04.07.2017 @  2:08:20 pm */
...
&Scoped-Define ENABLED-FIELDS rm-rcpt.trans-date rm-rcpt.i-no 
...
&Scoped-Define DISPLAYED-FIELDS rm-rcpt.trans-date rm-rcpt.i-no 
...
DEFINE FRAME F-Main
     BUTTON-1 AT ROW 1 COL 120
     rm-rcpt.trans-date AT ROW 1.48 COL 23 COLON-ALIGNED
          LABEL "Adjustment Date"
          VIEW-AS FILL-IN 
          SIZE 11.6 BY 1
          BGCOLOR 15 FONT 4
     rm-rcpt.i-no AT ROW 1.48 COL 50 COLON-ALIGNED
          LABEL "Item #"
          VIEW-AS FILL-IN 
          SIZE 14 BY 1
          BGCOLOR 15 FONT 4
     rm-rcpt_i-name AT ROW 1.48 COL 68 COLON-ALIGNED NO-LABEL
     F1 AT ROW 1.48 COL 66 NO-LABEL
...
------------------------------------------------------------------------------*/
  ...
  {methods/viewers/create/rm-adj.i}
