...
&Scoped-define INTERNAL-TABLES po-ordl po-ord ttbl ttbl-roll

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE Browser-Table                                 */
&Scoped-define FIELDS-IN-QUERY-Browser-Table po-ordl.po-no po-ordl.i-no ~
...
/* Query rebuild information for BROWSE Browser-Table
     ...
     _TblOptList       = ", FIRST"
     _Where[1]         = "ASI.po-ordl.company = cocode and
ASI.po-ordl.deleted = no and
ASI.po-ordl.stat <> ""C"" and
po-ordl.item-type = no
"
     _JoinCode[2]      = "ASI.po-ord.company = ASI.po-ordl.company
  AND ASI.po-ord.po-no = ASI.po-ordl.po-no
  AND ASI.po-ord.stat <> ""H"""
...
DO:
   ...
   */
    IF AVAIL itemfg THEN ASSIGN ttbl.loc = itemfg.def-loc
                                ...
                                ttbl.qty-case = itemfg.case-count.
  END.
...
DO:
  ...
  assign v-label   = sys-ctrl.descrip + "roll.lbl"
         v-exp-dir = sys-ctrl.descrip + "fgload1.txt".
