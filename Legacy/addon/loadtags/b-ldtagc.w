...
/* ***************************  Definitions  ************************** */
&SCOPED-DEFINE yellowColumnsName loadtag
...
&Scoped-define FIELDS-IN-QUERY-Browser-Table loadtag.tag-no loadtag.loc-bin ~
loadtag.loc loadtag.job-no2 loadtag.job-no loadtag.po-no loadtag.ord-no ~
loadtag.i-name loadtag.i-no 
&Scoped-define ENABLED-FIELDS-IN-QUERY-Browser-Table 
&Scoped-define QUERY-STRING-Browser-Table FOR EACH loadtag WHERE ~{&KEY-PHRASE} ~
      AND loadtag.company = g_company and ~
loadtag.item-type = no /* for fgitem */ ~
and loadtag.is-case-tag  NO-LOCK ~
    ~{&SORTBY-PHRASE}
...
DEFINE FRAME F-Main
     ...
     fi_sortby AT ROW 19.43 COL 48 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     "By:" VIEW-AS TEXT
...
"tag-no" ? "X(23)" "character" ? ? ? 14 ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > ASI.loadtag.loc-bin
"loc-bin" ? ? "character" ? ? ? 14 ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > ASI.loadtag.loc
"loc" ? ? "character" ? ? ? 14 ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > ASI.loadtag.job-no2
"job-no2" ? ? "integer" ? ? ? 14 ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > ASI.loadtag.job-no
"job-no" ? ? "character" ? ? ? 14 ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > ASI.loadtag.po-no
"po-no" ? ? "integer" ? ? ? 14 ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > ASI.loadtag.ord-no
"ord-no" ? ? "integer" ? ? ? 14 ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > ASI.loadtag.i-name
"i-name" ? ? "character" ? ? ? 14 ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > ASI.loadtag.i-no
