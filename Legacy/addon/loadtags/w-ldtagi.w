...
DEFINE VARIABLE h_b-ldtagi AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Loadtag Maintenance (Raw Materials)"
         HEIGHT             = 24
         WIDTH              = 150
         MAX-HEIGHT         = 24
         MAX-WIDTH          = 150
...
ON END-ERROR OF W-Win /* Loadtag Maintenance (Raw Materials) */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Loadtag Maintenance (Raw Materials) */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Brwse Loadtag|View RM Tag' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-ldtagi ).
       RUN set-position IN h_b-ldtagi ( 4.81 , 4.00 ) NO-ERROR.
       RUN set-size IN h_b-ldtagi ( 19.52 , 145.00 ) NO-ERROR.
       ...
       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-ldtagi ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-ldtagi ).
       RUN set-position IN h_v-ldtagi ( 5.52 , 3.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_b-ldtagi , 'Record':U , h_v-ldtagi ).
