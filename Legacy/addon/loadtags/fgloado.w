...
DEFINE VARIABLE h_loadordr AS HANDLE NO-UNDO.
...
IF NOT W-Win:LOAD-ICON("images\progress":U) THEN
...
ON END-ERROR OF W-Win /* FG Stock Load Tags */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* FG Stock Load Tags */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Btn_Exit W-Win
ON CHOOSE OF Btn_Exit IN FRAME F-Main /* Exit */
DO:
...
do:
  message "Sharp Shooter Module has Timed Out." skip
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'loadtags/loadordr.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_loadordr ).
       RUN set-position IN h_loadordr ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_loadordr ( 20.00 , 133.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_loadordr ,
             Btn_Exit:HANDLE IN FRAME F-Main , 'BEFORE':U ).
    END. /* Page 0 */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Viewer_Update_Mode W-Win 
PROCEDURE Viewer_Update_Mode :
/*------------------------------------------------------------------------------
  Purpose:     dummy procedure to enable working with NoSweat Browser
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
