...
&Scoped-define INTERNAL-TABLES loadtag rm-rctd
...
and loadtag.item-type = ip-item-type NO-LOCK, ~
      EACH rm-rctd WHERE rm-rctd.company = loadtag.company ~
  AND rm-rctd.loc = loadtag.loc  ~
  AND rm-rctd.tag = loadtag.tag-no ~
      AND rm-rctd.rita-code = "R" NO-LOCK ~
    ~{&SORTBY-PHRASE}
...
and loadtag.item-type = ip-item-type NO-LOCK, ~
  ...
  AND rm-rctd.tag = loadtag.tag-no ~
      AND rm-rctd.rita-code = "R" NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-BROWSE-1 loadtag rm-rctd
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-1 loadtag
&Scoped-define SECOND-TABLE-IN-QUERY-BROWSE-1 rm-rctd
...
/* Query rebuild information for BROWSE BROWSE-1
     _TblList          = "ASI.loadtag,ASI.rm-rctd WHERE ASI.loadtag ... ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "ASI.loadtag.company = ip-company
and loadtag.item-type = ip-item-type"
     _JoinCode[2]      = "ASI.rm-rctd.company = ASI.loadtag.company
  AND ASI.rm-rctd.loc = ASI.loadtag.loc 
  AND ASI.rm-rctd.tag = ASI.loadtag.tag-no"
     _Where[2]         = "ASI.rm-rctd.rita-code = ""R"""
