...
display-dimension('L') @ lv-po-len 
&Scoped-define ENABLED-FIELDS-IN-QUERY-Browser-Table rm-rctd.tag ~
rm-rctd.loc rm-rctd.loc-bin rm-rctd.job-no rm-rctd.job-no2 rm-rctd.qty 
...
"r-no" "Seq#" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
...
"rct-date" "Issue Date" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[6]   > asi.rm-rctd.po-no
"po-no" ? "x(6)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
