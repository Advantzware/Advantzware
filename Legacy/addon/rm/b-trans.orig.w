...
&Scoped-define FIELDS-IN-QUERY-Browser-Table rm-rctd.tag rm-rctd.rct-date ~
rm-rctd.i-no rm-rctd.i-name rm-rctd.loc rm-rctd.loc-bin rm-rctd.qty ~
rm-rctd.tag2 rm-rctd.loc2 rm-rctd.loc-bin2 
&Scoped-define ENABLED-FIELDS-IN-QUERY-Browser-Table rm-rctd.tag ~
rm-rctd.rct-date rm-rctd.i-no rm-rctd.i-name rm-rctd.loc rm-rctd.loc-bin ~
rm-rctd.qty rm-rctd.tag2 rm-rctd.loc2 rm-rctd.loc-bin2 
...
"rm-rctd.tag" "From!Tag" "x(20)" "character" ? ? ? ? ? ? yes ? no no "28" yes no no "U" "" ""
     _FldNameList[2]   > asi.rm-rctd.rct-date
"rm-rctd.rct-date" "Transfer!Date" ? "date" ? ? ? ? ? ? yes ? no no "15" yes no no "U" "" ""
     _FldNameList[3]   > asi.rm-rctd.i-no
"rm-rctd.i-no" ? ? "character" ? ? ? ? ? ? yes ? no no "15" yes no no "U" "" ""
     _FldNameList[4]   > asi.rm-rctd.i-name
"rm-rctd.i-name" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[5]   > asi.rm-rctd.loc
"rm-rctd.loc" "From!Whs" ? "character" ? ? ? ? ? ? yes ? no no "8" yes no no "U" "" ""
     _FldNameList[6]   > asi.rm-rctd.loc-bin
"rm-rctd.loc-bin" "From!Bin" ? "character" ? ? ? ? ? ? yes ? no no "12" yes no no "U" "" ""
     _FldNameList[7]   > asi.rm-rctd.qty
"rm-rctd.qty" "Qty" ? "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
     _FldNameList[8]   > asi.rm-rctd.tag2
"rm-rctd.tag2" "To !Tag" "x(20)" "character" ? ? ? ? ? ? yes ? no no "28" yes no no "U" "" ""
     _FldNameList[9]   > asi.rm-rctd.loc2
"rm-rctd.loc2" "To !Whs" ? "character" ? ? ? ? ? ? yes ? no no "8" yes no no "U" "" ""
     _FldNameList[10]   > asi.rm-rctd.loc-bin2
"rm-rctd.loc-bin2" "To!Bin" ? "character" ? ? ? ? ? ? yes ? no no "12" yes no no "U" "" ""
