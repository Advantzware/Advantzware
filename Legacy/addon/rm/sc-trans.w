...
&Scoped-Define ENABLED-OBJECTS BUTTON-2 Scan_Label BUTTON-1 To_Whse To_Bin ~
To_Tag Btn_Close 
&Scoped-Define DISPLAYED-OBJECTS Scan_Label Qty From_Whse From_Bin From_Tag ~
To_Whse To_Bin To_Tag 
...
DEFINE FRAME DEFAULT-FRAME
     BUTTON-2 AT ROW 6 COL 105
     Scan_Label AT ROW 1.95 COL 25 COLON-ALIGNED
     BUTTON-1 AT ROW 2.19 COL 105
     Qty AT ROW 3.62 COL 25 COLON-ALIGNED
     From_Whse AT ROW 5.52 COL 34 COLON-ALIGNED
     From_Bin AT ROW 5.52 COL 58 COLON-ALIGNED
     From_Tag AT ROW 5.52 COL 83 COLON-ALIGNED
     To_Whse AT ROW 8.14 COL 34 COLON-ALIGNED
     To_Bin AT ROW 8.14 COL 58 COLON-ALIGNED
     To_Tag AT ROW 8.14 COL 83 COLON-ALIGNED
     Btn_Close AT ROW 9.81 COL 39
     "Transfer To" VIEW-AS TEXT
          SIZE 19 BY .95 AT ROW 8.14 COL 6
          FONT 6
     "Transfer From" VIEW-AS TEXT
          SIZE 19 BY .95 AT ROW 5.52 COL 6
          FONT 6
...
/* SETTINGS FOR FILL-IN From_Whse IN FRAME DEFAULT-FRAME
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN Qty IN FRAME DEFAULT-FRAME
   NO-ENABLE                                                            */
...
------------------------------------------------------------------------------*/
  DISPLAY Scan_Label Qty From_Whse From_Bin From_Tag To_Whse To_Bin To_Tag 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE BUTTON-2 Scan_Label BUTTON-1 To_Whse To_Bin To_Tag Btn_Close 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
