...
Begin_whse End_whse Begin_procat End_procat t-inc-bal 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_i-no end_i-no Begin_whse ~
End_whse Begin_procat End_procat t-inc-bal F1 F-2 
...
DEFINE FRAME F-Main
     ...
     end_i-no AT ROW 4.1 COL 78 COLON-ALIGNED HELP
          "Enter Ending <Name>"
     Begin_whse AT ROW 5.29 COL 31 COLON-ALIGNED
     End_whse AT ROW 5.29 COL 78 COLON-ALIGNED
     Begin_procat AT ROW 6.48 COL 31 COLON-ALIGNED
     End_procat AT ROW 6.48 COL 78 COLON-ALIGNED
     ...
     "Include Quantity on Order with Quantity on Hand?" VIEW-AS TEXT
          SIZE 49 BY .48 AT ROW 9.1 COL 16
