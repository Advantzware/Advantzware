...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       ...
       RUN set-size IN h_b-phys ( 11.19 , 140.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updbar ).
       RUN set-position IN h_p-updbar ( 21.24 , 22.00 ) NO-ERROR.
       RUN set-size IN h_p-updbar ( 2.38 , 107.00 ) NO-ERROR.

       /* Links to SmartNavBrowser h_b-phys. */
       RUN add-link IN adm-broker-hdl ( h_p-updbar , 'TableIO':U , h_b-phys ).
