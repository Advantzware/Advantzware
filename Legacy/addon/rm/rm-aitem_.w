...
Begin_procat End_procat Begin_mtype End_mtype item-cd t-inc-bal FILL-IN-1 
...
DEFINE VARIABLE FILL-IN-1 AS CHARACTER FORMAT "X(10)":U 
     LABEL "Calculate Value using On Hand or Available?" 
     VIEW-AS FILL-IN 
     SIZE 8 BY 1 NO-UNDO.

DEFINE VARIABLE item-cd AS CHARACTER FORMAT "X(1)":U 
     LABEL "Item Code" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME F-Main
     ...
     Begin_mtype AT ROW 6.24 COL 38 COLON-ALIGNED
     End_mtype AT ROW 6.24 COL 89 COLON-ALIGNED
     item-cd AT ROW 7.67 COL 66 COLON-ALIGNED
     t-inc-bal AT ROW 8.62 COL 68
     FILL-IN-1 AT ROW 9.81 COL 66 COLON-ALIGNED
     F-2 AT ROW 3.86 COL 107 NO-LABEL
     F1 AT ROW 4.1 COL 56 NO-LABEL
     RECT-1 AT ROW 1 COL 1
     "Include Quantity on Order with Quantity Available?" VIEW-AS TEXT
          SIZE 49 BY .95 AT ROW 8.62 COL 19
     "( 'E'st, 'R'eal, 'B'oth)" VIEW-AS TEXT
          SIZE 20 BY .71 AT ROW 7.67 COL 73
