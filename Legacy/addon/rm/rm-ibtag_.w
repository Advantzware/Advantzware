...
&Scoped-Define ENABLED-OBJECTS RECT-3 RECT-1 list-order begin_i-no end_i-no ~
begin_whse End_whse Begin_procat End_procat Begin_mtype End_mtype t-inc-bal ~
t-subtot t-gtot 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_i-no end_i-no begin_whse ~
End_whse Begin_procat End_procat Begin_mtype End_mtype t-inc-bal t-subtot ~
t-gtot F-2 F1 

/* Custom List Definitions                                              */
/* List-1,List-2,List-3,List-4,List-5,F1                                */
&Scoped-define F1 F-2 F1 
...
DEFINE VARIABLE Begin_mtype AS CHARACTER FORMAT "X(10)":U 
     LABEL "From Material Type" 
     VIEW-AS FILL-IN 
     SIZE 6 BY 1 NO-UNDO.
...
DEFINE VARIABLE End_mtype AS CHARACTER FORMAT "X(10)":U 
     LABEL "To Material Type" 
     VIEW-AS FILL-IN 
     SIZE 6 BY 1 NO-UNDO.
...
DEFINE VARIABLE End_whse AS CHARACTER FORMAT "X(10)":U 
     LABEL "To Warehouse" 
     VIEW-AS FILL-IN 
     SIZE 16 BY 1 NO-UNDO.
...
DEFINE VARIABLE t-gtot AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 3 BY .81 NO-UNDO.

DEFINE VARIABLE t-inc-bal AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 3 BY .81 NO-UNDO.

DEFINE VARIABLE t-subtot AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME F-Main
     ...
     end_i-no AT ROW 3.86 COL 89 COLON-ALIGNED HELP
          "Enter Ending <Name>"
     begin_whse AT ROW 5.05 COL 38 COLON-ALIGNED
     End_whse AT ROW 5.05 COL 89 COLON-ALIGNED
     Begin_procat AT ROW 6.24 COL 38 COLON-ALIGNED
     End_procat AT ROW 6.24 COL 89 COLON-ALIGNED
     Begin_mtype AT ROW 7.43 COL 38 COLON-ALIGNED
     End_mtype AT ROW 7.43 COL 89 COLON-ALIGNED
     t-inc-bal AT ROW 8.86 COL 68
     t-subtot AT ROW 9.81 COL 68
     t-gtot AT ROW 10.76 COL 68
     F-2 AT ROW 3.86 COL 107 NO-LABEL
     F1 AT ROW 4.1 COL 56 NO-LABEL
     RECT-3 AT ROW 2.67 COL 1
     "Print Sub Totals ?" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 9.81 COL 49
     "Print Grand Totals ?" VIEW-AS TEXT
          SIZE 20 BY .62 AT ROW 10.76 COL 46
     "Include Balance?" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 8.86 COL 49
...
ASSIGN 
       Begin_mtype:PRIVATE-DATA IN FRAME F-Main     = 
                "save".
...
ASSIGN 
       End_mtype:PRIVATE-DATA IN FRAME F-Main     = 
                "save".
...
ASSIGN 
       t-gtot:PRIVATE-DATA IN FRAME F-Main     = 
                "save".

ASSIGN 
       t-inc-bal:PRIVATE-DATA IN FRAME F-Main     = 
                "save".

ASSIGN 
       t-subtot:PRIVATE-DATA IN FRAME F-Main     = 
                "save".
