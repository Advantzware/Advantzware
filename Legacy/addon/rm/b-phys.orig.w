...
rm-rctd.rct-date rm-rctd.i-no rm-rctd.loc rm-rctd.loc-bin rm-rctd.qty 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 138 BY 9.05
         FONT 2.
...
DEFINE FRAME F-Main
     ...
     auto_find AT ROW 10.76 COL 72 COLON-ALIGNED HELP
          "Enter Auto Find Value"
     Btn_Clear_Find AT ROW 10.76 COL 116 HELP
...
"rm-rctd.tag" "Tag#" "x(20)" "character" ? ? ? ? ? ? yes ? no no "25" yes no no "U" "" ""
     _FldNameList[2]   > asi.rm-rctd.rct-date
"rm-rctd.rct-date" "Count Date" ? "date" ? ? ? ? ? ? yes ? no no "14" yes no no "U" "" ""
     _FldNameList[3]   > asi.rm-rctd.i-no
"rm-rctd.i-no" "RM Item#" ? "character" ? ? ? ? ? ? yes ? no no "13" yes no no "U" "" ""
     _FldNameList[4]   > asi.rm-rctd.i-name
"rm-rctd.i-name" "RM Item Name" ? "character" ? ? ? ? ? ? no ? no no "35" yes no no "U" "" ""
     _FldNameList[5]   > asi.rm-rctd.loc
"rm-rctd.loc" "Whse" ? "character" ? ? ? ? ? ? yes ? no no "8" yes no no "U" "" ""
     _FldNameList[6]   > asi.rm-rctd.loc-bin
"rm-rctd.loc-bin" "Bin" ? "character" ? ? ? ? ? ? yes ? no no "12" yes no no "U" "" ""
     _FldNameList[7]   > asi.rm-rctd.qty
"rm-rctd.qty" "Qty Counted" ? "decimal" ? ? ? ? ? ? yes ? no no "17" yes no no "U" "" ""
