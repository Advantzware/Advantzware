...
Begin_ven End_ven Begin_mtype End_mtype pbven 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_i-no end_i-no Begin_ven ~
End_ven Begin_mtype End_mtype pbven F1 F-2 
...
DEFINE VARIABLE pbven AS LOGICAL INITIAL yes 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME F-Main
     ...
     begin_i-no AT ROW 4.1 COL 31 COLON-ALIGNED HELP
          "Enter Beginning <Name>"
     end_i-no AT ROW 4.1 COL 78 COLON-ALIGNED HELP
          "Enter Ending <Name>"
     Begin_ven AT ROW 5.29 COL 31 COLON-ALIGNED
     End_ven AT ROW 5.29 COL 78 COLON-ALIGNED
     Begin_mtype AT ROW 6.48 COL 31 COLON-ALIGNED
     End_mtype AT ROW 6.48 COL 78 COLON-ALIGNED
     pbven AT ROW 8.86 COL 68
     F1 AT ROW 4.1 COL 49 NO-LABEL
     F-2 AT ROW 4.1 COL 96 NO-LABEL
     RECT-1 AT ROW 1 COL 1
     RECT-3 AT ROW 3.14 COL 1
     "Print Blank Vendor?" VIEW-AS TEXT
          SIZE 26 BY .48 AT ROW 9.1 COL 40
          FONT 6
...
ASSIGN 
       pbven:PRIVATE-DATA IN FRAME F-Main     = 
                "save".
