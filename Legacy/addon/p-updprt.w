...
&Scoped-Define ENABLED-OBJECTS Btn-Save Btn-Cancel btn-ink-detail 
...
DEFINE FRAME Panel-Frame
     Btn-Save AT ROW 1 COL 2
     Btn-Cancel AT ROW 1.24 COL 11
     btn-ink-detail AT ROW 1.48 COL 21
...
&Scoped-define SELF-NAME btn-ink-detail
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn-ink-detail C-WIn
ON CHOOSE OF btn-ink-detail IN FRAME Panel-Frame /* Ink Reset */
DO:
    def var out-list as cha no-undo.

    run get-link-handle in adm-broker-hdl
           (this-procedure,"Tableio-target",output out-list).

    run calc-pass in widget-handle(out-list).
