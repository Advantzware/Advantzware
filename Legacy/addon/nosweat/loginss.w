...
&Scoped-Define ENABLED-OBJECTS m_id m_password Btn_Cancel Btn_OK RECT-9 
...
DEFINE FRAME DIALOG-1
     ...
     Btn_Cancel AT ROW 5.05 COL 7
     Btn_OK AT ROW 5.05 COL 23
     RECT-9 AT ROW 4.81 COL 2
     "Enter User Login ID and Password" VIEW-AS TEXT
          SIZE 35 BY 1.24 AT ROW 1 COL 3
     SPACE(2.19) SKIP(4.00)
...
------------------------------------------------------------------------------*/
  DISPLAY m_id m_password 
      WITH FRAME DIALOG-1.
  ENABLE m_id m_password Btn_Cancel Btn_OK RECT-9 
      WITH FRAME DIALOG-1.
