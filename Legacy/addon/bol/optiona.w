...
&Scoped-define SELF-NAME btn_update_rel
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn_update_rel s-object
ON CHOOSE OF btn_update_rel IN FRAME F-Main /* Update Release */
DO:
   IF CAN-FIND(FIRST asi._file WHERE
      asi._file._File-Name = "ssrelbol") THEN
   DO:      
