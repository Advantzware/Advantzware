...
&{&DEFINETYPE}-define TABLENAME zipcode
&{&DEFINETYPE}-define DBFIELD1 zipcode.zipcode
&{&DEFINETYPE}-define BEGINFLD1 begin_zipcode
&{&DEFINETYPE}-define BEGIN-DEFAULT-1 yes
&{&DEFINETYPE}-define ENDFLD1 end_zipcode
&{&DEFINETYPE}-define END-DEFAULT-1 yes
&{&DEFINETYPE}-define DBFIELD2 zipcode.city
&{&DEFINETYPE}-define BEGINFLD2 begin_zipcode_city
&{&DEFINETYPE}-define BEGIN-DEFAULT-2 yes
&{&DEFINETYPE}-define ENDFLD2 end_zipcode_city
...
&{&DEFINETYPE}-define LISTORDER Zip/Postal Code,City
...
&{&DEFINETYPE}-define SAVENAME zipcode
