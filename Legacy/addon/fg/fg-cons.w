...
DEFINE VARIABLE h_b-cons AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* FINISHED GOODS WAREHOUSE TRANSACTION TRANSFER */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* FINISHED GOODS WAREHOUSE TRANSACTION TRANSFER */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_loadtag ).
       RUN set-position IN h_loadtag ( 1.00 , 77.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.81 , 7.80 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-cons ).
       RUN set-position IN h_b-cons ( 4.81 , 1.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updbar ).
       RUN set-position IN h_p-updbar ( 22.43 , 21.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-post ).
       RUN set-position IN h_v-post ( 22.43 , 126.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.91 , 17.00 ) */

       /* Links to SmartObject h_loadtag. */
       RUN add-link IN adm-broker-hdl ( h_b-cons , 'loadtag':U , h_loadtag ).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE auto-add W-Win 
PROCEDURE auto-add :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
