...
DEFINE VARIABLE h_v-phpost AS HANDLE NO-UNDO.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = Yes':U ,
             OUTPUT h_b-phys ).
       RUN set-position IN h_b-phys ( 4.81 , 6.00 ) NO-ERROR.
       /* Size in UIB:  ( 17.38 , 143.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'fg/v-phpost.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-phpost ).
       RUN set-position IN h_v-phpost ( 22.67 , 96.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.91 , 33.00 ) */

       /* Links to SmartNavBrowser h_b-phys. */
       RUN add-link IN adm-broker-hdl ( h_p-updsav-2 , 'TableIO':U , h_b-phys ).

       /* Links to SmartViewer h_v-phpost. */
       RUN add-link IN adm-broker-hdl ( h_b-phys , 'Record':U , h_v-phpost ).
