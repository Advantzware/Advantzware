...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "FG WarehouseTransfer Transaction"
         HEIGHT             = 17.52
         WIDTH              = 151.6
         MAX-HEIGHT         = 17.52
         MAX-WIDTH          = 151.6
...
ON END-ERROR OF W-Win /* FG WarehouseTransfer Transaction */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* FG WarehouseTransfer Transaction */
DO:
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = Yes':U ,
             OUTPUT h_b-trans ).
       RUN set-position IN h_b-trans ( 1.00 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-trans ( 6.19 , 144.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_p-updba2 , 'TableIO':U , h_b-trans ).
