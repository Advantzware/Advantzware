...
&SCOPED-DEFINE winViewPrgmName fg-physi
...
DEFINE VARIABLE h_b-physi AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "INITIAL FG  PHYSICAL COUNT PROCESSING"
         HEIGHT             = 24
         WIDTH              = 150
         MAX-HEIGHT         = 33.29
         MAX-WIDTH          = 204.8
...
ON END-ERROR OF W-Win /* INITIAL FG  PHYSICAL COUNT PROCESSING */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* INITIAL FG  PHYSICAL COUNT PROCESSING */
DO:
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = Yes':U ,
             OUTPUT h_b-physi ).
       RUN set-position IN h_b-physi ( 4.81 , 4.00 ) NO-ERROR.
       RUN set-size IN h_b-physi ( 17.86 , 145.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updbar ).
       RUN set-position IN h_p-updbar ( 21.71 , 36.00 ) NO-ERROR.
       RUN set-size IN h_p-updbar ( 2.00 , 82.00 ) NO-ERROR.

       /* Links to SmartNavBrowser h_b-physi. */
       RUN add-link IN adm-broker-hdl ( h_p-updbar , 'TableIO':U , h_b-physi ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-physi ,
             h_folder , 'AFTER':U ).
