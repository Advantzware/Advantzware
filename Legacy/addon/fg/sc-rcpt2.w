...
&Scoped-Define ENABLED-OBJECTS rd-scan-via Scan_label BUTTON-1 Scan_Job ~
BUTTON-2 Btn_Close RECT-8 
&Scoped-Define DISPLAYED-OBJECTS rd-scan-via Scan_label v-po-no Scan_Job 
...
DEFINE VARIABLE rd-scan-via AS CHARACTER 
...
DEFINE FRAME DEFAULT-FRAME
     rd-scan-via AT ROW 1.71 COL 23 NO-LABEL
     Scan_label AT ROW 4.33 COL 16 COLON-ALIGNED
     BUTTON-1 AT ROW 5.05 COL 86.6
     v-po-no AT ROW 5.76 COL 17 COLON-ALIGNED
     Scan_Job AT ROW 7.19 COL 17 COLON-ALIGNED
     BUTTON-2 AT ROW 7.19 COL 86.6
     Scan_Form AT ROW 8.62 COL 17 COLON-ALIGNED
     Scan_Pass AT ROW 8.62 COL 48.6 COLON-ALIGNED
     Scan_Blank AT ROW 8.62 COL 79.6 COLON-ALIGNED
     Btn_Close AT ROW 10.76 COL 60
     RECT-8 AT ROW 1.24 COL 9
     "Via:" VIEW-AS TEXT
          SIZE 6 BY .95 AT ROW 1.95 COL 14
...
ON END-ERROR OF C-Win /* Scan FG Receipts */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Scan FG Receipts */
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY rd-scan-via Scan_label v-po-no Scan_Job 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE rd-scan-via Scan_label BUTTON-1 Scan_Job BUTTON-2 Btn_Close RECT-8 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
