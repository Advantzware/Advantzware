...
DEFINE VARIABLE h_v-ajpost AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'fg/v-ajpost.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-ajpost ).
       RUN set-position IN h_v-ajpost ( 22.43 , 102.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_v-ajpost. */
       RUN add-link IN adm-broker-hdl ( h_b-fgadj , 'Record':U , h_v-ajpost ).
