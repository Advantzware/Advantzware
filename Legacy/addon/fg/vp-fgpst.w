...
&Scoped-Define ENABLED-OBJECTS bt-post RECT-7 
      ...
      if not avail fg-bin then do:
        ...
        if fg-rctd.rita-code eq "C" then do:        /** Physical Count **/
          ...
          FIND FIRST bf-itemfg-loc 
              WHERE bf-itemfg-loc.company EQ itemfg.company
                AND bf-itemfg-loc.i-no    EQ itemfg.i-no
                AND bf-itemfg-loc.loc     EQ fg-rctd.loc
              EXCLUSIVE-LOCK NO-ERROR.
          bf-itemfg-loc.q-onh = fg-rctd.qty.

        end. /* C */

        FIND CURRENT itemfg NO-LOCK NO-ERROR.
        FIND CURRENT bf-itemfg-loc NO-LOCK NO-ERROR.
