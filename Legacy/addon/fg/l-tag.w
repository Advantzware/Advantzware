...
&Scoped-define FIELDS-IN-QUERY-BROWSE-1 loadtag.i-no loadtag.i-name ~
loadtag.po-no loadtag.ord-no loadtag.job-no loadtag.job-no2 loadtag.loc ~
loadtag.loc-bin loadtag.tag-no 
...
loadtag.item-type = ip-item-type ~
 NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
loadtag.item-type = ip-item-type
"
     _FldNameList[1]   = ASI.loadtag.i-no
     _FldNameList[2]   = ASI.loadtag.i-name
     _FldNameList[3]   = ASI.loadtag.po-no
     _FldNameList[4]   = ASI.loadtag.ord-no
     ...
     _FldNameList[9]   = ASI.loadtag.tag-no
     _Query            is OPENED
*/  /* BROWSE BROWSE-1 */
&ANALYZE-RESUME
