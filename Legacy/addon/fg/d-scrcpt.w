...
DEFINE FRAME D-Dialog
     Btn_exit AT ROW 1 COL 135
     SPACE(0.19) SKIP(19.71)
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* FG Receipts */
DO:  
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-size IN h_folder ( 20.71 , 149.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-rcptd ).
       RUN set-position IN h_b-rcptd ( 2.91 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-rcptd ( 15.71 , 145.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updsav ).
       RUN set-position IN h_p-updsav ( 19.33 , 37.00 ) NO-ERROR.
