...
&Scoped-Define DISPLAYED-FIELDS vend.vend-no vend.name 
...
DEFINE FRAME F-Main
     vend.vend-no AT ROW 1.71 COL 10 COLON-ALIGNED
          LABEL "Vendor"
          VIEW-AS FILL-IN 
          SIZE 11.6 BY 1
          BGCOLOR 15 FONT 4
     vend.name AT ROW 1.71 COL 31 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 38 BY 1
          BGCOLOR 15 FONT 4
