...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
   ...
   FOR EACH scoreType NO-LOCK 
       ...
       :
       cScoreTypes = cScoreTypes + "," + scoreType.scoreType.
   END. /* for scoretype */
