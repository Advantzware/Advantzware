...
PROCEDURE create-item :
    ...
    DO WITH FRAME {&FRAME-NAME}:
        lv-rno = 0.
        FIND LAST b-estRelease USE-INDEX iEstRelID NO-LOCK NO-ERROR.
        IF AVAILABLE b-estRelease AND b-estRelease.estReleaseID GT lv-rno THEN lv-rno = b-estRelease.estReleaseID.
        ...
        DO WHILE TRUE:
            lv-rno = lv-rno + 1.
            FIND FIRST b-estRelease WHERE b-estRelease.estReleaseID EQ lv-rno USE-INDEX iEstRelID NO-LOCK NO-ERROR.
