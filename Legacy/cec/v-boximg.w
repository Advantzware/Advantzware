...
&Scoped-Define ENABLED-OBJECTS box-image RECT-2 
...
DEFINE FRAME F-Main
     box-design-hdr.design-no AT ROW 12.43 COL 107 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 6.2 BY 1
     box-image AT ROW 1.48 COL 2
...
ASSIGN 
       ...
       FRAME F-Main:HEIGHT           = 12.52
       FRAME F-Main:WIDTH            = 115.4.

ASSIGN 
       RECT-2:RESIZABLE IN FRAME F-Main        = TRUE.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE display-image V-table-Win 
PROCEDURE display-image :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
