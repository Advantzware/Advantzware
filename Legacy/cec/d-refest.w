...
def input param ip-reftable-qty as recid no-undo.
def input param ip-reftable-cst as recid no-undo.
...
DO:
  ...
  find reftable where recid(reftable) = ip-reftable-cst .
  assign reftable.val[1] = lv-cost-1
         reftable.val[2] = lv-cost-2
         reftable.val[3] = lv-cost-3
         reftable.val[4] = lv-cost-4
         reftable.val[5] = lv-cost-5
         reftable.val[6] = lv-cost-6
         reftable.val[7] = lv-cost-7
         reftable.val[8] = lv-cost-8
         reftable.val[9] = lv-cost-9
         reftable.val[10] = lv-cost-10
         reftable.val[11] = lv-cost-11
         reftable.val[12] = lv-cost-12
         reftable.val[13] = lv-cost-13.

  find reftable where recid(reftable) = ip-reftable-qty .
  assign reftable.val[1] = lv-qty-1
         reftable.val[2] = lv-qty-2
         reftable.val[3] = lv-qty-3
         reftable.val[4] = lv-qty-4
         reftable.val[5] = lv-qty-5
         reftable.val[6] = lv-qty-6
         reftable.val[7] = lv-qty-7
         reftable.val[8] = lv-qty-8
         reftable.val[9] = lv-qty-9
         reftable.val[10] = lv-qty-10
         reftable.val[11] = lv-qty-11
         reftable.val[12] = lv-qty-12
         reftable.val[13] = lv-qty-13.
...
IF CAN-FIND(reftable WHERE RECID(reftable) EQ ip-reftable-qty) AND
   CAN-FIND(reftable WHERE RECID(reftable) EQ ip-reftable-cst) THEN DO:
...
------------------------------------------------------------------------------*/
  ...
  FIND reftable WHERE RECID(reftable) EQ ip-reftable-qty NO-LOCK.
  ASSIGN lv-qty-1 = reftable.val[1]
         lv-qty-2 = reftable.val[2]
         lv-qty-3 = reftable.val[3]
         lv-qty-4 = reftable.val[4]
         lv-qty-5 = reftable.val[5]
         lv-qty-6 = reftable.val[6]
         lv-qty-7 = reftable.val[7]
         lv-qty-8 = reftable.val[8]
         lv-qty-9 = reftable.val[9]
         lv-qty-10 = reftable.val[10]
         lv-qty-11 = reftable.val[11]
         lv-qty-12 = reftable.val[12]
         lv-qty-13 = reftable.val[13].

  FIND reftable WHERE RECID(reftable) EQ ip-reftable-cst NO-LOCK.
  ASSIGN lv-cost-1 = reftable.val[1]
         lv-cost-2 = reftable.val[2]
         lv-cost-3 = reftable.val[3]
         lv-cost-4 = reftable.val[4]
         lv-cost-5 = reftable.val[5]
         lv-cost-6 = reftable.val[6]
         lv-cost-7 = reftable.val[7]
         lv-cost-8 = reftable.val[8]
         lv-cost-9 = reftable.val[9]
         lv-cost-10 = reftable.val[10]
         lv-cost-11 = reftable.val[11]
         lv-cost-12 = reftable.val[12]
         lv-cost-13 = reftable.val[13].

  DO WITH FRAME {&FRAME-NAME}:
    lv-title = FRAME {&FRAME-NAME}:TITLE.

    IF reftable.reftable EQ "MACH-CREW" THEN
      ASSIGN
