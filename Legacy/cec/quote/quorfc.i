            ...
            ELSE
                ...
                ELSE
                    ...
                    ELSE
                        ...
                        DO:
                            ...
                            IF (NOT logSetPrinting OR NOT s-print-comp) AND s-print-2nd-dscr THEN
                                IF v-boardDescription EQ 'Est' THEN
                                    v-board = IF AVAILABLE ef THEN ef.brd-dscr ELSE "".
                                ELSE
                                    v-board = xqitm.i-dscr.

                            ELSE
                                IF NOT logSetPrinting AND AVAILABLE ef THEN 
                                DO:
                                    DO j = 1 TO 6:
                        ...
                        ELSE
                            IF i EQ 6 AND numfit GE 6 THEN 
                            DO:
...
do:
    ...
    do:
        ...
        DO:
            ...
            PUT "<C3>Department Notes: " SKIP.
            DO idx = 1 TO EXTENT(v-dept-inst):
                IF v-dept-inst[idx] NE "" THEN PUT "<C3>" v-dept-inst[idx] .
