...
if (not ch-multi) then do:
    ...
    PUT
     ...
     "<R55><C1>  please do not hesitate to call Packrite at 336-884-0793 or email to Lynn@PackRite.Net."
     "<R56><C1>  This quote subject to change if the cost of any material increases or any"
     "<R57><C1>  specifications change including art, size, quantity or materials." SKIP
     /*AT 210*/ .          
