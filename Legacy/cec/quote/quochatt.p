/* ------------------------------------------- cec/quote/quochatt.p 08/08/2018 Sewa */
/* print quotes in Pacific - Chattanooga format                                               */
/* -------------------------------------------------------------------------- */
...
define new shared variable v-out1-id        as recid     no-undo.  
define new shared variable v-out2-id        as recid     no-undo.  
