/* cec/quote/prcsheet.i  Price Sheet form */  
...
PUT /*"<C3><R4.5><#1><R+6><C+45><IMAGE#1=" ls-full-img1 SKIP */
    ...
    "<=2><R+54><C2><From><C80><LINE>" skip
    "<=2><R+55><C2><From><C80><LINE>" skip
    ...
    "<=2><R+2.5><C56>"  lv-cust-id  lv-contact   lv-pg-num " of " lv-tot-pg
    "<=2><R+4><C57.5><B>TELEPHONE                        FAX</B>"
    "<=2><R+5><C57>" lv-tel      "<C70>"  lv-fax
    "<=2><R+7><C56><B><P10>E-Mail:</B>" lv-email "</B>" 
    
    "<=2><R+8><C20><P12><B>INVOICE TO:  <C65>SHIP TO:"
    
    "<=2><R+13><C3><B><P10>DATE          FILE NO.            SALESPERSON & E-MAIL                          VIA                FOB                CUSTOMER PO#</B>"
