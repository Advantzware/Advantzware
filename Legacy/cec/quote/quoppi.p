/* ------------------------------------------- cec/quote/quoppi.p*/
/* print quotes - Xprint format for PPI                                       */
/* -------------------------------------------------------------------------- */
...
ASSIGN ls-image1 = "images\ppitop.jpg"
       ls-image2 = "images\ppibottom.jpg"
...
if (not ch-multi) then do:
    ...
    {cec/quote/quoppi1.i}    
    {cec/quote/quoppi.i 1}

    v-quo-total = v-line-total + v-t-tax[1] + v-t-tax[2] + v-t-tax[3].

    PUT
     "<FBook Antiqua><R58><C1><P8>" 
     "<R54><C1>  All item quantities are subject to an over / under of 10%.  If you have any further questions or concerns" 
     "<R55><C1>  please do not hesitate to call 336-884-0792 or e-mail us at preferredpkg@northstate.net." 
     "<R56><C1>  This quote subject to change if the cost of any material increases or any" 
     "<R57><C1>  specifications change including art, size, quantity or materials."
     "<C7><R59><#11><C+70><R+5><IMAGE#11=" ls-full-img2 SKIP
     /*AT 210*/ .       
