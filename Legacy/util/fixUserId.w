...
DEFINE FRAME FRAME-B
     "This utility will update all FG History User Id with ~"?~" to ~"ASI~"" VIEW-AS TEXT
          SIZE 71 BY .95 AT ROW 2.38 COL 10
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Change FG History UserID"
         HEIGHT             = 7.19
         WIDTH              = 90.2
         MAX-HEIGHT         = 45.05
         MAX-WIDTH          = 256
...
ON END-ERROR OF C-Win /* Change FG History UserID */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Change FG History UserID */
DO:
