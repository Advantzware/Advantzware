...
DEFINE FRAME FRAME-A
     ...
     btn-process AT ROW 10.76 COL 21
     btn-cancel AT ROW 10.76 COL 53
...
ON END-ERROR OF C-Win /* Set FG Price to Zero */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Set FG Price to Zero */
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY begin_i-no end_i-no begin_cust end_cust 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE RECT-17 begin_i-no end_i-no begin_cust end_cust btn-process btn-cancel 
      WITH FRAME FRAME-A IN WINDOW C-Win.
