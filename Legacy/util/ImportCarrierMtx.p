...
DEFINE TEMP-TABLE ttImportCarrierMtx
    ...
    FIELD weight1      AS INTEGER FORMAT ">>>>>>>" COLUMN-LABEL "Num Pallets-UpTo 1" HELP "Optional - Integer"
    FIELD weight2      AS INTEGER FORMAT ">>>>>>>" COLUMN-LABEL "Num Pallets-UpTo 2" HELP "Optional - Integer"
    FIELD weight3      AS INTEGER FORMAT ">>>>>>>" COLUMN-LABEL "Num Pallets-UpTo 3" HELP "Optional - Integer"
    FIELD weight4      AS INTEGER FORMAT ">>>>>>>" COLUMN-LABEL "Num Pallets-UpTo 4" HELP "Optional - Integer"
    FIELD weight5      AS INTEGER FORMAT ">>>>>>>" COLUMN-LABEL "Num Pallets-UpTo 5" HELP "Optional - Integer"
    FIELD weight6      AS INTEGER FORMAT ">>>>>>>" COLUMN-LABEL "Num Pallets-UpTo 6" HELP "Optional - Integer"
    FIELD weight7      AS INTEGER FORMAT ">>>>>>>" COLUMN-LABEL "Num Pallets-UpTo 7" HELP "Optional - Integer"
    FIELD weight8      AS INTEGER FORMAT ">>>>>>>" COLUMN-LABEL "Num Pallets-UpTo 8" HELP "Optional - Integer"
    FIELD weight9      AS INTEGER FORMAT ">>>>>>>" COLUMN-LABEL "Num Pallets-UpTo 9" HELP "Optional - Integer"
    FIELD weight10      AS INTEGER FORMAT ">>>>>>>" COLUMN-LABEL "Num Pallets-UpTo 10" HELP "Optional - Integer"
    FIELD rate1         AS DECIMAL FORMAT ">>>9.999" COLUMN-LABEL "Rate / Pallet 1" HELP "Optional - Decimal"
    FIELD rate2         AS DECIMAL FORMAT ">>>9.999" COLUMN-LABEL "Rate / Pallet 2" HELP "Optional - Decimal"
    FIELD rate3         AS DECIMAL FORMAT ">>>9.999" COLUMN-LABEL "Rate / Pallet 3" HELP "Optional - Decimal"
    FIELD rate4         AS DECIMAL FORMAT ">>>9.999" COLUMN-LABEL "Rate / Pallet 4" HELP "Optional - Decimal"
    FIELD rate5         AS DECIMAL FORMAT ">>>9.999" COLUMN-LABEL "Rate / Pallet 5" HELP "Optional - Decimal"
    FIELD rate6         AS DECIMAL FORMAT ">>>9.999" COLUMN-LABEL "Rate / Pallet 6" HELP "Optional - Decimal"
    FIELD rate7         AS DECIMAL FORMAT ">>>9.999" COLUMN-LABEL "Rate / Pallet 7" HELP "Optional - Decimal"
    FIELD rate8         AS DECIMAL FORMAT ">>>9.999" COLUMN-LABEL "Rate / Pallet 8" HELP "Optional - Decimal"
    FIELD rate9         AS DECIMAL FORMAT ">>>9.999" COLUMN-LABEL "Rate / Pallet 9" HELP "Optional - Decimal"
    FIELD rate10         AS DECIMAL FORMAT ">>>9.999" COLUMN-LABEL "Rate / Pallet 10" HELP "Optional - Decimal"
    .
