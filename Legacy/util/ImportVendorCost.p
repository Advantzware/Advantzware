    ...
    DO:
        ...
        DO:
            ...
            DO:
                ...
                FIND FIRST reftable 
                    WHERE reftable.reftable EQ "bf-e-itemfg-vend.std-uom" 
                ...
                DO:
                    CREATE reftable.
                    ASSIGN
                        reftable.reftable = "bf-e-itemfg-vend.std-uom"
            ...
            END.
            ASSIGN
                bf-e-itemfg-vend.vend-no      = ipbf-ttImportVendCost.cVendorID                                                                                                                       
                bf-e-itemfg-vend.std-uom      = IF ipbf-ttImportVendCost.cPurchaseUOM EQ "" THEN itemfg.pur-uom ELSE ipbf-ttImportVendCost.cPurchaseUOM                                          
                bf-e-itemfg-vend.vend-item    = ipbf-ttImportVendCost.cVendorItemID                                                                                                                  
                bf-e-itemfg-vend.roll-w[27]   = IF ipbf-ttImportVendCost.dSheetWidthMin NE 0 THEN ipbf-ttImportVendCost.dSheetWidthMin ELSE 0.0000                                                         
                bf-e-itemfg-vend.roll-w[28]   = IF ipbf-ttImportVendCost.dSheetWidthMax NE 0 THEN ipbf-ttImportVendCost.dSheetWidthMax ELSE  999.9999                                                 
                bf-e-itemfg-vend.roll-w[29]   = IF ipbf-ttImportVendCost.dSheetLengthMin NE 0 THEN ipbf-ttImportVendCost.dSheetLengthMin ELSE 0.0000                                                       
                bf-e-itemfg-vend.roll-w[30]   = IF ipbf-ttImportVendCost.dSheetLengthMax NE 0 THEN  ipbf-ttImportVendCost.dSheetLengthMax ELSE  999.9999                                              
                bf-e-itemfg-vend.spare-dec-1  = ipbf-ttImportVendCost.dMinimumCharge                                                                                                                  
                bf-e-itemfg-vend.markup       = ipbf-ttImportVendCost.iGSAMarkupPercent                                                                                                               
                bf-e-itemfg-vend.run-qty[1]   = ipbf-ttImportVendCost.dLevelQuantity01                                                                                                                
                bf-e-itemfg-vend.run-cost[1]  = ipbf-ttImportVendCost.dLevelCostPerUOM01                                                                                                              
                bf-e-itemfg-vend.setups[1]    = ipbf-ttImportVendCost.dLevelSetup01                                                                                                                   
                bf-e-itemfg-vend.run-qty[2]   = ipbf-ttImportVendCost.dLevelQuantity02                                                                                                                
                bf-e-itemfg-vend.run-cost[2]  = ipbf-ttImportVendCost.dLevelCostPerUOM02                                                                                                              
                bf-e-itemfg-vend.setups[2]    = ipbf-ttImportVendCost.dLevelSetup02                                                                                                                   
                bf-e-itemfg-vend.run-qty[3]   = ipbf-ttImportVendCost.dLevelQuantity03                                                                                                                
                bf-e-itemfg-vend.run-cost[3]  = ipbf-ttImportVendCost.dLevelCostPerUOM03                                                                                                              
                bf-e-itemfg-vend.setups[3]    = ipbf-ttImportVendCost.dLevelSetup03                                                                                                                   
                bf-e-itemfg-vend.run-qty[4]   = ipbf-ttImportVendCost.dLevelQuantity04                                                                                                                
                bf-e-itemfg-vend.run-cost[4]  = ipbf-ttImportVendCost.dLevelCostPerUOM04                                                                                                              
                bf-e-itemfg-vend.setups[4]    = ipbf-ttImportVendCost.dLevelSetup04                                                                                                                   
                bf-e-itemfg-vend.run-qty[5]   = ipbf-ttImportVendCost.dLevelQuantity05                                                                                                                
                bf-e-itemfg-vend.run-cost[5]  = ipbf-ttImportVendCost.dLevelCostPerUOM05                                                                                                              
                bf-e-itemfg-vend.setups[5]    = ipbf-ttImportVendCost.dLevelSetup05                                                                                                                   
                bf-e-itemfg-vend.run-qty[6]   = ipbf-ttImportVendCost.dLevelQuantity06                                                                                                                
                bf-e-itemfg-vend.run-cost[6]  = ipbf-ttImportVendCost.dLevelCostPerUOM06                                                                                                              
                bf-e-itemfg-vend.setups[6]    = ipbf-ttImportVendCost.dLevelSetup06                                                                                                                   
                bf-e-itemfg-vend.run-qty[7]   = ipbf-ttImportVendCost.dLevelQuantity07                                                                                                                
                bf-e-itemfg-vend.run-cost[7]  = ipbf-ttImportVendCost.dLevelCostPerUOM07                                                                                                              
                bf-e-itemfg-vend.setups[7]    = ipbf-ttImportVendCost.dLevelSetup07                                                                                                                   
                bf-e-itemfg-vend.run-qty[8]   = ipbf-ttImportVendCost.dLevelQuantity08                                                                                                                
                bf-e-itemfg-vend.run-cost[8]  = ipbf-ttImportVendCost.dLevelCostPerUOM08                                                                                                              
                bf-e-itemfg-vend.setups[8]    = ipbf-ttImportVendCost.dLevelSetup08                                                                                                                   
                bf-e-itemfg-vend.run-qty[9]   = ipbf-ttImportVendCost.dLevelQuantity09                                                                                                                
                bf-e-itemfg-vend.run-cost[9]  = ipbf-ttImportVendCost.dLevelCostPerUOM09                                                                                                              
                bf-e-itemfg-vend.setups[9]    = ipbf-ttImportVendCost.dLevelSetup09                                                                                                                   
                bf-e-itemfg-vend.run-qty[10]  = ipbf-ttImportVendCost.dLevelQuantity10                                                                                                               
                bf-e-itemfg-vend.run-cost[10] = ipbf-ttImportVendCost.dLevelCostPerUOM10                                                                                                             
                bf-e-itemfg-vend.setups[10]   = ipbf-ttImportVendCost.dLevelSetup10.                                                                                                                 
        END.
    END.
