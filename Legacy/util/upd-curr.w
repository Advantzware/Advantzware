...
&Scoped-Define ENABLED-OBJECTS begin_curr end_curr btn-process btn-cancel ~
RECT-17 
&Scoped-Define DISPLAYED-OBJECTS begin_curr end_curr 
...
DEFINE VARIABLE begin_curr AS CHARACTER FORMAT "X(3)":U 
     LABEL "Old Currency Code" 
     VIEW-AS FILL-IN 
     SIZE 14 BY 1 NO-UNDO.

DEFINE VARIABLE end_curr AS CHARACTER FORMAT "x(3)":U 
...
DEFINE FRAME FRAME-A
     begin_curr AT ROW 7.67 COL 37 COLON-ALIGNED
     end_curr AT ROW 10.52 COL 37 COLON-ALIGNED
     btn-process AT ROW 15.76 COL 21
     btn-cancel AT ROW 15.76 COL 53
     RECT-17 AT ROW 4.81 COL 1
     "Selection Parameters" VIEW-AS TEXT
          SIZE 31 BY .62 AT ROW 5.29 COL 5
     "(Enter '*' for all)" VIEW-AS TEXT
          SIZE 20 BY 1 AT ROW 7.67 COL 55
     "" VIEW-AS TEXT
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Update Customer Currency Code"
         HEIGHT             = 17.57
         WIDTH              = 90.2
         MAX-HEIGHT         = 26.62
         MAX-WIDTH          = 160
...
ON END-ERROR OF C-Win /* Update Customer Currency Code */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Update Customer Currency Code */
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY begin_curr end_curr 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE begin_curr end_curr btn-process btn-cancel RECT-17 
      WITH FRAME FRAME-A IN WINDOW C-Win.
