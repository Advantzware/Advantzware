...
DEFINE VARIABLE fi_please-wait AS CHARACTER FORMAT "X(256)":U 
     VIEW-AS FILL-IN 
     SIZE 94 BY 1 NO-UNDO.

DEFINE VARIABLE ls-proc AS CHARACTER FORMAT "X(256)":U INITIAL "Util/Utils.r" 
...
/* SETTINGS FOR FRAME F-Main
   FRAME-NAME                                                           */
/* SETTINGS FOR FILL-IN fi_please-wait IN FRAME F-Main
   NO-ENABLE ALIGN-L                                                    */
...
ON END-ERROR OF W-Win /* Run Custom Procedure */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Run Custom Procedure */
DO:
...
ON CHOOSE OF Btn_Cancel IN FRAME F-Main /* Close */
DO:
   APPLY "CLOSE":U TO THIS-PROCEDURE.
  RETURN NO-APPLY.
END.
...
DO:
   ...
   END.
    ...
    IF SEARCH(ls-proc) <> ? THEN DO WITH FRAME {&FRAME-NAME}:
        ...
        RUN VALUE(ls-proc).
        fi_please-wait:SCREEN-VALUE = "".
    END.
    ELSE DO:
        MESSAGE "Procedure " ls-proc " does not exist. Please verify the procedure name."
              VIEW-AS ALERT-BOX ERROR.
        RETURN.
    END.
...
ON HELP OF ls-proc IN FRAME F-Main /* Procedure Name */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL ls-proc W-Win
ON LEAVE OF ls-proc IN FRAME F-Main /* Procedure Name */
DO:
    ASSIGN {&self-name}.
END.
