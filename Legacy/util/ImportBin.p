...
DEFINE TEMP-TABLE ttImportBin
    ...
    FIELD Location  AS CHARACTER FORMAT "x(5)" COLUMN-LABEL "Location"
    FIELD cType     AS CHARACTER FORMAT "X(3)" COLUMN-LABEL "Type"
    FIELD cBinLoc     AS CHARACTER FORMAT "X(8)" COLUMN-LABEL "Primary Bin Loc"
    .
...
PROCEDURE pProcessRecord PRIVATE:
    ...
    FOR EACH ipbf-ttImportBin NO-LOCK
        : 
        IF ipbf-ttImportBin.cType = "FG" THEN DO:
