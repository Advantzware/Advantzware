...
DEFINE VARIABLE h_b-hrms-x AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Vendor to  RM Cross Reference"
         HEIGHT             = 24
         WIDTH              = 149.8
         MAX-HEIGHT         = 33.29
         MAX-WIDTH          = 204.8
...
ON END-ERROR OF W-Win /* Vendor to  RM Cross Reference */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Vendor to  RM Cross Reference */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'RM Item# XRef' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = Yes':U ,
             OUTPUT h_b-hrms-x ).
       RUN set-position IN h_b-hrms-x ( 4.57 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-hrms-x ( 17.38 , 95.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updsav ).
       RUN set-position IN h_p-updsav ( 22.19 , 11.00 ) NO-ERROR.
       RUN set-size IN h_p-updsav ( 1.76 , 82.00 ) NO-ERROR.

       /* Links to SmartBrowser h_b-hrms-x. */
       RUN add-link IN adm-broker-hdl ( h_p-updsav , 'TableIO':U , h_b-hrms-x ).

       /* Links to SmartPanel h_p-updsav. */
       RUN add-link IN adm-broker-hdl ( h_b-hrms-x , 'buttons':U , h_p-updsav ).
