...
DEFINE FRAME DEFAULT-FRAME
     rsRecordExists AT ROW 2.19 COL 41 NO-LABEL WIDGET-ID 68
     rsMandatoryFieldMissing AT ROW 6.48 COL 41 NO-LABEL WIDGET-ID 76
     tbLoadReadyShowLog AT ROW 10.52 COL 5 WIDGET-ID 52
     tbLoadReadyClose AT ROW 11.48 COL 5 WIDGET-ID 36
     btnLoad AT ROW 12.91 COL 69 WIDGET-ID 56
     "If a record already exists:" VIEW-AS TEXT
          SIZE 25 BY .62 AT ROW 2.19 COL 5 WIDGET-ID 74
     "If a mandatory field is missing:" VIEW-AS TEXT
          SIZE 29 BY .62 AT ROW 6.48 COL 5 WIDGET-ID 80
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 135.2 BY 15.29 WIDGET-ID 100.
...
/* SETTINGS FOR FRAME DEFAULT-FRAME
                                                                        */
ASSIGN
       btnLoad:PRIVATE-DATA IN FRAME DEFAULT-FRAME     = 
                "ribbon-button".
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  RUN enable_UI.
    ...
    {methods/setButton.i btnLoad "Load"} /* added by script _nonAdm1Images.p on 03.28.2017 @ 10:44:01 am */
