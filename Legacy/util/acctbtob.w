...
&Scoped-Define ENABLED-OBJECTS begin_acct end_acct btn-process btn-cancel ~
RECT-17 
&Scoped-Define DISPLAYED-OBJECTS begin_acct end_acct 
...
DEFINE VARIABLE end_acct AS CHARACTER FORMAT "X(25)":U INITIAL "zzzzzzzzzzzzzzz" 
     LABEL "Ending Acct#" 
     VIEW-AS FILL-IN 
     SIZE 48 BY 1 NO-UNDO.
...
DEFINE FRAME FRAME-A
     begin_acct AT ROW 6.71 COL 28 COLON-ALIGNED HELP
          "Enter Beginning Item Number"
     end_acct AT ROW 8.38 COL 28 COLON-ALIGNED HELP
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Copy Current Year Balances to Budgets"
         HEIGHT             = 12.67
         WIDTH              = 90.2
         MAX-HEIGHT         = 19.76
         MAX-WIDTH          = 98.2
...
ON END-ERROR OF C-Win /* Copy Current Year Balances to Budgets */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Copy Current Year Balances to Budgets */
DO:
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  {methods/nowait.i}
    ...
    {methods/setButton.i btn-process "Start"} /* added by script _nonAdm1Images.p on 03.28.2017 @ 10:43:57 am */
...
------------------------------------------------------------------------------*/
  DISPLAY begin_acct end_acct 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE begin_acct end_acct btn-process btn-cancel RECT-17 
      WITH FRAME FRAME-A IN WINDOW C-Win.
...
DEF VAR ld-period$ LIKE account.cyr NO-UNDO.
...
FOR EACH account
    WHERE account.company EQ cocode
      AND account.actnum  GE begin_acct
  ...
  DO li = 1 TO MIN(EXTENT(ld-period$),EXTENT(account.cyr)):
