...
DEFINE VARIABLE h_b-prdnot AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Enter Label Colors for FGs"
         HEIGHT             = 24
         WIDTH              = 149.8
         MAX-HEIGHT         = 33.29
         MAX-WIDTH          = 204.8
...
ON END-ERROR OF W-Win /* Enter Label Colors for FGs */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Enter Label Colors for FGs */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'util/b-prdnot.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-prdnot ).
       RUN set-position IN h_b-prdnot ( 4.57 , 4.00 ) NO-ERROR.
       RUN set-size IN h_b-prdnot ( 19.29 , 31.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updsav ).
       RUN set-position IN h_p-updsav ( 4.57 , 36.00 ) NO-ERROR.
       RUN set-size IN h_p-updsav ( 19.52 , 23.00 ) NO-ERROR.

       /* Links to SmartBrowser h_b-prdnot. */
       RUN add-link IN adm-broker-hdl ( h_p-updsav , 'TableIO':U , h_b-prdnot ).
