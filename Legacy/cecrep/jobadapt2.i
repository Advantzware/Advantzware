/* ---------------------------------------------- cecrep/jobadapt2.i 03/13 BPV */
/* factory ticket   Adapt-a-pack                                           */
/* -------------------------------------------------------------------------- */
...
format header
   ...
   /*    "<=#1><R+19><C1><FROM><C80><LINE><|3>"
       ...
       "<=#1><R+5><C40><FROM><R+10><C40><LINE><|3>"
       "<=#1><R+9><C56><FROM><R+6><C56><LINE><|3>"
       "<=#1><R+9><C66><FROM><R+6><C66><LINE><|3>"
