...
FORM HEADER
    ...
    "<=1><C2><B>Customer Name:</B>" 
       ...
       "<C2>Tel:"  v-tel 
       "<C36>Boxed:" v-cas-no
       "<C70>Min Qty Assd Sets:  " v-qty-1 SKIP
       "<C2>Fax:" v-fax 
       "<C36>Reverse Corrugation:" v-reversed
       "<C70>Max Qty Assd Sets:  " v-qty-2 skip
       "<C2>E-mail:" v-email FORMAT "x(32)"
       "<C36># of Load Tags" v-num-tags 
       "<C70>Under/Overrun:"  lv-under-run format "x(7)" "," lv-over-run format "x(7)"  SKIP
       /*"<C2><B>D/C Machine Set-up:</B>"*/
       "<C2><B>Long Strip Dies:  Slot Height:</B>" v-slot-height1
       
       /*"<C36><B>D/C Set-up:</B>"*/ 
       "<C36><B>Short Strip Dies: Slot Height:</B>" v-slot-height2 
       /*"<C70><B>Type Dies:</B>"   SKIP*/
       /*"<C70><B>Case Label:</B>"*/
       "<C70>" v-dept-note2[1] SKIP
       /*"<C2>Form #1:"  v-dc-msetup[1] */
       "<C2>"  v-dc-msetup[1] 
       /*"<C36>Form #1A:" v-dc-setup[1] */
       "<C36>" v-dc-setup[1]
       /*"<C70>Form #1:"  v-dies[1]*/ 
       "<C70>" v-dept-note2[2] SKIP
       /*"<C2>Form #1:"  v-dc-msetup[2]*/
       "<C2>"  v-dc-msetup[2]
       /*"<C36>Form #2A:" v-dc-setup[2] */
       "<C36>" v-dc-setup[2]
       /*"<C70>Form #1:" v-dies[2] */
       "<C70>" v-dept-note2[3] SKIP
       /*"<C2>Form #2:" v-dc-msetup[3] */
       "<C2>" v-dc-msetup[3]
       /*"<C36>Form #1B:" v-dc-setup[3]  */
       "<C36>" v-dc-setup[3]
       /*"<C70>Form #2:" v-dies[3]*/
       "<C70>" v-dept-note2[4] SKIP 
       /*"<C2>Form #2:"  v-dc-msetup[4]*/
       "<C2>"  v-dc-msetup[4]
       /*"<C36>Form #2B:" v-dc-setup[4] SKIP*/
       "<C36>" v-dc-setup[4] SKIP
       /*"<C70>Form #2:" v-dies[4] */
