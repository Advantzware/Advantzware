...
/*              "<=SheetsReceived>"*/
        ...
        FOR EACH notes WHERE notes.rec_key = bf-itemfg.rec_key 
         ...
         PUT  "<=NotesStart><FROM><C108><LINE><|1>"
          ...
          PUT  
              ...
              "<=NotesStart><C+1><R+" + STRING(k + 2) + "><#SpecNotes1>" FORMAT "x(100)"
              "<=NotesStart><C+1><R+" + STRING(k + 3) + "><#SpecNotes2>" FORMAT "x(100)"
              "<=NotesStart><C+1><R+" + STRING(k + 4) + "><#SpecNotes3>" FORMAT "x(100)"
              "<=NotesStart><C+1><R+" + STRING(k + 5) + "><#SpecNotes4>" FORMAT "x(100)"
              "<=NotesStart><C+1><R+" + STRING(k + 6) + "><#SpecNotes5>" FORMAT "x(100)"
              "<=NotesStart><C+1><R+" + STRING(k + 7) + "><#SpecNotes6>" FORMAT "x(100)"
           ...
           IF v-dept-note[12] NE "" THEN
             PUT "<=Notes12>" v-dept-note[12] FORMAT "x(100)"  SKIP .
           IF v-dept-note[13] NE "" THEN
       ...
       IF AVAILABLE xeb  THEN
        ...
        PUT  /*"<C1><R1.2><#Start>"
              ...
              "<=ShippingStart><C18><R+10><#ShippingEnd>"
              "<=ShippingStart><R+1><RIGHT=C+6>Ship To: <#ShipTo>"
              "<=ShippingStart><R+1><C44>Contact: "
              "<=ShippingStart><R+2><C+1><#ShipName>"
              "<=ShippingStart><R+2><C44><#ShipContact>"
              "<=ShippingStart><R+3><C+1><#ShipAdd1>"
              "<=ShippingStart><R+3><C44><#ShipPhone>"
              "<=ShippingStart><R+4><C+1><#ShipAdd2>"
              "<=ShippingStart><R+4><C44>Dock Hours: <#DockHours>"
              "<=ShippingStart><R+5><C+1><#ShipCityStateZip>"
              "<=ShippingStart><R+5><C44>Dock#: <#Dock>"
       ...
       PAGE.
            ...
            PUT UNFORMATTED "<R2><C2><#1><R+47><C+108><IMAGE#ItemImage=" ls-fgitem-img ">".
            PAGE.
