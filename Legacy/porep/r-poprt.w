...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
 ...
 /* security check need {methods/prgsecur.i} in definition section */
  ...
  DO WITH FRAME {&FRAME-NAME}:
    ...
    IF NOT CAN-DO('Brick,CSC,Southpak,Xprint,Lovepac,poprint 1,poprint 10,StClair,Boss,PeachTree,Asixprnt,PPI,CSC-GA,Indiana,Packrite,Allwest,Bell,ACPI,Sultana,CCC,Protagon,SouleMed,Soule,Hughes',v-print-fmt) THEN DISABLE tb_spec.

    IF NOT CAN-DO('Xprint,Lovepac,poprint 1,poprint 10,StClair,Boss,Hughes,PeachTree,Protagon,PPI,Packrite,Sultana',v-print-fmt) THEN DO:
    ...
    IF LOOKUP(v-print-fmt,"xprint,Lovepac,poprint 1,poprint 10,StClair,Boss,Hughes,PeachTree,Protagon,ppi,Packrite") = 0 THEN 
       DISABLE tb_metric.
...
------------------------------------------------------------------------------*/
  ...
  IF rd-dest = 5 THEN DO:      
    ...
    /* gdm - 11190804 */
    IF LOOKUP(v-print-fmt,"Xprint,Lovepac,poprint 1,poprint 10,StClair,Boss,Hughes,PeachTree,FibreX,Protagon") > 0 
...
/* -------------------------------------------------------------------------- */
  ...
  IF LOOKUP(v-print-fmt,"SOUTHPAK,SouthPak-xl,CENTBOX,Oracle,metro,ASIXprnt,Valley,CSC-GA,HPB,Indiana,XPRINT,Lovepac,poprint 1,poprint 10,StClair,Boss,Hughes,PeachTree,ACPI,Sultana,CCC,SouleMed,Soule") > 0 THEN 
...
------------------------------------------------------------------------------*/
  ...
  IF LOOKUP(v-print-fmt,"Pacific,Xprint,Lovepac,poprint 1,poprint 10,StClair,Boss,PeachTree,Xprint2,poprint 2,poprint 20,Southpak,Hughes,CENTbox,Oracle,metro,PremierX,PremierCX,PremierXFGItems,Protagon,Protagon2,Coburn,CSC,Elite,ottpkg,APC,consbox,FibreX,ASIXprnt,Valley,PPI,CSC-GA,HPB,Indiana,MWFibre,Packrite,Allwest,Bell,ACPI,Sultana,Badger,CCC,SouleMed,Soule") > 0 
...
------------------------------------------------------------------------------*/
  ...
  CASE icPrintFormat:
    ...
    WHEN 'Lovepac'      THEN ASSIGN v-program = "po/po-lovepac.p"     li-lineperpage = 80.
