...
{sys/inc/ttRptSel.i}
ASSIGN cTextListToDefault  = "FG Item#,P.O.#,PO Item#,G/L Account,Amt Invoiced,Category" .
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME FRAME-A
     ...
     btn_SelectColumns AT ROW 11.81 COL 28 WIDGET-ID 10
...
DO:
   apply "close" to this-procedure.
    {Advantzware/WinKit/winkit-panel-triggerend.i} /* added by script _nonAdm1.p on 03.28.2017 @ 10:43:08 am */
END.
...
ON CLOSE OF THIS-PROCEDURE DO:
   RUN disable_UI.
   {Advantzware/WinKit/closewindow-nonadm.i} /* added by script _nonAdm1.p on 03.28.2017 @ 10:43:08 am */
END.
 ...
 /* security check need {methods/prgsecur.i} in definition section */
  ...
  END.
   ...
   cColumnInit   = NO .
    ...
    {Advantzware/WinKit/embedfinalize-nonadm.i} /* added by script _nonAdm1.p on 03.28.2017 @ 10:43:08 am */
      ...
      IF tb_excel THEN
        ...
        DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
           cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                CASE cTmpField:             
                     WHEN "ino"      THEN cVarValue = string(tt-report.key-02,"x(15)")  .
                     WHEN "po"       THEN cVarValue = string(po-ordl.po-no)  .
                     WHEN "po-ino"   THEN cVarValue = string(po-ordl.i-no,"x(15)") .
                     WHEN "act"      THEN cVarValue = STRING(tt-report.key-05,"x(25)") .
                     WHEN "cat"      THEN cVarValue = STRING(tt-report.key-01) .
