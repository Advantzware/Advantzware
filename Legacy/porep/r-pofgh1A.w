...
end_due-date rd_sort rd_show select-mat tb_po tb_fg rd_show-2 tb_rm ~
TB_separate-dates rd-dest lv-ornt lines-per-page lv-font-no td-show-parm ~
...
rd_sort lbl_show rd_show select-mat tb_po mat-types tb_fg lbl_show-2 ~
rd_show-2 tb_rm TB_separate-dates rd-dest lv-ornt lines-per-page lv-font-no ~
...
DEFINE VARIABLE rd_show-2 AS CHARACTER INITIAL "Cust Part#" 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "FG Item#", "FG Item#",
"Cust Part#", "Cust Part#"
...
DEFINE VARIABLE TB_separate-dates AS LOGICAL INITIAL no 
     LABEL "Separate Due/Receipt Dates" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME FRAME-A
     ...
     lbl_show-2 AT ROW 13.14 COL 15.6 COLON-ALIGNED NO-LABEL
     rd_show-2 AT ROW 13.14 COL 24.6 NO-LABEL
     tb_rm AT ROW 14.24 COL 14
     TB_separate-dates AT ROW 15.19 COL 14 WIDGET-ID 2
...
/* SETTINGS FOR FILL-IN lbl_show-2 IN FRAME FRAME-A
   NO-ENABLE                                                            */
ASSIGN 
       lbl_show-2:PRIVATE-DATA IN FRAME FRAME-A     = 
                "rd_show-2".
...
ASSIGN 
       rd_show-2:PRIVATE-DATA IN FRAME FRAME-A     = 
                "parm".
...
DO:
   apply "close" to this-procedure.
    {Advantzware/WinKit/winkit-panel-triggerend.i} /* added by script _nonAdm1.p on 03.28.2017 @ 10:43:07 am */
END.
...
&Scoped-define SELF-NAME lbl_show-2
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL lbl_show-2 C-Win
ON LEAVE OF lbl_show-2 IN FRAME FRAME-A
DO:
  assign {&self-name}.
END.
...
&Scoped-define SELF-NAME rd_show-2
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL rd_show-2 C-Win
ON VALUE-CHANGED OF rd_show-2 IN FRAME FRAME-A
DO:
  assign {&self-name}.
END.
...
&Scoped-define SELF-NAME TB_separate-dates
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL TB_separate-dates C-Win
ON VALUE-CHANGED OF TB_separate-dates IN FRAME FRAME-A /* Separate Due/Receipt Dates */
DO:
   ASSIGN {&self-name}.
END.
...
ON CLOSE OF THIS-PROCEDURE DO:
   RUN disable_UI.
   {Advantzware/WinKit/closewindow-nonadm.i} /* added by script _nonAdm1.p on 03.28.2017 @ 10:43:07 am */
END.
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
 ...
 /* security check need {methods/prgsecur.i} in definition section */
  ...
  END.
    ...
    {Advantzware/WinKit/embedfinalize-nonadm.i} /* added by script _nonAdm1.p on 03.28.2017 @ 10:43:07 am */
...
------------------------------------------------------------------------------*/
  DISPLAY begin_po-no end_po-no begin_po-date end_po-date begin_vend end_vend 
          ...
          rd_show select-mat tb_po mat-types tb_fg lbl_show-2 rd_show-2 tb_rm 
          TB_separate-dates rd-dest lv-ornt lines-per-page lv-font-no 
          lv-font-name td-show-parm tb_excel tb_runExcel fi_file 
  ...
  ENABLE RECT-6 RECT-7 begin_po-no end_po-no begin_po-date end_po-date 
         ...
         rd_sort rd_show select-mat tb_po tb_fg rd_show-2 tb_rm 
         TB_separate-dates rd-dest lv-ornt lines-per-page lv-font-no 
