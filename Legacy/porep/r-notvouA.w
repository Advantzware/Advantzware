...
DEFINE FRAME FRAME-A
     begin_date AT ROW 2.48 COL 27 COLON-ALIGNED
     end_date AT ROW 2.48 COL 68 COLON-ALIGNED
     begin_po-no AT ROW 3.43 COL 27 COLON-ALIGNED HELP
          "Enter Beginning PO Number"
     end_po-no AT ROW 3.43 COL 68 COLON-ALIGNED HELP
          "Enter Ending PO Number"
     begin_po-i-no AT ROW 4.38 COL 27 COLON-ALIGNED HELP
          "Enter Beginning Order Number"
     end_po-i-no AT ROW 4.38 COL 68 COLON-ALIGNED HELP
          "Enter Ending Item Number"
     begin_rdate AT ROW 5.33 COL 27 COLON-ALIGNED
     end_rdate AT ROW 5.33 COL 68 COLON-ALIGNED
     begin_vend AT ROW 6.29 COL 27 COLON-ALIGNED HELP
     ...
     tb_excel AT ROW 17.38 COL 51 RIGHT-ALIGNED
     tb_runExcel AT ROW 17.38 COL 72 RIGHT-ALIGNED
...
------------------------------------------------------------------------------*/
   ...
   IF tb_excel THEN
      PUT STREAM excel UNFORMATTED
        ...
        '"' temp-po-rec.descr                               '",'
        '"' temp-po-rec.prod-cat                            '",'
        '"' STRING(temp-po-rec.qty-to-inv,"->>,>>>,>>9.9")  '",'
        '"' temp-po-rec.whse                                '",'
        '"' STRING(temp-po-rec.cost-each ,">>>,>>9.99<<<<") '",'
        '"' STRING(temp-po-rec.amt-to-inv,"->>,>>>,>>9.99") '",'
        SKIP.
   ...
   if ip-last-of and v-tot-amt ne 0 then do:
      ...
      IF tb_excel THEN
        PUT STREAM excel UNFORMATTED
            ...
            '"' ""                                 '",'
            '"' ""                                 '",'
            '"' STRING(v-tot-qty,"->>,>>>,>>9.9")  '",'
            '"' ""                                 '",'
            '"' ""                                 '",'
            '"' STRING(v-tot-amt,"->>,>>>,>>9.99") '",'
            SKIP(1).
...
IF tb_excel THEN DO:
  PUT STREAM excel UNFORMATTED
       ...
       '"' ""                                 '",'
       '"' ""                                 '",'
       '"' STRING(v-grand-tot-qty,"->>,>>>,>>9.9")  '",'
       '"' ""                                 '",'
       '"' ""                                 '",'
       '"' STRING(v-grand-tot-amt,"->>,>>>,>>9.99") '",'
       SKIP(1).
