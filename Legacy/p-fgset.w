...
&Scoped-define SELF-NAME Btn-est
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Btn-est C-WIn
ON CHOOSE OF Btn-est IN FRAME Panel-Frame /* EstimateBuild */
DO:
  DEF VAR char-hdl AS CHAR NO-UNDO.


  RUN get-link-handle IN adm-broker-hdl
      (THIS-PROCEDURE, "tableio-target", OUTPUT char-hdl).
