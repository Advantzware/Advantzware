...
&Scoped-Define ENABLED-OBJECTS UDF Select_spec Select_dept Select_frac ~
Select_add Select_appl Select_help 
...
ON CHOOSE OF Select_appl IN FRAME F-Main /* Util Appl */
DO:
  {methods/run_link.i "CONTAINER-SOURCE" "{&SELF-NAME}"}
END.
