...
DEFINE BUTTON btn-ytd 
     LABEL "&Prior Yr/YTD Bal" 
     SIZE 15 BY 1.29.
...
ON CHOOSE OF btn-recalc IN FRAME Panel-Frame /* Recalc Totals */
DO:
...
&Scoped-define SELF-NAME btn-ytd
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn-ytd C-WIn
ON CHOOSE OF btn-ytd IN FRAME Panel-Frame /* Prior Yr/YTD Bal */
DO:
  DEF VAR char-hdl AS CHAR NO-UNDO.


  RUN get-link-handle IN adm-broker-hdl (THIS-PROCEDURE, "tableio-target", OUTPUT char-hdl).
  IF VALID-HANDLE(WIDGET-HANDLE(char-hdl)) THEN RUN lyytd-tot IN WIDGET-HANDLE(char-hdl).
  {Advantzware/WinKit/winkit-panel-triggerend.i} /* added by script _admPanels.p on 03.28.2017 @ 10:44:46 am */
END.
...
/* ***************************  Main Block  *************************** */
  ...
  {methods/setButton.i Btn-Save "Update"} /* added by script _admTransPanels.p on 03.28.2017 @ 10:44:52 am */
  {methods/setButton.i Btn-Reset "Reset"} /* added by script _admTransPanels.p on 03.28.2017 @ 10:44:52 am */
