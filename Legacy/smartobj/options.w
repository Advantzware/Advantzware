...
&Scoped-Define ENABLED-OBJECTS Select_List Select_appl Select_frac ~
Select_help Select_Home Select_Notes Select_spec 
...
------------------------------------------------------------------------------*/
   ...
   DO WITH FRAME {&FRAME-NAME}:
      ...
      ELSE
         SELECT_spec:LOAD-IMAGE("Graphics/32x32/book_open_start.png").
   END.
END PROCEDURE.
