...
DEFINE BUTTON Select_attcust 
     IMAGE-UP FILE "Graphics/32x32/paperclip2.ico":U
...
------------------------------------------------------------------------------*/
   ...
   DO WITH FRAME {&FRAME-NAME}:
      IF NOT ip-attach THEN
         SELECT_attcust:LOAD-IMAGE("Graphics/32x32/pushpin.ico").
      ELSE
         SELECT_attcust:LOAD-IMAGE("Graphics/32x32/pushpiny.ico").
   END.
END PROCEDURE.
