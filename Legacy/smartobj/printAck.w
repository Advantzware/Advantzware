...
&Scoped-Define ENABLED-OBJECTS printAck 
...
DEFINE BUTTON printAck 
     IMAGE-UP FILE "Graphics/32x32/printer_ok.png":U
...
&Scoped-define SELF-NAME printAck
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL printAck s-object
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
printAck:SENSITIVE IN FRAME F-Main = FALSE.
END PROCEDURE.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
printAck:SENSITIVE IN FRAME F-Main = TRUE.
END PROCEDURE.
