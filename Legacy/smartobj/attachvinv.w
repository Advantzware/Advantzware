...
&Scoped-Define ENABLED-OBJECTS Select_attvinv 
...
&Scoped-define SELF-NAME Select_attvinv
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Select_attvinv s-object
ON CHOOSE OF Select_attvinv IN FRAME F-Main /* Attachment */
DO:
   {methods/run_link.i "CONTAINER-SOURCE" "{&SELF-NAME}"}

   RUN get-link-handle IN adm-broker-hdl(THIS-PROCEDURE,"attachinv-source",OUTPUT char-hdl).
...
------------------------------------------------------------------------------*/
   ...
   DO WITH FRAME {&FRAME-NAME}:
      IF NOT ip-attach THEN
         SELECT_attvinv:LOAD-IMAGE("images/pushpin.ico").
      ELSE
         SELECT_attvinv:LOAD-IMAGE("images/pushpiny.ico").
   END.
END PROCEDURE.
