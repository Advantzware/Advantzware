...
DEFINE VARIABLE jobRowID AS ROWID NO-UNDO.
...
&Scoped-define INTERNAL-TABLES job job-mch est mach

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH job ~
...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH job ~
      WHERE ROWID(job) EQ jobRowID NO-LOCK, ~
      FIRST job-mch WHERE TRUE /* Join to job incomplete */ ~
      AND ROWID(job-mch) EQ jobMchRowID NO-LOCK, ~
      FIRST est OF job NO-LOCK, ~
      ...
      AND mach.company EQ job-mch.company ~
AND mach.m-code EQ job-mch.m-code NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main job job-mch est mach
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main job
&Scoped-define SECOND-TABLE-IN-QUERY-Query-Main job-mch
&Scoped-define THIRD-TABLE-IN-QUERY-Query-Main est
&Scoped-define FOURTH-TABLE-IN-QUERY-Query-Main mach
...
------------------------------------------------------------------------------*/
  ...
  {{&viewers}/includes/qLocalInit.i &rowIDsOutput="OUTPUT jobRowID,OUTPUT jobMchRowID"}
