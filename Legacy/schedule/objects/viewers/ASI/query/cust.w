...
&Scoped-define INTERNAL-TABLES job-hdr cust

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH job-hdr OF job WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      FIRST cust OF job-hdr NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH job-hdr OF job WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      FIRST cust OF job-hdr NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main job-hdr cust
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "asi.job-hdr OF asi.job,asi.cust OF asi.job-hdr"
