...
ON END-ERROR OF W-Win /* Scheduler Startup */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Scheduler Startup */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_config ).
       RUN set-position IN h_config ( 1.00 , 1.00 ) NO-ERROR.
