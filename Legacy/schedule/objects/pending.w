...
&SCOPED-DEFINE viewerHandle h_Pending
...
DEFINE FRAME detailFrame
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SCROLLABLE SIZE 150.4 BY 28.57.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Pending by Job - Scheduler"
         HEIGHT             = 28.57
         WIDTH              = 150.4
         MAX-HEIGHT         = 320
         MAX-WIDTH          = 150.4
...
ON END-ERROR OF W-Win /* Pending by Job - Scheduler */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Pending by Job - Scheduler */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-RESIZED OF W-Win /* Pending by Job - Scheduler */
DO:
  RUN winReSize.
END.
...
------------------------------------------------------------------------------*/
  ...
  pending = findProgram('{&viewers}/',ID,'/pending.w').
