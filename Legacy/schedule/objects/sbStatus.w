...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Job Status Checkoff - Scheduler"
         HEIGHT             = 22.52
         WIDTH              = 150
         MAX-HEIGHT         = 22.52
         MAX-WIDTH          = 150
...
ON END-ERROR OF W-Win /* Job Status Checkoff - Scheduler */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Job Status Checkoff - Scheduler */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-RESIZED OF W-Win /* Job Status Checkoff - Scheduler */
DO:
  RUN winReSize.
END.
...
------------------------------------------------------------------------------*/
  ...
  sbStatus = findProgram('{&viewers}/',ID,'/sbStatus.w').
...
------------------------------------------------------------------------------*/
  ...
  RUN select-page (0).
  RUN passHandle IN h_Status (ipHandle,ipBoard).
...
------------------------------------------------------------------------------*/
  ...
  RUN setSize IN h_Status ({&WINDOW-NAME}:HEIGHT-PIXELS,{&WINDOW-NAME}:WIDTH-PIXELS).
