...
&scoped-define SORTBY-2 BY fg-bin.tag
&scoped-define fld-name-1 fg-bin.loc-bin
&scoped-define fld-name-2 fg-bin.tag
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-1 fg-bin.loc-bin fg-bin.tag ~
fg-bin.qty 
