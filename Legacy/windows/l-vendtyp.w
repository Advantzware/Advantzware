...
&scoped-define SORTBY-1 BY ventype.TYPE
&scoped-define SORTBY-2 BY ventype.dsc
&scoped-define fld-name-1 ventype.TYPE
&scoped-define fld-name-2 ventype.dscr
...
DO:
   op-char-val = ventype.TYPE:screen-value in browse {&browse-name} + "," +
                 ventype.dscr:screen-value in browse {&browse-name}.
