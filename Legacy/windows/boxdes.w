...
&SCOPED-DEFINE h_Browse01 h_boxdes
...
DEFINE VARIABLE h_boxdes AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v-boxdes AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Corrugated Box Design */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Corrugated Box Design */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_f-add-2 ).
       RUN set-position IN h_f-add-2 ( 1.00 , 77.20 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Brws Box Dsgn|View Box Dsgn|Box 3D Image' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'browsers/boxdes.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_boxdes ).
       RUN set-position IN h_boxdes ( 4.57 , 11.00 ) NO-ERROR.
       RUN set-size IN h_boxdes ( 19.52 , 117.00 ) NO-ERROR.

       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('2':U) NO-ERROR.

       /* Links to SmartNavBrowser h_boxdes. */
       RUN add-link IN adm-broker-hdl ( h_p-navico , 'Navigation':U , h_boxdes ).
       RUN add-link IN adm-broker-hdl ( h_boxdes , 'Record':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_boxdes ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'cec/v-boxdes.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = Yes':U ,
             OUTPUT h_v-boxdes ).
       RUN set-position IN h_v-boxdes ( 4.81 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 16.67 , 147.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updsav ).
       RUN set-position IN h_p-updsav ( 22.19 , 55.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-boximg ).
       RUN set-position IN h_p-boximg ( 22.19 , 111.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.14 , 33.00 ) */

       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('1':U) NO-ERROR.

       /* Links to SmartViewer h_v-boxdes. */
       RUN add-link IN adm-broker-hdl ( h_boxdes , 'Record':U , h_v-boxdes ).
       RUN add-link IN adm-broker-hdl ( h_p-boximg , 'image':U , h_v-boxdes ).
       RUN add-link IN adm-broker-hdl ( h_p-updsav , 'TableIO':U , h_v-boxdes ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'add-item':U , h_v-boxdes ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-boxdes ,
             h_folder , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-navico ,
             h_v-boxdes , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updsav ,
             h_p-navico , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-boximg ,
             h_p-updsav , 'AFTER':U ).
    END. /* Page 2 */
    WHEN 3 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-stybx3 ).
       RUN set-position IN h_v-stybx3 ( 4.81 , 4.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-boxupd ).
       RUN set-position IN h_p-boxupd ( 21.95 , 81.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-bximg2 ).
       RUN set-position IN h_p-bximg2 ( 21.95 , 112.00 ) NO-ERROR.
       RUN set-size IN h_p-bximg2 ( 1.76 , 37.00 ) NO-ERROR.

       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('1':U) NO-ERROR.

       /* Links to SmartViewer h_v-stybx3. */
       RUN add-link IN adm-broker-hdl ( h_boxdes , 'Record':U , h_v-stybx3 ).
       RUN add-link IN adm-broker-hdl ( h_p-boxupd , 'TableIO':U , h_v-stybx3 ).
       RUN add-link IN adm-broker-hdl ( h_p-bximg2 , 'image':U , h_v-stybx3 ).
       RUN add-link IN adm-broker-hdl ( h_p-bximg2 , 'TableIO':U , h_v-stybx3 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-boxupd ,
             h_v-stybx3 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-bximg2 ,
             h_p-boxupd , 'AFTER':U ).
    END. /* Page 3 */
