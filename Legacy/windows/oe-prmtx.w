...
--------------------------------------------------- ---------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_oe-prmtx , 'Record':U , THIS-PROCEDURE ).
       RUN add-link IN adm-broker-hdl ( h_oe-prmtx , 'export-xl':U , h_export ).
