...
&scoped-define fld-name-1 dept.code
&scoped-define fld-name-2 dept.dscr
&scoped-define SORTBY-1 BY dept.code
&scoped-define SORTBY-2 BY dept.dscr
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-1 dept.code dept.dscr 
...
/* Query rebuild information for BROWSE BROWSE-1
     ...
     _Where[1]         = "ASI.dept.setup <> 99
 OR ASI.dept.fc <> 99
 OR ASI.dept.corr <> 99
 OR ASI.dept.therm <> 99"
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Department Information */
DO:
...
DO:
   op-char-val = dept.code:screen-value in browse {&browse-name} + "," +
                 dept.dscr:screen-value in browse {&browse-name}
                 .
