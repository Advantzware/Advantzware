...
/* RUN windows/rejctcdw.w (INPUT "JH", "Job Hold Reason", "Description", */
/*                          INPUT "Job Hold Reason").                 */
/* smartrun.i */
...
DO:
  ...
  DO: /* took persistent out, per joe 6.3.2005 (res), put back 7.1.2005 */
    phandle = ?.
    RUN VALUE(run-proc) 
        PERSISTENT SET phandle (INPUT "JH", "Job Hold Reason", "Description", 
                         INPUT "Job Hold Reason", INPUT THIS-PROCEDURE)  NO-ERROR. /* YSK to stop if there's error*/
