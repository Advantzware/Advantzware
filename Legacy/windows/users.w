...
&SCOPED-DEFINE h_Browse01 h_users
&SCOPED-DEFINE h_Object01 h_usrcmp-c-2
&SCOPED-DEFINE h_Object02 h_p-updsav-2
&SCOPED-DEFINE h_Object03 h_usrcmp-l-2
&SCOPED-DEFINE h_Object04 h_p-updsav-3
&SCOPED-DEFINE h_Object05 h_p-popup
...
DEFINE VARIABLE h_p-popup AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_usercust-2 AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     RECT-5 AT ROW 20.05 COL 125 WIDGET-ID 2
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Users */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Browse Users|View User|Compny/Locatn|Popup Menu|Customers|Vendors|Sales Rep|Ship From' + ',
                     FOLDER-TAB-TYPE = 2':U ,
             OUTPUT h_folder ).
    ...
    WHEN 3 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'viewerid/users.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_users-3 ).
       RUN set-position IN h_users-3 ( 4.57 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.67 , 79.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'browsers/usrcmp-c.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_usrcmp-c ).
       RUN set-position IN h_usrcmp-c ( 6.48 , 3.00 ) NO-ERROR.
       RUN set-size IN h_usrcmp-c ( 13.57 , 70.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'browsers/usrcmp-l.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_usrcmp-l ).
       RUN set-position IN h_usrcmp-l ( 6.48 , 75.00 ) NO-ERROR.
       RUN set-size IN h_usrcmp-l ( 13.57 , 70.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'viewers/usrcmp-c.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_usrcmp-c-2 ).
       RUN set-position IN h_usrcmp-c-2 ( 20.52 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.43 , 36.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'viewers/usrcmp-l.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_usrcmp-l-2 ).
       RUN set-position IN h_usrcmp-l-2 ( 20.52 , 75.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.43 , 39.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updsav-2 ).
       RUN set-position IN h_p-updsav-2 ( 22.19 , 3.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updsav-3 ).
       RUN set-position IN h_p-updsav-3 ( 22.19 , 75.00 ) NO-ERROR.
       RUN set-size IN h_p-updsav-3 ( 2.14 , 56.00 ) NO-ERROR.

       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('1':U) NO-ERROR.

       /* Links to SmartViewer h_users-3. */
       RUN add-link IN adm-broker-hdl ( h_users , 'Record':U , h_users-3 ).

       /* Links to SmartNavBrowser h_usrcmp-c. */
       RUN add-link IN adm-broker-hdl ( h_users , 'Record':U , h_usrcmp-c ).

       /* Links to SmartNavBrowser h_usrcmp-l. */
       RUN add-link IN adm-broker-hdl ( h_usrcmp-c , 'Record':U , h_usrcmp-l ).

       /* Links to SmartViewer h_usrcmp-c-2. */
       RUN add-link IN adm-broker-hdl ( h_p-updsav-2 , 'TableIO':U , h_usrcmp-c-2 ).
       RUN add-link IN adm-broker-hdl ( h_usrcmp-c , 'Record':U , h_usrcmp-c-2 ).

       /* Links to SmartViewer h_usrcmp-l-2. */
       RUN add-link IN adm-broker-hdl ( h_p-updsav-3 , 'TableIO':U , h_usrcmp-l-2 ).
       RUN add-link IN adm-broker-hdl ( h_usrcmp-l , 'Record':U , h_usrcmp-l-2 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_usrcmp-l ,
             h_usrcmp-c , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_usrcmp-c-2 ,
             h_usrcmp-l , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_usrcmp-l-2 ,
             h_usrcmp-c-2 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updsav-2 ,
             h_usrcmp-l-2 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updsav-3 ,
             h_p-updsav-2 , 'AFTER':U ).
    END. /* Page 3 */
    WHEN 4 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'browsers/b-usrmnu.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = ?':U ,
             OUTPUT h_b-usrmnu ).
       RUN set-position IN h_b-usrmnu ( 6.00 , 25.00 ) NO-ERROR.
       RUN set-size IN h_b-usrmnu ( 13.57 , 77.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-popup ).
       RUN set-position IN h_p-popup ( 20.76 , 20.00 ) NO-ERROR.
       RUN set-size IN h_p-popup ( 1.76 , 92.00 ) NO-ERROR.

       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('1':U) NO-ERROR.

       /* Links to SmartBrowser h_b-usrmnu. */
       RUN add-link IN adm-broker-hdl ( h_p-popup , 'TableIO':U , h_b-usrmnu ).
       RUN add-link IN adm-broker-hdl ( h_users , 'Record':U , h_b-usrmnu ).
    ...
    WHEN 6 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'browsers/uservend.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_uservend ).
       RUN set-position IN h_uservend ( 4.81 , 34.00 ) NO-ERROR.
       RUN set-size IN h_uservend ( 10.57 , 90.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'viewers/uservend.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_uservend-2 ).
       RUN set-position IN h_uservend-2 ( 16.48 , 52.00 ) NO-ERROR.
       /* Size in UIB:  ( 4.05 , 34.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updsav-5 ).
       RUN set-position IN h_p-updsav-5 ( 21.48 , 35.00 ) NO-ERROR.
       RUN set-size IN h_p-updsav-5 ( 1.76 , 82.00 ) NO-ERROR.

       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('1':U) NO-ERROR.

       /* Links to SmartNavBrowser h_uservend. */
       RUN add-link IN adm-broker-hdl ( h_users , 'Record':U , h_uservend ).

       /* Links to SmartViewer h_uservend-2. */
       RUN add-link IN adm-broker-hdl ( h_p-updsav-5 , 'TableIO':U , h_uservend-2 ).
       RUN add-link IN adm-broker-hdl ( h_uservend , 'Record':U , h_uservend-2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_uservend ,
             FRAME message-frame:HANDLE , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_uservend-2 ,
             h_uservend , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updsav-5 ,
             h_uservend-2 , 'AFTER':U ).
    END. /* Page 6 */
    WHEN 7 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'browsers/usersman.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_usersman ).
       RUN set-position IN h_usersman ( 5.29 , 33.00 ) NO-ERROR.
       RUN set-size IN h_usersman ( 10.57 , 90.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'viewers/usersman.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_usersman-2 ).
       RUN set-position IN h_usersman-2 ( 16.71 , 52.00 ) NO-ERROR.
       /* Size in UIB:  ( 4.05 , 34.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updsav-6 ).
       RUN set-position IN h_p-updsav-6 ( 21.48 , 34.00 ) NO-ERROR.
       RUN set-size IN h_p-updsav-6 ( 1.76 , 82.00 ) NO-ERROR.

       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('1':U) NO-ERROR.

       /* Links to SmartNavBrowser h_usersman. */
       RUN add-link IN adm-broker-hdl ( h_users , 'Record':U , h_usersman ).

       /* Links to SmartViewer h_usersman-2. */
       RUN add-link IN adm-broker-hdl ( h_p-updsav-6 , 'TableIO':U , h_usersman-2 ).
       RUN add-link IN adm-broker-hdl ( h_usersman , 'Record':U , h_usersman-2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_usersman ,
             FRAME message-frame:HANDLE , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_usersman-2 ,
             h_usersman , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updsav-6 ,
             h_usersman-2 , 'AFTER':U ).
    END. /* Page 7 */
    WHEN 8 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'browsers/usrcmp-x.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_usrcmp-x ).
       RUN set-position IN h_usrcmp-x ( 4.57 , 27.00 ) NO-ERROR.
       RUN set-size IN h_usrcmp-x ( 13.57 , 70.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'viewers/usrcmp-x.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_usrcmp-x-2 ).
       RUN set-position IN h_usrcmp-x-2 ( 18.86 , 28.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.43 , 35.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updsav-7 ).
       RUN set-position IN h_p-updsav-7 ( 21.00 , 27.00 ) NO-ERROR.
       RUN set-size IN h_p-updsav-7 ( 1.76 , 82.00 ) NO-ERROR.

       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('1':U) NO-ERROR.

       /* Links to SmartNavBrowser h_usrcmp-x. */
       RUN add-link IN adm-broker-hdl ( h_users , 'Record':U , h_usrcmp-x ).

       /* Links to SmartViewer h_usrcmp-x-2. */
       RUN add-link IN adm-broker-hdl ( h_p-updsav-7 , 'TableIO':U , h_usrcmp-x-2 ).
       RUN add-link IN adm-broker-hdl ( h_usrcmp-x , 'Record':U , h_usrcmp-x-2 ).
