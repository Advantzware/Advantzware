...
AND rm-bin.i-no = ip-i-no AND ((rm-bin.qty > 0 AND NOT tb_dis-bin) OR (tb_dis-bin)) NO-LOCK ~
    ~{&SORTBY-PHRASE}
...
&Scoped-Define ENABLED-OBJECTS BROWSE-1 RECT-1 rd-sort tb_dis-bin bt-clear lv-search ~
bt-ok bt-cancel 
&Scoped-Define DISPLAYED-OBJECTS rd-sort tb_dis-bin lv-search 
...
DEFINE VARIABLE tb_dis-bin AS LOGICAL INITIAL no 
     LABEL "Display All Bins" 
     VIEW-AS TOGGLE-BOX
     SIZE 19.2 BY .95 NO-UNDO.
...
DEFINE FRAME Dialog-Frame
     ...
     tb_dis-bin AT ROW 12.71 COL 65.2 WIDGET-ID 2
...
&Scoped-define SELF-NAME tb_dis-bin
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tb_dis-bin Dialog-Frame
ON VALUE-CHANGED OF tb_dis-bin IN FRAME Dialog-Frame
DO:
    ASSIGN tb_dis-bin .
...
------------------------------------------------------------------------------*/
  DISPLAY rd-sort tb_dis-bin lv-search 
      WITH FRAME Dialog-Frame.
  ENABLE BROWSE-1 RECT-1 rd-sort tb_dis-bin bt-clear lv-search bt-ok bt-cancel 
      WITH FRAME Dialog-Frame.
