...
DEFINE VARIABLE h_invnotes AS HANDLE NO-UNDO.
DEFINE VARIABLE h_invnotes-2 AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Invoice Notes */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Invoice Notes */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'browsers/invnotes.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_invnotes ).
       RUN set-position IN h_invnotes ( 4.81 , 6.00 ) NO-ERROR.
       RUN set-size IN h_invnotes ( 18.10 , 138.00 ) NO-ERROR.

       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('2':U) NO-ERROR.

       /* Links to SmartNavBrowser h_invnotes. */
       RUN add-link IN adm-broker-hdl ( h_p-navico , 'Navigation':U , h_invnotes ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_invnotes ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'viewers/invnotes.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = Yes':U ,
             OUTPUT h_invnotes-2 ).
       RUN set-position IN h_invnotes-2 ( 5.76 , 15.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_invnotes-2. */
       RUN add-link IN adm-broker-hdl ( h_invnotes , 'Record':U , h_invnotes-2 ).
       RUN add-link IN adm-broker-hdl ( h_p-updsav , 'TableIO':U , h_invnotes-2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_invnotes-2 ,
             h_folder , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-navico ,
             h_invnotes-2 , 'AFTER':U ).
