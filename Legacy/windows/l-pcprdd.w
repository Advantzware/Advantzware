...
&Scoped-define FIELDS-IN-QUERY-BROWSE-1  pc-prdd.job-no pc-prdd.job-no2 ~
pc-prdd.frm pc-prdd.blank-no pc-prdd.pass pc-prdd.i-no pc-prdd.m-code 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-1 
&Scoped-define QUERY-STRING-BROWSE-1 FOR EACH pc-prdd WHERE ~{&KEY-PHRASE} ~
      AND pc-prdd.company = ip-company NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-BROWSE-1 OPEN QUERY BROWSE-1 FOR EACH pc-prdd WHERE ~{&KEY-PHRASE} ~
      AND pc-prdd.company = ip-company NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-BROWSE-1 pc-prdd
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-1 pc-prdd
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-1 Dialog-Frame _STRUCTURED
  QUERY BROWSE-1 NO-LOCK DISPLAY
      ...
      pc-prdd.i-no FORMAT "x(15)":U
      pc-prdd.m-code FORMAT "x(15)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE BROWSE-1
     ...
     _Where[1]         = "ASI.pc-prdd.company = ip-company"
     _FldNameList[1]   = ASI.pc-prdd.job-no
     _FldNameList[2]   = ASI.pc-prdd.job-no2
     _FldNameList[3]   = ASI.pc-prdd.i-no
     _FldNameList[4]   = ASI.pc-prdd.m-code
     _Query            is OPENED
*/  /* BROWSE BROWSE-1 */
&ANALYZE-RESUME
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  &scoped-define key-phrase pc-prdd.company EQ ip-company 
  {custom/lookpos.i &lookup-file = "pc-prdd" &lookup-field = "job-no" }
