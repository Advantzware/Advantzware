...
DEF INPUT PARAMETER ip-sts AS CHAR NO-UNDO.
...
&Scoped-define QUERY-STRING-BROWSE-1 FOR EACH wiptag WHERE wiptag.sts = ip-sts AND ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-BROWSE-1 OPEN QUERY BROWSE-1 FOR EACH wiptag WHERE wiptag.sts = ip-sts AND ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
