...
DEFINE VARIABLE h_vwrtag-2 AS HANDLE NO-UNDO.
...
ON END-ERROR OF wWin /* Tag Viewer */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wWin wWin
ON WINDOW-CLOSE OF wWin /* Tag Viewer */
DO:
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       RUN constructObject (
             ...
             OUTPUT h_sdotag ).
       RUN repositionObject IN h_sdotag ( 1.24 , 3.00 ) NO-ERROR.
       ...
       RUN constructObject (
             ...
             OUTPUT h_brwtag ).
       RUN repositionObject IN h_brwtag ( 3.38 , 3.00 ) NO-ERROR.
       ...
       RUN constructObject (
             ...
             OUTPUT h_vwrtag-2 ).
       RUN repositionObject IN h_vwrtag-2 ( 10.29 , 4.00 ) NO-ERROR.
       ...
       /* Links to SmartDataViewer h_vwrtag-2. */
       RUN addLink ( h_sdotag , 'Data':U , h_vwrtag-2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjustTabOrder ( h_vwrtag-2 ,
             h_brwtag , 'AFTER':U ).
    END. /* Page 0 */
