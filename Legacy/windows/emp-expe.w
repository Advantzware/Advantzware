...
{sys/inc/ttRptSel.i}
    ASSIGN cTextListToDefault  = "Emp.ID,First Name,Middle Name,Last Name,Social Security," + 
...
FUNCTION getValue-estf RETURNS CHARACTER
  ( BUFFER ipb-estf FOR employee, ipc-field AS CHAR  )  FORWARD.
...
FUNCTION getValue-estf RETURNS CHARACTER
  ( BUFFER ipb-estf FOR employee, ipc-field AS CHAR  ) :
/*------------------------------------------------------------------------------
...
------------------------------------------------------------------------------*/
    ...
    CASE ipc-field :
        ...
        END.
        WHEN "emp-type"  THEN DO:
            lc-return = ipb-estf.emp_type .
        END.
        WHEN "key-type"  THEN DO:
