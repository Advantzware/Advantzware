...
&scoped-define SORTBY-1 BY itemfg.spc-no
&scoped-define SORTBY-2 BY itemfg.i-name
&scoped-define fld-name-1 itemfg.spc-no
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-1 itemfg.spc-no itemfg.i-no ~
itemfg.i-name 
...
DEFINE FRAME Dialog-Frame
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         TITLE "Finished Good Information (SPC#)".
...
/* Query rebuild information for BROWSE BROWSE-1
     ...
     _FldNameList[1]   = ASI.itemfg.spc-no
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Finished Good Information (SPC#) */
DO:
...
DO:
   op-char-val = itemfg.spc-no:screen-value in browse {&browse-name} + "," +
