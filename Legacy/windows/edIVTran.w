...
&SCOPED-DEFINE h_Browse01 h_edIVTran
...
DEFINE VARIABLE h_edivaddon-2 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_edivaddon-3 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_edivline-2 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_edivline-3 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_edivtran AS HANDLE NO-UNDO.
DEFINE VARIABLE h_edivtran-2 AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* EDI 810 Invoices */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* EDI 810 Invoices */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'viewers/edivtran.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_edivtran-2 ).
       RUN set-position IN h_edivtran-2 ( 4.91 , 4.80 ) NO-ERROR.
       /* Size in UIB:  ( 24.29 , 150.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-navico ).
       RUN set-position IN h_p-navico ( 29.81 , 25.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updsav ).
       RUN set-position IN h_p-updsav ( 29.81 , 84.00 ) NO-ERROR.
       RUN set-size IN h_p-updsav ( 2.14 , 56.00 ) NO-ERROR.

       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('3':U) NO-ERROR.

       /* Links to SmartViewer h_edivtran-2. */
       RUN add-link IN adm-broker-hdl ( h_edivline-2 , 'Record':U , h_edivtran-2 ).
       RUN add-link IN adm-broker-hdl ( h_p-updsav , 'TableIO':U , h_edivtran-2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_edivtran-2 ,
             h_folder , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-navico ,
             h_edivtran-2 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updsav ,
             h_p-navico , 'AFTER':U ).
    END. /* Page 2 */
    WHEN 3 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'browsers/edivline.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_edivline-2 ).
       ...
       /* Links to SmartNavBrowser h_edivline-2. */
       RUN add-link IN adm-broker-hdl ( h_edivtran , 'Record':U , h_edivline-2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_edivline-2 ,
             h_folder , 'AFTER':U ).
    END. /* Page 3 */
    WHEN 4 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'viewers/edivline.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_edivline-3 ).
       ...
       /* Links to SmartViewer h_edivline-3. */
       RUN add-link IN adm-broker-hdl ( h_edivline-2 , 'Record':U , h_edivline-3 ).
       RUN add-link IN adm-broker-hdl ( h_p-updsav-3 , 'TableIO':U , h_edivline-3 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_edivline-3 ,
             h_folder , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updsav-3 ,
             h_edivline-3 , 'AFTER':U ).
    END. /* Page 4 */
    WHEN 5 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'browsers/edivaddon.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
       ...
       /* Links to SmartNavBrowser h_edivaddon-2. */
       RUN add-link IN adm-broker-hdl ( h_edivline-2 , 'Record':U , h_edivaddon-2 ).

       /* Links to SmartViewer h_edivaddon-3. */
       RUN add-link IN adm-broker-hdl ( h_edivaddon-2 , 'Record':U , h_edivaddon-3 ).
       RUN add-link IN adm-broker-hdl ( h_p-updsav-4 , 'TableIO':U , h_edivaddon-3 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_edivaddon-2 ,
             h_folder , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_edivaddon-3 ,
             h_edivaddon-2 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updsav-4 ,
             h_edivaddon-3 , 'AFTER':U ).
    END. /* Page 5 */
