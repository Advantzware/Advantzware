...
&scoped-define SORTBY-2 BY reftable.dscr {&SORTBY-1}
...
&Scoped-define QUERY-STRING-BROWSE-1 FOR EACH reftable         WHERE ~{&KEY-PHRASE}           AND reftable.reftable EQ "score-type"           AND reftable.company  EQ ip-company           AND reftable.loc      EQ ""         NO-LOCK         ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-BROWSE-1 OPEN QUERY {&SELF-NAME}     FOR EACH reftable         WHERE ~{&KEY-PHRASE}           AND reftable.reftable EQ "score-type"           AND reftable.company  EQ ip-company           AND reftable.loc      EQ ""         NO-LOCK         ~{&SORTBY-PHRASE}.
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Score Types */
DO:
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  RUN enable_UI.
/*
  &scoped-define key-phrase carr-mtx.company EQ ip-company AND arr-mtx.loc EQ ip-loc AND carr-mtx.carrier EQ ip-carrier
