...
/* Query rebuild information for BROWSE BROWSE-1
     ...
     _TblOptList       = ", FIRST"
     _Where[1]         = "oe-bolh.company = ip-company and not oe-bolh.posted"
     _FldNameList[1]   > ASI.oe-bolh.bol-no
"bol-no" "BOL#" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE BROWSE-1 */
&ANALYZE-RESUME
