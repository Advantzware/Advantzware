...
&scoped-define SORTBY-1 BY shipto.cust-no BY shipto.ship-id 
&scoped-define SORTBY-2 BY shipto.ship-id {&sortby-1}
&scoped-define SORTBY-3 BY shipto.ship-name {&sortby-1}
&scoped-define fld-name-1 shipto.cust-no
&scoped-define fld-name-2 shipto.ship-id
&scoped-define fld-name-3 shipto.ship-name
&scoped-define IDXNAME-1 ship-id
&scoped-define IDXNAME-2 ship-id
&scoped-define IDXNAME-3 ship-name
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-1 shipto.cust-no shipto.ship-id ~
shipto.ship-name shipto.ship-addr[1] shipto.ship-city shipto.ship-state ~
shipto.ship-zip shipto.carrier shipto.loc 
...
(shipto.cust-no eq lv-cust-x and lv-cust-x ne "")) NO-LOCK ~
    ~{&SORTBY-PHRASE}
...
DEFINE FRAME Dialog-Frame
     ...
     bt-ok AT ROW 14.1 COL 92
     bt-cancel AT ROW 14.1 COL 104
     RECT-1 AT ROW 12.43 COL 1
     "Sort By:" VIEW-AS TEXT
          SIZE 8 BY .62 AT ROW 12.91 COL 4
     SPACE(103.00) SKIP(1.84)
...
(shipto.cust-no eq lv-cust-x and lv-cust-x ne """"))"
     ...
     _FldNameList[4]   = ASI.shipto.ship-addr[1]
     _FldNameList[5]   = ASI.shipto.ship-city
     _FldNameList[6]   = ASI.shipto.ship-state
     _FldNameList[7]   = ASI.shipto.ship-zip
     _FldNameList[8]   = ASI.shipto.carrier
     _FldNameList[9]   = ASI.shipto.loc
     _Query            is OPENED
*/  /* BROWSE BROWSE-1 */
&ANALYZE-RESUME
