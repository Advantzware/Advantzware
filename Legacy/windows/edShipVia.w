...
&SCOPED-DEFINE h_Browse01 h_edShipVia
...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES edShipVia
&Scoped-define FIRST-EXTERNAL-TABLE edShipVia


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR edShipVia.
...
DEFINE VARIABLE h_edshipvia AS HANDLE NO-UNDO.
DEFINE VARIABLE h_edshipvia-2 AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Ship Via to SCAC Code Xref"
         HEIGHT             = 24.05
         WIDTH              = 150
         MAX-HEIGHT         = 320
         MAX-WIDTH          = 320
...
ON END-ERROR OF W-Win /* Ship Via to SCAC Code Xref */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Ship Via to SCAC Code Xref */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Browse SCAC|View SCAC' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'browsers/edshipvia.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_edshipvia ).
       RUN set-position IN h_edshipvia ( 5.10 , 3.40 ) NO-ERROR.
       RUN set-size IN h_edshipvia ( 19.52 , 145.00 ) NO-ERROR.

       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('2':U) NO-ERROR.

       /* Links to SmartNavBrowser h_edshipvia. */
       RUN add-link IN adm-broker-hdl ( h_p-navico , 'Navigation':U , h_edshipvia ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_edshipvia ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'viewers/edshipvia.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
       ...
       /* Links to SmartViewer h_edshipvia-2. */
       ...
       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_edshipvia-2 ,
             h_folder , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-navico ,
             h_edshipvia-2 , 'AFTER':U ).
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "edShipVia"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "edShipVia"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "edShipVia"}
