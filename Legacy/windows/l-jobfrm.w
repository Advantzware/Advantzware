...
&Scoped-define FIELDS-IN-QUERY-BROWSE-1 job-mch.frm job-mch.blank-no ~
get-item (output lv-i-name) @ lv-i-no lv-i-name 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-1 
&Scoped-define QUERY-STRING-BROWSE-1 FOR EACH job-mch WHERE ~{&KEY-PHRASE} ~
      AND job-mch.company = ip-company ~
 AND job-mch.job = ip-job ~
 AND job-mch.job-no = ip-job-no ~
 AND job-mch.job-no2 = ip-job-no2 NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-BROWSE-1 OPEN QUERY BROWSE-1 FOR EACH job-mch WHERE ~{&KEY-PHRASE} ~
      AND job-mch.company = ip-company ~
 AND job-mch.job = ip-job ~
 AND job-mch.job-no = ip-job-no ~
 AND job-mch.job-no2 = ip-job-no2 NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-BROWSE-1 job-mch
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-1 job-mch
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-1 Dialog-Frame _STRUCTURED
  QUERY BROWSE-1 NO-LOCK DISPLAY
      job-mch.frm COLUMN-LABEL "Form#" FORMAT ">>9":U
      job-mch.blank-no COLUMN-LABEL "Blank#" FORMAT ">>9":U
      get-item (output lv-i-name) @ lv-i-no COLUMN-LABEL "FG Item#" FORMAT "x(15)":U
            WIDTH 20
      lv-i-name COLUMN-LABEL "Name" FORMAT "x(30)":U WIDTH 35
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE BROWSE-1
     _TblList          = "ASI.job-mch"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = ","
     _Where[1]         = "ASI.job-mch.company = ip-company
 AND ASI.job-mch.job = ip-job
 AND ASI.job-mch.job-no = ip-job-no
 AND ASI.job-mch.job-no2 = ip-job-no2"
...
"get-item (output lv-i-name) @ lv-i-no" "FG Item#" "x(15)" ? ? ? ? ? ? ? no ? no no "20" yes no no "U" "" ""
     _FldNameList[4]   > "_<CALC>"
"lv-i-name" "Name" "x(30)" ? ? ? ? ? ? ? no ? no no "35" yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE BROWSE-1 */
&ANALYZE-RESUME
