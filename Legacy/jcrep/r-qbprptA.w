...
rd_sheet-size lines-per-page rd-dest lv-ornt lv-font-no td-show-parm ~
...
end_date lbl-sheet rd_sheet-size lines-per-page rd-dest lv-ornt lv-font-no ~
...
DEFINE FRAME FRAME-A
     ...
     lines-per-page AT ROW 10.05 COL 77 COLON-ALIGNED
     rd-dest AT ROW 10.29 COL 5 NO-LABEL
     ...
     td-show-parm AT ROW 14.91 COL 5
     tb_excel AT ROW 15.1 COL 66.4 RIGHT-ALIGNED
     tb_runExcel AT ROW 15.1 COL 87.8 RIGHT-ALIGNED
     fi_file AT ROW 16.05 COL 44 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 17.91 COL 24
     btn-cancel AT ROW 17.91 COL 56
...
------------------------------------------------------------------------------*/
  DISPLAY lbl_jstat rd_jstat tb_fold lbl_industry tb_corr begin_job-no 
          ...
          rd_sheet-size lines-per-page rd-dest lv-ornt lv-font-no lv-font-name 
          td-show-parm tb_excel tb_runExcel fi_file 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE RECT-6 RECT-7 rd_jstat tb_fold tb_corr begin_job-no begin_job-no2 
         end_job-no end_job-no2 begin_date end_date rd_sheet-size 
