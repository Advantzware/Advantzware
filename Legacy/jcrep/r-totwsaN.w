...
end_date rd-dest lv-ornt lines-per-page lv-font-no td-show-parm ~
...
DEFINE FRAME FRAME-A
     ...
     tb_excel AT ROW 20.05 COL 70.2 RIGHT-ALIGNED
     tb_runExcel AT ROW 20.05 COL 94 RIGHT-ALIGNED
     fi_file AT ROW 21.14 COL 48 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 22.91 COL 22
     btn-cancel AT ROW 22.91 COL 60
     "Available Columns" VIEW-AS TEXT
          SIZE 29 BY .62 AT ROW 7.1 COL 3.8 WIDGET-ID 38
     ...
     "Selected Columns(In Display Order)" VIEW-AS TEXT
          SIZE 34 BY .62 AT ROW 7.1 COL 61.8 WIDGET-ID 44
...
------------------------------------------------------------------------------*/
  DISPLAY begin_cust end_cust begin_date end_date rd-dest lv-ornt 
          lines-per-page lv-font-no lv-font-name td-show-parm tb_excel 
          tb_runExcel fi_file sl_avail sl_selected
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE RECT-6 RECT-7 begin_cust end_cust begin_date end_date  
