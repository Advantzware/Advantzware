...
DEFINE FRAME FRAME-A
     as-of-date AT ROW 4.57 COL 42 COLON-ALIGNED
     begin_job-no AT ROW 7.67 COL 23 COLON-ALIGNED HELP
          "Enter Beginning Job Number"
     begin_job-no2 AT ROW 7.67 COL 36 COLON-ALIGNED HELP
          "Enter Beginning Job Number"
     end_job-no AT ROW 7.67 COL 66 COLON-ALIGNED HELP
          "Enter Ending Job Number"
     end_job-no2 AT ROW 7.67 COL 78 COLON-ALIGNED HELP
          "Enter Ending Job Number"
     ...
     td-show-parm AT ROW 16.57 COL 30
     tb_excel AT ROW 17.67 COL 49.8 RIGHT-ALIGNED
     tb_runExcel AT ROW 17.67 COL 70.8 RIGHT-ALIGNED
     fi_file AT ROW 18.48 COL 27.8 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 20.62 COL 18
     btn-cancel AT ROW 20.62 COL 56
...
ON END-ERROR OF C-Win /* W.I.P. Daily Summary */
...
ON LEAVE OF as-of-date IN FRAME FRAME-A /* Daily Summary For Which Day? */
DO:
  assign {&self-name}.
END.
...
display "" with frame r-top.
  ...
  for each mch-act where mch-act.company = cocode and
      ...
      do:
         create work-dly.
         assign work-dly.job-no = mch-act.job-no
                work-dly.job    = mch-act.job
  ...
  for each mat-act where mat-act.company = cocode and
      ...
      do:
         create work-dly.
         assign work-dly.job-no = mat-act.job-no
                work-dly.job    = mat-act.job
   ...
   for each fg-act where fg-act.company = cocode and
      ...
      do:
         create work-dly.
         assign work-dly.job-no = fg-act.job-no
                work-dly.job    = fg-act.job
                work-dly.job-no2 = fg-act.job-no2.
      end.
   end.
   ...
   for each misc-act where misc-act.company = cocode and
      ...
      do:
         create work-dly.
         assign work-dly.job-no = misc-act.job-no
                work-dly.job    = misc-act.job
                work-dly.job-no2 = misc-act.job-no2.
      end.
   end.
          for each work-dly break by work-dly.job-no
                               by work-dly.job-no2:
         ...
         for each mat-act where mat-act.company = cocode and
                                mat-act.job = work-dly.job
                                use-index job
                                no-lock:
            if mat-act.mat-date <> v-date then next.
         ...
         for each mch-act where mch-act.company = cocode and
                                mch-act.job = work-dly.job
                                use-index job
                                no-lock:
            if mch-act.op-date <> v-date then next.
         ...
         for each misc-act where misc-act.company = cocode and
                                misc-act.job = work-dly.job
                                use-index misc-idx
                                no-lock:
            if misc-act.misc-date <> v-date then next.
