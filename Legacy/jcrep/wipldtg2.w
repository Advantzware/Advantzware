...
&Scoped-Define ENABLED-OBJECTS reprintTag fi_rmtagno tg_wip-reported ~
begin_job begin_job2 begin_job_form end_job_form begin_job_blank ~
end_job_blank begin_rm-i-no end_rm-i-no fi_total-wip-tags tb_16ths btn-ok ~
btn-cancel RECT-7 RECT-8 
&Scoped-Define DISPLAYED-OBJECTS reprintTag fi_rmtagno tg_wip-reported ~
fi_tag-date fi_tag-hr fi_tag-min begin_mach fi_wip-whs fi_wip-bin begin_job ~
begin_job2 begin_job_form end_job_form begin_job_blank end_job_blank ~
begin_rm-i-no end_rm-i-no fi_total-wip-tags tb_16ths fi_tag-ampm 

/* Custom List Definitions                                              */
/* paramFields,triad,List-3,List-4,List-5,F1                            */
&Scoped-define paramFields fi_rmtagno begin_job begin_job2 begin_job_form ~
end_job_form begin_job_blank end_job_blank begin_rm-i-no end_rm-i-no ~
tb_16ths 
...
DEFINE FRAME FRAME-A
     ...
     fi_oh-lf AT ROW 2.91 COL 80 COLON-ALIGNED HELP
          "Enter Lineal Feet" WIDGET-ID 12
     tg_wip-reported AT ROW 5.05 COL 24 WIDGET-ID 22
     fi_tag-date AT ROW 6 COL 32 COLON-ALIGNED WIDGET-ID 24
     fi_tag-hr AT ROW 6 COL 61 COLON-ALIGNED HELP
          "Enter Starting Hour" WIDGET-ID 44
     fi_tag-min AT ROW 6 COL 67 COLON-ALIGNED HELP
          "Enter Starting Minute" WIDGET-ID 46
     begin_mach AT ROW 7 COL 35.8 COLON-ALIGNED WIDGET-ID 30
     fi_wip-whs AT ROW 8.14 COL 32 COLON-ALIGNED WIDGET-ID 32
     fi_wip-bin AT ROW 8.14 COL 60.8 COLON-ALIGNED WIDGET-ID 34
     begin_job AT ROW 10.33 COL 21.8 COLON-ALIGNED HELP
          "Enter Job Number"
     begin_job2 AT ROW 10.29 COL 36.8 COLON-ALIGNED HELP
          "Enter Job Number"
     begin_job_form AT ROW 11.33 COL 21.8 COLON-ALIGNED HELP
          "Enter From Form#" WIDGET-ID 4
     end_job_form AT ROW 11.33 COL 65 COLON-ALIGNED HELP
          "Enter To Form#" WIDGET-ID 6
     begin_job_blank AT ROW 12.33 COL 21.8 COLON-ALIGNED HELP
          "Enter From Blank#" WIDGET-ID 8
     end_job_blank AT ROW 12.33 COL 65 COLON-ALIGNED HELP
          "Enter To Blank#" WIDGET-ID 10
     begin_rm-i-no AT ROW 13.33 COL 21.8 COLON-ALIGNED HELP
          "Enter From Board RM Item#"
     end_rm-i-no AT ROW 13.33 COL 65 COLON-ALIGNED HELP
          "Enter To Board RM Item#"
     fi_pallet_height AT ROW 14.38 COL 21.8 COLON-ALIGNED HELP
          "Enter Pallet Height" WIDGET-ID 14
     fi_exp-sheets-roll AT ROW 14.38 COL 65 COLON-ALIGNED HELP
          "Enter Expected Sheets/Roll" WIDGET-ID 20
     fi_sheets-pallet AT ROW 15.52 COL 21.8 COLON-ALIGNED HELP
          "Enter Sheets/Pallet" WIDGET-ID 16
     fi_total-wip-tags AT ROW 16.52 COL 22 COLON-ALIGNED HELP
          "Enter Total WIP Tags" WIDGET-ID 18
     tb_16ths AT ROW 16.19 COL 67
     btn-ok AT ROW 18 COL 23.8
     btn-cancel AT ROW 18 COL 67
     fi_tag-ampm AT ROW 5.95 COL 72 COLON-ALIGNED NO-LABEL WIDGET-ID 50
     "Selection Parameters" VIEW-AS TEXT
          SIZE 21 BY .71 AT ROW 1.24 COL 2
          BGCOLOR 8 
     RECT-7 AT ROW 1 COL 1
     RECT-8 AT ROW 4.67 COL 23.2 WIDGET-ID 26
...
/* SETTINGS FOR FILL-IN fi_exp-sheets-roll IN FRAME FRAME-A
   NO-DISPLAY NO-ENABLE                                                 */
ASSIGN 
       fi_exp-sheets-roll:HIDDEN IN FRAME FRAME-A           = TRUE.

/* SETTINGS FOR FILL-IN fi_oh-lf IN FRAME FRAME-A
   NO-DISPLAY NO-ENABLE                                                 */
ASSIGN 
       fi_oh-lf:HIDDEN IN FRAME FRAME-A           = TRUE.

/* SETTINGS FOR FILL-IN fi_pallet_height IN FRAME FRAME-A
   NO-DISPLAY NO-ENABLE                                                 */
ASSIGN 
       fi_pallet_height:HIDDEN IN FRAME FRAME-A           = TRUE.

/* SETTINGS FOR FILL-IN fi_rmtagno IN FRAME FRAME-A
   1                                                                    */
/* SETTINGS FOR FILL-IN fi_sheets-pallet IN FRAME FRAME-A
   NO-DISPLAY NO-ENABLE                                                 */
ASSIGN 
       fi_sheets-pallet:HIDDEN IN FRAME FRAME-A           = TRUE.
...
DO:
   begin_job:SCREEN-VALUE = FILL(" ",6 - LENGTH(TRIM(begin_job:SCREEN-VALUE))) + begin_job:SCREEN-VALUE.
...
ON LEAVE OF fi_oh-lf IN FRAME FRAME-A /* Lineal Feet */
DO:
      ...
      DO:
         ...
         DO:
            IF job-mat.len NE 0 THEN
               v-exp-sheets = INT(fi_oh-lf:SCREEN-VALUE) * 12 / job-mat.len.
...
ON HELP OF fi_rmtagno IN FRAME FRAME-A /* RM Tag# */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_rmtagno C-Win
ON LEAVE OF fi_rmtagno IN FRAME FRAME-A /* RM Tag# */
DO:
  ...
  IF SELF:SCREEN-VALUE EQ "" THEN
     ASSIGN
          fi_oh-lf:HIDDEN = YES
          fi_pallet_height:HIDDEN = YES
          fi_exp-sheets-roll:HIDDEN = YES
          fi_sheets-pallet:HIDDEN = YES
          fi_oh-lf:SENSITIVE = NO
          fi_pallet_height:SENSITIVE = NO
          fi_exp-sheets-roll:SENSITIVE = NO
          fi_sheets-pallet:SENSITIVE = NO.
  ELSE
...
/* security check need {methods/prgsecur.i} in definition section */
  ...
  DO WITH FRAME {&FRAME-NAME}:
    ...
    APPLY "entry" TO fi_rmtagno.

    IF ip-tag-no NE "" THEN
    DO:
       fi_rmtagno:SCREEN-VALUE = ip-tag-no.
       APPLY "LEAVE":U TO fi_rmtagno.
    END.
  END.

    {methods/setButton.i btn-cancel "Cancel"} /* added by script _nonAdm1Images.p on 03.28.2017 @ 10:43:41 am */
    {methods/setButton.i btn-ok "OK"} /* added by script _nonAdm1Images.p on 03.28.2017 @ 10:43:41 am */
...
------------------------------------------------------------------------------*/
  ...
  IF w-job.total-tags GT iop-total-wip-tags THEN
     w-job.total-tags = iop-total-wip-tags.
...
------------------------------------------------------------------------------*/
  DISPLAY reprintTag fi_rmtagno tg_wip-reported fi_tag-date fi_tag-hr fi_tag-min 
          begin_mach fi_wip-whs fi_wip-bin begin_job begin_job2 begin_job_form 
          end_job_form begin_job_blank end_job_blank begin_rm-i-no end_rm-i-no 
          fi_total-wip-tags tb_16ths fi_tag-ampm 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE reprintTag fi_rmtagno tg_wip-reported begin_job begin_job2 
         begin_job_form end_job_form begin_job_blank end_job_blank 
         begin_rm-i-no end_rm-i-no fi_total-wip-tags tb_16ths btn-ok btn-cancel 
         RECT-7 RECT-8 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ...
  DO:
     DO v-form-index = begin_job_form TO end_job_form:
        ...
        IF NOT CAN-FIND(FIRST job-mat WHERE
           ...
           job-mat.rm-i-no = loadtag.i-no AND
     ...
     FOR EACH job-mat WHERE
         ...
         job-mat.blank-no LE end_job_blank
         NO-LOCK,
         FIRST ITEM FIELDS(i-no i-name cons-uom loc loc-bin) WHERE
               ITEM.company EQ cocode AND
...
------------------------------------------------------------------------------*/
    ...
    DEF VAR v-exp-sheets AS INT NO-UNDO.
    DEF VAR v-mat-length AS DECIMAL DECIMALS 2 NO-UNDO.
...
------------------------------------------------------------------------------*/
    ...
    DO WITH FRAME {&FRAME-NAME}:
       ...
       IF CAN-FIND(FIRST wiptag WHERE
          ...
          MESSAGE "This RM Loadtag has already been used on a WIP Tag." VIEW-AS ALERT-BOX ERROR.
          APPLY 'ENTRY':U TO fi_rmtagno.
          op-error = YES.
          RETURN.
       END.
       ...
       DO:
          ASSIGN
             ...
             begin_rm-i-no:SCREEN-VALUE = loadtag.i-no
             end_rm-i-no:SCREEN-VALUE = loadtag.i-no
             fi_oh-lf:HIDDEN = NO
          ...
          IF AVAIL rm-bin THEN
             fi_oh-lf:SCREEN-VALUE = STRING(rm-bin.qty).
          ELSE
             fi_oh-lf:SCREEN-VALUE = "0".

          APPLY "LEAVE" TO fi_oh-lf IN FRAME {&FRAME-NAME}.

          IF loadtag.job-no NE "" THEN
          DO:
             FIND FIRST job WHERE
                  job.company EQ cocode AND
                  job.job-no EQ loadtag.job-no AND
