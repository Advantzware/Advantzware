...
&Scoped-Define ENABLED-OBJECTS as-of-date begin_cust end_cust rd-dest ~
lines-per-page td-show-parm btn-ok btn-cancel RECT-6 RECT-7 
&Scoped-Define DISPLAYED-OBJECTS as-of-date begin_cust end_cust rd-dest ~
...
DEFINE VARIABLE end_cust AS CHARACTER FORMAT "X(256)":U INITIAL "zzzzzzzzzzzzz" 
     LABEL "Fill 1" 
     VIEW-AS FILL-IN 
     SIZE 14 BY 1 NO-UNDO.
...
DEFINE FRAME FRAME-A
     ...
     begin_cust AT ROW 6.71 COL 24 COLON-ALIGNED
     end_cust AT ROW 6.71 COL 55 COLON-ALIGNED
...
ON LEAVE OF begin_cust IN FRAME FRAME-A /* Fill 1 */
DO:
  assign {&self-name}.
END.
...
ON LEAVE OF end_cust IN FRAME FRAME-A /* Fill 1 */
DO:
  assign {&self-name}.
END.
...
------------------------------------------------------------------------------*/
  DISPLAY as-of-date begin_cust end_cust rd-dest lines-per-page td-show-parm 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE as-of-date begin_cust end_cust rd-dest lines-per-page td-show-parm 
...
FOR EACH cust
    ...
    USE-INDEX city NO-LOCK,

    EACH oe-ord OF cust
    WHERE oe-ord.ord-date LE as-of-date
    NO-LOCK:
    
  DISPLAY cust.cust-no space(10) ord-no cust.zip cust.city.
END.
