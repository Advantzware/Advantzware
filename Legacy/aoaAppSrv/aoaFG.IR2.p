...
message "afer run" view-as alert-box.  
FOR EACH ttInventoryValue:
    DISPLAY
        ttInventoryValue.custNo
        ttInventoryValue.custName
        ttInventoryValue.iNo
        ttInventoryValue.iName
...
message "in pinventory" view-as alert-box.
    /* local variables */
/* Test values */
   lAllCustNo = TRUE.
   lAllLoc = TRUE.
