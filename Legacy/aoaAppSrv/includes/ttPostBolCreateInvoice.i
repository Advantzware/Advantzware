/*------------------------------------------------------------------------
    ...
    Syntax      : {aoaAppSrv/includes/ttPostBolCreateInvoice.i}
...
{aoaAppSrv/ttFields.i}
    ...
    FIELD custNo    AS CHARACTER LABEL "Customer"  FORMAT "x(5)" 
    ...
    FIELD poNo      AS CHARACTER LABEL "PO No"     FORMAT "x(1)"                                                          
    ...
    FIELD bolStatus AS CHARACTER LABEL "Status"    FORMAT "x(8)"
    FIELD reason    AS CHARACTER LABEL "Reason"    FORMAT "x(30)"
    .
/* Post BOL Create Invoice.rpa */
