...
/* ***************************  Definitions  ***************************/
{aoaAppSrv/ttPostBolCreateInvoice.i}
...
ASSIGN
    ...
    iStartBOL      = 8415
    iEndBOL        = 8417
    cStartCustNo   = "TacoBell"
    cEndCustNo     = "TacoBell"
    dtStartBOLDate = 1/1/2015   
    dtEndBOLDate   = 12/31/2016
    dtPostDate     = 2/1/2016
    cTransactionTime      = "" 
    .
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pCreateNoPostRec C-Win 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pCreateReorder C-Win 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pExceptionRpt C-Win 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pPostBols C-Win 
PROCEDURE pPostBols :
    /*------------------------------------------------------------------------------
      Purpose:     
      Parameters:  <none>
      ...
      BY w-bolh.b-ord-no:
        ...
        FOR EACH oe-boll NO-LOCK
            ...
            DO:
                ...
                IF NOT CAN-FIND(FIRST b-oe-boll NO-LOCK 
