...
DEF OUTPUT PARAM op-dest AS INT NO-UNDO.
DEF OUTPUT PARAM op-ornt AS cha NO-UNDO.
DEF OUTPUT PARAM op-lines-per-page AS INT NO-UNDO.
DEF OUTPUT PARAM op-font AS INT NO-UNDO.
DEF OUTPUT PARAM op-show-parm AS LOG NO-UNDO.
...
lv-font-no td-show-parm Btn_OK Btn_Cancel 
...
DEFINE FRAME D-Dialog
     rd-dest AT ROW 1.95 COL 3 NO-LABEL
     lv-ornt AT ROW 2.19 COL 30 NO-LABEL
     lines-per-page AT ROW 2.19 COL 82 COLON-ALIGNED
     lv-font-no AT ROW 5.62 COL 32 COLON-ALIGNED
     lv-font-name AT ROW 6.57 COL 26 COLON-ALIGNED NO-LABEL
     td-show-parm AT ROW 9.81 COL 3
     Btn_OK AT ROW 11.48 COL 20
     Btn_Cancel AT ROW 11.48 COL 61
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 1 COL 2
     RECT-6 AT ROW 1.71 COL 1
     RECT-7 AT ROW 1 COL 1
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Output Destination Selection"
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Output Destination Selection */
DO:  
...
DO:
    ...
    ASSIGN op-dest = rd-dest
           op-ornt = lv-ornt
           op-lines-per-page = lines-per-page
           op-font = int(lv-font-no)
           op-show-parm = td-show-parm.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL td-show-parm D-Dialog
ON VALUE-CHANGED OF td-show-parm IN FRAME D-Dialog /* Show Parameters? */
DO:
    assign {&self-name}.
END.
