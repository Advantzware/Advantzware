...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD display-eb B-table-Win 
FUNCTION display-eb RETURNS CHARACTER
  (  )  FORWARD.
...
DEFINE FRAME F-Main
     lv-start-date AT ROW 1.24 COL 33 COLON-ALIGNED
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION display-eb B-table-Win 
FUNCTION display-eb RETURNS CHARACTER
  (  ) :
/*------------------------------------------------------------------------------
  Purpose:  
