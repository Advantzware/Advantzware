...
&Scoped-Define ENABLED-OBJECTS Btn-Save Btn-Cancel btn-sch btn-sort ~
btn-lock btn-release btn-print 

/* Custom List Definitions                                              */
/* Box-Rectangle,List-2,List-3,List-4,List-5,List-6                     */
&Scoped-define Box-Rectangle RECT-1 
&Scoped-define List-4 btn-sch btn-sort btn-lock btn-release btn-print 
...
DEFINE BUTTON btn-sch 
     LABEL "&Scheduling" 
     SIZE 16 BY 1.14.

DEFINE BUTTON btn-sort 
     LABEL "&Re-Sequence" 
     SIZE 18 BY 1.14.
...
DEFINE FRAME Panel-Frame
     ...
     btn-sch AT ROW 1.24 COL 22
     btn-sort AT ROW 1.24 COL 38
     btn-lock AT ROW 1.24 COL 56
     btn-release AT ROW 1.24 COL 72
     btn-print AT ROW 1.24 COL 89
...
/* SETTINGS FOR BUTTON btn-lock IN FRAME Panel-Frame
   4                                                                    */
/* SETTINGS FOR BUTTON btn-print IN FRAME Panel-Frame
   4                                                                    */
/* SETTINGS FOR BUTTON btn-release IN FRAME Panel-Frame
   4                                                                    */
/* SETTINGS FOR BUTTON btn-sch IN FRAME Panel-Frame
   4                                                                    */
/* SETTINGS FOR BUTTON btn-sort IN FRAME Panel-Frame
   4                                                                    */
...
DO:
  DO WITH FRAME Panel-Frame:
      ...
      {methods/setButton.i Btn-Save "Update"} /* added by script _admTransPanels.p on 04.07.2017 @  2:08:58 pm */
      ENABLE {&list-4}.
   END.
  {Advantzware/WinKit/winkit-panel-triggerend.i} /* added by script _admPanels.p on 04.07.2017 @  2:08:46 pm */
END.
...
&Scoped-define SELF-NAME btn-lock
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn-lock C-WIn
ON CHOOSE OF btn-lock IN FRAME Panel-Frame /* Lock All */
DO:
...
ON CHOOSE OF btn-print IN FRAME Panel-Frame /* Print */
DO:
  DEF VAR char-hdl AS cha NO-UNDO.
...
ON CHOOSE OF btn-release IN FRAME Panel-Frame /* Unlock All */
DO:
  DEF VAR char-hdl AS cha NO-UNDO.
  ...
  DO:
     ...
     DO WITH FRAME Panel-Frame:
        ...
        DO:
           ...
           {methods/setButton.i Btn-Save "Save"} /* added by script _admTransPanels.p on 04.07.2017 @  2:08:58 pm */
...
&Scoped-define SELF-NAME btn-sch
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn-sch C-WIn
ON CHOOSE OF btn-sch IN FRAME Panel-Frame /* Scheduling */
DO:
    DEF VAR char-hdl AS cha NO-UNDO.
...
&Scoped-define SELF-NAME btn-sort
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn-sort C-WIn
ON CHOOSE OF btn-sort IN FRAME Panel-Frame /* Re-Sequence */
DO:
  DEF VAR char-hdl AS cha NO-UNDO.
...
/* ***************************  Main Block  *************************** */
  ...
  {methods/setButton.i Btn-Save "Update"} /* added by script _admTransPanels.p on 04.07.2017 @  2:08:58 pm */
  {methods/setButton.i Btn-Cancel "Cancel"} /* added by script _admTransPanels.p on 04.07.2017 @  2:08:58 pm */
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&frame-name}:
    op-ok = Btn-Save:LABEL EQ '&Update'.
  END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE end-update C-WIn 
PROCEDURE end-update :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
&ENDIF
  ...
  DO WITH FRAME {&FRAME-NAME}:
    IF NOT v-can-update THEN
      ASSIGN   btn-save:SENSITIVE = NO
                btn-sch:SENSITIVE = NO
               btn-sort:SENSITIVE = NO
               btn-lock:SENSITIVE = NO
