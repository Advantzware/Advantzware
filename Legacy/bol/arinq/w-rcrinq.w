...
DEFINE VARIABLE h_b-rcrinq AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Customer Cash Receipts Inquiry"
         HEIGHT             = 23.95
         WIDTH              = 151.2
         MAX-HEIGHT         = 24
         MAX-WIDTH          = 151.2
...
ON END-ERROR OF W-Win /* Customer Cash Receipts Inquiry */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Customer Cash Receipts Inquiry */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Browse Cash|View Cash' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 2 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-cash ).
       RUN set-position IN h_v-cash ( 4.57 , 4.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-cashl ).
       RUN set-position IN h_b-cashl ( 10.76 , 4.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-nav2 ).
       RUN set-position IN h_v-nav2 ( 21.95 , 25.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-disabl ).
       RUN set-position IN h_p-disabl ( 21.95 , 98.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_b-rcrinq , 'Record':U , h_v-cash ).
