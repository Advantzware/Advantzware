...
RMDIR /s /q PLBUILD\DataDigger >NUL
MKDIR PLBuild\Graphics
MKDIR PLBuild\adm
MKDIR PLBuild\adm2
MKDIR PLBuild\DataDigger
MKDIR PLBuild\DataDigger\image
...
XCOPY c:\asigui\environments\Devel\Programs\DataDigger\image\*.* .\PLBuild\DataDigger\Image\ /q /s >NUL
...
%DLCBIN%/prolib asiDataDigger.pl -add DataDigger/*.r >NUL
%DLCBIN%/prolib asiDataDigger.pl -add DataDigger/Image/*.* >NUL
