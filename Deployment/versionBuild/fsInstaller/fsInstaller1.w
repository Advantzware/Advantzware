...
DEF VAR cBaseFromLocn           AS CHAR NO-UNDO FORMAT "x(55)"  LABEL "Source Location for Uncompiled Base".
DEF VAR cBaseList               AS CHAR NO-UNDO.
DEF VAR cBaseSrcLocn            AS CHAR NO-UNDO FORMAT "x(55)"  LABEL "Source Location for Base Directories".
DEF VAR cBaseTgtLocn            AS CHAR NO-UNDO FORMAT "x(55)"  LABEL "Target Location for Base Directories".
DEF VAR cBaseToLocn             AS CHAR NO-UNDO FORMAT "x(55)"  LABEL "Target Location for Compiled Base".
...
DEF VAR cFullName               AS CHAR NO-UNDO FORMAT "x(60)".
...
DEF VAR cMyVar                  AS CHAR NO-UNDO FORMAT "x(60)".
...
&Scoped-Define ENABLED-OBJECTS fCopyCustTo tCreateStartup tCreateDB ~
tUpdateDB tLoadData tCreateObject tCreateCustom tCreateCustObj tCompileBase ~
tCompilePatch tCompileCustom tCompileSelected tRunFix tConnectMulti ~
tClearLog tStopOnError tLogErrors bRunDBAdmin bClear bModPropath ~
bSaveConfig cbSuggest fLogDir tHelp bProcess bQuit tCreateBase tCopyDfFiles ~
tCopyBaseFiles tCopyCustFiles fEnvTempLocn fEnvTargetLocn 
&Scoped-Define DISPLAYED-OBJECTS fCopyCustTo tCreateStartup fiAsOfDate ~
tConfigName tCreateDB tUpdateDB tLoadData tCreateObject tCreateCustom ~
tCreateCustObj tCompileBase tCompilePatch tCompileCustom tCompileSelected ~
tRunFix tConnectMulti tClearLog tStopOnError tLogErrors cbSuggest fLogDir ~
fDBLocn fDBName fDBConnParms fDFLocn fDeltaLocn fDataFilesLocn ~
fBaseCodeLocn fPatchCodeLocn fCopyBaseTo fCustCodeLocn fObjCodeLocn ~
fCustObjLocn tHelp fProgressLocn tCreateBase tCopyDfFiles tCopyBaseFiles ~
tCopyCustFiles fEnvTempLocn fEnvTargetLocn 
...
DEFINE VARIABLE cbSuggest AS CHARACTER FORMAT "X(256)":U INITIAL "Patch Application" 
     ...
     LIST-ITEMS "Apply a patch","Install a new system","Update the database","Compile code","Load data","Export data","Backup the database" 
     DROP-DOWN-LIST
     SIZE 28 BY 1
     FGCOLOR 9  NO-UNDO.
...
DEFINE VARIABLE fiAsOfDate AS CHARACTER FORMAT "X(256)":U INITIAL "Installer Version: 106101" 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE tCreateCustObj AS LOGICAL INITIAL no 
     LABEL "Create Custom Object Structure?" 
     VIEW-AS TOGGLE-BOX
     SIZE 37 BY 1 NO-UNDO.

DEFINE VARIABLE tCreateCustom AS LOGICAL INITIAL no 
     LABEL "Create Patch Object Structure?" 
     VIEW-AS TOGGLE-BOX
...
DEFINE VARIABLE tCreateObject AS LOGICAL INITIAL no 
     LABEL "Create Base Object Structure?" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME fMain
     fCopyCustTo AT ROW 19.75 COL 4 COLON-ALIGNED NO-LABEL
     tCreateStartup AT ROW 18.75 COL 4
     fiAsOfDate AT ROW 23.92 COL 133 NO-LABEL NO-TAB-STOP 
     tConfigName AT ROW 20.25 COL 125 COLON-ALIGNED NO-LABEL
     tCreateDB AT ROW 5.5 COL 4
     tUpdateDB AT ROW 8.63 COL 4
     tLoadData AT ROW 9.71 COL 4
     tCreateObject AT ROW 13.38 COL 122
     tCreateCustom AT ROW 16 COL 122
     tCreateCustObj AT ROW 18.63 COL 122
     tCompileBase AT ROW 12.33 COL 4
     tCompilePatch AT ROW 14.96 COL 4
     tCompileCustom AT ROW 17.58 COL 4
     tCompileSelected AT ROW 20.21 COL 56
     tRunFix AT ROW 6.54 COL 4
     tConnectMulti AT ROW 6.54 COL 133
     tClearLog AT ROW 23.92 COL 89
     tStopOnError AT ROW 25.21 COL 89
     tLogErrors AT ROW 26.54 COL 89
     bRunDBAdmin AT ROW 25.21 COL 115
     bClear AT ROW 25.21 COL 131
     bModPropath AT ROW 26.54 COL 115
     bSaveConfig AT ROW 26.54 COL 131
     cbSuggest AT ROW 1.25 COL 5.43
     fLogDir AT ROW 22.25 COL 59 COLON-ALIGNED
     fDBLocn AT ROW 5.5 COL 54 COLON-ALIGNED
     fDBName AT ROW 5.5 COL 131 COLON-ALIGNED
     fDBConnParms AT ROW 6.54 COL 54 COLON-ALIGNED
     fDFLocn AT ROW 7.58 COL 54 COLON-ALIGNED
     fDeltaLocn AT ROW 8.63 COL 54 COLON-ALIGNED
     fDataFilesLocn AT ROW 9.71 COL 54 COLON-ALIGNED
     fBaseCodeLocn AT ROW 12.33 COL 54 COLON-ALIGNED
     fPatchCodeLocn AT ROW 14.96 COL 54 COLON-ALIGNED
     fCopyBaseTo AT ROW 16 COL 54 COLON-ALIGNED
     fCustCodeLocn AT ROW 17.58 COL 54 COLON-ALIGNED
     fObjCodeLocn AT ROW 13.38 COL 54 COLON-ALIGNED
     fCustObjLocn AT ROW 18.63 COL 54 COLON-ALIGNED
     tHelp AT ROW 1.25 COL 58 NO-LABEL NO-TAB-STOP 
     fProgressLocn AT ROW 26.75 COL 19 COLON-ALIGNED
     bProcess AT ROW 25.21 COL 148
     bQuit AT ROW 26.54 COL 148
     tCreateBase AT ROW 18.75 COL 25
     tCopyDfFiles AT ROW 20 COL 25
     tCopyBaseFiles AT ROW 21.5 COL 25
     tCopyCustFiles AT ROW 21 COL 4
     fEnvTempLocn AT ROW 22.25 COL 4 COLON-ALIGNED NO-LABEL
     fEnvTargetLocn AT ROW 22.5 COL 23 COLON-ALIGNED NO-LABEL
...
ON VALUE-CHANGED OF cbSuggest IN FRAME fMain /* What do you want to do? */
DO:
    ...
    */
    ...
    CASE SELF:NAME:
        WHEN 'fLogDir' THEN DO:
            ...
            INITIAL-DIR fLogDir:SCREEN-VALUE.
            ASSIGN 
...
------------------------------------------------------------------------------*/
  DISPLAY fCopyCustTo tCreateStartup fiAsOfDate tConfigName tCreateDB tUpdateDB 
          tLoadData tCreateObject tCreateCustom tCreateCustObj tCompileBase 
          tCompilePatch tCompileCustom tCompileSelected tRunFix tConnectMulti 
          tClearLog tStopOnError tLogErrors cbSuggest fLogDir fDBLocn fDBName 
          fDBConnParms fDFLocn fDeltaLocn fDataFilesLocn fBaseCodeLocn 
          fPatchCodeLocn fCopyBaseTo fCustCodeLocn fObjCodeLocn fCustObjLocn 
          tHelp fProgressLocn tCreateBase tCopyDfFiles tCopyBaseFiles 
          tCopyCustFiles fEnvTempLocn fEnvTargetLocn 
      WITH FRAME fMain IN WINDOW wWin.
  ENABLE fCopyCustTo tCreateStartup tCreateDB tUpdateDB tLoadData tCreateObject 
         tCreateCustom tCreateCustObj tCompileBase tCompilePatch tCompileCustom 
         tCompileSelected tRunFix tConnectMulti tClearLog tStopOnError 
         tLogErrors bRunDBAdmin bClear bModPropath bSaveConfig cbSuggest 
         fLogDir tHelp bProcess bQuit tCreateBase tCopyDfFiles tCopyBaseFiles 
         tCopyCustFiles fEnvTempLocn fEnvTargetLocn 
      WITH FRAME fMain IN WINDOW wWin.
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute AFTER standard behavior.    */
    ...
    IF SEARCH("fsInstall.cfg") <> ? THEN DO:
        ASSIGN 
    ...
    APPLY "entry" TO cbSuggest IN FRAME fMain.
...
------------------------------------------------------------------------------*/
    ...
    FORM 
        ...
        SKIP(1)
        "Compiling: " AT 2 cCleanFullName FORMAT "x(60)"    AT 13 NO-LABEL
        "To: "        AT 2 cMyVar FORMAT "x(60)"            AT 13 NO-LABEL
    ...
    REPEAT:
        ...
        IF SUBSTRING(cFullName,LENGTH(cFullName),1) <> "." AND INDEX(cAttrList,"D") <> 0 THEN DO:
            ...
            RUN ipWriteMessage (INPUT "Compiling: " + STRING(cCleanCompileTo + replace(cCleanFullName,cCleanBaseFrom,""),"x(55)")).
            RUN ipCompileBase2 (INPUT cFullName, INPUT cCompileTo).
        END.
        /* If this is a procedure file... */
        ELSE IF INDEX(cAttrList,"F") <> 0 
        AND ((INDEX(cName,".p") <> 0 AND INDEX(cName,".pf") = 0 AND INDEX(cName,".pl") = 0) 
        OR (INDEX(cName,".w") <> 0 AND INDEX(cName,".wrx") = 0)) THEN DO:
            /* Display the message on screen */
            ASSIGN cMyVar = STRING(cCleanCompileTo) + REPLACE(REPLACE(cCleanFullName,cCleanBaseFrom,""),cName,"").
            DISPLAY cCleanFullName cMyVar iCtr2 WITH FRAME compdisp.
            /* and do the actual compile */
            COMPILE value(cFullName) SAVE INTO VALUE(cCleanCompileTo + REPLACE(REPLACE(cCleanFullName,cCleanBaseFrom,""),cName,"")) NO-ERROR. 
        ...
        ELSE IF INDEX(cAttrList,"F") <> 0 
        AND (INDEX(cName,"_tag") <> 0 
        OR INDEX(cName,".bat") <> 0
        OR INDEX(cName,".bmp") <> 0
        OR INDEX(cName,".cnt") <> 0 
        OR INDEX(cName,".com") <> 0 
        OR INDEX(cName,".cur") <> 0 
        OR INDEX(cName,".d") <> 0
        OR INDEX(cName,".dat") <> 0
        OR INDEX(cName,".df") <> 0
        OR INDEX(cName,".dos") <> 0 
        OR INDEX(cName,".fil") <> 0 
        OR INDEX(cName,".gid") <> 0 
        OR INDEX(cName,".gif") <> 0 
        OR INDEX(cName,".hlp") <> 0 
        OR INDEX(cName,".ico") <> 0
        OR INDEX(cName,".ini") <> 0
        OR INDEX(cName,".jbf") <> 0
        OR INDEX(cName,".jpg") <> 0 
        OR INDEX(cName,".log") <> 0
        OR INDEX(cName,".pf") <> 0 
        OR INDEX(cName,".pl") <> 0
        OR INDEX(cName,".q") <> 0 
        OR INDEX(cName,".r") <> 0 
        ...
        OR INDEX(cName,".sh") <> 0
        OR INDEX(cName,".t") <> 0
        OR INDEX(cName,".txt") <> 0
        OR INDEX(cName,".wrx") <> 0 
        ) THEN DO:
            /* Display the message on screen */
            ASSIGN cMyVar = STRING(cCleanCompileTo) + REPLACE(REPLACE(cCleanFullName,cCleanBaseFrom,""),cName,"").
            DISPLAY cCleanFullName cMyVar iCtr2 WITH FRAME compdisp.
            ...
            OS-COPY VALUE(cFullName) VALUE(cCleanCompileTo + REPLACE(REPLACE(cCleanFullName,cCleanBaseFrom,""),cName,"")). 
...
------------------------------------------------------------------------------*/
    ...
    IF NOT CONNECTED("ptdb1") THEN DO:
        IF INDEX(cDBParms1," -1 ") <> 0 THEN
            CONNECT VALUE(cDBFullName) -ld ptdb1 VALUE(cDBParms1).
        ELSE
            CONNECT VALUE(REPLACE(cDBFullName,".db","")) -ld ptdb1 VALUE(cDBParms1).
    END.
    ELSE DO:
    ...
    CREATE ALIAS "ptdb"     FOR DATABASE VALUE(ldbname(1)).
    CREATE ALIAS "ptdb1"    FOR DATABASE VALUE(ldbname(1)).
    CREATE ALIAS "ptdb9"    FOR DATABASE VALUE(ldbname(1)).
    CREATE ALIAS "schdb"    FOR DATABASE VALUE(ldbname(1)).
    CREATE ALIAS "ftappl"   FOR DATABASE VALUE(ldbname(1)).
    CREATE ALIAS "appldb"   FOR DATABASE VALUE(ldbname(1)).
    CREATE ALIAS "schem"    FOR DATABASE VALUE(ldbname(1)).
    CREATE ALIAS "oradb"    FOR DATABASE VALUE(LDBNAME(1)).
    CREATE ALIAS "olddb"    FOR DATABASE VALUE(LDBNAME(1)).
    CREATE ALIAS "newdb"    FOR DATABASE VALUE(LDBNAME(1)).
...
------------------------------------------------------------------------------*/
    ...
    FORM
        ...
        "To: "      AT 2 cMyVar FORMAT "x(60)"      AT 12 NO-LABEL
        SKIP(1)
        "(c) 2005, Foresight Software, Inc." AT 2
        "All rights reserved." TO 68
    ...
    REPEAT:
        ...
        ELSE IF tCopyBaseFiles:CHECKED IN FRAME fMain AND INDEX(cAttrList,"F") <> 0 THEN DO:
            ...
            DISPLAY cCleanFullName cMyVar WITH FRAME copydisp.
...
------------------------------------------------------------------------------*/
    ...
    IF NOT lErrorsOnlyLog OR 
        INDEX(cMessage,"ERROR") <> 0 OR 
        INDEX(cMessage,"WARNING") <> 0 OR 
        INDEX(cMessage,"Initiating") <> 0 OR 
        INDEX(cMessage,"Completing") <> 0 
        THEN DO:
        OUTPUT STREAM logStream TO VALUE(cLogDir + REPLACE(cThisConfig,".cfg",".log")) APPEND.
