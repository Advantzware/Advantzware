...
PROCEDURE pGetCustomersHubSpot PRIVATE:
/*------------------------------------------------------------------------------
 Purpose:
 Notes:
------------------------------------------------------------------------------*/
    ...
    IF VALID-OBJECT(jaResult) THEN DO:
        DO iCount = 1 TO iResultLength:
            ...
            ttCRMCustomers.custCity  = joProperties:GetJsonText("city") NO-ERROR.
            ttCRMCustomers.custState = joProperties:GetJsonText("state") NO-ERROR.
...
------------------------------------------------------------------------------*/
    ...
    REPEAT:        
        RUN Outbound_PrepareAndExecuteForScope IN hdOutboundProcs (
            ...
            INPUT  "GetCustomer",                          /* API ID (Mandatory) */
            INPUT  "",                                     /* Scope ID */
            INPUT  "",                                     /* Scope Type */
