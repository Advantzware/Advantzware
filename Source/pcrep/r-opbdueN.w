...
DEFINE TEMP-TABLE tt-rel NO-UNDO 
...
ASSIGN 
    cTextListToSelect  = "Due Date,Ord Date,Job #,Ord #,Customer Name,FG Item #,"
...
{sys/inc/ttRptSel.i}
ASSIGN 
    cTextListToDefault = "Due Date,Ord Date,Job #,Ord #,Customer Name,FG Item #,"
...
begin_due-date end_due-date sl_avail Btn_Def sl_selected Btn_Add Btn_Remove ~
btn_Up btn_down rd-dest fi_file tb_OpenCSV tbAutoClose btn-ok btn-cancel 
&Scoped-Define DISPLAYED-OBJECTS begin_cust-no end_cust-no begin_due-date ~
end_due-date sl_avail sl_selected rd-dest fi_file tb_OpenCSV tbAutoClose 
...
DEFINE VARIABLE fi_file        AS CHARACTER FORMAT "X(45)" INITIAL "c:~\tmp~\OpenJobsByDueDate.csv" 
    LABEL "Name" 
...
DEFINE FRAME FRAME-A
    begin_cust-no AT ROW 2.91 COL 27.4 COLON-ALIGNED HELP
    "Enter Beginning Customer Number"
    end_cust-no AT ROW 2.91 COL 70 COLON-ALIGNED HELP
    "Enter Ending Customer Number"
    begin_due-date AT ROW 4.33 COL 27.4 COLON-ALIGNED
    end_due-date AT ROW 4.33 COL 70 COLON-ALIGNED HELP
    "Enter Ending Due Date"
    sl_avail AT ROW 6.95 COL 4 NO-LABELS WIDGET-ID 26
    Btn_Def AT ROW 6.95 COL 40 HELP
    "Add Selected Table to Tables to Audit" WIDGET-ID 56
    sl_selected AT ROW 6.95 COL 60.6 NO-LABELS WIDGET-ID 28
    Btn_Add AT ROW 7.95 COL 40 HELP
    "Add Selected Table to Tables to Audit" WIDGET-ID 32
    Btn_Remove AT ROW 8.95 COL 40 HELP
    "Remove Selected Table from Tables to Audit" WIDGET-ID 34
    btn_Up AT ROW 10 COL 40 WIDGET-ID 40
    btn_down AT ROW 11 COL 40 WIDGET-ID 42
    lv-ornt AT ROW 13.14 COL 31 NO-LABELS
    lines-per-page AT ROW 13.14 COL 84 COLON-ALIGNED
    rd-dest AT ROW 13.38 COL 6 NO-LABELS
    lv-font-no AT ROW 14.1 COL 35 COLON-ALIGNED
    tb_excel AT ROW 14.1 COL 73 RIGHT-ALIGNED
    lv-font-name AT ROW 15.05 COL 29 COLON-ALIGNED NO-LABELS
    td-show-parm AT ROW 16.24 COL 28.6
    fi_file AT ROW 17.19 COL 26.6 COLON-ALIGNED HELP
    "Enter File Name"
    tb_OpenCSV AT ROW 17.29 COL 92.4 RIGHT-ALIGNED
    tbAutoClose AT ROW 19.29 COL 28.6 WIDGET-ID 78
    btn-ok AT ROW 20.29 COL 28.6
    btn-cancel AT ROW 20.29 COL 48.6
    "Available Columns" VIEW-AS TEXT
    SIZE 29 BY .62 AT ROW 6.19 COL 4.2 WIDGET-ID 38
    " Output Destination" VIEW-AS TEXT
    SIZE 19 BY .62 AT ROW 12.57 COL 5
    " Selection Parameters" VIEW-AS TEXT
    SIZE 21.2 BY .71 AT ROW 1.14 COL 5
    "Selected Columns(In Display Order)" VIEW-AS TEXT
    SIZE 34 BY .62 AT ROW 6.19 COL 60.2 WIDGET-ID 44
    RECT-6 AT ROW 12.91 COL 4
...
ON END-ERROR OF C-Win /* Open Jobs By Due Date */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Open Jobs By Due Date */
    DO:
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    RUN enable_UI.
    {methods/nowait.i}
    {sys/inc/reportsConfigNK1.i "DR10" }
    ASSIGN
...
PROCEDURE enable_UI :
    ...
    ------------------------------------------------------------------------------*/
    DISPLAY begin_cust-no end_cust-no begin_due-date end_due-date sl_avail 
        sl_selected rd-dest fi_file tb_OpenCSV tbAutoClose 
        WITH FRAME FRAME-A IN WINDOW C-Win.
    ENABLE RECT-6 RECT-7 begin_cust-no end_cust-no begin_due-date end_due-date 
...
PROCEDURE run-report :
    /* ---------------------------------------------- pc/rep/openjobs.p 04/98 JLF */
    /* Open Jobs By Due Date By Customer                                          */
    /* -------------------------------------------------------------------------- */

    /*{sys/form/r-topw.f}*/

    DEFINE VARIABLE v-fcust        LIKE job-hdr.cust-no EXTENT 2 INIT ["","zzzzzzzz"].
    DEFINE VARIABLE v-fdate        LIKE oe-ord.due-date EXTENT 2 FORMAT "99/99/99" 
        INIT [TODAY, 12/31/99].

    DEFINE VARIABLE v-date         AS DATE.
    DEFINE VARIABLE v-msf          AS DECIMAL.
    DEFINE VARIABLE v-tot-qty      AS INTEGER   FORMAT ">>>,>>>,>>9".
    DEFINE VARIABLE v-tot-msf      AS DECIMAL   FORMAT ">>>>9.9".
    ...
    FOR EACH ttRptSelected BY ttRptSelected.DisplayOrder:
        ...
        IF LOOKUP(ttRptSelected.TextList, "Job Qty,MSF") <> 0    THEN
            ASSIGN
    ...
    DO:
        ...
        /*excelheader = "Due Date,Ord Date,Job #,Our Ord #,Customer Name,FG Item #,"
                    + " FG Item Name,Job Qty,MSF".*/
    ...
    FOR EACH tt-report,
        ...
        FIND FIRST oe-ord
            ...
            {custom/statusMsg.i " 'Processing FG Item#  '  + job-hdr.i-no "}

        FIND FIRST itemfg OF job-hdr NO-LOCK NO-ERROR.
        ASSIGN
            v-msf  = IF AVAILABLE itemfg THEN itemfg.t-sqft * job-hdr.qty / 1000
                ELSE 0
        ...
        FOR EACH job-mat NO-LOCK
            ...
            FIND FIRST item NO-LOCK
                ...
                NO-ERROR .
            IF AVAILABLE ITEM AND LOOKUP(item.mat-type,"B,1,2,3,4") GT 0 THEN 
            DO:
                ASSIGN
                ...
                IF ITEM.mat-type EQ "B" THEN
                    lBoard = YES.                  
            END.  
            IF AVAILABLE ITEM AND LOOKUP(item.mat-type,"1,2,3,4") GT 0 THEN 
                lCheckFoam = YES.
        END.
        IF i GT 1 THEN
            cRmItemName = "Kit".
        ...
        DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
            ...
            CASE cTmpField:             
                WHEN "due-date"    THEN 
                    cVarValue = IF v-date NE ? THEN STRING(v-date,"99/99/99") ELSE "" .
                WHEN "ord-date"   THEN 
                ...
                WHEN "cust-name"   THEN 
                    cVarValue = STRING(tt-report.key-02,"x(30)") .
                WHEN "fgitem"  THEN 
                    cVarValue = STRING(job-hdr.i-no,"x(15)") .
                WHEN "item-name"   THEN 
                    cVarValue = IF AVAILABLE itemfg THEN STRING(itemfg.i-name,"x(30)") ELSE "" .
                WHEN "job-qty"  THEN 
                    cVarValue = STRING(job-hdr.qty,">>,>>>,>>9") .
                WHEN "msf"  THEN 
                    cVarValue = STRING(v-msf,">>>>9.9") .
                WHEN "rm-item-name"  THEN 
                    cVarValue = STRING(cRmItemName,"x(30)") .
                WHEN "job-board"  THEN 
            ...
            ELSE IF  cTmpField = "ord-date" THEN
                 cExcelVarValue = IF AVAILABLE oe-ord AND oe-ord.ord-date NE ? THEN DYNAMIC-FUNCTION("sfFormat_Date",oe-ord.ord-date) ELSE "".
        ...
        ASSIGN
            v-tot-qty = v-tot-qty + job-hdr.qty
    ...
    DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
        ...
        CASE cTmpField:             
            ...
            WHEN "item-name"   THEN 
                cVarValue = "".
            WHEN "job-qty"  THEN 
                cVarValue = STRING(v-tot-qty,">>,>>>,>>9") .
            WHEN "msf"  THEN 
                cVarValue = STRING(v-tot-msf,">>>>9.9") .
            WHEN "rm-item-name"  THEN 
                cVarValue = "" .
            WHEN "job-board"  THEN 
                cVarValue = "" .
    ...
    PUT UNFORMATTED "    Totals " +  substring(cDisplay,12,250) SKIP.
    IF tb_excel THEN 
    DO:
        PUT STREAM excel UNFORMATTED 
            'Totals, '  
    ...
    DO WITH FRAME {&FRAME-NAME}:
        ...
        ELSE
            ASSIGN
                ...
                .
        ASSIGN 
            fi_file:SCREEN-VALUE = "c:\tmp\OpenJobsByDueDate.csv".   
    END.
