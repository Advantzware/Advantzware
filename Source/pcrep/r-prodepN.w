...
{sys/inc/ttRptSel.i}
ASSIGN 
    cTextListToDefault = "M Code,Job#,##,Shift,MR Std,MR Act,MR Eff%," + 
                                               "Run Std,Run Act,Run Eff%," +
                                               "MR+Run Std,MR+Run Act,MR+Run Eff%," +
...
rd_alptime sl_avail sl_selected rd-dest fi_file tb_OpenCSV tbAutoClose 
...
DEFINE VARIABLE fi_file        AS CHARACTER FORMAT "X(45)" INITIAL "c:~\tmp~\ProductivityByDepartment.csv" 
    LABEL "Name" 
...
DEFINE FRAME FRAME-A
    begin_dept AT ROW 2.29 COL 27.2 COLON-ALIGNED HELP
    "Enter Beginning Department"
    end_dept AT ROW 2.29 COL 70.2 COLON-ALIGNED HELP
    "Enter Ending Department"
    begin_mach AT ROW 3.24 COL 27.2 COLON-ALIGNED HELP
    "Enter Beginning Machine"
    end_mach AT ROW 3.24 COL 70.2 COLON-ALIGNED HELP
    "Enter Ending Machine"
    begin_Shift AT ROW 4.19 COL 27.2 COLON-ALIGNED HELP
    "Enter Beginning Shift"
    end_shift AT ROW 4.19 COL 70.2 COLON-ALIGNED HELP
    "Enter Ending Shift"
    begin_date AT ROW 5.14 COL 27.2 COLON-ALIGNED HELP
    "Enter Beginning Date"
    end_date AT ROW 5.14 COL 70.2 COLON-ALIGNED HELP
    "Enter Ending Date"
    tb_sched AT ROW 6.71 COL 32.6
    TB_round AT ROW 7.52 COL 32.6 WIDGET-ID 2
    tb_TonMsf AT ROW 8.33 COL 32.6 WIDGET-ID 12
    rd_alptime AT ROW 9.43 COL 32.6 NO-LABELS WIDGET-ID 14
    ...
    SIZE 10 BY .62 AT ROW 9.48 COL 22.6 WIDGET-ID 18
    ...
    DO WITH FRAME {&FRAME-NAME}:
        ...
        ELSE
            ASSIGN
                ...
                .
        ASSIGN 
            fi_file:SCREEN-VALUE = "c:\tmp\ProductivityByDepartment.csv".   
    END.
