...
ASSIGN cTextListToSelect = "Machine,Job count,Gross Qty,Gross MSF,Waste Qty,Waste MSF,Net Qty,Net MSF"
       cFieldListToSelect = "mach,job-count,gross-qty,gross-msf,waste-qty,waste-msf,net-qty,net-msf" /*9*/

       cFieldLength = "10,9,14,11,14,11,14,11"  
         cFieldType = "c,i,i,i,i,i,i,i" .

{sys/inc/ttRptSel.i}
ASSIGN cTextListToDefault  = "Machine,Job count,Gross Qty,Gross MSF,Waste Qty,Waste MSF,Net Qty,Net MSF".
...
sl_avail Btn_Def sl_selected Btn_Add Btn_Remove btn_Up btn_down tb_runExcel ~
...
DEFINE FRAME FRAME-A
     ...
     sl_avail AT ROW 7.57 COL 3 NO-LABEL WIDGET-ID 26
     Btn_Def AT ROW 7.57 COL 39 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 56
     sl_selected AT ROW 7.57 COL 58.4 NO-LABEL WIDGET-ID 28
     Btn_Add AT ROW 8.57 COL 39 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 32
     Btn_Remove AT ROW 9.57 COL 39 HELP
          "Remove Selected Table from Tables to Audit" WIDGET-ID 34
     btn_Up AT ROW 10.62 COL 39 WIDGET-ID 40
     btn_down AT ROW 11.62 COL 39 WIDGET-ID 42
     lv-ornt AT ROW 13.19 COL 33 NO-LABEL
     lines-per-page AT ROW 13.19 COL 86 COLON-ALIGNED
     rd-dest AT ROW 14.14 COL 8 NO-LABEL
     lv-font-no AT ROW 14.62 COL 37 COLON-ALIGNED
     lv-font-name AT ROW 15.81 COL 31 COLON-ALIGNED NO-LABEL
     tb_excel AT ROW 17.24 COL 70 RIGHT-ALIGNED
     tb_runExcel AT ROW 17.24 COL 92 RIGHT-ALIGNED
     fi_file AT ROW 18.19 COL 48 COLON-ALIGNED HELP
          "Enter File Name"
     td-show-parm AT ROW 18.43 COL 7
     btn-ok AT ROW 20.29 COL 27
     btn-cancel AT ROW 20.29 COL 59
     "Selection Parameters" VIEW-AS TEXT
          SIZE 21 BY .71 AT ROW 1.24 COL 5
          BGCOLOR 2 
     "Available Columns" VIEW-AS TEXT
          SIZE 29 BY .62 AT ROW 6.86 COL 3.8 WIDGET-ID 38
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY 1 AT ROW 13.05 COL 5
     "Selected Columns(In Display Order)" VIEW-AS TEXT
          SIZE 34 BY .62 AT ROW 6.86 COL 58.4 WIDGET-ID 44
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Gross & Net MSF per Machine"
         HEIGHT             = 21.38
         WIDTH              = 95.8
         MAX-HEIGHT         = 33.29
         MAX-WIDTH          = 204.8
...
ON END-ERROR OF C-Win /* Gross & Net MSF per Machine */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Gross & Net MSF per Machine */
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY begin_mach end_mach begin_job-no begin_job-no2 end_job-no end_job-no2 
          begin_date end_date sl_avail sl_selected lv-ornt lines-per-page 
  ...
  ENABLE RECT-6 RECT-7 begin_mach end_mach begin_job-no begin_job-no2 
         end_job-no end_job-no2 begin_date end_date sl_avail Btn_Def 
...
DEFINE VARIABLE dGrossQty AS DECIMAL NO-UNDO .
DEFINE VARIABLE dTotWaste AS DECIMAL NO-UNDO .
DEFINE VARIABLE dNetQty AS DECIMAL NO-UNDO .

DEFINE VARIABLE dGrossMSF AS DECIMAL NO-UNDO .
DEFINE VARIABLE dTotMchWaste AS DECIMAL NO-UNDO .
DEFINE VARIABLE dTotWasteMSF AS DECIMAL NO-UNDO .
DEFINE VARIABLE dWasteMsf AS DECIMAL NO-UNDO .
DEFINE VARIABLE dTotNetMsf AS DECIMAL NO-UNDO .
DEFINE VARIABLE dNetMsf AS DECIMAL NO-UNDO .
...
DEF VAR cslist AS cha NO-UNDO.
 FOR EACH ttRptSelected BY ttRptSelected.DisplayOrder:
   ...
   ASSIGN str-tit4 = str-tit4 + 
        ...
        IF LOOKUP(ttRptSelected.TextList, "Gross MSF") <> 0    THEN
         ASSIGN
...
ASSIGN
  ...
  FOR EACH mch-act NO-LOCK
      ...
      IF FIRST-OF(mch-act.job-no) THEN
      ASSIGN iJob = iJob + 1.
     
      {custom/statusMsg.i " 'Processing Job#  '  + job.job-no "}

    FIND FIRST job-code NO-LOCK WHERE job-code.code EQ mch-act.code  NO-ERROR.
      ...
      FIND FIRST job-mch NO-LOCK
        WHERE job-mch.company  EQ mch-act.company
          ...
          AND job-mch.pass     EQ mch-act.pass NO-ERROR.
      RELEASE est.
      RELEASE ef.
      RELEASE eb.
      ...
      IF AVAIL ef THEN
          ...
          AND (eb.blank-no EQ mch-act.blank-no OR mch-act.blank-no EQ 0) NO-ERROR.
      ...
      IF AVAIL est THEN DO:
          ...
          FIND FIRST w-ink
              ...
              AND w-ink.pass    EQ mch-act.pass NO-ERROR.
      END.
      ...
      IF (mach.p-type = "R" OR mach.p-type = "S" OR mach.p-type = "B") THEN DO:     
          IF AVAIL eb THEN 
              IF mach.p-type = "R" THEN
                  dWasteMsf = mch-act.waste * ef.gsh-wid * ef.gsh-len / 1000 / 144.
              ELSE IF mach.p-type = "S" THEN
                  dWasteMsf = mch-act.waste * ef.nsh-wid * ef.nsh-len / 1000 / 144.
              ELSE IF mach.p-type = "B" THEN
                  dWasteMsf = mch-act.waste * eb.t-wid * eb.t-len / 1000 / 144.
      END.
      ASSIGN dTotWasteMSF = dTotWasteMSF + dWasteMsf.

      IF LAST-OF(mch-act.m-code) THEN DO:
               ASSIGN dNetQty   = dGrossQty - dTotWaste.
               
               ASSIGN dTotNetMsf = dGrossMSF - dTotWasteMSF.
          ...
          ASSIGN cDisplay = ""
              ...
              cExcelVarValue = "".
               DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
                   ...
                   CASE cTmpField:
                       WHEN "mach"         THEN cVarValue = mch-act.m-code.
                       WHEN "job-count"    THEN cVarValue = string(iJob).
                       WHEN "gross-qty"    THEN cVarValue = STRING(dGrossQty,"->>,>>>,>>9.99").
                       WHEN "gross-msf"    THEN cVarValue = STRING(dGrossMSF,"->>,>>9.999").
                       WHEN "waste-qty"    THEN cVarValue = STRING(dTotWaste,"->>,>>>,>>9.99").
                       WHEN "waste-msf"    THEN cVarValue = string(dTotWasteMSF,"->>,>>9.999").
                       WHEN "net-qty"      THEN cVarValue = STRING(dNetQty,"->>,>>>,>>9.99") .
                       WHEN "net-msf"      THEN cVarValue = string(dTotNetMsf,"->>,>>9.999").
                   END CASE.
