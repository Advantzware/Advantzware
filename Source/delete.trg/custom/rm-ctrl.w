...
&Scoped-define INTERNAL-TABLES rm-ctrl

/* Definitions for FRAME DEFAULT-FRAME                                  */
&Scoped-define FIELDS-IN-QUERY-DEFAULT-FRAME rm-ctrl.avg-lst-cst ~
rm-ctrl.using-jc rm-ctrl.master-audit rm-ctrl.mat rm-ctrl.inv-asset-acctno ~
rm-ctrl.post-transfers rm-ctrl.post-rcpts-w-i-p 
&Scoped-define OPEN-QUERY-DEFAULT-FRAME OPEN QUERY DEFAULT-FRAME FOR EACH rm-ctrl SHARE-LOCK.
&Scoped-define TABLES-IN-QUERY-DEFAULT-FRAME rm-ctrl
&Scoped-define FIRST-TABLE-IN-QUERY-DEFAULT-FRAME rm-ctrl


/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS RECT-16 RECT-15 Btn_Update Btn_Close 
...
/* SETTINGS FOR RADIO-SET rm-ctrl.avg-lst-cst IN FRAME DEFAULT-FRAME
   NO-ENABLE 1                                                          */
...
/* SETTINGS FOR FILL-IN rm-ctrl.inv-asset-acctno IN FRAME DEFAULT-FRAME
   NO-ENABLE 1 EXP-LABEL                                                */
/* SETTINGS FOR TOGGLE-BOX rm-ctrl.master-audit IN FRAME DEFAULT-FRAME
   NO-ENABLE 1 EXP-LABEL                                                */
/* SETTINGS FOR FILL-IN rm-ctrl.mat IN FRAME DEFAULT-FRAME
   NO-ENABLE 1 EXP-LABEL                                                */
/* SETTINGS FOR TOGGLE-BOX rm-ctrl.post-rcpts-w-i-p IN FRAME DEFAULT-FRAME
   NO-ENABLE 1 EXP-LABEL                                                */
/* SETTINGS FOR TOGGLE-BOX rm-ctrl.post-transfers IN FRAME DEFAULT-FRAME
   NO-ENABLE 1 EXP-LABEL                                                */
/* SETTINGS FOR TOGGLE-BOX rm-ctrl.using-jc IN FRAME DEFAULT-FRAME
   NO-ENABLE 1 EXP-LABEL                                                */
...
ON ENTRY OF rm-ctrl.inv-asset-acctno IN FRAME DEFAULT-FRAME /* Default Inventory Asset Account */
DO:
  {custom/actentry.i}
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL rm-ctrl.inv-asset-acctno C-Win
ON LEAVE OF rm-ctrl.inv-asset-acctno IN FRAME DEFAULT-FRAME /* Default Inventory Asset Account */
DO:
  {custom/actleave.i}
END.
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  FIND rm-ctrl WHERE rm-ctrl.company = gcompany NO-LOCK NO-ERROR.
  RUN enable_UI.
  {methods/nowait.i}
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-16 RECT-15 Btn_Update Btn_Close 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
