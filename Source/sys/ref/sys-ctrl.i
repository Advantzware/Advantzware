...
"TruckPlan,SSJobInquiryAdjust,SSJobInquiryIssue,OutputCSV,SSIssueDefaultRM,QuoteExpirationDays,CEGOTOCALC,APIRequestMethod,VendItemCostMaximum,PriceMatrixPricingMethod,CEVendorDefault,ARCashEntry,CEOpStandards,CEShipWeight,CECostSource,CESetHeaderForm,JobBarCode" 
.
...
ASSIGN
 str-init[1]  = "ABox,10 Pitch,ContSrvc,CSC-EXCEL,TRILAKE-EXCEL,HOP," +
                ...
                "QuoPrintVAL,QuoPrint-Excel-Mex,Onducorr,Altex,McElroy,GC,Portugese-Excel"
 str-init[2]  = "Capitol,ASI,Beeler,Argrov,ILWalker,1/2 Page,Phoenix,Color,Interpac,Royal,Keystone," +
		        ...
		        "invprint 21,CCCACH,Delta,NStockLogo1,NStockLogo2,Henry,Portugese" 
 ...
 str-init[8]  = "16th's,32nd's,Century,Middlesx,RFC,Sonoco,Rudd,Brick,Fibre,Metro,"
              ...
              + "Mclean,Altex,CapCity,Ruffino,Portugese,poprint-Sec"
 str-init[9]  = "ASI,Argrov,Century,HOP,MultiWll,Sonoco,TriState,Fibre," +
                ...
                "Frank,Axis,Distributor,Accord,Lakeside,relprint 1,relprint 2,relprint 10,Midwest,RFC,CardedX2,Henry,Portugese," +
                "Relprint 15"
 str-init[10] = "ASI,1/2 Page,Royal,ContSrvc,Superior,Premier,Warren,PAC 1/2," +
                ...
                "BOLFMT-Mex,PREMDSG,PremCAN,Mclean-Excel,Henry,GPI2_I,CardedBC_I,Ruffino,Portugese,SECorr"    
...
ASSIGN
 ...
 str-init[29] = ",Brick,Xprint,Unipak-XL,PremierPkg,ACPI,PremierPkgU,PremierPkgM,PremierBroker,CCC,LoyLang,CCCWPP,Prystup," +
                "bolcert 1,bolcert 2,BOLCERT10,CCC2,LancoYork,CCC3,CCC4,CCC5,BOLCERT-Mex,Soule,PackSlip,PrystupXLS,CCCEss,CCCRev,Altex,Portugese"
 ...
 str-init[33] = "ASI,HOP,Fibre,Century,Interpac,FibreFC,HPB,Dayton,Livngstn,CentBox,Metro,Keystone,Frankstn,Colonial,Unipak,OTTPkg,Shelby,CCC,Indiana-XL,PPI,Accord,Knight,MidYork,Dee,Badger,Rosmar,Carded,Carded2,PackRite,Prystup,Knight***,Coburn," + /*MWFibre=Keystone*/
                "jobcardf 1,jobcardf 2,xml,Wingate,Ruffino,McLean,Henry,Burt,GPI-STN,Preferred"
...
ASSIGN str-init[125] = "Ship Only,Invoice Only,Bill and Ship,Transfer Only"
       ...
       str-init[206] = "Existing Form 1,Separate Form 0"
       str-init[207] = ",Job Number,Job Number2,Form,Blank"
       .
