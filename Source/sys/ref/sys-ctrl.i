...
"CEUpdate,ValidShipTo,PriceHold,CreditHold,CustomerPO,UniquePO,ValidUoM,PriceGtCost,CustomerPN,CEOpRates,CERequestYield,CINVOICE,BOLPartialFlag,FreightCalculation"    .
...
ASSIGN str-init[125] = "Ship Only,Invoice Only,Bill and Ship,Transfer Only"
       ...
       str-init[175] = "All,Estimating,Order processing,Bol Processing"
       .
