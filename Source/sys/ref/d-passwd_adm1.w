...
&Scoped-Define ENABLED-OBJECTS pass_word Btn_OK Btn_Cancel RECT-29 
...
DEFINE FRAME D-Dialog
     ...
     Btn_OK AT ROW 4.81 COL 8
     Btn_Cancel AT ROW 4.81 COL 36
     RECT-29 AT ROW 1.24 COL 1
     SPACE(4.39) SKIP(2.41)
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Password */
DO:  
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL pass_word D-Dialog
ON LEAVE OF pass_word IN FRAME D-Dialog /* Please enter password */
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY pass_word 
      WITH FRAME D-Dialog.
  ENABLE pass_word Btn_OK Btn_Cancel RECT-29 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
