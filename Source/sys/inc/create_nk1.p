...
v-std-list = "IR12,OEDateChange,FGRecptPassWord,InvStatus,BOLQtyPopup,AgeDays,OEFGADD,HighBalDays,"
...
IF LOOKUP(ip-nk1-value, v-std-list) GT 0 THEN DO:
