...
v-std-list = "LoadTagSSCC,IR12,OEDateChange,FGRecptPassWord,InvStatus,BOLQtyPopup,AgeDays,OEFGADD,HighBalDays,"
           ...
           + "CEVendorDefault,JobCreateFromFG,CEPrompt,BOLHideBillableFreight,ARCashEntry,NewOrderEntry"
           .
...
CASE ip-nk1-value:
  ...
  WHEN "ARAutoReleaseCreditHold" THEN   
   ...
   WHEN "CaseLabel" THEN     
    ...
    WHEN "NewOrderEntry" THEN     
        RUN sys/inc/addnk1.p (
            INPUT cocode, 
            INPUT ip-nk1-value, 
            INPUT NO,           
            INPUT "New Order Entry screen", /* Description */
            INPUT "",                                   /* Char Value */
            INPUT 0,                                    /* Int value */
            INPUT NO,                                   /* Logical value */ 
            INPUT 0                                     /* Dec value*/
