...
v-std-list = "LoadTagSSCC,IR12,OEDateChange,FGRecptPassWord,InvStatus,BOLQtyPopup,AgeDays,OEFGADD,HighBalDays,"
           ...
           + "JobRecalc,JobBuildVersion,CEWood,SalesTaxRoundingMethod,SalesTaxCalcMethod,FGTagValidation,DynParamValidation,DateRule,FGTransferPost"
           .
...
CASE ip-nk1-value:
  ...
  WHEN "ARAutoReleaseCreditHold" THEN   
    ...
    WHEN "FGTransferPost" THEN 
        RUN sys/inc/addnk1.p (
            INPUT cocode, 
            INPUT ip-nk1-value, 
            INPUT NO,                                            /* Prompt? */
            INPUT "FG Warehouse Trans Transfer Post(IU2)",      /* Description */
            INPUT "",                                            /* Char Value */
            INPUT 0,                                             /* Int value */
            INPUT NO,                                            /* Logical value */ 
            INPUT 0                                              /* Dec value*/
