...
v-std-list = "LoadTagSSCC,IR12,OEDateChange,FGRecptPassWord,InvStatus,BOLQtyPopup,AgeDays,OEFGADD,HighBalDays,"
           ...
           + "TaskerNotRunning,OEBOLLOG,BOLPartialFlag,FGForceCommission,VendItemUseDeviation,FGItemUOM,LMReanalyze,ChkFmtConfig,FreightCalculation,"
           ...
           + "CECostSource,CEStyleF,ROUND,CESetHeaderForm,JobSubAssemblyPrefix,CESubAssembly,POPrintScores,OEUpdateLineDueDates,JobBarCode"
           .
...
CASE ip-nk1-value:
  ...
  WHEN "LoadTagLimit" THEN
    ...
    RUN sys/inc/addnk1.p (INPUT cocode, INPUT ip-nk1-value, INPUT NO /* Prompt? */,
        ...
        INPUT "" /* Char Value */, INPUT 0 /* Int value */,
        INPUT YES /* Logical value */, INPUT 0 /* dec value*/ ).        
   WHEN "TSShowPending" THEN
    RUN sys/inc/addnk1.p (INPUT cocode, INPUT ip-nk1-value, INPUT NO /* Prompt? */,
        INPUT "Show Schedule Board Pending Jobs",
        INPUT "" /* Char Value */, INPUT 0 /* Int value */,
        INPUT YES /* Logical value */, INPUT 0 /* dec value*/).
  WHEN "CEUpdateCAD" THEN
    RUN sys/inc/addnk1.p (INPUT cocode, INPUT ip-nk1-value, INPUT NO /* Prompt? */,
        INPUT "CAD and Box Design update on corrugated estimate",
        INPUT "" /* Char Value */, INPUT 0 /* Int value */,
        INPUT YES /* Logical value */, INPUT 0 /* dec value*/).
   WHEN "FGHistoryDate" THEN
    RUN sys/inc/addnk1.p (INPUT cocode, INPUT ip-nk1-value, INPUT NO /* Prompt? */,
   ...
   WHEN "FGLabel" THEN
    RUN sys/inc/addnk1.p (INPUT cocode, INPUT ip-nk1-value, INPUT NO /* Prompt? */,
        ...
        INPUT NO /* Logical value */, INPUT 0 /* dec value*/).
   WHEN "AuditJobCalc" THEN
    RUN sys/inc/addnk1.p (INPUT cocode, INPUT ip-nk1-value, INPUT NO /* Prompt? */,
        INPUT "Audit Job Calc (Job Rebuild)",
        INPUT "_default" /* Char Value */, INPUT 0 /* Int value */,
        INPUT NO /* Logical value */, INPUT 0 /* dec value*/).
   WHEN "WipTag" THEN
    RUN sys/inc/addnk1.p (INPUT cocode, INPUT ip-nk1-value, INPUT NO /* Prompt? */,
        INPUT "WIP Tag Template and Copy Control",
        INPUT "" /* Char Value */, INPUT 1 /* Int value */,
        INPUT NO /* Logical value */, INPUT 0 /* dec value*/).
   ...
   WHEN "CaseUOMList" THEN
    RUN sys/inc/addnk1.p (INPUT cocode, INPUT ip-nk1-value, INPUT NO /* Prompt? */,
        ...
        INPUT "" /* Char Value */, INPUT 0 /* Int value */,
        INPUT NO /* Logical value */, INPUT 0 /* dec value*/).       
      WHEN "OEAutoApproval" THEN
    RUN sys/inc/addnk1.p (INPUT cocode, INPUT ip-nk1-value, INPUT NO /* Prompt? */,
        INPUT "Auto Approval of CXML Orders",
        INPUT "" /* Char Value */, INPUT 0 /* Int value */,
        INPUT NO /* Logical value */, INPUT 0 /* dec value*/).                
   WHEN "SSPostRMTransfers" THEN   
    RUN sys/inc/addnk1.p (INPUT cocode, INPUT ip-nk1-value, INPUT NO /* Prompt? */,
        INPUT "Sharp Shooter RM Warehouse Trans Transfer Post",
        INPUT "" /* Char Value */, INPUT 0 /* Int value */,
        INPUT NO /* Logical value */, INPUT 0 /* dec value*/). 
   WHEN "PickTicketValidation" THEN   
    RUN sys/inc/addnk1.p (INPUT cocode, INPUT ip-nk1-value, INPUT NO /* Prompt? */,
        INPUT "BB - Able to force only select the tags that have been set on the pick ticket",
        INPUT "" /* Char Value */, INPUT 0 /* Int value */,
        INPUT NO /* Logical value */, INPUT 0 /* dec value*/).
   WHEN "CEMiscDefaultStyle" THEN   
    RUN sys/inc/addnk1.p (INPUT cocode, INPUT ip-nk1-value, INPUT NO /* Prompt? */,
        INPUT "Default on new Misc Estimate for Style",
        INPUT "" /* Char Value */, INPUT 0 /* Int value */,
        INPUT NO /* Logical value */, INPUT 0 /* dec value*/).
   WHEN "CEMiscDefaultBoard" THEN   
    RUN sys/inc/addnk1.p (INPUT cocode, INPUT ip-nk1-value, INPUT NO /* Prompt? */,
        INPUT "Default on new Misc Estimate for Board",
        INPUT "" /* Char Value */, INPUT 0 /* Int value */,
        INPUT NO /* Logical value */, INPUT 0 /* dec value*/).
   WHEN "CEMiscDefaultStackCode" THEN   
    RUN sys/inc/addnk1.p (INPUT cocode, INPUT ip-nk1-value, INPUT NO /* Prompt? */,
        INPUT "Default on new Misc Estimate for Stack Code",
        INPUT "" /* Char Value */, INPUT 0 /* Int value */,
        INPUT NO /* Logical value */, INPUT 0 /* dec value*/).
   WHEN "CEOpRates" THEN   
    RUN sys/inc/addnk1.p (INPUT cocode, INPUT ip-nk1-value, INPUT NO /* Prompt? */,
        INPUT "Machine Rates separate for MR and Run",
  ...
  WHEN "ARAutoReleaseCreditHold" THEN   
    ...
    RUN sys/inc/addnk1.p (INPUT cocode, INPUT ip-nk1-value, INPUT NO /* Prompt? */,
        ...
        INPUT "Order Quantity" /* Char Value */, INPUT 0 /* Int value */,
        INPUT NO /* Logical value */, INPUT 0 /* dec value*/).     
    WHEN "VendItemUseDeviation" THEN   
    RUN sys/inc/addnk1.p (INPUT cocode, INPUT ip-nk1-value, INPUT NO /* Prompt? */,
        INPUT "Use Deviation Vendor Cost Matrix",
        INPUT "" /* Char Value */, INPUT 0 /* Int value */,
        INPUT NO /* Logical value */, INPUT 0 /* dec value*/).
    WHEN "LMReanalyze" THEN   
    RUN sys/inc/addnk1.p (INPUT cocode, INPUT ip-nk1-value, INPUT NO /* Prompt? */,
        INPUT "Label Matrix - Control Reanalyzing",
        INPUT "" /* Char Value */, INPUT 0 /* Int value */,
        INPUT NO /* Logical value */, INPUT 0 /* dec value*/).
    WHEN "ChkFmtConfig" THEN   
    RUN sys/inc/addnk1.p (INPUT cocode, INPUT ip-nk1-value, INPUT NO /* Prompt? */,
        INPUT "Configuration file for Check printing (JSON)",
        INPUT "" /* Char Value */, INPUT 0 /* Int value */,
        INPUT NO /* Logical value */, INPUT 0 /* dec value*/).      
    ...
    WHEN "DynParamValidation" THEN 
        RUN sys/inc/addnk1.p (
            INPUT cocode, 
            INPUT ip-nk1-value, 
            INPUT NO,                                            /* Prompt? */
            INPUT "Dynamic Parameter Validation",                /* Description */
            INPUT "",                                            /* Char Value */
            INPUT 0,                                             /* Int value */
            INPUT YES,                                           /* Logical value */ 
            INPUT 0                                              /* Dec value*/
    ...
    WHEN "DateRule" THEN 
        RUN sys/inc/addnk1.p (
            ...
            INPUT ip-nk1-value, 
            INPUT NO,                                            /* Prompt? */
            INPUT "Use Date Rule Logic",                         /* Description */
            INPUT "",                                            /* Char Value */
            INPUT 0,                                             /* Int value */
            INPUT NO,                                            /* Logical value */ 
            INPUT 0                                              /* Dec value*/
    ...
    WHEN "InvoiceApprovalFreightAmount" THEN 
        RUN sys/inc/addnk1.p (
            INPUT cocode, 
            INPUT ip-nk1-value, 
            INPUT NO,                                            /* Prompt? */
            INPUT "If freight is billable, that freight amount is not zero", /* Description */
            INPUT "",                                            /* Char Value */
            INPUT 0,                                             /* Int value */
            INPUT NO,                                            /* Logical value */ 
            INPUT 0                                              /* Dec value*/
            ).
    WHEN "InvoiceApprovalFreightTerms" THEN 
         RUN sys/inc/addnk1.p (
            INPUT cocode, 
            INPUT ip-nk1-value, 
            INPUT NO,                                            /* Prompt? */
            INPUT "Verify that the freight terms are valid",     /* Description */
            INPUT "",                                            /* Char Value */
            INPUT 0,                                             /* Int value */
            INPUT NO,                                            /* Logical value */ 
            INPUT 0                                              /* Dec value*/
            ).
    WHEN "InvoiceApprovalPriceGTCost" THEN 
        RUN sys/inc/addnk1.p (
            INPUT cocode, 
            INPUT ip-nk1-value, 
            INPUT NO,                                            /* Prompt? */
            INPUT "Item Price is greater than the cost of the item", /* Description */
            INPUT "",                                            /* Char Value */
            INPUT 0,                                             /* Int value */
            INPUT NO,                                            /* Logical value */ 
            INPUT 0                                              /* Dec value*/
            ).
    WHEN "InvoiceApprovalInvoiceStatus" THEN 
        RUN sys/inc/addnk1.p (
            INPUT cocode, 
            INPUT ip-nk1-value, 
            INPUT NO,                                            /* Prompt? */
    ...
    WHEN "InvoiceApprovalTaxableCheck" THEN 
        RUN sys/inc/addnk1.p (
            ...
            INPUT ip-nk1-value, 
            INPUT NO,                                            /* Prompt? */
            INPUT "Ship to is taxable and any line is not set as taxable", /* Description */
            INPUT "",                                            /* Char Value */
            INPUT 0,                                             /* Int value */
            INPUT NO,                                            /* Logical value */ 
            INPUT 0                                              /* Dec value*/
            ).  
    WHEN "FGMasterLoc" THEN 
        RUN sys/inc/addnk1.p (
            INPUT cocode, 
            INPUT ip-nk1-value, 
            INPUT NO,                                            /* Prompt? */
            INPUT "Default Warehouse and Bin, FGItem created from estimate", /* Description */
            INPUT "FGMaster",                                    /* Char Value */
            INPUT 0,                                             /* Int value */
            INPUT NO,                                            /* Logical value */ 
            INPUT 0                                              /* Dec value*/
            ).     
    ...
    WHEN "SSIssueDefaultRM" THEN    
        RUN sys/inc/addnk1.p (
            ...
            INPUT ip-nk1-value, 
            INPUT NO,           
            INPUT "Default RM Item to select",          /* Description */
            INPUT "User Select",                        /* Char Value */
            INPUT 0,                                    /* Int value */
            INPUT NO,                                   /* Logical value */ 
            INPUT 0                                     /* Dec value*/
            ).  
    WHEN "PlateFile" THEN    
        RUN sys/inc/addnk1.p (
            ...
            INPUT ip-nk1-value, 
            INPUT NO,           
            INPUT "Character Value is location of images,  Integer dictates format", /* Description */
            INPUT "",                                   /* Char Value */
            INPUT 0,                                    /* Int value */
            INPUT NO,                                   /* Logical value */ 
            INPUT 0                                     /* Dec value*/
            ).
    WHEN "APInvoiceLength" THEN    
        RUN sys/inc/addnk1.p (
            INPUT cocode, 
            INPUT ip-nk1-value, 
            INPUT NO,           
            INPUT "AP Invoice Length",                  /* Description */
            INPUT "",                                   /* Char Value */
            INPUT 0,                                    /* Int value */
            INPUT NO,                                   /* Logical value */ 
            INPUT 0                                     /* Dec value*/
            ).  
    WHEN "InvoiceApprovalOrderlineChange" THEN    
        RUN sys/inc/addnk1.p (
            INPUT cocode, 
            INPUT ip-nk1-value, 
            INPUT NO,           
            INPUT "Order line manually overridden",     /* Description */
            INPUT "",                                   /* Char Value */
            INPUT 0,                                    /* Int value */
            INPUT NO,                                   /* Logical value */ 
            INPUT 0                                     /* Dec value*/
            ). 
    WHEN "QuotePriceMatrix" THEN    
        RUN sys/inc/addnk1.p (
            INPUT cocode, 
            INPUT ip-nk1-value, 
            INPUT NO,           
            INPUT "Quote and Price Matrix",             /* Description */
            INPUT "",                                   /* Char Value */
            INPUT 0,                                    /* Int value */
            INPUT NO,                                   /* Logical value */ 
            INPUT 0                                     /* Dec value*/
            ).
    WHEN "DeleteBinsAllowed" THEN   
          RUN sys/inc/addnk1.p (
            INPUT cocode, 
            INPUT ip-nk1-value, 
            INPUT NO,           
            INPUT "Allow a prompt for user to delete bins", /* Description */
            INPUT "",                                   /* Char Value */
            INPUT 0,                                    /* Int value */
            INPUT NO,                                   /* Logical value */ 
            INPUT 0                                     /* Dec value*/
            ).             
    WHEN "QuoteExpirationDays" THEN    
        RUN sys/inc/addnk1.p (
            INPUT cocode, 
            INPUT ip-nk1-value, 
            INPUT NO,           
    ...
    WHEN "QuoteExpireDuplicates" THEN    
        RUN sys/inc/addnk1.p (
            INPUT cocode, 
            INPUT ip-nk1-value, 
            INPUT NO,           
            INPUT "Expire duplicate quotes",            /* Description */
            INPUT "",                                   /* Char Value */
            INPUT 0,                                    /* Int value */
            INPUT NO,                                   /* Logical value */ 
            INPUT 0                                     /* Dec value*/
    ...
    WHEN "APIRequestMethod" THEN    
        RUN sys/inc/addnk1.p (
            ...
            INPUT ip-nk1-value, 
            INPUT NO,           
            INPUT "Desired method to make an API call", /* Description */
            INPUT "cURL",                               /* Char Value */
            INPUT 0,                                    /* Int value */
            INPUT NO,                                   /* Logical value */ 
            INPUT 0                                     /* Dec value*/
            ). 
    WHEN "InvoiceApprovalMiscCharge" THEN    
        RUN sys/inc/addnk1.p (
            INPUT cocode, 
            INPUT ip-nk1-value, 
            INPUT NO,           
    ...
    WHEN "PriceMatrixPricingMethod" THEN     
        RUN sys/inc/addnk1.p (
            INPUT cocode, 
            INPUT ip-nk1-value, 
            INPUT NO,           
            INPUT "Global Pricing Method for determining selling prices", /* Description */
            INPUT "Up To",                             /* Char Value */
            INPUT 0,                                    /* Int value */
            INPUT NO,                                  /* Logical value */ 
            INPUT 0                                     /* Dec value*/
            ).
   WHEN "CaseLabel" THEN     
    ...
    WHEN "CEOpStandards" THEN     
        RUN sys/inc/addnk1.p (
            ...
            INPUT ip-nk1-value, 
            INPUT NO,           
            INPUT "Calc source for Machine Standards",     /* Description */
            INPUT "Estimate",                     /* Char Value */
            INPUT 0,                              /* Int value */
            INPUT NO,                             /* Logical value */ 
            INPUT 0                               /* Dec value*/
    ...
    RUN sys/inc/addnk1.p (
            ...
            INPUT ip-nk1-value, 
            INPUT NO,           
            INPUT "Ship Weight Calculation - Net or Gross (include Tare)",     /* Description */
            INPUT "Net",                             /* Char Value */
            INPUT 0,                              /* Int value */
            INPUT NO,                             /* Logical value */ 
            INPUT 0                               /* Dec value*/
            ).                        
    WHEN "JobNoLength" THEN     
    RUN sys/inc/addnk1.p (
            INPUT cocode, 
            INPUT ip-nk1-value, 
            INPUT NO,           
            INPUT "Length of JobNo in Database (6 or 9)",     /* Description */
            INPUT "",                             /* Char Value */
            INPUT 6,                              /* Int value */
            INPUT NO,                             /* Logical value */ 
            INPUT 0                               /* Dec value*/
    ...
    RUN sys/inc/addnk1.p (
            ...
            INPUT ip-nk1-value, 
            INPUT NO,           
            INPUT "Calculation Source for vendor cost", /* Description */
            INPUT "VendorCostOnly",                     /* Char Value */
            INPUT 0,                                    /* Int value */
            INPUT NO,                                   /* Logical value */ 
            INPUT 0                                     /* Dec value*/
            ).            
    ...
    RUN sys/inc/addnk1.p (
            ...
            INPUT ip-nk1-value, 
            INPUT NO, 
            INPUT "Separate Form 0", /*Description */
    ...
    RUN sys/inc/addnk1.p (
        ...
        WHEN "POPrintScores" THEN 
        RUN sys/inc/addnk1.p (
            INPUT cocode, 
            INPUT ip-nk1-value, 
            INPUT NO,                                            /* Prompt? */
            INPUT "Print scoring information on PO lines",       /* Description */
            INPUT "",                                            /* Char Value */
            INPUT 0,                                             /* Int value */
            INPUT NO,                                           /* Logical value */ 
            INPUT 0                                              /* dec value*/
        ...
        RUN sys/inc/addnk1.p (
            ...
            INPUT ip-nk1-value, 
            INPUT NO,                                            /* Prompt? */
            INPUT "Print Barcode information on job ticket",     /* Description */
            INPUT "Job Number,Job Number2,Form,Blank",           /* Char Value */
            INPUT 0,                                             /* Int value */
            INPUT NO,                                            /* Logical value */ 
            INPUT 0                                              /* dec value*/
            ).      
