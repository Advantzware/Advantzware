...
DEFINE VARIABLE tfile        AS CHARACTER INIT "c:\tmp\rptfile.txt" NO-UNDO.
DEFINE VARIABLE v-1st-page   AS LOG       NO-UNDO.
DEFINE VARIABLE v-multi-cust AS LOG       NO-UNDO.
DEFINE VARIABLE v-count      AS INTEGER   NO-UNDO.
DEFINE VARIABLE tmp-dir      AS CHARACTER NO-UNDO. 
DEFINE VARIABLE cRptFile     AS CHARACTER NO-UNDO.
...
DEFINE VARIABLE v-ddate        AS DATE      NO-UNDO.

DEFINE VARIABLE lv-program     AS CHARACTER NO-UNDO.
...
{custom/xprint.i}
DEFINE NEW SHARED VARIABLE vPrinted           AS LOG       NO-UNDO.
DEFINE NEW SHARED VARIABLE v-exc-bin          AS LOG       NO-UNDO.
DEFINE NEW SHARED VARIABLE v-print-components AS LOG       NO-UNDO.
DEFINE NEW SHARED VARIABLE s-print-part-no    AS LOG       NO-UNDO.
DEFINE NEW SHARED VARIABLE s-print-what-item  AS CHARACTER NO-UNDO.
DEFINE NEW SHARED VARIABLE s-print-loc-from   AS CHARACTER NO-UNDO.
DEFINE NEW SHARED VARIABLE s-print-loc-to     AS CHARACTER NO-UNDO.
DEFINE NEW SHARED VARIABLE s-print-bin-from   AS CHARACTER NO-UNDO.
DEFINE NEW SHARED VARIABLE s-print-bin-to     AS CHARACTER NO-UNDO.
DEFINE NEW SHARED VARIABLE s-print-pricing    AS LOG       NO-UNDO.
DEFINE NEW SHARED VARIABLE lv-spec-list       AS CHARACTER NO-UNDO.
DEFINE NEW SHARED VARIABLE s-print-spec       AS LOG       NO-UNDO .
...
DEFINE BUFFER b-oe-relh FOR oe-relh.
{oe/oe-relp1.i NEW}
...
RUN epCanAccess IN hPgmSecurity ("oerep/r-relprt.w","", OUTPUT lResult).
...
/* gdm - 02020902 */
DEFINE VARIABLE v-hldflg              AS LOG       NO-UNDO.
...
tgMultipleReleases tb_post-rel run_format tbAutoClose btn-ok btn-cancel 
...
tb_whs-bin-sort rd-dest tgMultipleReleases tb_post-rel run_format ~
tbAutoClose 
...
DEFINE FRAME FRAME-A
    begin_cust-no AT ROW 1.76 COL 30.4 COLON-ALIGNED HELP
    "Enter Beginning Customer Number"
    end_cust-no AT ROW 1.76 COL 73.4 COLON-ALIGNED HELP
    "Enter Ending Customer Number"
    tb_excl_cust AT ROW 2.86 COL 32.4 WIDGET-ID 8
    begin_relnum AT ROW 3.57 COL 30.4 COLON-ALIGNED HELP
    "Enter Beginning Release Number"
    end_relnum AT ROW 3.57 COL 73.4 COLON-ALIGNED HELP
    "Enter Ending Release Number"
    begin_ord-no AT ROW 4.52 COL 30.4 COLON-ALIGNED HELP
    "Enter Beginning Order Number"
    end_ord-no AT ROW 4.52 COL 73.4 COLON-ALIGNED HELP
    "Enter Ending Order Number"
    begin_date AT ROW 5.48 COL 30.4 COLON-ALIGNED HELP
    "Enter Beginning Date"
    end_date AT ROW 5.48 COL 73.4 COLON-ALIGNED HELP
    "Enter Ending Date"
    begin_del-zone AT ROW 6.43 COL 30.4 COLON-ALIGNED HELP
    "Enter Beginning Delivery Zone"
    end_del-zone AT ROW 6.43 COL 73.4 COLON-ALIGNED HELP
    "Enter Ending Delivery zone"
    begin_whse AT ROW 7.38 COL 30.4 COLON-ALIGNED HELP
    "Enter Beginning Location" WIDGET-ID 4
    end_whse AT ROW 7.38 COL 73.4 COLON-ALIGNED HELP
    ...
    fi_specs AT ROW 8.86 COL 73.2 COLON-ALIGNED HELP
    "Enter Spec Code separated by commas" NO-LABELS WIDGET-ID 12
    tb_posted AT ROW 9.48 COL 35 RIGHT-ALIGNED
    tb_more AT ROW 10.33 COL 6
    rd-print-what AT ROW 10.38 COL 53 NO-LABELS
    ...
    end_loc AT ROW 14.19 COL 78 COLON-ALIGNED NO-LABELS
    tb_prt-part-no AT ROW 14.62 COL 6
    begin_loc-bin AT ROW 15.38 COL 60 COLON-ALIGNED
    end_loc-bin AT ROW 15.38 COL 78 COLON-ALIGNED NO-LABELS
    tb_pricing AT ROW 15.48 COL 6
    tb_whs-bin-sort AT ROW 16.33 COL 6
    lv-font-no AT ROW 18.14 COL 38 COLON-ALIGNED
    lv-ornt AT ROW 18.14 COL 48 NO-LABELS
    lines-per-page AT ROW 18.14 COL 91 COLON-ALIGNED
    rd-dest AT ROW 18.24 COL 4.6 NO-LABELS
    lv-font-name AT ROW 19.29 COL 33.2 COLON-ALIGNED NO-LABELS
    tgMultipleReleases AT ROW 20.43 COL 64 HELP
    "parm" WIDGET-ID 2
    tb_post-rel AT ROW 21.14 COL 64
    run_format AT ROW 22.24 COL 62 COLON-ALIGNED WIDGET-ID 12
    td-show-parm AT ROW 22.29 COL 31.6
    tbAutoClose AT ROW 23.76 COL 31.6 WIDGET-ID 64
    btn-ok AT ROW 24.76 COL 31.4
    btn-cancel AT ROW 24.76 COL 53.2
...
ASSIGN 
    begin_del-zone:PRIVATE-DATA IN FRAME FRAME-A = "parm".
...
ASSIGN 
    end_del-zone:PRIVATE-DATA IN FRAME FRAME-A = "parm".
...
ASSIGN 
    rd-print-what:PRIVATE-DATA IN FRAME FRAME-A = "parm".

ASSIGN 
    tb_excl_cust:PRIVATE-DATA IN FRAME FRAME-A = "parm".

/* SETTINGS FOR TOGGLE-BOX tb_exl-tg-bin IN FRAME FRAME-A
   NO-ENABLE                                                            */
ASSIGN 
    tb_exl-tg-bin:PRIVATE-DATA IN FRAME FRAME-A = "parm".

ASSIGN 
    tb_more:PRIVATE-DATA IN FRAME FRAME-A = "parm".

ASSIGN 
    tb_p-bin:PRIVATE-DATA IN FRAME FRAME-A = "parm".

ASSIGN 
    tb_post-rel:PRIVATE-DATA IN FRAME FRAME-A = "parm".
...
ASSIGN 
    ...
    tb_print-qty-uom:PRIVATE-DATA IN FRAME FRAME-A = "parm".
...
ASSIGN 
    ...
    tb_sort-rel:PRIVATE-DATA IN FRAME FRAME-A = "parm".

ASSIGN 
    tb_zone-p:PRIVATE-DATA IN FRAME FRAME-A = "parm".

ASSIGN 
    tb_zone-s:PRIVATE-DATA IN FRAME FRAME-A = "parm".
...
ON CHOOSE OF btn-ok IN FRAME FRAME-A /* OK */
    DO:
        ...
        DEFINE VARIABLE v-num-custs AS INTEGER NO-UNDO.
        ASSIGN 
            v-1st-page   = YES
            v-multi-cust = NO
        ...
        IF v-hldflg THEN
        DO TRANSACTION:
            IF (begin_relnum:SCREEN-VALUE EQ end_relnum:SCREEN-VALUE) THEN 
            DO:
        ...
        FOR EACH b-oe-relh FIELDS(company cust-no ship-id r-no release#) WHERE
            ...
            DO:
                ...
                IF AVAILABLE sys-ctrl-shipto AND NOT lAsiUser THEN
                DO:
...
ON HELP OF run_format IN FRAME FRAME-A /* Format */
    DO:
        ...
        IF v-relprint NE run_format:SCREEN-VALUE THEN 
        DO:
            ASSIGN 
                v-relprint    = run_format:SCREEN-VALUE
...
ON LEAVE OF run_format IN FRAME FRAME-A /* Format */
    DO:
        ...
        IF v-relprint NE run_format THEN 
        DO:
            ASSIGN 
                v-relprint    = run_format
                vcDefaultForm = v-relprint.
            RUN  pRunFormatValueChanged .
        END.
    END.
...
ON VALUE-CHANGED OF tb_p-bin IN FRAME FRAME-A /* Print Bin Locations? */
    DO:
        ASSIGN {&self-name}.
        IF LOOKUP(v-relprint,"HOPX,ACPI,RFC,Fibrex,Accord,Carded,Loylang,PremierX,Relprint 10,Relprint 15,Henry,Lakeside,Distributor,Frank,CSC-GA,Protagon,CardedX,Peachtree,Multicell,CCC,Soule,StClair,Midwest,CardedX2,Portugese") > 0 THEN 
        DO:
            IF tb_p-bin THEN
            DO:
                IF v-relprint = "PremierX" OR v-relprint = "Relprint 10" OR v-relprint = "Relprint 15" OR v-relprint = "Lakeside" OR v-relprint = "Distributor" OR v-relprint = "Frank" OR v-relprint = "NSTOCK" OR v-relprint = "Axis"
    ...
    DO:
        ...
        DO:
            IF tb_posted:SCREEN-VALUE NE ""                         AND
                ...
                AND oe-relh.release# EQ begin_relnum) THEN 
            DO:
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    DO WITH FRAME {&FRAME-NAME}:
        ...
        IF tb_excl_cust:SCREEN-VALUE EQ "Yes" THEN 
        DO:
            IF custcount NE "" AND ou-log THEN
                cCustList =  custcount .
        END.
        ...
        IF AVAILABLE sys-ctrl THEN  ASSIGN v-hldflg = sys-ctrl.log-fld.
        ...
        DO:
            ASSIGN 
                begin_date:SCREEN-VALUE = STRING("01/01/" + substring(STRING(v-ddate),7,4)) 
    ...
    ELSE 
        RUN_format:SCREEN-VALUE IN FRAME FRAME-A = v-relprint .
...
PROCEDURE check-4-hold :
    /*------------------------------------------------------------------------------
      ...
      Notes:       
    ------------------------------------------------------------------------------*/
    DEFINE OUTPUT PARAMETER op-flg AS LOG NO-UNDO.
    ...
    FIND FIRST sys-ctrl NO-LOCK
        WHERE sys-ctrl.company EQ cocode
        AND sys-ctrl.name EQ "RELCREDT" NO-ERROR.
    IF AVAILABLE sys-ctrl AND sys-ctrl.log-fld AND oe-relh.w-ord THEN
        op-flg = YES.
...
PROCEDURE createXMLRelease :
    ...
    DEFINE VARIABLE cXMLFieldList  AS CHARACTER NO-UNDO.
    DEFINE VARIABLE cXMLFieldLabel AS CHARACTER NO-UNDO.
    DEFINE VARIABLE cXMLOutput     AS CHARACTER NO-UNDO.
...
PROCEDURE enable_UI :
    ...
    ENABLE RECT-6 RECT-7 RECT-9 begin_cust-no end_cust-no tb_excl_cust 
        ...
        rd-print-what tb_p-bin tb_zone-s tb_zone-p tb_print-component 
        begin_loc end_loc begin_loc-bin end_loc-bin tb_whs-bin-sort rd-dest 
        tgMultipleReleases tb_post-rel run_format tbAutoClose btn-ok 
        btn-cancel 
        WITH FRAME FRAME-A IN WINDOW C-Win.
...
PROCEDURE new-relnum :
    ...
    DO WITH FRAME {&FRAME-NAME}:
        IF INT(begin_relnum:SCREEN-VALUE) NE 0                            AND
            INT(begin_relnum:SCREEN-VALUE) EQ INT(end_relnum:SCREEN-VALUE) THEN 
        DO:
            FIND FIRST oe-relh NO-LOCK
                WHERE oe-relh.company  EQ cocode
...
PROCEDURE post-releases :
    ...
    DEFINE VARIABLE v-first-release AS LOG NO-UNDO.
    DEFINE VARIABLE v-royal         AS LOG NO-UNDO.
...
PROCEDURE pRunAPIOutboundTrigger :
    ...
    IF AVAILABLE ipbf-oe-relh THEN 
    DO:
        IF iplReprint THEN 
        ...
        FOR EACH bf-oe-rell NO-LOCK 
            ...
            IF FIRST-OF(bf-oe-rell.r-no) THEN 
            DO:
                ASSIGN 
                    cAPIID       = "SendRelease"
            ...
            IF FIRST-OF(bf-oe-rell.i-no) THEN 
            DO:
                ASSIGN 
...
PROCEDURE pRunFormatValueChanged :
    ...
    DO WITH FRAME {&FRAME-NAME}:
        ...
        ELSE
            IF LOOKUP(v-relprint,"HOPX,ACPI,RFC,Fibrex,Accord,Loylang,PremierX,Relprint 10,Relprint 15,Henry,Lakeside,Distributor,Frank,Axis,CSC-GA,Protagon,CardedX,Peachtree,Multicell,CCC,Soule,StClair,Midwest,CardedX2,Portugese") > 0 THEN   /* NSTOCK,*/
                ASSIGN rd-print-what:sensitive = YES
        ...
        IF v-relprint = "Relprint 10" OR v-relprint = "Relprint 15" OR v-relprint = "Henry" THEN
            ASSIGN 
...
PROCEDURE run-report :
    ...
    IF LOOKUP(v-relprint,"Hopx,ACPI,RFC,Fibrex,Accord,Metro,Carded,Loylang,PremierX,PremTarget,Relprint 10,Relprint 15,Henry,Lakeside,Distributor,Frank,NSTOCK,Axis,CSC-GA,Protagon,CardedX,Peachtree,Multicell,CCC,Soule,StClair,Midwest,CardedX2,Portugese") > 0 AND
    ...
    DO WITH FRAME {&FRAME-NAME} TRANSACTION:
        ...
        IF AVAILABLE oe-relh AND NOT AVAILABLE oe-bolh THEN
            MESSAGE "Please enter new Release Date:"
                UPDATE oe-relh.rel-date FORMAT "99/99/9999".

        IF AVAILABLE oe-relh AND oe-relh.rel-date NE v-date THEN 
        DO:
            FOR EACH oe-rell
                WHERE oe-rell.company EQ cocode
                AND oe-rell.r-no    EQ oe-relh.r-no
    ...
    IF IS-xprint-form AND (v-1st-page OR v-multi-cust = NO) THEN 
    DO:
        v-1st-page = NO.
        CASE rd-dest:
            WHEN 1 THEN 
    ...
    IF AVAILABLE oe-relh AND v-posted AND oe-relh.rel-date EQ v-date THEN 
    DO TRANSACTION:
        oe-relh.posted = YES.
    END.
                        ...
                        ELSE
                            ...
                            ELSE
                                ...
                                ELSE
                                    ...
                                    IF v-relprint EQ "relprint 15" THEN
                                        ASSIGN
                                            lv-program     = "oe/rep/relxprnt15.p"
                                            lines-per-page = 80
                                            is-xprint-form = YES  . /*60*/
                                    ELSE

                                    IF v-relprint EQ "Henry" THEN
                                        ASSIGN
                                            lv-program     = "oe/rep/relhenry.p"
                                            lines-per-page = 75
                                            is-xprint-form = YES  . /*60*/        
                                        ...
                                        ELSE
                                            ...
                                            ELSE
                                                ...
                                                ELSE IF v-relprint EQ "Xprint2" OR  v-relprint EQ "relprint 2" THEN
                                                    ...
                                                    ELSE IF v-relprint EQ "Sonoco" THEN 
                                                        DO:
                                                            ASSIGN 
                                                                lines-per-page = 75
                                                                is-xprint-form = YES
                                                                                                                                                                        ...
                                                                                                                                                                        ELSE IF v-relprint EQ "Allwest" THEN
                                                                                                                                                                            ...
                                                                                                                                                                            ELSE IF v-relprint EQ "CCC" THEN
                                                                                                                                                                                    ASSIGN lv-program     = "oe/rep/relccc.p"
                                                                                                                                                                                        ...
                                                                                                                                                                                        is-xprint-form = YES  . 
                                                                                                                                                                                /* gdm - 10080912*/
                                                                                                                                                                                ELSE IF v-relprint EQ "Rosmar" THEN 
                                                                                                                                                                                    DO:
                                                                                                                                                                                        ASSIGN 
                                                                                                                                                                                            lines-per-page = 75
                                                                                                                                                                                            is-xprint-form = YES
                                                                                                                                                                                    ...
                                                                                                                                                                                    END.
                                                                                                                                                                                    /* gdm - 09220907 */
                                                                                                                                                                                    ELSE IF v-relprint EQ "Loylang" THEN 
                                                                                                                                                                                        DO:  
                                                                                                                                                                                            ASSIGN
