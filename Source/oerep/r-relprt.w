...
ON VALUE-CHANGED OF tb_p-bin IN FRAME FRAME-A /* Print Bin Locations? */
    DO:
        ASSIGN {&self-name}.
        IF LOOKUP(v-relprint,"HOPX,ACPI,RFC,Fibrex,Accord,Carded,Loylang,PremierX,Relprint 10,Lakeside,Distributor,Frank,CSC-GA,Protagon,CardedX,Peachtree,Multicell,CCC,Soule,StClair,Midwest,CardedX2,Henry") > 0 THEN 
        DO:
            IF tb_p-bin THEN
            DO:
                IF v-relprint = "PremierX" OR v-relprint = "Relprint 10" OR v-relprint = "Lakeside" OR v-relprint = "Distributor" OR v-relprint = "Frank" OR v-relprint = "NSTOCK" OR v-relprint = "Axis"
                    ...
                    OR v-relprint = "NStock"  /*OR v-relprint = "Prystup"*/ OR v-relprint = "StClair" OR v-relprint = "Midwest" OR v-relprint = "Henry" THEN
...
PROCEDURE pRunFormatValueChanged :
    ...
    DO WITH FRAME {&FRAME-NAME}:
        ...
        ELSE
            IF LOOKUP(v-relprint,"HOPX,ACPI,RFC,Fibrex,Accord,Loylang,PremierX,Relprint 10,Lakeside,Distributor,Frank,Axis,CSC-GA,Protagon,CardedX,Peachtree,Multicell,CCC,Soule,StClair,Midwest,CardedX2,Henry") > 0 THEN   /* NSTOCK,*/
                ASSIGN rd-print-what:sensitive = YES
        ...
        IF v-relprint = "Relprint 10" OR v-relprint = "Henry" THEN
            ASSIGN 
...
PROCEDURE run-report :
    ...
    IF LOOKUP(v-relprint,"Hopx,ACPI,RFC,Fibrex,Accord,Metro,Carded,Loylang,PremierX,PremTarget,Relprint 10,Lakeside,Distributor,Frank,NSTOCK,Axis,CSC-GA,Protagon,CardedX,Peachtree,Multicell,CCC,Soule,StClair,Midwest,CardedX2,Henry") > 0 AND
                                                                                                                                                                                    ...
                                                                                                                                                                                    ELSE IF v-relprint EQ "Loylang" THEN 
                                                                                                                                                                                        DO:  
                                                                                                                                                                                            ASSIGN
                                                                                                                                                                                                ...
                                                                                                                                                                                                is-xprint-form = YES  . /*60*/
                                                                                                                                                                                        END.
                                                                                                                                                                                        ELSE IF v-relprint EQ "Henry" THEN
                                                                                                                                                                                            ASSIGN
