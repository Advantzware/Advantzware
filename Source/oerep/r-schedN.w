...
DEFINE VARIABLE tb_prt-qoh          AS LOGICAL   NO-UNDO.
DEFINE VARIABLE tb_prt-last         AS LOGICAL   NO-UNDO.
...
DEFINE VARIABLE v-lst-m-code        AS CHARACTER NO-UNDO.
...
ASSIGN cTextListToSelect = "Job Qty OH,Tot Qty OH,Customer Name,Ship To,PO#,Order#,Rel#,Item,Description," +  /*9*/
                           ...
                           "Last Ship Date,Price,Price UOM,Remaining routing,Dock Appointment,Pallet Count Quantity,Estimated FG Weight,Actual FG Weight,Total # of Pallets (FG),Order Qty Invoiced"                           
           ...
           cFieldListToSelect = "w-ord.onh-qty,w-ord.tot-qty,w-ord.cust-name,w-ord.ship-id,w-ord.po-num,w-ord.ord-no,w-ord.rel-no,w-ord.i-no,w-ord.i-name," +
                                ...
                                "last-date,w-ord.price,w-ord.pr-uom,remaining-routing,dock-appointment,pallet-count-quantity,est-wt-per-ton,act-wt-per-ton,iTotalPallet,w-ord.t-inv-qty"
           cFieldLength = "10,10,15,8,15,8,6,15,15," + "11,8,9,7,11,13,8,13,14,8,9,15," + "8,4,13,35,8,11," + "11,10,10,10,12,5,11,11,11,20," + "7,12,30,30,15,12,15,30,10,5,12,11,9," + "13,15,10,14,15,9,10,16,14,7,18," + 
                          "14,9,30,10,11,13,30,6,14,15," + "15,15,10,35,20,23,19,16,23,19"
           cFieldType = "i,i,c,c,c,i,i,c,c," + "i,c,c,c,i,i,i,c,i,c,c,c," + "c,c,c,c,i,i," + "c,c,c,c,i,c,i,i,c,c,"  + "c,c,c,c,c,c,c,c,c,c,c,c,i," + "c,c,c,c,c,c,c,c,c,c,c," +
                        "i,c,c,i,c,c,c,c,i,i," + "c,i,c,c,c,c,i,i,i,i"
           .
...
&Scoped-Define ENABLED-OBJECTS tb_cust-list btnCustList begin_cust-no ~
...
end_cat begin_shipfrom end_shipfrom begin_csr end_csr tb_scheduled tb_late ~
...
sl_selected rd-dest td-show-parm tb_OpenCSV fi_file btn-ok btn-cancel ~
...
tb_invoiceable tb_actual tb_backordered tb_posted tb_invoice tb_completed ~
rd_printOnhand rd_sort tb_subt tb_neg-avail tb_oh-rlqty tb_notes begin_spec ~
end_spec tb_stats sl_avail sl_selected rd-dest td-show-parm tb_OpenCSV ~
...
DEFINE VARIABLE rd_printed AS CHARACTER INITIAL "All" 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "Yes", "Yes",
"No", "No",
...
DEFINE FRAME FRAME-A
     ...
     rd-dest AT ROW 26.22 COL 10 NO-LABEL WIDGET-ID 16
     ...
     tb_OpenCSV AT ROW 28.38 COL 97.8 RIGHT-ALIGNED WIDGET-ID 62
     ...
     " Selection Parameters" VIEW-AS TEXT
          SIZE 21.2 BY .71 AT ROW 1 COL 5.8 
     ...
     " Output Destination" VIEW-AS TEXT
          SIZE 19 BY .76 AT ROW 25.54 COL 5.8 WIDGET-ID 88
     "Printed Status?" VIEW-AS TEXT
          SIZE 15 BY .62 AT ROW 14.67 COL 8.4 WIDGET-ID 168
     RECT-6 AT ROW 25.9 COL 5 WIDGET-ID 40
...
ASSIGN 
       rd_printed:PRIVATE-DATA IN FRAME FRAME-A     = 
                "parm".
...
&Scoped-define SELF-NAME rd_printed
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL rd_printed C-Win
ON VALUE-CHANGED OF rd_printed IN FRAME FRAME-A
DO:
  IF rd_sort:SCREEN-VALUE NE "Customer#" THEN tb_subt:SCREEN-VALUE = "no".
END.
...
------------------------------------------------------------------------------*/
  DISPLAY tb_cust-list begin_cust-no end_cust-no begin_ord-no end_ord-no 
          ...
          end_date begin_carr end_carr begin_cat end_cat begin_shipfrom 
          ...
          tb_OpenCSV fi_file lbl-print-2 rd_printed tbAutoClose 
  ...
  ENABLE tb_cust-list btnCustList begin_cust-no end_cust-no begin_ord-no 
         ...
         begin_date end_date begin_carr end_carr begin_cat end_cat 
         begin_shipfrom end_shipfrom begin_csr end_csr tb_scheduled tb_late 
         ...
         Btn_Remove btn_Up btn_down sl_selected rd-dest td-show-parm tb_OpenCSV 
...
------------------------------------------------------------------------------*/
  DO WITH FRAME {&FRAME-NAME}:
      ...
      ELSE 
       ...
       .
     ASSIGN fi_file:SCREEN-VALUE = "c:\tmp\r-sched.csv".
  END.
