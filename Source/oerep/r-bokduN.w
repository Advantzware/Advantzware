...
DEFINE FRAME FRAME-A
     ...
     td-show-parm AT ROW 18.19 COL 37.8
     fi_file AT ROW 19.1 COL 26.8 COLON-ALIGNED HELP
          "Enter File Name"
     tb_OpenCSV AT ROW 19.14 COL 87 RIGHT-ALIGNED
...
display "" with frame r-top.
    ...
    DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
       cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
            ...
            IF cTmpField = "due-dt" THEN cExcelVarValue = IF oe-ordl.req-date NE ? THEN DYNAMIC-FUNCTION("sfFormat_Date",oe-ordl.req-date) ELSE "" .
...
------------------------------------------------------------------------------*/
  DO WITH FRAME {&FRAME-NAME}:
     ...
     ASSIGN fi_file:SCREEN-VALUE = "c:\tmp\r-bookdu.csv".  
  END.
