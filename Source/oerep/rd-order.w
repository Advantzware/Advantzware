...
DEFINE INPUT PARAMETER pcPartFrom AS CHARACTER NO-UNDO.
DEFINE INPUT PARAMETER pcPartTo   AS CHARACTER NO-UNDO.
DEFINE INPUT PARAMETER piOrderFrom AS INTEGER NO-UNDO.
DEFINE INPUT PARAMETER piOrderTo   AS INTEGER NO-UNDO.
...
ASSIGN 
    cTextListToSelect  = "Order#,Customer#,Order Date,FG Item#,Cust Part#,Item Name,Cust PO#,Ordered Qty,Prod. Qty," +
    ...
    cFieldLength       = "15,15,15,20,32,30,15,15,20," + "15,15,15,20,15,30,15,15,20," + "15,15,15,20,15,30,15,15,20," + "15,15,15,20,15,30,15,8,16,18," + "18,9,30,15,15,15,15"
...
tb_print-del sl_avail sl_selected fi_file tb_OpenCSV tbAutoClose 
...
DEFINE VARIABLE fi_file        AS CHARACTER FORMAT "X(45)" INITIAL "c:~\tmp~\OrderMaintenance.csv" 
    LABEL "Name" 
...
DEFINE FRAME Dialog-Frame
    RS-open-closed AT ROW 2 COL 41.2 NO-LABELS WIDGET-ID 2
    RS-ord-stat AT ROW 3.14 COL 41.2 NO-LABELS WIDGET-ID 120
    begin_cust-no AT ROW 4.48 COL 29.8 COLON-ALIGNED HELP
    "Enter Beginning Customer Number" WIDGET-ID 6
    end_cust-no AT ROW 4.48 COL 72.8 COLON-ALIGNED HELP
    "Enter Ending Customer Number" WIDGET-ID 16
    begin_item AT ROW 5.62 COL 29.8 COLON-ALIGNED HELP
    "Enter Beginning Customer Number" WIDGET-ID 100
    end_item AT ROW 5.62 COL 72.8 COLON-ALIGNED HELP
    "Enter Beginning Customer Number" WIDGET-ID 102
    begin_part AT ROW 6.76 COL 29.8 COLON-ALIGNED HELP
    "Enter Beginning Customer Number" WIDGET-ID 104
    end_part AT ROW 6.76 COL 72.8 COLON-ALIGNED HELP
    "Enter Beginning Customer Number" WIDGET-ID 106
    begin_order AT ROW 7.91 COL 29.8 COLON-ALIGNED HELP
    "Enter Beginning Customer Number" WIDGET-ID 108
    end_order AT ROW 7.91 COL 72.8 COLON-ALIGNED HELP
    "Enter Beginning Customer Number" WIDGET-ID 110
    end_date AT ROW 9 COL 72.8 COLON-ALIGNED HELP
    "Enter Beginning Customer Number" WIDGET-ID 114
    begin_date AT ROW 9.05 COL 29.8 COLON-ALIGNED HELP
    "Enter Beginning Customer Number" WIDGET-ID 112
    begin_reldt AT ROW 10.05 COL 29.8 COLON-ALIGNED HELP
    "Enter Beginning Customer Number" WIDGET-ID 116
    end_reldt AT ROW 10.14 COL 72.8 COLON-ALIGNED HELP
    "Enter Beginning Customer Number" WIDGET-ID 118
    begin_shipfrom AT ROW 11.19 COL 29.8 COLON-ALIGNED HELP
    "Enter starting ship from location." WIDGET-ID 158
    end_shipfrom AT ROW 11.24 COL 72.8 COLON-ALIGNED HELP
    "Enter ending ship from location." WIDGET-ID 160
    tb_print-del AT ROW 12.81 COL 35.8
    sl_avail AT ROW 15.29 COL 4.4 NO-LABELS WIDGET-ID 26
    sl_selected AT ROW 15.29 COL 62.4 NO-LABELS WIDGET-ID 28
    Btn_Add AT ROW 15.76 COL 42.2 HELP
    "Add Selected Table to Tables to Audit" WIDGET-ID 32
    Btn_Remove AT ROW 16.95 COL 42.2 HELP
    "Remove Selected Table from Tables to Audit" WIDGET-ID 34
    btn_Up AT ROW 18.14 COL 42.2 WIDGET-ID 40
    btn_down AT ROW 19.33 COL 42.2 WIDGET-ID 42
    fi_file AT ROW 22.48 COL 19.4 COLON-ALIGNED HELP
    "Enter File Name" WIDGET-ID 22
    tb_OpenCSV AT ROW 22.52 COL 86 RIGHT-ALIGNED WIDGET-ID 34
    tb_excel AT ROW 24.33 COL 3.6 WIDGET-ID 32
    tbAutoClose AT ROW 24.38 COL 30.2 WIDGET-ID 64
    btn-ok AT ROW 25.43 COL 30 WIDGET-ID 14
    btn-cancel AT ROW 25.43 COL 56.8 WIDGET-ID 12
    ...
    SIZE 17 BY .62 AT ROW 14.1 COL 4 WIDGET-ID 86
    RECT-6 AT ROW 14.48 COL 3 WIDGET-ID 30
    RECT-7 AT ROW 1.71 COL 3 WIDGET-ID 38
    RECT-8 AT ROW 21.71 COL 3 WIDGET-ID 84
    SPACE(1.99) SKIP(2.76)
...
ASSIGN 
    begin_reldt:PRIVATE-DATA IN FRAME Dialog-Frame = "parm".

ASSIGN 
    begin_shipfrom:PRIVATE-DATA IN FRAME Dialog-Frame = "parm".
...
ASSIGN 
    end_reldt:PRIVATE-DATA IN FRAME Dialog-Frame = "parm".

ASSIGN 
    end_shipfrom:PRIVATE-DATA IN FRAME Dialog-Frame = "parm".
...
ON LEAVE OF begin_shipfrom IN FRAME Dialog-Frame /* Beginning Ship From WH */
    DO:
        ASSIGN {&self-name}.
    END.
...
ON LEAVE OF end_shipfrom IN FRAME Dialog-Frame /* Ending Ship From WH */
    DO:
        ASSIGN {&self-name}.
    END.
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    DO WITH FRAME {&FRAME-NAME}:
        ...
        ASSIGN 
            RS-ord-stat:SCREEN-VALUE = "1" .

        fi_file:SCREEN-VALUE = "c:\tmp\OrderMaintenance.csv".
...
PROCEDURE run-report :
    ...
    FOR EACH oe-ordl NO-LOCK WHERE 
        ...
        FIND FIRST sman
            ...
            NO-LOCK NO-ERROR.
        IF AVAILABLE sman THEN ASSIGN vsman  = sman.sman 
                vsname = sman.sname.
        ...
        FOR EACH tt-report
            ...
            cShipName = IF AVAILABLE shipto THEN shipto.ship-name ELSE "" .         
            ...
            DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
                ...
                DO:         
                    CASE cTmpField:
                        ...
                        WHEN "v-bal" THEN 
                            cVarValue = STRING(v-bal). 
                        WHEN "case-count" THEN 
                            cVarValue = STRING(v-case-count). 
                        WHEN "pallet-count" THEN 
                            cVarValue = STRING(v-pallet-count).
                        ...
                        WHEN "pct" THEN 
                            cVarValue = STRING(v-pct).
                        WHEN "sman" THEN 
                            cVarValue = STRING(vsman).
                        WHEN "sname" THEN 
