...
&Scoped-Define ENABLED-OBJECTS RECT-1 RECT-2 list-order begin_rejct-cd ~
end_rejct-cd 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_rejct-cd ~
begin_rejct-cd_dscr end_rejct-cd end_rejct-cd_dscr F1 F-2 F-3 F-4 
...
DEFINE VARIABLE begin_rejct-cd AS CHARACTER FORMAT "X(2)" 
     LABEL "Beginning  Rejection Code" 
     VIEW-AS FILL-IN 
     SIZE 5 BY 1.

DEFINE VARIABLE begin_rejct-cd_dscr AS CHARACTER FORMAT "X(30)" 
     LABEL "Beginning Description" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE end_rejct-cd AS CHARACTER FORMAT "X(2)" 
     LABEL "Ending Rejection Code" 
     VIEW-AS FILL-IN 
     SIZE 5 BY 1.

DEFINE VARIABLE end_rejct-cd_dscr AS CHARACTER FORMAT "X(30)" 
...
DEFINE FRAME F-Main
     ...
     begin_rejct-cd AT ROW 4.81 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Rejection Code"
     begin_rejct-cd_dscr AT ROW 6 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Description"
     end_rejct-cd AT ROW 8.14 COL 45 COLON-ALIGNED HELP
          "Enter Ending Rejection Code"
     end_rejct-cd_dscr AT ROW 9.33 COL 45 COLON-ALIGNED HELP
          "Enter Ending Description"
     F1 AT ROW 4.81 COL 52 NO-LABEL
     F-2 AT ROW 6 COL 91 NO-LABEL
     F-3 AT ROW 8.14 COL 52 NO-LABEL
...
/* SETTINGS FOR FILL-IN begin_rejct-cd_dscr IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN end_rejct-cd_dscr IN FRAME F-Main
   NO-ENABLE                                                            */
