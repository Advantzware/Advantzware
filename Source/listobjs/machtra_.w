...
DEFINE FRAME F-Main
     ...
     selected-company AT ROW 4.57 COL 50 COLON-ALIGNED
     begin_machine AT ROW 6.24 COL 50 COLON-ALIGNED HELP
          "Enter Beginning Machine"
     end_machine AT ROW 7.91 COL 50 COLON-ALIGNED HELP
          "Enter Ending Machine"
     show-employees AT ROW 9.81 COL 52 HELP
          "Select to Show Employee Transactions"
     F1 AT ROW 6.24 COL 68 NO-LABEL
     F-3 AT ROW 7.91 COL 68 NO-LABEL
...
ASSIGN 
       show-employees:PRIVATE-DATA IN FRAME F-Main     = 
                "save".
