...
/*------------------------------------------------------------------------
  ...
  File: listobjs/stylef_.w

  Description: Folding Styles List
...
DEFINE FRAME FRAME-A
    begin_style AT ROW 2.71 COL 31.6 COLON-ALIGNED HELP
    "Enter Begining Style"
    end_style AT ROW 2.71 COL 66 COLON-ALIGNED HELP
    "Enter Ending Style"
    printScore AT ROW 3.86 COL 33.6 HELP
    "Select to Print Score Values"
    printDesign AT ROW 5.05 COL 33.6 HELP
    "Select to Print 2D Design Image"
    rd-dest AT ROW 7.43 COL 4.8 NO-LABELS
    lv-font-no AT ROW 7.43 COL 36 COLON-ALIGNED
    lv-ornt AT ROW 7.43 COL 45 NO-LABELS
    lines-per-page AT ROW 7.43 COL 87 COLON-ALIGNED
    lv-font-name AT ROW 8.67 COL 29 COLON-ALIGNED NO-LABELS
    tb_batch AT ROW 10.24 COL 60
    td-show-parm AT ROW 10.86 COL 29
    tbAutoClose AT ROW 12.19 COL 29 WIDGET-ID 64
    btn-ok AT ROW 13.14 COL 28.8
    btn-cancel AT ROW 13.14 COL 54.8
    "Output Destination" VIEW-AS TEXT
    SIZE 18 BY .62 AT ROW 6.71 COL 3
    " Selection Parameters" VIEW-AS TEXT
    SIZE 21 BY .71 AT ROW 1.48 COL 4
    RECT-7 AT ROW 1.95 COL 3
    RECT-8 AT ROW 7.19 COL 3
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
    CREATE WINDOW C-Win ASSIGN
        HIDDEN             = YES
        TITLE              = "Folding Style Box Design List"
        HEIGHT             = 13.76
        WIDTH              = 94.6
        MAX-HEIGHT         = 15.24
        MAX-WIDTH          = 95.8
...
ON END-ERROR OF C-Win /* Folding Style Box Design List */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Folding Style Box Design List */
    DO:
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    RUN enable_UI.
    {sys/inc/reportsConfigNK1.i "EB2" }
    ASSIGN
