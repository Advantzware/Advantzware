...
&Scoped-Define ENABLED-OBJECTS RECT-1 list-order RECT-2 begin_prgmname ~
end_prgmname 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_prgmname ~
begin_prgrms_prgtitle end_prgmname end_prgrms_prgtitle F1 F-2 F-3 F-4 
...
DEFINE VARIABLE begin_prgmname AS CHARACTER FORMAT "X(10)" 
     LABEL "Beginning Program Name" 
     VIEW-AS FILL-IN 
     SIZE 15.6 BY 1.

DEFINE VARIABLE begin_prgrms_prgtitle AS CHARACTER FORMAT "X(30)" 
     LABEL "Beginning Program Title" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE end_prgmname AS CHARACTER FORMAT "X(10)" 
     LABEL "Ending Program Name" 
     VIEW-AS FILL-IN 
     SIZE 15.6 BY 1.

DEFINE VARIABLE end_prgrms_prgtitle AS CHARACTER FORMAT "X(30)" 
     LABEL "Ending Program Title" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.
...
DEFINE FRAME F-Main
     ...
     begin_prgmname AT ROW 4.81 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Program Name"
     begin_prgrms_prgtitle AT ROW 6 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Program Title"
     end_prgmname AT ROW 8.14 COL 45 COLON-ALIGNED HELP
          "Enter Ending Program Name"
     end_prgrms_prgtitle AT ROW 9.33 COL 45 COLON-ALIGNED HELP
          "Enter Ending Program Title"
...
/* SETTINGS FOR FILL-IN begin_prgrms_prgtitle IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN end_prgrms_prgtitle IN FRAME F-Main
   NO-ENABLE                                                            */
