...
def {1} var v-due-date      as   char format "x(12)"                    no-undo.
...
FORM HEADER
       ...
       /*"Bin:" AT 82 v-loc-bin*/ "<P11><B>" "Job#:<P10>" AT 110  cJobNumber format "x(19)" "</B><P10>" "<C94.5>Overrun:" lv-over-run format "x(7)"   
       SKIP
       v-cus[2] AT 2 v-make-hold AT 39 "Est#:" AT 90 v-est-no  "<C93.6>Underrun:" lv-under-run FORMAT "x(7)"
       SKIP
    ...
    <U>Job Information:</U>" AT 2 
     ...
     /*  "<P12><B>Due Date: ON" AT 80 v-due-date  "</B><P10>" */
       ...
       "<P12><B>CustPart#:" AT 40 v-cp FORM "x(15)"  "</B><P10>"
       "Ord Date:" AT 91  v-ord-date "<P8>" SKIP
