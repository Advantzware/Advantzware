/* ----------------------------------------------  */
/*  cecrep/jobPreCorr.p copy of jobtickc20.p  Corrugated factory ticket  for PerCorr landscape */
/* -------------------------------------------------------------------------- */
...
{cecrep/jobprem.i}
      ...
      FOR EACH w-ef WHERE (w-ef.frm = job-hdr.frm OR est.est-type <> 8),
        ...
        PUT "<=BoxImageStart><FROM><LINE#BoxImageTR><|1>"
            ...
            "<=ItemStart><C+47><#ItemTR>"
            "<=ItemStart><R+8><#ItemBL>"
            "<=ItemStart><C+47><R+8><#ItemEnd>"
            "<=ItemTR><FROM><LINE#ItemEnd><|1>"
            "<=ItemStart><R+1><RIGHT=C+5>FG ID: <#FGItemID><RIGHT=C+17>Estimate: <#Estimate>" "<RIGHT=C+17>Job Card printed: <#Printed>"
            "<=ItemStart><R+2><RIGHT=C+5>Name: <#FGItemName>"     "<RIGHT=C+34>Our Order #: <#OrderNum>"
            "<=ItemStart><R+3><RIGHT=C+5>Desc1: <#FGItemDesc1>"   "<RIGHT=C+34>Customer PO: <#CustomerPO>"
            "<=ItemStart><R+4><RIGHT=C+5>Desc2: <#FGItemDesc2>"   "<RIGHT=C+34>Order Quantity: <#OrderQuantity>"
            "<=ItemStart><R+5><RIGHT=C+5>Style: <#Style><RIGHT=C+17>Tab: <#TabInOut>" "<RIGHT=C+17>Order Date: <#OrderDate>"
            "<=ItemStart><R+6><RIGHT=C+5>Size: <#Size><RIGHT=C+17>CAD#: <#CAD>"
            "<=ItemTR><#OrderStart>"
            "<=OrderStart><C108><#OrderTR>"
            "<=OrderStart><R+8><#OrderBL>"
            "<=OrderStart><C108><R+8><#OrderEnd>"
            
            "<=OrderStart><R+2><RIGHT=C+20><P24>Due Date:<P8> <#OrderDue>" 
            "<=OrderStart><R+4><RIGHT=C+20>   <#OrderDueDate>"
            ...
            "<=BoardStart><R+1><RIGHT=C+5>Vendor: <#VendorCode>"
            "<=BoardStart><R+1><RIGHT=C+20>PO: <#VendorPO>"
            "<=BoardStart><R+2><RIGHT=C+5>Board: <#Board>"
              "<=BoardStart><R+3><RIGHT=C+5>Sheets: <#SheetsRequired>"
              ...
              "<=BoardStart><R+8><RIGHT=C+6>Gross: "
              "<=BoardStart><R+8><RIGHT=C+8>W: <#GrossWidth> "
              "<=BoardStart><R+8><RIGHT=C+13>L: <#GrossLength>"
              "<=BoardStart><R+8><RIGHT=C+21>Out: "
              "<=BoardStart><R+8><RIGHT=C+23>W: <#OutW>"
              "<=BoardStart><R+8><RIGHT=C+26>L: <#OutL>"
              
              "<=BoardStart><R+9><RIGHT=C+6>Die: "
              "<=BoardStart><R+9><RIGHT=C+8>W: <#DieWidth> "
              "<=BoardStart><R+9><RIGHT=C+13>L: <#DieLength>"
              "<=BoardStart><R+9><RIGHT=C+21>Up: "
              "<=BoardStart><R+9><RIGHT=C+23>W: <#UpW>"
              "<=BoardStart><R+9><RIGHT=C+26>L: <#UpL>"
              "<=BoardStart><R+10><RIGHT=C+6>Blank: "
              "<=BoardStart><R+10><RIGHT=C+8>W: <#BlankWidth> "
              "<=BoardStart><R+10><RIGHT=C+13>L: <#BlankLength>"
              "<=BoardStart><R+10><RIGHT=C+21>Sq Ft: <#SqFeet>"
              
              "<=DieStart><R+1><RIGHT=C+10>Die#: <#Die>"
              "<=DieStart><R+2><RIGHT=C+10>Die Loc.: <#DieLocation>"
              "<=DieStart><R+3><RIGHT=C+10>Plate#: <#Plate>"
              "<=DieStart><R+4><RIGHT=C+10>Plate Loc.: <#PlateLocation>"
              "<=DieStart><R+5><RIGHT=C+10>Color Desc/Cert.: <#InkDescription>"
       ...
       IF v-format EQ "RFC" OR v-format EQ "Boxtech" THEN
        ...
        v-plate-loc = IF AVAILABLE xxprep THEN xxprep.loc + " " + xxprep.loc-bin ELSE "" .
         ...
         PUT "<FGColor=Blue><B>"
              ...
              "<FGColor=Blue><B><P24>"
               "<=OrderDue>"   IF AVAILABLE xoe-ord THEN STRING(xoe-ord.due-code)  ELSE "" FORMAT "x(15)"
              "<=OrderDueDate>"   IF AVAILABLE xoe-ord THEN "    " + STRING(xoe-ord.due-date) ELSE "" FORMAT "x(12)"
              "<P8></B><FGColor=Black>"
              "<B>"
             ...
             /** BUILD INK WORK FILE **/
                ...
                FOR EACH wrk-ink NO-LOCK:
                   ...
                   PUT "<=DieStart><R+" + string(5 + j) + "><RIGHT=C+5>Ink" + STRING( j) + ":<#Ink" + string(1 + j) +  "Name>" FORMAT "x(200)" 
                       "<=DieStart><R+" + string(5 + j) + "><C+14><#lbs" + string(1 + j) +  "Name>" FORMAT "x(200)"
                       "<=DieStart><R+" + string(5 + j) + "><C+23><#Pass" + string(1 + j) +  "Name>" FORMAT "x(200)".
                   ...
                   IF j EQ 5 THEN LEAVE.
                END.

                PUT "<=DieStart><R+" + STRING( 7 + j) + "><=DieTR><#PrintStart><#RoutingStart>" FORMAT "x(100)" .
        ...
        FOR EACH w-m BREAK BY w-m.dseq:
         IF w-m.dscr NE "" THEN DO:
          ...
          END.
           PUT  "<=RoutingStart><R+" + string(11) + "><#NotesStart>"  FORMAT "x(100)" .
       ...
       dJobQty  = job-hdr.qty * (IF xeb.est-type EQ 6 AND xeb.quantityPerSet GT 0 THEN xeb.quantityPerSet ELSE 1) .
          ...
          PUT "<=Start><R+38.5><#PageStart>"
              ...
              "<=PackingStart><C+25><R+9><#PackingEnd>"
              ...
              "<=PatternImageStart><R+9.5><#PatternImageBL>"
              "<=PatternImageStart><C+22><R+9.5><#PatternImageEnd>"
              "<=PatternImageStart><R+1><RIGHT=C+6>Pattern: <#PatternCode> <RIGHT=C+10>B - <#BundleCode>"
              "<=PatternImageStart><R+2><C+1><#Pattern>"
              ...
              "<=ShippingStart><R+1><RIGHT=C+21><P10>Ship To: <#ShipTo>"
              "<=ShippingStart><R+1><C88>Contact: "
              "<=ShippingStart><R+2><C+16><#ShipName>"
              "<=ShippingStart><R+2><C88><#ShipContact>"
              "<=ShippingStart><R+3><C+16><#ShipAdd1>"
              "<=ShippingStart><R+3><C88><#ShipPhone>"
              "<=ShippingStart><R+4><C+16><#ShipAdd2>"
              "<=ShippingStart><R+4><C88>Dock Hours: <#DockHours>"
              "<=ShippingStart><R+5><C+16><#ShipCityStateZip>"
              "<=ShippingStart><R+5><C88>Dock#: <#Dock>"
              "<=ShippingStart><R+6><C+16><#ShipNotes1>"
              "<=ShippingStart><R+7><C+16><#ShipNotes2>"
              "<=ShippingStart><R+8><C+16><#ShipNotes3>"
              "<=ShippingStart><R+9><C+16><#ShipNotes4>"
              "<=PackingBL><P8>"                             
              ...
              "<=BundleCode>" IF AVAILABLE xeb THEN STRING(xeb.cas-cnt) ELSE "" FORMAT "x(6)"
              "<B>"
              ...
              "<P10><=ShipTo>" v-shipto  FORMAT "x(10)"
       ...
       PAGE.
        ...
        PUT  "<C1><R1.2><#Start>"
            ...
            PUT UNFORMATTED "<=12><R+4><C3><#21><R+45><C+104><IMAGE#21=" ls-fgitem-img ">" SKIP.
            PAGE.
