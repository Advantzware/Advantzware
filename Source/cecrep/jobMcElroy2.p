/* ------------------------------------------- cecrep/jobMcElroy2.p  */
/* Job Ticket Xprint form for McElroy                                         */
/* cecrep/jobMcElroy2.p  factory ticket  for McElroy - landscape                 */
/* -------------------------------------------------------------------------- */
...
*/
  ...
  v-height = "HEIGHT: " + TRIM(STRING(xeb.tr-dep,"ZZ9.99")).
  ...
  display /*v-line[7]                 at 2 
      ...
      /*    v-rec-alf[3]              at 36     format "x(16)"
          ...
          trim(string({sys/inc/k16v.i xeb.tr-wid},">>>,>>9")) when avail xeb format "x(17)"
      /*  "     Totals"             at 36     format "x(16)"
          v-rec-alf[8]              at 55     format "x(21)"
          fill("_",13)              at 96    format "x(13)"
          fill("_",12)              at 113   format "x(12)" */
          SKIP
          ITEM.i-name AT 4 FORMAT "X(20)"  WHEN AVAIL ITEM
          v-height AT 25
