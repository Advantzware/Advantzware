...
/* Mod: Ticket - 103137 (Format Change for Order No. and Job No). */
    ...
    def {1} var v-cat           as   char format "x(5)"                    no-undo.
    ...
    FORM HEADER
           ...
           "Job#:"                         at 2
           v-job-prt
           "Overrun:"  AT 23 lv-over-run format "x(7)"       
           "Our Order#:" AT 40 v-ord-no
           "Ord Date:" AT 80  v-ord-date
           "New Item: ______" AT 109 /*v-loc */
           "Est#:" AT 2 v-est-no
            "Underrun:" AT 22 lv-under-run FORMAT "x(7)"
           "FG#:" AT 40 v-fg FORM "x(15)"
           "Due Date: " AT 80 v-due-date
           "CD Recd:  ______" AT 109 /*v-loc-bin*/  SKIP
           v-form-hdr AT 2 "CustPart#:" AT 40 v-cp FORM "x(15)" 
           "PD Recd:  ______" AT 109 SKIP
           "Slsm:" AT 2 v-sman 
           "FG Category:" AT 40 v-cat FORM "x(5)" SKIP
