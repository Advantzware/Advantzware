/* --------------------------------------------- cecrep/jobuntd2.p  */
/* cecrep/jobuntd2.p from cecrep/jobxpr2.p  factory ticket           Landscape                                        */
/* -------------------------------------------------------------------------- */
...
*/
  ...
  DISPLAY "<C2><P7><B>Prep & Packing:</B>"  "Sheets Received" AT 65
          "No. of Bundles" AT 97
         ...
         /* "Pallet ID:" xeb.tr-no when avail xeb SKIP*/
          ...
          SKIP
          "<C2>Pallet/Unit Qty:" xeb.tr-cnt when avail xeb
          ...
          fill("_",13)              at 99    format "x(13)"
          SKIP
          "<C2>Bundle Arrangement:" v-stackcode
