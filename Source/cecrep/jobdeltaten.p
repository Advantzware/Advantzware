...
FOR EACH w-ef WHERE (w-ef.frm = job-hdr.frm OR est.est-type <> 8),
    ...
    PUT "<FGColor=Blue><B>"
        ...
        "<P8></B><FGColor=Black>"
        "<=FGItemDesc1>" IF AVAILABLE xoe-ordl THEN xoe-ordl.part-dscr1 ELSE IF AVAILABLE xeb THEN  xeb.part-dscr2 ELSE "" FORMAT "x(30)" 
        "<=FGItemDesc2>" IF AVAILABLE xoe-ordl THEN xoe-ordl.part-dscr2 ELSE IF AVAILABLE xeb AND AVAILABLE bf-itemfg THEN  bf-itemfg.part-dscr2 ELSE "" FORMAT "x(30)" 
        "<B>"
