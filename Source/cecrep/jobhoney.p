        ...
        PUT 
          ...
          DO:
              ...
              DO:
                  PUT SKIP(1)
                      "<=BoxImageStart>"   .
                  PUT "<R22><P10><C39>PANEL MACHINE DIRECTION<-------  <P8>" .
...
/*              "<=SheetsReceived>"*/
       ...
       {sys/inc/roundup.i dRoundup} 
        ...
        PUT  "<C1><R1.2><#Start>"
              ...
              "<=JobLabel>Job #:"
              "<FGColor=Blue><B> "
              "<=JobNum>" TRIM(STRING(DYNAMIC-FUNCTION('sfFormat_JobFormatWithHyphen', job-hdr.job-no, job-hdr.job-no2))) FORM "X(13)"
              "</B><FGColor=Black>"
              "<P8>"
              "<=BlankLabel>Blank:"
              ...
              "<B>"
              "<=CaseCount>" IF AVAILABLE bf-eb THEN STRING(bf-eb.cas-cnt)  ELSE "" FORMAT "x(5)" 
              "<=PalletCount>" IF AVAILABLE bf-eb THEN STRING(bf-eb.tr-cnt) ELSE "" FORMAT "x(6)" 
              "</B>"
