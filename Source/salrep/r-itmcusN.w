...
DEFINE TEMP-TABLE tt-ordl NO-UNDO 
...
ASSIGN 
    cTextListToSelect  = "Customer,Cust Name,Contact Name,Phone,Fax,FG Item,Item Name,Cust PO#," +
...
{sys/inc/ttRptSel.i}
ASSIGN 
    cTextListToDefault = "Customer,Contact Name,Phone,Fax,FG Item,Cust PO#," +
...
tb_skip sl_avail sl_selected rd-dest fi_file tb_OpenCSV tbAutoClose 
...
DEFINE VARIABLE fi_file        AS CHARACTER FORMAT "X(45)" INITIAL "c:~\tmp~\SalesAnalysisByCust.csv" 
    LABEL "Name" 
...
DEFINE FRAME FRAME-A
    tb_cust-list AT ROW 1.81 COL 30 WIDGET-ID 6
    btnCustList AT ROW 1.86 COL 70.8 WIDGET-ID 8
    begin_cust-no AT ROW 2.95 COL 28 COLON-ALIGNED HELP
    "Enter Beginning Customer Number"
    end_cust-no AT ROW 2.95 COL 69 COLON-ALIGNED HELP
    "Enter Ending Customer Number"
    begin_ship AT ROW 3.91 COL 28 COLON-ALIGNED HELP
    "Enter Beginning Ship-to#"
    end_ship AT ROW 3.91 COL 69 COLON-ALIGNED HELP
    "Enter Ending Zip Code"
    begin_slsmn AT ROW 4.91 COL 28 COLON-ALIGNED HELP
    "Enter Beginning Sales Rep Number" WIDGET-ID 2
    end_slsmn AT ROW 4.91 COL 69 COLON-ALIGNED HELP
    "Enter Ending Sales Rep Number" WIDGET-ID 4
    begin_i-no AT ROW 5.91 COL 28 COLON-ALIGNED HELP
    "Enter Beginning Item Number"
    end_i-no AT ROW 5.91 COL 69 COLON-ALIGNED HELP
    "Enter Ending Customer Number"
    begin_inv-date AT ROW 6.91 COL 28 COLON-ALIGNED HELP
    "Enter Beginning Invoice Date"
    end_inv-date AT ROW 6.91 COL 69 COLON-ALIGNED HELP
    "Enter Ending Invoice Date"
    begin_po AT ROW 7.95 COL 28 COLON-ALIGNED HELP
    "Enter Beginning Po Number"
    end_po AT ROW 7.95 COL 69 COLON-ALIGNED HELP
    "Enter Ending Po#"
    lbl_cost AT ROW 9.24 COL 33 COLON-ALIGNED NO-LABELS
    rd_cost1 AT ROW 9.29 COL 43 NO-LABELS
    tb_fin-chg AT ROW 10.48 COL 22.4
    tb_skip AT ROW 10.48 COL 54 WIDGET-ID 58
    sl_avail AT ROW 12.43 COL 3 NO-LABELS WIDGET-ID 26
    Btn_Def AT ROW 12.43 COL 40.4 HELP
    "Add Selected Table to Tables to Audit" WIDGET-ID 56
    sl_selected AT ROW 12.48 COL 61.8 NO-LABELS WIDGET-ID 28
    Btn_Add AT ROW 13.43 COL 40.4 HELP
    "Add Selected Table to Tables to Audit" WIDGET-ID 32
    Btn_Remove AT ROW 14.43 COL 40.4 HELP
    "Remove Selected Table from Tables to Audit" WIDGET-ID 34
    btn_Up AT ROW 15.48 COL 40.4 WIDGET-ID 40
    btn_down AT ROW 16.48 COL 40.4 WIDGET-ID 42
    lv-font-no AT ROW 18.38 COL 34 COLON-ALIGNED
    lv-ornt AT ROW 18.38 COL 44 NO-LABELS
    lines-per-page AT ROW 18.38 COL 88 COLON-ALIGNED
    rd-dest AT ROW 18.48 COL 5 NO-LABELS
    lv-font-name AT ROW 19.57 COL 30 COLON-ALIGNED NO-LABELS
    tb_excel AT ROW 20.52 COL 93 RIGHT-ALIGNED
    td-show-parm AT ROW 20.76 COL 28.4
    fi_file AT ROW 21.62 COL 26.4 COLON-ALIGNED HELP
    "Enter File Name"
    tb_OpenCSV AT ROW 21.71 COL 93 RIGHT-ALIGNED
    tbAutoClose AT ROW 22.95 COL 28.4 WIDGET-ID 60
    btn-ok AT ROW 23.86 COL 28
    btn-cancel AT ROW 23.86 COL 55
    "Available Columns" VIEW-AS TEXT
    SIZE 29 BY .62 AT ROW 11.71 COL 3 WIDGET-ID 38
    " Selection Parameters" VIEW-AS TEXT
    SIZE 21 BY .71 AT ROW 1.1 COL 4.4
    BGCOLOR 15 
    " Output Destination" VIEW-AS TEXT
    SIZE 18 BY .62 AT ROW 17.76 COL 4.2
    "Selected Columns(In Display Order)" VIEW-AS TEXT
    SIZE 34 BY .62 AT ROW 11.71 COL 61.4 WIDGET-ID 44
...
ASSIGN 
    tb_skip:PRIVATE-DATA IN FRAME FRAME-A = "parm".
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    RUN enable_UI.
    {sys/inc/reportsConfigNK1.i "HR11" }
    ASSIGN
...
PROCEDURE run-report :
    ...
    DEFINE VARIABLE fship          AS ch        INIT "".
    DEFINE VARIABLE tship          LIKE fcust INIT "zzzzzzzz".
    ...
    DEFINE VARIABLE f-po           AS CHARACTER INIT "".
    DEFINE VARIABLE t-po           LIKE f-po INIT "zzzzzzzz".
    DEFINE VARIABLE v-inc-fc       AS LOG       INIT NO.

    DEFINE VARIABLE v-date         LIKE ar-inv.inv-date.
    DEFINE VARIABLE v-ord          LIKE ar-invl.ord-no.
    ...
    DEFINE VARIABLE v-qty          AS INTEGER   EXTENT 10.
    DEFINE VARIABLE v-amt          AS DECIMAL   EXTENT 5.
    DEFINE VARIABLE v-cst          AS DECIMAL   EXTENT 5.
    DEFINE VARIABLE v-exc          AS LOG.
    DEFINE VARIABLE v-hdr          AS CHARACTER EXTENT 10.
    ...
    DEFINE VARIABLE v-cust         LIKE cust.cust-no NO-UNDO.
    DEFINE VARIABLE v-cnam         LIKE cust.name NO-UNDO.
    DEFINE VARIABLE v-cont         LIKE cust.contact NO-UNDO.
    DEFINE VARIABLE v-phn#         LIKE cust.fax NO-UNDO.
    DEFINE VARIABLE v-fax#         LIKE cust.fax NO-UNDO.
    DEFINE VARIABLE v-i-no         LIKE itemfg.i-no NO-UNDO.
    DEFINE VARIABLE v-inam         LIKE itemfg.i-name NO-UNDO.
    DEFINE VARIABLE v-prof         AS DECIMAL   NO-UNDO.
    DEFINE VARIABLE v-cost1        AS CHARACTER NO-UNDO.
    DEFINE VARIABLE lv-r-no        LIKE oe-retl.r-no NO-UNDO.
    DEFINE VARIABLE lv-type        AS CHARACTER NO-UNDO.
    DEFINE VARIABLE v-skip-l       AS LOG       INIT NO NO-UNDO.
    DEFINE VARIABLE v-sname        AS CHARACTER EXTENT 3 NO-UNDO .
    ...
    DO WITH FRAME {&FRAME-NAME}:
        ...
        ELSE
            ASSIGN
                ...
                .
        ASSIGN 
            fi_file:SCREEN-VALUE = "c:\tmp\SalesAnalysisByCust.csv".   
    END.
