...
DEFINE FRAME FRAME-A
    fi_as-of-date AT ROW 2.43 COL 21 COLON-ALIGNED
    fi_company AT ROW 2.43 COL 51.4 COLON-ALIGNED
    tg_only-sales AT ROW 4 COL 14.8 WIDGET-ID 2
    btn-ok AT ROW 6.33 COL 19.2
    btn-cancel AT ROW 6.38 COL 37.6
    " Selection Parameters" VIEW-AS TEXT
    SIZE 21 BY .71 AT ROW 1 COL 4
    BGCOLOR 15 
