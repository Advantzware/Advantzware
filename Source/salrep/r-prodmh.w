...
DEFINE FRAME FRAME-A
    fi_as-of-date AT ROW 2.81 COL 21.6 COLON-ALIGNED
    fi_company AT ROW 2.81 COL 52 COLON-ALIGNED
    browse-machine AT ROW 5.14 COL 4.6
    btn-ok AT ROW 13.38 COL 17.6
    btn-cancel AT ROW 13.38 COL 38.6
    "Select Up To 15 Machines for Production:" VIEW-AS TEXT
    SIZE 48 BY .62 AT ROW 4.38 COL 4.4
    FONT 6
    " Selection Parameters" VIEW-AS TEXT
    SIZE 21 BY .71 AT ROW 1.1 COL 4
    RECT-9 AT ROW 1.57 COL 3
        ...
        DO WITH FRAME {&FRAME-NAME}:
            ...
            DO:
                ...
                DO counter = 1 TO BROWSE browse-machine:NUM-SELECTED-ROWS:
                    ...
                    ASSIGN 
                        user-print.field-value[counter] = mach.m-code  .
                END.
