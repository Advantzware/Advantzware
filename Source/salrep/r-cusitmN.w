...
ASSIGN 
    cTextListToSelect  = "Customer,Customer Name,Ship-To,Inv#,Inv Date,FG Item,Item Name,"
...
{sys/inc/ttRptSel.i}
ASSIGN 
    cTextListToDefault = "Customer,Customer Name,Ship-To,Inv#,Inv Date,FG Item,Item Name,"
...
DEFINE VARIABLE fi_file         AS CHARACTER FORMAT "X(45)" INITIAL "c:~\tmp~\SalesAnalysisByCustomer.csv" 
    LABEL "Name" 
...
DEFINE FRAME FRAME-A
    tb_cust-list AT ROW 2 COL 29.8 WIDGET-ID 6
    btnCustList AT ROW 2.05 COL 72.4 WIDGET-ID 8
    begin_cust-no AT ROW 3.14 COL 27.6 COLON-ALIGNED HELP
    "Enter Beginning Customer Number"
    end_cust-no AT ROW 3.14 COL 70.6 COLON-ALIGNED HELP
    "Enter Ending Customer Number"
    begin_cust-type AT ROW 4.1 COL 27.6 COLON-ALIGNED HELP
    "Enter Beginning Customer Type"
    end_cust-type AT ROW 4.1 COL 70.6 COLON-ALIGNED HELP
    "Enter Ending Customer Type"
    begin_ship-to AT ROW 5.05 COL 27.6 COLON-ALIGNED HELP
    "Enter Beginning Ship-to Number"
    end_ship-to AT ROW 5.05 COL 70.6 COLON-ALIGNED HELP
    "Enter Ending Order Number"
    begin_slsmn AT ROW 6 COL 27.6 COLON-ALIGNED HELP
    "Enter Beginning Sales Rep Number"
    end_slsmn AT ROW 6 COL 70.6 COLON-ALIGNED HELP
    "Enter Ending Sales Rep Number"
    begin_i-no AT ROW 6.95 COL 27.6 COLON-ALIGNED HELP
    "Enter Beginning Order Number"
    end_i-no AT ROW 6.95 COL 70.6 COLON-ALIGNED HELP
    "Enter Ending Item Number"
    begin_inv-date AT ROW 7.91 COL 27.6 COLON-ALIGNED
    end_inv-date AT ROW 7.91 COL 70.6 COLON-ALIGNED HELP
    "Enter Ending Due Date"
    begin_po AT ROW 8.86 COL 27.6 COLON-ALIGNED HELP
    "Enter Beginning PO#"
    end_po AT ROW 8.86 COL 70.6 COLON-ALIGNED HELP
    "Enter Ending PO#"
    lbl_sort AT ROW 10.29 COL 20 COLON-ALIGNED NO-LABELS
    rd_sort AT ROW 10.29 COL 29.6 NO-LABELS
    tb_disprice AT ROW 11.24 COL 29.6
    tb_sub-tot AT ROW 11.24 COL 60.6 WIDGET-ID 58
    tb_fin-chg AT ROW 12.29 COL 29.6
    sl_avail AT ROW 14.14 COL 3 NO-LABELS WIDGET-ID 26
    Btn_Def AT ROW 14.14 COL 41 HELP
    "Add Selected Table to Tables to Audit" WIDGET-ID 56
    sl_selected AT ROW 14.14 COL 61.6 NO-LABELS WIDGET-ID 28
    ...
    lv-font-no AT ROW 19.95 COL 33.8 COLON-ALIGNED
    lv-ornt AT ROW 19.95 COL 43.6 NO-LABELS
    lines-per-page AT ROW 19.95 COL 87.6 COLON-ALIGNED
    rd-dest AT ROW 20.19 COL 5 NO-LABELS
    lv-font-name AT ROW 21.1 COL 29.8 COLON-ALIGNED NO-LABELS
    td-show-parm AT ROW 22.33 COL 28.6
    fi_file AT ROW 23.24 COL 26.6 COLON-ALIGNED HELP
    "Enter File Name"
    tb_OpenCSV AT ROW 23.29 COL 93.6 RIGHT-ALIGNED
    tbAutoClose AT ROW 24.57 COL 28.4 WIDGET-ID 60
    btn-ok AT ROW 25.52 COL 28
    btn-cancel AT ROW 25.52 COL 54
    "Selected Columns(In Display Order)" VIEW-AS TEXT
    SIZE 34 BY .62 AT ROW 13.43 COL 61.2 WIDGET-ID 44
    "Available Columns" VIEW-AS TEXT
    SIZE 29 BY .62 AT ROW 13.43 COL 3 WIDGET-ID 38
    " Output Destination" VIEW-AS TEXT
    SIZE 18 BY .62 AT ROW 19.38 COL 4.2
...
ASSIGN 
    tb_sub-tot:PRIVATE-DATA IN FRAME FRAME-A = "parm".
...
PROCEDURE enable_UI :
    ...
    DISPLAY tb_cust-list begin_cust-no end_cust-no begin_cust-type end_cust-type 
        ...
        tb_disprice tb_sub-tot tb_fin-chg sl_avail sl_selected rd-dest fi_file 
...
PROCEDURE run-report :
    ...
    FOR EACH tt-report WHERE tt-report.term-id EQ "",
        ...
        DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
            ...
            CASE cTmpField:             
                ...
                WHEN "cust-g"  THEN 
                    cVarValue = STRING(cust.spare-char-2) .
        ...
        DO:
            ...
            PUT str-line SKIP.
            PUT UNFORMATTED  
                "      CUSTOMER TOTALS"  SUBSTRING(cDisplay,22,350) SKIP.
            IF rd-dest = 3 THEN 
            DO:
                PUT STREAM excel UNFORMATTED   
                    '      CUSTOMER TOTALS,' 
    ...
    PUT str-line SKIP.
    PUT UNFORMATTED  
        "         GRAND TOTALS"  SUBSTRING(cDisplay,22,350) SKIP.
    IF rd-dest = 3 THEN 
    DO:
        PUT STREAM excel UNFORMATTED   
            '      GRAND TOTALS,' 
