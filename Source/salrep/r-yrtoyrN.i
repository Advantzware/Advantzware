...
FOR EACH ar-inv
    ...
    FOR EACH ar-invl
        ...
        IF AVAILABLE itemfg OR ("" GE begin_fg-cat AND "" LE end_fg-cat) THEN
        DO i = 1 TO 3:
            ASSIGN
                v-amt     = 0
...
FOR EACH tt-report2,
    ...
    DO:
        ...
        DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
            ...
            CASE cTmpField:             
                ...
                WHEN "hding"   THEN 
                    cVarValue =  STRING(lv-ltype[1]) .
                WHEN "p1"        THEN 
                    cVarValue = IF v1 GE 1 THEN STRING(v-amt[14],"->>>,>>>,>>9")  ELSE " " .
                WHEN "p2"        THEN 
                    cVarValue = IF v1 GE 2 THEN STRING(v-amt[15],"->>>,>>>,>>9")  ELSE " ".
                WHEN "p3"        THEN 
                    cVarValue = IF v1 GE 3 THEN STRING(v-amt[16],"->>>,>>>,>>9")  ELSE " ".
                WHEN "p4"        THEN 
                    cVarValue = IF v1 GE 4 THEN STRING(v-amt[17],"->>>,>>>,>>9")  ELSE " ".
                WHEN "p5"        THEN 
                    cVarValue = IF v1 GE 5 THEN STRING(v-amt[18],"->>>,>>>,>>9") ELSE " ".
                WHEN "p6"        THEN 
                    cVarValue = IF v1 GE 6  THEN STRING(v-amt[19],"->>>,>>>,>>9") ELSE " ".
                WHEN "p7"        THEN 
                    cVarValue = IF v1 GE 7  THEN STRING(v-amt[20],"->>>,>>>,>>9") ELSE " ".
                WHEN "p8"        THEN 
                    cVarValue = IF v1 GE 8  THEN STRING(v-amt[21],"->>>,>>>,>>9") ELSE " ".
                WHEN "p9"        THEN 
                    cVarValue = IF v1 GE 9  THEN STRING(v-amt[22],"->>>,>>>,>>9") ELSE " ".
                WHEN "p10"      THEN 
                    cVarValue = IF v1 GE 10  THEN STRING(v-amt[23],"->>>,>>>,>>9") ELSE " ".
                WHEN "p11"      THEN 
                    cVarValue = IF v1 GE 11 THEN STRING(v-amt[24],"->>>,>>>,>>9") ELSE " ".
                WHEN "p12"      THEN 
                    cVarValue = IF v1 GE 12 THEN STRING(v-amt[25],"->>>,>>>,>>9") ELSE " ".
                WHEN "p13"      THEN 
                    cVarValue = IF v1 GE 13  THEN STRING(v-amt[26],"->>>,>>>,>>9") ELSE " ".
        ...
        DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
            ...
            CASE cTmpField:             
                ...
                WHEN "name"   THEN 
                    cVarValue =  " " .
                WHEN "hding"   THEN 
                    cVarValue =  STRING(lv-ltype[2]) .
                WHEN "p1"        THEN 
                    cVarValue = IF v1 GE 1 THEN STRING(v-amt[01],"->>>,>>>,>>9")  ELSE " " .
                WHEN "p2"        THEN 
                    cVarValue = IF v1 GE 2 THEN STRING(v-amt[02],"->>>,>>>,>>9")  ELSE " ". 
                WHEN "p3"        THEN 
                    cVarValue = IF v1 GE 3 THEN STRING(v-amt[03],"->>>,>>>,>>9")  ELSE " ". 
                WHEN "p4"        THEN 
                    cVarValue = IF v1 GE 4 THEN STRING(v-amt[04],"->>>,>>>,>>9")  ELSE " ". 
                WHEN "p5"        THEN 
                    cVarValue = IF v1 GE 5 THEN STRING(v-amt[05],"->>>,>>>,>>9") ELSE " ".  
                WHEN "p6"        THEN 
                    cVarValue = IF v1 GE 6  THEN STRING(v-amt[06],"->>>,>>>,>>9") ELSE " ". 
                WHEN "p7"        THEN 
                    cVarValue = IF v1 GE 7  THEN STRING(v-amt[07],"->>>,>>>,>>9") ELSE " ". 
                WHEN "p8"        THEN 
                    cVarValue = IF v1 GE 8  THEN STRING(v-amt[08],"->>>,>>>,>>9") ELSE " ". 
                WHEN "p9"        THEN 
                    cVarValue = IF v1 GE 9  THEN STRING(v-amt[09],"->>>,>>>,>>9") ELSE " ". 
                WHEN "p10"      THEN 
                    cVarValue = IF v1 GE 10  THEN STRING(v-amt[10],"->>>,>>>,>>9") ELSE " ". 
                WHEN "p11"      THEN 
                    cVarValue = IF v1 GE 11 THEN STRING(v-amt[11],"->>>,>>>,>>9") ELSE " ".  
                WHEN "p12"      THEN 
                    cVarValue = IF v1 GE 12 THEN STRING(v-amt[12],"->>>,>>>,>>9") ELSE " ".  
                WHEN "p13"      THEN 
                    cVarValue = IF v1 GE 13  THEN STRING(v-amt[13],"->>>,>>>,>>9") ELSE " ". 
        ...
        DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
            ...
            CASE cTmpField:             
                ...
                WHEN "name"   THEN 
                    cVarValue =  " " .
                WHEN "hding"   THEN 
                    cVarValue =  STRING(lv-ltype[3]) .
                WHEN "p1"        THEN 
                    cVarValue = IF v1 GE 1 THEN STRING(v-pct[01],"->>,>>>,>>9%")  ELSE " " .
                WHEN "p2"        THEN 
                    cVarValue = IF v1 GE 2  THEN STRING(v-pct[02],"->>,>>>,>>9%")  ELSE " ".
                WHEN "p3"        THEN 
                    cVarValue = IF v1 GE 3 THEN  STRING(v-pct[03],"->>,>>>,>>9%")  ELSE " ".
                WHEN "p4"        THEN 
                    cVarValue = IF v1 GE 4  THEN STRING(v-pct[04],"->>,>>>,>>9%")  ELSE " ".
                WHEN "p5"        THEN 
                    cVarValue = IF v1 GE 5  THEN STRING(v-pct[05],"->>,>>>,>>9%") ELSE " ".
                WHEN "p6"        THEN 
                    cVarValue = IF v1 GE 6  THEN STRING(v-pct[06],"->>,>>>,>>9%") ELSE " ".
                WHEN "p7"        THEN 
                    cVarValue = IF v1 GE 7  THEN STRING(v-pct[07],"->>,>>>,>>9%") ELSE " ".
                WHEN "p8"        THEN 
                    cVarValue = IF v1 GE 8  THEN STRING(v-pct[08],"->>,>>>,>>9%") ELSE " ".
                WHEN "p9"        THEN 
                    cVarValue = IF v1 GE 9  THEN STRING(v-pct[09],"->>,>>>,>>9%") ELSE " ".
                WHEN "p10"      THEN 
                    cVarValue = IF v1 GE 10  THEN STRING(v-pct[10],"->>,>>>,>>9%") ELSE " ".
                WHEN "p11"      THEN 
                    cVarValue = IF v1 GE 11 THEN STRING(v-pct[11],"->>,>>>,>>9%") ELSE " ".
                WHEN "p12"      THEN 
                    cVarValue = IF v1 GE 12  THEN STRING(v-pct[12],"->>,>>>,>>9%") ELSE " ".
                WHEN "p13"      THEN 
                    cVarValue = IF v1 GE 13  THEN STRING(v-pct[13],"->>,>>>,>>9%") ELSE " ".
    ...
    IF ll-tots AND (LAST-OF(tt-report2.key-01) OR v-prt EQ v-custs) THEN 
    DO:
        ll-tots = NO.
        ...
        PUT UNFORMATTED  
            "        Totals" SUBSTRING(cDisplay,15,350) SKIP.
        IF rd-dest = 3 THEN 
        DO:
            PUT STREAM excel UNFORMATTED 
                ' Totals ' 
