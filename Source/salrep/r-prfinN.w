...
ASSIGN 
    ...
    .
ASSIGN 
    cTextListToDefault = "Rep,Rep Name,Customer,Customer Name,Invoice#,FG Item,Name,Catgy,Qty shipped,Total MSF," +
...
rs_sort tb_prep tb_freight tb_fin-chg tb_sum sl_avail sl_selected rd-dest ~
...
DEFINE VARIABLE fi_file        AS CHARACTER FORMAT "X(45)" INITIAL "c:~\tmp~\ProfitByInvoice.csv" 
    LABEL "Name" 
...
DEFINE FRAME FRAME-A
    ...
    btnCustList AT ROW 2 COL 75.4 WIDGET-ID 8
    begin_cust-no AT ROW 3 COL 30.6 COLON-ALIGNED HELP
    "Enter Beginning Customer Number"
    end_cust-no AT ROW 3 COL 73.6 COLON-ALIGNED HELP
    "Enter Ending Customer Number"
    begin_fg-cat AT ROW 3.95 COL 30.6 COLON-ALIGNED HELP
    "Enter Beginning Product Category"
    end_fg-cat AT ROW 3.95 COL 73.6 COLON-ALIGNED HELP
    "Enter Ending Product Category"
    begin_i-no AT ROW 4.91 COL 30.6 COLON-ALIGNED HELP
    "Enter Beginning Order Number"
    end_i-no AT ROW 4.91 COL 73.6 COLON-ALIGNED HELP
    "Enter Ending Item Number"
    begin_slsmn AT ROW 5.91 COL 30.6 COLON-ALIGNED HELP
    "Enter Beginning Sales Rep Number" WIDGET-ID 8
    end_slsmn AT ROW 5.91 COL 73.6 COLON-ALIGNED HELP
    "Enter Ending Sales Rep Number" WIDGET-ID 10
    begin_inv-date AT ROW 6.91 COL 30.6 COLON-ALIGNED
    end_inv-date AT ROW 6.91 COL 73.6 COLON-ALIGNED HELP
    "Enter Ending Due Date"
    begin_sstate AT ROW 7.86 COL 30.6 COLON-ALIGNED HELP
    "Enter Beginning Shipto State" WIDGET-ID 60
    end_sstate AT ROW 7.86 COL 73.6 COLON-ALIGNED HELP
    "Enter Ending Shipto State" WIDGET-ID 62
    lbl_cost AT ROW 9.1 COL 18.2 COLON-ALIGNED NO-LABELS
    rd_cost AT ROW 9.1 COL 35.2 NO-LABELS
    rs_sort AT ROW 10.05 COL 35.2 NO-LABELS WIDGET-ID 2
    tb_prep AT ROW 11.24 COL 35.4
    tb_freight AT ROW 12.19 COL 35.4
    tb_fin-chg AT ROW 13.14 COL 35.4
    tb_sum AT ROW 14.05 COL 35.4 WIDGET-ID 58
    Btn_Def AT ROW 15.81 COL 41.6 HELP
    "Default Selected Table to Tables to Audit" WIDGET-ID 56
    sl_avail AT ROW 15.95 COL 3 NO-LABELS WIDGET-ID 26
    sl_selected AT ROW 15.95 COL 61.8 NO-LABELS WIDGET-ID 28
    Btn_Add AT ROW 16.76 COL 41.6 HELP
    "Add Selected Table to Tables to Audit" WIDGET-ID 32
    Btn_Remove AT ROW 17.71 COL 41.6 HELP
    "Remove Selected Table from Tables to Audit" WIDGET-ID 34
    btn_Up AT ROW 18.67 COL 41.6 WIDGET-ID 40
    btn_down AT ROW 19.62 COL 41.6 WIDGET-ID 42
    lv-font-no AT ROW 21.24 COL 42 COLON-ALIGNED
    lv-ornt AT ROW 21.24 COL 52 NO-LABELS
    lines-per-page AT ROW 21.24 COL 89 COLON-ALIGNED
    rd-dest AT ROW 21.38 COL 5 NO-LABELS
    lv-font-name AT ROW 22.43 COL 31 COLON-ALIGNED NO-LABELS
    td-show-parm AT ROW 23.62 COL 28.4
    tb_excel AT ROW 23.62 COL 94 RIGHT-ALIGNED
    fi_file AT ROW 24.52 COL 26.4 COLON-ALIGNED HELP
    "Enter File Name"
    tb_OpenCSV AT ROW 24.62 COL 93.8 RIGHT-ALIGNED
    tbAutoClose AT ROW 25.76 COL 28.6 WIDGET-ID 64
    btn-ok AT ROW 26.67 COL 28.4
    btn-cancel AT ROW 26.67 COL 55
    "Sort By:" VIEW-AS TEXT
    SIZE 8 BY .62 AT ROW 10.14 COL 25.4 WIDGET-ID 6
    " Output Destination" VIEW-AS TEXT
    SIZE 18 BY .62 AT ROW 20.71 COL 4
    "Selected Columns(In Display Order)" VIEW-AS TEXT
    SIZE 34 BY .62 AT ROW 15.29 COL 62.4 WIDGET-ID 44
    "Available Columns" VIEW-AS TEXT
    SIZE 22 BY .62 AT ROW 15.29 COL 3 WIDGET-ID 38
    " Selection Parameters" VIEW-AS TEXT
    SIZE 21 BY .71 AT ROW 1.24 COL 5
    BGCOLOR 15 
    RECT-6 AT ROW 21.1 COL 3
...
ASSIGN 
    rd_cost:PRIVATE-DATA IN FRAME FRAME-A = "parm".

ASSIGN 
    rs_sort:PRIVATE-DATA IN FRAME FRAME-A = "parm".
...
ASSIGN 
    tb_sum:PRIVATE-DATA IN FRAME FRAME-A = "parm".
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    RUN enable_UI.
    {sys/inc/reportsConfigNK1.i "HR3" }
    ASSIGN
...
PROCEDURE enable_UI :
    ...
    DISPLAY tb_cust-list begin_cust-no end_cust-no begin_fg-cat end_fg-cat 
        ...
        tb_fin-chg tb_sum sl_avail sl_selected rd-dest fi_file tb_OpenCSV 
        tbAutoClose 
...
PROCEDURE pgetBoard :
    ...
    DO:
        ...
        IF AVAILABLE eb AND AVAILABLE ef THEN
            opcBoard = ef.board .
        ELSE opcBoard = "" .
    END.
...
PROCEDURE run-report :
    ...
    DEFINE VARIABLE v-qty         AS DECIMAL   EXTENT 5 NO-UNDO.
    ...
    DO WITH FRAME {&FRAME-NAME}:
        ...
        ELSE
            ASSIGN
                ...
                .
        ASSIGN 
            fi_file:SCREEN-VALUE = "c:\tmp\ProfitByInvoice.csv".   
    END.
