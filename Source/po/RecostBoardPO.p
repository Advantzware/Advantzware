...
PROCEDURE GetNewCostsN:
    ...
    FOR EACH ttPOGroups 
        ...
        RUN GetVendorCost(cocode, 
            ...
            ttPOGroups.itemType, 
            ttPOGroups.VendNo, 
            ttPOGroups.customerID, 
            "", 
            0, 
            0,
            ttPOGroups.TotalQty, 
            ttPOGroups.TotalQtyUOM,
            ttPOGroups.Len, 
            ttPOGroups.Wid, 
            ttPOGroups.Dep, 
            "IN", 
        ...
        ASSIGN 
            ttPOGroups.NewCost    = dCostPerUOM + ttPOGroups.AdderCost
            ttPoGroups.NewCostUOM = cCostUOM
            ttPOGroups.NewSetup   = dCostSetup
            .
    ...
    FIRST bf-item 
        ...
        ELSE DO:
            ...
            ASSIGN
                ...
                ttPOGroups.itemType = IF bf-po-ordl.item-type THEN "RM" ELSE "FG"
                ttPOGroups.customerID = bf-po-ordl.cust-no.
        END.
        CREATE ttPOLineXRef.
        ASSIGN 
