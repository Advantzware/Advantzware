...
/*            PUT v-lstloc AT 7 FORM "x(15)". */
        IF po-ordl.dscr[1] <> "" OR v-ord-no <> "" THEN
        PUT po-ordl.dscr[1] AT 25  FORM "x(30)" v-ord-no AT 65  SKIP .
        PUT 
...
PUT "<FArial><R60><C2><P10><U><B>Forward Invoices via email to:  ap@coburncarton.com  </B></U> </P10> " SKIP(1)
