...
PUT 
      ...
      /*    v-comp-add1  AT 8 SKIP
       ...
       "<FArial><P14><=#3>" /*<C-20><R-2> <B>Purchase Order</B>*/  "<P10>" SKIP
          ...
          "<=#3><R+5.5>Changed Date: " po-ord.po-change-date SKIP
          "<=3><R+6.5>Date Required: " po-ord.due-date SKIP
       .
...
/*              "<R23><C47><FROM><R25><C47><LINE>" SKIP */
      ...
      PUT "<FArial><=5><C73>Ext Cost" 
          "<=5><R+1><C1.5>Line"
	  "<C7>Quantity"
          "<C15.5>UOM"
	  "<C21>Our Item/CP#/Description/Vendor ID/Vendor Item#"
          "<C54.5>Due Date"
          "<C63>Cost"
          "<C68.5>UOM"
          "<C73>Ext MSF" SKIP(1).
