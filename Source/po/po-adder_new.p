...
DEFINE INPUT PARAMETER v-part-dscr1       AS CHARACTER FORMAT "x(30)".
DEFINE INPUT PARAMETER v-part-dscr2       AS CHARACTER FORMAT "x(30)".
DEFINE INPUT PARAMETER v-basis-w          LIKE item.basis-w NO-UNDO.
DEFINE INPUT PARAMETER v-len              LIKE item.s-len NO-UNDO.
DEFINE INPUT PARAMETER v-wid              LIKE item.s-wid NO-UNDO.
DEFINE INPUT PARAMETER v-dep              LIKE item.s-dep NO-UNDO.
DEFINE INPUT PARAMETER v-gl-desc          AS CHARACTER FORMAT "x(30)" NO-UNDO.
DEFINE INPUT PARAMETER v-tot-msf          AS DECIMAL   FORMAT ">>,>>9.999" INIT 0 NO-UNDO.
DEFINE INPUT PARAMETER v-adder            AS DECIMAL   EXTENT 2.
DEFINE INPUT PARAMETER v-po-qty           AS LOG       INITIAL TRUE NO-UNDO.
