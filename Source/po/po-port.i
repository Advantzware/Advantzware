...
PUT 
         "<C1><#1><FArial>"  
         "<P10><R1><C70><B>N° da página:</B>" string(PAGE-NUM,">9")  SKIP
         "<P14><C+45> <B>Pedido de compra</B> <P10>" v-change-ord SKIP       
       "<C3><R2><#2><R+8><C+40>" "<IMAGE#2=" + ls-full-img1 FORM "x(200)"  SKIP 
       /*"<=1><R+2>" "<FGCOLOR=" + trim(lv-comp-color) + ">" FORM "x(15)" */
          "<P10><=1><R+9><C3><FCourier New>Pedido de compra para:" 
      ...
      /*    v-comp-add1  AT 8 SKIP
          ...
          lv-email AT 8 */
          "<FCourier New>" SKIP(2)
         space(21)    "Enviar para:" AT 50 SKIP
   ...
   */
      ...
      PUT "<FArial><=4><R+1>   Comprador                     Contato                                     Termos                        FOB                    Enviar via                     Frete" SKIP
...
/*              "<R23><C47><FROM><R25><C47><LINE>" SKIP */
      ...
      PUT "<FArial><=5><C21>Nosso item/N° CP/Descrição/ID do fornecedor/<C54.5>Data de<C73>Custo ext." 
          "<=5><R+1><C1.5>Linha"
	  "<C7>Quantidade"
          "<C15.5>UOM"
	  "<C21>N° do item do fornecedor"
          "<C54.5>vencimento"
          "<C63>Custo"
          "<C68.5>UOM"
          "<C73>MSF ext." SKIP(1).
