...
&SCOP tab-height 30
  ...
  DEF VAR width-tab-values    AS INT INIT [98,63] EXTENT 2 NO-UNDO.
...
&Scoped-Define ENABLED-OBJECTS Rect-Main Rect-Top 
...
DEFINE FRAME Folder-Frm
     Rect-Main AT ROW 1 COL 1
     Rect-Top AT ROW 1.71 COL 1.2 WIDGET-ID 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SCROLLABLE SIZE 194 BY 22.52
         BGCOLOR 15 .
...
ASSIGN 
       ...
       FRAME Folder-Frm:HEIGHT           = 11.86
       FRAME Folder-Frm:WIDTH            = 81.8.
...
/* -----------------------------------------------------------
    ...
    ELSE ASSIGN page# = 1.    /* For design mode. */
      ...
      DO: 
        ...
        up-image:Y      =     page-label[page#]:Y -  9 
        up-image:HIDDEN =     no
...
/* -----------------------------------------------------------
    ...
    DEFINE VARIABLE sts                     AS LOG NO-UNDO.
      ...
      ASSIGN      
      sts = image-hdl[p-page#]:LOAD-IMAGE("images\tabdown.png").
...
/* -----------------------------------------------------------
    ...
    Y                 = 0
    WIDTH-PIXEL       = width-tab-values[tab-type]
    HEIGHT-PIXEL      = {&tab-height} + 6
    PRIVATE-DATA      = "Tab-Folder":U
    SENSITIVE         = YES
    HIDDEN            = NO.  /* Do this explicitly or it's sometimes hidden. */

    ASSIGN
    sts            =   up-image:LOAD-IMAGE("images\tabup.png").
