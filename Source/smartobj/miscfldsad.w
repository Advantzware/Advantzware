...
&Scoped-Define ENABLED-OBJECTS selectMiscFlds 
...
&Scoped-define SELF-NAME selectMiscFlds
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE hideMiscFlds s-object 
PROCEDURE hideMiscFlds :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
  selectMiscFlds:HIDDEN IN FRAME {&FRAME-NAME} = YES.
