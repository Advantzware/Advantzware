...
&Scoped-Define ENABLED-OBJECTS btnRmLoadTag 
...
&Scoped-define SELF-NAME btnRmLoadTag
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btnRmLoadTag s-object
ON CHOOSE OF btnRmLoadTag IN FRAME F-Main /* Excel */
DO:
    DEFINE VARIABLE char-hdl AS CHARACTER NO-UNDO.

    RUN get-link-handle IN adm-broker-hdl (THIS-PROCEDURE,'loadtag-rm-source':U,OUTPUT char-hdl).
    RUN loadtag-rm in WIDGET-HANDLE(char-hdl).
END.
