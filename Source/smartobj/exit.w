...
&Scoped-Define ENABLED-OBJECTS Select_Exit 
...
DEFINE BUTTON Select_Exit 
     IMAGE-UP FILE "Resources/Graphics/32x32/logout_new.png":U
     IMAGE-DOWN FILE "Resources/Graphics/32x32/logout_hover_new.png":U
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
Select_Exit:SENSITIVE IN FRAME F-Main = FALSE.
END PROCEDURE.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
Select_Exit:SENSITIVE IN FRAME F-Main = TRUE.
END PROCEDURE.
