...
&SCOPED-DEFINE h_Browse01 h_b-cldown
...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES asi2corr
&Scoped-define FIRST-EXTERNAL-TABLE asi2corr


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR asi2corr.
...
DEFINE VARIABLE h_b-cldown AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Inquiry Downloading to Currgator"
         HEIGHT             = 24
         WIDTH              = 150
         MAX-HEIGHT         = 320
         MAX-WIDTH          = 320
...
ON END-ERROR OF W-Win /* Inquiry Downloading to Currgator */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Inquiry Downloading to Currgator */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Brows History' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'jc/b-cldown.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-cldown ).
       RUN set-position IN h_b-cldown ( 4.67 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 19.52 , 145.00 ) */

       /* Links to SmartNavBrowser h_b-cldown. */
       RUN add-link IN adm-broker-hdl ( h_b-cldown , 'Record':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-cldown ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "asi2corr"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "asi2corr"}
