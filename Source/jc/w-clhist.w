...
&SCOPED-DEFINE h_Browse01 h_b-clhist
...
DEFINE VARIABLE h_b-clhist AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Inquiry History of Currgator"
         HEIGHT             = 24
         WIDTH              = 150
         MAX-HEIGHT         = 320
         MAX-WIDTH          = 320
...
ON END-ERROR OF W-Win /* Inquiry History of Currgator */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Inquiry History of Currgator */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'jc/b-clhist.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-clhist ).
       RUN set-position IN h_b-clhist ( 4.57 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 19.52 , 145.00 ) */

       /* Links to SmartNavBrowser h_b-clhist. */
       RUN add-link IN adm-broker-hdl ( h_b-clhist , 'Record':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-clhist ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
