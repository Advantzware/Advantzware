...
DEF NEW SHARED TEMP-TABLE tt-job-hdr LIKE job-hdr
    INDEX j-no j-no
...
FOR EACH fg-set WHERE fg-set.company = itemfg.company 
                ...
                NO-LOCK.
    FOR EACH job-hdr WHERE job-hdr.company EQ itemfg.company
                       AND job-hdr.i-no EQ fg-set.set-no
                     NO-LOCK.           
            CREATE tt-job-hdr.
...
DEFINE VARIABLE h_b-jobinqc AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Job Variance Inquiry - Components"
         HEIGHT             = 24
         WIDTH              = 150.8
         MAX-HEIGHT         = 24
         MAX-WIDTH          = 160
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Browse|Detail|Material|MachHrs|MachQtys|Waste|MachCosts|D.L.|Var OH|Fixed OH' + ',
                     FOLDER-TAB-TYPE = 2':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'jcinq/b-jobinqc.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-jobinqc ).
       RUN set-position IN h_b-jobinqc ( 4.57 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 19.76 , 148.00 ) */

       /* Links to SmartNavBrowser h_b-jobinqc. */
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'inquiry':U , h_b-jobinqc ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-jobinqc ,
    ...
    WHEN 2 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_b-jobinqc , 'Record':U , h_v-job ).

       /* Links to SmartViewer h_v-nav2. */
       RUN add-link IN adm-broker-hdl ( h_b-jobinqc , 'nav-itm':U , h_v-nav2 ).

       /* Links to SmartBrowser h_b-jhdrin. */
       RUN add-link IN adm-broker-hdl ( h_b-jobinqc , 'Record':U , h_b-jhdrin ).
    ...
    WHEN 3 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_b-jobinqc , 'Record':U , h_v-job-2 ).

       /* Links to SmartViewer h_v-nav2-2. */
       RUN add-link IN adm-broker-hdl ( h_b-jobinqc , 'nav-itm':U , h_v-nav2-2 ).

       /* Links to SmartBrowser h_b-jmatin. */
       RUN add-link IN adm-broker-hdl ( h_b-jobinqc , 'Record':U , h_b-jmatin ).
    ...
    WHEN 4 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_b-jobinqc , 'Record':U , h_v-job-4 ).

       /* Links to SmartViewer h_v-nav2-3. */
       RUN add-link IN adm-broker-hdl ( h_b-jobinqc , 'nav-itm':U , h_v-nav2-3 ).

       /* Links to SmartBrowser h_b-jmchin. */
       RUN add-link IN adm-broker-hdl ( h_b-jobinqc , 'Record':U , h_b-jmchin ).
    ...
    WHEN 5 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_b-jobinqc , 'Record':U , h_v-job-5 ).

       /* Links to SmartViewer h_v-nav2-4. */
       RUN add-link IN adm-broker-hdl ( h_b-jobinqc , 'nav-itm':U , h_v-nav2-4 ).

       /* Links to SmartBrowser h_b-jmchqi. */
       RUN add-link IN adm-broker-hdl ( h_b-jobinqc , 'Record':U , h_b-jmchqi ).
    ...
    WHEN 6 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_b-jobinqc , 'Record':U , h_v-job-6 ).

       /* Links to SmartViewer h_v-nav2-5. */
       RUN add-link IN adm-broker-hdl ( h_b-jobinqc , 'nav-itm':U , h_v-nav2-5 ).

       /* Links to SmartBrowser h_b-jmchwi. */
       RUN add-link IN adm-broker-hdl ( h_b-jobinqc , 'Record':U , h_b-jmchwi ).
    ...
    WHEN 7 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_b-jobinqc , 'Record':U , h_v-job-7 ).

       /* Links to SmartViewer h_v-nav2-6. */
       RUN add-link IN adm-broker-hdl ( h_b-jobinqc , 'nav-itm':U , h_v-nav2-6 ).

       /* Links to SmartBrowser h_b-jmchci. */
       RUN add-link IN adm-broker-hdl ( h_b-jobinqc , 'Record':U , h_b-jmchci ).
    ...
    WHEN 8 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_b-jobinqc , 'Record':U , h_v-job-8 ).

       /* Links to SmartViewer h_v-nav2-7. */
       RUN add-link IN adm-broker-hdl ( h_b-jobinqc , 'nav-itm':U , h_v-nav2-7 ).

       /* Links to SmartBrowser h_b-jmchli. */
       RUN add-link IN adm-broker-hdl ( h_b-jobinqc , 'Record':U , h_b-jmchli ).
    ...
    WHEN 9 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_b-jobinqc , 'Record':U , h_v-job-9 ).

       /* Links to SmartViewer h_v-nav2-8. */
       RUN add-link IN adm-broker-hdl ( h_b-jobinqc , 'nav-itm':U , h_v-nav2-8 ).

       /* Links to SmartBrowser h_b-jmchvi. */
       RUN add-link IN adm-broker-hdl ( h_b-jobinqc , 'Record':U , h_b-jmchvi ).
    ...
    WHEN 10 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_b-jobinqc , 'Record':U , h_v-job-10 ).

       /* Links to SmartViewer h_v-nav2-9. */
       RUN add-link IN adm-broker-hdl ( h_b-jobinqc , 'nav-itm':U , h_v-nav2-9 ).

       /* Links to SmartBrowser h_b-jmchfi. */
       RUN add-link IN adm-broker-hdl ( h_b-jobinqc , 'Record':U , h_b-jmchfi ).
