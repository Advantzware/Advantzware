...
begin_procat end_procat begin_date end_date begin_vend end_vend ~
begin_cust-no end_cust-no tb_receipts tb_adjustments tb_issues tb_counts ~
tb_transfers tb_sumcat sl_avail Btn_Def sl_selected Btn_Add Btn_Remove ~
btn_Up btn_down rd-dest tb_OpenCSV tbAutoClose fi_file btn-ok btn-cancel
&Scoped-Define DISPLAYED-OBJECTS begin_rm-no end_rm-no begin_procat ~
end_procat begin_date end_date begin_vend end_vend begin_cust-no ~
end_cust-no tb_receipts tb_adjustments tb_issues tb_counts tb_transfers ~
tb_sumcat sl_avail sl_selected rd-dest tb_OpenCSV fi_file tbAutoClose
...
DEFINE VARIABLE end_cust-no    AS CHARACTER FORMAT "X(8)":U INITIAL "zzzzzzzz" 
...
DEFINE VARIABLE tb_sumcat      AS LOGICAL   INITIAL NO 
    LABEL "Summarize by Categorys?" 
    VIEW-AS TOGGLE-BOX
    SIZE 30.4 BY .95 NO-UNDO.
...
DEFINE FRAME FRAME-A
    begin_rm-no AT ROW 2.19 COL 29 COLON-ALIGNED HELP
    "Enter Beginning Item Number"
    end_rm-no AT ROW 2.19 COL 70 COLON-ALIGNED HELP
    "Enter Ending Item number"
    begin_procat AT ROW 3.14 COL 29 COLON-ALIGNED HELP
    "Enter Begining Category"
    end_procat AT ROW 3.14 COL 70 COLON-ALIGNED HELP
    "Enter Ending Category"
    begin_date AT ROW 4.1 COL 29 COLON-ALIGNED HELP
    "Enter Beginning Date"
    end_date AT ROW 4.1 COL 70 COLON-ALIGNED HELP
    "Enter ending Date"
    begin_vend AT ROW 5.05 COL 29 COLON-ALIGNED HELP
    "Enter Beginng Vendor"
    end_vend AT ROW 5.05 COL 70 COLON-ALIGNED HELP
    "Enter Endng Vendor"
    begin_cust-no AT ROW 6 COL 29 COLON-ALIGNED HELP
    "Enter Beginng Vendor" WIDGET-ID 58
    end_cust-no AT ROW 6 COL 70 COLON-ALIGNED HELP
    "Enter Endng Vendor" WIDGET-ID 60
    tb_receipts AT ROW 7.76 COL 30.6
    tb_adjustments AT ROW 7.76 COL 53.4
    tb_issues AT ROW 8.71 COL 30.6
    tb_counts AT ROW 8.71 COL 53.4
    tb_transfers AT ROW 9.67 COL 30.6
    tb_sumcat AT ROW 9.91 COL 60.6 WIDGET-ID 62
    sl_avail AT ROW 12.1 COL 4 NO-LABELS WIDGET-ID 26
    Btn_Def AT ROW 12.1 COL 40.8 HELP
    "Add Selected Table to Tables to Audit" WIDGET-ID 56
    sl_selected AT ROW 12.1 COL 60.8 NO-LABELS WIDGET-ID 28
    Btn_Add AT ROW 13.1 COL 40.8 HELP
    "Add Selected Table to Tables to Audit" WIDGET-ID 32
    Btn_Remove AT ROW 14.1 COL 40.8 HELP
    "Remove Selected Table from Tables to Audit" WIDGET-ID 34
    btn_Up AT ROW 15.14 COL 40.8 WIDGET-ID 40
    btn_down AT ROW 16.19 COL 40.8 WIDGET-ID 42
    rd-dest AT ROW 18.29 COL 5.8 NO-LABELS
    lv-ornt AT ROW 18.29 COL 29.8 NO-LABELS
    lines-per-page AT ROW 18.29 COL 82.8 COLON-ALIGNED
    lv-font-no AT ROW 20.1 COL 33.8 COLON-ALIGNED
    lv-font-name AT ROW 21.05 COL 27.8 COLON-ALIGNED NO-LABELS
    td-show-parm AT ROW 22.24 COL 29.8
    tb_OpenCSV AT ROW 22.2 COL 76 WIDGET-ID 4
    tbAutoClose AT ROW 24 COL 31 WIDGET-ID 58
    fi_file AT ROW 22.2 COL 29 COLON-ALIGNED HELP
    "Enter File Name" WIDGET-ID 6
    btn-ok AT ROW 25 COL 31
    btn-cancel AT ROW 25 COL 51
    "Available Columns" VIEW-AS TEXT
    SIZE 29 BY .62 AT ROW 11.19 COL 5 WIDGET-ID 38
    "Selected Columns(In Display Order)" VIEW-AS TEXT
    SIZE 34 BY .62 AT ROW 11.29 COL 60 WIDGET-ID 44
    "Transaction Types" VIEW-AS TEXT
    SIZE 20 BY 1.19 AT ROW 7.29 COL 8.2
    FGCOLOR 9 
    " Selection Parameters" VIEW-AS TEXT
    SIZE 21.2 BY .71 AT ROW 1.14 COL 5 
    " Output Destination" VIEW-AS TEXT
    SIZE 18.9 BY .62 AT ROW 17.43 COL 5
    RECT-6 AT ROW 17.72 COL 4
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
    CREATE WINDOW C-Win ASSIGN
        HIDDEN             = YES
        TITLE              = "Material Usage by Customer/Category"
        HEIGHT             = 25.6
        WIDTH              = 96.2
        MAX-HEIGHT         = 33.29
        MAX-WIDTH          = 204.8
...
ASSIGN 
    tb_sumcat:PRIVATE-DATA IN FRAME FRAME-A = "parm".
...
ON END-ERROR OF C-Win /* Material Usage by Customer/Category */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Material Usage by Customer/Category */
    DO:
...
&Scoped-define SELF-NAME tb_sumcat
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tb_sumcat C-Win
ON VALUE-CHANGED OF tb_sumcat IN FRAME FRAME-A /* Summarize by Categorys? */
    DO:
        ASSIGN {&self-name}.
    END.
...
PROCEDURE enable_UI :
    ...
    DISPLAY begin_rm-no end_rm-no begin_procat end_procat begin_date end_date 
        begin_vend end_vend begin_cust-no end_cust-no tb_receipts 
        tb_adjustments tb_issues tb_counts tb_transfers tb_sumcat sl_avail 
        sl_selected rd-dest tb_OpenCSV tbAutoClose fi_file 
        WITH FRAME FRAME-A IN WINDOW C-Win.
    ENABLE RECT-6 RECT-7 begin_rm-no end_rm-no begin_procat end_procat begin_date 
        end_date begin_vend end_vend begin_cust-no end_cust-no tb_receipts 
        tb_adjustments tb_issues tb_counts tb_transfers tb_sumcat sl_avail 
...
PROCEDURE run-report :
    ...
    DO:
        ...
        FOR EACH rm-rcpth WHERE rm-rcpth.company    EQ cocode
            ...
            FIND FIRST procat NO-LOCK 
                ...
                AND procat.procat EQ item.procat NO-ERROR .
               
            IF AVAILABLE procat THEN
                ASSIGN cCatDesc = procat.dscr .
            ELSE cCatDesc = "" .
            ...
            DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
                ...
                CASE cTmpField:             
                    ...
                    WHEN "cat"      THEN 
                        cVarValue = STRING(item.procat,"x(8)")    .
                    WHEN "cat-desc-val" THEN 
                        cVarValue = STRING(cCatDesc,"x(30)")    .
                    WHEN "cust-no"  THEN 
                        cVarValue = STRING(cCustNo,"x(8)")    .
                    WHEN "cust-name" THEN 
    ...
    DO: /* summarized by category */
        ...
        {custom/statusMsg.i "'Processing Item # ' + string(rm-rcpth.i-no)"} 
            ...
            CREATE tt-report2 .
            ASSIGN 
                tt-report2.key-01 = rm-rcpth.i-no  
                ...
                DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
                    ...
                    CASE cTmpField:             
                        ...
                        WHEN "cat-desc-val" THEN 
                            cVarValue = STRING(cCatDesc,"x(30)")    .
                        WHEN "cust-no"  THEN 
                            cVarValue = STRING(tt-report2.key-02,"x(8)")    .
                        WHEN "cust-name" THEN 
                            cVarValue = STRING(tt-report2.key-03,"x(30)")  .
                    END CASE.
...
------------------------------------------------------------------------------*/
 DO WITH FRAME {&FRAME-NAME}:
     ...
     ELSE
      ...
      .
    ASSIGN fi_file:SCREEN-VALUE = "c:\tmp\r-tonmsf.csv".   
 END.
