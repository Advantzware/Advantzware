...
DEFINE            VARIABLE dollar-chg     AS DECIMAL.
...
&Scoped-Define ENABLED-OBJECTS RECT-6 RECT-7 post-date rd-dest tbAutoClose ~
btn-ok btn-cancel 
&Scoped-Define DISPLAYED-OBJECTS post-date rd-dest tbAutoClose 
...
DEFINE FRAME FRAME-A
    post-date AT ROW 2.67 COL 41 COLON-ALIGNED
    lv-font-no AT ROW 5.67 COL 34 COLON-ALIGNED
    lv-ornt AT ROW 5.76 COL 44 NO-LABELS
    lines-per-page AT ROW 5.76 COL 87 COLON-ALIGNED
    rd-dest AT ROW 5.86 COL 5 NO-LABELS
    lv-font-name AT ROW 6.86 COL 28.6 COLON-ALIGNED NO-LABELS
    td-show-parm AT ROW 9.57 COL 29.2
    tbAutoClose AT ROW 10.86 COL 29.2 WIDGET-ID 64
    btn-ok AT ROW 11.81 COL 29
    btn-cancel AT ROW 11.81 COL 54
    " Output Destination" VIEW-AS TEXT
    SIZE 19 BY .62 AT ROW 5.05 COL 4
    " Selection Parameters" VIEW-AS TEXT
    SIZE 21 BY .71 AT ROW 1.1 COL 4
    RECT-6 AT ROW 5.48 COL 3
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    RUN enable_UI.
    {sys/inc/reportsConfigNK1.i "MC3" }
    ASSIGN
...
PROCEDURE enable_UI :
    ...
    ------------------------------------------------------------------------------*/
    DISPLAY post-date rd-dest tbAutoClose 
        WITH FRAME FRAME-A IN WINDOW C-Win.
    ENABLE RECT-6 RECT-7 post-date rd-dest tbAutoClose btn-ok btn-cancel 
        WITH FRAME FRAME-A IN WINDOW C-Win.
