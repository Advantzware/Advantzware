...
btnCustList begin_whse end_whse begin_cust end_cust begin_i-no end_i-no ~
...
DEFINE VARIABLE fi_file AS CHARACTER FORMAT "X(45)" INITIAL "c:~\tmp~\YTDSalesByCust.csv" 
     LABEL "Name" 
...
DEFINE FRAME FRAME-A
     ...
     sl_avail AT ROW 8.19 COL 4.4 NO-LABEL WIDGET-ID 26
     Btn_Def AT ROW 8.19 COL 40.2 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 56
     sl_selected AT ROW 8.19 COL 59.6 NO-LABEL WIDGET-ID 28
     ...
     lv-ornt AT ROW 16.95 COL 43 NO-LABEL
     lv-font-no AT ROW 16.95 COL 72 COLON-ALIGNED
     lines-per-page AT ROW 16.95 COL 85 COLON-ALIGNED
     rd-dest AT ROW 17.57 COL 5 NO-LABEL
     lv-font-name AT ROW 18.14 COL 28 COLON-ALIGNED NO-LABEL
     td-show-parm AT ROW 19.24 COL 27.8
     fi_file AT ROW 20.33 COL 25.2 COLON-ALIGNED HELP
          "Enter File Name"
     tb_OpenCSV AT ROW 20.43 COL 91.8 RIGHT-ALIGNED
     tbAutoClose AT ROW 22.1 COL 26.8 WIDGET-ID 16
     btn-ok AT ROW 23 COL 26.6
     btn-cancel AT ROW 23 COL 53.6
     "Inventory Valuation Method is set in the" VIEW-AS TEXT
          SIZE 74 BY .71 AT ROW 14.76 COL 20
          BGCOLOR 9 FGCOLOR 15 FONT 5
     "Text" VIEW-AS TEXT
          SIZE 17 BY 1.67 AT ROW 15 COL 3
          BGCOLOR 9 FGCOLOR 9 
     " Output Destination" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 16.71 COL 4
     "Finished Goods Control File." VIEW-AS TEXT
          SIZE 74 BY 1.19 AT ROW 15.48 COL 20
          BGCOLOR 9 FGCOLOR 15 FONT 5
     "Cost Shown is Average or Last Cost." VIEW-AS TEXT
          SIZE 74 BY 1.19 AT ROW 13.81 COL 20
          BGCOLOR 9 FGCOLOR 15 FONT 5
     "Selected Columns(In Display Order)" VIEW-AS TEXT
          SIZE 34 BY .62 AT ROW 7.48 COL 59 WIDGET-ID 44
     "Available Columns" VIEW-AS TEXT
          SIZE 29 BY .62 AT ROW 7.48 COL 4.4 WIDGET-ID 38
     " Selection Parameters" VIEW-AS TEXT
          SIZE 21 BY .71 AT ROW 1.24 COL 5
     "Please Note:" VIEW-AS TEXT
          SIZE 17 BY 1.19 AT ROW 13.81 COL 3
          BGCOLOR 9 FGCOLOR 15 FONT 5
     RECT-6 AT ROW 17.05 COL 3
     RECT-7 AT ROW 1.48 COL 3 WIDGET-ID 58
     RECT-8 AT ROW 7.43 COL 3 WIDGET-ID 60
...
/* security check need {methods/prgsecur.i} in definition section */
  ...
  btn-ok:load-image("Graphics/32x32/Ok.png").
    ...
    RUN enable_UI.
    {sys/inc/reportsConfigNK1.i "IR8" }
    ASSIGN
...
------------------------------------------------------------------------------*/
  DISPLAY tb_cust-list begin_whse end_whse begin_cust end_cust begin_i-no 
          end_i-no tb_inc-cust sl_avail sl_selected rd-dest fi_file tb_OpenCSV 
          tbAutoClose 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE RECT-6 RECT-7 RECT-8 tb_cust-list btnCustList begin_whse end_whse 
         begin_cust end_cust begin_i-no end_i-no tb_inc-cust sl_avail Btn_Def 
...
/*------------------------------------------------------------------------------
    ...
    DO WITH FRAME {&FRAME-NAME}:
        ...
        ASSIGN 
            fi_file:SCREEN-VALUE = "c:\tmp\YTDSalesByCust.csv".
    END.
