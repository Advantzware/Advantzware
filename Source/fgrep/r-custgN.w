...
ASSIGN cTextListToSelect = "CUSTOMER,TYPE,JOB,TAG NO,PO NO.,"
       ...
       cFieldLength = "8,8,9,6,9," + "15,15,14,12,15,3"  
...
DEFINE VARIABLE fi_file AS CHARACTER FORMAT "X(45)" INITIAL "c:~\tmp~\FGSalesValueByTag.csv" 
     LABEL "Name" 
...
DEFINE FRAME FRAME-A
     tb_cust-list AT ROW 1.76 COL 32 WIDGET-ID 6
     btnCustList AT ROW 1.81 COL 64 WIDGET-ID 8
     begin_cust AT ROW 2.91 COL 28.6 COLON-ALIGNED HELP
          "Enter Beginning Customer Number"
     end_cust AT ROW 2.91 COL 71.6 COLON-ALIGNED HELP
          "Enter Ending Customer Number"
     begin_cust-po AT ROW 3.86 COL 28.6 COLON-ALIGNED HELP
          "Enter Beginning Customer PO Number"
     end_cust-po AT ROW 3.86 COL 71.6 COLON-ALIGNED HELP
          "Enter Ending Customer PO Number"
     begin_slm AT ROW 4.81 COL 28.6 COLON-ALIGNED HELP
          "Enter Beginning Sales Rep Number"
     end_slm AT ROW 4.81 COL 71.6 COLON-ALIGNED HELP
          "Enter Ending Sales Rep Number"
     tb_inc-zer AT ROW 6.19 COL 32.6
     tb_inc-cust AT ROW 7.14 COL 77.6 RIGHT-ALIGNED
     sl_avail AT ROW 9.19 COL 3 NO-LABEL WIDGET-ID 26
     Btn_Def AT ROW 9.19 COL 40.2 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 56
     sl_selected AT ROW 9.19 COL 60.6 NO-LABEL WIDGET-ID 28
     Btn_Add AT ROW 10.19 COL 40.2 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 32
     Btn_Remove AT ROW 11.19 COL 40.2 HELP
          "Remove Selected Table from Tables to Audit" WIDGET-ID 34
     btn_Up AT ROW 12.24 COL 40.2 WIDGET-ID 40
     btn_down AT ROW 13.24 COL 40.2 WIDGET-ID 42
     lv-ornt AT ROW 15.29 COL 44 NO-LABEL
     lines-per-page AT ROW 15.29 COL 87 COLON-ALIGNED
     rd-dest AT ROW 15.48 COL 5 NO-LABEL
     lv-font-name AT ROW 16.24 COL 25 COLON-ALIGNED NO-LABEL
     lv-font-no AT ROW 16.24 COL 84 COLON-ALIGNED
     td-show-parm AT ROW 18.05 COL 28.2
     fi_file AT ROW 19.14 COL 26.2 COLON-ALIGNED HELP
          "Enter File Name"
     tb_OpenCSV AT ROW 19.19 COL 92 RIGHT-ALIGNED
     tbAutoClose AT ROW 20.57 COL 28.2 WIDGET-ID 58
     btn-ok AT ROW 21.48 COL 28
     btn-cancel AT ROW 21.48 COL 58
     "Available Columns" VIEW-AS TEXT
          SIZE 29 BY .62 AT ROW 8.48 COL 3 WIDGET-ID 38
     " Selection Parameters" VIEW-AS TEXT
          SIZE 21 BY .71 AT ROW 1.1 COL 5
     " Output Destination" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 14.71 COL 5
     "Selected Columns(In Display Order)" VIEW-AS TEXT
          SIZE 34 BY .62 AT ROW 8.43 COL 60.2 WIDGET-ID 44
...
------------------------------------------------------------------------------*/
  DISPLAY tb_cust-list begin_cust end_cust begin_cust-po end_cust-po begin_slm 
          end_slm tb_inc-zer tb_inc-cust sl_avail sl_selected rd-dest 
...
/*------------------------------------------------------------------------------
    ...
    DO WITH FRAME {&FRAME-NAME}:
        ...
        ASSIGN 
            fi_file:SCREEN-VALUE = "c:\tmp\FGSalesValueByTag.csv".
    END.
