...
ASSIGN cTextListToSelect = "FG ITEM #,NAME,PROD CAT,UOM,CUST. #,CUST NAME,QTY ON HAND," +
           ...
           cFieldListToSelect = "i-no,i-name,procat,sell-uom,cust-no,cust-name,v-qtyoh," +
                                ...
                                "job,po,group"
           cFieldLength = "15,30,8,3,8,30,12," + "32,28,28,28,8,12,12,12," + "8,8,8,10,10,30,7," +
...
begin_cat end_cat tb_zero tb_cust-whse rd_sort tb_prod-cat Btn_Def sl_avail ~
...
DEFINE VARIABLE fi_file AS CHARACTER FORMAT "X(45)" INITIAL "c:~\tmp~\ItemMasterList.csv" 
     LABEL "Name" 
...
DEFINE FRAME FRAME-A
     ...
     Btn_Def AT ROW 12.57 COL 41 HELP
          "Default Selected Table to Tables to Audit" WIDGET-ID 56
     sl_avail AT ROW 12.62 COL 4.8 NO-LABEL WIDGET-ID 26
     sl_selected AT ROW 12.62 COL 60.8 NO-LABEL WIDGET-ID 28
     Btn_Add AT ROW 13.71 COL 41 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 32
     Btn_Remove AT ROW 14.91 COL 41 HELP
          "Remove Selected Table from Tables to Audit" WIDGET-ID 34
     btn_Up AT ROW 16.1 COL 41 WIDGET-ID 40
     btn_down AT ROW 17.29 COL 41 WIDGET-ID 42
     lv-ornt AT ROW 19.1 COL 53 NO-LABEL
     rd-dest AT ROW 19.29 COL 4.8 NO-LABEL
     lv-font-name AT ROW 20.05 COL 27 COLON-ALIGNED NO-LABEL
     lines-per-page AT ROW 20.19 COL 84 COLON-ALIGNED
     lv-font-no AT ROW 21.24 COL 83 COLON-ALIGNED
     td-show-parm AT ROW 21.76 COL 28.6
     fi_file AT ROW 22.81 COL 26.4 COLON-ALIGNED HELP
          "Enter File Name"
     tb_OpenCSV AT ROW 22.86 COL 92.4 RIGHT-ALIGNED
     tbAutoClose AT ROW 24.24 COL 28.2 WIDGET-ID 16
     btn-ok AT ROW 25.14 COL 27.8
     btn-cancel AT ROW 25.14 COL 52
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 18.57 COL 4
     " Selection Parameters" VIEW-AS TEXT
          SIZE 21 BY .71 AT ROW 1.24 COL 5
          BGCOLOR 15 
     RECT-6 AT ROW 18.86 COL 3
     RECT-7 AT ROW 1.71 COL 3
     RECT-8 AT ROW 12.14 COL 3 WIDGET-ID 44
...
/* security check need {methods/prgsecur.i} in definition section */
  ...
  btn-ok:load-image("Graphics/32x32/Ok.png").
    ...
    RUN enable_UI.
    {sys/inc/reportsConfigNK1.i "IR9" }
    ASSIGN
...
------------------------------------------------------------------------------*/
  DISPLAY begin_whse end_whse tb_cust-list begin_cust-no end_cust-no begin_i-no 
          ...
          tb_prod-cat sl_avail sl_selected rd-dest fi_file tb_OpenCSV 
          tbAutoClose 
  ...
  ENABLE RECT-6 RECT-7 RECT-8 begin_whse end_whse tb_cust-list btnCustList 
         ...
         tb_zero tb_cust-whse rd_sort tb_prod-cat Btn_Def sl_avail sl_selected 
...
/*------------------------------------------------------------------------------
    ...
    DO WITH FRAME {&FRAME-NAME}:
        ...
        ASSIGN 
            fi_file:SCREEN-VALUE = "c:\tmp\ItemMasterList.csv".
    END.
