...
&Scoped-Define ENABLED-OBJECTS RECT-25 Btn_cpyest Btn_est Btn_est-2 ~
Btn_Cancel 
...
DEFINE BUTTON Btn_cpyest AUTO-GO 
     LABEL "Copy Estimate" 
     SIZE 26 BY 2.14
     BGCOLOR 8 .
...
DEFINE FRAME D-Dialog
     Btn_cpyest AT ROW 1.71 COL 18 WIDGET-ID 2
     Btn_est AT ROW 4.48 COL 18
     Btn_est-2 AT ROW 7.1 COL 18
     Btn_Cancel AT ROW 9.95 COL 18
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Copy Option */
DO:  
...
&Scoped-define SELF-NAME Btn_cpyest
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Btn_cpyest D-Dialog
ON CHOOSE OF Btn_cpyest IN FRAME D-Dialog /* Copy Estimate */
DO:
    assign ls-add-what = "copy".
...
------------------------------------------------------------------------------*/
  ENABLE RECT-25 Btn_cpyest Btn_est Btn_est-2 Btn_Cancel 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
