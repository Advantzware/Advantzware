...
ASSIGN cTextListToSelect = "Check/Journal#,Trans Date,Amount,Bank,Vendor#,Name,Cleared?"  

      cFieldListToSelect = "tt-number,tt-date,tt-amt,tt-bank,tt-vend,tt-name,tt-cleared" 
       .

{sys/inc/ttRptSel.i}
ASSIGN cTextListToDefault  = "Check/Journal#,Trans Date,Amount,Bank,Vendor#,Name,Cleared?"   .
...
DEFINE VARIABLE fi_file AS CHARACTER FORMAT "X(30)" INITIAL "c:~\tmp~\r-bnk-recl.csv" 
...
DEFINE FRAME rd-fgexp
     begin_chk-no AT ROW 3.95 COL 26.6 COLON-ALIGNED HELP
          "Enter Beginning Carrier Number" WIDGET-ID 142
     end_chk-no AT ROW 3.95 COL 73 COLON-ALIGNED HELP
          "Enter Ending Carrier #" WIDGET-ID 144
     begin_vend AT ROW 5.24 COL 26.6 COLON-ALIGNED HELP
          "Enter Beginning Delivery Zone" WIDGET-ID 142
     end_vend AT ROW 5.24 COL 73 COLON-ALIGNED HELP
          "Enter Ending Delivery Zone" WIDGET-ID 144
     begin_date AT ROW 6.52 COL 26.6 COLON-ALIGNED HELP
...
ASSIGN 
       begin_chk-no:PRIVATE-DATA IN FRAME rd-fgexp     = 
                "parm".
...
ASSIGN 
       end_chk-no:PRIVATE-DATA IN FRAME rd-fgexp     = 
                "parm".
