...
DEFINE VARIABLE h_b-apinv AS HANDLE NO-UNDO.
...
DEFINE FRAME OPTIONS-FRAME
     SPACE(147.81) SKIP(1.82)
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 2 ROW 1 SCROLLABLE 
         BGCOLOR 4 .

DEFINE FRAME message-frame
     SPACE(103.01) SKIP(1.15)
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 46 ROW 2.91 SCROLLABLE 
         BGCOLOR 4 .
...
/* SETTINGS FOR FRAME message-frame
   Size-to-Fit                                                          */
ASSIGN 
       FRAME message-frame:SCROLLABLE       = FALSE.

/* SETTINGS FOR FRAME OPTIONS-FRAME
   Size-to-Fit                                                          */
ASSIGN 
       FRAME OPTIONS-FRAME:SCROLLABLE       = FALSE.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'ap/b-apinv.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-apinv ).
       RUN set-position IN h_b-apinv ( 4.81 , 4.00 ) NO-ERROR.
       RUN set-size IN h_b-apinv ( 19.52 , 134.00 ) NO-ERROR.

       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('2') NO-ERROR.

       /* Links to SmartNavBrowser h_b-apinv. */
       RUN add-link IN adm-broker-hdl ( h_p-navico , 'Navigation':U , h_b-apinv ).
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-size IN h_p-arinv ( 1.43 , 82.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-cashl ).
       RUN set-position IN h_p-cashl ( 22.43 , 65.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_b-apinv , 'Record':U , h_v-apinv ).
