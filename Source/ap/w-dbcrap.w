...
ON END-ERROR OF W-Win /* Debit/Credit Memos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Debit/Credit Memos */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-arinv ).
       RUN set-position IN h_p-arinv ( 4.81 , 93.00 ) NO-ERROR.
       RUN set-size IN h_p-arinv ( 6.43 , 23.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = Yes':U ,
             OUTPUT h_v-dbcr ).
       RUN set-position IN h_v-dbcr ( 5.05 , 7.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = Yes':U ,
             OUTPUT h_b-dbcr2 ).
       RUN set-position IN h_b-dbcr2 ( 11.48 , 3.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-navico ).
       RUN set-position IN h_p-navico ( 22.19 , 9.00 ) NO-ERROR.
