...
end_shift tb_tot-hrs tb_pg-brk rd-dest fi_file tb_OpenCSV tbAutoClose ~
btn-ok btn-cancel 
...
DEFINE FRAME FRAME-A
    ...
    rd-dest AT ROW 11.48 COL 6 NO-LABELS
    lv-font-no AT ROW 11.71 COL 35 COLON-ALIGNED
    tb_excel AT ROW 11.95 COL 75 RIGHT-ALIGNED WIDGET-ID 4
    lv-font-name AT ROW 12.86 COL 29 COLON-ALIGNED NO-LABELS
    td-show-parm AT ROW 14.1 COL 28.8
    fi_file AT ROW 15.29 COL 26.8 COLON-ALIGNED HELP
    "Enter File Name" WIDGET-ID 2
    tb_OpenCSV AT ROW 15.38 COL 92.4 RIGHT-ALIGNED WIDGET-ID 6
    tbAutoClose AT ROW 17.1 COL 28.8 WIDGET-ID 64
    btn-ok AT ROW 17.95 COL 28.8
    btn-cancel AT ROW 17.95 COL 48.8
    " Output Destination" VIEW-AS TEXT
    SIZE 19 BY .62 AT ROW 10.52 COL 5
    " Selection Parameters" VIEW-AS TEXT
    SIZE 21.2 BY .71 AT ROW 1.14 COL 5
    RECT-6 AT ROW 10.91 COL 4
...
PROCEDURE enable_UI :
    ...
    ENABLE RECT-6 RECT-7 begin_date end_date begin_mach end_mach begin_job-no 
        ...
        tb_pg-brk rd-dest fi_file tb_OpenCSV tbAutoClose btn-ok btn-cancel 
        WITH FRAME FRAME-A IN WINDOW C-Win.
...
PROCEDURE post-wip :
    ...
    FOR EACH tt-report NO-LOCK,
      ...
      AND mach.m-code EQ pc-prdd.m-code
        ...
        IF pc-prdd.complete AND pc-prdd.qty NE 0 THEN 
        DO:
    ...
    DO WITH FRAME {&FRAME-NAME}:
        ...
        ELSE
            ASSIGN
                ...
                .
        ASSIGN 
            fi_file:SCREEN-VALUE = "c:\tmp\WipEditList.csv".   
    END.
