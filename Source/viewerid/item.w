...
&Scoped-Define ENABLED-FIELDS item.i-no item.i-name 
...
&Scoped-Define DISPLAYED-FIELDS item.i-no item.i-name 
...
DEFINE FRAME F-Main
     item.i-no AT ROW 1.71 COL 12 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 14 BY 1
     item.i-name AT ROW 1.71 COL 28 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 38 BY 1
