...
FIND FIRST xeb WHERE xeb.company = xest.company 
   ...
   FOR EACH est-prep WHERE est-prep.company = xest.company 
       ...
       IF est-prep.code NE "" THEN DO:
          ...
          IF LOOKUP(cerunc,"Protagon,CERunC 3,Atlantic") NE 0 /*cerunc EQ "Protagon"*/ AND
   ...
   FOR EACH xef WHERE xef.company = xest.company 
      ...
      IF tmpstore = "new" THEN DO i = 1 TO 6:
         ...
         tmpstore = "done".
         PUT SKIP(1).
         IF LOOKUP(cerunc,"Protagon,CERunC 3,Atlantic") NE 0 /*cerunc = "Protagon"*/ THEN
   ...
   IF LOOKUP(cerunc,"Protagon,CERunC 3,Atlantic") NE 0 /*cerunc EQ "Protagon"*/ AND AVAIL tt-prep-sep AND ip-last-ef  THEN
   DO:
