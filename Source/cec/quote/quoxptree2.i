/* Mod: Ticket - 103137 (Format Change for Order No. and Job No.    */ 
 ...
 PUT "<R2><C3><#89><R+12><C+43><IMAGE#89=" ls-full-img1 FORMAT "x(200)". /* Abox logo */ 
  PUT "<=1>" SKIP. 
  PUT "<C1><#2><Farial>"
  ...
  PUT "<|10><R4><C50><#3><FROM><R8><C80><RECT>" SKIP
   ...
   PUT "<FArial><=5><R+1><C1.5>Est#/Qt#<C11>Part#/Description<C30>Item/Style/Color/Board<C53>Quantity<C61>Release<C69.5>Price<C76>UOM" "<FCourier New>" SKIP(1).
   /* PUT "<FCourier New>".*/
