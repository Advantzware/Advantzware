            ...
            ELSE
                ...
                ELSE
                    ...
                    ELSE
                        IF i EQ 5 THEN 
                        DO:   
                            IF (AVAILABLE eb AND eb.i-coldscr NE "") OR xqitm.i-coldscr NE "" THEN
                                PUT "<C22>" (IF AVAILABLE eb AND eb.i-coldscr NE "" THEN eb.i-coldscr ELSE xqitm.i-coldscr)   FORM "x(40)".
                            ELSE 
                            DO:
                                numfit = numfit + 1 .
                                NEXT .
                        ...
                        ELSE
                            ...
                            ELSE
                                ...
                                ELSE
                                    IF i EQ 8  THEN 
                                    DO:  
                                        PUT "<C22>DIE#: " + (IF AVAILABLE eb THEN eb.die-no ELSE "") FORM "x(30)"  .
                                    END.
                                    ELSE
                                        IF i EQ 9  THEN 
                                        DO: 
                                            PUT "<C22>CAD#: " + (IF AVAILABLE eb THEN eb.cad-no ELSE "")  FORM "x(30)" .
                                        END.
                                        ELSE
                                            IF i EQ 10  THEN 
                                            DO:  
                                                ...
                                                DO j = 1 TO 6:
                                                    ...
                                                    DO:                    
                                                        ...
                                                        DO:
                                                            lCheckUom = IF xqqty.uom EQ "EA" OR xqqty.uom EQ "M" THEN YES ELSE NO.
                                                            ...
                                                            IF NOT lCheckPrice THEN 
                                                            DO:                     
                                                                PUT "<C49>" xqqty.qty FORMAT ">>>>>>>9"  SPACE(2)
                                                                    xqqty.rels 
                                                                    "<C66>"xqqty.price FORMAT "->>>>,>>9.99<<" SPACE(1)
                                                                    xqqty.uom.
                            
                                                                v-line-total = v-line-total + xqqty.price.
                                                            END.
                                                            IF lCheckPrice AND (xqqty.uom EQ "EA" OR xqqty.uom EQ "M") THEN 
                                                            DO:       
                                                                IF xqqty.uom EQ "EA" THEN
                                                                DO:
                                                                    PUT "<C66>" 
                                                                        (xqqty.price * 1000) FORMAT "->>>>,>>9.99<<" SPACE(1)
                                                                        "M".               
                                                                END.
                                                                IF xqqty.uom EQ "M" THEN
                                                                DO:
                                                        ...
                                                        END.
                                                        PUT  SKIP.
                                                        IF lCheckPrice OR NOT lCheckUom THEN
                                                            FIND NEXT xqqty OF xqitm NO-LOCK NO-ERROR.  
                                                        lCheckPrice = IF NOT lCheckPrice THEN YES ELSE NO.
                                                    END.
                                                END.
                                            END.
    ...
    DO :      /* Print components of a set */
        ...
        IF AVAILABLE(est) AND 
            ...
            FOR EACH ef WHERE ef.company EQ est.company
                ...
                PUT eb.part-dscr1 AT 10 FORM "x(21)" SPACE
                    style-dscr SKIP.
                cAdder = "" .
                DO i = 1 TO 6:
                ...
                PUT eb.part-dscr2  AT 10  FORM "x(21)" SPACE
