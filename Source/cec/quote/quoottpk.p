/* ------------------------------------------- cec/quote/quoottpk.p 06/05 YSK */
/* print quotes - Xprint format for Ott Package    Task# 06080507                                       */
/* -------------------------------------------------------------------------- */
...
ASSIGN ls-image1 = "images\ottpkg.jpg"
...
*/                
           PUT "<FBook Antiqua><R58><C1><P12><B> Comments </B> <P8> " SKIP
             ...
             "  subject to overrun / under run up to 20%.   Thank You" SKIP
             "  <B>OTT Packagings Inc. <U>appreciates your valuable business</U> and we are committed to"
             "  providing assistance at any time to meet your needs.</B>        <P9><FCourier New>" /*AT 210*/ SKIP.           
