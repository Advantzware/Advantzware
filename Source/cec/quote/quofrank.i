/* ------------------------------------------- cec/quote/quofrank.i 09/05 YSK */
/* print quote items in Frankston format                                          */
/* -------------------------------------------------------------------------- */
  ...
  DO i = 1 TO numfit /*WITH FRAME item-10p */:
    ...
    IF i EQ 2 THEN DO:
      ...
      ELSE DO:
           ...
           ELSE trim-size = "".
      END.
      PUT  /*xquo.q-no*/  trim-size AT 10 FORM "x(20)" " "
              /*xqitm.style*/  style-dscr  SPACE(4) .
    END.
    /*ELSE
    IF i EQ 3 THEN
    ...
    IF i EQ 3 THEN DO:
       ...
       PUT IF AVAIL ef THEN ef.brd-dscr /*xqitm.i-dscr*/ ELSE "" AT 31 FORMAT "x(30)" SPACE(4).
       IF v-boardDescription EQ 'Quote' THEN
       PUT xqitm.i-dscr AT 31 FORMAT "x(30)" SPACE(4).
    END.
    ELSE
    IF i EQ 4 THEN
         PUT xqitm.i-coldscr  AT 31 FORM "x(30)"    SPACE(4).  
    /*ELSE
    ...
    END. */
    IF i > 4 /*5*/ THEN PUT SPACE(62) . /*Task# 11011301*/
    ...
    /*  IF i EQ 3 THEN
      ...
      ELSE*/ 
       ...
       put     "<C51>"xqqty.qty /*xqqty.rels*/ FORM ">>,>>>,>>9" space(2)
  ...
  FOR EACH xqqty OF xqitm NO-LOCK,
    ...
    IF INDEX("TML",xqchg.bill) GT 0 THEN
       PUT xqchg.charge       AT 22
           ...
           lv-chg-amt FORM "$->>,>>9.99" /*xqchg.amt*/  TO 85 SKIP.
...
FOR EACH xqchg OF xquo NO-LOCK
  ...
  /*IF xqchg.qty EQ 0 OR FIRST-OF(xqchg.b-num) THEN DO:*/
    ...
    IF INDEX("TML",xqchg.bill) GT 0 THEN
      PUT xqchg.charge       AT 22
         /* "Time & Materials" AT 45 */
          lv-chg-amt  FORM "$->>,>>9.99"        TO 85 SKIP.
