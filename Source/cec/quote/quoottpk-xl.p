...
DO:
   ASSIGN ls-image1 = "images\TRILAKE.jpg".
...
IF CallingParameter = "CSC-EXCEL"  THEN
   ASSIGN chFile = CurrDir + "\Template\quote.xlt" no-error.
...
if not ch-multi then do:
   ...
   {cec/quote/quoottp1-xl.i}    
   {cec/quote/quoottpk-xl.i 1}
   
   IF CallingParameter = "TRILAKE-EXCEL" THEN
      RUN util/GetBottomRow.p(input 18, input 44, input 4, input inrowcount, output inrowcount ).
   ELSE IF CallingParameter = "CSC-EXCEL" THEN
   ...
   assign inrowcount = inrowcount + 3 .
