/* ------------------------------------------- cec/quote/quoprm-mci.p - BPV 6/27/2012        */
/* -------------------------------------------------------------------------- */
...
if (xquo.shipto[1] eq xquo.soldto[1] and
  ...
  RUN sys/ref/getFileFullPathName.p ("Template\QuoteMCI.xlt", OUTPUT chFile).
  IF chFile = ? THEN  
...
if not ch-multi then do:
   ...
   {cec/quote/quoprm2-xl.i}    
   {cec/quote/quoprm-xl.i 1}
