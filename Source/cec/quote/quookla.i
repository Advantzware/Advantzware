...
FOR EACH xqitm OF xquo NO-LOCK BREAK BY xqitm.part-no:
  ...
  /*from Multicell job-card - print long and short strips for partitions */
  ...
  IF numfit LT 6 AND ll-prt-dscr2 THEN numfit = 7.
  ELSE IF numfit LT 6 THEN numfit = 6.
  ...
  DO i = 1 TO numfit /*WITH FRAME item-10p */:
    ...
    IF i EQ 1 THEN DO:
      ...
      */
      PUT 
            xquo.q-no FORMAT ">>>>9" AT 1
/*           TRIM(lv-est-no) FORM "x(5)" AT 2 */
            xqitm.part-no           AT 8 FORMAT "x(11)"
            "Long Strip:"           AT 20
           .
...
/*       lv-part-dscr2 = IF ll-prt-dscr2 THEN xqitm.part-dscr2 ELSE style-dscr. */
         /* /*           xquo.q-no  trim-size AT 8 FORM "x(21)" */                      */
...
/*               /*xqitm.style*/ lv-part-dscr2 /* style-dscr*/  FORM "x(28)" . */
    ...
    IF i EQ 3 THEN DO:
        PUT     
            ...
            v-qty-set               AT 37
            v-slt1                  AT 43
            scr-in-cell-length      AT 47
            scr-end-cell-l2         AT 57 
            .
...
/*          adder-print = NO.                                                     */
/*                                                                                */
/*        IF (NOT logSetPrinting OR NOT s-print-comp) AND ll-prt-dscr2 THEN   */
...
/*        END.                                                                           */
    ...
    IF i EQ 6 THEN DO:
        PUT 
            ...
            v-qty-set2              AT 37
            v-slt2                  AT 43
            scr-in-cell-width       AT 47
            scr-end-cell-w2         AT 57
            .
...
/*             xqqty.rels          TO 85   FORMAT ">>9"         */
       ...
       */
       ...
       put xqqty.qty FORMAT ">>>>>>>9" AT 68 SPACE(2)
/*            xqqty.rels space(5) */
