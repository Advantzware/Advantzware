...
/*                 TRIM(lv-est-no) FORM "x(5)" AT 2 */
                xqitm.part-no AT 1 FORMAT "x(15)"
...
/*                IF AVAILABLE(ITEM)                                                                   */
/*                 THEN ASSIGN chrX = IF AVAILABLE(ITEM)                                               */
/*                                      THEN item.est-dscr ELSE "".                                    */
/*            END.                                                                                     */
/*             IF TRIM(chrX) NE ""                                                                     */
/*               THEN PUT chrX AT 22 FORMAT "x(30)".                                                   */
/*           END.                                                                                      */
/*           ELSE                                                                                      */
...
/*            ELSE ASSIGN temp-trim-size = trim-size.                       */
           ...
           PUT 
               eb.part-no AT 8 FORMAT "x(15)" eb.part-dscr1 AT 30 FORMAT "x(30)" SKIP.
...
/*          ASSIGN */
/*             v-board = ef.brd-dscr + " - " + ef.adder[1] + " " +           */
