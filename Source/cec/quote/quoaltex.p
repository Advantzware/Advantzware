/* ------------------------------------------- cec/quote/quoaltex.p 10/02 YSK */
/* print quotes in Pacific - altex format                                               */
/* -------------------------------------------------------------------------- */
...
ASSIGN
    ...
    cQuoteNumber       = IF NOT ch-multi  THEN STRING(xquo.q-no) ELSE "See Below"
    v-line-total       = 0
    v-printline        = 0
