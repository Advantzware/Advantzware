/* ------------------------------------------- cec/quote/quosmkct.i 05/18 GDM */
...
IF AVAILABLE(est) AND est.est-type EQ 6  
  THEN logSetPrinting = TRUE.
