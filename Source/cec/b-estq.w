...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 161 BY 14.76
         FONT 22.
...
DEFINE FRAME F-Main
     ...
     vi_stock-no AT ROW 1.95 COL 59.8 COLON-ALIGNED NO-LABEL
     vi_part-dscr1 AT ROW 3.14 COL 60 COLON-ALIGNED NO-LABEL
     vi_style AT ROW 1.95 COL 80 COLON-ALIGNED NO-LABEL
     vi_len AT ROW 1.95 COL 95 COLON-ALIGNED NO-LABEL
     vi_len-2 AT ROW 1.95 COL 112 COLON-ALIGNED NO-LABEL
     vi_wid AT ROW 2.91 COL 95 COLON-ALIGNED NO-LABEL
     vi_wid-2 AT ROW 2.91 COL 112 COLON-ALIGNED NO-LABEL
     vi_dep AT ROW 3.86 COL 95 COLON-ALIGNED NO-LABEL
     vi_dep-2 AT ROW 3.86 COL 112 COLON-ALIGNED NO-LABEL
     vi_die-no AT ROW 1.95 COL 125 COLON-ALIGNED NO-LABEL
     TG_exact-match AT ROW 2 COL 149.4 WIDGET-ID 4
     vi_cad-no AT ROW 2.91 COL 125 COLON-ALIGNED NO-LABEL
     vi_plate-no AT ROW 3.86 COL 125 COLON-ALIGNED NO-LABEL
     ...
     "to" VIEW-AS TEXT
          SIZE 3 BY 1 AT ROW 2.91 COL 110
     "to" VIEW-AS TEXT
          SIZE 3 BY 1 AT ROW 3.86 COL 110
     "Die # / Cad # / Plate #" VIEW-AS TEXT
          SIZE 28 BY .62 AT ROW 1.24 COL 127
          FGCOLOR 9 FONT 22
     "L x W x D" VIEW-AS TEXT
          SIZE 13 BY .62 AT ROW 1.24 COL 105
          FGCOLOR 9 FONT 22
     ...
     "FG Item# / Name" VIEW-AS TEXT
          SIZE 20 BY .62 AT ROW 1.24 COL 62.2
          FGCOLOR 9 FONT 22
     "Style" VIEW-AS TEXT
          SIZE 9 BY .62 AT ROW 1.24 COL 82.6
          FGCOLOR 9 FONT 22
     "to" VIEW-AS TEXT
          SIZE 3 BY 1 AT ROW 1.95 COL 110
     ...
     "Ship To" VIEW-AS TEXT
          ...
          FGCOLOR 9 FONT 22
     "Match" VIEW-AS TEXT
          SIZE 6.8 BY .62 AT ROW 2.76 COL 153 WIDGET-ID 6
