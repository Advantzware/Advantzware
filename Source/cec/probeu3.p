...
IF LOOKUP(cerunc,"Protagon,CERunC 3,Atlantic") EQ 0 /*cerunc NE "Protagon"*/ THEN
...
IF LOOKUP(cerunc,"Protagon,CERunC 3,Atlantic") NE 0 /*cerunc EQ "Protagon"*/ AND SEARCH(tmp-dir + TRIM(xest.est-no) + ".z" +
