  ...
  CASE adm-current-page: 
    ...
    WHEN 3 THEN DO:
      ...
      /* RUN init-object IN THIS-PROCEDURE (
       ...
       /*RUN add-link IN adm-broker-hdl ( /*h_b-item*/ h_v-item , 'nav-itm':U , h_v-navest ).*/
    ...
    WHEN 4 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( /*h_b-item*/ h_v-item , 'Record':U , h_e-item-2 ).
       ...
       /*RUN add-link IN adm-broker-hdl ( /*h_b-item*/ h_v-item , 'nav-itm':U , h_v-navest-2 ).*/
    ...
    WHEN 6 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( /*h_b-item*/ h_v-item , 'Record':U , h_b-rmainq ).
    ...
    WHEN 7 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( /*h_b-item*/ h_v-item , 'Record':U , h_rm-ibin ).
    ...
    WHEN 9 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( /*h_b-item*/ THIS-PROCEDURE , 'history':U , h_b-rmiinq ).
...
------------------------------------------------------------------------------*/
  ...
  do:
      ...
      ASSIGN li-pageb4VendCost = li-prev-page.
