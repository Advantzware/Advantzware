...
DEF TEMP-TABLE tt-box like box-design-hdr.
DEF TEMP-TABLE tt-line LIKE box-design-line.
...
DO:
    ...
    ASSIGN lv-file.
    /* save current data */
    OUTPUT TO c:\tmp\boxdesgn.d.
    FOR EACH box-design-hdr
        WHERE box-design-hdr.company EQ cocode
        NO-LOCK:
      EXPORT box-design-hdr.
    END.
    OUTPUT CLOSE.
    OUTPUT TO c:\tmp\boxline.d.
    FOR EACH box-design-line
        WHERE box-design-line.company EQ cocode
        NO-LOCK:
      EXPORT box-design-line.
    END.
    OUTPUT CLOSE.
    /*
    FOR EACH box-design-hdr WHERE BOX-design-hdr.design-no > 0:
    ...
    */
    ...
    REPEAT:
        CREATE tt-box.
        IMPORT tt-box.
        FIND FIRST box-design-hdr WHERE box-design-hdr.company = cocode
                                    AND box-design-hdr.design-no = tt-box.design-no
                         NO-ERROR.
        IF NOT AVAIL box-design-hdr THEN CREATE box-design-hdr.
        BUFFER-COPY tt-box EXCEPT rec_key company TO box-design-hdr
        ASSIGN
         box-design-hdr.company = cocode.
    END.
    lv-file2 = lv-file.
    ...
    REPEAT:
        ...
        CREATE tt-line.
        IMPORT tt-line.
        FIND FIRST box-design-line 
             WHERE box-design-line.company = cocode
               AND box-design-line.design-no = tt-line.design-no
               AND box-design-line.line-no = tt-line.line-no
               NO-ERROR.
        IF NOT AVAIL box-design-line THEN CREATE box-design-line.
        BUFFER-COPY tt-line EXCEPT rec_key company TO box-design-line
        ASSIGN
         box-design-line.company = cocode.
    END.
