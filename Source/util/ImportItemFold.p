...
DEFINE TEMP-TABLE ttImportItem
    ...
    FIELD reg-no               AS CHARACTER FORMAT "x(5)" COLUMN-LABEL "Reg. #" HELP "Optional - Size:5"            
    FIELD shrink               AS DECIMAL   FORMAT ">>9.9999" COLUMN-LABEL "Shrink%" HELP "Optional - Decimal"
    FIELD s-wid                AS DECIMAL   FORMAT ">>,>>9.99<<<" COLUMN-LABEL "Sheet Width" HELP "Optional - Decimal"
    FIELD s-len                AS DECIMAL   FORMAT ">>,>>9.99<<<" COLUMN-LABEL "Sheet Length" HELP "Optional - Decimal"
