...
DEFINE TEMP-TABLE ttImportJobSchedule
    ...
    FIELD jobNumber2              AS INTEGER FORMAT ">>9" COLUMN-LABEL "Job No2" HELP "Required - Integer"
    ...
    FIELD quantity                AS INTEGER FORMAT ">>>,>>>,>>9" COLUMN-LABEL "Quantity" HELP "Required - Integer"
    FIELD machineCode             AS CHARACTER FORMAT "x(10)" COLUMN-LABEL "Machine Code" HELP "Required - Size:10"
    FIELD machinePass             AS INTEGER   FORMAT ">>9" COLUMN-LABEL "Machine Pass" HELP "Required - Integer" 
    FIELD machineSequence         AS INTEGER   FORMAT ">>9" COLUMN-LABEL "Machine Sequence" HELP "Required - Integer"
    FIELD machineRunQuantity      AS DECIMAL FORMAT ">>>,>>>,>>9.99" COLUMN-LABEL "Machine Run Quantity" HELP "Required - Decimal"
   ...
   ASSIGN 
       iopiAdded = iopiAdded + 1.
        ...
        ASSIGN
            ...
            bf-job-mch.pass     = ipbf-ttImportJobSchedule.machinePass
...
PROCEDURE pValidate PRIVATE:
    ...
    IF oplValid THEN 
    DO:
        IF ipbf-ttImportJobSchedule.machinePass EQ 0 THEN 
            ASSIGN 
                oplValid = NO
    ...
    IF oplValid THEN 
    DO:
        FIND FIRST bf-ttImportJobSchedule NO-LOCK 
            ...
            AND ROWID(bf-ttImportJobSchedule) NE ROWID(ipbf-ttImportJobSchedule)
            NO-ERROR.
        IF AVAILABLE bf-ttImportJobSchedule THEN 
            ASSIGN 
                oplValid = NO 
    ...
    DO:
       FIND FIRST job EXCLUSIVE-LOCK 
        ...
        AND job.job-no2 EQ ipbf-ttImportJobSchedule.jobNumber2
        NO-ERROR.
        IF AVAIL job THEN
        DO:    
            ASSIGN 
