...
DEFINE FRAME DEFAULT-FRAME
     fiOrder AT ROW 2 COL 21.17 COLON-ALIGNED WIDGET-ID 42
     btCalculate AT ROW 2.08 COL 128 WIDGET-ID 36
     fiOrderDate AT ROW 5.54 COL 9 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     fiOrderTimeHours AT ROW 5.54 COL 41.17 COLON-ALIGNED WIDGET-ID 4
     fiOrderTimeMinutes AT ROW 5.54 COL 47.17 COLON-ALIGNED NO-LABEL WIDGET-ID 8
     fiExpectedDelDate AT ROW 5.54 COL 62 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     ...
     fiEvaluationOrderDate AT ROW 10.65 COL 39 COLON-ALIGNED WIDGET-ID 22
     slNK1Config AT ROW 10.92 COL 84 NO-LABEL WIDGET-ID 38
     fiIsWeekendOrder AT ROW 12.23 COL 39 COLON-ALIGNED WIDGET-ID 28
     fiIsSameDayOrder AT ROW 13.81 COL 39 COLON-ALIGNED WIDGET-ID 30
     fiIsNextDayOrder AT ROW 15.42 COL 39 COLON-ALIGNED WIDGET-ID 32
     fiIsWeekendDelivery AT ROW 17 COL 39 COLON-ALIGNED WIDGET-ID 34
     fiSurchargeItem AT ROW 19.12 COL 39 COLON-ALIGNED WIDGET-ID 46
     fiPrepCost AT ROW 19.12 COL 91.83 COLON-ALIGNED WIDGET-ID 48
     "OR" VIEW-AS TEXT
          SIZE 8 BY .69 AT ROW 3.69 COL 23 WIDGET-ID 54
     "Expected Delivery Date" VIEW-AS TEXT
          SIZE 34 BY .85 AT ROW 4.58 COL 63.83 WIDGET-ID 16
     "Evaluated NK1 Configuration" VIEW-AS TEXT
          SIZE 50 BY .85 AT ROW 9.81 COL 98 WIDGET-ID 40
     "(24 hours format)" VIEW-AS TEXT
          SIZE 25 BY .85 AT ROW 4.58 COL 35.33 WIDGET-ID 10
     ":" VIEW-AS TEXT
          SIZE 1 BY .85 AT ROW 5.77 COL 48.17 WIDGET-ID 6
     "Order Date" VIEW-AS TEXT
          SIZE 17 BY .85 AT ROW 4.58 COL 11 WIDGET-ID 14
     RECT-1 AT ROW 1.54 COL 4 WIDGET-ID 26
