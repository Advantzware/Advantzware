...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH rm-rcth WHERE ~{&KEY-PHRASE} ~
      AND rm-rcth.rita-code = "R" NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main rm-rcth
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main rm-rcth
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "JOBS.rm-rcth"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "JOBS.rm-rcth.rita-code = ""R"""
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "r-no" "rm-rcth" "r-no"}
