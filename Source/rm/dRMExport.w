...
IF ipcIndustry EQ "2" THEN
    ASSIGN 
        cTextListToSelect = "Item#,Name,DESC,Est.DESC,Item Code,Taxable,Mat'l Type,Mat'1 Dscr,Cost Type,Cost Dscr,Category,Category Dscr,QTY Usage PTD,Qty Usage YTD," + /*14 */
        ...
        cFieldListToSelect = "i-no,i-name,i-dscr,est-dscr,i-code,tax-rcpt,mat-type,mat-dscr,cost-type,costtype-descr,procat,procat-dscr,q-ptd,q-ytd," +   /* 14 */ 
...
{sys/inc/ttRptSel.i}
    IF ipcIndustry EQ "2" THEN
        ASSIGN cTextListToDefault  = "Item#,Name,DESC,Est.DESC,Item Code,Taxable,Mat'l Type,Cost Type,Category,QTY Usage PTD,Qty Usage YTD," +
    ...
    ELSE
   ASSIGN cTextListToDefault  = "Item#,Name,DESC,Est.DESC,Item Code,Taxable,Mat'l Type,Cost Type,Category,QTY Usage PTD,Qty Usage YTD," +
                            "Qty Usage Last YR,Ink Type,Press Type,Min Lbs/Job,SI/Lb,Wgt/100,Warehouse,Bin,Qty On Hand," +
                            "Caliper,Basis Weight,Reg. #,Shrink%,Sheet Width,Sheet Length,Roll Width,Core Dia,Department 1,Department 2,Department 3,Department 4,Department 5," +
                            "Department 6,Department 7,Department 8,Department 9,Department 10,Reduction% 1,Reduction% 2,Reduction% 3,Reduction% 4,Reduction% 5,Reduction% 6,Reduction% 7,Reduction% 8,Reduction% 9,Reduction% 10," +
                            "Sq In/Lb,Lin In/UOM,Length,Width,Depth,Avg Wt,Qty/Case,Case/Pallet,Flute" .
