...
&SCOPED-DEFINE h_Browse01 h_b-rmadj
...
DEFINE VARIABLE h_b-rmadj AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "WAREHOUSE TRANSACTION ADJUSTMENT"
         HEIGHT             = 24
         WIDTH              = 150
         MAX-HEIGHT         = 320
         MAX-WIDTH          = 320
...
ON END-ERROR OF W-Win /* WAREHOUSE TRANSACTION ADJUSTMENT */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* WAREHOUSE TRANSACTION ADJUSTMENT */
DO:
    ...
    WHEN 1 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = Yes':U ,
             OUTPUT h_b-rmadj ).
       RUN set-position IN h_b-rmadj ( 5.29 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-rmadj ( 17.14 , 146.00 ) NO-ERROR.
       ...
       /* Links to SmartNavBrowser h_b-rmadj. */
       RUN add-link IN adm-broker-hdl ( h_p-updsav-2 , 'TableIO':U , h_b-rmadj ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'add-item':U , h_b-rmadj ).
       RUN add-link IN adm-broker-hdl ( h_b-rmadj , 'Record':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-rmadj ,
             h_folder , 'AFTER':U ).
