...
DEFINE VARIABLE is-print-posted  AS LOG.
...
DEFINE VARIABLE v-header-chk       AS LOG       NO-UNDO.
...
ASSIGN 
    cTextListToSelect  = "CUSTOMER,NAME,CHECK #,DATE,CASH RECVD,INVOICE#,ORIGINAL AMT,AMT APPLIED,DISCOUNT,ON ACT PYMTS"
    cFieldListToSelect = "cust,name,chk,date,chs-rec,inv,org-amt,amt-app,disc,on-act"
    cFieldLength       = "8,30,12,10,11,9,14,13,10,12"
    cFieldType         = "c,c,c,c,i,c,i,i,i,i" 
    .

{sys/inc/ttRptSel.i}
ASSIGN 
    cTextListToDefault = "CUSTOMER,NAME,CHECK #,DATE,CASH RECVD,INVOICE#,ORIGINAL AMT,AMT APPLIED,DISCOUNT,ON ACT PYMTS" .
...
begin_date end_date lbl_sort rd_sort sl_avail sl_selected rd-dest fi_file ~
...
DEFINE VARIABLE fi_file        AS CHARACTER FORMAT "X(45)":U INITIAL "c:~\tmp~\CashHistory.csv" 
    LABEL "Name" 
...
DEFINE FRAME FRAME-A
    tb_cust-list AT ROW 2.14 COL 30 WIDGET-ID 6
    btnCustList AT ROW 2.19 COL 72.8 WIDGET-ID 8
    ...
    lbl_sort AT ROW 5.76 COL 30 COLON-ALIGNED NO-LABELS
    rd_sort AT ROW 5.76 COL 43 NO-LABELS
    sl_avail AT ROW 7.91 COL 3 NO-LABELS WIDGET-ID 26
    Btn_Def AT ROW 7.91 COL 40.4 HELP
    "Add Selected Table to Tables to Audit" WIDGET-ID 56
    sl_selected AT ROW 7.91 COL 60.8 NO-LABELS WIDGET-ID 28
    Btn_Add AT ROW 8.91 COL 40.4 HELP
    "Add Selected Table to Tables to Audit" WIDGET-ID 32
    Btn_Remove AT ROW 9.91 COL 40.4 HELP
    "Remove Selected Table from Tables to Audit" WIDGET-ID 34
    btn_Up AT ROW 10.95 COL 40.4 WIDGET-ID 40
    btn_down AT ROW 11.95 COL 40.4 WIDGET-ID 42
    lv-font-no AT ROW 13.86 COL 38 COLON-ALIGNED
    lines-per-page AT ROW 13.86 COL 87 COLON-ALIGNED
    rd-dest AT ROW 13.91 COL 5 NO-LABELS
    lv-ornt AT ROW 14.1 COL 47 NO-LABELS
    lv-font-name AT ROW 15.05 COL 29 COLON-ALIGNED NO-LABELS
    tb_excel AT ROW 16.24 COL 70 WIDGET-ID 4
    td-show-parm AT ROW 16.52 COL 28
    fi_file AT ROW 17.48 COL 26.2 COLON-ALIGNED WIDGET-ID 8
    tb_OpenCSV AT ROW 17.52 COL 77.6 WIDGET-ID 6
    tbAutoClose AT ROW 18.86 COL 28 WIDGET-ID 64
    btn-ok AT ROW 19.81 COL 28
    btn-cancel AT ROW 19.81 COL 54
    "Selected Columns(In Display Order)" VIEW-AS TEXT
    SIZE 34 BY .62 AT ROW 7.19 COL 60.8 WIDGET-ID 44
    " Output Destination" VIEW-AS TEXT
    SIZE 18 BY .62 AT ROW 13.19 COL 4.2
    " Selection Parameters" VIEW-AS TEXT
    SIZE 21 BY .71 AT ROW 1.24 COL 4.2
    BGCOLOR 15 
    "Available Columns" VIEW-AS TEXT
    SIZE 29 BY .62 AT ROW 7.19 COL 3 WIDGET-ID 38
    RECT-6 AT ROW 13.62 COL 3
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    RUN enable_UI.
    {sys/inc/reportsConfigNK1.i "AL1" }
    ASSIGN
...
PROCEDURE run-report :
    ...
    DEFINE VARIABLE iline-count     AS INTEGER .
    ...
    DEFINE VARIABLE v-custno   AS CHARACTER INIT "" NO-UNDO .
    DEFINE VARIABLE v-custname AS CHARACTER INIT "" NO-UNDO .
    DEFINE VARIABLE v-amtapp   AS DECIMAL   INIT 0 NO-UNDO .
    DEFINE VARIABLE v-disc     AS DECIMAL   INIT 0 NO-UNDO .
    ...
    DO WITH FRAME {&FRAME-NAME}:
        ...
        ELSE
            ASSIGN
                ...
                .
        ASSIGN 
            fi_file:SCREEN-VALUE = "c:\tmp\CashHistory.csv".   
    END.
