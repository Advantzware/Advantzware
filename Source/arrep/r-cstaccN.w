...
ASSIGN 
    cTextListToSelect  = "GL Acct#,Description,Customer,Inv#,Journal,Run#,Date,Amount"
...
{sys/inc/ttRptSel.i}
ASSIGN 
    cTextListToDefault = "GL Acct#,Description,Customer,Inv#,Journal,Run#,Date,Amount"  .
...
begin_cust end_cust begin_date end_date begin_acct end_acct tb_totals ~
...
begin_date end_date begin_acct end_acct tb_totals sl_avail sl_selected ~
...
DEFINE VARIABLE fi_file        AS CHARACTER FORMAT "X(45)" INITIAL "c:~\tmp~\r-cstacc.xls" 
    LABEL "Name" 
...
DEFINE FRAME FRAME-A
    tb_cust-list AT ROW 2.29 COL 21.6 WIDGET-ID 6
    btnCustList AT ROW 2.33 COL 65.6 WIDGET-ID 8
    begin_cust AT ROW 3.29 COL 19.6 COLON-ALIGNED HELP
    "Enter Beginning Customer Number"
    end_cust AT ROW 3.29 COL 63.6 COLON-ALIGNED HELP
    "Enter Ending Customer Number"
    begin_date AT ROW 4.24 COL 19.6 COLON-ALIGNED HELP
    "Enter Beginning Vendor Number"
    end_date AT ROW 4.24 COL 63.6 COLON-ALIGNED HELP
    "Enter Ending Vendor Number"
    begin_acct AT ROW 5.19 COL 19.6 COLON-ALIGNED HELP
    "Enter Beginning GL Account Number"
    end_acct AT ROW 5.19 COL 63.6 COLON-ALIGNED HELP
    "Enter Ending GL Account Number"
    tb_totals AT ROW 6.24 COL 38
    sl_avail AT ROW 8.1 COL 3 NO-LABELS WIDGET-ID 26
    Btn_Def AT ROW 8.1 COL 40.4 HELP
    "Add Selected Table to Tables to Audit" WIDGET-ID 56
    sl_selected AT ROW 8.1 COL 60.8 NO-LABELS WIDGET-ID 28
    Btn_Add AT ROW 9.1 COL 40.4 HELP
    "Add Selected Table to Tables to Audit" WIDGET-ID 32
    Btn_Remove AT ROW 10.1 COL 40.4 HELP
    "Remove Selected Table from Tables to Audit" WIDGET-ID 34
    btn_Up AT ROW 11.14 COL 40.4 WIDGET-ID 40
    btn_down AT ROW 12.14 COL 40.4 WIDGET-ID 42
    lv-font-no AT ROW 13.86 COL 37 COLON-ALIGNED
    lv-ornt AT ROW 13.86 COL 47 NO-LABELS
    lines-per-page AT ROW 13.91 COL 86.6 COLON-ALIGNED
    rd-dest AT ROW 14.19 COL 4.4 NO-LABELS
    lv-font-name AT ROW 14.81 COL 29 COLON-ALIGNED NO-LABELS
    td-show-parm AT ROW 16 COL 28.4
    fi_file AT ROW 16.91 COL 26.4 COLON-ALIGNED HELP
    "Enter File Name"
    tb_OpenCSV AT ROW 17 COL 77.8
    tbAutoClose AT ROW 18.14 COL 28.4 WIDGET-ID 16
    btn-ok AT ROW 19.1 COL 28
    btn-cancel AT ROW 19.1 COL 55
    "Selected Columns(In Display Order)" VIEW-AS TEXT
    SIZE 34 BY .62 AT ROW 7.38 COL 60.4 WIDGET-ID 44
    "Available Columns" VIEW-AS TEXT
    SIZE 29 BY .62 AT ROW 7.38 COL 3 WIDGET-ID 38
    " Output Destination" VIEW-AS TEXT
    SIZE 19 BY .62 AT ROW 13.29 COL 4
    " Selection Parameters" VIEW-AS TEXT
    SIZE 21.2 BY .71 AT ROW 1.1 COL 4.4
    BGCOLOR 15 
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    {methods/nowait.i}
    {sys/inc/reportsConfigNK1.i "AR10" }
    ASSIGN
...
PROCEDURE enable_UI :
    ...
    DISPLAY tb_cust-list begin_cust end_cust begin_date end_date begin_acct 
        end_acct tb_totals sl_avail sl_selected rd-dest fi_file tb_OpenCSV 
        tbAutoClose 
        WITH FRAME FRAME-A IN WINDOW C-Win.
    ENABLE RECT-6 RECT-7 tb_cust-list btnCustList begin_cust end_cust begin_date 
        end_date begin_acct end_acct tb_totals sl_avail Btn_Def sl_selected 
    ...
    DO WITH FRAME {&FRAME-NAME}:
        ...
        ELSE
            ASSIGN
                ...
                .
        ASSIGN 
            fi_file:SCREEN-VALUE = "c:\tmp\r-cstacc.csv".    
    END.
...
PROCEDURE run-report :
    ...
    DEFINE VARIABLE lv-amt         LIKE tt-report.amt EXTENT 5 NO-UNDO.
    DEFINE VARIABLE ld-tax-rate    AS DECIMAL   EXTENT 5 NO-UNDO.
    ...
    DEFINE VARIABLE chRangeRow  AS COMPONENT-HANDLE NO-UNDO.
    DEFINE VARIABLE chRangeCol  AS COMPONENT-HANDLE NO-UNDO.
    ...
    FOR EACH tt-report
        ...
        DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
            ...
            CASE cTmpField: 
                WHEN "act"     THEN 
                    ASSIGN 
                        cVarValue      = IF FIRST-OF(tt-report.actnum) THEN tt-report.actnum ELSE ""
        ...
        DO WITH FRAME detail:
            ...
            DO:
                ...
                END.
                PUT UNFORMATTED  
                    "       Customer Totals" SUBSTRING(cDisplay,23,300) SKIP.
                PUT SKIP(1).
            END. /* IF tb_totals */
        ...
        DO WITH FRAME detail:
            ...
            DO:
                ...
                END.
                PUT UNFORMATTED  
                    "       Acct# Totals" SUBSTRING(cDisplay,20,300) SKIP.
                PUT SKIP(3).
            END. /*if tb_totals*/
