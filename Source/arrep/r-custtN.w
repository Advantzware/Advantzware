...
ASSIGN 
    cTextListToSelect  = "Customer #,Customer Name,YTD Sales,LYR Sales," +
...
{sys/inc/ttRptSel.i}
ASSIGN 
    cTextListToDefault = "Customer #,Customer Name,YTD Sales,LYR Sales," +
...
tb_active tb_inactive lbl_sort rd_sort sl_avail sl_selected rd-dest fi_file ~
...
DEFINE VARIABLE fi_file         AS CHARACTER FORMAT "X(45)" INITIAL "c:~\tmp~\CustomerSnapshot.csv" 
    LABEL "Name" 
...
DEFINE FRAME FRAME-A
    tb_cust-list AT ROW 2.19 COL 30.6 WIDGET-ID 6
    btnCustList AT ROW 2.19 COL 73.4 WIDGET-ID 8
    begin_cust-no AT ROW 3.14 COL 28.6 COLON-ALIGNED HELP
    "Enter Beginning Customer Number"
    end_cust-no AT ROW 3.14 COL 71.6 COLON-ALIGNED HELP
    "Enter Ending Customer Number"
    begin_cust-type AT ROW 4.1 COL 28.6 COLON-ALIGNED HELP
    "Enter Beginning Customer Type"
    end_cust-type AT ROW 4.1 COL 71.6 COLON-ALIGNED HELP
    "Enter Ending Customer Type"
    begin_slsmn AT ROW 5.05 COL 28.6 COLON-ALIGNED HELP
    "Enter Beginning Sales Rep Number"
    end_slsmn AT ROW 5.05 COL 71.6 COLON-ALIGNED HELP
    "Enter Ending Sales Rep Number"
    begin_group AT ROW 6 COL 28.6 COLON-ALIGNED HELP
    "Enter Beginning Sales Rep Number" WIDGET-ID 58
    end_group AT ROW 6 COL 71.6 COLON-ALIGNED HELP
    "Enter Ending Sales Rep Number" WIDGET-ID 60
    tb_active AT ROW 7.1 COL 48.6 RIGHT-ALIGNED
    tb_inactive AT ROW 7.1 COL 72.4 RIGHT-ALIGNED
    lbl_sort AT ROW 8.24 COL 28.4 COLON-ALIGNED NO-LABELS
    rd_sort AT ROW 8.24 COL 38 NO-LABELS
    sl_avail AT ROW 10.24 COL 3 NO-LABELS WIDGET-ID 26
    Btn_Def AT ROW 10.24 COL 40.2 HELP
    "Add Selected Table to Tables to Audit" WIDGET-ID 56
    sl_selected AT ROW 10.24 COL 62.6 NO-LABELS WIDGET-ID 28
    Btn_Add AT ROW 11.38 COL 40.2 HELP
    "Add Selected Table to Tables to Audit" WIDGET-ID 32
    Btn_Remove AT ROW 12.57 COL 40.2 HELP
    "Remove Selected Table from Tables to Audit" WIDGET-ID 34
    btn_Up AT ROW 13.76 COL 40.2 WIDGET-ID 40
    btn_down AT ROW 14.91 COL 40.2 WIDGET-ID 42
    lv-ornt AT ROW 16.48 COL 45 NO-LABELS
    lines-per-page AT ROW 16.48 COL 87 COLON-ALIGNED
    lv-font-no AT ROW 16.62 COL 36 COLON-ALIGNED
    rd-dest AT ROW 16.71 COL 4.4 NO-LABELS
    lv-font-name AT ROW 17.67 COL 29 COLON-ALIGNED NO-LABELS
    tb_excel AT ROW 18.86 COL 92 RIGHT-ALIGNED
    tb_show-parm AT ROW 19.19 COL 28.2
    fi_file AT ROW 20.1 COL 26.2 COLON-ALIGNED HELP
    "Enter File Name"
    tb_OpenCSV AT ROW 20.19 COL 92.4 RIGHT-ALIGNED
    tbAutoClose AT ROW 21.48 COL 28.2 WIDGET-ID 64
    btn-ok AT ROW 22.43 COL 28
    btn-cancel AT ROW 22.43 COL 56
    " Output Destination" VIEW-AS TEXT
    SIZE 18 BY .62 AT ROW 16 COL 4
    " Selection Parameters" VIEW-AS TEXT
    SIZE 21 BY .71 AT ROW 1.24 COL 4
    RECT-6 AT ROW 16.38 COL 3
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    RUN enable_UI.
    {sys/inc/reportsConfigNK1.i "AR12" }
    ASSIGN
...
PROCEDURE run-report :
    ...
    FOR EACH cust
        ...
        FOR EACH ar-inv WHERE ar-inv.company = cocode 
            AND ar-inv.cust-no  = cust.cust-no NO-LOCK BY ar-inv.inv-date DESCENDING.
            ASSIGN 
            ...
            DO:            
                CASE cTmpField:               
                    ...
                    WHEN "date-field[1]"  THEN 
                        cVarValue = STRING(cust.date-field[1]).
                    WHEN  "ytd-sales" THEN 
                        cVarValue = STRING(cust.ytd-sales,"->>,>>>,>>9.99").
                    WHEN  "lyr-sales" THEN 
                        cVarValue = STRING(cust.lyr-sales,"->>>,>>>,>>9.99").
                    WHEN  "hibal" THEN 
                        cVarValue = STRING(cust.hibal,"->>,>>>,>>9.99").
                    WHEN  "num-inv" THEN 
                        cVarValue = STRING(cust.num-inv,">>>>>>>>9").
                    WHEN  "avg-pay" THEN 
                        cVarValue = STRING(cust.avg-pay,">>,>>>,>>9").
                    WHEN  "acc-bal" THEN 
                        cVarValue = STRING(cust.acc-bal,"->>>,>>>,>>9.99").
                    WHEN  "grp" THEN 
    ...
    DO WITH FRAME {&FRAME-NAME}:
        ...
        ELSE
            ASSIGN
                ...
                .
        ASSIGN 
            fi_file:SCREEN-VALUE = "c:\tmp\CustomerSnapshot.csv".    
    END.
