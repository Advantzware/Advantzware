...
FORM HEADER
       ...
       v-cus[1] AT 2 "<P12><B>Due Date: ON" AT 39 v-due-date  "</B><P10>"
       "Bin:" AT 80 v-loc-bin "<P12><B>" "Job#:" AT 110  v-job-prt "</B><P10>" "Overrun:" /*AT 131*/ lv-over-run format "x(7)"   
       SKIP
       v-cus[2] AT 2         "Est#:" AT 90 v-est-no  "Underrun:" AT 108 lv-under-run FORMAT "x(7)"
       SKIP
