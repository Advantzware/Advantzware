...
DEF VAR v-last-job         AS CHAR FORMAT "X(9)" NO-UNDO.
...
FORMAT HEADER
   "JOB NUMBER:<B>" TRIM(STRING(DYNAMIC-FUNCTION('sfFormat_JobFormatWithHyphen', v-job-no, v-job-no2) + "-" + STRING(v-form-no,"99"))) FORM "x(16)" "</B>"
