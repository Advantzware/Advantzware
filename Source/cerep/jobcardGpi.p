...
format HEADER 
       "<OLANDSCAPE><P12>" skip
        "<B>JOB NUMBER:<B><P13>" TRIM(STRING(DYNAMIC-FUNCTION('sfFormat_JobFormatWithHyphen', v-job-no, v-job-no2))) FORM "x(13)" "</B>"
            ...
            /*  if last-of(eb.form-no) then do: */
              ...
              /*v-upc-lbl = IF s-prt-sellprc THEN "Sell Price" ELSE "   UPC#". */
                ...
                IF FIRST-OF(eb.form-no) THEN
                 PUT "<C1>  <P10><B>F/B  FG ITEM/PO#/Ln#   #UP   FORM/JOB QTY  NAME/DESCRIPTION               CARTON SIZE/STYLE        CASE#/COUNT  ORDER TYPE/CAD#" /*v-upc-lbl */ "</B>" SKIP.
                v-job-qty = 0.
