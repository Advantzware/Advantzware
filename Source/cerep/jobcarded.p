...
format header
       ...
       "<C34><B><P12>Carded Graphics, LLC Factory Ticket <P11>"  "<C77>JOB START DATE:"  v-start-date /*"  PRINTED DATE:" TODAY*/  "</B><P10>" skip
       v-fill
...
for each job-hdr NO-LOCK
    ...
    if v-first then do:   
       ...
       ELSE PUT SKIP
            ...
            "<C34><B><P12>Carded Graphics, LLC Factory Ticket <P11>"  "<C77>JOB START DATE:" v-start-date "</B><P10>" skip
            v-fill SKIP.
       view frame head.
       VIEW FRAME bott.
