...
&scoped-define fld-name-2 eb.stock-no
&scoped-define fld-name-3 eb.part-no
&scoped-define SORTBY-1 BY eb.est-no
&scoped-define SORTBY-2 BY eb.stock-no
...
"est-no" ? "x(8)" "character" ? ? 2 ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > ASI.eb.cust-no
"cust-no" ? ? "character" ? ? 2 ? ? ? no ? no no ? yes no no "U" "" ""
...
"stock-no" "FG Item#" ? "character" ? ? 2 ? ? ? no ? no no ? yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE BROWSE-1 */
&ANALYZE-RESUME
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  &scoped-define key-phrase {&fld-name-2} begins ip-cur-val
  &scoped-define sortby-phrase {&sortby-2} descending
  &scoped-define IAMWHAT LOOKUP
  /*rd-sort = 2. /* stock-no*/ */
