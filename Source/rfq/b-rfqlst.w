...
DEFINE FRAME F-Main
     ...
     vi_part-dscr1 AT ROW 1.95 COL 64.8 COLON-ALIGNED NO-LABEL
     vi_style AT ROW 1.95 COL 100.4 COLON-ALIGNED NO-LABEL
     ...
     "Part Description" VIEW-AS TEXT
          SIZE 20 BY .62 AT ROW 1.24 COL 73.8
          FGCOLOR 9 FONT 6
     "Style" VIEW-AS TEXT
          SIZE 9 BY .62 AT ROW 1.24 COL 104.4
          FGCOLOR 9 FONT 6
     "RFQ#" VIEW-AS TEXT
