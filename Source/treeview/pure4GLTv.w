...
Made a special version of pure4gltv that will use a path relative to treeview
Introduced a few new preprocessors to manage the path of tvpics and tvskins
all relative to treeview}
...
DEFINE BUTTON SbtnScrollDown
     IMAGE-UP FILE "treeview/tvskins/Classic/scrollbuttondown.bmp":U NO-FOCUS
     LABEL ""
     SIZE 3.4 BY .81.

DEFINE BUTTON SbtnScrollUp
     IMAGE-UP FILE "treeview/tvskins/Classic/scrollbuttonup.bmp":U NO-FOCUS
     LABEL ""
     SIZE 3.4 BY .81.

DEFINE IMAGE imgsv
     FILENAME "treeview/tvskins/Classic/vscrollbg.jpg":U
...
&SCOPED-DEFINE tvskinpath treeviewtvskins/
&SCOPED-DEFINE tvpicpath treeviewtvpics/
...
&IF DEFINED (ADM-PROPERTY-DLG) = 0 &THEN
  &SCOP ADM-PROPERTY-DLG treeview/pure4glTvInstanceProp.w
&ENDIF
...
DEFINE VARIABLE gcDefaultIco       AS CHARACTER INITIAL "treeview/tvpics/Folder" NO-UNDO.
...
IF NOT lMthRtn THEN DO:
    ...
    btvpic.hpic:LOAD-IMAGE("treeview/tvpics/missingPicFile.bmp") NO-ERROR.
...
DO iiter = 1 TO gTvIterations:
    ...
    RUN createPic(/*X*/ 2 + 2 /*bnode.level*/ * gTvLevelWidth
                 ...
                 ,/*VISIBLE*/ NO
                 ,/*IMAGE file-name */ picFileName("collapsed","treeview/tvpics/Folder")).
...
------------------------------------------------------------------------------*/
    ...
    DO ON ERROR UNDO, LEAVE:
        ...
        RUN addNode ("n22"  ,"n2"  ,"node 22"  ,"treeview/tvpics/book02.bmp"   ,"expanded") NO-ERROR.
        RUN addNode ("n221" ,"n22" ,"node 221" ,"treeview/tvpics/book02.bmp"   ,"")         NO-ERROR.
        RUN addNode ("n222" ,"n22" ,"node 222" ,"treeview/tvpics/book02.bmp"   ,"")         NO-ERROR.
        RUN addNode ("n3"   ,""    ,"node 3"   ,"treeview/tvpics/present1.bmp" ,"expanded") NO-ERROR.
        RUN addNode ("n31"  ,"n3"  ,"node 31"  ,"treeview/tvpics/$.bmp"        ,"")         NO-ERROR.
        RUN addNode ("n4"   ,""    ,"node 4"   ,"treeview/tvpics/smile56.bmp"  ,"")         NO-ERROR.
    END.
    IF ERROR-STATUS:ERROR THEN DO:
...
ASSIGN
    cPicture-Folder = "treeview/tvskins/".
...
------------------------------------------------------------------------------*/
  ...
  IF glOnlyPlusMinus THEN CASE cCode:
      WHEN "noChild"   THEN RETURN "treeview/tvpics/blank.bmp".
      WHEN "expanded"  THEN RETURN "treeview/tvpics/minus.bmp".
      WHEN "collapsed" THEN RETURN "treeview/tvpics/plus.bmp".
  END CASE.
  ...
  IF ico = "treeview/tvpics/Folder" THEN DO:
      IF glPicWithPlusMinus THEN CASE cCode:
         WHEN "noChild"   THEN RETURN "treeview/tvpics/FoldNoSign.bmp".
         WHEN "expanded"  THEN RETURN "treeview/tvpics/FoldMinus.bmp".
         WHEN "collapsed" THEN RETURN "treeview/tvpics/FoldPlus.bmp".
      END CASE.
      ELSE CASE cCode:
         WHEN "noChild"   THEN RETURN "treeview/tvpics/Fold.bmp".
         WHEN "expanded"  THEN RETURN "treeview/tvpics/FoldOpen.bmp".
         WHEN "collapsed" THEN RETURN "treeview/tvpics/Fold.bmp".
      END CASE.
  END. /* ico = "treeview/tvpics/Folder" */
...
IF NOT ERROR-STATUS:ERROR /* The RUN GetCurrentThemeName failed because uxtheme.dll is not available (old MS Windows, or wine without multi skin support)*/
 AND iRtn = 0 THEN DO: /* = 0 means that GetCurrentThemeName ran fine, if error, then value is negative*/
    ...
    ASSIGN
     ...
     FILE-INFO:FILE-NAME = "treeview/tvskins/" + gWindowsSkin.
     IF FILE-INFO:FULL-PATHNAME = ? THEN DO:
         FILE-INFO:FILE-NAME = "treeview/tvskins/".
         emptySquare:TOOLTIP IN FRAME fsv  = "Skin was set to " + QUOTER(cwindowsSkin)
          ...
          + " directory with the necessary pictures~n =>(see what exists in the treeview/tvskins/Luna directory and provide the same)"
