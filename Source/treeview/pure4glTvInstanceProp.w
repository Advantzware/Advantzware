...
DO:
  CASE {&SELF-NAME}:SCREEN-VALUE:
    WHEN "1" THEN imgTreeStyle:LOAD-IMAGE("treeview/tvpics/FoldOpen.bmp") IN FRAME frameImg.
    WHEN "2" THEN imgTreeStyle:LOAD-IMAGE("treeview/tvpics/plus.bmp").
    WHEN "3" THEN imgTreeStyle:LOAD-IMAGE("treeview/tvpics/FoldMinus.bmp").
  END CASE.
END.
