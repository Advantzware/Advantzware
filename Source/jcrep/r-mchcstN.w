...
ASSIGN cTextListToSelect = "MACH CODE,JOB #,FG DESCRIPTION,EST M/R,ACT M/R,%VAR M/R,EST RUN," +
       ...
       cFieldLength = "9,13,30,10,10,8,10," + "10,8,10,10,8,15"
...
tb_show-dl tb_show-fo tb_show-vo sl_avail Btn_Def sl_selected Btn_Add ~
...
begin_job-no begin_job-no2 end_job-no end_job-no2 begin_date end_date ~
tb_show-dl tb_show-fo tb_show-vo sl_avail sl_selected rd-dest fi_file ~
...
DEFINE VARIABLE fi_file AS CHARACTER FORMAT "X(45)" INITIAL "c:~\tmp~\r-mchcst.csv" 
     LABEL "Name" 
...
DEFINE FRAME FRAME-A
     ...
     begin_mach AT ROW 4.1 COL 24 COLON-ALIGNED HELP
          "Enter Beginning Machine"
     end_mach AT ROW 4.1 COL 67 COLON-ALIGNED HELP
     ...
     end_job-no2 AT ROW 5.05 COL 82 COLON-ALIGNED HELP
          "Enter Ending Job Number"
     begin_date AT ROW 6 COL 24 COLON-ALIGNED
     end_date AT ROW 6 COL 67 COLON-ALIGNED HELP
          "Enter Ending Due Date"
     tb_show-dl AT ROW 7.43 COL 34
     tb_show-fo AT ROW 8.38 COL 34
     tb_show-vo AT ROW 9.33 COL 34
     sl_avail AT ROW 11.95 COL 4 NO-LABEL WIDGET-ID 26
     Btn_Def AT ROW 11.95 COL 40.6 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 56
     sl_selected AT ROW 11.95 COL 60.8 NO-LABEL WIDGET-ID 28
     Btn_Add AT ROW 12.95 COL 40.6 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 32
     Btn_Remove AT ROW 13.95 COL 40.6 HELP
          "Remove Selected Table from Tables to Audit" WIDGET-ID 34
     btn_Up AT ROW 15 COL 40.6 WIDGET-ID 40
     btn_down AT ROW 16 COL 40.6 WIDGET-ID 42
     lv-ornt AT ROW 18.14 COL 31 NO-LABEL
     lines-per-page AT ROW 18.14 COL 84 COLON-ALIGNED
     rd-dest AT ROW 18.67 COL 6 NO-LABEL
     lv-font-no AT ROW 19.1 COL 34 COLON-ALIGNED
     td-show-parm AT ROW 19.1 COL 57
     lv-font-name AT ROW 20.05 COL 28 COLON-ALIGNED NO-LABEL
     fi_file AT ROW 21.48 COL 29 COLON-ALIGNED HELP
          "Enter File Name"
     tb_OpenCSV AT ROW 21.57 COL 92.4 RIGHT-ALIGNED
     tbAutoClose AT ROW 23.48 COL 31.2 WIDGET-ID 16
     btn-ok AT ROW 24.81 COL 31
     btn-cancel AT ROW 24.81 COL 51
     "Available Columns" VIEW-AS TEXT
          SIZE 29 BY .62 AT ROW 11.24 COL 4.8 WIDGET-ID 38
     "Selected Columns(In Display Order)" VIEW-AS TEXT
          SIZE 34 BY .62 AT ROW 11.24 COL 60.2 WIDGET-ID 44
     " Selection Parameters" VIEW-AS TEXT
          SIZE 21.8 BY .71 AT ROW 1.14 COL 5
     " Output Destination" VIEW-AS TEXT
          SIZE 18.8 BY .62 AT ROW 17.71 COL 5
     RECT-6 AT ROW 18 COL 4
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
 ...
 /* security check need {methods/prgsecur.i} in definition section */
  ...
  RUN enable_UI.
  {methods/nowait.i}
  {sys/inc/reportsConfigNK1.i "JR7" }
  ASSIGN
...
------------------------------------------------------------------------------*/
  DISPLAY lbl_jstat rd_jstat begin_mach end_mach begin_job-no begin_job-no2 
          ...
          tb_show-vo sl_avail sl_selected rd-dest fi_file tb_OpenCSV 
          tbAutoClose 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE RECT-6 RECT-7 rd_jstat begin_mach end_mach begin_job-no begin_job-no2 
         end_job-no end_job-no2 begin_date end_date tb_show-dl tb_show-fo 
         tb_show-vo sl_avail Btn_Def sl_selected Btn_Add Btn_Remove btn_Up 
...
------------------------------------------------------------------------------*/
 DO WITH FRAME {&FRAME-NAME}:
     ...
     ELSE
      ...
      .
    ASSIGN fi_file:SCREEN-VALUE = "c:\tmp\r-mchcst.csv".    
 END.
