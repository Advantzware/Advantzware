...
DO:
  ...
  DO:
    fi_file:SCREEN-VALUE = "c:\tmp\r-wbyjob.csv".
    ASSIGN fi_file.
                       ...
                       DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
                          cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                               CASE cTmpField:             
                                    ...
                                    WHEN "dscr"             THEN cVarValue =  STRING(item.i-dscr) .
                                    WHEN "qty-pstd"         THEN cVarValue =  STRING(mat-act.qty,">>>>>>9.99-")  .
                       ...
                       DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
                          cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                               CASE cTmpField:             
                                    ...
                                    WHEN "dscr"             THEN cVarValue =  fg-act.i-name.
                                    WHEN "qty-pstd"         THEN cVarValue =  STRING(fg-act.qty,">>>>>>9.99-")  .
                                    WHEN "wst-qty"          THEN cVarValue =  "" .
                                    WHEN "mch-hrs"          THEN cVarValue =   "" .
                                    WHEN "mch-cd"           THEN cVarValue =   "" .
                                    WHEN "job-cd"           THEN cVarValue =   "" .
                       ...
                       DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
                          cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                               CASE cTmpField:             
                                    ...
                                    WHEN "dscr"             THEN cVarValue =  misc-act.dscr.
                       ...
                       DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
                          cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                               CASE cTmpField:             
                                    ...
                                    WHEN "dscr"             THEN cVarValue =  misc-act.dscr.
                                    WHEN "qty-pstd"         THEN cVarValue =  STRING(misc-act.cost,">>>>>>9.99-")  .
                                    WHEN "wst-qty"          THEN cVarValue =  IF AVAIL mch-act THEN STRING(mch-act.waste,">>>>>>>9") ELSE "" .
                                    WHEN "mch-hrs"          THEN cVarValue =   IF AVAIL mch-act THEN STRING(mch-act.hours,">>>>>9.99") ELSE ""  .
                                    WHEN "mch-cd"           THEN cVarValue =   STRING(mch-act.m-code) .
