...
begin_cust-no end_cust-no begin_item end_item begin_est end_est begin_job ~
begin_job-2 end_job end_job-2 sl_avail sl_selected Btn_Add Btn_Remove ~
...
begin_item end_item begin_est end_est begin_job begin_job-2 end_job ~
end_job-2 sl_avail sl_selected fi_file tb_OpenCSV tbAutoClose 
...
DEFINE FRAME Dialog-Frame
    RS-open-closed AT ROW 2 COL 39 NO-LABELS WIDGET-ID 2
    begin_cust-no AT ROW 3.43 COL 25.6 COLON-ALIGNED HELP
    "Enter Beginning Customer Number" WIDGET-ID 6
    end_cust-no AT ROW 3.43 COL 68.6 COLON-ALIGNED HELP
    "Enter Ending Customer Number" WIDGET-ID 16
    begin_item AT ROW 4.57 COL 25.6 COLON-ALIGNED HELP
    "Enter Beginning Item Number" WIDGET-ID 100
    end_item AT ROW 4.57 COL 68.6 COLON-ALIGNED HELP
    "Enter Beginning Item Number" WIDGET-ID 102
    begin_est AT ROW 5.71 COL 25.6 COLON-ALIGNED HELP
    "Enter Beginning Item Number" WIDGET-ID 108
    end_est AT ROW 5.71 COL 68.6 COLON-ALIGNED HELP
    "Enter Beginning Item Number" WIDGET-ID 110
    begin_job AT ROW 6.81 COL 25.6 COLON-ALIGNED HELP
    "Enter Beginning Job Number" WIDGET-ID 104
    begin_job-2 AT ROW 6.81 COL 38.4 COLON-ALIGNED HELP
    "Enter Beginning Job Number2" NO-LABELS WIDGET-ID 112
    end_job AT ROW 6.81 COL 68.6 COLON-ALIGNED HELP
    "Enter Beginning Job Number" WIDGET-ID 106
    end_job-2 AT ROW 6.81 COL 81.4 COLON-ALIGNED HELP
    "Enter Beginning Job Number2" NO-LABELS WIDGET-ID 114
    sl_avail AT ROW 9.38 COL 4.2 NO-LABELS WIDGET-ID 26
    sl_selected AT ROW 9.38 COL 62.4 NO-LABELS WIDGET-ID 28
    Btn_Add AT ROW 9.48 COL 41.8 HELP
    "Add Selected Table to Tables to Audit" WIDGET-ID 32
    Btn_Remove AT ROW 10.67 COL 41.8 HELP
    "Remove Selected Table from Tables to Audit" WIDGET-ID 34
    btn_Up AT ROW 11.86 COL 41.8 WIDGET-ID 40
    btn_down AT ROW 13.05 COL 41.8 WIDGET-ID 42
    tb_excel AT ROW 16.43 COL 36 WIDGET-ID 32
    fi_file AT ROW 16.52 COL 19.6 COLON-ALIGNED HELP
    "Enter File Name" WIDGET-ID 22
    tb_OpenCSV AT ROW 16.57 COL 86 RIGHT-ALIGNED WIDGET-ID 34
    tbAutoClose AT ROW 18.52 COL 30.4 WIDGET-ID 64
    btn-ok AT ROW 19.57 COL 30 WIDGET-ID 14
    btn-cancel AT ROW 19.57 COL 53.6 WIDGET-ID 12
    " Export Selection" VIEW-AS TEXT
    SIZE 17 BY .62 AT ROW 8.57 COL 4 WIDGET-ID 86
    ...
    RECT-8 AT ROW 15.67 COL 3 WIDGET-ID 84
    SPACE(1.99) SKIP(2.80)
...
ASSIGN 
    begin_est:PRIVATE-DATA IN FRAME Dialog-Frame = "parm".
...
ASSIGN 
    end_est:PRIVATE-DATA IN FRAME Dialog-Frame = "parm".
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    DO WITH FRAME {&FRAME-NAME}:
        ...
        fi_file:SCREEN-VALUE = "c:\tmp\JobCosting.csv".
...
PROCEDURE enable_UI :
    ...
    ------------------------------------------------------------------------------*/
    DISPLAY RS-open-closed begin_cust-no end_cust-no begin_item end_item begin_est 
        end_est begin_job begin_job-2 end_job end_job-2 sl_avail sl_selected 
        fi_file tb_OpenCSV tbAutoClose 
        WITH FRAME Dialog-Frame.
    ENABLE RECT-6 RECT-7 RECT-8 RS-open-closed begin_cust-no end_cust-no 
        begin_item end_item begin_est end_est begin_job begin_job-2 end_job 
        end_job-2 sl_avail sl_selected Btn_Add Btn_Remove btn_Up btn_down 
    ...
    FOR EACH job-hdr WHERE job-hdr.company EQ cocode
        ...
        DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
            ...
            DO:       
                CASE cTmpField:
                    WHEN "cust-part" THEN 
                        cVarValue = IF AVAILABLE itemfg THEN STRING(itemfg.part-no) ELSE "". 
                    WHEN "ord-qty" THEN 
                        cVarValue = IF AVAILABLE oe-ordl THEN STRING(oe-ordl.qty,"->>,>>>,>>>") ELSE "". 
                    WHEN "prod-qty" THEN 
                        cVarValue = STRING(v-prod-qty,"->>,>>>,>>>"). 
                    WHEN "oh-qty" THEN 
                        cVarValue = STRING(v-oh-qty,"->>,>>>,>>>"). 
                    WHEN "ship-qty" THEN 
                        cVarValue = STRING(v-shp-qty,"->>,>>>,>>>").
                    WHEN "inv-qty" THEN 
                    ...
                    WHEN "close-date" THEN 
                        cVarValue = IF job.close-date NE ? THEN STRING(job.close-date) ELSE "" .
                    WHEN "sales-rep" THEN 
                        cVarValue = IF AVAILABLE cust THEN STRING(cust.sman) ELSE "".
                    WHEN "job-hold" THEN 
                        cVarValue = STRING(vHoldReason).
