...
end_job-no end_job-no2 begin_est end_est begin_date end_date begin_i-no ~
end_i-no rd_sort tb_totals sl_avail Btn_Def sl_selected Btn_Add Btn_Remove ~
...
end_job-no2 begin_est end_est begin_date end_date begin_i-no end_i-no ~
lbl_sort rd_sort tb_totals sl_avail sl_selected rd-dest fi_file tb_OpenCSV ~
tbAutoClose 
...
DEFINE FRAME FRAME-A
     ...
     tb_totals AT ROW 8.19 COL 29.4 WIDGET-ID 80
     sl_avail AT ROW 10.52 COL 4 NO-LABEL WIDGET-ID 26
     Btn_Def AT ROW 10.52 COL 40.8 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 56
     sl_selected AT ROW 10.52 COL 60.8 NO-LABEL WIDGET-ID 28
     Btn_Add AT ROW 11.52 COL 40.8 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 32
     Btn_Remove AT ROW 12.52 COL 40.8 HELP
          "Remove Selected Table from Tables to Audit" WIDGET-ID 34
     btn_Up AT ROW 13.57 COL 40.8 WIDGET-ID 40
     btn_down AT ROW 14.57 COL 40.8 WIDGET-ID 42
     lv-ornt AT ROW 16.48 COL 31 NO-LABEL
     lines-per-page AT ROW 16.48 COL 83 COLON-ALIGNED
     rd-dest AT ROW 16.71 COL 6 NO-LABEL
     lv-font-no AT ROW 17.43 COL 34 COLON-ALIGNED
     td-show-parm AT ROW 17.43 COL 48
     lv-font-name AT ROW 18.38 COL 28 COLON-ALIGNED NO-LABEL
     fi_file AT ROW 21.1 COL 29 COLON-ALIGNED HELP
          "Enter File Name"
     tb_OpenCSV AT ROW 21.1 COL 90 RIGHT-ALIGNED
     tbAutoClose AT ROW 22.95 COL 31.2 WIDGET-ID 16
     btn-ok AT ROW 23.95 COL 31
     btn-cancel AT ROW 23.95 COL 51
     "Available Columns" VIEW-AS TEXT
          SIZE 29 BY .62 AT ROW 9.81 COL 4.4 WIDGET-ID 38
     " Output Destination" VIEW-AS TEXT
          SIZE 19 BY .62 AT ROW 15.91 COL 5
     " Selection Parameters" VIEW-AS TEXT
          SIZE 21.2 BY .71 AT ROW 1.24 COL 5
          BGCOLOR 15 
     "Selected Columns(In Display Order)" VIEW-AS TEXT
          SIZE 34 BY .62 AT ROW 9.76 COL 60.2 WIDGET-ID 44
     RECT-6 AT ROW 16.19 COL 4
...
ON END-ERROR OF C-Win /* Estimated Job Cost Detail */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Estimated Job Cost Detail */
DO:
...
ON LEAVE OF begin_date IN FRAME FRAME-A /* Beginning Job Created */
DO:
        ASSIGN {&self-name}.
    END.
...
ON LEAVE OF end_date IN FRAME FRAME-A /* Ending Job Created */
DO:
        ASSIGN {&self-name}.
    END.
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    RUN DisplaySelectionList. 
      ...
      RUN enable_UI.
      {methods/nowait.i}
      {sys/inc/reportsConfigNK1.i "JL8" }
      ASSIGN
...
------------------------------------------------------------------------------*/
  DISPLAY begin_job-no begin_job-no2 end_job-no end_job-no2 begin_est end_est 
          begin_date end_date begin_i-no end_i-no lbl_sort rd_sort tb_totals 
  ...
  ENABLE RECT-6 RECT-7 begin_job-no begin_job-no2 end_job-no end_job-no2 
         begin_est end_est begin_date end_date begin_i-no end_i-no rd_sort 
         tb_totals sl_avail Btn_Def sl_selected Btn_Add Btn_Remove btn_Up 
