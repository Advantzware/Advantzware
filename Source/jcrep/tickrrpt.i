...
ELSE IF ip-industry EQ "Corr" THEN DO: 
  ...
  END.
  ELSE IF lv-format-c = "PreCorr" THEN do:
      PUT UNFORMATTED "<OLANDSCAPE><FTahoma><P10></PROGRESS>" skip.
      RUN cecrep/jobPreCorr.p (lv-format-c).
  END.
  ...
  END.
  ELSE IF lv-format-c = "AtlanticBox" THEN do:
      PUT UNFORMATTED "<OLANDSCAPE><FTahoma><P10></PROGRESS>" skip.
      RUN cecrep/JobAtlBox.p (lv-format-c).
  END.
  ELSE IF lv-format-c = "HoneyCell" THEN do:
      PUT UNFORMATTED "<OLANDSCAPE><FTahoma><P10></PROGRESS>" skip.
      RUN cecrep/jobhoney.p (lv-format-c).
  END.
