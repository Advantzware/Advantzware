...
DEFINE FRAME Dialog-Frame
    RS-open-closed AT ROW 1.95 COL 40 NO-LABELS WIDGET-ID 2
    begin_cust-no AT ROW 3.1 COL 26.6 COLON-ALIGNED HELP
    "Enter Beginning Customer Number" WIDGET-ID 6
    end_cust-no AT ROW 3.1 COL 69.6 COLON-ALIGNED HELP
    "Enter Ending Customer Number" WIDGET-ID 16
    begin_job AT ROW 4.24 COL 26.6 COLON-ALIGNED HELP
    "Enter Beginning Job Number" WIDGET-ID 104
    begin_job-2 AT ROW 4.24 COL 39.4 COLON-ALIGNED HELP
    "Enter Beginning Job Number2" NO-LABELS WIDGET-ID 108
    end_job AT ROW 4.24 COL 69.6 COLON-ALIGNED HELP
    "Enter Beginning Job Number" WIDGET-ID 106
    end_job-2 AT ROW 4.24 COL 82.4 COLON-ALIGNED HELP
    "Enter Beginning Job Number2" NO-LABELS WIDGET-ID 110
    begin_item AT ROW 5.38 COL 26.6 COLON-ALIGNED HELP
    "Enter Beginning Item Number" WIDGET-ID 100
    end_item AT ROW 5.38 COL 69.6 COLON-ALIGNED HELP
    "Enter Beginning Item Number" WIDGET-ID 102
    sl_avail AT ROW 7.86 COL 4.4 NO-LABELS WIDGET-ID 26
    Btn_Add AT ROW 7.86 COL 42 HELP
    "Add Selected Table to Tables to Audit" WIDGET-ID 32
    sl_selected AT ROW 7.86 COL 61.4 NO-LABELS WIDGET-ID 28
    Btn_Remove AT ROW 9.05 COL 42 HELP
    "Remove Selected Table from Tables to Audit" WIDGET-ID 34
    btn_Up AT ROW 10.24 COL 42 WIDGET-ID 40
    btn_down AT ROW 11.43 COL 42 WIDGET-ID 42
    tb_excel AT ROW 14.43 COL 35 WIDGET-ID 32
    fi_file AT ROW 14.81 COL 19.8 COLON-ALIGNED HELP
    "Enter File Name" WIDGET-ID 22
    tb_OpenCSV AT ROW 14.86 COL 86 RIGHT-ALIGNED WIDGET-ID 34
    tbAutoClose AT ROW 16.86 COL 30.2 WIDGET-ID 64
    btn-ok AT ROW 17.86 COL 30 WIDGET-ID 14
    btn-cancel AT ROW 17.86 COL 52.6 WIDGET-ID 12
    " Export Selection" VIEW-AS TEXT
    SIZE 17 BY .62 AT ROW 6.95 COL 4 WIDGET-ID 86
    " Selection Parameters" VIEW-AS TEXT
    SIZE 21 BY .71 AT ROW 1.1 COL 4 WIDGET-ID 36
    RECT-6 AT ROW 7.38 COL 3 WIDGET-ID 30
    RECT-7 AT ROW 1.48 COL 3 WIDGET-ID 38
    RECT-8 AT ROW 13.91 COL 3 WIDGET-ID 84
    SPACE(0.99) SKIP(2.60)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
    SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
    BGCOLOR 15 
    TITLE "Job Costing Routing Excel Export" WIDGET-ID 100.
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    DO WITH FRAME {&FRAME-NAME}:
        ...
        fi_file:SCREEN-VALUE = "c:\tmp\JobCostingRouting.csv".
    END.
...
PROCEDURE run-report :
    ...
    DEFINE BUFFER b-job-mch FOR job-mch.
    ...
    FOR EACH job WHERE job.company EQ cocode
        ...
        NO-LOCK  BY job.job-no DESCENDING
        BY job-mch.frm
        BY job-mch.blank-no
        BY job-mch.pass:
        ...
        BUFFER b-job-mch:FIND-BY-ROWID(ROWID(job-mch), NO-LOCK) .
        ...
        DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
            ...
            DO:
                ...
                ELSE IF cFieldName BEGINS "job-mch" THEN hField = BUFFER b-job-mch:BUFFER-FIELD(cTmpField).
            ...
            DO:       
                CASE cTmpField:
                    ...
                    WHEN "start-time" THEN 
                        cVarValue = cvt-time-to-string('',job-mch.start-time-su,0.00) .
                    WHEN "start-end-time" THEN 
                        cVarValue = cvt-time-to-string('',job-mch.end-time-su,0.00) .
                    WHEN "sttime"  THEN 
