...
ASSIGN cTextListToSelect = "JOB #,CUSTOMER,RM ITEM#,RM QTY RECD,FG ITEM#,FG QTY INVCD," + 
       ...
       cFieldLength = "13,25,15,12,15,12," + "12,12,12,11,10,11,11,12"
...
DEFINE FRAME FRAME-A
     ...
     sl_selected AT ROW 10.81 COL 61 NO-LABEL WIDGET-ID 28
     ...
     lv-font-no AT ROW 18.14 COL 33 COLON-ALIGNED
     td-show-parm AT ROW 18.19 COL 50
     lv-font-name AT ROW 19.1 COL 27 COLON-ALIGNED NO-LABEL
     fi_file AT ROW 21.48 COL 29.2 COLON-ALIGNED HELP
          "Enter File Name"
     tb_OpenCSV AT ROW 21.57 COL 90.2 RIGHT-ALIGNED
     tbAutoClose AT ROW 23.67 COL 31.2 WIDGET-ID 16
     btn-ok AT ROW 24.81 COL 31
     btn-cancel AT ROW 24.81 COL 51
     "Available Columns" VIEW-AS TEXT
          SIZE 29 BY .62 AT ROW 10.1 COL 4.4 WIDGET-ID 38
     " Output Destination" VIEW-AS TEXT
          SIZE 18.8 BY .62 AT ROW 16.71 COL 5
     " Selection Parameters" VIEW-AS TEXT
          SIZE 21.2 BY .71 AT ROW 1.14 COL 5
          BGCOLOR 15 
     "Selected Columns(In Display Order)" VIEW-AS TEXT
          SIZE 34 BY .62 AT ROW 10.05 COL 60.4 WIDGET-ID 44
     RECT-6 AT ROW 17 COL 4
...
/* security check need {methods/prgsecur.i} in definition section */
  ...
  RUN enable_UI.
  {methods/nowait.i}
  {sys/inc/reportsConfigNK1.i "JR8" }
  ASSIGN
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-6 RECT-7 rd_jstat rd_ostat begin_rm-no end_rm-no begin_procat 
         ...
         btn_Up btn_down rd-dest fi_file tb_OpenCSV tbAutoClose 
         btn-ok btn-cancel 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ...
  EXPORT STREAM excel DELIMITER "," 
    ...
    DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
       cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
            CASE cTmpField:             
                 WHEN "job"       THEN cVarValue = IF v-frst THEN string(tt-report.key-01,"x(13)") ELSE " " .
...
------------------------------------------------------------------------------*/
 DO WITH FRAME {&FRAME-NAME}:
     ...
     ELSE
      ...
      .
    ASSIGN fi_file:SCREEN-VALUE = "c:\tmp\r-boarec.csv".  
 END.
