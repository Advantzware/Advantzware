...
begin_job-no2 end_job-no end_job-no2 sl_avail sl_selected rd-dest fi_file ~
...
DEFINE FRAME FRAME-A
     thru_date AT ROW 2.43 COL 26 COLON-ALIGNED
     begin_mach AT ROW 3.62 COL 26 COLON-ALIGNED HELP
          "Enter Beginning Machine"
     end_mach AT ROW 3.62 COL 66 COLON-ALIGNED HELP
          "Enter Ending Machine"
     begin_job-no AT ROW 4.57 COL 26 COLON-ALIGNED HELP
          "Enter Beginning Job Number"
     begin_job-no2 AT ROW 4.57 COL 39 COLON-ALIGNED HELP
          "Enter Beginning Job Number"
     ...
     sl_selected AT ROW 7.43 COL 60.8 NO-LABEL WIDGET-ID 28
     Btn_Add AT ROW 8.43 COL 40.8 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 32
     Btn_Remove AT ROW 9.43 COL 40.8 HELP
          "Remove Selected Table from Tables to Audit" WIDGET-ID 34
     btn_Up AT ROW 10.48 COL 40.8 WIDGET-ID 40
     btn_down AT ROW 11.48 COL 40.8 WIDGET-ID 42
     lv-ornt AT ROW 13.86 COL 32 NO-LABEL
     lines-per-page AT ROW 13.86 COL 85 COLON-ALIGNED
     rd-dest AT ROW 14.33 COL 6 NO-LABEL
     lv-font-no AT ROW 14.95 COL 35 COLON-ALIGNED
     td-show-parm AT ROW 15.05 COL 52
     lv-font-name AT ROW 15.91 COL 29 COLON-ALIGNED NO-LABEL
     fi_file AT ROW 17.57 COL 29 COLON-ALIGNED HELP
          "Enter File Name"
     tb_OpenCSV AT ROW 17.62 COL 90 RIGHT-ALIGNED
     tbAutoClose AT ROW 19.67 COL 31.2 WIDGET-ID 16
     btn-ok AT ROW 20.71 COL 31
     btn-cancel AT ROW 20.71 COL 51
     "Available Columns" VIEW-AS TEXT
          SIZE 29 BY .62 AT ROW 6.71 COL 4.2 WIDGET-ID 38
     " Output Destination" VIEW-AS TEXT
          SIZE 18.8 BY .62 AT ROW 13.29 COL 5
     " Selection Parameters" VIEW-AS TEXT
          SIZE 21.2 BY .71 AT ROW 1.14 COL 5
     "Selected Columns(In Display Order)" VIEW-AS TEXT
          SIZE 34 BY .62 AT ROW 6.71 COL 60.2 WIDGET-ID 44
...
------------------------------------------------------------------------------*/
 DO WITH FRAME {&FRAME-NAME}:
     ...
     ELSE
      ...
      .
    ASSIGN fi_file:SCREEN-VALUE = "c:\tmp\r-msfkic.csv".    
 END.
