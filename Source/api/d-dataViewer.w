...
&Scoped-Define ENABLED-OBJECTS edData btCancel btOk 
...
DEFINE FRAME D-Dialog
     ...
     btCancel AT ROW 1.05 COL 144.6
     btOk AT ROW 3.29 COL 144.6
     SPACE(0.59) SKIP(25.08)
...
------------------------------------------------------------------------------*/
    ...
    IF ipcAction EQ "Update" THEN
        edData:READ-ONLY = FALSE.
    ELSE IF ipcAction EQ "View" THEN
        btOk:VISIBLE = FALSE.
