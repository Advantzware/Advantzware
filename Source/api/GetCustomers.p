/*------------------------------------------------------------------------
    File        : api/ReceiveCustomer.p
    Purpose     : Returns the request data for customer
    ...
    Author(s)   : DEVA$!
    Created     : Thu Aug 12 07:33:22 EDT 2021
    Notes       :
  ----------------------------------------------------------------------*/
    {api/ttArgs.i}
    ...
    ELSE DO:
        ...
        IF AVAILABLE bf-cust THEN DO: 
            RUN updateRequestData(INPUT-OUTPUT ioplcRequestData,"CustomerID", bf-cust.cust-no).
            RUN updateRequestData(INPUT-OUTPUT ioplcRequestData,"CustomerName", bf-cust.name).
            RUN updateRequestData(INPUT-OUTPUT ioplcRequestData,"CustomerType", bf-cust.type).
        END.
