...
DO:
    ...
    FOR EACH oe-ordm OF oe-ord NO-LOCK
       ...
       // RUN pUpdateDelimiter (INPUT-OUTPUT lcLineMiscChargeData, cRequestDataType).
...
RUN updateRequestData(INPUT-OUTPUT ioplcRequestData, "LineCount", cLineCnt).
