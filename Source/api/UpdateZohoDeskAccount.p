/*------------------------------------------------------------------------
    File        : api/UpdateZohoDeskAccount.p
    Purpose     : 
  ...
  ----------------------------------------------------------------------*/
    ...
    ELSE DO:
        FOR EACH ttArgs
            ...
            RUN updateRequestData(INPUT-OUTPUT ioplcRequestData, "AttributeName", ttArgs.argKey).
            RUN updateRequestData(INPUT-OUTPUT ioplcRequestData, "AttributeValue", ttArgs.argValue).
        END.
