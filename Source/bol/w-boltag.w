...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "FINISHED GOODS WAREHOUSE TRANSACTION (BILL OF LADING)"
         HEIGHT             = 24
         WIDTH              = 150
         MAX-HEIGHT         = 33.29
         MAX-WIDTH          = 204.8
...
ON END-ERROR OF W-Win /* FINISHED GOODS WAREHOUSE TRANSACTION (BILL OF LADING) */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* FINISHED GOODS WAREHOUSE TRANSACTION (BILL OF LADING) */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Browse BOL|View BOL|BOL Detail' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 3 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = Yes':U ,
             OUTPUT h_b-oeboll ).
       RUN set-position IN h_b-oeboll ( 4.81 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 16.67 , 145.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updsav ).
       RUN set-position IN h_p-updsav ( 21.95 , 19.00 ) NO-ERROR.
       RUN set-size IN h_p-updsav ( 1.76 , 65.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'fg/v-blpost.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-blpost ).
       RUN set-position IN h_v-blpost ( 21.95 , 97.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_b-oebolh , 'Record':U , h_b-oeboll ).
