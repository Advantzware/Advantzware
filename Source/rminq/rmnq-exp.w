...
&Scoped-Define DISPLAYED-OBJECTS begin_i-no end_i-no sl_avail sl_selected ~
...
DEFINE FRAME rd-fgnq-exp
    begin_i-no AT ROW 2.86 COL 20.8 COLON-ALIGNED HELP
    "Enter Beginning Customer Number" WIDGET-ID 142
    end_i-no AT ROW 2.86 COL 63.8 COLON-ALIGNED HELP
    "Enter Ending Customer" WIDGET-ID 144
    sl_avail AT ROW 6.81 COL 4.8 NO-LABELS WIDGET-ID 26
    sl_selected AT ROW 6.81 COL 64 NO-LABELS WIDGET-ID 28
    Btn_Def AT ROW 7 COL 42 HELP
    "Add Selected Table to Tables to Audit" WIDGET-ID 56
    Btn_Add AT ROW 8.19 COL 42 HELP
    "Add Selected Table to Tables to Audit" WIDGET-ID 130
    Btn_Remove AT ROW 9.38 COL 42 HELP
    "Remove Selected Table from Tables to Audit" WIDGET-ID 134
    btn_Up AT ROW 10.57 COL 42 WIDGET-ID 136
    btn_down AT ROW 11.76 COL 42 WIDGET-ID 132
    fi_file AT ROW 14.33 COL 17.6 COLON-ALIGNED HELP
    "Enter File Name" WIDGET-ID 22
    tb_OpenCSV AT ROW 14.38 COL 84 RIGHT-ALIGNED WIDGET-ID 34
    tb_excel AT ROW 16.24 COL 5 WIDGET-ID 32
    tbAutoClose AT ROW 16.33 COL 30.2 WIDGET-ID 64
    btn-ok AT ROW 17.33 COL 30 WIDGET-ID 14
    btn-cancel AT ROW 17.33 COL 55.4 WIDGET-ID 12
    "Selected Columns" VIEW-AS TEXT
    SIZE 23.6 BY .62 AT ROW 6.1 COL 64.4 WIDGET-ID 138
    " Selection Parameters" VIEW-AS TEXT
    SIZE 21 BY .71 AT ROW 1.05 COL 4 WIDGET-ID 36
    " Export Selection" VIEW-AS TEXT
    SIZE 17 BY .62 AT ROW 5.29 COL 4 WIDGET-ID 86
    "Available Columns" VIEW-AS TEXT
    SIZE 29 BY .62 AT ROW 6.1 COL 5.2 WIDGET-ID 140
    RECT-6 AT ROW 5.71 COL 3 WIDGET-ID 30
    RECT-7 AT ROW 1.52 COL 3 WIDGET-ID 38
    RECT-8 AT ROW 13.62 COL 3 WIDGET-ID 84
    SPACE(1.79) SKIP(2.84)
...
PROCEDURE enable_UI :
    ...
    ------------------------------------------------------------------------------*/
    DISPLAY begin_i-no end_i-no sl_avail sl_selected fi_file tb_OpenCSV 
        tbAutoClose 
        WITH FRAME rd-fgnq-exp.
    ENABLE RECT-6 RECT-7 RECT-8 begin_i-no end_i-no sl_avail sl_selected Btn_Def 
...
PROCEDURE run-report :
    ...
    FOR EACH job WHERE TRUE /* Join to itemfg incomplete */
        ...
        FOR EACH ttRptSelected:
            ...
            IF ttRptSelected.TextList = "Allocated2" THEN 
            DO:
            ...
            END.
            IF ttRptSelected.TextList = "RM UOM" THEN 
            DO:
                DEFINE BUFFER b-item2 FOR ITEM.
                ...
                IF AVAILABLE b-item2 THEN v-uom = b-item2.cons-uom.
            ...
            IF ttRptSelected.TextList = "Length" THEN 
            DO:
                v-excel-detail-lines = v-excel-detail-lines + appendXLLine(STRING(job-mat.len)).
            END.
            IF ttRptSelected.TextList = "Due Date" AND job.due-date NE ? THEN 
            DO:
