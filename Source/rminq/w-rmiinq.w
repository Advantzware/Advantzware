...
&SCOPED-DEFINE h_Browse01 h_b-rmiinq
...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES rm-rcpth
&Scoped-define FIRST-EXTERNAL-TABLE rm-rcpth


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR rm-rcpth.
...
ON END-ERROR OF W-Win /* RM History Inquiry */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* RM History Inquiry */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_options ).
       RUN set-position IN h_options ( 1.00 , 84.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.81 , 55.80 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adm/objects/folder.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'FOLDER-LABELS = ':U + 'RM History' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_movecol ).
       RUN set-position IN h_movecol ( 1.00 , 76.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.81 , 7.80 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_export ).
       RUN set-position IN h_export ( 1.00 , 84.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.81 , 7.80 ) */
       ...
       RUN add-link IN adm-broker-hdl ( h_b-rmiinq , 'move-columns':U , h_movecol ).

       /* Links to SmartObject h_export. */
       RUN add-link IN adm-broker-hdl ( h_b-rmiinq , 'export-xl':U , h_export ).

       /* Links to SmartNavBrowser h_b-rmiinq. */
       RUN add-link IN adm-broker-hdl ( h_b-rmiinq , 'Record':U , THIS-PROCEDURE ).
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "rm-rcpth"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "rm-rcpth"}
