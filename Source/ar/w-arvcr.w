...
DEFINE VARIABLE h_v-void-2 AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Void Cash Receipts */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Void Cash Receipts */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'View Cash' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-void-2 ).
       RUN set-position IN h_v-void-2 ( 5.29 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 9.19 , 143.00 ) */

       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('2':U) NO-ERROR.

       /* Links to SmartViewer h_v-void-2. */
       RUN add-link IN adm-broker-hdl ( h_p-disabl , 'TableIO':U , h_v-void-2 ).
       RUN add-link IN adm-broker-hdl ( h_v-void , 'Record':U , h_v-void-2 ).
    ...
    WHEN 2 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-void ).
       RUN set-position IN h_v-void ( 4.57 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 9.19 , 143.00 ) */
