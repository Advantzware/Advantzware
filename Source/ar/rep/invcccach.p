...
RUN sys/ref/uom-ea.p (OUTPUT fg-uom-list).
 ...
 {ar/rep/invcccach.i}  /* xprint form */
        ...
        for each ar-invl no-lock where ar-invl.x-no = ar-inv.x-no BREAK BY ar-invl.inv-no:
          ...
          IF LAST(ar-invl.inv-no) THEN do:
              IF v-printline GE 37  THEN do:           
                  PAGE.
                  {ar/rep/invcccach.i}  /* xprint form */
                  v-printline = 21.
              END.
    ...
    PUT 
        ...
        "<C11><R50.5>Bank Routing #  <C30>021000089"
        "<C11><R51.5>Bank Account #  <C30>31016689"
        "<C11><R52.5>EIN # <C30>51-0299429"
