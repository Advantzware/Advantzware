...
PUT "<FArial><P12><=#3><C45><R-2> <B>Crédit/Débit Note #: " ar-cash.check-no FORMAT ">>>>>>>>>9" "<P10>             Page: </B>" string(PAGE-NUM - v-page-num,">>9") SKIP
    "<=#3> Client                       Contact"
    "<=#3><R+2> Téléphone                        Fax" 
    "<=#3><R+4>                  Crédit/Débit Note Date<FCourier New>"    
...
PUT "<FArial><=4><R+1>     Expédition              FOB                         Expéditeur                                  Termes                   Représentant                BOL#" SKIP
...
/* PUT "<FArial><=5><R+1>   Invoice #          PO#         Commande               Item#/CustPart#                              Note Description                          Total Appliqué" */ 
PUT "<FArial><=5><R26>                                                                                                                                                                                           Montant "
    SKIP.                                                                                                                                                                  
PUT "<FArial><=5><R+1>   Invoice #             PO#           Commande                                   Note Description                                                          Appliqué"
    SKIP(1).
