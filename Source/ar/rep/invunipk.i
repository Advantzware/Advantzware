...
PUT "<C1><#1><R+10><C+45><IMAGE#1=" ls-full-img1 SKIP.
PUT "<FArial><=1>" SKIP.
...
PUT "<R26><C1><#5><FROM><R28><C80><RECT><||3>" SKIP    
                ...
                .   
PUT "<FArial><=5><R+1>   Ordered     Invoiced     Order     Item#/CustPart#                           Description                         Price          UOM            Amount" SKIP(1).
