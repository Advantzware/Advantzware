...
format 
      ...
      skip (3)
      ar-inv.cust-no         AT 8 /*was 11*/  ar-inv.ship-id         AT 51
      v-cust[1]              AT 8 /*was 11*/  v-ship[1]              AT 51 format "x(27)"
      v-cust[2]              AT 8 v-ship[2]              AT 51 format "x(27)"
      v-cust[3]              AT 8 v-ship[3]              AT 51 format "x(27)"
      v-cust[4]              AT 8 v-ship[4]              AT 51 format "x(27)"
      skip (4)
      v-date-ship
...
format ar-inv.po-no           AT 1
       ...
       ar-invl.i-dscr         AT 19 FORM "x(23)" ar-invl.ship-qty TO 52 FORM "->,>>>,>>9"
       skip 
