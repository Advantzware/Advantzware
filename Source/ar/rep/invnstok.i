/*oe/rep/invnstok.i  */
     ...
     PUT "<FArial>".
        ...
        PUT "<C1><#2>" /*<R+10><C+35><IMAGE#2=" ls-full-img2 SKIP  /* company image */ */
            ...
            SPACE(7) ar-inv.cust-name                             v-shipto-name AT 53 skip
            SPACE(7) ar-inv.addr[1]                               v-shipto-addr[1] AT 53  SKIP
            SPACE(7) ar-inv.addr[2]                               v-shipto-addr[2] AT 53  SKIP
...
PUT "<FArial><P12><=#3><R2.5> <B>Invoice#: " ar-inv.inv-no FORMAT ">>>>>>9" "</B><P10>" SKIP
...
PUT "<FArial><=4><R+1> Ship Date             FOB                     Ship Via                                      Terms                                         S.Person            BOL#" SKIP
     ...
     ar-inv.terms-d FORM "x(15)" space(11) v-salesman FORM "x(8)"
     /*ar-inv.bol-no*/
    SKIP.
