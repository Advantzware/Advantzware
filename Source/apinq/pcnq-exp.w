...
ASSIGN 
    cTextListToSelect  = "Vendor#,Name,Memo#,Memo Date,Amount,Invoice#,Due Date,Balance Due,Credit Amount," +
...
ASSIGN 
    cTextListToDefault = "Vendor#,Name,Memo#,Memo Date,Amount,Invoice#,Due Date,Balance Due,Credit Amount," +
                                               "Debit Amount,Account Number,Account Description" .
...
DEFINE FRAME rd-fgnq-exp
    ...
    btn_down AT ROW 14.19 COL 42 WIDGET-ID 132
    ...
    FOR EACH ap-pay WHERE ap-pay.company EQ cocode 
        ...
        FOR EACH ttRptSelected:
            ...
            DO:
                ...
                DEFINE VARIABLE ld-amt AS DECIMAL NO-UNDO.
                ld-amt = 0.
