...
&SCOPED-DEFINE h_Browse01 h_b-apinq
...
ON END-ERROR OF W-Win /* Vendor Invoice Inquiry */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Vendor Invoice Inquiry */
DO:
    ...
    WHEN 2 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = ?':U ,
             OUTPUT h_b-apinvl ).
       RUN set-position IN h_b-apinvl ( 11.48 , 3.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-nav2 ).
       RUN set-position IN h_v-nav2 ( 21.24 , 22.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-disabl ).
       RUN set-position IN h_p-disabl ( 21.24 , 97.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_b-apinq , 'Record':U , h_v-apinv ).

       /* Links to SmartNavBrowser h_b-apinvl. */
       RUN add-link IN adm-broker-hdl ( h_b-apinq , 'inquiry':U , h_b-apinvl ).
       RUN add-link IN adm-broker-hdl ( h_p-disabl , 'TableIO':U , h_b-apinvl ).
       RUN add-link IN adm-broker-hdl ( h_v-apinv , 'Record':U , h_b-apinvl ).

       /* Links to SmartViewer h_v-nav2. */
       RUN add-link IN adm-broker-hdl ( h_b-apinq , 'nav-itm':U , h_v-nav2 ).
