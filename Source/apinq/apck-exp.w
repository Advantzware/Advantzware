...
ASSIGN 
    cTextListToSelect  = "Check#,Chk Date,Invoice#,Due Date,Gross Amount,Net Amount,Discount"

    cFieldListToSelect = "chk,chk-dt,inv,due-dt,grs-amt,net-amt,disc" .
{sys/inc/ttRptSel.i}

ASSIGN 
    cTextListToDefault = "Check#,Chk Date,Invoice#,Due Date,Gross Amount,Net Amount,Discount".
...
begin_chk end_chk begin_inv end_inv begin_date end_date sl_avail Btn_Def ~
...
begin_inv end_inv begin_date end_date sl_avail sl_selected fi_file ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD validDate rd-fgnq-exp 
...
DEFINE VARIABLE end_chk    AS INTEGER   FORMAT ">>>>>>>9" INITIAL 99999999 
    LABEL "To Check#" 
    VIEW-AS FILL-IN 
    SIZE 21 BY 1.
...
DEFINE FRAME rd-fgnq-exp
    begin_vend AT ROW 2.48 COL 25.6 COLON-ALIGNED HELP
    "Enter Beginning Vendor#" WIDGET-ID 142
    end_vend AT ROW 2.57 COL 65.8 COLON-ALIGNED HELP
    "Enter Ending Vendor#" WIDGET-ID 144
    begin_chk AT ROW 3.62 COL 25.6 COLON-ALIGNED HELP
    "Enter Beginning Vendor#" WIDGET-ID 146
    end_chk AT ROW 3.71 COL 65.8 COLON-ALIGNED HELP
    "Enter Ending Vendor#" WIDGET-ID 148
    begin_inv AT ROW 4.81 COL 25.6 COLON-ALIGNED HELP
    "Enter Beginning Vendor#" WIDGET-ID 150
    end_inv AT ROW 4.91 COL 65.8 COLON-ALIGNED HELP
    "Enter Ending Vendor#" WIDGET-ID 152
    begin_date AT ROW 6 COL 25.6 COLON-ALIGNED HELP
    "Enter Beginning Vendor#" WIDGET-ID 154
    end_date AT ROW 6.1 COL 65.8 COLON-ALIGNED HELP
    "Enter Ending Vendor#" WIDGET-ID 156
    sl_avail AT ROW 9.43 COL 7 NO-LABELS WIDGET-ID 26
    Btn_Def AT ROW 9.43 COL 42.4 HELP
    "Add Selected Table to Tables to Audit" WIDGET-ID 56
    sl_selected AT ROW 9.43 COL 62.6 NO-LABELS WIDGET-ID 28
    Btn_Add AT ROW 10.62 COL 42.4 HELP
    "Add Selected Table to Tables to Audit" WIDGET-ID 130
    Btn_Remove AT ROW 11.81 COL 42.4 HELP
    "Remove Selected Table from Tables to Audit" WIDGET-ID 134
    btn_Up AT ROW 13 COL 42.4 WIDGET-ID 136
    btn_down AT ROW 14.19 COL 42.4 WIDGET-ID 132
    ...
    btn-ok AT ROW 20.05 COL 32.4 WIDGET-ID 14
    btn-cancel AT ROW 20.05 COL 52.4 WIDGET-ID 12
...
PROCEDURE create-tempfile :
    ...
    DEFINE VARIABLE t-vendor    LIKE ap-pay.vend-no.
    DEFINE VARIABLE f-chk       LIKE ap-pay.check-no FORMAT ">>>>>>>>" INIT 0.
    DEFINE VARIABLE t-chk       LIKE f-chk INIT 99999999.
    DEFINE VARIABLE f-inv       LIKE ap-payl.inv-no INIT "".
    DEFINE VARIABLE t-inv       LIKE f-inv INIT "zzzzzzzzzzzz".
    DEFINE VARIABLE v-check-no  LIKE ap-pay.check-no.
    DEFINE VARIABLE v-disc-amt  LIKE ap-payl.amt-disc.
    DEFINE VARIABLE v-gross-amt LIKE ap-payl.amt-paid.
...
PROCEDURE enable_UI :
    ...
    DISPLAY begin_vend end_vend begin_chk end_chk begin_inv end_inv begin_date 
        end_date sl_avail sl_selected fi_file tb_OpenCSV tbAutoClose 
        WITH FRAME rd-fgnq-exp.
    ENABLE RECT-6 RECT-7 RECT-8 begin_vend end_vend begin_chk end_chk begin_inv 
        end_inv begin_date end_date sl_avail Btn_Def sl_selected Btn_Add 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION validDate rd-fgnq-exp 
FUNCTION validDate RETURNS LOGICAL
