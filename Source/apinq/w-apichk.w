...
&SCOPED-DEFINE h_Browse01 h_b-apichk
...
DEFINE VARIABLE h_attachvinv AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b-apichk AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Query Checks/Invoices */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Query Checks/Invoices */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_attachvinv ).
       RUN set-position IN h_attachvinv ( 1.00 , 76.60 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_options ).
       RUN set-position IN h_options ( 1.00 , 84.40 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_exit ).
       RUN set-position IN h_exit ( 1.00 , 140.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.81 , 7.80 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adm/objects/folder.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'FOLDER-LABELS = ':U + 'AP Checks/Inv' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'apinq/b-apichk.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-apichk ).
       RUN set-position IN h_b-apichk ( 4.57 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 19.33 , 148.00 ) */
       ...
       RUN add-link IN adm-broker-hdl ( h_b-apichk , 'export-xl':U , h_export ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-apichk ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
