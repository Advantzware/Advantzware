...
&IF DEFINED(EXCLUDE-calcQtyPerTrans) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE calcQtyPerTrans Procedure 
...
&IF DEFINED(EXCLUDE-completeMR) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE completeMR Procedure 
...
&IF DEFINED(EXCLUDE-createEmpLogin) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE createEmpLogin Procedure 
...
&IF DEFINED(EXCLUDE-createMachEmp) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE createMachEmp Procedure 
...
------------------------------------------------------------------------------*/
  ...
  FIND FIRST emplogin NO-LOCK
       WHERE ROWID(emplogin) EQ ipEmpLoginRowID.
  FIND FIRST employee NO-LOCK
...
&IF DEFINED(EXCLUDE-createTtblVorne) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE createTtblVorne Procedure 
...
&IF DEFINED(EXCLUDE-employeeRate) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE employeeRate Procedure 
...
&IF DEFINED(EXCLUDE-setRecKey) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE setRecKey Procedure 
PROCEDURE setRecKey :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
&IF DEFINED(EXCLUDE-setSBJobs) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE setSBJobs Procedure 
PROCEDURE setSBJobs :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
&IF DEFINED(EXCLUDE-vorneDetail) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE vorneDetail Procedure 
...
&IF DEFINED(EXCLUDE-vorneSummary) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE vorneSummary Procedure 
