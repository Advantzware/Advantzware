...
DO:
  IF SEARCH("{&docs}\sbProDoc.docx") NE ? THEN
  OS-COMMAND NO-WAIT VALUE(SEARCH("{&docs}\sbProDoc.docx")).
  ELSE IF SEARCH("{&docs}\sbProDoc.doc") NE ? THEN
  OS-COMMAND NO-WAIT VALUE(SEARCH("{&docs}\sbProDoc.doc")).
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Board|Config|Downtime|Resources' + ',
                     FOLDER-TAB-TYPE = 2':U ,
             OUTPUT h_folder ).
