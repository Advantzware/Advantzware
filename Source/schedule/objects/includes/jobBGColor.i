...
------------------------------------------------------------------------------*/
    ...
    ASSIGN
        ...
        d = IF dueDateUsed EQ YES THEN numericDateTime({&colorJobTable}.dueDate,{&colorJobTable}.dueTime)
            ELSE IF dueDateUsed EQ NO THEN numericDateTime({&colorJobTable}.prodDate,{&colorJobTable}.dueTime)
            ELSE numericDateTime(DATE({&colorJobTable}.userField82),{&colorJobTable}.dueTime)
        fgJobColor = 0
        .
