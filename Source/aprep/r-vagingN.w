...
DEFINE TEMP-TABLE tt-vend NO-UNDO
...
DEFINE TEMP-TABLE w-sort NO-UNDO 
...
lbl_sort rd_sort tb_detailed tb_print-head sl_avail sl_selected rd-dest ~
...
DEFINE VARIABLE fi_file        AS CHARACTER FORMAT "X(45)" INITIAL "c:~\tmp~\VendorAging.csv" 
    LABEL "Name" 
...
DEFINE FRAME FRAME-A
    begin_comp AT ROW 2.52 COL 29.6 COLON-ALIGNED
    end_comp AT ROW 2.52 COL 69.6 COLON-ALIGNED
    begin_vend AT ROW 3.48 COL 29.6 COLON-ALIGNED HELP
    "Enter Beginning Vendor"
    end_vend AT ROW 3.48 COL 69.6 COLON-ALIGNED HELP
    "Enter Ending Vendor"
    begin_curr AT ROW 4.43 COL 29.6 COLON-ALIGNED HELP
    "Enter Beginning Currency Code"
    end_curr AT ROW 4.43 COL 69.6 COLON-ALIGNED HELP
    "Enter Ending Currency Code"
    begin_type AT ROW 5.38 COL 29.6 COLON-ALIGNED HELP
    "Enter Beginning Currency Code" WIDGET-ID 10
    end_type AT ROW 5.38 COL 69.6 COLON-ALIGNED HELP
    ...
    lbl_sort AT ROW 10.81 COL 23 COLON-ALIGNED NO-LABELS
    rd_sort AT ROW 10.81 COL 35 NO-LABELS
    ...
    Btn_Def AT ROW 13.86 COL 40.2 HELP
    "Add Selected Table to Tables to Audit" WIDGET-ID 56
    sl_selected AT ROW 13.86 COL 60.6 NO-LABELS WIDGET-ID 28
    Btn_Add AT ROW 14.86 COL 40.2 HELP
    "Add Selected Table to Tables to Audit" WIDGET-ID 32
    Btn_Remove AT ROW 15.86 COL 40.2 HELP
    "Remove Selected Table from Tables to Audit" WIDGET-ID 34
    btn_Up AT ROW 16.91 COL 40.2 WIDGET-ID 40
    btn_down AT ROW 17.91 COL 40.2 WIDGET-ID 42
    rd-dest AT ROW 19.81 COL 4.8 NO-LABELS
    lv-font-no AT ROW 19.81 COL 40 COLON-ALIGNED
    lv-ornt AT ROW 19.81 COL 48 NO-LABELS
    lines-per-page AT ROW 19.81 COL 87 COLON-ALIGNED
    lv-font-name AT ROW 21 COL 30 COLON-ALIGNED NO-LABELS
    td-show-parm AT ROW 22.19 COL 29
    tb_excel AT ROW 22.19 COL 92 RIGHT-ALIGNED
    fi_file AT ROW 23.1 COL 27 COLON-ALIGNED HELP
    "Enter File Name"
    tb_OpenCSV AT ROW 23.19 COL 92.2 RIGHT-ALIGNED
    tbAutoClose AT ROW 24.33 COL 29 WIDGET-ID 78
    btn-ok AT ROW 25.29 COL 29
    btn-cancel AT ROW 25.29 COL 55
    "Selected Columns(In Display Order)" VIEW-AS TEXT
    SIZE 34 BY .62 AT ROW 13.14 COL 60.4 WIDGET-ID 44
    " Selection Parameters" VIEW-AS TEXT
    SIZE 21 BY .71 AT ROW 1.24 COL 4
    " Output Destination" VIEW-AS TEXT
    SIZE 18 BY .62 AT ROW 19.1 COL 4
    "Available Columns" VIEW-AS TEXT
    SIZE 29 BY .62 AT ROW 13.14 COL 3 WIDGET-ID 38
    RECT-6 AT ROW 19.52 COL 3
...
/* SETTINGS FOR FRAME FRAME-A
   FRAME-NAME                                                           */
ASSIGN 
    as_of_date:PRIVATE-DATA IN FRAME FRAME-A = "parm".
...
/* SETTINGS FOR FILL-IN lbl_date IN FRAME FRAME-A
   NO-ENABLE                                                            */
ASSIGN 
    lbl_date:PRIVATE-DATA IN FRAME FRAME-A = "rd_date".
...
ASSIGN 
    rd_date:PRIVATE-DATA IN FRAME FRAME-A = "Parm".
...
ASSIGN 
    tb_elect:PRIVATE-DATA IN FRAME FRAME-A = "parm".
...
ASSIGN 
    tb_non-elect:PRIVATE-DATA IN FRAME FRAME-A = "parm".

ASSIGN 
    tb_print-head:PRIVATE-DATA IN FRAME FRAME-A = "parm".
...
PROCEDURE enable_UI :
    ...
    DISPLAY begin_comp end_comp begin_vend end_vend begin_curr end_curr begin_type 
        ...
        rd_sort tb_detailed tb_print-head sl_avail sl_selected rd-dest fi_file 
...
PROCEDURE pPrintTotals :
    ...
    DO:
        cDisplay =  cDisplay + STRING(ipdValue1,"->,>>>,>>>,>>9.99") + " " + STRING(ipdValue2,"->,>>>,>>>,>>9.99") + 
            " " + STRING(ipdValue3,"->,>>>,>>>,>>9.99") + " " + STRING(ipdValue4,"->,>>>,>>>,>>9.99") + " " +
            STRING(ipdValue6,"->,>>>,>>>,>>9.99").
        cExcelDisplay = cExcelDisplay +  STRING(ipdValue1) + "," + STRING(ipdValue2) + "," +
            STRING(ipdValue3) + "," + STRING(ipdValue4) + "," + STRING(ipdValue6) .   
...
PROCEDURE run-report :
    ...
    IF tb_elect AND tb_non-elect THEN 
    DO:
        cPaymentList = "".
    END.
    ELSE IF tb_elect THEN 
        DO:
    ...
    DO:
        ...
        excelheader = excelheader
            ...
            + STRING(period-days-4) + " ,Total Payables".
    ...
    FOR EACH tt-vend,
        ...
        IF LAST-OF(tt-vend.curr-code) THEN 
        DO:
    ...
    DO WITH FRAME {&FRAME-NAME}:
        ...
        ELSE
            ASSIGN
                ...
                .
        ASSIGN 
            fi_file:SCREEN-VALUE = "c:\tmp\VendorAging.csv".    
    END.
