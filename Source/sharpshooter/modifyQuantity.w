...
/*------------------------------------------------------------------------
  ...
  File: sharpshooter/modifyQuantity.w
...
&Scoped-Define ENABLED-OBJECTS Btn_Cancel fiQuantity Btn_OK 
...
DEFINE FRAME D-Dialog
     Btn_Cancel AT ROW 5.29 COL 83.6 WIDGET-ID 4
     fiQuantity AT ROW 1.95 COL 38 COLON-ALIGNED WIDGET-ID 2
     Btn_OK AT ROW 5.29 COL 70.6 WIDGET-ID 6
     SPACE(15.79) SKIP(0.41)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         BGCOLOR 21 FGCOLOR 15 FONT 38
         TITLE "Enter Quantity to Adjust" WIDGET-ID 100.
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Enter Quantity to Adjust */
DO:  
...
DO:
    ASSIGN
        ...
        opdValue           = DECIMAL(fiQuantity:SCREEN-VALUE)
        .  
END.
...
------------------------------------------------------------------------------*/
  DISPLAY fiQuantity 
      WITH FRAME D-Dialog.
  ENABLE Btn_Cancel fiQuantity Btn_OK 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
