...
/*------------------------------------------------------------------------
  ...
  File: sharpshooter/w-createLoadtagReprint.w
...
DEFINE FRAME F-Main
     btClear AT ROW 3.19 COL 199.4 WIDGET-ID 146
     btnNumPad AT ROW 2.86 COL 94 WIDGET-ID 120 NO-TAB-STOP 
     btDelete AT ROW 14.95 COL 17 WIDGET-ID 62
     btPrint AT ROW 14.95 COL 199 WIDGET-ID 30
     btnExitText AT ROW 1.24 COL 189 COLON-ALIGNED NO-LABEL WIDGET-ID 70
     btnClearText AT ROW 3.38 COL 186.6 NO-LABEL WIDGET-ID 148
     btnSettingsText AT ROW 15.05 COL 147 COLON-ALIGNED NO-LABEL WIDGET-ID 72
     btnDeleteText AT ROW 15.19 COL 2 NO-LABEL WIDGET-ID 64
     statusMessage AT ROW 15.19 COL 30 COLON-ALIGNED NO-LABEL WIDGET-ID 66
     btnPrintText AT ROW 15.19 COL 184 COLON-ALIGNED NO-LABEL WIDGET-ID 68
     RECT-2 AT ROW 2.67 COL 93 WIDGET-ID 130
...
ON END-ERROR OF W-Win /* Create Loadtag - Reprint */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Create Loadtag - Reprint */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_f-reprint ).
       RUN set-position IN h_f-reprint ( 2.67 , 3.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-loadtags ).
       RUN set-position IN h_b-loadtags ( 5.52 , 1.00 ) NO-ERROR.
       ...
       RUN set-position IN h_navigatefirst ( 5.52 , 200.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.91 , 8.00 ) */
       ...
       RUN set-position IN h_navigateprev ( 7.71 , 200.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.91 , 8.00 ) */
       ...
       RUN set-position IN h_navigatenext ( 10.52 , 200.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.91 , 8.00 ) */
       ...
       RUN set-position IN h_navigatelast ( 12.86 , 200.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.91 , 8.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_setting ).
       RUN set-position IN h_setting ( 14.81 , 168.00 ) NO-ERROR.
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_f-reprint ,
             h_exit , 'AFTER':U ).
