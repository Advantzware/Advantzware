...
/*------------------------------------------------------------------------
  ...
  File: sharpshooter/w-createLoadtagReturn.w
...
DEFINE FRAME F-Main
     ...
     btDelete AT ROW 21.62 COL 17 WIDGET-ID 62
     btPrint AT ROW 21.62 COL 199 WIDGET-ID 30
     ...
     btnSettingsText AT ROW 21.71 COL 147 COLON-ALIGNED NO-LABEL WIDGET-ID 72
     btnDeleteText AT ROW 21.86 COL 2 NO-LABEL WIDGET-ID 64
     statusMessage AT ROW 21.86 COL 30 COLON-ALIGNED NO-LABEL WIDGET-ID 66
     btnPrintText AT ROW 21.86 COL 184 COLON-ALIGNED NO-LABEL WIDGET-ID 68
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_f-return ).
       RUN set-position IN h_f-return ( 2.43 , 2.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-loadtags ).
       RUN set-position IN h_b-loadtags ( 9.57 , 1.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_setting ).
       RUN set-position IN h_setting ( 21.48 , 168.00 ) NO-ERROR.
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_f-return ,
             h_exit , 'AFTER':U ).
