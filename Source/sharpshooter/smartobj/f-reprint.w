...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_tagfilter , 'REPRINT':U , THIS-PROCEDURE ).
...
------------------------------------------------------------------------------*/
    ...
    {methods/run_link.i "REPRINT-SOURCE" "GetTag" "(OUTPUT opoLoadtag)"}
END PROCEDURE.
...
-------------------------------------------------------------*/
    ...
    CASE p-state:
        WHEN "tag-valid" THEN DO:
            ...
            {methods/run_link.i "REPRINT-SOURCE" "EmptyTag"}
        
            {methods/run_link.i "REPRINT-SOURCE" "ScanNextTag"}            
        END.
    END CASE.
END PROCEDURE.
