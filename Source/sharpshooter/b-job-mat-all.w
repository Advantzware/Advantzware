...
&Scoped-define FIELDS-IN-QUERY-br_table job-mat.frm job-mat.blank-no job-mat.rm-i-no item.i-dscr getAvailQty() @ iAvailQty job-mat.qty-all job-mat.qty-uom ~
job-mat.all-flg fGetLinearFeet() @ dLinearFeet item.s-len item.s-wid item.cal fGetFGQty() @ iFGQty cEmptyColumn   
