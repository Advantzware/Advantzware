...
/*------------------------------------------------------------------------
  ...
  File: sharpshooter/w-createLoadtagRelease.w
...
DEFINE FRAME F-Main
     btClear AT ROW 3.19 COL 199.6 WIDGET-ID 146
     btnNumPad AT ROW 3.33 COL 68 WIDGET-ID 120 NO-TAB-STOP 
     btDelete AT ROW 16.86 COL 17 WIDGET-ID 62
     btPrint AT ROW 16.86 COL 199 WIDGET-ID 30
     btnExitText AT ROW 1.24 COL 189 COLON-ALIGNED NO-LABEL WIDGET-ID 70
     btnClearText AT ROW 3.38 COL 186.8 NO-LABEL WIDGET-ID 148
     btnSettingsText AT ROW 16.95 COL 147 COLON-ALIGNED NO-LABEL WIDGET-ID 72
     btnDeleteText AT ROW 17.1 COL 2 NO-LABEL WIDGET-ID 64
     statusMessage AT ROW 17.1 COL 30 COLON-ALIGNED NO-LABEL WIDGET-ID 66
     btnPrintText AT ROW 17.1 COL 184 COLON-ALIGNED NO-LABEL WIDGET-ID 68
     RECT-2 AT ROW 3.14 COL 67 WIDGET-ID 130
...
ON END-ERROR OF W-Win /* Create Loadtag - Release */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Create Loadtag - Release */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       ...
       RUN set-position IN h_adjustwindowsize ( 1.00 , 156.00 ) NO-ERROR.
       ...
       RUN set-position IN h_f-releasetag ( 3.14 , 1.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-loadtags ).
       RUN set-position IN h_b-loadtags ( 5.76 , 1.00 ) NO-ERROR.
       ...
       RUN set-position IN h_navigatefirst ( 5.76 , 200.40 ) NO-ERROR.
       /* Size in UIB:  ( 1.91 , 8.00 ) */
       ...
       RUN set-position IN h_navigateprev ( 7.95 , 200.40 ) NO-ERROR.
       /* Size in UIB:  ( 1.91 , 8.00 ) */
       ...
       RUN set-position IN h_navigatenext ( 10.76 , 200.40 ) NO-ERROR.
       /* Size in UIB:  ( 1.91 , 8.00 ) */
       ...
       RUN set-position IN h_navigatelast ( 13.10 , 200.40 ) NO-ERROR.
       /* Size in UIB:  ( 1.91 , 8.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_setting ).
       RUN set-position IN h_setting ( 16.71 , 168.00 ) NO-ERROR.
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_f-releasetag ,
             h_exit , 'AFTER':U ).
