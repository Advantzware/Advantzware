...
DYNAMIC-FUNCTION('sfCommon_TimeDisplay', machtran.end_time, YES, NO) @ end-time ~
...
"DYNAMIC-FUNCTION('sfCommon_TimeDisplay', machtran.start_time, YES, NO) @ start-time" "Log In" "X(8)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[4]   = machtran.end_date
     _FldNameList[5]   = machtran.shift
     _FldNameList[6]   > "_<CALC>"
"DYNAMIC-FUNCTION('sfCommon_TimeDisplay', machtran.end_time, YES, NO) @ end-time" "Log Out" "X(8)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[7]   = machtran.run_qty
     _FldNameList[8]   = machtran.waste_qty
     _FldNameList[9]   > "_<CALC>"
"DYNAMIC-FUNCTION('sfCommon_TimeDisplay', machtran.total_time, NO, NO) @ total-time" "Total" "X(5)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
