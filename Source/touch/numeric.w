...
/* This NK1 setting disables keyboards on WIP modules if set to NO.
   Below code has been commeneted, so that User do not use the NK1 to 
   drive the functionality but can select them on demand */ 
/*
DO TRANSACTION:
   {sys/inc/tskey.i}
END.
