...
&{&DEFINETYPE}-define TABLENAME reftable
&{&DEFINETYPE}-define DBFIELD1 reftable.code
&{&DEFINETYPE}-define BEGINFLD1 begin_code
&{&DEFINETYPE}-define BEGIN-DEFAULT-1 yes
&{&DEFINETYPE}-define ENDFLD1 end_code
...
&{&DEFINETYPE}-define LISTORDER Code
...
&{&DEFINETYPE}-define SAVENAME reftable
