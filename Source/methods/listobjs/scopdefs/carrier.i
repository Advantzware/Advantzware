...
&{&DEFINETYPE}-define TABLENAME carrier
&{&DEFINETYPE}-define DBFIELD1 carrier.carrier
&{&DEFINETYPE}-define BEGINFLD1 begin_carrier
&{&DEFINETYPE}-define BEGIN-DEFAULT-1 yes
&{&DEFINETYPE}-define ENDFLD1 end_carrier
&{&DEFINETYPE}-define END-DEFAULT-1 yes
&{&DEFINETYPE}-define DBFIELD2 carrier.dscr
&{&DEFINETYPE}-define BEGINFLD2 begin_carrier_dscr
&{&DEFINETYPE}-define BEGIN-DEFAULT-2 yes
&{&DEFINETYPE}-define ENDFLD2 end_carrier_dscr
...
&{&DEFINETYPE}-define LISTORDER Carrier,Description
&{&DEFINETYPE}-define ADDFLD-1 show-matrix
...
&{&DEFINETYPE}-define SAVENAME carrier
