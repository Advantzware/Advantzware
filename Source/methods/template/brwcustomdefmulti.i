...
define temp-table brwtemp
  fields brwname as character
  fields columlist as character.

DEFINE VARIABLE colHand      AS WIDGET-HANDLE NO-UNDO.
DEFINE VARIABLE brwHand      AS WIDGET-HANDLE NO-UNDO.
DEFINE VARIABLE colHandList AS CHAR NO-UNDO.
DEFINE VARIABLE icnt        as integer no-undo. 
DEFINE VARIABLE brwHandList AS CHAR NO-UNDO.
