...
/*--------------------------------------------------------------------------
    ...
    Syntax      : {methods/template/brwcustom2.i [integer]}
                  integer value is optional, used for multiple browsers
...
DO:
    DO iCnt{1} = 1 TO NUM-ENTRIES(colHandList{1},","):
        ASSIGN
            ...
            colHand{1}:BGCOLOR = IF CURRENT-RESULT-ROW("{&sdBrowseName}") MOD 2 EQ 0 THEN 25
                                 ELSE 26
            . 
    END. /* do cnt */ 
END.
