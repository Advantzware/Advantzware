...
&Global-define FLDNAME1 edmast.partner
&Global-define FORMAT-1 X(10)
&Global-define SORTBY-1 BY edmast.partner
&Global-define IDXNAME1 
&Global-define DESCRIP1 Partner
&Global-define FLDNAME2 edmast.cust
&Global-define FORMAT-2 X(8)
&Global-define SORTBY-2 BY edmast.cust
&Global-define IDXNAME2 
&Global-define DESCRIP2 Customer
&Global-define FLDNAME3 edmast.vendor
&Global-define FORMAT-3 X(8)
&Global-define SORTBY-3 BY edmast.vendor
