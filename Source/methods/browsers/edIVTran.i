...
&Global-define FLDNAME1 string(edIVTran.invoice-no)
&Global-define FORMAT-1 X(8)
&Global-define SORTBY-1 BY edIVTran.invoice-no
&Global-define IDXNAME1 
&Global-define DESCRIP1 Invoice Num
&Global-define FLDNAME2 edIVTran.partner
&Global-define FORMAT-2 X(10)
&Global-define SORTBY-2 BY edIVTran.partner
&Global-define IDXNAME2 
&Global-define DESCRIP2 Partner
&Global-define FLDNAME3 STRING(edIVTran.seq)
&Global-define FORMAT-3 x(8)
&Global-define SORTBY-3 BY edIVTran.seq
