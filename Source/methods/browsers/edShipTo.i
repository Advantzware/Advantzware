...
&Global-define FLDNAME1 edShipTo.Cust
&Global-define FORMAT-1 X(8)
&Global-define SORTBY-1 BY edShipTo.Cust
&Global-define IDXNAME1 
&Global-define DESCRIP1 Invoice Num
&Global-define FLDNAME2 edShipTo.partner
&Global-define FORMAT-2 X(10)
&Global-define SORTBY-2 BY edShipTo.partner
&Global-define IDXNAME2 
&Global-define DESCRIP2 Partner
&Global-define FLDNAME3 edShipTo.st-code
&Global-define FORMAT-3 x(8)
&Global-define SORTBY-3 BY edShipTo.st-code
&Global-define IDXNAME3 
&Global-define DESCRIP3 Ship To Code
