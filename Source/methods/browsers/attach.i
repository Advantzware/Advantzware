...
&Global-define FLDNAME2 attach.est-no
&Global-define FORMAT-2 X(5)
&Global-define SORTBY-2 BY {&FLDNAME2}
&Global-define IDXNAME2 
&Global-define DESCRIP2 Estimate #
&Global-define FLDNAME3 attach.i-no
&Global-define FORMAT-3 X(15)
&Global-define SORTBY-3 BY {&FLDNAME3}
&Global-define IDXNAME3 
&Global-define DESCRIP3 FG Item#
&Global-define FLDNAME4 STRING(ATTACH.creat-date)
&GLOBAL-DEFINE FORMAT-4 99/99/9999
&Global-define SORTBY-4 BY {&FLDNAME4} DESC {&SORTBY-3} 
&Global-define IDXNAME4 
&Global-define DESCRIP4 Created Date Desc.
