...
&Global-define FLDNAME1 apiClientXref.scopeID
&Global-define FORMAT-1 X(12)
&Global-define SORTBY-1 
&Global-define IDXNAME1 
&Global-define DESCRIP1 Scope ID
&Global-define FLDNAME2 apiClientXref.clientID
&Global-define FORMAT-2 X(8)
&Global-define SORTBY-2 
&Global-define IDXNAME2 
&Global-define DESCRIP2 Client ID
