/* wip/wipTagXprnt.i */
        ...
        PUT  "<=1>" SKIP.
        PUT  "<C1><#2>".
        PUT  SKIP "<R23><C3><P12>_____________________________________<B>Fold Here</B>_____________________________________" SKIP .
        ...
        PUT  "<R37.5><C10><P16> <b>Form #:</b>" ttPrintInventoryStock.formNo FORMAT ">>9" .
        PUT  "<R39><C10><P16> <b>Blank #:</b>" ttPrintInventoryStock.blankNo FORMAT ">>9" .
         
        PUT   "<#=100><C40><R36><FROM><C68><R+3><BARCODE,TYPE=128B,ANGLE=0,CHECKSUM=NONE,VALUE=" ttPrintInventoryStock.jobNumber + "-" + STRING(ttPrintInventoryStock.jobRunNumber,"999") + "-" + 
                                                                                                 STRING(ttPrintInventoryStock.formNo,"999") + "-" + STRING(ttPrintInventoryStock.blankNo,"999") FORMAT "x(21)" ">"
              "<C42><R39>" ttPrintInventoryStock.jobNumber + "-" + STRING(ttPrintInventoryStock.jobRunNumber,"999") + "-" + 
                           STRING(ttPrintInventoryStock.formNo,"999") + "-" + STRING(ttPrintInventoryStock.blankNo,"999") FORMAT "x(21)" .
        ...
        PUT  "<R49><C10><P16><b>Next Machine:</b>  " ttPrintInventoryStock.nextMachineName FORMAT "x(30)".            
