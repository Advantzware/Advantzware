...
DEF INPUT-OUTPUT PARAM ipTextListToSelect AS cha NO-UNDO.
DEF INPUT-OUTPUT PARAM iopListSelected AS cha NO-UNDO.
DEF INPUT-OUTPUT PARAM ipTextListToDefault AS cha NO-UNDO.
DEF INPUT-OUTPUT PARAM ipCompTextListToSelect AS cha NO-UNDO.
...
DO:
   iopListSelected = sl_selected:LIST-ITEMS IN FRAME {&FRAME-NAME}.
END.
...
------------------------------------------------------------------------------*/
  ...
  DO iCount = 1 TO NUM-ENTRIES(ipTextListToDefault):

     cListContents = cListContents +                   
                    (IF cListContents = "" THEN ""  ELSE ",") +
                     ENTRY(iCount,ipTextListToDefault)   .
  END.            
...
------------------------------------------------------------------------------*/
  ...
  DO iCount = 1 TO NUM-ENTRIES(ipCompTextListToSelect): 

     cListContents = cListContents +                     
                    (IF cListContents = "" THEN ""  ELSE ",") + ENTRY(iCount,ipCompTextListToSelect)   .
  /*  CREATE ttRptList.
    ASSIGN ttRptList.TextList = ENTRY(iCount,ipCompTextListToSelect)
