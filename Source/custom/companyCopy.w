...
tg_fg-set tg_fgcat tg_flute tg_gl-ctrl tg_gl-rpt tg_item tg_item-bom ~
tg_item-spec tg_itemfg tg_itemfg-bom tg_itemfg-ink tg_loadtag tg_loc ~
tg_itemfg-loc tg_itemfgdtl tg_MaterialTypes tg_mach tg_mach-adder ~
...
tg_fgcat tg_flute tg_gl-ctrl tg_gl-rpt tg_item tg_item-bom tg_item-spec ~
tg_itemfg tg_itemfg-bom tg_itemfg-ink tg_loadtag tg_loc tg_itemfg-loc ~
tg_itemfgdtl tg_MaterialTypes tg_mach tg_mach-adder tg_mach-calendar ~
tg_mat-act tg_matprep tg_mmtx tg_mmty tg_mstd tg_oe-ctrl tg_oe-prmtx ~
...
DEFINE FRAME DEFAULT-FRAME
     ...
     tg_MaterialTypes AT ROW 11.52 COL 45 WIDGET-ID 88
     ...
     tg_period AT ROW 14.24 COL 4.8 WIDGET-ID 24
     tg_po-ctrl AT ROW 14.24 COL 24.8 WIDGET-ID 44
     tg_prep AT ROW 14.24 COL 45 WIDGET-ID 24
     tg_procat AT ROW 14.24 COL 65.8 WIDGET-ID 44
     tg_prod AT ROW 14.24 COL 88.4 WIDGET-ID 24
     tg_prodl AT ROW 15.14 COL 4.8 WIDGET-ID 24
     tg_rm-bin AT ROW 15.14 COL 24.8 WIDGET-ID 44
     tg_rm-ctrl AT ROW 15.14 COL 45 WIDGET-ID 24
...
DEFINE FRAME DEFAULT-FRAME
     tg_routing AT ROW 15.14 COL 65.8 WIDGET-ID 44
     tg_routing-mtx AT ROW 15.14 COL 88.4 WIDGET-ID 24
     tg_shift AT ROW 16.05 COL 4.8 WIDGET-ID 24
     tg_shipto AT ROW 16.05 COL 24.8 WIDGET-ID 44
     tg_sman AT ROW 16.05 COL 45 WIDGET-ID 24
     tg_sman-mtx AT ROW 16.05 COL 65.8 WIDGET-ID 44
     tg_soldto AT ROW 16.05 COL 88.4 WIDGET-ID 24
     tg_stack-flute AT ROW 16.95 COL 4.8 WIDGET-ID 24
     tg_stack-size AT ROW 16.95 COL 24.8 WIDGET-ID 44
     tg_stax AT ROW 16.95 COL 45 WIDGET-ID 24
     tg_stax-group AT ROW 16.95 COL 65.8 WIDGET-ID 44
     tg_std-code AT ROW 16.95 COL 88.4 WIDGET-ID 24
     tg_style AT ROW 17.81 COL 4.8 WIDGET-ID 24
...
------------------------------------------------------------------------------*/
  DISPLAY companyFrom copyTable companyTo tg_copy-master tg_account tg_ap-buy 
          ...
          tg_gl-ctrl tg_gl-rpt tg_item tg_item-bom tg_item-spec tg_itemfg 
          tg_itemfg-bom tg_itemfg-ink tg_loadtag tg_loc tg_itemfg-loc 
          tg_itemfgdtl tg_MaterialTypes tg_mach tg_mach-adder tg_mach-calendar 
          tg_mat-act tg_matprep tg_mmtx tg_mmty tg_mstd tg_oe-ctrl tg_oe-prmtx 
          tg_period tg_po-ctrl tg_prep tg_procat tg_prod tg_prodl tg_rm-bin 
  ...
  ENABLE tg_account tg_ap-buy tg_ap-ctrl tg_ap-ledger tg_ar-ctrl tg_bank 
         ...
         tg_item-spec tg_itemfg tg_itemfg-bom tg_itemfg-ink tg_loadtag tg_loc 
         tg_itemfg-loc tg_itemfgdtl tg_MaterialTypes tg_mach tg_mach-adder 
         tg_mach-calendar tg_mat-act tg_matprep tg_mmtx tg_mmty tg_mstd 
         tg_oe-ctrl tg_oe-prmtx tg_period tg_po-ctrl tg_prep tg_procat tg_prod 
