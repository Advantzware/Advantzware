...
ASSIGN 
    opcPath = "c:\progra~~1\LABEL MATRIX 2022\lmwprint.exe'".
IF SEARCH(opcPath) NE ? THEN RETURN.
ELSE DO:
    ASSIGN 
        opcPath = "c:\progra~~2\LABEL MATRIX 2022\lmwprint.exe".
    IF SEARCH(opcPath) NE ? THEN RETURN.
END.
...
ASSIGN 
    opcPath = "c:\progra~~1\LABEL MATRIX 2021\lmwprint.exe".
IF SEARCH(opcPath) NE ? THEN RETURN.
ELSE DO:
    ASSIGN 
        opcPath = "c:\progra~~2\LABEL MATRIX 2021\lmwprint.exe".
    IF SEARCH(opcPath) NE ? THEN RETURN.
END.
