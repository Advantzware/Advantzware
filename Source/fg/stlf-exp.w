...
ASSIGN 
    cTextListToSelect  = "Style No.,Description,Design #,Royalty,Glue Lap,Tuck,DK Length,DK Width,5th Panel,Lock TAB,Board,Ink," +
...
FUNCTION getValue-itemfg RETURNS CHARACTER
    ( BUFFER ipb-itemfg FOR style, ipc-field AS CHARACTER )  FORWARD.
...
DEFINE VARIABLE fi_file     AS CHARACTER FORMAT "X(45)" INITIAL "c:~\tmp~\ExportFoldingStyle.csv" 
    LABEL "Name" 
...
DEFINE FRAME rd-fgexp
    begin_style AT ROW 3 COL 19.6 COLON-ALIGNED HELP
    "Enter Beginning Machine Number" WIDGET-ID 142
    end_style AT ROW 3 COL 62.6 COLON-ALIGNED HELP
    "Enter Ending Machine #" WIDGET-ID 144
    sl_avail AT ROW 6.76 COL 4.2 NO-LABELS WIDGET-ID 26
    Btn_Add AT ROW 6.76 COL 40.6 HELP
    "Add Selected Table to Tables to Audit" WIDGET-ID 130
    sl_selected AT ROW 6.76 COL 61.8 NO-LABELS WIDGET-ID 28
    Btn_Remove AT ROW 7.95 COL 40.6 HELP
    "Remove Selected Table from Tables to Audit" WIDGET-ID 134
    btn_Up AT ROW 9.14 COL 40.6 WIDGET-ID 136
    btn_down AT ROW 10.33 COL 40.6 WIDGET-ID 132
    fi_file AT ROW 14.38 COL 17.8 COLON-ALIGNED HELP
    "Enter File Name" WIDGET-ID 22
    tb_OpenCSV AT ROW 14.43 COL 84.2 RIGHT-ALIGNED WIDGET-ID 34
    tbAutoClose AT ROW 16.19 COL 29 WIDGET-ID 64
    tb_excel AT ROW 16.24 COL 4 WIDGET-ID 32
    btn-ok AT ROW 17.24 COL 28.8 WIDGET-ID 14
    btn-cancel AT ROW 17.24 COL 53.8 WIDGET-ID 12
    "Selected Columns" VIEW-AS TEXT
    SIZE 20.8 BY .62 AT ROW 6.05 COL 62.2 WIDGET-ID 138
    " Selection Parameters" VIEW-AS TEXT
    SIZE 21 BY .71 AT ROW 1.24 COL 4 WIDGET-ID 36
    " Export Selection" VIEW-AS TEXT
    SIZE 17 BY .62 AT ROW 5.29 COL 4 WIDGET-ID 86
    "Available Columns" VIEW-AS TEXT
    SIZE 29 BY .62 AT ROW 6.05 COL 4.6 WIDGET-ID 140
    RECT-6 AT ROW 5.62 COL 3 WIDGET-ID 30
    RECT-7 AT ROW 1.71 COL 3 WIDGET-ID 38
    RECT-8 AT ROW 13.76 COL 3 WIDGET-ID 84
    SPACE(1.59) SKIP(2.94)
...
ON HELP OF FRAME rd-fgexp /* Export Folding Style to Excel */
    DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL rd-fgexp rd-fgexp
ON WINDOW-CLOSE OF FRAME rd-fgexp /* Export Folding Style to Excel */
    DO:
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    DO WITH FRAME {&FRAME-NAME}:
        ...
        fi_file:SCREEN-VALUE = "c:\tmp\ExportFoldingStyle.csv".
...
FUNCTION getValue-itemfg RETURNS CHARACTER
    ( BUFFER ipb-itemfg FOR style, ipc-field AS CHARACTER ) :
    /*------------------------------------------------------------------------------
