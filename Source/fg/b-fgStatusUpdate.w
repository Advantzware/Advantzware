...
DEFINE FRAME F-Main
     ...
     fiTag AT ROW 2.71 COL 10 COLON-ALIGNED WIDGET-ID 44
     fiStatusID AT ROW 2.62 COL 56 COLON-ALIGNED WIDGET-ID 46
     rsOnHold AT ROW 2.48 COL 78.8 NO-LABEL WIDGET-ID 52
     tbZeroQty AT ROW 2.67 COL 121.6 WIDGET-ID 60
     btSearch AT ROW 1.19 COL 164.8 WIDGET-ID 32
     BROWSE-2 AT ROW 4.1 COL 2 WIDGET-ID 200
     btUpdate AT ROW 22.81 COL 63.6 WIDGET-ID 62
     btUpdateAll AT ROW 22.81 COL 95.6 WIDGET-ID 64
     "-" VIEW-AS TEXT
          SIZE 1 BY .62 AT ROW 1.43 COL 95 WIDGET-ID 56
     RECT-1 AT ROW 1.1 COL 2 WIDGET-ID 50
     RECT-32 AT ROW 22.57 COL 61.6 WIDGET-ID 66
