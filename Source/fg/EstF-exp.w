...
Btn_Add sl_avail sl_selected Btn_Remove btn_Up btn_down fi_file tb_OpenCSV ~
...
DEFINE VARIABLE fi_file   AS CHARACTER FORMAT "X(45)" INITIAL "c:~\tmp~\FoldingEstimate.csv" 
    LABEL "Name" 
...
DEFINE FRAME rd-fgexp
    begin_est AT ROW 3.86 COL 21 COLON-ALIGNED HELP
    "Enter Beginning Estimate Number" WIDGET-ID 142
    end_est AT ROW 3.86 COL 64 COLON-ALIGNED HELP
    "Enter Ending Estimate #" WIDGET-ID 144
    Btn_Add AT ROW 8.81 COL 40.6 HELP
    "Add Selected Table to Tables to Audit" WIDGET-ID 130
    sl_avail AT ROW 8.86 COL 5 NO-LABELS WIDGET-ID 26
    sl_selected AT ROW 8.86 COL 61.6 NO-LABELS WIDGET-ID 28
    Btn_Remove AT ROW 10 COL 40.6 HELP
    "Remove Selected Table from Tables to Audit" WIDGET-ID 134
    btn_Up AT ROW 11.19 COL 40.6 WIDGET-ID 136
    btn_down AT ROW 12.38 COL 40.6 WIDGET-ID 132
    fi_file AT ROW 16.29 COL 17.6 COLON-ALIGNED HELP
    "Enter File Name" WIDGET-ID 22
    tb_OpenCSV AT ROW 16.38 COL 83.6 RIGHT-ALIGNED WIDGET-ID 34
    tbAutoClose AT ROW 18.19 COL 31 WIDGET-ID 64
    tb_excel AT ROW 18.24 COL 5 WIDGET-ID 32
    btn-ok AT ROW 19.1 COL 31 WIDGET-ID 14
    btn-cancel AT ROW 19.1 COL 51 WIDGET-ID 12
    "Selected Columns" VIEW-AS TEXT
    SIZE 19 BY .62 AT ROW 8.19 COL 68 WIDGET-ID 138
    "Available Columns" VIEW-AS TEXT
    SIZE 29 BY .62 AT ROW 8.14 COL 9.4 WIDGET-ID 140
    " Export Selection" VIEW-AS TEXT
    SIZE 17 BY .62 AT ROW 7.29 COL 5 WIDGET-ID 86
    " Selection Parameters" VIEW-AS TEXT
    SIZE 21.2 BY .71 AT ROW 1.14 COL 5 WIDGET-ID 36
    RECT-6 AT ROW 7.57 COL 4 WIDGET-ID 30
    RECT-7 AT ROW 1.52 COL 4 WIDGET-ID 38
    RECT-8 AT ROW 15.62 COL 4 WIDGET-ID 84
    SPACE(2.99) SKIP(3.39)
...
PROCEDURE enable_UI :
    ...
    ------------------------------------------------------------------------------*/
    DISPLAY begin_est end_est sl_avail sl_selected fi_file tb_OpenCSV tbAutoClose 
        WITH FRAME rd-fgexp.
    ENABLE RECT-6 RECT-7 RECT-8 begin_est end_est Btn_Add sl_avail sl_selected 
