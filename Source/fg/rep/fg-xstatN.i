...
FOR EACH ttCustList 
    ...
    FOR EACH oe-ordl
        ...
        v-sales-rep = "" .
        IF AVAILABLE cust AND cust.ACTIVE NE "X" AND cSlsRep EQ "" THEN 
        DO:
        ...
        FOR EACH oe-rel
            ...
            ASSIGN 
                tt-oe-rel.lot-no = oe-rel.lot-no.

            v-prodqty2 = 0 .
                 
            IF AVAILABLE tt-oe-rel AND tt-oe-rel.lot-no NE "" THEN 
            DO:
                                    ...
                                    DO:            
                                        CASE cTmpField:               
                                            WHEN "v-job-no" THEN 
                                                cVarValue = v-job-no.
                                            WHEN "v-rel#" THEN 
                                                cvarValue = IF AVAILABLE tt-oe-rel AND tt-oe-rel.link-no <> 0 THEN STRING(tt-oe-rel.link-no) ELSE "" .                   /*Task# 12021301*/
                                            WHEN "v-relDate" THEN 
                                                cVarValue = IF AVAILABLE tt-oe-rel THEN STRING(tt-oe-rel.rel-date) ELSE "".
                                            WHEN "v-relQty" THEN 
                                                cVarValue = /*IF AVAIL tt-oe-rel THEN string(tt-oe-rel.tot-qty,"->>>>>>,>>9") ELSE ""*/
                                                    STRING(v-qty-allo,"->>>>>>,>>9") .
                                            WHEN "v-rctDate" THEN 
                                                cVarValue = IF trans-date <> ? THEN STRING(trans-date, "99/99/99") ELSE "".
                                            WHEN "v-qty-onh" THEN 
                                                cVarValue =     STRING(v-qty-onh,"->>>>>>,>>9").
                                            WHEN "li-ship-qty" THEN 
                                            ...
                                            WHEN "v-ext" THEN 
                                                cVarValue = STRING(v-ext-job,"->>>,>>>,>>9.99").
                                            WHEN "v-rfq" THEN 
                                                cVarValue = STRING(v-rfq,"x(10)").
                                            WHEN "qty-pro" THEN 
                                                cVarValue = STRING(qty-prod,"->>>>>,>>9").
                                            WHEN "qty-bal" THEN 
                                                cVarValue = STRING(oe-ordl.qty - li-ship-qty ,"->>>>>,>>9").
                                            WHEN "ord-date" THEN 
                                                cVarValue = IF oe-ord.ord-date <> ? THEN STRING(oe-ord.ord-date,"99/99/99") ELSE "" .
                                            WHEN "ship-date" THEN 
                                                cVarValue = IF ship-date <> ? THEN STRING(ship-date,"99/99/99") ELSE "" .
                                            WHEN "relqty" THEN 
                                                cVarValue = (IF rd_smry-dtl = "D" AND AVAILABLE tt-oe-rel  THEN STRING(tt-oe-rel.tot-qty,"->>>>>>,>>9") ELSE STRING(v-summ-temp,"->>>>>>,>>9") ) .
                                            WHEN "loc" THEN 
                                                cVarValue = STRING(fg-bin.loc,"x(5)").
                                            WHEN "relpo" THEN 
                                                cVarValue = IF AVAILABLE tt-oe-rel THEN STRING(tt-oe-rel.po-no) ELSE "".
                                            WHEN "rellot" THEN 
                                                cVarValue = IF AVAILABLE tt-oe-rel THEN STRING(tt-oe-rel.lot-no) ELSE "".
                                            WHEN "prodqty" THEN 
                                                cVarValue = (IF rd_smry-dtl = "D" AND AVAILABLE tt-oe-rel  THEN STRING(tt-oe-rel.qty,"->>>,>>>,>>>,>>9") ELSE STRING(v-prodqty,"->>>,>>>,>>>,>>9")) .
                                            WHEN "sman" THEN 
                                                cVarValue = STRING(v-sales-rep).
                                            WHEN "fg-lot" THEN 
                                                cVarValue = IF v-fg-lot NE "" THEN STRING(v-fg-lot) ELSE "".
                                            WHEN "shipto" THEN 
                                                cVarValue = v-shipto .
                                            WHEN "shipname" THEN 
                                                cVarValue = v-shipto-name  .
                                            WHEN "fac-costm" THEN 
                                                cVarValue = STRING(vtot-costm,"->>,>>>,>>9.99")  .
                                            WHEN "tot-fac-cost" THEN 
                                                cVarValue = IF v-job-no <> "" THEN STRING( v-qty-onh * vtot-costm ,"->>>>,>>>,>>9.99")  ELSE "" .
                                            WHEN "ord-price" THEN 
                                        ...
                                        DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
                                            ...
                                            CASE cTmpField:   
                                                WHEN "cust.cust-no" THEN 
                                                    cVarValue = "".
                                                WHEN "oe-ordl.po-no" THEN 
                                                    cVarValue = "".
                                                WHEN "sman" THEN 
                                                    cVarValue = "" .
                                                WHEN "oe-ordl.i-no" THEN 
                                                    cVarValue = "".
                                                WHEN "oe-ordl.part-no" THEN 
                                                    cVarValue = "".
                                                WHEN "oe-ordl.i-name" THEN 
                                                    cVarValue = "".
                                                WHEN "v-job-no" THEN 
                                                    cVarValue = "".
                                                WHEN "v-rel#" THEN 
                                                    cvarValue = IF AVAILABLE tt-oe-rel AND tt-oe-rel.link-no <> 0 THEN STRING(tt-oe-rel.link-no) ELSE "" .
                                                WHEN "v-relDate" THEN 
                                                    cVarValue = IF AVAILABLE tt-oe-rel THEN STRING(tt-oe-rel.rel-date) ELSE "".
                                                WHEN "v-relQty" THEN 
                                                    cVarValue = /*IF AVAIL tt-oe-rel THEN string(tt-oe-rel.tot-qty,"->>>>>>,>>9") ELSE ""*/
                                                ...
                                                WHEN "ship-date" THEN 
                                                    cVarValue = IF ship-date <> ? THEN STRING(ship-date,"99/99/99") ELSE "" .
                                                WHEN "relqty" THEN 
                                                    cVarValue = IF AVAILABLE tt-oe-rel THEN STRING(tt-oe-rel.tot-qty,"->>>>>>,>>9") ELSE "".
                                                WHEN "loc" THEN 
                                                    cVarValue = "" .
                                                WHEN "relpo" THEN 
                                                    cVarValue =  IF AVAILABLE tt-oe-rel THEN STRING(tt-oe-rel.po-no) ELSE "".
                                                WHEN "rellot" THEN 
                                                    cVarValue =  IF AVAILABLE tt-oe-rel THEN STRING(tt-oe-rel.lot-no) ELSE "".
                                                WHEN "prodqty" THEN 
                                                    cVarValue = IF AVAILABLE tt-oe-rel THEN STRING(tt-oe-rel.qty,"->>>,>>>,>>>,>>9") ELSE "". 
                                                WHEN "fg-lot" THEN 
                                                    cVarValue = "" .
                                                WHEN "shipto" THEN 
                                                    cVarValue = "".
                    ...
                    DO:            
                        CASE cTmpField:               
                            ...
                            WHEN "relqty" THEN 
                                cVarValue = (IF rd_smry-dtl = "D" AND AVAILABLE tt-oe-rel THEN STRING(tt-oe-rel.tot-qty,"->>>>>>,>>9") ELSE STRING(v-summ-temp,"->>>>>>,>>9") ) .
                            WHEN "loc" THEN 
                                cVarValue = STRING(itemfg.loc,"x(5)").   
                            WHEN "relpo" THEN 
                                cVarValue = IF AVAILABLE tt-oe-rel THEN STRING(tt-oe-rel.po-no) ELSE "".
                            WHEN "rellot" THEN 
                                cVarValue = IF AVAILABLE tt-oe-rel THEN STRING(tt-oe-rel.lot-no) ELSE "".
                            WHEN "prodqty" THEN 
                                cVarValue = STRING(v-prodqty,"->>>,>>>,>>>,>>9") .
                            WHEN "sman" THEN 
                                cVarValue = STRING(v-sales-rep).
                            WHEN "fg-lot" THEN 
                                cVarValue = IF v-fg-lot NE "" THEN STRING(v-fg-lot) ELSE "".
                            ...
                            WHEN "shipname" THEN 
                                cVarValue = v-shipto-name .
                            WHEN "fac-costm" THEN 
                                cVarValue = IF vtot-costm <> 0 THEN STRING(vtot-costm,"->>,>>>,>>9.99") ELSE "" .
                            WHEN "tot-fac-cost" THEN 
                                cVarValue = IF v-job-no <> "" THEN STRING(v-qty-onh * vtot-costm,"->>>>,>>>,>>9.99")  ELSE "" .
                            WHEN "on-hand-cost" THEN 
                                DO: 
                        ...
                        DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
                            ...
                            CASE cTmpField:   
                                ...
                                WHEN "v-rel#" THEN 
                                    cvarValue = IF AVAILABLE tt-oe-rel AND tt-oe-rel.link-no <> 0 THEN STRING(tt-oe-rel.link-no) ELSE "" .
                                WHEN "v-relDate" THEN 
                                    cVarValue = STRING(tt-oe-rel.rel-date).
                                WHEN "v-relQty" THEN 
                                    cVarValue = /*IF AVAIL tt-oe-rel THEN string(tt-oe-rel.tot-qty,"->>>>>>,>>9") ELSE ""*/
                                        STRING(v-qty-allo,"->>>>>>,>>9") .
                                WHEN "v-rctDate" THEN 
                                ...
                                WHEN "ship-date" THEN 
                                    cVarValue = IF ship-date <> ? THEN STRING(ship-date,"99/99/99") ELSE "" .
                                WHEN "relqty" THEN 
                                    cVarValue = STRING(tt-oe-rel.tot-qty,"->>>>>>,>>9").
                                WHEN "loc" THEN 
                                    cVarValue = "" .
                                WHEN "relpo" THEN 
                                    cVarValue =  "".
                                    ...
                                    DO:            
                                        CASE cTmpField:               
                                            ...
                                            WHEN "ship-date" THEN 
                                                cVarValue = IF ship-date <> ? THEN STRING(ship-date,"99/99/99") ELSE "" .
                                            WHEN "relqty" THEN 
                                                cVarValue = STRING(v-summ-temp,"->>>>>>,>>9") .
                                            WHEN "loc" THEN 
                                                cVarValue = STRING(fg-bin.loc,"x(5)").
                                            WHEN "relpo" THEN 
                                                cVarValue = IF AVAILABLE tt-oe-rel THEN STRING(tt-oe-rel.po-no) ELSE "".
                                            ...
                                            WHEN "fac-costm" THEN 
                                                cVarValue = IF vtot-costm <> 0 THEN STRING(vtot-costm,"->>,>>>,>>9.99") ELSE "" .
                                            WHEN "tot-fac-cost" THEN 
                                                cVarValue = IF vtot-job-cost <> 0 THEN STRING(vtot-job-cost,"->>>>,>>>,>>9.99") ELSE ""  .
                                            WHEN "on-hand-cost" THEN 
                                                DO: 
    ...
    DO:
        ...
        DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
            ...
            CASE cTmpField:   
                ...
                WHEN "v-relDate" THEN 
                    cVarValue = "".
                WHEN "v-relQty" THEN 
                    cVarValue = STRING(v-tot-allo,"->>>>>>,>>9").
                WHEN "v-rctDate" THEN 
                    cVarValue = "".
                WHEN "v-qty-onh" THEN 
                    cVarValue = STRING(v-tot-onh,"->>>>>>,>>9").
                WHEN "li-ship-qty" THEN 
                    cVarValue = STRING(v-tot-ship,"->>>>>>,>>9").
                WHEN "v-qty-ord" THEN 
                    cVarValue = STRING(v-tot-ord,"->>>>>>,>>9").
                WHEN "v-price" THEN 
                    cVarValue = "".
                WHEN "ord-price" THEN 
                    cVarValue = "" .
                WHEN "v-ext" THEN 
                    cVarValue = STRING(v-tot-ext,"->>>,>>>,>>9.99").
                WHEN "v-rfq" THEN 
                    cVarValue = "".
                WHEN "qty-pro" THEN 
                    cVarValue = "".
        ...
        END.
        PUT UNFORMATTED 
            "        CUSTOMER TOTALS:" SUBSTRING(cDisplay,25,300) SKIP(1).
...
DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
    ...
    CASE cTmpField:   
        ...
        WHEN "v-relDate" THEN 
            cVarValue = "".
        WHEN "v-relQty" THEN 
            cVarValue = STRING(v-grand-tot-allo,"->>>>>>,>>9").
        WHEN "v-rctDate" THEN 
            cVarValue = "".
        WHEN "v-qty-onh" THEN 
            cVarValue = STRING(v-grand-tot-onh,"->>>>>>,>>9").
        WHEN "li-ship-qty" THEN 
            cVarValue = STRING(v-grand-tot-ship,"->>>>>>,>>9").
        WHEN "v-qty-ord" THEN 
            cVarValue = STRING(v-grand-tot-ord,"->>>>>>,>>9").
        WHEN "v-price" THEN 
            cVarValue = "".
        WHEN "ord-price" THEN 
            cVarValue = "" .
        WHEN "v-ext" THEN 
            cVarValue = STRING(v-grand-tot-ext,"->>>,>>>,>>9.99").
        WHEN "v-rfq" THEN 
            cVarValue = "".
        WHEN "qty-pro" THEN 
            cVarValue = "".
...
END.
PUT UNFORMATTED 
    "        GRAND TOTALS:" SUBSTRING(cDisplay,22,300) SKIP(1).
