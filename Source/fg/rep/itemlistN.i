...
IF AVAILABLE bf-job THEN
    ...
    IF v-fgitm EQ "" AND AVAILABLE oe-ordl THEN
...
IF v-zbal OR v-qtyoh NE 0 THEN 
DO:
    ...
    DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
        ...
        CASE cTmpField:               
            ...
            WHEN "procat" THEN 
                cVarValue = itemfg.procat .
            WHEN "sell-uom" THEN 
                cvarValue = itemfg.sell-uom.
            WHEN "cust-no" THEN 
                cVarValue = itemfg.cust-no .
            WHEN "cust-name" THEN 
            ...
            WHEN "part-dscr2" THEN 
                cVarValue = STRING(itemfg.part-dscr2,"x(28)") .
            WHEN "part-dscr3" THEN 
                cVarValue = STRING(itemfg.part-dscr3,"x(28)") .
            WHEN "style"   THEN 
                cvarValue = itemfg.style.
            WHEN "group"   THEN 
                cvarValue = STRING(itemfg.spare-char-1,"x(15)").
            WHEN "l-score" THEN 
                cVarValue = STRING(itemfg.l-score[50], ">>>,>>9.99<<<<") .
            WHEN "w-score" THEN 
                cvarValue = STRING(itemfg.w-score[50], ">>>,>>9.99<<<<") . 
            WHEN "d-score" THEN 
                cVarValue = STRING(itemfg.d-score[50], ">>>,>>9.99<<<<") .
            WHEN "casew"    THEN     
                cVarValue =   STRING(casew, ">>9.9999") .    
            WHEN "casel"    THEN     
                cvarValue =   STRING(casel, ">>9.9999") .    
            WHEN "cased"    THEN     
                cVarValue =   STRING(cased, ">>9.9999") .    
            WHEN "count"     THEN    
                cVarValue =   STRING(itemfg.case-count, ">>>>9") .     
            WHEN "ink-cod1" THEN     
                cvarValue =   cInkCode[1] . 
            WHEN "ink-cod2" THEN     
                cVarValue =   cInkCode[2] . 
            WHEN "ink-cod3" THEN     
                cVarValue =   cInkCode[3] . 
            WHEN "ink-cod4" THEN     
                cvarValue =   cInkCode[4] . 
            WHEN "ink-cod5" THEN     
                cVarValue =   cInkCode[5] . 
            WHEN "ink-cod6" THEN     
                cVarValue =   cInkCode[6] . 
            WHEN "ink-cod7" THEN     
                cvarValue =   cInkCode[7] . 
            WHEN "ink-cod8" THEN     
                cVarValue =   cInkCode[8] . 
            WHEN "ink-cod9"  THEN    
                cVarValue =   cInkCode[9] . 
            WHEN "ink-cod10" THEN    
                cvarValue =   cInkCode[10] .
            WHEN "ink-nam1"  THEN    
                cVarValue =   cInkDesc[1] . 
            WHEN "ink-nam2"  THEN    
                cVarValue =   cInkDesc[2] . 
            WHEN "ink-nam3"  THEN    
                cvarValue =   cInkDesc[3] . 
            WHEN "ink-nam4"  THEN    
                cVarValue =   cInkDesc[4] . 
            WHEN "ink-nam5"  THEN    
                cVarValue =   cInkDesc[5] . 
            WHEN "ink-nam6"  THEN    
                cvarValue =   cInkDesc[6] . 
            WHEN "ink-nam7"  THEN    
                cVarValue =   cInkDesc[7] . 
            WHEN "ink-nam8"  THEN    
                cVarValue =   cInkDesc[8] . 
            WHEN "ink-nam9"  THEN    
                cvarValue =   cInkDesc[9] . 
            WHEN "ink-nam10" THEN    
                cVarValue =   cInkDesc[10] .
            WHEN "board-code" THEN   
                cVarValue  =  board-code .
            WHEN "board-name" THEN   
                cVarValue =   board-name .
            WHEN "caliper"  THEN     
                cVarValue =   STRING(caliper, "9.99999") .   
            WHEN "job" THEN  
                cVarValue =   cJobNo . 
            WHEN "po"  THEN  
                cVarValue =   cPO  .
            WHEN "v-qtyoh" THEN 
                cVarValue = STRING(v-qtyoh, "->>>,>>9.9<<<<<") .
