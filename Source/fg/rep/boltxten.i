 ...
 /* oe/rep/bolmet1.i */      
   put 
      ...
      "<P14><R8><C46><B>Bill of lading #:" ttTransBin.bol-no "</B><P10> "
      SKIP
      "<R12><C1>"
      ...
      "<=4><R+3> " TODAY space(4) v-ord-no space(9) v-fob space(1) cCarrierDscr space(1) v-frt-terms SPACE(1) /*v-gross-wt*/ SKIP
