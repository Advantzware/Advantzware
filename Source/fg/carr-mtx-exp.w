...
DEFINE INPUT PARAMETER lcCarrZonFrom AS CHARACTER NO-UNDO.
DEFINE INPUT PARAMETER lcCarrZonTo   AS CHARACTER NO-UNDO.
...
ASSIGN 
    cTextListToSelect  = "Carrier,Location,Zone,Description,Zip Code,Min Rate," +
...
{sys/inc/ttRptSel.i}
ASSIGN 
    cTextListToDefault = "Carrier,Location,Zone,Description,Zip Code,Min Rate," +
                           "Num Pallets-Up To 1,Num Pallets-Up To 2,Num Pallets-Up To 3,Num Pallets-Up To 4,Num Pallets-Up To 5," +
                           "Num Pallets-Up To 6,Num Pallets-Up To 7,Num Pallets-Up To 8,Num Pallets-Up To 9,Num Pallets-Up To 10," + 
                           "Rate/Pallet 1,Rate/Pallet 2,Rate/Pallet 3,Rate/Pallet 4,Rate/Pallet 5," +
                           "Rate/Pallet 6,Rate/Pallet 7,Rate/Pallet 8,Rate/Pallet 9,Rate/Pallet 10"  .
...
end_carr-no begin_del-zone end_del-zone sl_avail sl_selected Btn_Def ~
Btn_Add Btn_Remove btn_Up btn_down fi_file tb_OpenCSV tbAutoClose btn-ok ~
btn-cancel 
&Scoped-Define DISPLAYED-OBJECTS begin_carr-no end_carr-no begin_del-zone ~
end_del-zone sl_avail sl_selected fi_file tb_OpenCSV tbAutoClose 
...
FUNCTION getValue-itemfg RETURNS CHARACTER
    ( BUFFER ipb-itemfg FOR carr-mtx, ipc-field AS CHARACTER )  FORWARD.
...
DEFINE VARIABLE fi_file        AS CHARACTER FORMAT "X(45)" INITIAL "c:~\tmp~\CarrierMatrixExport.csv" 
    LABEL "Name" 
...
DEFINE FRAME rd-fgexp
    ...
    begin_del-zone AT ROW 5.24 COL 28 COLON-ALIGNED HELP
    "Enter Beginning Delivery Zone" WIDGET-ID 142
    end_del-zone AT ROW 5.24 COL 71 COLON-ALIGNED HELP
...
ASSIGN 
    begin_del-zone:PRIVATE-DATA IN FRAME rd-fgexp = "parm".

ASSIGN 
    end_carr-no:PRIVATE-DATA IN FRAME rd-fgexp = "parm".

ASSIGN 
    end_del-zone:PRIVATE-DATA IN FRAME rd-fgexp = "parm".
...
fi_file:SCREEN-VALUE = "c:\tmp\CarrierMatrixExport.csv".
END.
...
PROCEDURE enable_UI :
    ...
    ------------------------------------------------------------------------------*/
    DISPLAY begin_carr-no end_carr-no begin_del-zone end_del-zone sl_avail 
        sl_selected fi_file tb_OpenCSV tbAutoClose 
        WITH FRAME rd-fgexp.
    ENABLE RECT-6 RECT-7 RECT-8 begin_carr-no end_carr-no begin_del-zone 
        end_del-zone sl_avail sl_selected Btn_Def Btn_Add Btn_Remove btn_Up 
...
PROCEDURE run-report :
    ...
    DEFINE BUFFER b-carr-mtx FOR carr-mtx.
...
FUNCTION getValue-itemfg RETURNS CHARACTER
    ( BUFFER ipb-itemfg FOR carr-mtx, ipc-field AS CHARACTER ) :
    /*------------------------------------------------------------------------------
