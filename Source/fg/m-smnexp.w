...
DEFINE INPUT PARAMETER lcSmanFrom   AS CHARACTER NO-UNDO.
DEFINE INPUT PARAMETER lcSmanTo AS CHARACTER NO-UNDO.
...
ASSIGN 
    cTextListToSelect  = "Rep#,Name,CustType,CustType Desc,Category,Category Desc,Basis,Basis Name,Margin%,Comm% "
...
FUNCTION getValue-itemfg RETURNS CHARACTER
    ( BUFFER ipb-itemfg FOR smanmtrx, ipc-field AS CHARACTER )  FORWARD.
...
DEFINE FRAME rd-fgexp
    ...
    Btn_Remove AT ROW 10.76 COL 42 HELP
    "Remove Selected Table from Tables to Audit" WIDGET-ID 134
    btn_Up AT ROW 11.95 COL 42 WIDGET-ID 136
    btn_down AT ROW 13.14 COL 42 WIDGET-ID 132
...
PROCEDURE run-report :
    ...
    DEFINE BUFFER b-smanmtrx FOR smanmtrx.
...
FUNCTION getValue-itemfg RETURNS CHARACTER
    ( BUFFER ipb-itemfg FOR smanmtrx, ipc-field AS CHARACTER ) :
    /*------------------------------------------------------------------------------
