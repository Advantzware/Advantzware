...
&Scoped-Define ENABLED-OBJECTS btCancel btOk 
...
DEFINE VARIABLE h_b-fgitem-2 AS HANDLE NO-UNDO.
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Select Item for */
DO:  
...
DO:
    {methods/run_link.i "FGITEM-SOURCE" "GetSelectedFGItem" "(OUTPUT opcItemID)}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'fg/b-fgitem.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-fgitem-2 ).
       RUN set-position IN h_b-fgitem-2 ( 3.38 , 1.00 ) NO-ERROR.
       RUN set-size IN h_b-fgitem-2 ( 11.19 , 103.00 ) NO-ERROR.
