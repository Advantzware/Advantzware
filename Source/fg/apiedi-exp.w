...
ASSIGN cTextListToSelect = "Company,Scope Type,Scope ID,Client ID"

      cFieldListToSelect = "company,scopeType,scopeID,clientID" .
{sys/inc/ttRptSel.i}

    ASSIGN cTextListToDefault  = "Company,Scope Type,Scope ID,Client ID" .
...
end_scope-Id begin_scope-type end_scope-type Btn_Def sl_avail sl_selected ~
...
begin_scope-type end_scope-type sl_avail sl_selected tb_excel tb_runExcel ~
fi_file 
...
FUNCTION getValue-apiClientXref RETURNS CHARACTER
  ( BUFFER ipb-itemfg FOR apiClientXref, ipc-field AS CHAR )  FORWARD.
...
DEFINE VARIABLE fi_file AS CHARACTER FORMAT "X(30)" INITIAL "c:~\tmp~\r-apiedi.csv" 
...
DEFINE FRAME rd-fgexp
     begin_scope-Id AT ROW 3.95 COL 28 COLON-ALIGNED HELP
          "Enter Beginning Scope ID" WIDGET-ID 142
     end_scope-Id AT ROW 3.95 COL 71 COLON-ALIGNED HELP
          "Enter Ending Scope Id" WIDGET-ID 144
     begin_scope-type AT ROW 5.71 COL 28 COLON-ALIGNED HELP
          "Enter Beginning Scope Type" WIDGET-ID 150
     end_scope-type AT ROW 5.71 COL 71 COLON-ALIGNED HELP
     ...
     RECT-7 AT ROW 1 COL 4 WIDGET-ID 38
...
ASSIGN 
       begin_scope-Id:PRIVATE-DATA IN FRAME rd-fgexp     = 
                "parm".

ASSIGN 
       begin_scope-type:PRIVATE-DATA IN FRAME rd-fgexp     = 
                "parm".

ASSIGN 
       end_scope-Id:PRIVATE-DATA IN FRAME rd-fgexp     = 
                "parm".

ASSIGN 
       end_scope-type:PRIVATE-DATA IN FRAME rd-fgexp     = 
                "parm".
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-6 RECT-7 RECT-8 begin_scope-Id end_scope-Id begin_scope-type 
         end_scope-type Btn_Def sl_avail sl_selected Btn_Add Btn_Remove btn_Up 
...
DEF BUFFER b-apiClientXref FOR apiClientXref.
...
FUNCTION getValue-apiClientXref RETURNS CHARACTER
  ( BUFFER ipb-apiClientXref FOR apiClientXref, ipc-field AS CHAR ) :
/*------------------------------------------------------------------------------
