...
ASSIGN 
    ...
    cFieldListToSelect = "company,scopeType,scopeID,clientID" .
{sys/inc/ttRptSel.i}

ASSIGN 
    cTextListToDefault = "Company,Scope Type,Scope ID,Client ID" .
...
&Scoped-Define ENABLED-OBJECTS RECT-6 RECT-7 RECT-8 begin_scope-Id ~
end_scope-Id begin_scope-type end_scope-type sl_avail sl_selected Btn_Def ~
Btn_Add Btn_Remove btn_Up btn_down fi_file tb_OpenCSV tbAutoClose btn-ok ~
btn-cancel 
&Scoped-Define DISPLAYED-OBJECTS begin_scope-Id end_scope-Id ~
begin_scope-type end_scope-type sl_avail sl_selected fi_file tb_OpenCSV ~
tbAutoClose 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD getValue-apiClientXref rd-fgexp 
FUNCTION getValue-apiClientXref RETURNS CHARACTER
    ( BUFFER ipb-apiClientXref FOR apiClientXref, ipc-field AS CHARACTER )  FORWARD.
...
DEFINE VARIABLE begin_scope-Id   AS CHARACTER FORMAT "x(12)" 
    LABEL "From Scope ID" 
    VIEW-AS FILL-IN 
    SIZE 20 BY 1.

DEFINE VARIABLE begin_scope-type AS CHARACTER FORMAT "x(12)" 
    LABEL "From Scope Type" 
    VIEW-AS FILL-IN 
    SIZE 20 BY 1.

DEFINE VARIABLE end_scope-Id     AS CHARACTER FORMAT "X(112)" INITIAL "zzzzzzzzzzz" 
    LABEL "To Scope ID" 
    VIEW-AS FILL-IN 
    SIZE 21 BY 1.

DEFINE VARIABLE end_scope-type   AS CHARACTER FORMAT "X(112)" INITIAL "zzzzzzzzzzz" 
    LABEL "To Scope Type" 
    VIEW-AS FILL-IN 
    SIZE 21 BY 1.
...
DEFINE FRAME rd-fgexp
    begin_scope-Id AT ROW 3.05 COL 26.6 COLON-ALIGNED HELP
    "Enter Beginning Scope ID" WIDGET-ID 142
    end_scope-Id AT ROW 3.05 COL 68.2 COLON-ALIGNED HELP
    "Enter Ending Scope Id" WIDGET-ID 144
    begin_scope-type AT ROW 4.81 COL 26.6 COLON-ALIGNED HELP
    "Enter Beginning Scope Type" WIDGET-ID 150
    end_scope-type AT ROW 4.81 COL 68.2 COLON-ALIGNED HELP
    "Enter Ending Scope Type" WIDGET-ID 152
    sl_avail AT ROW 9.43 COL 7 NO-LABELS WIDGET-ID 26
    sl_selected AT ROW 9.43 COL 62.6 NO-LABELS WIDGET-ID 28
    Btn_Def AT ROW 9.52 COL 42.2 HELP
    ...
    btn-ok AT ROW 20.05 COL 34 WIDGET-ID 14
    btn-cancel AT ROW 20.05 COL 54 WIDGET-ID 12
    ...
    BGCOLOR 15 
    TITLE "Export API/EDI to Excel" WIDGET-ID 100.
...
ASSIGN 
    begin_scope-Id:PRIVATE-DATA IN FRAME rd-fgexp = "parm".

ASSIGN 
    begin_scope-type:PRIVATE-DATA IN FRAME rd-fgexp = "parm".

ASSIGN 
    end_scope-Id:PRIVATE-DATA IN FRAME rd-fgexp = "parm".

ASSIGN 
    end_scope-type:PRIVATE-DATA IN FRAME rd-fgexp = "parm".
...
ON HELP OF FRAME rd-fgexp /* Export API/EDI to Excel */
    DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL rd-fgexp rd-fgexp
ON WINDOW-CLOSE OF FRAME rd-fgexp /* Export API/EDI to Excel */
    DO:
...
&Scoped-define SELF-NAME begin_scope-Id
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL begin_scope-Id rd-fgexp
ON LEAVE OF begin_scope-Id IN FRAME rd-fgexp /* From Scope ID */
    DO:
        ASSIGN {&self-name}.
    END.
...
&Scoped-define SELF-NAME begin_scope-type
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL begin_scope-type rd-fgexp
ON LEAVE OF begin_scope-type IN FRAME rd-fgexp /* From Scope Type */
    DO:
        ASSIGN {&self-name}.
    END.
...
&Scoped-define SELF-NAME end_scope-Id
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL end_scope-Id rd-fgexp
ON LEAVE OF end_scope-Id IN FRAME rd-fgexp /* To Scope ID */
    DO:
        ASSIGN {&self-name}.
    END.
...
&Scoped-define SELF-NAME end_scope-type
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL end_scope-type rd-fgexp
ON LEAVE OF end_scope-type IN FRAME rd-fgexp /* To Scope Type */
    DO:
        ASSIGN {&self-name}.
    END.
...
PROCEDURE enable_UI :
    ...
    ------------------------------------------------------------------------------*/
    DISPLAY begin_scope-Id end_scope-Id begin_scope-type end_scope-type sl_avail 
        sl_selected fi_file tb_OpenCSV tbAutoClose 
        WITH FRAME rd-fgexp.
    ENABLE RECT-6 RECT-7 RECT-8 begin_scope-Id end_scope-Id begin_scope-type 
        end_scope-type sl_avail sl_selected Btn_Def Btn_Add Btn_Remove btn_Up 
...
PROCEDURE run-report :
    ...
    DEFINE BUFFER b-apiClientXref FOR apiClientXref.
    ...
    FOR EACH b-apiClientXref NO-LOCK
        WHERE b-apiClientXref.scopeID GE begin_scope-Id
        AND b-apiClientXref.scopeID LE end_scope-Id
        AND b-apiClientXref.scopeType GE begin_scope-type
        AND b-apiClientXref.scopeType LE end_scope-type   :
        ...
        FOR EACH ttRptSelected:
            ...
            v-excel-detail-lines = v-excel-detail-lines + 
                appendXLLine(getValue-apiClientXref(BUFFER b-apiClientXref,ttRptSelected.FieldList)).
...
PROCEDURE Set-Sort-Data :
    ...
    DO WITH FRAME {&FRAME-NAME}:     
        ...
        IF lcSearch NE "" THEN 
            ASSIGN
                begin_scope-Id:SCREEN-VALUE = lcSearch    
                end_scope-Id:SCREEN-VALUE   = lcSearch.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION getValue-apiClientXref rd-fgexp 
FUNCTION getValue-apiClientXref RETURNS CHARACTER
    ( BUFFER ipb-apiClientXref FOR apiClientXref, ipc-field AS CHARACTER ) :
/*------------------------------------------------------------------------------
...
------------------------------------------------------------------------------*/
    ...
    CASE ipc-field :
        ...
        DO:
            ...
            END.
            h-field = BUFFER ipb-apiClientXref:BUFFER-FIELD(ipc-field).
