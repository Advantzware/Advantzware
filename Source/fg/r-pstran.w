...
td-post-trans tbAutoClose Btn_OK Btn_Cancel 
&Scoped-Define DISPLAYED-OBJECTS trans_panding begins_ship-no rd-dest ~
td-post-trans tbAutoClose 
...
DEFINE FRAME FRAME-A
    trans_panding AT ROW 2.62 COL 17.6 COLON-ALIGNED HELP
    "Enter the From FG Item Number" NO-LABELS WIDGET-ID 38
    begins_ship-no AT ROW 4.52 COL 38.2 COLON-ALIGNED HELP
    "Enter the From FG Item Number"
    rd-dest AT ROW 7.29 COL 4.6 NO-LABELS
    td-post-trans AT ROW 10.95 COL 54.6
    tbAutoClose AT ROW 12.33 COL 23 WIDGET-ID 64
    Btn_OK AT ROW 13.33 COL 23
    Btn_Cancel AT ROW 13.38 COL 44.8
    "Transfer Bill of Lading Creation" VIEW-AS TEXT
    SIZE 41.2 BY .95 AT ROW 1.38 COL 23
    FONT 6
    " Output Options" VIEW-AS TEXT
    SIZE 18 BY .62 AT ROW 6.48 COL 4
    "Transfers Currently Pending" VIEW-AS TEXT
    SIZE 32.8 BY .62 AT ROW 2.86 COL 27.6 WIDGET-ID 36
    RECT-6 AT ROW 6.76 COL 3
...
ASSIGN 
    trans_panding:PRIVATE-DATA IN FRAME FRAME-A = "parm".
...
PROCEDURE enable_UI :
    ...
    ------------------------------------------------------------------------------*/
    DISPLAY trans_panding begins_ship-no rd-dest td-post-trans tbAutoClose 
        WITH FRAME FRAME-A IN WINDOW C-Win.
    ENABLE RECT-6 trans_panding begins_ship-no rd-dest td-post-trans tbAutoClose 
        Btn_OK Btn_Cancel 
        WITH FRAME FRAME-A IN WINDOW C-Win.
