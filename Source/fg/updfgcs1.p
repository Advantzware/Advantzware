...
DEFINE INPUT PARAMETER iplBinRecalcCost AS LOG NO-UNDO.  /* Run recalc on bins for the item */
DEFINE INPUT PARAMETER iplItemRecalcCost AS LOG NO-UNDO. /* update from last history records for the item */
