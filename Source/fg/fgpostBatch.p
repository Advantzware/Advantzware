...
PROCEDURE fg-post:
    ...
    DEFINE VARIABLE v-fin-qty      AS DECIMAL   NO-UNDO. /* not needed? */
    DEFINE VARIABLE choice         AS LOG       NO-UNDO. /* Not needed? */
    ...
    DEFINE VARIABLE ll-qty-changed AS LOG       NO-UNDO. /* not needed */
    DEFINE VARIABLE ll-whs-item    AS LOG       NO-UNDO. /* needed? */
