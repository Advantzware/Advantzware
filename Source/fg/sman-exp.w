...
ASSIGN 
    cTextListToSelect  = "Sales Rep,Name,Basis,Commission,Net%,Sales Territory,Terr Name "
...
&Scoped-Define DISPLAYED-OBJECTS begin_slsmn end_slsmn sl_avail sl_selected ~
...
FUNCTION getValue-itemfg RETURNS CHARACTER
    ( BUFFER ipb-itemfg FOR sman, ipc-field AS CHARACTER )  FORWARD.
...
DEFINE VARIABLE fi_file     AS CHARACTER FORMAT "X(45)" INITIAL "c:~\tmp~\SalesRepExport.csv" 
    LABEL "Name" 
...
DEFINE FRAME rd-fgexp
    begin_slsmn AT ROW 4.19 COL 25.4 COLON-ALIGNED HELP
    "Enter Beginning Sales Rep Number" WIDGET-ID 142
    end_slsmn AT ROW 4.19 COL 66.6 COLON-ALIGNED HELP
    ...
    Btn_Add AT ROW 9.52 COL 42.2 HELP
    "Add Selected Table to Tables to Audit" WIDGET-ID 130
    Btn_Remove AT ROW 10.71 COL 42.2 HELP
    "Remove Selected Table from Tables to Audit" WIDGET-ID 134
    btn_Up AT ROW 11.91 COL 42.2 WIDGET-ID 136
    btn_down AT ROW 13.1 COL 42.2 WIDGET-ID 132
    fi_file AT ROW 17.1 COL 18.8 COLON-ALIGNED HELP
    "Enter File Name" WIDGET-ID 22
    tb_OpenCSV AT ROW 17.1 COL 87.8 RIGHT-ALIGNED WIDGET-ID 34
    tbAutoClose AT ROW 19 COL 43 WIDGET-ID 60
    tb_excel AT ROW 19.1 COL 4 WIDGET-ID 32
    btn-ok AT ROW 20.05 COL 33.4 WIDGET-ID 14
    btn-cancel AT ROW 20.05 COL 53.4 WIDGET-ID 12
...
ASSIGN 
    begin_slsmn:PRIVATE-DATA IN FRAME rd-fgexp = "parm".

ASSIGN 
    end_slsmn:PRIVATE-DATA IN FRAME rd-fgexp = "parm".
...
ON HELP OF FRAME rd-fgexp /* Export Sales Rep to Excel */
    DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL rd-fgexp rd-fgexp
ON WINDOW-CLOSE OF FRAME rd-fgexp /* Export Sales Rep to Excel */
    DO:
...
ON LEAVE OF begin_slsmn IN FRAME rd-fgexp /* From Sales Rep */
    DO:
        ASSIGN {&self-name}.
    END.
...
ON LEAVE OF end_slsmn IN FRAME rd-fgexp /* To Sales Rep */
    DO:
        ASSIGN {&self-name}.
    END.
...
fi_file:SCREEN-VALUE = "c:\tmp\SalesRepExport.csv".        
END.
...
PROCEDURE enable_UI :
    ...
    ------------------------------------------------------------------------------*/
    DISPLAY begin_slsmn end_slsmn sl_avail sl_selected fi_file tb_OpenCSV 
        tbAutoClose 
        WITH FRAME rd-fgexp.
    ENABLE RECT-6 RECT-7 RECT-8 begin_slsmn end_slsmn sl_avail sl_selected 
...
PROCEDURE Set-Sort-Data :
    ...
    DO WITH FRAME {&FRAME-NAME}:
        ...
        IF begin_slsmn:SCREEN-VALUE EQ "" THEN 
        DO:
...
FUNCTION getValue-itemfg RETURNS CHARACTER
    ( BUFFER ipb-itemfg FOR sman, ipc-field AS CHARACTER ) :
    /*------------------------------------------------------------------------------
