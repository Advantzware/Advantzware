...
DEFINE VARIABLE h_b-issue AS HANDLE NO-UNDO.
DEFINE VARIABLE h_exit AS HANDLE NO-UNDO.
DEFINE VARIABLE h_folder AS HANDLE NO-UNDO.
DEFINE VARIABLE h_options AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updsav-2 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_smartmsg AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-fgpost AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'fg/b-issue.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-issue ).
       RUN set-position IN h_b-issue ( 5.05 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 17.14 , 146.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'fg/v-fgpost.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-fgpost ).
       RUN set-position IN h_v-fgpost ( 22.43 , 99.00 ) NO-ERROR.
       ...
       /* Links to SmartNavBrowser h_b-issue. */
       RUN add-link IN adm-broker-hdl ( h_p-updsav-2 , 'TableIO':U , h_b-issue ).

       /* Links to SmartViewer h_v-fgpost. */
       RUN add-link IN adm-broker-hdl ( h_b-issue , 'Record':U , h_v-fgpost ).
