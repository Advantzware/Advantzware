...
DEFINE INPUT PARAMETER ip-run-what AS CHARACTER NO-UNDO. /* "SETUP" from initial setup (addon/sshoot/sssetups.w),
                                                  else "" */
...
DEFINE            VARIABLE v-autobin      AS CHARACTER NO-UNDO.  
...
tgIssue rd-dest fi_file tb_OpenCSV tbAutoClose Btn_Cancel Btn_OK 
...
tb_totCstVal tgIssue rd-dest fi_file tb_OpenCSV tbAutoClose 
...
DEFINE VARIABLE fi_file        AS CHARACTER FORMAT "X(45)" INITIAL "c:~\tmp~\FGPosting.csv" 
    LABEL "Name" 
...
DEFINE FRAME FRAME-A
    v-post-date AT ROW 2.91 COL 27.2 COLON-ALIGNED
    begin_fg-r-no AT ROW 3.86 COL 27.2 COLON-ALIGNED HELP
    "Enter the From Sequence Number"
    end_fg-r-no AT ROW 3.86 COL 70.2 COLON-ALIGNED HELP
    "Enter the To Sequence Number"
    begin_userid AT ROW 4.81 COL 27.2 COLON-ALIGNED HELP
    "Enter the From Created ID"
    end_userid AT ROW 4.81 COL 70.2 COLON-ALIGNED HELP
    "Enter the To Created ID"
    begin_created AT ROW 5.76 COL 27.2 COLON-ALIGNED HELP
    "Enter the From Created ID" WIDGET-ID 36
    end_created AT ROW 5.76 COL 70.2 COLON-ALIGNED HELP
    "Enter the To Created ID" WIDGET-ID 38
    ldt-from AT ROW 6.71 COL 27.2 COLON-ALIGNED HELP
    "Enter the From Date"
    ldt-to AT ROW 6.71 COL 70.2 COLON-ALIGNED HELP
    "Enter the To Date"
    begin_job-no AT ROW 7.67 COL 27.2 COLON-ALIGNED HELP
    "Enter the From Job Number"
    end_job-no AT ROW 7.67 COL 70.2 COLON-ALIGNED HELP
    "Enter the To Job Number"
    begin_i-no AT ROW 8.62 COL 27.2 COLON-ALIGNED HELP
    "Enter the From FG Item Number"
    end_i-no AT ROW 8.62 COL 70.2 COLON-ALIGNED HELP
    "Enter the To FG Item Number"
    end_whs AT ROW 9.57 COL 70.2 COLON-ALIGNED HELP
    "Enter the To Location" WIDGET-ID 4
    begin_whs AT ROW 9.62 COL 27.2 COLON-ALIGNED HELP
    "Enter the from Location" WIDGET-ID 2
    tg-recalc-cost AT ROW 10.71 COL 29.2 WIDGET-ID 32
    v-trans-lbl AT ROW 12.86 COL 4.2 NO-LABELS
    tgl-itemCD AT ROW 12.86 COL 38 WIDGET-ID 16
    rd_print AT ROW 12.86 COL 57.2 NO-LABELS
    rd-Itm#Cst# AT ROW 13.71 COL 57.2 NO-LABELS WIDGET-ID 18
    t-receipt AT ROW 13.81 COL 4.2
    rd-ItmPo AT ROW 14.52 COL 57.2 NO-LABELS WIDGET-ID 26
    t-ship AT ROW 14.67 COL 4.2
    rd-UOMJob AT ROW 15.48 COL 57.2 NO-LABELS WIDGET-ID 22
    t-trans AT ROW 15.52 COL 4.2
    t-adj AT ROW 16.43 COL 4.2
    tb_glnum AT ROW 16.52 COL 57.2
    t-ret AT ROW 17.33 COL 4.2
    tb_grndtotal AT ROW 17.38 COL 79
    tb_totCstVal AT ROW 17.48 COL 57.2 WIDGET-ID 30
    tgIssue AT ROW 18.19 COL 4.2 WIDGET-ID 34
    lv-font-no AT ROW 20.29 COL 37 COLON-ALIGNED
    lv-ornt AT ROW 20.29 COL 47 NO-LABELS
    lines-per-page AT ROW 20.29 COL 90 COLON-ALIGNED
    rd-dest AT ROW 20.38 COL 4.8 NO-LABELS
    lv-font-name AT ROW 21.38 COL 32 COLON-ALIGNED NO-LABELS
    tb_excel AT ROW 22.43 COL 75
    td-show-parm AT ROW 23.05 COL 31
    fi_file AT ROW 24 COL 29 COLON-ALIGNED HELP
    "Enter File Name"
    tb_OpenCSV AT ROW 24.05 COL 95.2 RIGHT-ALIGNED
    tbAutoClose AT ROW 25.38 COL 31 WIDGET-ID 64
    Btn_Cancel AT ROW 26.29 COL 55.6
    Btn_OK AT ROW 26.38 COL 31
    " Selection Parameters" VIEW-AS TEXT
    SIZE 21 BY .71 AT ROW 1.05 COL 4
    "Trans Typ :" VIEW-AS TEXT
    SIZE 12 BY .95 AT ROW 11.91 COL 4.2 WIDGET-ID 6
    " Output Destination" VIEW-AS TEXT
    SIZE 19 BY .62 AT ROW 19.57 COL 4
    ...
    SIZE 65 BY .95 AT ROW 1.71 COL 17.4
    FONT 6
...
DEFINE FRAME FRAME-A
    RECT-6 AT ROW 20 COL 3
    RECT-7 AT ROW 1.48 COL 3
    RECT-30 AT ROW 11.81 COL 3.8 WIDGET-ID 8
    RECT-31 AT ROW 11.81 COL 34.8 WIDGET-ID 10
...
/* SETTINGS FOR FRAME FRAME-A
   FRAME-NAME                                                           */
ASSIGN 
    begin_created:PRIVATE-DATA IN FRAME FRAME-A = "parm".

ASSIGN 
    begin_fg-r-no:PRIVATE-DATA IN FRAME FRAME-A = "parm".
...
ASSIGN 
    end_created:PRIVATE-DATA IN FRAME FRAME-A = "parm".

ASSIGN 
    end_fg-r-no:PRIVATE-DATA IN FRAME FRAME-A = "parm".
...
ASSIGN 
    ldt-from:PRIVATE-DATA IN FRAME FRAME-A = "parm".

ASSIGN 
    ldt-to:PRIVATE-DATA IN FRAME FRAME-A = "parm".
...
ASSIGN 
    t-adj:PRIVATE-DATA IN FRAME FRAME-A = "parm".

ASSIGN 
    t-receipt:PRIVATE-DATA IN FRAME FRAME-A = "parm".

ASSIGN 
    t-ret:PRIVATE-DATA IN FRAME FRAME-A = "parm".

ASSIGN 
    t-ship:PRIVATE-DATA IN FRAME FRAME-A = "parm".

ASSIGN 
    t-trans:PRIVATE-DATA IN FRAME FRAME-A = "parm".
...
ASSIGN 
    tb_glnum:PRIVATE-DATA IN FRAME FRAME-A = "parm".

ASSIGN 
    tb_grndtotal:PRIVATE-DATA IN FRAME FRAME-A = "parm".
...
ASSIGN 
    tb_totCstVal:PRIVATE-DATA IN FRAME FRAME-A = "parm".
...
ASSIGN 
    tg-recalc-cost:PRIVATE-DATA IN FRAME FRAME-A = "parm".

ASSIGN 
    tgIssue:PRIVATE-DATA IN FRAME FRAME-A = "parm".

/* SETTINGS FOR TOGGLE-BOX tgl-itemCD IN FRAME FRAME-A
   NO-ENABLE                                                            */
ASSIGN 
    v-post-date:PRIVATE-DATA IN FRAME FRAME-A = "parm".
...
ON HELP OF begin_created IN FRAME FRAME-A /* From Created ID */
    DO:
...
ON HELP OF end_created IN FRAME FRAME-A /* To Created ID */
    DO:
        DEFINE VARIABLE char-val AS CHARACTER NO-UNDO.
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    DO WITH FRAME {&FRAME-NAME}:
        ...
        RUN enable_UI.
        {sys/inc/reportsConfigNK1.i "IU5" }
        ASSIGN
...
PROCEDURE enable_UI :
    ...
    DISPLAY v-post-date begin_fg-r-no end_fg-r-no begin_userid end_userid 
        ...
        t-trans t-adj tb_glnum t-ret tb_grndtotal tb_totCstVal tgIssue rd-dest 
...
PROCEDURE fg-post :
    ...
    DEFINE VARIABLE v-fgemail-file AS CHARACTER NO-UNDO.
    ...
    IF NOT fnValidateFgAssembly() THEN 
    DO:
    ...
    IF NOT fnValidateTransfers() THEN 
    DO:     
        RETURN.
    END.
...
PROCEDURE run-report PRIVATE :
    ...
    DEFINE VARIABLE v-postlst       AS CHARACTER NO-UNDO.
...
PROCEDURE send-fgemail :
    ...
    FOR EACH tt-email,
        ...
        PUT STREAM st-email UNFORMATTED
            ...
            " " (IF AVAILABLE bf-oe-ordl THEN bf-oe-ordl.part-no ELSE IF AVAILABLE bf-itemfg THEN bf-itemfg.part-no ELSE "") FORM "x(32)"
...
PROCEDURE Send-FGemail-Purchased :
    ...
    FOR EACH tt-fgemail BREAK BY tt-fgemail.Recipient:
        ...
        IF LAST-OF(tt-fgemail.recipient) THEN 
        DO:

            ASSIGN 
                cRecipientList = "To:" + tt-fgemail.Recipient
    ...
    DO WITH FRAME {&FRAME-NAME}:
        ...
        ELSE
            ASSIGN
                ...
                .
        ASSIGN 
            fi_file:SCREEN-VALUE = "c:\tmp\FGPosting.csv".   
    END.
