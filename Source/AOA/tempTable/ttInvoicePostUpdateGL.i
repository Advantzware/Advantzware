...
DEFINE TEMP-TABLE ttInvoicePostUpdateGL
    ...
    FIELD miscTot           AS DECIMAL   LABEL "Misc Total"    FORMAT "->>>,>>9.99"
    FIELD lineTot           AS DECIMAL   LABEL "Line Total"    FORMAT "->>,>>>,>>9.99"
    FIELD iInvRev           AS INTEGER   LABEL "Invoice Rev"   FORMAT "->>,>>>,>>9.99"
    FIELD weightPerTon      AS DECIMAL   LABEL "Weight"        FORMAT "->>>>9.99"
