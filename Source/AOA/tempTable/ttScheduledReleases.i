...
DEFINE TEMP-TABLE ttScheduledReleases NO-UNDO
    ...
    FIELD cRemainRoute    AS CHARACTER LABEL "Remaining routing"       FORMAT "x(30)"
    FIELD dDockApp        AS CHARACTER LABEL "Dock Appointment"        FORMAT "x(20)"
    FIELD iPalletCountQty AS INTEGER   LABEL "Pallet Count Quantity"   FORMAT "->>,>>>,>>9"
    FIELD iPallet         AS INTEGER   LABEL "Total # of Pallets (FG)" FORMAT "->>,>>>,>>9"
    FIELD dEstFGWeight    AS DECIMAL   LABEL "Estimated FG Weight"     FORMAT "->>,>>>,>>9.99<<<<"
    FIELD dActFGWeight    AS DECIMAL   LABEL "Actual FG Weight"        FORMAT "->>,>>>,>>9.99<<<<"    
    FIELD iQtyInvoiced    AS INTEGER   LABEL "Order Qty Invoiced"      FORMAT "->>,>>>,>>9"
