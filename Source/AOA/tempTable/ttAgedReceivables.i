...
DEFINE TEMP-TABLE ttAgedReceivables NO-UNDO
    ...
    FIELD periodDay5      AS DECIMAL   LABEL "Period Days 5"      FORMAT "->,>>>,>>>,>>9.99"
    FIELD periodDay6      AS DECIMAL   LABEL "Period Days 6"      FORMAT "->,>>>,>>>,>>9.99"
    FIELD periodDay7      AS DECIMAL   LABEL "Period Days 7"      FORMAT "->,>>>,>>>,>>9.99"
    ...
    FIELD daysFromDueDate AS INTEGER   LABEL "Days From Due Date" FORMAT "->,>>9"
