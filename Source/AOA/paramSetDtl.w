...
DEFINE FRAME viewFrame
     ...
     dynParamSetDtl.action AT ROW 4.81 COL 45 NO-LABEL WIDGET-ID 186
          ...
          LIST-ITEMS "NO:DISABLE","NO:ENABLE","NO:LOW","NO:HI","YES:DISABLE","YES:ENABLE","YES:LOW","YES:HI","CALENDAR","DATEPICKLIST","EMAIL","HORIZONTAL","VERTICAL","START DESCRIPTION","END DESCRIPTION","MULTISELECT","LIST-ITEM-PAIRS","SORT","SESSION PARAMETER" 
          SIZE 27 BY 11.43
