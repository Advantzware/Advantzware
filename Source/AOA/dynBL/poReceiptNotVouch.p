    ...
    FOR EACH po-ordl NO-LOCK
        ...
        DO:
            ...
            FOR EACH rm-rcpth FIELDS(trans-date r-no pur-uom)
                ...
                RUN sys/inc/po-recqa2.p (RECID(po-ordl), dtStartReceiptDate, dtEndReceiptDate, OUTPUT iQtyRec, OUTPUT dtAmtRec).
                LEAVE.
            END.
        END.
        ...
        DO:
            ...
            FOR EACH fg-rcpth FIELDS(trans-date pur-uom)
