...
&Scoped-define transInit btnUpdate btnAdd btnCopy btnDelete btnPageFormat-2 btnCloseView
...
dynSubject.mnemonic dynSubject.subjectGroup dynSubject.autoClose ~
dynSubject.outputFormat dynSubject.externalForm dynSubject.businessLogic ~
dynSubject.subjectAltID dynSubject.useCustList dynSubject.custListID ~
dynSubject.runSync dynSubject.saveLastRun dynSubject.lastRunDateTime ~
dynSubject.recordLimit dynSubject.udfGroup dynSubject.formType ~
dynSubject.onePer 
...
&Scoped-Define ENABLED-OBJECTS btnSetInitialize btnLookup btnCreateDefaults ~
btnDesign btnResults btnUndo btnSubjectParamSet subjectTab paramSetsTab ~
tableTab whereTab columnsTab btnOuterJoin subjectSearch subjectMatches ~
tableSearch tableMatches tableList btnOF tableListOf btnWhere btnToday ~
btnTime btnNow btnDateTime btnMatches subjectBrowse btnViewSubject ~
tableBrowse subjectWhereBrowse btnBegins btnAND btnOR btnEQ btnNE btnLT ~
btnGT fieldSearch fieldMatches btnCalcField paramSetSearch paramSetMatches ~
btnLE btnGE paramSetBrowse fieldBrowse btnPlus btnMinus ~
subjectParamSetBrowse btnMultiply btnErrorCheck btnDivide btnYes btnNo ~
btnDate cUseIndex findType btnDec subjectTableBrowse btnInt btnMoveUp ~
columnSearch columnMatches btnStr btnSave subjectColumnBrowse btnSubstr ~
cParameter btnOpen btnClose btnSyntax cConstant btnPeriod btnDouble ~
btnComma btnAddSelections btnSingle btnGroupCalc btnAddUseIndex queryStr ~
...
&Scoped-define allSection btnSetInitialize RECT-TABLE RECT-FIELD ~
RECT-QUERYTABLE RECT-QUERYSTR RECT-COLUMN btnUndo RECT-PARAM ~
btnSubjectParamSet btnOuterJoin tableSearch tableMatches tableList btnOF ~
tableListOf btnWhere btnToday btnTime btnNow btnDateTime btnMatches ~
btnViewSubject tableBrowse subjectWhereBrowse btnBegins btnAND btnOR btnEQ ~
btnNE btnLT btnGT fieldSearch fieldMatches btnCalcField paramSetSearch ~
...
findType btnDec subjectTableBrowse btnInt btnMoveUp columnSearch ~
columnMatches btnStr btnSave subjectColumnBrowse btnSubstr cParameter ~
btnOpen btnClose btnSyntax cConstant btnPeriod btnDouble btnComma ~
btnAddSelections btnSingle btnGroupCalc btnAddUseIndex queryStr ~
btnRemoveUseIndex btnAddParameter btnRemoveSelection btnMoveDown ~
...
btnOuterJoin tableList btnOF tableListOf btnWhere btnToday btnTime btnNow ~
btnDateTime btnMatches subjectWhereBrowse btnBegins btnAND btnOR btnEQ ~
btnNE btnLT btnGT fieldSearch fieldMatches btnCalcField paramSetMatches ~
btnLE btnGE fieldBrowse btnPlus btnMinus btnMultiply btnDivide btnYes btnNo ~
btnDate btnDec btnInt btnMoveUp btnStr btnSubstr cParameter btnOpen ~
btnClose btnSyntax cConstant btnPeriod btnDouble btnComma btnAddSelections ~
btnSingle queryStr btnAddParameter btnRemoveSelection btnMoveDown ~
...
fieldMatches btnCalcField paramSetMatches fieldBrowse btnMoveUp ~
columnSearch columnMatches subjectColumnBrowse btnAddSelections ~
btnGroupCalc btnRemoveSelection btnMoveDown btnRemove 
&Scoped-define subjectSection btnCreateDefaults btnDesign btnResults ~
subjectSearch subjectMatches btnViewSubject 
...
DEFINE BUTTON btnCreateDefaults  NO-FOCUS
     LABEL "Create Default/Test" 
     SIZE 22 BY 1.43 TOOLTIP "Create Defaults".
...
DEFINE BUTTON btnLookup 
     ...
     LABEL "Lookup" 
     SIZE 8 BY 1.91 TOOLTIP "Test Run Lookup".
...
dynSubject.runSync VIEW-AS TOGGLE-BOX
dynSubject.autoClose VIEW-AS TOGGLE-BOX
dynSubject.formType
dynSubject.onePer VIEW-AS TOGGLE-BOX
...
ttSubjectColumn.isFilterInitField VIEW-AS TOGGLE-BOX
ttSubjectColumn.filterInitValue
...
ttSubjectColumn.isFormField VIEW-AS TOGGLE-BOX
ttSubjectColumn.calcProc
...
ttSubjectColumn.isFilterInitField
ttSubjectColumn.filterInitValue
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS MULTIPLE SIZE 110 BY 4.19
...
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS MULTIPLE SIZE 78 BY 4.19
         TITLE "Subject Tables" ROW-HEIGHT-CHARS .62 FIT-LAST-COLUMN.
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS MULTIPLE SIZE 107 BY 4.19
         TITLE "Subject Where".
...
DEFINE FRAME DEFAULT-FRAME
     ...
     btnToday AT ROW 4.1 COL 149 WIDGET-ID 190
     btnTime AT ROW 4.1 COL 159 WIDGET-ID 192
     btnNow AT ROW 4.1 COL 167 WIDGET-ID 194
     btnDateTime AT ROW 4.1 COL 175 WIDGET-ID 196
     btnMatches AT ROW 4.1 COL 189 WIDGET-ID 88
     ...
     btnBegins AT ROW 5.29 COL 190 WIDGET-ID 84
     btnAND AT ROW 6.48 COL 190 WIDGET-ID 80
     ...
     btnLE AT ROW 10.05 COL 190 WIDGET-ID 76
     btnGE AT ROW 10.05 COL 195 WIDGET-ID 78
     paramSetBrowse AT ROW 11 COL 2 WIDGET-ID 1000
     fieldBrowse AT ROW 11 COL 40 WIDGET-ID 700
     btnPlus AT ROW 11.24 COL 190 WIDGET-ID 158
     btnMinus AT ROW 11.24 COL 195 WIDGET-ID 156
     subjectParamSetBrowse AT ROW 12.43 COL 82 WIDGET-ID 1100
     btnMultiply AT ROW 12.43 COL 190 WIDGET-ID 160
     btnErrorCheck AT ROW 3.86 COL 77 WIDGET-ID 294
     btnDivide AT ROW 12.43 COL 195 WIDGET-ID 154
     btnYes AT ROW 13.62 COL 190 WIDGET-ID 172
     btnNo AT ROW 13.62 COL 195 WIDGET-ID 174
     btnDate AT ROW 14.81 COL 190 WIDGET-ID 166
...
DEFINE FRAME DEFAULT-FRAME
     ...
     paramSetsSectionLabel AT ROW 1.48 COL 15.6 COLON-ALIGNED NO-LABEL WIDGET-ID 314
     tableSectionLabel AT ROW 1.48 COL 41 COLON-ALIGNED NO-LABEL WIDGET-ID 316
     whereSectionLabel AT ROW 1.48 COL 51.6 COLON-ALIGNED NO-LABEL WIDGET-ID 318
...
/* DEFINE FRAME statement is approaching 4K Bytes.  Breaking it up   */
DEFINE FRAME DEFAULT-FRAME
     paramSetsTab AT ROW 1.24 COL 16.6 WIDGET-ID 304
     tableTab AT ROW 1.24 COL 42 WIDGET-ID 306
     whereTab AT ROW 1.24 COL 52.6 WIDGET-ID 308
...
DEFINE FRAME viewFrame
     btnPageFormat-2 AT ROW 14.62 COL 58 HELP
     ...
     dynSubject.module AT ROW 3.62 COL 45 COLON-ALIGNED WIDGET-ID 160
          ...
          DROP-DOWN-LIST
          SIZE 8.2 BY 1
     dynSubject.mnemonic AT ROW 3.62 COL 70 COLON-ALIGNED WIDGET-ID 668
          LABEL "Hotkey"
          VIEW-AS FILL-IN 
          SIZE 9.2 BY 1
          BGCOLOR 15 
     dynSubject.subjectGroup AT ROW 4.81 COL 16 COLON-ALIGNED WIDGET-ID 672
          ...
          DROP-DOWN-LIST
          SIZE 37 BY 1
     dynSubject.autoClose AT ROW 4.81 COL 72 WIDGET-ID 674
          VIEW-AS TOGGLE-BOX
          SIZE 14 BY 1
...
DEFINE FRAME viewFrame
     dynSubject.recordLimit AT ROW 11.95 COL 70 COLON-ALIGNED WIDGET-ID 162
          ...
          SIZE 16 BY 1
          BGCOLOR 15 
     dynSubject.udfGroup AT ROW 13.14 COL 16 COLON-ALIGNED WIDGET-ID 676
          VIEW-AS COMBO-BOX INNER-LINES 5
          LIST-ITEMS "UDF Group" 
          DROP-DOWN-LIST
          SIZE 34 BY 1
          BGCOLOR 15 
     dynSubject.formType AT ROW 13.14 COL 70 COLON-ALIGNED WIDGET-ID 680
          VIEW-AS COMBO-BOX INNER-LINES 5
          LIST-ITEMS "","BOL","Invoice","PO" 
          DROP-DOWN-LIST
          SIZE 16 BY 1
     btnDelete AT ROW 14.67 COL 34 HELP
          "Delete" WIDGET-ID 124
     btnCopy AT ROW 14.67 COL 26 HELP
          "Copy" WIDGET-ID 122
     dynSubject.onePer AT ROW 14.33 COL 69 WIDGET-ID 678
          VIEW-AS TOGGLE-BOX
          SIZE 19 BY .95
     btnCancel AT ROW 14.67 COL 50 HELP
          "Cancel" WIDGET-ID 120
     btnCloseView AT ROW 1.24 COL 84 HELP
          "Close" WIDGET-ID 72
     btnUpdate AT ROW 14.67 COL 10 HELP
          "Update/Save" WIDGET-ID 128
     btnAdd AT ROW 14.67 COL 18 HELP
          "Add" WIDGET-ID 118
     btnReset AT ROW 14.67 COL 42 HELP
          "Reset" WIDGET-ID 126
     "Output Default:" VIEW-AS TEXT
          SIZE 15 BY 1 AT ROW 6 COL 2 WIDGET-ID 158
     RECT-PANEL AT ROW 14.33 COL 9 WIDGET-ID 130
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 113 ROW 12.67
         SIZE 88 BY 16.91
...
DEFINE FRAME resultsFrame
     btnCloseResults AT ROW 1 COL 6 HELP
          "Close Results" WIDGET-ID 252
     btnSaveResults AT ROW 1 COL 2 HELP
          "Save Results" WIDGET-ID 254
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 23.14
         SIZE 200 BY 6.43
...
DEFINE FRAME outputFrame
     btnPageFormat AT ROW 1.48 COL 182 HELP
          "Page Format" WIDGET-ID 652
     svRunSync AT ROW 1 COL 95 HELP
     ...
     svAutoClose AT ROW 1.95 COL 95 HELP
          "Toggle to Auto Close" WIDGET-ID 658
     svOnePer AT ROW 2.91 COL 95 WIDGET-ID 660
...
/* BROWSE-TAB tableBrowse btnViewSubject DEFAULT-FRAME */
...
/* BROWSE-TAB subjectColumnBrowse btnSave DEFAULT-FRAME */
...
/* SETTINGS FOR TOGGLE-BOX dynSubject.autoClose IN FRAME viewFrame
   NO-ENABLE                                                            */
...
/* SETTINGS FOR COMBO-BOX dynSubject.custListID IN FRAME viewFrame
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN dynSubject.externalForm IN FRAME viewFrame
   NO-ENABLE EXP-FORMAT                                                 */
/* SETTINGS FOR COMBO-BOX dynSubject.formType IN FRAME viewFrame
   NO-ENABLE                                                            */
...
/* SETTINGS FOR COMBO-BOX dynSubject.module IN FRAME viewFrame
   NO-ENABLE                                                            */
/* SETTINGS FOR TOGGLE-BOX dynSubject.onePer IN FRAME viewFrame
   NO-ENABLE                                                            */
...
/* SETTINGS FOR COMBO-BOX dynSubject.subjectType IN FRAME viewFrame
   NO-ENABLE                                                            */
/* SETTINGS FOR COMBO-BOX dynSubject.udfGroup IN FRAME viewFrame
   NO-ENABLE                                                            */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btnLookup C-Win
ON CHOOSE OF btnLookup IN FRAME DEFAULT-FRAME /* Lookup */
DO:
    RUN spGetSessionParam ("Company", OUTPUT cCompany).
    RUN system/openlookup.p (
        cCompany,
        "",                   /* Lookup ID */
        dynSubject.subjectID, /* Subject ID */
        "",                   /* User ID */
        0,                    /* Param Value ID */
        OUTPUT cAllFields,
        OUTPUT cField,
...
ON HELP OF subjectSearch IN FRAME DEFAULT-FRAME
DO:
...
DO:
    ASSIGN
        ...
        .
    IF ttTable.businessLogic EQ NO AND ttSubjectTable.tableName NE "ttUDF" THEN
    ASSIGN
...
DO:
/*    IF dynSubject.udfGroup EQ "" AND ttTable.tableName EQ "ttUDF" THEN*/
/*    RETURN NO-APPLY.                                                  */
    fSetSaveButton (YES).
    RUN pAddTable (ttTable.tableDB, ttTable.tableName, ttTable.tableDscr).
END.
...
&Scoped-define FRAME-NAME viewFrame
&Scoped-define SELF-NAME dynSubject.useCustList
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL dynSubject.useCustList C-Win
ON VALUE-CHANGED OF dynSubject.useCustList IN FRAME viewFrame /* Use --> */
DO:
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  btnDesign:SENSITIVE = lSuperAdmin.
  RUN LockWindowUpdate (0,OUTPUT i).
  SESSION:SET-WAIT-STATE("").
...
------------------------------------------------------------------------------*/
  ...
  ENABLE btnSetInitialize btnLookup btnCreateDefaults btnDesign btnResults 
         btnUndo btnSubjectParamSet subjectTab paramSetsTab tableTab whereTab 
         columnsTab btnOuterJoin subjectSearch subjectMatches tableSearch 
         tableMatches tableList btnOF tableListOf btnWhere btnToday btnTime 
         btnNow btnDateTime btnMatches subjectBrowse btnViewSubject tableBrowse 
         subjectWhereBrowse btnBegins btnAND btnOR btnEQ btnNE btnLT btnGT 
         fieldSearch fieldMatches btnCalcField paramSetSearch paramSetMatches 
         btnLE btnGE paramSetBrowse fieldBrowse btnPlus btnMinus 
         subjectParamSetBrowse btnMultiply btnErrorCheck btnDivide btnYes btnNo 
         btnDate cUseIndex findType btnDec subjectTableBrowse btnInt btnMoveUp 
         columnSearch columnMatches btnStr btnSave subjectColumnBrowse 
         btnSubstr cParameter btnOpen btnClose btnSyntax cConstant btnPeriod 
         btnDouble btnComma btnAddSelections btnSingle btnGroupCalc 
         btnAddUseIndex queryStr btnRemoveUseIndex btnAddParameter 
         btnRemoveSelection btnMoveDown btnAddConstant btnRemove 
  ...
  ENABLE btnPageFormat svRunSync btnPrint svRecipients svAutoClose svOnePer 
         svShowAll svShowReportHeader svShowReportFooter svShowPageHeader 
         btnView svShowPageFooter svShowGroupHeader svShowGroupFooter 
         svShowParameters btnCSV btnLocalCSV btnRunResults btnAddEmail btnDOCX 
         btnHTML btnPDF btnXLS 
      WITH FRAME outputFrame IN WINDOW C-Win.
  ...
  IF AVAILABLE dynSubject THEN 
    DISPLAY dynSubject.isActive dynSubject.isLookup dynSubject.securityLevel 
          ...
          dynSubject.autoClose dynSubject.outputFormat dynSubject.externalForm 
  ...
  ENABLE btnPageFormat-2 btnDelete btnCopy btnCloseView btnUpdate btnAdd 
      WITH FRAME viewFrame IN WINDOW C-Win.
...
------------------------------------------------------------------------------*/
    ...
    RETURN.
    IF dynSubject.udfGroup EQ "" THEN
    ...
    ASSIGN
        ...
        .
    IF dynSubject.udfGroup NE "" AND ttField.udfID NE "" THEN DO:
        FIND FIRST ttAttrb
             WHERE ttAttrb.attr_id EQ ttField.udfID
             NO-ERROR.
        IF NOT AVAILABLE ttAttrb THEN
        RETURN.
        ASSIGN
            cLabel    = IF ttAttrb.attr_colLabel NE "" THEN ttAttrb.attr_colLabel
                        ELSE ttAttrb.attr_Label
            cFormat   = ttAttrb.attr_settings
            cDataType = ttAttrb.attr_datatype
            cUDFID    = ttAttrb.attr_id
            .
    ...
    DO WITH FRAME viewFrame:
        IF AVAILABLE dynSubject THEN DO:
            ASSIGN
                ...
                dynSubject.formType:SCREEN-VALUE     = " "
...
------------------------------------------------------------------------------*/
    ...
    DO idx = 1 TO NUM-ENTRIES(cDBList):
        ...
        END. /* do jdx */
    END. /* do idx */
    CREATE ALIAS "dictdb" FOR DATABASE VALUE(ENTRY(1,cDBList)).
    {&OPEN-QUERY-tableBrowse}
    FIND FIRST ttTable.
...
------------------------------------------------------------------------------*/
    ...
    IF dynSubject.udfGroup NE "" THEN DO:
        ...
        RUN pGetMFData (dynSubject.udfGroup).
        FOR EACH ttAttrb
            WHERE ttAttrb.attr_name GT ""
            :
            CREATE ttField.
            ASSIGN
                ttField.tableDB    = "ASI"
                ttField.fieldLabel = ttAttrb.attr_label
                ttField.fieldName  = "ttUDF." + ttAttrb.attr_name
                ttField.udfID      = ttAttrb.attr_id
                .
        END.
    END. /* if udfgroup */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pGetUDFGroups C-Win 
PROCEDURE pGetUDFGroups :
/*------------------------------------------------------------------------------
 Purpose:
 Notes:
------------------------------------------------------------------------------*/
    dynSubject.udfGroup:LIST-ITEMS IN FRAME viewFrame = " ".
    FOR EACH mfGroup NO-LOCK:
        dynSubject.udfGroup:ADD-LAST(ENTRY(1,mfGroup.mfGroup_Data,"|")).
    END. /* each udfgroup */
    dynSubject.udfGroup:INNER-LINES = dynSubject.udfGroup:NUM-ITEMS.
