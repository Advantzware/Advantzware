...
/*------------------------------------------------------------------------
  ...
  File: AOA/qryComparisonKywd.w

  Description: Comparison Keywords used in Query Design
...
&Scoped-Define ENABLED-OBJECTS BROWSE-1 btnOK btnCancel 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-LABELS NO-ROW-MARKERS SEPARATORS SIZE 35 BY 9.05.
...
DEFINE FRAME Dialog-Frame
     ...
     btnOK AT ROW 10.76 COL 20 WIDGET-ID 6
     btnCancel AT ROW 10.76 COL 28 WIDGET-ID 4
     RECT-1 AT ROW 10.52 COL 19 WIDGET-ID 2
     SPACE(0.19) SKIP(0.00)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         BGCOLOR 15 FGCOLOR 1 
         TITLE "Comparison Keywords" WIDGET-ID 100.
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Comparison Keywords */
DO:
...
DO:
    iphWidget:SCREEN-VALUE = ttKeyword.keywordValue.
END.
...
------------------------------------------------------------------------------*/
  ENABLE BROWSE-1 btnOK btnCancel 
...
------------------------------------------------------------------------------*/
    ...
    DO idx = 1 TO NUM-ENTRIES(cLabel):
        ...
        ASSIGN
            ...
            ttKeyword.keywordValue = ENTRY(1,ENTRY(idx,cLabel)," ")
            .
    END. /* do idx */
