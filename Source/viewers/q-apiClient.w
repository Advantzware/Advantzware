...
&Scoped-define INTERNAL-TABLES apiClient
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH apiClient NO-LOCK       WHERE apiClient.company  EQ APIOutbound.company         AND apiClient.clientID EQ APIOutbound.clientID     ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY {&SELF-NAME} FOR EACH apiClient NO-LOCK       WHERE apiClient.company  EQ APIOutbound.company         AND apiClient.clientID EQ APIOutbound.clientID     ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main apiClient
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main apiClient
...
/* Query rebuild information for QUERY Query-Main
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH apiClient NO-LOCK
      WHERE apiClient.company  EQ APIOutbound.company
        AND apiClient.clientID EQ APIOutbound.clientID
    ~{&SORTBY-PHRASE}.
     _END_FREEFORM
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "ASI.apiClient.company = ""as"""
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE GetAPIAndClientID q-tables 
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE APIOutbound THEN
        ASSIGN
            opcAPIID    = APIOutbound.apiID
            opcClientID = APIOutbound.clientID
            .
END PROCEDURE.
