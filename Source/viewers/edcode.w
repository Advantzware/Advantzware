...
DEFINE FRAME F-Main
     EDCode.Partner AT ROW 1.71 COL 16 COLON-ALIGNED WIDGET-ID 10
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
     EDCode.SetID AT ROW 1.71 COL 41.2 COLON-ALIGNED WIDGET-ID 18
          VIEW-AS FILL-IN 
          SIZE 9.2 BY 1
     EDCode.Agency AT ROW 1.71 COL 61.6 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 3.2 BY 1
     EDCode.Version AT ROW 1.71 COL 72.6 COLON-ALIGNED WIDGET-ID 22
          VIEW-AS FILL-IN 
          SIZE 6.8 BY 1
     ...
     "(Include file prefix)" VIEW-AS TEXT
          SIZE 24 BY .62 AT ROW 7.43 COL 119 WIDGET-ID 34
          FGCOLOR 1 
     "(Include file prefix)" VIEW-AS TEXT
          SIZE 24 BY .62 AT ROW 6.48 COL 119 WIDGET-ID 32
          FGCOLOR 1 
