...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES customerPart
&Scoped-define FIRST-EXTERNAL-TABLE customerPart
...
DEFINE FRAME F-Main
     customerPart.customerID AT ROW 1.48 COL 17.6 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 19 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: ASI.customerPart
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "customerPart"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "customerPart"}
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE customerPart THEN
        customerPart.company = cCompany.
    ...
    CASE ipcField:
        ...
        DO:
            IF customerPart.itemID:SCREEN-VALUE NE "" AND  
               NOT CAN-FIND(FIRST item WHERE item.i-no EQ customerPart.itemID:SCREEN-VALUE)
               THEN 
               DO:
                   oplSuccess = FALSE.
