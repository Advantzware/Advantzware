...
&SCOPED-DEFINE h_Browse01 h_inventorysnapshot
...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES inventorySnapshot
&Scoped-define FIRST-EXTERNAL-TABLE inventorySnapshot


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR inventorySnapshot.
...
/* Settings for THIS-PROCEDURE
   ...
   External Tables: ASI.inventorySnapshot
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "inventorySnapshot"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "inventorySnapshot"}
