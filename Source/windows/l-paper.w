...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Paper */
DO:
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  &SCOPED-DEFINE key-phrase item.company = ip-company AND (item.industry = ip-industry or ip-industry = '') and item.mat-type = 'P'
