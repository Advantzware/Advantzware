...
&Scoped-Define ENABLED-OBJECTS BROWSE-1 RECT-1 rd-sort Btn_Select ~
Btn_Deselect bt-clear lv-search bt-ok bt-zero bt-cancel 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS MULTIPLE SIZE 103 BY 11.19
         BGCOLOR 8 .
...
DEFINE FRAME Dialog-Frame
     ...
     Btn_Select AT ROW 12.67 COL 77
     Btn_Deselect AT ROW 12.67 COL 91
     bt-clear AT ROW 14.1 COL 2
     lv-search AT ROW 14.1 COL 21 COLON-ALIGNED
     bt-ok AT ROW 14.1 COL 65
     bt-zero AT ROW 14.1 COL 78
     bt-cancel AT ROW 14.1 COL 93
     "Sort By:" VIEW-AS TEXT
          SIZE 8 BY .62 AT ROW 12.91 COL 4
     RECT-1 AT ROW 12.43 COL 1
     SPACE(28.79) SKIP(4.27)
...
"fg-bin.loc-bin" "Bin" ? "character" ? ? ? ? ? ? no ? no no "12" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > ASI.fg-bin.tag
"fg-bin.tag" "Tag#" "x(20)" "character" ? ? ? ? ? ? no ? no no "30" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > ASI.fg-bin.cust-no
"fg-bin.cust-no" "Customer#" ? "character" ? ? ? ? ? ? no ? no no "12" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > ASI.fg-bin.qty
"fg-bin.qty" ? "->,>>>,>>>,>>9" "decimal" ? ? ? ? ? ? no ? no no "18" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-1 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
  ...
  ENABLE BROWSE-1 RECT-1 rd-sort Btn_Select Btn_Deselect bt-clear lv-search 
         bt-ok bt-zero bt-cancel 
      WITH FRAME Dialog-Frame.
