...
&Scoped-define FIELDS-IN-QUERY-BROWSE-1 tt-tbl.form-no   
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Form  Information */
DO:
...
------------------------------------------------------------------------------*/
   ...
   FOR EACH bf-ef WHERE bf-ef.company = ip-company
                    AND bf-ef.est-no = ip-est-no
                    AND bf-ef.eqty = ip-eqty
                   /*ND bf-ef.form-no = ip-form-no */  NO-LOCK:
       CREATE tt-tbl.
       ASSIGN tt-tbl.form-no = bf-ef.form-no
