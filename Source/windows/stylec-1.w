...
DEFINE FRAME D-Dialog
     Btn_OK AT ROW 18.62 COL 30
     Btn_Cancel AT ROW 18.62 COL 102
     SPACE(33.99) SKIP(0.28)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Layout Furmulars"
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Layout Furmulars */
DO:  
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_stylec-1 ).
       RUN set-position IN h_stylec-1 ( 2.19 , 8.00 ) NO-ERROR.
       /* Size in UIB:  ( 14.05 , 137.00 ) */

       /* Links to SmartViewer h_stylec-1. */
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'Record':U , h_stylec-1 ).
