...
&scoped-define fld-name-1 machchrg.charge_code
&scoped-define SORTBY-1 BY machchrg.charge_code
...
&Scoped-define QUERY-STRING-BROWSE-1 FOR EACH machchrg WHERE ~{&KEY-PHRASE} ~
      AND machchrg.company eq ip-company and ~
machchrg.machine eq ip-machine NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-BROWSE-1 OPEN QUERY BROWSE-1 FOR EACH machchrg WHERE ~{&KEY-PHRASE} ~
      AND machchrg.company eq ip-company and ~
machchrg.machine eq ip-machine NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-1 Dialog-Frame _STRUCTURED
  QUERY BROWSE-1 NO-LOCK DISPLAY
      machchrg.charge_code COLUMN-LABEL "Code" FORMAT "X(5)":U
            WIDTH 8
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME Dialog-Frame
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         TITLE " Machine Assigned Charge Codes Lookup".
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /*  Machine Assigned Charge Codes Lookup */
DO:
...
DO:
   op-char-val = machchrg.charge_code:screen-value in browse {&browse-name}.
