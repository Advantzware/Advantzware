...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "System Control for Business Forms"
         HEIGHT             = 22
         WIDTH              = 144.2
         MAX-HEIGHT         = 22
         MAX-WIDTH          = 144.2
...
ON END-ERROR OF W-Win /* System Control for Business Forms */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* System Control for Business Forms */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_smartmsg ).
       RUN set-position IN h_smartmsg ( 1.24 , 35.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Browse Forms|View Form' + ',
                     FOLDER-TAB-TYPE = 2':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 3.14 , 2.00 ) NO-ERROR.
       RUN set-size IN h_folder ( 19.76 , 142.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_sys-form ).
       RUN set-position IN h_sys-form ( 4.81 , 4.00 ) NO-ERROR.
       RUN set-size IN h_sys-form ( 17.62 , 138.00 ) NO-ERROR.

       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('2') NO-ERROR.

       /* Links to SmartNavBrowser h_sys-form. */
       RUN add-link IN adm-broker-hdl ( h_p-navico , 'Navigation':U , h_sys-form ).
       RUN add-link IN adm-broker-hdl ( h_sys-form , 'Record':U , THIS-PROCEDURE ).
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_sys-form-2 ).
       RUN set-position IN h_sys-form-2 ( 6.48 , 33.00 ) NO-ERROR.
       /* Size in UIB:  ( 11.91 , 80.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-navico ).
       RUN set-position IN h_p-navico ( 20.29 , 4.00 ) NO-ERROR.
       RUN set-size IN h_p-navico ( 2.14 , 42.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updsav ).
       RUN set-position IN h_p-updsav ( 20.29 , 86.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_p-updsav , 'TableIO':U , h_sys-form-2 ).
