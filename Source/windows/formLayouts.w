...
&SCOPED-DEFINE h_Browse01 h_formLayouts   
...
DEFINE VARIABLE h_formLayouts AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v-formLayouts AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* formLayouts */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* formLayouts */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'browsers/formLayouts.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_formLayouts ).
       RUN set-position IN h_formLayouts ( 4.81 , 5.00 ) NO-ERROR.
       RUN set-size IN h_formLayouts ( 19.52 , 116.00 ) NO-ERROR.

       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('2':U) NO-ERROR.

       /* Links to SmartNavBrowser h_formLayouts. */
       RUN add-link IN adm-broker-hdl ( h_p-navico , 'Navigation':U , h_formLayouts ).
       RUN add-link IN adm-broker-hdl ( h_formLayouts , 'Record':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_formLayouts ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'viewers/formLayouts.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-formLayouts ).
       RUN set-position IN h_v-formLayouts ( 5.05 , 5.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_v-formLayouts. */
       RUN add-link IN adm-broker-hdl ( h_formLayouts , 'Record':U , h_v-formLayouts ).
       RUN add-link IN adm-broker-hdl ( h_p-updsav , 'TableIO':U , h_v-formLayouts ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'add-item':U , h_v-formLayouts ).
              
       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-formLayouts ,
             h_folder , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-navico ,
             h_v-formLayouts , 'AFTER':U ).
