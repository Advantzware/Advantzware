...
&scoped-define SORTBY-1 BY itemfg.part-no
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-1 itemfg.part-no itemfg.i-name ~
itemfg.i-no itemfg.style 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-1 
&Scoped-define FIELD-PAIRS-IN-QUERY-BROWSE-1
&Scoped-define OPEN-QUERY-BROWSE-1 OPEN QUERY BROWSE-1 FOR EACH itemfg WHERE ~{&KEY-PHRASE} ~
      AND itemfg.company = ip-company and itemfg.part-no <> "" NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
/* Query rebuild information for BROWSE BROWSE-1
     ...
     _Where[1]         = "ASI.itemfg.company = ip-company and itemfg.part-no <> """""
     _FldNameList[1]   = ASI.itemfg.part-no
     _FldNameList[2]   = ASI.itemfg.i-name
     _FldNameList[3]   = ASI.itemfg.i-no
     _FldNameList[4]   = ASI.itemfg.style
     _Query            is OPENED
*/  /* BROWSE BROWSE-1 */
&ANALYZE-RESUME
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Part No. Information */
DO:
...
DO:
   op-char-val = itemfg.part-no:screen-value in browse {&browse-name} + "," +
...
DO:
    ...
    &scoped-define fld-name-1 itemfg.part-no
