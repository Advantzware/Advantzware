...
DEFINE VARIABLE fi_file AS CHARACTER FORMAT "X(45)" INITIAL "c:~\tmp~\ExportUsers.csv" 
     LABEL "Name" 
...
DEFINE FRAME rd-fgexp
     begin_user AT ROW 2.91 COL 21 COLON-ALIGNED HELP
          "Enter Beginning Users Number" WIDGET-ID 142
     end_user AT ROW 2.91 COL 64 COLON-ALIGNED HELP
          "Enter Ending Users #" WIDGET-ID 144
     sl_avail AT ROW 7.24 COL 7 NO-LABEL WIDGET-ID 26
     Btn_Def AT ROW 7.24 COL 42.2 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 56
     sl_selected AT ROW 7.24 COL 62.6 NO-LABEL WIDGET-ID 28
     Btn_Add AT ROW 8.38 COL 42.2 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 130
     Btn_Remove AT ROW 9.57 COL 42.2 HELP
          "Remove Selected Table from Tables to Audit" WIDGET-ID 134
     btn_Up AT ROW 10.76 COL 42.2 WIDGET-ID 136
     btn_down AT ROW 11.95 COL 42.2 WIDGET-ID 132
     fi_file AT ROW 14.91 COL 18.8 COLON-ALIGNED HELP
          "Enter File Name" WIDGET-ID 22
     tb_OpenCSV AT ROW 15 COL 87.8 RIGHT-ALIGNED WIDGET-ID 34
     tbAutoClose AT ROW 16.76 COL 43 WIDGET-ID 64
     tb_excel AT ROW 16.86 COL 4 WIDGET-ID 32
     btn-ok AT ROW 17.71 COL 31 WIDGET-ID 14
     btn-cancel AT ROW 17.71 COL 51 WIDGET-ID 12
     "Selected Columns" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 6.52 COL 69.4 WIDGET-ID 138
     " Selection Parameters" VIEW-AS TEXT
          SIZE 21.2 BY .71 AT ROW 1.14 COL 5 WIDGET-ID 36
     " Export Selection" VIEW-AS TEXT
          SIZE 17 BY .62 AT ROW 5.86 COL 5 WIDGET-ID 86
     "Available Columns" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 6.52 COL 13.4 WIDGET-ID 140
     RECT-6 AT ROW 6.19 COL 4 WIDGET-ID 30
     RECT-7 AT ROW 1.52 COL 4 WIDGET-ID 38
     RECT-8 AT ROW 14.29 COL 4 WIDGET-ID 84
     SPACE(2.99) SKIP(3.17)
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  RUN enable_UI.
   ...
   DO WITH FRAME {&FRAME-NAME}:
    ...
    fi_file:SCREEN-VALUE = "c:~\tmp~\ExportUsers.csv".
  END.
...
------------------------------------------------------------------------------*/
  DISPLAY begin_user end_user sl_avail sl_selected fi_file tb_OpenCSV 
          tbAutoClose 
      WITH FRAME rd-fgexp.
  ENABLE RECT-6 RECT-7 RECT-8 begin_user end_user sl_avail Btn_Def sl_selected 
