  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'View Item|Bom|Inventory|Vend Cost|POs|Jobs|Bins|History' + ',
                     FOLDER-TAB-TYPE = 2':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( /*h_item*/ THIS-PROCEDURE , 'Record':U , h_item-2 ).
    ...
    WHEN 2 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_item-2 , 'Record':U , h_item-3 ).
    ...
    WHEN 4 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_item-2 , 'Record':U , h_e-item ).
    ...
    WHEN 5 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_item-2 , 'Record':U , h_item-pos ).
    ...
    WHEN 6 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_item-2 , 'Record':U , h_b-rmainq-2 ).
    ...
    WHEN 7 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_item-2 , 'Record':U , h_rm-ibin ).
    ...
    WHEN 8 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( /*h_item*/ THIS-PROCEDURE , 'history':U , h_b-rmiinq ).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE get-i-no W-Win 
PROCEDURE get-i-no :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
