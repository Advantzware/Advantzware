...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'browsers/attach.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_attach ).
       RUN set-position IN h_attach ( 4.57 , 4.00 ) NO-ERROR.
       RUN set-size IN h_attach ( 18.10 , 145.00 ) NO-ERROR.

       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('2') NO-ERROR.

       /* Links to SmartNavBrowser h_attach. */
       RUN add-link IN adm-broker-hdl ( h_p-navico , 'Navigation':U , h_attach ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'add-item':U , h_attach ).
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_attach-2 ).
       RUN set-position IN h_attach-2 ( 5.76 , 5.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_attach-2. */
       RUN add-link IN adm-broker-hdl ( h_attach , 'Record':U , h_attach-2 ).
       RUN add-link IN adm-broker-hdl ( h_p-attach , 'TableIO':U , h_attach-2 ).
