...
(item.mat-type = ip-mat-type or ip-mat-type = "") ~
and (item.i-code = ip-code or ip-code = "") NO-LOCK ~
    ~{&SORTBY-PHRASE}
...
(item.industry = ip-industry or ip-industry = """") and
(item.mat-type = ip-mat-type or ip-mat-type = """")
and (item.i-code = ip-code or ip-code = """")"
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  &scoped-define key-phrase item.company = ip-company and (item.industry = ip-industry or ip-industry = "") and (item.mat-type = ip-mat-type or ip-mat-type = "") and (item.i-code = ip-code or ip-code = "")
