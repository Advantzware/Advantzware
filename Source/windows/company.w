...
&SCOPED-DEFINE h_Browse01 h_company
&SCOPED-DEFINE h_Object01 h_p-updsav-2
&SCOPED-DEFINE h_Object02 h_period-2
&SCOPED-DEFINE moveRight {&h_Object01},{&h_Object02}
...
DEFINE VARIABLE h_company-2 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_company-3 AS HANDLE NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Company */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_smartmsg ).
       RUN set-position IN h_smartmsg ( 1.00 , 22.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_f-add ).
       RUN set-position IN h_f-add ( 1.00 , 53.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_options ).
       RUN set-position IN h_options ( 1.00 , 61.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.81 , 55.80 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adm/objects/folder.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'FOLDER-LABELS = ':U + 'Browse|Detail|Periods' + ',
                     FOLDER-TAB-TYPE = 2':U ,
             OUTPUT h_folder ).
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_empalert ).
       RUN set-position IN h_empalert ( 1.00 , 117.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.81 , 7.80 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_exit ).
       RUN set-position IN h_exit ( 1.00 , 125.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.81 , 7.80 ) */
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'browsers/company.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_company ).
       RUN set-position IN h_company ( 4.81 , 4.00 ) NO-ERROR.
       RUN set-size IN h_company ( 19.52 , 102.00 ) NO-ERROR.

       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('2':U) NO-ERROR.

       /* Links to SmartNavBrowser h_company. */
       RUN add-link IN adm-broker-hdl ( h_p-navico , 'Navigation':U , h_company ).
       RUN add-link IN adm-broker-hdl ( h_company , 'Record':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_company ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'viewers/company.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_company-2 ).
       ...
       /* Links to SmartViewer h_company-2. */
    ...
    WHEN 3 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_company-3 ).
       RUN set-position IN h_company-3 ( 4.57 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.91 , 78.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'browsers/period1.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_period1 ).
       ...
       /* Links to SmartViewer h_company-3. */
       RUN add-link IN adm-broker-hdl ( h_company , 'Record':U , h_company-3 ).

       /* Links to SmartNavBrowser h_period1. */
