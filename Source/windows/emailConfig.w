...
&SCOPED-DEFINE h_Browse01 h_emailConfig
...
DEFINE VARIABLE h_emailconfig AS HANDLE NO-UNDO.
DEFINE VARIABLE h_emailconfig-2 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_options ).
       RUN set-position IN h_options ( 1.00 , 6.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_smartmsg ).
       RUN set-position IN h_smartmsg ( 1.24 , 4.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_exit ).
       RUN set-position IN h_exit ( 1.00 , 60.80 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Browse|Detail' + ',
                     FOLDER-TAB-TYPE = 2':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 1.71 , 1.00 ) NO-ERROR.
       RUN set-size IN h_folder ( 27.86 , 160.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'browsers/emailconfig.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_emailconfig ).
       RUN set-position IN h_emailconfig ( 3.14 , 2.00 ) NO-ERROR.
       RUN set-size IN h_emailconfig ( 26.19 , 158.00 ) NO-ERROR.

       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('2':U) NO-ERROR.

       /* Links to SmartNavBrowser h_emailconfig. */
       RUN add-link IN adm-broker-hdl ( h_p-navico , 'Navigation':U , h_emailconfig ).
       RUN add-link IN adm-broker-hdl ( h_emailconfig , 'Record':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_emailconfig ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'viewers/emailconfig.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_emailconfig-2 ).
       RUN set-position IN h_emailconfig-2 ( 5.52 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 18.81 , 153.00 ) */
       ...
       /* Links to SmartViewer h_emailconfig-2. */
       RUN add-link IN adm-broker-hdl ( h_emailconfig , 'Record':U , h_emailconfig-2 ).
       RUN add-link IN adm-broker-hdl ( h_p-updsav , 'TableIO':U , h_emailconfig-2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_emailconfig-2 ,
             h_folder , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-navico ,
             h_emailconfig-2 , 'AFTER':U ).
