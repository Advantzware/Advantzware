...
&scoped-define SORTBY-1 BY fg-bin.i-no BY fg-bin.loc BY fg-bin.loc-bin
&scoped-define SORTBY-5 BY fg-bin.job-no BY fg-bin.job-no2 BY fg-bin.loc BY fg-bin.loc-bin BY fg-bin.tag 
...
&scoped-define fld-name-1 fg-bin.i-no
&scoped-define fld-name-5 fg-bin.job-no
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-1 fg-bin.i-no fg-bin.tag ~
...
DEFINE FRAME Dialog-Frame
     ...
     bt-ok AT ROW 14.1 COL 100
     bt-cancel AT ROW 14.1 COL 111
     RECT-1 AT ROW 12.43 COL 1
     "Sort By:" VIEW-AS TEXT
          SIZE 8 BY .62 AT ROW 12.91 COL 4
     SPACE(110.79) SKIP(1.84)
...
"
     _FldNameList[1]   = ASI.fg-bin.i-no
     _FldNameList[2]   > ASI.fg-bin.tag
"tag" "Tag#" "x(20)" "character" ? ? ? ? ? ? no ? no no "30" yes no no "U" "" ""
     _FldNameList[3]   > ASI.fg-bin.job-no
"job-no" "Job#" ? "character" ? ? ? ? ? ? no ? no no "15" yes no no "U" "" ""
     _FldNameList[4]   > ASI.fg-bin.job-no2
"job-no2" "" "999" "integer" ? ? ? ? ? ? no ? no no "6" yes no no "U" "" ""
     _FldNameList[5]   > ASI.fg-bin.loc
"loc" "Whs" ? "character" ? ? ? ? ? ? no ? no no "8" yes no no "U" "" ""
     _FldNameList[6]   > ASI.fg-bin.loc-bin
"loc-bin" "Bin" ? "character" ? ? ? ? ? ? no ? no no "12" yes no no "U" "" ""
     _FldNameList[7]   > ASI.fg-bin.cust-no
"cust-no" ? ? "character" ? ? ? ? ? ? no ? no no "12" yes no no "U" "" ""
     _FldNameList[8]   > ASI.fg-bin.qty
"qty" ? "->,>>>,>>>,>>9" "decimal" ? ? ? ? ? ? no ? no no "18" yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE BROWSE-1 */
&ANALYZE-RESUME
