...
DEFINE VARIABLE h_fg-binmn AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Finished Good Bin File */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Finished Good Bin File */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Browse Bin|View Bin' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'browsers/fg-binmn.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_fg-binmn ).
       /* Position in UIB:  ( 4.81 , 3.00 ) */
       ...
       /* Links to  h_fg-binmn. */
       RUN add-link IN adm-broker-hdl ( h_p-navico , 'Navigation':U , h_fg-binmn ).
