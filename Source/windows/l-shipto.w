...
def var ip-cust-no like cust.cust-no init "att10" no-undo.
...
&scoped-define SORTBY-2 BY shipto.ship-name
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-1 Dialog-Frame _STRUCTURED
  QUERY BROWSE-1 NO-LOCK DISPLAY
      shipto.ship-id FORMAT "x(8)":U WIDTH 11
...
"shipto.ship-id" ? ? "character" ? ? ? ? ? ? no ? no no "11" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  &scoped-define key-phrase  shipto.company = ip-company and ~
                      shipto.cust-no = ip-cust-no
  {custom/lookpos.i &lookup-file = "shipto" &lookup-field = "ship-id" }
