    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = Yes':U ,
             OUTPUT h_shipto ).
       RUN set-position IN h_shipto ( 1.00 , 1.00 ) NO-ERROR.
       RUN SET-SIZE IN h_shipto ( 10.00 , 50.12 ) NO-ERROR.
       /* Size in UIB:  ( 11.19 , 132.00 ) */
