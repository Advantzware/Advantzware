...
DEF INPUT PARAMETER ip-i-no LIKE job-hdr.i-no NO-UNDO.
...
&scoped-define SORTBY-3 BY job-hdr.ord-no
&scoped-define SORTBY-4 BY job-hdr.cust-no
&scoped-define fld-name-1  job-hdr.job-no
&scoped-define fld-name-2  job-hdr.est-no
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  FRAME {&FRAME-NAME}:TITLE = TRIM(FRAME {&FRAME-NAME}:TITLE) +
                              " for FG: " + TRIM(CAPS(ip-i-no)).

  RUN enable_UI.

  APPLY "value-changed" TO rd-sort IN FRAME {&FRAME-NAME}.

  &SCOPED-DEFINE KEY-PHRASE job-hdr.company EQ ip-company AND job-hdr.i-no EQ ip-i-no
