...
&SCOPED-DEFINE h_Browse01 h_xref-2
...
DEFINE VARIABLE h_xref-2 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_xref-3 AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Cross References */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Cross References */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'FOLDER-LABELS = ':U + 'Browse XRef|View XRef' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
...
------------------------------------------------------------------------------*/
  ...
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'change-page':U ) .
    ...
    IF il-cur-page = 2 THEN DO:
        ...
        RUN epCanAccess IN hPgmSecurity ("windows/xref.w", "", OUTPUT lResult).
        DELETE OBJECT hPgmSecurity.
        IF NOT lResult THEN 
            RUN set-buttons IN h_p-updncp ('disable-all').
    END.
