...
DEFINE VARIABLE h_brwprogrammenu AS HANDLE NO-UNDO.
DEFINE VARIABLE h_pupdsav AS HANDLE NO-UNDO.
DEFINE VARIABLE h_sdoprogrammenu AS HANDLE NO-UNDO.
DEFINE VARIABLE h_vprogrammenu AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN repositionObject IN h_sdoprogrammenu ( 17.43 , 151.00 ) NO-ERROR.
       ...
       RUN repositionObject IN h_brwprogrammenu ( 1.48 , 4.00 ) NO-ERROR.
       ...
       RUN repositionObject IN h_vprogrammenu ( 1.48 , 82.00 ) NO-ERROR.
       /* Size in AB:  ( 14.10 , 82.00 ) */
       ...
       RUN constructObject (
             ...
             OUTPUT h_pupdsav ).
       RUN repositionObject IN h_pupdsav ( 17.67 , 82.00 ) NO-ERROR.
       RUN resizeObject IN h_pupdsav ( 1.76 , 65.60 ) NO-ERROR.

       /* Links to SmartDataBrowser h_brwprogrammenu. */
       RUN addLink ( h_sdoprogrammenu , 'Data':U , h_brwprogrammenu ).
       RUN addLink ( h_brwprogrammenu , 'Update':U , h_sdoprogrammenu ).

       /* Links to SmartDataViewer h_vprogrammenu. */
       RUN addLink ( h_pupdsav , 'TableIO':U , h_vprogrammenu ).
       RUN addLink ( h_sdoprogrammenu , 'Data':U , h_vprogrammenu ).
       RUN addLink ( h_vprogrammenu , 'Update':U , h_sdoprogrammenu ).

       /* Adjust the tab order of the smart objects. */
       RUN adjustTabOrder ( h_vprogrammenu ,
             h_brwprogrammenu , 'AFTER':U ).
       RUN adjustTabOrder ( h_pupdsav ,
             h_vprogrammenu , 'AFTER':U ).
    END. /* Page 0 */
