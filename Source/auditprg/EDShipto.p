/* EDShipto.p - generated 12/09/2005 - 15:42:43 by NoSweat */
...
DO:
  PUT STREAM s-audit-rpt UNFORMATTED "?: " AT 3 ttbl_EDShipto1.Opened FORMAT "99/99/9999" " (Opened)".
  IF action = "UPDATE" THEN
  DO:
    IF ttbl_EDShipto1.Opened NE ttbl_EDShipto2.Opened THEN
    PUT STREAM s-audit-rpt UNFORMATTED "*" AT 1.
    PUT STREAM s-audit-rpt UNFORMATTED "?: " AT 3 ttbl_EDShipto2.Opened FORMAT "99/99/9999".
  END.
END.
