  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Browse|Detail|Items' + ',
                     FOLDER-TAB-TYPE = 2':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_bedpoack , 'Record':U , THIS-PROCEDURE ).
    ...
    WHEN 3 THEN DO:
       ...
       RUN set-size IN h_vedpoln ( 17.14 , 144.00 ) NO-ERROR.
