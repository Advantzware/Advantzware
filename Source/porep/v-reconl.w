...
ap-chk.check-date ap-chk.rec_key ap-chk.vend-no ap-chk.bank-code 
...
DEFINE FRAME F-Main
     ap-chk.check-no AT ROW 2.91 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9.2 BY 1
     ap-chk.check-amt AT ROW 3.91 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 15.2 BY 1
     ap-chk.check-date AT ROW 4.91 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 14 BY 1
     ap-chk.rec_key AT ROW 5.91 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 26 BY 1
     ap-chk.vend-no AT ROW 6.91 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 11.6 BY 1
     ap-chk.bank-code AT ROW 7.91 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 11.6 BY 1
