...
end_flute begin_cal end_cal begin_acct end_acct select-mat tb_det rd_fg-rm ~
...
begin_cal end_cal begin_acct end_acct select-mat tb_det lbl_fg-rm rd_fg-rm ~
...
DEFINE FRAME FRAME-A
     ...
     tb_det AT ROW 11.24 COL 16
     lbl_fg-rm AT ROW 12.43 COL 6 COLON-ALIGNED NO-LABEL
     rd_fg-rm AT ROW 12.43 COL 16 NO-LABEL
...
------------------------------------------------------------------------------*/
  DISPLAY begin_due-date begin_vend-no end_vend-no begin_i-code end_i-code 
          ...
          begin_acct end_acct select-mat tb_det lbl_fg-rm rd_fg-rm lv-ornt 
  ...
  ENABLE RECT-6 RECT-7 begin_due-date begin_vend-no end_vend-no begin_i-code 
         ...
         end_cal begin_acct end_acct select-mat tb_det rd_fg-rm lv-ornt 
