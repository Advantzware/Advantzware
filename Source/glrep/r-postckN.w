...
ASSIGN 
    cTextListToSelect  = "Trans Date,Run #,Journal,Balance,Bal Desc" 
...
{sys/inc/ttRptSel.i}
ASSIGN 
    cTextListToDefault = "Trans Date,Run #,Journal,Balance,Bal Desc" .
...
DEFINE VARIABLE fi_file        AS CHARACTER FORMAT "X(45)":U INITIAL "c:~\tmp~\GLPostingsCheck.csv" 
    LABEL "Name" 
...
DEFINE FRAME FRAME-A
    ...
    sl_avail AT ROW 6.38 COL 3 NO-LABELS WIDGET-ID 26
    Btn_Def AT ROW 6.38 COL 40.2 HELP
    "Add Selected Table to Tables to Audit" WIDGET-ID 56
    sl_selected AT ROW 6.38 COL 60.8 NO-LABELS WIDGET-ID 28
    Btn_Add AT ROW 7.38 COL 40.2 HELP
    "Add Selected Table to Tables to Audit" WIDGET-ID 32
    Btn_Remove AT ROW 8.38 COL 40.2 HELP
    "Remove Selected Table from Tables to Audit" WIDGET-ID 34
    btn_Up AT ROW 9.43 COL 40.2 WIDGET-ID 40
    btn_down AT ROW 10.48 COL 40.2 WIDGET-ID 42
    rd-dest AT ROW 12.19 COL 4.8 NO-LABELS
    lv-font-no AT ROW 12.19 COL 34 COLON-ALIGNED
    lv-ornt AT ROW 12.19 COL 44 NO-LABELS
    lines-per-page AT ROW 12.19 COL 87 COLON-ALIGNED
    lv-font-name AT ROW 13.14 COL 29 COLON-ALIGNED NO-LABELS
    tb_excel AT ROW 14.33 COL 72 WIDGET-ID 2
    td-show-parm AT ROW 14.76 COL 28.2
    fi_file AT ROW 15.62 COL 26.2 COLON-ALIGNED HELP
    "Enter File Name" WIDGET-ID 6
    tb_OpenCSV AT ROW 15.71 COL 77.8 WIDGET-ID 4
    tbAutoClose AT ROW 16.95 COL 28.2 WIDGET-ID 64
    btn-ok AT ROW 17.91 COL 28
    btn-cancel AT ROW 17.91 COL 53
    "Selected Columns(In Display Order)" VIEW-AS TEXT
    SIZE 34 BY .62 AT ROW 5.76 COL 60.4 WIDGET-ID 44
    " Selection Parameters" VIEW-AS TEXT
    SIZE 21 BY .71 AT ROW 1.24 COL 4
    " Output Destination" VIEW-AS TEXT
    SIZE 20 BY .62 AT ROW 11.62 COL 4
    "Available Columns" VIEW-AS TEXT
    SIZE 29 BY .62 AT ROW 5.76 COL 3 WIDGET-ID 38
    RECT-6 AT ROW 12.05 COL 3
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    RUN enable_UI.
    {sys/inc/reportsConfigNK1.i "GR7" }
    ASSIGN
        ...
        DO:
            ...
            DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
                ...
                CASE cTmpField:             
                    ...
                    WHEN "bal"  THEN 
                        cVarValue = STRING(v-tot,"->>>,>>>,>>9.99") .
                    WHEN "out"   THEN 
                        cVarValue = STRING(v-tot EQ 0,"/Out of Balance") .
    ...
    DO WITH FRAME {&FRAME-NAME}:
        ...
        ELSE
            ASSIGN
                ...
                .
        ASSIGN 
            fi_file:SCREEN-VALUE = "c:\tmp\GLPostingsCheck.csv".   
    END.
