...
oe-bolh.frt-pay oe-bolh.carrier oe-bolh.airway-bill oe-bolh.quoteNote ~
oe-bolh.loc oe-bolh.trailer oe-bolh.ship-id oe-bolh.cwt ~
oe-bolh.quotedFreight oe-bolh.tot-wt oe-bolh.freight oe-bolh.tot-pallets ~
oe-bolh.PROnumber 
...
oe-bolh.frt-pay oe-bolh.release# oe-bolh.carrier oe-bolh.stat ~
oe-bolh.airway-bill oe-bolh.quoteNote oe-bolh.cust-no oe-bolh.loc ~
oe-bolh.trailer oe-bolh.ship-id oe-bolh.cwt oe-bolh.quotedFreight ~
oe-bolh.tot-wt oe-bolh.freight oe-bolh.freightCalculationAmount ~
oe-bolh.tot-pallets oe-bolh.user-id oe-bolh.printed oe-bolh.posted ~
oe-bolh.upd-date oe-bolh.PROnumber 
...
DEFINE FRAME F-Main
     ...
     btnTags1 AT ROW 5.62 COL 139.6
     ...
     oe-bolh.airway-bill AT ROW 3.43 COL 69.4 COLON-ALIGNED HELP
          ...
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     oe-bolh.quoteNote AT ROW 9.76 COL 108.6 COLON-ALIGNED
     ...
     oe-bolh.loc AT ROW 4.52 COL 78.6 COLON-ALIGNED
          ...
          VIEW-AS FILL-IN 
          SIZE 15 BY 1
     oe-bolh.trailer AT ROW 3.43 COL 108.6 COLON-ALIGNED
          LABEL "Trailer#"
          VIEW-AS FILL-IN 
          SIZE 30 BY 1
...
DEFINE FRAME F-Main
     ...
     oe-bolh.tot-pallets AT ROW 7.76 COL 69.6 COLON-ALIGNED
     ...
     oe-bolh.PROnumber AT ROW 4.52 COL 108.6 COLON-ALIGNED WIDGET-ID 304
          LABEL "PRO#"
          VIEW-AS FILL-IN 
          SIZE 23.2 BY 1 TOOLTIP "Enter carrier's PRO number"
     "@" VIEW-AS TEXT
...
/* SETTINGS FOR FILL-IN oe-bolh.loc IN FRAME F-Main
   EXP-LABEL EXP-FORMAT                                                 */
/* SETTINGS FOR TOGGLE-BOX oe-bolh.posted IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR TOGGLE-BOX oe-bolh.printed IN FRAME F-Main
   NO-ENABLE                                                            */
...
/* SETTINGS FOR FILL-IN oe-bolh.user-id IN FRAME F-Main
   NO-ENABLE EXP-LABEL                                                  */
/* SETTINGS FOR FILL-IN oe-bolh.PROnumber IN FRAME F-Main
   EXP-LABEL                                                            */    
...
&Scoped-define SELF-NAME btnTags1
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btnTags1 V-table-Win
...
&Scoped-define SELF-NAME oe-bolh.cwt
...
&Scoped-define SELF-NAME oe-bolh.tot-pallets
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL oe-bolh.tot-pallets V-table-Win
ON VALUE-CHANGED OF oe-bolh.tot-pallets IN FRAME F-Main /* Total Pallets */
DO:  
  RUN calc-freight.
END.
...
&Scoped-define SELF-NAME oe-bolh.tot-wt
...
------------------------------------------------------------------------------*/
  ...
  DEFINE VARIABLE cOldPRONum AS CHARACTER NO-UNDO.
  ...
  IF cOldPRONum NE oe-bolh.PROnumber THEN
  DO:
      FIND FIRST bf-oe-relh EXCLUSIVE-LOCK
           WHERE bf-oe-relh.company EQ cocode
             AND bf-oe-relh.release# EQ oe-bolh.release# NO-ERROR.
      IF AVAILABLE bf-oe-relh THEN
      bf-oe-relh.PROnumber = oe-bolh.PROnumber.
      RELEASE bf-oe-relh. 
  END.
