...
&Scoped-define QUERY-STRING-Query-Main FOR EACH oe-ord OF oe-ordl WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH oe-ord OF oe-ordl WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main oe-ord
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main oe-ord
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "ASI.oe-ord OF ASI.oe-ordl"
