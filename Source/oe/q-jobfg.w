...
&Scoped-define QUERY-STRING-Query-Main FOR EACH oe-ordl OF job-hdr WHERE ~{&KEY-PHRASE} ~
      AND oe-ordl.company EQ job-hdr.company ~
AND oe-ordl.job-no EQ job-hdr.job-no ~
AND oe-ordl.job-no2 EQ job-hdr.job-no2 ~
AND oe-ordl.ord-no EQ job-hdr.ord-no ~
AND oe-ordl.i-no EQ job-hdr.i-no NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH oe-ordl OF job-hdr WHERE ~{&KEY-PHRASE} ~
      AND oe-ordl.company EQ job-hdr.company ~
AND oe-ordl.job-no EQ job-hdr.job-no ~
AND oe-ordl.job-no2 EQ job-hdr.job-no2 ~
AND oe-ordl.ord-no EQ job-hdr.ord-no ~
AND oe-ordl.i-no EQ job-hdr.i-no NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main oe-ordl
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main oe-ordl
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "asi.oe-ordl OF asi.job-hdr"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = "USED"
     _Where[1]         = "oe-ordl.company EQ job-hdr.company
AND oe-ordl.job-no EQ job-hdr.job-no
AND oe-ordl.job-no2 EQ job-hdr.job-no2
AND oe-ordl.ord-no EQ job-hdr.ord-no
