...
/*------------------------------------------------------------------------
  ...
  File: oe/b-order-type.w

  Description: SmartBrowser for orderType table
...
&Scoped-define FIELDS-IN-QUERY-br_table orderType.orderTypeID orderType.orderTypeDescription cEmptyColumn   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table   
&Scoped-define SELF-NAME br_table
&Scoped-define QUERY-STRING-br_table FOR EACH orderType WHERE orderType.Company = cCompany AND orderType.inactive EQ NO ~         ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY {&SELF-NAME} FOR EACH orderType WHERE orderType.Company = cCompany AND orderType.inactive EQ NO ~         ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table orderType
&Scoped-define FIRST-TABLE-IN-QUERY-br_table orderType
...
/* Query rebuild information for BROWSE br_table
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH orderType
WHERE orderType.company EQ cCompany
  orderType.inactive EQ NO NO-LOCK
    ~{&SORTBY-PHRASE}.
     _END_FREEFORM
...
ON VALUE-CHANGED OF br_table IN FRAME F-Main
    DO:
        ...
        {methods/run_link.i "container-source" "pChangeTypeSource" "( input orderType.orderTypeSource + ':', input orderType.orderTypeID)" }
    END.
