...
&Scoped-Define ENABLED-FIELDS oe-reth.ra-no oe-reth.inv-no ~
oe-reth.return-date oe-reth.applied oe-reth.posted 
&Scoped-define ENABLED-TABLES oe-reth
&Scoped-define FIRST-ENABLED-TABLE oe-reth
&Scoped-Define ENABLED-OBJECTS RECT-1 
&Scoped-Define DISPLAYED-FIELDS oe-reth.ra-no oe-reth.inv-no ~
oe-reth.return-date oe-reth.applied oe-reth.posted 
&Scoped-define DISPLAYED-TABLES oe-reth
&Scoped-define FIRST-DISPLAYED-TABLE oe-reth
&Scoped-Define DISPLAYED-OBJECTS lv-tot-line lv-tot-line-qty 
...
DEFINE VARIABLE lv-tot-line-qty AS DECIMAL FORMAT "->,>>>,>>9.99":U INITIAL 0 
     LABEL "Grand Total Cr Memo Qty" 
     VIEW-AS FILL-IN 
     SIZE 19.6 BY 1
     BGCOLOR 14  NO-UNDO.
