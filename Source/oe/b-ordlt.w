...
"oe-ordl.i-no" ? ? "character" ? ? ? 14 ? ? no ? no no "24" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"fGetTotalPallet(INT(oe-ordl.qty) ) @ iTotalPallet" "Due Dt Usr" "->>,>>>,>>9" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
