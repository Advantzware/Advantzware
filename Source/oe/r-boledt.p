...
end_bolnum begin_date end_date begin_cust end_cust rd-dest fi_file ~
...
DEFINE VARIABLE fi_file        AS CHARACTER FORMAT "X(45)":U INITIAL "c:~\tmp~\r-boledt.csv" 
    LABEL "Name" 
...
DEFINE FRAME FRAME-A
    ...
    lv-font-name AT ROW 12.14 COL 29 COLON-ALIGNED NO-LABELS
    rd-dest AT ROW 12.38 COL 5 NO-LABELS
    lv-font-no AT ROW 13.19 COL 33.6 COLON-ALIGNED
    lines-per-page AT ROW 13.19 COL 86.6 COLON-ALIGNED
    lv-ornt AT ROW 13.24 COL 42.8 NO-LABELS
    td-show-parm AT ROW 14.14 COL 28.2
    tb_excel AT ROW 14.14 COL 72
    fi_file AT ROW 15.05 COL 26.2 COLON-ALIGNED HELP
    "Enter File Name"
    tb_OpenCSV AT ROW 15.14 COL 77.6
    tbAutoClose AT ROW 16.57 COL 28.2 WIDGET-ID 64
    btn-ok AT ROW 17.48 COL 28
    btn-cancel AT ROW 17.48 COL 53.4
    " Selection Parameters" VIEW-AS TEXT
    SIZE 21 BY .71 AT ROW 1.14 COL 4
    " Output Destination" VIEW-AS TEXT
    SIZE 19 BY .62 AT ROW 11.52 COL 4
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    RUN enable_UI.
    {sys/inc/reportsConfigNK1.i "OS2" }
    ASSIGN
...
PROCEDURE enable_UI :
    ...
    DISPLAY tran-date tran-period begin_bolnum end_bolnum begin_date end_date 
        begin_cust end_cust rd-dest fi_file tb_OpenCSV tbAutoClose 
        WITH FRAME FRAME-A IN WINDOW C-Win.
    ENABLE RECT-6 RECT-7 tran-date begin_bolnum end_bolnum begin_date end_date 
        begin_cust end_cust rd-dest fi_file tb_OpenCSV tbAutoClose btn-ok 
        btn-cancel 
        WITH FRAME FRAME-A IN WINDOW C-Win.
...
PROCEDURE run-report :
    ...
    DEFINE VARIABLE v-exp-name  AS CHARACTER FORMAT "x(40)".
    {sys/form/r-top3w.f}
...
PROCEDURE pChangeFileName :
    ...
    DO WITH FRAME {&FRAME-NAME}:
        IF ip-post THEN
            ASSIGN fi_file:SCREEN-VALUE = "c:\tmp\BOLPostingInvoice.csv".
        ELSE
            ASSIGN fi_file:SCREEN-VALUE = "c:\tmp\BOLEditList.csv".    
    END.
