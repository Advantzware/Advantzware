...
IF FIRST-OF({1}.{2})                   OR
  ...
  ASSIGN
   ...
   RUN Notes_CopyShipNote (oe-bolh.rec_key, inv-head.rec_key).
...
RUN Notes_CopyShipNote IN hNotesProcs (oe-bolh.rec_key, oe-relh.rec_key).
...
if avail oe-rel THEN DO:
  ...
  assign
   ...
   RUN Notes_CopyShipNote IN hNotesProcs (oe-relh.rec_key, oe-rel.rec_key).
