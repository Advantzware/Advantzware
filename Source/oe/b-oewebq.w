...
/* sorting ascending breaks the navigation panel */
ll-sort-asc = NO.
...
fi_i-no fi_part-no fi_po-no1 fi_est-no fi_job-no fi_job-no2  ~
 fi_sort-by fi_po-no-2 fi_i-name tb_appr
...
ASSIGN 
       ...
       tb_closed = FALSE.
ASSIGN
       tb_open:VISIBLE = FALSE
       tb_closed:VISIBLE = FALSE.
