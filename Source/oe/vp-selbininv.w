...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
     ...
     DO:
        FIND FIRST b-oe-bolh WHERE
             b-oe-bolh.company = inv-line.company AND
             b-oe-bolh.b-no = inv-line.b-no
             NO-LOCK NO-ERROR.
        
        IF AVAIL b-oe-bolh THEN
           v-bol-no = b-oe-bolh.bol-no.
       
        IF v-bol-no EQ 0 THEN
           DISABLE btn-update.
     END.
     ELSE
        DISABLE btn-update.
