...
DEFINE VARIABLE li-alloc AS INTEGER FORMAT "->>>,>>>,>>9":U INITIAL 0           /*Task# 08191306*/
     VIEW-AS FILL-IN 
     SIZE 16 BY 1 NO-UNDO.

DEFINE VARIABLE li-avail AS INTEGER FORMAT "->>>,>>>,>>9":U INITIAL 0           /*Task# 08191306*/
     VIEW-AS FILL-IN 
     SIZE 16 BY 1 NO-UNDO.
...
DEFINE FRAME F-Main
     ...
     oe-ordl.est-no AT ROW 1.24 COL 129 COLON-ALIGNED FORMAT "x(8)"
          VIEW-AS FILL-IN 
          SIZE 14 BY 1
     li-on-hand AT ROW 3.38 COL 19 COLON-ALIGNED NO-LABEL
     li-on-order AT ROW 3.38 COL 40 COLON-ALIGNED NO-LABEL
     li-alloc AT ROW 3.38 COL 62 COLON-ALIGNED NO-LABEL
     li-backorder AT ROW 3.38 COL 83 COLON-ALIGNED NO-LABEL
     li-avail AT ROW 3.38 COL 104 COLON-ALIGNED NO-LABEL
     li-reorder AT ROW 3.38 COL 125 COLON-ALIGNED NO-LABEL
     RECT-37 AT ROW 2.43 COL 2
     RECT-38 AT ROW 1 COL 1
     "On Order" VIEW-AS TEXT
          SIZE 15 BY .62 AT ROW 2.67 COL 42
     "Reorder" VIEW-AS TEXT
          SIZE 15 BY .62 AT ROW 2.67 COL 127
     "Backorder" VIEW-AS TEXT
          SIZE 15 BY .62 AT ROW 2.67 COL 85
     "Available" VIEW-AS TEXT
          SIZE 15 BY .62 AT ROW 2.67 COL 106
     "Allocated" VIEW-AS TEXT
          SIZE 15 BY .62 AT ROW 2.67 COL 64
     "On Hand" VIEW-AS TEXT
          SIZE 15 BY .62 AT ROW 2.67 COL 21
