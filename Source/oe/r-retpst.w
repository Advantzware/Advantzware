...
&Scoped-Define ENABLED-OBJECTS begin_ra-no end_ra-no tb_prt-notes rd-dest ~
lines-per-page td-show-parm btn-ok btn-cancel RECT-6 RECT-7 
&Scoped-Define DISPLAYED-OBJECTS begin_ra-no end_ra-no tb_prt-notes rd-dest ~
...
DEFINE FRAME FRAME-A
     begin_ra-no AT ROW 3.86 COL 27 COLON-ALIGNED HELP
          "Enter the beginning BOL number"
     end_ra-no AT ROW 3.86 COL 66 COLON-ALIGNED HELP
          "Enter the ending BOL number"
     tb_prt-notes AT ROW 5.52 COL 29
     rd-dest AT ROW 10.52 COL 11 NO-LABEL
     lines-per-page AT ROW 11.24 COL 72 COLON-ALIGNED
     td-show-parm AT ROW 12.91 COL 58
     btn-ok AT ROW 17.19 COL 20
     btn-cancel AT ROW 17.19 COL 58
     RECT-6 AT ROW 9.1 COL 2
     RECT-7 AT ROW 1 COL 1
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 9.57 COL 5
...
/* SETTINGS FOR FRAME FRAME-A
                                                                        */
ASSIGN 
       begin_ra-no:PRIVATE-DATA IN FRAME FRAME-A     = 
                "parm".

ASSIGN 
       end_ra-no:PRIVATE-DATA IN FRAME FRAME-A     = 
                "parm".

ASSIGN 
       tb_prt-notes:PRIVATE-DATA IN FRAME FRAME-A     = 
                "parm".
...
ON END-ERROR OF C-Win /* Returns Edit List */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Returns Edit List */
DO:
...
ON LEAVE OF begin_ra-no IN FRAME FRAME-A /* Beginning RA# */
DO:
  ASSIGN {&self-name}.
END.
...
ON LEAVE OF end_ra-no IN FRAME FRAME-A /* Ending RA# */
DO:
  ASSIGN {&self-name}.
END.
...
ON VALUE-CHANGED OF tb_prt-notes IN FRAME FRAME-A /* Print Notes? */
DO:
  assign {&self-name}.
END.
...
------------------------------------------------------------------------------*/
  DISPLAY begin_ra-no end_ra-no tb_prt-notes rd-dest lines-per-page td-show-parm 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE begin_ra-no end_ra-no tb_prt-notes rd-dest lines-per-page td-show-parm 
