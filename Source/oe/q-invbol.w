...
&Scoped-define QUERY-STRING-Query-Main FOR EACH oe-bolh OF inv-line WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH oe-bolh OF inv-line WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main oe-bolh
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main oe-bolh
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "company,Carrier,j-no,q-no"':U).
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "asi.oe-bolh OF asi.inv-line"
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "q-no" "oe-ord" "q-no"}
