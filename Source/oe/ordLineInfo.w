...
DEFINE VARIABLE fiQuote AS INTEGER FORMAT ">>>>>>>>":U 
     VIEW-AS FILL-IN 
     SIZE 20 BY 1.48
     BGCOLOR 15 FGCOLOR 0  NO-UNDO. 
...
DEFINE VARIABLE fiOver AS INTEGER FORMAT ">>9%":U 
     VIEW-AS FILL-IN 
     SIZE 10 BY 1.48
     BGCOLOR 15 FGCOLOR 0  NO-UNDO. 
     
DEFINE VARIABLE fiUnder AS INTEGER FORMAT ">>9%":U 
     VIEW-AS FILL-IN 
     SIZE 10 BY 1.48
     BGCOLOR 15 FGCOLOR 0  NO-UNDO.  
     
DEFINE VARIABLE fiDueCode AS CHARACTER FORMAT "X(3)":U 
     VIEW-AS FILL-IN 
     SIZE 10 BY 1.48
     BGCOLOR 15 FGCOLOR 0  NO-UNDO. 
     
DEFINE VARIABLE fiDueDate AS DATE FORMAT "99/99/9999":U 
     VIEW-AS FILL-IN 
     SIZE 22 BY 1.48
     BGCOLOR 118 FGCOLOR 0  NO-UNDO.      
     
DEFINE VARIABLE fiQuoteLabel AS CHARACTER FORMAT "X(256)":U INITIAL "Quote#:" 
     VIEW-AS FILL-IN 
     SIZE 15 BY 1.48 NO-UNDO.
     
DEFINE VARIABLE fiSoldToLabel AS CHARACTER FORMAT "X(256)":U INITIAL "Sold To:" 
     VIEW-AS FILL-IN 
     SIZE 15 BY 1.48 NO-UNDO.
     
DEFINE VARIABLE fiOverUnderLabel AS CHARACTER FORMAT "X(256)":U INITIAL "Over/Under:" 
     VIEW-AS FILL-IN 
     SIZE 24 BY 1.48 NO-UNDO.
     
DEFINE VARIABLE fiDueDateLabel AS CHARACTER FORMAT "X(256)":U INITIAL "Due Date:" 
     VIEW-AS FILL-IN 
     SIZE 19 BY 1.48 NO-UNDO.     
...
DEFINE FRAME F-Main
     ...
     fiQuoteLabel AT ROW 3.24 COL 2 COLON-ALIGNED NO-LABEL
     fiQuote AT ROW 3.24 COL 20 COLON-ALIGNED NO-LABEL
     fiSoldToLabel AT ROW 3.24 COL 48.6 COLON-ALIGNED NO-LABEL
     fiSoldTo AT ROW 3.24 COL 68 COLON-ALIGNED NO-LABEL
     fiOverUnderLabel AT ROW 3.24 COL 102 COLON-ALIGNED NO-LABEL
     fiOver AT ROW 3.24 COL 125 COLON-ALIGNED NO-LABEL
     fiUnder AT ROW 3.24 COL 137 COLON-ALIGNED NO-LABEL
     fiDueDateLabel AT ROW 3.24 COL 157 COLON-ALIGNED NO-LABEL
     fiDueCode AT ROW 3.24 COL 180 COLON-ALIGNED NO-LABEL
     fiDueDate AT ROW 3.24 COL 192 COLON-ALIGNED NO-LABEL
...
/* SETTINGS FOR FILL-IN fiShipTo IN FRAME F-Main
   NO-ENABLE ALIGN-L                                                    */ 
/* SETTINGS FOR FILL-IN fiQuoteLabel IN FRAME F-Main
   NO-ENABLE ALIGN-L                                                    */
/* SETTINGS FOR FILL-IN fiSoldToLabel IN FRAME F-Main
   NO-ENABLE ALIGN-L                                                    */
/* SETTINGS FOR FILL-IN fiOverUnderLabel IN FRAME F-Main
   NO-ENABLE ALIGN-L                                                    */
/* SETTINGS FOR FILL-IN fiDueDateLabel IN FRAME F-Main
   NO-ENABLE ALIGN-L                                                    */   
...
------------------------------------------------------------------------------*/
    DO WITH FRAME {&FRAME-NAME}:
        DISABLE fiCustNo fiShipTo fiCustPo fiEstNo fiQuoteLabel fiSoldToLabel fiOverUnderLabel fiDueDateLabel
                fiQuote fiSoldTo fiOver fiUnder fiDueCode fiDueDate.
    END.
END PROCEDURE.
...
------------------------------------------------------------------------------*/
    ...
    DEFINE INPUT PARAMETER  ipcSoldNo AS CHARACTER NO-UNDO.      
    DEFINE INPUT PARAMETER  ipcDueCode AS CHARACTER NO-UNDO.
    DEFINE INPUT PARAMETER  ipcDueDate AS CHARACTER NO-UNDO.
    DEFINE INPUT PARAMETER  ipiOver AS INTEGER NO-UNDO.
    DEFINE INPUT PARAMETER  ipiUnder AS INTEGER NO-UNDO.
    ...
    ASSIGN
        ...
        fiQuote:SCREEN-VALUE  = string(ipiQuoteNo)
        fiSoldTo:SCREEN-VALUE = ipcSoldNo
        fiOver:SCREEN-VALUE   = STRING(ipiOver) 
        fiUnder:SCREEN-VALUE  = STRING(ipiUnder)
        fiDueCode:SCREEN-VALUE = ipcDueCode
        fiDueDate:SCREEN-VALUE = STRING(ipcDueDate).
