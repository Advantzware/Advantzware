...
def var v-ship-qty as int format "->>,>>>,>>9.99" no-undo.
...
for each report where report.term-id eq v-term-id no-lock,
   ...
   /*     chExcelApplication:Goto("R7C1") NO-ERROR.
        ...
        ASSIGN chExcelApplication:ActiveCell:Value = xinv-head.bol-no /*v-po-no*/ .
     ...
     /*   /* SalesPerson */
        ...
        BY inv-line.i-no:
          ...
          chExcelApplication:Goto(v-cell) NO-ERROR.
          ASSIGN chExcelApplication:ActiveCell:Value = v-i-no /*inv-line.po-no*/ .

          /* Customer Item */
          ASSIGN v-cell = "R" + STRING(inrowcount) + "C26".
          chExcelApplication:Goto(v-cell) NO-ERROR.
          ASSIGN chExcelApplication:ActiveCell:Value = inv-line.ord-no.

          /* Southpak Item */
          ASSIGN v-cell = "R" + STRING(inrowcount) + "C30".
          chExcelApplication:Goto(v-cell) NO-ERROR.
          ASSIGN chExcelApplication:ActiveCell:Value = v-lot-no.
   ...
   /* v-cell = "R" + STRING(inrowcount) + "C35".
    ...
    chExcelApplication:Goto(v-cell) NO-ERROR.
    ASSIGN chExcelApplication:ActiveCell:Value = (v-subtot-lines + v-inv-freight) /*inv-head.t-inv-rev*/.
