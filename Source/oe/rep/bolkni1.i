...
/* Mod: Ticket - 103137 (Format Change for Order No. and Job No. */
     ...
     /* "<P14><=#3>" /*<C-20><R-2> <B>Bill Of Lading</B>*/ "<P10>" SKIP
             ...
             /*   "<=#3><R+2>" /*Ship Date:" oe-bolh.ship-date        */ SKIP
                ...
                "<=4><R+3> " oe-bolh.bol-date /*v-po-no FORM "x(15)" */ space(5) v-ord-no space(4) v-fob space(1) carrier.dscr FORM "X(26)" space(1) v-frt-terms FORM "x(13)" SPACE(1) v-tot-wt FORM "->>,>>>,>>9" SKIP
