...
PUT "<=1>" SKIP.
  PUT "<C2><R2><#1><R+10><C+37><IMAGE#1=" ls-full-img1  SKIP
    "<FCourier New>"
    "<C8>" "Bill To:" "<C50>" "Ship To:" SKIP
    "<C8>" inv-head.cust-name "<C50>" v-shipto-name  skip
    "<C8>" inv-head.addr[1] "<C50>"  v-shipto-addr[1]  SKIP
    "<C8>" inv-head.addr[2] "<C50>" v-shipto-addr[2]  SKIP
    "<C8>" v-addr3 "<C50>"  v-sold-addr3  SKIP.
