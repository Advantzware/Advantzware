...
/*                       END.                         */
        ...
        ASSIGN
             gchWorkSheet:Range("B1"):VALUE  = cust.NAME
             gchWorkSheet:Range("B2"):VALUE  = itemfg.i-name
             gchWorkSheet:Range("B3"):VALUE  = itemfg.i-no
             gchWorkSheet:Range("B4"):VALUE  = STRING(eb.wid) + " x " + STRING(eb.len) + " x " + STRING(eb.dep)
             gchWorkSheet:Range("B5"):VALUE  = eb.i-col
             gchWorkSheet:Range("B6"):VALUE  = eb.style
             gchWorkSheet:Range("B7"):VALUE  = ef.board
             gchWorkSheet:Range("B8"):VALUE  = oe-boll.ord-no
             gchWorkSheet:Range("B9"):VALUE  = oe-boll.po-no
             gchWorkSheet:Range("B10"):VALUE = oe-ordl.PROM-DATE
             gchWorkSheet:Range("B11"):VALUE = oe-boll.qty
             gchWorkSheet:Range("B12"):VALUE = eb.cas-pal
             gchWorkSheet:Range("B13"):VALUE = oe-bolh.tot-pallets
             .
...
/* IF cCertFormat EQ "CCC" THEN
 ...
 ELSE IF cCertFormat EQ "CCC" AND lCustomNotesMik THEN
    ...
    cTemplateFile = SEARCH("template\CCCEssBOLCert.xlt"). 
