...
FOR EACH oe-boll WHERE
    ...
    IF lv-bolfmt-int = 1 AND
        ...
        ASSIGN
            ...
            v-total-count = 0
            v-weight      = 0.
    ELSE IF lv-bolfmt-int NE 1 THEN
            ASSIGN
                v-cases       = 0
                v-partial     = 0
                v-total-count = 0
    ...
    ASSIGN
        ...
        iTotalCase    = iTotalCase + oe-boll.cases + oe-boll.partial .
    ...
    DO:
        ...
        chWorkSheet:Range("P" + string(iLineCount)):VALUE = STRING(oe-boll.cases) + " x " + string(oe-boll.qty-case) + " + " + string(oe-boll.partial) + 
