/* oe/rep/lodxprntSemo.i */
 ...
 END.
     FIND FIRST company NO-LOCK
        ...
        PUT "<FArial><=8><R63.5><C2><B><P30>  " tt-word-print.cust-part-no FORMAT "x(15)"  "</B>" SKIP.
