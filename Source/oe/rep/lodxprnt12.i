...
IF iplPrintView THEN DO:
        ...
        PUT "<FArial><=4><R-1.6><C3><B><p15> Customer Name </B>" SKIP.
        
        PUT "<FArial><=4><R19.3><C3><B><P20>  " tt-word-print.cust-name FORMAT "x(30)" "</B>" SKIP.

        PUT "<||><R24><C3><#5><FROM><R27><C80><RECT>" SKIP.            
        
        PUT "<FArial><=5><R-1.6><C3><B><p15> Description </B>" SKIP.
        PUT "<FArial><=5><R24.3><C3><B><P17>  " tt-word-print.i-name FORMAT "x(30)" "</B>" SKIP.

        PUT "<||><R29><C3><#4><FROM><R32><C40><RECT>" SKIP.            
        
        PUT "<FArial><=4><R-1.6><C3><B><p15> Customer Part# </B>" SKIP.
        
        PUT "<FArial><=4><R29.3><C3><B><P20>  " tt-word-print.cust-part-no FORMAT "x(15)" "</B>" SKIP.

        PUT "<||><R34><C3><#7><FROM><R37><C40><RECT>" SKIP.            
        
        PUT "<FArial><=7><R-1.6><C3><B><p15> Job# </B>" SKIP.
        PUT "<FArial><=7><R34.3><C3><B><P20>  " TRIM(STRING(DYNAMIC-FUNCTION('sfFormat_JobFormatWithHyphen', tt-word-print.job-no, tt-word-print.job-no2))) FORM "x(13)" "</B>" SKIP.

        PUT "<||><R34><C43><#8><FROM><R37><C80><RECT>" SKIP.            
        ...
        PUT "<||><R39><C3><#9><FROM><R42><C40><RECT>" SKIP.            
        
        PUT "<FArial><=9><R-1.6><C3><B><p15> Order PO # </B>" SKIP.
        PUT "<FArial><=9><R39.3><C3><B><P20>  " (IF AVAIL oe-ord THEN string(oe-ord.po-no,"x(15)") ELSE "") FORMAT "x(15)" "</B>" SKIP.
        ...
        PUT "<FArial><=11><R-1.6><C3><B><p15> Finished Goods Item </B>" SKIP.
        PUT "<FArial><=11><R44.3><C3><B><P20>  " tt-word-print.i-no FORMAT "x(15)" "</B>" SKIP.

        PUT "<||><R44><C43><#12><FROM><R47><C80><RECT>" SKIP.            
