...
for each xxreport where xxreport.term-id eq v-term-id,
 ...
 END.
  ...
  PUT
      "<R58.0><C3><P7>Sujeito à Seção 7 das Condições do"
      "<R58.6><C3>conhecimento de embarque aplicável, esta" 
      "<R59.2><C3>remessa deve ser entregue ao destinatário sem"
      "<R59.8><C3>recurso ao consignador. O consignador deve"
      "<R60.4><C3>assinar a seguinte declaração."
      "<R61.0><C3>O transportador não fará a entrega desta"
  ...
  PUT
      ...
      "<R61.0><C51>expedidores são obrigados a indicar especificamente"
