...
DEF TEMP-TABLE w-bin-cons NO-UNDO
    ...
    FIELD w-unit-count AS INT
    FIELD w-units AS INT
    FIELD w-partialCount AS INTEGER
    field w-qty like fg-bin.qty extent 2
    FIELD w-cust-qty AS INT
    FIELD w-uom  AS CHAR 
...
format w-oe-rell.ord-no /*w-bin.w-ord-col                  */
       ...
       v-bin                            at 36   format "x(30)"
       w-bin.w-units                    TO 71   format "->>>>>"
       w-bin.w-unit-count               TO 77   format "->>>>>"
       w-bin.w-partialCount             TO 83   FORMAT "->>>>>"
        ...
        ASSIGN
           ...
           for each fg-bin
               ...
               assign
                ...
                w-bin.w-partialCount = fg-bin.partial-count
           ...
           DO:
              ...
              FOR EACH w-bin:
                  ...
                  ASSIGN
                     ...
                     w-bin-cons.w-partialCount = w-bin-cons.w-partialCount + w-bin.w-partialCount.
