...
PUT "<C1><#2><R1>" 
 ...
 PUT    "<P10><ADJUST=LPI>"
                ...
                "<FArial><=4><R+0.8><P10><ADJUST=LPI>          VENDOR ORDER                                   PO #                                                 DATE SHIPPED " SKIP 
                "<FCourier New><=4><R+2.5> " space(3) oe-boll.ord-no SPACE(24)  string(cCustomerPo) FORMAT "x(15)" SPACE(17) string(oe-bolh.bol-date) FORMAT "x(15)"  SKIP
