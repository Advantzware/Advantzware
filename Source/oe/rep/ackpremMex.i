...
PUT "<FArial><P12><=#3><R-2> <B>    Reconocimiento</B> " "<P10>" SKIP
    "<=#3>  Cliente                   Contacto"
    "<=#3><R+2>  Teléfono                        Fax" 
    "<=#3><R+4>  Cliente PO                        Fecha de orden <FCourier New>"
...
.
PUT "<FArial><=4><R+1>Fecha requerida     Flete a bordo      Embarcar vía                     Condiciones                  Vendedor                   Es #          Citar #" SKIP
...
PUT "<FArial><=5><R24>                  Número de parte                                                                                                                                              Unidad de" SKIP.
PUT "<FArial><=5><R+1> Línea             del cliente                  Descripción                                                       Ordenado                    Precio            medida" SKIP(1).
PUT "<FCourier New>"          .
