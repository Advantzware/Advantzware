/* bolpremdsc.i - used by bolpremcx.p, bolprempx.p and bolpremx.p */
...
for each xxreport where xxreport.term-id eq v-term-id,
 ...
 END.
  ...
  PUT "<FArial>"
      ...
      "<=9> SKIDS:"
      "<=9><R+1> STC:"
      "<=9><R+2> LBS:"  "<C25><B>NMFC ITEM# 29250 - CLASS 125</B>" 
      " <R51><C1><P12><B>     Shipping Instructions: <P10> "
  ...
  PUT "<R57><C26><P10>ALL CLAIMS ON SHIPMENT MUST BE MADE WITHIN 10 DAYS</B>"
      ...
      "<R64><C28><P6>              Agent or Cashier <P7>  <C44>  SHIPPER PER         " SPACE(4) USERID(LDBNAME(1)).
  IF cSignatureFile NE "" THEN 
