/* ----------------------------------------------- oe/rep/ackindc.p 11/06 JLF */
/* ORDER ACKNOLEDGEMENT   for Indiana Carton                                  */
...
ASSIGN ls-image1 = "images\indiana.jpg".
...
{oe/rep/ackindc.i}
      ...
      for each oe-ordl
        ...
        put /*v-line FORM ">>>9" SPACE(3)*/
                v-part /*oe-ordl.i-no*/ SKIP
                oe-ordl.part-no  AT 2  oe-ordl.po-no SPACE(1)
