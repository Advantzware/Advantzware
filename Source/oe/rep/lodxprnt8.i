...
IF iplPrintView THEN do:                 
        ...
        PUT UNFORMATTED   
         ...
         PUT "<FArial><=9><R62.5><C7> <B><P22> "    TRIM(STRING(DYNAMIC-FUNCTION('sfFormat_JobFormatWithHyphen', tt-word-print.job-no, tt-word-print.job-no2))) FORM "x(13)" "</B>" SKIP.
...
ELSE DO:
        ...
        PUT UNFORMATTED   
         ...
         PUT "<FArial><=9><R72.5><C7> <B><P22> "    TRIM(STRING(DYNAMIC-FUNCTION('sfFormat_JobFormatWithHyphen', tt-word-print.job-no, tt-word-print.job-no2))) FORM "x(13)" "</B>" SKIP.
