...
/* oe/rep/relpremx2.i */   
   ...
   PUT "<FArial>" SKIP
      ...
      PUT
         ...
         "<R24><C8.2><FROM><R26><C8.2><LINE>" SKIP
         "<R24><C24.2><FROM><R26><C24.2><LINE>" SKIP
         ...
         "<=5><R+1> Order# <C10>Item / Desc / Lot #<C28>Tag/Loc/Bin/Job# <C54>                   Units<C65.8>Count<C71.5>Ord Qty/UOM" SKIP(1)
         "<FCourier New>".
