...
DEF {1} SHARED VARIABLE cInvMessage1 AS CHARACTER NO-UNDO.
DEF {1} SHARED VARIABLE cInvMessage2 AS CHARACTER NO-UNDO.
DEF {1} SHARED VARIABLE cInvMessage3 AS CHARACTER NO-UNDO.
DEF {1} SHARED VARIABLE cInvMessage4 AS CHARACTER NO-UNDO.
DEF {1} SHARED VARIABLE cInvMessage5 AS CHARACTER NO-UNDO.
DEF {1} SHARED VARIABLE lPrintMessage AS LOGICAL NO-UNDO.
