...
/* Mod: Ticket - 103137 (Format Change for Order No. and Job No. */
   ...
   IF lvFirstPage THEN DO:
      PUT UNFORMATTED   
       "<C2><R3.5><#1><R+60><C+45><IMAGE#1=" ls-full-img1
       "<P10></B>"
       "<P10><=1><R+10>"
   ...
   PUT
         ...
         "<R22><C7.5><FROM><R24><C7.5><LINE>" SKIP
         "<R22><C32.5><FROM><R24><C32.5><LINE>" SKIP
         "<R22><C50><FROM><R24><C50><LINE>" SKIP 
         "<R22><C60><FROM><R24><C60><LINE>" SKIP   
         "<R22><C65><FROM><R24><C65><LINE>" SKIP   
         "<R22><C73><FROM><R24><C73><LINE>" SKIP
         "<R22><C80><FROM><R24><C80><LINE>" SKIP
         "<R22><C93><FROM><R24><C93><LINE>" SKIP

         "<FArial><=5><C33.5>TAG/Whs/Bin<C51>Receipt Date<C81>QOH: RelQty: Ship<C94>Pallets:   Total" SKIP
         "<=5><R+1> Order# <C9>Item/Desc/Lot#<C33.5>Vendor Name/PO#(Job#)<C61>Units<C66>Unit Count<C74>Partial<C81>Qty<C94>Pallets" SKIP
         "<FCourier New>"
