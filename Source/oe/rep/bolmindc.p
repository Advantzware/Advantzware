...
PUT "<FBook Antiqua><R45><C1><P12><B>     Shipping Instructions: </B> <P9> " SKIP(1)
    ...
    "<#7><FROM><C+38><R+7><RECT>" SKIP
    "<=7><P6><C3>Subject to Section 7 of Conditions of applicable bill of lading, if"
    "<=7><C3><R+.7>this shipment is to be delivered to the consignee without recourse on"
    "<=7><C3><R+1.4>the consignor, the consignor shall sign the following statement:"
    "<=7><C3><R+2.1>The carrier shall not make delivery of this shipment without payment"
    "<=7><C3><R+2.8>of freight and all other lawful charges."
    "<=7><C4><R+3.5>Signature of"
    "<=7><C5><R+4.2>Consignor"
    ...
    "<=7><R+6><C72> " /*string(PAGE-NUM - lv-pg-num ,">>9") + " of " + string(lv-tot-pg) FORM "x(20)"*/ SKIP
