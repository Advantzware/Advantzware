...
/*                 oe-ord.ord-no AT 17 */
          ...
          PUT {1}
              "===================" AT 68 SKIP
              v-tot-pkgs AT 71 FORM "->>>9"  SPACE(5)
  ...
  ELSE DO:
     DISPLAY  {1}
          ...
          oe-boll.po-no                        /* 15 */
          oe-ordl.i-name  FORM "x(30)" SPACE(1)         /* 19 not 30 */
          oe-boll.cases FORM "->>,>>>"  SPACE(4)
          
          /*oe-boll.qty-case FORM "->>>>>Z" SKIP  */
/*           oe-ord.ord-no AT 17 */
          /*oe-boll.i-no AT 6*/
          oe-ordl.part-dscr1 AT 38 FORM "x(30)" SPACE(1) /* 25 */
     ...
     DISPLAY 
         "====================" AT 69 SKIP
         v-tot-pkgs AT 69 FORM "->>,>>9"  "" SPACE(3)
  ...
  for each fg-set
    ...
    put {1}
        ...
        xitemfg.i-name  FORMAT "x(22)" AT 38
        oe-boll.qty * v-part-qty        TO 84 FORMAT "->>>,>>9" SKIP
        fg-set.part-no                  AT 6
        skip(1).
 ...
 v-tot-unit = v-tot-unit + oe-boll.cases +
                if oe-boll.partial gt 0 then 1 else 0 .
