 /* oe/rep/bolxprn2.i  */  
   ...
   put "<FArial>"  SKIP
        ...
        "<FArial><P14><=#3>" /*<C-20><R-2> <B>Bill Of Lading</B> */ "<P10>" SKIP
                "<=#3><P20><B>BOL #: " oe-bolh.bol-no "</B><P10>" SKIP(1)
              ...
              /*  "<R19><C25><FROM><R23><C25><LINE>" SKIP      
                ...
                "<FCourier New><=4><R+3> " oe-bolh.bol-date SPACE(3) /*v-po-no FORM "x(15)" space(2) v-job-no*/ v-fob space(10) cTrailer space carrier.dscr FORMAT "x(24)" v-frt-terms SKIP
   ...
   IF lv-bolfmt-int = 1 THEN PUT "<FArial><=5><R+1> Order#                       PO#                           Part#                        Description                                 Units       Qty/Unit           Weight  <FCourier New>" SKIP(1).
                       ELSE  PUT "<FArial><=5><R+1> Order#                      PO#                            Part#                        Description                                 Units       Qty/Unit           Weight  <FCourier New>" SKIP(1).
            .
