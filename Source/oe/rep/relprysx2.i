/* oe/rep/relprysx2.i */   
   ...
   PUT "<FArial>" SKIP
       "<P14><C35><B>Pick Ticket</B> " SKIP
        ...
        "<=1><R+4><C+15><IMAGE#1=" ls-full-img1 SKIP /* image */
...
/*        "<=1><R+2>" "<FGCOLOR=" + trim(lv-comp-color) + ">" FORM "x(15)"                            */
      ...
      PUT
         ...
         "<=#3><R+6>Delivery Date:" oe-relh.rel-date        SKIP
         "<=#3><R+7>CSR: " v-csr SKIP
          SKIP     
         "<|10><R19><C1><#4><FROM><R23><C79.5><RECT>" SKIP
         "<R21><C1><FROM><R21><C79.5><LINE>" SKIP    
