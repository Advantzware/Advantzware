...
PUT "<FTimes New Roman>".
        ...
        PUT "<C1><#2>" /*<R+10><C+35><IMAGE#2=" ls-full-img2 SKIP  /* company image */ */
            ...
            SPACE(14) inv-head.cust-name v-shipto-name AT 64 skip
            SPACE(14) inv-head.addr[1]   v-shipto-addr[1] AT 64 SKIP
            SPACE(14) inv-head.addr[2]  v-shipto-addr[2] AT 64 SKIP
