...
def var v-ship-addr3 as   char format "x(40)".
   ...
   END.
    ...
    if v-comp-addr[2] eq "" then
      assign
       ...
       v-comp-addr3   = "".
    if v-ship-addr[2] eq "" THEN do:
      assign
       v-ship-addr[2] = v-ship-addr3 
       v-ship-addr3   = "" .
       
    /*  IF v-phone-num <> "" OR v-phone-num <> "()" THEN
