/* ------------------------------------------ oe/rep/invallws.p 04200903 GDM */
  ...
  BREAK BY report.key-01
    ...
    ASSIGN  
      ...
      DO TRANSACTION:
        ...
        {oe/rep/invallws.i}  /* xprint form */

        ASSIGN v-printline    = 28
               v-subtot-lines = 0
               v-t-tax        = 0.
        ...
        FOR EACH inv-line NO-LOCK WHERE inv-line.r-no = inv-head.r-no:
          ...
          PUT 
           ...
           SPACE(1) 
           SKIP
           SPACE(15) inv-line.part-dscr1 FORMAT "x(25)" 
           SKIP
           SPACE(15) inv-line.part-dscr2 FORMAT "x(25)" .
        ...
        FOR EACH inv-misc NO-LOCK WHERE inv-misc.company = inv-head.company 
            ...
            IF FIRST(inv-misc.ord-no) THEN DO:
                PUT "** Miscellaneous Items **" AT 16 SKIP.
      ...
      ASSIGN
        ...
        v-inv-total = v-subtot-lines + inv-head.t-inv-tax.
      ...
      PUT
       ...
       SKIP
        "<=9><R62.5> LEGAL ACTION IS REQUIRED FOR COLLECTION OF THIS INVOICE. THE"
