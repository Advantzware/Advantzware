...
for each xxreport where xxreport.term-id eq v-term-id,
 ...
 END.
  ...
  PUT "<R52><C53><#8><FROM><R+4><C+27><RECT> " 
      "<=8><R+1> Unidades totales  :" v-grand-total-cases format ">>,>>>,>>9"
      "<=8><R+3> Peso total        :" v-tot-wt format ">>,>>>,>>9".
  
  PUT "<FArial><R51><C1><P12><B>     Instrucciones de envío: <P10> "
