...
DEF VAR v-shipto-fedx AS CHAR NO-UNDO.
...
for each xxreport where xxreport.term-id eq v-term-id,
    ...
    v-shipto-fedx    =  shipto.spare-char-4 .
...
/*                 lv-email    = v-cusx-email  */
  ...
  PUT "<FArial><R49><C1><P6> * Customer responsible to inspect incoming material for any possible damage and verification of count." 
      "  Once bill of lading/receiver is signed, customer accepts responsibility of product.<P9> " SKIP
      .

  PUT "<FArial><R51><C1><P12><B>     Shipping Instructions: </B> <P10>    Receipient ID:  " v-shipto-fedx FORMAT "x(10)"  "<P9>"  
