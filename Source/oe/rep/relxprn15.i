...
/* Mod: Ticket - 103137 (Format Change for Order No. and Job No. */
   ...
   PUT "<FArial>" SKIP
       "<P14><C+50><B>Pick Ticket</B> " SKIP(10)
      ...
      PUT
         ...
         "<R24><C59.5><FROM><R26><C59.5><LINE>" SKIP
         "<R24><C65><FROM><R26><C65><LINE>" SKIP   
         "<R24><C70><FROM><R26><C70><LINE>" SKIP
         "<FArial><=5><C60.8>Unit<C65.5> Partial  Rel Qty/UOM" SKIP
         "<=5><R+1> Order# <C8> Item / Desc / Lot #<C30>Tag/Locn/Bin/Job# <C55.5>Units<C60.8>Count<C65.8>Count". IF lPrintQtyUom THEN PUT "<C71.5>Ord Qty/UOM". ELSE PUT "". PUT SKIP(1)
         "<FCourier New>".
