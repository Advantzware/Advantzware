...
DEFINE VARIABLE iUnitPerPallet AS INTEGER NO-UNDO.
      ...
      for each w-oe-rell USE-INDEX idx,
        ...
        ASSIGN
           ...
           for each fg-bin
               ...
               create w-bin
                   .
               iUnitPerPallet = fg-bin.cases-unit.
               IF iUnitPerPallet EQ 0 THEN
               iUnitPerPallet = IF AVAILABLE oe-ordl THEN oe-ordl.cases-unit ELSE 1.  
               assign
                ...
                w-bin.w-unit-count = iUnitPerPallet
                w-bin.w-units  = TRUNC(fg-bin.qty / iUnitPerPallet,0)
