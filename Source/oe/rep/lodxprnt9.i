...
IF iplPrintView THEN do: 
        ...
        PUT "<FArial><=6><R29><C4><B><P24>  " tt-word-print.cust-po-no FORMAT "x(15)" "          "  TRIM(STRING(DYNAMIC-FUNCTION('sfFormat_JobFormatWithHyphen', tt-word-print.job-no, tt-word-print.job-no2))) FORM "x(13)" "</B>" SKIP.
        ...
        PUT "<FArial><=10><R59><C44><B><P24>  " TRIM(STRING(DYNAMIC-FUNCTION('sfFormat_JobFormatWithHyphen', tt-word-print.job-no, tt-word-print.job-no2))) FORM "x(13)" "</B>" SKIP.
...
ELSE DO:
        ...
        PUT "<FArial><=6><R-2><B><p14> Customer PO# / Job# </B>" SKIP.
        PUT "<FArial><=6><R49><C4><B><P24>  " tt-word-print.cust-po-no FORMAT "x(15)" "          "  TRIM(STRING(DYNAMIC-FUNCTION('sfFormat_JobFormatWithHyphen', tt-word-print.job-no, tt-word-print.job-no2))) FORM "x(13)" "</B>" SKIP.
        ...
        PUT "<FArial><=10><R79><C44><B><P24>  " TRIM(STRING(DYNAMIC-FUNCTION('sfFormat_JobFormatWithHyphen', tt-word-print.job-no, tt-word-print.job-no2))) FORM "x(13)" "</B>" SKIP.
