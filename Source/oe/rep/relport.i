/* ---------------------------------------------- oe/rep/relPort.i */
/* Print OE Release/Picking tickets    for Portugese Xprint          */
/* -----------------------------------------------------------------*/
...
DEFINE VARIABLE opcDateStringTicketDate AS CHARACTER NO-UNDO.
...
IF v-ship-i[1] NE "" OR
   ...
   v-ship-i[3] NE "" OR
   v-ship-i[4] NE "" THEN
   PUT "<FArial><R50><C1><P12><B>     Instruções de envio: </B> <P9> "SKIP(1)
