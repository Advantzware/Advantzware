...
PUT "<FArial><=5>  <C15.5> Order /" SKIP
                   "<C2>Ordered    <C9>Shipped    <C15.5>Cust PO    <C22>Item#/CustPart#    <C41>Description     <C60>Price    <C66.5>UOM     <C75>Amount <P9>" SKIP(1).
END.
ELSE DO:
PUT "<FArial><=5>" "<C2>Ordered"  "<C15.5> Order /" SKIP
                   "<C2>Shipped     <C9>Invoiced    <C15.5>Cust PO    <C22>Item#/CustPart#    <C41>Description    <C60>Price   <C66.5>UOM     <C75>Amount <P9>" SKIP(1).
END.
