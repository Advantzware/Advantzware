...
&IF DEFINED(EXCLUDE-panel-identifier) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE panel-identifier Method-Library 

  PROCEDURE panel-identifier:
    /* Purpose: To make external programs identify this is a panel using current procedure handle. */
  END PROCEDURE.
