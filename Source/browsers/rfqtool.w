...
&Scoped-define INTERNAL-TABLES rfq

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE Browser-Table                                 */
&Scoped-define FIELDS-IN-QUERY-Browser-Table rfq.rfq-no rfq.cust-no ~
rfq.sman rfq.req-date rfq.due-date rfq.ship-state rfq.wh-month 
...
&Scoped-define OPEN-QUERY-Browser-Table OPEN QUERY Browser-Table FOR EACH rfq WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Browser-Table rfq
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      ...
      rfq.sman FORMAT "x(3)":U
      rfq.req-date FORMAT "99/99/9999":U
      rfq.due-date FORMAT "99/99/9999":U
      rfq.ship-state FORMAT "x(2)":U
      rfq.wh-month FORMAT ">9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE Browser-Table
     ...
     _FldNameList[3]   = rfq.rfq.sman
     _FldNameList[4]   = rfq.rfq.req-date
     _FldNameList[5]   = rfq.rfq.due-date
     _FldNameList[6]   = rfq.rfq.ship-state
     _FldNameList[7]   = rfq.rfq.wh-month
