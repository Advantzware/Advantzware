...
&Scoped-define INTERNAL-TABLES ttScopes

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table ttScopes.apiID ttScopes.clientID ttScopes.locValidation ttScopes.triggerID ttScopes.inactive   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table   
&Scoped-define SELF-NAME br_table
&Scoped-define QUERY-STRING-br_table FOR EACH ttScopes BY ttScopes.inactive DESC
&Scoped-define OPEN-QUERY-br_table OPEN QUERY {&SELF-NAME} FOR EACH ttScopes BY ttScopes.inactive DESC.
&Scoped-define TABLES-IN-QUERY-br_table ttScopes
&Scoped-define FIRST-TABLE-IN-QUERY-br_table ttScopes
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _FREEFORM
  QUERY br_table NO-LOCK DISPLAY
      ...
      ttScopes.clientID COLUMN-LABEL "Client ID" WIDTH 20 FORMAT "X(32)"
      ttScopes.locValidation COLUMN-LABEL "Location Validation" WIDTH 20 FORMAT "Enabled/Disabled"
      ttScopes.triggerID COLUMN-LABEL "Trigger ID" WIDTH 35 FORMAT "X(32)"
      ttScopes.inactive COLUMN-LABEL "Status" FORMAT "Inactive/Active"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 138 BY 11.48
...
/* Query rebuild information for BROWSE br_table
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH ttScopes BY ttScopes.inactive DESC.
     _END_FREEFORM
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
    DEFINE VARIABLE cFirstData AS CHARACTER NO-UNDO.

    IF AVAILABLE ttScopes THEN
        cFirstData = ttScopes.scopeID .
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE vend THEN
        RUN Outbound_GetAPIsForScopeID IN hdOutboundProcs (
            INPUT  vend.company,
    ...
    FOR EACH ttScopes:
        FIND FIRST bf-ttScopes
             WHERE bf-ttScopes.company    EQ ttScopes.company
               ...
               AND bf-ttScopes.vendorID   EQ ttScopes.vendorID
               AND ROWID(bf-ttScopes)     NE ROWID(ttScopes)
             NO-ERROR.
        IF AVAILABLE bf-ttScopes THEN
            DELETE bf-ttScopes.        
        
        /* Delete records which will have less priority over a record that has vendor scope */ 
        IF ttScopes.vendorID EQ vend.vend-no THEN DO:
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "ttScopes"}
