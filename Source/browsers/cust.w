...
DEFINE FRAME F-Main
     ...
     fi_XCustomer AT ROW 3.27 COL 23 COLON-ALIGNED NO-LABEL NO-TAB-STOP
   ...
   /*  "Mode:" VIEW-AS TEXT
     ...
     "Customer#" VIEW-AS TEXT
      ...
      "Default Customer :" VIEW-AS TEXT
          SIZE 22 BY .71 AT ROW 3.50 COL 3 WIDGET-ID 60
          FGCOLOR 9 FONT 6
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pGetCustRecKey B-table-Win 
PROCEDURE pGetCustRecKey :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
  DEFINE OUTPUT PARAMETER opcRecKeyVlaue AS CHARACTER NO-UNDO.   
  IF AVAILABLE cust THEN
   opcRecKeyVlaue = cust.rec_key.
