...
emplogin.start_date ~
DYNAMIC-FUNCTION('sfTimeDisplay', emplogin.start_time, YES, YES) @ ls-start-time ~
emplogin.end_date ~
DYNAMIC-FUNCTION('sfTimeDisplay', emplogin.end_time, YES, YES) @ ls-end-time ~
emplogin.shift DYNAMIC-FUNCTION('sfTimeDisplay', emplogin.total_time, NO, YES) @ ls-total-time 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      DYNAMIC-FUNCTION('sfTimeDisplay', emplogin.start_time, YES, YES) @ ls-start-time COLUMN-LABEL "Start Time"
            COLUMN-FONT 0
      emplogin.end_date FORMAT "99/99/9999":U COLUMN-FONT 0
      DYNAMIC-FUNCTION('sfTimeDisplay', emplogin.end_time, YES, YES) @ ls-end-time COLUMN-LABEL "End Time"
            COLUMN-FONT 0
      emplogin.shift FORMAT "XX":U COLUMN-FONT 0
      DYNAMIC-FUNCTION('sfTimeDisplay', emplogin.total_time, NO, YES) @ ls-total-time COLUMN-LABEL "Total Time"
            COLUMN-FONT 0
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"DYNAMIC-FUNCTION('sfTimeDisplay', emplogin.start_time, YES, YES) @ ls-start-time" "Start Time" ? ? ? ? 0 ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[4]   > emplogin.end_date
"emplogin.end_date" ? ? "date" ? ? 0 ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[5]   > "_<CALC>"
"DYNAMIC-FUNCTION('sfTimeDisplay', emplogin.end_time, YES, YES) @ ls-end-time" "End Time" ? ? ? ? 0 ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[6]   > emplogin.shift
"emplogin.shift" ? "XX" "character" ? ? 0 ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[7]   > "_<CALC>"
"DYNAMIC-FUNCTION('sfTimeDisplay', emplogin.total_time, NO, YES) @ ls-total-time" "Total Time" ? ? ? ? 0 ? ? ? no ? no no ? yes no no "U" "" ""
