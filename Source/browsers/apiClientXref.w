...
&SCOPED-DEFINE cellColumnDat browsers-apiClientXref
...
&Scoped-define FIELDS-IN-QUERY-Browser-Table apiClientXref.company ~
apiClientXref.scopeID apiClientXref.scopeType apiClientXref.clientID 
&Scoped-define ENABLED-FIELDS-IN-QUERY-Browser-Table 
&Scoped-define QUERY-STRING-Browser-Table FOR EACH apiClientXref WHERE ~{&KEY-PHRASE} ~
      AND ((lCheckCustProgram and apiClientXref.scopeType eq "Customer") or (NOT lCheckCustProgram and apiClientXref.scopeType eq "Vendor")) ~
      AND ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Browser-Table OPEN QUERY Browser-Table FOR EACH apiClientXref WHERE ~{&KEY-PHRASE} ~
      AND ((lCheckCustProgram and apiClientXref.scopeType eq "Customer") or (NOT lCheckCustProgram and apiClientXref.scopeType eq "Vendor")) ~
      AND ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Browser-Table apiClientXref
&Scoped-define FIRST-TABLE-IN-QUERY-Browser-Table apiClientXref
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY        
      apiClientXref.company FORMAT "x(5)":U
      apiClientXref.scopeID FORMAT "x(15)":U
      apiClientXref.scopeType FORMAT "x(15)":U
      apiClientXref.clientID FORMAT "x(12)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE Browser-Table
     _TblList          = "apiClientXref"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = "USED,"
     _Where[1]         = "~{&KEY-PHRASE} AND ((lCheckCustProgram and apiClientXref.scopeType eq ""Customer"") or (NOT lCheckCustProgram and apiClientXref.scopeType eq ""Vendor""))"     
     _FldNameList[1]   = ASI.apiClientXref.company
     _FldNameList[2]   = ASI.apiClientXref.scopeID
     _FldNameList[3]   = ASI.apiClientXref.scopeType
     _FldNameList[4]   = ASI.apiClientXref.clientID
...
------------------------------------------------------------------------------*/
 ...
 /* ASSIGN
    op-company = apiClientXref.company
    op-cust-no = apiClientXref.cust-no. */
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
DEFINE VARIABLE cFirstData AS CHAR NO-UNDO.

IF AVAIL apiClientXref THEN
 cFirstData =  apiClientXref.scopeID .
 

RUN fg/apiedi-exp.w (cFirstData).
