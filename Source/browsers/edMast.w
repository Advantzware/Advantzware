...
&Scoped-define INTERNAL-TABLES EDMast
...
&Scoped-define QUERY-STRING-Browser-Table FOR EACH EDMast WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Browser-Table OPEN QUERY Browser-Table FOR EACH EDMast WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Browser-Table EDMast
&Scoped-define FIRST-TABLE-IN-QUERY-Browser-Table EDMast
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      ...
      EDMast.Ship-to-mask COLUMN-LABEL "Ship To Mask" FORMAT ">>>>>>>":U
      EDMast.Path-out COLUMN-LABEL "Outbound Path" FORMAT "x(60)":U
      EDMast.Path-in COLUMN-LABEL "Inbound Path" FORMAT "x(60)":U
      EDMast.Order-no-mask COLUMN-LABEL "Order # mask" FORMAT ">>>>>>>>":U
      EDMast.Item-Length COLUMN-LABEL "Item Length" FORMAT ">9":U
      EDMast.Item-suffix COLUMN-LABEL "Item Suffix" FORMAT "x(8)":U
      EDMast.Item-Prefix COLUMN-LABEL "Item Prefix" FORMAT "x(8)":U
      EDMast.Id-trim FORMAT "yes/no":U
      EDMast.ID-Out FORMAT ">9":U
      EDMast.ID-Len FORMAT ">9":U
      EDMast.Del-Days FORMAT "x(7)":U
