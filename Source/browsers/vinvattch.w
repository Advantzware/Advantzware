...
DEF VAR ip-inv-no AS CHAR NO-UNDO.
...
&SCOPED-DEFINE BRWSDEFS attachvinv
...
(if ip-inv-no ne "" then (attach.est-no eq ip-inv-no or attach.est-no eq "") else ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      ...
      attach.est-no COLUMN-LABEL "Invoice #" FORMAT "x(12)":U WIDTH 16
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"attach.est-no" "Invoice #" "x(12)" "character" ? ? ? ? ? ? no "" no no "16" no no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
  ...
  {methods/run_link.i "CONTAINER-SOURCE" "Get-ip-rec_key" "(OUTPUT ip-rec_key,OUTPUT ip-inv-no)"}
