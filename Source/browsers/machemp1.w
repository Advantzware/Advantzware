...
DYNAMIC-FUNCTION('sfCommon_TimeDisplay', machemp.start_time, YES, NO) @ start-time machemp.end_date ~
machemp.shift DYNAMIC-FUNCTION('sfCommon_TimeDisplay', machemp.end_time, YES, NO) @ end-time machemp.ratetype ~
machemp.posted DYNAMIC-FUNCTION('sfCommon_TimeDisplay', machemp.total_time, NO, NO) @ total-time 
...
"DYNAMIC-FUNCTION('sfCommon_TimeDisplay', machemp.start_time, YES, NO) @ start-time" "Started" "X(8)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"DYNAMIC-FUNCTION('sfCommon_TimeDisplay', machemp.end_time, YES, NO) @ end-time" "Ended" "X(8)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"DYNAMIC-FUNCTION('sfCommon_TimeDisplay', machemp.total_time, NO, NO) @ total-time" "Total" "X(5)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
