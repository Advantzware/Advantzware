...
/*------------------------------------------------------------------------
  ...
  File: browsers\l-truck.w

  Description: Truck Browser

  Input Parameters:
      ip-company ip-cur-val
...
&Scoped-define QUERY-STRING-BROWSE-1 FOR EACH truck WHERE ~{&KEY-PHRASE} ~
      AND truck.company = ip-company NO-LOCK ~
    ~{&SORTBY-PHRASE}
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-1 Dialog-Frame _STRUCTURED
  QUERY BROWSE-1 NO-LOCK DISPLAY
      truck.truck-code FORMAT "X(20)":U
...
/* Query rebuild information for BROWSE BROWSE-1
     ...
     _Where[1]         = "ASI.truck.company = ip-company"
...
"truck.carrier" ? ? "character" ? ? ? ? ? ? no ? no no "8.2" yes no no "U" "" ""
