...
&Scoped-define FIELDS-IN-QUERY-Browser-Table wip-bin.loc-bin 
&Scoped-define ENABLED-FIELDS-IN-QUERY-Browser-Table 
&Scoped-define QUERY-STRING-Browser-Table FOR EACH wip-bin OF loc WHERE ~{&KEY-PHRASE} ~
      AND ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Browser-Table OPEN QUERY Browser-Table FOR EACH wip-bin OF loc WHERE ~{&KEY-PHRASE} ~
      AND ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Browser-Table wip-bin
&Scoped-define FIRST-TABLE-IN-QUERY-Browser-Table wip-bin
...
DEFINE QUERY Browser-Table FOR 
      wip-bin
    FIELDS(wip-bin.loc-bin) SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      wip-bin.loc-bin COLUMN-LABEL "Primary Bin Loc." FORMAT "x(8)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE Browser-Table
     _TblList          = "ASI.wip-bin OF ASI.loc"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = "USED"
     _Where[1]         = "~{&KEY-PHRASE}"
     _FldNameList[1]   > ASI.wip-bin.loc-bin
"wip-bin.loc-bin" "Primary Bin Loc." ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "wip-bin"}
