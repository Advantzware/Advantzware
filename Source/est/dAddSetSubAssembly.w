...
DO:
        ...
        RUN est/dAddEditSubAssembly.w (?,ROWID(eb),"Add",cCustPart:SCREEN-VALUE IN FRAME {&frame-name},
...
DO:
        ...
        DO:   
            ...
            RUN est/dAddEditSubAssembly.w (RECID(ttInputEst),lv-rowid,"Copy",cCustPart:SCREEN-VALUE IN FRAME {&frame-name},
                item-name:SCREEN-VALUE IN FRAME {&frame-name},
                cCustPart:SCREEN-VALUE IN FRAME {&frame-name},
                fg-cat:SCREEN-VALUE IN FRAME {&frame-name},
                LOGICAL(tb_auto:SCREEN-VALUE IN FRAME {&frame-name}),
...
DO:
        ...
        DO:
            ...
            RUN est/dAddEditSubAssembly.w (RECID(ttInputEst),rwRowidEb,"Update",cCustPart:SCREEN-VALUE IN FRAME {&frame-name},
                item-name:SCREEN-VALUE IN FRAME {&frame-name},
                cCustPart:SCREEN-VALUE IN FRAME {&frame-name},
                fg-cat:SCREEN-VALUE IN FRAME {&frame-name},
                LOGICAL(tb_auto:SCREEN-VALUE IN FRAME {&frame-name}),
    ...
    DO WITH FRAME {&FRAME-NAME}:
        ...
        DO:
            ...
            FOR EACH bf-eb NO-LOCK
                ...
                CREATE ttInputEst.
                ASSIGN
                    ttInputEst.cEstType         = "SetSubAssembly"
                    ...
                    ttInputEst.cPartDescription = bf-eb.part-dscr2
