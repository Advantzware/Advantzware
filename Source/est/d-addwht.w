...
&Scoped-Define ENABLED-OBJECTS Btn_est Btn_itm Btn_Cancel 
...
DEFINE FRAME D-Dialog
     Btn_est AT ROW 1.71 COL 18
     Btn_itm AT ROW 4.57 COL 18
...
ON CHOOSE OF Btn_itm IN FRAME D-Dialog /* New Item */
DO:
    assign ls-add-what = "item".
    apply "window-close" to this-procedure.
END.
...
------------------------------------------------------------------------------*/
  ENABLE Btn_est Btn_itm Btn_Cancel 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
