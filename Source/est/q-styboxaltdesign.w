...
&Scoped-define QUERY-STRING-Query-Main FOR EACH box-design-hdr WHERE box-design-hdr.design-no = style.designIDAlt ~
and box-design-hdr.company = style.company  ~
 NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH box-design-hdr WHERE box-design-hdr.design-no = style.designIDAlt ~
and box-design-hdr.company = style.company  ~
 NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
/* Query rebuild information for QUERY Query-Main
     ...
     _JoinCode[1]      = "ASI.box-design-hdr.design-no = style.designIDAlt
and box-design-hdr.company = style.company 
"
