...
&Scoped-Define ENABLED-OBJECTS RECT-4 Btn-print Btn-Update 
...
ON CHOOSE OF Btn-Update IN FRAME F-Main /* Update Price Matrix */
DO:
  DEF VAR ll-ans AS LOG NO-UNDO.
  DEF VAR cTransQ AS cha NO-UNDO.
