...
/*------------------------------------------------------------------------
  File: est\dAddEditSubAssembly.w
------------------------------------------------------------------------*/
...
RECT-21 RECT-38 RECT-39 tb_add-subassembly cSourceEst 
...
board-dscr cat-dscr len wid dep rd_show1 item-name item-dscr ~
...
DEFINE FRAME Dialog-Frame
    ...
    iForm AT ROW 7.95 COL 15.6 COLON-ALIGNED WIDGET-ID 314
    iBlank AT ROW 7.95 COL 34.8 COLON-ALIGNED WIDGET-ID 316
    cSetCustPart AT ROW 2.91 COL 15 COLON-ALIGNED WIDGET-ID 176
    dQtyPerSet AT ROW 7.95 COL 59.6 COLON-ALIGNED WIDGET-ID 178
    Btn_OK AT ROW 14.48 COL 108
    Btn_Done AT ROW 14.76 COL 109
    Btn_Cancel AT ROW 14.48 COL 117
    set-item-name AT ROW 4.14 COL 15 COLON-ALIGNED WIDGET-ID 208
    cCustPart AT ROW 9.14 COL 15.6 COLON-ALIGNED WIDGET-ID 88
    style-cod AT ROW 10.43 COL 15.6 COLON-ALIGNED WIDGET-ID 180
    style-dscr AT ROW 10.43 COL 30.6 COLON-ALIGNED NO-LABELS WIDGET-ID 182
    board AT ROW 11.57 COL 15.6 COLON-ALIGNED WIDGET-ID 174
    fg-cat AT ROW 12.67 COL 15.6 COLON-ALIGNED WIDGET-ID 196
    board-dscr AT ROW 11.57 COL 30.6 COLON-ALIGNED NO-LABELS WIDGET-ID 212
    cat-dscr AT ROW 12.71 COL 30.6 COLON-ALIGNED NO-LABELS WIDGET-ID 214
    len AT ROW 7.95 COL 79 COLON-ALIGNED WIDGET-ID 190
    wid AT ROW 9.14 COL 79 COLON-ALIGNED WIDGET-ID 194
    dep AT ROW 10.43 COL 79 COLON-ALIGNED WIDGET-ID 192
    item-name AT ROW 11.57 COL 79 COLON-ALIGNED WIDGET-ID 322
    item-dscr AT ROW 12.71 COL 79 COLON-ALIGNED WIDGET-ID 210
    rd_show1 AT ROW 5.71 COL 8.4 NO-LABELS WIDGET-ID 324      
...
/* SETTINGS FOR FILL-IN style-dscr IN FRAME Dialog-Frame
   NO-ENABLE                                                            */
ASSIGN 
    tb_add-subassembly:PRIVATE-DATA IN FRAME Dialog-Frame = "parm".
...
ON HELP OF board IN FRAME Dialog-Frame /* Board */
    DO:
        ...
        ELSE lv-ind = "".  
        IF AVAILABLE style AND style.type = "f" THEN  
        DO: /* foam */    
            RUN AOA/dynLookupSetParam.p (70, ROWID(style), OUTPUT char-val).
            IF char-val NE "" AND ENTRY(1,char-val) NE board:SCREEN-VALUE THEN 
            DO:
                board:SCREEN-VALUE = DYNAMIC-FUNCTION("sfDynLookupValue", "item.i-no", char-val).                
                APPLY "ENTRY":U TO board.
            END.
        END.
        IF AVAILABLE style AND style.type = "W" THEN  
        DO: /* foam */                  
            RUN AOA/dynLookupSetParam.p (155, ROWID(style), OUTPUT char-val).  
            IF char-val NE "" AND DYNAMIC-FUNCTION("sfDynLookupValue", "item.i-no", char-val) NE board:SCREEN-VALUE THEN 
            DO:
                board:SCREEN-VALUE = DYNAMIC-FUNCTION("sfDynLookupValue", "item.i-no", char-val).                
                APPLY "ENTRY":U TO board.
            END.
        ...
        DO:
            ...
            IF AVAILABLE ITEM AND ITEM.i-no NE board:SCREEN-VALUE THEN 
            DO:
...
ON HELP OF cSourceEst IN FRAME Dialog-Frame /* Cust Part# */
    DO:
        DEFINE VARIABLE char-val   AS cha       NO-UNDO.
        DEFINE VARIABLE look-recid AS RECID     NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL cSourceEst Dialog-Frame
ON LEAVE OF cSourceEst IN FRAME Dialog-Frame /* Cust Part# */
    DO: 
        DEFINE VARIABLE lError AS LOGICAL   NO-UNDO.
        DEFINE VARIABLE cEstNo AS CHARACTER NO-UNDO.
        IF LASTKEY NE -1 THEN 
...
PROCEDURE display-item :
    ...
    DISPLAY   
        ...
        rd_show1 len wid dep cSourceEst
...
PROCEDURE enable_UI :
    ...
    DISPLAY est-no iForm iBlank cSetCustPart dQtyPerSet set-item-name cCustPart 
        ...
        rd_show1 item-name item-dscr tb_add-subassembly cSourceEst 
        WITH FRAME Dialog-Frame.
...
PROCEDURE valid-est-no :
    ...
    DO WITH FRAME {&FRAME-NAME}:
        ...
        IF lMiscEstimateSource AND iMiscEstimateSource EQ 1 AND CAN-FIND(FIRST b-est
            ...
            AND b-est.estimateTypeID EQ "SetSubAssembly")  THEN 
        DO:
