...
/*------------------------------------------------------------------------
    ...
    Notes       : Sakshi.Singh - Original Copy of EstimateCalcProcs.p before refactoring changes done.
                               - Due to syntax change Material .w original copy is placed in testers
  ----------------------------------------------------------------------*/
...
PROCEDURE pPromptForCalculationChanges PRIVATE:
    ...
    DO:
        ...
        RUN testers/estCostMaterialListAlt.w (INPUT-OUTPUT TABLE ttEstCostHeaderToCalc BY-REFERENCE).
