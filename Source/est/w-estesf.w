...
FIND FIRST est WHERE recid(est) = ip-est NO-LOCK NO-ERROR.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Browse|Detail|Specs|Layout|Inks/Pack|Prep/Route|Misc/Sub|Box Design|Print|Quote|Farm' + ',
                     FOLDER-TAB-TYPE = 2':U ,
             OUTPUT h_folder ).
    ...
    WHEN 2 THEN DO:
      ...
      /* RUN init-object IN THIS-PROCEDURE (
       ...
       RUN add-link IN adm-broker-hdl ( /*h_q-ordest*/ THIS-PROCEDURE , 'Record':U , h_b-estitm ).
