...
DEFINE VARIABLE fi_file         AS CHARACTER FORMAT "X(45)" INITIAL "c:~\tmp~\ExportQuote.csv" 
    LABEL "Name" 
...
DEFINE FRAME rd-fgexp
    begin_cust AT ROW 2.48 COL 23.8 COLON-ALIGNED HELP
    "Enter Beginning Customer Number" WIDGET-ID 6
    end_cust AT ROW 2.48 COL 66.8 COLON-ALIGNED HELP
    "Enter Ending Customer Number" WIDGET-ID 16
    begin_quo# AT ROW 3.52 COL 23.8 COLON-ALIGNED HELP
    "Enter Beginning Quote Number" WIDGET-ID 146
    end_quo# AT ROW 3.52 COL 66.8 COLON-ALIGNED HELP
    "Enter Ending Customer Number" WIDGET-ID 148
    begin_procat AT ROW 4.57 COL 23.8 COLON-ALIGNED HELP
    "Enter Beginning Category" WIDGET-ID 108
    end_procat AT ROW 4.57 COL 66.8 COLON-ALIGNED HELP
    "Enter Ending Category" WIDGET-ID 110
    begin_fg-procat AT ROW 5.62 COL 23.8 COLON-ALIGNED HELP
    "Enter Beginning Category" WIDGET-ID 142
    end_fg-procat AT ROW 5.62 COL 66.8 COLON-ALIGNED HELP
    "Enter Ending Category" WIDGET-ID 144
    begin_slm AT ROW 6.67 COL 23.8 COLON-ALIGNED HELP
    "Enter Beginning Sales Rep" WIDGET-ID 120
    end_slm AT ROW 6.67 COL 66.8 COLON-ALIGNED HELP
    "Enter Ending Sales Rep" WIDGET-ID 122
    begin_date AT ROW 7.71 COL 23.8 COLON-ALIGNED HELP
    "Enter Beginning Quote Date" WIDGET-ID 100
    end_date AT ROW 7.71 COL 66.8 COLON-ALIGNED HELP
    "Enter Ending Quote Date" WIDGET-ID 102
    expiration_date AT ROW 9.43 COL 50 COLON-ALIGNED HELP
    "Enter Beginning Quote Date" WIDGET-ID 152
    tb_expmatrix AT ROW 9.52 COL 30.8 RIGHT-ALIGNED WIDGET-ID 150
    tb_qtymin AT ROW 9.52 COL 90.8 RIGHT-ALIGNED WIDGET-ID 154
    sl_avail AT ROW 12.62 COL 4 NO-LABELS WIDGET-ID 26
    sl_selected AT ROW 12.62 COL 61.6 NO-LABELS WIDGET-ID 28
    Btn_Def AT ROW 12.86 COL 40.2 HELP
    "Add Selected Table to Tables to Audit" WIDGET-ID 56
    Btn_Add AT ROW 14.05 COL 40.2 HELP
    "Add Selected Table to Tables to Audit" WIDGET-ID 130
    Btn_Remove AT ROW 15.24 COL 40.2 HELP
    "Remove Selected Table from Tables to Audit" WIDGET-ID 134
    btn_Up AT ROW 16.43 COL 40.2 WIDGET-ID 136
    btn_down AT ROW 17.62 COL 40.2 WIDGET-ID 132
    tb_excel AT ROW 19.81 COL 3.8 WIDGET-ID 32
    fi_file AT ROW 20.33 COL 17.4 COLON-ALIGNED HELP
    "Enter File Name" WIDGET-ID 22
    tb_OpenCSV AT ROW 20.43 COL 83.8 RIGHT-ALIGNED WIDGET-ID 34
    tbAutoClose AT ROW 22 COL 25.2 WIDGET-ID 64
    btn-ok AT ROW 22.95 COL 25 WIDGET-ID 14
    btn-cancel AT ROW 22.95 COL 55.2 WIDGET-ID 12
    "Available Columns" VIEW-AS TEXT
    SIZE 29 BY .62 AT ROW 11.91 COL 4 WIDGET-ID 140
    "Selected Columns" VIEW-AS TEXT
    SIZE 29.2 BY .62 AT ROW 11.91 COL 61.8 WIDGET-ID 138
    " Selection Parameters" VIEW-AS TEXT
    SIZE 21 BY .71 AT ROW 1.24 COL 4 WIDGET-ID 36
    " Export Selection" VIEW-AS TEXT
    SIZE 17 BY .62 AT ROW 11.24 COL 4 WIDGET-ID 86
    RECT-6 AT ROW 11.67 COL 3 WIDGET-ID 30
    RECT-7 AT ROW 1.71 COL 3 WIDGET-ID 38
    RECT-8 AT ROW 19.67 COL 3 WIDGET-ID 84
    SPACE(1.99) SKIP(2.70)
...
ASSIGN 
    begin_cust:PRIVATE-DATA IN FRAME rd-fgexp = "parm".

ASSIGN 
    begin_date:PRIVATE-DATA IN FRAME rd-fgexp = "parm".

ASSIGN 
    begin_fg-procat:PRIVATE-DATA IN FRAME rd-fgexp = "parm".

ASSIGN 
    begin_procat:PRIVATE-DATA IN FRAME rd-fgexp = "parm".

ASSIGN 
    begin_quo#:PRIVATE-DATA IN FRAME rd-fgexp = "parm".

ASSIGN 
    begin_slm:PRIVATE-DATA IN FRAME rd-fgexp = "parm".

ASSIGN 
    end_cust:PRIVATE-DATA IN FRAME rd-fgexp = "parm".

ASSIGN 
    end_date:PRIVATE-DATA IN FRAME rd-fgexp = "parm".

ASSIGN 
    end_fg-procat:PRIVATE-DATA IN FRAME rd-fgexp = "parm".

ASSIGN 
    end_procat:PRIVATE-DATA IN FRAME rd-fgexp = "parm".

ASSIGN 
    end_quo#:PRIVATE-DATA IN FRAME rd-fgexp = "parm".

ASSIGN 
    end_slm:PRIVATE-DATA IN FRAME rd-fgexp = "parm".

ASSIGN 
    expiration_date:PRIVATE-DATA IN FRAME rd-fgexp = "parm".
...
/* SETTINGS FOR TOGGLE-BOX tb_expmatrix IN FRAME rd-fgexp
   ALIGN-R                                                              */
ASSIGN 
    tb_expmatrix:PRIVATE-DATA IN FRAME rd-fgexp = "parm".

/* SETTINGS FOR TOGGLE-BOX tb_qtymin IN FRAME rd-fgexp
   ALIGN-R                                                              */
ASSIGN 
    tb_qtymin:PRIVATE-DATA IN FRAME rd-fgexp = "parm".
...
ON HELP OF FRAME rd-fgexp /* Export Quote to Excel */
    DO:
        ...
        CASE lw-focus:NAME :
            ...
            WHEN "begin_procat" OR 
            WHEN "begin_fg-procat" THEN 
                DO:
                    ls-cur-val = lw-focus:SCREEN-VALUE.
...
PROCEDURE enable_UI :
    ...
    DISPLAY begin_cust end_cust begin_quo# end_quo# begin_procat end_procat 
        ...
        expiration_date tb_expmatrix tb_qtymin sl_avail sl_selected fi_file 
...
PROCEDURE run-report-matrix :
    ...
    FOR EACH quotehd
        ...
        ASSIGN
            ...
            v-excel-detail-lines = v-excel-detail-lines + appendXLLine(IF AVAILABLE cust THEN cust.TYPE ELSE "")
            v-excel-detail-lines = v-excel-detail-lines + appendXLLine(STRING(IF AVAILABLE itemfg THEN itemfg.procat ELSE ""))
            v-excel-detail-lines = v-excel-detail-lines + appendXLLine(quoteitm.i-no)                      
        ...
        ASSIGN   
            ...
            v-excel-detail-lines = v-excel-detail-lines + appendXLLine(IF AVAILABLE itemfg THEN itemfg.part-no ELSE "") 
            v-excel-detail-lines = v-excel-detail-lines + appendXLLine(IF AVAILABLE itemfg THEN itemfg.i-name ELSE "") 
            v-excel-detail-lines = v-excel-detail-lines + appendXLLine(IF AVAILABLE itemfg THEN itemfg.part-dscr1 ELSE "")
