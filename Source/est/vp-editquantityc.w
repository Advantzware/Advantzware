...
&Scoped-Define ENABLED-OBJECTS edit-quantities RECT-41 
...
DEFINE FRAME F-Main
     edit-quantities AT ROW 1.24 COL 2.2
...
&Scoped-define SELF-NAME edit-quantities
...
DO:
    ...
    IF VALID-HANDLE(WIDGET-HANDLE(char-hdl)) THEN
       RUN edit-quantity IN WIDGET-HANDLE(char-hdl).
END.
