...
PROCEDURE pPrintItemInfoDetail PRIVATE:
    ...
    RUN pWriteToCoordinatesString(iopiRowCount, iItemColumn3, ipbf-estCostItem.sizeDesc , 30, NO, NO, NO).
    ...
    RUN pWriteToCoordinatesString(iopiRowCount, iItemColumn3, ipbf-estCostItem.colorDesc, 41, NO, NO, NO).
