...
/*------------------------------------------------------------------------
  ...
  File: system/d-TagViewer.w

  Description: Tag Viewer dialog screen

  Input Parameters: LinkRecKey, TagType
      <none>
...
DEFINE VARIABLE h_tag AS HANDLE NO-UNDO.
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Tag Viewer */
DO:  
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'browsers/tag.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_tag ).
       RUN set-position IN h_tag ( 1.24 , 1.00 ) NO-ERROR.
       RUN set-size IN h_tag ( 14.52 , 131.00 ) NO-ERROR.

       /* Links to SmartBrowser h_tag. */
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'Query':U , h_tag ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_tag ,
             btnOk:HANDLE , 'BEFORE':U ).
    END. /* Page 0 */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pReopenQueryBrowse D-Dialog 
PROCEDURE pReopenQueryBrowse PRIVATE :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
