...
DEFINE BUTTON btnAddSession 
     LABEL "Add Additional Session" 
     SIZE 33 BY 1.14
     FONT 6.

DEFINE BUTTON btnClearOtherSessions 
...
DEFINE FRAME F-Main
     fiUserMessage AT ROW 1.95 COL 20 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     btnAddSession AT ROW 5.33 COL 3 WIDGET-ID 4
     btnClearOtherSessions AT ROW 5.33 COL 38 WIDGET-ID 6
     btnExit AT ROW 5.33 COL 74 WIDGET-ID 8
     "Choose One Option:" VIEW-AS TEXT
          SIZE 26 BY 1.43 AT ROW 3.14 COL 33 WIDGET-ID 10
          FONT 6
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 100 BY 7.95 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Session Control Question"
         HEIGHT             = 7.95
         WIDTH              = 100
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 116.4
...
/* SETTINGS FOR FRAME F-Main
   FRAME-NAME                                                           */
/* SETTINGS FOR FILL-IN fiUserMessage IN FRAME F-Main
   NO-ENABLE                                                            */
...
ON END-ERROR OF W-Win /* Session Control Question */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Session Control Question */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btnAddSession W-Win
ON CHOOSE OF btnAddSession IN FRAME F-Main /* Add Additional Session */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btnClearOtherSessions W-Win
ON CHOOSE OF btnClearOtherSessions IN FRAME F-Main /* Log Out Other Sessions */
DO:
  op-value = TRIM(SELF:label).
  RUN local-exit.
END.
