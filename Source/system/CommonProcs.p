...
&IF DEFINED(EXCLUDE-spCommon_GetJobMaterialDimensions) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE spCommon_GetJobMaterialDimensions Procedure
PROCEDURE spCommon_GetJobMaterialDimensions:
/*------------------------------------------------------------------------------
 Purpose: Code copy of rm/pol-dims.i
 Notes:
------------------------------------------------------------------------------*/
    DEFINE INPUT        PARAMETER ipcCompany      AS CHARACTER NO-UNDO.
