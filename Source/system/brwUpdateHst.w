...
&Scoped-define FIELDS-IN-QUERY-br_table fromVersion toVersion applyDate ~
startTime endTime success user_id 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTable _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      fromVersion FORMAT "x(12)":U
      toVersion FORMAT "x(12)":U
      applyDate FORMAT "99/99/9999":U
      startTime FORMAT "x(12)":U WIDTH 15.2
      endTime FORMAT "x(12)":U WIDTH 16.2
      success FORMAT "Yes/No":U
      user_id FORMAT "x(12)":U WIDTH 4
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 95 BY 15.71 FIT-LAST-COLUMN.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.fromVersion
     _FldNameList[2]   = _<SDO>.rowObject.toVersion
     _FldNameList[3]   = _<SDO>.rowObject.applyDate
     _FldNameList[4]   > _<SDO>.rowObject.startTime
"startTime" ? ? "character" ? ? ? ? ? ? no ? no no "15.2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > _<SDO>.rowObject.endTime
"endTime" ? ? "character" ? ? ? ? ? ? no ? no no "16.2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   = _<SDO>.rowObject.success
     _FldNameList[7]   > _<SDO>.rowObject.user_id
"user_id" ? ? "character" ? ? ? ? ? ? no ? no no "11" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
