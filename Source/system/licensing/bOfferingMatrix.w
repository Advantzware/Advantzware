...
&Scoped-define FIELDS-IN-QUERY-br_table iPlanLevel iOfferingCode lDefault ~
lOptional 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTable _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      iPlanLevel FORMAT ">>>9":U
      iOfferingCode FORMAT ">>>9":U
      lDefault FORMAT "Yes/No":U
      lOptional FORMAT "Yes/No":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "n:\repositories\advantzware\source\sdo\sdoofferingmatrix.w"
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.iPlanLevel
     _FldNameList[2]   = _<SDO>.rowObject.iOfferingCode
     _FldNameList[3]   = _<SDO>.rowObject.lDefault
     _FldNameList[4]   = _<SDO>.rowObject.lOptional
