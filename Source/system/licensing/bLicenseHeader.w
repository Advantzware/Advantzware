...
&Scoped-define FIELDS-IN-QUERY-br_table cSiteID cClientID cPlanLevel ~
iNumUsers dtExpiration dtUpdated cUserUpdated 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTable _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      cClientID FORMAT "x(32)":U
      cPlanLevel FORMAT "x(24)":U
      iNumUsers FORMAT ">>>>9":U
      dtExpiration FORMAT "99/99/9999 HH:MM:SS.SSS":U
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[2]   = _<SDO>.rowObject.cClientID
     _FldNameList[3]   = _<SDO>.rowObject.cPlanLevel
     _FldNameList[4]   = _<SDO>.rowObject.iNumUsers
     _FldNameList[5]   = _<SDO>.rowObject.dtExpiration
     _FldNameList[6]   = _<SDO>.rowObject.dtUpdated
     _FldNameList[7]   = _<SDO>.rowObject.cUserUpdated
