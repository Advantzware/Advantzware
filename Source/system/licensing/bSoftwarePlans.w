...
&Scoped-define FIELDS-IN-QUERY-br_table cPlanLevel iPlanLevel cDescription 
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.cPlanLevel
     _FldNameList[2]   = _<SDO>.rowObject.iPlanLevel
