...
&Scoped-define FIELDS-IN-QUERY-br_table cSiteID iPlanLevelOld iPlanLevelNew ~
iNumUsersOld iNumUsersNew cOfferingCode cOfferingCodeAction dtUpdated ~
cUserUpdated cWinUserUpdated 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTable _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      cSiteID FORMAT "x(16)":U
      iPlanLevelOld FORMAT ">>>9":U
      iPlanLevelNew FORMAT ">>>9":U
      iNumUsersOld FORMAT ">>>>9":U
      iNumUsersNew FORMAT ">>>>9":U
      cOfferingCode FORMAT "x(24)":U
      cOfferingCodeAction FORMAT "x(12)":U
      dtUpdated FORMAT "99/99/9999 HH:MM:SS.SSS":U
      cUserUpdated FORMAT "x(16)":U
      cWinUserUpdated FORMAT "x(24)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.cSiteID
     _FldNameList[2]   = _<SDO>.rowObject.iPlanLevelOld
     _FldNameList[3]   = _<SDO>.rowObject.iPlanLevelNew
     _FldNameList[4]   = _<SDO>.rowObject.iNumUsersOld
     _FldNameList[5]   = _<SDO>.rowObject.iNumUsersNew
     _FldNameList[6]   = _<SDO>.rowObject.cOfferingCode
     _FldNameList[7]   = _<SDO>.rowObject.cOfferingCodeAction
     _FldNameList[8]   = _<SDO>.rowObject.dtUpdated
     _FldNameList[9]   = _<SDO>.rowObject.cUserUpdated
     _FldNameList[10]   = _<SDO>.rowObject.cWinUserUpdated
