...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.moduleGroup ~
rowObject.module rowObject.dscr rowObject.licensed rowObject.subLevel 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTable _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.moduleGroup FORMAT "x(16)":U
      rowObject.module FORMAT "X(24)":U WIDTH 22.2
      rowObject.dscr FORMAT "X(256)":U WIDTH 80.4
      rowObject.licensed FORMAT "yes/no":U WIDTH 18.4
      rowObject.subLevel FORMAT ">>9":U WIDTH 3.4
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 137 BY 15.71 FIT-LAST-COLUMN.
...
ASSIGN 
       rowObject.subLevel:VISIBLE IN BROWSE br_table = FALSE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > _<SDO>.rowObject.moduleGroup
"rowObject.moduleGroup" ? ? "character" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > _<SDO>.rowObject.module
"rowObject.module" ? "X(24)" "character" ? ? ? ? ? ? no "?" no no "22.2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > _<SDO>.rowObject.dscr
"rowObject.dscr" ? ? "character" ? ? ? ? ? ? no ? no no "80.4" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > _<SDO>.rowObject.licensed
"rowObject.licensed" ? ? "logical" ? ? ? ? ? ? no ? no no "18.4" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > _<SDO>.rowObject.subLevel
"rowObject.subLevel" ? ? "integer" ? ? ? ? ? ? no ? no no "3.4" no no no "U" "" "" "" "" "" "" 0 no 0 no no
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE refreshQuery bTable 
