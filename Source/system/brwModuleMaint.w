...
&Scoped-define FIELDS-IN-QUERY-br_table moduleGroup module subLevel 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTable _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      moduleGroup FORMAT "x(16)":U
      module FORMAT "X(24)":U WIDTH 22.2
      subLevel FORMAT ">>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 47 BY 15.71 FIT-LAST-COLUMN.
...
"moduleGroup" ? ? "character" ? ? ? ? ? ? no "?" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > _<SDO>.rowObject.module
"module" ? "X(24)" "character" ? ? ? ? ? ? no "?" no no "22.2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > _<SDO>.rowObject.subLevel
"subLevel" ? ? "integer" ? ? ? ? ? ? no ? no no "2.6" no no no "U" "" "" "" "" "" "" 0 no 0 no no
