...
FIND FIRST userLog NO-LOCK USE-INDEX sessionID 
     WHERE userLog.sessionID  EQ iSessionToDisconnect 
...
IF iplDisconnect THEN DO:
    ...
    FIND FIRST asi._connect NO-LOCK
         WHERE asi._connect._connect-id EQ iDbUserNum
         NO-ERROR.                  
