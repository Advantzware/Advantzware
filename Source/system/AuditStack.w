...
/*------------------------------------------------------------------------
  ...
  Description: View Audit Program Stack Trace

  Input Parameters: ipcAuditStack
...
&Scoped-Define ENABLED-OBJECTS btnExit eAuditStack 
&Scoped-Define DISPLAYED-OBJECTS eAuditStack 
...
DEFINE VARIABLE eAuditStack AS CHARACTER 
     VIEW-AS EDITOR SCROLLBAR-VERTICAL
     SIZE 94 BY 15.24
     BGCOLOR 0 FGCOLOR 14 FONT 0 NO-UNDO.
...
ASSIGN 
       eAuditStack:READ-ONLY IN FRAME Dialog-Frame        = TRUE.
