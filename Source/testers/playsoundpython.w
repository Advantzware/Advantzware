...
DEFINE VARIABLE fiBad AS CHARACTER FORMAT "X(256)":U INITIAL "C:~\Asigui~\Backups~\done.mp3" 
     LABEL "Bad Sound" 
     VIEW-AS FILL-IN NATIVE 
     SIZE 70 BY 1 NO-UNDO.

DEFINE VARIABLE fiGood AS CHARACTER FORMAT "X(256)":U INITIAL "C:~\Asigui~\Backups~\done.mp3" 
     LABEL "Good Sound" 
     VIEW-AS FILL-IN NATIVE 
     SIZE 70 BY 1 NO-UNDO.
...
DO:
  ...
  def var cRunPyScript as char.   
def var cPyFile as char.

 cPyFile = "C:\Asigui\Backups\sound.py" .
 cRunPyScript  = "python " + cPyFile + " " + fibad:screen-value.
  
  os-command   value(cRunPyScript) .
END.
...
def var cPyFile as char.
 ...
 cPyFile = "C:\Asigui\Backups\sound.py" .
 cRunPyScript  = "python " + cPyFile + " " + figood:screen-value.
