...
&Scoped-Define ENABLED-OBJECTS btn-23d btn-3d 
...
DEFINE BUTTON btn-23d 
     LABEL "&CAD/2D" 
     SIZE 13 BY 1.29
     FONT 4.

DEFINE BUTTON btn-3d 
     LABEL "&3D Image" 
     SIZE 13 BY 1.29
     FONT 4.
...
DEFINE FRAME Panel-Frame
     btn-23d AT ROW 1.24 COL 2
     btn-3d AT ROW 1.24 COL 15
...
ASSIGN 
       btn-23d:PRIVATE-DATA IN FRAME Panel-Frame     = 
                "panel-image".

ASSIGN 
       btn-3d:PRIVATE-DATA IN FRAME Panel-Frame     = 
                "panel-image".
...
&Scoped-define SELF-NAME btn-23d
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn-23d C-WIn
ON CHOOSE OF btn-23d IN FRAME Panel-Frame /* CAD/2D */
DO:
...
&Scoped-define SELF-NAME btn-3d
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn-3d C-WIn
ON CHOOSE OF btn-3d IN FRAME Panel-Frame /* 3D Image */
DO:
