...
ON CHOOSE OF btn-save IN FRAME Panel-Frame /* Update */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE DisablePanel C-WIn
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE EnablePanel C-WIn
