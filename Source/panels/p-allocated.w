...
&Scoped-Define ENABLED-OBJECTS btn-allocated 
...
DEFINE FRAME Panel-Frame
     btn-allocated AT ROW 1.24 COL 2
...
ASSIGN 
       btn-allocated:PRIVATE-DATA IN FRAME Panel-Frame     = 
                "panel-image".
...
&Scoped-define SELF-NAME btn-allocated
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn-allocated C-WIn
ON CHOOSE OF btn-allocated IN FRAME Panel-Frame /* Allocated */
DO:
   ...
   IF valid-handle(widget-handle(char-hdl))
      THEN RUN pAllocated IN WIDGET-HANDLE(char-hdl).
