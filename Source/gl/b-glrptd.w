...
&Scoped-define INTERNAL-TABLES tt-rpt gl-rpt

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table tt-rpt.LINE   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table   
&Scoped-define SELF-NAME br_table
&Scoped-define QUERY-STRING-br_table FOR EACH tt-rpt, ~
                                   FIRST gl-rpt WHERE RECID(gl-rpt) EQ tt-rpt.tt-recid NO-LOCK
&Scoped-define OPEN-QUERY-br_table OPEN QUERY {&SELF-NAME} FOR EACH tt-rpt, ~
                                   FIRST gl-rpt WHERE RECID(gl-rpt) EQ tt-rpt.tt-recid NO-LOCK.
&Scoped-define TABLES-IN-QUERY-br_table tt-rpt gl-rpt
&Scoped-define FIRST-TABLE-IN-QUERY-br_table tt-rpt
&Scoped-define SECOND-TABLE-IN-QUERY-br_table gl-rpt
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 18 BY 16.43
         BGCOLOR 8 .
...
/* Query rebuild information for BROWSE br_table
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH tt-rpt,
                            FIRST gl-rpt WHERE RECID(gl-rpt) EQ tt-rpt.tt-recid NO-LOCK.
     _END_FREEFORM
...
DO:
  ...
  FIND gl-rpt WHERE RECID(gl-rpt) = tt-rpt.tt-rec NO-LOCK NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  FIND FIRST bf-rpt WHERE ROWID(bf-rpt) EQ ip-rowid NO-LOCK NO-ERROR.

  lv-recid = IF AVAIL bf-rpt THEN RECID(bf-rpt) ELSE ?.
  ...
  IF lv-recid NE ? THEN DO WITH FRAME {&FRAME-NAME}:
    ...
    IF AVAIL b-tt-rpt THEN
      REPOSITION {&browse-name} TO ROWID ROWID(b-tt-rpt) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "tt-rpt"}
  {src/adm/template/snd-list.i "gl-rpt"}
