...
DEFINE VARIABLE v-sub-1 AS CHARACTER FORMAT "x(18)":U 
     LABEL "1" 
     VIEW-AS FILL-IN 
     SIZE 28 BY 1 NO-UNDO.

DEFINE VARIABLE v-sub-10 AS CHARACTER FORMAT "x(18)":U 
     LABEL "10" 
     VIEW-AS FILL-IN 
     SIZE 28 BY 1 NO-UNDO.

DEFINE VARIABLE v-sub-11 AS CHARACTER FORMAT "x(18)":U 
     LABEL "11" 
     VIEW-AS FILL-IN 
     SIZE 28 BY 1 NO-UNDO.

DEFINE VARIABLE v-sub-12 AS CHARACTER FORMAT "x(18)":U 
     LABEL "12" 
     VIEW-AS FILL-IN 
     SIZE 28 BY 1 NO-UNDO.

DEFINE VARIABLE v-sub-2 AS CHARACTER FORMAT "x(18)":U 
     LABEL "2" 
     VIEW-AS FILL-IN 
     SIZE 28 BY 1 NO-UNDO.

DEFINE VARIABLE v-sub-3 AS CHARACTER FORMAT "x(18)":U 
     LABEL "3" 
     VIEW-AS FILL-IN 
     SIZE 28 BY 1 NO-UNDO.

DEFINE VARIABLE v-sub-4 AS CHARACTER FORMAT "x(18)":U 
     LABEL "4" 
     VIEW-AS FILL-IN 
     SIZE 28 BY 1 NO-UNDO.

DEFINE VARIABLE v-sub-5 AS CHARACTER FORMAT "x(18)":U 
     LABEL "5" 
     VIEW-AS FILL-IN 
     SIZE 28 BY 1 NO-UNDO.

DEFINE VARIABLE v-sub-6 AS CHARACTER FORMAT "x(18)":U 
     LABEL "6" 
     VIEW-AS FILL-IN 
     SIZE 28 BY 1 NO-UNDO.

DEFINE VARIABLE v-sub-7 AS CHARACTER FORMAT "x(18)":U 
     LABEL "7" 
     VIEW-AS FILL-IN 
     SIZE 28 BY 1 NO-UNDO.

DEFINE VARIABLE v-sub-8 AS CHARACTER FORMAT "x(18)":U 
     LABEL "8" 
     VIEW-AS FILL-IN 
     SIZE 28 BY 1 NO-UNDO.

DEFINE VARIABLE v-sub-9 AS CHARACTER FORMAT "x(18)":U 
     LABEL "9" 
     VIEW-AS FILL-IN 
     SIZE 28 BY 1 NO-UNDO.
...
DEFINE FRAME F-Main
     ...
     v-sub-1 AT ROW 11.95 COL 78.4 COLON-ALIGNED
     v-sub-2 AT ROW 12.91 COL 78.4 COLON-ALIGNED
     v-sub-3 AT ROW 13.86 COL 78.4 COLON-ALIGNED
     v-sub-4 AT ROW 14.81 COL 78.4 COLON-ALIGNED
     v-sub-5 AT ROW 15.76 COL 78.4 COLON-ALIGNED
     v-sub-6 AT ROW 16.71 COL 78.4 COLON-ALIGNED
     v-sub-7 AT ROW 11.95 COL 111.8 COLON-ALIGNED
     v-sub-8 AT ROW 12.91 COL 111.8 COLON-ALIGNED
     v-sub-9 AT ROW 13.86 COL 111.8 COLON-ALIGNED
     v-sub-10 AT ROW 14.81 COL 111.8 COLON-ALIGNED
     v-sub-11 AT ROW 15.76 COL 111.8 COLON-ALIGNED
     v-sub-12 AT ROW 16.71 COL 111.8 COLON-ALIGNED
