/* EDPOTran.p - generated 01/10/2001 - 13:00:01 by nosweat */
...
DO:
  PUT STREAM s-audit-rpt UNFORMATTED "?: " AT 3 ttbl_EDPOTran1.Cancel-date FORMAT "99/99/99" " (Cancel-date)".
  IF action = "UPDATE" THEN
  DO:
    IF ttbl_EDPOTran1.Cancel-date NE ttbl_EDPOTran2.Cancel-date THEN
    PUT STREAM s-audit-rpt UNFORMATTED "*" AT 1.
    PUT STREAM s-audit-rpt UNFORMATTED "?: " AT 3 ttbl_EDPOTran2.Cancel-date FORMAT "99/99/99".
  END.
END.
...
DO:
  PUT STREAM s-audit-rpt UNFORMATTED "?: " AT 3 ttbl_EDPOTran1.Misc-date1 FORMAT "99/99/99" " (Misc-date1)".
  IF action = "UPDATE" THEN
  DO:
    IF ttbl_EDPOTran1.Misc-date1 NE ttbl_EDPOTran2.Misc-date1 THEN
    PUT STREAM s-audit-rpt UNFORMATTED "*" AT 1.
    PUT STREAM s-audit-rpt UNFORMATTED "?: " AT 3 ttbl_EDPOTran2.Misc-date1 FORMAT "99/99/99".
  END.
END.
...
DO:
  PUT STREAM s-audit-rpt UNFORMATTED "?: " AT 3 ttbl_EDPOTran1.Order-date FORMAT "99/99/99" " (Order-date)".
  IF action = "UPDATE" THEN
  DO:
    IF ttbl_EDPOTran1.Order-date NE ttbl_EDPOTran2.Order-date THEN
    PUT STREAM s-audit-rpt UNFORMATTED "*" AT 1.
    PUT STREAM s-audit-rpt UNFORMATTED "?: " AT 3 ttbl_EDPOTran2.Order-date FORMAT "99/99/99".
  END.
END.
...
DO:
  PUT STREAM s-audit-rpt UNFORMATTED "?: " AT 3 ttbl_EDPOTran1.Request-date FORMAT "99/99/99" " (Request-date)".
  IF action = "UPDATE" THEN
  DO:
    IF ttbl_EDPOTran1.Request-date NE ttbl_EDPOTran2.Request-date THEN
    PUT STREAM s-audit-rpt UNFORMATTED "*" AT 1.
    PUT STREAM s-audit-rpt UNFORMATTED "?: " AT 3 ttbl_EDPOTran2.Request-date FORMAT "99/99/99".
  END.
END.
DO i = 1 TO 4:
