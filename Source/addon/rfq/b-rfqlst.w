...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      ...
      rfqitem.part-no FORMAT "x(32)":U LABEL-BGCOLOR 14
...
DEFINE FRAME F-Main
     ...
     begin_cust-no AT ROW 1.95 COL 16.8 COLON-ALIGNED NO-LABEL
     vi_part-no AT ROW 1.95 COL 31.6 COLON-ALIGNED NO-LABEL
     vi_part-dscr1 AT ROW 1.95 COL 63.6 COLON-ALIGNED NO-LABEL
     vi_style AT ROW 1.95 COL 99.8 COLON-ALIGNED NO-LABEL
     ...
     "Customer Part#" VIEW-AS TEXT
          SIZE 19 BY .62 AT ROW 1.24 COL 34.6
          FGCOLOR 9 FONT 6
     "RFQ#" VIEW-AS TEXT
          SIZE 13 BY .62 AT ROW 1.24 COL 5
          FGCOLOR 9 FONT 6
     "Style" VIEW-AS TEXT
          SIZE 9 BY .62 AT ROW 1.24 COL 103.8
          FGCOLOR 9 FONT 6
     "Part Description" VIEW-AS TEXT
          SIZE 20 BY .62 AT ROW 1.24 COL 72.6
          FGCOLOR 9 FONT 6
     "Customer" VIEW-AS TEXT
          SIZE 13 BY .62 AT ROW 1.24 COL 19.8
          FGCOLOR 9 FONT 6
