  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-issued ).
       RUN set-position IN h_b-issued ( 5.05 , 3.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updbar ).
       RUN set-position IN h_p-updbar ( 22.43 , 45.00 ) NO-ERROR.
       RUN set-size IN h_p-updbar ( 1.76 , 82.00 ) NO-ERROR.

       /* Links to SmartNavBrowser h_b-issued. */
       RUN add-link IN adm-broker-hdl ( h_p-updbar , 'TableIO':U , h_b-issued ).
