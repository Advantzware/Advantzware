...
&SCOPED-DEFINE winViewPrgmName w-rcpt

/* Parameters Definitions ---                                           */

&IF DEFINED(UIB_is_Running) EQ 0 &THEN
DEFINE INPUT PARAMETER ip-do-what AS CHARACTER NO-UNDO.
&ELSE
DEFINE VARIABLE ip-do-what AS CHARACTER NO-UNDO INITIAL 'Receipt'.
&ENDIF
...
ON END-ERROR OF W-Win /* Warehouse Transaction */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Warehouse Transaction */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updsav ).
       RUN set-position IN h_p-updsav ( 21.95 , 3.00 ) NO-ERROR.
       RUN set-size IN h_p-updsav ( 2.24 , 82.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_p-updsav , 'TableIO':U , h_b-rcptd ).
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN
    ...
    {&WINDOW-NAME}:TITLE = "Warehouse Transaction " + ip-do-what.
