...
and item.mat-type = ip-mat-type NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  case ip-mat-type :
      when "W" then lv-type-dscr = "Window/Wax".
      when "F" then lv-type-dscr = "Foil/Stamp".
      when "M" then lv-type-dscr = "Special Material".
