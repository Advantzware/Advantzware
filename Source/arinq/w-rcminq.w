...
&SCOPED-DEFINE h_Browse01 h_b-rcminq
...
DEFINE VARIABLE h_b-rcminq AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Customer Credit/Debit Memo Inquiry"
         HEIGHT             = 23.95
         WIDTH              = 151.2
         MAX-HEIGHT         = 320
         MAX-WIDTH          = 320
...
ON END-ERROR OF W-Win /* Customer Credit/Debit Memo Inquiry */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Customer Credit/Debit Memo Inquiry */
DO:
    ...
    WHEN 2 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = ?':U ,
             OUTPUT h_v-dbcr ).
       RUN set-position IN h_v-dbcr ( 4.81 , 4.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = ?':U ,
             OUTPUT h_b-dbcr2 ).
       RUN set-position IN h_b-dbcr2 ( 11.00 , 4.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-nav2 ).
       RUN set-position IN h_v-nav2 ( 21.48 , 25.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-disabl ).
       RUN set-position IN h_p-disabl ( 21.48 , 98.00 ) NO-ERROR.
       RUN set-size IN h_p-disabl ( 2.38 , 30.00 ) NO-ERROR.

       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('1':U) NO-ERROR.

       /* Links to SmartViewer h_v-dbcr. */
       RUN add-link IN adm-broker-hdl ( h_b-rcminq , 'Record':U , h_v-dbcr ).

       /* Links to SmartNavBrowser h_b-dbcr2. */
       RUN add-link IN adm-broker-hdl ( h_b-rcminq , 'inquiry':U , h_b-dbcr2 ).
       ...
       RUN add-link IN adm-broker-hdl ( h_b-rcminq , 'nav-itm':U , h_v-nav2 ).
