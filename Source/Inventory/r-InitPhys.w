...
DEFINE FRAME FRAME-A
    ...
    "Select items that are valid, problems, or all." NO-LABELS WIDGET-ID 30
    fiWhseList AT ROW 8.05 COL 1.8 COLON-ALIGNED NO-LABELS WIDGET-ID 14
    ficSnapshotDesc AT ROW 10.52 COL 1.8 COLON-ALIGNED NO-LABELS WIDGET-ID 46
    btn-ok AT ROW 12.38 COL 39.6
    btn-cancel AT ROW 12.38 COL 68
    " Selection Parameters" VIEW-AS TEXT
    SIZE 21 BY .71 AT ROW 1.05 COL 4
    "Snapshot Description" VIEW-AS TEXT
    SIZE 22 BY .62 AT ROW 9.57 COL 3.8 WIDGET-ID 48
    " Select items that are:" VIEW-AS TEXT
    SIZE 21 BY .62 AT ROW 4.24 COL 22 WIDGET-ID 34
    "Warehouse List (Comma separated):" VIEW-AS TEXT
    SIZE 36 BY .62 AT ROW 7.1 COL 3.8 WIDGET-ID 38
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    DO:
        ...
        RETURN .
    END.
    btn-ok:LOAD-IMAGE("Graphics/32x32/startInitialize.png").
