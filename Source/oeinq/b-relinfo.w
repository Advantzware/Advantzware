...
oe-rel.spare-char-1 oe-rel.tot-qty oe-rel.stat get-rel-date () @ dtRelDate
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD get-rel-date C-Win 
FUNCTION get-rel-date RETURNS DATE
    ( /* parameter-definitions */ )  FORWARD.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-1 C-Win _FREEFORM
    ...
    LABEL-BGCOLOR 14
    get-rel-date () @ dtRelDate COLUMN-LABEL "Release!Date" FORMAT "99/99/9999"
    oe-ordl.req-date COLUMN-LABEL "Order!Due Date" FORMAT "99/99/9999":U
    LABEL-BGCOLOR 14
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION get-rel-date C-Win 
FUNCTION get-rel-date RETURNS DATE
    ( /* parameter-definitions */ ) :
    /*------------------------------------------------------------------------------
      Purpose:  
