...
DEFINE VARIABLE h_pure4gltv-2 AS HANDLE NO-UNDO.
...
DEFINE BUTTON btnPopulateSmall-2 
     LABEL "Load 2nd TV" 
     SIZE 25 BY 1.14 TOOLTIP "Populate a small demo TV.  Has some addOnExpand Nodes".
...
DEFINE FRAME fMain
     ...
     edMsg AT ROW 9.33 COL 33 NO-LABEL
     btnPopulateSmall-2 AT ROW 15.05 COL 2 WIDGET-ID 2
...
DO ON ERROR UNDO, LEAVE:
  ...
  RUN addNode IN h_pure4gltv  ("n2"   ,""    ,"node 2"   ,""                    ,"expanded") NO-ERROR.
  RUN addNode IN h_pure4gltv  ("n21"  ,"n2"  ,"node 21"  ,""                    ,"")             NO-ERROR.
  RUN addNode IN h_pure4gltv  ("n22"  ,"n2"  ,"node 22"  ,"treeview/tvpics/book02.bmp"  ,"expanded") NO-ERROR.
  RUN addNode IN h_pure4gltv  ("n221" ,"n22" ,"221 dummy addOnExpand" ,"treeview/tvpics/book02.bmp"  ,"addOnExpand")             NO-ERROR.
  RUN addNode IN h_pure4gltv  ("n222" ,"n22" ,"222 real addOnExpand","treeview/tvpics/book02.bmp"  ,"addOnExpand")             NO-ERROR.
  ...
  RUN addNode IN h_pure4gltv  ("n4"   ,""    ,"node 4  returns cancelDrag"   ,"treeview/tvpics/smile56.bmp"  ,"")             NO-ERROR.
...
&Scoped-define SELF-NAME btnPopulateSmall-2
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btnPopulateSmall-2 wWin
ON CHOOSE OF btnPopulateSmall-2 IN FRAME fMain /* Load 2nd TV */
DO:
...
DO ON ERROR UNDO, LEAVE:
  RUN addNode IN h_pure4gltv-2  ("n1"   ,""    ,"node 1 (drop on another window)"   ,""                    ,"")             NO-ERROR.
  RUN addNode IN h_pure4gltv-2  ("n2"   ,""    ,"node 2"   ,""                    ,"expanded") NO-ERROR.
  RUN addNode IN h_pure4gltv-2  ("n21"  ,"n2"  ,"node 21"  ,""                    ,"")             NO-ERROR.
  RUN addNode IN h_pure4gltv-2  ("n22"  ,"n2"  ,"node 22"  ,"treeview/tvpics/book02.bmp"  ,"expanded") NO-ERROR.
  RUN addNode IN h_pure4gltv-2  ("n221" ,"n22" ,"221 dummy addOnExpand" ,"treeview/tvpics/book02.bmp"  ,"addOnExpand")             NO-ERROR.
  RUN addNode IN h_pure4gltv-2  ("n222" ,"n22" ,"222 real addOnExpand","treeview/tvpics/book02.bmp"  ,"addOnExpand")             NO-ERROR.
  RUN addNode IN h_pure4gltv-2  ("n3"   ,""    ,"node 3  dragSource option"   ,"treeview/tvpics/present1.bmp" ,"expanded" + CHR(1) + "dragSource") NO-ERROR.
  RUN addNode IN h_pure4gltv-2  ("n31"  ,"n3"  ,"node 31 nodragSource option"  ,"treeview/tvpics/$.bmp"        ,"noDragSource")             NO-ERROR.
  RUN addNode IN h_pure4gltv-2  ("n4"   ,""    ,"node 4  returns cancelDrag"   ,"treeview/tvpics/smile56.bmp"  ,"")             NO-ERROR.
  RUN addNode IN h_pure4gltv-2  ("n5"   ,""    ,"node 5  with unvalid picture file"   ,"treeview/tvpics/ThereIsNoSuchPicFile.bmp"  ,"")             NO-ERROR.
END.

DYNAMIC-FUNCTION('tvRefresh':U IN h_pure4gltv-2).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btnPopulateSmall-2 wWin
ON CURSOR-DOWN OF btnPopulateSmall-2 IN FRAME fMain /* Load 2nd TV */
DO:
...
FOR EACH salesrep NO-LOCK BY salesrep.repname:
    ...
    RUN addNode IN h_pure4gltv ("sr=" + salesrep.salesrep
                               ,""
                               ,salesrep.repname
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN constructObject (
             ...
             OUTPUT h_pure4gltv-2 ).
       RUN repositionObject IN h_pure4gltv-2 ( 9.33 , 2.00 ) NO-ERROR.
       RUN resizeObject IN h_pure4gltv-2 ( 5.71 , 29.00 ) NO-ERROR.
       ...
       RUN adjustTabOrder ( h_pure4gltv-2 ,
             updOptn:HANDLE IN FRAME fMain , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  ENABLE rectUpd btnPopulateSmall BtnPopulateMore cSelectNode sortChildren 
         btnPopulateWide bPopulateLargeTree giRowsToBatch btnFocusInfo 
         ...
         btnClearEditor btnDumpNodeTable updOptn edMsg btnPopulateSmall-2 
      WITH FRAME fMain IN WINDOW wWin.
...
------------------------------------------------------------------------------*/
  ...
  /* to illustrate 2 TV with 2nd as drop target */
  APPLY 'CHOOSE' TO btnPopulateSmall.
  APPLY 'CHOOSE' TO btnPopulateSmall-2.
...
ELSE DO:
    ...
    {get ContainerHandle hContainerHandle h_pure4gltv-2}.
    
    DO iCount = 4 TO NUM-ENTRIES(pcEvent):
        hWidget = WIDGET-HANDLE(ENTRY(iCount,pcEvent)) NO-ERROR.
        
        IF hWidget = hContainerHandle THEN DO:
            MESSAGE 'DROP ON 2nd TV'
                VIEW-AS ALERT-BOX INFO BUTTONS OK.
            /* now let's guess on what node if any beloow the mouse cursor */
            targetKe = DYNAMIC-FUNCTION('getNodeLocatedAtXY' IN h_pure4GlTv-2
                                        , mouseX - hContainerHandle:X
                                        , mouseY - hContainerHandle:Y).
            MESSAGE 'targetKe = ' targetKe
                VIEW-AS ALERT-BOX INFO BUTTONS OK.
        END.
