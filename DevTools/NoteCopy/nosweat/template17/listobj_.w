...
"NoSweat SmartListObject Template.

Use this template to create a SmartListObject that can contain basic objects (and nothing else)."
*/
&ANALYZE-RESUME
...
&Scoped-Define ENABLED-OBJECTS RECT-1 list-order RECT-2 begin_name end_name 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_name ~
begin_name_description end_name end_name_description F1 F-2 F-3 F-4 
...
DEFINE VARIABLE begin_name AS CHARACTER FORMAT "X(10)" 
...
DEFINE VARIABLE end_name AS CHARACTER FORMAT "X(10)" 
     LABEL "Ending <Name>" 
     VIEW-AS FILL-IN 
     SIZE 15.6 BY 1.
...
DEFINE FRAME F-Main
     ...
     begin_name AT ROW 4.81 COL 45 COLON-ALIGNED HELP
          "Enter Beginning <Name>"
     begin_name_description AT ROW 6 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Description"
     end_name AT ROW 8.14 COL 45 COLON-ALIGNED HELP
          "Enter Ending <Name>"
     end_name_description AT ROW 9.33 COL 45 COLON-ALIGNED HELP
...
Welcome to the SmartListObject Wizard! During the next few steps, the wizard will lead you through creating a SmartListObject. You will need to define External Tables. Press Next to proceed.
nosweat/_wizntro.w,nosweat/_wizxtbl.w,adm/support/_wizend.w 
*/
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
