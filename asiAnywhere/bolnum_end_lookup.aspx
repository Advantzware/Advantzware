<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bolnum_rep_lookup.aspx.cs" Inherits="bolnum_rep_lookup" Title="Invoice LookUp"%>
...
<body>
    ...
    <div><asp:Panel ID="panelsearch" runat="server" DefaultButton="btnSearch">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
            ...
            <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.bolnumendlook('<%#DataBinder.Eval(Container,"DataItem.ArBol")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
