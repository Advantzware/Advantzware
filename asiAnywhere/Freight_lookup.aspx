<%@ Page Language="C#" AutoEventWireup="true" Inherits="freight_lookup" Codebehind="Freight_lookup.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Freight Lookup</title>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800">&nbsp;                
                <B>Search for:&nbsp; </B>&nbsp;&nbsp;&nbsp;
                  <asp:dropdownlist id="ddlSearchField" runat="server">
                    <asp:ListItem Value="freight">Freight Class</asp:ListItem>
                      <asp:ListItem Value="dscr">Freight Desc</asp:ListItem>  
        ...
        <asp:GridView ID="GridView1" AllowPaging="True" AllowSorting="True" runat="server" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1"
            ...
            <Columns>
                <asp:TemplateField>
                    ...
                    <ItemTemplate>       
		                <a href="#" onClick="javascript:top.opener.window.FreightLookup('<%#DataBinder.Eval(Container,"DataItem.frtclass")%>', '<%#DataBinder.Eval(Container,"DataItem.frtclass-dscr")%>');window.close();">Select</a>             	    
                    </ItemTemplate>
                </asp:TemplateField> 
                
                <asp:BoundField DataField="frtclass" HeaderText="Freight Class" SortExpression="frtclass" />
                <asp:BoundField DataField="frtclass-dscr" HeaderText="Freight Class Description" SortExpression="frtclass-dscr" />                                
            </Columns>
        </asp:GridView>
        <input type="button" name="close" class="buttonM" id="close" value="Close" onclick="javascript:window.close()" />
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="FreightclassLookup" TypeName="LookUp">
            <SelectParameters>               
