<%@ Page Language="C#" AutoEventWireup="true" Inherits="spec_lookup" Title="Spec Lookup" Codebehind="~/spec_lookup.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Spec Lookup</title>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800">&nbsp;                
                <B>Search for:&nbsp; </B>&nbsp;&nbsp;&nbsp;
                  <asp:dropdownlist id="ddlSearchField" runat="server">
                      ...
                      <asp:ListItem Value="code">Spec Code</asp:ListItem>
                      <asp:ListItem Value="dscr">Notes</asp:ListItem>                      
                  </asp:dropdownlist>&nbsp;&nbsp;
    ...
    <div>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		                 <a href="#" onClick="javascript:top.opener.window.TopSpecLookUp('<%#DataBinder.Eval(Container,"DataItem.vCode")%>', '<%#DataBinder.Eval(Container,"DataItem.vDscr")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
         SelectMethod="SpecLook" TypeName="LookUp">
            <SelectParameters>
