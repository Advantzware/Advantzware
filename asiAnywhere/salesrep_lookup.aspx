<%@ Page Language="C#" AutoEventWireup="true" Inherits="salesrep_lookup" Codebehind="salesrep_lookup.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Sales Rep Lookup</title>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800">&nbsp;                
                <B>Search for:&nbsp; </B>&nbsp;&nbsp;&nbsp;
                  <asp:dropdownlist id="ddlSearchField" runat="server">               
                      <asp:ListItem Value="sman">Sales Rep#</asp:ListItem>                                             
                  </asp:dropdownlist>&nbsp;&nbsp;
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.SalesRepLookup('<%#DataBinder.Eval(Container,"DataItem.vSaleman")%>','<%#DataBinder.Eval(Container,"DataItem.vSsname")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>     
                 <asp:BoundField DataField="vSaleman" HeaderText="Sales Rep#" SortExpression="vSaleman" />
                 <asp:BoundField DataField="vSsname" HeaderText="Name" SortExpression="vSsname" />
                
            </Columns>
        </asp:GridView>
        <input type="button" name="close" class="buttonM" id="close" value="Close" onclick="javascript:window.close()" />
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="SelSalesRep" TypeName="LookUp">
            <SelectParameters>               
