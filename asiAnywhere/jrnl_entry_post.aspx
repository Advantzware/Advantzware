<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="jrnl_entry_post" Codebehind="~/jrnl_entry_post.aspx.cs" %>
<%@ Register Src="footer.ascx" TagName="Footer" TagPrefix="ft" %>
<%@ Register Src="header.ascx" TagName="Header" TagPrefix="hd" %>
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head id="Head1" runat="server">
    <title>Journal Entries Edit/Posting Register</title>  
...
<script language="javascript">
    function confirmPost() {
        var retVal = makeMsgBox("Confirmation", "Are you ready to post Journal?", 48, 4, 256, 4096);
        if (retVal == 6) {
    ...
    <form id="frmList" runat="server"  defaultfocus='begstatTextBox'>   
      ...
      <TABLE id="tblTop" cellSpacing="3" align="center" border="0" Width="100%">
        <TR>
          ...
          <TD align=center nowrap><font size=+0><b>Journal Entries Edit/Posting Register &nbsp;</b></font></TD>
      ...
      <table class="shade" width="580px">
       
      <tr><td align="right" style="padding-right: 5px"><b>Beginning Journal#:</b></td><td>
          <asp:TextBox ID="begjrnlTextBox"  width="100px" MaxLength="8" runat="server"></asp:TextBox>         
          </td>
      <td align="right" style="padding-right: 5px"><b>Ending Journal#:</b></td>
      <td nowrap>
        <asp:TextBox ID="endjrnlTextBox" width="100px" MaxLength="8" runat="server"></asp:TextBox>        
      </td>
        </tr>
        ...
        <td align="right" style="padding-right: 5px"><b>Sort By?:</b></td>
        <td colspan="2"><b><asp:RadioButtonList ID="RadioButtonList1" RepeatLayout="Flow"  CellSpacing="1" RepeatColumns="5" Font-Bold ="true" runat="server">
                 ...
                 <asp:ListItem  Value="Account#"    Text="Account#" />
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>OutPut To?:</b> <asp:RadioButtonList ID="RadioButtonList3" RepeatLayout="Flow"  CellSpacing="1" RepeatColumns="5" Font-Bold ="true" runat="server">
         ...
         <tr><td colspan="2">
          ...
          <asp:FormView ID="FormView1" runat="server" Visible="false" DataSourceID="ObjectDataSource1">
              ...
              <ItemTemplate>
                  gljrn:
                  <asp:Label ID="gljrnLabel" runat="server" Text='<%# Bind("gljrn") %>' />
                  <br />
                  post:
          ...
          <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
               SelectMethod="GlJrnPosting" TypeName="ledger">
              <SelectParameters>
                  <asp:Parameter Name="prmUser" Type="String" />
                  <asp:Parameter Name="prmAction" DefaultValue="journal" Type="String" />
                  <asp:Parameter Name="prmBeginjou" Type="String" />
                  <asp:Parameter Name="prmEndjou" Type="String" />
