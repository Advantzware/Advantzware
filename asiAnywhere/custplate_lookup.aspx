<%@ Page Language="C#" AutoEventWireup="true" Inherits="custplate_lookup" Codebehind="custplate_lookup.aspx.cs" %>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800">&nbsp;                
    ...
    <div>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.plateLookup('<%#DataBinder.Eval(Container,"DataItem.vmat")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField> 
                <asp:BoundField DataField="vmat" HeaderText="Type" SortExpression="vmat" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="SePalletLook" TypeName="LookUp">
            <SelectParameters>               
