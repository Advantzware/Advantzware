<%@ Page Language="C#" AutoEventWireup="true" Inherits="custcarr_lookup " Title="Carrier Information(Window)" Codebehind="custcarr_lookup.aspx.cs" %>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" >&nbsp;                
    ...
    <div>
            ...
            <Columns>
             <asp:TemplateField>
                  <ItemStyle HorizontalAlign="Center" Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick = "javascript:top.opener.window.Carrlookup('<%#DataBinder.Eval(Container,"DataItem.carrier")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
         SelectMethod="CustCarrLookup" TypeName="LookUp" OnSelecting="ObjectDataSource1_Selecting">
            <SelectParameters>            
              ...
              <asp:Parameter Name="prmUser" Type="String" />
                ...
                <asp:QueryStringParameter QueryStringField="loc" Name="prmLoc" Type="string" />
