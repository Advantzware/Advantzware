<%@ Page Language="c#" AutoEventWireup="true" Debug="true" Inherits="view_apinv_inquiry" Codebehind="view_apinv_inquiry.aspx.cs" %>
  ...
  <head id="Head1" runat="server">
   ...
   <body>
    <form id="frmList" runat="server"  defaultfocus='Inv_TextBox'>   
      ...
      <li class="selected"><asp:LinkButton ID="lnk_viewcustomers" runat="server" OnClick="lnk_viewcustomers_Click" >View Invoices</asp:LinkButton></li></ul></div>
       ...
       <div>
           <asp:FormView ID="FormView1" runat="server" OnDataBound="FormView1_OnDataBound" DataSourceID="ObjectDataSource1">
               ...
               <td><asp:TextBox ID="invnoTextBox" Width="100px" onfocus= "javascript:focusval(this)" onblur="javascript:blurval(this)" runat="server" Text='<%# Bind("invno") %>' /></td>
               ...
               <td><asp:TextBox ID="invdateTextBox" runat="server" Width="100px" onfocus="javascript:preEnter( this, 'yes' );" onblur="javascript:preLeave( this, 'date', '99/99/9999' );" Text='<%# Bind("invdate") %>' />
               <a href="#" tabindex="1" onClick="showCalendarControl(FormView1_invdateTextBox); return false"><asp:Image ID="Image1" runat="server" ImageUrl="images/lookup_icon.gif" /></a></td>
               <td colspan="2"><b>Discount%:</b> &nbsp; &nbsp; <asp:TextBox ID="discountTextBox" onfocus= "javascript:focusval(this)" onblur="javascript:blurval(this)" runat="server" Width="100px" Text='<%# Bind("discount") %>' /></td></tr>
               <tr><td align="right" style="padding-right:5px"><b>Due Date:</b></td>
               <td><asp:TextBox ID="duedateTextBox" runat="server" Width="100px" onfocus="javascript:preEnter( this, 'yes' );" onblur="javascript:preLeave( this, 'date', '99/99/9999' );" Text='<%# Bind("duedate") %>' />
               <a href="#" tabindex="1" onClick="showCalendarControl(FormView1_duedateTextBox); return false"><asp:Image ID="Image3" runat="server" ImageUrl="images/lookup_icon.gif" /></a></td>
               ...
               <tr><td><input id="Button2" type="button" onclick="exrateclick()" value="Exrate" /></td><td></td><td></td>
               ...
               <tr><td align="right" style="padding-right:5px"><b>Due Date:</b></td>
               <td><asp:TextBox ID="duedateTextBox" runat="server" Width="100px" onfocus="javascript:preEnter( this, 'yes' );" onblur="javascript:preLeave( this, 'date', '99/99/9999' );" Text='<%# Bind("duedate") %>' />
               <a href="#" tabindex="1" onClick="showCalendarControl(FormView1_duedateTextBox); return false"><asp:Image ID="Image5" runat="server" ImageUrl="images/lookup_icon.gif" /></a></td>
               <td><b>Day:</b> &nbsp;&nbsp;  <asp:TextBox ID="discdaysTextBox" Width="50px" onfocus= "javascript:focusval(this)" onblur="javascript:blurval(this)" runat="server" Text='<%# Bind("discdays") %>' /></td>
               <td><b>manual Check#</b></td></tr>
               <tr><td><input id="Button2" type="button" onclick="exrateclick()" value="Exrate" /></td><td></td><td></td>
               <td><asp:TextBox ID="mnulchecTextBox" onfocus= "javascript:focusval(this)" onblur="javascript:blurval(this)" runat="server" Width="100px" Text='<%# Bind("mnulchec") %>' /></td></tr>
               </table>
               </td>
               <td><fieldset>
               <table><tr><td align="right" style="padding-right:5px"><b>Tax:</b></td><td><asp:TextBox ID="taxamtTextBox" Width="100px" onfocus= "javascript:focusval(this)" onblur="javascript:blurval(this)" runat="server" Text='<%# Bind("taxamt") %>' /></td></tr>
               ...
               <td colspan="2"><asp:Label ID="vendnameLabel" BackColor="Turquoise" Width="200" runat="server" Text='<%# Bind("vendname") %>' /></td></tr>
               <tr><td align="right" style="padding-right:5px"><b>Invoice#:</b></td>
               <td><asp:Label ID="invnoLabel" BackColor="Turquoise" Width="100" runat="server" Text='<%# Bind("invno") %>' /></td>
               ...
               <tr><td align="right" style="padding-right:5px"><b>Invoice Date:</b></td>
               <td><asp:Label ID="invdateLabel" BackColor="Turquoise" Width="100" runat="server" Text='<%# Bind("invdate") %>' /></td>
               <td colspan="2"><b>Discount%:</b> &nbsp; &nbsp; <asp:Label ID="discountLabel" BackColor="Turquoise" Width="100" runat="server" Text='<%# Bind("discount") %>' /></td></tr>
               <tr><td align="right" style="padding-right:5px"><b>Due Date:</b></td>
               <td><asp:Label ID="duedateLabel" BackColor="Turquoise" Width="100" runat="server" Text='<%# Bind("duedate") %>' /></td>
               <td><b>Day:</b> &nbsp;&nbsp;  <asp:Label ID="discdaysLabel" BackColor="Turquoise" Width="50" runat="server" Text='<%# Bind("discdays") %>' /></td>
               <td><b>Manual Check#</b></td></tr>
               <tr><td> <input id="Button2" type="button" disabled="disabled" onclick="exrateclick()" value="Exrate" />
               </td><td></td><td></td>
           ...
           <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                ...
                <SelectParameters>
                   ...
                   <asp:Parameter Name="prmFreight" Type="Decimal" />
                    <asp:SessionParameter SessionField="vendor_invoice_reckey_rec" Name="prmReckey" Type="String" />
                </SelectParameters>
        ...
        <AlternatingRowStyle CssClass="GridItemOdd" />
           ...
           <asp:FormView ID="FormView2" runat="server" OnDataBound="FormView2_OnDataBound" DataSourceID="ObjectDataSource3">
               <EditItemTemplate>
                   ...
                   <td>
                   <asp:TextBox ID="inv_qtyTextBox" runat="server" onfocus= "javascript:focusval(this)" onblur="javascript:blurval(this)" Width="70px"  MaxLength="9" Text='<%# Bind("[inv-qty]") %>' />
                   ...
                   <td><asp:TextBox ID="unit_priceTextBox" runat="server" onfocus= "javascript:focusval(this)" onblur="javascript:blurval(this)" Width="70px" MaxLength="10"  Text='<%# Bind("[unit-price]") %>' />
                   ...
                   <td nowrap><asp:TextBox ID="qty_uom_priTextBox" runat="server" onfocus= "javascript:focusval(this)" onblur="javascript:blurval(this)" Width="30px" MaxLength="3" Text='<%# Bind("[qty-uom-pri]") %>' />
                   ...
                   <td><asp:TextBox ID="amtTextBox" runat="server" onfocus= "javascript:focusval(this)" onblur="javascript:blurval(this)" Width="80px" MaxLength="10"  Text='<%# Bind("amt") %>' />
           ...
           <asp:ObjectDataSource ID="ObjectDataSource3" runat="server" 
               ...
               <SelectParameters>
                   ...
                   <asp:SessionParameter SessionField="view_inv_vendor_reckey" Name="prmReckey"  Type="String" />
               </SelectParameters>
           </asp:ObjectDataSource>
           ...
           <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" 
               ...
               <SelectParameters>
                   ...
                   <asp:SessionParameter DefaultValue="" Name="prmReckey" SessionField="vendor_invoice_reckey_rec" 
                       Type="String" />
               </SelectParameters>
           </asp:ObjectDataSource>
       </div>
