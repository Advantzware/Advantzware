<%@ Page Language="C#" AutoEventWireup="true" Inherits="InvNum_lookup" Title="Invoice LookUp" Codebehind="InvNum_lookup.aspx.cs" %>
...
<body>
    ...
    <div><asp:Panel ID="panelsearch" runat="server" DefaultButton="Button1">
                ...
                <B>Search for:&nbsp; </B>&nbsp;&nbsp;&nbsp;
                  <asp:dropdownlist id="ddlSearchField" runat="server" AutoPostBack="true" OnSelectedIndexChanged="searchindexchanged">
                    <%--<asp:ListItem Value="ANY">ANY</asp:ListItem>--%>
                      <asp:ListItem Value="inv-no">INVOICE#</asp:ListItem>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
            ...
            <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.InvNumLookup('<%#DataBinder.Eval(Container,"DataItem.ArInv")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="ArInv" HeaderText="Invoice#" SortExpression="ArInv" />
                <asp:BoundField DataField="ArInvItem" HeaderText="Item Number" SortExpression="ArInvItem" />
                <asp:BoundField DataField="ArInvName" HeaderText="Item Name" SortExpression="ArInvName" />
                
            </Columns>
        </asp:GridView>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
         SelectMethod="InvNum" TypeName="Order">
            <SelectParameters>
