<%@ Page Language="C#" AutoEventWireup="true" Inherits="job1_lookup" Title ="Job1 LookUp" Codebehind="job1_lookup.aspx.cs" %>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800">&nbsp;                
                <B>Search for:&nbsp; </B>&nbsp;&nbsp;&nbsp;
                  ...
                  <asp:dropdownlist id="ddlSearchOperation" runat="server">            
                    <asp:ListItem Value="BEGIN">EQUAL</asp:ListItem>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
            ...
            <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.Job1Lookup('<%#DataBinder.Eval(Container,"DataItem.JOB")%>','<%#DataBinder.Eval(Container,"DataItem.JOB2")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
