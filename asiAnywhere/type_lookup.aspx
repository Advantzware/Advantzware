<%@ Page Language="C#" AutoEventWireup="true" Inherits="type_lookup" Codebehind="type_lookup.aspx.cs" %>
...
<body>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800">&nbsp;                
                <B>Search for:&nbsp; </B>&nbsp;&nbsp;&nbsp;
                  <asp:dropdownlist id="ddlSearchField" runat="server">
                    <%--<asp:ListItem Value="Any">Any</asp:ListItem>--%>
                      <asp:ListItem Value="custype">Cust Type</asp:ListItem>  
    ...
    <div>
        <asp:GridView ID="GridView1" runat="server" AllowPaging="true" PageSize="10" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1"
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.TypeLookup('<%#DataBinder.Eval(Container,"DataItem.vCustype")%>','<%#DataBinder.Eval(Container,"DataItem.vDscr")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>            

                 <asp:BoundField DataField="vCustype" HeaderText="Customer Type" SortExpression="vCustype" />
                <asp:BoundField DataField="vDscr" HeaderText="Description" SortExpression="vDscr" />
                <asp:BoundField DataField="vCommrate" HeaderText="Commorate" SortExpression="vCommrate" />
                <asp:BoundField DataField="vDiscount" HeaderText="Discount" SortExpression="vDiscount" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="SelCustype" TypeName="LookUp">
            <SelectParameters>               
