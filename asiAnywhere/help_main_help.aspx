<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="help_main_help" Codebehind="help_main_help.aspx.cs" %>
...
//    
   ...
   <body>
    ...
    <td><div  id="navigation" style="width:100%">
        ...
        <asp:LinkButton ID="lnk_listsic" runat="server"  OnClick="lnk_listsic_Click" >Browse Help</asp:LinkButton></li>
        <li><asp:LinkButton ID="lnk_viewsic" runat="server"  OnClick="lnk_viewsic_Click">View Help</asp:LinkButton></li></ul></div>
      ...
      <asp:linkbutton id="btnDelete" runat="server" OnClick="btnDelete_Click">Delete selected</asp:linkbutton>
            ...
            <asp:GridView id="dbGrid_help_main" runat="server" CssClass="Grid" Width="600px"
