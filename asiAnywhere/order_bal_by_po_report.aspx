<%@ Page Language="c#" AutoEventWireup="true" Debug="true" Inherits="order_bal_by_po_report" Codebehind="~/order_bal_by_po_report.aspx.cs" %>
<%@ Register Src="footer.ascx" TagName="Footer" TagPrefix="ft" %>
<%@ Register Src="header.ascx" TagName="Header" TagPrefix="hd" %>
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head id="Head1" runat="server">
    <title>Order Balance By PO#</title>
    ...
    <form id="frmList" runat="server"  defaultfocus='TextBox1'>   
      ...
      <TABLE id="tblTop" cellSpacing="3" align="center" border="0" Width="100%">
        <TR>
          ...
          <TD align=center nowrap><font size=+0><b>Order Balance By PO# Report &nbsp;</b></font></TD>
      ...
      <td>
        ...
        <table class="shade" width="700px">
           ...
           </b><br/><b><asp:CheckBox ID="CheckBox_SchRel" runat="server" Text="Show Scheduled Releases?" /></b></td>
           <td>
           <fieldset>
           <table>
           <tr>
        ...
        <asp:FormView ID="FormView1" Visible="false"   runat="server" DataSourceID="ObjectDataSource1">
              ...
              <ItemTemplate>
                  vBalFile:
                  <asp:Label ID="vBalFileLabel" runat="server" Text='<%# Bind("vBalFile") %>'></asp:Label><br />
                  vtextfile:
                  <asp:Label ID="vtextfileLabel" runat="server" Text='<%# Bind("vtextfile") %>'></asp:Label><br />
                  vFile:
          ...
          <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
               SelectMethod="BalancePo" TypeName="reports">
              <SelectParameters>
