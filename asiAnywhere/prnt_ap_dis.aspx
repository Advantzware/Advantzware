<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="prnt_ap_dis" Codebehind="prnt_ap_dis.aspx.cs" %>
<%@ Register Src="footer.ascx" TagName="Footer" TagPrefix="ft" %>
<%@ Register Src="header.ascx" TagName="Header" TagPrefix="hd" %>
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head id="Head1" runat="server">
    <title>Cash Disbursements Register</title>
...
<script language="javascript">
    function confirmPost() {
        var retVal = makeMsgBox("Confirmation", "Post Cash Disbursements?", 48, 4, 256, 4096);
        if (retVal == 6) {
...
function blurval(obj) {
    ...
    function vendtext() {
        var memo = document.getElementById("begdateTextBox");
        memo.focus();
    }
    function periodtext() {
    ...
    <form id="frmList" runat="server"  defaultfocus='postdateTextBox'>   
      ...
      <TABLE id="tblTop" cellSpacing="3" align="center" border="0" Width="100%">
        <TR>
          ...
          <TD align=left nowrap><font size=+0><b>Cash Disbursements Register&nbsp;</b></font></TD>
      ...
      <b>Period:</b></td>
            ...
            <tr><td style="width:380px;" align="right" >      
            <fieldset style="width:450px; color:Blue">
            <legend>DATE RANGE AND SORTING ORDER:</legend>
            <table><tr><td>
            <table><tr><td></td>
            <td colspan="2" align="right" style="padding-right: 5px"><b>Begining Date:</b></td>
            <td><asp:TextBox  ID="begdateTextBox" onfocus="this.select();javascript:preEnter( this, 'yes' );" onblur="javascript:preLeave( this, 'date', '99/99/9999' );periodtext()"  Width="100px" runat="server"></asp:TextBox>        
            ...
            <td></td><td colspan="2" align="right" style="padding-right: 5px"><b>Ending Date:</b></td>
            <td><asp:TextBox  ID="enddateTextBox" onfocus="this.select();javascript:preEnter( this, 'yes' );" onblur="javascript:preLeave( this, 'date', '99/99/9999' );periodtext()"  Width="100px" runat="server"></asp:TextBox>          
            <a href="#" onblur="document.getElementById('enddateTextBox').focus()"  tabindex="1" onClick="showCalendarControl(enddateTextBox); return false"><asp:Image ID="Image1" runat="server" ImageUrl="images/lookup_icon.gif" /></a>
            </td></tr></table>
            
            <tr><td align="center"><table>
            &nbsp; &nbsp; &nbsp; &nbsp;<b>Sort by?   <asp:RadioButtonList ID="RadioButtonList1" RepeatLayout="Flow" CellSpacing="1" RepeatColumns="2"  Font-Bold ="true" runat="server" >                                                      
                            <asp:ListItem  Value="vendor#"    Text="Vendor#" /> 
                            <asp:ListItem   Value="sequence" Text="Sequence" />                                                                
        ...
        <tr></tr><tr></tr>        
          ...
          <asp:FormView ID="FormView1" Visible="false"  runat="server" 
              ...
              <ItemTemplate>
                  apdis:
                  <asp:Label ID="apdisLabel" runat="server" 
                      Text='<%# Bind("apdis") %>'></asp:Label><br />                 
                  
              </ItemTemplate>                            
          </asp:FormView>
          
          <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
              SelectMethod="SelectDisbursementRegister" TypeName="voucherpay">
              <SelectParameters>
                  <asp:Parameter Name="prmUser" Type="String" />
                  <asp:Parameter Name="prmapdis" Type="String" />                  
                  ...
                  <asp:Parameter Name="prmvndseq" Type="String" />
