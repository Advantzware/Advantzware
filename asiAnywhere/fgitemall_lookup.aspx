<%@ Page Language="C#" AutoEventWireup="true" Inherits="fgitemall_lookup" Codebehind="fgitemall_lookup.aspx.cs" %>
...
<body>
  ...
  <fieldset><br /><br />
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <asp:Button ID="Button_rm" runat="server" class="buttonM" Width="120px" OnClick="Button_rm_Click" Text="RM Item" /> <br /><br />
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     <asp:Button ID="Button_fg" OnClick="Button_fg_Click" Width="120px" class="buttonM" runat="server" Text="Fg Item" /><br />
      <br />
  </fieldset>
  </div>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800">&nbsp;                
    ...
    <div id="gridviewdiv" runat="server">
        <asp:GridView ID="GridView1"  AllowPaging="True" runat="server" AllowSorting="True" OnRowCreated="GridView2_RowCreated" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1"
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.FGallLookup('<%#DataBinder.Eval(Container,"DataItem.idscr")%>','<%#DataBinder.Eval(Container,"DataItem.item-type")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField> 
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            ...
            <SelectParameters>               
                ...
                <asp:SessionParameter Name="prmType" SessionField="fgitemall_lookup_type" Type="String"  />
