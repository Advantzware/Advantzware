...
<%@ Page Language="C#" AutoEventWireup="true" Inherits="customer2_lookup" Title="Customer2 Lookup" Codebehind="customer2_lookup.aspx.cs" %>
            ...
            <Columns > 
              <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.Customer2Lookup('<%#DataBinder.Eval(Container,"DataItem.Customer")%>','<%#DataBinder.Eval(Container,"DataItem.Name")%>','<%#DataBinder.Eval(Container,"DataItem.fob-code")%>','<%#DataBinder.Eval(Container,"DataItem.sname")%>','<%#DataBinder.Eval(Container,"DataItem.city")%>','<%#DataBinder.Eval(Container,"DataItem.state")%>','<%#DataBinder.Eval(Container,"DataItem.zip")%>','<%#DataBinder.Eval(Container,"DataItem.sman")%>','<%#DataBinder.Eval(Container,"DataItem.Address1" )%>', '<%#DataBinder.Eval(Container,"DataItem.Address2")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
