        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
            ...
            <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.Adder3LookUp('<%#DataBinder.Eval(Container,"DataItem.AddIno")%>','<%#DataBinder.Eval(Container,"DataItem.AddIname")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
