<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="FoldEstimatePrint" Codebehind="~/FoldEstimatePrint.aspx.cs" %>
      ...
      <tr><td colspan="2">
          ...
          <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
              ...
              <SelectParameters>
                  ...
                  <asp:SessionParameter SessionField="order_folding_est" Name="prmEstimate" Type="String" />
                  <asp:SessionParameter SessionField="order_folding_formno" Name="prmFormno" Type="int32" />
                  <asp:SessionParameter SessionField="order_folding_blankno" Name="prmBlankno" Type="int32" />
                  <asp:SessionParameter SessionField="fold_print_line" Name="prmLine" Type="int32" />
              </SelectParameters>
          </asp:ObjectDataSource>            
    </div>
    </form>
