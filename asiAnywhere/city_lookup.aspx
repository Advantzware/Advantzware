<%@ Page Language="C#" AutoEventWireup="true" Inherits="city_lookup" Codebehind="city_lookup.aspx.cs" %>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.CityCodeLookup('<%#DataBinder.Eval(Container,"DataItem.vCity")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>            
