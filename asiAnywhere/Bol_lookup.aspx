<%@ Page Language="C#" AutoEventWireup="true" Inherits="Bol_lookup" Title="Bol LookUp" Codebehind="Bol_lookup.aspx.cs" %>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
            ...
            <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.BolNumLookup('<%#DataBinder.Eval(Container,"DataItem.BolNum")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="BolNum" HeaderText="Bol#" SortExpression="BolNum" />
                <asp:BoundField DataField="BolItem" HeaderText="Item Number" SortExpression="BolItem" />
                
                
            </Columns>
        </asp:GridView>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
         SelectMethod="Bol" TypeName="Order">
            <SelectParameters>
