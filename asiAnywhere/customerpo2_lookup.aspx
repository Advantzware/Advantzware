<%@ Page Language="C#" AutoEventWireup="true" Inherits="customerpo2_lookup" Codebehind="customerpo2_lookup.aspx.cs" %>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
            ...
            <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.CustomerPO2Lookup('<%#DataBinder.Eval(Container,"DataItem.CustPo")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
