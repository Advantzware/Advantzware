<%@ Page Language="C#" AutoEventWireup="true" Inherits="customerpo_entry_lookup" Codebehind="customerpo_entry_lookup.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>CustomerPo Lookup</title>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800">&nbsp;                
                <B>Search for:&nbsp; </B>&nbsp;&nbsp;&nbsp;
                  <asp:dropdownlist id="ddlSearchField" runat="server">
                      <asp:ListItem Value="po-no">PO NUM</asp:ListItem>  
                      <asp:ListItem Value="cust-no">CUST#</asp:ListItem>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
            ...
            <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.CustomerPOLookup('<%#DataBinder.Eval(Container,"DataItem.CustPo")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="CustPo" HeaderText="P.O. Num" SortExpression="CustPo" />
                <asp:BoundField DataField="Number" HeaderText="Cust #" SortExpression="Number" />
            </Columns>
        </asp:GridView>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="SelectCustPoLook" TypeName="Order">
            <SelectParameters>
