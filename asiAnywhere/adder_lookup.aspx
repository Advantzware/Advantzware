<%@ Page Language="C#" AutoEventWireup="True" Inherits="adder_lookup" Codebehind="adder_lookup.aspx.cs" %>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800">&nbsp;                
    ...
    <div>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.AdderLookup1('<%#DataBinder.Eval(Container,"DataItem.vIno")%>','<%#DataBinder.Eval(Container,"DataItem.vName")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>     
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="SelectAdder" TypeName="Corrugated">
            <SelectParameters>               
