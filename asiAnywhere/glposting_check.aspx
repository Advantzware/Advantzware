<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="glposting_check" Codebehind="~/glposting_check.aspx.cs" %>
<%@ Register Src="footer.ascx" TagName="Footer" TagPrefix="ft" %>
<%@ Register Src="header.ascx" TagName="Header" TagPrefix="hd" %>
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head id="Head1" runat="server">
    <title>GL postings Check</title>  
    ...
    <form id="frmList" runat="server"  defaultfocus='begjoTextBox'>   
      ...
      <TABLE id="tblTop" cellSpacing="3" align="center" border="0" Width="100%">
        <TR>
          ...
          <TD align=center nowrap><font size=+0><b>GL postings Check   &nbsp;</b></font></TD>
     ...
     <tr><td align="right" style="padding-right: 5px"><b>Beginning Run#:</b></td>
        ...
        <td align="right" style="padding-right: 5px"><b>Ending Run#:</b></td>
          ...
          <asp:CompareValidator ID="CompareValidator2" runat="server" ControlToValidate="endjoTextBox" SetFocusOnError="true" Display="dynamic" Operator="dataTypeCheck" Type="Integer" ErrorMessage="Number Only"></asp:CompareValidator> 
          </td>
         </tr>             
         ...
         <tr><td colspan="4">
          ...
          <asp:FormView ID="FormView1" Visible="False"   runat="server" 
              ...
              <ItemTemplate>
                  ...
                  <asp:Label ID="postckfileLabel" runat="server" 
                      Text='<%# Bind("postckfile") %>'></asp:Label><br />
          ...
          <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
               SelectMethod="GlPostingCheckRep" TypeName="ledger">
              <SelectParameters>
