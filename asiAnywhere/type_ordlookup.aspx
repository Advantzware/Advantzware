<%@ Page Language="C#" AutoEventWireup="true" Inherits="type_ordlookup" Codebehind="type_ordlookup.aspx.cs" %>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800">&nbsp;                
    ...
    <div>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.typeordLookup('<%#DataBinder.Eval(Container,"DataItem.vtype")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>            

                 <asp:BoundField DataField="vtype" HeaderText="Type Code" SortExpression="vtype" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="SelectTypeLook" TypeName="LookUp">
            <SelectParameters>               
