<%@ Page Language="C#" AutoEventWireup="true" Inherits="type_copylookup" Codebehind="type_copylookup.aspx.cs" %>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.TypecopyLookup('<%#DataBinder.Eval(Container,"DataItem.vCustype")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>            
