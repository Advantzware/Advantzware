<%@ Page Language="c#" AutoEventWireup="True" Debug="true" Inherits="estimate_probeit" Codebehind="estimate_probeit.aspx.cs" %>
  ...
  <head id="Head1" runat="server">
   ...
   <body>
        ...
        <asp:GridView ID="GridView1" AllowPaging="True" runat="server"  DataKeyNames="vPartNo"
            ...
            <asp:FormView ID="FormView1"  runat="server" DataSourceID="ObjectDataSource2" OnDataBound="FormView1_DataBound">            
              ...
              <ItemTemplate>
                ...
                &nbsp;<asp:Button ID="InsertCancelButton" runat="server" CssClass="button"  CausesValidation="False" OnClientClick="javascript:window.opener.location.href='corr_print.aspx'; self.close()" Text="Close" />
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
              OldValuesParameterFormatString="original_{0}" SelectMethod="SelectEstimateProbeit" 
              TypeName="Corrugated">
              <SelectParameters>
