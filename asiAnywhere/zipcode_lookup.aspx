<%@ Page Language="C#" AutoEventWireup="true" Inherits="zipcode_lookup" Codebehind="zipcode_lookup.aspx.cs" %>
                ...
                <B>Search for:&nbsp; </B>&nbsp;&nbsp;&nbsp;
                  <asp:dropdownlist id="ddlSearchField" runat="server">
                    <%--<asp:ListItem Value="Any">Any</asp:ListItem>--%>
                      <asp:ListItem Value="zipcode">ZipCode</asp:ListItem>  
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.ZipCodeLookup('<%#DataBinder.Eval(Container,"DataItem.vZip")%>', '<%#DataBinder.Eval(Container,"DataItem.vCity")%>', '<%#DataBinder.Eval(Container,"DataItem.vState")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>            
