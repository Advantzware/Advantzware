        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
            ...
            <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.Code5LookUp('<%#DataBinder.Eval(Container,"DataItem.Prinno")%>','<%#DataBinder.Eval(Container,"DataItem.PrintName")%>','<%#DataBinder.Eval(Container,"DataItem.InkType")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
