<%@ Page Language="C#" AutoEventWireup="true" Inherits="poitem_lookup" Codebehind="poitem_lookup.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Item PO Lookup</title>
...
<body>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800">&nbsp;                
                <B>Search for:&nbsp; </B>&nbsp;&nbsp;&nbsp;
                  <asp:dropdownlist id="ddlSearchField" OnTextChanged="ddlSearchField_TextChange" AutoPostBack="true" runat="server">
                      <asp:ListItem Value="itempo">Item</asp:ListItem>
                      <asp:ListItem Value="itemname">Name</asp:ListItem> 
                      <asp:ListItem Value="pono">Purchase Order#</asp:ListItem> 
    ...
    <div>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick ="javascript:top.opener.window.ItemPoLookup('<%#DataBinder.Eval(Container,"DataItem.ponopo")%>','<%#DataBinder.Eval(Container,"DataItem.itempo")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>   
                ...
                <asp:BoundField DataField="itemname" HeaderText="Name" SortExpression="itemname" />
                 <asp:BoundField DataField="ponopo" HeaderText="Purchase Order#" SortExpression="ponopo" />           
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="PoItemLook" TypeName="browspo">
            <SelectParameters>               
