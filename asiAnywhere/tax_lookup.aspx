<%@ Page Language="C#" AutoEventWireup="true" Inherits="tax_lookup" Codebehind="tax_lookup.aspx.cs" %>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800">&nbsp;                
    ...
    <div>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.TaxLookup('<%#DataBinder.Eval(Container,"DataItem.vgroup")%>','<%#DataBinder.Eval(Container,"DataItem.vdscr")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>            
                 ...
                 <asp:BoundField DataField="vtaxcode" HeaderText="Tax Code" SortExpression="vtaxcode" />
                 <asp:BoundField DataField="vtaxcode1" HeaderText="Tax Code[2]" SortExpression="vtaxcode1" />
                 <asp:BoundField DataField="vtaxcode2" HeaderText="Tax Code[3]" SortExpression="vtaxcode2" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="SelectTaxLook" TypeName="LookUp">
            <SelectParameters>               
