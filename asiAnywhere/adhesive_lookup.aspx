<%@ Page Language="C#" AutoEventWireup="true" Inherits="adhesive_lookup" Codebehind="adhesive_lookup.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Adhesive Lookup</title>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800">&nbsp;                
                <B>Search for:&nbsp; </B>&nbsp;&nbsp;&nbsp;
                  <asp:dropdownlist id="ddlSearchField" runat="server">           
                      ...
                      <asp:ListItem Value="adh">Adhesive</asp:ListItem>  
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.AdhesiveLookup1('<%#DataBinder.Eval(Container,"DataItem.vIno")%>','<%#DataBinder.Eval(Container,"DataItem.vName")%>','<%#DataBinder.Eval(Container,"DataItem.vPressType")%>','<%#DataBinder.Eval(Container,"DataItem.vCasLen")%>','<%#DataBinder.Eval(Container,"DataItem.vCaswid")%>','<%#DataBinder.Eval(Container,"DataItem.vCasdep")%>','<%#DataBinder.Eval(Container,"DataItem.vCaspal")%>','<%#DataBinder.Eval(Container,"DataItem.vCascnt")%>','<%#DataBinder.Eval(Container,"DataItem.vCasWt")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>     
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            ...
            <SelectParameters>               
                ...
                <asp:QueryStringParameter QueryStringField="code" Name="prmIndustry" Type="String" />
                 <asp:QueryStringParameter QueryStringField="lookest" Name="prmEstimate" Type="String" />
            </SelectParameters>
