<%@ Page Language="C#" AutoEventWireup="true" Inherits="item3" Title="Raw Material Information(Special Material)" Codebehind="Item3_look.aspx.cs" %>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800">&nbsp;                
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
            ...
            <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.ItemLookUp('<%#DataBinder.Eval(Container,"DataItem.itemno")%>','<%#DataBinder.Eval(Container,"DataItem.iname")%>','<%#DataBinder.Eval(Container,"DataItem.retname")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
         SelectMethod="SelectItem3Lookup" TypeName="LookUp">
            <SelectParameters>
