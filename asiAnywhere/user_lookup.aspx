<%@ Page Language="C#" AutoEventWireup="true" Inherits="user_lookup" Codebehind="user_lookup.aspx.cs" %>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick ="javascript:top.opener.window.UserLookup('<%#DataBinder.Eval(Container,"DataItem.user_id")%>','<%#DataBinder.Eval(Container,"DataItem.user_name")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>            
