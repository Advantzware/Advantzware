<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="glposting_register" Codebehind="~/glposting_register.aspx.cs" %>
<%@ Register Src="footer.ascx" TagName="Footer" TagPrefix="ft" %>
<%@ Register Src="header.ascx" TagName="Header" TagPrefix="hd" %>
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head id="Head1" runat="server">
    <title>GL Posting Register</title>  
...
var newrun;
function runlookup(obj2) {
    newrun = obj2;
    var NewWindow = window.open("runno_lookup.aspx", "RunNolookup", "width=500,height=400,scrollbars=1,toolbars=1,statusbar=1,resizeable=1");
}

function runnolookup(ReturnObj1) {
    if (newrun == "1")
        document.forms[0].begjoTextBox.value = ReturnObj1;
    else
        document.forms[0].endjoTextBox.value = ReturnObj1;
    ...
    <form id="frmList" runat="server"  defaultfocus='begjoTextBox'>   
      ...
      <TABLE id="tblTop" cellSpacing="3" align="center" border="0" Width="100%">
        <TR>
          ...
          <TD align=center nowrap><font size=+0><b>GL posting Register   &nbsp;</b></font></TD>
     ...
     <tr><td align="right" style="padding-right: 5px"><b>Beginning Run#:</b></td>
          <td nowrap><asp:TextBox ID="begjoTextBox" Width="100px" runat="server"></asp:TextBox>
          <a href="#" tabindex="1" onclick="runlookup(1); return false"><asp:Image ID="runnoImage" runat="server" ImageUrl="images/lookup_icon.gif" /></a>
          <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="begjoTextBox" SetFocusOnError="true" Display="dynamic" Operator="dataTypeCheck" Type="Integer" ErrorMessage="Number Only"></asp:CompareValidator> </td>
        <td align="right" style="padding-right: 5px"><b>Ending Run#:</b></td>
          <td nowrap><asp:TextBox ID="endjoTextBox"  Width="100px" runat="server"></asp:TextBox>
          <a href="#" tabindex="1" onclick="runlookup(2); return false"><asp:Image ID="runno2Image" runat="server" ImageUrl="images/lookup_icon.gif" /></a>
         ...
         <tr><td colspan="4">
          ...
          <asp:FormView ID="FormView1" Visible="False"   runat="server" 
              ...
              <ItemTemplate>
                  ...
                  <asp:Label ID="postregisterLabel" runat="server" 
                      Text='<%# Bind("postregister") %>'></asp:Label><br />
          ...
          <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
               SelectMethod="GlPostingRegisterRep" TypeName="ledger">
              <SelectParameters>
                  <asp:Parameter Name="prmUser" Type="String" />
                  <asp:Parameter Name="prmAction" Type="String" />
                   <asp:Parameter Name="prmBegRun" Type="String" />
                  <asp:Parameter Name="prmEndRun" Type="String" />
