<%@ Page Language="c#" AutoEventWireup="true" Debug="true" Inherits="chartof_account" Codebehind="chartof_account.aspx.cs" %>
    ...
    <form id="frmList" runat="server"  defaultfocus='TextBox1'>   
      ...
      <TABLE id="tblTop" cellSpacing="3" align="center" border="0" Width="100%">
        <TR>
          ...
          <TD align=center nowrap><font size=+0><b>Control File&nbsp;</b></font></TD>
      ...
      <tr height="70px"><td><br /></td></tr>
          ...
          <asp:FormView ID="FormView1" Visible="false" runat="server" DataSourceID="ObjectDataSource1">
              ...
              <ItemTemplate>
                  ...
                  <asp:Label ID="chartLabel" runat="server" Text='<%# Bind("[chart]") %>'></asp:Label><br />
          ...
          <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
              SelectMethod="GlChartofAccount" TypeName="ledger">
              <SelectParameters>
