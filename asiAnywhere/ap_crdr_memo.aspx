<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="ap_crdr_memo" Codebehind="ap_crdr_memo.aspx.cs" %>
...
function printackrep() {
    var NewWindow = window.open("topprintorderack_report.aspx", "OrderAcknowledgementReport", "width=500,height=500,scrollbars=1,toolbars=1,statusbar=1,resizeable=1");
}
function ordernotes() {
...
function specnote() {
    var NewWindow = window.open("invspec_list_notes.aspx", "OrderAcknowledgementReport", "width=500,height=500,scrollbars=1,toolbars=1,statusbar=1,resizeable=1");
}
        ...
        <table align="left" border="1" width="75%">
                <tr class="topheadcolor">
                     ...
                     <td nowrap width="25px";>
                        ...
                        <td nowrap width="25px";>
                        <a href="#" onClick="specnote(); return false"><asp:Image ID="Image3" Width="35px" runat="server" ImageUrl="~/Images/dict.ico" /></a>
                        </td> 
      ...
      <TABLE id="tblMain" cellSpacing="1" cellPadding="1" width='600px' border="0">
        ...
        <tr><td> 
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                ...
                TypeName="voucherpay">
                <SelectParameters>
                   <asp:Parameter DefaultValue="MemoSearch" Name="prmAction" Type="String" />                    
                   <asp:Parameter Name="prmComp"  Type="string" />
                   <asp:Parameter Name="prmUser" Type="string" />                     
                   <asp:SessionParameter SessionField="ap_crdr_memo_vendor" Name="prmvend" Type="String" />                   
                   <asp:Parameter Name="prmvname" Type="String" />                   
                   <asp:SessionParameter SessionField="ap_crdr_memo_check_no" Name="prmcheckno" Type="Int32" />
