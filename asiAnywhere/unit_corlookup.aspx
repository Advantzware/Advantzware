<%@ Page Language="C#" AutoEventWireup="true" Inherits="unit_lookup" Codebehind="unit_corlookup.aspx.cs" %>
    ...
    <div>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.UnitLookup('<%#DataBinder.Eval(Container,"DataItem.vIno")%>','<%#DataBinder.Eval(Container,"DataItem.vCasLen")%>','<%#DataBinder.Eval(Container,"DataItem.vCaswid")%>','<%#DataBinder.Eval(Container,"DataItem.vCasdep")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>     
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            ...
            <SelectParameters>               
                ...
                <asp:QueryStringParameter QueryStringField="looktype" Name="prmType" Type="String" />
                <asp:Parameter Name="prmIndustry" Type="String" />
                 <asp:QueryStringParameter QueryStringField="esttype" Name="prmEstimate" Type="String" />
            </SelectParameters>
