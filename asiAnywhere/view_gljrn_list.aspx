<%@ Page Language="c#" AutoEventWireup="true" Debug="true" Inherits="view_gljrn_list" Codebehind="view_gljrn_list.aspx.cs" %>
  ...
  <head id="Head1" runat="server">
   ...
   <body>
    <form id="frmList" runat="server"  defaultfocus='Inv_TextBox'>   
      ...
      <li class="selected"><asp:LinkButton ID="lnk_viewcustomers" runat="server" OnClick="lnk_viewcustomers_Click" > View Journals</asp:LinkButton></li></ul></div>
       ...
       <div>
           ...
           <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                ...
                <SelectParameters>
                   ...
                   <asp:SessionParameter SessionField="general_ledger_reckey_journal" Name="prmReckey" Type="String" />
                </SelectParameters>
          ...
          <asp:FormView ID="FormView2" runat="server" OnDataBound="FormView2_OnDataBound" DataSourceID="ObjectDataSource3">
           ...
           <asp:ObjectDataSource ID="ObjectDataSource3" runat="server" 
               ...
               <SelectParameters>
                   ...
                   <asp:SessionParameter SessionField="general_ledger_reckey_journal" Name="prmactdscr" Type="String" />
                   <asp:Parameter Name="prmdscr" Type="String" />
                   <asp:Parameter  Name="prmamt"  Type="Decimal" />                   
                   <asp:Parameter  Name="prmjrl_no" Type="Int32" />
                   <asp:SessionParameter SessionField="view_general_ledger_reckey" Name="prmReckey"  Type="String" />
               </SelectParameters>
           </asp:ObjectDataSource>
