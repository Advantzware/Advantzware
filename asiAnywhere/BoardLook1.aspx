  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800">&nbsp;                
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
		    ...
		    <a href="#" onClick="javascript:top.opener.window.BoardLookUp1('<%#DataBinder.Eval(Container,"DataItem.QINum")%>', '<%#DataBinder.Eval(Container,"DataItem.QCal")%>' ,'<%#DataBinder.Eval(Container,"DataItem.QCal")%>' , '<%#DataBinder.Eval(Container,"DataItem.QWid")%>' , '<%#DataBinder.Eval(Container,"DataItem.QLen")%>' );window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
