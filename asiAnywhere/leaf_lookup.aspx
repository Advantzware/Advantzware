<%@ Page Language="C#" AutoEventWireup="true" Inherits="leaf_lookup" Codebehind="leaf_lookup.aspx.cs" %>
    ...
    <div>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.LeafLookup1('<%#DataBinder.Eval(Container,"DataItem.vIno")%>','<%#DataBinder.Eval(Container,"DataItem.vName")%>','<%#DataBinder.Eval(Container,"DataItem.vPressType")%>','<%#DataBinder.Eval(Container,"DataItem.vCasLen")%>','<%#DataBinder.Eval(Container,"DataItem.vCaswid")%>','<%#DataBinder.Eval(Container,"DataItem.vCasdep")%>','<%#DataBinder.Eval(Container,"DataItem.vCascnt")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>     
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            ...
            <SelectParameters>               
                ...
                <asp:QueryStringParameter QueryStringField="look1" Name="prmType" Type="String" />
                <asp:Parameter Name="prmIndustry" Type="String" />
                 <asp:QueryStringParameter QueryStringField="leaftype" Name="prmEstimate" Type="String" />
            </SelectParameters>
