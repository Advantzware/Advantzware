<%@ Page Language="C#" Inherits="order_lookup" Title="Order Lookup" Codebehind="order_lookup.aspx.cs" %>
<html>
<head>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
            ...
            <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.OrderLookup2('<%#DataBinder.Eval(Container,"DataItem.Order")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField> 
