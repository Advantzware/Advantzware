<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="Cindustry_sic_list" Codebehind="industry_sic_list.aspx.cs" %>
...
//    
   ...
   <body>
    ...
    <td><div  id="navigation" style="width:100%">
        ...
        <asp:LinkButton ID="lnk_listsic" runat="server"  OnClick="lnk_listsic_Click" >List Sic Code</asp:LinkButton></li>
        <li><asp:LinkButton ID="lnk_viewsic" runat="server"  OnClick="lnk_viewsic_Click">View Sic Code</asp:LinkButton></li></ul></div>
            ...
            <TABLE id="tblSearch" cellSpacing="1" cellPadding="5" border="0"  bgcolor=black Width="510px">
              <TR>
                <TD class="shade" align="center" width="45"><nobr>
                  ...
                  <b>Industry Code</b></br>
                    <asp:TextBox ID="txt_industrycode" Width="100px" runat="server"></asp:TextBox>
                    </td>
                    <td class="shade" align="center"  nowrap>
                   <b>Description</b><br />
      ...
      <asp:linkbutton id="btnDelete" runat="server" OnClick="btnDelete_Click">Delete selected</asp:linkbutton>
            ...
            <asp:GridView id="dbGrid_industry_sic" runat="server" CssClass="Grid" Width="510px"
                   
                  OnPageIndexChanging="dbGrid_industry_sic_PageIndexChanging"  
                  OnSorted="dbGrid_industry_sic_Sorted"
                    OnRowCommand="dbGrid_contact_RowCommand" 
                  OnRowDeleted="dbGrid_industry_sic_RowDeleted" OnSorting="GridView1_Sorting"
                            

                   AllowPaging="True" AllowSorting="True" BorderStyle="Dotted" EmptyDataText="No records found" OnSelectedIndexChanged="dbGrid_industry_sic_SelectedIndexChanged">
        ...
        <HeaderStyle  VerticalAlign="Middle"  ForeColor ="white" CssClass="headcolor"  HorizontalAlign="Center" Wrap="False"></HeaderStyle>
