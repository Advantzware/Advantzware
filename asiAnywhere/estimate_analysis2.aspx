<%@ Page Language="c#" AutoEventWireup="true" Debug="true" Inherits="estimate_analysis2" Codebehind="estimate_analysis2.aspx.cs" %>
  ...
  <head id="Head1" runat="server">
   ...
   <body>
       ...
       <td  nowrap><b>Rels</b></td>
         ...
         <td> <asp:TextBox ID="TextBox25" onkeypress="return validate(event)" Width="70px" runat="server"></asp:TextBox> </td>
          ...
          <table>       
           ...
           <tr>
                <td>
                    <b><asp:CheckBox ID="CheckBox5" runat="server" />
                        Find Ink Cost for All Forms?</b>
                </td>
            </tr>
            <tr>
                <td colspan="2">&nbsp;
                    <b>Match Marup Percentage?:</b> &nbsp;  <asp:TextBox ID="machper_textBox" runat="server" Width="50px" Text="0.00"></asp:TextBox></b>
                </td>
            </tr>
           </table><br />
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
              OldValuesParameterFormatString="original_{0}" SelectMethod="SelectQuantity3" 
              TypeName="Corrugated">
              <SelectParameters>
                  ...
                  <asp:SessionParameter Name="prmEstimate" SessionField="tr" Type="String" />
