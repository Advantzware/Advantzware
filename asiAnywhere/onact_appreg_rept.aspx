<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="onact_appreg_rept" Codebehind="onact_appreg_rept.aspx.cs" %>
<%@ Register Src="footer.ascx" TagName="Footer" TagPrefix="ft" %>
<%@ Register Src="header.ascx" TagName="Header" TagPrefix="hd" %>
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head id="Head1" runat="server">
    <title>On Account Application Register</title>
...
<script language="javascript">
    function confirmPost() {
        var retVal = makeMsgBox("Confirmation", "Post Invoices?", 48, 4, 256, 4096);
        if (retVal == 6) {
    ...
    <form id="frmList" runat="server"  defaultfocus='TextBox1'>   
      ...
      <TABLE id="tblTop" cellSpacing="3" align="center" border="0" Width="100%">
        <TR>
          ...
          <TD align=left nowrap><font size=+0><b>On Account Application Register&nbsp;</b></font></TD>
      ...
      <tr><td align="right" style="padding-right: 5px"><b>Begining Customer#:</b></td><td>
        ...
        <a href="#" tabindex="1" onClick="contactcustomerlook(2); return false"><asp:Image ID="Image2" runat="server" ImageUrl="images/lookup_icon.gif" /></a></td>
          ...
          <asp:FormView ID="FormView1" Visible="false" runat="server" 
              ...
              <ItemTemplate>
                  actapp:
                  <asp:Label ID="actappLabel" runat="server" 
                      Text='<%# Bind("actapp") %>'></asp:Label><br />  
                  ext:
          ...
          <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
              SelectMethod="OnAccountApplicationReport" TypeName="account">
              <SelectParameters>
                  <asp:Parameter Name="prmUser" Type="String" />
                  <asp:Parameter Name="prmAction" Type="String" />
                  <asp:Parameter Name="prmtrnsdt" Type="String" />
                  <asp:Parameter Name="prmperiod" Type="Int32" />
                  <asp:Parameter Name="prmbegcst" Type="String" />                  
                  <asp:Parameter Name="prmendcst" Type="String" />                                   
