<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="Ccomp_suppliers_list" Codebehind="comp_suppliers_list.aspx.cs" %>
  ...
  <head id="Head1" runat="server">
   ...
   <body>
    ...
    <td><div  id="navigation" style="width:100%">
        ...
        <li><asp:LinkButton ID="lnk_viewsupplier" runat="server" OnClick="lnk_viewsupplier_Click">View Supplier</asp:LinkButton></li>
      ...
      <TABLE id="tblMain" cellSpacing="1" Width="700px" cellPadding="1" border="0">
            ...
            <TABLE id="tblSearch" cellSpacing="1" Width="700px"  cellPadding="5" border="0"  bgcolor=black>
              <TR>
                <TD class="shade" align="center" width="50"><nobr>
                  ...
                  <b>Suppliers Code</b></br>
                    <asp:TextBox ID="txt_supplierscode" Width="100px" runat="server"></asp:TextBox>
                    </td>
                    <td class="shade" align="center" nowrap >
                   <b>Suppliers Name</b><br />
                    <asp:textbox id="txt_suppliersname" runat="server" Width="100px"></asp:textbox>
                    </td>             
        ...
        <tr>
          <td style="width: 761px">
            ...
            <asp:GridView id="dbGrid_comp_suppliers" runat="server" CssClass="Grid" Width="700px"
                   
                  OnPageIndexChanging="dbGrid_comp_suppliers_PageIndexChanging" 
                  OnRowCommand="dbGrid_comp_suppliers_RowCommand" 
                   OnRowCreated="dbGrid_comp_suppliers_RowCreated"
                  OnSorted="dbGrid_comp_suppliers_Sorted"
                  ...
                  OnRowDeleted="dbGrid_comp_suppliers_RowDeleted"                  
                   ...
                   AllowPaging="True"  AllowSorting="True" BorderStyle="Dotted" EmptyDataText="No records found" OnSelectedIndexChanged="dbGrid_comp_suppliers_SelectedIndexChanged">
        <SelectedRowStyle BackColor="Yellow" CssClass="GridSelected" />
        <AlternatingRowStyle CssClass="GridItemOdd" />
        <%--<EmptyDataRowStyle BorderStyle="None" BorderWidth="0px" Font-Bold="True" HorizontalAlign="left" VerticalAlign="Middle" />--%>
      ...
      <%--<asp:Button ID="NewAddButton" CssClass="ButtonM" runat="server" OnClick="NewButton_Click" Text="Add"></asp:Button>--%>
