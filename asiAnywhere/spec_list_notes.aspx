<%@ Page Language="C#" AutoEventWireup="true" Debug="true" Inherits="spec_list_notes" Codebehind="spec_list_notes.aspx.cs" %>
    ...
    <form id="form1" runat="server">
        ...
        <EmptyDataRowStyle BorderStyle="None" BorderWidth="0px" Font-Bold="True"  />
            <Columns>
                ...
                <asp:BoundField DataField="vUserId" HeaderText="UserId" SortExpression="vUserId" ItemStyle-Wrap="false" />
                <asp:BoundField DataField="vDeptCode" HeaderText="Spec" SortExpression="vDeptCode" ItemStyle-Wrap="false" />
                <%--<asp:BoundField DataField="vDeptName" HeaderText="DeptName" SortExpression="vDeptName" />
                <asp:BoundField DataField="vNoteFrmNo" HeaderText="NoteFrmNo" SortExpression="vNoteFrmNo" />
                <asp:BoundField DataField="vNoteViewed" HeaderText="NoteViewed" SortExpression="vNoteViewed" />
                <asp:BoundField DataField="vNoteType" HeaderText="NoteType" SortExpression="vNoteType" />
                 <asp:BoundField DataField="vNoteText" HeaderText="NoteText" SortExpression="vNoteText" />--%>
            </Columns>
