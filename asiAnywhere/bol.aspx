<%@ Page Language="C#" AutoEventWireup="true" Inherits="bolinv" Codebehind="bol.aspx.cs" %>
...
<body>
    ...
    <li class="selected" ><asp:LinkButton ID="lnkbol" runat="server">Bol</asp:LinkButton></li>
    <li ><asp:LinkButton ID="ImageButton1" runat="server" onclick="bolButton">Print Bol</asp:LinkButton> </li>   
    <li ><asp:LinkButton ID="ImageButton2" runat="server" onclick="SignbolButton">Signed Bol</asp:LinkButton></li></ul></div>
    </td>
