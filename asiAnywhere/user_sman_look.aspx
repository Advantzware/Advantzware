...
<%@ Page Language="C#" AutoEventWireup="true" Inherits="user_sman_look" Codebehind="user_sman_look.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Users SalesRep Information</title>
  ...
  <td nowrap  id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="400">&nbsp;                
                <B>Search for:&nbsp; </B>&nbsp;&nbsp;&nbsp;
                  <asp:dropdownlist id="ddlSearchField" runat="server">
                      <asp:ListItem>Sman</asp:ListItem>
    ...
    <div>
            ...
            <Columns > 
              <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.usrsmanlook('<%#DataBinder.Eval(Container,"DataItem.sman")%>');window.close();">Select</a>
                   </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="sman" HeaderText="SalesRep" SortExpression="sman" >
                    <ItemStyle Wrap="False" />
                </asp:BoundField>
                <asp:BoundField DataField="sname" HeaderText="SalesRep Name" SortExpression="sname" >
                    <ItemStyle Wrap="False" />
                </asp:BoundField>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="SelectUserManTable" TypeName="browspo">
            <SelectParameters>            
                ...
                <asp:Parameter Name="prmsdefault" Type="String" />
