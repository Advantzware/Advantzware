<%@ Page Language="C#" AutoEventWireup="true" Inherits="procat2_lookup" Codebehind="procat_lookup2.aspx.cs" %>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.procat2Lookup('<%#DataBinder.Eval(Container,"DataItem.vProcat")%>','<%#DataBinder.Eval(Container,"DataItem.vDscr")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>            
