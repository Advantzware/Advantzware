<%@ Page Language="C#" AutoEventWireup="true" Inherits="rfqs_lookup" Title = "Rfqs" Codebehind="rfqs_lookup.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Rfqs Lookup</title>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800" style="height: 32px">&nbsp;                
                <B>Search for:&nbsp; </B>&nbsp;&nbsp;&nbsp;
                  <asp:dropdownlist id="ddlSearchField" runat="server">                    
                      <asp:ListItem Value="rfq-no">Rfq NO#</asp:ListItem>                                              
                  </asp:dropdownlist>&nbsp;&nbsp;
    ...
    <div>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
            ...
            <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.rfqLookup('<%#DataBinder.Eval(Container,"DataItem.kRqfsNo")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="kRqfsNo" HeaderText="RFQ#" SortExpression="kRqfsNo" >
                    <ItemStyle Wrap="False" />
                </asp:BoundField>
                <asp:BoundField DataField="kCust" HeaderText="Cust#" SortExpression="kCust" >
                    <ItemStyle Wrap="False" />
                </asp:BoundField>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
         SelectMethod="RfqsLook" TypeName="rfqs">
            <SelectParameters>
            <asp:QueryStringParameter QueryStringField="customer" Name="prmCustomer" Type="String" />
