<%@ Page Language="c#" AutoEventWireup="true" Debug="true" Inherits="control_file_rep" Codebehind="control_file_rep.aspx.cs" %>
      ...
      <tr height="70px"><td><br /></td></tr>
          ...
          <asp:FormView ID="FormView1" Visible="false" runat="server" DataSourceID="ObjectDataSource1">
              ...
              <ItemTemplate>
                  ...
                  <asp:Label ID="stylefileLabel" runat="server" Text='<%# Bind("[control-file-rep]") %>'></asp:Label><br />
          ...
          <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
              SelectMethod="SelectControlRep" TypeName="reports">
              <SelectParameters>
