<%@ Page Language="C#" AutoEventWireup="true" Inherits="Uom_lookup " Title="Uom Information(Window)" Codebehind="Uom_lookup.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Uom Information</title>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" >&nbsp;                
    ...
    <div>
            ...
            <Columns>
             <asp:TemplateField>
                  <ItemStyle HorizontalAlign="Center" Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick = "javascript:top.opener.window.UomLookup('<%#DataBinder.Eval(Container,"DataItem.uom")%>','<%#DataBinder.Eval(Container,"DataItem.dscr")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
         SelectMethod="SelectUomLookup" TypeName="LookUp" OnSelecting="ObjectDataSource1_Selecting">
            <SelectParameters>            
