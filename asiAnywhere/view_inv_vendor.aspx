<%@ Page Language="c#" AutoEventWireup="true" Debug="true" Inherits="view_inv_vendor" Codebehind="view_inv_vendor.aspx.cs" %>
           ...
           <asp:FormView ID="FormView2" runat="server" OnDataBound="FormView2_OnDataBound" DataSourceID="ObjectDataSource3">
               ...
               <InsertItemTemplate>
                  ...
                  <tr><td>
                   ...
                   <td nowrap><asp:TextBox ID="qty_uom_priTextBox" runat="server" onfocus= "javascript:focusval(this)" onblur="javascript:blurval(this)" Width="30px" OnTextChanged="Insertinvqty_Change" AutoPostBack="true" MaxLength="3" Text='<%# Bind("[qty-uom-pri]") %>' />
                   ...
                   <td><asp:TextBox ID="amtTextBox" runat="server" onfocus= "javascript:focusval(this)" onblur="javascript:blurval(this)" Width="80px" MaxLength="10" OnTextChanged="InsertamtTextBox_Change" AutoPostBack="true" Text='<%# Bind("amt") %>' />
