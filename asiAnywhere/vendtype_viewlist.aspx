<%@ Page Language="c#" AutoEventWireup="true" Debug="true" Inherits="vendtype_viewlist" Codebehind="vendtype_viewlist.aspx.cs" %>
      ...
      <td>
                <div>            
                    <TABLE id="tblTop" cellSpacing="3" align="center" border="0" Width="100%">
                        <TR>
                             <TD width=30>&nbsp;</TD>
                            <TD align=center nowrap><font size=+0><b>Vendor Types &nbsp;</b></font></TD>
                            <td nowrap>
                    ...
                    <table>
                        <tr bgcolor="gray">
                            <td nowrap><div  id="navigation" style="width:100%">
		                        <ul nowrap> <li>
                                <asp:LinkButton ID="lnk_Listvend" runat="server" OnClick="lnk_Listvend_Click" >Browse Type</asp:LinkButton></li>
                                <li class="selected"><asp:LinkButton ID="lnk_viewvend" runat="server"  OnClick="lnk_viewvend_Click"  > View Type</asp:LinkButton></li></ul></div>
                   ...
                   <table>
                   <tr><td align="right" style="padding-right:5px"><b>Vendor Type:</b></td>
                   <td><asp:Label ID="vtypeLabel" BackColor="turquoise" Width="120px" BorderColor="white" BorderStyle="solid" BorderWidth="1px" runat="server" Text='<%# Bind("vtype") %>' /></td></tr>
                   <tr><td align="right" style="padding-right:5px"><b>Description:</b></td>
                   <td><asp:TextBox ID="vdscrTextBox" runat="server" onfocus= "javascript:focusval(this)" onblur="javascript:blurval(this)" Width="200px" MaxLength="30" Text='<%# Bind("vdscr") %>' /></td></tr>
             ...
             &nbsp;<asp:Button ID="UpdateCancelButton" runat="server" CssClass="button" 
                   ...
                   <table>
                   <tr><td align="right" style="padding-right:5px"><b>Vendor Type:</b></td>
                   <td><asp:TextBox ID="vtypeTextBox" runat="server" onfocus= "javascript:focusval(this)" onblur="javascript:blurval(this)" MaxLength="8" Width="100px" Text='<%# Bind("vtype") %>' /></td></tr>
                   <tr><td align="right" style="padding-right:5px"><b>Description:</b></td>
                   <td><asp:TextBox ID="vdscrTextBox" Width="200px" onfocus= "javascript:focusval(this)" onblur="javascript:blurval(this)" MaxLength="30" runat="server" Text='<%# Bind("vdscr") %>' /></td></tr>
                   ...
                   <br />
                        ...
                        <table>
                   <tr><td align="right" style="padding-right:5px"><b>Vendor Type:</b></td>
                   <td><asp:Label ID="vtypeLabel" Width="120px" BackColor="turquoise" BorderColor="white" BorderStyle="solid" BorderWidth="1px" runat="server" Text='<%# Bind("vtype") %>' /></td></tr>
                   <tr><td align="right" style="padding-right:5px"><b>Description:</b></td>
                   <td><asp:Label ID="vdscrLabel" Width="200px" BackColor="turquoise" BorderColor="white" BorderStyle="solid" BorderWidth="1px" runat="server" Text='<%# Bind("vdscr") %>' /></td></tr>
          ...
          <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
              SelectMethod="SelectVendTypeList" TypeName="voucherpay">
              <SelectParameters>
                  ...
                  <asp:Parameter Name="prmvdscr" Type="String" />
                  <asp:SessionParameter SessionField="vendtype_new_reckey" Name="prmReckey" 
                      Type="String" />
              </SelectParameters>
