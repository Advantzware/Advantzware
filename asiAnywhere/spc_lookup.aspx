<%@ Page Language="C#" AutoEventWireup="true" Inherits="spc_lookup" Codebehind="spc_lookup.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Spc Lookup</title>
                ...
                <B>Search for:&nbsp; </B>&nbsp;&nbsp;&nbsp;
                  <asp:dropdownlist id="ddlSearchField" runat="server">
                    <%--<asp:ListItem Value="Any">Any</asp:ListItem>--%>
                      <asp:ListItem Value="spc">Type </asp:ListItem>  
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.SpcLookup('<%#DataBinder.Eval(Container,"DataItem.vspc")%>','<%#DataBinder.Eval(Container,"DataItem.vitemno")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField> 
                <asp:BoundField DataField="vspc" HeaderText="Type" SortExpression="vspc" />
                <asp:BoundField DataField="vitemno" HeaderText="Item" SortExpression="vitemno" />
                <asp:BoundField DataField="vitemname" HeaderText="Description" SortExpression="vitemname" />
