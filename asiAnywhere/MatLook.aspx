...
<head id="Head1" runat="server">
    <title>Raw Material Information(Special Material)</title>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
            ...
            <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.MaterialLookUp('<%#DataBinder.Eval(Container,"DataItem.Ino")%>','<%#DataBinder.Eval(Container,"DataItem.Iname")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
