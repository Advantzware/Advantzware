<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="payterm_list" Codebehind="payterm_list.aspx.cs" %>
  ...
  document.forms[0].Salesman_TextBox.focus();
   ...
   <body>
    <form id="frmList" runat="server"  defaultfocus='tdSearch'>   
      ...
      <asp:LinkButton ID="lnk_Listvend" runat="server" >Browse Terms</asp:LinkButton></li>
      <li><asp:LinkButton ID="lnk_viewvend" runat="server" OnClick="lnk_viewvend_Click" > View Terms</asp:LinkButton></li></ul></div>
          ...
          <TD>
            <TABLE id="tblSearch" cellSpacing="1" cellPadding="5" width="100%" border="0"  bgcolor=black>
              <TR>
                ...
                <TD id="tdSearch" runat="server" class="shade" vAlign="middle" align="left" width="800">&nbsp;                
                <table>
                <tr><td ><b>Terms#</b></td><td align="center"><b> Description</b></td>
                </tr>
                <tr><td>
                    <asp:TextBox ID="terms_TextBox" Width="100px" runat="server"></asp:TextBox></td>
                    <td><asp:TextBox ID="name_TextBox" Width="120px" runat="server"></asp:TextBox>                    
                    </td>
        ...
        <tr><td> --%>
            <asp:GridView ID="GridView1" runat="server" DataSourceID="ObjectDataSource1" EmptyDataText=" Records not  Found" AllowPaging="True" AllowSorting="True" Width="600px" AutoGenerateColumns="False" BorderStyle="Dotted" CssClass="Grid" OnSelectedIndexChanged="GridView1_SelectedIndex">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="tcode" HeaderText="Terms" SortExpression="tcode" />
                    <asp:BoundField DataField="dscr" HeaderText="Description" SortExpression="dscr" />
                    <asp:BoundField DataField="disc_rate" HeaderText="Disc%" 
                        SortExpression="disc_rate" />
                    <asp:BoundField DataField="disc_dys" HeaderText="Day" 
                        SortExpression="disc_dys" />
                    <asp:BoundField DataField="net_dys" HeaderText="Net" 
                        SortExpression="net_dys" />
                    <asp:BoundField DataField="CUT_date" HeaderText="Cutoff" 
                        SortExpression="CUT_date" />
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
              OldValuesParameterFormatString="original_{0}" SelectMethod="SelectPaymentTerms" 
              TypeName="voucherpay">
                <SelectParameters>
                    ...
                    <asp:SessionParameter SessionField="payterms_list_prmterms" Name="prmtcode" Type="String" />
                    <asp:SessionParameter SessionField="payterms_list_prmname"  Name="prmdscr" Type="String" />
