<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="back_log_report_list" Codebehind="back_log_report.aspx.cs" %>
<%@ Register Src="footer.ascx" TagName="Footer" TagPrefix="ft" %>
<%@ Register Src="header.ascx" TagName="Header" TagPrefix="hd" %>
<HTML xmlns="http://www.w3.org/1999/xhtml" >
  <head id="Head1" runat="server">
    <title>Order BackLog By Part#</title>
 ...
 function samevalue()
    ...
    var custno = "";
    function contactcustomerlook(cust) {
        custno = cust;
   ...
   <body>
    <form id="frmList" runat="server"  defaultfocus='TextBox1'>   
      ...
      <TABLE id="tblTop" cellSpacing="3" align="center" border="0" Width="100%" >
        <TR>
          ...
          <TD align=left nowrap><font size=+0><b>Order Backlog By Part#&nbsp;</b></font></TD>
      ...
      <a href="#" tabindex="1" onClick="contactcustomerlook(2); return false"><asp:Image ID="Image6" runat="server" ImageUrl="images/lookup_icon.gif" /></a></td>
        </tr>
       ...
       <tr> <td align="right" style="padding-right: 5px"><b>Begining Order#:</b></td>
          <td><asp:TextBox ID="BeOrderTextBox" Width="100px" runat="server"></asp:TextBox></td>
        <td align="right" style="padding-right: 5px"><b>Ending Order#:</b></td>
          <td><asp:TextBox ID="endorderTextBox" Width="100px" runat="server"></asp:TextBox></td></tr>
      ...
      <tr><td align="right" style="padding-right: 5px"><b>Begining Item#:</b></td>
        ...
        <tr><td align="right" style="padding-right: 5px"><b>Begining DueDate#:</b></td>
          ...
          <a href="#" tabindex="1" onblur="document.getElementById('bedateTextBox').focus()" onClick="showCalendarControl(bedateTextBox); return false"><asp:Image ID="Image2" runat="server" ImageUrl="images/lookup_icon.gif" /></a></td>
        <td align="right" style="padding-right: 5px"><b>Ending OrderDate:</b></td>
          ...
          <a href="#" tabindex="1" onblur="document.getElementById('enddateTextBox').focus()" onClick="showCalendarControl(enddateTextBox); return false"><asp:Image ID="Image3" runat="server" ImageUrl="images/lookup_icon.gif" /></a></td></tr>
        </table>
          
        
        <table class="shade" width="520px">
         <tr><td>
         <b><asp:CheckBox ID="CheckBox1" Text="Print Po#" runat="server"></asp:CheckBox></b>
         </td>
         <td><b><asp:CheckBox ID="CheckBox2" Text="Include Job?" runat="server"></asp:CheckBox></b></td></tr> 
         <tr><td>
         <b><asp:CheckBox ID="CheckBox3" Text="Item Subtotals?" runat="server"></asp:CheckBox></b>
         </td>
         <td><b><asp:CheckBox ID="CheckBox4" Text="Exclude Set Components?" runat="server"></asp:CheckBox></b></td></tr> 
         <tr><td>
         <b><asp:CheckBox ID="CheckBox5" Text="Print Price/Sales?" runat="server"></asp:CheckBox></b>
         </td>
         <td><b><asp:CheckBox ID="CheckBox6" Text="Exclude transfer Releases/orders" runat="server"></asp:CheckBox></b></td></tr>
         <tr><td colspan="2"><b>Primary Sort</b>
             <asp:RadioButtonList ID="RadioButtonList1" RepeatLayout="Flow"  CellSpacing="1" RepeatColumns="5" Font-Bold ="true" runat="server">
             
                 
                 <asp:ListItem  Value="Item"     Text="Part#" />
                  <asp:ListItem Value="Cust"    Text="Customer" />
                  <asp:ListItem Value="Sales"    Text="salesrep#" />
                 
         </asp:RadioButtonList> &nbsp; &nbsp;</td></tr>
         <tr><td colspan="2"><b>Qty On-hand Source</b>
             <asp:RadioButtonList ID="RadioButtonList2" RepeatLayout="Flow"  CellSpacing="1" RepeatColumns="5" Font-Bold ="true" runat="server">
             
                 
                 <asp:ListItem   Value="FG"    Text="FG" />
        ...
        <tr><td colspan="3">
          ...
          <asp:Label ID="OutPutFile" runat="server" Text="Output File:" Font-Bold="True" Font-Size="Larger" ForeColor="Blue"></asp:Label>
           ...
           <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
              SelectMethod="SeBacklogPart" TypeName="reports">
              <SelectParameters>
                  <asp:Parameter Name="prmUser" Type="String" />
                  <asp:Parameter Name="prmBackLog" Type="String" />
                  <asp:Parameter Name="prmBeCust" Type="String" />
                  <asp:Parameter Name="prmEndCust" Type="String" />
                  <asp:Parameter Name="prmBeSalesman" Type="String" />
                  ...
                  <asp:Parameter Name="prmBemDue" Type="DateTime" />
                  <asp:Parameter Name="pemEndDue" Type="DateTime" />
                  <asp:Parameter Name="prmPrintpo" Type="String" />
                  <asp:Parameter Name="prmIncJob" Type="String" />
                  <asp:Parameter Name="prmItemSub" Type="String" />
                  <asp:Parameter Name="prmExcludeCo" Type="String" />
                  <asp:Parameter Name="prmPriceSale" Type="String" />
                  <asp:Parameter Name="pemExcludeTr" Type="String" />
                  <asp:Parameter Name="prmSort" Type="String" />
                  <asp:Parameter Name="pemQtyOn" Type="String" />
    ...
    <ft:footer id="Footer1" runat="server"></ft:footer>
        <asp:FormView ID="FormView1" Visible="false" runat="server" DataSourceID="ObjectDataSource1">
            ...
            <ItemTemplate>
                vBackLog:
                <asp:Label ID="vBackLogLabel" runat="server" Text='<%# Bind("vBackLog") %>'></asp:Label><br />
            </ItemTemplate>
