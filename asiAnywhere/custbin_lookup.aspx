<%@ Page Language="C#" AutoEventWireup="true" Inherits="custbin_lookup" Codebehind="custbin_lookup.aspx.cs" %>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800">&nbsp;                
                <B>Search for:&nbsp; </B>&nbsp;&nbsp;&nbsp;
                  <asp:dropdownlist id="ddlSearchField" runat="server">
                    <%--<asp:ListItem Value="Any">Any</asp:ListItem>--%>
                      <asp:ListItem Value="Binloc">Bin</asp:ListItem>  
    ...
    <div>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.CustBinLookup('<%#DataBinder.Eval(Container,"DataItem.vbinloc")%>','<%#DataBinder.Eval(Container,"DataItem.vjob")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>            
                ...
                <%--<asp:BoundField DataField="v#" HeaderText="#" SortExpression="v#" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="CustBinLook" TypeName="LookUp">
            <SelectParameters>               
                ...
                <asp:QueryStringParameter QueryStringField="binloc" Name="prmLoc" Type="string" />
            </SelectParameters>
