<%@ Page Language="C#" AutoEventWireup="true" Inherits="cor_fgitem_look" Codebehind="cor_fgitem_look.aspx.cs" %>
                ...
                <B>Search for:&nbsp; </B>&nbsp;&nbsp;&nbsp;
                  <asp:dropdownlist id="ddlSearchField" runat="server">
                    <%--<asp:ListItem Value="Any">Any</asp:ListItem>--%>
                      <asp:ListItem Value="item-no">FG Item </asp:ListItem>  
        ...
        <asp:GridView ID="GridView1"  AllowPaging="True" runat="server" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1"
            ...
            <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.FGItemLookup('<%#DataBinder.Eval(Container,"DataItem.vFgItem")%>','<%#DataBinder.Eval(Container,"DataItem.vPartNum")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:BoundField DataField="vPartNum" HeaderText="PartNum" SortExpression="vPartNum" />
                <asp:BoundField DataField="vPartDscr" HeaderText="PartDscr" SortExpression="vPartDscr" />
                <asp:BoundField DataField="vFgItem" HeaderText="FgItem" SortExpression="vFgItem" />
                
            </Columns>
        </asp:GridView>
        <input type="button" name="close" class="buttonM" id="close" value="Close" onclick="javascript:window.close()" />
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="SelectFGItem" TypeName="Corrugated">
            <SelectParameters>               
