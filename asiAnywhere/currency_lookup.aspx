<%@ Page Language="C#" AutoEventWireup="true" Inherits="currency_lookup" Codebehind="currency_lookup.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Currency Lookup</title>
                ...
                <B>Search for:&nbsp; </B>&nbsp;&nbsp;&nbsp;
                  <asp:dropdownlist id="ddlSearchField" runat="server">
                    <%--<asp:ListItem Value="Any">Any</asp:ListItem>--%>
                      <asp:ListItem Value="c-code">Code</asp:ListItem>  
            ...
            <Columns>
             <asp:TemplateField>
                  ...
                  <ItemStyle HorizontalAlign="Center" Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.CurrencyLookup('<%#DataBinder.Eval(Container,"DataItem.vcode")%>','<%#DataBinder.Eval(Container,"DataItem.vdesc")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>     
              
                   
                <asp:BoundField DataField="vcode" HeaderText="Code" SortExpression="vcode" />
                <asp:BoundField DataField="vdesc" HeaderText="Description" SortExpression="vdesc" />
                <asp:BoundField DataField="vex-rate" HeaderText="vex-rate" SortExpression="vex-rate" />
                
            </Columns>
        </asp:GridView>
        <input type="button" name="close" class="buttonM" id="close" value="Close" onclick="javascript:window.close()" />
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="CurrencyCodeLook" TypeName="LookUp">
            <SelectParameters>               
