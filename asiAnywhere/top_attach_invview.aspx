<%@ Page Language="C#" AutoEventWireup="true" Debug="true" Inherits="top_attach_invview" Codebehind="top_attach_invview.aspx.cs" %>
    ...
    <div>
      ...
      <table>
        ...
        <asp:FormView ID="FormView1" runat="server" DataSourceID="ObjectDataSource1" OnDataBound="FormView1_DataBound" OnUnload="FormView1_Unload">
            <EditItemTemplate>
               ...
               <table class="shade"><tr><td nowrap align="right" style="padding-right:5px"><b>Attached File: </b></td>
                ...
                <tr><td nowrap align="right" style="padding-right:5px"><b>File Type:</b></td>
                <td><asp:TextBox ID="type_TextBox" Width="100px" runat="server" Text='<%# Bind("vFGitem") %>'>
                </asp:TextBox>                
                </td></tr>
                ...
                <td nowrap align="right" style="padding-right:5px"><b>Invoice#:</b></td>
                <td><asp:TextBox ID="vPoNoTextBox" Width="100px" runat="server" Text='<%# Bind("vPoNo") %>'>
                </asp:TextBox>                
                </td>
                </tr>
                <tr><td colspan="4">
            ...
            <ItemTemplate>
                ...
                <tr><td align="right" style="padding-right:5px"><b>File Type:</b></td>
                <td><asp:Label ID="type_Label" runat="server" Width="100px" BackColor="turquoise" Text='<%# Bind("vFGitem") %>'></asp:Label></td></tr>
                ...
                <td><asp:Label ID="vDateLabel" runat="server" Width="100px" BackColor="turquoise" Text='<%# Bind("vDate","{0:MM/dd/yyyy}" ) %>'></asp:Label></td>
                <td align="right" style="padding-right:5px"><b>Invoice#:</b></td>
                <td><asp:Label ID="vPoNoLabel" runat="server" Width="100px" BackColor="turquoise" Text='<%# Bind("vPoNo") %>'></asp:Label></td>
                </tr>
                <tr><td><asp:Label ID="vReckeyLabel" Visible="false" runat="server" Text='<%# Bind("vReckey") %>'></asp:Label><br /></td></tr>
                              
                <tr><td colspan="5">
               <asp:Button ID="update_button" runat="server" CausesValidation="true" CommandName="edit" CssClass="button" Text="Update" />
               <asp:Button ID="add_Button" runat="server" CausesValidation="true" CommandName="new" CssClass="button" Text="Add" />
               <asp:Button ID="delete_Button" runat="server" CausesValidation="true"  CssClass="button" Text="Delete" OnClick="btn_delete_click"  OnClientClick="return confirm('Are you sure to delete this record')" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="TopAttachpoinvoice" TypeName="voucherpay">
            <SelectParameters>
                <asp:Parameter DefaultValue="View" Name="prmAction" Type="String" />
                <asp:Parameter Name="prmUser" Type="String" />
                <asp:SessionParameter DefaultValue="" Name="prmRecKey" SessionField="invtop_list_attach_rec_key"
                    Type="String" />
                <asp:Parameter Name="prmAttFile" Type="String" />
                <asp:SessionParameter DefaultValue="" Name="prmPoNo"  Type="String" />
                ...
                <asp:SessionParameter SessionField="top_attach_invlist_reckey" Name="prmSerchEst" Type="string" />
            </SelectParameters>
