<%@ Page Language="C#" AutoEventWireup="True" Debug="true" Codebehind="accountlook.aspx.cs" Inherits="accountlook" %>
            ...
            <Columns>
             <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.AccountLookup('<%#DataBinder.Eval(Container,"DataItem.actno")%>','<%#DataBinder.Eval(Container,"DataItem.dscr")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>     
                 ...
                 <asp:BoundField DataField="dscr" HeaderText="Description" SortExpression="dscr" />
                  <asp:BoundField DataField="acc-type" HeaderText="Type" SortExpression="acc-type" />
                                 
            </Columns>
        </asp:GridView>
        <input type="button" name="close" class="buttonM" id="close" value="Close" onclick="javascript:window.close()" />
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="AccountLookup" TypeName="LookUp">
            <SelectParameters>               
                ...
                <asp:QueryStringParameter QueryStringField="jrnl" Name="prmjournal" Type="String" />             
