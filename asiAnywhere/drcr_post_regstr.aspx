<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="drcr_post_regstr" Codebehind="drcr_post_regstr.aspx.cs" %>
<%@ Register Src="footer.ascx" TagName="Footer" TagPrefix="ft" %>
<%@ Register Src="header.ascx" TagName="Header" TagPrefix="hd" %>
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head id="Head1" runat="server">
    <title>Debit/Credit Memo Edit/Post Register</title>
...
function blurval(obj) {
    ...
    function vendtext() {
        var memo = document.getElementById("bememoTextBox");
        memo.focus();
    }
    function periodtext() {
    ...
    <form id="frmList" runat="server"  defaultfocus='TextBox1'>   
      ...
      <TABLE id="tblTop" cellSpacing="3" align="center" border="0" Width="100%">
        <TR>
          ...
          <TD align=left nowrap><font size=+0><b>Debit/Credit Memo Edit/Post Register&nbsp;</b></font></TD>
      ...
      <tr>
        ...
        <td colspan="3" align="left" style="padding-right: 5px; " nowrap>&nbsp;&nbsp;&nbsp;&nbsp;<b>Post Date:</b>
           &nbsp;
            <asp:TextBox ID="postdateTextBox" onfocus="javascript:preEnter( this, 'yes' );" onblur="javascript:preLeave( this, 'date', '99/99/9999' );"  runat="server" Width="100px"></asp:TextBox>
      ...
      <tr>
        <td align="right" style="padding-right: 5px"><b>Begining Memo Date:</b></td>
          <td><asp:TextBox MaxLength="5" ID="bememoTextBox" Width="100px" onfocus="javascript:preEnter( this, 'yes' );" onblur="javascript:preLeave( this, 'date', '99/99/9999' );" runat="server"></asp:TextBox>
          <a href="#" onblur="document.getElementById('bememoTextBox').focus()"  tabindex="1" onClick="showCalendarControl(bememoTextBox); return false"><asp:Image ID="Image6" runat="server" ImageUrl="images/lookup_icon.gif" /></a>          
        </td>
        <td align="right" style="padding-right: 5px"><b>Ending Memo Date:</b></td>
          <td><asp:TextBox MaxLength="5" ID="endmemoTextBox" Width="100px" onfocus="javascript:preEnter( this, 'yes' );" onblur="javascript:preLeave( this, 'date', '99/99/9999' );" runat="server"></asp:TextBox>
          <a href="#" onblur="document.getElementById('endmemoTextBox').focus()"  tabindex="1" onClick="showCalendarControl(endmemoTextBox); return false"><asp:Image ID="Image3" runat="server" ImageUrl="images/lookup_icon.gif" /></a>          
        </td>
       </tr>
        ...
        <tr></tr><tr></tr>
          ...
          <asp:FormView ID="FormView1" Visible="false"  runat="server" 
              ...
              <ItemTemplate>
                  dbreg:
                  <asp:Label ID="dbregLabel" runat="server" 
                      Text='<%# Bind("dbreg") %>'></asp:Label><br />                 
                  
              </ItemTemplate>                            
          </asp:FormView>
          
          <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
              SelectMethod="SelectDbCrRegisterPost" TypeName="voucherpay">
              <SelectParameters>
