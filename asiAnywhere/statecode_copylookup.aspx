<%@ Page Language="C#" AutoEventWireup="true" Inherits="statecode_copylookup" Codebehind="statecode_copylookup.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>State Code Lookup</title>
                ...
                <B>Search for:&nbsp; </B>&nbsp;&nbsp;&nbsp;
                  <asp:dropdownlist id="ddlSearchField" runat="server">
                    <asp:ListItem Value="Any">Any</asp:ListItem>
                      <asp:ListItem Value="statecod">Territory</asp:ListItem>  
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.StateCodeCopyLookup('<%#DataBinder.Eval(Container,"DataItem.vStateCode")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>            
