<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="cash_requirements" Codebehind="cash_requirements.aspx.cs" %>
<%@ Register Src="footer.ascx" TagName="Footer" TagPrefix="ft" %>
<%@ Register Src="header.ascx" TagName="Header" TagPrefix="hd" %>
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head id="Head1" runat="server">
    <title>AP Cash Requirements Report</title>
    ...
    <form id="frmList" runat="server"  defaultfocus='begcomTextBox'>   
      ...
      <TABLE id="tblTop" cellSpacing="3" align="center" border="0" Width="100%">
        <TR>
          ...
          <TD align=center nowrap><font size=+0><b>AP Cash Requirements Report &nbsp;</b></font></TD>
      ...
      <table class="shade" style="width: 500px">                    
        ...
        <tr><td align="center"><b>Cash Needed On:</b><br /></td></tr>         
        </td></tr></table>
      ...
      <td><asp:TextBox ID="endcomTextBox"  width="100px" MaxLength="3" runat="server"></asp:TextBox>        
        ...
        <table class="shade" style="width: 500px">                    
         <tr><td valign="top" align="center">                  
        <table>         
        <tr><td align="right" style="padding-right:5px"><b>Date1:</b></td>
          <td>
              ...
              <tr><td align="right" style="padding-right:5px"><b>Date2:</b></td>
              <td>
              <asp:TextBox ID="dt2_TextBox" Width="100px" onfocus="javascript:preEnter( this, 'yes' );" onblur="javascript:preLeave( this, 'date', '99/99/9999' );" runat="server"></asp:TextBox>
              <a href="#" onblur="document.getElementById('dt2_TextBox').focus()" tabindex="1" onClick="showCalendarControl(dt2_TextBox); return false"><asp:Image ID="Image3" runat="server" ImageUrl="images/lookup_icon.gif" /></a>
              </td></tr>
              <tr><td align="right" style="padding-right:5px"><b>Date3:</b></td>
                <td>
              <asp:TextBox ID="dt3_TextBox" Width="100px" onfocus="javascript:preEnter( this, 'yes' );" onblur="javascript:preLeave( this, 'date', '99/99/9999' );" runat="server"></asp:TextBox>
              <a href="#" onblur="document.getElementById('dt3_TextBox').focus()" tabindex="1" onClick="showCalendarControl(dt3_TextBox); return false"><asp:Image ID="Image4" runat="server" ImageUrl="images/lookup_icon.gif" /></a>
              </td></tr>
              </table>     
         </td></tr></table>        
        ...
        <table class="shade" style="width: 500px">                    
         <tr><td valign="top" align="center">                  
        <table>         
         <tr><td><b><asp:CheckBox ID="CheckBox1" Text="Sort By Vendor Name?" runat="server"></asp:CheckBox></b></td></tr>
         <tr><td><b><asp:CheckBox ID="CheckBox2" Text="Print Discount Date?" runat="server"></asp:CheckBox></b></td></tr>
         <tr><td><b><asp:CheckBox ID="CheckBox3" Text="Show Company" runat="server"  ></asp:CheckBox></b></td></tr>                 
         </table>     
         </td></tr></table>
         ...
         <tr><td  colspan="3">
          ...
          <asp:FormView ID="FormView1" Visible="False"  runat="server" DataSourceID="ObjectDataSource1">
              ...
              <ItemTemplate>
                  cash:
                  <asp:Label ID="cashLabel" runat="server" Text='<%# Bind("cash") %>'></asp:Label><br />
                  extra:
          ...
          <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
              SelectMethod="CashRequirements" TypeName="voucherpay">
              <SelectParameters>
                  <asp:Parameter Name="prmUser" Type="String" />
                  <asp:Parameter Name="prmcash" Type="String" />
                  <asp:Parameter Name="prmbegcom" Type="String" />
                  <asp:Parameter Name="prmendcom" Type="String" />
                  <asp:Parameter Name="prmbegdt1" Type="String" />
                  <asp:Parameter Name="prmbegdt2" Type="String" />
                  <asp:Parameter Name="prmbegdt3" Type="String" />
                  <asp:Parameter Name="prmshrtby" Type="String" />
                  <asp:Parameter Name="prmdiscdt" Type="String" />
                  <asp:Parameter Name="prmcompny" Type="String" />                  
