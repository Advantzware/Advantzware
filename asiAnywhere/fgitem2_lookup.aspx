<%@ Page Language="C#" AutoEventWireup="true" Inherits="fgitem2_lookup" Title="FgItem LookUp" Codebehind="fgitem2_lookup.aspx.cs" %>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
            ...
            <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.FGLookup('<%#DataBinder.Eval(Container,"DataItem.Item")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
