<%@ Page Language="C#" AutoEventWireup="true" Inherits="sman_copylookup" Codebehind="sman_copylookup.aspx.cs" %>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.smancopyLookup('<%#DataBinder.Eval(Container,"DataItem.vSaleman")%>','<%#DataBinder.Eval(Container,"DataItem.vSsname")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>     
