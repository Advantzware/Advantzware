<%@ Page Language="C#" MasterPageFile="~/MasterPageFolding.master"  Debug="true" EnableEventValidation="false" Inherits="folding" Title="Folding Estimate" Codebehind="~/fold_estimate.aspx.cs" %>
    ...
    <TABLE id="tblMain" cellSpacing="1" cellPadding="1"  width='95%' border="0">
        <TR>
          <TD style="width: 1330px; height: 60px;">
		   ...
		   <tr>
            ...
            <asp:TextBox ID="txt_shipto" runat="server" onkeyup="blankcust()" Width="65px" ></asp:TextBox>
			<a href="#" onclick="ShipTOLook(); return false"><asp:Image ID="Image1" runat="server" ImageUrl="~/images/lookup_icon.gif" /></a>
                	    	</td> --%> 
            ...
            <asp:TextBox ID="txt_itemname" runat="server" MaxLength="30" Width="65px" ></asp:TextBox>			
                	...
                	<td nowrap  align="center" style="padding-bottom:20px"> Style# <br>
			...
			<a href="#"  tabindex="1" onClick="stylelook(); return false"><asp:Image ID="EstimateLookup" runat="server" ImageUrl="~/images/lookup_icon.gif" /></a>
			   	...
			   	<td nowrap> LxWxD <br>
                    <asp:TextBox ID="txt_l2" runat="server" Width="65px" MaxLength="2" onblur="limit()" onfocus="blank()" ></asp:TextBox>
                    ...
                    <br />
                     <asp:TextBox ID="txt_w2" runat="server" Width="65px" MaxLength="2" onblur="limit1()" onfocus="blank1()" ></asp:TextBox>
                     ...
                     <br />
                    <asp:TextBox ID="txt_d2" runat="server" Width="65px" MaxLength="2" onblur="limit2()" onfocus="blank2()" ></asp:TextBox>
        ...
        <td>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="logicno" Visible="false" >                    
                    <ItemTemplate>
                        <asp:Label ID="logicLabel" runat="server" Text='<%# Bind("[vLogic]") %>'></asp:Label>
                    </ItemTemplate>
                    <ItemStyle Wrap="False" />
                </asp:TemplateField>
