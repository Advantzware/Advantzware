<%@ Page Language="C#" AutoEventWireup="true" Inherits="machine_lookup" Codebehind="machine_lookup.aspx.cs" %>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800">&nbsp;                
    ...
    <div>
            ...
            <Columns>
              <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.MachineLookup('<%#DataBinder.Eval(Container,"DataItem.vCode")%>','<%#DataBinder.Eval(Container,"DataItem.vCodeDesc")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="vCode" HeaderText="Item " SortExpression="vCode" />
                <asp:BoundField DataField="vCodeDesc" HeaderText="Item Name" SortExpression="vCodeDesc" />
                <asp:BoundField DataField="vDept" HeaderText="ER" SortExpression="vDept" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="SelectMachine" TypeName="Corrugated">
            <SelectParameters>               
                ...
                <asp:QueryStringParameter Name="prmEstimate" QueryStringField="est" Type="String" />
                ...
                <asp:QueryStringParameter QueryStringField="board" Name="prmBoard" Type="String" />
                <asp:QueryStringParameter QueryStringField="xgrain" Name="prmXgrain" Type="String" />
            </SelectParameters>
