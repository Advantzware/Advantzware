<%@ Page Language="c#" AutoEventWireup="true" Debug="true" Inherits="list_daily_usag" Codebehind="item_daily_usag.aspx.cs" %>
<%@ Register Src="footer.ascx" TagName="Footer" TagPrefix="ft" %>
<%@ Register Src="header.ascx" TagName="Header" TagPrefix="hd" %>
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head id="Head1" runat="server">
    <title>Customer Plant Usage</title>
...
function datevalidate()
{
   ...
   <body>
    <form id="frmList" runat="server"   defaultfocus ='txt_seqno' >   
      ...
      <table id="tblTop" cellSpacing="3" border="0">
        <tr>
          ...
          <td align=center nowrap><font size=+0><b>Customer Plant Usage&nbsp;</b></font></td>
          <td vAlign="middle">
    ...
    <asp:LinkButton ID="lnk_listitem" runat="server" OnClick="lnk_list_click">List Usage</asp:LinkButton></li>
    <li><asp:LinkButton ID="lnk_viewitem" runat="server" OnClick="lnk_view_click">View Usage</asp:LinkButton></li></ul></div>
    </td>
    </tr></table>
     ...
     AllowPaging="True" AllowSorting="True" 
        ...
        <RowStyle CssClass="shade"  />
         <Columns>
             ...
             <asp:TemplateField HeaderText="Customer Usage Date" SortExpression="vUsgDate">                    
                    <ItemTemplate>
                        <asp:Label ID="Label3" runat="server" Text='<%# Bind("[vUsgDate]","{0:MM/dd/yyyy}") %>'></asp:Label>
                    </ItemTemplate>
                    <ItemStyle Wrap="False" />
                </asp:TemplateField>
             <asp:BoundField DataField="vQtyUsed" HeaderText="Quantity Used" SortExpression="vQtyUsed" />
             <asp:BoundField DataField="vCustHandQty" HeaderText="Cust Plant on Hand Qty" SortExpression="vCustHandQty" />
             <asp:BoundField DataField="vCustPoNum" HeaderText="Customer Po#" SortExpression="vCustPoNum" />            
             <asp:BoundField DataField="vCustPartNum" HeaderText="Customer Part#" SortExpression="vCustPartNum" />
             <asp:BoundField DataField="vFgItmNum" HeaderText="Suppliers FG Item" SortExpression="vFgItmNum" />
             <asp:BoundField DataField="vCustVenCode" HeaderText="Customer A/P Code" SortExpression="vCustVenCode" />
             <asp:BoundField DataField="vCustPlantId" HeaderText="Customer Plant ID" SortExpression="vCustPlantId" />
             <asp:BoundField DataField="vCustDptCod" HeaderText="Customer Dept Code" SortExpression="vCustDptCod" />
             ...
             <asp:BoundField DataField="vItmSelPrice" HeaderText="Suppliers Item Sell Price" SortExpression="vItmSelPrice" />
                          
             <asp:TemplateField HeaderText="Trans-type" Visible="false" SortExpression="vTransType">                    
                    <ItemTemplate>
                        <asp:Label ID="typeLabel" runat="server" Text='<%# Bind("[vTransType]") %>'></asp:Label>
                    </ItemTemplate>
                    <ItemStyle Wrap="False" />
                </asp:TemplateField>
         </Columns>
              ...
              <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
                  SelectMethod="Selectdailyusege" TypeName="custitem">
                  <SelectParameters>
