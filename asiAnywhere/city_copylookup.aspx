<%@ Page Language="C#" AutoEventWireup="true" Inherits="city_copylookup" Codebehind="city_copylookup.aspx.cs" %>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.CityCodecopyLookup('<%#DataBinder.Eval(Container,"DataItem.vCity")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>            
