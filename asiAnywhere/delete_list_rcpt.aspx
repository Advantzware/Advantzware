<%@ Page Language="C#" MasterPageFile="MasterPageReceGds.master" Debug="true" AutoEventWireup="true" Inherits="delete_list_rcpt" Title="Warehouse Transactions Receipts" Codebehind="delete_list_rcpt.aspx.cs" %>
...
function fgtaglook() {
    ...
    var NewWindow = window.open("fgtaglookup.aspx?binloc="+ "Delete" +"", "fgtagLookUpWindow", "width=500,height=500,scrollbars=1,toolbars=1,statusbar=1,resizeable=1");
}
...
<div>
    ...
    <%--<asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
        ...
        <SelectParameters>            
            ...
            <asp:SessionParameter Name="prmAction" DefaultValue="Select" SessionField="prmAction_rcpt_gd" Type="String"  />
     ...
     <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
        ...
        <SelectParameters>            
            <asp:SessionParameter Name="prmUser" SessionField="prmUser" Type="String" />          
            <asp:Parameter Name="prmAction" DefaultValue="GridSelect"  Type="String"  />
            <asp:SessionParameter Name="prmFgItem" SessionField="prmIno_rcpt_delete" Type="String" />
            <asp:SessionParameter Name="prmJobno" SessionField="prmJob_rcpt_delete" Type="String" />
            <asp:SessionParameter Name="prmPono" SessionField="prmPo_rcpt_delete" Type="String" />
            <asp:SessionParameter Name="prmSeqno" SessionField="prmSeq_rcpt_delete" Type="String" />
            <asp:SessionParameter Name="prmRcptDate" SessionField="prmDate_rcpt_delete" Type="String" />
            <asp:SessionParameter Name="prmTagno" SessionField="prmTag_rcpt_delete" Type="String" />
            ...
            <asp:Parameter Name="prmRecKey" DefaultValue="delete" Type="String" />
        </SelectParameters>
    </asp:ObjectDataSource>
</div>
