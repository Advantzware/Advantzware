<%@ Page Language="c#" AutoEventWireup="true" Debug="true" Inherits="Qty_Jobcust" Codebehind="qty_by_jobcust.aspx.cs" %>
<%@ Register Src="footer.ascx" TagName="Footer" TagPrefix="ft" %>
<%@ Register Src="header.ascx" TagName="Header" TagPrefix="hd" %>
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head id="Head1" runat="server">
    <title>Finished Goods Inventory Status by Customer</title>
    ...
    <form id="frmList" runat="server"   defaultfocus ='begincust_TextBox' >   
      ...
      <TABLE id="tblTop" cellSpacing="3" border="0">
        <TR>
          ...
          <TD align=center nowrap><font size=+0><b>Finished Goods Inventory Status by Customer&nbsp;</b></font></TD>
          <TD vAlign="middle">
      ...
      <td>
        ...
        <td align="right" style="padding-right: 5px"><b>Ending Sales Rep:</b></td>
         ...
         <tr><td></td><td>
          ...
          <tr><td></td><td>
              <b><asp:CheckBox ID="checkbox3"  Text=" Receipt Date?" runat="server" /></b></td></tr>
          <tr><td></td><td><b><asp:CheckBox ID="CheckBox4" Text="Print Customer Part# ?" runat="server" /></b></td></tr>
         ...
         <asp:FormView ID="FormView1" Visible="false"   runat="server" DataSourceID="ObjectDataSource1" OnPreRender="FormView1_PreRender">
            ...
            <ItemTemplate>
                ...
                vhhhjkkj:
                <asp:Label ID="vhhhjkkjLabel" runat="server" Text='<%# Bind("vhhhjkkj") %>'></asp:Label><br />
            </ItemTemplate>
        </asp:FormView>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="SelectQtycustjob" TypeName="reports">
            <SelectParameters>
                <asp:Parameter Name="prmUser" Type="String"  />
