            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign="Center" Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.ItemLookup5('<%#DataBinder.Eval(Container,"DataItem.vIno")%>','<%#DataBinder.Eval(Container,"DataItem.vName")%>','<%#DataBinder.Eval(Container,"DataItem.vPressType")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>     
