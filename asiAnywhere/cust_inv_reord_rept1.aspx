<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="cust_inv_reord_rep1" Codebehind="cust_inv_reord_rept1.aspx.cs" %>
...
function ShipToLookup(ReturnObj1){ 
  ...
  document.forms[0].BelocTextBoxfocus();
...
function ShipTo2Lookup(ReturnObj1){
    ...
    document.forms[0].EndlocTextBox.focus();
}
function procatlook(){ 
      ...
      <a href="#" tabindex="1" onClick="contactcustomerlook2(); return false"><asp:Image ID="Image3" runat="server" ImageUrl="images/lookup_icon.gif" /></a>
        ...
        <table class="shade" style="width: 700px">
         ...
         <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Button ID="submitbutton" OnClick="submitbutton_click" runat="server" class="buttonM" Text="Submit" />
          ...
          <asp:FormView ID="FormView1" OnPreRender="FormView1_PreRender" Visible="false" runat="server" DataSourceID="ObjectDataSource1">
                           
               <ItemTemplate>
                vCustFile:
                <asp:Label ID="vCustFileLabel" runat="server" Text='<%# Bind("vCustFile") %>'></asp:Label><br />
            </ItemTemplate>
        </asp:FormView>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="SelCustInvReReport1" TypeName="reports">
            <SelectParameters>
                <asp:Parameter Name="prmUser" Type="String" />
                ...
                <asp:Parameter Name="prmcustom" Type="String" />
                <asp:Parameter Name="prIncQoh" Type="String" />
                <asp:Parameter Name="prmUse" Type="String" />
                <asp:Parameter Name="prmAsDate" Type="DateTime" />
                <asp:Parameter Name="prmPrintPur" Type="String" />
