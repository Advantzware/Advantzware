<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="arvoid_csh_rcptreg" Codebehind="arvoid_csh_rcptreg.aspx.cs" %>
<%@ Register Src="footer.ascx" TagName="Footer" TagPrefix="ft" %>
<%@ Register Src="header.ascx" TagName="Header" TagPrefix="hd" %>
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head id="Head1" runat="server">
    <title>A/R Voided Cash Receipt Register</title>
...
<script language="javascript">
    function confirmPost() {
        var retVal = makeMsgBox("Confirmation", "Do you want to post voided cash receipts?", 48, 4, 256, 4096);
        if (retVal == 6) {
    ...
    <form id="frmList" runat="server"  defaultfocus='postdateTextBox'>   
      ...
      <TABLE id="tblTop" cellSpacing="3" align="center" border="0" Width="100%">
        <TR>
          ...
          <TD align=left nowrap><font size=+0><b>A/R Voided Cash Receipt Register&nbsp;</b></font></TD>
      ...
      <table class="shade" width="470px">
      <tr><td align="center" style="padding-right: 5px"><b>Transaction Date:</b>
      ...
      <tr><td align="center" style="padding-right: 5px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Period:</b>
      <asp:TextBox ID="perTextBox" onfocus="vendtext()" BackColor="Turquoise"  runat="server" Width="100px"></asp:TextBox></td>      
      </tr> 
      </table>      
          ...
          <asp:FormView ID="FormView1" Visible="false"  runat="server" 
              ...
              <ItemTemplate>
                  arvoid:
                  <asp:Label ID="arvoidLabel" runat="server" 
                      Text='<%# Bind("arvoid") %>'></asp:Label><br />   
                  ext:
          ...
          <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
              SelectMethod="ArVoidCashRegRcptReport" TypeName="account">
              <SelectParameters>
