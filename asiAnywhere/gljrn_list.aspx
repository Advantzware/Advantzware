<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="gljrn_list" Codebehind="gljrn_list.aspx.cs" %>
<%@ Register Src="footer.ascx" TagName="Footer" TagPrefix="ft" %>
<%@ Register Src="header.ascx" TagName="Header" TagPrefix="hd" %>
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head id="Head1" runat="server">
    <title>General Ledger Journal Entries</title>
   ...
   <body>
    <form id="frmList" runat="server"  defaultfocus='jurl_TextBox'>   
      ...
      <TABLE id="tblTop" cellSpacing="3" align="center" border="0" Width="100%">
        <TR>         
          <TD align=left nowrap><font size=+0><b>General Ledger Journal Entries&nbsp;</b></font></TD>
          <TD >
      ...
      <asp:LinkButton ID="lnk_Listcustomers" runat="server" >Brws Journals </asp:LinkButton></li>
      <li><asp:LinkButton ID="lnk_viewcustomers" runat="server" OnClick="lnk_viewcustomers_Click" > View Journals</asp:LinkButton></li></ul></div>
          ...
          <TD><fieldset>
            <TABLE id="tblSearch" cellSpacing="1" cellPadding="5" width="100%" border="0" class="shade" bgcolor="gray" >
              <TR >
                ...
                <asp:CompareValidator ID="CompareValidator1" ControlToValidate="jurl_TextBox" runat="server" Operator="DataTypeCheck" Type="Integer" Display="Dynamic" SetFocusOnError="true"  ErrorMessage="Integer Value Only"></asp:CompareValidator>
                </td>
                <td><b> Trx Date</b><br />
                    <asp:TextBox ID="trxdate_TextBox" Width="100px" onfocus="javascript:preEnter( this, 'yes' );" onblur="javascript:preLeave( this, 'date', '99/99/9999' );dateper();" runat="server"></asp:TextBox>                    
                    <a href="#" tabindex="1" onClick="showCalendarControl(trxdate_TextBox); return false"><asp:Image ID="Image1" runat="server" ImageUrl="images/lookup_icon.gif" /></a></td>
        ...
        <tr><td> 
            <asp:GridView ID="GridView1" runat="server" DataSourceID="ObjectDataSource1" EmptyDataText=" Records not  Found" AllowPaging="True" AllowSorting="True" Width="600px" AutoGenerateColumns="False" BorderStyle="Dotted" CssClass="Grid" OnSelectedIndexChanged="GridView1_SelectedIndex">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="tr_date" HeaderText="Date" SortExpression="tr_date" />
                    ...
                    <asp:BoundField DataField="reverse" HeaderText="" SortExpression="reverse" />
                    <asp:BoundField DataField="from_revr" HeaderText="" SortExpression="from_revr" />
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                OldValuesParameterFormatString="original_{0}" SelectMethod="GeneralLedgerlist" 
                TypeName="ledger">
                <SelectParameters>
                   <asp:Parameter DefaultValue="Search" Name="prmAction" Type="String" />                    
                   <asp:Parameter Name="prmComp"  Type="string" />
                   <asp:Parameter Name="prmUser" Type="string" />                     
                   <asp:SessionParameter SessionField="general_ledger_jrnl" Name="prmjrn_no" Type="Int32" />                   
                   <asp:SessionParameter SessionField="general_ledger_trdate" Name="prmtr_date" Type="String" />                   
