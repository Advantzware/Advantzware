<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="crdb_memo_report" Codebehind="crdb_memo_report.aspx.cs" %>
<%@ Register Src="footer.ascx" TagName="Footer" TagPrefix="ft" %>
<%@ Register Src="header.ascx" TagName="Header" TagPrefix="hd" %>
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head id="Head1" runat="server">
    <title>Credit/Debit Memo- Edit Register</title>
    ...
    <form id="frmList" runat="server"  defaultfocus='postdateTextBox'>   
      ...
      <TABLE id="tblTop" cellSpacing="3" align="center" border="0" Width="100%">
        <TR>
          ...
          <TD align=left nowrap><font size=+0><b>Credit/Debit Memo- Edit Register&nbsp;</b></font></TD>
      ...
      <asp:TextBox ID="perTextBox" onfocus="vendtext()" BackColor="Turquoise"  runat="server" Width="100px"></asp:TextBox></td>      
          ...
          <asp:FormView ID="FormView1" Visible="false"  runat="server" 
              ...
              <ItemTemplate>
                  crdb:
                  <asp:Label ID="crdbLabel" runat="server" 
                      Text='<%# Bind("crdb") %>'></asp:Label><br />                 
                  
              </ItemTemplate>                            
          </asp:FormView>
          
          <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
              SelectMethod="CreditDebitMemoRpt" TypeName="account">
              <SelectParameters>
