<%@ Page Language="C#" AutoEventWireup="true" Inherits="statecode_lookup" Codebehind="statecode_lookup.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>StateCode Lookup</title>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800">&nbsp;                
                <B>Search for:&nbsp; </B>&nbsp;&nbsp;&nbsp;
                  <asp:dropdownlist id="ddlSearchField" runat="server">
                      ...
                      <asp:ListItem Value="statecod">StateCode</asp:ListItem>  
    ...
    <div>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.StateCodeLookup('<%#DataBinder.Eval(Container,"DataItem.vStateCode")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>            

                 <asp:BoundField DataField="vStateCode" HeaderText="StateCode" SortExpression="vStateCode" />
                <asp:BoundField DataField="vDscrp" HeaderText="Description" SortExpression="vDscrp" />
                <asp:BoundField DataField="vFif" HeaderText="Description" SortExpression="vFif" />
       ...
       <input type="button" name="close" class="buttonM" id="close" value="Close" onclick="javascript:window.close()" />
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="SelStateCodeLook" TypeName="LookUp">
            <SelectParameters>               
