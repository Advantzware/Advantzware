<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="apinv_byvend" Codebehind="~/apinv_byvend.aspx.cs" %>
<%@ Register Src="footer.ascx" TagName="Footer" TagPrefix="ft" %>
<%@ Register Src="header.ascx" TagName="Header" TagPrefix="hd" %>
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head id="Head1" runat="server">
    <title>AP Invoices by Vendor</title>  
    ...
    <form id="frmList" runat="server"  defaultfocus='begvendTextBox'>   
      ...
      <TABLE id="tblTop" cellSpacing="3" align="center" border="0" Width="100%">
        <TR>
          ...
          <TD align=center nowrap><font size=+0><b>AP Invoices by Vendor   &nbsp;</b></font></TD>
     ...
     <tr><td align="right" style="padding-right: 5px"><b>Beginning Vendor#:</b></td>
        ...
        <td align="right" style="padding-right: 5px"><b>Ending Vendor#:</b></td>
          ...
          <tr><td align="right" style="padding-right:5px"><b>Beginning Inv Date:</b></td>
          <td>
          ...
          <td align="right" style="padding-right:5px"><b>Ending Inv Date:</b></td>
          <td>
         ...
         <tr><td></td><td><b><asp:CheckBox ID="CheckBox1" Text="Run By Post Date?" runat="server"></asp:CheckBox></b></td></tr>
        <tr><td colspan="3"><b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>OutPut To?:</b> <asp:RadioButtonList ID="RadioButtonList3" RepeatLayout="Flow"  CellSpacing="1" RepeatColumns="5" Font-Bold ="true" runat="server">
         ...
         <tr><td colspan="4">
          ...
          <asp:FormView ID="FormView1" Visible="False"   runat="server" 
              ...
              <ItemTemplate>
                   vendinv:
                  <asp:Label ID="vendinvLabel" runat="server" 
                      Text='<%# Bind("vendinv") %>'></asp:Label><br />
          ...
          <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
               SelectMethod="APInvoicesByVendor" TypeName="voucherpay">
              <SelectParameters>
                  <asp:Parameter Name="prmUser" Type="String" />
                  <asp:Parameter Name="prmvendinv" Type="String" />
                  ...
                  <asp:Parameter Name="prmrun" Type="String" />
