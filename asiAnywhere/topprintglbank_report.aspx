<%@ Page Language="c#" AutoEventWireup="true" Debug="true" Inherits="topprintglbank_report" Codebehind="topprintglbank_report.aspx.cs" %>
...
function banklook(ReturnObj1, ReturnObj2) {
    if (bnk == "1") {
        document.forms[0].begbnk_TextBox.value = ReturnObj1;
        document.forms[0].begdscr_TextBox.value = ReturnObj2;
    }
    else {
        document.forms[0].endbnk_TextBox.value = ReturnObj1;
        document.forms[0].enddscr_TextBox.value = ReturnObj2;
    }
}
function chk_enbl() {    
    ...
    <form id="frmList" runat="server"   defaultfocus ='txt_supplierscode' >   
      ...
      <TABLE id="tblTop" cellSpacing="3" border="0">
        <TR>
          ...
          <TD align=center nowrap><font size=+0><b>GL Bank List&nbsp;</b></font></TD>
       ...
       <asp:ListItem Text="1 By Bank " Value="1"></asp:ListItem>
       <asp:ListItem Text="2 By Bank name" Value="2"></asp:ListItem>
      ...
      <table class="shade">
        ...
        <tr>
            <td align="right" style="padding-right:5px"><b>Beginning Bank#:</b></td>
            <td nowrap>
                <asp:TextBox ID="begbnk_TextBox"  runat="server"></asp:TextBox>
        ...
        <td align="right" style="padding-right:5px"><b>Ending Bank#:</b></td>
            <td>
                <asp:TextBox ID="endbnk_TextBox"  runat="server"></asp:TextBox>
                 <a href="#" tabindex="1" onclick="banklookup(2); return false"><asp:Image ID="Image1" runat="server" ImageUrl="images/lookup_icon.gif" /></a>
            </td>
        </tr>
        ...
        <fieldset  style="width:550px" class="shade"><legend>Show Options</legend>
         ...
         <asp:FormView ID="FormView1" Visible="False" runat="server" DataSourceID="ObjectDataSource1" OnPreRender="FormView1_PreRender">
            ...
            <ItemTemplate>
                bnkrpt:
                <asp:Label ID="bnkrptLabel" runat="server" Text='<%# Bind("bnkrpt") %>'></asp:Label><br />
                bnkext:
                <asp:Label ID="bnkextLabel" runat="server" Text='<%# Bind("bnkext") %>'></asp:Label><br />
            </ItemTemplate>
                         
        </asp:FormView>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GLBankReportUp" TypeName="ledger">
            <SelectParameters>
                <asp:Parameter Name="prmUser" Type="String" />
                <asp:Parameter Name="prmAction" Type="String" />                                
                <asp:Parameter Name="prmbebnk" Type="String" />
                <asp:Parameter Name="prmbegbnkdr" Type="String" />
                <asp:Parameter Name="prmendbnk" Type="String" />
                <asp:Parameter Name="prmendbnkdr" Type="String" />                
