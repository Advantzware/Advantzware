<%@ Page Language="c#" AutoEventWireup="true" Debug="true" Inherits="corr_print_gsm2" Codebehind="corr_print_gsm2.aspx.cs" %>
    ...
    <form id="frmList" runat="server"   defaultfocus ='' >   
      ...
      <div>
          ...
          <asp:FormView ID="FormView1" runat="server" OnDataBound="formview1_databound" DataSourceID="ObjectDataSource1">
              ...
              <table ><tr><td><b>Overrides for Qty:</b></td>
              ...
              <td><asp:Label ID="ld_gsa_warTextBox" runat="server" Text='<%# Bind("[ld-gsa-war]") %>' />             
              </td></tr>
              ...
              <td><asp:Label ID="ld_gsa_war_u_cTextBox" runat="server" Text='<%# Bind("[ld-gsa-war-u-c]") %>' /></td></tr>
              
              <tr><td><b>Pallet Count:</b></td>
              <td><asp:Label ID="ld_gsa_war_cntTextBox"  runat="server" Text='<%# Bind("[ld-gsa-war-cnt]") %>' /></td></tr>
              
              <tr><td><b>Total Units:</b></td>
              <td><asp:Label ID="ld_gsa_war_uniTextBox" runat="server" Text='<%# Bind("[ld-gsa-war-uni]") %>' /></td></tr>
       ...
       &nbsp;
        <input type="button" name="Cancel" class="buttonM" id="close" value="Cancel" onClick="javascript:self.close();window.opener.location.reload();"  />
          ...
          <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
              OldValuesParameterFormatString="original_{0}" SelectMethod="SelectGsa2" 
              TypeName="Corrugated">
              <SelectParameters>
                  ...
                  <asp:QueryStringParameter QueryStringField="qty" Name="prmQty" Type="Int32" />
