<%@ Page Language="C#" AutoEventWireup="true" Inherits="zone_lookup" Codebehind="zone_lookup.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Zone Lookup</title>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800">&nbsp;                
    ...
    <div>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.zoneLookup('<%#DataBinder.Eval(Container,"DataItem.vZon")%>','<%#DataBinder.Eval(Container,"DataItem.vZonDscr")%>');window.close();">Select</a> 
                   </ItemTemplate>
                </asp:TemplateField>     
                 <asp:BoundField DataField="vZon" HeaderText="Zone" SortExpression="vZon" />
                 <asp:BoundField DataField="vZonDscr" HeaderText="Dscription" SortExpression="vZonDscr" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="SelectZone" TypeName="Corrugated">
            <SelectParameters>               
                ...
                <asp:QueryStringParameter QueryStringField="zone" Name="prmCarrier" Type="String" />
