<%@ Page Language="C#" AutoEventWireup="true" Inherits="CorFG_lookup" Codebehind="corfg_catlookup.aspx.cs" %>
                ...
                <B>Search for:&nbsp; </B>&nbsp;&nbsp;&nbsp;
                  <asp:dropdownlist id="ddlSearchField" runat="server">
                    <%--<asp:ListItem Value="Any">Any</asp:ListItem>--%>
                      <asp:ListItem Value="item">Category</asp:ListItem>  
    ...
    <div>
        <asp:GridView ID="GridView1"  AllowPaging="True" runat="server" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1"
		    ...
		    <a href="#" onClick="javascript:top.opener.window.categoryLookup('<%#DataBinder.Eval(Container,"DataItem.vProcat")%>','<%#DataBinder.Eval(Container,"DataItem.vDscr")%>');window.close();">Select</a>             	    
                ...
                <asp:BoundField Visible="false" DataField="vDdd" HeaderText="vDdd" SortExpression="vDdd" />
                
            </Columns>
        </asp:GridView>
        <input type="button" name="close" class="buttonM" id="close" value="Close" onclick="javascript:window.close()" />
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="SelectFGCat" TypeName="Corrugated">
            <SelectParameters>               
