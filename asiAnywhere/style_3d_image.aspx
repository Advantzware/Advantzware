<%@ Page Language="C#" AutoEventWireup="true" Debug="true" Inherits="style_3d_image" Title="Style LookUp" Codebehind="style_3d_image.aspx.cs" %>
...
<body>
    ...
    <div>
     ...
     <%-- <asp:LinkButton ID="lnk_boxdesign" runat="server" OnClick="lnk_boxdesign_Click" > <img src="Images/box design 0.jpg" border="0" alt="Box Design" /></asp:LinkButton>--%>
      ...
      <asp:LinkButton ID="lnk_3boxdesign" runat="server" OnClick="lnk_3boxdesign_Click" ><img src="Images/box 3d image 1.jpg" border="0" alt="3D Box Design" /></asp:LinkButton>
    ...
    <div>
     <table><tr><td><b>Design#:</b></td>
     <td>  <asp:Label ID="Label3" Font-Bold="true" runat="server" BackColor="Turquoise" Text="Label"></asp:Label></td>
     <td> &nbsp;&nbsp;<asp:Label ID="Label2" Font-Bold="true" BackColor="Turquoise"  runat="server" Text="Label"></asp:Label></td>
     </tr></table>
