<%@ Page Language="C#" AutoEventWireup="true" Inherits="corrAdder_look" Codebehind="coradd_look.aspx.cs" %>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.Machin2Lookup('<%#DataBinder.Eval(Container,"DataItem.vMcode")%>','<%#DataBinder.Eval(Container,"DataItem.vAttDscr")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>     
