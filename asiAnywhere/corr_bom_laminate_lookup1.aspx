<%@ Page Language="C#" AutoEventWireup="true" CodeFile="corr_bom_laminate_lookup.aspx.cs" Inherits="corr_bom_laminate_lookup" %>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		                <a href="#" onClick="javascript:top.opener.window.ItemLaminateLookup1('<%#DataBinder.Eval(Container,"DataItem.vItem2")%>','<%#DataBinder.Eval(Container,"DataItem.vItemName2")%>','<%#DataBinder.Eval(Container,"DataItem.vSqInch")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
