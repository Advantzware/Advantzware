<%@ Page Language="C#" AutoEventWireup="true" Inherits="corr_bom_laminate_lookup" Codebehind="corr_bom_laminate_lookup.aspx.cs" %>
...
<body>
    ...
    <div>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		                <a href="#" onClick="javascript:top.opener.window.ItemLaminateLookup('<%#DataBinder.Eval(Container,"DataItem.vItem2")%>','<%#DataBinder.Eval(Container,"DataItem.vItemName2")%>','<%#DataBinder.Eval(Container,"DataItem.vSqInch")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="vItem" HeaderText="Item No" SortExpression="vItem" />
                ...
                <asp:BoundField DataField="vCaliper" HeaderText="Caliper" HtmlEncode="false" DataFormatString="{0:0.####0}" SortExpression="vCaliper" />
                <asp:BoundField DataField="vWidth" HeaderText="Width" HtmlEncode="false" DataFormatString="{0:###,##0.0}" SortExpression="vWidth" />
                <asp:BoundField DataField="vLength" HeaderText="Length" HtmlEncode="false" DataFormatString="{0:###,##0.0}" SortExpression="vLength" />
                <asp:BoundField DataField="vQOH" HeaderText="Qty on Hand" HtmlEncode="false" DataFormatString="{0:###,###,##0.##0}" SortExpression="vQOH" />
                <asp:BoundField DataField="vCommitted" HeaderText="Committed" HtmlEncode="false" DataFormatString="{0:###,##0.0}" SortExpression="vCommitted" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="BOMItemLaminateLookup" TypeName="Corrugated">
            <SelectParameters>
                ...
                <asp:QueryStringParameter QueryStringField="item" Name="prmMatType" Type="String" />
                <asp:QueryStringParameter QueryStringField="code" Name="prmIndustry" Type="String" />
