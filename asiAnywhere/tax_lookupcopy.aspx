<%@ Page Language="C#" AutoEventWireup="true" Inherits="tax_lookupcopy" Codebehind="tax_lookupcopy.aspx.cs" %>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.TaxLookupcopy('<%#DataBinder.Eval(Container,"DataItem.vgroup")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>            
