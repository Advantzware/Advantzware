...
FIND FIRST est-qty WHERE est-qty.company EQ est.company AND est-qty.est-no  EQ est.est-no NO-LOCK NO-ERROR. 

FIND LAST ef WHERE ef.company EQ est-qty.company AND ef.est-no = est-qty.est-no AND ef.eqty EQ est-qty.eqty USE-INDEX est-qty NO-LOCK NO-ERROR.
