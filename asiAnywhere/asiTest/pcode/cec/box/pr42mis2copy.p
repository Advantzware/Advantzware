...
DEFINE TEMP-TABLE tt-prep-sep NO-UNDO
   FIELD CODE AS CHAR
   ...
   if (xeb.chg-method ne "P" and fr-tot <> 0) or avail est-prep
   then
    PUT SKIP(1)
   ...
   for each xef where xef.company = xest.company 
      ...
      if tmpstore = "new" then do i = 1 to 6:
         ...
         tmpstore = "done".
         put skip(1)
         "Miscellaneous Cost    Mat/F   Lab/F    Mat/M  Lab/M  Charge   Mrkup% Total Cost" 
         skip . leave.
      end.
