/*cec/quote/quoabox2.i*/
   ...
   PUT "<|5><R16><C1><#4><FROM><R20><C80><RECT>" SKIP
   "<R18><C1><FROM><R18><C80><LINE>" SKIP    
   "<R16><C11><FROM><R20><C11><LINE>" SKIP
   "<R16><C22><FROM><R20><C22><LINE>" SKIP
   "<R16><C40><FROM><R20><C40><LINE>" SKIP
   "<R16><C55><FROM><R20><C55><LINE>" SKIP
   "<R16><C68><FROM><R20><C68><LINE>" SKIP
   .
   ...
   terms.dscr FORM "x(15)" space(3) sman.sname FORM "x(15)" space(0) v-over-under SKIP.


   PUT "<|5><R21><C1><#5><FROM><R23><C80><RECT>" SKIP    
