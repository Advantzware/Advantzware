/*cec/quote/quoottp1.i */
   ...
   "<R18><C21><FROM><R22><C21><LINE>" SKIP
   "<R18><C39><FROM><R22><C39><LINE>" SKIP
   "<R18><C54><FROM><R22><C54><LINE>" SKIP
   ...
   space(1) terms.dscr FORM "x(15)" space(4) sman.sname space(0) v-over-under SKIP.
