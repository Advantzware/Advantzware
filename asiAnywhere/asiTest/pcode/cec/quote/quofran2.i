...
/*
  ...
  /* carrier.dscr FORM "x(20)" SPACE(1)*/
   terms.dscr FORM "x(30)" space(4) sman.sname space(2) /*v-over-under*/ SKIP.


   PUT "<|5><R22><C1><#5><FROM><R24><C80><RECT>" SKIP    
             "<R22><C7><FROM><R24><C7><LINE>" SKIP
             "<R22><C20><FROM><R24><C20><LINE>" SKIP
             "<R22><C45><FROM><R24><C45><LINE>" SKIP
            /* "<R28><C56><FROM><R30><C56><LINE>" SKIP*/
             "<R22><C63><FROM><R24><C63><LINE>" SKIP
