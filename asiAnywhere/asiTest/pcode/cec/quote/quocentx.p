...
*/             
        ...
        PUT "<R57><C1>" v-whse-txt 
             ...
             "<R60><C1>  accidents or other causes beyond our control. All quantities are subject to industry standard overrun / under run of up to 10%. Order quantities below 20,000 are" 
             "<R61><C1>  subject to overrun / under run up to 20%. "
