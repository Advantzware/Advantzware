 /* cec/quote/quohawl2.i */
   ...
   */  
   ...
   PUT "<|5><R23><C1><#4><FROM><R27><C81><RECT>" SKIP
   "<R25><C1><FROM><R25><C81><LINE>"     SKIP
   "<R23><C11><FROM><R27><C11><LINE>"    SKIP
   "<R23><C21><FROM><R27><C21><LINE>"    
   "<R23><C39><FROM><R27><C39><LINE>"    
