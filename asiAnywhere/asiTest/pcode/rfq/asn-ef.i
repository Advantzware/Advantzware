...
/*       ef.leaf-w[3]    = rfqitem.leaf-w[3]  
       ...
       ef.weight       = IF AVAIL ITEM THEN ITEM.basis-w ELSE 0
       .
    DO li-cnt = 1 TO 8:
...
ef.xgrain                                         
*/
MESSAGE "asnef" ef.company ef.loc ef.est-type ef.e-num   ef.est-no  ef.eqty .
