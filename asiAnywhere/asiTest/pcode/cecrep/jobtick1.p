...
if avail xoe-ordl then do:
  ...
  IF CAN-DO("Triad,Brick,Corrugat,RFC,ASI,Xprint,Pacific,Hughes,P&P,MWBox,ARTIOS,Suthrlnd,TriLakes,TriLakes2,LoyLang",v-format) THEN
  FIND FIRST xoe-rel
