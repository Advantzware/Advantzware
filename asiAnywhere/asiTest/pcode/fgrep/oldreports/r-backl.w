...
end_due-date tb_po-no tb_detailed tb_subt tb_jobs tb_qohgt0 rd_sort rd_show ~
rd_qoh rd-dest lv-ornt lines-per-page lv-font-no td-show-parm btn-ok ~
btn-cancel RECT-6 RECT-7 
&Scoped-Define DISPLAYED-OBJECTS begin_cust-no end_cust-no begin_slsmn ~
end_slsmn begin_ord-no end_ord-no begin_i-no end_i-no begin_due-date ~
end_due-date tb_po-no tb_detailed tb_subt tb_jobs tb_qohgt0 lbl_sort ~
rd_sort lbl_show1 rd_show lbl_qoh rd_qoh rd-dest lv-ornt lines-per-page ~
...
DEFINE FRAME FRAME-A
     ...
     begin_slsmn AT ROW 2.91 COL 27 COLON-ALIGNED HELP
          "Enter Beginning Salesman Number"
     end_slsmn AT ROW 2.91 COL 70 COLON-ALIGNED HELP
          "Enter Ending Salesman Number"
     ...
     tb_po-no AT ROW 6.95 COL 44
     tb_detailed AT ROW 7.67 COL 77 RIGHT-ALIGNED
     tb_subt AT ROW 8.38 COL 44
     tb_jobs AT ROW 9.1 COL 44
     tb_qohgt0 AT ROW 9.81 COL 44
     lbl_sort AT ROW 10.76 COL 35 COLON-ALIGNED NO-LABEL
     rd_sort AT ROW 10.76 COL 44 NO-LABEL
     lbl_show1 AT ROW 11.48 COL 35 COLON-ALIGNED NO-LABEL
     rd_show AT ROW 11.48 COL 44 NO-LABEL
     lbl_qoh AT ROW 12.19 COL 19 COLON-ALIGNED NO-LABEL
     rd_qoh AT ROW 12.19 COL 44 NO-LABEL
     rd-dest AT ROW 14.57 COL 5 NO-LABEL
     lv-ornt AT ROW 14.57 COL 29 NO-LABEL
     lines-per-page AT ROW 14.57 COL 82 COLON-ALIGNED
     lv-font-no AT ROW 16.48 COL 32 COLON-ALIGNED
     lv-font-name AT ROW 17.43 COL 26 COLON-ALIGNED NO-LABEL
     td-show-parm AT ROW 19.81 COL 28
     ...
     "(Summary Only)" VIEW-AS TEXT
          SIZE 15 BY .62 AT ROW 8.38 COL 65
...
ON LEAVE OF begin_slsmn IN FRAME FRAME-A /* Beginning Salesman# */
DO:
     assign {&self-name}.
END.
...
ON LEAVE OF end_slsmn IN FRAME FRAME-A /* Ending Salesman# */
DO:
     assign {&self-name}.
END.
...
------------------------------------------------------------------------------*/
  DISPLAY begin_cust-no end_cust-no begin_slsmn end_slsmn begin_ord-no 
          ...
          tb_detailed tb_subt tb_jobs tb_qohgt0 lbl_sort rd_sort lbl_show1 
          rd_show lbl_qoh rd_qoh rd-dest lv-ornt lines-per-page lv-font-no 
          lv-font-name td-show-parm 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE begin_cust-no end_cust-no begin_slsmn end_slsmn begin_ord-no 
         end_ord-no begin_i-no end_i-no begin_due-date end_due-date tb_po-no 
         tb_detailed tb_subt tb_jobs tb_qohgt0 rd_sort rd_show rd_qoh rd-dest 
...
format
  ...
  w-ord.est-no label "Estimate No."
