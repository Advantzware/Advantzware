...
DEFINE SHARED VAR vFileName AS CHAR  NO-UNDO.
...
------------------------------------------------------------------------------*/
    ...
    ASSIGN v-outputfile = v-webrootpath + "invoice_high_rpt_"  + cocode 
     + STRING(YEAR(TODAY), "9999") + STRING(MONTH(TODAY), "99") + ".xlsm"  .
     /*+ STRING(DAY(TODAY), "99") + REPLACE(STRING(TIME, "HH:MM:SS"), ":", "") .*/
