...
DEFINE TEMP-TABLE ttFoldMiscSub NO-UNDO
        ...
        .
DEFINE DATASET dsFoldMiscSub FOR ttFoldMiscSub .
...
DEFINE INPUT-OUTPUT PARAMETER DATASET FOR dsFoldMiscSub.
...
IF prmAction = "Select" THEN DO:
    ...
    MESSAGE "select" prmAction  prmEstimate prmComp prmForm prmBlank.
        
        IF AVAIL est AND AVAIL ef AND AVAIL eb THEN DO:
            CREATE ttFoldMiscSub.
            ASSIGN
                ttFoldMiscSub.vEstimate         = est.est-no   
                ttFoldMiscSub.vEstDate          = est.est-date
                ttFoldMiscSub.vForm             = ef.form-no  
                ttFoldMiscSub.vFormQty          = est.form-qty    
                ttFoldMiscSub.vBlk              = eb.blank-no
                ttFoldMiscSub.vBlkQty           = ef.blank-qty
                ttFoldMiscSub.vCustPart         = eb.part-no
                ttFoldMiscSub.vS1               = ef.mis-snum[1]
                ttFoldMiscSub.vB1               = ef.mis-bnum[1]
                ttFoldMiscSub.vCost1            = ef.mis-cost[1]
                ttFoldMiscSub.vMatf1            = ef.mis-matf[1]
                ttFoldMiscSub.vLabf1            = ef.mis-labf[1]
                ttFoldMiscSub.vMatm1            = ef.mis-matm[1]
                ttFoldMiscSub.vLabm1            = ef.mis-labm[1]
                ttFoldMiscSub.vSimon1           = ef.mis-simon[1]
                ttFoldMiscSub.vMarkUp1          = ef.mis-mkup[1]
                ttFoldMiscSub.vS2               = ef.mis-snum[2]
                ttFoldMiscSub.vB2               = ef.mis-bnum[2]
                ttFoldMiscSub.vCost2            = ef.mis-cost[2]
                ttFoldMiscSub.vMatf2            = ef.mis-matf[2]
                ttFoldMiscSub.vLabf2            = ef.mis-labf[2]
                ttFoldMiscSub.vMatm2            = ef.mis-matm[2]
                ttFoldMiscSub.vLabm2            = ef.mis-labm[2]
                ttFoldMiscSub.vSimon2           = ef.mis-simon[2]
                ttFoldMiscSub.vMarkUp2          = ef.mis-mkup[2]
                ttFoldMiscSub.vS3               = ef.mis-snum[3]
                ttFoldMiscSub.vB3               = ef.mis-bnum[3]
                ttFoldMiscSub.vCost3            = ef.mis-cost[3]
                ttFoldMiscSub.vMatf3            = ef.mis-matf[3]
                ttFoldMiscSub.vLabf3            = ef.mis-labf[3]
                ttFoldMiscSub.vMatm3            = ef.mis-matm[3]
                ttFoldMiscSub.vLabm3            = ef.mis-labm[3]
                ttFoldMiscSub.vSimon3           = ef.mis-simon[3]
                ttFoldMiscSub.vMarkUp3          = ef.mis-mkup[3]
                ttFoldMiscSub.vS4               = ef.mis-snum[4]
                ttFoldMiscSub.vB4               = ef.mis-bnum[4]
                ttFoldMiscSub.vCost4            = ef.mis-cost[4]
                ttFoldMiscSub.vMatf4            = ef.mis-matf[4]
                ttFoldMiscSub.vLabf4            = ef.mis-labf[4]
                ttFoldMiscSub.vMatm4            = ef.mis-matm[4]
                ttFoldMiscSub.vLabm4            = ef.mis-labm[4]
                ttFoldMiscSub.vSimon4           = ef.mis-simon[4]
                ttFoldMiscSub.vMarkUp4          = ef.mis-mkup[4]
                ttFoldMiscSub.vS5               = ef.mis-snum[5]
                ttFoldMiscSub.vB5               = ef.mis-bnum[5]
                ttFoldMiscSub.vCost5            = ef.mis-cost[5]
                ttFoldMiscSub.vMatf5            = ef.mis-matf[5]
                ttFoldMiscSub.vLabf5            = ef.mis-labf[5]
                ttFoldMiscSub.vMatm5            = ef.mis-matm[5]
                ttFoldMiscSub.vLabm5            = ef.mis-labm[5]
                ttFoldMiscSub.vSimon5           = ef.mis-simon[5]
                ttFoldMiscSub.vMarkUp5          = ef.mis-mkup[5]
                ttFoldMiscSub.vS6               = ef.mis-snum[6]
                ttFoldMiscSub.vB6               = ef.mis-bnum[6]
                ttFoldMiscSub.vCost6            = ef.mis-cost[6]
                ttFoldMiscSub.vMatf6            = ef.mis-matf[6]
                ttFoldMiscSub.vLabf6            = ef.mis-labf[6]
                ttFoldMiscSub.vMatm6            = ef.mis-matm[6]
                ttFoldMiscSub.vLabm6            = ef.mis-labm[6]
                ttFoldMiscSub.vSimon6           = ef.mis-simon[6]
                ttFoldMiscSub.vMarkUp6          = ef.mis-mkup[6]
                ttFoldMiscSub.vItem1            = ef.spec-no[1]
                ttFoldMiscSub.vItemDscr1        = ef.spec-dscr[1]
                ttFoldMiscSub.vQty1             = ef.spec-qty[1] * .0001
                ttFoldMiscSub.vUom1             = ef.spec-uom[1]
                ttFoldMiscSub.vItem2            = ef.spec-no[2]
                ttFoldMiscSub.vItemDscr2        = ef.spec-dscr[2]
                ttFoldMiscSub.vQty2             = ef.spec-qty[2] * .0001
                ttFoldMiscSub.vUom2             = ef.spec-uom[2]
                ttFoldMiscSub.vItem3            = ef.spec-no[3]
                ttFoldMiscSub.vItemDscr3        = ef.spec-dscr[3]
                ttFoldMiscSub.vQty3             = ef.spec-qty[3] * .0001
                ttFoldMiscSub.vUom3             = ef.spec-uom[3]
                ttFoldMiscSub.vItem4            = ef.spec-no[4]
                ttFoldMiscSub.vItemDscr4        = ef.spec-dscr[4]
                ttFoldMiscSub.vQty4             = ef.spec-qty[4] * .0001
                ttFoldMiscSub.vUom4             = ef.spec-uom[4]
                ttFoldMiscSub.vItem5            = ef.spec-no[5]
                ttFoldMiscSub.vItemDscr5        = ef.spec-dscr[5]
                ttFoldMiscSub.vQty5             = ef.spec-qty[5] * .0001
                ttFoldMiscSub.vUom5             = ef.spec-uom[5]
                ttFoldMiscSub.vItem6            = ef.spec-no[6]
                ttFoldMiscSub.vItemDscr6        = ef.spec-dscr[6]
                ttFoldMiscSub.vQty6             = ef.spec-qty[6] * .0001
                ttFoldMiscSub.vUom6             = ef.spec-uom[6]
                ttFoldMiscSub.vItem7            = ef.spec-no[7]
                ttFoldMiscSub.vItemDscr7        = ef.spec-dscr[7]
                ttFoldMiscSub.vQty7             = ef.spec-qty[7] * .0001
                ttFoldMiscSub.vUom7             = ef.spec-uom[7]
                ttFoldMiscSub.vItem8            = ef.spec-no[8]
                ttFoldMiscSub.vItemDscr8        = ef.spec-dscr[8]
                ttFoldMiscSub.vQty8             = ef.spec-qty[8] * .0001
                ttFoldMiscSub.vUom8             = ef.spec-uom[8]
