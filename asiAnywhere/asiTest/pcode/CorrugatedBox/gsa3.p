...
DEFINE TEMP-TABLE ttGsaFile3 NO-UNDO 
...
DEFINE DATASET dsGsa3File FOR ttGsaFile3.
...
DEFINE INPUT-OUTPUT PARAMETER DATASET FOR dsGsa3File.
DEFINE OUTPUT PARAMETER cError AS CHAR NO-UNDO.
    ...
    IF prmForm       = ? THEN ASSIGN  prmBlank      = 0.
...
ASSIGN
   ...
   FOR EACH probe WHERE probe.company = est.company and probe.est-no = est.est-no AND probe.LINE EQ prmSeq
...
if prmAction = "select" then do:
    ...
    FOR EACH ce-ctrl WHERE ce-ctrl.company = prmComp and  
        ...
        ASSIGN
           ttGsaFile3.vMatcost[1] = ce-ctrl.mat-cost[1] 
           ttGsaFile3.vMatcost[2] = ce-ctrl.mat-cost[2] 
           ttGsaFile3.vMatcost[3] = ce-ctrl.mat-cost[3] 
           ttGsaFile3.vMatcost[4] = ce-ctrl.mat-cost[4] 
           ttGsaFile3.vMatcost[5] = ce-ctrl.mat-cost[5] 
           ttGsaFile3.vMatcost[6] = ce-ctrl.mat-cost[6] 

           ttGsaFile3.vMatpct[1] = ce-ctrl.mat-pct[1]
           ttGsaFile3.vMatpct[2] = ce-ctrl.mat-pct[2]
           ttGsaFile3.vMatpct[3] = ce-ctrl.mat-pct[3]
           ttGsaFile3.vMatpct[4] = ce-ctrl.mat-pct[4]
           ttGsaFile3.vMatpct[5] = ce-ctrl.mat-pct[5]
           ttGsaFile3.vMatpct[6] = ce-ctrl.mat-pct[6]

           ttGsaFile3.vLabcost[1] = ce-ctrl.lab-cost[1]
           ttGsaFile3.vLabcost[2] = ce-ctrl.lab-cost[2]
           ttGsaFile3.vLabcost[3] = ce-ctrl.lab-cost[3]
           ttGsaFile3.vLabcost[4] = ce-ctrl.lab-cost[4]
           ttGsaFile3.vLabcost[5] = ce-ctrl.lab-cost[5]
           ttGsaFile3.vLabcost[6] = ce-ctrl.lab-cost[6]

           ttGsaFile3.vLabpct[1] = ce-ctrl.lab-cost[1]
           ttGsaFile3.vLabpct[2] = ce-ctrl.lab-cost[2]
           ttGsaFile3.vLabpct[3] = ce-ctrl.lab-cost[3]
           ttGsaFile3.vLabpct[4] = ce-ctrl.lab-cost[4]
           ttGsaFile3.vLabpct[5] = ce-ctrl.lab-cost[5]
           ttGsaFile3.vLabpct[6] = ce-ctrl.lab-cost[6] .
  ...
  IF AVAIL est THEN DO:
   ...
   ASSIGN
     ttGsaFile3.ld-gsa-brd     = calcpcts.val[1]
     ttGsaFile3.ld-gsa-mat     = prmGsaMat 
     ttGsaFile3.ld-gsa-lab     = prmGsaLab 
     ttGsaFile3.ld-gsa-war     = prmGsaWar 
     ttGsaFile3.ld-gsa-fm      = prmGsaFm  
     ttGsaFile3.ld-gsa-war-tot = ctrl2[1]
     ttGsaFile3.ld-qty         = qty 
     ttGsaFile3.cha-value      = cewhschg-cha     .
 ...
 /*FOR EACH brd
     ...
     ASSIGN
      ...
      ASSIGN
       ttGsaFile3.ld-gsa-war-u-c = IF AVAIL eb THEN eb.tr-cnt
                                    ELSE ROUND(qty / li-qty,0)
       ttGsaFile3.ld-gsa-war-u-p = 1
       ttGsaFile3.ld-gsa-war-amt = cewhschg-dec
       ttGsaFile3.ld-gsa-war-hdl = cewhschg-int
       ttGsaFile3.ld-gsa-war-per = li-qty.

      IF ttGsaFile3.ld-gsa-war-u-c NE 0 THEN
         v-dec = ld-qty / ttGsaFile3.ld-gsa-war-u-c.

      {sys/inc/roundup.i v-dec}

      ttGsaFile3.ld-gsa-war-uni = v-dec.
   ...
   /* IF NOT vprint OR est.override THEN*/
    ...
    FOR EACH b-probe NO-LOCK
      ...
      ASSIGN
       ttGsaFile3.ld-gsa-mat = b-probe.gsa-mat
       ttGsaFile3.ld-gsa-lab = b-probe.gsa-lab
       ttGsaFile3.ld-gsa-war = b-probe.gsa-war
       ttGsaFile3.ld-gsa-war-per = b-probe.gsa-war-per.
      ...
      FIND FIRST probe-ref NO-LOCK
          ...
          NO-ERROR.
      IF AVAIL probe-ref THEN ttGsaFile3.ld-gsa-brd = probe-ref.val[1].
      ...
      IF AVAIL probe-fm THEN
         ttGsaFile3.ld-gsa-fm = probe-fm.val[1].
      
     /* IF  vprint THEN
        ASSIGN
         ttGsaFile3.ld-gsa-war-amt = b-probe.gsa-war-amt
         ttGsaFile3.ld-gsa-war-hdl = b-probe.gsa-war-hdl
         ttGsaFile3.ld-gsa-war-tot = b-probe.gsa-war-tot
         ttGsaFile3.ld-gsa-war-u-c = b-probe.gsa-war-u-c
         ttGsaFile3.ld-gsa-war-cnt = b-probe.gsa-war-cnt
         ttGsaFile3.ld-gsa-war-uni = b-probe.gsa-war-uni
         ttGsaFile3.ld-gsa-war-pal = b-probe.gsa-war-pal
         ttGsaFile3.ld-gsa-war-per = b-probe.gsa-war-per
         ttGsaFile3.ld-gsa-war-u-p = b-probe.gsa-war-u-p.*/
...
PROCEDURE calc-count :
    ...
    ttGsaFile3.ld-gsa-war-cnt = DEC(ttGsaFile3.ld-gsa-war-u-c) * DEC(ttGsaFile3.ld-gsa-war-u-p).
...
PROCEDURE calc-pallets :
    ...
    ttGsaFile3.ld-gsa-war-pal  = DEC(ttGsaFile3.ld-gsa-war-uni) /
                                         DEC(ttGsaFile3.ld-gsa-war-u-p).
...
PROCEDURE calc-war-tot :
  ...
  ASSIGN
     li-qty = INT(ttGsaFile3.ld-gsa-war-pal)
     ld-tot = li-qty * DEC(ttGsaFile3.ld-gsa-war-hdl)
     li-qty = li-qty - INT(ttGsaFile3.ld-gsa-war-per).

    DO WHILE li-qty GT 0 AND INT(ttGsaFile3.ld-gsa-war-per) GT 0:
      ASSIGN
       ld-tot = ld-tot + (li-qty * DEC(ttGsaFile3.ld-gsa-war-amt))
       li-qty = li-qty - INT(ttGsaFile3.ld-gsa-war-per).
    END.
    ...
    ttGsaFile3.ld-gsa-war-tot = (ROUND(ld-tot,2)).
