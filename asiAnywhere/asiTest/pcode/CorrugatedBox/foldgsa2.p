...
/* ***************************  Definitions  ************************** */
DEFINE TEMP-TABLE ttFoldGsaFile2 NO-UNDO 
...
DEFINE DATASET dsFoldGsaFile2 FOR ttFoldGsaFile2.
...
DEFINE INPUT-OUTPUT PARAMETER DATASET FOR dsFoldGsaFile2 .
...
FOR EACH ce-ctrl WHERE ce-ctrl.company = prmComp and  
        ce-ctrl.loc = locode SHARE-LOCK.

        CREATE ttFoldGsaFile2 .

        ASSIGN
           ttFoldGsaFile2.vMatcost[1] = ce-ctrl.mat-cost[1] 
           ttFoldGsaFile2.vMatcost[2] = ce-ctrl.mat-cost[2] 
           ttFoldGsaFile2.vMatcost[3] = ce-ctrl.mat-cost[3] 
           ttFoldGsaFile2.vMatcost[4] = ce-ctrl.mat-cost[4] 
           ttFoldGsaFile2.vMatcost[5] = ce-ctrl.mat-cost[5] 
           ttFoldGsaFile2.vMatcost[6] = ce-ctrl.mat-cost[6] 

           ttFoldGsaFile2.vMatpct[1] = ce-ctrl.mat-pct[1]
           ttFoldGsaFile2.vMatpct[2] = ce-ctrl.mat-pct[2]
           ttFoldGsaFile2.vMatpct[3] = ce-ctrl.mat-pct[3]
           ttFoldGsaFile2.vMatpct[4] = ce-ctrl.mat-pct[4]
           ttFoldGsaFile2.vMatpct[5] = ce-ctrl.mat-pct[5]
           ttFoldGsaFile2.vMatpct[6] = ce-ctrl.mat-pct[6]

           ttFoldGsaFile2.vLabcost[1] = ce-ctrl.lab-cost[1]
           ttFoldGsaFile2.vLabcost[2] = ce-ctrl.lab-cost[2]
           ttFoldGsaFile2.vLabcost[3] = ce-ctrl.lab-cost[3]
           ttFoldGsaFile2.vLabcost[4] = ce-ctrl.lab-cost[4]
           ttFoldGsaFile2.vLabcost[5] = ce-ctrl.lab-cost[5]
           ttFoldGsaFile2.vLabcost[6] = ce-ctrl.lab-cost[6]
                        
           ttFoldGsaFile2.vLabpct[1] = ce-ctrl.lab-pct[1]
           ttFoldGsaFile2.vLabpct[2] = ce-ctrl.lab-pct[2]
           ttFoldGsaFile2.vLabpct[3] = ce-ctrl.lab-pct[3]
           ttFoldGsaFile2.vLabpct[4] = ce-ctrl.lab-pct[4]
           ttFoldGsaFile2.vLabpct[5] = ce-ctrl.lab-pct[5]
           ttFoldGsaFile2.vLabpct[6] = ce-ctrl.lab-pct[6] .
  ...
  IF AVAIL est THEN DO:
   ASSIGN
     ttFoldGsaFile2.ld-gsa-brd = calcpcts.val[1]
     ttFoldGsaFile2.ld-gsa-mat = prmGsaMat
     ttFoldGsaFile2.ld-gsa-lab = prmGsaLab
     ttFoldGsaFile2.ld-gsa-war = prmGsaWar
     ttFoldGsaFile2.ld-qty     = qty.
    ...
    FOR EACH b-probe NO-LOCK
      ...
      ASSIGN
       ttFoldGsaFile2.ld-gsa-mat = b-probe.gsa-mat
       ttFoldGsaFile2.ld-gsa-lab = b-probe.gsa-lab
       ttFoldGsaFile2.ld-gsa-war = b-probe.gsa-war.
      ...
      FIND FIRST probe-ref NO-LOCK
          ...
          NO-ERROR.
      IF AVAIL probe-ref THEN ttFoldGsaFile2.ld-gsa-brd = probe-ref.val[1].
      ...
      IF AVAIL probe-fm THEN
         ttFoldGsaFile2.foldgsa = probe-fm.val[1].
