...
/* ***************************  Definitions  ************************** */
DEFINE TEMP-TABLE ttFoldGsaFile NO-UNDO 
...
DEFINE DATASET dsFoldGsaFile FOR ttFoldGsaFile.
...
DEFINE INPUT-OUTPUT PARAMETER DATASET FOR dsFoldGsaFile .
...
FOR EACH ce-ctrl WHERE ce-ctrl.company = prmComp and  
        ...
        CREATE ttFoldGsaFile .

        ASSIGN
           ttFoldGsaFile.vMatcost[1] = ce-ctrl.mat-cost[1] 
           ttFoldGsaFile.vMatcost[2] = ce-ctrl.mat-cost[2] 
           ttFoldGsaFile.vMatcost[3] = ce-ctrl.mat-cost[3] 
           ttFoldGsaFile.vMatcost[4] = ce-ctrl.mat-cost[4] 
           ttFoldGsaFile.vMatcost[5] = ce-ctrl.mat-cost[5] 
           ttFoldGsaFile.vMatcost[6] = ce-ctrl.mat-cost[6] 

           ttFoldGsaFile.vMatpct[1] = ce-ctrl.mat-pct[1]
           ttFoldGsaFile.vMatpct[2] = ce-ctrl.mat-pct[2]
           ttFoldGsaFile.vMatpct[3] = ce-ctrl.mat-pct[3]
           ttFoldGsaFile.vMatpct[4] = ce-ctrl.mat-pct[4]
           ttFoldGsaFile.vMatpct[5] = ce-ctrl.mat-pct[5]
           ttFoldGsaFile.vMatpct[6] = ce-ctrl.mat-pct[6]

           ttFoldGsaFile.vLabcost[1] = ce-ctrl.lab-cost[1]
           ttFoldGsaFile.vLabcost[2] = ce-ctrl.lab-cost[2]
           ttFoldGsaFile.vLabcost[3] = ce-ctrl.lab-cost[3]
           ttFoldGsaFile.vLabcost[4] = ce-ctrl.lab-cost[4]
           ttFoldGsaFile.vLabcost[5] = ce-ctrl.lab-cost[5]
           ttFoldGsaFile.vLabcost[6] = ce-ctrl.lab-cost[6]

           ttFoldGsaFile.vLabpct[1] = ce-ctrl.lab-pct[1]
           ttFoldGsaFile.vLabpct[2] = ce-ctrl.lab-pct[2]
           ttFoldGsaFile.vLabpct[3] = ce-ctrl.lab-pct[3]
           ttFoldGsaFile.vLabpct[4] = ce-ctrl.lab-pct[4]
           ttFoldGsaFile.vLabpct[5] = ce-ctrl.lab-pct[5]
           ttFoldGsaFile.vLabpct[6] = ce-ctrl.lab-pct[6] .
...
MESSAGE "prmQty" prmQty . 
  ...
  IF AVAIL est THEN DO:
   ASSIGN
     ttFoldGsaFile.ld-gsa-brd = calcpcts.val[1]
     ttFoldGsaFile.ld-gsa-mat = prmGsaMat
     ttFoldGsaFile.ld-gsa-lab = prmGsaLab
     ttFoldGsaFile.ld-gsa-war = prmGsaWar
     ttFoldGsaFile.ld-qty     = qty.
    ...
    FOR EACH b-probe NO-LOCK
      ...
      ASSIGN
       ttFoldGsaFile.ld-gsa-mat = b-probe.gsa-mat
       ttFoldGsaFile.ld-gsa-lab = b-probe.gsa-lab
       ttFoldGsaFile.ld-gsa-war = b-probe.gsa-war.
      ...
      FIND FIRST probe-ref NO-LOCK
          ...
          NO-ERROR.
      IF AVAIL probe-ref THEN ttFoldGsaFile.ld-gsa-brd = probe-ref.val[1].
      ...
      IF AVAIL probe-fm THEN
         ttFoldGsaFile.foldgsa = probe-fm.val[1].
