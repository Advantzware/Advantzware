DEFINE TEMP-TABLE ttbalanordjob NO-UNDO
    FIELD vBalFile-job AS CHAR  .
   
    DEFINE DATASET dsbalanordjob FOR ttbalanordjob .
...
DEFINE INPUT-OUTPUT PARAMETER DATASET FOR dsbalanordjob.
...
def var v-po    like oe-relh.po-no   extent 2 init ["","zzzzzzzzzzzzzzz"] NO-UNDO.
...
CREATE ttbalanordjob.
    ASSIGN ttbalanordjob.vBalFile-job = vPdfFile.
