...
PUT "<FBook Antiqua><R45><C1><P12><B>     Shipping Instructions: </B> <P9> " SKIP(1)
    ...
    "<P9><=7><R+3><C3>Signature _______________________________________" SKIP(1)
    "<=7><R+5><C3>Date __________________________________________" SKIP 
    ...
    "<=7><C1><R+7><FROM><C+38><LINE> "  
    "<=7><C3><R+7>If charges are to be prepaid, write or stamp here, ""To be Prepaid""  "
    "<=7><C8><R+7.7><B><P14>" v-prepaid FORM "x(20)" "</B>"
    "<=7><P7><R+6><C72>Page " string(PAGE-NUM - lv-pg-num,">>9") + " of " + string(lv-tot-pg) FORM "x(20)" SKIP
    "<=7><R+10><C9>CLASS   <C42>DESCRIPTION OF ARTICLES" SKIP
    "<C1><FROM><C80><LINE> "   SKIP
    /*v-frt-class FORM "x(40)" AT 10 */
    "<=7><R+11><C10>55 <C36>Item #29280-sub 4, KD, other than corrugated, in packages" SKIP    
    "<C1><FROM><C80><LINE> "   SKIP
    "<=7><R+12><C10>70 <C36>Item #29275-sub 4, KD, corrugated, in packages" SKIP
    "<C1><FROM><C80><LINE> "   SKIP
    .
