   ...
   /*      "<P10><ADJUST=LPI><=1><R+1>"  */ SKIP
       ...
       PUT    "<P10><ADJUST=LPI>"
              ...
              /*  "<R19><C25><FROM><R23><C25><LINE>" SKIP      */
                ...
                "<FCourier New><=4><R+3> " oe-bolh.bol-date SPACE(3) /*v-po-no FORM "x(15)" space(2) v-job-no*/ v-fob space(10) v-trailer SPACE(10) carrier.dscr FORM "x(26)" SPACE(2) v-frt-terms SKIP
