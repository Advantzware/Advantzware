...
for each report where report.term-id eq v-term-id,
  ...
  IF lv-bolfmt-int = 1 THEN DO:  /* show summary per item */
    IF LAST-OF(report.key-02) THEN DO:
       ...
       FOR EACH w2 BREAK BY w2.cases * w2.cas-cnt DESC:
         i = i + 1.
         IF i eq 1 THEN ASSIGN v-job-po    = IF NOT v-broker THEN oe-boll.po-no
                                                             ELSE ""                                                              
  ...
  ELSE DO:
     ...
     DISPLAY  {1}
          ...
          IF NOT v-broker THEN oe-boll.po-no ELSE "" AT 11
          oe-boll.i-no                    AT 27
         ...
         SKIP          
          ...
          oe-ordl.part-dscr2  FORM "x(30)" AT 42
          SKIP
