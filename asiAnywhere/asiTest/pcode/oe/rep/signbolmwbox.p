...
output stream last-page to value("c:\tmp\bolempir.txt") page-size 66.
...
*/
  PUT "<FArial><R47><C1><P12><B>     Shipping Instructions: </B> <P9> " 
    "<R49><C1>" oe-bolh.ship-i[1] AT 7
    "<R50><C1>" oe-bolh.ship-i[2] AT 7 
    "<R51><C1>" oe-bolh.ship-i[3] AT 7 
    "<R52><C1>" oe-bolh.ship-i[4] AT 7 
    ...
    "<R61><C7>" "Date _______________________________                           Date _______________________________________"   AT 20    
    .
