     ...
     /* "<P14><=#3>" /*<C-20><R-2> <B>Bill Of Lading</B>*/ "<P10>" SKIP
             ...
             /*   "<=#3><R+2>" /*Ship Date:" oe-bolh.ship-date        */ SKIP
              ...
              /*"<R19><C24><FROM><R23><C24><LINE>" SKIP      */
                ...
                "<R19><C62><FROM><R23><C62><LINE>" SKIP
                /*"<R19><C69><FROM><R23><C69><LINE>" SKIP*/
                "<=4><R+1>    Date               FOB                       Carrier                    Freight Terms    " SKIP
                "<=4><R+3> " oe-bolh.bol-date /*v-po-no FORM "x(15)" */ space(6) /*v-ord-no*/ v-fob space(11) space(1) carrier.dscr space(3) v-frt-terms /*SPACE(1) v-tot-wt*/ SKIP
                ...
                "<R24><C59><FROM><R26><C59><LINE>" 
                "<R24><C71.5><FROM><R26><C71.5><LINE>" SKIP            
