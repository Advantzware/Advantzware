...
DEF VAR v-po-printed AS LOG NO-UNDO.
...
PUT "<FBook Antiqua><R48><C1><P12><B>     Shipping Instructions: </B> <P9> " SKIP(1)
    ...
    "<R62><C7>" "Date _____________________________________                           Date _______________________________________"   AT 23 SKIP    
    /*
