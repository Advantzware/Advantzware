/* ---------------------------------------------- oe/rep/bolsoule.p -------- *
*    Program Name  : oe/rep/bolsoule.p                                       *
      Author       :                                                         *
...
/*                 lv-email    = v-cusx-email  */
  ...
  PUT "<FArial><R50><C1><P6> * Customer responsible to inspect incoming material for any possible damage and verification of count." 
  ...
  PUT "<FArial><R51><C1><P12><B>     Shipping Instructions: </B> <P9> " 
    "<R52><C1>" v-ship-i[1] AT 7 
    "<R53><C1>" v-ship-i[2] AT 7 
    "<R54><C1>" v-ship-i[3] AT 7 
    "<R55><C1>" v-ship-i[4] AT 7 
    "<R56><C1>"
    "__________________________________________________________________________________________________________________" 
    "<R57><C1>" "<B>  Signature of Receipt </B>"                  "<C42> Carrier       " 
    "<R58><C14><#1><R+7><C+46><IMAGE#1=" ls-full-img3 
