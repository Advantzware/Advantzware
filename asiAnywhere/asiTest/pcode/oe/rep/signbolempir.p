...
form header
   ...
   with frame bol-top  no-box no-underline stream-io width 80.
...
PUT 
    "<R55>Total Pallets:"               to 60
     v-tot-cases                    to 80
     "<R56>Total Weight:"                to 60
     v-tot-wt                       to 80
     SKIP(1)
    "<R57>------------------------------------------------------------------------------------"
    "<R58><C5>" "<B>  Customer: </B>"                  "<C32> Carrier       " 
    "<R59><C11><#1><R+5><C+46><IMAGE#1=" ls-full-img3 
    "<R64><C5>" "<B>  Date: </B>"                      "<C32> Date          "
    . 
