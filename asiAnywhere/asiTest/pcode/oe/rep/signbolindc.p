/* ---------------------------------------------- oe/rep/signbolindc.p  */
/* PRINT Indiana Carton 
Created date : 18 march 2010                                                      */
/* -------------------------------------------------------------------------- */
...
ls-full-img1 = SEARCH(ls-image1) + ">".             /*FILE-INFO:FULL-PATHNAME + ">".*/
...
PUT "<FBook Antiqua><R41><C1><P12><B>     Shipping Instructions: </B> <P9> " SKIP(1)
    ...
    "<#7><FROM><C+80><R+13><RECT>" SKIP
    "<=7><P6><C3>Subject to Section 7 of Conditions of applicable bill of lading, if
    this shipment is to be delivered to the consignee without recourse on
    the consignor, the consignor shall sign the following statement:"
    "<=7><P6><C3><R+1>The carrier shall not make delivery of this shipment without payment
    of freight and all other lawful charges."
   
    "<P9><=7><R+2><C3>Signature"                             "<C42>  Carrier " SKIP(1)
    "<R51><C10><#1><R+7><C+46><IMAGE#1=" ls-full-img3
    
    "<=7><R+10><C3>Date __________________________________   " SKIP 
    "<=7><R+10><C40>Date __________________________________" SKIP   
   
    "<=7><C1><R+11><FROM><C+38><LINE> "  
    "<=7><C3><R+11>If charges are to be prepaid, write or stamp here, ""To be Prepaid""  "
    "<=7><C8><R+11.7><B><P14>" v-prepaid FORM "x(20)" "</B>"
    "<=7><P7><R+11><C72>Page " string(PAGE-NUM - lv-pg-num,">>9") + " of " + string(lv-tot-pg) FORM "x(20)" SKIP
    "<=7><R+14><C9>CLASS   <C42>DESCRIPTION OF ARTICLES" SKIP
    "<C1><FROM><C80><LINE> "   SKIP
    /*v-frt-class FORM "x(40)" AT 10 */
    "<=7><R+15><C10>55 <C36>Item #29280-sub 4, KD, other than corrugated, in packages" SKIP    
    "<C1><FROM><C80><LINE> "   SKIP
    "<=7><R+16><C10>70 <C36>Item #29275-sub 4, KD, corrugated, in packages" SKIP
    "<C1><FROM><C80><LINE> "   SKIP
    .
