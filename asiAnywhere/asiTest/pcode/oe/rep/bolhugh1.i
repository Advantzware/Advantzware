/* oe/rep/bolhugh1.i */
      ...
      put 
         "<FArial>"  SKIP
          "<P14><C+35><B>Bill Of Lading</B> " SKIP
        ...
        "<FArial><P14><=#3>" /*<C-20><R-2> <B>Bill Of Lading</B> */ "<P10>" SKIP
              ...
              /*  "<R19><C25><FROM><R23><C25><LINE>" SKIP      
                ...
                "<FCourier New><=4><R+3> " oe-bolh.bol-date SPACE(3) /*v-po-no FORM "x(15)" space(2) v-job-no*/ v-fob space(15) carrier.dscr SPACE(8) v-frt-terms SKIP
            ...
            "<FArial><=5><R+1> Part# / Ord Qty.         PO# / Rel Qty            FG Item# / Job#      Description                     Unit-Quantity  Partial/Complete  Wt.lbs." SKIP(1)
            "<FCourier New>"                                  
            .
