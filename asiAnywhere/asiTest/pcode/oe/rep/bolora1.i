/* oe/rep/bolcent1.i */      
     ...
     /* "<P14><=#3>" /*<C-20><R-2> <B>Bill Of Lading</B>*/ "<P10>" SKIP
             ...
             /*   "<=#3><R+2>" /*Ship Date:" oe-bolh.ship-date        */ SKIP
                ...
                "<=4><R+3> " oe-bolh.bol-date /*v-po-no FORM "x(15)" */ space(4) v-ord-no space(7) v-fob space(1) carrier.dscr FORMAT "x(22)" space(3) v-frt-terms SPACE(1) v-tot-wt SKIP
                ...
                "<R24><C53><FROM><R26><C53><LINE>" 
                "<R24><C68><FROM><R26><C68><LINE>" SKIP            
                "<R24><C77><FROM><R26><C77><LINE>"
            "<=5><R+1>    Part#       PO#/JOB#        Description             PAL    Cases-Quantity      Total  P/C" SKIP(1)
            .
