      ...
      put 
        ...
        /*"<R9><C46><#3>" SKIP*/
          "<R9><C46>" SKIP
                ...
                "<=4><R+3> " oe-bolh.bol-date /*v-po-no FORM "x(15)" */ space(4) v-ord-no space(7) v-fob space(1) carrier.dscr space(3) v-frt-terms /*SPACE(1) v-tot-wt*/ SKIP
