...
PUT "<FArial><R46><C1><P12><B>     Shipping Instructions: </B> <P9> " SKIP(1)
   ...
   "<R54><C1>" "<B>  Signature of Receipt </B>"                  "<C42> Carrier       " 
    "<R55><C14><#1><R+7><C+46><IMAGE#1=" ls-full-img3 
    "<R60><C7>" "Date _______________________________                           Date _______________________________________"   AT 20    
    .
