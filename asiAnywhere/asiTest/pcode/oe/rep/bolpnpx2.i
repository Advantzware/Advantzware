   ...
   put "<FArial>"  SKIP
        ...
        "<FArial><P14><=#3>" /*<C-20><R-2> <B>Bill Of Lading</B> */ "<P10>" SKIP
              ...
              /*  "<R19><C25><FROM><R23><C25><LINE>" SKIP      
                ...
                "<FCourier New><=4><R+3> " oe-bolh.bol-date SPACE(3) /*v-po-no FORM "x(15)" space(2) v-job-no*/ v-fob space(15) carrier.dscr SPACE(7) v-frt-terms SKIP
                ...
                "<R24><C75.8><FROM><R26><C75.8><LINE>" SKIP.
