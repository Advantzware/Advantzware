/* ---------------------------------------------- oe/rep/signbolcolor.p 07/09 GDM 
    File        : oe/rep/signbolcolor.p
    Purpose     : BOL Print
...
ASSIGN
        ls-image1   = vImage  /*"images\icc.jpg" */  .
ASSIGN
...
*/
  PUT "<R50><C50><#8><FROM><R+4><C+30><RECT> " 
    "<=8><R+1> Total Cases       :" v-tot-cases 
    "<=8><R+3> Total Weight      :" v-tot-wt 
    "<FArial><R47><C1><P12><B>     Shipping Instructions: </B> <P9> " 
    ...
    "<R55><C13><#1><R+8><C+45><IMAGE#1=" ls-full-img                      
    "<R62><C1>" "Date __________________________________                       Date _________________________________" AT 20    
    .
