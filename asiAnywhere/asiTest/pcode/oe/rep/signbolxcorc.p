...
/*    if can-do("COD,CIA", oe-ord.terms) then v-terms = oe-ord.terms-d. */
  ...
  PUT "<R50><C53><#8><FROM><R+4><C+30><RECT> " 
...
PUT "<FArial><R50><C1><P12><B>     Shipping Instructions: </B> <P9> " SKIP(1)
    ...
    "<P10><ADJUST=LPI><R57><C1>" "<B>  Signature of Receipt </B>"                  "<C42> Carrier       " 
    "<R58><C14><#1><R+7><C+46><IMAGE#1=" ls-full-img3 
    "<R63><C7>" "Date ___________________________                       Date ___________________________________"   AT 20 SKIP(1)   
