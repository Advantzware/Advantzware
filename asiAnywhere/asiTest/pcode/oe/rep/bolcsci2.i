 ...
 put 
        ...
        "<FArial><P14><=#3><P10>" SKIP
                ...
                "<FCourier New><=4><R+3> " oe-bolh.bol-date SPACE(3) v-fob space(15) oe-bolh.trailer space(20) v-frt-terms SKIP
            ...
            "<FArial><=5><R+1> Part#                        PO#                            Finished Good#        Description                     Unit-Quantity              P /  C        Sq Ft" SKIP(1)
            "<FCourier New>"                                  
            .
