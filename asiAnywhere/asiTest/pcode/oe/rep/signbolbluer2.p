...
format header
    ...
    with frame bol-top   no-box no-underline stream-io width 85.
...
form header
    ...
    with frame bol-bot2 page-bottom no-box no-underline stream-io width 185.
...
view stream last-page frame bol-top.
  ...
  {oe/rep/signbolbluer.i "stream last-page"}

  v-page-tot = page-number (last-page) - v-last-page.

  {oe/rep/signbolbluer.i}
...
PUT 
    ...
    "<R58><C1>" "<B>  Received by: </B>"                  "<C32> Date       " 
