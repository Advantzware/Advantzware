...
for each xxreport where xxreport.term-id eq v-term-id,
    ...
    assign
     ...
     v-ship-addr3   = shipto.ship-city + ", " +
                      shipto.ship-state + "  " +
                      shipto.ship-zip
     v-phone-num    = "(" + shipto.area-code + ")"  + shipto.phone.
  ...
  PUT "<R50><C50><#8><FROM><R+4><C+30><RECT> " 
    "<=8><R+1> Total Units       :" /*v-tot-cases*/ v-tot-palls
    "<=8><R+3> Total Weight      :" v-tot-wt /*fORM ">>,>>9.99"*/ .
    
  PUT "<FArial><R47><C1><P12><B>     Shipping Instructions: </B> <P9> " 
    "<R49><C1>" oe-bolh.ship-i[1] 
    "<R50><C1>" oe-bolh.ship-i[2] 
    "<R51><C1>" oe-bolh.ship-i[3] 
    "<R52><C1>" oe-bolh.ship-i[4] 
    "<R54><C1>"
    "__________________________________________________________________________________________________________________" 
    "<R55><C1>" "<B>  Signature of Receipt </B>"                  "<C42> Carrier       " 
    "<R56><C14><#1><R+7><C+46><IMAGE#1=" ls-full-img3 
    "<R61><C7>" "Date ___________________________________                    Date __________________________________"   AT 20 SKIP(1)   
    .
