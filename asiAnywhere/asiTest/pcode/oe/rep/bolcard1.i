...
PUT
  ...
  "<C1><R-1><#1><R+9><C+29>" "<IMAGE#1=" + ls-full-img1 FORM "x(60)" SKIP 
/*   "<=1><R+2>" "<FGCOLOR=" + TRIM(lv-comp-color) + ">" FORM "x(15)" */
  ...
  */    
    SKIP(5)
  "<FCourier New><B>"
  SPACE(30) "<P12><B>" "Ship To:" AT 59  "</B><P10>" SKIP
  SPACE(5) v-comp-name    "<P12><B>" v-ship-name    AT 45 "</B><P10>" SKIP
  SPACE(5) v-comp-addr[1] "<P12><B>" v-ship-addr[1] AT 45 "</B><P10>" SKIP
  SPACE(5) v-comp-addr[2] "<P12><B>" v-ship-addr[2] AT 45 "</B><P10>" SKIP
  SPACE(5) v-comp-addr3   "<P12><B>" v-ship-addr3   AT 45 "</B><P10>" SKIP.
...
/*   "<FArial><=5><R+1> Order Qty / Part#            PO# / Job#                        Description                                              Units    Count         Total          P/C" SKIP(1) */
  "<FArial><=5><R+1> Customer Part #                PO #                            Description                                                Units    Count         Total          P/C" SKIP(1)
  "<FCourier New>"                                  
  .
