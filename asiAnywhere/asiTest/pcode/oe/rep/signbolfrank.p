/* ---------------------------------------------- oe/rep/signbolfrank.p 01/05 YSK */
/* PRINT Frankstn                                                             */
/* -------------------------------------------------------------------------- */
...
DEF VAR ls-full-img3 AS CHA FORM "x(100)"  NO-UNDO.
...
/*    if can-do("COD,CIA", oe-ord.terms) then v-terms = oe-ord.terms-d. */
  ...
  PUT "<R38><C40><#7><C-6>Shipper Signature"
      "<=7><C+10><FROM><R+2><C+20><RECT> " 
      "<R40><C50><#8><FROM><R+4><C+30><RECT> " 
...
PUT "<FBook Antiqua><R38><C1><P12><B>     Shipping Instructions: </B> <P9> " SKIP(1)
    ...
    "_________________________________________________________________________________________________________________________________" SKIP
     "<R46><C1>" "<B>  Signature of Receipt </B>"                  "<C42> Carrier       " 
     "<R47><C14><#1><R+7><C+46><IMAGE#1=" ls-full-img3 
