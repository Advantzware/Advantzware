...
PUT "<FBook Antiqua><R44><C1><P12><B>     Shipping Instructions: </B> <P9> " SKIP(1)
    ...
    "<R51><C1>" "<B>  Signature of Receipt </B>"                  "<C42> Carrier       " 
    "<R52><C14><#1><R+6><C+46><IMAGE#1=" ls-full-img3 
    "<R57><C7>" "Date ___________________________________                              Date ___________________________________"   AT 20 SKIP(1)   
