...
/*    if can-do("COD,CIA", oe-ord.terms) then v-terms = oe-ord.terms-d. */
    ...
    PUT "<R46><C52><#8><FROM><R+4><C+30><RECT> " 
    ...
    "<P10><ADJUST=LPI><R53><C1>" "<B>  Signature of Receipt </B>"                  "<C42> Carrier       " 
    "<R54><C14><#1><R+7><C+46><IMAGE#1=" ls-full-img3 
    "<R60><C7>" "Date _____________________________                    Date __________________________________"   AT 20 SKIP(1)   
