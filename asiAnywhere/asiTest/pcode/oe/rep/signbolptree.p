...
FOR EACH oe-boll where oe-boll.company eq oe-bolh.company and oe-boll.b-no eq oe-bolh.b-no:
  ...
  PUT "<R56><C50><#8><FROM><R+4><C+30><RECT>" 
      "<=8><R+1> Total Pallets       :" v-tot-palls.

  PUT "<FArial><R55><C1><P12><B>     Shipping Instructions: </B> <P9> " 
    "<R56><C1>" oe-bolh.ship-i[1] AT 7 /* 53 */
    "<R57><C1>" oe-bolh.ship-i[2] AT 7 
    "<R58><C1>" oe-bolh.ship-i[3] AT 7 
    "<R59><C1>" oe-bolh.ship-i[4] AT 7 
    "<R60><C1>"
    "__________________________________________________________________________________________________________________" 
    "<R61><C1>" "<B>  Signature of Receipt </B>"                  "<C42> Carrier       " 
    "<R62><C14><#1><R+6><C+46><IMAGE#1=" ls-full-img3 
      .
  PAGE.
