...
"<R19><C56><FROM><R23><C56><LINE>" SKIP
"<R19><C71><FROM><R23><C71><LINE>" SKIP
.

PUT "<=4><R+1> Ready Date     FOB           Ship Via              Terms          Sales Person       Order#" SKIP
"<=4><R+3> " oe-ord.due-date FORM "99/99/9999" space(2)
cust.fob-code FORM "x(14)" SPACE(1)
v-shipvia /*carrier.carrier*/ FORM "x(17)" SPACE(1)
oe-ord.terms-d /*terms.dscr*/ FORM "x(20)" SPACE(1) v-salesman FORM "x(18)" space(1) oe-ord.ord-no SKIP.

PUT "<|10><R24><C1><#5><FROM><R26><C80><RECT>" SKIP    
       "<R24><C14.2><FROM><R26><C14.2><LINE>" SKIP
       "<R24><C27><FROM><R26><C27><LINE>" SKIP
       "<R24><C45.5><FROM><R26><C45.5><LINE>" SKIP
       "<R24><C56><FROM><R26><C56><LINE>" SKIP
       "<R24><C65.3><FROM><R26><C65.3><LINE>" SKIP
       "<R24><C69><FROM><R26><C69><LINE>" SKIP
       .

PUT "<=5><R+0> FG Item #                                            Pcs / Cases                             " SKIP
    "<=5><R+1> Your Part#      Customer PO#    Description            Ordered    Unit Price UOM   Ext. Price" SKIP(1).
