...
PUT "<FBook Antiqua><R42><C1><P12><B>     Shipping Instructions: </B> <P9> " SKIP(1)
    ...
    "<R49><C1>" "<B>  Signature of Receipt </B>"                  "<C42> Carrier       " 
    "<R50><C14><#1><R+7><C+46><IMAGE#1=" ls-full-img3 
    "<R56><C7>" "Date ___________________________________                           Date _______________________________________"   AT 20  SKIP(1)
    ...
    "<C24><P6>A.   FOLDING CARTONS KDF, NOT CORRUGATED   CLASS 55" SKIP    
    "<C24>B.   ASSEMBLED SETUP TOP AND BOTTOM PACKED CORR. CTN   CLASS 150" SKIP
    .
