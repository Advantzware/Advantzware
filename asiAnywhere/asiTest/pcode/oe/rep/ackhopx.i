...
PUT "<|5><R4><C50><#3><FROM><R10><C80><RECT>" SKIP.
...
PUT "<|5><R19><C1><#4><FROM><R23><C81><RECT>" SKIP
...
oe-ord.terms-d FORM "x(15)" space(5) v-salesman space(7) oe-ord.ord-no space(2) v-q-no SKIP.


PUT "<|5><R24><C1><#5><FROM><R26><C81><RECT>" SKIP    
