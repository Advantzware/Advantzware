...
PUT "<FArial><R48><C1><P12><B>     Shipping Instructions: </B> <P9> "
    "<R50><C4>" oe-bolh.ship-i[1] 
    "<R51><C4>" oe-bolh.ship-i[2] 
    "<R52><C4>" oe-bolh.ship-i[3] 
    "<R53><C4>" oe-bolh.ship-i[4]
    "<R54><C1>" "__________________________________________________________________________________________________________________" 
    "<R55><C1>" "<B>  Signature of Receipt </B>"                  "<C38> Carrier       " 
    "<R56><C14><#1><R+6><C+46><IMAGE#1=" ls-full-img3 
    "<R62><C8>" "Date ___________________________________             Date _________________________________________" 
    .
