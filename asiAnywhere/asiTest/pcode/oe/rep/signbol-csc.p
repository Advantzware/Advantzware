...
FORM v-qty             to 9    format ">>>,>>9"
    ...
    with frame detail no-attr-space NO-LABEL NO-BOX no-underline down STREAM-IO width 80.
...
for each report   where report.term-id eq v-term-id,
    ...
    IF v-i-dscr[1] = "" THEN 
     ...
     /*if li = 1 AND v-printline gt 28 then do:
        put skip(29 - v-printline)
            "Page"
            PAGE-NUMBER - 1  /*- v-last-page format ">9"*/  .
  ...
  PUT "<FArial>"
   "<R54><C1> "  "Page"   PAGE-NUM  /*- v-last-page*/  
