/* ---------------------------------------------- oe/rep/signboldee.p 09/05 YSK */
/* PRINT BOL for Ott Package  */
/* -------------------------------------------------------------------------- */
...
def var v-ship-phone-num         as   char format "x(13)" no-undo.
...
ASSIGN ls-image1 = "images\dee.jpg".
...
DEF VAR lv-po-printed AS LOG NO-UNDO.
...
ASSIGN
    FILE-INFO:FILE-NAME = ls-image3.
    ls-full-img3 = FILE-INFO:FULL-PATHNAME + ">" .
  ...
  if first-of(oe-bolh.bol-no) then do:
    ...
    assign
     ...
     v-ship-addr3   = shipto.ship-city + ", " +
                      shipto.ship-state + "  " +
                      shipto.ship-zip
     v-ship-phone-num    = shipto.area-code + shipto.phone.
...
/*    if can-do("COD,CIA", oe-ord.terms) then v-terms = oe-ord.terms-d. */
  ...
  PUT "<R50><C40><#7><C-6>Shipper Signature"
...
PUT "<FArial><R50><C1><P12><B>     Shipping Instructions: </B> <P9> " 
    "<R51><C1>" oe-bolh.ship-i[1] AT 7 SKIP 
    "<R52><C1>" oe-bolh.ship-i[2] AT 7 SKIP 
    "<R53><C1>" oe-bolh.ship-i[3] AT 7 SKIP 
    "<R54><C1>" oe-bolh.ship-i[4] AT 7 SKIP 
    "<R55><C1>"
    "__________________________________________________________________________________________________________________" 
    "<R56><C1>" "<B>  Signature of Receipt </B>"                  "<C38> Carrier       " 
    "<R57><C14><#1><R+6><C+46><IMAGE#1=" ls-full-img3 
    "<R63><C7>" "Date _______________________________                       Date _______________________________________"    
    "<R64>Page " AT 200 string(PAGE-NUM - lv-pg-num,">>9") + " of " + string(lv-tot-pg) FORM "x(20)"
    "<R64><C35><P6>   FREIGHT CODE NMFC 029280       CLASS 55" SKIP 
    .
