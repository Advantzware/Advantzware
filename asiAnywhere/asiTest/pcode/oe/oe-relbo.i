...
IF oe-boll.p-c AND oe-boll.s-code NE "I" THEN v-complete = YES.
...
DO bo-try = 1 TO 2:
  ...
  ELSE
  IF oe-boll.s-code EQ "S" AND NOT oe-ordl.is-a-component THEN DO:
    /*IF oe-boll.b-ord-no NE 0 THEN*/
  ...
  IF (bo-try EQ 1 AND v-rel-qty GT 0) OR
    ...
    IF NOT AVAIL xoe-relh THEN DO:
      ...
      CREATE xoe-relh.
      ASSIGN
       xoe-relh.r-no      = (IF AVAIL yoe-relh THEN yoe-relh.r-no ELSE 0) + 1
    ...
    IF AVAIL oe-rel THEN DO:
      ...
      IF oe-rel.qty LE 0 THEN DELETE oe-rel.
    END.
