...
FOR EACH shipto OF cust NO-LOCK
    WITH FRAME shipto STREAM-IO TITLE '----- SHIP TO ADDRESSES -----' COLUMN 5 WIDTH 80:
  DISPLAY
...
FOR EACH soldto OF cust NO-LOCK
    WITH FRAME soldto STREAM-IO TITLE '----- SOLD TO ADDRESSES -----' COLUMN 5 WIDTH 80:
  DISPLAY
...
/*{custom/gperiod.i}*/  DEFINE VARIABLE gperiod AS INTEGER NO-UNDO.
/*{custom/getperd.i}*/  /*RUN Get-Period IN Persistent-Handle (OUTPUT gperiod).*/
gperiod = 1.
