  ...
  ****************************************************************/
    ...
    /*do i = 1 to 3:
      ...
      for each xoe-ord
          ...
          IF LOOKUP(xoe-ord.cust-no, custcount) = 0 THEN NEXT.
    ...
    DO:
        ...
        DO: /* not v-sumdet */
            excelheader = IF v-ponum 
                          THEN "Order No.,Date,Customer,Sales Rep,PO #," 
                          ELSE "Order No.,Date,Customer,Sales Rep,".
    ...
    for each tt-report
        ...
        if v-sumdet then do:
            if first-of(tt-report.key-01) then do:
                if v-sort eq "S" then put "Sales Rep: " w-ord.sman space(4).
            ...
            DO:
               chrSalesCustAndName = "".
                IF v-sort EQ "S" THEN  
                  chrSalesCustAndName = "Sales Rep: " + TRIM(w-ord.sman) + " ".
