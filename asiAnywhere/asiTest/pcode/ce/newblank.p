...
DEF  SHARED VAR g_company AS CHAR NO-UNDO.
DEF  SHARED VAR g_loc AS CHAR NO-UNDO.
...
FIND FIRST ce-ctrl where (ce-ctrl.company = g_company and 
                          ce-ctrl.loc     = g_loc) NO-LOCK NO-ERROR.
