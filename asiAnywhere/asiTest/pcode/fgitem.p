...
DEFINE INPUT-OUTPUT PARAMETER DATASET FOR dsfg.
...
ASSIGN
    v-qry-handle = QUERY q-fgQuery:HANDLE.
...
PROCEDURE build-qry:
    ...
    ASSIGN
        prm-query = "FOR EACH itemfg NO-LOCK where company eq " + QUOTER(prmComp).
END PROCEDURE.
