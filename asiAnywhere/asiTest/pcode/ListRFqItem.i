...
/* ***************************  Definitions  ************************** */
DEFINE TEMP-TABLE ttListRfqitem NO-UNDO 
    FIELD abc AS CHAR
    FIELD xyz AS INT
    ...
    FIELD RfqType AS CHARACTER  FORMAT "x(6)"
...
DEFINE DATASET dsListRfqitem FOR ttListRfqitem.
DEFINE QUERY q-ListRfqitemQuery FOR ttListRfqitem.
DEFINE DATA-SOURCE src-ListRfqitem  FOR QUERY q-ListRfqitemQuery.
BUFFER ttListRfqitem :ATTACH-DATA-SOURCE(DATA-SOURCE src-ListRfqitem  :HANDLE).
