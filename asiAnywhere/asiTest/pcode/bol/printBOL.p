...
DEFINE SHARED VAR pdfname AS CHAR NO-UNDO.
...
{oe/closchk.i NEW}
 {oerep/r-bolx.i NEW}
    ...
    ASSIGN
        lv-pdf-file =  v-webrootpath + 'CreateBOLPrint' +  STRING(YEAR(TODAY), "9999") + STRING(MONTH(TODAY), "99")
                         + STRING(DAY(TODAY), "99")
       pdfname     =  'CreateBOLPrint' +  STRING(YEAR(TODAY), "9999") + STRING(MONTH(TODAY), "99")
