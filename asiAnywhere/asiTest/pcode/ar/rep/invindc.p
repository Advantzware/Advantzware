/* ---------------------------------------------- ar/rep/invindc.p  */
/* PRINT INVOICE   Xprint Form for Indiana         */
/* -------------------------------------------------------------------------- */
...
*/
       ...
       */
        ...
        for each ar-invl no-lock where ar-invl.x-no = ar-inv.x-no:
            ...
            assign v-inv-qty = v-rel-qty /* ar-invl.qty */
                   ...
                   /*v-cases-order = ar-invl.qty / v-cases-order*/.
...
/*        end. */
  ...
  */
    ...
    PUT "<R58><C58><#8><FROM><R+4><C+22><RECT> " 
        ...
        "<=8><R+2> " /*PST        :" ar-inv.t-inv-tax FORM "->>,>>9.99"*/
                    /*v-bot-lab[2] */
        "<=8><R+3> Invoice Total:" ar-inv.due FORM "->>,>>9.99" .
/*
