...
format 
      ...
      skip (5)
      ar-inv.cust-no         AT 11 ar-inv.ship-id         AT 51
      v-cust[1]              AT 11 v-ship[1]              AT 51 format "x(27)"
      v-cust[2]              AT 11 v-ship[2]              AT 51 format "x(27)"
      v-cust[3]              AT 11 v-ship[3]              AT 51 format "x(27)"
      v-cust[4]              AT 11 v-ship[4]              AT 51 format "x(27)"
      skip (2)
      v-date-ship
...
format 
      ...
      ar-inv.terms-d      AT 32    format "x(20)"
      skip (3)
      ar-inv.cust-no         AT 11 ar-inv.ship-id         AT 54
      v-cust[1]              AT 11 v-ship[1]              AT 54 format "x(27)"
      v-cust[2]              AT 11 v-ship[2]              AT 54 format "x(27)"
      v-cust[3]              AT 11 v-ship[3]              AT 54 format "x(27)"
      v-cust[4]              AT 11 v-ship[4]              AT 54 format "x(27)"
      skip (2)
      v-date-ship
      v-shipvia AT 11 FORM "x(25)"
      ar-inv.t-weight TO 44 FORM ">>>>9.99" v-del-no TO 53 v-bol-no TO 65 FORM ">>>>>9"
      v-tot-pallets AT 69 SKIP(1)
      WITH FRAME invoice-header-ag no-BOX no-labels stream-io width 80.
...
format skip (2)
      ...
      skip(5)
      big_ul AT 1
      WITH FRAME invoice-header-labels-ag no-BOX no-labels stream-io width 80.
