...
DEFINE TEMP-TABLE ttViewItemEstimate NO-UNDO
    FIELD abc           AS CHAR
    FIELD OrdNo         AS INT 
   ...
   . 
DEFINE DATASET dsViewItemEstimate FOR ttViewItemEstimate .
...
DEFINE INPUT-OUTPUT PARAMETER DATASET FOR dsViewItemEstimate.
...
ASSIGN
    g_company  = prmComp
    cocode = g_company
    locode = IF AVAIL usercomp THEN usercomp.loc ELSE "".
...
FIND FIRST oe-ordl where oe-ordl.company EQ prmComp AND
        ...
        IF AVAIL oe-ordl THEN DO:
            create ttViewItemEstimate.
            assign 
                ttViewItemEstimate.OrdNo          = oe-ordl.ord-no
                ttViewItemEstimate.vLine          = oe-ordl.LINE
                ttViewItemEstimate.est-no         = oe-ordl.est-no
                ttViewItemEstimate.Item1          = oe-ordl.i-no
                ttViewItemEstimate.CustPart       = oe-ordl.part-no
                ttViewItemEstimate.quantity       = oe-ordl.qty
                ttViewItemEstimate.Name1          = oe-ordl.i-name
                ttViewItemEstimate.Dscr           = oe-ordl.part-dscr1 
                ttViewItemEstimate.Dscr2          = oe-ordl.part-dscr2 
                ttViewItemEstimate.Dscr3          = oe-ordl.part-dscr3
                ttViewItemEstimate.price          = oe-ordl.price
                ttViewItemEstimate.uom            = oe-ordl.pr-uom
                ttViewItemEstimate.taxable        = oe-ordl.tax
                ttViewItemEstimate.custpo         = oe-ordl.po-no
                ttViewItemEstimate.job-no         = oe-ordl.job-no
                ttViewItemEstimate.job-no2         = oe-ordl.job-no2
                ttViewItemEstimate.discount       = oe-ordl.disc
                ttViewItemEstimate.requested      = oe-ordl.req-code
                ttViewItemEstimate.requestdate    = oe-ordl.req-date
                ttViewItemEstimate.extprice       = oe-ordl.t-price
                ttViewItemEstimate.promised       = oe-ordl.prom-code
                ttViewItemEstimate.promisdate     = oe-ordl.prom-date
                ttViewItemEstimate.shipqty        = oe-ordl.ship-qty
                ttViewItemEstimate.counter        = oe-ordl.cas-cnt
                ttViewItemEstimate.vPartial       =  oe-ordl.partial
                ttViewItemEstimate.VcasUnit       =  oe-ordl.cases-unit 
                ttViewItemEstimate.vEnum          = oe-ordl.e-num 
                ttViewItemEstimate.vPono          = oe-ordl.po-no-po 
                ttViewItemEstimate.vSman          =  oe-ordl.s-man[1]
                ttViewItemEstimate.vSpct          =  oe-ordl.s-pct[1]
                ttViewItemEstimate.vScomm         = oe-ordl.s-comm[1]
                ttViewItemEstimate.vSman2         =  oe-ordl.s-man[2]
                ttViewItemEstimate.vSpct2         =  oe-ordl.s-pct[2]
                ttViewItemEstimate.vScomm2        =  oe-ordl.s-comm[2]
                ttViewItemEstimate.vSman3         = oe-ordl.s-man[3]
                ttViewItemEstimate.vSpct3         =  oe-ordl.s-pct[3]
                ttViewItemEstimate.vScomm3        = oe-ordl.s-comm[3]
                ttViewItemEstimate.vType          = oe-ordl.type-code
                ttViewItemEstimate.vOver          = oe-ordl.over-pct 
                ttViewItemEstimate.vUnder         = oe-ordl.under-pct
                ttViewItemEstimate.vBoardVen      = oe-ordl.vend-no
                ttViewItemEstimate.vManag         = oe-ordl.whsed
                ttViewItemEstimate.vCost          = oe-ordl.cost  
                ttViewItemEstimate.vQno           = oe-ordl.q-no
                ttViewItemEstimate.vReckey           = oe-ordl.rec_key
            ...
            FOR EACH sman NO-LOCK :
                IF sman.sman = oe-ordl.s-man[1] THEN
                    ASSIGN ttViewItemEstimate.vSname         = sman.sname .
                IF sman.sman = oe-ordl.s-man[2] THEN 
                    ASSIGN ttViewItemEstimate.vSname2        = sman.sname.
                IF sman.sman = oe-ordl.s-man[3] THEN 
                    ASSIGN ttViewItemEstimate.vSname3        = sman.sname.
            END.   /*for each sman */
