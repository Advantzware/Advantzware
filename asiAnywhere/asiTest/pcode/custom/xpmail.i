...
/*   MESSAGE 'Report       : '   CAPS (ipGroupTitle)   SKIP    */
/*           'Type          : '  ipType                SKIP    */
/*           'Record ID  : '     vcRecordID            SKIP    */
/*           'E-Mail(s)    : '   ls-to-list            SKIP(1) */
/*           'No contact information defined OR'       SKIP    */
/*           'Invalid e-mail address. Create E-mail anyway?'   */
/*     VIEW-AS ALERT-BOX                                       */
/*     QUESTION                                                */
/*     BUTTONS YES-NO                                          */
/*     UPDATE vlProceed AS LOGICAL.                            */
/*                                                             */
/*   IF NOT vlProceed THEN RETURN.                             */
END.
