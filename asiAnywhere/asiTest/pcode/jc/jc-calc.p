...
DEFINE NEW SHARED  VARIABLE prmUser AS CHARACTER NO-UNDO.
...
DO TRANSACTION:
  ...
  if not avail xest THEN do:
        ...
        if choice THEN repeat:
            ...
            vError =  "Estimate Does Not Exist. Please Re-enter." .
            RETURN.
  ...
  IF nufile THEN DO:
    ...
    FOR EACH brd WHERE brd.i-no NE "":
      ...
      IF brd.qty GT 0 THEN DO:
        ...
        /*  vError = "Allocated material must be manually updated by Planner..." . 
          RETURN.*/
          ll-all-warn = YES.
        END.
