...
"BOLFreight,CESAMPLE,SSRMISSUE,CorrTrim,CustShipToImp,OEScreen".
                                  /* 126*/
...
assign
 str-init[1]  = "ABox,10 Pitch,ContSrvc,CSC-EXCEL,TRILAKE-EXCEL,HOP," +
                ...
                "PeachTree,LoylangBSF,Premier-Excel,Oklahoma,Accord"
 str-init[2]  = "ASI,Beeler,Argrov,ILWalker,1/2 Page,Phoenix,Color,Interpac,Royal,Keystone," +
                ...
                "BlueRX,ImperiaX,ColoniaX,Indiana,ArgrovX,AgMach,HPB,PPI,ABC,Fibrex,TriLakes,Knight,Knight1,Southpakl,Androp,Packrite," +
                "Rosmar,Badger,Badger-Emailed,AllWest,Simkins,ACPI,ColorX,Loylang,ColonialLot#,LoylangJIT,Carded,CCCFGLot,CSC-GA,CCCFGL3,Adapt,Soule,SouleMed,CapCityIN," +
 ...
 str-init[8]  = "16th's,32nd's,Century,Middlesx,RFC,Sonoco,Rudd,Brick,Fibre,Metro,"
              ...
              + "HPB,Indiana,MWFibre,Packrite,Allwest,ACPI,Badger,CCC,Soule,SouleMed,Protagon,Protagon2,PremierCX,PeachTree"
 str-init[9]  = "ASI,Argrov,Century,HOP,MultiWll,Sonoco,TriState,Fibre," +
                ...
                "HPB,Keystone,Hughes,Allwest,Rosmar,Loylang,Carded,PremierX,CSC-GA,CardedX,Protagon,Peachtree,ACPI,Soule,NStock"
 str-init[10] = "ASI,1/2 Page,Royal,ContSrvc,Superior,Premier,Warren,PAC 1/2," +
                "Imperial,P&P,Triad,TriState,BlueRidg,Sonoco,HOP,CCC," +
                ...
                "PremierCX,PeachTreeBC,ACCORDBC,Soule,NSTOCK,TrilakesLot#,Multicell,MetroTags"
...
ASSIGN
 str-init[13] = "ASI,WesInd,ILWalker,HOP,Brick,Gulf,Pacific,Xprint,SouthPak,"   +
                ...
                "Allwest,Simkins,HOPX,PremierCX,Accord,Soule,ACPI"
 str-init[14] = "10 Pitch,17 Pitch,Boxtech,Phoenix,TriState,Triad,RFC,HOP," +
                "Brick,Hartford"
 str-init[15] = "Inches,MM,Both"
 str-init[16] = ",Net Shts"
 str-init[17] = ",Order#,YYMMSEQ#,PLine&Order#"
 str-init[18] = "FG BIN,SHIPTO,FIFO"
 ...
 str-init[29] = ",Brick,Xprint,Unipak-XL,PremierPkg,ACPI,PremierPkgU"
 str-init[30] = "ASI,Clevelnd,McLean,Suthrlnd,Brick,Fibre,Protagon"
 str-init[31] = "ASI,McLean,HOP,Dee,Fibre"
 str-init[32] = "XPRINT,Pacific,RFC,Hughes,HPB,MWFIBRE,ARTIOS,P&,MWBox,CSC,CSC-GA,PREMIER,Suthrlnd,United,MulticellGA,MCPartitions,TriLakes,TriLakes2,Spectrum,Michcor,CapCity,colonialPL,Allwest,LoyLang,Badger,Delta,PQP,RFC2,Peachtree,BlueRidg,Oklahoma,Protagon,TriState,Soule"
 str-init[33] = "ASI,HOP,Fibre,Century,Interpac,FibreFC,HPB,Dayton,Livngstn,CentBox,Metro,Keystone,Frankstn,Colonial,Unipak,OTTPkg,Shelby,CCC,Indiana-XL,PPI,Accord,Knight,MidYork,Dee,Badger,Rosmar,Carded,PackRite,Prystup,Knight***" /*MWFibre=Keystone*/
...
ASSIGN
 str-init[51] = "None,CorrTrim,Alliance,HRMS,CorSuply,Corr-U-KraftII,GP," +
                "Vendor,Kiwi,Smurfit,CorrChoice,Pratt"  
 ...
 str-init[88] = ",AllOrders,SameOrderOnly,SamePo#Only,SamePo#OnlyWithPrompt,SamePo#OnlyWithoutPrompt" /* relmerge */       
 str-init[89] = ",ASI,ASIXprnt,Premier,ASIExcel,Loylang,Printers"  /*stmtprin*/
 ...
 str-init[96] = ",Michcor,Trilakes,Woodland,PremierPkg,St.Clair,NStock"  /* GP */
 ...
 str-init[120] = "" 
 str-init[121] = ""
 str-init[122] = "ASIJobCL,MidYorkJobCL,CentBoxJobCL"
