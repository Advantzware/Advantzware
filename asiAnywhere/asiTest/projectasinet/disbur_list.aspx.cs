...
public partial class disbur_list : System.Web.UI.Page
{
   ...
   protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        try
        {
            if (Session["disbur_list_index1"] == null)
            {
                GridView1.SelectedIndex = 0;

                Session["disbur_list_reckey_rec"] = ((Label)GridView1.SelectedRow.FindControl("reclabel")).Text;
                Session["top_list_notes_rec_key"] = Session["disbur_list_reckey_rec"];
        ...
        try
        {
            if (Session["disbur_list_index1"] != null)
            {
                GridView1.SelectedIndex = Convert.ToInt32(Session["disbur_list_index1"]);
    ...
    {
        Session["disbur_list_index1"] = GridView1.SelectedIndex;
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        Session["disbur_list_index1"] = null;
    }
     ...
     protected void img_btn_exit_click(object sender, EventArgs e)
    {
     ...
     {
         Session["disbur_list_add_button"] = "add";
         Response.Redirect("view_disbur.aspx");
