<%@ Page Language="C#" MasterPageFile="~/MasterPageCorrugated.master" Debug="true"  AutoEventWireup="true" EnableEventValidation="false" Inherits="corr_prep" Title="Prep/Route Estimate" Codebehind="corr_prep.aspx.cs" %>
...
function MachinLookup(ReturnObj1,ReturnObj2)
{
    ...
    document.forms[0].ctl00_ContentPlaceHolder1_FormView_Route_vAtype1TextBox.focus();
...
function Machin2Lookup(ReturnObj1,ReturnObj2)
{
    ...
    document.forms[0].ctl00_ContentPlaceHolder1_FormView_Route_vAtype2TextBox.focus();
...
function Machin3Lookup(ReturnObj1,ReturnObj2)
{
    ...
    document.forms[0].ctl00_ContentPlaceHolder1_FormView_Route_vAtype3TextBox.focus();
 ...
 function jobbuttonconfirm() {
    ...
    <asp:FormView ID="FormView1"  runat="server" DataSourceID="est_ObjectDataSource">
        ...
        <ItemTemplate>
            ...
            <td style="display:none"><asp:Label ID="vOrderLabel" BackColor="turquoise"  runat="server" Text='<%# Bind("vOrder") %>'></asp:Label>
    ...
    <legend> Preparation</legend>
     <asp:GridView ID="GridView_Prep" Width="750px" runat="server" AutoGenerateColumns="False" DataKeyNames="vLine"
            DataSourceID="CorrugatedPrepDataSource" AllowPaging="True" AllowSorting="True" 
        ...
        <table class="shade"><tr><td>
            ...
            <asp:FormView ID="FormView2" runat="server" DataSourceID="ObjectDataSource1" OnItemUpdated="FormView2_ItemUpdated" OnUnload="FormView2_Unload" OnDataBound="FormView2_DataBound" >
            <EditItemTemplate>
              <asp:Panel ID="update_panel" runat="server" DefaultButton="UpdateButton">
                ...
                <asp:CompareValidator ID="CompareValidator2" runat="server" ControlToValidate="vSnumTextBox" SetFocusOnError="true" Display="dynamic" Operator="dataTypeCheck" Type="integer" ErrorMessage="Invalid"></asp:CompareValidator></td>
                ...
                <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="vBnumTextBox" SetFocusOnError="true" Display="dynamic" Operator="dataTypeCheck" Type="integer" ErrorMessage="Invalid"></asp:CompareValidator></td>
                ...
                <asp:CompareValidator ID="CompareValidator3" runat="server" ControlToValidate="vQtyTextBox" SetFocusOnError="true" Display="dynamic" Operator="dataTypeCheck" Type="double" ErrorMessage="Invalid"></asp:CompareValidator></td>
                ...
                <td><asp:TextBox ID="vMarkTextBox" runat="server" MaxLength="6" Width="40px" onkeyup="prepmark()" Text='<%# Bind("vMark") %>'></asp:TextBox>
                <asp:CompareValidator ID="CompareValidator4" runat="server" ControlToValidate="vMarkTextBox" SetFocusOnError="true" Display="dynamic" Operator="dataTypeCheck" Type="double" ErrorMessage="Invalid"></asp:CompareValidator></td></tr>
                ...
                <asp:CompareValidator ID="CompareValidator5" runat="server" ControlToValidate="vCostTextBox" SetFocusOnError="true" Display="dynamic" Operator="dataTypeCheck" Type="double" ErrorMessage="Invalid"></asp:CompareValidator></td>
                ...
                <td><asp:TextBox ID="vAmortTextBox" runat="server" MaxLength="6" Width="40px" onkeyup="prepamort()" onblur="javascript:shblurval(this)"  Text='<%# Bind("vAmort") %>'></asp:TextBox>
                <asp:CompareValidator ID="CompareValidator6" runat="server" ControlToValidate="vAmortTextBox" SetFocusOnError="true" Display="dynamic" Operator="dataTypeCheck" Type="double" ErrorMessage="Invalid"></asp:CompareValidator></td></tr>
                <tr><td>
                ...
                <asp:Button ID="copysaveButton" runat="server" CssClass="button" CausesValidation="True" OnClick="copy_save_Click"  Text="Save">
                </asp:Button>
            ...
            <asp:Panel ID="update_panel" runat="server" DefaultButton="InsertButton">
                ...
                <asp:CompareValidator ID="CompareValidator4" runat="server" ControlToValidate="vMarkTextBox" SetFocusOnError="true" Display="dynamic" Operator="dataTypeCheck" Type="double" ErrorMessage="Invalid"></asp:CompareValidator></td></tr>
                <tr><td align="right" style="padding-left:5px"><b>Cost:</b></td>
                <td><asp:TextBox ID="vCostTextBox" runat="server" MaxLength="8" onkeyup="prepcost()" Width="50px" Text='<%# Bind("vCost") %>'></asp:TextBox>
                <asp:CompareValidator ID="CompareValidator5" runat="server" ControlToValidate="vCostTextBox" SetFocusOnError="true" Display="dynamic" Operator="dataTypeCheck" Type="double" ErrorMessage="Invalid"></asp:CompareValidator></td>
                <td align="right" style="padding-left:5px"><b>M/L:</b></td>
                <td><asp:DropDownList ID="DropDownList1" selectedvalue='<%# Bind("vMl") %>' Width="40px" DataValueField='<%# Bind("vMl") %>' RepeatLayout="Flow"  CellSpacing="1" RepeatColumns="2"   runat="server">
                    <asp:ListItem Text="M" Value="M"></asp:ListItem>
                ...
                <td><asp:TextBox ID="vDescTextBox" runat="server" Text='<%# Bind("vDesc") %>'></asp:TextBox></td>
                <td align="right" style="padding-left:5px"><b>Amort:</b></td>
                <td><asp:TextBox ID="vAmortTextBox" runat="server" Width="40px" onkeyup="prepamort()" onblur="javascript:shblurval(this)" MaxLength="6" Text='<%# Bind("vAmort") %>'></asp:TextBox>
                <asp:CompareValidator ID="CompareValidator6" runat="server" ControlToValidate="vAmortTextBox" SetFocusOnError="true" Display="dynamic" Operator="dataTypeCheck" Type="double" ErrorMessage="Invalid"></asp:CompareValidator></td></tr>
                <tr><td>
                <asp:Label ID="vLineLabel" Visible="false" runat="server" Text='<%# Bind("vLine") %>'></asp:Label></td></tr>
                <tr><td colspan="5">
            ...
            <ItemTemplate>
                ...
                <asp:Button ID="DeleteButton" runat="server" CausesValidation="true" CssClass="button" OnClick="delete_Click"  Text="Delete" OnClientClick= 'return confirm ("Are you sure to Delete This Record")'>
                 ...
                 <asp:Button ID="CopyButton" runat="server" CausesValidation="True" CssClass="button" OnClick="copybutton" CommandName="edit" Text="Copy" >  </asp:Button>
    ...
    <asp:ObjectDataSource ID="CorrugatedPrepDataSource" runat="server" OldValuesParameterFormatString="original_{0}"
        SelectMethod="SelectListPrep" TypeName="Corrugated">
        <SelectParameters>
   ...
   <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
        ...
        <SelectParameters>
            ...
            <asp:Parameter Name="prmMark" Type="Decimal" />
            <asp:Parameter Name="prmAmort" Type="Decimal" />
            <asp:SessionParameter SessionField="corr_prep_line" Name="prmLine" Type="Int32" />
    ...
    <asp:GridView ID="GridView_Qty"  runat="server" AutoGenerateColumns="False"
        ...
        <asp:ObjectDataSource ID="ObjectDataSource_qty" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="SelectCorrQty" TypeName="Corrugated">
            <SelectParameters>
                ...
                <asp:Parameter DefaultValue="Select" Name="prmActSelect" Type="String" />
                <asp:Parameter Name="prmComp" Type="String" />
                <asp:SessionParameter Name="prmEstNum" SessionField="order_corrugated_est" Type="String" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSource_qtydetail" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="SelectCorrQty" TypeName="Corrugated">
            <SelectParameters>
                ...
                <asp:SessionParameter Name="prmEstNum" SessionField="order_corrugated_est" Type="String" />
                <asp:Parameter Name="prmFormNo" Type="Int32" />
                <asp:SessionParameter SessionField="corr_order_qty" Name="prmQty" Type="Int32" />
                <asp:Parameter Name="prmReckey" Type="string" />
            </SelectParameters>
        </asp:ObjectDataSource>
    </td>
    <td>
        <asp:FormView ID="FormView_Qty" CssClass="shade" DataSourceID="ObjectDataSource_qtydetail"  runat="server" OnUnload="FormView_Qty_unload" OnDataBound="FormView_Qty_DataBound">
            ...
            <asp:Panel ID="qtyupdate_panel" runat="server" DefaultButton="UpdateButton">
                <b>Qty:</b>
                <asp:TextBox ID="vCorQtyTextBox" MaxLength="12" runat="server" onblur="qtyfocus()" Text='<%# Bind("vCorQty") %>'>
                </asp:TextBox><asp:CompareValidator ID="CompareValidator10" runat="server" ControlToValidate="vCorQtyTextBox" SetFocusOnError="true" Display="dynamic" Operator="dataTypeCheck" Type="integer" ErrorMessage="Invalid Number"></asp:CompareValidator>
            ...
            <ItemTemplate>
                ...
                <asp:Label ID="corridLabel"  runat="server" Visible="false" Text='<%# Bind("vCorid") %>'></asp:Label></td></tr>
                <tr><td nowrap colspan="2"><asp:Button ID="updateButton" runat="server" CausesValidation="True" CssClass="button" OnClick="UpdateButton_Click" CommandName="edit" Text="Update">
                </asp:Button>
                <asp:Button ID="addButton" runat="server" CausesValidation="true" CssClass="button" CommandName="new"  Text="Add">
                </asp:Button>
...
<asp:GridView ID="GridView1" Width="790px" runat="server" AutoGenerateColumns="False"
        ...
        <RowStyle CssClass="shade"  />
            <Columns >
                ...
                <asp:BoundField HeaderStyle-Wrap="false" DataField="vOppass" HeaderText="Pass#" SortExpression="vOppass" />
                <asp:BoundField HeaderStyle-Wrap="false" DataField="vNout" HeaderText="Out" SortExpression="vNout" />
                <asp:BoundField HeaderStyle-Wrap="false" DataField="vOpmr" HeaderText="MR-Hrs" SortExpression="vOpmr" />
                ...
                <asp:BoundField HeaderStyle-Wrap="false" DataField="vAtype1" HeaderText="Adder" SortExpression="vAtype1" />
                <asp:BoundField HeaderStyle-Wrap="false" DataField="vAtqty1" HeaderText="Qty" SortExpression="vAtqty1" />
                <asp:BoundField HeaderStyle-Wrap="false" DataField="vAtype2" HeaderText="Adder2" SortExpression="vAtype2" />
                <asp:BoundField HeaderStyle-Wrap="false" DataField="vAtqty2" HeaderText="Qty" SortExpression="vAtqty2" />
                <asp:BoundField HeaderStyle-Wrap="false" DataField="vAtype3" HeaderText="Adder3" SortExpression="vAtype3" />
                <asp:BoundField HeaderStyle-Wrap="false" DataField="vAtqty3" HeaderText="Qty" SortExpression="vAtqty3" />
                <asp:TemplateField HeaderText="Line" Visible="false">
                <ItemTemplate>
    ...
    <asp:FormView ID="FormView_Route" runat="server" DataSourceID="Detail_ObjectDataSource" OnDataBound="FormView_Route_DataBound" OnPreRender="FormView_Route_PreRender" OnLoad="FormView_Route_Load" OnUnload="FormView_Route_Unload">
        ...
        <asp:Panel ID="update_panel" runat="server" DefaultButton="UpdateButton">
            ...
            <tr><td align="right" style="padding-right:5px"><b>Pass#:</b></td>
            <td><asp:TextBox ID="vOppassTextBox" Width="50px" runat="server" Text='<%# Bind("vOppass") %>'></asp:TextBox>
            <asp:CompareValidator ID="CompareValidator8" runat="server" ControlToValidate="vOppassTextBox" SetFocusOnError="true" Display="dynamic" Operator="dataTypeCheck" Type="double" ErrorMessage="Invalid Number"></asp:CompareValidator></td>
            ...
            <td><asp:TextBox ID="vOpmrTextBox" Width="50px" MaxLength="6" onkeyup="valhr()" runat="server" Text='<%# Bind("vOpmr") %>'></asp:TextBox>
            ...
            <asp:CompareValidator ID="CompareValidator11" runat="server" ControlToValidate="vOpwasteTextBox" SetFocusOnError="true" Display="dynamic" Operator="dataTypeCheck" Type="integer" ErrorMessage="Invalid Number"></asp:CompareValidator></td></tr>
            <tr><td align="right" style="padding-right:5px"><b>Speed:</b></td>
            ...
            <td><asp:TextBox ID="vOpcrew2TextBox" Width="50px" MaxLength="4" runat="server" onkeyup="crown2()" Text='<%# Bind("vOpcrew2") %>'> </asp:TextBox>
            <asp:CompareValidator ID="CompareValidator15" runat="server" ControlToValidate="vOpcrew2TextBox" SetFocusOnError="true" Display="dynamic" Operator="dataTypeCheck" Type="double" ErrorMessage="Invalid Number"></asp:CompareValidator></td></tr>
            <tr><td align="right" style="padding-right:5px"><b>MRate:</b></td>
            ...
            <td><asp:TextBox ID="vFountainsTextBox" Width="50px" runat="server" Text='<%# Bind("vFountains") %>'> </asp:TextBox></td></tr>
            <tr><td align="right" style="padding-right:5px"><b>Adder:</b></td>
            <td><asp:TextBox ID="vAtype1TextBox" Width="100px" runat="server" Text='<%# Bind("vAtype1") %>'> </asp:TextBox>
            <a href="#" tabindex="1" onclick="adderlook(); return false"><asp:Image ID="Image1" runat="server" ImageUrl="images/lookup_icon.gif" /></a></td>
            <td align="right" style="padding-right:5px"><b>Qty:</b></td>
            <td><asp:TextBox ID="vAtqty1TextBox" Width="50px" MaxLength="5" runat="server" Text='<%# Bind("vAtqty1") %>'></asp:TextBox>
            <asp:CompareValidator ID="CompareValidator16" runat="server" ControlToValidate="vAtqty1TextBox" SetFocusOnError="true" Display="dynamic" Operator="dataTypeCheck" Type="integer" ErrorMessage="Invalid Number"></asp:CompareValidator></td>
            <td align="right" style="padding-right:5px"><b>Adder2:</b></td>
            <td><asp:TextBox ID="vAtype2TextBox" Width="100px" runat="server" Text='<%# Bind("vAtype2") %>'></asp:TextBox>
            <a href="#" tabindex="1" onclick="adder2look(); return false"><asp:Image ID="Image3" runat="server" ImageUrl="images/lookup_icon.gif" /></a></td>
            <td align="right" style="padding-right:5px"><b>Qty:</b></td>
            <td><asp:TextBox ID="vAtqty2TextBox" Width="50px" MaxLength="5" runat="server" Text='<%# Bind("vAtqty2") %>'> </asp:TextBox>
            <asp:CompareValidator ID="CompareValidator17" runat="server" ControlToValidate="vAtqty2TextBox" SetFocusOnError="true" Display="dynamic" Operator="dataTypeCheck" Type="integer" ErrorMessage="Invalid Number"></asp:CompareValidator></td></tr>
            <tr><td align="right" style="padding-right:5px"><b>Adder3:</b></td>
            <td><asp:TextBox ID="vAtype3TextBox" Width="100px" runat="server" Text='<%# Bind("vAtype3") %>'> </asp:TextBox>
            <a href="#" tabindex="1" onclick="adder3look(); return false"><asp:Image ID="Image4" runat="server" ImageUrl="images/lookup_icon.gif" /></a></td>
            <td align="right" style="padding-right:5px"><b>Qty:</b></td>
            <td><asp:TextBox ID="vAtqty3TextBox" Width="50px" MaxLength="5" runat="server" onblur="focusnum()" Text='<%# Bind("vAtqty3") %>'></asp:TextBox>
            <asp:CompareValidator ID="CompareValidator18" runat="server" ControlToValidate="vAtqty3TextBox" SetFocusOnError="true" Display="dynamic" Operator="dataTypeCheck" Type="integer" ErrorMessage="Invalid Number"></asp:CompareValidator></td></tr>
            <tr>
        ...
        <asp:Panel ID="insert_panel" runat="server" DefaultButton="InsertButton">
            ...
            <td><asp:TextBox ID="vMdscrTextBox" Width="100px" runat="server" Text='<%# Bind("vMdscr") %>'> </asp:TextBox></td></tr>
            <tr><td align="right" style="padding-right:5px"><b>Pass#:</b></td>
            <td><asp:TextBox ID="vOppassTextBox" Width="50px" runat="server" Text='<%# Bind("vOppass") %>'></asp:TextBox></td>
            <td align="right" style="padding-right:5px"><b>Out:</b></td>
            <td><asp:TextBox ID="vNoutTextBox" Width="50px" MaxLength="3" runat="server"  Text='<%# Bind("vNout") %>'> </asp:TextBox>
            <asp:CompareValidator ID="CompareValidator23" runat="server" ControlToValidate="vNoutTextBox" SetFocusOnError="true" Display="dynamic" Operator="dataTypeCheck" Type="integer" ErrorMessage="Invalid Number"></asp:CompareValidator>
            </td>
            <td align="right" style="padding-right:5px"><b>MH-Hrs:</b></td>
            <td><asp:TextBox ID="vOpmrTextBox" Width="50px" MaxLength="6" onkeyup="valhr()" runat="server" Text='<%# Bind("vOpmr") %>'></asp:TextBox></td>
            <td align="right" style="padding-right:5px"><b>Waste:</b></td>
            <td><asp:TextBox ID="vOpwasteTextBox" Width="50px" MaxLength="6" runat="server" Text='<%# Bind("vOpwaste") %>'></asp:TextBox></td></tr>
            <tr><td align="right" style="padding-right:5px"><b>Speed:</b></td>
            ...
            <td align="right" style="padding-right:5px"><b>RunCrew:</b></td>
            <td><asp:TextBox ID="vOpcrew2TextBox" Width="50px" MaxLength="4" runat="server" Text='<%# Bind("vOpcrew2") %>'> </asp:TextBox></td></tr>
            <tr><td align="right" style="padding-right:5px"><b>MRate:</b></td>
            <td><asp:TextBox ID="vOpRateTextBox" Width="50px" runat="server" Text='<%# Bind("vOpRate") %>'></asp:TextBox></td>
            <td align="right" style="padding-right:5px"><b>RRate:</b></td>
            <td><asp:TextBox ID="vOpRate2TextBox" Width="50px" runat="server" Text='<%# Bind("vOpRate2") %>'></asp:TextBox></td>
            ...
            <td align="right" style="padding-right:5px"><b>Qty:</b></td>
            <td><asp:TextBox ID="vAtqty1TextBox" Width="50px" MaxLength="5" runat="server" Text='<%# Bind("vAtqty1") %>'></asp:TextBox>
            <asp:CompareValidator ID="CompareValidator22" runat="server" ControlToValidate="vAtqty1TextBox" SetFocusOnError="true" Display="dynamic" Operator="dataTypeCheck" Type="integer" ErrorMessage="Invalid Number"></asp:CompareValidator></td>
            <td align="right" style="padding-right:5px"><b>Adder2:</b></td>
            <td><asp:TextBox ID="vAtype2TextBox" Width="100px" runat="server" Text='<%# Bind("vAtype2") %>'></asp:TextBox>
            <a href="#" tabindex="1" onclick="adder2look(); return false"><asp:Image ID="Image5" runat="server" ImageUrl="images/lookup_icon.gif" /></a></td>
            <td align="right" style="padding-right:5px"><b>Qty:</b></td>
            <td><asp:TextBox ID="vAtqty2TextBox" Width="50px" MaxLength="5" runat="server" Text='<%# Bind("vAtqty2") %>'> </asp:TextBox>
            <asp:CompareValidator ID="CompareValidator21" runat="server" ControlToValidate="vAtqty2TextBox" SetFocusOnError="true"  Display="dynamic" Operator="dataTypeCheck" Type="integer" ErrorMessage="Invalid Number"></asp:CompareValidator></td></tr>
            <tr><td align="right" style="padding-right:5px"><b>Adder3:</b></td>
            <td><asp:TextBox ID="vAtype3TextBox" Width="100px" runat="server" Text='<%# Bind("vAtype3") %>'> </asp:TextBox>
            <a href="#" tabindex="1" onclick="adder3look(); return false"><asp:Image ID="Image6" runat="server" ImageUrl="images/lookup_icon.gif" /></a></td>
            <td align="right" style="padding-right:5px"><b>Qty:</b></td>
            <td><asp:TextBox ID="vAtqty3TextBox" Width="50px" MaxLength="5" runat="server" onblur="focusnum()" Text='<%# Bind("vAtqty3") %>'></asp:TextBox>
            <asp:CompareValidator ID="CompareValidator20" runat="server" ControlToValidate="vAtqty3TextBox" SetFocusOnError="true" Display="dynamic" Operator="dataTypeCheck" Type="integer" ErrorMessage="Invalid Number"></asp:CompareValidator></td>
            <td><asp:Label ID="vLineTextBox" runat="server" Visible="false" Text='<%# Bind("vLine") %>'></asp:Label>
            <asp:Label ID="typeLabel" runat="server" Visible="false"  Text='<%# Bind("vtype") %>'></asp:Label>
            </td>
            </tr>           
            <tr><td colspan="6">
            <asp:Button ID="InsertButton" runat="server" CssClass="button" CausesValidation="True" OnClick="RoureSave_Click" Text="Save">
            </asp:Button>
        ...
        <ItemTemplate>
            ...
            <td align="right" style="padding-right:5px"><b>Desc:</b></td>
            <td><asp:Label ID="vMdscrLabel" runat="server" Width="120px" BackColor="turquoise" Text='<%# Bind("vMdscr") %>'></asp:Label></td></tr>
            <tr><td align="right" style="padding-right:5px"><b>Pass#:</b></td>
            <td><asp:Label ID="vOppassLabel" runat="server" Width="70px" BackColor="turquoise" Text='<%# Bind("vOppass") %>'></asp:Label></td>
            <td align="right" style="padding-right:5px"><b>Out:</b></td>
            ...
            <td><asp:Label ID="vOpmrLabel" runat="server" Width="70px" BackColor="turquoise" Text='<%# Bind("vOpmr") %>'></asp:Label></td>
            <td align="right" style="padding-right:5px"><b>Waste:</b></td>
            <td><asp:Label ID="vOpwasteLabel" runat="server" Width="70px" BackColor="turquoise" Text='<%# Bind("vOpwaste") %>'></asp:Label></td></tr>
            <tr><td align="right" style="padding-right:5px"><b>Speed:</b></td>
            <td><asp:Label ID="vOpspeedLabel" runat="server" Width="70px" BackColor="turquoise" Text='<%# Bind("vOpspeed") %>'></asp:Label></td>
            <td align="right" style="padding-right:5px"><b>Spoil%:</b></td>
            ...
            <td align="right" style="padding-right:5px"><b>RunCrew:</b></td>
            <td><asp:Label ID="vOpcrew2Label" runat="server" Width="70px" BackColor="turquoise" Text='<%# Bind("vOpcrew2") %>'></asp:Label></td></tr>
            <tr><td align="right" style="padding-right:5px"><b>MRate:</b></td>
            ...
            <td><asp:Label ID="vFountainsLabel" runat="server" Width="70px" BackColor="turquoise" Text='<%# Bind("vFountains") %>'></asp:Label></td></tr>
            <tr><td align="right" style="padding-right:5px"><b>Adder:</b></td>
            <td><asp:Label ID="vAtype1Label" runat="server" Width="120px" BackColor="turquoise" Text='<%# Bind("vAtype1") %>'></asp:Label></td>
            <td align="right" style="padding-right:5px"><b>Qty:</b></td>
            <td><asp:Label ID="vAtqty1Label" runat="server" Width="70px" BackColor="turquoise" Text='<%# Bind("vAtqty1") %>'></asp:Label></td>
            <td align="right" style="padding-right:5px"><b>Adder2:</b></td>
            <td><asp:Label ID="vAtype2Label" runat="server" Width="120px" BackColor="turquoise" Text='<%# Bind("vAtype2") %>'></asp:Label></td>
            <td align="right" style="padding-right:5px"><b>Qty:</b></td>
            <td><asp:Label ID="vAtqty2Label" runat="server" Width="70px" BackColor="turquoise" Text='<%# Bind("vAtqty2") %>'></asp:Label></td></tr>
            <tr><td align="right" style="padding-right:5px"><b>adder3:</b></td>
            <td><asp:Label ID="vAtype3Label" runat="server" Width="120px" BackColor="turquoise" Text='<%# Bind("vAtype3") %>'></asp:Label></td>
            <td align="right" style="padding-right:5px"><b>Qty:</b></td>
            <td><asp:Label ID="vAtqty3Label" runat="server" Width="70px" BackColor="turquoise" Text='<%# Bind("vAtqty3") %>'></asp:Label></td>--%>
    ...
    <asp:ObjectDataSource ID="Route_ListObjectDataSource" runat="server" OldValuesParameterFormatString="original_{0}"
        SelectMethod="SelectRoute" TypeName="Corrugated">
        <SelectParameters>
            <asp:Parameter Name="prmUser" Type="String" />
            <asp:Parameter Name="prmAction" Type="String" />
            <asp:Parameter DefaultValue="Select" Name="prmActSelect" Type="String" />
            ...
            <asp:Parameter Name="prmOppass" Type="Int32" />
            ...
            <asp:Parameter Name="prmAtype1" Type="String" />
            <asp:Parameter Name="prmAtqty1" Type="Int32" />
            <asp:Parameter Name="prmAtype2" Type="String" />
            <asp:Parameter Name="prmAtqty2" Type="Int32" />
            <asp:Parameter Name="prmAtype3" Type="String" />
            <asp:Parameter Name="prmAtqty3" Type="Int32" />
            <asp:Parameter Name="prmLine" Type="Int32" />
            <asp:SessionParameter SessionField="corr_order_qty" Name="prmQty"  Type="int32" />
        </SelectParameters>
    </asp:ObjectDataSource>
   <asp:ObjectDataSource ID="Detail_ObjectDataSource" runat="server" OldValuesParameterFormatString="original_{0}"
        SelectMethod="SelectRoute" TypeName="Corrugated" OnUpdated="ObjectDataSource1_Updated" OnSelecting="ObjectDataSource1_Selecting">
        <SelectParameters>
            <asp:Parameter Name="prmUser" Type="String" />
            <asp:Parameter DefaultValue="View" Name="prmAction" Type="String" />
            <asp:Parameter Name="prmActSelect" Type="String" />
            ...
            <asp:Parameter Name="prmAtqty3" Type="Int32" />
            <asp:SessionParameter SessionField="corr_order_qty" Name="prmQty"  Type="int32" />
            <asp:SessionParameter SessionField="corr_route_line" Name="prmLine" Type="Int32" />
        </SelectParameters>
    </asp:ObjectDataSource>
