<%@ Page Language="C#" AutoEventWireup="true" Debug="false" Inherits="entr_cshrcpt_list" CodeBehind="entr_cshrcpt_list.aspx.cs" %>
        ...
        <tr><td> 
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                ...
                <SelectParameters>
                   ...
                   <asp:SessionParameter SessionField="cash_receipt_cust" Name="prmcustno" Type="String" />                   
                   <asp:Parameter Name="prmcustname" Type="String" />                   
                   <asp:SessionParameter SessionField="cash_receipt_check_no" Name="prmchkno" Type="Int32" />
