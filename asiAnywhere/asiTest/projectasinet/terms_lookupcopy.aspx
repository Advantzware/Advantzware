<%@ Page Language="C#" AutoEventWireup="true" Inherits="terms_lookupcopy" Codebehind="terms_lookupcopy.aspx.cs" %>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800">&nbsp;                
    ...
    <div>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.termsLookupcopy('<%#DataBinder.Eval(Container,"DataItem.vcode")%>','<%#DataBinder.Eval(Container,"DataItem.vdscr")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>            

                 <asp:BoundField DataField="vcode" HeaderText="Terms Code" SortExpression="vcode" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="SeTermsLook" TypeName="LookUp">
            <SelectParameters>               
