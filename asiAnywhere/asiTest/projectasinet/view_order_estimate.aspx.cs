...
public partial class order_estimate : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            Session["order_est"] = orderno.Text;
            Label quote = (Label)FormView1.FindControl("vRfqLabel");
            Session["order_entry_quote"] = quote.Text;
            Label job = (Label)FormView1.FindControl("Label3");
            Session["order_entry_job_no_1"] = job.Text;
            Label job2 = (Label)FormView1.FindControl("Label4");
            Session["order_entry_job_no_2"] = job2.Text;
            Label comp = (Label)Master.FindControl("lblComp");
            COMPANY = comp.Text;
        ...
        if (!Page.IsPostBack)
        {
            if (Session["User"] != null)
            {
                ...
                if (Convert.ToString(Session["add_buton"]) == "add")
                {
                    NewAddButton.Visible = false;
    ...
    protected void UpdateButon_click(object sender, EventArgs e)
    {
        ...
        bool check = ord.ValidateEstEntry(UserLogin.UserName, "Update", "", Convert.ToInt32(orderno.Text.Trim()), cust.Text.Trim(), "", status.Text.Trim(), sold.Text.Trim(), Convert.ToDateTime(orddate.Text.Trim()), Soldname.Text.Trim(), "", Convert.ToDateTime(duedate.Text.Trim()), custaddr.Text.Trim(), soldaddr.Text.Trim(), Convert.ToDateTime("01/01/2009"), "", "", Convert.ToDateTime("01/01/2009"), ccity.Text.Trim(), cstate.Text.Trim(), czip.Text.Trim(), scity.Text.Trim(), sstate.Text.Trim(), szip.Text.Trim(), ponum.Text.Trim(), contact.Text.Trim(), 0, 0, Convert.ToString(HiddenTerm.Value), "", Convert.ToInt32("0"), taxgr.Text.Trim(), freight.Text.Trim(), HiddenCarr.Value, fob.Text.Trim(), sman.Text.Trim(), sname.Text.Trim(), "", "", "", "", ctype.Text.Trim(), Convert.ToDateTime(cExp.Text.Trim()), cnum.Text.Trim(), cauth.Text.Trim(), Custname.Text.Trim(), type.SelectedValue.Trim(), Convert.ToInt32("0"), "", Convert.ToInt64("0"), "",0, "", Convert.ToDecimal("0"), Convert.ToDecimal("0"), Convert.ToDecimal("0"), Convert.ToDecimal("0"), Convert.ToDecimal("0"),0, 0);
        ...
        if (value == "True")
        {
            ...
            Session["order_entry_req_date"] = duedate.Text.Trim();
            Session["customer_fglookup_val"] = cust.Text.Trim();
    ...
    protected void InsertButon_click(object sender, EventArgs e)
    {
        ...
        bool check = ord.ValidateEstEntry(UserLogin.UserName, "Validate", "", Convert.ToInt32("0"), cust.Text.Trim(), lastuser.Text.Trim(), status.Text.Trim(), sold.Text.Trim(), Convert.ToDateTime(orddate.Text.Trim()), Soldname.Text.Trim(), "", Convert.ToDateTime(duedate.Text.Trim()), custaddr.Text.Trim(), soldaddr.Text.Trim(), Convert.ToDateTime(HiddenField10.Value), "", "", Convert.ToDateTime("01/01/2009"), ccity.Text.Trim(), cstate.Text.Trim(), czip.Text.Trim(), scity.Text.Trim(), sstate.Text.Trim(), szip.Text.Trim(), ponum.Text.Trim(), contact.Text.Trim(), Convert.ToDecimal(overpct.Text.Trim()), Convert.ToDecimal(underpct.Text.Trim()), Convert.ToString(HiddenTerm.Value), Convert.ToString(HiddenTermdesc), Convert.ToInt32("0"), taxgr.Text.Trim(), freight.Text.Trim(), HiddenCarr.Value, fob.Text.Trim(), sman.Text.Trim(), sname.Text.Trim(), "", "", "", "", ctype.Text.Trim(), Convert.ToDateTime(cExp.Text.Trim()), cnum.Text.Trim(), cauth.Text.Trim(), Custname.Text.Trim(), type.SelectedValue.Trim(), Convert.ToInt32("0"), "", Convert.ToInt64("0"), HiddenField8.Value, Convert.ToInt32(HiddenField9.Value), "", Convert.ToDecimal("0"), Convert.ToDecimal("0"), Convert.ToDecimal("0"), Convert.ToDecimal("0"), Convert.ToDecimal("0"), Convert.ToDecimal("0"), Convert.ToInt32(quote.Text.Trim()));
        ...
        if (value == "True")
        {
            ...
            Session["order_entry_customer_po"] = ponum.Text.Trim();
            Session["order_entry_req_date"] = duedate.Text.Trim();
            Session["order_entry_req_code"] = code.SelectedValue.Trim();
            Session["order_entry_prom_code"] = code.SelectedValue.Trim(); ;
            Session["order_entry_prom_date"] = duedate.Text.Trim();
            Session["order_entry_over"] = overpct.Text.Trim();
            Session["order_entry_under"] = underpct.Text.Trim();
            Session["order_entry_sman1"] = sman.Text.Trim();
            Session["order_entry_luser"] = lastuser.Text.Trim(); ;
            Session["order_entry_type"] = type.Text.Trim();
            Session["order_entry_sname1"] = sname.Text.Trim();
            Session["order_entry_type"] = type.SelectedValue.Trim();
            Session["customer_fglookup_val"] = cust.Text.Trim();
            Session["order_entry_cust_no"] = cust.Text.Trim();
            if (quote.Text != "")
            {
                Session["view_line_est"] = 1;
            }
        ...
        {
            //Response.Write("<script>window.location.href='view_item_estimate.aspx';</script>");
    ...
    protected void UpdateButton_Cancel_Click(object sender, EventArgs e)
    {
        ...
        Session["order_est"] = ord.Text;
    }

    protected void FormView1_PreRender(object sender, EventArgs e)
    {
        if (Session["get_new_order_est_2"] != null)
        {
            Session["order_est"] = Session["get_new_order_est_2"];
        }
    ...
    protected void FormView1_Unload(object sender, EventArgs e)
    {
        try
        {
            ...
            Session["order_rec_key"] = rec_key.Text;
            Session["my_new_order_est"] = orderno.Text;
            if (Session["order_est"] == Session["my_new_order_est"])
            {
                Session["my_new_order_est"] = null;
            }
            else
            {
                Session["order_est"] = Session["my_new_order_est"];
                Session["order"] = Session["my_new_order_est"];
            }
            Session["order_entry_status_check"] = stat.Text.Trim();
