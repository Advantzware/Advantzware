<%@ Page Language="C#" AutoEventWireup="true" Inherits="location_lookup" Codebehind="location_lookup.aspx.cs" %>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800">&nbsp;                
                <B>Search for:&nbsp; </B>&nbsp;&nbsp;&nbsp;
                  <asp:dropdownlist id="ddlSearchField" runat="server">
                    <asp:ListItem Value="Any">Location</asp:ListItem>
    ...
    <div>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AllowSorting="true" DataSourceID="ObjectDataSource1"
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle  Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.LocationLookUp('<%#DataBinder.Eval(Container,"DataItem.vLoc")%>','<%#DataBinder.Eval(Container,"DataItem.vName")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField> 
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="SelLocationLook" TypeName="LookUp">
            <SelectParameters>
