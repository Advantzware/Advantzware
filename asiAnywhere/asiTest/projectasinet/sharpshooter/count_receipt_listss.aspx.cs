...
{
    public partial class count_receipt_listss : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                GridView1.SelectedIndex = Convert.ToInt32(Session["count_recept_list_index"]);
                if (Session["count_recept_list_index"] == null)
                {
                    GridView1.SelectedIndex = 0;
                    Session["count_recept_list_seq"] = GridView1.SelectedRow.Cells[1].Text;
                }
        ...
        protected void btnShowAll_Click(object sender, System.EventArgs e)
        {
            ...
            Session["count_recept_list_seq_no"] = txt_seqno.Text.Trim();
            Session["count_recept_list_recdate"] = txt_date.Text.Trim();
            Session["count_recept_list_po"] = txt_po.Text.Trim();
            Session["count_recept_list_inum"] = txt_item.Text.Trim();
            Session["count_recept_list_tag"] = txt_tag.Text.Trim();
            Session["count_recept_list_job"] = txt_job.Text.Trim();
        }
        ...
        {
            Session["count_recept_list_index"] = GridView1.SelectedIndex;
            Session["count_recept_list_seq"] = GridView1.SelectedRow.Cells[1].Text;
        }
        ...
        {
            Session["count_receipt_list_add_new"] = "Yes";
            Response.Redirect("view_count_receiptss.aspx");
        }
