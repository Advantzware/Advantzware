<%@ Page Language="C#" MasterPageFile="MasterPageReceGdsss.master" Debug="true" AutoEventWireup="true" Inherits="projectasinet.sharpshooter.rece_set_partss" Title="Warehouse Transactions Receipts" Codebehind="rece_set_partss.aspx.cs" %>
...
<div>
    ...
    <asp:GridView ID="GridView1" runat="server" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1" AllowPaging="True" AllowSorting="True" BorderStyle="Dotted" CssClass="Grid" EmptyDataText="No Record Found" OnPageIndexChanging="GridView1_PageIndexChanging">
        <Columns>
            ...
            <asp:BoundField DataField="vLoc"  ItemStyle-Wrap="false" HeaderText="Whse" SortExpression="vLoc" />
            ...
            <asp:BoundField DataField="vTotWt" HeaderText="Tot-Wt" 
        ...
        <RowStyle Wrap="false" CssClass="shade" />
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
        ...
        <SelectParameters>            
            ...
            <asp:SessionParameter Name="prmSeqno" SessionField="prmSeq_rcpt2_gd" Type="String" />
            <asp:SessionParameter Name="prmTagno" SessionField="prmTag_rcpt2_gd" Type="String" />
            <asp:SessionParameter Name="prmRcptDate" SessionField="prmDate_rcpt2_gd" Type="String" />
            <asp:SessionParameter Name="prmPono" SessionField="prmPo_rcpt2_gd" Type="String" />
            <asp:SessionParameter Name="prmFgItem" SessionField="prmIno_rcpt2_gd" Type="String" />
            <asp:SessionParameter Name="prmJobno" SessionField="prmJob_rcpt2_gd" Type="String" />
            <asp:SessionParameter Name="prmRecKey" SessionField="seqno_list" Type="String" />
            <asp:Parameter Name="prmllSetParts" Type="String" DefaultValue="Yes" />
        </SelectParameters>
    </asp:ObjectDataSource>
</div>
