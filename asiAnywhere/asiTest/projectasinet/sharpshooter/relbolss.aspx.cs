...
{
    public partial class relbolss : System.Web.UI.Page
    {
        public Int32 seq = 0;
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (Request.QueryString["clean"] == "yes")
            {
                ...
                Response.Redirect("relbolss.aspx");
            }
                ...
                try
                {
                    ...
                    if (path2 != "")
                    {
                        if (!Request.Browser.Browser.Contains("Safari"))
                            Response.Write("<script>window.open('print_create_rel_bol_listss.aspx'); target='_blank'</script>");
