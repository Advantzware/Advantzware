<%@ Page Language="C#" MasterPageFile="MasterPageReceGdsss.master" Debug="true" AutoEventWireup="true" Inherits="projectasinet.sharpshooter.rece_viewset_partss" Title="Warehouse Transactions Receipts" Codebehind="rece_viewset_partss.aspx.cs" %>
...
<div>
    <asp:FormView ID="FormView1" runat="server" OnDataBound="FormView1_DataBound" OnUnload="FormView1_Unload" DataSourceID="ObjectDataSource1">
        ...
        Tag#: </b><br>
         ...
         <td nowrap align="left" style="padding-right:5px;"><b>   
            Po#: </b><br>
            <asp:TextBox ID="vPo_noTextBox" MaxLength="9" Width="58px" Enabled="false" runat="server" Text='<%# Bind("vPo_no") %>' />
                        
            <br />
            </td>
            <td nowrap align="left" style="padding-right:5px;"><b>
            Job#: </b><br>
            <asp:TextBox ID="vJob_noTextBox" MaxLength="6" Width="40px" Enabled="false" runat="server" Text='<%# Bind("vJob_no") %>' />
            <br />
            </td>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
        ...
        <SelectParameters>            
            ...
            <asp:SessionParameter Name="prmSeqno" SessionField="seqno_rec_set_part_gd" Type="String" />
            ...
            <asp:SessionParameter SessionField="seqno_list" Name="prmCreatedBy" Type="String" />
            <asp:Parameter Name="prmCreate2" DefaultValue="Yes" Type="String" />
