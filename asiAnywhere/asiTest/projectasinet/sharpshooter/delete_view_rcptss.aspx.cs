...
{
    public partial class delete_view_rcptss : System.Web.UI.Page
    {
        public delete_view_rcptss()
        {
            //
        ...
        protected void UpdateButton_Click(object sender, EventArgs e)
        {
            ...
            ObjectDataSource1.SelectParameters["prmRecKey"].DefaultValue = "delete";
        ...
        protected void DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            ObjectDataSource1.SelectParameters["prmFgItem"].DefaultValue = "delete";
        ...
        protected void Tagtextbox_Click(object sneder, EventArgs e)
        {
            ...
            try
            {
                ...
                ds = fgtaglook.SelectfgtakLook("PoSearch", UserLogin.UserName, "Tag#", "EQUAL", tag.Text.Trim(), "no", "Delete");
