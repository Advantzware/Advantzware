<%@ Page Language="C#" AutoEventWireup="true" Debug="true" Inherits="projectasinet.sharpshooter.view_returns_rcptss" Codebehind="view_returns_rcptss.aspx.cs" %>
...
<body>
    ...
    <td>
    <asp:LinkButton ID="lnk_list" runat="server" CssClass="imagesize" OnClick="lnk_list_click"><img src="../Images/list_receipt_0.jpg" border="0" width="150px" alt="List Receipt" /></asp:LinkButton>
    <asp:LinkButton ID="lnk_view" runat="server" CssClass="imagesize" OnClick="lnk_view_click"><img src="../Images/view_reciept_1.jpg" border="0" alt="View Receipt" width="150px" /></asp:LinkButton>
    </td>
    </tr></table>
    <br />
