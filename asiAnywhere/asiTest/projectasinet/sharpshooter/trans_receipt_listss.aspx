<%@ Page Language="c#" AutoEventWireup="True" Debug="true" Inherits="projectasinet.sharpshooter.trans_receipt_listss" Codebehind="trans_receipt_listss.aspx.cs" %>
...
function ordernotes() {
   ...
   <body>
    ...
    <td>
    <asp:LinkButton ID="lnk_listitem" runat="server" OnClick="lnk_list_click"><img src="../images/transfer.jpg" border="0" width="150px" alt="List Transfer" /></asp:LinkButton>
    <%--<asp:LinkButton ID="lnk_viewitem" runat="server" OnClick="lnk_view_click"><img src="Images/view transfer1.jpg" border="0" alt="View Transfer" /></asp:LinkButton>--%>
     ...
     <asp:Panel ID="Grid_panel" runat="server" Width="100%"  ScrollBars="Vertical" Height="250px">
