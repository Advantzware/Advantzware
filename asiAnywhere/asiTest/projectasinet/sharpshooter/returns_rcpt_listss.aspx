<%@ Page Language="c#" AutoEventWireup="True" Debug="true" Inherits="projectasinet.sharpshooter.returns_rcpt_listss" Codebehind="returns_rcpt_listss.aspx.cs" %>
...
function lpofglLookup(ReturnObj1) {
   ...
   <body>
    ...
    <td>
    <asp:LinkButton ID="lnk_listitem" runat="server" CssClass="imagesize" OnClick="lnk_list_click"><img src="../Images/list_receipt_1.jpg" border="0" width="150px" alt="List Receipt" /></asp:LinkButton>
    <asp:LinkButton ID="lnk_viewitem" runat="server" CssClass="imagesize" OnClick="lnk_view_click"><img src="../Images/view_receipt_0.jpg" border="0" width="150px" alt="View Receipt" /></asp:LinkButton>
    </td>
    </tr></table>
