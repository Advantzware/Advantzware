<%@ Page Language="C#" MasterPageFile="MasterPageMoveRcptss.master" Debug="true" AutoEventWireup="true" Inherits="projectasinet.sharpshooter.movelist_rcptss" Title="Warehouse Transactions Receipts Update" Codebehind="movelist_rcptss.aspx.cs" %>
...
<div>
    ...
    <asp:GridView ID="GridView1" runat="server" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1" AllowPaging="True" AllowSorting="True" BorderStyle="Dotted" CssClass="Grid" EmptyDataText="No Record Found" OnPageIndexChanging="GridView1_PageIndexChanging">
        <Columns>
            ...
            <asp:BoundField DataField="vLoc" HeaderText="Whse" ItemStyle-Wrap="false" SortExpression="vLoc" /> 
