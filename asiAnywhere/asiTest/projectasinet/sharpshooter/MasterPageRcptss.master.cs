...
{
    public partial class MasterRcptss : System.Web.UI.MasterPage
    {
        public MasterRcptss()
        {
            //
        ...
        protected void list_rcpt_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("list_rcptss.aspx");
        }

        protected void view_rcpt_Click(object sender, ImageClickEventArgs e)
        {

            Response.Redirect("view_rcptss.aspx");
        }
        ...
        {
            Response.Redirect("list_set_partss.aspx");
        }
