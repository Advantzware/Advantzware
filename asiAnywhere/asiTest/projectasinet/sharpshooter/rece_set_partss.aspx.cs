...
{
    public partial class rece_set_partss : System.Web.UI.Page
    {
        public rece_set_partss()
        {
            //
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (Session["prmSeq_rcpt2_gd"] != null)
                    txt_seq.Text = Convert.ToString(Session["prmSeq_rcpt2_gd"]);
                else
                    txt_seq.Text = "";
                if (Session["prmTag_rcpt2_gd"] != null)
                    txt_tag.Text = Convert.ToString(Session["prmTag_rcpt2_gd"]);
                else
                    txt_tag.Text = "";
                if (Session["prmDate_rcpt2_gd"] != null)
                    txt_date.Text = Convert.ToString(Session["prmDate_rcpt2_gd"]);
                else
                    txt_date.Text = "";
                if (Session["prmPo_rcpt2_gd"] != null)
                    txt_po.Text = Convert.ToString(Session["prmPo_rcpt2_gd"]);
                else
                    txt_po.Text = "";
                if (Session["prmIno_rcpt2_gd"] != null)
                    txt_ino.Text = Convert.ToString(Session["prmIno_rcpt2_gd"]);
                else
                    txt_ino.Text = "";
                if (Session["prmJob_rcpt2_gd"] != null)
                    txt_job.Text = Convert.ToString(Session["prmJob_rcpt2_gd"]);
                else
                    txt_job.Text = "";
            ...
            ImageButton brwsorder = (ImageButton)Master.FindControl("recelist_item");
            brwsorder.ImageUrl = "~/Images/set-parts.jpg";

            GridView1.PageIndex = Convert.ToInt32(Session["page_inder_rcpt_gd"]);

            GridView1.SelectedIndex = Convert.ToInt32(Session["list_rcpt_grid2_seqno_index_gd"]) - 1;
            try
            {
                if (Session["list_rcpt_grid2_seqno_index_gd"] == null)
                {
                    GridView1.SelectedIndex = 0;
                    Session["seqno_rec_set_part_gd"] = GridView1.SelectedRow.Cells[1].Text;
                }
            }
            catch
            {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            Session["prmAction_rcpt2_gd"] = "Search";
            Session["prmSeq_rcpt2_gd"] = null;
            Session["prmTag_rcpt2_gd"] = null;
            Session["prmDate_rcpt2_gd"] = null;
            Session["prmPo_rcpt2_gd"] = null;
            Session["prmIno_rcpt2_gd"] = null;
            Session["prmJob_rcpt2_gd"] = null;

            Session["list_rcpt_grid2_seqno_index_gd"] = null;
            Session["list_rcpt_grid2_seqno_gd"] = null;
            GridView1.SelectedIndex = 0;
        ...
        protected void btn_reset_Click(object sender, EventArgs e)
        {
            ...
            Session["prmAction_rcpt2_gd"] = "Select";
            Session["prmSeq_rcpt2_gd"] = null;
            Session["prmTag_rcpt2_gd"] = null;
            Session["prmDate_rcpt2_gd"] = null;
            Session["prmPo_rcpt2_gd"] = null;
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Session["list_rcpt_grid2_seqno_index_gd"] = GridView1.SelectedIndex + 1;
            Session["seqno_rec_set_part_gd"] = GridView1.SelectedRow.Cells[1].Text;
        ...
        protected void GridView1_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            Session["page_inder_rcpt_gd"] = e.NewPageIndex;
        }
