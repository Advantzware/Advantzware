<%@ Page Language="c#" AutoEventWireup="True" Debug="true" Inherits="projectasinet.sharpshooter.cons_receipt_listss" Codebehind="cons_receipt_listss.aspx.cs" %>
...
function lpofglLookup(ReturnObj1) {
   ...
   <body>
    ...
    <td>
    <asp:LinkButton ID="lnk_listitem" runat="server" OnClick="lnk_list_click"><img src="../Images/list_receipt_1.jpg" border="0" width="150px" alt="List Receipt" /></asp:LinkButton>
    <asp:LinkButton ID="lnk_viewitem" runat="server" OnClick="lnk_view_click"><img src="../Images/view_receipt_0.jpg" border="0" width="150px" alt="View Receipt" /></asp:LinkButton>
    </td>
    </tr></table>
     ...
     AllowPaging="True" AllowSorting="True" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="vItemName" HeaderText="Name" SortExpression="vItemName" HeaderStyle-Wrap="false" ItemStyle-Wrap="false" />
                ...
                <asp:BoundField DataField="vQtyCas" HeaderText="Qty/Unit" SortExpression="vQtyCas" HeaderStyle-Wrap="false" ItemStyle-Wrap="false" />  
              ...
              <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
                  ...
                  <SelectParameters>
                      ...
                      <asp:SessionParameter SessionField="cons_recept_list_inum" Name="prmFgItem" Type="String" />
                      <asp:SessionParameter SessionField="cons_recept_list_job" Name="prmJobno" Type="String" />
                      <asp:SessionParameter SessionField="cons_recept_list_po" Name="prmPono" Type="String" />
                      <asp:SessionParameter SessionField="cons_recept_list_seq_no" Name="prmSeqno" Type="String" />
                      <asp:SessionParameter SessionField="cons_recept_list_recdate" Name="prmRcptDate" Type="String" />
                      <asp:SessionParameter SessionField="cons_recept_list_tag" Name="prmTagno" Type="String" />
