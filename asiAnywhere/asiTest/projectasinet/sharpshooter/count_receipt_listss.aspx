<%@ Page Language="c#" AutoEventWireup="True" Debug="true" Inherits="projectasinet.sharpshooter.count_receipt_listss" Codebehind="count_receipt_listss.aspx.cs" %>
...
function lpofglLookup(ReturnObj1) {
   ...
   <body>
    ...
    <td>
    <asp:LinkButton ID="lnk_listitem" runat="server" CssClass="imagesize" OnClick="lnk_list_click"><img src="../Images/list count0.jpg" border="0" width="150px" alt="List Count" /></asp:LinkButton>
    <asp:LinkButton ID="lnk_viewitem" runat="server" CssClass="imagesize" OnClick="lnk_view_click"><img src="../Images/view count1.jpg" border="0" width="150px" alt="View Count" /></asp:LinkButton>
    </td>
    </tr></table>
