...
{
    public partial class view_cons_receiptss : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Session["cons_recipt_list_add_new"] = null;
        ...
        {
            Response.Redirect("cons_receipt_listss.aspx");
        }

        protected void lnk_view_click(object sender, EventArgs e)
        {
            Response.Redirect("view_cons_receiptss.aspx");
        }
        protected void Insert_Button_Click(object sender, EventArgs e)
        {
            ...
            ObjectDataSource1.SelectParameters["prmPartial"].DefaultValue = PartialHiddenField.Value;
        ...
        protected void DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            ObjectDataSource1.SelectParameters["prmRecKey"].DefaultValue = Convert.ToString(Session["cons_recept_list_seq"]);
        ...
        protected void FormView1_PreRender(object sender, EventArgs e)
        {
            try
            {
                ...
                Session["cons_recept_list_seq"] = sql.Text;
        ...
        protected void tag_TextBoxChange(object sender, EventArgs e)
        {
            TextBox tag = (TextBox)FormView1.FindControl("vTagTextBox");
            TextBox itemname = (TextBox)FormView1.FindControl("vItemNameTextBox");
            TextBox job = (TextBox)FormView1.FindControl("vJobnoTextBox");
            ...
            try
            {
                ...
                cust.Text = ds.Tables[0].Rows[0][20].ToString();
                cases.Text = ds.Tables[0].Rows[0][11].ToString();
                qtycas.Text = ds.Tables[0].Rows[0][13].ToString();
                toloc.Text = ds.Tables[0].Rows[0][18].ToString();
                tolocbbin.Text = ds.Tables[0].Rows[0][19].ToString();
                totag.Text = ds.Tables[0].Rows[0][17].ToString();
                item.Text = ds.Tables[0].Rows[0][3].ToString();
                PartialHiddenField.Value = ds.Tables[0].Rows[0][14].ToString();
                tag.Focus();
