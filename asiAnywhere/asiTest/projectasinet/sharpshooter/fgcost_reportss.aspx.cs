...
{
    public partial class fgcost_reportss : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (Session["User"] != null)
            {
                ...
                string vPage = "fgcost_report.aspx";
                string aUsers = null;
                string PrmComp = null;
            ...
            if (!Page.IsPostBack)
            {
                ...
                try
                {
                    ...
                    string cmd = "select * from report_maintance where user_name = '" + UserLogin.UserName + "' and prog_name = 'fgcost_report.aspx' ";
                    ...
                    foreach (DataRow dr in ds.Tables[0].Rows)
                    {
                        ...
                        if (dr["rd_field2"].ToString() == "Whs/Bin")
                            RadioButtonList2.SelectedIndex = 4;
        ...
        protected void submitbutton_click(object sender, EventArgs e)
        {
            ...
            ObjectDataSource1.SelectParameters["prmAction"].DefaultValue = "Fgcost";
            ...
            ObjectDataSource1.SelectParameters["prmPrint"].DefaultValue = Convert.ToString(RadioButtonList3.SelectedValue);
            ObjectDataSource1.SelectParameters["prmCustPart"].DefaultValue = HiddenField1.Value;
            ...
            try
            {
                ...
                {
                    SqlCommand cmd_insert = new SqlCommand("insert into report_maintance (user_name, prog_name , field1, field2, field3, field4, field5, field6,field7, field8, field9, chk_field1, rd_field1, rd_field2, rd_field3) values ('" + UserLogin.UserName + "','fgcost_report.aspx' , '" + TextBox1.Text.Trim() + "', '" + TextBox2.Text.Trim() + "', '" + TextBox5.Text.Trim() + "', '" + TextBox7.Text.Trim() + "', '" + TextBox8.Text.Trim() + "', '" + TextBox3.Text.Trim() + "', '" + TextBox4.Text.Trim() + "', '" + BeCatTextBox.Text.Trim() + "', '" + EndCatTextBox.Text.Trim() + "', '" + HiddenField1.Value + "','" + Convert.ToString(RadioButtonList1.SelectedValue) + "','" + Convert.ToString(RadioButtonList2.SelectedValue) + "','" + Convert.ToString(RadioButtonList3.SelectedValue) + "')", conn);
                    cmd_insert.ExecuteNonQuery();
                }
                else
                {
                    SqlCommand cmd_update = new SqlCommand("update report_maintance set field1 = '" + TextBox1.Text.Trim() + "', field2 = '" + TextBox2.Text.Trim() + "', field3 = '" + TextBox5.Text.Trim() + "', field4 = '" + TextBox7.Text.Trim() + "', field5 = '" + TextBox8.Text.Trim() + "', field6 = '" + TextBox3.Text.Trim() + "',field7 = '" + TextBox4.Text.Trim() + "',field8 = '" + BeCatTextBox.Text.Trim() + "',field9 = '" + EndCatTextBox.Text.Trim() + "', chk_field1 = '" + HiddenField1.Value + "', rd_field1 = '" + Convert.ToString(RadioButtonList1.SelectedValue) + "',rd_field2 = '" + Convert.ToString(RadioButtonList2.SelectedValue) + "',rd_field3 = '" + Convert.ToString(RadioButtonList3.SelectedValue) + "' where user_name = '" + UserLogin.UserName + "' and prog_name =  'fgcost_report.aspx' ", conn);
            ...
            try
            {
                ...
                Label vpath = (Label)FormView1.FindControl("vFgCostFileLabel");
