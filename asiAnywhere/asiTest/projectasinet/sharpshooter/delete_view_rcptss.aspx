<%@ Page Language="C#" MasterPageFile="MasterPageReceGdsss.master" Debug="true" AutoEventWireup="true" Inherits="projectasinet.sharpshooter.delete_view_rcptss" Title="Warehouse Transactions Receipts" Codebehind="delete_view_rcptss.aspx.cs" %>
...
<div>
    <asp:FormView ID="FormView1" runat="server" OnDataBound="FormView1_DataBound" OnUnload="FormView1_Unload" DataSourceID="ObjectDataSource1">
        ...
        <td nowrap align="left" style="padding-right:5px;"><b> 
            Whse: </b><br>
            <asp:TextBox ID="vLocTextBox" onkeyup="tagtxtbox()" MaxLength="5" Width="35px" runat="server" Text='<%# Bind("vLoc") %>' />
            ...
            <td nowrap align="left" style="padding-right:5px;"><b>
            Job#: </b><br>
            <asp:TextBox ID="vJob_noTextBox" MaxLength="6" Width="40px" runat="server" Text='<%# Bind("vJob_no") %>' />
            <br />
            </td>
        ...
        Receipt Time: </b><br>
         ...
         <td nowrap align="left" style="padding-right:5px;"><b>   
            Po#: </b><br>
            <asp:TextBox ID="vPo_noTextBox" MaxLength="9" Width="58px"  runat="server" Text='<%# Bind("vPo_no") %>' />
            ...
            <a href="#" tabindex="1" onClick="fglook(); return false"><asp:Image ID="Image5" runat="server" ImageUrl="i~/mages/lookup_icon.gif" /></a>
            <br />
            </td>
            <td nowrap align="left" style="padding-right:5px;"><b> 
            Name/Desc: </b><br>
        ...
        <td nowrap align="left" style="padding-right:5px;"><b> 
         ...
         <td nowrap align="left" style="padding-right:5px;"><b>   
            ...
            <td nowrap align="left" style="padding-right:5px;"><b> 
            Item: </b><br>
            <asp:TextBox ID="vItemTextBox" MaxLength="15" Width="95px" runat="server" Text='<%# Bind("vItem") %>' />
