<%@ Page Language="C#" MasterPageFile="MasterPageReceGdsss.master" Debug="true" AutoEventWireup="true" Inherits="projectasinet.sharpshooter.receview_rcptss" Title="Warehouse Transactions Receipts" Codebehind="receview_rcptss.aspx.cs" %>
...
<div>
    <asp:FormView ID="FormView1" runat="server" OnDataBound="FormView1_DataBound" OnUnload="FormView1_Unload" DataSourceID="ObjectDataSource1">
        ...
        <td nowrap align="left" style="padding-right:5px;"><b> 
        Tag#: </b><br>
            <asp:Label ID="vTagLabel" MaxLength="20" Width="130px" BackColor="PaleTurquoise" BorderColor="White" BorderStyle="Solid" BorderWidth="1px" runat="server" Text='<%# Bind("vTag") %>' />
            <br />
        </td>
        <td nowrap align="left" style="padding-right:5px;"><b> 
            Whse: </b><br>
