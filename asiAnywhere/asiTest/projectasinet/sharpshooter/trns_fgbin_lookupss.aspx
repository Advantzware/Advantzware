<%@ Page Language="C#" AutoEventWireup="True" Debug="true" Codebehind="trns_fgbin_lookupss.aspx.cs" Inherits="projectasinet.sharpshooter.trns_fgbin_lookupss" %>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800">&nbsp;                
    ...
    <div>
            ...
            <Columns>
             <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.trnsfgbinlookup('<%#DataBinder.Eval(Container,"DataItem.vINo")%>','<%#DataBinder.Eval(Container,"DataItem.vtag")%>','<%#DataBinder.Eval(Container,"DataItem.vJobNo")%>','<%#DataBinder.Eval(Container,"DataItem.vJob2")%>','<%#DataBinder.Eval(Container,"DataItem.vLoc")%>','<%#DataBinder.Eval(Container,"DataItem.vLocBin")%>','<%#DataBinder.Eval(Container,"DataItem.vcust")%>','<%#DataBinder.Eval(Container,"DataItem.vqty")%>','<%#DataBinder.Eval(Container,"DataItem.vQtyCas")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>     
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="trnsfgbinLook" TypeName="browspo">
            <SelectParameters>               
