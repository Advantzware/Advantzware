<%@ Page Language="C#" AutoEventWireup="true" Debug="true" Inherits="projectasinet.sharpshooter.view_trans_receiptss" Codebehind="view_trans_receiptss.aspx.cs" %>
...
<body>
    ...
    <td>
    <asp:LinkButton ID="lnk_list" runat="server" CssClass="imagesize" OnClick="lnk_list_click"><img src="~/Images/list transfer1.jpg" border="0" width="150px" alt="List Transfer" /></asp:LinkButton>
    <asp:LinkButton ID="lnk_view" runat="server" CssClass="imagesize" OnClick="lnk_view_click"><img src="~/Images/view transfer0.jpg" border="0" width="150px" alt="View Transfer" /></asp:LinkButton>
    </td>
    </tr></table>
    <br />
