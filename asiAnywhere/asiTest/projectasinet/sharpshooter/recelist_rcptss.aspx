<%@ Page Language="C#" MasterPageFile="MasterPageReceGdsss.master" Debug="true" AutoEventWireup="true" Inherits="projectasinet.sharpshooter.recelist_rcptss" Title="Warehouse Transactions Receipts" Codebehind="recelist_rcptss.aspx.cs" %>
...
<div>
    ...
    <asp:Panel ID="Grid_panel" runat="server" Width="1400px"  ScrollBars="Vertical" Height="270px">
...
<div>
    ...
    <asp:FormView ID="FormView1" runat="server" OnDataBound="FormView1_DataBound" OnUnload="FormView1_Unload" DataSourceID="ObjectDataSource1">
        ...
        <td nowrap align="left" style="padding-right:5px;"><b> 
            ...
            <td nowrap align="left" style="padding-right:5px;"><b> 
            Units/Skid: </b><br>
            <asp:TextBox ID="vCasUnitTextBox" MaxLength="3" Width="75px" runat="server" onfocus="ssfgscan(1)"
                Text='<%# Bind("vCasUnit") %>' />
            ...
            <td nowrap align="left" style="padding-right:5px;"><b> 
            Partial: </b><br>
            <asp:TextBox ID="vPartialTextBox" MaxLength="6" onkeyup="coltotqty()" onfocus="ssfgscan(1)" Width="45px" runat="server" 
                Text='<%# Bind("vPartial") %>' />
        ...
        <td nowrap align="left" style="padding-right:5px;"><b> 
            ...
            <td nowrap align="left" style="padding-right:5px;"><b> 
            Units Count: </b><br>
            <asp:TextBox ID="vQtyCasTextBox" MaxLength="6" Width="65px" onfocus="ssfgscan(2)" onkeyup="coltotqty()"  runat="server" Text='<%# Bind("vQtyCas") %>' />
            ...
            <td nowrap align="left" style="padding-right:5px;"><b> 
            Partial: </b><br>
            <asp:TextBox ID="vPartialTextBox" MaxLength="6" onfocus="ssfgscan(2)" onkeyup="coltotqty()" Width="45px" runat="server" 
                Text='<%# Bind("vPartial") %>' />
