<%@ Page Language="C#" MasterPageFile="MasterPageMoveRcptss.master" Debug="true" AutoEventWireup="true" Inherits="projectasinet.sharpshooter.moveview_rcptss" Title="Warehouse Transactions Receipts" Codebehind="moveview_rcptss.aspx.cs" %>
...
<script type="text/javascript" language="javascript">
    ...
    function setfocus() {
        document.forms[0].ctl00$ContentPlaceHolder1$FormView1$vTagTextBox.focus();
    }*/
...
function tagtxtbox() {
    ...
    var img = document.getElementById("ctl00_ContentPlaceHolder1_FormView1_fgtagimage");
    if(tagv.value == "") {
...
//function open_pst() {
//    var NewWindow = window.open("finishgdspsting.aspx", "FGpost", "width=700,height=400,scrollbars=1,toolbars=1,statusbar=1,resizeable=1");
//}
...
//    document.forms[0].ctl00_ContentPlaceHolder1_FormView1_vItemTextBox.focus();
//}
...
<div>
    <asp:FormView ID="FormView1" runat="server" OnDataBound="FormView1_DataBound" OnUnload="FormView1_Unload" DataSourceID="ObjectDataSource1">
        ...
        <td nowrap align="left" style="padding-right:5px;"><b>
            ...
            <asp:Label ID="vRnoLabel" Width="55px" Visible="false" BackColor="PaleTurquoise" BorderColor="White" BorderStyle="Solid" BorderWidth="1px" runat="server" Text='<%# Bind("vRno") %>' />
            <br />                        
        </td>
        <td nowrap align="left" style="padding-right:5px;"><b> 
            Tag#: </b><br>
            <asp:TextBox ID="vTagTextBox" MaxLength="20" onblur="tagtxtbox()" Enabled="false" Width="118px" runat="server" Text='<%# Bind("vTag") %>' />
        ...
        <td nowrap align="left" style="padding-right:5px;"><b> 
            ...
            <td nowrap align="left" style="padding-right:5px;"><b>
            Job#: </b><br>
            <asp:TextBox ID="vJob_noTextBox" MaxLength="6" Enabled="false" Width="40px" runat="server" Text='<%# Bind("vJob_no") %>' />
            <br />
            </td>
            <td nowrap align="left" style="padding-right:5px;">
             <br>
            <asp:TextBox ID="vJob_no2TextBox" Enabled="false" MaxLength="2" Width="15px" runat="server" 
                Text='<%# Bind("vJob_no2") %>' />
        ...
        <td nowrap align="left" style="padding-right:5px;"><b> 
        Receipt Date: </b><br>
            <asp:TextBox ID="vDateTextBox" Width="65px" runat="server" Enabled="false" onfocus="javascript:preEnter( this, 'yes' );" onblur="javascript:preLeave( this, 'date', '99/99/9999' );" Text='<%# Bind("vDate") %>' />
        ...
        Receipt Time: </b><br>
         ...
         <td nowrap align="left" style="padding-right:5px;"><b>   
            Po#: </b><br>
            <asp:TextBox ID="vPo_noTextBox" Enabled="false" MaxLength="9" Width="58px"  runat="server" Text='<%# Bind("vPo_no") %>' />
            ...
            <td nowrap align="left" style="padding-right:5px;"><b> 
            Item: </b><br>
            <asp:TextBox ID="vItemTextBox" Enabled="false" MaxLength="15" Width="95px" runat="server" Text='<%# Bind("vItem") %>' />
            <br />
            </td>
            <td nowrap align="left" style="padding-right:5px;"><b> 
            Name/Desc: </b><br>
            <asp:TextBox ID="vItemNameTextBox" Enabled="false" MaxLength="30" Width="110px" runat="server" 
                Text='<%# Bind("vItemName") %>' />
            <br />
            </td>
            ...
            <asp:TextBox ID="vCasUnitTextBox" Enabled="false" MaxLength="3" Width="75px" runat="server" 
                Text='<%# Bind("vCasUnit") %>' />
            ...
            <td nowrap align="left" style="padding-right:5px;"><b> 
            Cost/UOM: </b><br>
            <asp:TextBox ID="vStdCostTextBox" Enabled="false" Width="65px" runat="server" 
                Text='<%# Bind("vStdCost") %>' />
            ...
            <td nowrap align="left" style="padding-right:5px;"><b> 
            UOM: </b><br>
            <asp:TextBox ID="vCostUomTextBox" Enabled="false" MaxLength="3" Width="20px" runat="server" 
                Text='<%# Bind("vCostUom") %>' />
            <br />
            </td>
            <td nowrap align="left" style="padding-right:5px;"><b> 
            ...
            <td nowrap align="left" style="padding-right:5px;"><b> 
            FG Lot#: </b><br>
            <asp:TextBox ID="vStackCodeTextBox" Enabled="false" onblur="fglotfocus()" Width="65px" runat="server" 
        ...
        Receipt Date: </b><br>
         ...
         <td nowrap align="left" style="padding-right:5px;"><b>   
            ...
            <td><b> 
            <br>
            <asp:Label ID="vseqLabel" Visible="false" Width="65px" runat="server" Text='<%# Bind("vRno") %>' />
            <br />
            </td>
            </tr>
            <tr>
    ...
    <br />
        ...
        <asp:Button ID="Postbutton" runat="server" OnClick="PostButton_click" CssClass="buttonM" Text="Post" OnClientClick="return confirm('Are you sure you want to Post this record')"  />
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
        ...
        <SelectParameters>            
            ...
            <asp:SessionParameter Name="prmSeqno" SessionField="move_list_seq" Type="String" />
