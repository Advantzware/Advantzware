<%@ Page Language="C#" AutoEventWireup="true" Debug="true" Inherits="projectasinet.sharpshooter.view_count_receiptss" Codebehind="view_count_receiptss.aspx.cs" %>
...
function open_transfer() {
    //var custNum = document.getElementById("FormView1_vCustNumTextBox").value;
    var NewWindow = window.open("count_trans_popupss.aspx", "CountTransPopupWindow", "width=600,height=500,scrollbars=1,toolbars=1,statusbar=1,resizeable=1");
}
function open_pst() {
...
<body>
    ...
    <div>
     <TABLE id="TABLE1" cellSpacing="3" align="center" border="0" Width="100%">
        <TR>
          ...
          <TD align=left nowrap><font size=+1><b>Finished Goods Physical Count Processing &nbsp;</asp:label> </b></font></TD>
          <TD vAlign="middle">
    ...
    <td>
    <asp:LinkButton ID="lnk_list" runat="server" CssClass="imagesize" OnClick="lnk_list_click"><img src="../Images/list count1.jpg" border="0" width="150px" alt="List Count" /></asp:LinkButton>
    <asp:LinkButton ID="lnk_view" runat="server" CssClass="imagesize" OnClick="lnk_view_click"><img src="../Images/view count0.jpg" border="0" width="150px" alt="View Count" /></asp:LinkButton>
    </td>
    </tr></table>
    <br />
