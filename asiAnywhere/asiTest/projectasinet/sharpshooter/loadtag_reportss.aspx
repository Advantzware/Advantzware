<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="projectasinet.sharpshooter.loadtag_reportss" Codebehind="loadtag_reportss.aspx.cs" %>
    ...
    function loadtaglookup() {
     ...
     function reprint() {
         ...
         var commaLabel = document.getElementById("commaLabel")
            var chk1 = document.getElementById("CheckBox3");
            if (chk1.checked) {
                var rd1 = document.getElementById("RadioButtonList1");
   ...
   <body>
    <form id="frmList" runat="server"  defaultfocus='TextBox1'>   
      ...
      <TABLE id="tblTop" cellSpacing="3" align="center" border="0" Width="100%">
       ...
       <fieldset class="shade" style="width:600px"><legend>Selection Parameter</legend>
       ...
       <fieldset class="shade" style="width:600px"><legend><b>Data Parameter</b></legend>
       ...
       <td>
           <asp:TextBox ID="fromOrder_TextBox" MaxLength="8" Width="100px" runat="server"></asp:TextBox>
       ...
       <td> <asp:TextBox ID="torder_TextBox" MaxLength="8" Width="100px" runat="server"></asp:TextBox>
       ...
       <td> <asp:TextBox ID="fromjob_TextBox" MaxLength="8" Width="60px" runat="server"></asp:TextBox>
       <asp:TextBox ID="fromjob2_TextBox" MaxLength="2" Width="30px" runat="server"></asp:TextBox>
       ...
       <td> <asp:TextBox ID="tojob_TextBox" MaxLength="8" Width="60px" runat="server"></asp:TextBox>
       <asp:TextBox ID="tojob2_TextBox" Width="30px" MaxLength="2" runat="server"></asp:TextBox>
       ...
       <fieldset class="shade" style="width:600px"> <legend> <b>Print Options</b></legend>
       ...
       <fieldset class="shade" style="width:600px"><legend><b>Output Option</b></legend>
       <table><tr><td></td>
       ...
       <td>
           ...
           <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="Labelpath_TextBox" Display="Dynamic" runat="server" ErrorMessage="Please Enter Server Path"></asp:RequiredFieldValidator></td></tr>
