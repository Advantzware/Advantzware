...
{
    public partial class loadtaglookss : System.Web.UI.Page
    {
        ...
        protected void updatebutton_click(object sender, EventArgs e)
        {
            ...
            FormView1.ChangeMode(FormViewMode.ReadOnly);
            Response.Write("<script>window.location.href='loadtaglookss.aspx?tagno=" + Convert.ToString(Session["loadtaglook_tagno"]) + "'</script>");
