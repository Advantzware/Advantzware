<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="fgcostsumm_report" Codebehind="fgcostsumm_report.aspx.cs" %>
<%@ Register Src="footer.ascx" TagName="Footer" TagPrefix="ft" %>
<%@ Register Src="header.ascx" TagName="Header" TagPrefix="hd" %>
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head id="Head1" runat="server">
    <title>FG Item Value/Cost Summary</title>
    ...
    <form id="frmList" runat="server"  defaultfocus='TextBox1'>   
      ...
      <TABLE id="tblTop" cellSpacing="3" align="center" border="0" Width="100%">
        <TR>
          ...
          <TD align=center nowrap><font size=+0><b>FG Item Value/Cost Summary&nbsp;</b></font></TD>
      ...
      <tr><td colspan="4" align="left" style="padding-left:10px">
          ...
          <asp:FormView ID="FormView1" Visible="False" runat="server" 
              ...
              <ItemTemplate>
                  vFgCostSummFile:
                  <asp:Label ID="vFgCostSummFileLabel" runat="server" 
                      Text='<%# Bind("vFgCostSummFile") %>'></asp:Label><br />                 
              </ItemTemplate>                            
          </asp:FormView>
          
          <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
              SelectMethod="SelectFgcostSummRep" TypeName="reports">
              <SelectParameters>
                  <asp:Parameter Name="prmUser" Type="String" />
