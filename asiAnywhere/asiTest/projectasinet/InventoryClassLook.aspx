<%@ Page Language="C#" AutoEventWireup="true" Inherits="InventoryClassLook" Codebehind="InventoryClassLook.aspx.cs" %>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.InventoryClassLookup('<%#DataBinder.Eval(Container,"DataItem.vClass")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>            
