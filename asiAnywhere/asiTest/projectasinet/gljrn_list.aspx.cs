...
public partial class gljrn_list : System.Web.UI.Page
{
   ...
   protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        try
        {
            if (Session["gljrn_list_index1"] == null)
            {
                GridView1.SelectedIndex = 0;

                Session["general_ledger_reckey_journal"] = ((Label)GridView1.SelectedRow.FindControl("reclabel")).Text;
        ...
        try
        {
            if (Session["gljrn_list_index1"] != null)
            {
                GridView1.SelectedIndex = Convert.ToInt32(Session["gljrn_list_index1"]);
    ...
    {
        Session["gljrn_list_index1"] = GridView1.SelectedIndex;
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        Session["general_ledger_trdate"] = trxdate_TextBox.Text.Trim();
        
       
        ObjectDataSource1.SelectParameters["prmAction"].DefaultValue = "Search";
        ObjectDataSource1.SelectParameters["prmjrn_no"].DefaultValue = jurl_TextBox.Text.Trim();
        ObjectDataSource1.SelectParameters["prmtr_date"].DefaultValue = trxdate_TextBox.Text.Trim();


        Session["gljrn_list_index1"] = null;
    }
    protected void btnShowAll_Click(object sender, EventArgs e)
    {
        jurl_TextBox.Text = "";
        trxdate_TextBox.Text = "";
     ...
     protected void img_btn_exit_click(object sender, EventArgs e)
    {
     ...
     {
         Session["gljrn_list_add_button"] = "add";
         Response.Redirect("view_gljrn_list.aspx");
