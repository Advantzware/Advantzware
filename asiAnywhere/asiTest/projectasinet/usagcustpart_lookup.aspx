<%@ Page Language="C#" AutoEventWireup="true" Inherits="usag_look_Custpart" Codebehind="usagcustpart_lookup.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Customer Part Lookup</title>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800">&nbsp;                
    ...
    <div>
        <asp:GridView ID="GridView1" AllowPaging="True" runat="server" AutoGenerateColumns="False" AllowSorting="True" DataSourceID="ObjectDataSource1"
            ...
            <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.UsagCustPartLookup('<%#DataBinder.Eval(Container,"DataItem.PartNo")%>', '<%#DataBinder.Eval(Container,"DataItem.ItemNo")%>', '<%#DataBinder.Eval(Container,"DataItem.Vander")%>', '<%#DataBinder.Eval(Container,"DataItem.PlantCode")%>', '<%#DataBinder.Eval(Container,"DataItem.DeptCode")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField> 
                <asp:BoundField DataField="PartNo" HeaderText="Customer Part#" SortExpression="PartNo" />
                <asp:BoundField DataField="ItemNo" HeaderText="Suppliers FG Item" SortExpression="ItemNo" />
                <asp:BoundField DataField="Vander" HeaderText="Customer A/P Code" SortExpression="Vander" />
                <asp:BoundField DataField="PlantCode" HeaderText="Customer Plant ID" SortExpression="PlantCode" />
                <asp:BoundField DataField="DeptCode" HeaderText="Customer Dept Code" SortExpression="DeptCode" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="UsagCustPartLook" TypeName="LookUp">
            <SelectParameters>               
                ...
                <asp:QueryStringParameter QueryStringField="part" Name="prmCustPart" Type="String" />
            </SelectParameters>
