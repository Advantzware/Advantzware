...
public partial class fold_gsa_set : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        ObjectDataSource1.SelectParameters["prmGsaMat"].DefaultValue = Convert.ToString(Session["fold_analysis_set_gsa_mat"]);
        ObjectDataSource1.SelectParameters["prmGsaLab"].DefaultValue = Convert.ToString(Session["fold_analysis_set_gsa_lab"]);
        ObjectDataSource1.SelectParameters["prmGsaWar"].DefaultValue = Convert.ToString(Session["fold_analysis_set_gsa_war"]);
        ObjectDataSource1.SelectParameters["prmGsaMonth"].DefaultValue = Convert.ToString(Session["fold_analysis_set_gsa_month"]);
    ...
    protected void updatebutton_click(object sender, EventArgs e)
    {
         ...
         ObjectDataSource1.SelectParameters["prmWHMark"].DefaultValue = wherehousemark.Text.Trim();
         ObjectDataSource1.SelectParameters["prmGsafm"].DefaultValue = foldfg.Text.Trim();
         ObjectDataSource1.SelectParameters["prmVendor"].DefaultValue = Convert.ToString(Session["fold_analysis_set_vendor_no"]);
        ...
        {
            conn.Open();
            string cmd2 = "select max(seq_no) from corr_print_maintenance  where user_name = '" + UserLogin.UserName + "' and est = '" + Convert.ToString(Session["order_folding_est"]) + "'  ";
