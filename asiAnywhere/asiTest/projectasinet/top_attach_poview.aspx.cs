...
public partial class top_attach_poview : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("top_attach_po.aspx");
    }
    protected void img_btn_view_attach_click(object sender, EventArgs e)
    {
        Response.Redirect("top_attach_poview.aspx");
    }
    protected void FormView1_DataBound(object sender, EventArgs e)
    {
        ...
        if (FormView1.CurrentMode == FormViewMode.Insert)
        {
            ...
            est.Text = Convert.ToString(Session["pur_ord_po"]);
    ...
    protected void UpdateButton_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            ObjectDataSource1.SelectParameters["prmPoNo"].DefaultValue = est.Text.Trim();
    ...
    protected void btn_delete_click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            ObjectDataSource1.SelectParameters["prmUser"].DefaultValue = UserLogin.UserName;
            ObjectDataSource1.SelectParameters["prmPoNo"].DefaultValue = Convert.ToString(Session["pur_ord_po"]);
    ...
    protected void FormView1_Unload(object sender, EventArgs e)
    {
        try
        {
            ...
            Session["top_list_attachpo_rec_key"] = reckey.Text.Trim();
