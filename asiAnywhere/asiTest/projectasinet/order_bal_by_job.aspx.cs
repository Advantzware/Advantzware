...
public partial class order_bal_by_job : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (Session["User"] != null)
        {
            ...
            string vPage = "order_bal_by_job.aspx";
            string aUsers = null;
            string PrmComp = null;
            ...
            if (aUsers == "external")
            {
                if (!Page.IsPostBack)
                {
                    ...
                    try
                    {
                        ...
                        string cmd = "select * from report_maintance where user_name = '" + UserLogin.UserName + "' and prog_name = 'order_bal_by_job.aspx'  ";
    ...
    protected void submitbutton_click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            Label path = (Label)FormView1.FindControl("vBalFileLabel");
            ...
            if (path.Text == "")
            {
                ...
                Response.Write("<script>window.location.href='order_bal_by_job.aspx'</script>");
            }
        }
        catch
        {
