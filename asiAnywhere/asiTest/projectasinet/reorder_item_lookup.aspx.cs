...
public partial class reorder_item_lookup : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Response.Write(Session["reorder_begin_cust"]);
    }
    ...
    {
        //Response.Redirect("reorder_item_lookup.aspx");
        ObjectDataSource1.SelectParameters["prmAction"].DefaultValue = "All";
    }
}
