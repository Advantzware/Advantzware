...
public partial class cust_list_notes : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (Session["User"] != null)
            {
                ...
                string vPage = "cust_list_notes.aspx";
                string aUsers = null;
                string PrmComp = null;
        ...
        try
        {
            if (Session["spec_cust_list_notes_index"] == null)
            {
                GridView1.SelectedIndex = 0;
                Session["spec_cust_list_notes_date"] = ((Label)GridView1.SelectedRow.FindControl("vcustdatelabel")).Text;  
                //Session["order_list_notes_time"] = GridView1.SelectedRow.Cells[2].Text;
                Session["spec_cust_list_notes_title"] = GridView1.SelectedRow.Cells[3].Text;
                ...
                Session["spec_cust_list_notes_time"] = totaltime;
            }
            GridView1.SelectedIndex = Convert.ToInt32(Session["spec_cust_list_notes_index"]);
        }
        catch { }
    }
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        Session["spec_cust_list_notes_index"] = GridView1.SelectedIndex;
        Session["spec_cust_list_notes_date"] = ((Label)GridView1.SelectedRow.FindControl("vcustdatelabel")).Text;  
        //Session["order_list_notes_time"] = GridView1.SelectedRow.Cells[2].Text;
        Session["spec_cust_list_notes_title"] = GridView1.SelectedRow.Cells[3].Text;
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        ObjectDataSource1.SelectParameters["prmUser"].DefaultValue = UserLogin.UserName;
        ObjectDataSource1.SelectParameters["prmCode"].DefaultValue = txt_dept_spec.Text.Trim();
        ObjectDataSource1.SelectParameters["prmNoteDate"].DefaultValue = txt_note_date.Text.Trim();
        ObjectDataSource1.SelectParameters["prmGroup"].DefaultValue = txt_note_group.Text.Trim();
    }
