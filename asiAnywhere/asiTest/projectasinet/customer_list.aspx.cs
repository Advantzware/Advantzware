...
public partial class customers_list : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        try
        {
            if (Session["customer1_list_index"] == null)
            {
                GridView1.SelectedIndex = 0;

                Session["customer1_list_cust"] = GridView1.SelectedRow.Cells[1].Text;
                Session["customer_list_shipto"] = Session["customer1_list_cust"];
                Session["customer_list_soldto"] = Session["customer1_list_cust"];
                Session["customer1_list_cust_name"] = GridView1.SelectedRow.Cells[2].Text;
            }
        }
        catch
        {
        ...
        try
        {
            if (Session["customer1_list_index"] != null)
            {
                GridView1.SelectedIndex = Convert.ToInt32(Session["customer1_list_index"]);
    ...
    {
        Session["customer1_list_index"] = GridView1.SelectedIndex;
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        ObjectDataSource1.SelectParameters["prmCustname"].DefaultValue = Name_TextBox.Text.Trim();
        ObjectDataSource1.SelectParameters["prmCity"].DefaultValue = City_TextBox.Text.Trim();
        ObjectDataSource1.SelectParameters["prmState"].DefaultValue = State_TextBox.Text.Trim();
        ObjectDataSource1.SelectParameters["prmZip"].DefaultValue = Zip_TextBox.Text.Trim();
        ObjectDataSource1.SelectParameters["prmType"].DefaultValue = Type_TextBox.Text.Trim();
        ObjectDataSource1.SelectParameters["prmSman"].DefaultValue = Salesman_TextBox.Text.Trim();
        ObjectDataSource1.SelectParameters["prmTerr"].DefaultValue = Territory_TextBox.Text.Trim();
