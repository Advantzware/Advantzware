...
public partial class top_attach_invview : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["User"] != null)
        {
            ...
            string vPage = "top_attach_invview.aspx";
            string aUsers = null;
            string PrmComp = null;
    ...
    protected void FormView1_DataBound(object sender, EventArgs e)
    {
        ...
        {
            TextBox inv = (TextBox)FormView1.FindControl("vPoNoTextBox");
           // TextBox fgitem1 = (TextBox)FormView1.FindControl("vFGitemTextBox");
            inv.Text = Convert.ToString(Session["top_attach_invlist_inv"]);
    ...
    protected void UpdateButton_Click(object sender, EventArgs e)
    {
        ...
        TextBox inv = (TextBox)FormView1.FindControl("vPoNoTextBox");
        TextBox type = (TextBox)FormView1.FindControl("type_TextBox");
        ...
        try
        {
            ...
            ObjectDataSource1.SelectParameters["prmUser"].DefaultValue = UserLogin.UserName;
            ObjectDataSource1.SelectParameters["prmPoNo"].DefaultValue = inv.Text.Trim();
            ObjectDataSource1.SelectParameters["prmOpenWith"].DefaultValue = open.Text.Trim();
            ObjectDataSource1.SelectParameters["prmFgitem"].DefaultValue = type.Text.Trim();
        }
        catch { }        
    ...
    protected void btn_delete_click(object sender, EventArgs e)
    {
        ...
        try
        {
            Label inv = (Label)FormView1.FindControl("vPoNoLabel");
    ...
    protected void FormView1_Unload(object sender, EventArgs e)
    {
        try
        {
            ...
            Session["invtop_list_attach_rec_key"] = reckey.Text.Trim();
