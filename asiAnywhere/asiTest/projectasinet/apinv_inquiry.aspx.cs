...
public partial class apinv_inquiry : System.Web.UI.Page
{
   ...
   protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        try
        {
            if (Session["vendor_invoice_index1"] == null)
            {
                ...
                Session["top_list_notes_rec_key"] = Session["vendor_invoice_reckey_rec"];
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        ObjectDataSource1.SelectParameters["prmAction"].DefaultValue = "InqSearch";
