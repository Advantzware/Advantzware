...
public partial class view_gljrn_list : System.Web.UI.Page
{
   ...
   protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            if (Session["User"] != null)
            {
                ...
                if (Convert.ToString(Session["gljrn_list_add_button"]) == "add")
                {
                    FormView1.ChangeMode(FormViewMode.Insert);
                    Session["gljrn_list_add_button"] = null;
                }
                if (Session["view_general_ledger_reckey_index"] != null)
                {
                    try
                    {
                        GridView1.SelectedIndex = Convert.ToInt32(Session["view_general_ledger_reckey_index"]);
                        Session["view_general_ledger_reckey"] = ((Label)GridView1.SelectedRow.FindControl("reclabel")).Text;
   ...
   protected void FormView1_OnDataBound(object sender, EventArgs e)
   {
       ...
       if (FormView1.CurrentMode == FormViewMode.Insert)
       {
           ...
           TextBox date = (TextBox)FormView1.FindControl("dateTextBox");
           ...
           try
           {
               ...
               ds = con.GeneralLedgerlist("AddNew", "", UserLogin.UserName, 0, "", 0, 0, 0, 0, "", "", "", "");

               jrnl.Text = Convert.ToString(ds.Tables[0].Rows[0][0]);               
               date.Text = Convert.ToString(ds.Tables[0].Rows[0][1]);
       ...
       if (FormView1.CurrentMode == FormViewMode.ReadOnly)
       {
           ...
           try
           {
               ...
               Session["general_ledger_reckey_journal"] = reckey.Text.Trim();
   ...
   protected void delete_Button_Click(object sender, EventArgs e)
   {
       ...
       try
       {
           ...
           Response.Write("<script>window.location.href='view_gljrn_list.aspx'</script>");
       }
       catch { }
   ...
   protected void Formview1_InsertCancelButtonClick(object sender, EventArgs e)
   {
       try
       {
           ...
           ledger con = new ledger();
           DataSet ds = new DataSet();
           ds = con.GeneralLedgerlist("DataDelete", "", UserLogin.UserName, 0, "", 0, 0, 0, 0, "", "", "", reckey.Text.Trim());
   ...
   protected void UpdateButton_Click(object sender, EventArgs e)
   {
       ...
       ObjectDataSource1.SelectParameters["prmtr_date"].DefaultValue = date.Text.Trim();
       ObjectDataSource1.SelectParameters["prmperiod"].DefaultValue = period.Text.Trim();
   ...
   protected void InsertButton_Click(object sender, EventArgs e)
   {
       ...
       bool check = val.ValidateGeneralLedgerlist("ValidateAdd", "", UserLogin.UserName, Convert.ToInt32(jrnl.Text.Trim()), date.Text.Trim(), Convert.ToInt32(period.Text.Trim()), 0, 0, 0, "", "", "", "");
            ...
            if (value == "True")
            {
                ...
                ObjectDataSource1.SelectParameters["prmreverse"].DefaultValue = Convert.ToString(chk1.Checked);
                ObjectDataSource1.SelectParameters["prmfrom_revr"].DefaultValue = Convert.ToString(chk2.Checked);
                //ObjectDataSource1.SelectParameters["prmt_deb"].DefaultValue = tdebit.Text.Trim();
                //ObjectDataSource1.SelectParameters["prmt_crd"].DefaultValue = tcrdt.Text.Trim();
                //ObjectDataSource1.SelectParameters["prmt_amt"].DefaultValue = bal.Text.Trim();
    ...
    {
        Response.Redirect("gljrn_list.aspx");
    }
    ...
    {
        Session["view_general_ledger_reckey_index"] = GridView1.SelectedIndex;
        Session["view_general_ledger_reckey"] = ((Label)GridView1.SelectedRow.FindControl("reclabel")).Text;
        Session["top_list_notes_rec_key"] = ((Label)GridView1.SelectedRow.FindControl("reclabel")).Text;
    }
    ...
    protected void AddButton_Formview2_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (value == "True")
            {
                ...
                Session["view_general_ledger_reckey"] = reckey.Text.Trim();
    ...
    protected void FormView2_OnDataBound(object sender, EventArgs e)
    {
        if (FormView2.CurrentMode == FormViewMode.Insert)
        {
            ...
            {               
                ledger con = new ledger();
                DataSet ds = new DataSet();
                ds = con.GeneralLedgerView("AddnewRec", "", UserLogin.UserName, 0, "", Convert.ToString(Session["general_ledger_reckey_journal"]), "", 0, 0, "");
    ...
    protected void deleteButton_FormView2_Click(object sender, EventArgs e)
    {
        ...
        ObjectDataSource3.SelectParameters["prmactdscr"].DefaultValue = Convert.ToString(Session["general_ledger_reckey_journal"]);
        Response.Write("<script>window.location.href='view_gljrn_list.aspx'</script>");
    ...
    protected void InsertCancelButton_Formview2_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ledger con = new ledger();
            DataSet ds = new DataSet();
            ds = con.GeneralLedgerView("DataDelete", "001", UserLogin.UserName, 0, "",Convert.ToString(Session["general_ledger_reckey_journal"]) , "", 0, 0,  reckey.Text.Trim());
        }
        catch { }        
        FormView1.ChangeMode(FormViewMode.ReadOnly);
    }
