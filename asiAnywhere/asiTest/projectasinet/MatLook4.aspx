<%@ Page Language="C#" AutoEventWireup="true" Inherits="MatLookup4" Title="Raw Material Information(Leminate)" Codebehind="MatLook4.aspx.cs" %>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
            ...
            <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.MatLookUp4('<%#DataBinder.Eval(Container,"DataItem.Ino")%>','<%#DataBinder.Eval(Container,"DataItem.Iname")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
         SelectMethod="MatLook" TypeName="LookUp">
            ...
            <asp:Parameter Name="prmUser" Type="String" />
                ...
                <asp:Parameter Name="MatType" Type="String" DefaultValue="L" />
