<%@ Page Language="c#" AutoEventWireup="true" Debug="true" Inherits="view_manchk" Codebehind="view_manchk.aspx.cs" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head id="Head1" runat="server">
   ...
   function bankfocus() {
       var checkno = document.getElementById("FormView1_bankcodeTextBox");
       checkno.focus();
   } 
      ...
      <li class="selected"><asp:LinkButton ID="lnk_viewcustomers" runat="server" OnClick="lnk_viewcustomers_Click" > View Check</asp:LinkButton></li></ul></div>
       ...
       <div>
           <asp:FormView ID="FormView1" runat="server" OnDataBound="FormView1_OnDataBound" DataSourceID="ObjectDataSource1">
               ...
               <td><asp:TextBox ID="vendnoTextBox" Width="100px"   runat="server" Text='<%# Bind("vendno") %>' />
               <a href="#" tabindex="1" onclick="vendorlook(); return false"><asp:Image ID="Image4" runat="server" ImageUrl="images/lookup_icon.gif" /></a></td>
               <td colspan="2"><asp:TextBox ID="vendnameLabel" ForeColor="#ACA899" onfocus="bankfocus()" Width="200" runat="server" Text='<%# Bind("vendname") %>' /></td></tr>
               <tr><td><b>Bank:</b></td>
               <td><asp:TextBox ID="bankcodeTextBox" Width="100px" onfocus= "javascript:focusval(this)" onblur="javascript:blurval(this)" runat="server" Text='<%# Bind("bankcode") %>' />
               ...
               <td colspan="2"><asp:TextBox ID="banknameTextBox" Width="200px" onfocus="checkno()" ForeColor="#ACA899" runat="server" Text='<%# Bind("bankname") %>' /></td></tr>
               ...
               <td><asp:TextBox ID="amtTextBox" onfocus="datefocus()" ForeColor="#ACA899" runat="server" Width="100px" Text='<%# Bind("checkamt") %>' /></td></tr>
                </table>
               ...
               <a href="#" tabindex="1" onclick="vendorlook(); return false"><asp:Image ID="Image4" runat="server" ImageUrl="images/lookup_icon.gif" /></a></td>
               <td colspan="2"><asp:TextBox ID="vendnameLabel" Width="200" ForeColor="#ACA899" onfocus="bankfocus()" runat="server" Text='<%# Bind("vendname") %>' /></td></tr>
               <tr><td><b>Bank:</b></td>
               <td><asp:TextBox ID="bankcodeTextBox" Width="100px" onfocus= "javascript:focusval(this)" onblur="javascript:blurval(this)" runat="server" Text='<%# Bind("bankcode") %>' />
               <a href="#" tabindex="1" onclick="banklookup(); return false"><asp:Image ID="banklookimg" runat="server" ImageUrl="images/lookup_icon.gif" /></a></td>
               <td colspan="2"><asp:TextBox ID="banknameTextBox" Width="200px" onfocus= "javascript:focusval(this)" onblur="javascript:blurval(this)" runat="server" Text='<%# Bind("bankname") %>' /></td></tr>
               <tr><td align="right" style="padding-right:5px"><b>Check No:</b></td>
               <td><asp:TextBox ID="ChecknoTextBox" Width="100px" onfocus= "javascript:focusval(this)" onblur="javascript:blurval(this)" runat="server" Text='<%# Bind("checkno") %>' /></td>
               <td align="right" style="padding-right:5px"><b>Date:</b></td>
               <td><asp:TextBox ID="memodateTextBox" runat="server" Width="100px" onfocus="javascript:preEnter( this, 'yes' );" onblur="javascript:preLeave( this, 'date', '99/99/9999' );" Text='<%# Bind("checkdate") %>' />
               <a href="#" tabindex="1" onClick="showCalendarControl(FormView1_memodateTextBox); return false"><asp:Image ID="Image1" runat="server" ImageUrl="images/lookup_icon.gif" /></a></td>
               <td align="right" style="padding-right:5px"><b>Amount:</b></td>
               <td><asp:TextBox ID="amtTextBox" onfocus= "javascript:focusval(this)" onblur="javascript:blurval(this)" runat="server" Width="100px" Text='<%# Bind("checkamt") %>' /></td></tr>
                </table>
               <br />
               ...
               <tr><td align="right" style="padding-right:5px"><b>Vendor#:</b></td>
               <td><asp:Label ID="vendnoLabel" Width="100px" BackColor="Turquoise" BorderColor="White" BorderStyle="Solid" BorderWidth="1px"  runat="server" Text='<%# Bind("vendno") %>' /></td>
               <td colspan="2"><asp:Label ID="vendnameLabel" BackColor="Turquoise" BorderColor="White" BorderStyle="Solid" BorderWidth="1px"  Width="200" runat="server" Text='<%# Bind("vendname") %>' /></td></tr>
               <tr><td align="right" style="padding-right:5px"><b>Bank:</b></td>
               <td><asp:Label ID="bankLabel" runat="server" BackColor="Turquoise" BorderColor="White" BorderStyle="Solid" BorderWidth="1px"  Width="100px" Text='<%# Bind("bankcode") %>' />
               </td>
               <td colspan="2"><asp:Label ID="Label1" runat="server" BackColor="Turquoise" BorderColor="White" BorderStyle="Solid" BorderWidth="1px"  Width="200px" Text='<%# Bind("bankname") %>' /></td></tr>
               <tr><td align="right" style="padding-right:5px"><b>Check No:</b></td>
               <td><asp:Label ID="memonumLabel" Width="100px" BackColor="Turquoise" BorderColor="White" BorderStyle="Solid" BorderWidth="1px"  runat="server" Text='<%# Bind("checkno") %>' /></td>
               <td align="right" style="padding-right:5px"><b>Date:</b></td>
           ...
           <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                ...
                <SelectParameters>
                   ...
                   <asp:SessionParameter SessionField="manchk_list_reckey_rec" Name="prmReckey" Type="String" />
       ...
       <br />
        ...
        <Columns>
            ...
            <asp:BoundField DataField="amtpaid" HeaderText="Payment" SortExpression="amtpaid" />
        ...
        <AlternatingRowStyle CssClass="GridItemOdd" />
           ...
           <asp:FormView ID="FormView2" runat="server" OnDataBound="FormView2_OnDataBound" DataSourceID="ObjectDataSource3">
               <EditItemTemplate>
                   ...
                   <table>
                   <tr>
                   <td><b>Invoice #:</b></td><td><b>Due Date:</b></td><td><b>Balance Due:</b></td><td><b>Discount:</b></td>
                   <td><b>Payment:</b></td>
                   </tr>
                   <tr><td>
                   ...
                   <td>
                   <asp:TextBox ID="dbamtTextBox" runat="server" onfocus= "javascript:focusval(this)" onblur="javascript:blurval(this)" Width="70px"  MaxLength="11" Text='<%# Bind("amtdisc") %>' />
                   ...
                   <td>
                   <asp:TextBox ID="cramtTextBox" runat="server" onfocus= "javascript:focusval(this)" onblur="javascript:blurval(this)" Width="70px" MaxLength="11" Text='<%# Bind("amtpaid") %>' />
           ...
           <asp:ObjectDataSource ID="ObjectDataSource3" runat="server" 
               OldValuesParameterFormatString="original_{0}" SelectMethod="SelectManSel" 
               TypeName="voucherpay">
               <SelectParameters>                                      
                   <asp:Parameter DefaultValue="View" Name="prmAction" Type="String" />
                   <asp:Parameter Name="prmComp" Type="String" />
                   ...
                   <asp:Parameter Name="prmamtdisc" Type="Decimal" />
                    <asp:SessionParameter SessionField="view_manchk_reckey" Name="prmreckey" Type="String" />
                   <asp:SessionParameter SessionField="manchk_list_reckey_rec"  Name="prmchkno" Type="String" />
                   <asp:Parameter Name="prmapsal" Type="String" /> 
               </SelectParameters>
           </asp:ObjectDataSource>
