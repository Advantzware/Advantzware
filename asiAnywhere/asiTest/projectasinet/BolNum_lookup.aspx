<%@ Page Language="C#" AutoEventWireup="true" Inherits="BolNum_lookup" Title="Invoice LookUp" Codebehind="BolNum_lookup.aspx.cs" %>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
            ...
            <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.BolNumLookup('<%#DataBinder.Eval(Container,"DataItem.ArBol")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="ArBol" HeaderText="BOL#" SortExpression="ArBol" />
                <asp:BoundField DataField="ArBolItem" HeaderText="Item Number" SortExpression="ArBolItem" />
         ...
         SelectMethod="BolNum" TypeName="Order">
            ...
            <asp:Parameter Name="prmUser" Type="String" />
                ...
                <asp:Parameter Name="prmText" Type="String" />
                 <asp:QueryStringParameter Name="prmCustomer" QueryStringField="cust" Type="String" />                             
