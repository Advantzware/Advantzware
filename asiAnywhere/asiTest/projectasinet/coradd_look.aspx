            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.MachinLookup('<%#DataBinder.Eval(Container,"DataItem.vMcode")%>','<%#DataBinder.Eval(Container,"DataItem.vAttDscr")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>     
