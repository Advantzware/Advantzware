<%@ Page Language="C#" AutoEventWireup="true" Inherits="location2_lookup" Codebehind="location_lookup2.aspx.cs" %>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle  Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.Location2LookUp('<%#DataBinder.Eval(Container,"DataItem.vLoc")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField> 
