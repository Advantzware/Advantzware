<%@ Page Language="c#" AutoEventWireup="true" Debug="true" Inherits="view_cash_rcpt" Codebehind="view_cash_rcpt.aspx.cs" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head id="Head1" runat="server">
   ...
   function actfocus() {
       var amt = document.getElementById("FormView2_actnumTextBox");
       amt.focus();
   }
...
function calcu(obj) {    
    var bal = document.getElementById("FormView2_baldueLabel");
    var disc = document.getElementById("FormView2_disTextBox");
    var cshpy = document.getElementById("FormView2_cshpayTextBox");
    var ttlapp = document.getElementById("FormView2_ttlappTextBox");
    var aftrbal = document.getElementById("FormView2_balaftrTextBox");

    if (obj == "1") {
        ttlapp.value = (disc.value);
        cshpy.value = (ttlapp.value - disc.value);        
        aftrbal.value = ((bal.value + disc.value) - cshpy.value);
    }
    else {
        cshpy.value = (ttlapp.value - disc.value);
        aftrbal.value = ((bal.value + disc.value) - cshpy.value);
...
function upcalcu(obj) {
    ...
    if (obj == "1") {
        ttlapp.value = (parseInt(disc.value) + parseInt(cshpy.value));        
        }
        if (obj == "2") {
            cshpy.value = (ttlapp.value - disc.value);            
        }
   ...
   <body>
    <form id="frmList" runat="server"  defaultfocus='Inv_TextBox'>   
      ...
      <TABLE id="tblTop" cellSpacing="3" align="center" border="0" Width="100%">
        <TR>         
          <TD align=left nowrap><font size=+0><b>Cash Receipts&nbsp;</b></font></TD>
          <TD >
      ...
      <li class="selected"><asp:LinkButton ID="lnk_viewcustomers" runat="server" OnClick="lnk_viewcustomers_Click" > View Memos</asp:LinkButton></li></ul></div>
       ...
       <div>
           <asp:FormView ID="FormView1" runat="server" OnDataBound="FormView1_OnDataBound" DataSourceID="ObjectDataSource1">
               ...
               <td><asp:TextBox ID="custnoTextBox" Width="100px" onfocus="bnkfocus()" BackColor="Turquoise" runat="server" Text='<%# Bind("custno") %>' /></td>
               ...
               <td><asp:TextBox ID="bnkcdTextBox" Width="100px" runat="server" Text='<%# Bind("bnkcd") %>' />
               ...
               <td colspan="2"><asp:Label ID="bnknameLabel" BackColor="Turquoise" Width="200" runat="server" Text='<%# Bind("bnknam") %>' /></td></tr>
               <tr><td align="right" style="padding-right:5px"><b>Check No:</b></td>
               <td><asp:TextBox ID="memonumTextBox" Width="100px" runat="server" Text='<%# Bind("chkno") %>' />
               <asp:CompareValidator ID="CompareValidator5" ControlToValidate="memonumTextBox" SetFocusOnError="true" Display="Dynamic" Operator="DataTypeCheck" Type="Double" runat="server" ErrorMessage="Invalid Number"></asp:CompareValidator></td></tr>
               <tr><td align="right" style="padding-right:5px"><b>Check Date:</b></td>
               ...
               <td><asp:TextBox ID="amtTextBox" runat="server" Width="100px" Text='<%# Bind("amt") %>' />
               <asp:CompareValidator ID="CompareValidator1" ControlToValidate="amtTextBox" SetFocusOnError="true" Display="Dynamic" Operator="DataTypeCheck" Type="Double" runat="server" ErrorMessage="Invalid Number"></asp:CompareValidator></td>
               <td align="right" style="padding-right:5px"><b>Not Appliedt:</b></td>
               <td><asp:TextBox ID="notappTextBox" onfocus="chkamt()" ForeColor="#ACA899" runat="server" Width="100px" Text='<%# Bind("notapp") %>' /></td></tr>
               <tr><td align="right" style="padding-right:5px"><b>Currency Code:</b></td>
               <td><asp:TextBox ID="currTextBox" runat="server" onfocus="chkamt()" ForeColor="#ACA899" Width="100px" Text='<%# Bind("cur_cod") %>' /></td>
               <td align="right" style="padding-right:5px"><b>Exchange Rate:</b></td>
               <td><asp:TextBox ID="exchTextBox" onfocus="chkamt()" ForeColor="#ACA899" runat="server" Width="100px" Text='<%# Bind("ex_rate") %>' /></td></tr>
               ...
               <InsertItemTemplate>
                   <fieldset><table class="shade">               
               <tr><td align="right" style="padding-right:5px"><b>Customer:</b></td>
               <td><asp:TextBox ID="custnoTextBox" Width="100px" runat="server" Text='<%# Bind("custno") %>' />
               ...
               <tr><td align="right" style="padding-right:5px"><b>Check No:</b></td>
               <td><asp:TextBox ID="memonumTextBox" Width="100px" runat="server" Text='<%# Bind("chkno") %>' />
               <asp:CompareValidator ID="CompareValidator2" ControlToValidate="memonumTextBox" SetFocusOnError="true" Display="Dynamic" Operator="DataTypeCheck" Type="Double" runat="server" ErrorMessage="Invalid Number"></asp:CompareValidator></td></tr>
               <tr><td align="right" style="padding-right:5px"><b>Check Date:</b></td>
               <td><asp:TextBox ID="memodateTextBox" runat="server" Width="100px" onfocus="javascript:preEnter( this, 'yes' );" onblur="javascript:preLeave( this, 'date', '99/99/9999' );" Text='<%# Bind("chkdt") %>' />
               <a href="#" tabindex="1" onClick="showCalendarControl(FormView1_memodateTextBox); return false"><asp:Image ID="Image1" runat="server" ImageUrl="images/lookup_icon.gif" /></a></td>
               <td align="right" style="padding-right:5px"><b>Check Amount:</b></td>
               ...
               <tr><td align="right" style="padding-right:5px"><b>Bank Code:</b></td>
               <td><asp:Label ID="bnkcdLabel" Width="100px" BackColor="Turquoise" BorderColor="White" BorderStyle="Solid" BorderWidth="1px" runat="server" Text='<%# Bind("bnkcd") %>' /></td>
               <td colspan="2"><asp:Label ID="bnknameLabel" BackColor="Turquoise" BorderColor="White" BorderStyle="Solid" BorderWidth="1px" Width="200" runat="server" Text='<%# Bind("bnknam") %>' /></td></tr>
               <tr><td align="right" style="padding-right:5px"><b>Check No:</b></td>
               <td><asp:Label ID="memonumLabel" Width="100px" BackColor="Turquoise" BorderColor="White" BorderStyle="Solid" BorderWidth="1px"  runat="server" Text='<%# Bind("chkno") %>' /></td></tr>
               <tr><td align="right" style="padding-right:5px"><b>Check Date:</b></td>
               ...
               <td align="right" style="padding-right:5px"><b>Check Amount:</b></td>
               <td><asp:Label ID="amtLabel" runat="server" BackColor="Turquoise" BorderColor="White" BorderStyle="Solid" BorderWidth="1px"  Width="100px" Text='<%# Bind("amt") %>' /></td>
               <td align="right" style="padding-right:5px"><b>Not Appliedt:</b></td>
               <td><asp:Label ID="notappTextBox" runat="server" BackColor="Turquoise" BorderColor="White" BorderStyle="Solid" BorderWidth="1px" Width="100px" Text='<%# Bind("notapp") %>' /></td></tr>
               <tr><td align="right" style="padding-right:5px"><b>Currency Code:</b></td>
           ...
           <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                OldValuesParameterFormatString="original_{0}" SelectMethod="EnterEditCashReceipts" 
                TypeName="account">
                <SelectParameters>
                   ...
                   <asp:Parameter Name="prmnotapp" Type="Decimal" />
                   <asp:Parameter Name="prmout" Type="String" />
                   <asp:SessionParameter SessionField="cash_receipt_cust_reckey_rec" Name="prmReckey" Type="String" />                
                </SelectParameters>
       ...
       <br />
        ...
        <Columns>
            ...
            <asp:BoundField DataField="cashpy" HeaderText="Cash Payment" SortExpression="cashpy" />
            <asp:BoundField DataField="totl_app" HeaderText="Total Applied" SortExpression="totl_app" />  
            <asp:BoundField DataField="balaftr" HeaderText="Bal After Pymt" SortExpression="balaftr" /> 
        ...
        <AlternatingRowStyle CssClass="GridItemOdd" />
           ...
           <asp:FormView ID="FormView2" runat="server" OnDataBound="FormView2_OnDataBound" DataSourceID="ObjectDataSource3">
               <EditItemTemplate>
                   <asp:Panel ID="EditPanel" Width="1100px" Height="120px" DefaultButton="UpdateButton" runat="server" >
                   ...
                   <td>
                   <asp:TextBox ID="disTextBox" runat="server"  onfocus= "javascript:focusval(this)" onblur="javascript:blurval(this)" onchange="upcalcu(1)"  Width="100px" MaxLength="11" Text='<%# Bind("disc") %>' />
                   ...
                   <td>
                   <asp:TextBox ID="cshpayTextBox" runat="server" onfocus="ttlfocus()" onchange="calcu(1)"  ForeColor="#ACA899" Width="100px"  MaxLength="11" Text='<%# Bind("cashpy") %>' />                   
                   </td>
                   <td>
                   <asp:TextBox ID="ttlappTextBox" runat="server" onfocus= "javascript:focusval(this)" onblur="javascript:blurval(this);upcalcu(2);" Width="100px"  MaxLength="11" Text='<%# Bind("totl_app") %>' />
                   ...
                   <td>
                   <asp:TextBox ID="balaftrTextBox" runat="server" onfocus="actfocus()" ForeColor="#ACA899" onchange="upcalcu(3)"  Width="100px"  MaxLength="11" Text='<%# Bind("balaftr") %>' />                   
                   </td>                   
               ...
               <InsertItemTemplate>
                   ...
                   <td><asp:TextBox ID="invdateLabel" runat="server" ForeColor="#ACA899" onfocus="discfocus()" Width="100px" Text='<%# Bind("invdt") %>' /></td>
                   <td>
                   <asp:TextBox ID="baldueLabel" runat="server" ForeColor="#ACA899" onfocus="discfocus()" onkeyup="calcu(1)" MaxLength="25" Width="100px" Text='<%# Bind("baldu") %>' />
                   <asp:CompareValidator ID="CompareValidator4" runat="server" ControlToValidate="baldueLabel" SetFocusOnError="true" Display="dynamic" Operator="dataTypeCheck" Type="Double" ErrorMessage="Invalid Number"></asp:CompareValidator>
                   </td>
                   <td>
                   <asp:TextBox ID="disTextBox" runat="server"  onfocus= "javascript:focusval(this)" onblur="javascript:blurval(this)" onkeyup="calcu(1)"  Width="100px" MaxLength="11" Text='<%# Bind("disc") %>' />
                   <asp:CompareValidator ID="CompareValidator3" runat="server" ControlToValidate="disTextBox" SetFocusOnError="true" Display="dynamic" Operator="dataTypeCheck" Type="Double" ErrorMessage="Invalid Number"></asp:CompareValidator></td>
                   <td>
                   <asp:TextBox ID="cshpayTextBox" runat="server" ForeColor="#ACA899" onkeyup="calcu()" onfocus="ttlfocus(1)" Width="100px"  MaxLength="11" Text='<%# Bind("cashpy") %>' />                   
                   </td>
                   <td>
                   <asp:TextBox ID="ttlappTextBox" runat="server" onfocus= "javascript:focusval(this)" onblur="javascript:blurval(this);calcu(2);" Width="100px"  MaxLength="11" Text='<%# Bind("totl_app") %>' />
                   <asp:CompareValidator ID="CompareValidator5" runat="server" ControlToValidate="ttlappTextBox" SetFocusOnError="true" Display="dynamic" Operator="dataTypeCheck" Type="Double" ErrorMessage="Invalid Number"></asp:CompareValidator>
                   </td>
                   <td>
                   <asp:TextBox ID="balaftrTextBox" runat="server" ForeColor="#ACA899" onkeyup="calcu(1)" onfocus="actfocus()" Width="100px"  MaxLength="11" Text='<%# Bind("balaftr") %>' />                   
                   </td>                   
                   <td><asp:TextBox ID="actnumTextBox" runat="server" onfocus= "javascript:focusval(this)" onblur="javascript:blurval(this)" Width="100px" MaxLength="25" Text='<%# Bind("actno") %>' />
                   <a href="#" tabindex="1" onClick="AccountLook(); return false"><asp:Image ID="Image13" runat="server" ImageUrl="images/lookup_icon.gif" /></a>
                   </td>
           ...
           <asp:ObjectDataSource ID="ObjectDataSource3" runat="server" 
               OldValuesParameterFormatString="original_{0}" SelectMethod="EnterEditCashReceiptView" 
               TypeName="account">
               <SelectParameters>
                   <asp:Parameter DefaultValue="View" Name="prmAction" Type="String" />
                   <asp:Parameter Name="prmComp" Type="String" />
                   ...
                   <asp:Parameter Name="prmcashpy" Type="Decimal" />
                   ...
                   <asp:Parameter Name="prmbalaftr" Type="Decimal" />
                   <asp:SessionParameter SessionField="cash_receipt_cust_reckey_rec" Name="prmOut" Type="String" />
                   <asp:SessionParameter SessionField="view_cash_receipt_cust_reckey" Name="prmReckey"  Type="String" />
               </SelectParameters>
           </asp:ObjectDataSource>
