<%@ Page Language="C#" AutoEventWireup="true" Inherits="title_lookup" Codebehind="title_lookup.aspx.cs" %>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.TitleLookup('<%#DataBinder.Eval(Container,"DataItem.vCode")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>            
