<%@ Page Language="C#" AutoEventWireup="true" Inherits="zipcode_copylookup" Codebehind="zipcode_copylookup.aspx.cs" %>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800">&nbsp;                
                <B>Search for:&nbsp; </B>&nbsp;&nbsp;&nbsp;
                  <asp:dropdownlist id="ddlSearchField" runat="server">
                   <%-- <asp:ListItem Value="Any">Any</asp:ListItem>--%>
                      <asp:ListItem Value="company">ZipCode</asp:ListItem>  
    ...
    <div>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.ZipCodeCopyLookup('<%#DataBinder.Eval(Container,"DataItem.vZip")%>', '<%#DataBinder.Eval(Container,"DataItem.vCity")%>', '<%#DataBinder.Eval(Container,"DataItem.vState")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>            

                 <asp:BoundField DataField="vZip" HeaderText="ZipCode" SortExpression="vZip" />
                <asp:BoundField DataField="vPrefType" HeaderText="Pref Type" SortExpression="vPrefType" />
                <asp:BoundField DataField="vPref" HeaderText="Pref#" SortExpression="vPref" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="SelZipCode" TypeName="LookUp">
            <SelectParameters>               
