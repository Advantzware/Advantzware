...
public partial class order_lookup : System.Web.UI.Page

{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (ddlSearchField.SelectedValue == "est-no" || ddlSearchField.SelectedValue == "ord-no")
        {
    ...
    {
        Response.Redirect("order_lookup.aspx");
    }
