...
public partial class mischarge : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        name.Text = "Misc Charge";
        /*ImageButton misccharge = (ImageButton)Master.FindControl("misccharge");
        misccharge.ImageUrl = "~/img/misccharge1.jpg";*/
    }
    ...
    protected void formview2_ondatabound(object sender, EventArgs e)
    {
        ...
        {
            Label costlabel = (Label)FormView2.FindControl("Ordercostlabel");
            Label coslabel = (Label)FormView2.FindControl("OrderCosLabel");

            if (Session["view_order_entry_pages_with_estimate"] == null)
            {
                costlabel.Visible = false;
                coslabel.Visible = false;
            }
