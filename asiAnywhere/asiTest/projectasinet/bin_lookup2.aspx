            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.Bin2Lookup('<%#DataBinder.Eval(Container,"DataItem.vbinloc")%>','<%#DataBinder.Eval(Container,"DataItem.vjob")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>            
