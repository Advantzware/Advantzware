<%@ Page Language="C#" AutoEventWireup="true" Inherits="corstyle_lookup" Codebehind="corstyle_lookup.aspx.cs" %>
                ...
                <B>Search for:&nbsp; </B>&nbsp;&nbsp;&nbsp;
                  <asp:dropdownlist id="ddlSearchField" runat="server">
                    <%--<asp:ListItem Value="Any">Any</asp:ListItem>--%>
                      <asp:ListItem Value="upc-no">Style </asp:ListItem>  
        ...
        <asp:GridView ID="GridView1"  AllowPaging="True" runat="server" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1"
            ...
            <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.CorStyleLookup('<%#DataBinder.Eval(Container,"DataItem.vStyle")%>','<%#DataBinder.Eval(Container,"DataItem.vStyleDscr")%>','<%#DataBinder.Eval(Container,"DataItem.vboard")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="vStyle" HeaderText="Style" SortExpression="vStyle" />
                <asp:BoundField DataField="vStyleDscr" HeaderText="Style Dscr" SortExpression="vStyleDscr" />
                
            </Columns>
        </asp:GridView>
        <input type="button" name="close" class="buttonM" id="close" value="Close" onclick="javascript:window.close()" />
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="Selectstyle" TypeName="Corrugated">
            <SelectParameters>               
                <asp:Parameter Name="prmAction" Type="String"  />
                <asp:Parameter Name="prmUser"  Type="String" />
                <asp:Parameter Name="prmCondition" Type="String" />
                <asp:Parameter Name="prmText" Type="String" />
                <asp:QueryStringParameter QueryStringField="style" Name="prmInd" Type="String" />
            </SelectParameters>
