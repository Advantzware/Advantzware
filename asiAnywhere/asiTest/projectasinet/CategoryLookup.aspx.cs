...
public partial class CategoryLookup : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        txtSearchValue.Attributes.Add("onkeypress", "return clickButton(event,'" + btnSearch.ClientID + "')");
        if (!Page.IsPostBack)
        {
    ...
    {
        Response.Redirect("CategoryLookup.aspx");
    }
}
