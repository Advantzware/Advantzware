...
public partial class reprnt_tag_look : System.Web.UI.Page
{
    ...
    {        
        ...
        if (!Page.IsPostBack)
        {
            ObjectDataSource1.SelectParameters["prmAction"].DefaultValue = "loadtg";    
    ...
    {
        ObjectDataSource1.SelectParameters["prmAction"].DefaultValue = "tagSearch";
