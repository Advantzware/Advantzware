<%@ Page Language="C#" AutoEventWireup="true" Inherits="bill_customer_lookup" Codebehind="bill_customer_lookup.aspx.cs" %>
    ...
    <div>
     <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
            ...
            <asp:TemplateField>
                ...
                <asp:BoundField DataField="LastShip" HeaderText="LastShip" HtmlEncode="false" DataFormatString="{0:MM/dd/yyyy}" SortExpression="LastShip" />
