...
public partial class MasterPage : System.Web.UI.MasterPage
{
    ...
    protected void lnk_viewitem_Click(object sender, EventArgs e)
    {
        ...
        //string swhere = Request.Form["radio1"];
        //if (swhere != null && swhere != string.Empty)
        if (Session["order"] != null && Session["item"] != null)
        {
            //Response.Write(Session["order"]);
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (fname == "order_inquiry_aspx")
        {
            
            librowseorder.Attributes.Add("class", "selected");
        }
        else if (fname == "vieworder_aspx")
        {
        ...
        {
            lijobprod.Attributes.Add("class", "selected");
        }
        ...
        {
            liinvoice.Attributes.Add("class", "selected");
        }
        else
        {
             ...
             {                 
                 ...
                 if (ss5.Contains(UserLogin.UserName) || ss5.Contains("*"))
                 {
                    // jobprod.Visible = Convert.ToBoolean(dr["chk5"].ToString());
                     ...
                     lijobprod.Attributes.Add("style", "display:none");
                 }
    ...
    protected void lnk_ordertotal_Click(object sender, EventArgs e)
    {
        if (Session["order"] != null)
        {
            ...
            //Response.Write(Session["jobprod"]);
    ...
    protected void lnk_vieworder2_Click(object sender, EventArgs e)
    {

        if (Session["order_entry"] != null)
        {
            Session["vieworder_entry"] = Session["order_entry"];
            Response.Redirect("view_order_entry.aspx");
        }
        else
        {
            Response.Write("<script> alert('Please Select a Record')</script>");
    ...
    protected void lnk_listitem2_Click(object sender, EventArgs e)
    {
        if (Session["order_entry"] != null)
        {
            Session["order_entry"] = Session["order_entry"];

            Response.Redirect("Item_Entry.aspx");
        }
        else
        {
            Response.Write("<script> alert('Please Select a Record')</script>");
    ...
    protected void lnk_viewitem2_Click(object sender, EventArgs e)
    {
        if (Session["view_line"] != null)
        {
            Response.Redirect("view_item_entry.aspx");
        }
        else
        {
            Response.Write("<script> alert('Please Select a Record')</script>");
    ...
    protected void lnk_brwsorder2_Click(object sender, EventArgs e)
    {
        Response.Redirect("order_entry.aspx");
    }
    protected void brwsorder2_Click(object sender, ImageClickEventArgs e)
    {
        Response.Redirect("order_entry.aspx");
    }
    protected void vieworder2_Click(object sender, ImageClickEventArgs e)
    {
        lnk_vieworder2_Click(sender, e);
    }
    protected void listitem2_Click(object sender, ImageClickEventArgs e)
    {
        lnk_listitem2_Click(sender, e);
    }
    protected void viewitem2_Click(object sender, ImageClickEventArgs e)
    {
        lnk_viewitem2_Click(sender, e);
    }
