<%@ Page Language="C#" AutoEventWireup="true" Inherits="FgItmOrd_Lookup" Title="FgItem LookUp" Codebehind="FgItmOrd_Lookup.aspx.cs" %>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800">&nbsp;                
                <B>Search for:&nbsp; </B>&nbsp;&nbsp;&nbsp;
                  <asp:dropdownlist id="ddlSearchField" runat="server">                    
                      <asp:ListItem Value="ino">ITEM NO#</asp:ListItem>                        
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
            ...
            <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.FGOrdLookup('<%#DataBinder.Eval(Container,"DataItem.ino")%>','<%#DataBinder.Eval(Container,"DataItem.qty")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="CustomerItemLookup" TypeName="release">
            <SelectParameters>
            <asp:Parameter DefaultValue="Select" Name="prmAction" Type="String" />
                ...
                <asp:QueryStringParameter QueryStringField="fgord" Name="prmord" Type="Int32" />
            </SelectParameters>
