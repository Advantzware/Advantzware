...
public partial class corr_print_gsm2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        Label wherehousemark = (Label)FormView1.FindControl("ld_gsa_warTextBox");
        TextBox brokencomm = (TextBox)FormView1.FindControl("ld_gsa_fmTextBox");
        Label unitcount = (Label)FormView1.FindControl("ld_gsa_war_u_cTextBox");
        Label palletcount = (Label)FormView1.FindControl("ld_gsa_war_cntTextBox");
        Label totalunit = (Label)FormView1.FindControl("ld_gsa_war_uniTextBox");
        ...
        ObjectDataSource1.SelectParameters["prmVendor"].DefaultValue = Convert.ToString(Session["estimate_analysis1_vendor_no"]);
        ObjectDataSource1.SelectParameters["prmGsaMat"].DefaultValue = Convert.ToString(Session["estimate1_analysis_gsa_mat"]);
        ObjectDataSource1.SelectParameters["prmGsaLab"].DefaultValue = Convert.ToString(Session["estimate1_analysis_gsa_lab"]);
        ObjectDataSource1.SelectParameters["prmGsaWar"].DefaultValue = Convert.ToString(Session["estimate1_analysis_gsa_war"]);
        ObjectDataSource1.SelectParameters["prmGsaFm"].DefaultValue = Convert.ToString(Session["estimate1_analysis_gsa_fm"]);
        ObjectDataSource1.SelectParameters["prmGsaMonth"].DefaultValue = Convert.ToString(Session["estimate1_analysis_gsa_month"]);
    ...
    protected void updatebutton_click(object sender, EventArgs e)
    {
         ...
         ObjectDataSource1.SelectParameters["prmTotPall"].DefaultValue = totalpallet.Text.Trim();
         ObjectDataSource1.SelectParameters["prmVendor"].DefaultValue = Convert.ToString(Session["estimate_analysis1_vendor_no"]);
         ObjectDataSource1.SelectParameters["prmGsaMat"].DefaultValue = Convert.ToString(Session["estimate2_analysis_gsa_mat"]);
         ObjectDataSource1.SelectParameters["prmGsaLab"].DefaultValue = Convert.ToString(Session["estimate2_analysis_gsa_lab"]);
         ObjectDataSource1.SelectParameters["prmGsaWar"].DefaultValue = Convert.ToString(Session["estimate2_analysis_gsa_war"]);
         ObjectDataSource1.SelectParameters["prmGsaFm"].DefaultValue = Convert.ToString(Session["estimate2_analysis_gsa_fm"]);
         ObjectDataSource1.SelectParameters["prmGsaMonth"].DefaultValue = Convert.ToString(Session["estimate2_analysis_gsa_month"]);
