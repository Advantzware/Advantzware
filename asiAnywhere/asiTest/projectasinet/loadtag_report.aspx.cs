...
public partial class loadtag_report : System.Web.UI.Page
{
    ...
    protected void open_popup()
    {
        ...
        RegisterStartupScript("str1", "<script>window.open('loadtaglook.aspx?tagno=" + tanvalue.Trim() + "','ItemWindow','width=860,height=520, scrollbars=1, toolbars=1,statusbar=1,resizeable=1');</script>");
    }
