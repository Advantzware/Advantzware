<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="gltrial_balance" Codebehind="gltrial_balance.aspx.cs" %>
...
//    }
    ...
    function vendtext() {
        var memo = document.getElementById("begactTextBox");
        memo.focus();
    }
    function subtext() {
        var memo = document.getElementById("begsubTextBox");
        memo.focus();
    }
    function periodtext() {
    ...
    <form id="frmList" runat="server"  defaultfocus='postdateTextBox'>   
      ...
      <TABLE id="tblTop" cellSpacing="3" align="center" border="0" Width="100%">
        <TR>
          ...
          <TD align=left nowrap><font size=+0><b>Trial Balance&nbsp;</b></font></TD>
      ...
      <b>Transaction Date:</b></td>
            <td><asp:TextBox ID="postdateTextBox" onfocus="javascript:preEnter( this, 'yes' );" onblur="javascript:preLeave( this, 'date', '99/99/9999' );"  runat="server" Width="100px"></asp:TextBox>
      ...
      <b>Period:</b></td>
            ...
            <tr><td colspan="2" align="right" style="padding-right: 5px"><b>Begining Acct:</b></td>
            <td><asp:TextBox  ID="begactTextBox" Width="100px" runat="server"></asp:TextBox> 
            <a href="#" tabindex="1" onClick="AccountLook(1); return false"><asp:Image ID="Image3" runat="server" ImageUrl="images/lookup_icon.gif" /></a>                 
            </td></tr>
            <tr><td colspan="2" align="right" style="padding-right: 5px"><b>Ending Acct:</b></td>
            <td><asp:TextBox  ID="endactTextBox" Width="100px" runat="server"></asp:TextBox> 
            <a href="#" tabindex="1" onClick="AccountLook(2); return false"><asp:Image ID="Image1" runat="server" ImageUrl="images/lookup_icon.gif" /></a>                 
            </td></tr>
            <tr><td colspan="2" align="right" style="padding-right: 5px"><b>Suppress Zero Balance?</b></td>
            <td><asp:CheckBox ID="CheckBox1" runat="server"></asp:CheckBox>
            </td></tr>
            </table></td></tr>
            <tr></tr><tr></tr>
            
            
            <tr><td style="width:420px;" align="right" >      
            <fieldset style="width:500px; color:Blue">
            <legend>SORT OPTIONS:</legend>
            <table><tr><td>
            <tr><td colspan="2" align="right" style="padding-right: 5px"><b>Sort by Sub Account Level?</b></td>
            <td><asp:CheckBox ID="CheckBox2" runat="server"></asp:CheckBox>
            </td></tr>
            <tr><td colspan="2" align="right" style="padding-right: 5px"><b>Sub Account Level:</b></td>
            <td><asp:TextBox  ID="subactTextBox" onfocus="subtext()" BackColor="Turquoise"  Width="20px" runat="server"></asp:TextBox>                  
            </td></tr>
            <tr><td colspan="2" align="right" style="padding-right: 5px"><b>Begining Subacct:</b></td>
            <td><asp:TextBox  ID="begsubTextBox" Width="100px" runat="server"></asp:TextBox>                    
            <asp:CompareValidator ID="CompareValidator2" runat="server" ControlToValidate="begsubTextBox" SetFocusOnError="true" Display="dynamic" Operator="dataTypeCheck" Type="Integer" ErrorMessage="Number Only"></asp:CompareValidator> </td>
            <td></td><td colspan="2" align="right" style="padding-right: 5px"><b>Ending Subacct:</b></td>
            <td><asp:TextBox  ID="endsubTextBox" Width="100px" runat="server"></asp:TextBox>
            <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="endsubTextBox" SetFocusOnError="true" Display="dynamic" Operator="dataTypeCheck" Type="Integer" ErrorMessage="Number Only"></asp:CompareValidator>         
            </td></tr>          
        ...
        <tr><td colspan="2" align="left" style="padding-left:10px">
         ...
         <b>Output to?  <asp:RadioButtonList ID="RadioButtonList_out"  RepeatLayout="Flow"  CellSpacing="1" RepeatColumns="5" Font-Bold ="true" runat="server">
          ...
          <asp:FormView ID="FormView1" Visible="false"  runat="server" 
              ...
              <ItemTemplate>
                  tribal:
                  <asp:Label ID="tribalLabel" runat="server" 
                      Text='<%# Bind("tribal") %>'></asp:Label><br />    
                  extra:
                  <asp:Label ID="extraLabel" runat="server" 
                      Text='<%# Bind("extra") %>'></asp:Label><br />                  
                  
              </ItemTemplate>                            
          </asp:FormView>
          
          <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
              SelectMethod="GLTrialBalance" TypeName="ledger">
              <SelectParameters>
                  ...
                  <asp:Parameter Name="prmbegsub" Type="Int32" />
                  <asp:Parameter Name="prmendact" Type="String" /> 
                  <asp:Parameter Name="prmendsub" Type="Int32" />
                  <asp:Parameter Name="prmZerobal" Type="String" />
                  <asp:Parameter Name="prmsortsub" Type="String" />
                  <asp:Parameter Name="prmactlevl" Type="Int32" />                                   
