<%@ Page Language="C#" MasterPageFile="~/MasterPageFolding.master" AutoEventWireup="true" Inherits="fold_miscsub" Title="Folding Misc/Sub" Codebehind="fold_miscsub.aspx.cs" %>
...
window.onload = setfocus;
    ...
    function setfocus()
    {
        ...
        {
            var b1 = document.getElementById("ctl00_ContentPlaceHolder1_FormView_MiscSub_vB1TextBox");
            b1.focus();
        }
    ...
    function Itemlook9()
    {  
        var NewWindow = window.open("item_lookup9.aspx","ItemLookupWindow","width=500,height=500,scrollbars=1,toolbars=1,statusbar=1,resizeable=1");
    }

    function ItemLookup9(ReturnObj1, ReturnObj2)
    { 
    ...
    function Itemlook10()
    {  
        var NewWindow = window.open("item_lookup10.aspx","ItemLookupWindow","width=500,height=500,scrollbars=1,toolbars=1,statusbar=1,resizeable=1");
    }

    function ItemLookup10(ReturnObj1, ReturnObj2)
    { 
    ...
    function Itemlook11()
    {  
        var NewWindow = window.open("item_lookup11.aspx","ItemLookupWindow","width=500,height=500,scrollbars=1,toolbars=1,statusbar=1,resizeable=1");
    }

    function ItemLookup11(ReturnObj1, ReturnObj2)
    { 
    ...
    function Itemlook12()
    {  
        var NewWindow = window.open("item_lookup12.aspx","ItemLookupWindow","width=500,height=500,scrollbars=1,toolbars=1,statusbar=1,resizeable=1");
    }

    function ItemLookup12(ReturnObj1, ReturnObj2)
    { 
    ...
    function Itemlook13()
    {  
        var NewWindow = window.open("item_lookup13.aspx","ItemLookupWindow","width=500,height=500,scrollbars=1,toolbars=1,statusbar=1,resizeable=1");
    }

    function ItemLookup13(ReturnObj1, ReturnObj2)
    { 
    ...
    function Itemlook14()
    {  
        var NewWindow = window.open("item_lookup14.aspx","ItemLookupWindow","width=500,height=500,scrollbars=1,toolbars=1,statusbar=1,resizeable=1");
    }

    function ItemLookup14(ReturnObj1, ReturnObj2)
    { 
    ...
    function Itemlook15()
    {  
        var NewWindow = window.open("item_lookup15.aspx","ItemLookupWindow","width=500,height=500,scrollbars=1,toolbars=1,statusbar=1,resizeable=1");
    }

    function ItemLookup15(ReturnObj1, ReturnObj2)
    { 
    ...
    function Itemlook16()
    {  
        var NewWindow = window.open("item_lookup16.aspx","ItemLookupWindow","width=500,height=500,scrollbars=1,toolbars=1,statusbar=1,resizeable=1");
    }

    function ItemLookup16(ReturnObj1, ReturnObj2)
    { 
                    ...
                    <table>
                        ...
                        <tr>
                            <td nowrap><b><asp:TextBox ID="vItem1TextBox" onblur="item1()" runat="server" Text='<%# Bind("vItem1") %>'></asp:TextBox>
                                            <a href="#" tabindex="1" onclick="Itemlook9(); return false"><asp:Image ID="Image9" runat="server" ImageUrl="images/lookup_icon.gif" /></a>
                            </b></td>
                        ...
                        <tr>
                            <td nowrap><b><asp:TextBox ID="vItem2TextBox" onblur="item2()" runat="server" Text='<%# Bind("vItem2") %>'></asp:TextBox>
                                        <a href="#" tabindex="1" onclick="Itemlook10(); return false"><asp:Image ID="Image10" runat="server" ImageUrl="images/lookup_icon.gif" /></a>
                            </b></td>
                        ...
                        <tr>
                            <td nowrap><b><asp:TextBox ID="vItem3TextBox" onblur="item3()" runat="server" Text='<%# Bind("vItem3") %>'></asp:TextBox>
                                        <a href="#" tabindex="1" onclick="Itemlook11(); return false"><asp:Image ID="Image11" runat="server" ImageUrl="images/lookup_icon.gif" /></a>
                            </b></td>
                        ...
                        <tr>
                            <td nowrap><b><asp:TextBox ID="vItem4TextBox" onblur="item4()" runat="server" Text='<%# Bind("vItem4") %>'></asp:TextBox>
                                        <a href="#" tabindex="1" onclick="Itemlook12(); return false"><asp:Image ID="Image12" runat="server" ImageUrl="images/lookup_icon.gif" /></a>
                            </b></td>
                        ...
                        <tr>
                            <td nowrap><b><asp:TextBox ID="vItem5TextBox" onblur="item5()" runat="server" Text='<%# Bind("vItem5") %>'></asp:TextBox>
                                          <a href="#" tabindex="1" onclick="Itemlook13(); return false"><asp:Image ID="Image13" runat="server" ImageUrl="images/lookup_icon.gif" /></a>
                            </b></td>
                        ...
                        <tr>
                            <td nowrap><b><asp:TextBox ID="vItem6TextBox" onblur="item6()" runat="server" Text='<%# Bind("vItem6") %>'></asp:TextBox>
                                        <a href="#" tabindex="1" onclick="Itemlook14(); return false"><asp:Image ID="Image14" runat="server" ImageUrl="images/lookup_icon.gif" /></a>
                            </b></td>
                        ...
                        <tr>
                            <td nowrap><b><asp:TextBox ID="vItem7TextBox" onblur="item7()" runat="server" Text='<%# Bind("vItem7") %>'></asp:TextBox>
                                        <a href="#" tabindex="1" onclick="Itemlook15(); return false"><asp:Image ID="Image15" runat="server" ImageUrl="images/lookup_icon.gif" /></a>
                            </b></td>
                        ...
                        <tr>
                            <td nowrap><b><asp:TextBox ID="vItem8TextBox" onblur="item8()" runat="server" Text='<%# Bind("vItem8") %>'></asp:TextBox>
                                        <a href="#" tabindex="1" onclick="Itemlook16(); return false"><asp:Image ID="Image16" runat="server" ImageUrl="images/lookup_icon.gif" /></a>
                            </b></td>
    ...
    <asp:ObjectDataSource ID="MiscSub_ObjectDataSource" runat="server" OldValuesParameterFormatString="original_{0}"
        SelectMethod="SelectFoldMiscSub" TypeName="Corrugated">
        <SelectParameters>
