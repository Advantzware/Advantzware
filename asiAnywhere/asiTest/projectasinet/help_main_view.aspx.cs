...
public partial class help_main_view : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (Session["help_main_list_code"] == null)
        {
    ...
    protected void FormView1_DataBound(object sender, EventArgs e)
    {
        ...
        if (FormView1.CurrentMode == FormViewMode.Edit)
        {
            ...
            Label flage = (Label)FormView1.FindControl("flagsLabel");
            CheckBox chk1 = (CheckBox)FormView1.FindControl("CheckBox1");
            if (flage.Text == "Yes" || flage.Text == "yes" || flage.Text == "True" || flage.Text == "true")
            {
                chk1.Checked = true;
            }
            chk1.Focus();
