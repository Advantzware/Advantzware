...
public partial class toporder_view_notes : System.Web.UI.Page
{
    protected void Page_PreRender(object sender, EventArgs e)
    {        
        Session["order_list_notes_title"] = Session["order_list_notes_newtitle"];
    }
    ...
    {
        Response.Redirect("toporder_view_notes.aspx");
    }
    ...
    protected void UpdateButton_Click(object sender, EventArgs e)
    {
        ...
        ObjectDataSource1.SelectParameters["prmUser"].DefaultValue = UserLogin.UserName;
        ObjectDataSource1.SelectParameters["prmRecKey"].DefaultValue = Convert.ToString(Session["order_rec_key"]);
        ...
        ObjectDataSource1.SelectParameters["prmNoteTitle"].DefaultValue = Convert.ToString(Session["order_list_notes_title"]);
    ...
    protected void InsertButton_Click(object sender, EventArgs e)
    {
        ...
        Session["order_list_notes_time"] = time.Text.Trim();
        Session["order_list_notes_date"] = date.Text.Trim();
    ...
    protected void btn_delete_click(object sender, EventArgs e)
    {
        ...
        Session["order_list_notes_time"] = totalval;
        Session["order_list_notes_date"] = date.Text.Trim();
        Session["order_list_notes_title"] = title.Text.Trim();
        UserClass UserLogin = (UserClass)Session["User"];
        ...
        ObjectDataSource1.SelectParameters["prmUser"].DefaultValue = UserLogin.UserName;
        ObjectDataSource1.SelectParameters["prmRecKey"].DefaultValue = Convert.ToString(Session["order_rec_key"]);
        ObjectDataSource1.SelectParameters["prmNoteDate"].DefaultValue = Convert.ToString(Session["order_list_notes_date"]);
        ObjectDataSource1.SelectParameters["prmNoteTime"].DefaultValue = Convert.ToString(Session["order_list_notes_time"]);
        ObjectDataSource1.SelectParameters["prmNoteTitle"].DefaultValue = Convert.ToString(Session["order_list_notes_title"]);
    }
    protected void FormView1_Unload(object sender, EventArgs e)
    {
        ...
        {
            Label title = (Label)FormView1.FindControl("vNoteTitleLabel");
            Session["order_list_notes_newtitle"] = title.Text.Trim();
        }
        catch { }
    }
