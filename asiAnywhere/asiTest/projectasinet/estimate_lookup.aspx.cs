...
public partial class estimate_lookup : System.Web.UI.Page
{
    ...
    {
        string custval = Request.QueryString["customer_val"];
        Response.Redirect("estimate_lookup.aspx?customer_val=" + custval);
    }
}
