...
public partial class signatures_bill_of_ipad : System.Web.UI.Page
{
    ...
    protected void submitbutton_click(object sender, EventArgs e)
    {
        ...
        UserClass.CheckLogin(Page);
        UserClass UserLogin = (UserClass)Session["User"];
        string imagecontrol = ctlMySignature.SignatureFile;
        //string str1 = Path.GetFileName(imagecontrol);
        // string str2 = "Signatures/" + Convert.ToString(Session["signaturefile_image_name"]);
            ...
            if (vpath.Text != "")
            {
                ...
                if (path2 != "")
                {
                    if (!Request.Browser.Browser.Contains("Safari"))
                        ...
                        Response.Redirect("signatures_bill_of_lad.aspx");
                }
            }
            else
            {
        ...
        {
            Response.Write("<script>window.location.href='signatures_bill_of_lad.aspx'</script>");
        }
    ...
    protected void bol_textbox_change(object sender, EventArgs e)
    {
        ...
        if (TextBox3.Text != "")
        {
            try
            {
                ...
                bolno = bolno + Convert.ToString(System.DateTime.Now.Year) + Convert.ToString(System.DateTime.Now.Month) + Convert.ToString(System.DateTime.Now.Day) + Convert.ToString(DateTime.Now.Hour) + Convert.ToString(DateTime.Now.Minute) + Convert.ToString(DateTime.Now.Second) + ".jpeg";

                Session["signaturefile_image_name"] = bolno;
