...
public partial class apaco_byvend : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (Session["User"] != null)
        {
            ...
            string vPage = "apaco_byvend.aspx";
            string aUsers = null;
            string PrmComp = null;
        ...
        if (!Page.IsPostBack)
        {
            ...
            try
            {
                ...
                string cmd = "select * from report_maintance where user_name = '" + UserLogin.UserName + "' and prog_name = 'apaco_byvend.aspx' ";
                ...
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    ...
                    begaccTextBox.Text = dr["field5"].ToString();
                    endaccTextBox.Text = dr["field6"].ToString();
            ...
            if (endaccTextBox.Text == "")
                endaccTextBox.Text = "zzzzzzzzzzzzzzzzzzzz";
    ...
    protected void submitbutton_click(object sender, EventArgs e)
    {
        ...
        ObjectDataSource1.SelectParameters["prmUser"].DefaultValue = UserLogin.UserName;
        ObjectDataSource1.SelectParameters["prmvendacc"].DefaultValue = "vendacc";
        ...
        try
        {
            ...
            {
                SqlCommand cmd_insert = new SqlCommand("insert into report_maintance (user_name, prog_name , field1, field2, field3, field4,field5,field6) values ('" + UserLogin.UserName + "','apaco_byvend.aspx' , '" + begvendTextBox.Text.Trim() + "', '" + endvendTextBox.Text.Trim() + "','" + begdateTextBox.Text.Trim() + "','" + enddateTextBox.Text.Trim() + "','" + begaccTextBox.Text.Trim() + "','" + endaccTextBox.Text.Trim() + "')", conn);
                cmd_insert.ExecuteNonQuery();
            }
            else
            {
                SqlCommand cmd_update = new SqlCommand("update report_maintance set field1 = '" + begvendTextBox.Text.Trim() + "', field2 = '" + endvendTextBox.Text.Trim() + "', field3 = '" + begdateTextBox.Text.Trim() + "', field4 = '" + enddateTextBox.Text.Trim() + "',field5 = '" + begaccTextBox.Text.Trim() + "', field6 = '" + endaccTextBox.Text.Trim() + "' where user_name = '" + UserLogin.UserName + "' and prog_name =  'apaco_byvend.aspx' ", conn);
        ...
        try
        {
            ...
            Label vpath = (Label)FormView1.FindControl("vendaccLabel");
            ...
            if (vpath.Text == "")
            {
                ...
                Response.Write("<script>window.location.href='apaco_byvend.aspx'</script>");
            }
        }
        catch { }
