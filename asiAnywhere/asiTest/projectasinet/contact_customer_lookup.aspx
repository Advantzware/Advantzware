<%@ Page Language="C#" AutoEventWireup="true" Inherits="contact_customer_lookup" Title="Customer Lookup" Codebehind="contact_customer_lookup.aspx.cs" %>
            ...
            <Columns > 
              <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.ContactCustomerLookup('<%#DataBinder.Eval(Container,"DataItem.Customer")%>','<%#DataBinder.Eval(Container,"DataItem.Name")%>','<%#DataBinder.Eval(Container,"DataItem.Address1")%>','<%#DataBinder.Eval(Container,"DataItem.Address2")%>','<%#DataBinder.Eval(Container,"DataItem.city")%>','<%#DataBinder.Eval(Container,"DataItem.state")%>','<%#DataBinder.Eval(Container,"DataItem.zip")%>','<%#DataBinder.Eval(Container,"DataItem.sman")%>','<%#DataBinder.Eval(Container,"DataItem.country")%>','<%#DataBinder.Eval(Container,"DataItem.county")%>','<%#DataBinder.Eval(Container,"DataItem.terr")%>','<%#DataBinder.Eval(Container,"DataItem.carrier")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
