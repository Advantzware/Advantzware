<%@ Page Language="C#" AutoEventWireup="true" Inherits="cust_po_lookup2" Codebehind="cust_po_lookup2.aspx.cs" %>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick ="javascript:top.opener.window.CustPoLookup2('<%#DataBinder.Eval(Container,"DataItem.vpono")%>','<%#DataBinder.Eval(Container,"DataItem.vvendor")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>            
