...
public partial class Debit_memo : System.Web.UI.Page
{
   ...
   protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        try
        {
            if (Session["debit_memo_index1"] == null)
            {
                GridView1.SelectedIndex = 0;
                               
                Session["debit_memo_reckey_rec"] = ((Label)GridView1.SelectedRow.FindControl("reclabel")).Text;
        ...
        try
        {
            if (Session["debit_memo_index1"] != null)
            {
                GridView1.SelectedIndex = Convert.ToInt32(Session["debit_memo_index1"]);
    ...
    {
        Session["debit_memo_index1"] = GridView1.SelectedIndex;
    ...
    {
        Session["debit_memo_vendor"] = vendor_TextBox.Text;
        Session["debit_memo_check_no"] = checkno_TextBox.Text.Trim();
        Session["debit_memo_bank_code"] = bankcode_TextBox.Text.Trim();
        ...
        Session["debit_memo_index1"] = null;
    }
     ...
     protected void img_btn_exit_click(object sender, EventArgs e)
    {
     ...
     {
         Session["debit_memo_add_button"] = "add";
         Response.Redirect("view_debit_memo.aspx");
