<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdderLook.aspx.cs" Inherits="AdderLookup" Title="Raw Material Information(Window)"%>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
            ...
            <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.Adder4LookUp('<%#DataBinder.Eval(Container,"DataItem.AddIno")%>','<%#DataBinder.Eval(Container,"DataItem.AddIname")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
