 <%@ Page Language="C#" AutoEventWireup="true" Inherits="reorder_item_lookup2" Title="ReOrder Item LookUp" Codebehind="reorder_item_lookup2.aspx.cs" %>
    ...
    <div>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.ReLookup2('<%#DataBinder.Eval(Container,"DataItem.vItemno")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            ...
            <asp:Parameter Name="prmUser" Type="String" />
                ...
                <asp:QueryStringParameter Name="prmCust" QueryStringField="item1" 
                    Type="String" />
            </SelectParameters>
