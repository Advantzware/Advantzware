<%@ Page Language="C#" AutoEventWireup="true" Inherits="MatLookup" Title="Raw Material Information(Special Material)" Codebehind="MatLook.aspx.cs" %>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
            ...
            <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.Item1LookUp('<%#DataBinder.Eval(Container,"DataItem.Ino")%>','<%#DataBinder.Eval(Container,"DataItem.Iname")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
