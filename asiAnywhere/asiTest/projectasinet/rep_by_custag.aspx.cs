...
public partial class rep_custag : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            try
            {
                ...
                string cmd = "select * from report_maintance where user_name = '" + UserLogin.UserName + "' and prog_name = 'rep_by_custag.aspx' ";
    ...
    protected void SubmitButton_Click(object sender, EventArgs e)
    {
        ...
        ObjectDataSource1.SelectParameters["prmAction"].DefaultValue = "custag";
        ...
        try
        {
            ...
            {
                SqlCommand cmd_insert = new SqlCommand("insert into report_maintance (user_name, prog_name , field1, field2, field3, field4, field5, field6, chk_field1, chk_field2) values ('" + UserLogin.UserName + "','rep_by_custag.aspx' , '" + begincust_TextBox.Text.Trim() + "', '" + endcust_TextBox.Text.Trim() + "', '" + custpo_TextBox.Text.Trim() + "', '" + endcustpo_TextBox.Text.Trim() + "', '" + besmanTextBox.Text.Trim() + "', '" + endsmanTextBox.Text.Trim() + "', '" + HiddenField1.Value + "', '" + HiddenField2.Value + "')", conn);
                cmd_insert.ExecuteNonQuery();
            }
            else
            {
                SqlCommand cmd_update = new SqlCommand("update report_maintance set field1 = '" + begincust_TextBox.Text.Trim() + "', field2 = '" + endcust_TextBox.Text.Trim() + "', field3 = '" + custpo_TextBox.Text.Trim() + "', field4 = '" + endcustpo_TextBox.Text.Trim() + "', field5 = '" + besmanTextBox.Text.Trim() + "', field6 = '" + endsmanTextBox.Text.Trim() + "', chk_field1 = '" + HiddenField1.Value + "', chk_field2 = '" + HiddenField2.Value + "' where user_name = '" + UserLogin.UserName + "' and prog_name =  'rep_by_custag.aspx' ", conn);
        ...
        try
        {
            ...
            if (path.Text == "")
            {
                ...
                Response.Write("<script>window.location.href='rep_by_custag.aspx'</script>");
            }
        }
        catch { }        
    ...
    protected void FormView1_PreRender(object sender, EventArgs e)
    {
        ...
        //            else
        //                Response.Redirect("inv_by_salesman.aspx");
        //        }
        //    }
        //    else
        //    {
