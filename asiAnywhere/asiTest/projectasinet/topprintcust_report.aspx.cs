...
public partial class topprintcust_report : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            try
            {
                ...
                string cmd = "select * from report_maintance where user_name = '" + UserLogin.UserName + "' and prog_name = 'topprintcust_report.aspx'  ";
                ...
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    ...
                    endcust_TextBox.Text = dr["field3"].ToString();
                    ...
                    if (dr["chk_field2"].ToString() == "True")
                        chk_soldto.Checked = true;
                    else
                        chk_soldto.Checked = false;
    ...
    protected void SubmitButton_Click(object sender, EventArgs e)
    {
        ...
        ObjectDataSource1.SelectParameters["prmShiptoAdd"].DefaultValue = Convert.ToString(chk_shipto.Checked);
        ObjectDataSource1.SelectParameters["prmSoldtoAdd"].DefaultValue = Convert.ToString(chk_soldto.Checked);
        ObjectDataSource1.SelectParameters["prmTotal"].DefaultValue = Convert.ToString(chk_total.Checked);
        ...
        try
        {
            ...
            {
                SqlCommand cmd_insert = new SqlCommand("insert into report_maintance (user_name, prog_name, field1, field2, field3, field4,rd_field1, chk_field1, chk_field2,chk_field3,chk_field4,chk_field5,chk_field6,chk_field7,chk_field8) values ('" + UserLogin.UserName + "','topprintcust_report.aspx','" + begincust_TextBox.Text.Trim() + "','" + beginame_TextBox.Text.Trim() + "','" + endcust_TextBox.Text.Trim() + "','" + endnameTextBox.Text.Trim() + "','" + RadioButtonList2.SelectedValue + "','" + Convert.ToString(chk_shipto.Checked) + "','" + Convert.ToString(chk_soldto.Checked) + "','" + Convert.ToString(chk_total.Checked) + "','" + Convert.ToString(chk_note.Checked) + "','" + Convert.ToString(chk_parameter.Checked) + "','" + Convert.ToString(chk_misc.Checked) + "','" + Convert.ToString(chk_add.Checked) + "','" + Convert.ToString(chk_phone.Checked) + "')", conn);
                cmd_insert.ExecuteNonQuery();
            }
            else
            {
                SqlCommand cmd_update = new SqlCommand("update report_maintance set field1 = '" + begincust_TextBox.Text.Trim() + "', field2 = '" + beginame_TextBox.Text.Trim() + "', field3 = '" + endcust_TextBox.Text.Trim() + "', field4 = '" + endnameTextBox.Text.Trim() + "', rd_field1 = '" + RadioButtonList2.SelectedValue + "', chk_field1 = '" + Convert.ToString(chk_shipto.Checked) + "', chk_field2 = '" + Convert.ToString(chk_soldto.Checked) + "',chk_field3 = '" + Convert.ToString(chk_total.Checked) + "',chk_field4 = '" + Convert.ToString(chk_note.Checked) + "', chk_field5 = '" + Convert.ToString(chk_parameter.Checked) + "',chk_field6 = '" + Convert.ToString(chk_misc.Checked) + "',chk_field7 = '" + Convert.ToString(chk_add.Checked) + "',chk_field8 = '" + Convert.ToString(chk_phone.Checked) + "' where user_name = '" + UserLogin.UserName + "' and prog_name ='topprintcust_report.aspx' ", conn);
        ...
        try
        {
            Label vpath = (Label)FormView1.FindControl("custprintLabel");
        ...
        if (vpath.Text != "")
        {
            ...
            if (path2 != "")
            {
                ...
                Response.Redirect("topprintcust_report.aspx");
            }
        }
        else
        {
    ...
    if (Label1.Text == "")
    {
        Response.Write("<script>window.location.href='topprintcust_report.aspx'</script>");
    }
    }
