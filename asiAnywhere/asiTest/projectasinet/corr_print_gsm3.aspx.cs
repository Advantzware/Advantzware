...
public partial class corr_print_gsm3 : System.Web.UI.Page
{
    ...
    {       
        ...
        try
        {
            ...
            ObjectDataSource1.SelectParameters["prmIpRels"].DefaultValue = "0";
    ...
    protected void updatebutton_click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            ObjectDataSource1.SelectParameters["prmCostPerPall"].DefaultValue = costperpallet.Text.Trim();
            ObjectDataSource1.SelectParameters["prmTotPall"].DefaultValue = totalpallet.Text.Trim();
            ObjectDataSource1.SelectParameters["prmVendor"].DefaultValue = Convert.ToString(Session["estimate_analysis2_vendor_no"]);
        ...
        try
        {
            ...
            if (Convert.ToInt32(Request.QueryString["seq"]) < Convert.ToInt32(ds2.Tables[0].Rows[0][0].ToString()))
            {
                ...
                Response.Write("<script>location.href='corr_print_gsm3.aspx?seq=" + seqno + "'</script>");
