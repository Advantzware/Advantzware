<%@ Page Language="C#" AutoEventWireup="true" Inherits="terms_lookup" Codebehind="terms_lookup.aspx.cs" %>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.termsLookup('<%#DataBinder.Eval(Container,"DataItem.vcode")%>','<%#DataBinder.Eval(Container,"DataItem.vdscr")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>            
