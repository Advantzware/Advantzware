<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="quoted_price" Codebehind="quoted_price_report.aspx.cs" %>
<%@ Register Src="footer.ascx" TagName="Footer" TagPrefix="ft" %>
<%@ Register Src="header.ascx" TagName="Header" TagPrefix="hd" %>
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head id="Head1" runat="server">
    <title>Quoted Price List</title>
    ...
    function begdate() {
        var beg = document.getElementById("BegdateTextBox");
        beg.focus();
    }
    function enddate() {
        var end = document.getElementById("EnddateTextBox");
        end.focus();
    }
    ...
    <form id="frmList" runat="server"  defaultfocus='BegCustTextBox'>   
      ...
      <TABLE id="tblTop" cellSpacing="3" align="center" border="0" Width="100%">
        <TR>
          ...
          <TD align=center nowrap><font size=+0><b>Quoted Price List&nbsp;</b></font></TD>
      ...
      <tr><td align="right" style="padding-right: 5px"><b> Beginning Date:</b></td><td>
          ...
          <a href="#" tabindex="1" onblur="begdate()" onClick="showCalendarControl(BegdateTextBox); return false"><asp:Image ID="datelook" runat="server" ImageUrl="images/lookup_icon.gif" /> </a>
          </td>
      <td align="right" style="padding-right: 5px"><b>Ending Date:</b></td><td>
          <asp:TextBox ID="EnddateTextBox" onfocus="javascript:preEnter( this, 'yes' );" onblur="javascript:preLeave( this, 'date', '99/99/9999' );" width="100px"  runat="server"></asp:TextBox>
           <a href="#" tabindex="1" onblur="enddate()" onClick="showCalendarControl(EnddateTextBox); return false"><asp:Image id="look2" runat="server" ImageUrl="images/lookup_icon.gif" /></a></td>
        </tr>
          ...
          <asp:FormView ID="FormView1" Visible="False" runat="server" 
              ...
              <ItemTemplate>
                  qPrcFile:
                  <asp:Label ID="qPrcFileLabel" runat="server" Text='<%# Bind("qPrcFile") %>'></asp:Label><br />                 
              </ItemTemplate>                            
          </asp:FormView>
          
          <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
              SelectMethod="SelectQtdPriceRep" TypeName="reports">
              <SelectParameters>
