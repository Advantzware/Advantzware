...
public partial class company_list : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (Session["User"] != null)
            {
                ...
                comp_TextBox.Text = Convert.ToString(Session["company_list_prmcomp"]);
                Name_TextBox.Text  = Convert.ToString(Session["company_list_prmname"]);
        ...
        try
        {
            if (Session["company_list_index"] == null)
            {
                GridView1.SelectedIndex = 0;
                Session["company_list_company"] = GridView1.SelectedRow.Cells[1].Text;
                Session["company_list_reckey_name"] = ((Label)GridView1.SelectedRow.FindControl("reckeyLabel")).Text;
            }
        }
        catch {}
        ...
        try
        {
            if (Session["company_list_index"] != null)
            {
                GridView1.SelectedIndex = Convert.ToInt32(Session["company_list_index"]);
                Session["company_list_company"] = GridView1.SelectedRow.Cells[1].Text;
                Session["company_list_reckey_name"] = ((Label)GridView1.SelectedRow.FindControl("reckeyLabel")).Text;
            }
        }
    ...
    {
        Session["company_list_index"] = GridView1.SelectedIndex;
    ...
    {
        Session["company_list_prmcomp"] = comp_TextBox.Text.Trim();
        Session["company_list_prmname"] = Name_TextBox.Text.Trim();
        ObjectDataSource1.SelectParameters["prmAction"].DefaultValue = "Search";
        ObjectDataSource1.SelectParameters["prmCompany"].DefaultValue = comp_TextBox.Text.Trim();
        ObjectDataSource1.SelectParameters["prmvname"].DefaultValue = Name_TextBox.Text.Trim();
        
        Session["company_list_index"] = null;
    }
