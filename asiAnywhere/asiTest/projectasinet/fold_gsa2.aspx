<%@ Page Language="c#" AutoEventWireup="true" Debug="true" Inherits="fold_gsa2" Codebehind="fold_gsa2.aspx.cs" %>
       ...
       &nbsp;
        <input type="button" name="Cancel" class="buttonM" id="close" value="Cancel" onClick="javascript:self.close();window.opener.location.reload();"  />
          ...
          <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
              OldValuesParameterFormatString="original_{0}" SelectMethod="SelectFoldGsa2" 
              TypeName="Corrugated">
              <SelectParameters>
