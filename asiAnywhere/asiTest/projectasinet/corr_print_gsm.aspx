<%@ Page Language="c#" AutoEventWireup="true" Debug="true" Inherits="corr_print_gsm" Codebehind="corr_print_gsm.aspx.cs" %>
    ...
    <form id="frmList" runat="server"   defaultfocus ='' >   
      ...
      <div>
          ...
          <asp:FormView ID="FormView1" runat="server" OnDataBound="formview1_databound" DataSourceID="ObjectDataSource1">
              ...
              <table ><tr><td width="137px" align="right" style="padding-right:5px"><b>Overrides for Qty:</b></td>
              ...
              <tr><td align="right" style="padding-right:5px"><b>Broken Comm:</b></td>
              <td><asp:TextBox ID="ld_gsa_fmTextBox" runat="server" Text='<%# Bind("[ld-gsa-fm]") %>' />
              ...
              <tr><td align="right" style="padding-right:5px"><b>Unit Count:</b></td>
              <td><asp:TextBox ID="ld_gsa_war_u_cTextBox" runat="server" Text='<%# Bind("[ld-gsa-war-u-c]") %>' /></td></tr>
              
              <tr><td align="right" style="padding-right:5px"><b>Pallet Count:</b></td>
              <td><asp:TextBox ID="ld_gsa_war_cntTextBox"  runat="server" Text='<%# Bind("[ld-gsa-war-cnt]") %>' /></td></tr>
              
              <tr><td align="right" style="padding-right:5px"><b>Total Units:</b></td>
              <td><asp:TextBox ID="ld_gsa_war_uniTextBox" runat="server" Text='<%# Bind("[ld-gsa-war-uni]") %>' /></td></tr>
              
              <tr><td align="right" style="padding-right:5px"><b>Units per Pallet:</b></td>
              <td><asp:TextBox ID="ld_gsa_war_u_pTextBox" onkeyup="unitperpallet()" MaxLength="6" runat="server" Text='<%# Bind("[ld-gsa-war-u-p]") %>' />
              ...
              <tr><td align="right" style="padding-right:5px"><b>Total Pallet:</b></td>
              <td><asp:TextBox ID="ld_gsa_war_palTextBox" runat="server" Text='<%# Bind("[ld-gsa-war-pal]") %>' />
              ...
              <tr><td align="right" style="padding-right:5px"><b>Cost per Pallet:</b></td>
              ...
              <asp:CompareValidator ID="CompareValidator8" ControlToValidate="ld_gsa_war_amtTextBox" Display="Dynamic" Operator="DataTypeCheck" Type="Integer" SetFocusOnError="true"  runat="server" ErrorMessage="Enter only Integer Value"></asp:CompareValidator>                  
                ...
                <tr><td align="right" style="padding-right:5px"><b>Pallet Handling Charge:</b></td>
              <td><asp:TextBox ID="ld_gsa_war_hdlTextBox" runat="server"  Text='<%# Bind("[ld-gsa-war-hdl]") %>' />
              <asp:CompareValidator ID="CompareValidator9" ControlToValidate="ld_gsa_war_hdlTextBox" Display="Dynamic" Operator="DataTypeCheck" Type="Double" SetFocusOnError="true"  runat="server" ErrorMessage="Enter only Decimal Value"></asp:CompareValidator>                  
                ...
                <tr><td align="right" style="padding-right:5px"><b>Pallets Delivered/Month:</b></td>
              <td><asp:TextBox ID="ld_gsa_war_perTextBox" runat="server"  Text='<%# Bind("[ld-gsa-war-per]") %>' />
              <asp:CompareValidator ID="CompareValidator10" ControlToValidate="ld_gsa_war_perTextBox" Display="Dynamic" Operator="DataTypeCheck" Type="Integer" SetFocusOnError="true"  runat="server" ErrorMessage="Enter only Integer Value"></asp:CompareValidator>                  
                ...
                <tr><td align="right" style="padding-right:5px"><b>Total Charge:</b></td>
              <td><asp:TextBox ID="ld_gsa_war_totTextBox"  runat="server" Text='<%# Bind("[ld-gsa-war-tot]") %>' />
       ...
       &nbsp;
        <input type="button" name="Cancel" class="buttonM" id="close" value="Cancel" onClick="javascript:self.close();window.opener.location.reload();"  />
          ...
          <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
              OldValuesParameterFormatString="original_{0}" SelectMethod="SelectGsa" 
              TypeName="Corrugated">
              <SelectParameters>
