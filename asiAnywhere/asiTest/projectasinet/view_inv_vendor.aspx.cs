...
public partial class view_inv_vendor : System.Web.UI.Page
{
    string oldinv = "";
    string recid = "";
   ...
   protected void delete_Button_Click(object sender, EventArgs e)
   {
       ...
       bool check = con.ValidateUpdateVendor("ValidateDelete", "", UserLogin.UserName, "", "","","","","",0,0,0, 0,0,"","",0,0,"",1,"","",0,reckey.Text.Trim());
            ...
            if (value == "True")
            {
                ...
                ObjectDataSource1.SelectParameters["prmExrate"].DefaultValue = "1";
                FormView1.ChangeMode(FormViewMode.ReadOnly);

                Response.Write("<script>window.location.href='view_inv_vendor.aspx'</script>");
            }
   ...
   protected void InsertButton_Click(object sender, EventArgs e)
   {
       ...
       bool check = con.ValidateUpdateVendor("ValidateAdd", "", UserLogin.UserName, vendor.Text.Trim(), invoice.Text.Trim(), "", "", "", invdate.Text.Trim(), 0, 0, 0, 0, 0, duedate.Text.Trim(), taxcode.Text.Trim(),0,0,"",1,"","",0,"");
    ...
    {
        Response.Redirect("vendor_invoice.aspx");
    }
    ...
    protected void UpdateButton_Formview2_Click(object sender, EventArgs e)
    {
        ...
        bool check = con.ValidateViewVendor("ValidateUpdate", "", UserLogin.UserName, Convert.ToString(Session["vendor_invoice_reckey_rec"]), Convert.ToInt32(pono.Text.Trim()), 0, actnum.Text.Trim(), "", "", idscr.Text.Trim(), Convert.ToDecimal(invqty.Text.Trim()), "", Convert.ToDecimal(unitpr.Text.Trim()), prqtyuom.Text.Trim(), tax.SelectedValue, Convert.ToDecimal(sqft.Text.Trim()), Convert.ToDecimal(amt.Text.Trim()), 0, "", 0, 0, reckey.Text.Trim());
            ...
            if (value == "True")
            {
                ...
                ObjectDataSource3.SelectParameters["prmInv"].DefaultValue = Convert.ToString(Session["vendor_invoice_reckey_rec"]);
        ...
        if (FormView2.CurrentMode == FormViewMode.Insert)
        {
           ...
           // try
            //{
             ...
             bool check = val.ValidateViewVendor("AddnewRecValidate", "", UserLogin.UserName, "", 0, 0, "", "", "", "", 0, "", 0, "", "", 0, 0, 0, "", 0, 0, Convert.ToString(Session["vendor_invoice_reckey_rec"]));
            ...
            if (value == "True")
            {
                voucherpay con = new voucherpay();
                DataSet ds = new DataSet();
                ds = con.SelectViewVendor("AddnewRec", "", UserLogin.UserName, "", 0, 0, "", "", "", "", 0, "", 0, "", "", 0, 0, 0, "", 0, 0, Convert.ToString(Session["vendor_invoice_reckey_rec"]));
    ...
    protected void CancelButton_FormView2_Delete(object sender, EventArgs e)
    {
        ...
        try
        {
            voucherpay con = new voucherpay();
            DataSet ds = new DataSet();
            ds = con.SelectViewVendor("DataDelete", "001", UserLogin.UserName, Convert.ToString(Session["vendor_invoice_reckey_rec"]), 0, 0, "", "", "", "", 0, "", 0, "","", 0, 0, 0,"", 0, 0, reckey.Text.Trim());
        }
        catch { }
    ...
    protected void deleteButton_FormView2_Click(object sender, EventArgs e)
    {
        ...
        bool check = con.ValidateViewVendor("ValidateDelete", "001", UserLogin.UserName, Convert.ToString(Session["vendor_invoice_reckey_rec"]), 0, 0, "", "", "", "", 0, "", 0, "", "", 0, 0, 0, "", 0, 0, reckey.Text.Trim());
    ...
    protected void BoardReclButton_Click(object sender, EventArgs e)
    {
       
        UserClass UserLogin = (UserClass)Session["User"];
        ObjectDataSource3.SelectParameters["prmUser"].DefaultValue = UserLogin.UserName;
        ObjectDataSource3.SelectParameters["prmAction"].DefaultValue = "BrdReClc";
