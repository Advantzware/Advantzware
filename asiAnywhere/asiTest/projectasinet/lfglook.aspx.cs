...
public partial class lfglook : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {        
       if (!Page.IsPostBack)
        {
            ObjectDataSource1.SelectParameters["prmAction"].DefaultValue = "ItemSelect";    
    ...
    {
        ObjectDataSource1.SelectParameters["prmAction"].DefaultValue = "ItemSearch";
