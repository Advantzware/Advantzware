<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="vendtype_list" Codebehind="vendtype_list.aspx.cs" %>
  ...
  <head id="Head1" runat="server">
   ...
   <body>
    <form id="frmList" runat="server"  defaultfocus='tdSearch'>   
      ...
      <asp:LinkButton ID="lnk_Listvend" runat="server" >Browse Type</asp:LinkButton></li>
      <li><asp:LinkButton ID="lnk_viewvend" runat="server" OnClick="lnk_viewvend_Click" > View Type</asp:LinkButton></li></ul></div>
        ...
        <TR>
          <TD>
            <TABLE id="tblSearch" cellSpacing="1" cellPadding="5" width="100%" border="0"  bgcolor=black>
              <TR>
                ...
                <table>
                <tr><td ><b>Vendor Type</b></td><td align="center"><b> Description</b></td>
                </tr>
                <tr><td>
                    <asp:TextBox ID="vendtype_TextBox" Width="100px" runat="server"></asp:TextBox></td>
          ...
          <EmptyDataRowStyle BorderColor="Gray" BorderStyle="Dotted" BorderWidth="0px" Font-Bold="True"
              ...
              <asp:CommandField ShowSelectButton="true" ButtonType="image" SelectImageUrl="~/Images/sel.gif" SelectText="" > 
                  ...
                  <asp:BoundField DataField="vtype" HeaderText="Vendor Type" SortExpression="vtype" />
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
              OldValuesParameterFormatString="original_{0}" SelectMethod="SelectVendTypeList" 
              TypeName="voucherpay">
                <SelectParameters>
                    ...
                    <asp:SessionParameter SessionField="vendtype_prmvtype" Name="prmvtype" Type="String" />
                    <asp:SessionParameter SessionField="vendtype_list_prmdscr" Name="prmvdscr" Type="String" />
