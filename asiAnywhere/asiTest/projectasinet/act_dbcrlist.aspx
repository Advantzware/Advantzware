<%@ Page Language="C#" AutoEventWireup="true" Debug="false" Inherits="act_dbcrlist" CodeBehind="act_dbcrlist.aspx.cs" %>
        ...
        <TR>
          <TD><fieldset>
            <TABLE id="tblSearch" cellSpacing="1" cellPadding="5" width="100%" border="0" class="shade" bgcolor="gray" >
              <TR >
                <TD class="shade" align="center" width="50"  bgcolor="gray"><nobr>
        ...
        <tr><td> 
            <asp:GridView ID="GridView1" runat="server" DataSourceID="ObjectDataSource1" EmptyDataText=" Records not  Found" AllowPaging="True" AllowSorting="True" Width="500px" AutoGenerateColumns="False" BorderStyle="Dotted" CssClass="Grid" OnSelectedIndexChanged="GridView1_SelectedIndex">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="custno" HeaderText="Customer Number" SortExpression="custno" />
                    <asp:BoundField DataField="chkno" HeaderText="Memo Number" SortExpression="chkno" />
                    <asp:BoundField DataField="chkdt" HeaderText="Memo Date" SortExpression="chkdt" />                    
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                ...
                <SelectParameters>
                   ...
                   <asp:SessionParameter SessionField="debit_memo_cust" Name="prmcustno" Type="String" />                   
                   <asp:Parameter Name="prmcustname" Type="String" />                   
                   <asp:SessionParameter SessionField="debit_memo_check_no" Name="prmchkno" Type="Int32" />
                   ...
                   <asp:SessionParameter SessionField="customer_dbcr_posted" Name="prmout" Type="String" />
