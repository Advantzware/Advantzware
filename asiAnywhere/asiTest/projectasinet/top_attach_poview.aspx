<%@ Page Language="C#" AutoEventWireup="true" Debug="true" Inherits="top_attach_poview" Codebehind="top_attach_poview.aspx.cs" %>
...
<head runat="server">
    ...
    function ItemPoLookup(ReturnObj1) {
        document.forms[0].FormView1_vEstimateTextBox.value = ReturnObj1;
        document.forms[0].FormView1_vEstimateTextBox.focus();
    }
      ...
      <table>
        ...
        <asp:FormView ID="FormView1" runat="server" DataSourceID="ObjectDataSource1" OnDataBound="FormView1_DataBound" OnUnload="FormView1_Unload">
            <EditItemTemplate>
               ...
               <table class="shade"><tr><td nowrap align="right" style="padding-right:5px"><b>Attached File: </b></td>
                ...
                <tr><td nowrap align="right" style="padding-right:5px"><b>Po#:</b></td>
                <td><asp:TextBox ID="vEstimateTextBox" Width="100px" runat="server" Text='<%# Bind("vPoNo") %>'>
                </asp:TextBox>
                <a href="#" onclick="customerpolook(); return false"><asp:Image ID="custLookup" runat="server" ImageUrl="~/images/lookup_icon.gif" /></a>
                </td>
            ...
            <ItemTemplate>
                ...
                <td><asp:Label ID="vEstimateLabel" runat="server" Width="100px" BackColor="turquoise" Text='<%# Bind("vPoNo") %>'></asp:Label></td>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            ...
            <SelectParameters>
                ...
                <asp:SessionParameter DefaultValue="" Name="prmRecKey" SessionField="top_list_attachpo_rec_key"
                    Type="String" />
                <asp:Parameter Name="prmAttFile" Type="String" />
                <asp:SessionParameter Name="prmPoNo" SessionField="pur_ord_po" Type="String" />
                <asp:SessionParameter DefaultValue="" SessionField="order_rec_key" Name="prmFgitem"  Type="String" />
