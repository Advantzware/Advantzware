<%@ Page Language="C#" AutoEventWireup="True" Inherits="reprnt_tag_look" Codebehind="reprnt_tag_look.aspx.cs" %>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800">&nbsp;                
    ...
    <div>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.ReprintTagLook('<%#DataBinder.Eval(Container,"DataItem.vtag")%>','<%#DataBinder.Eval(Container,"DataItem.vINo")%>','<%#DataBinder.Eval(Container,"DataItem.vJobNo")%>','<%#DataBinder.Eval(Container,"DataItem.vJob2")%>','<%#DataBinder.Eval(Container,"DataItem.ordno")%>','<%#DataBinder.Eval(Container,"DataItem.vabc")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>     
                 ...
                 <asp:BoundField DataField="vQty" HeaderText="On Hand" SortExpression="vOrdQty" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="LabelMenuReturnTagLook" TypeName="ledger">
            <SelectParameters>               
                ...
                <asp:Parameter Name="prmReTag" Type="String" />
