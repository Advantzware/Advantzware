...
public partial class purge_contacts_notes : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        //if (!func.CheckUserPermissions("[dbo].[contact]", "SA"))
        //{
        ...
        if (Session["User"] != null)
        {
            ...
            string vPage = "purge_contacts_notes.aspx";
            string aUsers = null;
            string PrmComp = null;
        ...
        //String expression = "last_name";
        //SortDirection direction;
        //direction = SortDirection.Descending;
        //dbGrid_contact.Sort(expression, direction);
    ...
    private void BuildDataSource()
    {
        ...
        {
            conn.Open();
            string cmd = "select last_name as 'Last Name', first_name as 'First Name', contact_title as 'Title', cust_no as 'Customer', ship_id as 'ShipId', type as 'Type', phone as 'Phone', extension as 'Extension', cust_name as 'Company' , maillist as 'Mail List', sman, middle_initial, sirname, maillist, contact_loc, addr1, addr2, city, state, zip, country, county, territory, access_code, cell_phone, fax, email, website, comp_code, status_code, sic_code,comp_des,status_des,sic_des, rec_key  from contact";
    ...
    protected void btnSearch_Click(object sender, System.EventArgs e)
    {
        ...
        try
        {
            ...
            {
                cmd = "select last_name as 'Last Name', first_name as 'First Name', contact_title as 'Title', cust_no as 'Customer', ship_id as 'ShipId', type as 'Type', phone as 'Phone', extension as 'Extension', cust_name as 'Company' , maillist as 'Mail List', sman, middle_initial, sirname, maillist, contact_loc, addr1, addr2, city, state, zip, country, county, territory, access_code, cell_phone, fax, email, website, comp_code, status_code, sic_code,comp_des,status_des,sic_des, rec_key  from contact where status_code LIKE '" + txt_statuscode.Text + "%'";
            }
               ...
               try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("delete from contact where rec_key='" + ((Label)row.FindControl("Label22")).Text + "'", conn);
                    SqlCommand cmd2 = new SqlCommand("delete from notes where rec_key='" + ((Label)row.FindControl("Label22")).Text + "'", conn);
                    cmd.ExecuteNonQuery();
                    cmd2.ExecuteNonQuery();
                    conn.Close();
                    Response.Write("<script>window.location.href='purge_contacts_notes.aspx'</script>");
                }
                catch
                {
