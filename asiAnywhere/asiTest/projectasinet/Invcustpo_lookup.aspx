<%@ Page Language="C#" AutoEventWireup="true" Inherits="Invcustpo_lookup" Codebehind="Invcustpo_lookup.aspx.cs" %>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
            ...
            <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.CustomerPOLookup('<%#DataBinder.Eval(Container,"DataItem.INvCustPo")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="InvCustPo" HeaderText="P.O. Num" SortExpression="InvCustPo" />
                <asp:BoundField DataField="InvNumber" HeaderText="Cust #" SortExpression="InvNumber" />
            </Columns>
        </asp:GridView>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
         SelectMethod="InvCustPoLook" TypeName="Order">
            <SelectParameters>
