...
public partial class top_attach_po : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            if (Session["top_list_attachpo_index"] != null)
            {
                Session["top_list_attachpo_rec_key"] = ((Label)GridView1.SelectedRow.FindControl("rec_key_label")).Text;
            }
            if (Session["top_list_attachpo_index"] == null)
            {
             ...
             GridView1.SelectedIndex = Convert.ToInt32(Session["top_list_attachpo_index"]);
        }
        catch { }
    }
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        Session["top_list_attachpo_index"] = GridView1.SelectedIndex;
        Session["top_list_attachpo_rec_key"] = ((Label)GridView1.SelectedRow.FindControl("rec_key_label")).Text;
