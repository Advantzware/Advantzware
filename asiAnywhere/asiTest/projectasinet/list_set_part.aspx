<%@ Page Language="C#" MasterPageFile="MasterPageRcpt.master" Debug="true" AutoEventWireup="true" Inherits="list_set_part" Title="Warehouse Transactions Receipts" Codebehind="list_set_part.aspx.cs" %>
...
<div>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
        ...
        <SelectParameters>            
            ...
            <asp:SessionParameter Name="prmSeqno" SessionField="prmSeq_rcpt2" Type="String" />
            <asp:SessionParameter Name="prmTagno" SessionField="prmTag_rcpt2" Type="String" />
            <asp:SessionParameter Name="prmRcptDate" SessionField="prmDate_rcpt2" Type="String" />
            <asp:SessionParameter Name="prmPono" SessionField="prmPo_rcpt2" Type="String" />
            <asp:SessionParameter Name="prmFgItem" SessionField="prmIno_rcpt2" Type="String" />
            <asp:SessionParameter Name="prmJobno" SessionField="prmJob_rcpt2" Type="String" />
            <asp:SessionParameter Name="prmRecKey" SessionField="seqno" Type="String" />
