...
public partial class toporder_list_notes : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            if (Session["order_list_notes_index"] == null)
            {
                GridView1.SelectedIndex = 0;
                Session["order_list_notes_date"] = GridView1.SelectedRow.Cells[1].Text;
                //Session["order_list_notes_time"] = GridView1.SelectedRow.Cells[2].Text;
                Session["order_list_notes_title"] = GridView1.SelectedRow.Cells[3].Text;
                ...
                Session["order_list_notes_time"] = totaltime;
            }
            GridView1.SelectedIndex = Convert.ToInt32(Session["order_list_notes_index"]);
        }
        catch { }
    }
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        Session["order_list_notes_index"] = GridView1.SelectedIndex;
        Session["order_list_notes_date"] = GridView1.SelectedRow.Cells[1].Text;
        //Session["order_list_notes_time"] = GridView1.SelectedRow.Cells[2].Text;
        Session["order_list_notes_title"] = GridView1.SelectedRow.Cells[3].Text;
