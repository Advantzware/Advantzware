<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="tax_sche_bycust" Codebehind="~/tax_sche_bycust.aspx.cs" %>
<%@ Register Src="footer.ascx" TagName="Footer" TagPrefix="ft" %>
<%@ Register Src="header.ascx" TagName="Header" TagPrefix="hd" %>
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head id="Head1" runat="server">
    <title>Tax Schedule by Customer</title>  
...
function VendLookup(ReturnObj1) {
   ...
   <body>
    <form id="frmList" runat="server"  defaultfocus='foryearTextBox'>   
      ...
      <TABLE id="tblTop" cellSpacing="3" align="center" border="0" Width="100%">
        <TR>
          ...
          <TD align=center nowrap><font size=+0><b>Tax Schedule by Customer &nbsp;</b></font></TD>
      ...
      <tr><td align="right" style="padding-right: 5px"><b>For  Year:</b></td><td>
          <asp:TextBox ID="foryearTextBox"  MaxLength="4" width="70px" runat="server"></asp:TextBox>
          <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="foryearTextBox" Display="Dynamic" Operator="DataTypeCheck" Type="Integer" ErrorMessage="Invalid Enter"></asp:CompareValidator>
        ...
        <tr><td align="right" style="padding-right: 5px"><b>For Period:</b></td>
          <td nowrap><asp:TextBox ID="perTextBox" MaxLength="2" Width="50px" runat="server"></asp:TextBox>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>OutPut To?:</b> <asp:RadioButtonList ID="RadioButtonList3" RepeatLayout="Flow"  CellSpacing="1" RepeatColumns="5" Font-Bold ="true" runat="server">
         ...
         <tr><td colspan="4">
          ...
          <asp:FormView ID="FormView1" Visible="False"   runat="server" 
              ...
              <ItemTemplate>
                  taxcust:
                  <asp:Label ID="taxcustLabel" runat="server" 
                      Text='<%# Bind("taxcust") %>'></asp:Label><br />
          ...
          <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
               SelectMethod="TaxScheduleByCustomer" TypeName="voucherpay">
              <SelectParameters>
                  <asp:Parameter Name="prmUser" Type="String" />
                  <asp:Parameter Name="prmtaxcust" Type="String" />
                   <asp:Parameter Name="prmbegyr" Type="Int32" />
