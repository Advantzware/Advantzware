...
public partial class booking_high_report : System.Web.UI.Page
{   
    protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (Session["User"] != null)
        {
            ...
            string vPage = "booking_high_report.aspx";
            string aUsers = null;
            string PrmComp = null;
    ...
    protected void submitbutton_click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            Label path = (Label)FormView1.FindControl("vBookingFileLabel");
            ...
            if (path.Text == "")
            {
                ...
                /*Response.Write("<script>window.location.href='booking_high_report.aspx'</script>");*/
            }
