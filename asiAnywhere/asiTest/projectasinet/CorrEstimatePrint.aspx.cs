...
public partial class CorrEstimatePrint : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (Session["User"] != null)
        {
            ...
            string vPage = "CorrEstimatePrint.aspx";
            string aUsers = null;
            string PrmComp = null;
            ...
            if (aUsers == "external")
            {
                ...
                {                
                    ...
                    try
                    {
                        ...
                        string cmd = "select * from report_maintance where user_name = '" + UserLogin.UserName + "' and prog_name = 'CorrEstimatePrint.aspx'  ";
    ...
    {                
        ...
        ObjectDataSource1.SelectParameters["prmBlankNo"].DefaultValue = Convert.ToString(Session["order_corrugated_blankno"]);
        ObjectDataSource1.SelectParameters["prmLine"].DefaultValue = Convert.ToString(Session["corr_print_line"]);
        ...
        try
        {
            ...
            {
                SqlCommand cmd_insert = new SqlCommand("insert into report_maintance (user_name, prog_name, field1, field2, chk_field1, chk_field2) values ('" + UserLogin.UserName + "','CorrEstimatePrint.aspx','" + FrmDept_TextBox.Text.Trim() + "','" + ToDept_TextBox.Text.Trim() + "','" + HiddenField1.Value + "','" + HiddenField2.Value + "')", conn);
                cmd_insert.ExecuteNonQuery();
            }
            else
            {
                SqlCommand cmd_update = new SqlCommand("update report_maintance set field1 = '" + FrmDept_TextBox.Text.Trim() + "', field2 = '" + ToDept_TextBox.Text.Trim() + "', chk_field1 = '" + HiddenField1.Value + "', chk_field2 = '" + HiddenField2.Value + "' where user_name = '" + UserLogin.UserName + "' and prog_name ='CorrEstimatePrint.aspx' ", conn);
