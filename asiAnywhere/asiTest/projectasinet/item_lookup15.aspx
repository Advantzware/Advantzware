  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800">&nbsp;                
    ...
    <div>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign="Center" Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.ItemLookup15('<%#DataBinder.Eval(Container,"DataItem.vIno")%>','<%#DataBinder.Eval(Container,"DataItem.vName")%>','<%#DataBinder.Eval(Container,"DataItem.vPressType")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>     
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="SelectSpecItem" TypeName="Corrugated">
            <SelectParameters>               
                ...
                <asp:Parameter Name="prmType" DefaultValue="M" Type="String" />
                <asp:Parameter Name="prmIndustry" DefaultValue="1" Type="String" />
