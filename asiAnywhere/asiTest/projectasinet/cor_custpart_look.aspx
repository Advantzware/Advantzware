<%@ Page Language="C#" AutoEventWireup="true" Inherits="cor_custpart_look" Codebehind="cor_custpart_look.aspx.cs" %>
            ...
            <Columns>
             <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.CustpartLookup('<%#DataBinder.Eval(Container,"DataItem.vPartNum")%>','<%#DataBinder.Eval(Container,"DataItem.vPartDscr")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:BoundField DataField="vPartDscr" HeaderText="Dscription" SortExpression="vPartDscr" />
                
            </Columns>
        </asp:GridView>
        <input type="button" name="close" class="buttonM" id="close" value="Close" onclick="javascript:window.close()" />
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="Selectcustpart" TypeName="Corrugated">
            <SelectParameters>               
