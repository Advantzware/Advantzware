...
public partial class freight_lookup : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ObjectDataSource1.SelectParameters["prmAction"].DefaultValue = "ghj";
        if (!Page.IsPostBack)
        {
    ...
    {
        Response.Redirect("Freight_lookup.aspx");
    }
