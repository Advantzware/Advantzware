...
public partial class help_main: System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        dbGrid_help_main.SelectedIndex = Convert.ToInt32(Session["help_main_list_index"]);
        try
        {
            if (Session["help_main_list_index"] == null)
            {
                dbGrid_help_main.SelectedIndex = 0;
                Session["help_main_list_code"] = dbGrid_help_main.SelectedRow.Cells[1].Text;
            }
        }
        catch
        {
    ...
    private void BuildDataSource()
    {
        ...
        {
            conn.Open();
            string cmd = "select client_id as 'Client Name ', flags as 'Paid' from client_id";
    ...
    protected void btnShowAll_Click(object sender, System.EventArgs e)
    {
        ...
        Session["htPeramhelp_main"] = null;
        Session["help_main_list_index"] = null;
        BuildDataSource();
    }
    ...
    protected void btnSearch_Click(object sender, System.EventArgs e)
    {
        ...
        try
        {
            ...
            if (txt_fldname.Text != "")
            {
                cmd = "select client_id as 'Client Name', flags as 'Paid' from client_id where client_id LIKE '" + txt_fldname.Text + "%'";
            }
    ...
    {
        Session["help_main_list_index"] = dbGrid_help_main.SelectedIndex;
    ...
    {
        Response.Redirect("help_main_view.aspx");
    }
