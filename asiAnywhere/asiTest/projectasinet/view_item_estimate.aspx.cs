...
/// </summary>
public partial class view_entry_estimate : System.Web.UI.Page
{
    string mailto = "";
    string user_login = "";
    ...
    {        
        ...
        if (Convert.ToString(Session["view_item_mode"]) == "add")
        {
            FormView1.ChangeMode(FormViewMode.Insert);
            NewAddButton.Visible = false;
        }
        else if (Convert.ToString(Session["view_item_mode"]) == "edit")
        {
        ...
        if (Request.QueryString["mode"] == "item")
        {
            FormView1.ChangeMode(FormViewMode.ReadOnly);
        }
        if (Request.QueryString["mode"] == "mail")
        {
            try
            {
        ...
        if (Session["User"] != null)
        {
            ...
            try
            {
                ...
                ord_label.Text = Convert.ToString(Session["order_est"]);
                cust_label.Text = Convert.ToString(Session["order_entry_cust_no"]);
                type_label.Text = Convert.ToString(Session["order_entry_type"]);
    ...
    protected void FormView1_DataBound(object sender, EventArgs e)
    {
        ...
        {            
            ...
            if (FormView1.CurrentMode == FormViewMode.Insert)
            {
                ...
                vType.Text = "EA";
                if (Convert.ToInt32(Session["order_entry_cust_quote"]) != 0) 
                {
                    addquote.Text = Convert.ToString(Session["order_entry_quote"]);
                    addquote.Enabled = false;
                 
                }
                if (Convert.ToString(Session["order_entry_job_no_1"]) != "&nbsp;" || Session["order_entry_job_no_1"] != null)
                {
                    if(Convert.ToString(Session["order_entry_job_no_1"])!="&nbsp;")
                    addjob.Text = Convert.ToString(Session["order_entry_job_no_1"]);                    
                }
                addjob2.Text = Convert.ToString(Session["order_entry_job_no_2"]);
                ...
                if (Session["User"] != null)
                {
                    ...
                    sman1.Text = Convert.ToString(Session["order_entry_sman1"]);
                    sman2.Text = Convert.ToString(Session["order_entry_sman2"]);
                    sman3.Text = Convert.ToString(Session["order_entry_sman3"]);

                    sname1.Text = Convert.ToString(Session["order_entry_sname1"]);
                    sname2.Text = Convert.ToString(Session["order_entry_sname2"]);
                    sname3.Text = Convert.ToString(Session["order_entry_sname3"]);

                    overrun.Text = Convert.ToString(Session["order_entry_over"]);
                    underrun.Text = Convert.ToString(Session["order_entry_under"]);
                    duedate.Text = Convert.ToString(Session["order_entry_req_date"]);
                    promisedate.Text = Convert.ToString(Session["order_entry_req_date"]);
                    custpo.Text = Convert.ToString(Session["order_entry_customer_po"]);
                    if (custpo.Text == "&nbsp;")
                    {
                        custpo.Text = "";
                    }
                    ...
                    type.SelectedValue = Convert.ToString(Session["order_entry_type"]);
                    priority.SelectedValue = Convert.ToString(Session["order_entry_req_code"]);
                    priority2.SelectedValue = Convert.ToString(Session["order_entry_prom_code"]);
                    if (Convert.ToString(Session["order_entry_tax"]) == "Y")
                        tax.Checked = true;
                    if (Convert.ToString(Session["order_entry_tax"]) == "N")
                        tax.Checked = false;
    ...
    protected void InsertButton_Click(object sender, EventArgs e)
    {
        ...
        if (Convert.ToString(job.Text.Trim()) == "")
        {
            ...
            {
                job.Text = Convert.ToString(Session["order_est"]);
            }
        }
        ...
        try
        {
            ...
            {                
                ...
                bool check = ord.AddViewItemEstimate(UserLogin.UserName, "AddValidate", Convert.ToInt32(Session["order_est"]), 0, Convert.ToString(HiddenEstmate.Value), fgitem.Text, custpart.Text, Convert.ToDecimal(quantity.Text.Trim()), itemname.Text, description.Text, description2.Text, "", Convert.ToDecimal(price.Text.Trim()), uom.Text, HiddenField2.Value, custpo.Text, "", 0, Convert.ToDecimal(discount.Text), priority2.Text, Convert.ToDateTime(duedate.Text), 0, priority.SelectedValue, Convert.ToDateTime(Session["order_entry_req_date"]), 0, Convert.ToInt32(qtyunit.Text), Convert.ToDecimal(partial.Text), Convert.ToInt32(units.Text), Convert.ToInt32(line.Text), Convert.ToInt32(boardpo.Text), sman.Text, sman2.Text, sman3.Text, original.SelectedValue, Convert.ToDecimal(over.Text), Convert.ToDecimal(under.Text), boardvend.Text, HiddenField1.Value, "", sname.Text, sname2.Text, sname3.Text, Convert.ToDecimal(Hiddenspct.Value), 0, 0, Convert.ToDecimal(Hiddencomm.Value), 0, 0, Convert.ToDecimal(Cost.Text), Convert.ToInt32(quote.Text.Trim()), "y");
            ...
            if (user_login == "external")
            {
                ...
                orderentry ord = new orderentry();
                bool check = ord.AddViewItemEstimate(UserLogin.UserName, "AddValidate", Convert.ToInt32(Session["order_est"]), 0, Convert.ToString(HiddenEstmate.Value), fgitem.Text, custpart.Text, Convert.ToDecimal(quantity.Text.Trim()), Convert.ToString(HiddenFieldname.Value), Convert.ToString(Hiddencustdesc.Value), Convert.ToString(Hiddencustdesc2.Value), "", Convert.ToDecimal(Hiddenprice.Value), Convert.ToString(HiddenTextBox1.Value), HiddenField2.Value, custpo.Text, "", 0, Convert.ToDecimal(Hiddendiscount.Value), "ASAP", Convert.ToDateTime(duedate.Text), 0, priority.SelectedValue, Convert.ToDateTime(Session["order_entry_req_date"]), 0, Convert.ToInt32(Hiddencounter.Value), Convert.ToDecimal(partial.Text), Convert.ToInt32(Hiddencasunit.Value), Convert.ToInt32(line.Text), Convert.ToInt32(boardpo.Text), Convert.ToString(Session["order_entry_sman1"]), Convert.ToString(Session["order_entry_sman2"]), Convert.ToString(Session["order_entry_sman3"]), "N", Convert.ToDecimal(over.Text), Convert.ToDecimal(under.Text), boardvend.Text, HiddenField1.Value, "", Convert.ToString(Session["order_entry_sname1"]), Convert.ToString(Session["order_entry_sname2"]), Convert.ToString(Session["order_entry_sname3"]), Convert.ToDecimal(Hiddenspct.Value), 0, 0, Convert.ToDecimal(Hiddencomm.Value), 0, 0, Convert.ToDecimal(Hiddencost.Value), Convert.ToInt32(quote.Text.Trim()), "y");
                value = Convert.ToString(check);
            }
            ...
            if (value == "True")
            {
                ...
                ObjectDataSource1.SelectParameters["prmCode"].DefaultValue = priority2.SelectedValue;
                ObjectDataSource1.SelectParameters["prmReqDate"].DefaultValue = duedate.Text.Trim();
                ObjectDataSource1.SelectParameters["prmPromDate"].DefaultValue = Convert.ToString(Session["order_entry_req_date"]);
                ObjectDataSource1.SelectParameters["prmPrevOrder"].DefaultValue = boardpo.Text.Trim();
                ObjectDataSource1.SelectParameters["prmVend"].DefaultValue = boardvend.Text.Trim();
                ObjectDataSource1.SelectParameters["prmOver"].DefaultValue = over.Text.Trim();
                ObjectDataSource1.SelectParameters["prmUnder"].DefaultValue = under.Text.Trim();
                ...
                if (Session["User"] != null)
                {
                    ...
                    if (aUsers == "external")
                    {
                        ...
                        ObjectDataSource1.SelectParameters["prmCost"].DefaultValue = Hiddencost.Value;
                        ObjectDataSource1.SelectParameters["prmReqDate"].DefaultValue = duedate.Text.Trim();
                        ObjectDataSource1.SelectParameters["prmSman"].DefaultValue = Convert.ToString(Session["order_entry_sman1"]);
                        ObjectDataSource1.SelectParameters["prmSman2"].DefaultValue = Convert.ToString(Session["order_entry_sman2"]);
                        ObjectDataSource1.SelectParameters["prmSman3"].DefaultValue = Convert.ToString(Session["order_entry_sman3"]);
                        ObjectDataSource1.SelectParameters["prmSname"].DefaultValue = Convert.ToString(Session["order_entry_sname1"]);
                        ObjectDataSource1.SelectParameters["prmSname2"].DefaultValue = Convert.ToString(Session["order_entry_sname2"]);
                        ObjectDataSource1.SelectParameters["prmSname3"].DefaultValue = Convert.ToString(Session["order_entry_sname3"]);
                ...
                //Response.Write("<script> if(confirm('Do you wish to Add another item?')) location.href='view_item_estimate.aspx?mode=insert';</script>");
                //Response.Write("<script> location.href='view_item_estimate.aspx?mode=mail';</script>");
    ...
    protected void DeleteButton_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Session["view_line_est"] = vline.Text;

            ObjectDataSource1.SelectParameters["prmAction"].DefaultValue = "Delete";
            ObjectDataSource1.SelectParameters["prmLine"].DefaultValue = Convert.ToString(Session["view_line_est"]);
            FormView1.ChangeMode(FormViewMode.ReadOnly);
            Session["view_item_mode"] = null;
        }
        catch { }
    ...
    protected void quote_text_changed(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Convert.ToInt32(quote1.Text.Trim()) > 0 && Convert.ToInt32(HiddenQuoteNum.Value) <= 0)
              {
                  Response.Write("<script>window.open('item_qut_look.aspx?quote=" + quote1.Text.Trim() + "&cust=" + cust_label.Text.Trim() + "','typoeordLookupWindow','width=720,height=450, scrollbars=1, toolbars=1,statusbar=1,resizeable=1');</script>");
                  
              }
              if (quote1.Text != Convert.ToString(HiddenQuoteNum.Value))
              {
                  Response.Write("<script>window.open('item_qut_look.aspx?quote=" + quote1.Text.Trim() + "&cust=" + cust_label.Text.Trim() + "','typoeordLookupWindow','width=720,height=450, scrollbars=1, toolbars=1,statusbar=1,resizeable=1');</script>");
              }
