<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="refer_posting_date" Codebehind="~/refer_posting_date.aspx.cs" %>
<%@ Register Src="footer.ascx" TagName="Footer" TagPrefix="ft" %>
<%@ Register Src="header.ascx" TagName="Header" TagPrefix="hd" %>
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head id="Head1" runat="server">
    <title>Reference Date vs Posting Date</title>  
    ...
    <form id="frmList" runat="server"  defaultfocus='begjoTextBox'>   
      ...
      <TABLE id="tblTop" cellSpacing="3" align="center" border="0" Width="100%">
        <TR>
          ...
          <TD align=center nowrap><font size=+0><b>Reference Date vs Posting Date   &nbsp;</b></font></TD>
     ...
     <tr><td align="right" style="padding-right: 5px"><b>Beginning Run#:</b></td>
        ...
        <td align="right" style="padding-right: 5px"><b>Ending Run#:</b></td>
          ...
          <a href="#" tabindex="1" onclick="runlookup(2); return false"><asp:Image ID="Image2" runat="server" ImageUrl="images/lookup_icon.gif" /></a>
          ...
          <tr><td align="right" style="padding-right:5px"><b>Beginning Reference Date:</b></td>
          <td>
          ...
          <td align="right" style="padding-right:5px"><b>Ending Reference Date:</b></td>
          <td>
          ...
          <td>
              <asp:TextBox ID="bepostTextBox" Width="100px" onfocus="javascript:preEnter( this, 'yes' );" onblur="javascript:preLeave( this, 'date', '99/99/9999' );" runat="server"></asp:TextBox>
              <a href="#" onblur="document.getElementById('bepostTextBox').focus()" tabindex="1" onClick="showCalendarControl(bepostTextBox); return false"><asp:Image ID="Image5" runat="server" ImageUrl="images/lookup_icon.gif" /></a></td>
          <td align="right" style="padding-right:5px"><b>Ending Posting Date:</b></td>
          <td>
              <asp:TextBox ID="endpostTextBox" Width="100px" onfocus="javascript:preEnter( this, 'yes' );" onblur="javascript:preLeave( this, 'date', '99/99/9999' );" runat="server"></asp:TextBox>
              <a href="#" onblur="document.getElementById('endpostTextBox').focus()" tabindex="1" onClick="showCalendarControl(endpostTextBox); return false"><asp:Image ID="Image6" runat="server" ImageUrl="images/lookup_icon.gif" /></a>
              </td></tr>
         ...
         <tr><td colspan="4">
          ...
          <asp:FormView ID="FormView1" Visible="False"   runat="server" 
              ...
              <ItemTemplate>
                  ...
                  <asp:Label ID="pstfileLabel" runat="server" 
                      Text='<%# Bind("pstfile") %>'></asp:Label><br />
          ...
          <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
               SelectMethod="ReferencevsPosting" TypeName="ledger">
              <SelectParameters>
                  ...
                  <asp:Parameter Name="prmBegPdate" Type="String" />
                  <asp:Parameter Name="prmEndPdate" Type="String" />
