...
public partial class quote_list : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (Session["User"] != null)
        {
            ...
            string vPage = "quote_list_report.aspx";
            string aUsers = null;
            string PrmComp = null;
        ...
        if (!Page.IsPostBack)
        {
            ...
            try
            {
                ...
                string cmd = "select * from report_maintance where user_name = '" + UserLogin.UserName + "' and prog_name = 'quote_list_report.aspx' ";
                ...
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    ...
                    if (dr["rd_field1"].ToString() == "SalesRep")
    ...
    protected void submitbutton_click(object sender, EventArgs e)
    {
        ...
        ObjectDataSource1.SelectParameters["prmAction"].DefaultValue = "QuoteListRep";
        ...
        ObjectDataSource1.SelectParameters["prmBoCost"].DefaultValue = HiddenField1.Value;
        ...
        try
        {
            ...
            {
                SqlCommand cmd_insert = new SqlCommand("insert into report_maintance (user_name, prog_name , field1, field2, field3, field4, field5, field6, chk_field1, rd_field1) values ('" + UserLogin.UserName + "','quote_list_report.aspx' , '" + BegCustTextBox.Text.Trim() + "', '" + EndCustTextBox.Text.Trim() + "', '" + BegSalrepTextBox.Text.Trim() + "', '" + EndSalrepTextBox.Text.Trim() + "', '" + BegdateTextBox.Text.Trim() + "', '" + EnddateTextBox.Text.Trim() + "', '" + HiddenField1.Value + "', '" + RadioButtonList1.SelectedValue + "')", conn);
                cmd_insert.ExecuteNonQuery();
            }
            else
            {
                SqlCommand cmd_update = new SqlCommand("update report_maintance set field1 = '" + BegCustTextBox.Text.Trim() + "', field2 = '" + EndCustTextBox.Text.Trim() + "', field3 = '" + BegSalrepTextBox.Text.Trim() + "', field4 = '" + EndSalrepTextBox.Text.Trim() + "', field5 = '" + BegdateTextBox.Text.Trim() + "', field6 = '" + EnddateTextBox.Text.Trim() + "', chk_field1 = '" + HiddenField1.Value + "', rd_field1 = '" + RadioButtonList1.SelectedValue + "' where user_name = '" + UserLogin.UserName + "' and prog_name =  'quote_list_report.aspx' ", conn);
        ...
        try
        {
            ...
            if (vpath.Text == "")
            {
                ...
                //Response.Write("<script>window.location.href='quote_list_report.aspx'</script>");
            }
        }
        catch { }       
