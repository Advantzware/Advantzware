            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		                <a href="#" onClick="javascript:top.opener.window.ItemLookup6('<%#DataBinder.Eval(Container,"DataItem.vItemNo2")%>','<%#DataBinder.Eval(Container,"DataItem.vItemName2")%>','<%#DataBinder.Eval(Container,"DataItem.vShrink")%>','<%#DataBinder.Eval(Container,"DataItem.vSqInch")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField> 
