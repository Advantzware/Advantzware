...
public partial class void_ap_chklist : System.Web.UI.Page
{
   ...
   protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        try
        {
            if (Session["void_chklist_index1"] == null)
            {
                GridView1.SelectedIndex = 0;

                Session["void_chklist_reckey_rec"] = ((Label)GridView1.SelectedRow.FindControl("reclabel")).Text;
        ...
        try
        {
            if (Session["void_chklist_index1"] != null)
            {
                GridView1.SelectedIndex = Convert.ToInt32(Session["void_chklist_index1"]);
    ...
    {
        Session["void_chklist_index1"] = GridView1.SelectedIndex;
    ...
    {
        Session["void_chklist_vendor"] = vendor_TextBox.Text;
        Session["void_chklist_checkno"] = checkno_TextBox.Text.Trim();
        Session["void_chklist_bank_code"] = bankcode_TextBox.Text.Trim();
        ...
        ObjectDataSource1.SelectParameters["prmchkno"].DefaultValue = checkno_TextBox.Text.Trim();
        ObjectDataSource1.SelectParameters["prmbnkcod"].DefaultValue = bankcode_TextBox.Text.Trim();


        Session["void_chklist_index1"] = null;
    }
