...
public partial class vend_1099rep : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (Session["User"] != null)
        {
            ...
            string vPage = "vend_1099rep.aspx";
            string aUsers = null;
            string PrmComp = null;
        ...
        if (!Page.IsPostBack)
        {
            ...
            try
            {
                ...
                string cmd = "select * from report_maintance where user_name = '" + UserLogin.UserName + "' and prog_name = 'vend_1099rep.aspx' ";
    ...
    protected void submitbutton_click(object sender, EventArgs e)
    {
        ...
        ObjectDataSource1.SelectParameters["prmUser"].DefaultValue = UserLogin.UserName;
        ObjectDataSource1.SelectParameters["prmAction"].DefaultValue = "ven1099";        
        ...
        ObjectDataSource1.SelectParameters["prmincld"].DefaultValue = HiddenField1.Value;
        ...
        try
        {
            ...
            {
                SqlCommand cmd_insert = new SqlCommand("insert into report_maintance (user_name, prog_name , field1, field2, field3, field4,chk_field1,  rd_field1) values ('" + UserLogin.UserName + "','vend_1099rep.aspx' , '" + begvendTextBox.Text.Trim() + "', '" + endvendTextBox.Text.Trim() + "','" + begdateTextBox.Text.Trim() + "','" + enddateTextBox.Text.Trim() + "','" + Convert.ToString(CheckBox1.Checked) + "', '"+ RadioButtonList1.SelectedValue +"')", conn);
                cmd_insert.ExecuteNonQuery();
            }
            else
            {
                SqlCommand cmd_update = new SqlCommand("update report_maintance set field1 = '" + begvendTextBox.Text.Trim() + "', field2 = '" + endvendTextBox.Text.Trim() + "', field3 = '" + begdateTextBox.Text.Trim() + "', field4 = '" + enddateTextBox.Text.Trim() + "', chk_field1 = '" + Convert.ToString(CheckBox1.Checked) + "',rd_field1 = '" + RadioButtonList1.SelectedValue + "' where user_name = '" + UserLogin.UserName + "' and prog_name =  'vend_1099rep.aspx' ", conn);
        ...
        try
        {
            ...
            Label vpath = (Label)FormView1.FindControl("ven1099Label");
            ...
            if (vpath.Text == "")
            {
                ...
                Response.Write("<script>window.location.href='vend_1099rep.aspx'</script>");
            }
        }
        catch { }
