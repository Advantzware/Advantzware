<%@ Page Language="C#" AutoEventWireup="true" Inherits="fgitem_translookup" Title="FgItem LookUp" Codebehind="fgitem_translookup.aspx.cs" %>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
            ...
            <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.FG2Lookup('<%#DataBinder.Eval(Container,"DataItem.Item")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="Item" HeaderText="Item Number" SortExpression="Item" />
                <asp:BoundField DataField="Name" HeaderText="Item Name" SortExpression="Name" />
                <asp:BoundField DataField="Dscr" HeaderText="Desc" SortExpression="Dscr" />
            </Columns>
        </asp:GridView>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="SelectFgItem" TypeName="Order">
            <SelectParameters>
