<%@ Page Language="C#" AutoEventWireup="true" Inherits="InvEst_lookup" Title = "Estimate" Codebehind="InvEst_lookup.aspx.cs" %>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
            ...
            <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.EstimateLookup('<%#DataBinder.Eval(Container,"DataItem.InvEstimate")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="InvEstimate" HeaderText="Estimate#" SortExpression="InvEstimate" >
                    <ItemStyle Wrap="False" />
                </asp:BoundField>
                <asp:BoundField DataField="InvCustomer" HeaderText="Cust#" SortExpression="InvCustomer" >
                    <ItemStyle Wrap="False" />
                </asp:BoundField>
                <asp:BoundField DataField="InvType" HeaderText="Type" SortExpression="InvType" >
                    <ItemStyle Wrap="False" />
                </asp:BoundField>
            </Columns>
        </asp:GridView>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
         SelectMethod="InvEstimateLook" TypeName="Order">
            <SelectParameters>
