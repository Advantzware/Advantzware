<%@ Page Language="C#" AutoEventWireup="true" Inherits="UnitNoLook" Title="Unit No Lookup" Codebehind="UnitNoLook.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Packing Code Information(Special Material)</title>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800">&nbsp;                
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
            ...
            <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		    <%--<a href="#" onClick="javascript:top.opener.window.UnitNoLook('<%#DataBinder.Eval(Container,"DataItem.Ino")%>','<%#DataBinder.Eval(Container,"DataItem.Iname")%>') ;window.close();">Select</a>--%>
		    <asp:CheckBox ID="chkSelect" runat="server" /> 
                ...
                <asp:TemplateField HeaderText="Name" SortExpression="Iname">
                    ...
                    <ItemTemplate>
                        <asp:Label ID="Label1" runat="server" Text='<%# Bind("Iname") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
         SelectMethod="PackingLook" TypeName="LookUp">
            <SelectParameters>
            <asp:Parameter Name="prmUser" Type="String" />
                ...
                <asp:Parameter Name="MatType" Type="String" DefaultValue="D" />
                
                 
            </SelectParameters>
        </asp:ObjectDataSource>
        
        <asp:Button ID="Select" runat="server" OnClick="Select_Click" Text="Select" CssClass="buttonM" />
        <asp:Button ID="Select2" runat="server" Text="Select" CssClass="buttonM" />
        <input type="button" value="Close" id="close" class="buttonM" onclick="javascript:window.close()";
    </div>
    </form>
</body>
</html>
