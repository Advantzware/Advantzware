<%@ Page Language="C#" AutoEventWireup="true" Debug="true" Inherits="toporder_view_notes" Codebehind="toporder_view_notes.aspx.cs" %>
...
<head runat="server">
    <title>View Notes</title>
     ...
     <script>
        ...
        function deptlook()
        { 
            var NewWindow = window.open("topdept_lookup.aspx","TopDeptLookupWindow","width=500,height=500,scrollbars=1,toolbars=1,statusbar=1,resizeable=1");
        }
...
<body>
    ...
    <div>
        ...
        <TR>
          <TD >&nbsp;</TD>
          <TD  nowrap><font size=+0><b>View Notes &nbsp;<asp:Label ID="lbl_page" runat="server"></asp:Label></b></font></TD>
      ...
      <table>
                ...
                <fieldset class="shade">
                    <table>
                        ...
                        <tr>
                            ...
                            <td nowrap>
                                <asp:TextBox ID="vNoteTitleTextBox" runat="server" Text='<%# Bind("vNoteTitle") %>'></asp:TextBox>
                        ...
                        <tr>
                            <td nowrap align="right" style="padding-right:5px;"></td>
                            <td nowrap colspan="2">
                                <asp:TextBox ID="vNoteTextTextBox" TextMode="multiline" Height="200px" Width="200px" runat="server" Text='<%# Bind("vNoteText") %>'></asp:TextBox>
                            </td>
                            <td nowrap align="right" style="padding-right:5px;"></td>
                            <td nowrap></td>
                            <td nowrap align="right" style="padding-right:5px;"></td>
                ...
                <fieldset class="shade">
                    <table>
                        ...
                        <tr>
                            <td nowrap align="right" style="padding-right:5px;">Note Title:</td>
                            <td nowrap colspan="4">
                                <asp:Label ID="vNoteTitleLabel" Width="200px" BackColor="turquoise" BorderColor="white" BorderStyle="solid" BorderWidth="1px" runat="server" Text='<%# Bind("vNoteTitle") %>'>
                                </asp:Label>
                            </td>
                            <td nowrap align="right" style="padding-right:5px;"></td>
                            <td nowrap></td>
                        ...
                        <tr>
                            <td nowrap align="right" style="padding-right:5px;"></td>
                            <td nowrap colspan="4">
                                <asp:TextBox ID="vNoteTextLabel" ReadOnly="true" Height="200px" TextMode="multiLine" Width="200px" BackColor="turquoise" BorderColor="white" BorderStyle="solid" BorderWidth="1px" runat="server" Text='<%# Bind("vNoteText") %>'></asp:TextBox>
                            </td>
                            <td nowrap align="right" style="padding-right:5px;"></td>
                            <td nowrap></td>
                            <td nowrap align="right" style="padding-right:5px;"></td>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="ViewTopOrderNotes" TypeName="orderentry">
            <SelectParameters>
                <asp:Parameter DefaultValue="Select" Name="prmAction" Type="String" />
                <asp:Parameter Name="prmUser" Type="String" />
                <asp:SessionParameter DefaultValue="" Name="prmRecKey" SessionField="order_rec_key"
                    Type="String" />
                <asp:Parameter Name="prmHeader" Type="String" />
                <asp:SessionParameter Name="prmNoteDate" SessionField="order_list_notes_date" Type="DateTime" />
                <asp:SessionParameter Name="prmNoteTime" SessionField="order_list_notes_time" Type="String" />
                ...
                <asp:SessionParameter Name="prmNoteTitle" SessionField="order_list_notes_title" Type="String" />
