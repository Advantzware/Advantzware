<%@ Page Language="C#" AutoEventWireup="true" Inherits="estimate_lookup" Title = "Estimate" Codebehind="estimate_lookup.aspx.cs" %>
...
<body>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800" style="height: 32px">&nbsp;                
    ...
    <div>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="SelectEstimateLook" TypeName="Order">
            <SelectParameters>
            <asp:QueryStringParameter QueryStringField="customer_val" Name="prmCust" Type="String" />
