...
public partial class customers_list_ship : System.Web.UI.Page
{
    ...
    {
       // Response.Write(Session["customer1_list_cust"]);
       // Response.Write(Session["customer_list_shipto"]);
        ...
        if (Session["User"] != null)
        {
            ...
            string vPage = "cust_list_ship.aspx";
            string aUsers = null;
            string PrmComp = null;
        ...
        GridView1.SelectedIndex = Convert.ToInt32(Session["customer_list_ship_index"]);

        try
        {
            if (Session["customer_list_ship_index"] == null)
            {
                GridView1.SelectedIndex = 0;

                Session["customer_list_shipto"] = GridView1.SelectedRow.Cells[1].Text;
            }
    ...
    {
        Session["customer_list_ship_index"] = GridView1.SelectedIndex;
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        ObjectDataSource1.SelectParameters["prmshipid"].DefaultValue = Ship_TextBox.Text.Trim();
        ObjectDataSource1.SelectParameters["prmshipname"].DefaultValue = Name_TextBox.Text.Trim();
