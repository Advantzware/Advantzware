<%@ Page Language="C#" AutoEventWireup="true" Inherits="terr_lookup" Codebehind="terr_lookup.aspx.cs" %>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.TerrCodeLookup('<%#DataBinder.Eval(Container,"DataItem.VTerro")%>','<%#DataBinder.Eval(Container,"DataItem.VDscr")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>            
