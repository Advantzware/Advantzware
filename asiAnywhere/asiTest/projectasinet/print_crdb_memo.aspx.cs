...
public partial class print_crdb_memo : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (Session["User"] != null)
        {
            ...
            string vPage = "print_crdb_memo.aspx";
            string aUsers = null;
            string PrmComp = null;
        ...
        if (!Page.IsPostBack)
        {
            ...
            try
            {
                ...
                string cmd = "select * from report_maintance where user_name = '" + UserLogin.UserName + "' and prog_name = 'print_crdb_memo.aspx' ";
    ...
    protected void submitbutton_click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (vpath.Text == "")
            {
                ...
                Response.Write("<script>window.location.href='print_crdb_memo.aspx'</script>");
            }
        }
        catch { }   
