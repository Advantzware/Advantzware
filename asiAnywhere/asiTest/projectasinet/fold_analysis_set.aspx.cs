...
public partial class fold_analysis_set : System.Web.UI.Page
{
    string puge = "";
        ...
        if (Session["User"] != null)
        {
            ...
            if (aUsers == "external")
            {
                if (!Page.IsPostBack)
                {
                    ...
                    Session["fold_analysis_set_vendor_no"] = ""; 
                }
            }
            if (aUsers == "internal")
            {
    ...
    protected void SaveBtnClick(object sender, EventArgs e)
    {
        ...
        ds = fold.FoldSetQty(UserLogin.UserName, "doCalc", Convert.ToInt32(Qty1.Text), Convert.ToInt32(Qty2.Text), Convert.ToInt32(Qty3.Text), Convert.ToInt32(Qty4.Text), Convert.ToInt32(Qty5.Text), Convert.ToInt32(Qty6.Text), Convert.ToInt32(Qty7.Text), Convert.ToInt32(Qty8.Text), Convert.ToInt32(Qty9.Text), Convert.ToInt32(Qty10.Text), Convert.ToInt32(Qty11.Text), Convert.ToInt32(Qty12.Text), Convert.ToInt32(Qty13.Text), Convert.ToInt32(Qty14.Text), Convert.ToInt32(Qty15.Text), Convert.ToInt32(Qty16.Text), Convert.ToInt32(Qty17.Text), Convert.ToInt32(Qty18.Text), Convert.ToInt32(Qty19.Text), Convert.ToInt32(Qty20.Text), Convert.ToInt32(Qty21.Text), Convert.ToInt32(Qty22.Text), Convert.ToInt32(Qty23.Text), Convert.ToInt32(Qty24.Text), Convert.ToInt32(Qty25.Text), Convert.ToInt32(Qty26.Text), Convert.ToInt32(Qty27.Text), Convert.ToInt32(Qty28.Text), Convert.ToInt32(Rel1.Text), Convert.ToInt32(Rel2.Text), Convert.ToInt32(Rel3.Text), Convert.ToInt32(Rel4.Text), Convert.ToInt32(Rel5.Text), Convert.ToInt32(Rel6.Text), Convert.ToInt32(Rel7.Text), Convert.ToInt32(Rel8.Text), Convert.ToInt32(Rel9.Text), Convert.ToInt32(Rel10.Text), Convert.ToInt32(Rel11.Text), Convert.ToInt32(Rel12.Text), Convert.ToInt32(Rel13.Text), Convert.ToInt32(Rel14.Text), Convert.ToInt32(Rel15.Text), Convert.ToInt32(Rel16.Text), Convert.ToInt32(Rel17.Text), Convert.ToInt32(Rel18.Text), Convert.ToInt32(Rel19.Text), Convert.ToInt32(Rel20.Text), Convert.ToInt32(Rel21.Text), Convert.ToInt32(Rel22.Text), Convert.ToInt32(Rel23.Text), Convert.ToInt32(Rel24.Text), Convert.ToInt32(Rel25.Text), Convert.ToInt32(Rel26.Text), Convert.ToInt32(Rel27.Text), Convert.ToInt32(Rel28.Text), do_gsa, do_mr, do_speed, "", estimate, formno, blankno, HiddenField1.Value.Trim(),HiddenField_Vendor.Value.Trim());
        ...
        //{
           ...
           if (do_gsa == "True")
           {
               Session["fold_analysis_set_gsa_mat"] = ds.Tables[0].Rows[0][5].ToString();
               Session["fold_analysis_set_gsa_lab"] = ds.Tables[0].Rows[0][6].ToString();
               Session["fold_analysis_set_gsa_war"] = ds.Tables[0].Rows[0][7].ToString();               
               Session["fold_analysis_set_gsa_month"] = ds.Tables[0].Rows[0][9].ToString();
               SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["Project1ConnectionString"].ToString());
               conn.Open();
               int row = 0;
               ...
               conn.Close();
               Response.Write("<script>location.href='fold_gsa_set.aspx?seq=" + seqno + "'</script>");
           }
           else
           {
    ...
    protected void GridView1_selectedindex_change(object sender, EventArgs e)
    {
        ...
        Session["fold_analysis_set_vendor_no"] = GridView1.SelectedRow.Cells[1].Text;
    }
    ...
    protected void Price_Button_Click(object sender, EventArgs e)
    {
        ...
        Session["fold_analysis_set_vendor_no"] = "bestvendor";
        vendordiv.Visible = false;
        FormView1.ChangeMode(FormViewMode.Insert);
