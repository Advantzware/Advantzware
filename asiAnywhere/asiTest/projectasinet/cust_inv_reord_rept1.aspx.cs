...
public partial class cust_inv_reord_rep1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (Session["User"] != null)
        {
            ...
            string vPage = "cust_inv_reord_rept1.aspx";
            string aUsers = null;
            string PrmComp = null;
            ...
            if (aUsers == "external")
            {
                if (!Page.IsPostBack)
                {
                    ...
                    try
                    {
                        ...
                        string cmd = "select * from report_maintance where user_name = '" + UserLogin.UserName + "' and prog_name = 'cust_inv_reord_rept1.aspx'  ";
    ...
    protected void submitbutton_click(object sender, EventArgs e)
    {
        ...
        ObjectDataSource1.SelectParameters["prmAct"].DefaultValue = "CustomerInv1";
        ...
        ObjectDataSource1.SelectParameters["prmBeginShip"].DefaultValue = BelocTextBox.Text.Trim();
        ObjectDataSource1.SelectParameters["prmEndShip"].DefaultValue = EndlocTextBox.Text.Trim();
        ObjectDataSource1.SelectParameters["prmBeginItem"].DefaultValue = BeitemTextBox.Text.Trim();
        ...
        ObjectDataSource1.SelectParameters["prmcustom"].DefaultValue = HiddenField1.Value;
        ObjectDataSource1.SelectParameters["prIncQoh"].DefaultValue = HiddenField2.Value;
        ObjectDataSource1.SelectParameters["prmUse"].DefaultValue = HiddenField3.Value;
        ObjectDataSource1.SelectParameters["prmAsDate"].DefaultValue = DateTextBox.Text.Trim();
        ObjectDataSource1.SelectParameters["prmPrintPur"].DefaultValue = HiddenField4.Value;
        ObjectDataSource1.SelectParameters["prmPrintLot"].DefaultValue = HiddenField5.Value;
        ...
        try
        {
            Label vpath = (Label)FormView1.FindControl("vCustFileLabel");

            if (vpath.Text != "")
            {
                string path = vpath.Text;
                string path2 = @"/pdfs/" + path;
                Session["cust_reorder_list_rep1"] = path2;
                if (path2 != "")
                {
                    if (!Request.Browser.Browser.Contains("Safari"))
                        Response.Write("<script>window.open('print_cust_inv_reord_rept1.aspx'); target='_blank'</script>");
                    else
                        Response.Redirect("cust_inv_reord_rept1.aspx");
                }
        ...
        finally
        {
            if (Label1.Text == "")
            {
                Response.Write("<script>window.location.href='cust_inv_reord_rept1.aspx'</script>");
