<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="suppliers_copylookup" Codebehind="supplier_copylookup.aspx.cs" %>
      ...
      <TABLE id="tblMain" cellSpacing="1" Width="450px" cellPadding="1" border="0">
        ...
        <HeaderStyle BackColor="Teal" ForeColor="White" VerticalAlign="Middle"  HorizontalAlign="Center" Wrap="False"></HeaderStyle>
          ...
          <input type="checkbox" name="chDelete" value='<%#DataBinder.Eval(Container,"RowIndex")%>'/>
                  ...
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.SupplierCopyLookup('<%#DataBinder.Eval(Container,"DataItem.comp_code")%>','<%#DataBinder.Eval(Container,"DataItem.name")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
              ...
              <asp:ButtonField Text="Edit" Visible="False" CommandName="cmdEdit" HeaderImageUrl="images\icon_edit.gif"></asp:ButtonField>
                ...
                <asp:BoundField DataField="name" ReadOnly="True" HeaderText="Competitive Supplier Name" SortExpression="name">
                   ...
                   <%--<asp:BoundField DataField="address1" ReadOnly="True" HeaderText="Address" SortExpression="address1">
                    <ItemStyle HorizontalAlign="Center" />
                  
                </asp:BoundField>
                
                <asp:BoundField DataField="address2" ReadOnly="True" HeaderText="Address" SortExpression="address2">
                    <ItemStyle HorizontalAlign="Center" />
                  
                </asp:BoundField>
                
                <asp:BoundField DataField="city" ReadOnly="True" HeaderText="City" SortExpression="city">
                    <ItemStyle HorizontalAlign="Center" />
                  
                </asp:BoundField>
                <asp:BoundField DataField="state" ReadOnly="True" HeaderText="State" SortExpression="state">
                    <ItemStyle HorizontalAlign="Center" />
                  
                </asp:BoundField>
                <asp:BoundField DataField="zip" ReadOnly="True" HeaderText="Zip" SortExpression="zip">
                    <ItemStyle HorizontalAlign="Center" />
