...
public partial class mtd_dest_subtot : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (Session["User"] != null)
        {
            ...
            string vPage = "mtd_dest_subtot.aspx";
            string aUsers = null;
            string PrmComp = null;
        ...
        if (!Page.IsPostBack)
        {
            ...
            try
            {
                ...
                string cmd = "select * from report_maintance where user_name = '" + UserLogin.UserName + "' and prog_name = 'mtd_dest_subtot.aspx' ";
    ...
    protected void submitbutton_click(object sender, EventArgs e)
    {
        ...
        ObjectDataSource1.SelectParameters["prmUser"].DefaultValue = UserLogin.UserName;
        ObjectDataSource1.SelectParameters["prmmtdsub"].DefaultValue = "mtdsub";
        ...
        try
        {
            ...
            {
                SqlCommand cmd_insert = new SqlCommand("insert into report_maintance (user_name, prog_name , field1, field2, field3, field4) values ('" + UserLogin.UserName + "','mtd_dest_subtot.aspx' , '" + foryearTextBox.Text.Trim() + "', '" + perTextBox.Text.Trim() + "','" + begdateTextBox.Text.Trim() + "','" + enddateTextBox.Text.Trim() + "')", conn);
                cmd_insert.ExecuteNonQuery();
            }
            else
            {
                SqlCommand cmd_update = new SqlCommand("update report_maintance set field1 = '" + foryearTextBox.Text.Trim() + "', field2 = '" + perTextBox.Text.Trim() + "', field3 = '" + begdateTextBox.Text.Trim() + "', field4 = '" + enddateTextBox.Text.Trim() + "' where user_name = '" + UserLogin.UserName + "' and prog_name =  'mtd_dest_subtot.aspx' ", conn);
        ...
        try
        {
            ...
            Label vpath = (Label)FormView1.FindControl("mtdsubLabel");
            ...
            if (vpath.Text == "")
            {
                ...
                Response.Write("<script>window.location.href='mtd_dest_subtot.aspx'</script>");
            }
        }
        catch { }
