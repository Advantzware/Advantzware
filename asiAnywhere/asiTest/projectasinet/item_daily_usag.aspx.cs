...
public partial class list_daily_usag : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (Session["User"] != null)
        {
            ...
            string vPage = "item_daily_usag.aspx";
            string aUsers = null;
            string PrmComp = null;
        ...
        try
        {
            ...
            GridView1.SelectedIndex = Convert.ToInt32(Session["itemdaily_index"]);
            if (Session["itemdaily_index"] == null)
            {
                GridView1.SelectedIndex = 0;
                Session["itemdaily_seq_no"] = GridView1.SelectedRow.Cells[1].Text;
            }
    ...
    protected void btnShowAll_Click(object sender, System.EventArgs e)
    {
        ...
        Session["itemuseg_seq"] = txt_seqno.Text.Trim();
        Session["itemuseg_recdate"] = txt_recdate.Text.Trim();
        Session["itemuseg_po"] = txt_po.Text.Trim();
        Session["itemuseg_inum"] = txt_item.Text.Trim();
        Session["itemuseg_part"] = txt_custpart.Text.Trim();
    }
    ...
    protected void btnSearch_Click(object sender, System.EventArgs e)
    {
        ...
        Session["itemuseg_seq"] = txt_seqno.Text.Trim();
        Session["itemuseg_recdate"] = txt_recdate.Text.Trim();
        Session["aitemuseg_po"] = txt_po.Text.Trim();
        Session["aitemuseg_inum"] = txt_item.Text.Trim();
        Session["itemuseg_part"] = txt_custpart.Text.Trim();
    ...
    {
        Session["itemdaily_index"] = GridView1.SelectedIndex;
        Session["itemdaily_seq_no"] = GridView1.SelectedRow.Cells[1].Text;
    }
