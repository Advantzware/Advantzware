<%@ Page Language="C#" AutoEventWireup="true" Inherits="toporder_list_notes" Codebehind="toporder_list_notes.aspx.cs" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="GridView1" CssClass="Grid" runat="server" AutoGenerateColumns="False" AllowPaging="True" AllowSorting="True" BorderStyle="Dotted" EmptyDataText="No records found" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" DataSourceID="ObjectDataSource1">
