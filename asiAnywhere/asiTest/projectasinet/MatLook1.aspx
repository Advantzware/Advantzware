<%@ Page Language="C#" AutoEventWireup="true" Inherits="MatLookup1" Title="Raw Material Information(Window)" Codebehind="MatLook1.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Raw Material Information(Window)</title>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
            ...
            <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.MatLookUp1('<%#DataBinder.Eval(Container,"DataItem.Ino")%>','<%#DataBinder.Eval(Container,"DataItem.Iname")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
         SelectMethod="MatLook" TypeName="LookUp">
            ...
            <asp:Parameter Name="prmUser" Type="String" />
                ...
                <asp:Parameter Name="MatType" Type="String" DefaultValue="W" />
