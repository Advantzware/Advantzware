...
public partial class invoice_high_report : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (Session["User"] != null)
        {
            ...
            string vPage = "invoice_high_report.aspx";
            string aUsers = null;
            string PrmComp = null;
    ...
    protected void submitbutton_click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            Label path = (Label)FormView1.FindControl("vInvoiceFileLabel");
            ...
            if (path.Text == "")
            {
                ...
                /*Response.Write("<script>window.location.href='invoice_high_report.aspx'</script>");*/
            }
