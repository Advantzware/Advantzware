<%@ Page Language="C#" AutoEventWireup="true" Inherits="Carrier_lookupcopy " Title="Carrier Information(Window)" Codebehind="Carrier_lookupcopy.aspx.cs" %>
            ...
            <Columns>
             <asp:TemplateField>
                  <ItemStyle HorizontalAlign="Center" Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.Carrierlookupcopy('<%#DataBinder.Eval(Container,"DataItem.vcarrier")%>','<%#DataBinder.Eval(Container,"DataItem.vdscr")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
