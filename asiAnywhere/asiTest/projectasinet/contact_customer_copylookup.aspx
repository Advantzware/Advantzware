<%@ Page Language="C#" AutoEventWireup="true" Inherits="contact_customer_copylookup" Title="Customer Lookup" Codebehind="contact_customer_copylookup.aspx.cs" %>
    ...
    <div>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
		    ...
		    <a href="#" onClick="javascript:top.opener.window.ContactCustomerCopyLookup('<%#DataBinder.Eval(Container,"DataItem.Customer")%>','<%#DataBinder.Eval(Container,"DataItem.Name")%>','<%#DataBinder.Eval(Container,"DataItem.Address1")%>','<%#DataBinder.Eval(Container,"DataItem.Address2")%>','<%#DataBinder.Eval(Container,"DataItem.city")%>','<%#DataBinder.Eval(Container,"DataItem.state")%>','<%#DataBinder.Eval(Container,"DataItem.zip")%>','<%#DataBinder.Eval(Container,"DataItem.sman")%>','<%#DataBinder.Eval(Container,"DataItem.country")%>','<%#DataBinder.Eval(Container,"DataItem.county")%>','<%#DataBinder.Eval(Container,"DataItem.terr")%>'); window.close(); ">Select</a>             	    
                ...
                <asp:BoundField DataField="sman" HeaderText="Sales Rep" SortExpression="sman" >
                    <ItemStyle Wrap="False" />
                </asp:BoundField>
