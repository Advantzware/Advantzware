<%@ Page Language="C#" AutoEventWireup="true" Inherits="sman_lookup2" Codebehind="sman_lookup2.aspx.cs" %>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.SalesManLookup2('<%#DataBinder.Eval(Container,"DataItem.vSman1")%>','<%#DataBinder.Eval(Container,"DataItem.vSname1")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>     
