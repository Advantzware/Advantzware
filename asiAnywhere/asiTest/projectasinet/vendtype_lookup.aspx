<%@ Page Language="C#" AutoEventWireup="true" Inherits="vendtype_lookup" Codebehind="vendtype_lookup.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Vendor Type Lookup</title>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800">&nbsp;                
                <B>Search for:&nbsp; </B>&nbsp;&nbsp;&nbsp;
                  <asp:dropdownlist id="ddlSearchField" runat="server">
                    <%--<asp:ListItem Value="Any">Any</asp:ListItem>--%>
                      <asp:ListItem Value="Vend Type">Vendor Type</asp:ListItem>  
    ...
    <div>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.VendTypeLookup('<%#DataBinder.Eval(Container,"DataItem.vendtype")%>', '<%#DataBinder.Eval(Container,"DataItem.venddscr")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>            

                 <asp:BoundField DataField="vendtype" HeaderText="Vendor Type" SortExpression="vendtype" />
                <asp:BoundField DataField="venddscr" HeaderText="Description" SortExpression="venddscr" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="SelectVendorTypeLook" TypeName="voucherpay">
            <SelectParameters>               
