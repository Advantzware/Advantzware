<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="bnk_recon_reg" Codebehind="bnk_recon_reg.aspx.cs" %>
<%@ Register Src="footer.ascx" TagName="Footer" TagPrefix="ft" %>
<%@ Register Src="header.ascx" TagName="Header" TagPrefix="hd" %>
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head id="Head1" runat="server">
    <title>A/P Bank Reconciliation Register</title>
...
<script language="javascript">
    function confirmPost() {
        var retVal = makeMsgBox("Confirmation", "Do You Want To Purge Reconciled Checks ?", 48, 4, 256, 4096);
        if (retVal == 6) {
    ...
    <form id="frmList" runat="server"  defaultfocus='postdateTextBox'>   
      ...
      <TABLE id="tblTop" cellSpacing="3" align="center" border="0" Width="100%">
        <TR>
          ...
          <TD align=left nowrap><font size=+0><b>A/P Bank Reconciliation Register&nbsp;</b></font></TD>
      ...
      <tr><td colspan="3" align="center" style="padding-right: 5px; " nowrap>&nbsp;&nbsp;<b>Ending Date:</b>
           &nbsp;
            <asp:TextBox ID="enddateTextBox" onkeyup="periodtext()" onfocus="javascript:preEnter( this, 'yes' );" onblur="javascript:preLeave( this, 'date', '99/99/9999' );"  runat="server" Width="100px"></asp:TextBox>
            <a href="#" onblur="document.getElementById('enddateTextBox').focus()"  tabindex="1" onClick="showCalendarControl(enddateTextBox); return false"><asp:Image ID="Image5" runat="server" ImageUrl="images/lookup_icon.gif" /></a>          
         </td></tr>   
       <tr></tr><tr></tr>  
      <tr>
        ...
        <tr></tr><tr></tr><tr></tr><tr></tr>
          ...
          <asp:FormView ID="FormView1" Visible="false"  runat="server" 
              ...
              <ItemTemplate>
                  recreg:
                  <asp:Label ID="recregLabel" runat="server" 
                      Text='<%# Bind("recreg") %>'></asp:Label><br />                 
                  
              </ItemTemplate>                            
          </asp:FormView>
          
          <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
              SelectMethod="SelectReconciliationRegister" TypeName="voucherpay">
              <SelectParameters>
                  <asp:Parameter Name="prmUser" Type="String" />
                  <asp:Parameter Name="prmrecreg"  Type="String" />                  
