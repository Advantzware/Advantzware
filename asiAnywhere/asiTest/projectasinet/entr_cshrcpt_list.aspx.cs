...
public partial class entr_cshrcpt_list : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (Session["User"] != null)
            {
                ...
                string vPage = "entr_cshrcpt_list.aspx";
                string aUsers = null;
                string PrmComp = null;
            ...
            try
            {
                if (Session["cash_receipt_cust_index1"] == null)
                {
                    GridView1.SelectedIndex = 0;

                    Session["cash_receipt_cust_reckey_rec"] = ((Label)GridView1.SelectedRow.FindControl("reclabel")).Text;
            ...
            try
            {
                if (Session["cash_receipt_cust_index1"] != null)
                {
                    GridView1.SelectedIndex = Convert.ToInt32(Session["cash_receipt_cust_index1"]);
        ...
        {
            Session["cash_receipt_cust_index1"] = GridView1.SelectedIndex;
        ...
        {
            Session["cash_receipt_cust"] = customer_TextBox.Text;
            Session["customer_dbcr_posted"] = CheckBox1.Checked;            
            ...
            Session["cash_receipt_cust_index1"] = null;
        }
        ...
        {
            Session["cash_receipt_add_button"] = "add";
            Response.Redirect("view_cash_rcpt.aspx");
