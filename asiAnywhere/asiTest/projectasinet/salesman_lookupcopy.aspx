<%@ Page Language="C#" AutoEventWireup="true" Inherits="salesman_lookupcopy" Codebehind="salesman_lookupcopy.aspx.cs" %>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.smancopyLookup1copy('<%#DataBinder.Eval(Container,"DataItem.vSaleman")%>','<%#DataBinder.Eval(Container,"DataItem.vSsname")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>     
