<%@ Page Language="C#" AutoEventWireup="true" Inherits="sman_lookup" Codebehind="sman_lookup.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Sales  Man Lookup</title>
                ...
                <B>Search for:&nbsp; </B>&nbsp;&nbsp;&nbsp;
                  <asp:dropdownlist id="ddlSearchField" runat="server">
                    <%--<asp:ListItem Value="Any">Any</asp:ListItem>--%>
                      <asp:ListItem Value="sman">Sman</asp:ListItem>  
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.SalesManLookup('<%#DataBinder.Eval(Container,"DataItem.vSman1")%>','<%#DataBinder.Eval(Container,"DataItem.vSname1")%>', '<%#DataBinder.Eval(Container,"DataItem.SComm")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>     
                 <asp:BoundField DataField="vSman1" HeaderText="Salesman#" SortExpression="vSman1" />
                 <asp:BoundField DataField="vSname1" HeaderText="Name" SortExpression="vSname1" />
                 <asp:BoundField DataField="SComm" HeaderText="Comm%" SortExpression="SComm" />
                
            </Columns>
        </asp:GridView>
        <input type="button" name="close" class="buttonM" id="close" value="Close" onclick="javascript:window.close()" />
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="SelectSman" TypeName="LookUp">
            <SelectParameters>               
