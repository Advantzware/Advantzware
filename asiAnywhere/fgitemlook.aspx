<%@ Page Language="C#" AutoEventWireup="true" Inherits="fgitemlook" Title="FgItem LookUp" Codebehind="fgitemlook.aspx.cs" %>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
            ...
            <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.FGitemLookup('<%#DataBinder.Eval(Container,"DataItem.vno")%>','<%#DataBinder.Eval(Container,"DataItem.vcustpart")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="vno" HeaderText="Item Number" SortExpression="vno" />
                <asp:BoundField DataField="vname" HeaderText="Item Name" SortExpression="vname" />
                <asp:BoundField DataField="vcustpart" HeaderText="Cust Part" SortExpression="vcustpart" />
            </Columns>
        </asp:GridView>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="SedsFGitemLookup" TypeName="LookUp">
            <SelectParameters>
