<%@ Page Language="C#" AutoEventWireup="true" Inherits="salesman_lookup" Codebehind="salesman_lookup.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>SalesRep Lookup</title>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.smancopyLookup1('<%#DataBinder.Eval(Container,"DataItem.vSaleman")%>','<%#DataBinder.Eval(Container,"DataItem.vSsname")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>     
