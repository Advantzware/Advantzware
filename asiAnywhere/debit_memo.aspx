<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="Debit_memo" Codebehind="debit_memo.aspx.cs" %>
<%@ Register Src="footer.ascx" TagName="Footer" TagPrefix="ft" %>
<%@ Register Src="header.ascx" TagName="Header" TagPrefix="hd" %>
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head id="Head1" runat="server">
    <title>Debit/Credit Memos</title>
   ...
   <body>
    <form id="frmList" runat="server"  defaultfocus='bankcode_TextBox'>   
      ...
      <TABLE id="tblTop" cellSpacing="3" align="center" border="0" Width="100%">
        <TR>         
          <TD align=left nowrap><font size=+0><b>Debit/Credit Memos&nbsp;</b></font></TD>
          <TD >
          ...
          <TD><fieldset>
            <TABLE id="tblSearch" cellSpacing="1" cellPadding="5" width="102%" border="0" class="shade" bgcolor="gray" >
              <TR >
                ...
                <b>Bank Code</b> <br />
                <asp:TextBox ID="bankcode_TextBox" Width="100px" runat="server"></asp:TextBox></td>
                <td><b> Check No</b><br />
        ...
        <tr><td> 
            <asp:GridView ID="GridView1" runat="server" DataSourceID="ObjectDataSource1" EmptyDataText=" Records not  Found" AllowPaging="True" AllowSorting="True" Width="600px" AutoGenerateColumns="False" BorderStyle="Dotted" CssClass="Grid" OnSelectedIndexChanged="GridView1_SelectedIndex">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="checkno" HeaderText="Memo Number" SortExpression="checkno" />
                    <asp:BoundField DataField="checkdate" HeaderText="Memo Date" SortExpression="checkdate" />
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                ...
                <SelectParameters>
                   ...
                   <asp:SessionParameter SessionField="debit_memo_vendor" Name="prmvend" Type="String" />                   
                   <asp:Parameter Name="prmvname" Type="String" />                   
                   <asp:SessionParameter SessionField="debit_memo_check_no" Name="prmcheckno" Type="Int32" />
