<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="misc_cshrcpt_report" Codebehind="misc_cshrcpt_report.aspx.cs" %>
<%@ Register Src="footer.ascx" TagName="Footer" TagPrefix="ft" %>
<%@ Register Src="header.ascx" TagName="Header" TagPrefix="hd" %>
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head id="Head1" runat="server">
    <title>Miscellaneous Cash Receipts Register</title>
...
<script language="javascript">
    function confirmPost() {
        var retVal = makeMsgBox("Confirmation", "Post Miscellaneous Cash Receipts?", 48, 4, 256, 4096);
        if (retVal == 6) {
    ...
    <form id="frmList" runat="server"  defaultfocus='TextBox1'>   
      ...
      <TABLE id="tblTop" cellSpacing="3" align="center" border="0" Width="100%">
        <TR>
          ...
          <TD align=left nowrap><font size=+0><b>Miscellaneous Cash Receipts Register&nbsp;</b></font></TD>
      ...
      <tr>
        <td align="right" style="padding-right: 5px"><b>Begining Receipt Date:</b></td>
        ...
        <td align="right" style="padding-right: 5px"><b>Ending Receipt Date:</b></td>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>OutPut To?:</b> <asp:RadioButtonList ID="RadioButtonList3" RepeatLayout="Flow"  CellSpacing="1" RepeatColumns="5" Font-Bold ="true" runat="server">
         ...
         <tr><td>
          ...
          <asp:FormView ID="FormView1" Visible="false" runat="server" 
              ...
              <ItemTemplate>
                  pstmisc:
                  <asp:Label ID="pstmiscLabel" runat="server" 
                      Text='<%# Bind("pstmisc") %>'></asp:Label><br />  
                  ext:
          ...
          <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
              SelectMethod="EditPstArMiscReceiptReport" TypeName="account">
              <SelectParameters>
                  ...
                  <asp:Parameter Name="prmIn" Type="String" />                  
