<%@ Page Language="c#" AutoEventWireup="true" Debug="true" Inherits="glinv_summary" Codebehind="glinv_summary.aspx.cs" %>
<%@ Register Src="footer.ascx" TagName="Footer" TagPrefix="ft" %>
<%@ Register Src="header.ascx" TagName="Header" TagPrefix="hd" %>
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head id="Head1" runat="server">
    <title>GL Invoive Summary</title>
    ...
    <form id="frmList" runat="server"  defaultfocus='TextBox1'>   
      ...
      <TABLE id="tblTop" cellSpacing="3" align="center" border="0" Width="100%">
        <TR>
          ...
          <TD align=center nowrap><font size=+0><b>GL Invoive Summary&nbsp;</b></font></TD>
     ...
     <fieldset style="width:520px" class="shade" ><legend>Selection Parameters</legend>
      <table class="shade" height="100px" width="520px">    
      <tr height="70px"><td><br /></td></tr>
          ...
          <asp:FormView ID="FormView1" Visible="false" runat="server" DataSourceID="ObjectDataSource1">
              ...
              <ItemTemplate>
                  ...
                  <asp:Label ID="invsumLabel" runat="server" Text='<%# Bind("[invsum]") %>'></asp:Label><br />
          ...
          <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
              SelectMethod="GLInvoiceSummary" TypeName="ledger">
              <SelectParameters>
                  <asp:Parameter Name="prmUser" Type="String" />
                  <asp:Parameter Name="prmAction" Type="String" />
                  <asp:Parameter Name="prmchart" Type="String" />
