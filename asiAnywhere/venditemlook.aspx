<%@ Page Language="C#" AutoEventWireup="True" Debug="true" Codebehind="venditemlook.aspx.cs" Inherits="venditemlook" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Vendor Item Lookup</title>   
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800">&nbsp;                
                <B>Search for:&nbsp; </B>&nbsp;&nbsp;&nbsp;
                  <asp:dropdownlist id="ddlSearchField" runat="server">
                      <asp:ListItem Value="vend-i-no">VendorItem#</asp:ListItem>  
    ...
    <div>
            ...
            <Columns>
             <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.VendItemLook('<%#DataBinder.Eval(Container,"DataItem.vend-i-no")%>','<%#DataBinder.Eval(Container,"DataItem.i-no")%>','<%#DataBinder.Eval(Container,"DataItem.cust")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>     
                 <asp:BoundField DataField="vend-i-no" HeaderText="VendorItem#" SortExpression="vend-i-no" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="SelectVendItem" TypeName="browsinvoice">
            <SelectParameters>               
