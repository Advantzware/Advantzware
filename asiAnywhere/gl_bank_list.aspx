<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="gl_bank_list" Codebehind="gl_bank_list.aspx.cs" %>
...
function printgl() {
   ...
   <body>
    <form id="frmList" runat="server"  defaultfocus='jurl_TextBox'>   
      ...
      <asp:LinkButton ID="lnk_Listcustomers" runat="server" >Browse Bank </asp:LinkButton></li>
      <li><asp:LinkButton ID="lnk_viewcustomers" runat="server" OnClick="lnk_viewcustomers_Click" > View Bank</asp:LinkButton></li></ul></div>
          ...
          <TD><fieldset>
            <TABLE id="tblSearch" cellSpacing="1" cellPadding="5" width="100%" border="0" class="shade" bgcolor="gray" >
              <TR >
                ...
                <b>Bank</b> <br />
                <asp:TextBox ID="bnk_TextBox" Width="100px" runat="server"></asp:TextBox>                    
                </td>
                <td><b> Account#</b><br />
                    <asp:TextBox ID="act_TextBox" Width="100px" runat="server"></asp:TextBox>                    </td>
                    <td><b> Phone</b><br />
                    <asp:TextBox ID="phn_TextBox" Width="100px" runat="server"></asp:TextBox>                    </td>
        ...
        <tr><td> 
            <asp:GridView ID="GridView1" runat="server" DataSourceID="ObjectDataSource1" EmptyDataText=" Records not  Found" AllowPaging="True" AllowSorting="True" Width="600px" AutoGenerateColumns="False" BorderStyle="Dotted" CssClass="Grid" OnSelectedIndexChanged="GridView1_SelectedIndex">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="bank-code" HeaderText="Bank" SortExpression="bank-code" />
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                ...
                <SelectParameters>
                   ...
                   <asp:SessionParameter SessionField="general_bank_no" Name="prmBankcode" Type="String" />
                   <asp:Parameter Name="prmBankname" Type="String" />                   
                   ...
                   <asp:SessionParameter SessionField="general_phone" Name="prmPhone" Type="String" />
                   <asp:Parameter Name="prmContact" Type="String" />
                   <asp:Parameter Name="prmBkact" Type="String" />
                   <asp:SessionParameter SessionField="general_account" Name="prmActnum" Type="String" />
