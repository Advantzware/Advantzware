<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="cshrcpt_entr_report" Codebehind="cshrcpt_entr_report.aspx.cs" %>
<%@ Register Src="footer.ascx" TagName="Footer" TagPrefix="ft" %>
<%@ Register Src="header.ascx" TagName="Header" TagPrefix="hd" %>
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head id="Head1" runat="server">
    <title>Cash Receipts Edit/Post Register</title>
...
<script language="javascript">
    function confirmPost() {
        var retVal = makeMsgBox("Confirmation", "Post Cash Receipts?", 48, 4, 256, 4096);
        if (retVal == 6) {
    ...
    <form id="frmList" runat="server"  defaultfocus='TextBox1'>   
      ...
      <TABLE id="tblTop" cellSpacing="3" align="center" border="0" Width="100%">
        <TR>
          ...
          <TD align=left nowrap><font size=+0><b>Cash Receipts Edit/Post Register&nbsp;</b></font></TD>
      ...
      <tr>
        ...
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;            
          ...
          <asp:FormView ID="FormView1" Visible="false" runat="server" 
              ...
              <ItemTemplate>
                  cash:
                  <asp:Label ID="cashLabel" runat="server" 
                      Text='<%# Bind("cash") %>'></asp:Label><br />  
                  ext:
          ...
          <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
              SelectMethod="EditPostCashReceiptReport" TypeName="account">
              <SelectParameters>
