<%@ Page Language="C#" AutoEventWireup="true" Inherits="Invcustomer_lookup" Title="Customer Lookup" Codebehind="Invcustomer_lookup.aspx.cs" %>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800">&nbsp;                
    ...
    <div>
            ...
            <Columns > 
              <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.CustomerLookup('<%#DataBinder.Eval(Container,"DataItem.InvCustomer")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="InvCustomer" HeaderText="Cust #" SortExpression="InvCustomer" >
                    <ItemStyle Wrap="False" />
                </asp:BoundField>
                <asp:BoundField DataField="InvName" HeaderText="Customer Name" SortExpression="InvName" >
                    <ItemStyle Wrap="False" />
                </asp:BoundField>
                <asp:BoundField DataField="Invcity" HeaderText="City" SortExpression="Invcity" >
                    <ItemStyle Wrap="False" />
                </asp:BoundField>
                <asp:BoundField DataField="Invstate" HeaderText="State" SortExpression="Invstate" >
                    <ItemStyle Wrap="False" />
                </asp:BoundField>
                <asp:BoundField DataField="Invzip" HeaderText="Zip Code" SortExpression="Invzip" >
                    <ItemStyle Wrap="False" />
                </asp:BoundField>
                <asp:BoundField DataField="Invtype" HeaderText="Customer Type" SortExpression="Invtype" >
                    <ItemStyle Wrap="False" />
                </asp:BoundField>
                <asp:BoundField DataField="Invsman" HeaderText="Salesman" SortExpression="Invsman" >
                    <ItemStyle Wrap="False" />
                </asp:BoundField>
                <asp:BoundField DataField="Invterr" HeaderText="Sales Territory" SortExpression="Invterr" >
                    <ItemStyle Wrap="False" />
                </asp:BoundField>
                </Columns>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="InvCustomer" TypeName="Order">
            <SelectParameters>
