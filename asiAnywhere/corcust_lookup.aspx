<%@ Page Language="C#" AutoEventWireup="true" Inherits="corcust_lookup" Codebehind="corcust_lookup.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Cust Lookup</title>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800">&nbsp;                
                <B>Search for:&nbsp; </B>&nbsp;&nbsp;&nbsp;
                  <asp:dropdownlist id="ddlSearchField" runat="server">
                    <asp:ListItem Value="Any">Any</asp:ListItem>
                      ...
                      <asp:ListItem Value="name">Cust Name </asp:ListItem>  
    ...
    <div>
        <asp:GridView ID="GridView1"  AllowPaging="True" runat="server" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1"
            ...
            <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.currcustLookup('<%#DataBinder.Eval(Container,"DataItem.CustNum")%>','<%#DataBinder.Eval(Container,"DataItem.CustName")%>','<%#DataBinder.Eval(Container,"DataItem.shipto")%>','<%#DataBinder.Eval(Container,"DataItem.ShipName")%>','<%#DataBinder.Eval(Container,"DataItem.ShipAddr1")%>','<%#DataBinder.Eval(Container,"DataItem.ShipAddr2")%>','<%#DataBinder.Eval(Container,"DataItem.ShipCity")%>','<%#DataBinder.Eval(Container,"DataItem.ShipState")%>','<%#DataBinder.Eval(Container,"DataItem.ShipZip")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField> 
                <asp:BoundField DataField="CustNum" HeaderText="CustNum" SortExpression="CustNum" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="SelectCust" TypeName="Corrugated">
            <SelectParameters>               
