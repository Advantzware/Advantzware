<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="vend_1099rep" Codebehind="~/vend_1099rep.aspx.cs" %>
<%@ Register Src="footer.ascx" TagName="Footer" TagPrefix="ft" %>
<%@ Register Src="header.ascx" TagName="Header" TagPrefix="hd" %>
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head id="Head1" runat="server">
    <title>Vendor 1099 Report</title>  
    ...
    <form id="frmList" runat="server"  defaultfocus='begvendTextBox'>   
      ...
      <TABLE id="tblTop" cellSpacing="3" align="center" border="0" Width="100%">
        <TR>
          ...
          <TD align=center nowrap><font size=+0><b>Vendor 1099 Report &nbsp;</b></font></TD>
     ...
     <tr><td align="right" style="padding-right: 5px"><b>Beginning Vendor#:</b></td>
          <td nowrap><asp:TextBox ID="begvendTextBox" Width="100px" MaxLength="8" runat="server"></asp:TextBox>
        ...
        <td align="right" style="padding-right: 5px"><b>Ending Vendor#:</b></td>
          <td nowrap><asp:TextBox ID="endvendTextBox"  Width="100px" MaxLength="8" runat="server"></asp:TextBox>
        ...
        <tr><td align="right" style="padding-right: 5px" colspan="2">
          <b><asp:RadioButtonList ID="RadioButtonList1" RepeatLayout="Flow"  CellSpacing="1" RepeatColumns="5" Font-Bold ="true" runat="server">
                 ...
                 <asp:ListItem  Value="Invoice"    Text="Invoice Date" />
                  <asp:ListItem Value="Check"    Text="Check Date" />
                 
         </asp:RadioButtonList></b>
          </td>
       
          </tr>
          <tr><td align="right" style="padding-right:5px"><b>Beginning Invoice Date:</b></td>
          <td>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>OutPut To?:</b> <asp:RadioButtonList ID="RadioButtonList3" RepeatLayout="Flow"  CellSpacing="1" RepeatColumns="5" Font-Bold ="true" runat="server">
         ...
         <tr><td colspan="4">
          ...
          <asp:FormView ID="FormView1" Visible="False"   runat="server" 
              ...
              <ItemTemplate>
                  ven1099:
                  <asp:Label ID="ven1099Label" runat="server" 
                      Text='<%# Bind("ven1099") %>'></asp:Label><br />
          ...
          <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
               SelectMethod="Vendor1099Report" TypeName="voucherpay">
              <SelectParameters>
