<%@ Page Language="c#" AutoEventWireup="true" Debug="false" Inherits="status_copylookup" Codebehind="status_copylookup.aspx.cs" %>
  ...
  <head id="Head1" runat="server">
   ...
   <body>
    <form id="frmList" runat="server"  defaultfocus='txtSearchValue'  DefaultButton="btnSearch">           
      <div>                 
      <TABLE id="tblMain" cellSpacing="1" cellPadding="1" width="450px" align='left' border="0">
        <TR>
          <TD>
            <TABLE id="tblSearch" cellSpacing="1" cellPadding="5" border="0"  width="450px" bgcolor=black>
              <TR>
                <TD class="shade" align="center" width="45"><nobr>
                  <asp:button id="btnSearch" Width="40px" runat="server" CssClass="button" Text="Go" OnClick="btnSearch_Click"></asp:button><br /><br />
                  <asp:button id="btnShowAll" Width="40px" runat="server" CssClass="button" Text="All" OnClick="btnShowAll_Click"></asp:button>
                </TD>               
          ...
          <input type="checkbox" name="chDelete" value='<%#DataBinder.Eval(Container,"RowIndex")%>'/>
                ...
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.statusCopyLookup('<%#DataBinder.Eval(Container,"DataItem.status_code")%>','<%#DataBinder.Eval(Container,"DataItem.description")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
