<%@ Page Language="C#" AutoEventWireup="true" CodeFile="coradd_look.aspx.cs" Inherits="corrAdder_look" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Adder Lookup</title>
            ...
            <Columns>
                <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.Machin3Lookup('<%#DataBinder.Eval(Container,"DataItem.vMcode")%>','<%#DataBinder.Eval(Container,"DataItem.vAttDscr")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>     
                 <asp:BoundField DataField="vMcode" HeaderText="vMcode" SortExpression="vMcode" />
                 <asp:BoundField DataField="vAttType" HeaderText="vAttType" SortExpression="vAttType" />
                 <asp:BoundField DataField="vAttDscr" HeaderText="vAttDscr" SortExpression="vAttDscr" />
                                 
            </Columns>
        </asp:GridView>
        <input type="button" name="close" class="buttonM" id="close" value="Close" onclick="javascript:window.close()" />
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="SelectCorrAdder" TypeName="Corrugated">
            <SelectParameters>               
                ...
                <asp:Parameter Name="prmComp" Type="String" />
                 <asp:QueryStringParameter QueryStringField="mtype" Name="prmMachine" Type="String" />
            </SelectParameters>
