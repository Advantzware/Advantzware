<%@ Page Language="C#" AutoEventWireup="true" Debug="true" Inherits="top_attach_invlist" Codebehind="top_attach_invlist.aspx.cs" %>
...
<body>
    <form id="form1" runat="server" defaultfocus="att_TextBox">
        <div>
              ...
              <TR>
		        ...
		        <tr>
                    ...
                    <br />
                       ...
                       <td nowrap> Attached File:
                            <asp:TextBox ID="att_TextBox" runat="server" Width="65px" ></asp:TextBox>			
                	    </td> 
                       
                       <td nowrap> File Type:
                            <asp:TextBox ID="type_TextBox" runat="server" Width="65px" ></asp:TextBox>			
                	    </td> 
                    <td nowrap="nowrap"> 
                        Created Date:           
			            ...
			            <a href="#" onClick="showCalendarControl(txt_att_date); return false"><asp:Image ID="OrderLook" runat="server" ImageUrl="images/lookup_icon.gif" /></a></td>
           		        ...
           		        <td nowrap> Invoice#:
                            <asp:TextBox ID="txt_att_inv" runat="server" Width="65px" ></asp:TextBox>			
                	    </td>                 
                </tr>
            </table>
                </TD> 
        ...
        <EmptyDataRowStyle BorderStyle="None" BorderWidth="0px" Font-Bold="True"  />
            <Columns>
                ...
                <asp:BoundField DataField="vFGitem" HeaderText="File Type" SortExpression="vFGitem" />
                ...
                <asp:BoundField DataField="vPoNo" HeaderText="Invoice#" SortExpression="vPoNo" />                
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            ...
            <SelectParameters>
                ...
                <asp:SessionParameter SessionField="top_attach_invlist_reckey" DefaultValue="" Name="prmRecKey" Type="String" />
                <asp:Parameter Name="prmAttFile" Type="String" />
                <asp:SessionParameter Name="prmPoNo" SessionField="top_attach_invlist_inv" Type="String" />
