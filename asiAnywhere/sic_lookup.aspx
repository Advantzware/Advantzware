<%@ Page Language="c#" AutoEventWireup="true" Debug="false" CodeFile="sic_lookup.aspx.cs" Inherits="sic_lookup"%>
          ...
          <input type="checkbox" name="chDelete" value='<%#DataBinder.Eval(Container,"RowIndex")%>'/>
            ...
            <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.sicLookup('<%#DataBinder.Eval(Container,"DataItem.industry_sic_code")%>','<%#DataBinder.Eval(Container,"DataItem.description")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
