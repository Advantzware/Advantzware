<%@ Page Language="C#" AutoEventWireup="true" Inherits="usag_look_Plant" Codebehind="usagplant_lookup.aspx.cs" %>
  ...
  <td id="tdSearch" runat="server" class="shade" vAlign="middle" align="center" width="800">&nbsp;                
    ...
    <div>
            ...
            <Columns>
                 <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center Wrap="False" />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.UsagPlantLookup('<%#DataBinder.Eval(Container,"DataItem.PlantCust")%>', '<%#DataBinder.Eval(Container,"DataItem.PlantId")%>', '<%#DataBinder.Eval(Container,"DataItem.DeptCode")%>', '<%#DataBinder.Eval(Container,"DataItem.PlantName")%>', '<%#DataBinder.Eval(Container,"DataItem.PlantShipId")%>', '<%#DataBinder.Eval(Container,"DataItem.VanderCode")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField> 
                <asp:BoundField DataField="PlantCust" HeaderText="PlantCust" SortExpression="PlantCust" />
                ...
                <asp:BoundField DataField="PlantShipId" HeaderText="PlantShipId" SortExpression="PlantShipId" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="UsagPlantLook" TypeName="LookUp">
            <SelectParameters>               
                ...
                <asp:QueryStringParameter QueryStringField="item"  Name="prmFGItem" Type="String" />
                <asp:QueryStringParameter QueryStringField="vander" Name="prmVanderCode" Type="String" />
            </SelectParameters>
