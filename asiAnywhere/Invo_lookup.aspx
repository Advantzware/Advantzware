<%@ Page Language="C#" AutoEventWireup="true" Inherits="Invo_lookup" Title="Invoice LookUp" Codebehind="Invo_lookup.aspx.cs" %>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
            ...
            <asp:TemplateField>
                  <ItemStyle HorizontalAlign=Center />
                   <ItemTemplate>       
		    <a href="#" onClick="javascript:top.opener.window.InvNumLookup('<%#DataBinder.Eval(Container,"DataItem.Invo")%>');window.close();">Select</a>             	    
                   </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="Invo" HeaderText="Invoice#" SortExpression="Invo" />
                <asp:BoundField DataField="InvoItem" HeaderText="Item Number" SortExpression="InvoItem" />
                <asp:BoundField DataField="InvoName" HeaderText="Item Name" SortExpression="InvoName" />
                
            </Columns>
        </asp:GridView>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
         SelectMethod="Invo" TypeName="Order">
            <SelectParameters>
