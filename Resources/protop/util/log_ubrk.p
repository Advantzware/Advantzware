/* log_ubrk.p
 *
 * rule set for ubroker managed log files
 *
 * i.e.
...
subscribe to "ubrk_rules"    anywhere run-procedure "chkRuleCfg".	/* load the rules related to this log type		*/
subscribe to "ubrk_line"     anywhere run-procedure "parse_line".	/* parse the raw log line				*/
