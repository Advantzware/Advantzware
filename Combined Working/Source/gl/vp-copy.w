...
&Scoped-Define ENABLED-OBJECTS RECT-4 Btn-copy 
...
DEFINE BUTTON Btn-copy 
     LABEL "c&Opy Balances to Budgets" 
     SIZE 29 BY 1.19
     FONT 4.
...
ON CHOOSE OF Btn-copy IN FRAME F-Main /* cOpy Balances to Budgets */
DO:
  RUN get-link-handle IN adm-broker-hdl(THIS-PROCEDURE,"record-source",OUTPUT char-hdl).
  IF VALID-HANDLE(WIDGET-HANDLE(char-hdl)) THEN
    RUN copy-bal-to-bud IN WIDGET-HANDLE(char-hdl). 
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE enable-disable-buttons V-table-Win 
PROCEDURE enable-disable-buttons :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
