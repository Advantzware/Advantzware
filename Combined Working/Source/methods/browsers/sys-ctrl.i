...
&Global-define FLDNAME1 sys-ctrl.name
&Global-define FORMAT-1 X(6)
&Global-define SORTBY-1 BY {&FLDNAME1}
&Global-define IDXNAME1 
&Global-define DESCRIP1 
&Global-define FLDNAME2 sys-ctrl.module
&Global-define FORMAT-2 X(5)
&Global-define SORTBY-2 BY {&FLDNAME2} BY {&FLDNAME1} 
&Global-define IDXNAME2 
&Global-define DESCRIP2 
&Global-define FLDNAME3 sys-ctrl.descrip
&Global-define FORMAT-3 X(25)
&Global-define SORTBY-3 BY {&FLDNAME3} BY {&FLDNAME2} BY {&FLDNAME1}
