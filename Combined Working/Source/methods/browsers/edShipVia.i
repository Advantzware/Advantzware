...
&Global-define FLDNAME1 string(edShipVia.carrier)
&Global-define FORMAT-1 X(8)
&Global-define SORTBY-1 BY edShipVia.carrier
&Global-define IDXNAME1 
&Global-define DESCRIP1 Carrier
&Global-define FLDNAME2 edShipVia.carrier-code
&Global-define FORMAT-2 X(10)
&Global-define SORTBY-2 BY edShipVia.carrier-code
&Global-define IDXNAME2 
&Global-define DESCRIP2 SCAC
