...
&IF "{&IAM}" = "usrcmp-c" &THEN
&Global-define FLDNAME1 usercomp.company
&Global-define FORMAT-1 X(8)
&Global-define SORTBY-1 
&Global-define IDXNAME1 
&Global-define DESCRIP1 Company
&Global-define FLDNAME2 company.name
&Global-define FORMAT-2 X(30)
&Global-define SORTBY-2 
&Global-define IDXNAME2 
&Global-define DESCRIP2 Name
&ELSEIF "{&IAM}" = "usrcmp-l" &THEN
&Global-define FLDNAME1 usercomp.loc
&Global-define FORMAT-1 X(8)
&Global-define SORTBY-1 
&Global-define IDXNAME1 
&Global-define DESCRIP1 Location
&Global-define FLDNAME2 loc.dscr
&Global-define FORMAT-2 X(30)
&Global-define SORTBY-2 
&Global-define IDXNAME2 
