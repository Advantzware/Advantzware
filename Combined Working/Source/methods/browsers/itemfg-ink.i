...
&Global-define FLDNAME1 itemfg-ink.rm-i-no
&Global-define FORMAT-1 X(10)
&Global-define SORTBY-1 BY item.press-type BY {&FLDNAME1}
&Global-define IDXNAME1 
&Global-define DESCRIP1 RM Item#
&Global-define FLDNAME2 itemfg-ink.dscr
&Global-define FORMAT-2 X(30)
&Global-define SORTBY-2 BY item.press-type BY {&FLDNAME2}
