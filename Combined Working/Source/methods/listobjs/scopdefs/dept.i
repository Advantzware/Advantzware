...
&{&DEFINETYPE}-define TABLENAME dept
&{&DEFINETYPE}-define DBFIELD1 dept.code
&{&DEFINETYPE}-define BEGINFLD1 begin_dept
&{&DEFINETYPE}-define BEGIN-DEFAULT-1 yes
&{&DEFINETYPE}-define ENDFLD1 end_dept
&{&DEFINETYPE}-define END-DEFAULT-1 yes
&{&DEFINETYPE}-define DBFIELD2 dept.dscr
&{&DEFINETYPE}-define BEGINFLD2 begin_dept_dscr
&{&DEFINETYPE}-define BEGIN-DEFAULT-2 yes
&{&DEFINETYPE}-define ENDFLD2 end_dept_dscr
...
&{&DEFINETYPE}-define LISTORDER Department,Description
...
&{&DEFINETYPE}-define SAVENAME dept
