...
&{&DEFINETYPE}-define TABLENAME ventype
&{&DEFINETYPE}-define DBFIELD1 ventype.type
&{&DEFINETYPE}-define BEGINFLD1 begin_ventype
&{&DEFINETYPE}-define BEGIN-DEFAULT-1 yes
&{&DEFINETYPE}-define ENDFLD1 end_ventype
&{&DEFINETYPE}-define END-DEFAULT-1 yes
&{&DEFINETYPE}-define DBFIELD2 ventype.Dscr
&{&DEFINETYPE}-define BEGINFLD2 begin_ventype_Dscr
&{&DEFINETYPE}-define BEGIN-DEFAULT-2 yes
&{&DEFINETYPE}-define ENDFLD2 end_ventype_Dscr
...
&{&DEFINETYPE}-define LISTORDER Vendor Type,Description
...
&{&DEFINETYPE}-define SAVENAME ventype
