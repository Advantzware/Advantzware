...
&{&DEFINETYPE}-define DBFIELD2 item.i-name
&{&DEFINETYPE}-define BEGINFLD2 begin_item_i-name
&{&DEFINETYPE}-define BEGIN-DEFAULT-2 yes
&{&DEFINETYPE}-define ENDFLD2 end_item_i-name
...
&{&DEFINETYPE}-define LISTORDER Item No,Name
...
&{&DEFINETYPE}-define SAVENAME item
