...
&{&DEFINETYPE}-define TABLENAME sman
&{&DEFINETYPE}-define DBFIELD1 sman.sman
&{&DEFINETYPE}-define BEGINFLD1 begin_sman
&{&DEFINETYPE}-define BEGIN-DEFAULT-1 yes
&{&DEFINETYPE}-define ENDFLD1 end_sman
&{&DEFINETYPE}-define END-DEFAULT-1 yes
&{&DEFINETYPE}-define DBFIELD2 sman.sname
&{&DEFINETYPE}-define BEGINFLD2 begin_sman_sname
&{&DEFINETYPE}-define BEGIN-DEFAULT-2 yes
&{&DEFINETYPE}-define ENDFLD2 end_sman_sname
...
&{&DEFINETYPE}-define LISTORDER Sales Rep,Sales Rep Name
...
&{&DEFINETYPE}-define SAVENAME sman
