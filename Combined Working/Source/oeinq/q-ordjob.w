...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH job WHERE job.company = oe-ordl.company ~
  AND job.job-no = oe-ordl.job-no ~
  AND job.job-no2 = oe-ordl.job-no2 NO-LOCK, ~
      EACH job-hdr OF job NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main job job-hdr
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main job
&Scoped-define SECOND-TABLE-IN-QUERY-Query-Main job-hdr
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "ASI.job WHERE ASI.oe-ordl ... ... ...,ASI.job-hdr OF ASI.job"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _JoinCode[1]      = "ASI.job.company = ASI.oe-ordl.company
  AND ASI.job.job-no = ASI.oe-ordl.job-no
  AND ASI.job.job-no2 = ASI.oe-ordl.job-no2"
