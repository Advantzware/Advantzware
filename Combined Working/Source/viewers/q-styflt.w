...
&Scoped-define QUERY-STRING-Query-Main FOR EACH flute WHERE TRUE /* Join to style incomplete */ ~
      AND flute.company = g_company NO-LOCK ~
    BY flute.code
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH flute WHERE TRUE /* Join to style incomplete */ ~
      AND flute.company = g_company NO-LOCK ~
    BY flute.code.
&Scoped-define TABLES-IN-QUERY-Query-Main flute
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main flute
...
<FOREIGN-KEYS>
company||y|ASI.flute.company
code||y|ASI.flute.code
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "ASI.flute WHERE ASI.style <external> ..."
     _Options          = "NO-LOCK KEY-PHRASE"
     _OrdList          = "ASI.flute.code|yes"
     _Where[1]         = "ASI.flute.company = g_company"
...
------------------------------------------------------------------------------*/
  ...
  IF NOT AVAIL style AND NOT AVAIL flute THEN do:
     FIND FIRST flute NO-LOCK WHERE flute.company = g_company NO-ERROR.
     IF AVAIL flute THEN RUN dispatch ('row-changed').
  END.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "company" "flute" "company"}
  {src/adm/template/sndkycas.i "code" "flute" "code"}
