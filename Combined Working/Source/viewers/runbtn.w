...
ASSIGN 
       btn_cal:PRIVATE-DATA IN FRAME F-Main     = 
                "panel-image".

ASSIGN 
       btn_depth:PRIVATE-DATA IN FRAME F-Main     = 
                "panel-image".

ASSIGN 
       btn_eff:PRIVATE-DATA IN FRAME F-Main     = 
                "panel-image".
...
&Scoped-define SELF-NAME btn_cal
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn_cal V-table-Win
...
&Scoped-define SELF-NAME btn_depth
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn_depth V-table-Win
...
&Scoped-define SELF-NAME btn_eff
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn_eff V-table-Win
ON CHOOSE OF btn_eff IN FRAME F-Main /* Eff/Qty */
DO:
