...
DEFINE FRAME F-Main
     ...
     notes.note_code AT ROW 1.33 COL 14 COLON-ALIGNED
          ...
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     spec-desc AT ROW 1.33 COL 23 COLON-ALIGNED NO-LABEL
     cbTitle AT ROW 2.52 COL 14 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     ...
     notes.note_text AT ROW 3.71 COL 16 NO-LABEL
          ...
          SIZE 106 BY 9.29
     notes.createDate AT ROW 12.95 COL 23 COLON-ALIGNED WIDGET-ID 4
          LABEL "Created Date"
          VIEW-AS FILL-IN 
          SIZE 14 BY 1
     notes.createTime AT ROW 12.95 COL 51.4 COLON-ALIGNED WIDGET-ID 6
          LABEL "Time"
          VIEW-AS FILL-IN 
          SIZE 14 BY 1
     notes.createUser AT ROW 12.95 COL 83.6 COLON-ALIGNED WIDGET-ID 8
          LABEL "User ID"
          VIEW-AS FILL-IN 
          SIZE 14 BY 1
     btProgram AT ROW 13.62 COL 105 WIDGET-ID 16
     notes.updateDate AT ROW 13.91 COL 23 COLON-ALIGNED WIDGET-ID 10
          LABEL "Last Updated Date"
          VIEW-AS FILL-IN 
          SIZE 14 BY 1
     notes.updateTime AT ROW 13.91 COL 51.4 COLON-ALIGNED WIDGET-ID 12
          LABEL "Time"
          VIEW-AS FILL-IN 
          SIZE 14 BY 1
     notes.updateUser AT ROW 13.91 COL 83.6 COLON-ALIGNED WIDGET-ID 14
          LABEL "User ID"
          VIEW-AS FILL-IN 
          SIZE 14 BY 1
...
END.
notes.note_code:SCREEN-VALUE IN FRAME {&FRAME-NAME} = gvcNoteType.
