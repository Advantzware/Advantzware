...
PUT 
     "<FArial>"   SKIP
       ...
       "<C2><R2><#1><R+10><C+50><IMAGE#1=" ls-full-img1  SKIP     
   /*"<C1><#1><R+5><C+25>" SKIP 
...
PUT
    ...
    /*IF lv-display-comp THEN 
      ...
      PUT "<FArial><=4><R+1>       Buyer                         Contact                                         Terms                        FOB              Ship Via                        Freight" SKIP
          "<FCourier New><=4><R+3> " po-ord.buyer    po-ord.contact FORM "x(25)" terms.dscr FORM "x(23)" po-ord.fob-code space(2) cCarrierDscr  FORM "x(20)" v-freight-dscr
          .
      ...
      PUT "<|10><R25><C1><#5><FROM><R27><C80><RECT>" SKIP    
             ...
             .
      PUT "<FArial><=5><C7>"
          "<=5><R+1> Line       Quantity           UOM          Item/Description                                                                           Cost         UOM      Ext Cost" SKIP(1).
      PUT "<FCourier New>"          .
