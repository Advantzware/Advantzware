...
&scoped-define SORTBY-2 BY po-ordl.vend-i-no
...
po-ordl.i-name po-ordl.job-no po-ordl.job-no2 po-ordl.vend-i-no ~
po-ord.vend-no po-ordl.s-wid po-ordl.s-len 
...
&Scoped-Define ENABLED-OBJECTS BROWSE-1 RECT-1 rd-sort bt-ok bt-cancel ~
bt-clear lv-search 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-1 Dialog-Frame _STRUCTURED
  QUERY BROWSE-1 NO-LOCK DISPLAY
      ...
      po-ordl.i-no FORMAT "x(15)":U COLUMN-FONT 0
      po-ordl.i-name FORMAT "x(30)":U COLUMN-FONT 0
      po-ordl.job-no COLUMN-LABEL "Job #" FORMAT "x(6)":U COLUMN-FONT 0
      po-ordl.job-no2 COLUMN-LABEL "" FORMAT ">9":U COLUMN-FONT 0
      po-ordl.vend-i-no FORMAT "x(15)":U COLUMN-FONT 0
      po-ord.vend-no FORMAT "x(8)":U COLUMN-FONT 0
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 146 BY 11.43
         BGCOLOR 8 FONT 0.
...
DEFINE FRAME Dialog-Frame
     ...
     bt-ok AT ROW 14.1 COL 113
     bt-cancel AT ROW 14.1 COL 123
...
/* Query rebuild information for BROWSE BROWSE-1
     ...
     _Where[1]         = "po-ordl.deleted = no and
po-ordl.stat <> ""C"" and
po-ordl.item-type = no
"
     _JoinCode[2]      = "po-ord.company eq po-ordl.company and
po-ord.po-no eq po-ordl.po-no"
     _Where[2]         = "ASI.po-ord.stat <> ""H"""
     _FldNameList[1]   > ASI.po-ordl.po-no
"po-ordl.po-no" "PO#" ? "integer" ? ? 0 ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > ASI.po-ordl.i-no
"po-ordl.i-no" ? ? "character" ? ? 0 ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > ASI.po-ordl.i-name
"po-ordl.i-name" ? ? "character" ? ? 0 ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > ASI.po-ordl.job-no
"po-ordl.job-no" "Job #" ? "character" ? ? 0 ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > ASI.po-ordl.job-no2
"po-ordl.job-no2" "" ? "integer" ? ? 0 ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > ASI.po-ordl.vend-i-no
"po-ordl.vend-i-no" ? ? "character" ? ? 0 ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > ASI.po-ord.vend-no
"po-ord.vend-no" ? ? "character" ? ? 0 ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > ASI.po-ordl.s-wid
"po-ordl.s-wid" "Sheet!Wid" ? "decimal" ? ? 0 ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > ASI.po-ordl.s-len
"po-ordl.s-len" "Sheet!Len" ? "decimal" ? ? 0 ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-1 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
  ...
  ENABLE BROWSE-1 RECT-1 rd-sort bt-ok bt-cancel bt-clear lv-search 
      WITH FRAME Dialog-Frame.
