...
03.11.98 by CAH on \\ricky\robj8\ Log#0000:
1.  Initial write from ed/rms/i8503020.p for Royal Pioneer.
**
*****************************************************************************
\***************************************************************************/
bell.
run rc/debugmsg.p ("top of " + program-name(1)).
...
dtl_rec_code = 70. /* X ANSI version, Note that VICS=21. */
...
DO:
  ...
  DO:
    BELL.
    MESSAGE error-status:error error-status:get-number(1).
    PAUSE.
  END.
END.
ELSE
