...
find first inv-head where company = '001' and inv-no eq 8102.
message "inv-ehad.cust" inv-head.cust-no inv-head.bill-to view-as alert-box.

DEF /* INPUT PARAM */ var i_rec               AS RECID NO-UNDO.
DEF /* INPUT PARAM */ var original_print      AS LOGICAL NO-UNDO.
DEF var /* INPUT PARAM */ force_asn           AS LOGICAL INITIAL FALSE.
i_rec = recid(inv-head).
...
DO:
  ...
  message "not cust" ws_billto view-as alert-box.
  ...
  DO:
    ...
    DO searchx = 1 TO 2:
      ...
      "ed" + dirsep + edco.system + dirsep + "o" + TRIM(edcode.setid) +
        ...
        ELSE "")
        + ".p".
        message "next_program" next_program view-as alert-box.
