...
PUT "<C1><R5><#1><R+7><C+33><IMAGE#1=" ls-full-img1 SKIP
    "<FArial>".
PUT "<=1>" SKIP.
/*
PUT "<C1><R5><#2>" 
...
PUT "<FArial><P12><=#3><C45><R-2> <B>Credit/Debit Memo #: " ar-cash.check-no FORMAT ">>>>>>>>>9" "<P10>             Page: </B>" string(PAGE-NUM - v-page-num,">>9") SKIP
...
PUT 
    ...
    "<R26><C20><FROM><R28><C20><LINE><||3>"    SKIP
    "<R26><C27><FROM><R28><C27><LINE><||3>"    SKIP
...
PUT "<FArial><=5><R26>                                                                                                                                                                                            Amount "
    SKIP.                                                                                                                                                                  
PUT "<FArial><=5><R+1>   Invoice #             PO#               Order                                  Memo Description                                                               Applied"
    SKIP(1).
