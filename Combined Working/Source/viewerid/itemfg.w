...
DEFINE FRAME F-Main
     btnFirst AT ROW 1.48 COL 135
     btnPrevious AT ROW 1.48 COL 140
     btnNext AT ROW 1.48 COL 145
     btnLast AT ROW 1.48 COL 150
     itemfg.i-no AT ROW 1.71 COL 12 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 30 BY 1
     itemfg.i-name AT ROW 1.71 COL 43 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 40 BY 1
     itemfg.i-dscr AT ROW 1.71 COL 84 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 40 BY 1
