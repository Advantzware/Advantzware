...
DEFINE VARIABLE h_b-itemfgh AS HANDLE NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-2 D-Dialog _FREEFORM
  ...
  QUERY BROWSE-2 DISPLAY
    ...
    WITH NO-ROW-MARKERS SEPARATORS MULTIPLE SIZE 313 BY 21.78
...
/*     btn_go AT ROW 1.48 COL 56
     ...
     Btn_Cancel AT ROW 25.52 COL 60 */
     SPACE(101.19) SKIP(1.57)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER WIDTH 314
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-itemfgh ).
       RUN set-position IN h_b-itemfgh ( 1.00 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 20.00 , 83.40 ) */

       RUN set-parent IN h_b-itemfgh (INPUT THIS-PROCEDURE).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-itemfgh ,
