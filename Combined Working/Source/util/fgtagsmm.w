...
DEFINE VARIABLE h_fgtags-mismatch1 AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* FG Tag Item# Mismatches */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* FG Tag Item# Mismatches */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'util/fgtags-mismatch1.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_fgtags-mismatch1 ).
       RUN set-position IN h_fgtags-mismatch1 ( 4.57 , 4.00 ) NO-ERROR.
       RUN set-size IN h_fgtags-mismatch1 ( 19.52 , 92.00 ) NO-ERROR.
