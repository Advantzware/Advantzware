...
&Scoped-Define ENABLED-OBJECTS RECT-2 RECT-1 list-order begin_custype ~
end_custype 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_custype ~
begin_custype_dscr end_custype end_custype_dscr F1 F-2 F-3 F-4 
...
DEFINE VARIABLE begin_custype AS CHARACTER FORMAT "X(8)" 
     LABEL "Beginning  Customer Type" 
     VIEW-AS FILL-IN 
     SIZE 15.6 BY 1.

DEFINE VARIABLE begin_custype_dscr AS CHARACTER FORMAT "X(20)" 
     LABEL "Beginning Description" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE end_custype AS CHARACTER FORMAT "X(8)" 
     LABEL "Ending Customer Type" 
     VIEW-AS FILL-IN 
     SIZE 15.6 BY 1.

DEFINE VARIABLE end_custype_dscr AS CHARACTER FORMAT "X(20)" 
...
DEFINE FRAME F-Main
     ...
     begin_custype AT ROW 4.81 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Customer Type"
     begin_custype_dscr AT ROW 6 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Description"
     end_custype AT ROW 8.14 COL 45 COLON-ALIGNED HELP
          "Enter Ending Customer Type"
     end_custype_dscr AT ROW 9.33 COL 45 COLON-ALIGNED HELP
...
/* SETTINGS FOR FILL-IN begin_custype_dscr IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN end_custype_dscr IN FRAME F-Main
   NO-ENABLE                                                            */
