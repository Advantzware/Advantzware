...
&Scoped-Define ENABLED-OBJECTS RECT-1 RECT-2 list-order begin_uom end_uom 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_uom begin_uom_dscr ~
end_uom end_uom_dscr F1 F-2 F-3 F-4 
...
DEFINE VARIABLE begin_uom AS CHARACTER FORMAT "X(4)" 
     LABEL "Beginning  Unit of Measure" 
     VIEW-AS FILL-IN 
     SIZE 9 BY 1.

DEFINE VARIABLE begin_uom_dscr AS CHARACTER FORMAT "X(30)" 
     LABEL "Beginning Description" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE end_uom AS CHARACTER FORMAT "X(4)" 
     LABEL "Ending Unit of Measure" 
     VIEW-AS FILL-IN 
     SIZE 9 BY 1.

DEFINE VARIABLE end_uom_dscr AS CHARACTER FORMAT "X(30)" 
...
DEFINE FRAME F-Main
     ...
     begin_uom AT ROW 4.81 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Unit of Measure"
     begin_uom_dscr AT ROW 6 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Description"
     end_uom AT ROW 8.14 COL 45 COLON-ALIGNED HELP
          "Enter Ending Unit of Measure"
     end_uom_dscr AT ROW 9.33 COL 45 COLON-ALIGNED HELP
          "Enter Ending Description"
     F1 AT ROW 4.81 COL 56 NO-LABEL
     F-2 AT ROW 6 COL 91 NO-LABEL
     F-3 AT ROW 8.14 COL 56 NO-LABEL
...
/* SETTINGS FOR FILL-IN begin_uom_dscr IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN end_uom_dscr IN FRAME F-Main
   NO-ENABLE                                                            */
