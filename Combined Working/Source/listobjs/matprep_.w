...
&Scoped-Define ENABLED-OBJECTS RECT-2 RECT-1 list-order begin_mat end_mat 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_mat begin_matprep_dscr ~
end_mat end_matprep_dscr F1 F-2 F-3 F-4 
...
DEFINE VARIABLE begin_mat AS CHARACTER FORMAT "X(5)" 
     LABEL "Beginning  Preperation Material" 
     VIEW-AS FILL-IN 
     SIZE 11 BY 1.

DEFINE VARIABLE begin_matprep_dscr AS CHARACTER FORMAT "X(30)" 
     LABEL "Beginning Description" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE end_mat AS CHARACTER FORMAT "X(5)" 
     LABEL "Ending Preperation Material" 
     VIEW-AS FILL-IN 
     SIZE 11 BY 1.

DEFINE VARIABLE end_matprep_dscr AS CHARACTER FORMAT "X(30)" 
...
DEFINE FRAME F-Main
     ...
     begin_mat AT ROW 4.81 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Preperation Material"
     begin_matprep_dscr AT ROW 6 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Description"
     end_mat AT ROW 8.14 COL 45 COLON-ALIGNED HELP
          "Enter Ending Preperation Material"
     end_matprep_dscr AT ROW 9.33 COL 45 COLON-ALIGNED HELP
...
/* SETTINGS FOR FILL-IN begin_matprep_dscr IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN end_matprep_dscr IN FRAME F-Main
   NO-ENABLE                                                            */
