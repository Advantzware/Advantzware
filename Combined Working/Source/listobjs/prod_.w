...
&Scoped-Define ENABLED-OBJECTS RECT-2 RECT-1 list-order begin_prolin ~
end_prolin show-catagories 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_prolin begin_prod_dscr ~
end_prolin end_prod_dscr show-catagories F1 F-2 F-3 F-4 
...
DEFINE VARIABLE begin_prod_dscr AS CHARACTER FORMAT "X(30)" 
     LABEL "Beginning Description" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE begin_prolin AS CHARACTER FORMAT "X(8)" 
     LABEL "Beginning  Product Line" 
     VIEW-AS FILL-IN 
     SIZE 15.6 BY 1.

DEFINE VARIABLE end_prod_dscr AS CHARACTER FORMAT "X(30)" 
     LABEL "Ending Description" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE end_prolin AS CHARACTER FORMAT "X(8)" 
...
DEFINE VARIABLE show-catagories AS LOGICAL INITIAL no 
     LABEL "Show Catagories" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME F-Main
     ...
     begin_prolin AT ROW 3.86 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Product Line"
     begin_prod_dscr AT ROW 5.05 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Description"
     end_prolin AT ROW 7.19 COL 45 COLON-ALIGNED HELP
          "Enter Ending Product Line"
     end_prod_dscr AT ROW 8.38 COL 45 COLON-ALIGNED HELP
          "Enter Ending Description"
     show-catagories AT ROW 10.29 COL 47 HELP
          "Select to Show Catagories"
     F1 AT ROW 3.86 COL 63 NO-LABEL
     F-2 AT ROW 5.05 COL 91 NO-LABEL
     F-3 AT ROW 7.19 COL 63 NO-LABEL
...
/* SETTINGS FOR FILL-IN begin_prod_dscr IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN end_prod_dscr IN FRAME F-Main
   NO-ENABLE                                                            */
...
ASSIGN 
       show-catagories:PRIVATE-DATA IN FRAME F-Main     = 
                "save".
