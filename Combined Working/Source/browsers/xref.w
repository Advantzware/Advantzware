...
&Scoped-define QUERY-STRING-Browser-Table FOR EACH reftable WHERE ~{&KEY-PHRASE} ~
      AND reftable.reftable = "Xref" NO-LOCK ~
    ~{&SORTBY-PHRASE}
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      reftable.loc COLUMN-LABEL "Type" FORMAT "x(12)":U
      reftable.code COLUMN-LABEL "Lookup Value" FORMAT "x(24)":U
      reftable.code2 COLUMN-LABEL "ASI Value" FORMAT "X(24)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 112 BY 18.1
         FONT 2.
...
DEFINE FRAME F-Main
     ...
     Btn_Clear_Find AT ROW 19.33 COL 99 HELP
...
/* Query rebuild information for BROWSE Browser-Table
     ...
     _TblOptList       = "USED"
     _Where[1]         = "ASI.reftable.reftable = ""Xref"""
     _FldNameList[1]   > ASI.reftable.loc
"loc" "Type" "x(12)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > ASI.reftable.code
"code" "Lookup Value" "x(24)" "character" ? ? ? ? ? ? no "Value to Lookup" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > ASI.reftable.code2
"code2" "ASI Value" "X(24)" "character" ? ? ? ? ? ? no "Value in ASI" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
