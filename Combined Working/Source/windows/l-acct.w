...
&IF DEFINED(UIB_is_Running) NE 0 &THEN
  ...
  def VAR ip-type like account.type no-undo.
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-1 account.actnum account.dscr ~
account.type 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-1 
&Scoped-define OPEN-QUERY-BROWSE-1 OPEN QUERY BROWSE-1 FOR EACH account WHERE ~{&KEY-PHRASE} ~
      AND account.company = ip-company ~
...
/* Query rebuild information for BROWSE BROWSE-1
     ...
     _Where[1]         = "ASI.account.company = ip-company
