...
&SCOPED-DEFINE h_Browse01 h_ediPartnerSegment
...
DEFINE VARIABLE h_edipartnersegment AS HANDLE NO-UNDO.
DEFINE VARIABLE h_edipartnersegment-2 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'browsers/edipartnersegment.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_edipartnersegment ).
       RUN set-position IN h_edipartnersegment ( 4.81 , 3.60 ) NO-ERROR.
       RUN set-size IN h_edipartnersegment ( 19.52 , 145.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'viewers/edipartnersegment.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_edipartnersegment-2 ).
       RUN set-position IN h_edipartnersegment-2 ( 4.76 , 4.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_edipartnersegment-2. */
       RUN add-link IN adm-broker-hdl ( h_edipartnersegment , 'Record':U , h_edipartnersegment-2 ).
       RUN add-link IN adm-broker-hdl ( h_p-updsav , 'TableIO':U , h_edipartnersegment-2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_edipartnersegment-2 ,
             h_folder , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-navico ,
             h_edipartnersegment-2 , 'AFTER':U ).
