...
&scoped-define SORTBY-1 BY oe-rel.po-no
&scoped-define SORTBY-2 BY oe-rel.i-no 
&scoped-define fld-name-1 oe-rel.po-no
&scoped-define fld-name-2 oe-rel.i-no 
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-1 oe-rel.po-no oe-rel.i-no oe-rel.qty ~
oe-rel.ship-id oe-rel.rel-date 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-1 
&Scoped-define FIELD-PAIRS-IN-QUERY-BROWSE-1
&Scoped-define OPEN-QUERY-BROWSE-1 OPEN QUERY BROWSE-1 FOR EACH oe-rel WHERE ~{&KEY-PHRASE} ~
      AND oe-rel.company = ip-company ~
 AND oe-rel.ord-no = ip-ord-no  NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-BROWSE-1 oe-rel
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-1 oe-rel
...
DO:
   op-char-val = oe-rel.po-no + "," +
                 oe-rel.i-no
                 .
   op-rec-id = recid(oe-rel).                 
