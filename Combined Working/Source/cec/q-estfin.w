...
&Scoped-define INTERNAL-TABLES est-qty ef eb

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH est-qty WHERE est-qty.company = est.company ~
  AND est-qty.est-no = est.est-no NO-LOCK, ~
      EACH ef OF est NO-LOCK, ~
      EACH eb OF est NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main est-qty ef eb
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main est-qty
&Scoped-define SECOND-TABLE-IN-QUERY-Query-Main ef
&Scoped-define THIRD-TABLE-IN-QUERY-Query-Main eb
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "ASI.est-qty WHERE ASI.est <external> ...,ASI.ef OF ASI.est,ASI.eb OF ASI.est"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _JoinCode[1]      = "ASI.est-qty.company = ASI.est.company
