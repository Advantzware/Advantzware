/* ------------------------------------------- cec/quote/quosoule.p 04/09 GDM */
...
IF bill[3] = "" THEN DO:
    ASSIGN bill[3] = bill[4]
           bill[4] = "".
END.

IF ship[3] = "" THEN do:
   ASSIGN ship[3] = ship[4]
          ship[4] = "".
END.
...
PROCEDURE verBage:
    ...
    PUT 
     ...
     " <P13><B>*</B><P9> Inventory for items will not exceed 90 days." SKIP
     " <P13><B>*</B><P10><B> Visit our Website at www.soulepackaging.com </B>"                              SKIP   
     .
    ...
    PUT "<|5><R55><C1><#5><FROM><R64><C80><RECT>" SKIP    
        ...
        "<=6><R57>"
        "Signature below by an authorized representative of Customer authorizes Soule Packaging Company (and its designated affiliates)" SKIP
        "<=6><R58>"
        ...
        " " SKIP
        "          4322 Pet Lane Lutz, Florida 33559-6349 " "     Phone  813-907-6000    Fax  (813) 907-6092         <B>www.soulepackaging.com</B>"
        .
