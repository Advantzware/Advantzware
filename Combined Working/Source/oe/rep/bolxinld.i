...
for each report where report.term-id eq v-term-id,
  ...
  IF oe-ordl.part-dscr1 <> "" OR oe-boll.partial > 0 THEN DO:
     PUT {1} oe-ordl.part-dscr1 AT 33 FORM "x(25)".
     IF oe-boll.partial > 0  THEN PUT {1} v-1 FORM ">>>9" AT 66
  ...
  PUT {1}  "====================" AT 66 SKIP
           v-tot-pkgs AT 66 FORM ">>>9" " = "
           oe-boll.qty FORM "->>>>>z" SPACE(8)
           v-part-comp  SPACE(1)
           oe-boll.weight  SKIP.
