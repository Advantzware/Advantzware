/* _---------------------------------------------- oe/rep/invacme.p 12/99 FWK */
/* PRINT INVOICE when sys-ctrl.char-fld eq "Acme" - O/E Module                */
/* -------------------------------------------------------------------------- */
...
form header
 ...
 "SHIPPED TO:" at 50 inv-head.sold-no to 74
  ...
  "APB#" v-ord-no at 6 "CUSTOMER PO" at 13 v-po-no at 25
...
form
  "____________" at 69
  inv-head.bill-i[1] at 1 format "x(50)"
  "SUB-TOTAL" at 58 v-subtot-lines to 80 format "->>>,>>9.99"
  inv-head.bill-i[2] at 1 format "x(50)"
  "SALES TAX" at 58 inv-head.t-inv-tax to 80 format "->>>,>>9.99"
  inv-head.bill-i[3] at 1 format "x(50)"
  "FREIGHT" at 58 v-frt-display to 80 format "->>>,>>9.99"
  inv-head.bill-i[4] at 1 format "x(50)"
  "------------" at 69
  "INVOICE TOTAL" at 55 inv-head.t-inv-rev TO 80 format "$->>>,>>9.99"
  "============" at 69
...
*/
      ...
      v-subtot-lines = v-subtot-lines + v-subtot-misc.
