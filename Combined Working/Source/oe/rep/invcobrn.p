...
ASSIGN ls-image1 = "images\CCS_logo with address.jpg"
...
/*         RUN cXMLOutput (clXMLOutput,'/Extrinsic','','Row').                               */
    ...
    PUT "<R58><C58><#8><FROM><R+3><C+22><RECT> " 
        "<=8> Sub Total    :" v-subtot-lines FORM "->>,>>9.99"
        /*"<=8><R+1> Freight      :" v-inv-freight
        "<=8><R+2> Sales Tax    :" inv-head.t-inv-tax FORM "->>,>>9.99" */
        "<=8><R+1>" "" 
        "<=8><R+2> Total Invoice:" inv-head.t-inv-rev FORM "->>,>>9.99" .
