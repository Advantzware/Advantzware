 /* oe/rep/bolacrdbc2.i  */  
   ...
   put "<FArial>"  SKIP
        ...
        "<FArial><P14><=#3>" /*<C-20><R-2> <B>Bill Of Lading</B> */ "<P10>" SKIP
                ...
                "<=#3><R+1><B>Page#:        " string(trim(string(page-number - v-last-page,">9"))) "</B>" SKIP /*Task# 01241407*/
...
/* IF lv-bolfmt-int = 1 THEN */ 
   PUT "<FArial><=5><R+1> Part#/Order#               PO#/Job#                Finished Good#              Description                         Units       Qty/Unit    P/C    Weight  <FCourier New>" SKIP(1).
