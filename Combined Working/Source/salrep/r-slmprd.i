        ...
        if not called then do:
          ...
          IF tb_excel THEN
             PUT STREAM excel UNFORMATTED
                 ...
                 '"' STRING(w-data1.w-sqft[1],lv-format-1)    '",'
                 '"' STRING(w-data1.w-amt[1],lv-format-2)    '",'
                 '"' STRING(w-data1.w-pmsf[1],lv-format-3)    '",'
                 '"' STRING(w-data1.w-sqft[2],lv-format-1)    '",'
                 '"' STRING(w-data1.w-amt[2],lv-format-2)    '",'
                 '"' STRING(w-data1.w-pmsf[2],lv-format-3)    '",'
                 '"' STRING(w-data1.w-sqft[3],lv-format-1)    '",'
                 '"' STRING(w-data1.w-amt[3],lv-format-2)    '",'
                 '"' STRING(w-data1.w-pmsf[3],lv-format-3)    '",'
                  SKIP.
        end.
      end.
    end.
          ...
          IF tb_excel THEN
             PUT STREAM excel UNFORMATTED
                 ...
                 '"' if w-data.w-type eq "1" then "  TOTAL SALES"
                     ...
                     ELSE "  MEMO"    '",'
                 '"' STRING(v-tot-sqft[1],lv-format-1)    '",'
                 '"' STRING(v-tot-amt[1],lv-format-2)    '",'
                 '"' STRING(v-tot-pmsf[1],lv-format-3)    '",'
                 '"' STRING(v-tot-sqft[2],lv-format-1)    '",'
                 '"' STRING(v-tot-amt[2],lv-format-2)    '",'
                 '"' STRING(v-tot-pmsf[2],lv-format-3)    '",'
                 '"' STRING(v-tot-sqft[3],lv-format-1)    '",'
                 '"' STRING(v-tot-amt[3],lv-format-2)    '",'
                 '"' STRING(v-tot-pmsf[3],lv-format-3)    '",'
                 SKIP.
        ...
        if not called then do with frame f-prod:
          ...
          IF tb_excel THEN
             PUT STREAM excel UNFORMATTED
                 ...
                 '"' "" '",'
                 '"' "  SALES"    '",'
                 '"' STRING(v-tot-sqft[4],lv-format-1)    '",'
                 '"' STRING(v-tot-amt[4],lv-format-2)    '",'
                 '"' STRING(v-tot-pmsf[4],lv-format-3)    '",'
                 '"' STRING(v-tot-sqft[5],lv-format-1)    '",'
                 '"' STRING(v-tot-amt[5],lv-format-2)    '",'
                 '"' STRING(v-tot-pmsf[5],lv-format-3)    '",'
                 '"' STRING(v-tot-sqft[6],lv-format-1)    '",'
                 '"' STRING(v-tot-amt[6],lv-format-2)    '",'
                 '"' STRING(v-tot-pmsf[6],lv-format-3)    '",'
                  SKIP.
        end.
      end.
    end.
