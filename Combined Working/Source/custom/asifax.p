...
/*
   ...
   */
     ...
     IF ls-to-list = "" THEN ls-to-list = cust.fax-prefix + cust.fax.
   ...
   IF AVAIL vend THEN DO:
      /*FOR EACH phone WHERE phone.table_rec_key = vend.rec_key 
          ...
          ls-to-list = ls-to-list + 
                 ...
                 ELSE "".
      END.  */
      ASSIGN ls-to-list = vend.fax-prefix + vend.fax-area + vend.fax
             lv-rec-email = "".
      ...
      THEN DO:    /* xprint image file */ 
        ...
        IF ls-to-list <> "" THEN do: /* send fax */
           ...
           ASSIGN /*ls-to-list = /*IF length(trim(ls-to-list)) < 10 THEN ls-to-list ELSE "1" + ls-to-list */
                  ...
                  lv-outfile   = lv-faxattach /* No fax in ASI office but works at Southpak
                                                 when "", only cover page get faxed  */
                  .                                 
...
/*ELSE ls-to-list = IF length(trim(ls-to-list)) < 10 THEN ls-to-list ELSE "1" + ls-to-list.*/
...
END.
*/
IF lv-faxname = "" THEN lv-faxname = ip-cust-no.

hc-fax:priority = 1.
hC-fax:Recipients:ADD(lv-faxto,lv-faxname). 
