...
rd_ext-cst tb_cost tb_cust-whse tb_sort tb_zero rd_active rd-dest lv-ornt ~
...
lbl_ext-cst rd_ext-cst tb_cost tb_cust-whse tb_sort tb_zero rd_active ~
...
DEFINE FRAME FRAME-A
     tb_cust-list AT ROW 2 COL 29 WIDGET-ID 6
     btnCustList AT ROW 2.05 COL 61 WIDGET-ID 8
     begin_i-no AT ROW 3.19 COL 23 COLON-ALIGNED HELP
          "Enter Beginning Order Number"
     end_i-no AT ROW 3.19 COL 66 COLON-ALIGNED HELP
          "Enter Ending Item Number"
     begin_cust-no AT ROW 4.14 COL 23 COLON-ALIGNED HELP
          "Enter Beginning Customer Number"
     end_cust-no AT ROW 4.14 COL 66 COLON-ALIGNED HELP
          "Enter Ending Customer Number"
     begin_cat AT ROW 5.1 COL 23 COLON-ALIGNED HELP
          "Enter Beginning Category"
     end_cat AT ROW 5.1 COL 66 COLON-ALIGNED HELP
          "Enter Ending Order Number"
     lbl_pg-brk AT ROW 6.48 COL 26 COLON-ALIGNED NO-LABEL
     rd_pg-brk AT ROW 6.48 COL 42 NO-LABEL
     lbl_ext-cst AT ROW 7.43 COL 10 COLON-ALIGNED NO-LABEL
     rd_ext-cst AT ROW 7.43 COL 42 NO-LABEL
     tb_cost AT ROW 7.43 COL 69
     tb_cust-whse AT ROW 8.62 COL 42
     tb_sort AT ROW 9.57 COL 42
     tb_zero AT ROW 10.52 COL 42
     rd_active AT ROW 11.48 COL 42 NO-LABEL WIDGET-ID 2
     rd-dest AT ROW 13.62 COL 5 NO-LABEL
     lv-ornt AT ROW 13.62 COL 29 NO-LABEL
     lines-per-page AT ROW 13.62 COL 84 COLON-ALIGNED
     lv-font-no AT ROW 15.05 COL 28 COLON-ALIGNED
     lv-font-name AT ROW 16.24 COL 28 COLON-ALIGNED NO-LABEL
     td-show-parm AT ROW 17.43 COL 27
     tb_excel AT ROW 18.38 COL 69 RIGHT-ALIGNED
     tb_runExcel AT ROW 18.38 COL 91 RIGHT-ALIGNED
     fi_file AT ROW 19.33 COL 47 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 20.86 COL 18
     btn-cancel AT ROW 20.86 COL 56
     "Selection Parameters" VIEW-AS TEXT
          SIZE 21 BY .71 AT ROW 1.24 COL 5
          BGCOLOR 2 
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 12.91 COL 2
...
------------------------------------------------------------------------------*/
  DISPLAY tb_cust-list begin_i-no end_i-no begin_cust-no end_cust-no begin_cat 
          end_cat lbl_pg-brk rd_pg-brk lbl_ext-cst rd_ext-cst tb_cost 
          tb_cust-whse tb_sort tb_zero rd_active rd-dest lv-ornt lines-per-page 
          lv-font-no lv-font-name td-show-parm tb_excel tb_runExcel fi_file 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE RECT-6 RECT-7 tb_cust-list btnCustList begin_i-no end_i-no 
         begin_cust-no end_cust-no begin_cat end_cat rd_pg-brk rd_ext-cst 
         tb_cost tb_cust-whse tb_sort tb_zero rd_active rd-dest lv-ornt 
