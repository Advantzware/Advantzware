...
def {1} {2} var v-fg-lot as log format "Y/N" init no no-undo.
...
DEF {1} {2} VAR lIncludeInactive AS LOG INIT NO NO-UNDO.
def {1} {2} var fslm like cust.sman INIT " " no-undo.                           /*Task# 01221409*/
def {1} {2} var tslm like cust.sman INIT "zzz" no-undo.                     /*Task# 01221409*/

def {1} {2} var v-tot-qty as dec format "->>>,>>>,>>9"  extent 3 no-undo.
def {1} {2} var v-tot-msf as dec format "->>>,>>>,>>9"  extent 3 no-undo.
...
def var v-label4 as char format "x(15)" extent 3 no-undo.
...
DEF VAR lv-sell-price-fg LIKE itemfg.sell-price NO-UNDO.
DEF VAR lv-sell-price-ord LIKE oe-ordl.price NO-UNDO.
DEF VAR lv-sell-value-fg AS DEC FORMAT  "->>,>>>,>>9.99" NO-UNDO.
DEF VAR lv-sell-value-ord AS DEC FORMAT  "->>,>>>,>>9.99" NO-UNDO.
DEF VAR lv-sell-value-fg-s AS DEC FORMAT  "->>,>>>,>>9.99" NO-UNDO.
DEF VAR lv-sell-value-ord-s AS DEC FORMAT  "->>,>>>,>>9.99" NO-UNDO.
DEF VAR lv-sell-uom LIKE itemfg.sell-uom NO-UNDO.
DEF VAR lv-sell-uom-fg LIKE itemfg.sell-uom NO-UNDO.
DEF VAR lv-sell-uom-ord LIKE oe-ordl.pr-uom NO-UNDO.
...
DEF VAR  v-tot-bin-sum AS dec format "->>>>9.9<<<<" no-undo.
...
form itemfg.cust-no
     ...
     v-po-no
     v-arq
   with frame itemx1 no-labels no-box down stream-io width 230.
...
form itemfg.cust-no
     ...
     v-po-no
     v-bin-arq
   with frame itemx11 no-labels no-box down stream-io width 230.
...
form itemfg.cust-no
     ...
     v-po-no
     v-arq
   with frame itemx3 no-labels no-box down stream-io width 230.
...
form itemfg.cust-no
     ...
     v-po-no
     v-bin-arq
   with frame itemx33 no-labels no-box down stream-io width 230.
