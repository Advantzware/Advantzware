...
*/
  ...
  display /*v-line[7]                 at 2 
          ...
          "<=6><P8><C12><B><U>Packing:</U>" /*AT 10*/  "<C38><U>Sheets Received</U>" /*AT 77*/ "<C56><U>Date</U>" /*AT 110*/
          "<C72><U>Total Completed</U>" /*AT 150*/ "<C92><U>Unit Count</U></B><P10>"SKIP
          "Pallet ID:" xeb.tr-no when avail xeb 
          fill("_",25)              at 36    format "x(25)"
          fill("_",13)              at 63    format "x(13)"
          fill("_",25)              at 80    format "x(25)"
          fill("_",15)              at 108    format "x(15)" SKIP
          "# Per Bundle: "   AT 4
          /*"# Per Bndl:"                 AT 4*/
          /*ESP - reversed order of following two lines*/
          xoe-ordl.cas-cnt when avail xoe-ordl @ xeb.cas-cnt FORM "->,>>>,>>9"
          ...
          SKIP
          "# Per Unit: " AT 4 xeb.tr-cnt when avail xeb FORM "->>>,>>>,>>9"
          ...
          SKIP
          /* pattern*/
          "# Per Pallet: " AT 4 xeb.cas-pal when avail xeb FORM "->,>>>,>>9"
