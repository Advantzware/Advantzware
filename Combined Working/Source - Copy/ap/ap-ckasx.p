/* ap/ap-ckasx.p  for Protagon BPV - 11/2012*/
...
PROCEDURE writeRegisterLine:
    ...
    PUT 
        ipc-bookmark "<R+" TRIM(STRING(ipi-line)) "><C+10.5>" ip-inv-no
        ipc-bookmark "<R+" TRIM(STRING(ipi-line)) "><C+19>" ip-date
        ipc-bookmark "<R+" TRIM(STRING(ipi-line)) "><C+25>" ip-po-no
        ipc-bookmark "<R+" TRIM(STRING(ipi-line)) "><RIGHT=C+39><C+" li-col-invamt ">" ip-invamt
        ipc-bookmark "<R+" TRIM(STRING(ipi-line)) "><RIGHT=C+49><C+" li-col-amount ">" ip-amount
        ipc-bookmark "<R+" TRIM(STRING(ipi-line)) "><RIGHT=C+59><C+" li-col-discount ">" ip-discount
        ipc-bookmark "<R+" TRIM(STRING(ipi-line)) "><RIGHT=C+69><C+" li-col-net ">" ip-net SKIP.
...
PROCEDURE writeRegisterHeader:
    ...
    lc-rect = lc-rect + "<C20><FROM><C+59><R+1><RECT>".
    PUT lc-rect SKIP
        lc-start SKIP
      /*  opc-bookmark "<R+0><C+" li-col-date "><FROM>" opc-bookmark "<R+1><C+" li-col-date "><LINE>" 
        ...
        opc-bookmark "<R+0><C+60" "><FROM>" opc-bookmark "<R+1><C+60" "><LINE>"
        ...
        opc-bookmark "<C+" li-col-po + 1 FORMAT ">9" ">REF"
        opc-bookmark "<C+" li-col-invamt + 3 FORMAT ">9" ">INV AMT"
        opc-bookmark "<C+" li-col-amount + 13 FORMAT ">9" ">AMT PAID"
        opc-bookmark "<C+" li-col-discount + 13 FORMAT ">9" ">DISCOUNT"
        opc-bookmark "<C+" li-col-net + 13 FORMAT ">9" ">NET AMT." SKIP
        "</B>". */
        
        opc-bookmark "<R+0><C+18" "><FROM>" opc-bookmark "<R+1><C+18" "><LINE>" 
        opc-bookmark "<R+0><C+24" "><FROM>" opc-bookmark "<R+1><C+24" "><LINE>" 
        opc-bookmark "<R+0><C+60" "><FROM>" opc-bookmark "<R+1><C+60" "><LINE>"
        opc-bookmark "<R+0><C+" li-col-amount "><FROM>" opc-bookmark "<R+1><C+" li-col-amount "><LINE>"
        opc-bookmark "<R+0><C+" li-col-discount "><FROM>" opc-bookmark "<R+1><C+" li-col-discount "><LINE>"
        opc-bookmark "<R+0><C+" li-col-net "><FROM>" opc-bookmark "<R+1><C+" li-col-net "><LINE>" SKIP. 

    PUT "<B>" opc-bookmark "<C+10.5" ">INVOICE NO."
        opc-bookmark "<C+19.5" ">DATE"
        opc-bookmark "<C+25.5" ">REF."                                            /*Task# 03071305 */
        opc-bookmark "<C+" li-col-invamt + 3 FORMAT ">9" ">INV AMT"
        opc-bookmark "<C+" li-col-amount + 13 FORMAT ">9" ">AMT PAID"
        opc-bookmark "<C+" li-col-discount + 13 FORMAT ">9" ">DISCOUNT"
        opc-bookmark "<C+" li-col-net + 13 FORMAT ">9" ">NET AMT." SKIP
