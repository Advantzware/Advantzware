...
&Scoped-Define ENABLED-OBJECTS Btn-Save Btn-Cancel Btn-recalc-qty 
...
DEFINE FRAME Panel-Frame
     ...
     Btn-recalc-qty AT ROW 1.24 COL 20
...
ASSIGN 
       Btn-recalc-qty:PRIVATE-DATA IN FRAME Panel-Frame     = 
                "panel-image".
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Btn-recalc-qty C-WIn
ON CHOOSE OF Btn-recalc-qty IN FRAME Panel-Frame /* Recalc Qty */
DO:
