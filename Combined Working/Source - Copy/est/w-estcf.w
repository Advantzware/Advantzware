...
DEFINE VARIABLE h_v-navef-5 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 2 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updsav-2 ).
       RUN set-position IN h_p-updsav-2 ( 21.95 , 55.00 ) NO-ERROR.
       RUN set-size IN h_p-updsav-2 ( 1.90 , 50.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_vp-est ).
       RUN set-position IN h_vp-est ( 21.95 , 112.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-navef-4 ).
       RUN set-position IN h_v-navef-4 ( 22.19 , 7.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_q-estfin ).
       RUN set-position IN h_q-estfin ( 8.86 , 23.00 ) NO-ERROR.
    ...
    WHEN 3 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-est ).
       RUN set-position IN h_v-est ( 4.81 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 16.67 , 150.00 ) */
    ...
    WHEN 4 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-navef-2 ).
       RUN set-position IN h_v-navef-2 ( 22.91 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.43 , 42.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-layout ).
       RUN set-position IN h_p-layout ( 22.91 , 46.00 ) NO-ERROR.
       RUN set-size IN h_p-layout ( 1.67 , 104.00 ) NO-ERROR.
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-navef-2 ,
             h_v-est2 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-layout ,
             h_v-navef-2 , 'AFTER':U ).
    END. /* Page 4 */
    WHEN 5 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-navef-3 ).
       RUN set-position IN h_v-navef-3 ( 22.67 , 18.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.43 , 42.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-inkpak ).
       RUN set-position IN h_p-inkpak ( 22.67 , 66.00 ) NO-ERROR.
    ...
    WHEN 7 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updc&c ).
       RUN set-position IN h_p-updc&c ( 8.14 , 117.00 ) NO-ERROR.
       RUN set-size IN h_p-updc&c ( 11.19 , 26.00 ) NO-ERROR.
    ...
    WHEN 8 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-boxdee ).
       RUN set-position IN h_v-boxdee ( 6.48 , 2.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-navef-5 ).
       RUN set-position IN h_v-navef-5 ( 23.14 , 21.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.43 , 42.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-estbox ).
       RUN set-position IN h_p-estbox ( 23.14 , 71.00 ) NO-ERROR.
       RUN set-size IN h_p-estbox ( 1.43 , 63.60 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_q-boxdes ).
       RUN set-position IN h_q-boxdes ( 6.48 , 1.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_v-navef-5. */
       RUN add-link IN adm-broker-hdl ( h_b-estitm , 'nav-itm':U , h_v-navef-5 ).

       /* Links to SmartQuery h_q-boxdes. */
       RUN add-link IN adm-broker-hdl ( h_b-estitm , 'Record':U , h_q-boxdes ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_vi-est-6 ,
             h_folder , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-boxdee ,
             h_vi-est-6 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-navef-5 ,
             h_v-boxdee , 'AFTER':U ).
