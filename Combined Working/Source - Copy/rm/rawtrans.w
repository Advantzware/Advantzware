...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "RM Warehouse Transactions"
         HEIGHT             = 18.62
         WIDTH              = 94.2
         MAX-HEIGHT         = 27.48
         MAX-WIDTH          = 160
...
ON END-ERROR OF W-Win /* RM Warehouse Transactions */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* RM Warehouse Transactions */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_option ).
       RUN set-position IN h_option ( 1.71 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 15.95 , 86.00 ) */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE valid-liscense W-Win 
PROCEDURE valid-liscense :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
