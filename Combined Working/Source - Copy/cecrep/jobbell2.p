...
*/
  ...
  display /*v-line[7]                 at 2 
          ...
          "<R-1><P7><U>Packing:</U>" AT 2  "<U>Qty Completed#</U>" AT 65
          /*"Total" AT 87*/
          "<U>Sheets Ordered</U>" AT 127
          "<U>Due Date</U> " AT 167 "<U>Supplier</U>" AT 198 "<P10>" SKIP
          ...
          "Partial: ________ @ _______" AT 36
          SKIP
           "Pallet:" AT 4
          ...
          /*fill("_",13)              at 96    format "x(13)"*/
           "Total:   ________ @ _______" AT 36 SKIP
          /*SKIP*/
           "# of Layer:" AT 4 STRING(xeb.tr-cas) when avail xeb format "x(15)"
          /*"     Totals"             at 36     format "x(16)"
          v-rec-alf[8]              at 55     format "x(21)"
          fill("_",13)              at 96    format "x(13)"
          "QA " + fill("_",10)      at 113   format "x(12)"*/
         with no-box no-labels frame m9 width 230 NO-ATTR-SPACE STREAM-IO.
