...
def {1} var v-board-code     as   char format "x(32)"                    no-undo.
...
FORM HEADER
     "<P9><B><=1> Job Information:</B>" AT 2 
     "<B>Production ID:</B>" AT 59
     "<B>Date:</B>" AT 111
     "<B>Location:" AT 150 "</B><P10>"       
     "Job#:"                         at 2
     v-job-prt
     ...
     v-form-hdr AT 2 "CustPart#:" AT 40 v-cp FORM "x(15)" "<P9>" SKIP
     "<B>Sold To:</B>" AT 2
     "<B>Order Information:</B>" AT 50
     "<B>Item Description:</B>" AT 102
     "<P10>"
       
    with no-box frame head no-labels width 171 NO-ATTR-SPACE STREAM-IO.
