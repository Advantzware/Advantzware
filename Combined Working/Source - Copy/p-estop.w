...
&Scoped-Define ENABLED-OBJECTS btn-add btn-add-stds btn-import btn-save ~
btn-build btn-delete btn-copy btn-cancel 
...
DEFINE FRAME Panel-Frame
     btn-add AT ROW 1.24 COL 2
     btn-add-stds AT ROW 1.24 COL 13
     btn-import AT ROW 1.24 COL 24
     btn-save AT ROW 1.24 COL 35
     btn-build AT ROW 1.24 COL 46
     btn-delete AT ROW 1.24 COL 57
     btn-copy AT ROW 1.24 COL 68
     btn-cancel AT ROW 1.24 COL 79
...
&Scoped-define SELF-NAME btn-add-stds
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn-add-stds C-WIn
...
&ENDIF
  DO:
     ...
     DO WITH FRAME Panel-Frame:
        IF Btn-Save:LABEL = '&Override' THEN 
        DO:
           RUN new-state('update-begin':U).
