/*sys/ref/attachlogic.i*/
    ...
    ELSE DO:
            ...
            IF AVAIL bf2-est THEN DO:
                ...
                FOR EACH bf2-eb FIELDS(stock-no) WHERE
                    ...
                    FIND FIRST bf2-itemfg WHERE
                        ...
                        NO-LOCK NO-ERROR.
                    IF AVAIL bf2-itemfg 
                    AND LOOKUP(bf2-itemfg.rec_key,v-rec-key-list) EQ 0 THEN ASSIGN
                        v-rec-key-list = v-rec-key-list + "," + bf2-itemfg.rec_key.
                END.
            END.
        END.
        ELSE DO: 
            ...
            ELSE DO:
                FIND FIRST bf2-itemfg WHERE 
                    bf2-itemfg.rec_key = ip-rec_key 
                    NO-LOCK NO-ERROR.
                IF AVAIL bf2-itemfg THEN ASSIGN
