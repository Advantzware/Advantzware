...
DEFINE INPUT PARAMETER flute AS CHAR NO-UNDO.
...
ASSIGN cTextListToSelect = "Style NO.,Description,Type,Design #,Markup$,Flute,Board,Ink,Ink Cov %,Adder,Label," +
...
DEFINE VARIABLE fi_file AS CHARACTER FORMAT "X(30)" INITIAL "c:~\tmp~\r-stylec.csv" 
...
FUNCTION getValue-itemfg RETURNS CHARACTER
  ( BUFFER ipb-style FOR style, ipc-field AS CHAR ) :
/*------------------------------------------------------------------------------
