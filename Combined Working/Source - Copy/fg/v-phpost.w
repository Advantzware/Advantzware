 ...
 */      
      ...
      if not avail fg-bin then do:
        ...
        if fg-rctd.rita-code eq "C" then do:        /** Physical Count **/
         
           assign  fg-bin.qty     =  fg-rctd.qty
                   itemfg.last-count =  fg-rctd.qty
                   itemfg.q-onh     =  fg-rctd.qty
                   itemfg.last-date = fg-rctd.rct-date
                   .
