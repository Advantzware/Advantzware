...
/*------------------------------------------------------------------------------
  ...
  Parameters:  <none>
  Notes:       
  if reftable.val[1] = 1 then .use-job = Yes Otherwise .use-job = No. 
Was that not apparent from the code? 
Mark Tyndall See if Jitender needs additional assistance on this. Maybe he is seeing something in the code that I'm not.    
------------------------------------------------------------------------------*/
