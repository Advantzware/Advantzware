/* ar-mcashl.i  ar-mcashl Miscellaneous Cash Receipts Phantom Line Items
"asi" "ar-mcashl"
"actnum" "Acct#" ""
"acct-dscr" "Description" ""
"" "" ""
"" "" ""
"" "" ""
"" "" ""
...
&Global-define FLDNAME1 ar-mcashl.actnum
&Global-define FORMAT-1 X(25)
&Global-define SORTBY-1 BY {&FLDNAME1} BY ar-mcashl.m-no
&Global-define IDXNAME1 
&Global-define DESCRIP1 Acct#
&Global-define FLDNAME2 ar-mcashl.acct-dscr
&Global-define FORMAT-2 X(45)
&Global-define SORTBY-2 BY {&FLDNAME2} {&SORTBY-1}
&Global-define IDXNAME2 
&Global-define DESCRIP2 Account Description
