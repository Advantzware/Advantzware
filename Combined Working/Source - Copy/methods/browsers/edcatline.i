...
&Global-define FLDNAME1 edcatline.partner
&Global-define FORMAT-1 X(5)
&Global-define SORTBY-1 BY edcatline.partner 
&Global-define IDXNAME1 
&Global-define DESCRIP1 Partner
&Global-define FLDNAME2 edcatline.vendor-item
&Global-define FORMAT-2 X(20)
&Global-define SORTBY-2 BY edcatline.vendor-item
&Global-define DESCRIP2 vendor-item
&Global-define FLDNAME3 edcatline.upc
&Global-define FORMAT-3 X(16)
&Global-define SORTBY-3 BY edcatline.upc
&Global-define IDXNAME3 
&Global-define DESCRIP3 Catalog
