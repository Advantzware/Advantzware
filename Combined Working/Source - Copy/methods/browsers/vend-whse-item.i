...
&Global-define FLDNAME1 vend-whse-item.cust-no  
...
&Global-define FLDNAME2 vend-whse-item.fg-item-no
...
/*&Global-define FLDNAME4 vend-whse-item.vendor-code
&Global-define FORMAT-4 X(9)
&Global-define SORTBY-4 BY {&FLDNAME4}
&Global-define IDXNAME4 
&Global-define DESCRIP4 Cust. A/P Code
&Global-define FLDNAME5 vend-whse-item.vendor-plant-code
&Global-define FORMAT-5 X(10)
&Global-define SORTBY-5 BY {&FLDNAME5}
&Global-define IDXNAME5 
&Global-define DESCRIP5 Cust. Plant ID
