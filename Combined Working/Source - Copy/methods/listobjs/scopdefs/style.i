...
&{&DEFINETYPE}-define TABLENAME style
&{&DEFINETYPE}-define DBFIELD1 style.style
&{&DEFINETYPE}-define BEGINFLD1 begin_style
&{&DEFINETYPE}-define BEGIN-DEFAULT-1 yes
&{&DEFINETYPE}-define ENDFLD1 end_style
...
&{&DEFINETYPE}-define LISTORDER Style No.
...
&{&DEFINETYPE}-define SAVENAME style
