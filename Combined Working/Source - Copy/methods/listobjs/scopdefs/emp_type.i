...
"description"
"Description"
"begin_emp_type_description"
"yes"
"end_emp_type_description"
"yes"
?
""
""
...
&{&DEFINETYPE}-define TABLENAME emp_type
&{&DEFINETYPE}-define DBFIELD1 emp_type.emp_type
&{&DEFINETYPE}-define BEGINFLD1 begin_emp_type
&{&DEFINETYPE}-define BEGIN-DEFAULT-1 yes
&{&DEFINETYPE}-define ENDFLD1 end_emp_type
&{&DEFINETYPE}-define END-DEFAULT-1 yes
&{&DEFINETYPE}-define DBFIELD2 emp_type.description
&{&DEFINETYPE}-define BEGINFLD2 begin_emp_type_description
&{&DEFINETYPE}-define BEGIN-DEFAULT-2 yes
&{&DEFINETYPE}-define ENDFLD2 end_emp_type_description
...
&{&DEFINETYPE}-define LISTORDER Employee Type,Description
...
&{&DEFINETYPE}-define SAVENAME emp_type
