...
&Scoped-define INTERNAL-TABLES est est-qty

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH est WHERE est.company = inv-line.company ~
  AND est.est-no = inv-line.est-no NO-LOCK, ~
      FIRST est-qty WHERE est-qty.company = est.company ~
  AND est-qty.est-no = est.est-no NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH est WHERE est.company = inv-line.company ~
  AND est.est-no = inv-line.est-no NO-LOCK, ~
      FIRST est-qty WHERE est-qty.company = est.company ~
  AND est-qty.est-no = est.est-no NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main est est-qty
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "ASI.est WHERE ASI.inv-line <external> ...,ASI.est-qty WHERE ASI.est ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = ", FIRST,"
     _JoinCode[1]      = "ASI.est.company = ASI.inv-line.company
  AND ASI.est.est-no = ASI.inv-line.est-no"
