...
for each inv-line
    ...
    IF AVAIL oe-ord AND v-post THEN 
    DO:
    ...
    if avail itemfg and v-post then 
    do:
        assign
        ...
        do:
            ...
            if v-sum-rel-qty ge oe-ordl.qty and 
                ...
                for each oe-ordl where oe-ordl.company eq cocode
                    ...
                    assign 
                        v-close-qty = oe-ordl.qty - oe-ordl.t-ship-qty.
                    if v-close-qty lt 0 
...
do:
    ...
    DO:
        ...
        ASSIGN
            ...
            ttInvoicePostUpdateGL.invoiceQty        = v-inv-qty
            ttInvoicePostUpdateGL.totInvoicefreight = inv-head.t-inv-freight
            ttInvoicePostUpdateGL.totInvoiceTax     = inv-head.t-inv-tax
            ttInvoicePostUpdateGL.miscTot           = v-misc-tot
            ttInvoicePostUpdateGL.lineTot           = v-line-tot
    ...
    do:
        ...
        for each w-inv-line break by w-inv-line.ord-no:
            ...
            ASSIGN
                ...
                ttInvoicePostUpdateGL.profit            = v-prof
                .
            IF lPrintTon THEN 
                ASSIGN 
