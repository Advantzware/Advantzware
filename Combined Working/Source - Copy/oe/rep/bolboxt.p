...
form
  ...
  space(2) oe-boll.po-no space(0) "/" space(0) oe-ordl.part-no format "x(20)"
...
for each report   where report.term-id eq v-term-id,
  ...
  if first-of(oe-bolh.bol-no) then do:
    ...
    for each oe-boll where oe-boll.company eq oe-bolh.company and oe-boll.b-no eq oe-bolh.b-no NO-LOCK,
      ...
      assign
        ...
        v-frt-pay      = SUBSTR(v-frt-pay-dscr,1,1).
    ...
    if v-print-hdgs then do:
      format header
             skip(1)
             "Date:" oe-bolh.bol-date FORMAT "99/99/99" "/" v-time
             ...
             "# Pkgs:" v-tot-pkgs
             " Weight:" v-tot-wgt /* oe-bolh.tot-wt */
             " Cwt:" oe-bolh.cwt
             " Frt Pay:" v-frt-pay skip
      ...
      format header
             skip(3)
             v-time at 4
             oe-bolh.bol-date at 16 format "99/99/99"
  ...
  for each oe-boll where oe-boll.company eq oe-bolh.company and oe-boll.b-no eq oe-bolh.b-no:
    ...
    display v-ord-bal
            ...
            oe-boll.po-no
            oe-rel.po-no
              when avail oe-rel and oe-rel.po-no ne "" @ oe-boll.po-no
            oe-ordl.part-no
              when avail oe-ordl
            oe-boll.ord-no
            oe-boll.p-c
