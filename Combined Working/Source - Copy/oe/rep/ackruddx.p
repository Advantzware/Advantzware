      ...
      */
        ...
        IF v-prntinst THEN DO:
           ...
           IF AVAIL itemfg THEN DO:
              lv-first-note = yes.
              {custom/notespr2.i itemfg v-inst 4 "notes.rec_key = itemfg.rec_key and notes.note_code <> 'PO'}
              DO i = 1 TO 4:
                 IF v-inst[i] <> "" THEN DO:
      ...
      END.      
      if v-printline ge 40 /*lv-line-print*/ then
      do:
            PAGE .
            {oe/rep/ackruddx.i}
            assign v-printline = 20.          
...
*/      
      ...
      PUT "<FArial><R55><C1><#10><P12><B> Comments </B> <P8> " 
        ...
        "<=10><R-2><P9><B><C13>THIS IS A CONFIRMATION OF YOUR ORDER,NOT AN INVOICE.</B><P8>"
        "<=10><R-3><C13>If no cancellation of this order within 24 hrs, Rudd will proceed with order."  
        "<=10><R-4><C13>*Pallets Exchanged or $6.00 each."
        "<=10><R-5><C13>*If total billing is less than $500.00, a $50.00 delivery charge will be added to your invoice."
        "<=10><R-6><C13>*FREE DELIVERY on orders totaling over $500.00!"
        "<=10><R-10><C13>NOTE: A 10% underrun or overrun will constitute fulfillment of order."
        "<=10><R-9><C13> *ALL CLAIMS MUST BE MADE WITHIN 5 DAYS" 
        "<=10><R-8><C13>  A CHARGE OF 1 1/2% (18% - PER ANNUM) WILL" 
        "<=10><R-7><C13> *BE APPLIED TO ALL PAST DUE BALANCES" SKIP(1)
