/* oe/rep/ackcared.i */ /* copy of hopx*/
PUT "<FArial>".
PUT "<C1><#1><R+25><C+31><IMAGE#1=" ls-full-img1 SKIP.
...
v-fob FORM "x(11)" SPACE(2)     /*Task# 01031411*/
v-shipvia FORM "x(20)" 
...
PUT "<FArial><=5><R24>              Customer Part#           " SKIP.
PUT "<FArial><=5><R+1> Line        FG item # / PO#            Description                                                           Ordered                       Price                  UOM" SKIP(1).
PUT "<FCourier New>"          .
