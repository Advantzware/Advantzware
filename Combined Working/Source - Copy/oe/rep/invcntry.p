...
form v-case-line AT 5 format "x(80)" SKIP
    with frame case-line no-labels no-box no-underline down stream-io width 90.
    ...
    ELSE IF v-print-fmt = "CENTURY" THEN
        ASSIGN v-c-phone   = ""
               v-c-fax     = ""
               v-c-email   = "".
    else    
      ...
      DO TRANSACTION:
        ...
        for each wf no-lock where wf.r-no eq inv-head.r-no:  
          ...
          if v-printline ge end-page then do:
            put skip(end-page + 3 - v-printline) "* CONTINUED *" at 25 SKIP.
          ...
          do i = 1 to 5:
            if v-case-cnt[i] ne "" then do:
              DISPLAY v-case-cnt[i] @ v-case-line WITH FRAME case-line.
            end.
          end. /* 1 to 5 */
        ...
        for each inv-misc of inv-head no-lock where
          ...
          do:
            ...
            if v-printline + 2 ge end-page then
            do:
              put skip(end-page + 3 - v-printline) "* CONTINUED *" at 25 SKIP.
        ...
        do:  /* T O T A L S */ 
          ...
          put skip(end-page + 3 - v-printline).
