...
for each xxreport where xxreport.term-id eq v-term-id,
  ...
  PUT "<FArial><R52.5><C1><P12><B>     Shipping Instructions: </B> <P9> " 
    ...
    "<R60><C7>" "Customer/Carrier _______________________________             Pallets Exchanged __________________________________" 
    "<R62><C7>" "Date __________________________________________            Date ______________________________________________"     
    .
