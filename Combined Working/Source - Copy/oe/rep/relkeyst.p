...
output stream last-page to value(tmp-dir + "relkeyst.txt") page-size VALUE(v-lines-per-page).
...
find first oe-ctrl where oe-ctrl.company eq cocode no-lock no-error.
    ...
    {oe/rep/foreachr.i},
      ...
      FOR EACH oe-rell FIELDS(company ord-no)
          where oe-rell.company eq oe-relh.company
            and oe-rell.r-no    eq oe-relh.r-no
          USE-INDEX r-no NO-LOCK,
          FIRST oe-ord FIELDS(company ord-no stat frt-pay fob-code)
      ...
      {oe/rep/relkeyst.i "stream last-page" "(last-page)"}
