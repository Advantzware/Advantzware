       ...
       PUT "<C3><R2><#1><R+13><C+40><IMAGE#1=" ls-full-img1 SKIP  /* company image */ 
          /*  "<P10><=2><R+9>"
            ...
            */
            ...
            space(10) "Bill To:" SPACE(30) "Ship To:" SKIP
            SPACE(10) inv-head.cust-name v-shipto-name AT 60 skip
            SPACE(10) inv-head.addr[1]   v-shipto-addr[1] AT 60 SKIP
            SPACE(10) inv-head.addr[2]  v-shipto-addr[2] AT 60 SKIP
