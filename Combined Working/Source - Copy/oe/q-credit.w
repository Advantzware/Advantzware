...
&Scoped-define INTERNAL-TABLES oe-ord cust
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "asi.oe-ord OF asi.oe-ordl,asi.cust OF asi.oe-ordl"
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE get-item-no q-tables 
...
------------------------------------------------------------------------------*/
  ...
  IF AVAIL oe-ordl THEN ASSIGN op-ord-no = oe-ordl.ord-no
