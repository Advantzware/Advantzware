...
def var deb-tot  as dec  format "->>,>>>,>>9.99" NO-UNDO.
def var cred-tot as dec format "->>,>>>,>>9.99" NO-UNDO.
DEF VAR lv-rev AS CHAR LABEL " " NO-UNDO.
def var tot-deb  as dec format "->>,>>>,>>9.99" NO-UNDO.
def var tot-cred like tot-deb NO-UNDO.
def var tot-deb-t  as dec format "->>,>>>,>>9.99" NO-UNDO.
def var tot-cred-t like tot-deb NO-UNDO.
...
{sys/inc/ttRptSel.i}
ASSIGN cTextListToDefault  = "Journal,Description,Date,Account,Account Desc,DEBIT,CREDIT,Rev" .
...
DEFINE FRAME FRAME-A
     begin_j-no AT ROW 2.81 COL 26 COLON-ALIGNED HELP
          "Enter Beginning Journal Number"
     end_j-no AT ROW 2.81 COL 69 COLON-ALIGNED HELP
          "Enter Ending Customer Number"
     begin_date AT ROW 4 COL 26 COLON-ALIGNED HELP
          "Enter Beginning Journal Date"
     end_date AT ROW 4 COL 69 COLON-ALIGNED HELP
          "Enter Ending Journal Date"
     lbl_sort AT ROW 5.71 COL 30 COLON-ALIGNED NO-LABEL
     rd_sort AT ROW 5.81 COL 42 NO-LABEL
     sl_avail AT ROW 8.05 COL 5 NO-LABEL WIDGET-ID 26
     Btn_Def AT ROW 8.05 COL 41 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 56
     sl_selected AT ROW 8.05 COL 60.4 NO-LABEL WIDGET-ID 28
     Btn_Add AT ROW 9.05 COL 41 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 32
     Btn_Remove AT ROW 10.05 COL 41 HELP
          "Remove Selected Table from Tables to Audit" WIDGET-ID 34
     btn_Up AT ROW 11.1 COL 41 WIDGET-ID 40
     btn_down AT ROW 12.1 COL 41 WIDGET-ID 42
     ...
     td-show-parm AT ROW 19.86 COL 31
     tb_excel AT ROW 20.81 COL 31 WIDGET-ID 2
     tb_runExcel AT ROW 20.81 COL 53 WIDGET-ID 4
     fi_file AT ROW 21.71 COL 29 COLON-ALIGNED HELP
          "Enter File Name" WIDGET-ID 6
     btn-ok AT ROW 23.71 COL 27
     btn-cancel AT ROW 23.71 COL 58
     "Available Columns" VIEW-AS TEXT
          SIZE 29 BY .62 AT ROW 7.33 COL 5.8 WIDGET-ID 38
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY 1 AT ROW 13.86 COL 3
     "Selection Parameters" VIEW-AS TEXT
          SIZE 21 BY 1 AT ROW 1.24 COL 5
          BGCOLOR 2 
     "Selected Columns(In Display Order)" VIEW-AS TEXT
          SIZE 34 BY .62 AT ROW 7.33 COL 60.4 WIDGET-ID 44
