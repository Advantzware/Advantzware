...
&Scoped-define QUERY-STRING-Browser-Table FOR EACH style WHERE ~{&KEY-PHRASE} ~
 ...
 AND style.company = gcompany NO-LOCK ~
    ~{&SORTBY-PHRASE}
...
/* Query rebuild information for BROWSE Browser-Table
     ...
     _TblOptList       = "USED"
     _Where[1]         = "ASI.style.industry = ""1""
 AND ASI.style.company = gcompany"
...
RUN fg/stlf-exp.w (auto_find,browse-order).
