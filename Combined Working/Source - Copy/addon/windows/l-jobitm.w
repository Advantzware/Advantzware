...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-1 Dialog-Frame _STRUCTURED
  QUERY BROWSE-1 NO-LOCK DISPLAY
      job-hdr.job-no FORMAT "x(6)":U COLUMN-FONT 0
      job-hdr.job-no2 COLUMN-LABEL "#" FORMAT ">9":U COLUMN-FONT 0
      job-hdr.i-no FORMAT "x(15)":U COLUMN-FONT 0
      job-hdr.est-no FORMAT "x(5)":U COLUMN-FONT 0
...
"job-hdr.job-no" ? ? "character" ? ? 0 ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > ASI.job-hdr.job-no2
"job-hdr.job-no2" "#" ? "integer" ? ? 0 ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[3]   > ASI.job-hdr.i-no
"job-hdr.i-no" ? ? "character" ? ? 0 ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[4]   > ASI.job-hdr.est-no
"job-hdr.est-no" ? ? "character" ? ? 0 ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[5]   > ASI.job-hdr.ord-no
"job-hdr.ord-no" ? ? "integer" ? ? 0 ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[6]   > ASI.job-hdr.cust-no
"job-hdr.cust-no" ? ? "character" ? ? 0 ? ? ? no ? no no ? yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE BROWSE-1 */
&ANALYZE-RESUME
