...
ce-ctrl.fg-rate-farm ce-ctrl.ls-length ce-ctrl.ls-trimw ce-ctrl.rm-rate ~
ce-ctrl.rm-rate-farm ce-ctrl.hand-pct ce-ctrl.hand-pct-farm ce-ctrl.def-ink ~
...
ce-ctrl.ls-width ce-ctrl.ls-triml ce-ctrl.fg-rate ce-ctrl.fg-rate-farm ~
ce-ctrl.ls-length ce-ctrl.ls-trimw ce-ctrl.rm-rate ce-ctrl.rm-rate-farm ~
...
rd-sp-3 ls-mtx-title ls-title1 ls-title2 ls-title3 ls-title4 
...
ce-ctrl.ls-triml ce-ctrl.fg-rate ce-ctrl.fg-rate-farm ce-ctrl.ls-length ~
ce-ctrl.ls-trimw ce-ctrl.rm-rate ce-ctrl.rm-rate-farm avg_cost ~
ce-ctrl.hand-pct ce-ctrl.hand-pct-farm ce-ctrl.def-ink ce-ctrl.def-inkcov ~
ce-ctrl.whse-mrkup ce-ctrl.def-case ce-ctrl.def-pal ce-ctrl.fold-pct ~
fi_broker-pct ce-ctrl.def-coat ce-ctrl.comm-mrkup ce-ctrl.spec-l[1] ~
ce-ctrl.spec-%[1] ce-ctrl.r-cost ce-ctrl.spec-l[2] ce-ctrl.spec-%[2] ~
ce-ctrl.spec-l[3] ce-ctrl.spec-%[3] ce-ctrl.hd-net ce-ctrl.mat-cost[1] ~
ce-ctrl.mat-pct[1] ce-ctrl.lab-cost[1] ce-ctrl.lab-pct[1] ce-ctrl.hd-gross ~
ce-ctrl.mat-cost[2] ce-ctrl.mat-pct[2] ce-ctrl.lab-cost[2] ~
...
DEFINE FRAME DEFAULT-FRAME
     ...
     ce-ctrl.fg-rate AT ROW 4.33 COL 86.6 COLON-ALIGNED
          ...
          SIZE 10.4 BY 1
          BGCOLOR 15 
     ce-ctrl.fg-rate-farm AT ROW 4.33 COL 99 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 10.4 BY 1
          BGCOLOR 15 
     ...
     ce-ctrl.rm-rate AT ROW 5.52 COL 86.6 COLON-ALIGNED
          ...
          SIZE 10.4 BY 1
          BGCOLOR 15 
     ce-ctrl.rm-rate-farm AT ROW 5.52 COL 99 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 10.4 BY 1
          BGCOLOR 15 
     ...
     ce-ctrl.hand-pct AT ROW 6.71 COL 86.6 COLON-ALIGNED
          ...
          SIZE 10.4 BY 1
          BGCOLOR 15 
     ce-ctrl.hand-pct-farm AT ROW 6.71 COL 99 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 10.4 BY 1
          BGCOLOR 15 
...
DEFINE FRAME DEFAULT-FRAME
     ce-ctrl.fold-pct AT ROW 9.1 COL 86.6 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 10.4 BY 1
...
------------------------------------------------------------------------------*/
  DISPLAY avg_cost fi_broker-pct rd-sp-1 rd-sp-2 rd-sp-3 ls-mtx-title ls-title1 
          ls-title2 ls-title3 ls-title4 
  ...
  IF AVAILABLE ce-ctrl THEN 
    DISPLAY ce-ctrl.e-num ce-ctrl.e-range[1] ce-ctrl.e-range[2] ce-ctrl.q-num 
          ...
          ce-ctrl.ls-triml ce-ctrl.fg-rate ce-ctrl.fg-rate-farm 
          ce-ctrl.ls-length ce-ctrl.ls-trimw ce-ctrl.rm-rate 
          ce-ctrl.rm-rate-farm ce-ctrl.hand-pct ce-ctrl.hand-pct-farm 
