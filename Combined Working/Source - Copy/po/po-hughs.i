...
PUT 
     "<FArial>"  SKIP
       ...
       "<C1><#1><R+5><C+25>" SKIP 
       "<C3><R2><#2><R+16><C+29><IMAGE#2=" + ls-full-img1 FORM "x(200)"
...
/*       " "  AT 8 SKIP                                                      */
/*       " "  AT 8 SKIP                                                      */
/*       " " AT 8 "<FGCOLOR=" + trim(lv-other-color) + ">" FORM "x(15)" skip */
/*       " " AT 8 SKIP(1)                                                    */
     "<FCourier New>"
...
/*             "<=1><C3><R+1><P20><B></B><P10><FGCOLOR=" trim(lv-other-color) + ">" FORM "x(6)" . */
