...
&Scoped-define QUERY-STRING-BROWSE-1 FOR EACH style WHERE ~{&KEY-PHRASE} ~
      AND style.company = ip-company and style.style <> "" NO-LOCK ~
    ~{&SORTBY-PHRASE}
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-1 Dialog-Frame _STRUCTURED
  QUERY BROWSE-1 NO-LOCK DISPLAY
      style.style COLUMN-LABEL "Description" FORMAT "x(6)":U WIDTH 9
      style.dscr FORMAT "x(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"style" "Description" ? "character" ? ? ? ? ? ? no ? no no "9" yes no no "U" "" ""
     _FldNameList[2]   > ASI.style.dscr
"dscr" ? "x(30)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE BROWSE-1 */
&ANALYZE-RESUME
