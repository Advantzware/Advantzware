...
ON END-ERROR OF W-Win /* EDI Transaction Types */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* EDI Transaction Types */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_edcode-2 ).
       RUN set-position IN h_edcode-2 ( 5.29 , 6.00 ) NO-ERROR.
