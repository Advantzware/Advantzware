...
&scoped-define SORTBY-1 BY rm-bin.loc-bin
&scoped-define SORTBY-2 BY rm-bin.tag
&scoped-define fld-name-1 rm-bin.loc-bin
&scoped-define fld-name-2 rm-bin.tag
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-1 rm-bin.loc-bin rm-bin.tag ~
rm-bin.qty 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-1 Dialog-Frame _STRUCTURED
  QUERY BROWSE-1 NO-LOCK DISPLAY
      ...
      rm-bin.tag COLUMN-LABEL "Tag#" FORMAT "x(8)":U
