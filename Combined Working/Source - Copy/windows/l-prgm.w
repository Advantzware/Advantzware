...
&scoped-define fld-name-2 prgrms.prgmname
&scoped-define fld-name-1 prgrms.prgtitle
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-1 prgrms.prgtitle prgrms.prgmname 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-1 
&Scoped-define QUERY-STRING-BROWSE-1 FOR EACH prgrms WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-BROWSE-1 OPEN QUERY BROWSE-1 FOR EACH prgrms WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-BROWSE-1 prgrms
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-1 prgrms
...
/* Query rebuild information for BROWSE BROWSE-1
     ...
     _FldNameList[1]   = NOSWEAT.prgrms.prgtitle
     _FldNameList[2]   = NOSWEAT.prgrms.prgmname
     _Query            is OPENED
*/  /* BROWSE BROWSE-1 */
&ANALYZE-RESUME
...
DO:
   op-char-val = prgrms.prgmname:screen-value in browse {&browse-name} + "," +
                 prgrms.prgtitle:screen-value in browse {&browse-name}
                 .
