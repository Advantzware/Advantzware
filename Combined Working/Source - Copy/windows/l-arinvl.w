...
DEF INPUT PARAM ip-inv-no AS INT NO-UNDO.
...
&scoped-define fld-name-1 ar-invl.i-no
&scoped-define fld-name-2 ar-invl.ord-no
&scoped-define SORTBY-1 BY ar-invl.i-no
&scoped-define SORTBY-2 BY ar-invl.ord-no

&scoped-define datatype-2 INTEGER
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-1 ar-invl.ord-no ar-invl.i-no ~
ar-invl.i-name ar-invl.ship-qty ar-invl.po-no 
...
ar-invl.inv-no = ip-inv-no NO-LOCK ~
    ~{&SORTBY-PHRASE}
...
ar-invl.inv-no = ip-inv-no NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-BROWSE-1 ar-invl
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-1 Dialog-Frame _STRUCTURED
  QUERY BROWSE-1 NO-LOCK DISPLAY
      ...
      ar-invl.po-no COLUMN-LABEL "PO Number" FORMAT "x(15)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME Dialog-Frame
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         TITLE "Invoice Item Information".
...
DO:
   op-char-val = string(ar-invl.i-no) + "," + STRING(ar-invl.ord-no,">>>>>>>>>>") .
