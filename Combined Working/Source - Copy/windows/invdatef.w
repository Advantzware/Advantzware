...
ON END-ERROR OF W-Win /* Fix A/R Invoice Dates */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Fix A/R Invoice Dates */
DO:
...
------------------------------------------------------------------------------*/
  ...
  IF NOT VALID-HANDLE(WIDGET-HANDLE(char-hdl)) THEN
          RUN add-link IN adm-broker-hdl (ip-handle, "record", h_invdatef-2).
  op-handle = h_invdatef-2.
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_invdatef-2 ).
       RUN set-position IN h_invdatef-2 ( 1.48 , 38.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.67 , 34.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'viewers/ar-invf.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_ar-invf ).
       RUN set-position IN h_ar-invf ( 1.71 , 5.00 ) NO-ERROR.
