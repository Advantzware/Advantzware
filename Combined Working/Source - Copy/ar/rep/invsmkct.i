/* ------------------------------------------ ar/rep/invsmkct.i 04270902 GDM */
...
/*     "<=#3><R+4>          Invoice #                        Invoice Date <FCourier New>" */
    ...
    "<=3><R+5> " /*SPACE(3) ar-inv.inv-no*/ space(12) v-inv-date .
...
PUT
    ...
    SPACE(15) "Price"       SPACE(7)  "UOM"         SPACE(7)  "Amount" SKIP
