/*oe/rep/invhugh2.i  */
     ...
     PUT "<FArial>".
        ...
        PUT "<C1><#2>" /*<R+10><C+35><IMAGE#2=" ls-full-img2 SKIP  /* company image */ */
            ...
            "<FCourier New>"
            "Bill To:"  SKIP
            SPACE(7) ar-inv.cust-name skip
            SPACE(7) ar-inv.addr[1]   SKIP
            SPACE(7) ar-inv.addr[2]   SKIP
            SPACE(7) v-addr3  
            "Ship To:" AT 55 SKIP
...
PUT "<FArial><=4><R+1> Ship Date             FOB                    Ship Via                                 Terms                       S.Person         Pallets                 " SKIP
     "<FCourier New><=4><R+3> " v-date-ship FORM "99/99/9999" space(2)
     v-fob FORM "x(12)" SPACE(1)
     v-shipvia FORM "x(19)" SPACE(1)
...
PUT "<FArial><=5>                    Shipped/" SKIP.
PUT "<FArial><=5><R+1>   Ordered     BOL#      Invoiced    Item#\Cust. PO          Description                               Ln#         Price    UOM                 Amount" SKIP(1).
