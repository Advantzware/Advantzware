/* ---------------------------------------------- ar/rep/invruddx.p   */
/* PRINT INVOICE   Xprint form for Rudd      */
/* -------------------------------------------------------------------------- */
...
ASSIGN ls-image1 = "images\ruddlogo.jpg"
       ls-image2 = "images\ruddlogo.jpg".
...
*/
    ...
    PUT "<R58><C60><#8><FROM><R+5><C+20><RECT> " 
     ...
     /*   "<=8><R+4> " v-bot-lab[3] */
        ...
        "<=8><C-33><R+3><FGCOLOR=BLUE>IF IS'S CORRUGATED, WE MAKE IT!<FGCOLOR=BLACK>"
