...
end_job-no2 fi_days btn-process btn-cancel RECT-17 
...
DEFINE FRAME FRAME-A
     begin_job-no AT ROW 6.71 COL 21 COLON-ALIGNED HELP
          "Enter Beginning Job Number"
     begin_job-no2 AT ROW 6.71 COL 36 COLON-ALIGNED HELP
          "Enter Beginning Job Number" NO-LABEL
     end_job-no AT ROW 6.71 COL 63 COLON-ALIGNED HELP
          "Enter Ending Job Number"
     end_job-no2 AT ROW 6.71 COL 78 COLON-ALIGNED HELP
          "Enter Ending Job Number" NO-LABEL
     fi_days AT ROW 8.62 COL 48 COLON-ALIGNED
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Close Jobs with Days Past Due"
         HEIGHT             = 12.43
         WIDTH              = 90.2
         MAX-HEIGHT         = 33.29
         MAX-WIDTH          = 204.8
...
ON END-ERROR OF C-Win /* Close Jobs with Days Past Due */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Close Jobs with Days Past Due */
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY begin_job-no begin_job-no2 end_job-no end_job-no2 fi_days 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE begin_job-no begin_job-no2 end_job-no end_job-no2 fi_days btn-process 
         btn-cancel RECT-17 
      WITH FRAME FRAME-A IN WINDOW C-Win.
