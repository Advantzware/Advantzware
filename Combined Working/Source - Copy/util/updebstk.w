...
DEFINE FRAME FRAME-A
     begin_i-no AT ROW 6.71 COL 24 COLON-ALIGNED
     end_i-no AT ROW 6.71 COL 62 COLON-ALIGNED
     btn-process AT ROW 10.52 COL 21
     btn-cancel AT ROW 10.52 COL 65
     "" VIEW-AS TEXT
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Update Estimate FG Item Name from FG Item"
         HEIGHT             = 11.95
         WIDTH              = 98.4
         MAX-HEIGHT         = 19.76
         MAX-WIDTH          = 98.4
...
ON END-ERROR OF C-Win /* Update Estimate FG Item Name from FG Item */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Update Estimate FG Item Name from FG Item */
DO:
...
FOR EACH itemfg NO-LOCK WHERE itemfg.company = g_company 
    ...
    EACH eb WHERE eb.company = itemfg.company
