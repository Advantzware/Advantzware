    ...
    for each tt-report2
      ...
      if v-sort and first-of(tt-report2.key-01) then do:
       ...
       /* v-slsmn-hdr = "SalesRep: " + trim(tt-report2.key-01) + " " +
         ...
         v-slsmn-hdr = trim(tt-report2.key-01) .
      ...
      ASSIGN cDisplay = ""
             ...
             DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
                cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                     CASE cTmpField:    
                          WHEN "rep"         THEN cVarValue = STRING(trim(tt-report2.key-01)) .
                          WHEN "cust-nam"    THEN cVarValue = IF AVAIL cust THEN cust.name ELSE "" .    
        ...
        DOWN WITH FRAME itemx.*/
            ...
            PUT SKIP str-line SKIP .
             ...
             PUT UNFORMATTED "    DATE TOTALS FOR " + SUBSTR(tt-report2.key-02,5,2) + "/" +
                                         SUBSTR(tt-report2.key-02,7,2) + "/" +
                                         SUBSTR(tt-report2.key-02,1,4) substring(cDisplay,31,300) SKIP.
        END.
      ...
      IF LAST-OF(tt-report2.key-01) THEN DO:
        IF v-sort THEN DO:
          ...
          DOWN WITH FRAME itemx.*/
             ...
             PUT UNFORMATTED "    SALESREP TOTALS" substring(cDisplay,20,300) SKIP.
          END.
