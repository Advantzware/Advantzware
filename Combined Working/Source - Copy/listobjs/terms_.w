...
&Scoped-Define ENABLED-OBJECTS RECT-1 RECT-2 list-order begin_t-code ~
end_t-code 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_t-code begin_terms_dscr ~
end_terms_dscr F1 F-2 F-3 F-4 
...
DEFINE VARIABLE begin_t-code AS CHARACTER FORMAT "X(5)" 
     LABEL "Beginning Terms" 
     VIEW-AS FILL-IN 
     SIZE 15.6 BY 1.

DEFINE VARIABLE begin_terms_dscr AS CHARACTER FORMAT "X(30)" 
     LABEL "Beginning Description" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE end_t-code AS CHARACTER FORMAT "X(5)" 
     LABEL "Ending Terms" 
     VIEW-AS FILL-IN 
     SIZE 15.6 BY 1.

DEFINE VARIABLE end_terms_dscr AS CHARACTER FORMAT "X(30)" 
...
DEFINE FRAME F-Main
     ...
     begin_t-code AT ROW 4.81 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Terms"
     begin_terms_dscr AT ROW 6 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Description"
     end_t-code AT ROW 8.14 COL 45 COLON-ALIGNED HELP
          "Enter Ending Terms"
     end_terms_dscr AT ROW 9.33 COL 45 COLON-ALIGNED HELP
...
/* SETTINGS FOR FILL-IN begin_terms_dscr IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN end_t-code IN FRAME F-Main
   NO-DISPLAY                                                           */
/* SETTINGS FOR FILL-IN end_terms_dscr IN FRAME F-Main
   NO-ENABLE                                                            */
