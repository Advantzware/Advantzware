...
&Scoped-Define ENABLED-OBJECTS RECT-2 RECT-1 list-order begin_procat ~
end_procat 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_procat begin_fgcat_dscr ~
end_procat end_fgcat_dscr F1 F-2 F-3 F-4 
...
DEFINE VARIABLE begin_fgcat_dscr AS CHARACTER FORMAT "X(30)" 
     LABEL "Beginning Description" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE begin_procat AS CHARACTER FORMAT "X(5)" 
     LABEL "Beginning  Category" 
     VIEW-AS FILL-IN 
     SIZE 11 BY 1.

DEFINE VARIABLE end_fgcat_dscr AS CHARACTER FORMAT "X(30)" 
     LABEL "Ending Description" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE end_procat AS CHARACTER FORMAT "X(5)" 
...
DEFINE FRAME F-Main
     ...
     begin_procat AT ROW 4.81 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Category"
     begin_fgcat_dscr AT ROW 6 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Description"
     end_procat AT ROW 8.14 COL 45 COLON-ALIGNED HELP
          "Enter Ending Category"
     end_fgcat_dscr AT ROW 9.33 COL 45 COLON-ALIGNED HELP
...
/* SETTINGS FOR FILL-IN begin_fgcat_dscr IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN end_fgcat_dscr IN FRAME F-Main
   NO-ENABLE                                                            */
