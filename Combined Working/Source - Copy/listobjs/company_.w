...
&Scoped-Define ENABLED-OBJECTS RECT-1 RECT-2 list-order begin_company ~
end_company show-open-periods 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_company ~
begin_company_name end_company end_company_name show-open-periods F1 F-2 ~
F-3 F-4 
...
DEFINE VARIABLE begin_company_name AS CHARACTER FORMAT "X(30)" 
     LABEL "Beginning Name" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE end_company AS CHARACTER FORMAT "X(3)" 
     LABEL "Ending Company" 
     VIEW-AS FILL-IN 
     SIZE 6 BY 1.

DEFINE VARIABLE end_company_name AS CHARACTER FORMAT "X(30)" 
     LABEL "Ending Name" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.
...
DEFINE VARIABLE show-open-periods AS LOGICAL INITIAL no 
     LABEL "Show Open Periods" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME F-Main
     ...
     begin_company AT ROW 4.33 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Company"
     begin_company_name AT ROW 5.52 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Name"
     end_company AT ROW 6.95 COL 45 COLON-ALIGNED HELP
          "Enter Ending Company"
     end_company_name AT ROW 8.14 COL 45 COLON-ALIGNED HELP
          "Enter Ending Name"
     show-open-periods AT ROW 9.81 COL 47 HELP
          "Select to Show Open Periods"
     F1 AT ROW 4.33 COL 53 NO-LABEL
     F-2 AT ROW 5.52 COL 91 NO-LABEL
     F-3 AT ROW 6.95 COL 53 NO-LABEL
     F-4 AT ROW 8.14 COL 91 NO-LABEL
...
/* SETTINGS FOR FILL-IN begin_company_name IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN end_company_name IN FRAME F-Main
   NO-ENABLE                                                            */
...
ASSIGN 
       show-open-periods:PRIVATE-DATA IN FRAME F-Main     = 
                "save".
