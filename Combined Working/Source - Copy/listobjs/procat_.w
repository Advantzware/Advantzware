...
&Scoped-Define ENABLED-OBJECTS RECT-1 RECT-2 list-order begin_procat_procat ~
end_procat_procat 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_procat_procat ~
begin_procat_dscr end_procat_procat end_procat_dscr F1 F-2 F-3 F-4 
...
DEFINE VARIABLE begin_procat_dscr AS CHARACTER FORMAT "X(30)" 
     LABEL "Beginning Description" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE begin_procat_procat AS CHARACTER FORMAT "X(5)" 
     LABEL "Beginning  Product Category" 
     VIEW-AS FILL-IN 
     SIZE 13 BY 1.

DEFINE VARIABLE end_procat_dscr AS CHARACTER FORMAT "X(30)" 
     LABEL "Ending Description" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE end_procat_procat AS CHARACTER FORMAT "X(5)" 
...
DEFINE FRAME F-Main
     ...
     begin_procat_procat AT ROW 4.81 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Product Category"
     begin_procat_dscr AT ROW 6 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Description"
     end_procat_procat AT ROW 8.14 COL 45 COLON-ALIGNED HELP
          "Enter Ending Product Category"
     end_procat_dscr AT ROW 9.33 COL 45 COLON-ALIGNED HELP
          "Enter Ending Description"
     F1 AT ROW 4.81 COL 60 NO-LABEL
     F-2 AT ROW 6 COL 91 NO-LABEL
     F-3 AT ROW 8.14 COL 60 NO-LABEL
...
/* SETTINGS FOR FILL-IN begin_procat_dscr IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN end_procat_dscr IN FRAME F-Main
   NO-ENABLE                                                            */
