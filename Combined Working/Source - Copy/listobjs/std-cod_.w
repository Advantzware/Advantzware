...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES std-code
&Scoped-define FIRST-EXTERNAL-TABLE std-code


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR std-code.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS RECT-1 RECT-2 list-order begin_std-code ~
end_std-code 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_std-code ~
begin_std-code_dscr end_std-code end_std-code_dscr F1 F-2 F-3 F-4 
...
DEFINE VARIABLE begin_std-code AS CHARACTER FORMAT "X(2)" 
     LABEL "Beginning  Standard Matrix" 
     VIEW-AS FILL-IN 
     SIZE 4 BY 1.

DEFINE VARIABLE begin_std-code_dscr AS CHARACTER FORMAT "X(30)" 
     LABEL "Beginning Description" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE end_std-code AS CHARACTER FORMAT "X(2)" 
     LABEL "Ending Standard Matrix" 
     VIEW-AS FILL-IN 
     SIZE 4 BY 1.

DEFINE VARIABLE end_std-code_dscr AS CHARACTER FORMAT "X(30)" 
...
DEFINE FRAME F-Main
     ...
     begin_std-code AT ROW 4.81 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Standard Matrix"
     begin_std-code_dscr AT ROW 6 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Description"
     end_std-code AT ROW 8.14 COL 45 COLON-ALIGNED HELP
          "Enter Ending Standard Matrix"
     end_std-code_dscr AT ROW 9.33 COL 45 COLON-ALIGNED HELP
          "Enter Ending Description"
     F1 AT ROW 4.81 COL 51 NO-LABEL
     F-2 AT ROW 6 COL 91 NO-LABEL
     F-3 AT ROW 8.14 COL 51 NO-LABEL
...
/* SETTINGS FOR FILL-IN begin_std-code_dscr IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN end_std-code_dscr IN FRAME F-Main
   NO-ENABLE                                                            */
