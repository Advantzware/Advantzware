...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES item-spec item
&Scoped-define FIRST-EXTERNAL-TABLE item-spec


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR item-spec, item.
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: ASI.item-spec,ASI.item
...
------------------------------------------------------------------------------*/
  ...
  assign item-spec.company = item.company
         item-spec.i-no = item.i-no
