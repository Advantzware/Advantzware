...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH hlp-head NO-LOCK ~
    BY hlp-head.MSG-NUM.
&Scoped-define TABLES-IN-QUERY-Query-Main hlp-head
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main hlp-head
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Options          = "NO-LOCK"
     _OrdList          = "asihlp.hlp-head.MSG-NUM|yes"
