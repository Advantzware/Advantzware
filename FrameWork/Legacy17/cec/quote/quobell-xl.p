/* ------------------------------------------- cec/quote/quobell-xl.p - BPV 12/30/2014        */
/* -------------------------------------------------------------------------- */
...
DEF VAR ld-wid AS DEC FORMAT ">>>>>9.99<<<" NO-UNDO.
DEF VAR ld-len AS DEC FORMAT ">>>>>9.99<<<" NO-UNDO.
DEF VAR ld-dep AS DEC FORMAT ">>>>>9.99<<<" NO-UNDO.
...
def var v-first-q-no AS CHAR no-undo.
...
DEFINE VARIABLE iAddCount AS INTEGER     NO-UNDO.
...
if not ch-multi then do:
   ...
   {cec/quote/quobell2-xl.i}    
   {cec/quote/quobell-xl.i 1}
   ...
   chExcelApplication:activeSheet:PageSetup:CenterFooter = "PO BOX 294 / 697 Millers Run Road / Cuddy, PA 15031 / 412-221-1830 / Fax: 412-221-1891".
