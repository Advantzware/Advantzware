...
&Scoped-Define ENABLED-FIELDS style.style style.dscr style.type flute.code 
&Scoped-define FIELD-PAIRS~
 ~{&FP1}style ~{&FP2}style ~{&FP3}~
 ~{&FP1}dscr ~{&FP2}dscr ~{&FP3}~
 ~{&FP1}type ~{&FP2}type ~{&FP3}~
 ~{&FP1}code ~{&FP2}code ~{&FP3}
&Scoped-define ENABLED-TABLES style flute
&Scoped-define FIRST-ENABLED-TABLE style
&Scoped-define SECOND-ENABLED-TABLE flute
...
DEFINE FRAME F-Main
     style.style AT ROW 1.71 COL 16 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     style.dscr AT ROW 1.71 COL 26 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
     style.type AT ROW 1.71 COL 71 COLON-ALIGNED
          LABEL "Type"
          VIEW-AS FILL-IN 
          SIZE 3.2 BY 1
     flute.code AT ROW 1.71 COL 96 COLON-ALIGNED
          LABEL "Flute"
          VIEW-AS FILL-IN 
          SIZE 5.6 BY 1
