...
&Scoped-Define DISPLAYED-FIELDS prod.prolin prod.dscr 
...
DEFINE FRAME F-Main
     prod.prolin AT ROW 1.71 COL 16 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 11.6 BY 1
          BGCOLOR 15 FONT 4
     prod.dscr AT ROW 1.71 COL 36 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 56 BY 1
          BGCOLOR 15 FONT 4
