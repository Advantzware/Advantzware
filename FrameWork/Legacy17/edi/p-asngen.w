...
ON CHOOSE OF btn-Asn IN FRAME F-Main /* ASN Generation */
DO:
    def var char-hdl as cha no-undo.
    run get-link-handle in adm-broker-hdl (this-procedure, "asn-source", output char-hdl).
    run GenerateASN in widget-handle(char-hdl).
END.
