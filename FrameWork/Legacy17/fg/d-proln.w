...
DEFINE VARIABLE h_vprodln2 AS HANDLE NO-UNDO.
...
DEFINE FRAME D-Dialog
     Btn_OK AT ROW 18.38 COL 24
     Btn_Cancel AT ROW 18.38 COL 123
     SPACE(10.19) SKIP(0.09)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'fg/vprodln2.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_vprodln2 ).
       RUN set-position IN h_vprodln2 ( 1.00 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 17.14 , 144.00 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_vprodln2 ,
