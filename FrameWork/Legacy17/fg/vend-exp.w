...
DEFINE FRAME rd-fgexp
     begin_vend AT ROW 3.95 COL 28 COLON-ALIGNED HELP
...
ON LEAVE OF begin_vend IN FRAME rd-fgexp /* From vend # */
DO:
   assign {&self-name}.
END.
...
ON LEAVE OF end_vend IN FRAME rd-fgexp /* To vend # */
DO:
     assign {&self-name}.
END.
...
------------------------------------------------------------------------------*/
  DISPLAY begin_vend end_vend sl_avail sl_selected tb_excel 
          tb_runExcel fi_file 
      WITH FRAME rd-fgexp.
