...
/* ***************************  Definitions  ************************** */
&GLOBAL in IN FRAME {&FRAME-NAME}
&GLOBAL inb IN BROWSE {&BROWSE-NAME} 
&GLOBAL sv SCREEN-VALUE {&IN}
&GLOBAL svb SCREEN-VALUE {&INB}
&GLOBAL tp THIS-PROCEDURE
&GLOBAL WOn lDummy = SESSION:set-wait-state ("general").
&GLOBAL WOff lDummy = SESSION:set-wait-state ("").
