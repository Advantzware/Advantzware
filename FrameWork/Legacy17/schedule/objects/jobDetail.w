    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
           ...
           &ENDIF
             ...
             INPUT  '':U ,
             OUTPUT h_jobDetail ).
       RUN set-position IN h_jobDetail ( 1.00 , 1.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {&WINDOW-NAME}:Y = ipYCoord + 120.
  RUN select-page (0).
  RUN passRowID IN h_jobDetail (ipRowID).
...
------------------------------------------------------------------------------*/
  ...
  jobDetail = findProgram('{&viewers}/',ID,'/jobDetail.w').
