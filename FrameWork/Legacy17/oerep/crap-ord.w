...
DEFINE INPUT PARAMETER pcHold AS CHAR NO-UNDO.
...
RS-ord-stat begin_cust-no end_cust-no begin_item end_item begin_part end_part ~
begin_order end_order end_date begin_date end_reldt begin_reldt ~
tb_print-del sl_avail sl_selected Btn_Add Btn_Remove btn_Up btn_down ~
tb_excel tb_runExcel fi_file btn-ok btn-cancel 
&Scoped-Define DISPLAYED-OBJECTS RS-open-closed RS-ord-stat begin_cust-no end_cust-no ~
begin_item end_item begin_part end_part begin_order end_order end_date ~
begin_date end_reldt begin_reldt tb_print-del sl_avail sl_selected tb_excel ~
tb_runExcel fi_file 
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  RUN enable_UI.
   ...
   DO WITH FRAME {&FRAME-NAME}:
    ...
    IF pcHold EQ "No" THEN
           ASSIGN RS-ord-stat:SCREEN-VALUE = "2" .
       ELSE
           ASSIGN RS-ord-stat:SCREEN-VALUE = "3" . 
...
------------------------------------------------------------------------------*/
  DISPLAY RS-open-closed RS-ord-stat begin_cust-no end_cust-no begin_item end_item 
          begin_part end_part begin_order end_order end_date begin_date 
          end_reldt begin_reldt tb_print-del sl_avail sl_selected tb_excel 
          tb_runExcel fi_file 
      WITH FRAME Dialog-Frame.
  ENABLE RECT-6 RECT-7 RECT-8 RS-open-closed RS-ord-stat begin_cust-no end_cust-no 
         begin_item end_item begin_part end_part begin_order end_order end_date 
         begin_date end_reldt begin_reldt tb_print-del sl_avail sl_selected 
         Btn_Add Btn_Remove btn_Up btn_down tb_excel tb_runExcel fi_file btn-ok 
         btn-cancel 
      WITH FRAME Dialog-Frame.
