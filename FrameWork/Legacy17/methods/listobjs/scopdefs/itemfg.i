...
&{&DEFINETYPE}-define TABLENAME itemfg
&{&DEFINETYPE}-define DBFIELD1 itemfg.company
...
&{&DEFINETYPE}-define DBFIELD2 itemfg.i-no
&{&DEFINETYPE}-define BEGINFLD2 begin_itemfg_i-no
&{&DEFINETYPE}-define BEGIN-DEFAULT-2 no
&{&DEFINETYPE}-define ENDFLD2 end_itemfg_i-no
...
&{&DEFINETYPE}-define LISTORDER Company,Item No
...
&{&DEFINETYPE}-define SAVENAME itemfg
