...
&{&DEFINETYPE}-define TABLENAME uom
&{&DEFINETYPE}-define DBFIELD1 uom.uom
&{&DEFINETYPE}-define BEGINFLD1 begin_uom
&{&DEFINETYPE}-define BEGIN-DEFAULT-1 yes
&{&DEFINETYPE}-define ENDFLD1 end_uom
&{&DEFINETYPE}-define END-DEFAULT-1 yes
&{&DEFINETYPE}-define DBFIELD2 uom.dscr
&{&DEFINETYPE}-define BEGINFLD2 begin_uom_dscr
&{&DEFINETYPE}-define BEGIN-DEFAULT-2 yes
&{&DEFINETYPE}-define ENDFLD2 end_uom_dscr
...
&{&DEFINETYPE}-define LISTORDER UOM,Description
...
&{&DEFINETYPE}-define SAVENAME uom
