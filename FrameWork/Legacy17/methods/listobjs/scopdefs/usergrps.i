...
&{&DEFINETYPE}-define TABLENAME usergrps
&{&DEFINETYPE}-define DBFIELD1 usergrps.usergrps
&{&DEFINETYPE}-define BEGINFLD1 begin_usergrps
&{&DEFINETYPE}-define BEGIN-DEFAULT-1 yes
&{&DEFINETYPE}-define ENDFLD1 end_usergrps
...
&{&DEFINETYPE}-define LISTORDER User Group
...
&{&DEFINETYPE}-define SAVENAME usergrps
