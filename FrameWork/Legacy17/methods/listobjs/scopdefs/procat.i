...
&{&DEFINETYPE}-define TABLENAME procat
&{&DEFINETYPE}-define DBFIELD1 procat.procat
&{&DEFINETYPE}-define BEGINFLD1 begin_procat_procat
&{&DEFINETYPE}-define BEGIN-DEFAULT-1 yes
&{&DEFINETYPE}-define ENDFLD1 end_procat_procat
&{&DEFINETYPE}-define END-DEFAULT-1 yes
&{&DEFINETYPE}-define DBFIELD2 procat.dscr
&{&DEFINETYPE}-define BEGINFLD2 begin_procat_dscr
&{&DEFINETYPE}-define BEGIN-DEFAULT-2 yes
&{&DEFINETYPE}-define ENDFLD2 end_procat_dscr
...
&{&DEFINETYPE}-define LISTORDER Category,Description
...
&{&DEFINETYPE}-define SAVENAME procat
