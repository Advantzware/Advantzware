...
&{&DEFINETYPE}-define TABLENAME costtype
&{&DEFINETYPE}-define DBFIELD1 costtype.cost-type
&{&DEFINETYPE}-define BEGINFLD1 begin_cost-type
&{&DEFINETYPE}-define BEGIN-DEFAULT-1 yes
&{&DEFINETYPE}-define ENDFLD1 end_cost-type
&{&DEFINETYPE}-define END-DEFAULT-1 yes
&{&DEFINETYPE}-define DBFIELD2 costtype.descr
&{&DEFINETYPE}-define BEGINFLD2 begin_costtype_descr
&{&DEFINETYPE}-define BEGIN-DEFAULT-2 yes
&{&DEFINETYPE}-define ENDFLD2 end_costtype_descr
...
&{&DEFINETYPE}-define LISTORDER Cost Type,Description
...
&{&DEFINETYPE}-define SAVENAME costtype
