...
&Global-define FLDNAME1 rm-bin.loc-bin
&Global-define FORMAT-1 X(8)
&Global-define SORTBY-1 
&Global-define IDXNAME1 
&Global-define DESCRIP1 Bin Loc.
&Global-define FLDNAME2 string(rm-bin.po-no)
&Global-define DATATYP2  
&Global-define FORMAT-2 X(8)
&Global-define SORTBY-2              
&Global-define IDXNAME2              
&Global-define DESCRIP2 Vend PO#   
&Global-define FLDNAME3 rm-bin.tag 
&Global-define FORMAT-3 X(20)      
&Global-define SORTBY-3            
&Global-define IDXNAME3            
&Global-define DESCRIP3 Tag#       
