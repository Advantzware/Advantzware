...
def output param op-cust like cust.cust-no no-undo.
def output param op-name like cust.name no-undo.
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-1 cust.cust-no cust.name 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-1 
&Scoped-define FIELD-PAIRS-IN-QUERY-BROWSE-1
&Scoped-define OPEN-QUERY-BROWSE-1 OPEN QUERY BROWSE-1 FOR EACH cust NO-LOCK.
&Scoped-define TABLES-IN-QUERY-BROWSE-1 cust
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SIZE 40 BY 11.19.
...
DO:
   op-cust = cust.cust-no:screen-value in browse {&browse-name}.
   op-name = cust.name:screen-value in browse {&browse-name}. 
