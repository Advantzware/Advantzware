...
&Scoped-Define ENABLED-OBJECTS tran-date begin_bolnum end_bolnum begin_date ~
end_date begin_cust end_cust rd-dest lines-per-page td-show-parm btn-ok ~
btn-cancel RECT-6 RECT-7 
&Scoped-Define DISPLAYED-OBJECTS tran-date tran-period begin_bolnum ~
end_bolnum begin_date end_date begin_cust end_cust rd-dest lines-per-page ~
td-show-parm 
...
------------------------------------------------------------------------------*/
  DISPLAY tran-date tran-period begin_bolnum end_bolnum begin_date end_date 
          begin_cust end_cust rd-dest lines-per-page td-show-parm 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE tran-date begin_bolnum end_bolnum begin_date end_date begin_cust 
         end_cust rd-dest lines-per-page td-show-parm btn-ok btn-cancel RECT-6 
         RECT-7 
      WITH FRAME FRAME-A IN WINDOW C-Win.
...
do TRANSACTION.
  ...
  for each oe-bolh
      where oe-bolh.company  eq cocode
        ...
        and not can-find(first oe-boll where
