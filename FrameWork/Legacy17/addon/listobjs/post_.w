...
end_machine begin_date end_date begin_shift end_shift post t-purge 
&Scoped-Define DISPLAYED-OBJECTS list-order selected-company begin_machine ~
end_machine begin_date end_date begin_shift end_shift post t-purge F1 F-3 ~
F-5 F-6 F-2 F-4 
...
ASSIGN 
       t-purge:PRIVATE-DATA IN FRAME F-Main     = 
                "save".
