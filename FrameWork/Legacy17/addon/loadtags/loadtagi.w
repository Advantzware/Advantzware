...
DEFINE VARIABLE h_loaditem AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* RM Stock Load Tags */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* RM Stock Load Tags */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'loadtags/loaditem.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_loaditem ).
       RUN set-position IN h_loaditem ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_loaditem ( 20.00 , 133.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_loaditem ,
