...
&scoped-define SORTBY-1 BY vend-whse-item.cust-part-no
&scoped-define SORTBY-2 BY vend-whse-item.fg-item-no
&scoped-define fld-name-1 vend-whse-item.cust-part-no
&scoped-define fld-name-2 vend-whse-item.fg-item-no
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-1 vend-whse-item.cust-part-no ~
vend-whse-item.fg-item-no vend-whse-item.vendor-code ~
vend-whse-item.vendor-plant-code vend-whse-item.vendor-dept-code ~
vend-whse-item.cust-no 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-1 
&Scoped-define QUERY-STRING-BROWSE-1 FOR EACH vend-whse-item WHERE ~{&KEY-PHRASE} ~
      AND vend-whse-item.company = ip-company NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-BROWSE-1 OPEN QUERY BROWSE-1 FOR EACH vend-whse-item WHERE ~{&KEY-PHRASE} ~
      AND vend-whse-item.company = ip-company NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-BROWSE-1 vend-whse-item
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-1 Dialog-Frame _STRUCTURED
  QUERY BROWSE-1 NO-LOCK DISPLAY
      ...
      vend-whse-item.vendor-dept-code FORMAT "x(8)":U WIDTH 14
      vend-whse-item.cust-no FORMAT "x(8)":U WIDTH 15.4
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DO:
   op-char-val = vend-whse-item.cust-part-no:screen-value in browse {&browse-name} + "," + 
                 vend-whse-item.fg-item-no:screen-value in browse {&browse-name} + "," + 
                 vend-whse-item.vendor-plant-code:screen-value in browse {&browse-name} + "," + 
                 vend-whse-item.vendor-dept-code:screen-value in browse {&browse-name}.
