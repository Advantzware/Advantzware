...
/* ---------------------------------------------------------------------------
  ...
  DO WHILE VALID-HANDLE(phandle):
    ...
    DO:
      ...
      /* get child record */
      FIND b2-prgrms WHERE b2-prgrms.prgmname =
...
-------------------------------------------------------------------------------------*/
  ...
  DO:
    IF buf-prgrms.WIDGET_font[13] = 999 THEN DO:
       MESSAGE "Liscense is not purchased. Please Contact Advanced Software."
  ...
  DO WHILE VALID-HANDLE(phandle):
    ...
    DO:
      IF INDEX(progname,"notes.") NE 0 OR
         INDEX(progname,"mfvalues.") NE 0 THEN
