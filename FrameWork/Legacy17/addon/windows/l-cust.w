...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-1 Dialog-Frame _STRUCTURED
  QUERY BROWSE-1 NO-LOCK DISPLAY
      cust.cust-no COLUMN-FONT 0
      cust.name COLUMN-FONT 0
      cust.addr[1] COLUMN-FONT 0
      cust.addr[2] COLUMN-FONT 0
      cust.city COLUMN-FONT 0
      cust.state COLUMN-FONT 0
      cust.zip COLUMN-FONT 0
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"cust.cust-no" ? ? "character" ? ? 0 ? ? ? no ?
     _FldNameList[2]   > ASI.cust.name
"cust.name" ? ? "character" ? ? 0 ? ? ? no ?
     _FldNameList[3]   > ASI.cust.addr[1]
"cust.addr[1]" ? ? "character" ? ? 0 ? ? ? no ?
     _FldNameList[4]   > ASI.cust.addr[2]
"cust.addr[2]" ? ? "character" ? ? 0 ? ? ? no ?
     _FldNameList[5]   > ASI.cust.city
"cust.city" ? ? "character" ? ? 0 ? ? ? no ?
     _FldNameList[6]   > ASI.cust.state
"cust.state" ? ? "character" ? ? 0 ? ? ? no ?
     _FldNameList[7]   > ASI.cust.zip
"cust.zip" ? ? "character" ? ? 0 ? ? ? no ?
     _Query            is OPENED
*/  /* BROWSE BROWSE-1 */
&ANALYZE-RESUME
