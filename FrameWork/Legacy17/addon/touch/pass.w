...
DEFINE BUTTON Btn_First 
     LABEL "FIRST PASS" 
     SIZE 20 BY 2.38 TOOLTIP "FIRST PASS".

DEFINE BUTTON Btn_Last 
     LABEL "LAST PASS" 
     SIZE 20 BY 2.38 TOOLTIP "LAST PASS".
...
ON CHOOSE OF Btn_First IN FRAME F-Main /* FIRST PASS */
DO:
  button_item = 1.
...
ON CHOOSE OF Btn_Last IN FRAME F-Main /* LAST PASS */
DO:
