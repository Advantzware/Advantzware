/* custom/getipadr.p   YSK
    How to use:
       DEF VAR tcp-name AS cha FORM "x(50)" NO-UNDO.
       DEF VAR tcp-addr AS cha FORM "x(50)" NO-UNDO.

       RUN custom/getipadr.p (OUTPUT tcp-name, OUTPUT tcp-addr). 
       MESSAGE tcp-name SKIP
               tcp-addr VIEW-AS ALERT-BOX.
