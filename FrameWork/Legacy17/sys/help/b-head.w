...
&SCOPED-DEFINE dataGridInclude dataGrid\sys\help\b-head.i
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      hlp-head.MSG-NUM COLUMN-LABEL "Message#" FORMAT ">>>9":U
      hlp-head.FLD-NAME COLUMN-LABEL "Field Name" FORMAT "x(25)":U
      hlp-head.FRM-TITLE COLUMN-LABEL "Title" FORMAT "x(20)":U
      hlp-head.FIL-NAME COLUMN-LABEL "Table Name" FORMAT "x(15)":U
      hlp-head.FRM-NAME COLUMN-LABEL "Frame Name" FORMAT "x(15)":U
      hlp-head.help-txt FORMAT "x(50)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE Browser-Table
     _TblList          = "asihlp.hlp-head"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = "USED"
     _FldNameList[1]   > asihlp.hlp-head.MSG-NUM
"hlp-head.MSG-NUM" "Message#" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > asihlp.hlp-head.FLD-NAME
"hlp-head.FLD-NAME" "Field Name" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > asihlp.hlp-head.FRM-TITLE
"hlp-head.FRM-TITLE" "Title" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > asihlp.hlp-head.FIL-NAME
"hlp-head.FIL-NAME" "Table Name" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > asihlp.hlp-head.FRM-NAME
"hlp-head.FRM-NAME" "Frame Name" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > asihlp.hlp-head.help-txt
"hlp-head.help-txt" ? "x(50)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
