...
begin_cust end_cust begin_i-no end_i-no tb_bld-bal rd_sort rd-dest lv-ornt ~
...
begin_i-no end_i-no tb_bld-bal lbl_sort rd_sort rd-dest lv-ornt ~
...
DEFINE FRAME FRAME-A
     tb_cust-list AT ROW 2.19 COL 31.8 WIDGET-ID 6
     btnCustList AT ROW 2.19 COL 64.2 WIDGET-ID 8
     begin_cust AT ROW 3.33 COL 26 COLON-ALIGNED HELP
          "Enter Beginning Customer Number"
     end_cust AT ROW 3.33 COL 69 COLON-ALIGNED HELP
          "Enter Ending Customer Number"
     begin_i-no AT ROW 4.29 COL 26 COLON-ALIGNED HELP
          "Enter Beginning Order Number"
     end_i-no AT ROW 4.29 COL 69 COLON-ALIGNED HELP
          "Enter Ending Item Number"
     tb_bld-bal AT ROW 6 COL 39
     lbl_sort AT ROW 7.67 COL 31 COLON-ALIGNED NO-LABEL
     rd_sort AT ROW 7.67 COL 40 NO-LABEL
     ...
     fi_file AT ROW 17 COL 49 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 18.62 COL 19
     btn-cancel AT ROW 18.62 COL 57
     "Selection Parameters" VIEW-AS TEXT
          SIZE 21 BY .71 AT ROW 1.24 COL 5
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 10.05 COL 2
...
------------------------------------------------------------------------------*/
  DISPLAY tb_cust-list begin_cust end_cust begin_i-no end_i-no tb_bld-bal 
          lbl_sort rd_sort rd-dest lv-ornt lines-per-page lv-font-no 
          lv-font-name td-show-parm tb_excel tb_runExcel fi_file 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE RECT-12 RECT-6 tb_cust-list btnCustList begin_cust end_cust begin_i-no 
         end_i-no tb_bld-bal rd_sort rd-dest lv-ornt lines-per-page lv-font-no 
