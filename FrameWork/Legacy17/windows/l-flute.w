...
&Scoped-define QUERY-STRING-BROWSE-1 FOR EACH flute ~
      WHERE flute.company = ip-company NO-LOCK
&Scoped-define OPEN-QUERY-BROWSE-1 OPEN QUERY BROWSE-1 FOR EACH flute ~
      WHERE flute.company = ip-company NO-LOCK.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-1 Dialog-Frame _STRUCTURED
  QUERY BROWSE-1 NO-LOCK DISPLAY
      flute.code FORMAT "x(3)":U
      flute.dscr FORMAT "x(30)":U
      flute.thickness FORMAT ">>.9999<<":U
      flute.class COLUMN-LABEL "SW/DW/TW" FORMAT "x(2)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE BROWSE-1
     _TblList          = "ASI.flute"
     _Options          = "NO-LOCK"
     _Where[1]         = "flute.company = ip-company"
...
"flute.class" "SW/DW/TW" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-1 */
&ANALYZE-RESUME
