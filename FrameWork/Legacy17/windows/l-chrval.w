...
def output parameter char-val as cha no-undo.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-1 D-Dialog _STRUCTURED
  QUERY BROWSE-1 DISPLAY
      tt-report.key-01 COLUMN-LABEL "Company"
...
DEFINE FRAME D-Dialog
     ...
     Btn_Cancel AT ROW 8.86 COL 30.2
     SPACE(38.39) SKIP(0.66)
...
"tt-report.key-01" "Vendor" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL D-Dialog D-Dialog
ON WINDOW-CLOSE OF FRAME D-Dialog /* Company Selection */
DO:  
...
DO I = 1 TO NUM-ENTRIES(v-ordxchr-val):
    ASSIGN thisOne = ENTRY(i,v-ordxchr-val).
