...
DEFINE VARIABLE h_phone2 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'browsers/phone2.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_phone2 ).
       RUN set-position IN h_phone2 ( 4.81 , 4.00 ) NO-ERROR.
       RUN set-size IN h_phone2 ( 9.29 , 117.00 ) NO-ERROR.

       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('2') NO-ERROR.

       /* Links to SmartNavBrowser h_phone2. */
       RUN add-link IN adm-broker-hdl ( h_p-navico , 'Navigation':U , h_phone2 ).
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-navico ).
       RUN set-position IN h_p-navico ( 11.95 , 4.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updsav ).
       RUN set-position IN h_p-updsav ( 11.95 , 65.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_phone-2 ).
       RUN set-position IN h_phone-2 ( 4.86 , 26.20 ) NO-ERROR.
       /* Size in UIB:  ( 6.91 , 73.00 ) */
       ...
       RUN add-link IN adm-broker-hdl ( h_phone2 , 'Record':U , h_phone-2 ).
