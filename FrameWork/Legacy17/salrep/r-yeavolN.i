            ...
            DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
               cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                    CASE cTmpField:             
                         ...
                         WHEN "name-city"   THEN cVarValue =  STRING(cust.NAME,"x(30)").
                         WHEN "rep"   THEN cVarValue = STRING(cust.sman,"x(3)").
                         WHEN "comp"  THEN cVarValue = STRING("  PTD:","x(6)") .
                         WHEN "$msf"   THEN cVarValue = STRING(v-a-m,"->>>9.99") .
                         WHEN "msf"  THEN cVarValue = STRING(v-msf[1],"->>>>9.9") .
                         WHEN "cost-sale"   THEN cVarValue = STRING(v-cst[1],"->>,>>>,>>9.99") .
                         WHEN "sale"  THEN cVarValue = STRING(v-amt[1],"->>,>>>,>>9.99") .
                         WHEN "%sale"    THEN cVarValue = string(v-pc1,"->>>9.9") .
                         WHEN "return"   THEN cVarValue = string(v-ret,"->>,>>>,>>9.99").
                         WHEN "%ofret"   THEN cVarValue = STRING(v-pc2,"->>>9.9").
                         WHEN "$ton"  THEN cVarValue = STRING(v-a-t,"->>>>>>9.99") .
                         WHEN "ton"   THEN cVarValue = STRING(v-ton[1],"->>>9.9") .
            ...
            DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
               cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                    CASE cTmpField:             
                         ...
                         WHEN "name-city"   THEN cVarValue =  string(cust.city + ", " + cust.state,"x(30)").
                         WHEN "rep"   THEN cVarValue = "".
                         WHEN "comp"  THEN cVarValue = STRING("  YTD:","x(6)") .
                         WHEN "$msf"   THEN cVarValue = STRING(v-a-m,"->>>9.99") .
                         WHEN "msf"  THEN cVarValue = STRING(v-msf[2],"->>>>9.9") .
                         WHEN "cost-sale"   THEN cVarValue = STRING(v-cst[2],"->>,>>>,>>9.99") .
                         WHEN "sale"  THEN cVarValue = STRING(v-amt[2],"->>,>>>,>>9.99") .
                         WHEN "%sale"    THEN cVarValue = string(v-pc1,"->>>9.9") .
                         WHEN "return"   THEN cVarValue = string(v-ret,"->>,>>>,>>9.99").
                         WHEN "%ofret"   THEN cVarValue = STRING(v-pc2,"->>>9.9").
                         WHEN "$ton"  THEN cVarValue = STRING(v-a-t,"->>>>>>9.99") .
                         WHEN "ton"   THEN cVarValue = STRING(v-ton[2],"->>>9.9") .
          ...
          ASSIGN cDisplay = ""
            ...
            DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
               cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                    CASE cTmpField:             
                         WHEN "cust"    THEN cVarValue = "" .
                         WHEN "name-city"   THEN cVarValue = string("PTD Sales Diff: " + string(v-dif,">>>>>>>>9.99-"),"x(30)") .
                         WHEN "rep"   THEN cVarValue = "".
                         WHEN "comp"  THEN cVarValue = STRING("PTDLY:","x(6)") .
                         WHEN "$msf"   THEN cVarValue = STRING(v-a-m,"->>>9.99") .
                         WHEN "msf"  THEN cVarValue = STRING(v-msf[3],"->>>>9.9") .
                         WHEN "cost-sale"   THEN cVarValue = STRING(v-cst[3],"->>,>>>,>>9.99") .
                         WHEN "sale"  THEN cVarValue = STRING(v-amt[3],"->>,>>>,>>9.99") .
                         WHEN "%sale"    THEN cVarValue = string(v-pc1,"->>>9.9") .
                         WHEN "return"   THEN cVarValue = string(v-ret,"->>,>>>,>>9.99").
                         WHEN "%ofret"   THEN cVarValue = STRING(v-pc2,"->>>9.9").
                         WHEN "$ton"  THEN cVarValue = STRING(v-a-t,"->>>>>>9.99") .
                         WHEN "ton"   THEN cVarValue = STRING(v-ton[3],"->>>9.9") .
          ...
          ASSIGN cDisplay = ""
            ...
            DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
               cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                    CASE cTmpField:             
                         WHEN "cust"    THEN cVarValue = "" .
                         WHEN "name-city"   THEN cVarValue = string("YTD Sales Diff: " + string(v-dif,">>>>>>>>9.99-"),"x(30)") .
                         WHEN "rep"   THEN cVarValue = "".
                         WHEN "comp"  THEN cVarValue = STRING("YTDLY:","x(6)") .
                         WHEN "$msf"   THEN cVarValue = STRING(v-a-m,"->>>9.99") .
                         WHEN "msf"  THEN cVarValue = STRING(v-msf[4],"->>>>9.9") .
                         WHEN "cost-sale"   THEN cVarValue = STRING(v-cst[4],"->>,>>>,>>9.99") .
                         WHEN "sale"  THEN cVarValue = STRING(v-amt[4],"->>,>>>,>>9.99") .
                         WHEN "%sale"    THEN cVarValue = string(v-pc1,"->>>9.9") .
                         WHEN "return"   THEN cVarValue = string(v-ret,"->>,>>>,>>9.99").
                         WHEN "%ofret"   THEN cVarValue = STRING(v-pc2,"->>>9.9").
                         WHEN "$ton"  THEN cVarValue = STRING(v-a-t,"->>>>>>9.99") .
                         WHEN "ton"   THEN cVarValue = STRING(v-ton[4],"->>>9.9") .
        ...
        ASSIGN cDisplay = ""
            ...
            DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
               cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                    CASE cTmpField:             
                         WHEN "cust"    THEN cVarValue = "" .
                         WHEN "name-city"   THEN cVarValue = "".
                         WHEN "rep"   THEN cVarValue = "".
                         WHEN "comp"  THEN cVarValue = STRING("  PTD:","x(6)") .
                         WHEN "$msf"   THEN cVarValue = STRING(v-a-m,"->>>9.99") .
                         WHEN "msf"  THEN cVarValue = STRING(v-msf[5],"->>>>9.9") .
                         WHEN "cost-sale"   THEN cVarValue = STRING(v-cst[5],"->>,>>>,>>9.99") .
                         WHEN "sale"  THEN cVarValue = STRING(v-amt[5],"->>,>>>,>>9.99") .
                         WHEN "%sale"    THEN cVarValue = string(v-pc1,"->>>9.9") .
                         WHEN "return"   THEN cVarValue = string(v-ret,"->>,>>>,>>9.99").
                         WHEN "%ofret"   THEN cVarValue = STRING(v-pc2,"->>>9.9").
                         WHEN "$ton"  THEN cVarValue = STRING(v-a-t,"->>>>>>9.99") .
                         WHEN "ton"   THEN cVarValue = STRING(v-ton[5],"->>>9.9") .
            ...
            DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
               cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                    CASE cTmpField:             
                         ...
                         WHEN "comp"  THEN cVarValue = STRING("  YTD:","x(6)") .
                         WHEN "$msf"   THEN cVarValue = STRING(v-a-m,"->>>9.99") .
                         WHEN "msf"  THEN cVarValue = STRING(v-msf[6],"->>>>9.9") .
                         WHEN "cost-sale"   THEN cVarValue = STRING(v-cst[6],"->>,>>>,>>9.99") .
                         WHEN "sale"  THEN cVarValue = STRING(v-amt[6],"->>,>>>,>>9.99") .
                         WHEN "%sale"    THEN cVarValue = string(v-pc1,"->>>9.9") .
                         WHEN "return"   THEN cVarValue = string(v-ret,"->>,>>>,>>9.99").
                         WHEN "%ofret"   THEN cVarValue = STRING(v-pc2,"->>>9.9").
                         WHEN "$ton"  THEN cVarValue = STRING(v-a-t,"->>>>>>9.99") .
                         WHEN "ton"   THEN cVarValue = STRING(v-ton[6],"->>>9.9") .
            ...
            DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
               cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                    CASE cTmpField:             
                         ...
                         WHEN "comp"  THEN cVarValue = STRING("PTDLY:","x(6)") .
                         WHEN "$msf"   THEN cVarValue = STRING(v-a-m,"->>>9.99") .
                         WHEN "msf"  THEN cVarValue = STRING(v-msf[7],"->>>>9.9") .
                         WHEN "cost-sale"   THEN cVarValue = STRING(v-cst[7],"->>,>>>,>>9.99") .
                         WHEN "sale"  THEN cVarValue = STRING(v-amt[7],"->>,>>>,>>9.99") .
                         WHEN "%sale"    THEN cVarValue = string(v-pc1,"->>>9.9") .
                         WHEN "return"   THEN cVarValue = string(v-ret,"->>,>>>,>>9.99").
                         WHEN "%ofret"   THEN cVarValue = STRING(v-pc2,"->>>9.9").
                         WHEN "$ton"  THEN cVarValue = STRING(v-a-t,"->>>>>>9.99") .
                         WHEN "ton"   THEN cVarValue = STRING(v-ton[7],"->>>9.9") .
            ...
            DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
               cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                    CASE cTmpField:             
                         ...
                         WHEN "comp"  THEN cVarValue = STRING("YTDLY:","x(6)") .
                         WHEN "$msf"   THEN cVarValue = STRING(v-a-m,"->>>9.99") .
                         WHEN "msf"  THEN cVarValue = STRING(v-msf[8],"->>>>9.9") .
                         WHEN "cost-sale"   THEN cVarValue = STRING(v-cst[8],"->>,>>>,>>9.99") .
                         WHEN "sale"  THEN cVarValue = STRING(v-amt[8],"->>,>>>,>>9.99") .
                         WHEN "%sale"    THEN cVarValue = string(v-pc1,"->>>9.9") .
                         WHEN "return"   THEN cVarValue = string(v-ret,"->>,>>>,>>9.99").
                         WHEN "%ofret"   THEN cVarValue = STRING(v-pc2,"->>>9.9").
                         WHEN "$ton"  THEN cVarValue = STRING(v-a-t,"->>>>>>9.99") .
                         WHEN "ton"   THEN cVarValue = STRING(v-ton[8],"->>>9.9") .
