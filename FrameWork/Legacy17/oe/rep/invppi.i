...
PUT "<P10><R15><C1><#2>" 
            ...
            SPACE(6) inv-head.cust-name v-shipto-name AT 60 skip
            SPACE(6) inv-head.addr[1]   v-shipto-addr[1] AT 60 SKIP
            SPACE(6) inv-head.addr[2]  v-shipto-addr[2] AT 60 SKIP
...
PUT "<R27><C1><#5><FROM><R29><C81><RECT><||3>" SKIP    
    ...
    "<=5><R+1>  Cust PO#      Ship   Order Item#/CustPart#       Description           Price   UOM    Amount" SKIP(1).
