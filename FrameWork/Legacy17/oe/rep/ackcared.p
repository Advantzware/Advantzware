  ...
  FOR EACH report WHERE report.term-id EQ v-term-id NO-LOCK,
      ...
      END.
        ...
        put v-line FORM ">>>9" SPACE(3)
            oe-ordl.part-no  SPACE(2)             
            oe-ordl.part-dscr1 SPACE(2)
            oe-ordl.qty SPACE(2)
        ...
        if oe-ordl.i-no NE "" or
           oe-ordl.i-name ne ""        then do:
          v-part =  oe-ordl.i-no .
          put v-part             at 8
              oe-ordl.i-name at 25 skip.
          v-printline = v-printline + 1.
        end. 
        
        IF AVAIL oe-rel THEN
        if oe-rel.po-no ne "" then do:
            PUT oe-rel.po-no  AT 8 .
            /*v-printline = v-printline + 1.*/
        end.  /* task 11051303 */
        ...
        END.
        /* task 11051303 */
        IF ( NOT v-schrel AND NOT v-actrel) THEN do:
        PUT SKIP(1).
        v-printline = v-printline + 1.
        END.
        IF ( v-schrel OR  v-actrel) THEN do:
        ...
        do:
          ...
          put lcnt AT 10 SPACE(2) (IF oe-rel.link-no EQ 0 THEN oe-rel.tot-qty ELSE oe-rel.qty) FORMAT "->,>>>,>>9" space(5) ld-date  SKIP.
            ...
            IF AVAIL shipto THEN DO:
               ...
               do:
                ...
                put shipto.ship-name AT 10 SKIP 
                    ...
                    v-addr4 AT 10 SKIP(1).
                v-printline = v-printline + 5.
            END.
          end.
          ELSE DO:
              if LAST(oe-rel.link-no) then do:
              PUT SKIP(1).
                v-printline = v-printline + 1.
              END.
          END.
