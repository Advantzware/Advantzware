   ...
   FOR EACH tt-report WHERE tt-report.term-id EQ ""
      ...
      IF AVAIL oe-relh THEN
         ASSIGN
            ...
            v-rel-no  = IF rd_rel BEGINS "N" AND v-rel-no EQ 0 THEN oe-rell.rel-no ELSE v-rel-no
      ...
      ELSE
         IF AVAIL oe-rel THEN
            ASSIGN
               ...
               v-rel-no  = IF rd_rel BEGINS "N" AND v-rel-no EQ 0 THEN oe-rel.rel-no ELSE v-rel-no
