...
&Scoped-define FIELDS-IN-QUERY-br_table fa-entity asset-code asset-desc ~
asset-status date-aquired date-service date-retired multiple Sale-date 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTable _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      fa-entity COLUMN-LABEL "Company" FORMAT "x(8)":U WIDTH 13.2
      asset-code FORMAT "x(8)":U WIDTH 16.2
      asset-desc FORMAT "x(30)":U WIDTH 59.2
      asset-status FORMAT "x(1)":U WIDTH 18.4
      date-aquired FORMAT "99/99/99":U WIDTH 20.4
      date-service FORMAT "99/99/9999":U WIDTH 18
      date-retired FORMAT "99/99/99":U WIDTH 19
      multiple FORMAT "999":U WIDTH 19.2
      Sale-date FORMAT "99/99/99":U WIDTH 20.4
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 215 BY 6.67
...
"fa-entity" "Company" ? "character" ? ? ? ? ? ? no ? no no "13.2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > _<SDO>.rowObject.asset-code
"asset-code" ? ? "character" ? ? ? ? ? ? no ? no no "16.2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > _<SDO>.rowObject.asset-desc
"asset-desc" ? ? "character" ? ? ? ? ? ? no ? no no "59.2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > _<SDO>.rowObject.asset-status
"asset-status" ? ? "character" ? ? ? ? ? ? no ? no no "18.4" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > _<SDO>.rowObject.date-aquired
"date-aquired" ? ? "date" ? ? ? ? ? ? no ? no no "20.4" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > _<SDO>.rowObject.date-service
"date-service" ? ? "date" ? ? ? ? ? ? no ? no no "18" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > _<SDO>.rowObject.date-retired
"date-retired" ? ? "date" ? ? ? ? ? ? no ? no no "19" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > _<SDO>.rowObject.multiple
"multiple" ? ? "integer" ? ? ? ? ? ? no ? no no "19.2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > _<SDO>.rowObject.Sale-date
"Sale-date" ? ? "date" ? ? ? ? ? ? no ? no no "20.4" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
