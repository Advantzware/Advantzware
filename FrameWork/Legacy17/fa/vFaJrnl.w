...
DEF SHARED VAR h_pupdsave AS HANDLE.

{pt/setinit use-file 'sales-jrnl'}
DEF VAR do-copy AS LOG.
DEF NEW SHARED VAR do-delete AS   LOG.
DEF SHARED VAR waction   AS   CHAR.
DEF SHARED VAR waction1  AS   CHAR.
DEF SHARED VAR wsequence LIKE  z_numgen.l-sequence.
DEF SHARED VAR wdo-audit LIKE  z_numgen.do-audit.
DEF SHARED VAR wkey      LIKE buyer.buyer-code no-undo.
DEF SHARED VAR wwkey     LIKE wkey.
DEF SHARED VAR kase      AS   INT NO-UNDO.
DEF SHARED VAR wentered  AS   LOG.
DEF SHARED VAR pgm       AS   CHAR FORMAT "x(13)".
DEF NEW SHARED BUFFER    wznumgen FOR  z_numgen.
DEF SHARED VAR deleteok  AS LOG.
DEF SHARED VAR waction2   AS   CHAR.
DEF SHARED VAR wsequence2 LIKE  z_audit.sequence.
DEF SHARED VAR wwsequence LIKE  z_audit.sequence.
DEF SHARED VAR wdo-audit2 LIKE  z_numgen.do-audit.
DEF SHARED VAR wwaction   AS   CHAR.
DEF SHARED VAR wwaction1  AS   CHAR.
DEF SHARED VAR wwdo-audit LIKE  z_numgen.do-audit.

DEF SHARED VAR wkey1      LIKE sales-jrnl.ar-entity NO-UNDO.
DEF SHARED VAR wwkey1     LIKE wkey1.
DEF SHARED VAR wkey2      LIKE mat-burd-rt.effective NO-UNDO.
DEF SHARED VAR wwkey2     LIKE wkey2.
DEF SHARED VAR wwwkey2    LIKE wkey2.
DEF SHARED VAR h_viewer AS HANDLE NO-UNDO.
DEF SHARED VAR h_parent AS HANDLE.
