...
&Scoped-Define ENABLED-OBJECTS cEstNo btnOk BtnCancel 
&Scoped-Define DISPLAYED-OBJECTS cEstNo 
...
DEFINE VARIABLE cEstNo AS CHARACTER FORMAT "X(256)":U INITIAL "0" 
     LABEL "Estimate#" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME DEFAULT-FRAME
     cEstNo AT ROW 2.43 COL 32 COLON-ALIGNED
...
ON END-ERROR OF C-Win /* Restore Estimates */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Restore Estimates */
DO:
...
DO:
   ...
   MESSAGE "Are you sure you want to restore Estimate?"
   ...
   DO WITH FRAME {&FRAME-NAME}:
      ...
      IF NOT CAN-FIND(est WHERE est.company = cocode AND est.est-no = cEstNo)  THEN DO:
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
   ...
   RUN enable_UI.
    ...
    {methods/setButton.i btnOk "Run"} /* added by script _nonAdm1Images1.p */
