...
&Scoped-define FIELDS-IN-QUERY-br_table bol-no i-name inv-no line i-dscr 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      bol-no FORMAT ">>>>>>>9":U
      i-name FORMAT "x(30)":U
      inv-no FORMAT ">>>>>9":U
      line FORMAT "999":U
      i-dscr FORMAT "x(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 89 BY 6.91 FIT-LAST-COLUMN.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.bol-no
     _FldNameList[2]   = _<SDO>.rowObject.i-name
     _FldNameList[3]   = _<SDO>.rowObject.inv-no
     _FldNameList[4]   = _<SDO>.rowObject.line
     _FldNameList[5]   > _<SDO>.rowObject.i-dscr
"i-dscr" ? ? "character" ? ? ? ? ? ? no ? no no "29.2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
