...
&Scoped-Define ENABLED-OBJECTS RECT-42 btnOk 
&Scoped-Define DISPLAYED-OBJECTS fi_folder 
...
DEFINE VARIABLE fi_folder AS CHARACTER FORMAT "X(256)":U 
     LABEL "Image Folder" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME DEFAULT-FRAME
     fi_folder AT ROW 3.14 COL 16.4 COLON-ALIGNED
     btnOk AT ROW 4.43 COL 31.6
     "Set FG Images" VIEW-AS TEXT
          SIZE 15.4 BY .62 AT ROW 2.1 COL 5.8
...
ON END-ERROR OF C-Win /* Set FG Images */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Set FG Images */
DO:
...
DO:
   ...
   DO:
      ...
      INPUT FROM OS-DIR (v-graphic-char) ECHO.
      ...
      MESSAGE "FG Item Image File(s) Saved."
