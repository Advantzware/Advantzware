...
&SCOPED-DEFINE dataGridInclude dataGrid\browsers\terms.i
...
&Scoped-define QUERY-STRING-Browser-Table FOR EACH terms WHERE ~{&KEY-PHRASE} ~
    ...
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Browser-Table OPEN QUERY Browser-Table FOR EACH terms WHERE ~{&KEY-PHRASE} ~
      AND terms.company = gcompany NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Browser-Table terms
&Scoped-define FIRST-TABLE-IN-QUERY-Browser-Table terms
...
DEFINE FRAME F-Main
     ...
     auto_find AT ROW 19.33 COL 55 COLON-ALIGNED HELP
          "Enter Auto Find Value"
     Btn_Clear_Find AT ROW 19.33 COL 79 HELP
