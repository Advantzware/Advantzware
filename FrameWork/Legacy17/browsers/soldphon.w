...
&Scoped-define INTERNAL-TABLES phone soldto
...
&Scoped-define QUERY-STRING-Browser-Table FOR EACH phone WHERE NOT phone.table_rec_key = '' NO-LOCK, ~
      EACH soldto WHERE soldto.rec_key = phone.table_rec_key NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Browser-Table OPEN QUERY Browser-Table FOR EACH phone WHERE NOT phone.table_rec_key = '' NO-LOCK, ~
      EACH soldto WHERE soldto.rec_key = phone.table_rec_key NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Browser-Table phone soldto
&Scoped-define FIRST-TABLE-IN-QUERY-Browser-Table phone
&Scoped-define SECOND-TABLE-IN-QUERY-Browser-Table soldto
...
DEFINE QUERY Browser-Table FOR 
    ...
    FIELDS(phone.attention
      ...
      phone.rec_key), 
      soldto
    FIELDS(soldto.cust-no
      soldto.sold-id
      soldto.sold-name) SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      soldto.cust-no FORMAT "x(8)":U LABEL-BGCOLOR 4
      soldto.sold-id FORMAT "x(8)":U LABEL-BGCOLOR 4
      soldto.sold-name FORMAT "x(30)":U LABEL-BGCOLOR 4
...
/* Query rebuild information for BROWSE Browser-Table
     _TblList          = "NOSWEAT.phone WHERE asi.emailcod <external> ... ...,asi.soldto WHERE NOSWEAT.phone ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = "USED, USED,"
     _JoinCode[1]      = "NOT NOSWEAT.phone.table_rec_key = ''"
     _JoinCode[2]      = "asi.soldto.rec_key = NOSWEAT.phone.table_rec_key"
     _FldNameList[1]   > asi.soldto.cust-no
"asi.soldto.cust-no" ? ? "character" ? ? ? 4 ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > asi.soldto.sold-id
"asi.soldto.sold-id" ? ? "character" ? ? ? 4 ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > asi.soldto.sold-name
"asi.soldto.sold-name" ? ? "character" ? ? ? 4 ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > NOSWEAT.phone.attention
"NOSWEAT.phone.attention" ? ? "character" ? ? ? 4 15 ? no ? no no "38" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > NOSWEAT.phone.titlcode
"NOSWEAT.phone.titlcode" "Title" ? "character" ? ? ? 4 15 ? no ? no no "10" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
