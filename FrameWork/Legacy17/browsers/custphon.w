...
&SCOPED-DEFINE dataGridInclude dataGrid\browsers\custphon.i
...
&Scoped-define INTERNAL-TABLES phone cust
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      cust.cust-no FORMAT "x(8)":U LABEL-FGCOLOR 15 LABEL-BGCOLOR 4
...
DO:
  ...
  {methods/run_link.i "CONTAINER-SOURCE" "setPhoneValues" "('Customer',ROWID(cust))"}
...
------------------------------------------------------------------------------*/
  ...
  DO i = 1 TO {&BROWSE-NAME}:NUM-SELECTED-ROWS IN FRAME {&FRAME-NAME}:
    ...
    IF NOT CAN-FIND(FIRST reftable WHERE
       reftable.rec_key = STRING(phone.rec_key) AND
       reftable.CODE    = emailcod.emailcod) THEN
       DO:
          CREATE reftable.
          ASSIGN reftable.rec_key = STRING(phone.rec_key)
