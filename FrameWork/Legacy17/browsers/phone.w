...
&SCOPED-DEFINE dataGridInclude dataGrid\browsers\phone.i
...
phone.phone_city_code phone.phone phone.phone_ext phone.fax_city_code ~
phone.fax phone.e_mail 
&Scoped-define ENABLED-FIELDS-IN-QUERY-Browser-Table 
&Scoped-define QUERY-STRING-Browser-Table FOR EACH phone WHERE ~{&KEY-PHRASE} ~
      AND phone.table_rec_key = ip-rec_key NO-LOCK ~
    ~{&SORTBY-PHRASE}
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD RefreshBrowse B-table-Win 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      phone.attention FORMAT "X(35)":U WIDTH 29
      ...
      phone.e_mail COLUMN-LABEL "E-Mail Address" FORMAT "X(30)":U
            WIDTH 34
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION RefreshBrowse B-table-Win 
FUNCTION RefreshBrowse RETURNS CHARACTER
