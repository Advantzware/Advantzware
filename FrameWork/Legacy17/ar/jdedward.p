...
for first ar-invl where recid(ar-invl) eq v-recid no-lock,
  ...
  output stream s-jded to value(v-out + v-slash + "JDEDWARD.TXT") append.
  ...
  /* Billing Terms */
  v-jded = v-jded + string(ar-inv.terms-d,"x(30)").
  ...
  /* Item Number */
  v-jded = v-jded + string(ar-invl.i-no,"x(15)").
  ...
  v-jded = v-jded + string(ar-invl.part-no,"x(15)").
  
  /* Customer's item description line 1 */
  v-jded = v-jded + string(ar-invl.part-dscr1,"x(30)").
  
  /* Customer's item description line 2 */
  v-jded = v-jded + string(ar-invl.part-dscr2,"x(30)").
  ...
  /* Ship Date */
  assign
   v-date = if avail oe-bolh then oe-bolh.bol-date else ar-inv.inv-date
   v-jded = v-jded + string(year(v-date),"9999") +
                     string(month(v-date),"99")  +
                     string(month(v-date),"99").
  ...
  assign
   v-dec  = if avail tt-cost then tt-cost else 0
   v-jded = v-jded + string(v-dec,">>>>>>9.99<<<<").
