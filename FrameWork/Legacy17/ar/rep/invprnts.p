/* ------------------------------------------- ar/rep/invprnts.p   BV */
/* PRINT INVOICE   PRINTERS (Loylang )  - copied from Soule                   */
/* -------------------------------------------------------------------------- */
...
DEFINE VARIABLE li-on-order AS INTEGER NO-UNDO.
     ...
     FOR EACH ar-invl NO-LOCK 
         ...
         PUT 
          ...
          SKIP
           SPACE(6)
             /*v-ord-no    FORMAT ">>>>>>" */
           SPACE(11) v-i-dscr    FORMAT "x(30)"
/*            SPACE(2) ar-invl.qty FORMAT "->>>>>9" */
           SPACE(20) v-pc  
           SPACE(0)  v-price-head 
           SPACE(1) 
          SKIP
           SPACE(1)
         ...
         ASSIGN v-printline = v-printline + 5.
