...
------------------------------------------------------------------------------*/
  ...
  RUN get-link-handle IN adm-broker-hdl (THIS-PROCEDURE,"farmNav-Source",OUTPUT char-hdl).

  IF VALID-HANDLE(WIDGET-HANDLE(char-hdl)) THEN DO:
    RUN farmNav IN WIDGET-HANDLE(char-hdl) (ipButton,OUTPUT navType).
    DO WITH FRAME {&FRAME-NAME}:
      ENABLE ALL.
      IF navType EQ "F" THEN DISABLE btn-first btn-prev.
      IF navType EQ "L" THEN DISABLE btn-last btn-next.
      IF navType EQ "B" THEN DISABLE ALL.
    END.
  END.
