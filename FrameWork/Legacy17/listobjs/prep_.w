...
&Scoped-define WHERE-STATEMENT prep.company = gcompany AND prep.loc = gloc
...
&Scoped-Define ENABLED-OBJECTS RECT-2 RECT-1 list-order begin_code end_code 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_code begin_prep_dscr ~
end_code end_prep_dscr F1 F-2 F-3 F-4 
...
DEFINE VARIABLE begin_code AS CHARACTER FORMAT "X(10)" 
     LABEL "Beginning  Preperation Code" 
     VIEW-AS FILL-IN 
     SIZE 15.6 BY 1.

DEFINE VARIABLE begin_prep_dscr AS CHARACTER FORMAT "X(30)" 
     LABEL "Beginning Description" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE end_code AS CHARACTER FORMAT "X(10)" 
     LABEL "Ending Preperation Code" 
     VIEW-AS FILL-IN 
     SIZE 15.6 BY 1.

DEFINE VARIABLE end_prep_dscr AS CHARACTER FORMAT "X(30)" 
...
DEFINE FRAME F-Main
     ...
     begin_code AT ROW 4.81 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Preperation Code"
     begin_prep_dscr AT ROW 6 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Description"
     end_code AT ROW 8.14 COL 45 COLON-ALIGNED HELP
          "Enter Ending Preperation Code"
     end_prep_dscr AT ROW 9.33 COL 45 COLON-ALIGNED HELP
...
/* SETTINGS FOR FILL-IN begin_prep_dscr IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN end_prep_dscr IN FRAME F-Main
   NO-ENABLE                                                            */
