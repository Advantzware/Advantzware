...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES ventype
&Scoped-define FIRST-EXTERNAL-TABLE ventype


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR ventype.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS RECT-2 RECT-1 list-order begin_ventype ~
end_ventype 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_ventype ~
begin_ventype_dscr end_ventype end_ventype_dscr F1 F-2 F-3 F-4 
...
DEFINE VARIABLE begin_ventype AS CHARACTER FORMAT "X(8)" 
     LABEL "Beginning  Vendor Type" 
     VIEW-AS FILL-IN 
     SIZE 15.6 BY 1.

DEFINE VARIABLE begin_ventype_dscr AS CHARACTER FORMAT "X(30)" 
     LABEL "Beginning Description" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE end_ventype AS CHARACTER FORMAT "X(8)" 
     LABEL "Ending Vendor Type" 
     VIEW-AS FILL-IN 
     SIZE 15.6 BY 1.

DEFINE VARIABLE end_ventype_dscr AS CHARACTER FORMAT "X(30)" 
...
DEFINE FRAME F-Main
     ...
     begin_ventype AT ROW 4.81 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Vendor Type"
     begin_ventype_dscr AT ROW 6 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Description"
     end_ventype AT ROW 8.14 COL 45 COLON-ALIGNED HELP
          "Enter Ending Vendor Type"
     end_ventype_dscr AT ROW 9.33 COL 45 COLON-ALIGNED HELP
          "Enter Ending Description"
     F1 AT ROW 4.81 COL 63 NO-LABEL
     F-2 AT ROW 6 COL 91 NO-LABEL
     F-3 AT ROW 8.14 COL 63 NO-LABEL
...
/* SETTINGS FOR FILL-IN begin_ventype_dscr IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN end_ventype_dscr IN FRAME F-Main
   NO-ENABLE                                                            */
