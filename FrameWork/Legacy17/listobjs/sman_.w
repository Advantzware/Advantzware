...
&Scoped-Define ENABLED-OBJECTS RECT-1 RECT-2 list-order begin_sman end_sman ~
tb_matrix 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_sman begin_sman_sname ~
end_sman end_sman_sname tb_matrix F1 F-2 F-3 F-4 
...
DEFINE VARIABLE begin_sman AS CHARACTER FORMAT "X(3)" 
     LABEL "Beginning Sale Rep" 
     VIEW-AS FILL-IN 
     SIZE 15.6 BY 1.

DEFINE VARIABLE begin_sman_sname AS CHARACTER FORMAT "X(20)" 
     LABEL "Beginning Name" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE end_sman AS CHARACTER FORMAT "X(3)" 
     LABEL "Ending Sales Rep" 
     VIEW-AS FILL-IN 
     SIZE 15.6 BY 1.

DEFINE VARIABLE end_sman_sname AS CHARACTER FORMAT "X(20)" 
     LABEL "Ending Name" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.
...
DEFINE VARIABLE tb_matrix AS LOGICAL INITIAL no 
     LABEL "Print Commission Matrix?" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME F-Main
     ...
     begin_sman AT ROW 4.57 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Sales Rep"
     begin_sman_sname AT ROW 5.76 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Name"
     end_sman AT ROW 7.43 COL 45 COLON-ALIGNED HELP
          "Enter Ending Sales Rep"
     end_sman_sname AT ROW 8.62 COL 45 COLON-ALIGNED HELP
          "Enter Ending Name"
     tb_matrix AT ROW 10.29 COL 47
...
/* SETTINGS FOR FILL-IN begin_sman_sname IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN end_sman_sname IN FRAME F-Main
   NO-ENABLE                                                            */
...
ASSIGN 
       tb_matrix:PRIVATE-DATA IN FRAME F-Main     = 
                "save".
