...
&Scoped-Define ENABLED-OBJECTS list-order begin_vend-no end_vend-no ~
show-totals RECT-1 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_vend-no begin_vend_name ~
end_vend-no end_vend_name show-totals F-4 

/* Custom List Definitions                                              */
/* List-1,List-2,List-3,List-4,List-5,F1                                */
&Scoped-define F1 F-4 
...
DEFINE VARIABLE begin_vend_name AS CHARACTER FORMAT "X(30)" 
     LABEL "Beginning Vendor Name" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE end_vend-no AS CHARACTER FORMAT "X(8)" 
     LABEL "Ending Vendor" 
     VIEW-AS FILL-IN 
     SIZE 15.6 BY 1.

DEFINE VARIABLE end_vend_name AS CHARACTER FORMAT "X(30)" 
     LABEL "Ending Vendor Name" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.
...
DEFINE FRAME F-Main
     ...
     begin_vend-no AT ROW 4.1 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Vendor"
     begin_vend_name AT ROW 5.29 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Vendor Name"
     end_vend-no AT ROW 7.19 COL 45 COLON-ALIGNED HELP
          "Enter Ending Vendor"
     end_vend_name AT ROW 8.38 COL 45 COLON-ALIGNED HELP
          "Enter Ending Vendor Name"
     show-totals AT ROW 10.29 COL 47 HELP
...
/* SETTINGS FOR FILL-IN begin_vend_name IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN end_vend_name IN FRAME F-Main
   NO-ENABLE                                                            */
