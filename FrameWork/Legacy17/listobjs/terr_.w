...
&Scoped-Define ENABLED-OBJECTS RECT-2 RECT-1 list-order begin_terr end_terr 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_terr begin_terr_dscr ~
end_terr_dscr F1 F-2 F-3 F-4 
...
DEFINE VARIABLE begin_terr AS CHARACTER FORMAT "X(3)" 
     LABEL "Beginning Territory" 
     VIEW-AS FILL-IN 
     SIZE 15.6 BY 1.

DEFINE VARIABLE begin_terr_dscr AS CHARACTER FORMAT "X(20)" 
     LABEL "Beginning Description" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE end_terr AS CHARACTER FORMAT "X(3)" 
     LABEL "Ending Territory" 
     VIEW-AS FILL-IN 
     SIZE 15.6 BY 1.

DEFINE VARIABLE end_terr_dscr AS CHARACTER FORMAT "X(20)" 
...
DEFINE FRAME F-Main
     ...
     begin_terr AT ROW 4.81 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Territory"
     begin_terr_dscr AT ROW 6 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Description"
     end_terr AT ROW 8.14 COL 45 COLON-ALIGNED HELP
          "Enter Ending Territory"
     end_terr_dscr AT ROW 9.33 COL 45 COLON-ALIGNED HELP
...
/* SETTINGS FOR FILL-IN begin_terr_dscr IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN end_terr IN FRAME F-Main
   NO-DISPLAY                                                           */
/* SETTINGS FOR FILL-IN end_terr_dscr IN FRAME F-Main
   NO-ENABLE                                                            */
