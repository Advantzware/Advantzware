...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES buyer
&Scoped-define FIRST-EXTERNAL-TABLE buyer


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR buyer.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS RECT-2 RECT-1 list-order begin_buyer ~
end_buyer 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_buyer begin_buyer_buyer-n ~
end_buyer end_buyer_buyer-n F1 F-2 F-3 F-4 
...
DEFINE VARIABLE begin_buyer AS CHARACTER FORMAT "X(3)" 
     LABEL "Beginning Buyer" 
     VIEW-AS FILL-IN 
     SIZE 7 BY 1.

DEFINE VARIABLE begin_buyer_buyer-n AS CHARACTER FORMAT "X(30)" 
     LABEL "Beginning Buyer Name" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE end_buyer AS CHARACTER FORMAT "X(3)" 
     LABEL "Ending Buyer" 
     VIEW-AS FILL-IN 
     SIZE 7 BY 1.

DEFINE VARIABLE end_buyer_buyer-n AS CHARACTER FORMAT "X(30)" 
     LABEL "Ending Buyer Name" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.
...
DEFINE FRAME F-Main
     ...
     begin_buyer AT ROW 4.81 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Buyer"
     begin_buyer_buyer-n AT ROW 6 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Buyer Name"
     end_buyer AT ROW 8.14 COL 45 COLON-ALIGNED HELP
          "Enter Ending Buyer"
     end_buyer_buyer-n AT ROW 9.33 COL 45 COLON-ALIGNED HELP
          "Enter Ending Buyer Name"
...
/* SETTINGS FOR FILL-IN begin_buyer_buyer-n IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN end_buyer_buyer-n IN FRAME F-Main
   NO-ENABLE                                                            */
