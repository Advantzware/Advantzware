...
&Scoped-Define ENABLED-OBJECTS RECT-1 RECT-2 list-order begin_carrier ~
end_carrier show-matrix 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_carrier ~
begin_carrier_dscr end_carrier_dscr show-matrix F1 F-2 F-3 F-4 
...
DEFINE VARIABLE begin_carrier AS CHARACTER FORMAT "X(5)" 
     LABEL "Beginning Carrier" 
     VIEW-AS FILL-IN 
     SIZE 15.6 BY 1.

DEFINE VARIABLE begin_carrier_dscr AS CHARACTER FORMAT "X(20)" 
     LABEL "Beginning Description" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE end_carrier AS CHARACTER FORMAT "X(5)" 
     LABEL "Ending Carrier" 
     VIEW-AS FILL-IN 
     SIZE 15.6 BY 1.

DEFINE VARIABLE end_carrier_dscr AS CHARACTER FORMAT "X(20)" 
...
DEFINE VARIABLE show-matrix AS LOGICAL INITIAL no 
...
DEFINE FRAME F-Main
     ...
     begin_carrier AT ROW 3.86 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Carrier"
     begin_carrier_dscr AT ROW 5.05 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Description"
     end_carrier AT ROW 7.19 COL 45 COLON-ALIGNED HELP
          "Enter Ending Carrier"
     end_carrier_dscr AT ROW 8.38 COL 45 COLON-ALIGNED HELP
          "Enter Ending Description"
     show-matrix AT ROW 10.29 COL 47 HELP
          "Select to Show Product Matrix"
...
/* SETTINGS FOR FILL-IN begin_carrier_dscr IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN end_carrier IN FRAME F-Main
   NO-DISPLAY                                                           */
/* SETTINGS FOR FILL-IN end_carrier_dscr IN FRAME F-Main
   NO-ENABLE                                                            */
...
ASSIGN 
       show-matrix:PRIVATE-DATA IN FRAME F-Main     = 
                "save".
