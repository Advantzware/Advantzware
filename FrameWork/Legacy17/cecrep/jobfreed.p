/* ---------------------------------------------- */
/*  cecrep/jobfreed.p  factory ticket  for Freedman landscape */
/* -------------------------------------------------------------------------- */
...
*/
        ...
        ASSIGN
        v-inst = ""
        v-dept-note[42] = "PM: " + IF AVAIL xoe-ord THEN xoe-ord.user-id ELSE "".
            ...
            PUT "<R1><C1><#1>"   /*SKIP         */
             ...
             PUT "<R1><C1><#15><C35><P16><B> BILL OF MATERIALS<P7>" SKIP(4)
                ...
                /* "<P10><B>Our Date: " AT 65 v-ord-date */
                 ...
                 v-cus[1] AT 3 "<C25>" "    PO#:" xoe-ordl.po-no "Set Qty: " STRING(v-set-qty,">>>>>>>")
                 ...
                 "<C2>FINISHED GOOD#  CUSTOMER PART# DESCRIPTION               QTY PER SET               CAD#           STYLE" SKIP.
             /* each components */                                                    
             ...
             FOR EACH xeb NO-LOCK 
                 ...
                 PUT 
                    ...
                    if avail xstyle then xstyle.dscr else "" FORMAT "x(30)" AT 100. 
                 PUT SKIP.
             ...
             DO i = 1 TO v-last-note-line:                
                IF i > iNotePrtLine THEN DO:  /* 1st page - 23 2nd - 53, 3rd 83...*/
                   ...
                   PUT "<R1><C1><#15><C35><P16><B> BILL OF MATERIALS<P7>" SKIP(4)
                      ...
                      .
                END.
                IF i <= 4 THEN PUT v-dept-inst[i] AT 5 FORM "x(90)" chr(124) format "xx" v-shp[1] SKIP .
