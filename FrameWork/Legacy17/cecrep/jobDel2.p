/* ---------------------------------------------                  */
/* cecrep/jobdel2.p   Factory ticket  Landscape   for Delta       */
/* -------------------------------------------------------------- */
...
def TEMP-TABLE w-rec field w-recdate as date field w-rec-qty as dec.
...
v-oecount = avail sys-ctrl and sys-ctrl.log-fld.
  ...
  FIND FIRST bf-oe-ordl WHERE
       bf-oe-ordl.company EQ xeb.company AND
       bf-oe-ordl.ord-no EQ xoe-ordl.ord-no AND
       bf-oe-ordl.i-no EQ xeb.stock-no
       NO-LOCK NO-ERROR.
  ...
  display "<P8><U>Packing:</U>" AT 13
          ...
          bf-oe-ordl.cas-cnt when avail bf-oe-ordl @ xeb.cas-cnt*/
          SKIP
          "# Per Unit:" AT 4 xeb.tr-cnt when avail xeb
         /* xoe-ordl.cases-unit when avail xoe-ordl @ xeb.tr-cnt
          bf-oe-ordl.cases-unit when avail bf-oe-ordl @ xeb.tr-cnt*/
          SKIP
          /* pattern*/
