/* ----------------------------------------------  */
/*  cecrep/jobsuthr.p  Corrugated factory ticket  for Sutherland */
/* -------------------------------------------------------------------------- */
...
*/
      ...
      /* gdm - 09300905 end */
        ...
        if avail xeb then do:
          ...
          /* task # 05121003 per user the FG# should change NOT display just 1st FG# on job ticket */
          /*if xeb.stock-no ne "" then v-fg = xeb.stock-no.
          v-cp = xeb.part-no.*/
          if bf-eb.stock-no ne "" then v-fg = bf-eb.stock-no.
          v-cp = bf-eb.part-no.
