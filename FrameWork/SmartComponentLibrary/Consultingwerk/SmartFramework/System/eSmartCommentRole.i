...
DEFINE {&ACCESS} TEMP-TABLE eSmartCommentRole NO-UNDO {&REFERENCE-ONLY} &IF DEFINED (NO-BEFORE) EQ 0 &THEN BEFORE-TABLE eSmartCommentRoleBefore &ENDIF
    FIELD CommentRoleGUID AS CHARACTER FORMAT "x(36)":U LABEL "CommentRoleGUID":T SERIALIZE-NAME "CommentRoleGUID":U XML-DATA-TYPE "string":U XML-NODE-TYPE "ELEMENT":U
    ...
    INDEX CommentRoleGUID AS UNIQUE CommentRoleGUID ASCENDING
