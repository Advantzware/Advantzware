/* Progress constants and function definitions for LL17.DLL */
/*  (c) 1991,..,1999,2000,..,06,... combit GmbH, Konstanz, Germany  */
/*  [build of 2012-06-27 08:06:41] */
...
&GLOBAL-DEFINE LL_DEBUG_CMBTXL64                                   1024 /* (0x0400) debug CXLLnnXL.DLL */
...
&GLOBAL-DEFINE LL_VERSION_SERNO_LO                                    3 /* (3) LOWORD(serial number) */
&GLOBAL-DEFINE LL_VERSION_SERNO_HI                                    4 /* (4) HIWORD(serial number) */
&GLOBAL-DEFINE LL_VERSION_OEMNO                                       5 /* (5) OEM number */
&GLOBAL-DEFINE LL_VERSION_RESMAJOR                                   11 /* (11) internal, for LlRCGetVersion: resource version */
&GLOBAL-DEFINE LL_VERSION_RESMINOR                                   12 /* (12) internal, for LlRCGetVersion: resource version */
&GLOBAL-DEFINE LL_VERSION_RESLANGUAGE                                14 /* (14) internal, for LlRCGetVersion: resource language */
...
&GLOBAL-DEFINE LL_PROJECT_LAST                                        5 /* (5)  */
...
&IF DEFINED(CMLL17_PERSISTENT)=0 &THEN
 &GLOBAL-DEFINE CMLL17_PERSISTENT PERSISTENT
&ENDIF

&IF DEFINED(CMLL17_DLLNAME)=0 &THEN
 &GLOBAL-DEFINE CMLL17_DLLNAME CMLL17.DLL
&ENDIF

/* functions */

    PROCEDURE LlJobOpen EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 10 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER nLanguage AS LONG.
    END.
    PROCEDURE LlJobOpenLCID EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 12 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER nLCID AS LONG.
    END.
    PROCEDURE LlJobClose EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 11 {&CMLL17_PERSISTENT}:
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlSetDebug EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 13 {&CMLL17_PERSISTENT}:
      DEFINE INPUT PARAMETER nOnOff AS LONG.
    END.
    PROCEDURE LlGetVersion EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 14 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER nCmd AS LONG.
    END.
    PROCEDURE LlGetNotificationMessage EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 15 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlSetNotificationMessage EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 16 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nMessage AS LONG.
    END.
    PROCEDURE LlDefineField EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 18 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszVarName AS CHARACTER.
      DEFINE INPUT PARAMETER lpbufContents AS CHARACTER.
    END.
    PROCEDURE LlDefineFieldExt EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 19 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszVarName AS CHARACTER.
      DEFINE INPUT PARAMETER lpbufContents AS CHARACTER.
    ...
    END.
    PROCEDURE LlDefineFieldExtHandle EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 20 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszVarName AS CHARACTER.
      ...
      DEFINE INPUT PARAMETER lpPtr AS LONG.
    END.
    PROCEDURE LlDefineFieldStart EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 21 {&CMLL17_PERSISTENT}:
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlDefineVariable EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 22 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszVarName AS CHARACTER.
      DEFINE INPUT PARAMETER lpbufContents AS CHARACTER.
    END.
    PROCEDURE LlDefineVariableExt EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 23 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszVarName AS CHARACTER.
      DEFINE INPUT PARAMETER lpbufContents AS CHARACTER.
      ...
      DEFINE INPUT PARAMETER lpPtr AS LONG.
    END.
    PROCEDURE LlDefineVariableExtHandle EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 24 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszVarName AS CHARACTER.
      DEFINE INPUT PARAMETER hContents AS LONG.
      ...
      DEFINE INPUT PARAMETER lpPtr AS LONG.
    END.
    PROCEDURE LlDefineVariableName EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 25 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszVarName AS CHARACTER.
    END.
    PROCEDURE LlDefineVariableStart EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 26 {&CMLL17_PERSISTENT}:
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlDefineSumVariable EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 27 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszVarName AS CHARACTER.
      DEFINE INPUT PARAMETER lpbufContents AS CHARACTER.
    END.
    PROCEDURE LlDefineLayout EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 28 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    ...
    END.
    PROCEDURE LlDlgEditLine EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 29 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hWnd AS LONG.
    ...
    END.
    PROCEDURE LlDlgEditLineEx EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 30 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hWnd AS LONG.
    ...
    END.
    PROCEDURE LlPreviewSetTempPath EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 31 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszPath AS CHARACTER.
    END.
    PROCEDURE LlPreviewDeleteFiles EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 32 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszObjName AS CHARACTER.
      DEFINE INPUT PARAMETER pszPath AS CHARACTER.
    END.
    PROCEDURE LlPreviewDisplay EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 33 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszObjName AS CHARACTER.
      DEFINE INPUT PARAMETER pszPath AS CHARACTER.
    ...
    END.
    PROCEDURE LlPreviewDisplayEx EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 34 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszObjName AS CHARACTER.
      DEFINE INPUT PARAMETER pszPath AS CHARACTER.
    ...
    END.
    PROCEDURE LlPrint EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 35 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlPrintAbort EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 36 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlPrintCheckLineFit EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 37 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlPrintEnd EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 38 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nPages AS LONG.
    END.
    PROCEDURE LlPrintFields EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 39 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlPrintFieldsEnd EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 40 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlPrintGetCurrentPage EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 41 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlPrintGetItemsPerPage EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 42 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlPrintGetItemsPerTable EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 43 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlPrintGetRemainingItemsPerTable EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 44 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszField AS CHARACTER.
    END.
    PROCEDURE LlPrintGetRemItemsPerTable EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 45 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszField AS CHARACTER.
    END.
    PROCEDURE LlPrintGetOption EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 46 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nIndex AS LONG.
    END.
    PROCEDURE LlPrintGetPrinterInfo EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 47 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    ...
    END.
    PROCEDURE LlPrintOptionsDialog EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 48 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hWnd AS LONG.
      DEFINE INPUT PARAMETER pszText AS CHARACTER.
    END.
    PROCEDURE LlPrintSelectOffsetEx EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 49 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hWnd AS LONG.
    END.
    PROCEDURE LlPrintSetBoxText EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 50 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER szText AS CHARACTER.
      DEFINE INPUT PARAMETER nPercentage AS LONG.
    END.
    PROCEDURE LlPrintSetOption EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 51 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nIndex AS LONG.
      DEFINE INPUT PARAMETER nValue AS LONG.
    END.
    PROCEDURE LlPrintUpdateBox EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 52 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlPrintStart EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 53 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nObjType AS LONG.
      DEFINE INPUT PARAMETER pszObjName AS CHARACTER.
    ...
    END.
    PROCEDURE LlPrintWithBoxStart EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 54 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nObjType AS LONG.
      DEFINE INPUT PARAMETER pszObjName AS CHARACTER.
      ...
      DEFINE INPUT PARAMETER pszTitle AS CHARACTER.
    END.
    PROCEDURE LlPrinterSetup EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 55 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hWnd AS LONG.
      DEFINE INPUT PARAMETER nObjType AS LONG.
      DEFINE INPUT PARAMETER pszObjName AS CHARACTER.
    END.
    PROCEDURE LlSelectFileDlgTitleEx EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 56 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hWnd AS LONG.
      DEFINE INPUT PARAMETER pszTitle AS CHARACTER.
    ...
    END.
    PROCEDURE LlSetDlgboxMode EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 57 {&CMLL17_PERSISTENT}:
      DEFINE INPUT PARAMETER nMode AS LONG.
    END.
    PROCEDURE LlGetDlgboxMode EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 58 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
    END.
    PROCEDURE LlExprParse EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 59 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER lpExprText AS CHARACTER.
      DEFINE INPUT PARAMETER bIncludeFields AS LONG.
    END.
    PROCEDURE LlExprType EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 60 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER lpExpr AS LONG.
    END.
    PROCEDURE LlExprError EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 61 {&CMLL17_PERSISTENT}:
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuf AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlExprFree EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 62 {&CMLL17_PERSISTENT}:
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER lpExpr AS LONG.
    END.
    PROCEDURE LlExprEvaluate EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 63 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER lpExpr AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuf AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlExprGetUsedVars EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 162 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER lpExpr AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlSetOption EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 64 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nMode AS LONG.
      DEFINE INPUT PARAMETER nValue AS LONG.
    END.
    PROCEDURE LlGetOption EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 65 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nMode AS LONG.
    END.
    PROCEDURE LlSetOptionString EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 66 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nIndex AS LONG.
      DEFINE INPUT PARAMETER pszBuffer AS CHARACTER.
    END.
    PROCEDURE LlGetOptionString EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 67 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nIndex AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlPrintSetOptionString EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 68 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nIndex AS LONG.
      DEFINE INPUT PARAMETER pszBuffer AS CHARACTER.
    END.
    PROCEDURE LlPrintGetOptionString EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 69 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nIndex AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlDesignerProhibitAction EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 70 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nMenuID AS LONG.
    END.
    PROCEDURE LlDesignerProhibitFunction EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 1 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszFunction AS CHARACTER.
    END.
    PROCEDURE LlPrintEnableObject EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 71 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszObjectName AS CHARACTER.
      DEFINE INPUT PARAMETER bEnable AS LONG.
    END.
    PROCEDURE LlSetFileExtensions EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 72 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nObjType AS LONG.
    ...
    END.
    PROCEDURE LlPrintGetTextCharsPrinted EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 73 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszObjectName AS CHARACTER.
    END.
    PROCEDURE LlPrintGetFieldCharsPrinted EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 74 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszObjectName AS CHARACTER.
      DEFINE INPUT PARAMETER pszField AS CHARACTER.
    END.
    PROCEDURE LlPrintIsVariableUsed EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 75 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszVarName AS CHARACTER.
    END.
    PROCEDURE LlPrintIsFieldUsed EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 76 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszFieldName AS CHARACTER.
    END.
    PROCEDURE LlPrintOptionsDialogTitle EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 77 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hWnd AS LONG.
      DEFINE INPUT PARAMETER pszTitle AS CHARACTER.
      DEFINE INPUT PARAMETER pszText AS CHARACTER.
    END.
    PROCEDURE LlSetPrinterToDefault EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 78 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nObjType AS LONG.
      DEFINE INPUT PARAMETER pszObjName AS CHARACTER.
    END.
    PROCEDURE LlDefineSortOrderStart EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 79 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlDefineSortOrder EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 80 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszIdentifier AS CHARACTER.
      DEFINE INPUT PARAMETER pszText AS CHARACTER.
    END.
    PROCEDURE LlPrintGetSortOrder EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 81 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlDefineGrouping EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 82 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      ...
      DEFINE INPUT PARAMETER pszText AS CHARACTER.
    END.
    PROCEDURE LlPrintGetGrouping EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 83 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlAddCtlSupport EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 84 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hWnd AS LONG.
      DEFINE INPUT PARAMETER nFlags AS LONG.
      DEFINE INPUT PARAMETER pszInifile AS CHARACTER.
    END.
    PROCEDURE LlPrintBeginGroup EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 85 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER lParam AS LONG.
      DEFINE INPUT PARAMETER lpParam AS LONG.
    END.
    PROCEDURE LlPrintEndGroup EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 86 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER lParam AS LONG.
      DEFINE INPUT PARAMETER lpParam AS LONG.
    END.
    PROCEDURE LlPrintGroupLine EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 87 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER lParam AS LONG.
      DEFINE INPUT PARAMETER lpParam AS LONG.
    END.
    PROCEDURE LlPrintGroupHeader EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 88 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER lParam AS LONG.
    END.
    PROCEDURE LlPrintGetFilterExpression EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 89 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlPrintWillMatchFilter EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 90 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlPrintDidMatchFilter EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 91 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlGetFieldContents EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 93 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      ...
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlGetVariableContents EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 92 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszName AS CHARACTER.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlGetSumVariableContents EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 94 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszName AS CHARACTER.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlGetUserVariableContents EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 95 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszName AS CHARACTER.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlGetVariableType EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 96 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszName AS CHARACTER.
    END.
    PROCEDURE LlGetFieldType EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 97 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszName AS CHARACTER.
    END.
    PROCEDURE LlSetPrinterDefaultsDir EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 200 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszDir AS CHARACTER.
    END.
    PROCEDURE LlCreateSketch EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 201 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nObjType AS LONG.
      DEFINE INPUT PARAMETER lpszObjName AS CHARACTER.
    END.
    PROCEDURE LlViewerProhibitAction EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 202 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nMenuID AS LONG.
    END.
    PROCEDURE LlPrintCopyPrinterConfiguration EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 203 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER lpszFilename AS CHARACTER.
      DEFINE INPUT PARAMETER nFunction AS LONG.
    END.
    PROCEDURE LlRTFCreateObject EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 228 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlRTFDeleteObject EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 229 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hRTF AS LONG.
    END.
    PROCEDURE LlRTFSetText EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 230 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hRTF AS LONG.
      DEFINE INPUT PARAMETER pszText AS CHARACTER.
    END.
    PROCEDURE LlRTFGetTextLength EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 231 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hRTF AS LONG.
      DEFINE INPUT PARAMETER nFlags AS LONG.
    END.
    PROCEDURE LlRTFGetText EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 232 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hRTF AS LONG.
      DEFINE INPUT PARAMETER nFlags AS LONG.
      ...
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlRTFEditObject EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 233 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hRTF AS LONG.
      DEFINE INPUT PARAMETER hWnd AS LONG.
    ...
    END.
    PROCEDURE LlRTFCopyToClipboard EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 234 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hRTF AS LONG.
    END.
    PROCEDURE LlRTFDisplay EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 235 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hRTF AS LONG.
    ...
    END.
    PROCEDURE LlRTFEditorProhibitAction EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 109 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hRTF AS LONG.
      DEFINE INPUT PARAMETER nControlID AS LONG.
    END.
    PROCEDURE LlRTFEditorInvokeAction EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 117 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hRTF AS LONG.
      DEFINE INPUT PARAMETER nControlID AS LONG.
    END.
    PROCEDURE LlDebugOutput EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 240 {&CMLL17_PERSISTENT}:
      DEFINE INPUT PARAMETER nIndent AS LONG.
      DEFINE INPUT PARAMETER pszText AS CHARACTER.
    END.
    PROCEDURE LlEnumGetFirstVar EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 241 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nFlags AS LONG.
    END.
    PROCEDURE LlEnumGetFirstField EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 242 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nFlags AS LONG.
    END.
    PROCEDURE LlEnumGetNextEntry EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 243 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nPos AS LONG.
      DEFINE INPUT PARAMETER nFlags AS LONG.
    END.
    PROCEDURE LlEnumGetEntry EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 244 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nPos AS LONG.
    ...
    END.
    PROCEDURE LlPrintResetObjectStates EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 245 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlXSetParameter EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 246 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    ...
    END.
    PROCEDURE LlXGetParameter EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 247 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nExtensionType AS LONG.
      DEFINE INPUT PARAMETER pszExtensionName AS CHARACTER.
      ...
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlPrintResetProjectState EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 248 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
    END.
    PROCEDURE LlDefineChartFieldStart EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 2 {&CMLL17_PERSISTENT}:
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlDefineChartFieldExt EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 3 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszVarName AS CHARACTER.
      ...
      DEFINE INPUT PARAMETER lpPtr AS LONG.
    END.
    PROCEDURE LlPrintDeclareChartRow EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 4 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nFlags AS LONG.
    END.
    PROCEDURE LlPrintGetChartObjectCount EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 6 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nType AS LONG.
    END.
    PROCEDURE LlPrintIsChartFieldUsed EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 5 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszFieldName AS CHARACTER.
    END.
    PROCEDURE LlGetChartFieldContents EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 8 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszName AS CHARACTER.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlEnumGetFirstChartField EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 9 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nFlags AS LONG.
    END.
    PROCEDURE LlPrintGetRemainingSpacePerTable EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 102 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszField AS CHARACTER.
      DEFINE INPUT PARAMETER nDimension AS LONG.
    END.
    PROCEDURE LlSetDefaultProjectParameter EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 108 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      ...
      DEFINE INPUT PARAMETER nFlags AS LONG.
    END.
    PROCEDURE LlGetDefaultProjectParameter EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 110 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszParameter AS CHARACTER.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
    ...
    END.
    PROCEDURE LlPrintSetProjectParameter EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 113 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszParameter AS CHARACTER.
      DEFINE INPUT PARAMETER pszValue AS CHARACTER.
      DEFINE INPUT PARAMETER nFlags AS LONG.
    END.
    PROCEDURE LlPrintGetProjectParameter EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 114 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszParameter AS CHARACTER.
      ...
      DEFINE INPUT-OUTPUT PARAMETER pnFlags AS HANDLE TO LONG.
    END.
    PROCEDURE LlExprContainsVariable EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 7 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hExpr AS LONG.
      DEFINE INPUT PARAMETER pszVariable AS CHARACTER.
    END.
    PROCEDURE LlExprIsConstant EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 116 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hExpr AS LONG.
    END.
    PROCEDURE LlProfileStart EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 136 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
    ...
    END.
    PROCEDURE LlProfileEnd EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 137 {&CMLL17_PERSISTENT}:
      DEFINE INPUT PARAMETER hThread AS LONG.
    END.
    PROCEDURE LlDbAddTable EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 139 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
      DEFINE INPUT PARAMETER pszTableID AS CHARACTER.
      DEFINE INPUT PARAMETER pszDisplayName AS CHARACTER.
    END.
    PROCEDURE LlDbAddTableRelation EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 140 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
      DEFINE INPUT PARAMETER pszTableID AS CHARACTER.
    ...
    END.
    PROCEDURE LlDbAddTableSortOrder EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 141 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
      DEFINE INPUT PARAMETER pszTableID AS CHARACTER.
    ...
    END.
    PROCEDURE LlPrintDbGetCurrentTable EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 142 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
    ...
    END.
    PROCEDURE LlPrintDbGetCurrentTableRelation EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 143 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszRelationID AS MEMPTR.
      DEFINE INPUT PARAMETER nRelationIDLength AS LONG.
    END.
    PROCEDURE LlPrintDbGetCurrentTableSortOrder EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 146 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszSortOrderID AS MEMPTR.
      DEFINE INPUT PARAMETER nSortOrderIDLength AS LONG.
    END.
    PROCEDURE LlDbDumpStructure EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 149 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
    END.
    PROCEDURE LlPrintDbGetRootTableCount EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 151 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
    END.
    PROCEDURE LlDbSetMasterTable EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 152 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
      DEFINE INPUT PARAMETER pszTableID AS CHARACTER.
    END.
    PROCEDURE LlDbGetMasterTable EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 157 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlXSetExportParameter EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 158 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszExtensionName AS CHARACTER.
      DEFINE INPUT PARAMETER pszKey AS CHARACTER.
      DEFINE INPUT PARAMETER pszValue AS CHARACTER.
    END.
    PROCEDURE LlXGetExportParameter EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 160 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszExtensionName AS CHARACTER.
      DEFINE INPUT PARAMETER pszKey AS CHARACTER.
      ...
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlXlatName EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 164 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszName AS CHARACTER.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlDesignerProhibitEditingObject EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 185 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszObject AS CHARACTER.
    END.
    PROCEDURE LlGetUsedIdentifiers EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 186 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      ...
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlExprGetUsedVarsEx EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 205 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER lpExpr AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
    ...
    END.
    PROCEDURE LlDomGetProject EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 206 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER phDOMObj AS HANDLE TO LONG.
    END.
    PROCEDURE LlDomGetProperty EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 207 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      ...
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlDomSetProperty EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 208 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hDOMObj AS LONG.
      DEFINE INPUT PARAMETER pszName AS CHARACTER.
      DEFINE INPUT PARAMETER pszValue AS CHARACTER.
    END.
    PROCEDURE LlDomGetObject EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 209 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hDOMObj AS LONG.
      DEFINE INPUT PARAMETER pszName AS CHARACTER.
      DEFINE INPUT-OUTPUT PARAMETER phDOMSubObj AS HANDLE TO LONG.
    END.
    PROCEDURE LlDomGetSubobjectCount EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 210 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hDOMObj AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pnCount AS HANDLE TO LONG.
    END.
    PROCEDURE LlDomGetSubobject EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 211 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hDOMObj AS LONG.
      DEFINE INPUT PARAMETER nPosition AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER phDOMSubObj AS HANDLE TO LONG.
    END.
    PROCEDURE LlDomCreateSubobject EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 212 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hDOMObj AS LONG.
      DEFINE INPUT PARAMETER nPosition AS LONG.
      ...
      DEFINE INPUT-OUTPUT PARAMETER phDOMSubObj AS HANDLE TO LONG.
    END.
    PROCEDURE LlDomDeleteSubobject EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 213 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hDOMObj AS LONG.
      DEFINE INPUT PARAMETER nPosition AS LONG.
    END.
    PROCEDURE LlProjectOpen EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 214 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nObjType AS LONG.
      DEFINE INPUT PARAMETER pszObjName AS CHARACTER.
    ...
    END.
    PROCEDURE LlProjectSave EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 215 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszObjName AS CHARACTER.
    END.
    PROCEDURE LlProjectClose EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 216 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlAssociatePreviewControl EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 218 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hWndControl AS LONG.
      DEFINE INPUT PARAMETER nFlags AS LONG.
    END.
    PROCEDURE LlGetErrortext EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 219 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER nError AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlSetPreviewOption EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 221 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nOption AS LONG.
      DEFINE INPUT PARAMETER nValue AS LONG.
    END.
    PROCEDURE LlGetPreviewOption EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 222 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nOption AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pnValue AS HANDLE TO LONG.
    END.
    PROCEDURE LlDesignerInvokeAction EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 223 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nMenuID AS LONG.
    END.
    PROCEDURE LlDesignerRefreshWorkspace EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 224 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlDesignerFileOpen EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 225 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszFilename AS CHARACTER.
      DEFINE INPUT PARAMETER nFlags AS LONG.
    END.
    PROCEDURE LlDesignerFileSave EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 226 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nFlags AS LONG.
    END.
    PROCEDURE LlDesignerAddAction EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 227 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      ...
      DEFINE INPUT PARAMETER pvReserved AS LONG.
    END.
    PROCEDURE LlDesignerGetOptionString EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 236 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nIndex AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlDesignerSetOptionString EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 237 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nIndex AS LONG.
      DEFINE INPUT PARAMETER pszBuffer AS CHARACTER.
    END.
    PROCEDURE LlJobOpenCopy EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 239 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
    END.
    PROCEDURE LlGetProjectParameter EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 249 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszProjectName AS CHARACTER.
      DEFINE INPUT PARAMETER pszParameter AS CHARACTER.
      ...
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlConvertBLOBToString EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 250 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
    ...
    END.
    PROCEDURE LlConvertStringToBLOB EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 251 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER pszText AS CHARACTER.
      DEFINE INPUT-OUTPUT PARAMETER pBytes AS HANDLE TO BYTE.
      DEFINE INPUT PARAMETER nBytes AS LONG.
    END.
    PROCEDURE LlDbAddTableRelationEx EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 238 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
      DEFINE INPUT PARAMETER pszTableID AS CHARACTER.
      DEFINE INPUT PARAMETER pszParentTableID AS CHARACTER.
    ...
    END.
    PROCEDURE LlDbAddTableSortOrderEx EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 257 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
      DEFINE INPUT PARAMETER pszTableID AS CHARACTER.
      DEFINE INPUT PARAMETER pszSortOrderID AS CHARACTER.
      ...
      DEFINE INPUT PARAMETER pszField AS CHARACTER.
    END.
    PROCEDURE LlGetUsedIdentifiersEx EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 258 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszProjectName AS CHARACTER.
      ...
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlGetTempFileName EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 259 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      ...
      DEFINE INPUT PARAMETER nOptions AS LONG.
    END.
    PROCEDURE LlGetDebug EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 260 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
    END.
    PROCEDURE LlRTFEditorGetRTFControlHandle EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 261 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hRTF AS LONG.
    END.
    PROCEDURE LlLocAddDictionaryEntry EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 263 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nLCID AS LONG.
      DEFINE INPUT PARAMETER pszKey AS CHARACTER.
      ...
      DEFINE INPUT PARAMETER nType AS LONG.
    END.
    PROCEDURE LlLocAddDesignLCID EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 264 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nLCID AS LONG.
    END.
    PROCEDURE LlIsUILanguageAvailable EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 265 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER nLanguage AS LONG.
      DEFINE INPUT PARAMETER nTypesToLookFor AS LONG.
    END.
    PROCEDURE LlIsUILanguageAvailableLCID EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 266 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER nLCID AS LONG.
      DEFINE INPUT PARAMETER nTypesToLookFor AS LONG.
    END.
    PROCEDURE LlDbAddTableEx EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 267 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
      DEFINE INPUT PARAMETER pszTableID AS CHARACTER.
      DEFINE INPUT PARAMETER pszDisplayName AS CHARACTER.
      DEFINE INPUT PARAMETER nOptions AS LONG.
    END.
    PROCEDURE LlRTFSetTextEx EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 269 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hRTF AS LONG.
      DEFINE INPUT PARAMETER nFlags AS LONG.
      DEFINE INPUT PARAMETER pszText AS CHARACTER.
    END.
    PROCEDURE LlInplaceDesignerInteraction EXTERNAL "{&CMLL17_DLLNAME}" ORDINAL 270 {&CMLL17_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
