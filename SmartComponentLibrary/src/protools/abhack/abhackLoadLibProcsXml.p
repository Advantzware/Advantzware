...
PROCEDURE loadXmlDef:    
    ...
    FOR EACH tdProc WHERE tdProc.cAccessMode <> "PRIVATE":  /* 22-APR-2008 sla: added the filtering of PRIVATE */
        CREATE ttFreeList.
        ASSIGN
         ttFreeList.cItem     = tdProc.cName
         ttFreeList.cObjTypes = tdProc.cParameters.
    END.
