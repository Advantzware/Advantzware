...
REPEAT:
    ...
    IF cLine BEGINS "#define":U AND NOT cLine BEGINS "#define _":U THEN DO:
        ...
        IF NOT NUM-ENTRIES (cLine, " ":U) > 2 THEN NEXT . 
        
        ASSIGN cConst = ENTRY (2, cLine, " ":U)
               cHex   = ENTRY (3, cLine, " ":U) .
        
        IF NOT cConst BEGINS "WM_":U OR cConst BEGINS "BM_":U THEN NEXT . 
        ...
        ELSE DO:
            ...
            IF ERROR-STATUS:ERROR OR ERROR-STATUS:NUM-MESSAGES > 0 THEN NEXT . 
        END. 
        
/*        DISPL cLine FORMAT "x(70)":U cConst cHex FORMAT "x(20)" iNum WITH WIDTH 200 .*/
