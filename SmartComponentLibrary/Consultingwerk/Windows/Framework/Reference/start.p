...
&scoped-define ApplicationTitle Consultingwerk Reference Application
&scoped-define BaseRegistryKey Software~\Consultingwerk Ltd.~\Sample Applications~\
...
&scoped-define StartupForm Consultingwerk.Windows.Framework.Reference.MainMenuForm
&scoped-define TaskbarApplicationId de.consultingwerk.reference.mainmenuform
...
IF NUM-DBS = 0 OR ListHelper:CanDo (SESSION:PARAMETER, "AppServerConnect":U) THEN DO:

    /* Mike Fechner, Consultingwerk Ltd. 03.11.2013
       Default Partition from -param? */
    oParamDictionary = ListHelper:AlternatingListToDictionary (SESSION:PARAMETER, ",":U, "=":U) .
    ...
    FrameworkSettings:ServiceAdapter:BehaviorOnDisconnect = OptionsOnDisconnectEnum:QuitRetryIgnore .
