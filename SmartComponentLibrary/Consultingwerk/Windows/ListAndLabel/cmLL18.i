/* Progress constants and function definitions for LL18.DLL */
/*  (c) combit GmbH */
...
&GLOBAL-DEFINE LL_TYPEMASK                                   2146435072 /* (0x7ff00000)  */
...
&GLOBAL-DEFINE LL_BOXTYPE_NONE                                       -1 /* (-1)  */
...
&GLOBAL-DEFINE LL_FCTPARATYPE_DOUBLE                                  1 /* (0x01)  */
&GLOBAL-DEFINE LL_FCTPARATYPE_DATE                                    2 /* (0x02)  */
&GLOBAL-DEFINE LL_FCTPARATYPE_STRING                                  4 /* (0x04)  */
&GLOBAL-DEFINE LL_FCTPARATYPE_BOOL                                    8 /* (0x08)  */
&GLOBAL-DEFINE LL_FCTPARATYPE_DRAWING                                16 /* (0x10)  */
&GLOBAL-DEFINE LL_FCTPARATYPE_BARCODE                                32 /* (0x20)  */
&GLOBAL-DEFINE LL_FCTPARATYPE_ALL                                    63 /* (0x3f)  */
...
&GLOBAL-DEFINE LL_FCTPARATYPEFLAG_NONULLCHECK                     65536 /* (0x10000)  */
...
&GLOBAL-DEFINE LL_OPTION_BOTTOMALIGNMENT_WIN9X_UNLIKE_NT             105 /* (105) default: true */
...
&GLOBAL-DEFINE LL_OPTION_RELAX_AT_SHUTDOWN                          136 /* (136) default: false */
&GLOBAL-DEFINE LL_OPTION_NOPRINTERPATHCHECK                         137 /* (137) default: false */
&GLOBAL-DEFINE LL_OPTION_SUPPORT_HUGESTORAGEFS                      138 /* (138) default: false */
...
&GLOBAL-DEFINE LL_OPTION_USE_JPEG_OPTIMIZATION                      147 /* (147) default: true */
...
&GLOBAL-DEFINE LL_OPTION_DESIGNER_RIBBONBACKGROUNDCOLOR             215 /* (215) default: 0 (system default) */
...
&GLOBAL-DEFINE LL_OPTION_PRVFILEVERSION                             218 /* (218) default: 0 (2 would optimized version, supported since LL18, possibly faster if > 5000 pages or so) */
...
&GLOBAL-DEFINE LL_OPTIONSTR_QUERY_LICENSINGINFO                      55 /* (55) r/o, returns serial number in return value */
...
&GLOBAL-DEFINE LL_OPTIONSTR_DEFAULTSCHEME                            63 /* (63) default: empty (summertime) */
...
&GLOBAL-DEFINE LL_CHAR_PHANTOMSPACE                                   2 /* (2)  */
&GLOBAL-DEFINE LL_CHAR_LOCK                                           3 /* (3)  */
...
&GLOBAL-DEFINE LL_TEMPFILENAME_DEFAULT                                0 /* (0x0000)  */
&GLOBAL-DEFINE LL_TEMPFILENAME_ENSURELONGPATH                         1 /* (0x0001)  */
...
&IF DEFINED(CMLL18_PERSISTENT)=0 &THEN
 &GLOBAL-DEFINE CMLL18_PERSISTENT PERSISTENT
&ENDIF

&IF DEFINED(CMLL18_DLLNAME)=0 &THEN
 &GLOBAL-DEFINE CMLL18_DLLNAME CMLL18.DLL
&ENDIF

/* functions */

    PROCEDURE LlJobOpen EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 10 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER nLanguage AS LONG.
    END.
    PROCEDURE LlJobOpenLCID EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 12 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER nLCID AS LONG.
    END.
    PROCEDURE LlJobClose EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 11 {&CMLL18_PERSISTENT}:
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlSetDebug EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 13 {&CMLL18_PERSISTENT}:
      DEFINE INPUT PARAMETER nOnOff AS LONG.
    END.
    PROCEDURE LlGetVersion EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 14 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER nCmd AS LONG.
    END.
    PROCEDURE LlGetNotificationMessage EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 15 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlSetNotificationMessage EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 16 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nMessage AS LONG.
    END.
    PROCEDURE LlDefineField EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 18 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszVarName AS CHARACTER.
      DEFINE INPUT PARAMETER lpbufContents AS CHARACTER.
    END.
    PROCEDURE LlDefineFieldExt EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 19 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszVarName AS CHARACTER.
      DEFINE INPUT PARAMETER lpbufContents AS CHARACTER.
    ...
    END.
    PROCEDURE LlDefineFieldExtHandle EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 20 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszVarName AS CHARACTER.
      ...
      DEFINE INPUT PARAMETER lpPtr AS LONG.
    END.
    PROCEDURE LlDefineFieldStart EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 21 {&CMLL18_PERSISTENT}:
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlDefineVariable EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 22 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszVarName AS CHARACTER.
      DEFINE INPUT PARAMETER lpbufContents AS CHARACTER.
    END.
    PROCEDURE LlDefineVariableExt EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 23 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszVarName AS CHARACTER.
      DEFINE INPUT PARAMETER lpbufContents AS CHARACTER.
      ...
      DEFINE INPUT PARAMETER lpPtr AS LONG.
    END.
    PROCEDURE LlDefineVariableExtHandle EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 24 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszVarName AS CHARACTER.
      DEFINE INPUT PARAMETER hContents AS LONG.
      ...
      DEFINE INPUT PARAMETER lpPtr AS LONG.
    END.
    PROCEDURE LlDefineVariableName EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 25 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszVarName AS CHARACTER.
    END.
    PROCEDURE LlDefineVariableStart EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 26 {&CMLL18_PERSISTENT}:
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlDefineSumVariable EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 27 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszVarName AS CHARACTER.
      DEFINE INPUT PARAMETER lpbufContents AS CHARACTER.
    END.
    PROCEDURE LlDefineLayout EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 28 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    ...
    END.
    PROCEDURE LlDlgEditLine EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 29 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hWnd AS LONG.
    ...
    END.
    PROCEDURE LlDlgEditLineEx EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 30 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hWnd AS LONG.
    ...
    END.
    PROCEDURE LlPreviewSetTempPath EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 31 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszPath AS CHARACTER.
    END.
    PROCEDURE LlPreviewDeleteFiles EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 32 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszObjName AS CHARACTER.
      DEFINE INPUT PARAMETER pszPath AS CHARACTER.
    END.
    PROCEDURE LlPreviewDisplay EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 33 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszObjName AS CHARACTER.
      DEFINE INPUT PARAMETER pszPath AS CHARACTER.
    ...
    END.
    PROCEDURE LlPreviewDisplayEx EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 34 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszObjName AS CHARACTER.
      DEFINE INPUT PARAMETER pszPath AS CHARACTER.
    ...
    END.
    PROCEDURE LlPrint EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 35 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlPrintAbort EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 36 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlPrintCheckLineFit EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 37 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlPrintEnd EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 38 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nPages AS LONG.
    END.
    PROCEDURE LlPrintFields EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 39 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlPrintFieldsEnd EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 40 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlPrintGetCurrentPage EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 41 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlPrintGetItemsPerPage EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 42 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlPrintGetItemsPerTable EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 43 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlPrintGetRemainingItemsPerTable EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 44 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszField AS CHARACTER.
    END.
    PROCEDURE LlPrintGetRemItemsPerTable EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 45 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszField AS CHARACTER.
    END.
    PROCEDURE LlPrintGetOption EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 46 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nIndex AS LONG.
    END.
    PROCEDURE LlPrintGetPrinterInfo EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 47 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    ...
    END.
    PROCEDURE LlPrintOptionsDialog EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 48 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hWnd AS LONG.
      DEFINE INPUT PARAMETER pszText AS CHARACTER.
    END.
    PROCEDURE LlPrintSelectOffsetEx EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 49 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hWnd AS LONG.
    END.
    PROCEDURE LlPrintSetBoxText EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 50 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER szText AS CHARACTER.
      DEFINE INPUT PARAMETER nPercentage AS LONG.
    END.
    PROCEDURE LlPrintSetOption EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 51 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nIndex AS LONG.
      DEFINE INPUT PARAMETER nValue AS LONG.
    END.
    PROCEDURE LlPrintUpdateBox EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 52 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlPrintStart EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 53 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nObjType AS LONG.
      DEFINE INPUT PARAMETER pszObjName AS CHARACTER.
    ...
    END.
    PROCEDURE LlPrintWithBoxStart EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 54 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nObjType AS LONG.
      DEFINE INPUT PARAMETER pszObjName AS CHARACTER.
      ...
      DEFINE INPUT PARAMETER pszTitle AS CHARACTER.
    END.
    PROCEDURE LlPrinterSetup EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 55 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hWnd AS LONG.
      DEFINE INPUT PARAMETER nObjType AS LONG.
      DEFINE INPUT PARAMETER pszObjName AS CHARACTER.
    END.
    PROCEDURE LlSelectFileDlgTitleEx EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 56 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hWnd AS LONG.
      DEFINE INPUT PARAMETER pszTitle AS CHARACTER.
    ...
    END.
    PROCEDURE LlSetDlgboxMode EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 57 {&CMLL18_PERSISTENT}:
      DEFINE INPUT PARAMETER nMode AS LONG.
    END.
    PROCEDURE LlGetDlgboxMode EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 58 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
    END.
    PROCEDURE LlExprParse EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 59 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER lpExprText AS CHARACTER.
      DEFINE INPUT PARAMETER bIncludeFields AS LONG.
    END.
    PROCEDURE LlExprType EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 60 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER lpExpr AS LONG.
    END.
    PROCEDURE LlExprError EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 61 {&CMLL18_PERSISTENT}:
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuf AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlExprFree EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 62 {&CMLL18_PERSISTENT}:
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER lpExpr AS LONG.
    END.
    PROCEDURE LlExprEvaluate EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 63 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER lpExpr AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuf AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlExprGetUsedVars EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 162 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER lpExpr AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlSetOption EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 64 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nMode AS LONG.
      DEFINE INPUT PARAMETER nValue AS LONG.
    END.
    PROCEDURE LlGetOption EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 65 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nMode AS LONG.
    END.
    PROCEDURE LlSetOptionString EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 66 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nIndex AS LONG.
      DEFINE INPUT PARAMETER pszBuffer AS CHARACTER.
    END.
    PROCEDURE LlGetOptionString EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 67 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nIndex AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlPrintSetOptionString EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 68 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nIndex AS LONG.
      DEFINE INPUT PARAMETER pszBuffer AS CHARACTER.
    END.
    PROCEDURE LlPrintGetOptionString EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 69 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nIndex AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlDesignerProhibitAction EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 70 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nMenuID AS LONG.
    END.
    PROCEDURE LlDesignerProhibitFunction EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 1 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszFunction AS CHARACTER.
    END.
    PROCEDURE LlPrintEnableObject EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 71 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszObjectName AS CHARACTER.
      DEFINE INPUT PARAMETER bEnable AS LONG.
    END.
    PROCEDURE LlSetFileExtensions EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 72 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nObjType AS LONG.
    ...
    END.
    PROCEDURE LlPrintGetTextCharsPrinted EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 73 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszObjectName AS CHARACTER.
    END.
    PROCEDURE LlPrintGetFieldCharsPrinted EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 74 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszObjectName AS CHARACTER.
      DEFINE INPUT PARAMETER pszField AS CHARACTER.
    END.
    PROCEDURE LlPrintIsVariableUsed EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 75 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszVarName AS CHARACTER.
    END.
    PROCEDURE LlPrintIsFieldUsed EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 76 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszFieldName AS CHARACTER.
    END.
    PROCEDURE LlPrintOptionsDialogTitle EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 77 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hWnd AS LONG.
      DEFINE INPUT PARAMETER pszTitle AS CHARACTER.
      DEFINE INPUT PARAMETER pszText AS CHARACTER.
    END.
    PROCEDURE LlSetPrinterToDefault EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 78 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nObjType AS LONG.
      DEFINE INPUT PARAMETER pszObjName AS CHARACTER.
    END.
    PROCEDURE LlDefineSortOrderStart EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 79 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlDefineSortOrder EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 80 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszIdentifier AS CHARACTER.
      DEFINE INPUT PARAMETER pszText AS CHARACTER.
    END.
    PROCEDURE LlPrintGetSortOrder EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 81 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlDefineGrouping EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 82 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      ...
      DEFINE INPUT PARAMETER pszText AS CHARACTER.
    END.
    PROCEDURE LlPrintGetGrouping EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 83 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlAddCtlSupport EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 84 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hWnd AS LONG.
      DEFINE INPUT PARAMETER nFlags AS LONG.
      DEFINE INPUT PARAMETER pszInifile AS CHARACTER.
    END.
    PROCEDURE LlPrintBeginGroup EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 85 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER lParam AS LONG.
      DEFINE INPUT PARAMETER lpParam AS LONG.
    END.
    PROCEDURE LlPrintEndGroup EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 86 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER lParam AS LONG.
      DEFINE INPUT PARAMETER lpParam AS LONG.
    END.
    PROCEDURE LlPrintGroupLine EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 87 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER lParam AS LONG.
      DEFINE INPUT PARAMETER lpParam AS LONG.
    END.
    PROCEDURE LlPrintGroupHeader EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 88 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER lParam AS LONG.
    END.
    PROCEDURE LlPrintGetFilterExpression EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 89 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlPrintWillMatchFilter EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 90 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlPrintDidMatchFilter EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 91 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlGetFieldContents EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 93 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      ...
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlGetVariableContents EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 92 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszName AS CHARACTER.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlGetSumVariableContents EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 94 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszName AS CHARACTER.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlGetUserVariableContents EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 95 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszName AS CHARACTER.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlGetVariableType EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 96 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszName AS CHARACTER.
    END.
    PROCEDURE LlGetFieldType EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 97 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszName AS CHARACTER.
    END.
    PROCEDURE LlSetPrinterDefaultsDir EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 200 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszDir AS CHARACTER.
    END.
    PROCEDURE LlCreateSketch EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 201 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nObjType AS LONG.
      DEFINE INPUT PARAMETER lpszObjName AS CHARACTER.
    END.
    PROCEDURE LlViewerProhibitAction EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 202 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nMenuID AS LONG.
    END.
    PROCEDURE LlPrintCopyPrinterConfiguration EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 203 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER lpszFilename AS CHARACTER.
      DEFINE INPUT PARAMETER nFunction AS LONG.
    END.
    PROCEDURE LlRTFCreateObject EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 228 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlRTFDeleteObject EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 229 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hRTF AS LONG.
    END.
    PROCEDURE LlRTFSetText EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 230 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hRTF AS LONG.
      DEFINE INPUT PARAMETER pszText AS CHARACTER.
    END.
    PROCEDURE LlRTFGetTextLength EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 231 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hRTF AS LONG.
      DEFINE INPUT PARAMETER nFlags AS LONG.
    END.
    PROCEDURE LlRTFGetText EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 232 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hRTF AS LONG.
      DEFINE INPUT PARAMETER nFlags AS LONG.
      ...
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlRTFEditObject EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 233 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hRTF AS LONG.
      DEFINE INPUT PARAMETER hWnd AS LONG.
    ...
    END.
    PROCEDURE LlRTFCopyToClipboard EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 234 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hRTF AS LONG.
    END.
    PROCEDURE LlRTFDisplay EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 235 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hRTF AS LONG.
    ...
    END.
    PROCEDURE LlRTFEditorProhibitAction EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 109 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hRTF AS LONG.
      DEFINE INPUT PARAMETER nControlID AS LONG.
    END.
    PROCEDURE LlRTFEditorInvokeAction EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 117 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hRTF AS LONG.
      DEFINE INPUT PARAMETER nControlID AS LONG.
    END.
    PROCEDURE LlDebugOutput EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 240 {&CMLL18_PERSISTENT}:
      DEFINE INPUT PARAMETER nIndent AS LONG.
      DEFINE INPUT PARAMETER pszText AS CHARACTER.
    END.
    PROCEDURE LlEnumGetFirstVar EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 241 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nFlags AS LONG.
    END.
    PROCEDURE LlEnumGetFirstField EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 242 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nFlags AS LONG.
    END.
    PROCEDURE LlEnumGetNextEntry EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 243 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nPos AS LONG.
      DEFINE INPUT PARAMETER nFlags AS LONG.
    END.
    PROCEDURE LlEnumGetEntry EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 244 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nPos AS LONG.
    ...
    END.
    PROCEDURE LlPrintResetObjectStates EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 245 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlXSetParameter EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 246 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    ...
    END.
    PROCEDURE LlXGetParameter EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 247 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nExtensionType AS LONG.
      DEFINE INPUT PARAMETER pszExtensionName AS CHARACTER.
      ...
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlPrintResetProjectState EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 248 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
    END.
    PROCEDURE LlDefineChartFieldStart EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 2 {&CMLL18_PERSISTENT}:
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlDefineChartFieldExt EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 3 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszVarName AS CHARACTER.
      ...
      DEFINE INPUT PARAMETER lpPtr AS LONG.
    END.
    PROCEDURE LlPrintDeclareChartRow EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 4 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nFlags AS LONG.
    END.
    PROCEDURE LlPrintGetChartObjectCount EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 6 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nType AS LONG.
    END.
    PROCEDURE LlPrintIsChartFieldUsed EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 5 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszFieldName AS CHARACTER.
    END.
    PROCEDURE LlGetChartFieldContents EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 8 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszName AS CHARACTER.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlEnumGetFirstChartField EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 9 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nFlags AS LONG.
    END.
    PROCEDURE LlPrintGetRemainingSpacePerTable EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 102 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszField AS CHARACTER.
      DEFINE INPUT PARAMETER nDimension AS LONG.
    END.
    PROCEDURE LlSetDefaultProjectParameter EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 108 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      ...
      DEFINE INPUT PARAMETER nFlags AS LONG.
    END.
    PROCEDURE LlGetDefaultProjectParameter EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 110 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszParameter AS CHARACTER.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
    ...
    END.
    PROCEDURE LlPrintSetProjectParameter EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 113 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszParameter AS CHARACTER.
      DEFINE INPUT PARAMETER pszValue AS CHARACTER.
      DEFINE INPUT PARAMETER nFlags AS LONG.
    END.
    PROCEDURE LlPrintGetProjectParameter EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 114 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszParameter AS CHARACTER.
      ...
      DEFINE INPUT-OUTPUT PARAMETER pnFlags AS HANDLE TO LONG.
    END.
    PROCEDURE LlExprContainsVariable EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 7 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hExpr AS LONG.
      DEFINE INPUT PARAMETER pszVariable AS CHARACTER.
    END.
    PROCEDURE LlExprIsConstant EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 116 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hExpr AS LONG.
    END.
    PROCEDURE LlProfileStart EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 136 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
    ...
    END.
    PROCEDURE LlProfileEnd EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 137 {&CMLL18_PERSISTENT}:
      DEFINE INPUT PARAMETER hThread AS LONG.
    END.
    PROCEDURE LlDbAddTable EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 139 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
      DEFINE INPUT PARAMETER pszTableID AS CHARACTER.
      DEFINE INPUT PARAMETER pszDisplayName AS CHARACTER.
    END.
    PROCEDURE LlDbAddTableRelation EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 140 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
      DEFINE INPUT PARAMETER pszTableID AS CHARACTER.
    ...
    END.
    PROCEDURE LlDbAddTableSortOrder EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 141 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
      DEFINE INPUT PARAMETER pszTableID AS CHARACTER.
    ...
    END.
    PROCEDURE LlPrintDbGetCurrentTable EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 142 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
    ...
    END.
    PROCEDURE LlPrintDbGetCurrentTableRelation EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 143 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszRelationID AS MEMPTR.
      DEFINE INPUT PARAMETER nRelationIDLength AS LONG.
    END.
    PROCEDURE LlPrintDbGetCurrentTableSortOrder EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 146 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszSortOrderID AS MEMPTR.
      DEFINE INPUT PARAMETER nSortOrderIDLength AS LONG.
    END.
    PROCEDURE LlDbDumpStructure EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 149 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
    END.
    PROCEDURE LlPrintDbGetRootTableCount EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 151 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
    END.
    PROCEDURE LlDbSetMasterTable EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 152 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
      DEFINE INPUT PARAMETER pszTableID AS CHARACTER.
    END.
    PROCEDURE LlDbGetMasterTable EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 157 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlXSetExportParameter EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 158 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszExtensionName AS CHARACTER.
      DEFINE INPUT PARAMETER pszKey AS CHARACTER.
      DEFINE INPUT PARAMETER pszValue AS CHARACTER.
    END.
    PROCEDURE LlXGetExportParameter EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 160 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszExtensionName AS CHARACTER.
      DEFINE INPUT PARAMETER pszKey AS CHARACTER.
      ...
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlXlatName EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 164 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszName AS CHARACTER.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlDesignerProhibitEditingObject EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 185 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszObject AS CHARACTER.
    END.
    PROCEDURE LlGetUsedIdentifiers EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 186 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      ...
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlExprGetUsedVarsEx EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 205 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER lpExpr AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
    ...
    END.
    PROCEDURE LlDomGetProject EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 206 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER phDOMObj AS HANDLE TO LONG.
    END.
    PROCEDURE LlDomGetProperty EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 207 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      ...
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlDomSetProperty EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 208 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hDOMObj AS LONG.
      DEFINE INPUT PARAMETER pszName AS CHARACTER.
      DEFINE INPUT PARAMETER pszValue AS CHARACTER.
    END.
    PROCEDURE LlDomGetObject EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 209 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hDOMObj AS LONG.
      DEFINE INPUT PARAMETER pszName AS CHARACTER.
      DEFINE INPUT-OUTPUT PARAMETER phDOMSubObj AS HANDLE TO LONG.
    END.
    PROCEDURE LlDomGetSubobjectCount EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 210 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hDOMObj AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pnCount AS HANDLE TO LONG.
    END.
    PROCEDURE LlDomGetSubobject EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 211 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hDOMObj AS LONG.
      DEFINE INPUT PARAMETER nPosition AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER phDOMSubObj AS HANDLE TO LONG.
    END.
    PROCEDURE LlDomCreateSubobject EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 212 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hDOMObj AS LONG.
      DEFINE INPUT PARAMETER nPosition AS LONG.
      ...
      DEFINE INPUT-OUTPUT PARAMETER phDOMSubObj AS HANDLE TO LONG.
    END.
    PROCEDURE LlDomDeleteSubobject EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 213 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hDOMObj AS LONG.
      DEFINE INPUT PARAMETER nPosition AS LONG.
    END.
    PROCEDURE LlProjectOpen EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 214 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nObjType AS LONG.
      DEFINE INPUT PARAMETER pszObjName AS CHARACTER.
    ...
    END.
    PROCEDURE LlProjectSave EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 215 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszObjName AS CHARACTER.
    END.
    PROCEDURE LlProjectClose EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 216 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlAssociatePreviewControl EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 218 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hWndControl AS LONG.
      DEFINE INPUT PARAMETER nFlags AS LONG.
    END.
    PROCEDURE LlGetErrortext EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 219 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER nError AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlSetPreviewOption EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 221 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nOption AS LONG.
      DEFINE INPUT PARAMETER nValue AS LONG.
    END.
    PROCEDURE LlGetPreviewOption EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 222 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nOption AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pnValue AS HANDLE TO LONG.
    END.
    PROCEDURE LlDesignerInvokeAction EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 223 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nMenuID AS LONG.
    END.
    PROCEDURE LlDesignerRefreshWorkspace EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 224 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlDesignerFileOpen EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 225 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszFilename AS CHARACTER.
      DEFINE INPUT PARAMETER nFlags AS LONG.
    END.
    PROCEDURE LlDesignerFileSave EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 226 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nFlags AS LONG.
    END.
    PROCEDURE LlDesignerAddAction EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 227 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      ...
      DEFINE INPUT PARAMETER pvReserved AS LONG.
    END.
    PROCEDURE LlDesignerGetOptionString EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 236 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nIndex AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlDesignerSetOptionString EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 237 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nIndex AS LONG.
      DEFINE INPUT PARAMETER pszBuffer AS CHARACTER.
    END.
    PROCEDURE LlJobOpenCopy EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 239 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
    END.
    PROCEDURE LlGetProjectParameter EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 249 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszProjectName AS CHARACTER.
      DEFINE INPUT PARAMETER pszParameter AS CHARACTER.
      ...
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlConvertBLOBToString EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 250 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
    ...
    END.
    PROCEDURE LlConvertStringToBLOB EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 251 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER pszText AS CHARACTER.
      DEFINE INPUT-OUTPUT PARAMETER pBytes AS HANDLE TO BYTE.
      DEFINE INPUT PARAMETER nBytes AS LONG.
    END.
    PROCEDURE LlDbAddTableRelationEx EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 238 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
      DEFINE INPUT PARAMETER pszTableID AS CHARACTER.
      DEFINE INPUT PARAMETER pszParentTableID AS CHARACTER.
    ...
    END.
    PROCEDURE LlDbAddTableSortOrderEx EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 257 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
      DEFINE INPUT PARAMETER pszTableID AS CHARACTER.
      DEFINE INPUT PARAMETER pszSortOrderID AS CHARACTER.
      ...
      DEFINE INPUT PARAMETER pszField AS CHARACTER.
    END.
    PROCEDURE LlGetUsedIdentifiersEx EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 258 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszProjectName AS CHARACTER.
      ...
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlGetTempFileName EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 259 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      ...
      DEFINE INPUT PARAMETER nOptions AS LONG.
    END.
    PROCEDURE LlGetDebug EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 260 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
    END.
    PROCEDURE LlRTFEditorGetRTFControlHandle EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 261 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hRTF AS LONG.
    END.
    PROCEDURE LlLocAddDictionaryEntry EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 263 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nLCID AS LONG.
      DEFINE INPUT PARAMETER pszKey AS CHARACTER.
      ...
      DEFINE INPUT PARAMETER nType AS LONG.
    END.
    PROCEDURE LlLocAddDesignLCID EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 264 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nLCID AS LONG.
    END.
    PROCEDURE LlIsUILanguageAvailable EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 265 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER nLanguage AS LONG.
      DEFINE INPUT PARAMETER nTypesToLookFor AS LONG.
    END.
    PROCEDURE LlIsUILanguageAvailableLCID EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 266 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER nLCID AS LONG.
      DEFINE INPUT PARAMETER nTypesToLookFor AS LONG.
    END.
    PROCEDURE LlDbAddTableEx EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 267 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
      DEFINE INPUT PARAMETER pszTableID AS CHARACTER.
      DEFINE INPUT PARAMETER pszDisplayName AS CHARACTER.
      DEFINE INPUT PARAMETER nOptions AS LONG.
    END.
    PROCEDURE LlRTFSetTextEx EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 269 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hRTF AS LONG.
      DEFINE INPUT PARAMETER nFlags AS LONG.
      DEFINE INPUT PARAMETER pszText AS CHARACTER.
    END.
    PROCEDURE LlInplaceDesignerInteraction EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 270 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      ...
      DEFINE INPUT PARAMETER lParam AS LONG.
    END.
    PROCEDURE LlGetProjectDescription EXTERNAL "{&CMLL18_DLLNAME}" ORDINAL 280 {&CMLL18_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszProjectName AS CHARACTER.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
