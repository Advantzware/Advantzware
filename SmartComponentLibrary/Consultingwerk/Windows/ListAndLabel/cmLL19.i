/* Progress constants and function definitions for LL19.DLL */
/*  (c) combit GmbH */
/*  [build of 2013-09-30 16:09:42] */
...
&GLOBAL-DEFINE LL_SUBTYPEMASK                                      2047 /* (0x000007ff)  */
...
&GLOBAL-DEFINE LL_FCTPARATYPEFLAG_MULTIDIM_ALLOWED               131072 /* (0x20000) internal */
...
&IF DEFINED(CMLL19_PERSISTENT)=0 &THEN
 &GLOBAL-DEFINE CMLL19_PERSISTENT PERSISTENT
&ENDIF

&IF DEFINED(CMLL19_DLLNAME)=0 &THEN
 &GLOBAL-DEFINE CMLL19_DLLNAME CMLL19.DLL
&ENDIF

/* functions */

    PROCEDURE LlJobOpen EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 10 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER nLanguage AS LONG.
    END.
    PROCEDURE LlJobOpenLCID EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 12 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER nLCID AS LONG.
    END.
    PROCEDURE LlJobClose EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 11 {&CMLL19_PERSISTENT}:
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlSetDebug EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 13 {&CMLL19_PERSISTENT}:
      DEFINE INPUT PARAMETER nOnOff AS LONG.
    END.
    PROCEDURE LlGetVersion EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 14 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER nCmd AS LONG.
    END.
    PROCEDURE LlGetNotificationMessage EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 15 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlSetNotificationMessage EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 16 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nMessage AS LONG.
    END.
    PROCEDURE LlDefineField EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 18 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszVarName AS CHARACTER.
      DEFINE INPUT PARAMETER lpbufContents AS CHARACTER.
    END.
    PROCEDURE LlDefineFieldExt EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 19 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszVarName AS CHARACTER.
      DEFINE INPUT PARAMETER lpbufContents AS CHARACTER.
    ...
    END.
    PROCEDURE LlDefineFieldExtHandle EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 20 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszVarName AS CHARACTER.
      ...
      DEFINE INPUT PARAMETER lpPtr AS LONG.
    END.
    PROCEDURE LlDefineFieldStart EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 21 {&CMLL19_PERSISTENT}:
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlDefineVariable EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 22 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszVarName AS CHARACTER.
      DEFINE INPUT PARAMETER lpbufContents AS CHARACTER.
    END.
    PROCEDURE LlDefineVariableExt EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 23 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszVarName AS CHARACTER.
      DEFINE INPUT PARAMETER lpbufContents AS CHARACTER.
      ...
      DEFINE INPUT PARAMETER lpPtr AS LONG.
    END.
    PROCEDURE LlDefineVariableExtHandle EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 24 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszVarName AS CHARACTER.
      DEFINE INPUT PARAMETER hContents AS LONG.
      ...
      DEFINE INPUT PARAMETER lpPtr AS LONG.
    END.
    PROCEDURE LlDefineVariableName EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 25 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszVarName AS CHARACTER.
    END.
    PROCEDURE LlDefineVariableStart EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 26 {&CMLL19_PERSISTENT}:
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlDefineSumVariable EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 27 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszVarName AS CHARACTER.
      DEFINE INPUT PARAMETER lpbufContents AS CHARACTER.
    END.
    PROCEDURE LlDefineLayout EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 28 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    ...
    END.
    PROCEDURE LlDlgEditLine EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 29 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hWnd AS LONG.
    ...
    END.
    PROCEDURE LlDlgEditLineEx EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 30 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hWnd AS LONG.
    ...
    END.
    PROCEDURE LlPreviewSetTempPath EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 31 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszPath AS CHARACTER.
    END.
    PROCEDURE LlPreviewDeleteFiles EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 32 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszObjName AS CHARACTER.
      DEFINE INPUT PARAMETER pszPath AS CHARACTER.
    END.
    PROCEDURE LlPreviewDisplay EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 33 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszObjName AS CHARACTER.
      DEFINE INPUT PARAMETER pszPath AS CHARACTER.
    ...
    END.
    PROCEDURE LlPreviewDisplayEx EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 34 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszObjName AS CHARACTER.
      DEFINE INPUT PARAMETER pszPath AS CHARACTER.
    ...
    END.
    PROCEDURE LlPrint EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 35 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlPrintAbort EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 36 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlPrintCheckLineFit EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 37 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlPrintEnd EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 38 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nPages AS LONG.
    END.
    PROCEDURE LlPrintFields EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 39 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlPrintFieldsEnd EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 40 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlPrintGetCurrentPage EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 41 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlPrintGetItemsPerPage EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 42 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlPrintGetItemsPerTable EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 43 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlPrintGetRemainingItemsPerTable EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 44 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszField AS CHARACTER.
    END.
    PROCEDURE LlPrintGetRemItemsPerTable EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 45 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszField AS CHARACTER.
    END.
    PROCEDURE LlPrintGetOption EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 46 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nIndex AS LONG.
    END.
    PROCEDURE LlPrintGetPrinterInfo EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 47 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    ...
    END.
    PROCEDURE LlPrintOptionsDialog EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 48 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hWnd AS LONG.
      DEFINE INPUT PARAMETER pszText AS CHARACTER.
    END.
    PROCEDURE LlPrintSelectOffsetEx EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 49 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hWnd AS LONG.
    END.
    PROCEDURE LlPrintSetBoxText EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 50 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER szText AS CHARACTER.
      DEFINE INPUT PARAMETER nPercentage AS LONG.
    END.
    PROCEDURE LlPrintSetOption EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 51 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nIndex AS LONG.
      DEFINE INPUT PARAMETER nValue AS LONG.
    END.
    PROCEDURE LlPrintUpdateBox EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 52 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlPrintStart EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 53 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nObjType AS LONG.
      DEFINE INPUT PARAMETER pszObjName AS CHARACTER.
    ...
    END.
    PROCEDURE LlPrintWithBoxStart EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 54 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nObjType AS LONG.
      DEFINE INPUT PARAMETER pszObjName AS CHARACTER.
      ...
      DEFINE INPUT PARAMETER pszTitle AS CHARACTER.
    END.
    PROCEDURE LlPrinterSetup EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 55 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hWnd AS LONG.
      DEFINE INPUT PARAMETER nObjType AS LONG.
      DEFINE INPUT PARAMETER pszObjName AS CHARACTER.
    END.
    PROCEDURE LlSelectFileDlgTitleEx EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 56 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hWnd AS LONG.
      DEFINE INPUT PARAMETER pszTitle AS CHARACTER.
    ...
    END.
    PROCEDURE LlSetDlgboxMode EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 57 {&CMLL19_PERSISTENT}:
      DEFINE INPUT PARAMETER nMode AS LONG.
    END.
    PROCEDURE LlGetDlgboxMode EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 58 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
    END.
    PROCEDURE LlExprParse EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 59 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER lpExprText AS CHARACTER.
      DEFINE INPUT PARAMETER bIncludeFields AS LONG.
    END.
    PROCEDURE LlExprType EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 60 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER lpExpr AS LONG.
    END.
    PROCEDURE LlExprError EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 61 {&CMLL19_PERSISTENT}:
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuf AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlExprFree EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 62 {&CMLL19_PERSISTENT}:
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER lpExpr AS LONG.
    END.
    PROCEDURE LlExprEvaluate EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 63 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER lpExpr AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuf AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlExprGetUsedVars EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 162 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER lpExpr AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlSetOption EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 64 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nMode AS LONG.
      DEFINE INPUT PARAMETER nValue AS LONG.
    END.
    PROCEDURE LlGetOption EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 65 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nMode AS LONG.
    END.
    PROCEDURE LlSetOptionString EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 66 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nIndex AS LONG.
      DEFINE INPUT PARAMETER pszBuffer AS CHARACTER.
    END.
    PROCEDURE LlGetOptionString EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 67 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nIndex AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlPrintSetOptionString EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 68 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nIndex AS LONG.
      DEFINE INPUT PARAMETER pszBuffer AS CHARACTER.
    END.
    PROCEDURE LlPrintGetOptionString EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 69 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nIndex AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlDesignerProhibitAction EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 70 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nMenuID AS LONG.
    END.
    PROCEDURE LlDesignerProhibitFunction EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 1 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszFunction AS CHARACTER.
    END.
    PROCEDURE LlPrintEnableObject EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 71 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszObjectName AS CHARACTER.
      DEFINE INPUT PARAMETER bEnable AS LONG.
    END.
    PROCEDURE LlSetFileExtensions EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 72 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nObjType AS LONG.
    ...
    END.
    PROCEDURE LlPrintGetTextCharsPrinted EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 73 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszObjectName AS CHARACTER.
    END.
    PROCEDURE LlPrintGetFieldCharsPrinted EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 74 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszObjectName AS CHARACTER.
      DEFINE INPUT PARAMETER pszField AS CHARACTER.
    END.
    PROCEDURE LlPrintIsVariableUsed EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 75 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszVarName AS CHARACTER.
    END.
    PROCEDURE LlPrintIsFieldUsed EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 76 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszFieldName AS CHARACTER.
    END.
    PROCEDURE LlPrintOptionsDialogTitle EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 77 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hWnd AS LONG.
      DEFINE INPUT PARAMETER pszTitle AS CHARACTER.
      DEFINE INPUT PARAMETER pszText AS CHARACTER.
    END.
    PROCEDURE LlSetPrinterToDefault EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 78 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nObjType AS LONG.
      DEFINE INPUT PARAMETER pszObjName AS CHARACTER.
    END.
    PROCEDURE LlDefineSortOrderStart EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 79 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlDefineSortOrder EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 80 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszIdentifier AS CHARACTER.
      DEFINE INPUT PARAMETER pszText AS CHARACTER.
    END.
    PROCEDURE LlPrintGetSortOrder EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 81 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlDefineGrouping EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 82 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      ...
      DEFINE INPUT PARAMETER pszText AS CHARACTER.
    END.
    PROCEDURE LlPrintGetGrouping EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 83 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlAddCtlSupport EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 84 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hWnd AS LONG.
      DEFINE INPUT PARAMETER nFlags AS LONG.
      DEFINE INPUT PARAMETER pszInifile AS CHARACTER.
    END.
    PROCEDURE LlPrintBeginGroup EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 85 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER lParam AS LONG.
      DEFINE INPUT PARAMETER lpParam AS LONG.
    END.
    PROCEDURE LlPrintEndGroup EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 86 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER lParam AS LONG.
      DEFINE INPUT PARAMETER lpParam AS LONG.
    END.
    PROCEDURE LlPrintGroupLine EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 87 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER lParam AS LONG.
      DEFINE INPUT PARAMETER lpParam AS LONG.
    END.
    PROCEDURE LlPrintGroupHeader EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 88 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER lParam AS LONG.
    END.
    PROCEDURE LlPrintGetFilterExpression EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 89 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlPrintWillMatchFilter EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 90 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlPrintDidMatchFilter EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 91 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlGetFieldContents EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 93 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      ...
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlGetVariableContents EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 92 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszName AS CHARACTER.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlGetSumVariableContents EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 94 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszName AS CHARACTER.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlGetUserVariableContents EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 95 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszName AS CHARACTER.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlGetVariableType EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 96 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszName AS CHARACTER.
    END.
    PROCEDURE LlGetFieldType EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 97 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszName AS CHARACTER.
    END.
    PROCEDURE LlSetPrinterDefaultsDir EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 200 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszDir AS CHARACTER.
    END.
    PROCEDURE LlCreateSketch EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 201 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nObjType AS LONG.
      DEFINE INPUT PARAMETER lpszObjName AS CHARACTER.
    END.
    PROCEDURE LlViewerProhibitAction EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 202 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nMenuID AS LONG.
    END.
    PROCEDURE LlPrintCopyPrinterConfiguration EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 203 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER lpszFilename AS CHARACTER.
      DEFINE INPUT PARAMETER nFunction AS LONG.
    END.
    PROCEDURE LlRTFCreateObject EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 228 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlRTFDeleteObject EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 229 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hRTF AS LONG.
    END.
    PROCEDURE LlRTFSetText EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 230 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hRTF AS LONG.
      DEFINE INPUT PARAMETER pszText AS CHARACTER.
    END.
    PROCEDURE LlRTFGetTextLength EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 231 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hRTF AS LONG.
      DEFINE INPUT PARAMETER nFlags AS LONG.
    END.
    PROCEDURE LlRTFGetText EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 232 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hRTF AS LONG.
      DEFINE INPUT PARAMETER nFlags AS LONG.
      ...
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlRTFEditObject EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 233 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hRTF AS LONG.
      DEFINE INPUT PARAMETER hWnd AS LONG.
    ...
    END.
    PROCEDURE LlRTFCopyToClipboard EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 234 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hRTF AS LONG.
    END.
    PROCEDURE LlRTFDisplay EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 235 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hRTF AS LONG.
    ...
    END.
    PROCEDURE LlRTFEditorProhibitAction EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 109 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hRTF AS LONG.
      DEFINE INPUT PARAMETER nControlID AS LONG.
    END.
    PROCEDURE LlRTFEditorInvokeAction EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 117 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hRTF AS LONG.
      DEFINE INPUT PARAMETER nControlID AS LONG.
    END.
    PROCEDURE LlDebugOutput EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 240 {&CMLL19_PERSISTENT}:
      DEFINE INPUT PARAMETER nIndent AS LONG.
      DEFINE INPUT PARAMETER pszText AS CHARACTER.
    END.
    PROCEDURE LlEnumGetFirstVar EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 241 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nFlags AS LONG.
    END.
    PROCEDURE LlEnumGetFirstField EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 242 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nFlags AS LONG.
    END.
    PROCEDURE LlEnumGetNextEntry EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 243 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nPos AS LONG.
      DEFINE INPUT PARAMETER nFlags AS LONG.
    END.
    PROCEDURE LlEnumGetEntry EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 244 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nPos AS LONG.
    ...
    END.
    PROCEDURE LlPrintResetObjectStates EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 245 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlXSetParameter EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 246 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    ...
    END.
    PROCEDURE LlXGetParameter EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 247 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nExtensionType AS LONG.
      DEFINE INPUT PARAMETER pszExtensionName AS CHARACTER.
      ...
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlPrintResetProjectState EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 248 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
    END.
    PROCEDURE LlDefineChartFieldStart EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 2 {&CMLL19_PERSISTENT}:
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlDefineChartFieldExt EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 3 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszVarName AS CHARACTER.
      ...
      DEFINE INPUT PARAMETER lpPtr AS LONG.
    END.
    PROCEDURE LlPrintDeclareChartRow EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 4 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nFlags AS LONG.
    END.
    PROCEDURE LlPrintGetChartObjectCount EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 6 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nType AS LONG.
    END.
    PROCEDURE LlPrintIsChartFieldUsed EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 5 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszFieldName AS CHARACTER.
    END.
    PROCEDURE LlGetChartFieldContents EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 8 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszName AS CHARACTER.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlEnumGetFirstChartField EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 9 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nFlags AS LONG.
    END.
    PROCEDURE LlPrintGetRemainingSpacePerTable EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 102 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszField AS CHARACTER.
      DEFINE INPUT PARAMETER nDimension AS LONG.
    END.
    PROCEDURE LlSetDefaultProjectParameter EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 108 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      ...
      DEFINE INPUT PARAMETER nFlags AS LONG.
    END.
    PROCEDURE LlGetDefaultProjectParameter EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 110 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszParameter AS CHARACTER.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
    ...
    END.
    PROCEDURE LlPrintSetProjectParameter EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 113 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszParameter AS CHARACTER.
      DEFINE INPUT PARAMETER pszValue AS CHARACTER.
      DEFINE INPUT PARAMETER nFlags AS LONG.
    END.
    PROCEDURE LlPrintGetProjectParameter EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 114 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszParameter AS CHARACTER.
      ...
      DEFINE INPUT-OUTPUT PARAMETER pnFlags AS HANDLE TO LONG.
    END.
    PROCEDURE LlExprContainsVariable EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 7 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hExpr AS LONG.
      DEFINE INPUT PARAMETER pszVariable AS CHARACTER.
    END.
    PROCEDURE LlExprIsConstant EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 116 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hExpr AS LONG.
    END.
    PROCEDURE LlProfileStart EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 136 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
    ...
    END.
    PROCEDURE LlProfileEnd EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 137 {&CMLL19_PERSISTENT}:
      DEFINE INPUT PARAMETER hThread AS LONG.
    END.
    PROCEDURE LlDbAddTable EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 139 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
      DEFINE INPUT PARAMETER pszTableID AS CHARACTER.
      DEFINE INPUT PARAMETER pszDisplayName AS CHARACTER.
    END.
    PROCEDURE LlDbAddTableRelation EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 140 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
      DEFINE INPUT PARAMETER pszTableID AS CHARACTER.
    ...
    END.
    PROCEDURE LlDbAddTableSortOrder EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 141 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
      DEFINE INPUT PARAMETER pszTableID AS CHARACTER.
    ...
    END.
    PROCEDURE LlPrintDbGetCurrentTable EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 142 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
    ...
    END.
    PROCEDURE LlPrintDbGetCurrentTableRelation EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 143 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszRelationID AS MEMPTR.
      DEFINE INPUT PARAMETER nRelationIDLength AS LONG.
    END.
    PROCEDURE LlPrintDbGetCurrentTableSortOrder EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 146 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszSortOrderID AS MEMPTR.
      DEFINE INPUT PARAMETER nSortOrderIDLength AS LONG.
    END.
    PROCEDURE LlDbDumpStructure EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 149 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
    END.
    PROCEDURE LlPrintDbGetRootTableCount EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 151 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
    END.
    PROCEDURE LlDbSetMasterTable EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 152 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
      DEFINE INPUT PARAMETER pszTableID AS CHARACTER.
    END.
    PROCEDURE LlDbGetMasterTable EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 157 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlXSetExportParameter EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 158 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszExtensionName AS CHARACTER.
      DEFINE INPUT PARAMETER pszKey AS CHARACTER.
      DEFINE INPUT PARAMETER pszValue AS CHARACTER.
    END.
    PROCEDURE LlXGetExportParameter EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 160 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszExtensionName AS CHARACTER.
      DEFINE INPUT PARAMETER pszKey AS CHARACTER.
      ...
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlXlatName EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 164 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszName AS CHARACTER.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlDesignerProhibitEditingObject EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 185 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszObject AS CHARACTER.
    END.
    PROCEDURE LlGetUsedIdentifiers EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 186 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      ...
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlExprGetUsedVarsEx EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 205 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER lpExpr AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
    ...
    END.
    PROCEDURE LlDomGetProject EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 206 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER phDOMObj AS HANDLE TO LONG.
    END.
    PROCEDURE LlDomGetProperty EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 207 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      ...
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlDomSetProperty EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 208 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hDOMObj AS LONG.
      DEFINE INPUT PARAMETER pszName AS CHARACTER.
      DEFINE INPUT PARAMETER pszValue AS CHARACTER.
    END.
    PROCEDURE LlDomGetObject EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 209 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hDOMObj AS LONG.
      DEFINE INPUT PARAMETER pszName AS CHARACTER.
      DEFINE INPUT-OUTPUT PARAMETER phDOMSubObj AS HANDLE TO LONG.
    END.
    PROCEDURE LlDomGetSubobjectCount EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 210 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hDOMObj AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pnCount AS HANDLE TO LONG.
    END.
    PROCEDURE LlDomGetSubobject EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 211 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hDOMObj AS LONG.
      DEFINE INPUT PARAMETER nPosition AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER phDOMSubObj AS HANDLE TO LONG.
    END.
    PROCEDURE LlDomCreateSubobject EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 212 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hDOMObj AS LONG.
      DEFINE INPUT PARAMETER nPosition AS LONG.
      ...
      DEFINE INPUT-OUTPUT PARAMETER phDOMSubObj AS HANDLE TO LONG.
    END.
    PROCEDURE LlDomDeleteSubobject EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 213 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hDOMObj AS LONG.
      DEFINE INPUT PARAMETER nPosition AS LONG.
    END.
    PROCEDURE LlProjectOpen EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 214 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nObjType AS LONG.
      DEFINE INPUT PARAMETER pszObjName AS CHARACTER.
    ...
    END.
    PROCEDURE LlProjectSave EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 215 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszObjName AS CHARACTER.
    END.
    PROCEDURE LlProjectClose EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 216 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlAssociatePreviewControl EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 218 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hWndControl AS LONG.
      DEFINE INPUT PARAMETER nFlags AS LONG.
    END.
    PROCEDURE LlGetErrortext EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 219 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER nError AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlSetPreviewOption EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 221 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nOption AS LONG.
      DEFINE INPUT PARAMETER nValue AS LONG.
    END.
    PROCEDURE LlGetPreviewOption EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 222 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nOption AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pnValue AS HANDLE TO LONG.
    END.
    PROCEDURE LlDesignerInvokeAction EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 223 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nMenuID AS LONG.
    END.
    PROCEDURE LlDesignerRefreshWorkspace EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 224 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
    END.
    PROCEDURE LlDesignerFileOpen EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 225 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszFilename AS CHARACTER.
      DEFINE INPUT PARAMETER nFlags AS LONG.
    END.
    PROCEDURE LlDesignerFileSave EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 226 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nFlags AS LONG.
    END.
    PROCEDURE LlDesignerAddAction EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 227 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      ...
      DEFINE INPUT PARAMETER pvReserved AS LONG.
    END.
    PROCEDURE LlDesignerGetOptionString EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 236 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nIndex AS LONG.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlDesignerSetOptionString EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 237 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nIndex AS LONG.
      DEFINE INPUT PARAMETER pszBuffer AS CHARACTER.
    END.
    PROCEDURE LlJobOpenCopy EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 239 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
    END.
    PROCEDURE LlGetProjectParameter EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 249 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszProjectName AS CHARACTER.
      DEFINE INPUT PARAMETER pszParameter AS CHARACTER.
      ...
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlConvertBLOBToString EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 250 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
    ...
    END.
    PROCEDURE LlConvertStringToBLOB EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 251 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER pszText AS CHARACTER.
      DEFINE INPUT-OUTPUT PARAMETER pBytes AS HANDLE TO BYTE.
      DEFINE INPUT PARAMETER nBytes AS LONG.
    END.
    PROCEDURE LlDbAddTableRelationEx EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 238 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
      DEFINE INPUT PARAMETER pszTableID AS CHARACTER.
      DEFINE INPUT PARAMETER pszParentTableID AS CHARACTER.
    ...
    END.
    PROCEDURE LlDbAddTableSortOrderEx EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 257 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
      DEFINE INPUT PARAMETER pszTableID AS CHARACTER.
      DEFINE INPUT PARAMETER pszSortOrderID AS CHARACTER.
      ...
      DEFINE INPUT PARAMETER pszField AS CHARACTER.
    END.
    PROCEDURE LlGetUsedIdentifiersEx EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 258 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszProjectName AS CHARACTER.
      ...
      DEFINE INPUT PARAMETER nBufSize AS LONG.
    END.
    PROCEDURE LlGetTempFileName EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 259 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      ...
      DEFINE INPUT PARAMETER nOptions AS LONG.
    END.
    PROCEDURE LlGetDebug EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 260 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
    END.
    PROCEDURE LlRTFEditorGetRTFControlHandle EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 261 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hRTF AS LONG.
    END.
    PROCEDURE LlLocAddDictionaryEntry EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 263 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nLCID AS LONG.
      DEFINE INPUT PARAMETER pszKey AS CHARACTER.
      ...
      DEFINE INPUT PARAMETER nType AS LONG.
    END.
    PROCEDURE LlLocAddDesignLCID EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 264 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER nLCID AS LONG.
    END.
    PROCEDURE LlIsUILanguageAvailable EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 265 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER nLanguage AS LONG.
      DEFINE INPUT PARAMETER nTypesToLookFor AS LONG.
    END.
    PROCEDURE LlIsUILanguageAvailableLCID EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 266 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER nLCID AS LONG.
      DEFINE INPUT PARAMETER nTypesToLookFor AS LONG.
    END.
    PROCEDURE LlDbAddTableEx EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 267 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hJob AS LONG.
      DEFINE INPUT PARAMETER pszTableID AS CHARACTER.
      DEFINE INPUT PARAMETER pszDisplayName AS CHARACTER.
      DEFINE INPUT PARAMETER nOptions AS LONG.
    END.
    PROCEDURE LlRTFSetTextEx EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 269 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER hRTF AS LONG.
      DEFINE INPUT PARAMETER nFlags AS LONG.
      DEFINE INPUT PARAMETER pszText AS CHARACTER.
    END.
    PROCEDURE LlInplaceDesignerInteraction EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 270 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      ...
      DEFINE INPUT PARAMETER lParam AS LONG.
    END.
    PROCEDURE LlGetProjectDescription EXTERNAL "{&CMLL19_DLLNAME}" ORDINAL 280 {&CMLL19_PERSISTENT}:
      DEFINE RETURN PARAMETER rc AS LONG.
      DEFINE INPUT PARAMETER hLlJob AS LONG.
      DEFINE INPUT PARAMETER pszProjectName AS CHARACTER.
      DEFINE INPUT-OUTPUT PARAMETER pszBuffer AS MEMPTR.
