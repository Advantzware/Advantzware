...
DEFINE {&ACCESS} TEMP-TABLE eSmartLoginCompany NO-UNDO {&REFERENCE-ONLY} &IF DEFINED (NO-BEFORE) EQ 0 &THEN BEFORE-TABLE eSmartLoginCompanyBefore &ENDIF
    ...
    INDEX LoginCompanyGuid AS UNIQUE PRIMARY LoginCompanyGuid ASCENDING
