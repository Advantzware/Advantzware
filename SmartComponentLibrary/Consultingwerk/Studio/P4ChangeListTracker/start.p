...
DEFINE VARIABLE oForm AS PerforceChangeListForm NO-UNDO . 

DEFINE VARIABLE oTaskbarManager AS Microsoft.WindowsAPICodePack.Taskbar.TaskbarManager NO-UNDO . 

&scoped-define ApplicationTitle Consultingwerk Studio
&scoped-define BaseRegistryKey Software~\Consultingwerk Ltd.~\Studio~\PerforceChangeListTracker~\
...
IF Microsoft.WindowsAPICodePack.Taskbar.TaskbarManager:IsPlatformSupported THEN DO:
    ...
    oTaskbarManager:ApplicationId = "de.consultingwerk.perforcechangelistform":U . 
END.

oForm = NEW PerforceChangeListForm () . 
