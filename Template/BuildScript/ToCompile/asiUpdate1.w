...
/*------------------------------------------------------------------------------
    ...
    DO:
        ...
        RUN ipStatus("Initiating asiUpdateDB1.w").
        ASSIGN
            c-Win:VISIBLE = FALSE. 
        
        IF SEARCH("asiUpdateDB1.r") NE ? 
        OR SEARCH("asiUpdateDB1.w") NE ? THEN 
        DO:
            ASSIGN 
                cFileToRun = "asiUpdateDB1.w".
        END.
        ELSE ASSIGN 
            cFileToRun = "N:\Repository\PatchTemplate\Deployment\Admin\EnvAdmin\asiUpdateDB1.w".
        ...
        ASSIGN
            c-Win:VISIBLE = TRUE. 
        RUN ipStatus("Return from asiUpdateDB1.w").
    ...
    IF SEARCH("asiUpdateENV1.r") NE ? 
        OR SEARCH("asiUpdateENV1.w") NE ? THEN ASSIGN 
            cFileToRun = "asiUpdateENV1.w".
    ELSE ASSIGN 
            cFileToRun = "N:\Repository\PatchTemplate\Deployment\Admin\EnvAdmin\asiUpdateENV1.w".

    CREATE ALIAS "DICTDB" FOR DATABASE asi.
    RUN ipStatus("Initiating asiUpdateENV1.w").
    ASSIGN
        c-Win:VISIBLE = FALSE. 
    ...
    ASSIGN
        c-Win:VISIBLE = TRUE. 
    RUN ipStatus("Return from asiUpdateENV1.w").
