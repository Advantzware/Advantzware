...
bTestStructure fiEnvOverrideDir fiEnvPoDir tbBackupDBs fiEnvProgramsDir ~
tbUserControl fiEnvResourceDir tbUserCleanup fiEnvScheduleDir ~
fiEnvTemplateDir tbBuildDirs fiEnvUserMenuDir tbDelBadData fiEnvUsersDir ~
tbUpdateMaster fiEnvTestDir fiInstallDir tbLoadMenus fiUpdatesDir ~
tbRunDataFix fiPatchDir tbUpdateStartup fiUpdAdminDir fiUpdCompressDir ~
tbRelNotes fiUpdDataDir tbBackupFiles fiUpdDataUpdateDir tbInstallFiles ~
fiUpdDeskDir fiUpdMenuDir tbDelDupeNotes fiUpdProgramDir fiUpdRelNotesDir ~
bProcess fiUpdSqlDir fiUpdStructureDir tbUpdateIni 
...
fiUpdatesDir tbComp-7 tbRunDataFix fiPatchDir tbComp-8 tbUpdateStartup ~
fiUpdAdminDir fiUpdCompressDir tbComp-9 tbRelNotes fiUpdDataDir tbComp-11 ~
tbBackupFiles fiUpdDataUpdateDir tbComp-12 tbInstallFiles fiUpdDeskDir ~
fiUpdMenuDir tbComp-13 tbDelDupeNotes fiUpdProgramDir tbComp-14 ~
tbUpdateNK1s fiUpdRelNotesDir tbComp-15 tbUpdateFileLocs fiUpdSqlDir ~
fiUpdStructureDir tbComp-16 tbUpdateIni 
...
DEFINE VARIABLE fiNewVer AS CHARACTER FORMAT "X(256)":U INITIAL "16.6.8" 
     LABEL "New Version" 
     VIEW-AS FILL-IN 
     SIZE 14 BY 1 NO-UNDO.
...
DEFINE FRAME DEFAULT-FRAME
     ...
     bTestStructure AT ROW 16.48 COL 81 WIDGET-ID 392
     ...
     bFixStructure AT ROW 17.67 COL 81 WIDGET-ID 394
     ...
     tbComp-7 AT ROW 24.33 COL 11 WIDGET-ID 414
     tbRunDataFix AT ROW 24.33 COL 17 WIDGET-ID 400
     fiPatchDir AT ROW 24.57 COL 113 COLON-ALIGNED NO-LABEL WIDGET-ID 290
     tbComp-8 AT ROW 25.29 COL 11 WIDGET-ID 416
     tbUpdateStartup AT ROW 25.29 COL 17 WIDGET-ID 380
     ...
     tbComp-9 AT ROW 26.24 COL 11 WIDGET-ID 426
     tbRelNotes AT ROW 26.24 COL 17 WIDGET-ID 382
     fiUpdDataDir AT ROW 26.71 COL 116 COLON-ALIGNED NO-LABEL WIDGET-ID 148
     tbComp-11 AT ROW 27.19 COL 11 WIDGET-ID 422
     tbBackupFiles AT ROW 27.19 COL 17 WIDGET-ID 386
     fiUpdDataUpdateDir AT ROW 27.43 COL 116 COLON-ALIGNED NO-LABEL WIDGET-ID 154
     tbComp-12 AT ROW 28.14 COL 11 WIDGET-ID 424
     tbInstallFiles AT ROW 28.14 COL 17 WIDGET-ID 388
...
DEFINE FRAME DEFAULT-FRAME
     ...
     bProcess AT ROW 31 COL 81 WIDGET-ID 404
...
------------------------------------------------------------------------------*/
  DISPLAY fiCurrVer fiVerDate fiAdminDir fiDbAdmin fiSiteName fiHostname 
          ...
          fiUpdatesDir tbComp-7 tbRunDataFix fiPatchDir tbComp-8 tbUpdateStartup 
          fiUpdAdminDir fiUpdCompressDir tbComp-9 tbRelNotes fiUpdDataDir 
          tbComp-11 tbBackupFiles fiUpdDataUpdateDir tbComp-12 tbInstallFiles 
          fiUpdDeskDir fiUpdMenuDir tbComp-13 tbDelDupeNotes fiUpdProgramDir 
          tbComp-14 tbUpdateNK1s fiUpdRelNotesDir tbComp-15 tbUpdateFileLocs 
          fiUpdSqlDir fiUpdStructureDir tbComp-16 tbUpdateIni 
  ...
  ENABLE RECT-1 RECT-2 RECT-3 RECT-4 fiCurrVer fiVerDate fiAdminDir fiDbAdmin 
         ...
         fiEnvProdDir fiDbName-3 fiDbDir-3 fiDbPort-3 tbBackupAlt fiEnvAddonDir 
         fiEnvCustFiles fiEnvCustomerDir tbInstallPatchComplete fiNewVer 
         bTestStructure fiEnvOverrideDir fiEnvPoDir tbBackupDBs 
         fiEnvProgramsDir tbUserControl fiEnvResourceDir tbUserCleanup 
         fiEnvScheduleDir fiEnvTemplateDir tbBuildDirs fiEnvUserMenuDir 
         tbDelBadData fiEnvUsersDir tbUpdateMaster fiEnvTestDir fiInstallDir 
         tbLoadMenus fiUpdatesDir tbRunDataFix fiPatchDir tbUpdateStartup 
         fiUpdAdminDir fiUpdCompressDir tbRelNotes fiUpdDataDir tbBackupFiles 
         fiUpdDataUpdateDir tbInstallFiles fiUpdDeskDir fiUpdMenuDir 
         tbDelDupeNotes fiUpdProgramDir fiUpdRelNotesDir bProcess fiUpdSqlDir 
         fiUpdStructureDir tbUpdateIni 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
...
------------------------------------------------------------------------------*/
    ...
    IF SEARCH(cUpdProgramDir + "\programs.7z") NE ? THEN DO:
        ...
        IF lTestExists THEN DO:
            ...
            OS-CREATE-DIR VALUE(cEnvTestDir + "\Programs").
            ASSIGN
    ...
    IF SEARCH(cUpdProgramDir + "\resources.7z") NE ? THEN DO:
        ...
        IF lProdExists THEN DO:
            ...
            OS-CREATE-DIR VALUE(cEnvProdDir + "\Resources").
            ASSIGN
                cCmdLine3 = cCmdLine2 + cEnvProdDir + "\" + cFileType.
            OS-COMMAND SILENT VALUE(cCmdLine3).
        END.
        IF lTestExists THEN DO:
            ...
            OS-CREATE-DIR VALUE(cEnvTestDir + "\Resources").
            ASSIGN
                cCmdLine3 = cCmdLine2 + cEnvTestDir + "\" + cFileType.
            OS-COMMAND SILENT VALUE(cCmdLine3).
        END.
    ...
    IF lProdExists THEN DO:
        ...
        OS-CREATE-DIR VALUE(cEnvProdDir + "\Override").
    END.
    IF lTestExists THEN DO:
        OS-DELETE VALUE(cEnvTestDir + "\Override") RECURSIVE.
        OS-CREATE-DIR VALUE(cEnvTestDir + "\Override").
    END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE ipFixConfiguration C-Win 
PROCEDURE ipFixConfiguration :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
