...
DEFINE VARIABLE lhTableIOtarget AS HANDLE NO-UNDO.
...
DO:
  ...
  {methods/setButton.i Btn-Save "Save"} /* added by script _admTransPanels.p on 04.07.2017 @  2:09:01 pm */
...
DO:
  DO WITH FRAME Panel-Frame:
      ...
      {methods/setButton.i Btn-Save "Update"} /* added by script _admTransPanels.p on 04.07.2017 @  2:09:01 pm */
   END.
  {Advantzware/WinKit/winkit-panel-triggerend.i} /* added by script _admPanels.p on 04.07.2017 @  2:08:49 pm */
END.
...
&ENDIF
  ...
  /* Check if ordFrest needs to run, postponed from local-update-record */
  IF VALID-HANDLE(lhTableIOtarget) THEN 
      RUN createFromEst IN lhTableIOtarget NO-ERROR.

  /* Handle auto add of items for new orders */
  IF VALID-HANDLE(lhTableIOtarget) THEN 
      RUN addItems IN lhTableIOtarget NO-ERROR.
  {Advantzware/WinKit/winkit-panel-triggerend.i} /* added by script _admPanels.p on 04.07.2017 @  2:08:49 pm */
END.
...
/* ***************************  Main Block  *************************** */
  ...
  {methods/setButton.i Btn-Save "Update"} /* added by script _admTransPanels.p on 04.07.2017 @  2:09:01 pm */
  {methods/setButton.i Btn-Reset "Reset"} /* added by script _admTransPanels.p on 04.07.2017 @  2:09:01 pm */
  {methods/setButton.i Btn-Add "Add"} /* added by script _admTransPanels.p on 04.07.2017 @  2:09:01 pm */
  {methods/setButton.i Btn-Copy "Copy"} /* added by script _admTransPanels.p on 04.07.2017 @  2:09:01 pm */
  {methods/setButton.i Btn-Delete "Delete"} /* added by script _admTransPanels.p on 04.07.2017 @  2:09:01 pm */
  {methods/setButton.i Btn-Cancel "Cancel"} /* added by script _admTransPanels.p on 04.07.2017 @  2:09:01 pm */
...
/*--------------------------------------------------------------------------
  ...
  IF RETURN-VALUE <> 'DESIGN':U THEN DO:
     ...
     lhTableIOtarget = WIDGET-HANDLE(char-hdl).
/*
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE manual-apply-add C-WIn 
PROCEDURE manual-apply-add :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
IF Btn-Add:SENSITIVE IN FRAME {&FRAME-NAME} = YES THEN
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE manual-apply-save C-WIn 
PROCEDURE manual-apply-save :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       If user exits without saving in v-ord
------------------------------------------------------------------------------*/
DO WITH FRAME panel-frame:
    IF Btn-Save:LABEL = '&Update' THEN 
