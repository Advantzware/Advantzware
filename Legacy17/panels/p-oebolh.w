...
Btn-Cancel btn-release btn-frate 
...
DEFINE FRAME Panel-Frame
     ...
     btn-release AT ROW 1.29 COL 47
     btn-frate AT ROW 1.29 COL 59
...
ASSIGN 
       btn-frate:PRIVATE-DATA IN FRAME Panel-Frame     = 
                "panel-image".
...
&Scoped-define SELF-NAME btn-frate
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn-frate C-WIn
ON CHOOSE OF btn-frate IN FRAME Panel-Frame /* Freight */
DO:
...
/* ***************************  Main Block  *************************** */
  ...
  {methods/setButton.i btn-frate "Freight"} /* added by script c:\tmp\p64604__panelImages.ped */
...
&ENDIF
&IF LOOKUP("btn-frate":U, "{&ENABLED-OBJECTS}":U," ":U) NE 0 &THEN
             btn-frate:SENSITIVE = NO.
&ENDIF
