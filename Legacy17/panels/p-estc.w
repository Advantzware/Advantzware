...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE is-in-update C-WIn 
...
IF Btn-Save:LABEL IN FRAME {&FRAME-NAME}  = '&Update' THEN
    opl-is-updating = FALSE.
ELSE
    opl-is-updating = TRUE.
END PROCEDURE.
