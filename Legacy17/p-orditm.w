...
DEFINE FRAME Panel-Frame
     ...
     btn-price AT ROW 1.24 COL 38
     btn-stat AT ROW 1.24 COL 54
     btn-his AT ROW 1.24 COL 69
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn-his C-WIn
ON CHOOSE OF btn-his IN FRAME Panel-Frame /* History */
DO:
...
ON CHOOSE OF btn-price IN FRAME Panel-Frame /* Price */
DO:
   run get-link-handle in adm-broker-hdl(this-procedure,"tableio-target", output char-hdl).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn-stat C-WIn
ON CHOOSE OF btn-stat IN FRAME Panel-Frame /* Stat */
DO:
   run get-link-handle in adm-broker-hdl(this-procedure,"tableio-target", output char-hdl).
...
/* ***************************  Main Block  *************************** */
  ...
  {methods/setButton.i Btn-Save "Update"} /* added by script _admTransPanels.p on 04.18.2017 @ 11:38:28 am */
  {methods/setButton.i Btn-Add "Add"} /* added by script _admTransPanels.p on 04.18.2017 @ 11:38:28 am */
  {methods/setButton.i Btn-Delete "Delete"} /* added by script _admTransPanels.p on 04.18.2017 @ 11:38:28 am */
