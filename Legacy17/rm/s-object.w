...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BUTTON-3 s-object
ON CHOOSE OF BUTTON-3 IN FRAME F-Main /* Post */
DO:
  message "Here I am" avail rm-rcpt view-as alert-box.
END.
