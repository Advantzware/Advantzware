...
DEFINE BUTTON btn-add-2  NO-CONVERT-3D-COLORS
     LABEL "" 
     SIZE 9 BY 1.29.
...
DEFINE FRAME Panel-Frame
     ...
     btn-add-2 AT ROW 1.29 COL 56.2 WIDGET-ID 2
...
/* SETTINGS FOR BUTTON btn-add-2 IN FRAME Panel-Frame
   NO-ENABLE                                                            */
ASSIGN 
       btn-add-2:HIDDEN IN FRAME Panel-Frame           = TRUE.
...
DO:
  ...
  {Advantzware/WinKit/winkit-panel-triggerend.i} /* added by script _admPanels.p on 04.18.2017 @ 11:38:21 am */
END.
...
&Scoped-define SELF-NAME btn-add-2
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn-add-2 C-WIn
ON CHOOSE OF btn-add-2 IN FRAME Panel-Frame
DO:
   add-active = yes.
...
/* ***************************  Main Block  *************************** */
  ...
  {methods/setButton.i Btn-Copy "Copy"} /* added by script _admTransPanels.p on 04.18.2017 @ 11:38:29 am */
