...
&Scoped-Define ENABLED-OBJECTS as-of-date begin_slm end_slm begin_cust-no ~
...
aged-days-1 aged-days-2 aged-days-3 aged-days-4 rd_show rd_price rd_show2 ~
rd_sort tb_cust-whse tb_cost tb_break tb_neg-sale tb_curr tb_val-cust ~
tb_custpart tb_last-ship-date rd-dest lv-ornt lines-per-page lv-font-no ~
td-show-parm tb_excel tb_runExcel fi_file btn-ok btn-cancel RECT-6 RECT-7 
&Scoped-Define DISPLAYED-OBJECTS as-of-date begin_slm end_slm begin_cust-no ~
end_cust-no begin_i-no end_i-no begin_job-no begin_job-no2 end_job-no ~
end_job-no2 begin_whse end_whse begin_loc-bin end_loc-bin list_class ~
aged-days-1 aged-days-2 aged-days-3 aged-days-4 lbl_show rd_show rd_price ~
lbl_show2 rd_show2 lbl_sort rd_sort tb_cust-whse tb_cost tb_break ~
tb_neg-sale tb_curr tb_val-cust tb_custpart tb_last-ship-date rd-dest ~
...
DEFINE FRAME FRAME-A
     ...
     begin_i-no AT ROW 4.1 COL 28 COLON-ALIGNED HELP
          "Enter Beginning Order Number"
     end_i-no AT ROW 3.86 COL 68 COLON-ALIGNED HELP
          "Enter Ending Item Number"
     begin_job-no AT ROW 5.05 COL 28 COLON-ALIGNED HELP
          "Enter Beginning Job Number"
     begin_job-no2 AT ROW 5.05 COL 41 COLON-ALIGNED HELP
          "Enter Beginning Job Number"
     ...
     end_whse AT ROW 5.76 COL 68.2 COLON-ALIGNED HELP
          "Enter Ending Warehouse"
     begin_loc-bin AT ROW 6.95 COL 28 COLON-ALIGNED HELP
          "Enter Beginning Warehouse"
     end_loc-bin AT ROW 6.76 COL 68.2 COLON-ALIGNED HELP
          "Enter Beginning Warehouse" WIDGET-ID 18
     list_class AT ROW 8.05 COL 28 COLON-ALIGNED HELP
          "Enter Beginning Inventory Class"
     aged-days-1 AT ROW 9.62 COL 25 COLON-ALIGNED
     aged-days-2 AT ROW 9.62 COL 43 COLON-ALIGNED
     aged-days-3 AT ROW 9.62 COL 60 COLON-ALIGNED
     aged-days-4 AT ROW 9.62 COL 77 COLON-ALIGNED
     lbl_show AT ROW 10.57 COL 19 COLON-ALIGNED NO-LABEL
     rd_show AT ROW 10.57 COL 28 NO-LABEL
     rd_price AT ROW 10.57 COL 55.2 NO-LABEL WIDGET-ID 6
     lbl_show2 AT ROW 11.76 COL 19 COLON-ALIGNED NO-LABEL
     rd_show2 AT ROW 11.76 COL 28 NO-LABEL
     lbl_sort AT ROW 12.95 COL 19 COLON-ALIGNED NO-LABEL
     rd_sort AT ROW 12.95 COL 28 NO-LABEL WIDGET-ID 14
     tb_cust-whse AT ROW 13.91 COL 6
     tb_cost AT ROW 13.95 COL 49
     tb_break AT ROW 14.71 COL 6
     tb_neg-sale AT ROW 14.67 COL 49
     tb_curr AT ROW 15.57 COL 6
     tb_val-cust AT ROW 15.48 COL 49
     tb_custpart AT ROW 16.24 COL 6
     tb_last-ship-date AT ROW 16.24 COL 49
     rd-dest AT ROW 18.52 COL 5 NO-LABEL
     lv-ornt AT ROW 18.76 COL 31 NO-LABEL
     lines-per-page AT ROW 18.76 COL 84 COLON-ALIGNED
     ...
     tb_excel AT ROW 23.38 COL 66 RIGHT-ALIGNED
     tb_runExcel AT ROW 23.38 COL 91 RIGHT-ALIGNED
     fi_file AT ROW 24.38 COL 44 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 25.76 COL 22
     btn-cancel AT ROW 25.76 COL 58
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 17.62 COL 3
     "(Blank for all Inventory Classes)" VIEW-AS TEXT
          SIZE 30.8 BY .62 AT ROW 9.1 COL 39
...
/* security check need {methods/prgsecur.i} in definition section */
  ...
  DO WITH FRAME {&FRAME-NAME}:
    ...
    {methods/setButton.i btn-cancel "Cancel"} /* added by script _nonAdm1Images2.p on 04.18.2017 @ 11:37:23 am */
    {methods/setButton.i btn-ok "OK"} /* added by script _nonAdm1Images2.p on 04.18.2017 @ 11:37:23 am */
    {custom/usrprint.i}
...
------------------------------------------------------------------------------*/
  DISPLAY as-of-date begin_slm end_slm begin_cust-no end_cust-no begin_i-no 
          end_i-no begin_job-no begin_job-no2 end_job-no end_job-no2 begin_whse 
          end_whse begin_loc-bin end_loc-bin list_class aged-days-1 aged-days-2 
          aged-days-3 aged-days-4 lbl_show rd_show rd_price lbl_show2 rd_show2 
          lbl_sort rd_sort tb_cust-whse tb_cost tb_break tb_neg-sale tb_curr 
          tb_val-cust tb_custpart tb_last-ship-date rd-dest lv-ornt 
          lines-per-page lv-font-no lv-font-name td-show-parm tb_excel 
          tb_runExcel fi_file 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE as-of-date begin_slm end_slm begin_cust-no end_cust-no begin_i-no 
         end_i-no begin_job-no begin_job-no2 end_job-no end_job-no2 begin_whse 
         end_whse begin_loc-bin end_loc-bin list_class aged-days-1 aged-days-2 
...
IF v-cost THEN
  ASSIGN
   ...
   v-label1[6] = "-------------"
   v-label1[7] = "             "
   v-label1[8] = IF rd_show2 BEGINS "Com" THEN "Comments"
                                          ELSE "Days Old"
   v-label1[9] = "--------     "
...
ELSE
  ASSIGN
   ...
   v-label1[2]  = "             "
   v-label1[3]  = "      Value $"
   v-label1[4]  = IF rd_show2 BEGINS "Com" THEN "Comments     "
                                          ELSE "Days Old     "
   v-label1[5]  = "-------------"
   v-label1[6]  = "--------     "
   v-label1[7]  = ""
...
FOR EACH tt-file.
    IF tt-file.tt-cust = "" THEN DO:
        ...
        IF AVAIL cust THEN
            ASSIGN tt-file.tt-cust = cust.cust-no tt-file.tt-sman = s-man[1].
    END.
END.
...
/*    AND (tt-qohi[1] + tt-qohi[2] + tt-qohi[3] + tt-qohi[4] + tt-qohi[5]) GT
  ...
  ASSIGN
   ...
   v-shipdt = IF AVAIL fg-rcpth AND v-sdate THEN STRING(fg-rcpth.trans-date) 
    ...
    /* Test of reducing negative quantities */
    DO v-q = 1 TO 5:
