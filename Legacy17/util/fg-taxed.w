...
&Scoped-Define ENABLED-OBJECTS RECT-17 tb_taxable btn-process btn-cancel 
&Scoped-Define DISPLAYED-OBJECTS tb_taxable 
...
DEFINE VARIABLE tb_taxable AS LOGICAL INITIAL yes 
     LABEL "Taxable?" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME FRAME-A
     tb_taxable AT ROW 7.91 COL 37
     btn-process AT ROW 11.95 COL 21
     btn-cancel AT ROW 11.95 COL 52
     "Selection Parameters" VIEW-AS TEXT
          SIZE 21 BY .62 AT ROW 5.29 COL 5
     "Set default value for all FGs" VIEW-AS TEXT
          SIZE 27 BY 1 AT ROW 6.71 COL 29
     "" VIEW-AS TEXT
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Set Taxable field for all FGs"
         HEIGHT             = 13.62
         WIDTH              = 90.2
         MAX-HEIGHT         = 19.76
         MAX-WIDTH          = 98.2
...
ON END-ERROR OF C-Win /* Set Taxable field for all FGs */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Set Taxable field for all FGs */
DO:
...
&Scoped-define SELF-NAME tb_taxable
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tb_taxable C-Win
ON VALUE-CHANGED OF tb_taxable IN FRAME FRAME-A /* Taxable? */
DO:
  ASSIGN {&self-name}.
END.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-17 tb_taxable btn-process btn-cancel 
      WITH FRAME FRAME-A IN WINDOW C-Win.
...
DEF VAR play AS CHAR NO-UNDO.
DEF VAR xyz  AS INT NO-UNDO.
