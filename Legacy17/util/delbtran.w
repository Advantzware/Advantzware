...
DEFINE FRAME FRAME-A
     btn-process AT ROW 7.76 COL 21
     btn-cancel AT ROW 7.76 COL 53
     "" VIEW-AS TEXT
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Delete I-U-2 Blank FG Code Transfers"
         HEIGHT             = 11.71
         WIDTH              = 90.2
         MAX-HEIGHT         = 19.76
         MAX-WIDTH          = 98.2
...
ON END-ERROR OF C-Win /* Delete I-U-2 Blank FG Code Transfers */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Delete I-U-2 Blank FG Code Transfers */
DO:
