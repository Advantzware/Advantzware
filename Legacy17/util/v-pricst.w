...
&Scoped-Define ENABLED-FIELDS itemfg.i-name itemfg.sell-price ~
itemfg.sell-uom itemfg.case-count 
&Scoped-define ENABLED-TABLES itemfg
&Scoped-define FIRST-ENABLED-TABLE itemfg
&Scoped-Define ENABLED-OBJECTS RECT-5 
&Scoped-Define DISPLAYED-FIELDS itemfg.i-no itemfg.i-name itemfg.sell-price ~
itemfg.sell-uom itemfg.case-count 
...
DEFINE FRAME F-Main
     itemfg.i-no AT ROW 1.48 COL 19 COLON-ALIGNED
          LABEL "Item No"
          VIEW-AS FILL-IN 
          SIZE 17 BY 1
     itemfg.i-name AT ROW 1.48 COL 48 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 32 BY 1
     itemfg.sell-price AT ROW 3.14 COL 19 COLON-ALIGNED
          LABEL "Price"
          VIEW-AS FILL-IN 
          SIZE 16.4 BY 1
     itemfg.sell-uom AT ROW 3.14 COL 48 COLON-ALIGNED
          LABEL "UOM"
          VIEW-AS FILL-IN 
          SIZE 5.6 BY 1
     itemfg.case-count AT ROW 3.14 COL 73 COLON-ALIGNED
