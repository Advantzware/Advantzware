...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Fix Price Matrix Effective Dates"
         HEIGHT             = 11
         WIDTH              = 90.2
         MAX-HEIGHT         = 19.76
         MAX-WIDTH          = 98.2
...
ON END-ERROR OF C-Win /* Fix Price Matrix Effective Dates */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Fix Price Matrix Effective Dates */
DO:
...
FOR EACH bf-oe-prmtx
    ...
    END.
    ELSE DO:
        IF (cRefTableDate EQ "" OR cRefTableDate EQ "01/01/001") 
            AND (CINoDate NE "" AND cINoDate NE "00010101") THEN DO:
            dtEffectiveDate = ConvertINoToDate(cINoDate).
            cRefTableDate = STRING(dtEffectiveDate,"99/99/9999").
        END.
        ELSE IF (cReftableDate NE "" AND cReftableDate NE "01/01/001")
            AND (cINoDate EQ "" OR cINODate EQ "00010101") THEN DO:
        ...
        END.
        ELSE DO:
            cRefTableDate = STRING(TODAY,"99/99/9999").
