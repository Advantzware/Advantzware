...
&Scoped-Define ENABLED-OBJECTS lv-file rd-type Btn_OK Btn_Cancel 
&Scoped-Define DISPLAYED-OBJECTS lv-file rd-type 
...
DEFINE VARIABLE rd-type AS CHARACTER 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "Folding", "1",
"Corrugated", "2",
"Both", "B"
     SIZE 47 BY 1.43 NO-UNDO.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME Dialog-Frame
     lv-file AT ROW 2.91 COL 6 COLON-ALIGNED NO-LABEL
     rd-type AT ROW 4.33 COL 18 NO-LABEL
     ...
     "Dump for:" VIEW-AS TEXT
          SIZE 12 BY .71 AT ROW 4.57 COL 5
          FONT 6
     SPACE(55.19) SKIP(7.00)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Dump Style File"
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Dump Style File */
DO:
...
DO:
    ...
    FOR each style NO-LOCK WHERE style.industry = rd-type OR rd-type = "B".
      /*
       ...
       */
       ...
       FOR each reftable where reftable.reftable = "STYFLU" 
                          ...
                          /* and reftable.loc = ip-flute
                           ...
                           no-lock.
           EXPORT STREAM st-line reftable.
       END.
    END.
...
------------------------------------------------------------------------------*/
  DISPLAY lv-file rd-type 
      WITH FRAME Dialog-Frame.
  ENABLE lv-file rd-type Btn_OK Btn_Cancel 
      WITH FRAME Dialog-Frame.
