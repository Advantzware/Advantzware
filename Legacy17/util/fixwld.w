...
DEFINE FRAME FRAME-A
     ...
     "" VIEW-AS TEXT
          ...
          BGCOLOR 11 
     "This procedure will reset Sheet Width and Length" VIEW-AS TEXT
          SIZE 58 BY 1 AT ROW 6.24 COL 17
          FONT 6
     "and Roll Width to zero for all estimated RMs" VIEW-AS TEXT
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Clear Estimated RM Dimensions"
         HEIGHT             = 11.86
         WIDTH              = 90.2
         MAX-HEIGHT         = 19.76
         MAX-WIDTH          = 98.2
...
ON END-ERROR OF C-Win /* Clear Estimated RM Dimensions */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Clear Estimated RM Dimensions */
DO:
