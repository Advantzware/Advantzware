...
def new shared var cocode as cha.
def new shared var locode as cha.
...
DEFINE FRAME FRAME-B
     "Please LOG ALL USERS OFF the system before continuing!" VIEW-AS TEXT
          SIZE 72 BY .95 AT ROW 2.19 COL 9
...
ON END-ERROR OF C-Win /* Purge Report File */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Purge Report File */
DO:
