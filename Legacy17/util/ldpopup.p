...
DEF TEMP-TABLE tt-menu LIKE mnu-item.
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Load Popup Menu */
DO:
...
DO:
    ...
    ASSIGN lv-file.
    /* save current data */
    OUTPUT TO value("c:\tmp\mnu-item.d" + string(TIME)) .
    ...
    REPEAT:
        ...
        FIND FIRST mnu-item WHERE mnu-item.user-initials = tt-menu.user-initials
                              AND mnu-item.menu-num = tt-menu.menu-num
                              NO-ERROR.
        IF NOT AVAIL mnu-item THEN DO:
           CREATE mnu-item.
        END.
        BUFFER-COPY tt-menu TO mnu-item.
    END.
    /*
    lv-file2 = lv-file.
    ...
    */
    ...
    MESSAGE "Popup Menu Loading is completed." VIEW-AS ALERT-BOX.
