...
tb_freight tb_fin-chg rd-dest lv-ornt lines-per-page lv-font-no ~
...
DEFINE FRAME FRAME-A
     ...
     rd-dest AT ROW 14.57 COL 8 NO-LABEL
     ...
     td-show-parm AT ROW 19.57 COL 30
     tb_excel AT ROW 20.76 COL 63 RIGHT-ALIGNED
     tb_runExcel AT ROW 20.76 COL 87 RIGHT-ALIGNED
     fi_file AT ROW 21.71 COL 41 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 23.62 COL 23
     btn-cancel AT ROW 23.62 COL 56
...
------------------------------------------------------------------------------*/
  DISPLAY tb_cust-list begin_cust-no end_cust-no begin_fg-cat end_fg-cat 
          ...
          lbl_cost rd_cost rs_sort tb_prep tb_freight tb_fin-chg rd-dest lv-ornt 
  ...
  ENABLE RECT-6 RECT-7 tb_cust-list btnCustList begin_cust-no end_cust-no 
         ...
         tb_fin-chg rd-dest lv-ornt lines-per-page lv-font-no td-show-parm 
