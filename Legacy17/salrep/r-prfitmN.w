...
begin_inv-date end_inv-date tb_prep tb_fin-chg rd_sort sl_avail sl_selected ~
...
lbl_sort-2 tb_prep tb_fin-chg lbl_sort rd_sort sl_avail sl_selected rd-dest ~
...
DEFINE FRAME FRAME-A
     ...
     begin_cust-no AT ROW 3.05 COL 32.6 COLON-ALIGNED HELP
          "Enter Beginning Customer Number"
     end_cust-no AT ROW 3.05 COL 75.6 COLON-ALIGNED HELP
          "Enter Ending Customer Number"
     begin_fg-cat AT ROW 4 COL 32.6 COLON-ALIGNED HELP
          "Enter Beginning Product Category"
     end_fg-cat AT ROW 4 COL 75.6 COLON-ALIGNED HELP
          "Enter Ending Product Category"
     begin_i-no AT ROW 4.95 COL 32.6 COLON-ALIGNED HELP
          "Enter Beginning Order Number"
     end_i-no AT ROW 4.95 COL 75.6 COLON-ALIGNED HELP
          "Enter Ending Item Number"
     begin_inv-date AT ROW 5.91 COL 32.6 COLON-ALIGNED
     end_inv-date AT ROW 5.91 COL 75.6 COLON-ALIGNED HELP
          "Enter Ending Due Date"
     lbl_sort-2 AT ROW 7.48 COL 17.6 NO-LABEL WIDGET-ID 22
     tb_prep AT ROW 7.52 COL 34
     tb_fin-chg AT ROW 7.52 COL 61.4
     lbl_sort AT ROW 8.57 COL 17.6 NO-LABEL
     rd_sort AT ROW 8.62 COL 34 NO-LABEL
     sl_avail AT ROW 10.71 COL 6.2 NO-LABEL WIDGET-ID 26
     sl_selected AT ROW 10.76 COL 67.8 NO-LABEL WIDGET-ID 28
     Btn_Def AT ROW 10.86 COL 46.2 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 56
     Btn_Add AT ROW 11.86 COL 46.2 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 32
     Btn_Remove AT ROW 12.86 COL 46.2 HELP
          "Remove Selected Table from Tables to Audit" WIDGET-ID 34
     btn_Up AT ROW 13.91 COL 46.2 WIDGET-ID 40
     btn_down AT ROW 14.91 COL 46.2 WIDGET-ID 42
     rd-dest AT ROW 17.71 COL 12.8 NO-LABEL
     lv-ornt AT ROW 17.81 COL 40.2 NO-LABEL
     lines-per-page AT ROW 17.81 COL 93.6 COLON-ALIGNED
     lv-font-no AT ROW 19.19 COL 43.6 COLON-ALIGNED
     lv-font-name AT ROW 20.14 COL 37.6 COLON-ALIGNED NO-LABEL
     td-show-parm AT ROW 21.67 COL 39.6
     tb_excel AT ROW 22.76 COL 77 RIGHT-ALIGNED
     tb_runExcel AT ROW 22.76 COL 101 RIGHT-ALIGNED
     fi_file AT ROW 23.86 COL 54.8 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 25.62 COL 31.6
     btn-cancel AT ROW 25.62 COL 69.6
     "Selected Columns(In Display Order)" VIEW-AS TEXT
          SIZE 34 BY .62 AT ROW 9.95 COL 68.2 WIDGET-ID 44
     "Available Columns" VIEW-AS TEXT
          SIZE 29 BY .62 AT ROW 10 COL 7 WIDGET-ID 38
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 16.76 COL 5.6
     "Selection Parameters" VIEW-AS TEXT
          SIZE 21 BY .71 AT ROW 1.14 COL 5
          BGCOLOR 2 
     RECT-6 AT ROW 16.48 COL 2 WIDGET-ID 16
...
------------------------------------------------------------------------------*/
  DISPLAY tb_cust-list begin_cust-no end_cust-no begin_fg-cat end_fg-cat 
          ...
          tb_fin-chg lbl_sort rd_sort sl_avail sl_selected rd-dest lv-ornt 
  ...
  ENABLE RECT-6 RECT-7 tb_cust-list btnCustList begin_cust-no end_cust-no 
         ...
         end_inv-date tb_prep tb_fin-chg rd_sort sl_avail sl_selected Btn_Def 
