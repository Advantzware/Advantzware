...
DEF TEMP-TABLE tt-report NO-UNDO LIKE report
    FIELD dec1 AS DEC FIELD dec2 AS DEC FIELD dec3 AS DEC FIELD date1 AS DATE.
...
ASSIGN cTextListToSelect = "Customer,Name,Labels,Period1,Period2,Period3,Period4,Period5, "  +
...
{sys/inc/ttRptSel.i}
ASSIGN cTextListToDefault  = "Customer,Name,Labels,Period1,Period2,Period3,Period4,Period5, "  +
                                               "Period6,Period7,Period8,Period9,Period10,Period11,Period12" .
...
DEFINE VARIABLE fi_file AS CHARACTER FORMAT "X(30)" INITIAL "c:~\tmp~\r-yrtoyr.csv" 
...
DEFINE FRAME FRAME-A
     ...
     sl_avail AT ROW 11.86 COL 4.4 NO-LABEL WIDGET-ID 26
     Btn_Def AT ROW 11.86 COL 40.4 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 56
     sl_selected AT ROW 11.86 COL 59.8 NO-LABEL WIDGET-ID 28
     ...
     rd-dest AT ROW 18.43 COL 5 NO-LABEL
     lv-ornt AT ROW 18.91 COL 31 NO-LABEL
     lines-per-page AT ROW 18.91 COL 84 COLON-ALIGNED
     lv-font-no AT ROW 20.81 COL 34 COLON-ALIGNED
     lv-font-name AT ROW 21.76 COL 28 COLON-ALIGNED NO-LABEL
     td-show-parm AT ROW 23.91 COL 30
     tb_excel AT ROW 24.95 COL 49.8 RIGHT-ALIGNED
     tb_runExcel AT ROW 24.95 COL 70.8 RIGHT-ALIGNED
     fi_file AT ROW 25.76 COL 27.8 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 27.67 COL 19
     btn-cancel AT ROW 27.67 COL 57
     "(Enter 99 For YTD)" VIEW-AS TEXT
          SIZE 22 BY 1 AT ROW 3.62 COL 51
          FGCOLOR 9 
     "Selected Columns(In Display Order)" VIEW-AS TEXT
          SIZE 34 BY .62 AT ROW 11.14 COL 59.8 WIDGET-ID 44
     "Available Columns" VIEW-AS TEXT
          SIZE 29 BY .62 AT ROW 11.14 COL 5.2 WIDGET-ID 38
     "Selection Parameters" VIEW-AS TEXT
          SIZE 21 BY .71 AT ROW 1.24 COL 5
          BGCOLOR 2 
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 17.48 COL 3
...
/* security check need {methods/prgsecur.i} in definition section */
  ...
  FIND FIRST period NO-LOCK
      ...
      NO-ERROR.  
  IF AVAIL period THEN srt-period = period.pnum.
...
DEF VAR v-amt1    AS   DEC.
DEF VAR v-slsm    LIKE ar-invl.sman  EXTENT 1 NO-UNDO.
DEF VAR v-slsp    LIKE ar-invl.s-pct EXTENT 1 NO-UNDO.

DEF VAR v-amt     AS   DEC  EXTENT 26 NO-UNDO.
DEF VAR excel-amt AS   DEC  EXTENT 26 NO-UNDO.
DEF VAR v-tot     AS   DEC  EXTENT 26 NO-UNDO.
DEF VAR v-pct     AS   DEC  EXTENT 13 NO-UNDO.
DEF VAR excel-pct AS   DEC  EXTENT 13 NO-UNDO.
DEF VAR v-label   AS   CHAR EXTENT 26       FORMAT "x(12)" NO-UNDO.
...
DEF VAR lv-ltype  AS   CHAR EXTENT 6 NO-UNDO.
