...
DEFINE FRAME FRAME-A
     ...
     begin_cust-no AT ROW 3.19 COL 29 COLON-ALIGNED HELP
          "Enter Beginning Customer Number"
     end_cust-no AT ROW 3.19 COL 72 COLON-ALIGNED HELP
          "Enter Ending Customer Number"
     begin_fg-cat AT ROW 4.14 COL 29 COLON-ALIGNED HELP
          "Enter Beginning Product Category"
     end_fg-cat AT ROW 4.14 COL 72 COLON-ALIGNED HELP
          "Enter Ending Product Category"
     begin_i-no AT ROW 5.1 COL 29 COLON-ALIGNED HELP
          "Enter Beginning Order Number"
     end_i-no AT ROW 5.1 COL 72 COLON-ALIGNED HELP
     ...
     begin_inv-date AT ROW 7.1 COL 29 COLON-ALIGNED
     end_inv-date AT ROW 7.1 COL 72 COLON-ALIGNED HELP
          "Enter Ending Due Date"
     lbl_cost AT ROW 8.43 COL 21 COLON-ALIGNED NO-LABEL
     rd_cost AT ROW 8.43 COL 38 NO-LABEL
     lbl_sort AT ROW 9.62 COL 26 COLON-ALIGNED NO-LABEL
     rd_sort AT ROW 9.62 COL 38 NO-LABEL
     tb_prep AT ROW 10.81 COL 38
     tb_fin-chg AT ROW 11.76 COL 38
     ...
     tb_excel AT ROW 20.57 COL 50.2 RIGHT-ALIGNED
     tb_runExcel AT ROW 20.57 COL 71.2 RIGHT-ALIGNED
     fi_file AT ROW 21.38 COL 28.2 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 23.33 COL 28
...
------------------------------------------------------------------------------*/
  DISPLAY tb_cust-list begin_cust-no end_cust-no begin_fg-cat end_fg-cat 
          ...
          lbl_cost rd_cost lbl_sort rd_sort tb_prep tb_fin-chg rd-dest lv-ornt 
  ...
  ENABLE RECT-6 RECT-7 tb_cust-list btnCustList begin_cust-no end_cust-no 
         begin_fg-cat end_fg-cat begin_i-no end_i-no begin_slsmn end_slsmn 
         begin_inv-date end_inv-date rd_cost rd_sort tb_prep tb_fin-chg rd-dest 
