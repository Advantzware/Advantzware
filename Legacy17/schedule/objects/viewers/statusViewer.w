...
DEFINE VARIABLE h_pending AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Job Status Checkoff Viewer - Scheduler"
         HEIGHT             = 22.52
         WIDTH              = 150
         MAX-HEIGHT         = 22.52
         MAX-WIDTH          = 150
...
ON END-ERROR OF W-Win /* Job Status Checkoff Viewer - Scheduler */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Job Status Checkoff Viewer - Scheduler */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-RESIZED OF W-Win /* Job Status Checkoff Viewer - Scheduler */
DO:
  RUN winReSize.
END.
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
           ...
           &ENDIF
             ...
             INPUT  '':U ,
             OUTPUT h_pending ).
       RUN set-position IN h_pending ( 1.00 , 1.00 ) NO-ERROR.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE closePending W-Win 
...
------------------------------------------------------------------------------*/
  ...
  sbStatus = findProgram('{&viewers}/',ID,'/statusBrowse.w').
...
------------------------------------------------------------------------------*/
  ...
  RUN select-page (0).
  RUN passHandle IN h_Pending (THIS-PROCEDURE,ipHandle).
...
------------------------------------------------------------------------------*/
  ...
  RUN setSize IN h_Pending ({&WINDOW-NAME}:HEIGHT-PIXELS,{&WINDOW-NAME}:WIDTH-PIXELS).
