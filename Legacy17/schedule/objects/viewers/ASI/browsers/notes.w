...
&Scoped-define FIELDS-IN-QUERY-br_table notes.note_date ~
STRING(notes.note_time,'HH:MM:SSam') @ noteTime notes.note_title ~
...
&Scoped-Define DISPLAYED-FIELDS notes.note_text 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      notes.note_date COLUMN-LABEL "Date" FORMAT "99.99.9999":U
      STRING(notes.note_time,'HH:MM:SSam') @ noteTime COLUMN-LABEL "Time" FORMAT "X(10)":U
            WIDTH 10.8
      notes.note_title COLUMN-LABEL "Title" FORMAT "X(30)":U
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 88 BY 7.43 ROW-HEIGHT-CHARS .52.
...
DEFINE FRAME F-Main
     ...
     notes.note_text AT ROW 1 COL 90 NO-LABEL
...
ASSIGN 
       notes.note_text:READ-ONLY IN FRAME F-Main        = TRUE.
...
DO:
  ...
  DISPLAY notes.note_text WITH FRAME {&FRAME-NAME}.
END.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE notes.note_text WITH FRAME {&FRAME-NAME}.
