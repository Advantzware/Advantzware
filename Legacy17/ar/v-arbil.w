...
{Advantzware\WinKit\admViewersUsing.i} /* added by script _admViewers.p on 04.07.2017 @  2:08:08 pm */
...
&Scoped-Define ENABLED-FIELDS ar-inv.bill-i[1] ar-inv.bill-i[2] ~
ar-inv.bill-i[3] ar-inv.bill-i[4] 
&Scoped-define ENABLED-TABLES ar-inv
&Scoped-define FIRST-ENABLED-TABLE ar-inv
&Scoped-Define ENABLED-OBJECTS RECT-42 
&Scoped-Define DISPLAYED-FIELDS ar-inv.bill-i[1] ar-inv.bill-i[2] ~
ar-inv.bill-i[3] ar-inv.bill-i[4] 
...
DEFINE FRAME F-Main
     ar-inv.bill-i[1] AT ROW 1.95 COL 4 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 99 BY 1
     ar-inv.bill-i[2] AT ROW 2.91 COL 4 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 99 BY 1
     ar-inv.bill-i[3] AT ROW 4.1 COL 4 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 99 BY 1
     ar-inv.bill-i[4] AT ROW 5.29 COL 4 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 99 BY 1
     "Bill Instructions" VIEW-AS TEXT
          SIZE 16 BY .62 AT ROW 1.24 COL 3
     RECT-42 AT ROW 1.48 COL 1.6
