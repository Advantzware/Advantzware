...
ar-inv.cust-name ar-inv.gross ar-inv.paid ar-inv.due ar-inv.due-date ~
ar-inv.inv-date ar-inv.ship-id ar-inv.x-no 
&Scoped-define ENABLED-FIELDS-IN-QUERY-Browser-Table 
&Scoped-define QUERY-STRING-Browser-Table FOR EACH ar-inv WHERE ~{&KEY-PHRASE} ~
      AND ar-inv.company = g_company and ~
ar-inv.posted = yes NO-LOCK ~
    ~{&SORTBY-PHRASE}
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      ...
      ar-inv.paid COLUMN-LABEL "Paid!Amount" FORMAT "->,>>>,>>9.99":U
      ar-inv.due FORMAT "->>,>>>,>>9.99":U
      ar-inv.due-date FORMAT "99/99/9999":U
      ar-inv.inv-date FORMAT "99/99/9999":U
      ar-inv.ship-id FORMAT "x(8)":U
      ar-inv.x-no FORMAT ">>>>>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE Browser-Table
     ...
     _TblOptList       = "USED"
     _Where[1]         = "ASI.ar-inv.company = g_company and
ar-inv.posted = yes"
     _FldNameList[1]   > ASI.ar-inv.inv-no
"ar-inv.inv-no" "Invoice#" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[2]   = ASI.ar-inv.cust-no
     _FldNameList[3]   = ASI.ar-inv.cust-name
     _FldNameList[4]   > ASI.ar-inv.gross
"ar-inv.gross" "Invoice!Amount" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[5]   > ASI.ar-inv.paid
"ar-inv.paid" "Paid!Amount" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[6]   = ASI.ar-inv.due
     _FldNameList[7]   = ASI.ar-inv.due-date
     _FldNameList[8]   = ASI.ar-inv.inv-date
     _FldNameList[9]   = ASI.ar-inv.ship-id
     _FldNameList[10]   = ASI.ar-inv.x-no
