       ...
       find first stax {sys/ref/stax1W.i}
        ...
        for each ar-invl no-lock where ar-invl.x-no = ar-inv.x-no:
          ...
          assign v-case-line = ""
           ...
           /* gdm - 08050902 */
           IF AVAIL ar-invl THEN ASSIGN v-cust-po = ar-invl.po-no.
           ...
           DO:
              ...
              IF ar-invl.bol-no > 0 THEN DO:
                 PUT STRING(ar-invl.bol-no) AT 9 SKIP.
                 v-printline = v-printline + 1.
              END.
              ...
              do v = 1 to 2:
                ...
                IF v-part-info NE "" OR v-cust-po <> "" THEN DO:
                   IF v = 1 AND v-cust-po <> "" THEN
                     put space(25) v-cust-po format "x(15)" SPACE(1) v-part-info SKIP.
                   ELSE
