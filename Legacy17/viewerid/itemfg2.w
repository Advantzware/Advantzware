...
&Scoped-Define ENABLED-FIELDS itemfg.q-onh 
...
&Scoped-define ADM-CREATE-FIELDS itemfg.i-no itemfg.i-name itemfg.i-dscr 
...
DEFINE FRAME F-Main
     itemfg.i-no AT ROW 1.71 COL 12 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 29 BY 1
     itemfg.i-name AT ROW 1.71 COL 41 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 38 BY 1
     itemfg.i-dscr AT ROW 1.71 COL 80 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 38 BY 1
     itemfg.q-onh AT ROW 2.91 COL 38 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
...
/* SETTINGS FOR FILL-IN itemfg.i-dscr IN FRAME F-Main
   NO-ENABLE 1                                                          */
