...
DEFINE FRAME F-Main
     sman.sman AT ROW 1.24 COL 35 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 8 BY 1
          BGCOLOR 15 
     sman.sname AT ROW 1.24 COL 43 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 26 BY 1
          BGCOLOR 15 
     sman.commbasis AT ROW 1.24 COL 77 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 3.2 BY 1
          BGCOLOR 15 
     sman.netpct AT ROW 1.24 COL 89 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9.2 BY 1
          BGCOLOR 15 
     sman.scomm AT ROW 1.24 COL 114 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9.2 BY 1
          BGCOLOR 15 
     "Reference Information" VIEW-AS TEXT
          SIZE 22 BY .62 AT ROW 1.48 COL 2
          FONT 1
...
/* SETTINGS FOR FILL-IN sman.commbasis IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN sman.netpct IN FRAME F-Main
   NO-ENABLE                                                            */
