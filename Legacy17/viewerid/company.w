...
&Scoped-Define DISPLAYED-FIELDS company.company company.name 
...
DEFINE FRAME F-Main
     company.company AT ROW 1.71 COL 12 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 5.6 BY 1
          BGCOLOR 15 FONT 4
     company.name AT ROW 1.71 COL 38 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 38 BY 1
          BGCOLOR 15 FONT 4
...
/* SETTINGS FOR FILL-IN company.company IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN company.name IN FRAME F-Main
   NO-ENABLE                                                            */
