/* parmfile.p - generated 12/02/2005 - 16:51:17 by NoSweat */
...
DEFINE WORK-TABLE ttbl_parmfile1 NO-UNDO LIKE parmfile.
DEFINE WORK-TABLE ttbl_parmfile2 NO-UNDO LIKE parmfile.

CREATE ttbl_parmfile1.
IMPORT STREAM s_audit_file ttbl_parmfile1.
CREATE ttbl_parmfile2.
IF action = "UPDATE" THEN
IMPORT STREAM s_audit_file ttbl_parmfile2.
...
IF NOT v_field_changed OR ttbl_parmfile1.parmfile NE ttbl_parmfile2.parmfile OR action NE "UPDATE" THEN
DO:
  PUT STREAM s-audit-rpt UNFORMATTED "Parameter File: " AT 3 ttbl_parmfile1.parmfile " (parmfile)".
  IF action = "UPDATE" THEN
  DO:
    IF ttbl_parmfile1.parmfile NE ttbl_parmfile2.parmfile THEN
    PUT STREAM s-audit-rpt UNFORMATTED "*" AT 1.
    PUT STREAM s-audit-rpt UNFORMATTED "Parameter File: " AT 3 ttbl_parmfile2.parmfile.
  END.
END.
IF v_show_index THEN
DO:
  PUT STREAM s-audit-rpt UNFORMATTED "Index Fields - Label: Value (database field-name)" AT 5.
  PUT STREAM s-audit-rpt UNFORMATTED "Parameter File: " AT 7.
  IF action = "UPDATE" THEN
  PUT STREAM s-audit-rpt UNFORMATTED ttbl_parmfile2.parmfile " (parmfile)".
  ELSE
  PUT STREAM s-audit-rpt UNFORMATTED ttbl_parmfile1.parmfile " (parmfile)".
END.
