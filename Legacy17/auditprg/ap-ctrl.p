/* ap-ctrl.p - generated 12/09/2005 - 15:42:37 by NoSweat */
...
END.
DO i = 1 TO 5:
IF NOT v_field_changed OR ttbl_ap-ctrl1.rate-var-act[i] NE ttbl_ap-ctrl2.rate-var-act[i] OR action NE "UPDATE" THEN
DO:
  PUT STREAM s-audit-rpt UNFORMATTED "Rate Var. Account[" AT 3 i "]: " ttbl_ap-ctrl1.rate-var-act[i] " (rate-var-act[" i "])".
  IF action = "UPDATE" THEN
  DO:
    IF ttbl_ap-ctrl1.rate-var-act[i] NE ttbl_ap-ctrl2.rate-var-act[i] THEN
    PUT STREAM s-audit-rpt UNFORMATTED "*" AT 1.
    PUT STREAM s-audit-rpt UNFORMATTED "Rate Var. Account[" AT 3 i "]: " ttbl_ap-ctrl2.rate-var-act[i].
  END.
END.
END.
