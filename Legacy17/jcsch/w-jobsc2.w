...
DEF INPUT PARAMETER ip-mach-code AS cha NO-UNDO.
...
/* ***************************  Main Block  *************************** */
FIND mach WHERE mach.company = g_company
            AND mach.m-code = ip-mach-code NO-LOCK.
RUN SET-ATTRIBUTE-list ("Display-machine = YES").
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-jobsch ).
       RUN set-position IN h_b-jobsch ( 4.81 , 15.00 ) NO-ERROR.
