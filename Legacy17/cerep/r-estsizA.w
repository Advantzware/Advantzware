...
begin_die-no end_die-no rd_sortby tb_fold tb_corr rd-dest lv-ornt ~
...
lbl-sortby rd_sortby tb_fold lbl-industry tb_corr rd-dest lv-ornt ~
...
DEFINE FRAME FRAME-A
     ...
     lv-font-no AT ROW 14.1 COL 34 COLON-ALIGNED
     lv-font-name AT ROW 15.05 COL 29 COLON-ALIGNED NO-LABEL
     td-show-parm AT ROW 16.71 COL 31
     tb_excel AT ROW 18 COL 51 RIGHT-ALIGNED WIDGET-ID 4
     tb_runExcel AT ROW 18 COL 73.6 RIGHT-ALIGNED WIDGET-ID 6
     fi_file AT ROW 19.19 COL 29.2 COLON-ALIGNED HELP
          "Enter File Name" WIDGET-ID 2
     btn-ok AT ROW 20.86 COL 21
     btn-cancel AT ROW 20.86 COL 60
...
------------------------------------------------------------------------------*/
  DISPLAY begin_cust-no end_cust-no begin_style end_style begin_flute end_flute 
          ...
          tb_fold lbl-industry tb_corr rd-dest lv-ornt lines-per-page lv-font-no 
  ...
  ENABLE RECT-6 RECT-7 begin_cust-no end_cust-no begin_style end_style 
         ...
         rd_sortby tb_fold tb_corr rd-dest lv-ornt lines-per-page lv-font-no 
