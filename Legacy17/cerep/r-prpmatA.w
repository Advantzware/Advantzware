...
tb_contr rd-dest lv-ornt lines-per-page lv-font-no td-show-parm tb_excel ~
...
end_prep lbl_sort rd_sort tb_contr rd-dest lv-ornt lines-per-page ~
...
DEFINE VARIABLE tb_contr AS LOGICAL INITIAL yes 
...
DEFINE FRAME FRAME-A
     ...
     tb_contr AT ROW 12.19 COL 38
     rd-dest AT ROW 14.57 COL 7 NO-LABEL
     ...
     td-show-parm AT ROW 20.29 COL 27
     tb_excel AT ROW 20.29 COL 72 RIGHT-ALIGNED
     tb_runExcel AT ROW 20.29 COL 95 RIGHT-ALIGNED
     fi_file AT ROW 21.48 COL 50 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 23.38 COL 22
     btn-cancel AT ROW 23.38 COL 60
...
DO:
   apply "close" to this-procedure.
    {Advantzware/WinKit/winkit-panel-triggerend.i} /* added by script _nonAdm1.p on 04.18.2017 @ 11:35:53 am */
END.
...
ON VALUE-CHANGED OF tb_contr IN FRAME FRAME-A /* Print Description? */
DO:
  assign {&self-name}.
END.
...
ON CLOSE OF THIS-PROCEDURE DO:
   RUN disable_UI.
   {Advantzware/WinKit/closewindow-nonadm.i} /* added by script _nonAdm1.p on 04.18.2017 @ 11:35:53 am */
END.
...
/* security check need {methods/prgsecur.i} in definition section */
  ...
  {methods/nowait.i}
  DO WITH FRAME {&FRAME-NAME}:
    {methods/setButton.i btn-cancel "Cancel"} /* added by script _nonAdm1Images2.p on 04.18.2017 @ 11:36:53 am */
    {methods/setButton.i btn-ok "OK"} /* added by script _nonAdm1Images2.p on 04.18.2017 @ 11:36:53 am */
    {custom/usrprint.i}
    APPLY "entry" TO begin_slsmn.
  END.
    {Advantzware/WinKit/embedfinalize-nonadm.i} /* added by script _nonAdm1.p on 04.18.2017 @ 11:35:53 am */
...
------------------------------------------------------------------------------*/
  DISPLAY tb_die lbl-mat-types tb_plate tb_fold lbl-industry tb_corr begin_slsmn 
          ...
          tb_contr rd-dest lv-ornt lines-per-page lv-font-no lv-font-name 
  ...
  ENABLE RECT-6 RECT-7 tb_die tb_plate tb_fold tb_corr begin_slsmn end_slsmn 
         ...
         end_last-ord begin_prep end_prep rd_sort tb_contr rd-dest lv-ornt 
