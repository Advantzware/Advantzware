/* fa/srt2lst.p   F/A Sort Code 2 List (from pt/report.m)
		warty 04/09/90
*/
...
{fa/srt2lst.y}             /* YOUR PARAMETERS INCLUDE FILE */
{fa/shared}
...
MAIN-LOOP:
for each  sort2
    where sort2.sort-code2 ge sort2-begin
      and sort2.sort-code2 le sort2-end
    no-lock
  ...
  display sort2 with {&UGUI-RPT}.


  accumulate 1 /*sort2*/ (count).   /* RECORD COUNT */

  /* INCLUDE AT THE END OF EACH PRINTING LOOP*/

  {pt/newpage main-loop string(sort2.sort-code2)}
...
form header skip(1) "End-of-Report." accum count 1 /*sort2*/ format ">>>,>>9"
     "sort2(s) Printed."
