...
&Scoped-define FIELDS-IN-QUERY-br_table fa-entity Asset-code Trans-date ~
Item-no Description1 Description2 Cost-book Purch-order# Line-no ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTable _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      fa-entity COLUMN-LABEL "Company" FORMAT "x(8)":U WIDTH 11.2
      Asset-code FORMAT "x(8)":U WIDTH 22.2
      Trans-date FORMAT "99/99/99":U WIDTH 15.2
      Item-no FORMAT "x(16)":U WIDTH 23.2
      Description1 FORMAT "x(30)":U
      Description2 FORMAT "x(30)":U
      Cost-book FORMAT ">>>,>>>,>>9.99":U
      Purch-order# FORMAT "x(12)":U
      Line-no FORMAT ">>9":U WIDTH 13
      Vendor-code FORMAT "x(6)":U WIDTH 17.2
      Voucher-no FORMAT ">>>>>9":U WIDTH 17.4
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 218 BY 6.67
...
"fa-entity" "Company" ? "character" ? ? ? ? ? ? no ? no no "11.2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > _<SDO>.rowObject.Asset-code
"Asset-code" ? ? "character" ? ? ? ? ? ? no ? no no "22.2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > _<SDO>.rowObject.Trans-date
"Trans-date" ? ? "date" ? ? ? ? ? ? no ? no no "15.2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > _<SDO>.rowObject.Item-no
"Item-no" ? ? "character" ? ? ? ? ? ? no ? no no "23.2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   = _<SDO>.rowObject.Description1
     _FldNameList[6]   = _<SDO>.rowObject.Description2
     _FldNameList[7]   = _<SDO>.rowObject.Cost-book
     _FldNameList[8]   = _<SDO>.rowObject.Purch-order#
     _FldNameList[9]   > _<SDO>.rowObject.Line-no
"Line-no" ? ? "integer" ? ? ? ? ? ? no ? no no "13" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > _<SDO>.rowObject.Vendor-code
"Vendor-code" ? ? "character" ? ? ? ? ? ? no ? no no "17.2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > _<SDO>.rowObject.Voucher-no
"Voucher-no" ? ? "integer" ? ? ? ? ? ? no ? no no "17.4" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
