...
&SCOPED-DEFINE h_Object01 h_vp-viewp
&SCOPED-DEFINE h_Object02 h_vp-clsp2
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Browse PO|View PO|Items' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-purord ).
       RUN set-position IN h_v-purord ( 5.05 , 4.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-navico ).
       RUN set-position IN h_p-navico ( 21.24 , 18.00 ) NO-ERROR.
       RUN set-size IN h_p-navico ( 2.14 , 50.00 ) NO-ERROR.
    ...
    WHEN 3 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_vi-poord ).
       RUN set-position IN h_vi-poord ( 4.81 , 3.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_bi-poord ).
       RUN set-position IN h_bi-poord ( 7.67 , 4.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_b-po-inq , 'Record':U , h_vi-poord ).
