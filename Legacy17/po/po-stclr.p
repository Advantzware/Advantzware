/* -------------------------------------------------------------------------- */ 
/* po/po-stclr.p                                                              */
/* Purchase Order Print Program for POPRINT = StClair                      */
/*                                                                            */
/* -------------------------------------------------------------------------- */
      ...
      /*  IF NOT(lv-cost GT 9999.99 OR
        ...
        DO:*/
           PUT po-ordl.LINE FORM ">>9"
               STRING(lv-ord-qty, lv-format) FORMAT "x(14)" SPACE(2)
               lv-pr-qty-uom SPACE(1)
               po-ordl.i-no FORM "x(30)" SPACE(14)
             /*  v-adder[1] 
               v-job-no FORM "x(12)" SPACE(1) */
               /*SKIP
               SPACE(68) */
...
PUT "<FArial><R58><C1><P12><B> Terms and Conditions </B> <P9> " SKIP
     ...
     " " SKIP
     " " SKIP(1.5)     
     "  I acknowledge the pricing on this P.O. is correct. _________________________(please sign and return by email or fax to buyer indicated above)" SKIP
     .
