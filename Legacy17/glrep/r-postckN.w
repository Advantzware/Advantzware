...
ASSIGN cTextListToSelect = "Trans Date,Run #,Journal,Balance,Bal Desc" 

       cFieldListToSelect = "date,run,jur,bal,out"

       cFieldLength = "10,7,8,15,15" 
       cFieldType = "c,i,c,i,c" 
    .

{sys/inc/ttRptSel.i}
ASSIGN cTextListToDefault  = "Trans Date,Run #,Journal,Balance,Bal Desc" .
...
DEFINE VARIABLE fi_file AS CHARACTER FORMAT "X(256)":U INITIAL "c:~\tmp~\r-postchk.csv" 
...
DEFINE FRAME FRAME-A
     begin_run-no AT ROW 2.57 COL 25 COLON-ALIGNED HELP
          "Enter Beginning Run Number"
     end_run-no AT ROW 2.57 COL 63 COLON-ALIGNED HELP
          "Enter Ending Run Number"
     begin_date AT ROW 4 COL 25 COLON-ALIGNED
     end_date AT ROW 4 COL 63 COLON-ALIGNED HELP
          "Enter Ending Due Date"
     sl_avail AT ROW 7 COL 5 NO-LABEL WIDGET-ID 26
     Btn_Def AT ROW 7 COL 41 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 56
     sl_selected AT ROW 7 COL 60.4 NO-LABEL WIDGET-ID 28
     Btn_Add AT ROW 8 COL 41 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 32
     Btn_Remove AT ROW 9 COL 41 HELP
          "Remove Selected Table from Tables to Audit" WIDGET-ID 34
     btn_Up AT ROW 10.05 COL 41 WIDGET-ID 40
     btn_down AT ROW 11.1 COL 41 WIDGET-ID 42
     rd-dest AT ROW 13.48 COL 5 NO-LABEL
     lv-ornt AT ROW 13.48 COL 30 NO-LABEL
     lines-per-page AT ROW 13.48 COL 84 COLON-ALIGNED
     lv-font-no AT ROW 15.86 COL 35 COLON-ALIGNED
     lv-font-name AT ROW 17.1 COL 28 COLON-ALIGNED NO-LABEL
     td-show-parm AT ROW 18.24 COL 30
     tb_excel AT ROW 19.24 COL 30 WIDGET-ID 2
     tb_runExcel AT ROW 19.24 COL 51.6 WIDGET-ID 4
     fi_file AT ROW 20.14 COL 28 COLON-ALIGNED HELP
          "Enter File Name" WIDGET-ID 6
     btn-ok AT ROW 21.86 COL 17
     btn-cancel AT ROW 21.86 COL 56
     "Available Columns" VIEW-AS TEXT
          SIZE 29 BY .62 AT ROW 6.19 COL 5.8 WIDGET-ID 38
     "Selected Columns(In Display Order)" VIEW-AS TEXT
          SIZE 34 BY .62 AT ROW 6.29 COL 60.4 WIDGET-ID 44
     "Output Destination" VIEW-AS TEXT
          SIZE 20 BY .62 AT ROW 12.76 COL 4.2
          FGCOLOR 9 
     "Selection Parameters" VIEW-AS TEXT
          SIZE 21 BY .71 AT ROW 1.24 COL 5
          BGCOLOR 2 
     RECT-6 AT ROW 12.95 COL 1.4
...
ON END-ERROR OF C-Win /* GL Postings Check */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* GL Postings Check */
DO:
            ...
            DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
               cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                    CASE cTmpField:             
                         ...
                         WHEN "jur"   THEN cVarValue = STRING(glhist.jrnl,"x(8)").
                         WHEN "bal"  THEN cVarValue = STRING(v-tot,"->>>,>>>,>>9.99") .
                        WHEN "out"   THEN cVarValue = string(v-tot eq 0,"/Out of Balance") .
            ...
            DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
               cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                    CASE cTmpField:             
                         ...
                         WHEN "jur"   THEN cVarValue = STRING(gltrans.jrnl,"x(8)").
                         WHEN "bal"  THEN cVarValue = STRING(v-tot,"->>>,>>>,>>9.99") .
                         WHEN "out"   THEN cVarValue = string(v-tot eq 0,"/Out of Balance") .
