...
ASSIGN cTextListToSelect = "Account Number,Description,Run #,Journal,Reference,Date," +
                           "Debits,Credits,Balance,Jrnl#" 
       cFieldListToSelect = "act,dscr,run,jrnl,ref,date," +
                            "dbt,crdt,bal,jrnl#"
       cFieldLength = "25,45,7,10,35,10," + "19,19,19,7" 
       cFieldType = "c,c,i,c,c,c," + "i,i,i,c"  
    .

{sys/inc/ttRptSel.i}
ASSIGN cTextListToDefault  = "Account Number,Description,Run #,Journal,Reference,Date," +
                           "Debits,Credits,Balance,Jrnl#"  .
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME FRAME-A
     tran-date AT ROW 2.33 COL 46 COLON-ALIGNED
     tran-period AT ROW 3.52 COL 46 COLON-ALIGNED
     begin_acct AT ROW 5.14 COL 19 COLON-ALIGNED HELP
          "Enter Beginning Account Number"
     end_acct AT ROW 5.14 COL 63 COLON-ALIGNED HELP
          "Enter Ending Account Number"
     sl_avail AT ROW 7.57 COL 4 NO-LABEL WIDGET-ID 26
     Btn_Def AT ROW 7.57 COL 40 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 56
     sl_selected AT ROW 7.57 COL 59.4 NO-LABEL WIDGET-ID 28
     Btn_Add AT ROW 8.57 COL 40 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 32
     Btn_Remove AT ROW 9.57 COL 40 HELP
          "Remove Selected Table from Tables to Audit" WIDGET-ID 34
     btn_Up AT ROW 10.62 COL 40 WIDGET-ID 40
     btn_down AT ROW 11.67 COL 40 WIDGET-ID 42
     rd-dest AT ROW 14.29 COL 6 NO-LABEL
     lv-ornt AT ROW 15 COL 31 NO-LABEL
     lines-per-page AT ROW 15 COL 84 COLON-ALIGNED
     lv-font-no AT ROW 16.43 COL 35 COLON-ALIGNED
     lv-font-name AT ROW 17.38 COL 29 COLON-ALIGNED NO-LABEL
     td-show-parm AT ROW 19.19 COL 31
     tb_excel AT ROW 20.67 COL 31.6 WIDGET-ID 2
     tb_runExcel AT ROW 20.67 COL 53.2 WIDGET-ID 4
     fi_file AT ROW 21.76 COL 29.6 COLON-ALIGNED HELP
          "Enter File Name" WIDGET-ID 6
     btn-ok AT ROW 23.62 COL 19
     btn-cancel AT ROW 23.62 COL 58
     "Available Columns" VIEW-AS TEXT
          SIZE 29 BY .62 AT ROW 6.67 COL 5 WIDGET-ID 38
     "Selection Parameters" VIEW-AS TEXT
          SIZE 21 BY .71 AT ROW 1.24 COL 5
          BGCOLOR 2 
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 13.57 COL 3
          FGCOLOR 9 
     "Selected Columns(In Display Order)" VIEW-AS TEXT
          SIZE 34 BY .62 AT ROW 6.76 COL 59.6 WIDGET-ID 44
...
DO:
   apply "close" to this-procedure.
    {Advantzware/WinKit/winkit-panel-triggerend.i} /* added by script _nonAdm1.p on 04.18.2017 @ 11:36:02 am */
END.
...
ON CLOSE OF THIS-PROCEDURE DO:
   RUN disable_UI.
   {Advantzware/WinKit/closewindow-nonadm.i} /* added by script _nonAdm1.p on 04.18.2017 @ 11:36:02 am */
END.
...
/* security check need {methods/prgsecur.i} in definition section */
  ...
  DO WITH FRAME {&FRAME-NAME}:
    {methods/setButton.i btn-cancel "Cancel"} /* added by script _nonAdm1Images2.p on 04.18.2017 @ 11:36:59 am */
    {methods/setButton.i btn-ok "OK"} /* added by script _nonAdm1Images2.p on 04.18.2017 @ 11:36:59 am */
    {custom/usrprint.i}
    RUN DisplaySelectionList2.
    APPLY "entry" TO tran-date.
  END.

    {Advantzware/WinKit/embedfinalize-nonadm.i} /* added by script _nonAdm1.p on 04.18.2017 @ 11:36:02 am */
...
------------------------------------------------------------------------------*/
  DISPLAY tran-date tran-period begin_acct end_acct sl_avail sl_selected rd-dest 
          lv-ornt lines-per-page lv-font-no lv-font-name td-show-parm tb_excel 
          tb_runExcel fi_file 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE RECT-6 RECT-7 tran-date begin_acct end_acct sl_avail Btn_Def 
...
DEF VAR v-tot-bal AS DEC NO-UNDO.
...
DEF VAR cslist AS cha NO-UNDO.
 FOR EACH ttRptSelected BY ttRptSelected.DisplayOrder:
   ...
   ASSIGN str-tit4 = str-tit4 + 
        ...
        IF LOOKUP(ttRptSelected.TextList, "Debits,Credits,Balance") <> 0    THEN
         ASSIGN
        ...
        DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
           cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                CASE cTmpField:             
                     ...
                     WHEN "jrnl#"  THEN cVarValue = string(v-jrnl-no,"x(7)") .
...
*/
      ...
      if last(gltrans.trnum) then do:
       /* PUT v-debit[2]                                   to 97 format "(>>>,>>>,>>9.99)"
        ...
        v-tot-bal = (v-debit[2] + v-crdit[2] + open-amt)  .
        ...
        DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
           cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                CASE cTmpField:             
                     ...
                     WHEN "dbt"    THEN cVarValue = string(v-debit[2],"->>>,>>>,>>>,>>9.99") .
                     WHEN "crdt"   THEN cVarValue = STRING(v-crdit[2],"->>>,>>>,>>>,>>9.99") .
                     WHEN "bal"    THEN cVarValue = IF v-runbal NE ? THEN string(v-tot-bal,"->>>,>>>,>>>,>>9.99") ELSE "".
                     WHEN "jrnl#"  THEN cVarValue = "" .
        ...
        /* gdm - 10010905 end */
                ...
                /*djk*/
        IF v-debit[2] NE ? THEN
            tot-all = tot-all +  v-debit[2] .
        IF v-crdit[2] NE ? THEN
            tot-all = tot-all + v-crdit[2] .
        IF open-amt NE ? THEN
    ...
    if last(account.actnum) THEN do:
      /*display "TOTAL"    to 68
        ...
        DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
           cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                CASE cTmpField:             
                     ...
                     WHEN "ref"    THEN cVarValue = "" .
                     WHEN "date"   THEN cVarValue = "" .
                     WHEN "dbt"    THEN cVarValue = string(v-debit[3],"->>>,>>>,>>>,>>9.99") .
                     WHEN "crdt"   THEN cVarValue = STRING(v-crdit[3],"->>>,>>>,>>>,>>9.99") .
        ...
        PUT UNFORMATTED  "       TOTAL" substring(cDisplay,13,300) SKIP(1).
        IF tb_excel THEN DO:
         PUT STREAM str-exl UNFORMATTED  
              'TOTAL ,' + substring(cExcelDisplay,4,300) SKIP.
        END. 
    END.
