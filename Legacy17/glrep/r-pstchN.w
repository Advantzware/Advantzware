...
ASSIGN cTextListToSelect = "Run#,Post Date,Ref Date,AR Description,Amount" 
...
{sys/inc/ttRptSel.i}
ASSIGN cTextListToDefault  = "Run#,Post Date,Ref Date,AR Description,Amount" .
...
DEFINE FRAME FRAME-A
     ...
     end_pdate AT ROW 4.86 COL 73 COLON-ALIGNED HELP
          "Enter Ending Posting Date"
     sl_avail AT ROW 7.52 COL 4.4 NO-LABEL WIDGET-ID 26
     Btn_Def AT ROW 7.52 COL 40.4 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 56
     sl_selected AT ROW 7.52 COL 59.8 NO-LABEL WIDGET-ID 28
     Btn_Add AT ROW 8.52 COL 40.4 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 32
     Btn_Remove AT ROW 9.52 COL 40.4 HELP
          "Remove Selected Table from Tables to Audit" WIDGET-ID 34
     btn_Up AT ROW 10.57 COL 40.4 WIDGET-ID 40
     btn_down AT ROW 11.62 COL 40.4 WIDGET-ID 42
     rd-dest AT ROW 14.81 COL 5 NO-LABEL
     lv-ornt AT ROW 15.52 COL 31 NO-LABEL
     lines-per-page AT ROW 15.52 COL 84 COLON-ALIGNED
     lv-font-no AT ROW 17.19 COL 35 COLON-ALIGNED
     lv-font-name AT ROW 18.14 COL 29.2 COLON-ALIGNED NO-LABEL
     td-show-parm AT ROW 19.33 COL 31.2
     tb_excel AT ROW 20.29 COL 31.2 WIDGET-ID 2
     tb_runExcel AT ROW 20.29 COL 53 WIDGET-ID 4
     fi_file AT ROW 21.24 COL 29.2 COLON-ALIGNED HELP
          "Enter File Name" WIDGET-ID 6
     btn-ok AT ROW 22.71 COL 17
     btn-cancel AT ROW 22.71 COL 56
     "Available Columns" VIEW-AS TEXT
          SIZE 29 BY .62 AT ROW 6.71 COL 5.2 WIDGET-ID 38
     ...
     "Selected Columns(In Display Order)" VIEW-AS TEXT
          SIZE 34 BY .62 AT ROW 6.81 COL 59.8 WIDGET-ID 44
...
/* security check need {methods/prgsecur.i} in definition section */
  ...
  DO WITH FRAME {&FRAME-NAME}:
    {methods/setButton.i btn-cancel "Cancel"} /* added by script _nonAdm1Images2.p on 04.18.2017 @ 11:37:01 am */
    {methods/setButton.i btn-ok "OK"} /* added by script _nonAdm1Images2.p on 04.18.2017 @ 11:37:01 am */
    {custom/usrprint.i}
    RUN DisplaySelectionList2.
...
DEF VAR v-tot-amt2 AS DEC NO-UNDO.
DEF VAR g-tot-amt AS DEC NO-UNDO.
DEF VAR g-tot-amt2 AS DEC NO-UNDO.
...
if td-show-parm then run show-param.
   ...
   /* DISPLAY ar-ledger.tr-num    WHEN FIRST-OF(ar-ledger.tr-num)
    ...
    DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
      cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
           CASE cTmpField:             
                WHEN "run"     THEN cVarValue = string(ar-ledger.tr-num,">>>>>>9") .
                WHEN "pst-dt"  THEN cVarValue = string(ar-ledger.tr-date,"99/99/9999").
                WHEN "ref-dt"  THEN cVarValue = STRING(ar-ledger.ref-date,"99/99/9999").
                WHEN "ap-dscr" THEN cVarValue = STRING(ar-ledger.ref-num,"x(20)") .
                WHEN "amt"     THEN cVarValue = string(ar-ledger.amt,"->>>,>>>,>>9.99") .
       ...
       DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
          cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
               CASE cTmpField:             
                    ...
                    WHEN "pst-dt"  THEN cVarValue = "".
                    WHEN "ref-dt"  THEN cVarValue = "".
                    WHEN "ap-dscr" THEN cVarValue = "".
                    WHEN "amt"     THEN cVarValue = string(v-tot-amt,"->>>,>>>,>>9.99") .
  ...
  PUT SKIP str-line SKIP .
    ...
    DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
       cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
            CASE cTmpField:             
                 ...
                 WHEN "ref-dt"  THEN cVarValue = "".
                 WHEN "ap-dscr" THEN cVarValue = "".
                 WHEN "amt"     THEN cVarValue = string(g-tot-amt,"->>>,>>>,>>9.99") .
    ...
    PUT UNFORMATTED  " GRAND TOTAL" substring(cDisplay,13,300) SKIP(1).
  IF tb_excel THEN DO:
      PUT STREAM s-temp UNFORMATTED  
  ...
  /*  DISPLAY ap-ledger.trnum     WHEN FIRST-OF(ap-ledger.trnum)
    ...
    if tb_excel then 
       ...
       DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
          cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
               CASE cTmpField:             
                    WHEN "run"     THEN cVarValue = string(ap-ledger.trnum,">>>>>>9") .
                    WHEN "pst-dt"  THEN cVarValue = string(ap-ledger.tr-date,"99/99/9999").
                    WHEN "ref-dt"  THEN cVarValue = STRING(ap-ledger.ref-date,"99/99/9999").
                    WHEN "ap-dscr" THEN cVarValue = STRING(ap-ledger.refnum,"x(20)") .
                    WHEN "amt"     THEN cVarValue = string(ap-ledger.amt,"->>>,>>>,>>9.99") .
       ...
       IF tb_excel THEN DO:
        ...
        IF LAST-OF(ap-ledger.trnum) THEN do:
          PUT SKIP str-line SKIP .
            ...
            DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
               cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                    CASE cTmpField:             
                         ...
                         WHEN "ref-dt"  THEN cVarValue = "".
                         WHEN "ap-dscr" THEN cVarValue = "".
                         WHEN "amt"     THEN cVarValue = string(v-tot-amt2,"->>>,>>>,>>9.99") .
                    END CASE.
                    cExcelVarValue = cVarValue.
                    cDisplay = cDisplay + cVarValue +
                               FILL(" ",int(entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldLength)) + 1 - LENGTH(cVarValue)). 
    ...
    DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
       cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
            CASE cTmpField:             
                 ...
                 WHEN "ref-dt"  THEN cVarValue = "".
                 WHEN "ap-dscr" THEN cVarValue = "".
                 WHEN "amt"     THEN cVarValue = string(g-tot-amt2,"->>>,>>>,>>9.99") .
            END CASE.
            cExcelVarValue = cVarValue.
            cDisplay = cDisplay + cVarValue +
                       FILL(" ",int(entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldLength)) + 1 - LENGTH(cVarValue)). 
