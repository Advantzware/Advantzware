...
&Scoped-Define ENABLED-OBJECTS print_RelTicket 
...
DEFINE FRAME F-Main
     print_RelTicket AT ROW 1 COL 1
...
&Scoped-define SELF-NAME print_RelTicket
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL print_RelTicket s-object
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE setEnabled s-object 
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
    IF ipEnable THEN
    ENABLE print_RelTicket.
    ELSE
    DISABLE print_RelTicket.
  END.
