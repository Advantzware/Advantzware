...
ASSIGN cTextListToSelect = "Routing Code,Description,Machine Code[1],Machine Code[2],Machine Code[3]," +
...
{sys/inc/ttRptSel.i}
    ...
    ASSIGN cTextListToDefault  = "Routing Code,Description,Machine Code[1],Machine Code[2],Machine Code[3]," +
                           "Machine Code[4],Machine Code[5],Machine Code[6],Machine Code[7],Machine Code[8]," +
                           "Machine Code[9],Machine Code[10]"  .
...
DEFINE VARIABLE fi_file AS CHARACTER FORMAT "X(30)" INITIAL "c:~\tmp~\r-routing.csv" 
...
DEFINE FRAME rd-fgexp
     begin_code AT ROW 4.43 COL 28 COLON-ALIGNED HELP
          "Enter Beginning Routing Number" WIDGET-ID 142
     end_code AT ROW 4.43 COL 71 COLON-ALIGNED HELP
...
ASSIGN 
       begin_code:PRIVATE-DATA IN FRAME rd-fgexp     = 
                "parm".

ASSIGN 
       end_code:PRIVATE-DATA IN FRAME rd-fgexp     = 
                "parm".
...
------------------------------------------------------------------------------*/
  DISPLAY begin_code end_code sl_avail sl_selected tb_excel tb_runExcel fi_file 
      WITH FRAME rd-fgexp.
