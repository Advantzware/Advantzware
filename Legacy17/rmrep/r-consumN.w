...
{sys/inc/ttRptSel.i}
ASSIGN cTextListToDefault  = "CATEGORY,ITEM,DESCRIPTION,TAG#,LINEAL FEET,MSF," +
                           "WEIGHT,COST VALUE" .
...
tg-subtot tg-subtot-item sl_avail sl_selected rd-dest lv-ornt ~
...
DEFINE FRAME FRAME-A
     ...
     sl_avail AT ROW 10.62 COL 4.4 NO-LABEL WIDGET-ID 26
     Btn_Def AT ROW 10.62 COL 40.6 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 56
     sl_selected AT ROW 10.62 COL 59.8 NO-LABEL WIDGET-ID 28
     Btn_Add AT ROW 11.62 COL 40.6 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 32
     Btn_Remove AT ROW 12.62 COL 40.6 HELP
          "Remove Selected Table from Tables to Audit" WIDGET-ID 34
     btn_Up AT ROW 13.67 COL 40.6 WIDGET-ID 40
     btn_down AT ROW 14.71 COL 40.6 WIDGET-ID 42
     rd-dest AT ROW 17.19 COL 5 NO-LABEL
     lv-ornt AT ROW 18.14 COL 31 NO-LABEL
     lines-per-page AT ROW 18.14 COL 84 COLON-ALIGNED
     lv-font-no AT ROW 19.43 COL 29.8 COLON-ALIGNED
     lv-font-name AT ROW 20.48 COL 29 COLON-ALIGNED NO-LABEL
     td-show-parm AT ROW 21.52 COL 31
     tb_excel AT ROW 22.57 COL 31.8
     tb_runExcel AT ROW 22.57 COL 77 RIGHT-ALIGNED
     v-excel-file AT ROW 23.91 COL 29.4 COLON-ALIGNED
     btn-ok AT ROW 25.48 COL 23
     btn-cancel AT ROW 25.48 COL 62
     "Available Columns" VIEW-AS TEXT
          SIZE 29 BY .62 AT ROW 9.81 COL 5.4 WIDGET-ID 38
     ...
     "Selected Columns(In Display Order)" VIEW-AS TEXT
          SIZE 34 BY .62 AT ROW 9.81 COL 60 WIDGET-ID 44
...
DO:
   apply "close" to this-procedure.
    {Advantzware/WinKit/winkit-panel-triggerend.i} /* added by script _nonAdm1.p on 04.18.2017 @ 11:36:20 am */
END.
...
ON CLOSE OF THIS-PROCEDURE DO:
   RUN disable_UI.
   {Advantzware/WinKit/closewindow-nonadm.i} /* added by script _nonAdm1.p on 04.18.2017 @ 11:36:20 am */
END.
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
 ...
 /* security check need {methods/prgsecur.i} in definition section */
  ...
  DO WITH FRAME {&FRAME-NAME}:
    {methods/setButton.i btn-cancel "Cancel"} /* added by script _nonAdm1Images2.p on 04.18.2017 @ 11:37:15 am */
    {methods/setButton.i btn-ok "OK"} /* added by script _nonAdm1Images2.p on 04.18.2017 @ 11:37:15 am */
    {custom/usrprint.i}
    RUN DisplaySelectionList2.
    APPLY "entry" TO begin_rm-no.
  END.

    {Advantzware/WinKit/embedfinalize-nonadm.i} /* added by script _nonAdm1.p on 04.18.2017 @ 11:36:20 am */
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-6 RECT-7 begin_rm-no end_rm-no begin_procat end_procat begin_date 
         ...
         tb_runExcel v-excel-file btn-ok btn-cancel
      WITH FRAME FRAME-A IN WINDOW C-Win.
        ...
        DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
           cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                CASE cTmpField:             
                     ...
                     WHEN "lin-ft"   THEN cVarValue = string(v-qty[1],"->>>>>>>>9.99<<")  .
        ...
        DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
           cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                CASE cTmpField:             
                     ...
                     WHEN "dscr"     THEN cVarValue = "" .
                     WHEN "tag"      THEN cVarValue = "" .
                     WHEN "lin-ft"   THEN cVarValue = string(v-qty[2],"->>>>>>>>9.99<<")  .
        ...
        DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
           cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                CASE cTmpField:             
                     ...
                     WHEN "dscr"     THEN cVarValue = "" .
                     WHEN "tag"      THEN cVarValue = "" .
                     WHEN "lin-ft"   THEN cVarValue = string(v-qty[3],"->>>>>>>>9.99<<")  .
