...
ASSIGN cTextListToSelect = "ITEM #,CAT,UOM,LOC,REORD LVL,QTY O|H,"
                        + "QTY ALLCTD,QTY ON ORD,MIN ORDER,VENDOR,"
                        + "VENDOR ITEM NUMBER"
       cFieldListToSelect = "i-no,cat,uom,loc,rcrd-lvl,qty-oh," +
                            "qty-all,qty-ord,min-ord,vend," +
                            "vend-ino"
       cFieldLength = "10,5,3,5,10,10," + "10,10,15,8," + "30" 
       cFieldType = "c,c,c,c,i,i," + "i,i,i,c," + "c"  
    .

{sys/inc/ttRptSel.i}
ASSIGN cTextListToDefault  = "ITEM #,CAT,UOM,LOC,REORD LVL,QTY O|H,"
                        + "QTY ALLCTD,QTY ON ORD,MIN ORDER,VENDOR,"
                        + "VENDOR ITEM NUMBER"  .
...
end_rm-no begin_procat end_procat tb_qty-oh lv-ornt lines-per-page rd-dest ~
...
begin_procat end_procat tb_qty-oh lv-ornt lines-per-page rd-dest lv-font-no ~
...
DEFINE VARIABLE fi_file AS CHARACTER FORMAT "X(30)" INITIAL "c:~\tmp~\r-reordr.csv" 
...
DEFINE FRAME FRAME-A
     begin_whs AT ROW 2.62 COL 31 COLON-ALIGNED HELP
          "Enter Beginng Warehouse"
     end_whs AT ROW 2.62 COL 69 COLON-ALIGNED HELP
          "Enter Ending Warehouse"
     begin_rm-no AT ROW 3.81 COL 31 COLON-ALIGNED HELP
          "Enter Beginning Item Number"
     end_rm-no AT ROW 3.81 COL 69 COLON-ALIGNED HELP
          "Enter Ending Item Number"
     begin_procat AT ROW 5 COL 31 COLON-ALIGNED HELP
          "Enter Beginning Category"
     end_procat AT ROW 5 COL 69 COLON-ALIGNED HELP
          "Enter Ending Category"
     tb_qty-oh AT ROW 6.43 COL 30.8
     sl_avail AT ROW 8.86 COL 4.2 NO-LABEL WIDGET-ID 26
     Btn_Def AT ROW 8.86 COL 40.2 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 56
     sl_selected AT ROW 8.86 COL 59.6 NO-LABEL WIDGET-ID 28
     ...
     lv-ornt AT ROW 15.86 COL 31 NO-LABEL
     ...
     td-show-parm AT ROW 19.81 COL 31
     tb_excel AT ROW 21.81 COL 51.2 RIGHT-ALIGNED
     tb_runExcel AT ROW 21.81 COL 72.2 RIGHT-ALIGNED
     fi_file AT ROW 22.62 COL 29.2 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 24.95 COL 22
     btn-cancel AT ROW 24.95 COL 60
     "Available Columns" VIEW-AS TEXT
          SIZE 29 BY .62 AT ROW 7.95 COL 5.2 WIDGET-ID 38
     ...
     "Selected Columns(In Display Order)" VIEW-AS TEXT
          SIZE 34 BY .62 AT ROW 8.05 COL 59.8 WIDGET-ID 44
...
DO:
   apply "close" to this-procedure.
    {Advantzware/WinKit/winkit-panel-triggerend.i} /* added by script _nonAdm1.p on 04.18.2017 @ 11:36:21 am */
END.
...
ON CLOSE OF THIS-PROCEDURE DO:
   RUN disable_UI.
   {Advantzware/WinKit/closewindow-nonadm.i} /* added by script _nonAdm1.p on 04.18.2017 @ 11:36:21 am */
END.
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
 ...
 /* security check need {methods/prgsecur.i} in definition section */
  ...
  DO WITH FRAME {&FRAME-NAME}:
    {methods/setButton.i btn-cancel "Cancel"} /* added by script _nonAdm1Images2.p on 04.18.2017 @ 11:37:16 am */
    {methods/setButton.i btn-ok "OK"} /* added by script _nonAdm1Images2.p on 04.18.2017 @ 11:37:16 am */
    {custom/usrprint.i}
    RUN DisplaySelectionList2.
    APPLY "entry" TO begin_whs.
  END.

    {Advantzware/WinKit/embedfinalize-nonadm.i} /* added by script _nonAdm1.p on 04.18.2017 @ 11:36:21 am */
...
------------------------------------------------------------------------------*/
  DISPLAY begin_whs end_whs begin_rm-no end_rm-no begin_procat end_procat 
          tb_qty-oh lv-ornt lines-per-page rd-dest lv-font-no lv-font-name 
  ...
  ENABLE RECT-6 RECT-7 begin_whs end_whs begin_rm-no end_rm-no begin_procat 
         end_procat tb_qty-oh lv-ornt lines-per-page rd-dest lv-font-no 
...
def var floc  like loc.loc NO-UNDO.
def var tloc  like floc NO-UNDO.
def var fcat  like procat.procat NO-UNDO.
def var tcat  like fcat NO-UNDO.
def var fitem like item.i-no NO-UNDO.
          ...
          /*  display
            ...
            DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
               cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                    CASE cTmpField:             
                         WHEN "i-no"      THEN cVarValue = IF first-of(item.i-no) THEN string(ITEM.i-no,"x(10)") ELSE "" .        
