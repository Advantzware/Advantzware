...
ON END-ERROR OF C-Win /* Open Jobs Backlog Report */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Open Jobs Backlog Report */
DO:
      ...
      for each mch-act where
          ...
          find first x-mch where
           ...
           if job-code.cat = "MR" then
              ...
              assign
                 x-mch.run-act = x-mch.run-act + mch-act.hours
