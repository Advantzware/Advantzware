        ...
        END.
          ELSE DO:       
             CASE cTmpField:
                  ...
                  WHEN "i-name" THEN cVarValue = IF AVAIL itemfg THEN STRING(itemfg.i-name,"x(30)") ELSE "" .
                  WHEN "start-time" THEN cVarValue = cvt-time-to-string('',job-mch.start-time-su,0.00) .
                  WHEN "start-end-time" THEN cVarValue = cvt-time-to-string('',job-mch.end-time-su,0.00) .
                  WHEN "sttime"  THEN cVarValue = cvt-time-to-string('',job-mch.start-time,0.00) .
                  WHEN "endtime"  THEN cVarValue = cvt-time-to-string('',job-mch.end-time,0.00) .
             END CASE.
