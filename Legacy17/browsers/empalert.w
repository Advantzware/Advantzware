...
&Scoped-define INTERNAL-TABLES empalert users

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE Browser-Table                                 */
&Scoped-define FIELDS-IN-QUERY-Browser-Table empalert.user-id ~
users.user_name 
&Scoped-define ENABLED-FIELDS-IN-QUERY-Browser-Table 
&Scoped-define QUERY-STRING-Browser-Table FOR EACH empalert WHERE ~{&KEY-PHRASE} ~
      AND empalert.table_rec_key = ip-rec_key NO-LOCK, ~
      FIRST users WHERE users.user_id = empalert.user-id NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Browser-Table OPEN QUERY Browser-Table FOR EACH empalert WHERE ~{&KEY-PHRASE} ~
      AND empalert.table_rec_key = ip-rec_key NO-LOCK, ~
      FIRST users WHERE users.user_id = empalert.user-id NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Browser-Table empalert users
&Scoped-define FIRST-TABLE-IN-QUERY-Browser-Table empalert
&Scoped-define SECOND-TABLE-IN-QUERY-Browser-Table users
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      empalert.user-id COLUMN-LABEL "User ID" FORMAT "x(8)":U WIDTH 12
      users.user_name FORMAT "X(30)":U WIDTH 40
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
