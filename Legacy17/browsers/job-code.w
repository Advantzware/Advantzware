...
&SCOPED-DEFINE dataGridInclude dataGrid\browsers\job-code.i
&SCOPED-DEFINE yellowColumnsName job-code
...
&Scoped-define QUERY-STRING-Browser-Table FOR EACH job-code WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Browser-Table OPEN QUERY Browser-Table FOR EACH job-code WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Browser-Table job-code
&Scoped-define FIRST-TABLE-IN-QUERY-Browser-Table job-code
