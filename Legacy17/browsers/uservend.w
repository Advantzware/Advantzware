...
&SCOPED-DEFINE dataGridInclude dataGrid\browsers\uservend.i
...
&Scoped-define INTERNAL-TABLES uservend vend

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE Browser-Table                                 */
&Scoped-define FIELDS-IN-QUERY-Browser-Table uservend.vend-no vend.name uservend.vend_default   
&Scoped-define ENABLED-FIELDS-IN-QUERY-Browser-Table   
&Scoped-define SELF-NAME Browser-Table
&Scoped-define QUERY-STRING-Browser-Table FOR EACH uservend WHERE      uservend.user_id EQ users.user_id AND      uservend.company EQ cocode NO-LOCK, ~
             FIRST vend WHERE             vend.company EQ uservend.company AND             vend.vend-no EQ uservend.vend-no AND             ~{&KEY-PHRASE} NO-LOCK     ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Browser-Table OPEN QUERY {&SELF-NAME} FOR EACH uservend WHERE      uservend.user_id EQ users.user_id AND      uservend.company EQ cocode NO-LOCK, ~
             FIRST vend WHERE             vend.company EQ uservend.company AND             vend.vend-no EQ uservend.vend-no AND             ~{&KEY-PHRASE} NO-LOCK     ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Browser-Table uservend vend
&Scoped-define FIRST-TABLE-IN-QUERY-Browser-Table uservend
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _FREEFORM
  QUERY Browser-Table NO-LOCK DISPLAY
      uservend.vend-no FORMAT "x(8)":U WIDTH 12
      vend.name FORMAT "x(30)":U
      uservend.vend_default COLUMN-LABEL "Default" FORMAT "YES/NO":U
            WIDTH 12
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE Browser-Table
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH uservend WHERE
     uservend.user_id EQ users.user_id AND
     uservend.company EQ cocode NO-LOCK,
      FIRST vend WHERE
            vend.company EQ uservend.company AND
            vend.vend-no EQ uservend.vend-no AND
            ~{&KEY-PHRASE} NO-LOCK
    ~{&SORTBY-PHRASE}.
     _END_FREEFORM
