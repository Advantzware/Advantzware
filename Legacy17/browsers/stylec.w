...
&SCOPED-DEFINE dataGridInclude dataGrid\browsers\stylec.i
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 56 BY 18.1
         FONT 2.
...
"style.dscr" "Description" "x(30)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
