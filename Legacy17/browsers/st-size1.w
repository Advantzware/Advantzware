...
&SCOPED-DEFINE dataGridInclude dataGrid\browsers\st-size1.i
...
&Scoped-define FIELDS-IN-QUERY-br_table item.i-no item.i-name 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      item.i-no FORMAT "x(10)":U
      item.i-name FORMAT "x(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 27 BY 15.24.
...
/* Query rebuild information for BROWSE br_table
     ...
     _OrdList          = "ASI.item.i-no|yes"
     _Where[1]         = "ASI.item.company = gcompany
 AND ASI.item.mat-type = ""D"""
