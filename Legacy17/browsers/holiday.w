...
&SCOPED-DEFINE dataGridInclude dataGrid\browsers\holiday.i
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      reftable.loc COLUMN-LABEL "Date" FORMAT "x(12)":U
      reftable.code COLUMN-LABEL "Holiday" FORMAT "x(24)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
