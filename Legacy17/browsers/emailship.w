...
&SCOPED-DEFINE dataGridInclude dataGrid\browsers\emailship.i
/* Preprocessors */
&SCOPED-DEFINE BRWSDEFS   emailcst
&SCOPED-DEFINE emailTable shipto
&SCOPED-DEFINE browse2    methods/browsers/emailBrowse3.i
...
&Scoped-define INTERNAL-TABLES emaildtl phone shipto
...
&Scoped-define QUERY-STRING-Browser-Table FOR EACH emaildtl OF emailcod  WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      ...
      FIRST shipto WHERE shipto.rec_key = phone.table_rec_key ~
...
&Scoped-define OPEN-QUERY-Browser-Table OPEN QUERY Browser-Table FOR EACH emaildtl OF emailcod  WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      ...
      AND shipto.rec_key = phone.table_rec_key NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Browser-Table emaildtl phone shipto
&Scoped-define FIRST-TABLE-IN-QUERY-Browser-Table emaildtl
&Scoped-define SECOND-TABLE-IN-QUERY-Browser-Table phone
&Scoped-define THIRD-TABLE-IN-QUERY-Browser-Table shipto
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      shipto.cust-no COLUMN-LABEL "Customer":C FORMAT "x(8)":C
            WIDTH 14 LABEL-FGCOLOR 15 LABEL-BGCOLOR 2
      shipto.ship-id COLUMN-LABEL "Ship-To ID" FORMAT "x(8)":U
            WIDTH 14 LABEL-FGCOLOR 15 LABEL-BGCOLOR 2
      shipto.ship-name FORMAT "x(30)":U WIDTH 38 LABEL-FGCOLOR 15 LABEL-BGCOLOR 2
