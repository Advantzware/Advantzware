...
&SCOPED-DEFINE dataGridInclude dataGrid\browsers\emailcod.i
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      emailcod.emailcod FORMAT "X(10)":U
      emailcod.description FORMAT "X(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 63 BY 15
         FONT 2.
...
DEFINE FRAME F-Main
     ...
     Btn_Clear_Find AT ROW 17.43 COL 50 HELP
...
"emailcod.emailcod" ? "X(10)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
