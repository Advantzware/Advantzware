...
&SCOPED-DEFINE dataGridInclude dataGrid\browsers\specnot3.i
...
notes.note_group notes.note_code 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      ...
      notes.note_group FORMAT "X(20)":U
      notes.note_code COLUMN-LABEL "Dept" FORMAT "X(2)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 139 BY 16.67
         FONT 2.
...
DEFINE FRAME F-Main
     ...
     auto_find AT ROW 17.91 COL 70 COLON-ALIGNED HELP
...
"notes.note_title" ? "X(50)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > ASI.notes.note_group
"notes.note_group" ? "X(20)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > ASI.notes.note_code
"notes.note_code" "Dept" ? "character" ? ? ? ? ? ? no "Dept Code" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
