...
item.i-dscr item.i-code item.mat-type item.procat item.cost-type item.q-onh ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      item.i-no FORMAT "x(10)":U LABEL-BGCOLOR 14
      item.i-name FORMAT "x(30)":U LABEL-BGCOLOR 14
      item.i-dscr FORMAT "x(30)":U LABEL-BGCOLOR 14
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 144 BY 16.91
         BGCOLOR 8 FONT 2.
...
/* Query rebuild information for BROWSE Browser-Table
 ...
 AND ASI.item.industry = ""1"""
     _FldNameList[1]   > ASI.item.i-no
"item.i-no" ? ? "character" ? ? ? 14 ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > ASI.item.i-name
"item.i-name" ? ? "character" ? ? ? 14 ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > ASI.item.i-dscr
"item.i-dscr" ? ? "character" ? ? ? 14 ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > ASI.item.i-code
"item.i-code" "Real?" ? "character" ? ? ? ? ? ? no ? no no "6" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > ASI.item.mat-type
"item.mat-type" "Mat'l!Type" ? "character" ? ? ? 14 ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > ASI.item.procat
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE reset-init-values B-table-Win 
PROCEDURE reset-init-values :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
