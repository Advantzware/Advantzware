...
&SCOPED-DEFINE dataGridInclude dataGrid\browsers\invdatef.i
...
&Scoped-define FIELDS-IN-QUERY-br_table ar-inv.inv-no ar-inv.cust-no 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH ar-inv ~
      WHERE ar-inv.company = cocode ~
 AND ar-inv.posted = TRUE NO-LOCK ~
    BY ar-inv.inv-no.
...
&Scoped-Define ENABLED-OBJECTS br_table auto-find clear-btn 
&Scoped-Define DISPLAYED-OBJECTS auto-find 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      ar-inv.cust-no COLUMN-LABEL "Customer No."
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 30 BY 16.91.
...
DEFINE FRAME F-Main
     ...
     auto-find AT ROW 18.38 COL 1
     clear-btn AT ROW 18.38 COL 18
...
/* SETTINGS FOR FILL-IN auto-find IN FRAME F-Main
   ALIGN-L                                                              */
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "ASI.ar-inv"
     _Options          = "NO-LOCK"
     _OrdList          = "ASI.ar-inv.inv-no|yes"
     _Where[1]         = "ASI.ar-inv.company = cocode
 AND ASI.ar-inv.posted = TRUE"
     _FldNameList[1]   > ASI.ar-inv.inv-no
"inv-no" "Invoice" ? "integer" ? ? ? ? ? ? no ""
     _FldNameList[2]   > ASI.ar-inv.cust-no
"cust-no" "Customer No." ? "character" ? ? ? ? ? ? no ""
     _Query            is OPENED
*/  /* BROWSE br_table */
&ANALYZE-RESUME
...
ON ENTRY OF auto-find IN FRAME F-Main
DO:
...
&Scoped-define SELF-NAME clear-btn
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL clear-btn B-table-Win
