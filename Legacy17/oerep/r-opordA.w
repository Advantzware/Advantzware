...
begin_slsmn RECT-6 end_slsmn end_date RECT-7 begin_date begin_carr end_carr ~
RECT-8 tb_scheduled RECT-9 tb_late tb_invoiceable RECT-11 tb_posted ~
tb_invoice tb_completed tb_actual tb_backordered rd_sort tb_qoh-job ~
tb_exp-po rd_print-fg# tb_notes begin_spec end_spec rd-dest lv-ornt ~
lv-font-no lines-per-page tb_excel tb_runExcel fi_file btn-ok btn-cancel 
...
tb_backordered rd_sort tb_qoh-job tb_exp-po rd_print-fg# tb_notes ~
begin_spec end_spec rd-dest lv-ornt lv-font-no lines-per-page lv-font-name ~
...
DEFINE FRAME FRAME-A
     ...
     tb_late AT ROW 12.19 COL 4
     tb_invoiceable AT ROW 13.14 COL 4
     tb_posted AT ROW 14.57 COL 4
     tb_invoice AT ROW 15.67 COL 4
     tb_completed AT ROW 16.81 COL 4
     tb_actual AT ROW 14.57 COL 22.8
     tb_backordered AT ROW 15.76 COL 22.8
     rd_sort AT ROW 11.62 COL 46 NO-LABEL
     tb_qoh-job AT ROW 11.19 COL 101 RIGHT-ALIGNED
     tb_exp-po AT ROW 12.33 COL 101 RIGHT-ALIGNED
     rd_print-fg# AT ROW 11.14 COL 102.6 NO-LABEL
     tb_notes AT ROW 13.62 COL 74
     begin_spec AT ROW 14.71 COL 83.4 COLON-ALIGNED HELP
          "Enter Beginning Carrier Number"
     end_spec AT ROW 14.71 COL 99.8 COLON-ALIGNED HELP
          "Enter Ending Carrier Number"
     rd-dest AT ROW 18.62 COL 6.6 NO-LABEL
     lv-ornt AT ROW 18.62 COL 43.2 NO-LABEL
     lv-font-no AT ROW 20.05 COL 48.2 COLON-ALIGNED
     lines-per-page AT ROW 20.05 COL 106 COLON-ALIGNED
     lv-font-name AT ROW 21.33 COL 48.2 COLON-ALIGNED NO-LABEL
     td-show-parm AT ROW 22.43 COL 50.2
     tb_excel AT ROW 23.43 COL 70.2 RIGHT-ALIGNED
     tb_runExcel AT ROW 23.38 COL 92 RIGHT-ALIGNED
     fi_file AT ROW 24.62 COL 48.2 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 26.38 COL 31
     btn-cancel AT ROW 26.38 COL 79
     "Release Types:" VIEW-AS TEXT
          SIZE 15 BY 1 AT ROW 9.86 COL 2
     "Selection Parameters" VIEW-AS TEXT
          SIZE 21 BY .71 AT ROW 1.19 COL 2.2
          BGCOLOR 2 
     "Print Options:" VIEW-AS TEXT
          SIZE 15 BY 1.19 AT ROW 10 COL 71.4
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 17.76 COL 2.4
     " Sort Options:" VIEW-AS TEXT
          SIZE 15 BY 1 AT ROW 10.05 COL 42.2
...
DEFINE FRAME FRAME-A
     RECT-8 AT ROW 9.81 COL 1
     RECT-9 AT ROW 9.81 COL 39.4 WIDGET-ID 2
     RECT-11 AT ROW 9.81 COL 69 WIDGET-ID 6
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 123.4 BY 27.33.
...
DO:
   apply "close" to this-procedure.
    {Advantzware/WinKit/winkit-panel-triggerend.i} /* added by script _nonAdm1.p on 04.07.2017 @  2:06:49 pm */
END.
...
ON CLOSE OF THIS-PROCEDURE DO:
   RUN disable_UI.
   {Advantzware/WinKit/closewindow-nonadm.i} /* added by script _nonAdm1.p on 04.07.2017 @  2:06:49 pm */
END.
...
/* security check need {methods/prgsecur.i} in definition section */
  ...
  DO WITH FRAME {&FRAME-NAME}:
    {methods/setButton.i btn-cancel "Cancel"} /* added by script _nonAdm1Images2.p on 04.07.2017 @  2:07:39 pm */
    {methods/setButton.i btn-ok "OK"} /* added by script _nonAdm1Images2.p on 04.07.2017 @  2:07:39 pm */
    {custom/usrprint.i}
    APPLY "entry" TO begin_cust-no.
  END.

    {Advantzware/WinKit/embedfinalize-nonadm.i} /* added by script _nonAdm1.p on 04.07.2017 @  2:06:49 pm */
...
------------------------------------------------------------------------------*/
  DISPLAY begin_userid end_userid begin_cust-no end_cust-no begin_ord-no 
          ...
          tb_backordered rd_sort tb_qoh-job tb_exp-po rd_print-fg# tb_notes 
          begin_spec end_spec rd-dest lv-ornt lv-font-no lines-per-page 
          lv-font-name tb_excel tb_runExcel fi_file 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE begin_userid end_userid begin_cust-no end_cust-no begin_ord-no 
         end_ord-no begin_i-no end_i-no begin_loc end_loc begin_slsmn RECT-6 
         end_slsmn end_date RECT-7 begin_date begin_carr end_carr RECT-8 
         tb_scheduled RECT-9 tb_late tb_invoiceable RECT-11 tb_posted 
         tb_invoice tb_completed tb_actual tb_backordered rd_sort tb_qoh-job 
         tb_exp-po rd_print-fg# tb_notes begin_spec end_spec rd-dest lv-ornt 
         lv-font-no lines-per-page tb_excel tb_runExcel fi_file btn-ok 
         btn-cancel 
      WITH FRAME FRAME-A IN WINDOW C-Win.
