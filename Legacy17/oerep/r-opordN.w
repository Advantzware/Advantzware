...
ASSIGN cTextListToSelect = "FG Item,Rel Date,Ord Date,Order#,Cust PO#,Item Name,Routing,Ven PO#,Brd Rcpt," +
       ...
       cFieldType = "c,c,c,i,c,c,c,c,c," + "i,i,i,c,c" 
    .

{sys/inc/ttRptSel.i}
ASSIGN cTextListToDefault  = "Rel Date,Ord Date,Order#,Cust PO#,Item Name,Routing,Ven PO#,Brd Rcpt," +
                             "Qty Order,Qty Comp,Qty Onhand,Ship City,Status"  .
...
tb_late tb_invoiceable tb_posted tb_invoice tb_completed tb_actual ~
tb_backordered rd_sort tb_notes tb_qoh-job begin_spec end_spec sl_avail ~
sl_selected rd-dest lv-ornt lv-font-no lines-per-page lv-font-name tb_excel ~
tb_runExcel fi_file 
...
DEFINE FRAME FRAME-A
     ...
     rd_sort AT ROW 10.05 COL 53 NO-LABEL
     ...
     end_spec AT ROW 11.14 COL 98.4 COLON-ALIGNED HELP
          "Enter Ending Carrier Number"
     sl_avail AT ROW 13.57 COL 32.8 NO-LABEL WIDGET-ID 26
     Btn_Def AT ROW 13.86 COL 70 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 56
     sl_selected AT ROW 13.57 COL 88.2 NO-LABEL WIDGET-ID 28
     ...
     rd-dest AT ROW 20.29 COL 6.6 NO-LABEL
     lv-ornt AT ROW 20.29 COL 43.2 NO-LABEL
     lv-font-no AT ROW 21.71 COL 48.2 COLON-ALIGNED
     lines-per-page AT ROW 21.71 COL 106 COLON-ALIGNED
     lv-font-name AT ROW 23 COL 48.2 COLON-ALIGNED NO-LABEL
     td-show-parm AT ROW 24.1 COL 50.2
     tb_excel AT ROW 25.1 COL 70.2 RIGHT-ALIGNED
     tb_runExcel AT ROW 25.05 COL 92 RIGHT-ALIGNED
     fi_file AT ROW 26.29 COL 48.2 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 28.05 COL 31
     btn-cancel AT ROW 28.05 COL 79
...
DEFINE FRAME FRAME-A
     ...
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 19.43 COL 2.4
...
------------------------------------------------------------------------------*/
  DISPLAY begin_userid end_userid begin_cust-no end_cust-no begin_ord-no 
          ...
          sl_avail sl_selected rd-dest lv-ornt lv-font-no lines-per-page 
  ...
  ENABLE begin_userid end_userid begin_cust-no end_cust-no begin_ord-no 
         ...
         btn-ok btn-cancel RECT-6 RECT-7 RECT-8 RECT-9 
      WITH FRAME FRAME-A IN WINDOW C-Win.
