...
DEF VAR v-date      AS   DATE EXTENT 4 INIT [01/01/01, TODAY].
...
ASSIGN cTextListToSelect  = "Sman,Customer,Inv#,Inv Date,FG Item Code,Order#,Quantity," +
                            "Inv Amt,Date Inv Paid,Amt Paid,Delta,GrossProfit%,Comm Amt,Comm Pct,Basis,Total Cost"  
       cFieldListToSelect = "sman,cust-no,ar-inv.inv-no,ar-inv.inv-date,i-no,ord-no,qty," +
                            "amt,cash-date,amtp,delta,v-gp,v-camt,v-comm,basis,ttl-cst"

       cFieldLength = "4,8,6,10,15,6,9," + "12,13,12,12,12,12,8,5,15"
       .

{sys/inc/ttRptSel.i}
 ASSIGN cTextListToDefault  = "Sman,Customer,Inv#,Inv Date,FG Item Code,Order#,Quantity," +
...
sl_selected Btn_Def Btn_Add Btn_Remove btn_Up btn_down lv-ornt ~
...
lbl_inv rd_inv tb_prep tb_detailed tb_calc sl_avail sl_selected lv-ornt ~
...
DEFINE FRAME FRAME-A
     rcptbe_date AT ROW 2.33 COL 24 COLON-ALIGNED HELP
          "Enter Beginning Date" WIDGET-ID 58
     rcptend_date AT ROW 2.33 COL 67 COLON-ALIGNED HELP
          "Enter Ending Date" WIDGET-ID 60
     begin_date AT ROW 3.38 COL 24 COLON-ALIGNED HELP
          "Enter Beginning Date"
     end_date AT ROW 3.38 COL 67 COLON-ALIGNED HELP
          "Enter Ending Date"
     begin_slsmn AT ROW 4.43 COL 24 COLON-ALIGNED HELP
          "Enter Beginning Sales Rep Number"
     end_slsmn AT ROW 4.43 COL 67 COLON-ALIGNED HELP
          "Enter Ending Sales Rep Number"
     tb_cust-list AT ROW 5.62 COL 26.2 WIDGET-ID 6
     btnCustList AT ROW 5.71 COL 59.6 WIDGET-ID 8
     begin_cust-no AT ROW 6.71 COL 24 COLON-ALIGNED HELP
          "Enter Beginning Customer Number"
     end_cust-no AT ROW 6.71 COL 67 COLON-ALIGNED HELP
          "Enter Ending Customer Number"
     lbl_inv AT ROW 8.05 COL 23 NO-LABEL
     rd_inv AT ROW 8.05 COL 40 NO-LABEL
     tb_prep AT ROW 9.19 COL 40
     tb_detailed AT ROW 9.24 COL 23
     tb_calc AT ROW 10.38 COL 23
     sl_avail AT ROW 12.71 COL 2 NO-LABEL WIDGET-ID 26
     sl_selected AT ROW 12.71 COL 58.8 NO-LABEL WIDGET-ID 28
     Btn_Def AT ROW 12.81 COL 39.4 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 56
     Btn_Add AT ROW 13.91 COL 39.4 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 32
     Btn_Remove AT ROW 15 COL 39.4 HELP
          "Remove Selected Table from Tables to Audit" WIDGET-ID 34
     btn_Up AT ROW 16.1 COL 39.4 WIDGET-ID 40
     btn_down AT ROW 17.19 COL 39.4 WIDGET-ID 42
     lv-ornt AT ROW 19.29 COL 31 NO-LABEL
     lines-per-page AT ROW 19.29 COL 84 COLON-ALIGNED
     rd-dest AT ROW 19.71 COL 6 NO-LABEL
     lv-font-no AT ROW 20.52 COL 34 COLON-ALIGNED
     lv-font-name AT ROW 21.48 COL 28 COLON-ALIGNED NO-LABEL
     td-show-parm AT ROW 22.95 COL 30
     tb_excel AT ROW 24.52 COL 67.8 RIGHT-ALIGNED
     tb_runExcel AT ROW 24.52 COL 89.8 RIGHT-ALIGNED
     fi_file AT ROW 25.38 COL 45.8 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 27.05 COL 23
     btn-cancel AT ROW 27.05 COL 59
     "Selected Columns(In Display Order)" VIEW-AS TEXT
          SIZE 34 BY .62 AT ROW 11.95 COL 59.2 WIDGET-ID 44
     ...
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 18.76 COL 4
...
/* SETTINGS FOR FILL-IN lv-font-name IN FRAME FRAME-A
   NO-ENABLE                                                            */
ASSIGN 
       rcptbe_date:PRIVATE-DATA IN FRAME FRAME-A     = 
                "parm".

ASSIGN 
       rcptend_date:PRIVATE-DATA IN FRAME FRAME-A     = 
                "parm".
...
------------------------------------------------------------------------------*/
  DISPLAY rcptbe_date rcptend_date begin_date end_date begin_slsmn end_slsmn 
          ...
          tb_detailed tb_calc sl_avail sl_selected lv-ornt lines-per-page 
