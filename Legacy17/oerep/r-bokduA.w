...
begin_slsmn end_slsmn tb_ex-msf rd-dest lv-ornt lines-per-page lv-font-no ~
td-show-parm tb_excel tb_runExcel fi_file btn-ok btn-cancel 
&Scoped-Define DISPLAYED-OBJECTS begin_ord-date end_ord-date begin_slsmn ~
end_slsmn tb_ex-msf rd-dest lv-ornt lines-per-page lv-font-no lv-font-name ~
...
DEFINE FRAME FRAME-A
     begin_ord-date AT ROW 3.86 COL 27 COLON-ALIGNED HELP
          "Enter Beginning Order Date"
     end_ord-date AT ROW 3.86 COL 66 COLON-ALIGNED HELP
          "Enter Ending Order Date"
     begin_slsmn AT ROW 4.81 COL 27 COLON-ALIGNED HELP
          "Enter Beginning Sales Rep Number"
     end_slsmn AT ROW 4.81 COL 66 COLON-ALIGNED HELP
          "Enter Ending Sales Rep Number"
     tb_ex-msf AT ROW 6.81 COL 68.4 RIGHT-ALIGNED WIDGET-ID 2
     rd-dest AT ROW 10.76 COL 5 NO-LABEL
     lv-ornt AT ROW 11.24 COL 30 NO-LABEL
     lines-per-page AT ROW 11.24 COL 83 COLON-ALIGNED
     lv-font-no AT ROW 13.14 COL 33 COLON-ALIGNED
     lv-font-name AT ROW 14.1 COL 27 COLON-ALIGNED NO-LABEL
     td-show-parm AT ROW 15.29 COL 29
     tb_excel AT ROW 16 COL 71 RIGHT-ALIGNED
     tb_runExcel AT ROW 16 COL 93 RIGHT-ALIGNED
     fi_file AT ROW 16.95 COL 49 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 18.86 COL 20
...
------------------------------------------------------------------------------*/
  DISPLAY begin_ord-date end_ord-date begin_slsmn end_slsmn tb_ex-msf rd-dest 
          lv-ornt lines-per-page lv-font-no lv-font-name td-show-parm tb_excel 
          tb_runExcel fi_file 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE RECT-7 RECT-8 begin_ord-date end_ord-date begin_slsmn end_slsmn 
         tb_ex-msf rd-dest lv-ornt lines-per-page lv-font-no td-show-parm 
