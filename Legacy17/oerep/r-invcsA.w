...
&Scoped-Define ENABLED-OBJECTS begin_cust-no end_cust-no begin_fg-cat ~
end_fg-cat begin_i-no end_i-no begin_slmn end_slmn begin_inv-date ~
end_inv-date tb_sort tb_prep tb_freight tb_fin-chg rd-dest lv-ornt ~
...
DEFINE VARIABLE fi_file AS CHARACTER FORMAT "X(30)" INITIAL "c:~\tmp~\r-invcst.csv" 
...
DEFINE FRAME FRAME-A
     ...
     end_cust-no AT ROW 2.91 COL 72 COLON-ALIGNED HELP
          "Enter Ending Customer Number"
     begin_fg-cat AT ROW 3.86 COL 29 COLON-ALIGNED HELP
          "Enter Beginning Product Category"
     end_fg-cat AT ROW 3.86 COL 72 COLON-ALIGNED HELP
          "Enter Ending Product Category"
     begin_i-no AT ROW 4.81 COL 29 COLON-ALIGNED HELP
          "Enter Beginning Order Number"
     end_i-no AT ROW 4.81 COL 72 COLON-ALIGNED HELP
          "Enter Ending Item Number"
     begin_slmn AT ROW 5.76 COL 29 COLON-ALIGNED HELP
          "Enter Beginning Sales Rep Number"
     end_slmn AT ROW 5.76 COL 72 COLON-ALIGNED HELP
          "Enter Ending Sales Rep Number"
     begin_inv-date AT ROW 6.71 COL 29 COLON-ALIGNED
     end_inv-date AT ROW 6.71 COL 72 COLON-ALIGNED HELP
          "Enter Ending Due Date"
     tb_sort AT ROW 8.38 COL 33
     tb_prep AT ROW 9.38 COL 33
     tb_freight AT ROW 10.38 COL 33
...
ON VALUE-CHANGED OF tb_sort IN FRAME FRAME-A /* Sort By SalesRep? */
DO:
  assign {&self-name}.
END.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE begin_cust-no end_cust-no begin_fg-cat end_fg-cat begin_i-no end_i-no 
         begin_slmn end_slmn begin_inv-date end_inv-date tb_sort tb_prep 
         tb_freight tb_fin-chg rd-dest lv-ornt lines-per-page lv-font-no 
...
DEF VAR v-cost1     as   char FORMAT "!" init "O".
