...
{sys/inc/ttRptSel.i}
ASSIGN cTextListToDefault  = "Customer Name,Invoice#,FG Item#,Job#,Mat'l Cost," +
                           "Labor Cost,FixOH Cost,VarOH Cost,Total Cost,Sales Amt" .
...
DEFINE FRAME FRAME-A
     ...
     sl_avail AT ROW 11.62 COL 3.4 NO-LABEL WIDGET-ID 26
     Btn_Def AT ROW 11.62 COL 39.6 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 56
     sl_selected AT ROW 11.62 COL 58.8 NO-LABEL WIDGET-ID 28
     Btn_Add AT ROW 12.62 COL 39.6 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 32
     Btn_Remove AT ROW 13.62 COL 39.6 HELP
          "Remove Selected Table from Tables to Audit" WIDGET-ID 34
     btn_Up AT ROW 14.67 COL 39.6 WIDGET-ID 40
     btn_down AT ROW 15.67 COL 39.6 WIDGET-ID 42
     rd-dest AT ROW 18.33 COL 8 NO-LABEL
     lv-ornt AT ROW 18.57 COL 31 NO-LABEL
     lines-per-page AT ROW 18.57 COL 84 COLON-ALIGNED
     lv-font-no AT ROW 20.48 COL 34 COLON-ALIGNED
     lv-font-name AT ROW 21.67 COL 29 COLON-ALIGNED NO-LABEL
     td-show-parm AT ROW 23.33 COL 30
     tb_excel AT ROW 24.52 COL 63 RIGHT-ALIGNED
     tb_runExcel AT ROW 24.52 COL 87 RIGHT-ALIGNED
     fi_file AT ROW 25.48 COL 41 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 27.38 COL 23
     btn-cancel AT ROW 27.38 COL 56
     "Selection Parameters" VIEW-AS TEXT
          SIZE 21 BY .71 AT ROW 1.24 COL 5
          BGCOLOR 2 
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 17.38 COL 5
     "Selected Columns(In Display Order)" VIEW-AS TEXT
          SIZE 34 BY .62 AT ROW 10.86 COL 58.4 WIDGET-ID 44
     "Available Columns" VIEW-AS TEXT
          SIZE 29 BY .62 AT ROW 10.91 COL 4.2 WIDGET-ID 38
     RECT-6 AT ROW 16.91 COL 1
...
------------------------------------------------------------------------------*/
  ...
  ENABLE begin_cust-no end_cust-no begin_fg-cat end_fg-cat begin_i-no end_i-no 
         ...
         RECT-7 sl_avail sl_selected Btn_Def Btn_Add Btn_Remove btn_Up btn_down
      WITH FRAME FRAME-A IN WINDOW C-Win.
