...
ASSIGN cTextListToSelect = "FG ITEM #,NAME,PROD CAT,UOM,CUST. #,CUST NAME,QTY ON HAND," +
                           "CUST PART#,DESC LINE 1,DESC LINE 2,DESC LINE 3,STYLE,BOX L,BOX W,BOX D," +
                           "CASE W,CASE L,CASE D,UNIT COUNT,BOARD CODE,BOARD NAME,CALIPER," +
                           "INK CODE1,INK CODE2,INK CODE3,INK CODE4,INK CODE5,INK CODE6,INK CODE7,INK CODE8,INK CODE9,INK CODE10," +
                           "INK NAME1,INK NAME2,INK NAME3,INK NAME4,INK NAME5,INK NAME6,INK NAME7,INK NAME8,INK NAME9,INK NAME10," +
                           "JOB#,PO#,GROUP"
           cFieldListToSelect = "i-no,i-name,procat,sell-uom,cust-no,cust-name,v-qtyoh," +
                                "part-no,part-dscr1,part-dscr2,part-dscr3,style,l-score,w-score,d-score," +
                                "casew,casel,cased,count,board-code,board-name,caliper," +
                                "ink-cod1,ink-cod2,ink-cod3,ink-cod4,ink-cod5,ink-cod6,ink-cod7,ink-cod8,ink-cod9,ink-cod10," +
           ...
           ASSIGN cTextListToDefault  = "FG ITEM #,NAME,PROD CAT,UOM,CUST. #,CUST NAME,QTY ON HAND," +
...
&Scoped-Define ENABLED-OBJECTS RECT-6 RECT-7 RECT-8 begin_whse end_whse ~
tb_cust-list btnCustList begin_cust-no end_cust-no begin_i-no end_i-no ~
begin_cat end_cat tb_zero tb_cust-whse rd_sort tb_prod-cat sl_avail ~
...
tb_cust-whse lbl_sort rd_sort tb_prod-cat sl_avail sl_selected rd-dest ~
...
DEFINE FRAME FRAME-A
     begin_whse AT ROW 2.33 COL 27 COLON-ALIGNED HELP
          "Enter Beginning Warehouse"
     end_whse AT ROW 2.33 COL 70 COLON-ALIGNED HELP
          "Enter Ending Warehouse"
     tb_cust-list AT ROW 3.62 COL 30.2 WIDGET-ID 6
     btnCustList AT ROW 3.67 COL 62.2 WIDGET-ID 8
     begin_cust-no AT ROW 4.81 COL 27 COLON-ALIGNED HELP
          "Enter Beginning Customer Number"
     end_cust-no AT ROW 4.81 COL 70 COLON-ALIGNED HELP
          "Enter Ending Customer Number"
     begin_i-no AT ROW 5.76 COL 27 COLON-ALIGNED HELP
          "Enter Beginning Order Number"
     end_i-no AT ROW 5.76 COL 70 COLON-ALIGNED HELP
          "Enter Ending Item Number"
     begin_cat AT ROW 6.71 COL 27 COLON-ALIGNED HELP
          "Enter Beginning Category"
     end_cat AT ROW 6.71 COL 70 COLON-ALIGNED HELP
          "Enter Ending Order Number"
     tb_zero AT ROW 7.86 COL 35.8
     tb_cust-whse AT ROW 8.81 COL 35.8
     lbl_sort AT ROW 9.76 COL 26.8 COLON-ALIGNED NO-LABEL
     rd_sort AT ROW 9.76 COL 35.8 NO-LABEL
     tb_prod-cat AT ROW 10.71 COL 35.8
     sl_avail AT ROW 12.62 COL 6.6 NO-LABEL WIDGET-ID 26
     sl_selected AT ROW 12.62 COL 60.6 NO-LABEL WIDGET-ID 28
     Btn_Def AT ROW 12.67 COL 41 HELP
          "Default Selected Table to Tables to Audit" WIDGET-ID 56
     Btn_Add AT ROW 13.81 COL 41 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 32
     Btn_Remove AT ROW 15 COL 41 HELP
          "Remove Selected Table from Tables to Audit" WIDGET-ID 34
     btn_Up AT ROW 16.19 COL 41 WIDGET-ID 40
     btn_down AT ROW 17.38 COL 41 WIDGET-ID 42
     rd-dest AT ROW 19.71 COL 5 NO-LABEL
     lv-ornt AT ROW 20.19 COL 31 NO-LABEL
     lines-per-page AT ROW 20.19 COL 84 COLON-ALIGNED
     lv-font-no AT ROW 21.71 COL 34 COLON-ALIGNED
     lv-font-name AT ROW 22.86 COL 28 COLON-ALIGNED NO-LABEL
     td-show-parm AT ROW 24.1 COL 30
     tb_excel AT ROW 24.76 COL 70 RIGHT-ALIGNED
     tb_runExcel AT ROW 24.76 COL 92 RIGHT-ALIGNED
     fi_file AT ROW 25.71 COL 48 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 27.14 COL 19
     btn-cancel AT ROW 27.14 COL 57
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 19 COL 3
     "Selection Parameters" VIEW-AS TEXT
          SIZE 21 BY .71 AT ROW 1.24 COL 5
          BGCOLOR 2 
     RECT-6 AT ROW 18.76 COL 1.6
     RECT-7 AT ROW 1 COL 1
     RECT-8 AT ROW 12.14 COL 1.4 WIDGET-ID 44
...
DO:
   apply "close" to this-procedure.
    {Advantzware/WinKit/winkit-panel-triggerend.i} /* added by script _nonAdm1.p on 04.18.2017 @ 11:35:59 am */
END.
...
ON CLOSE OF THIS-PROCEDURE DO:
   RUN disable_UI.
   {Advantzware/WinKit/closewindow-nonadm.i} /* added by script _nonAdm1.p on 04.18.2017 @ 11:35:59 am */
END.
...
/* security check need {methods/prgsecur.i} in definition section */
  ...
  DO WITH FRAME {&FRAME-NAME}:
    {methods/setButton.i btn-cancel "Cancel"} /* added by script _nonAdm1Images2.p on 04.18.2017 @ 11:36:57 am */
    {methods/setButton.i btn-ok "OK"} /* added by script _nonAdm1Images2.p on 04.18.2017 @ 11:36:57 am */
    {custom/usrprint.i}
    RUN DisplaySelectionList2.
  ...
  ELSE
   ...
   END.
    ...
    {Advantzware/WinKit/embedfinalize-nonadm.i} /* added by script _nonAdm1.p on 04.18.2017 @ 11:35:59 am */
...
------------------------------------------------------------------------------*/
  DISPLAY begin_whse end_whse tb_cust-list begin_cust-no end_cust-no begin_i-no 
          ...
          tb_prod-cat sl_avail sl_selected rd-dest lv-ornt lines-per-page 
          lv-font-no lv-font-name td-show-parm tb_excel tb_runExcel fi_file 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE RECT-6 RECT-7 RECT-8 begin_whse end_whse tb_cust-list btnCustList 
         begin_cust-no end_cust-no begin_i-no end_i-no begin_cat end_cat 
         tb_zero tb_cust-whse rd_sort tb_prod-cat sl_avail sl_selected Btn_Def 
...
/* ---------------------------------------------- fg/rep/itemlistN.p 9/94 rd */
/* FINISHED GOODS - INVENTORY MASTER FILE LIST                                */
/* -------------------------------------------------------------------------- */

/*{sys/form/r-topw.f}*/

def var casew       AS INT NO-UNDO. 
def var casel       AS INT NO-UNDO. 
def var cased       AS INT NO-UNDO. 
def var unit        AS INT NO-UNDO. 
def var board-code  AS CHAR NO-UNDO.
def var board-name  AS CHAR NO-UNDO.
def var caliper     LIKE ef.cal NO-UNDO.
DEF VAR cInkCode AS CHAR EXTENT 12 NO-UNDO.
DEF VAR cInkDesc AS CHAR EXTENT 12 NO-UNDO.
DEF VAR iInkCount AS INT NO-UNDO.
/* def var ink-cod1    AS CHAR NO-UNDO. */
/* def var ink-cod2    AS CHAR NO-UNDO. */
/* def var ink-cod3    AS CHAR NO-UNDO. */
/* def var ink-cod4    AS CHAR NO-UNDO. */
/* def var ink-cod5    AS CHAR NO-UNDO. */
/* DEF VAR ink-cod6    AS CHAR NO-UNDO. */
/* DEF VAR ink-cod7    AS CHAR NO-UNDO. */
/* DEF VAR ink-cod8    AS CHAR NO-UNDO. */
/* DEF VAR ink-cod9    AS CHAR NO-UNDO. */
/* DEF VAR ink-cod10   AS CHAR NO-UNDO. */
/* DEF VAR ink-cod11   AS CHAR NO-UNDO. */
/* def var ink-cod12   AS CHAR NO-UNDO. */
/* def var ink-nam1    AS CHAR NO-UNDO. */
/* def var ink-nam2    AS CHAR NO-UNDO. */
/* def var ink-nam3    AS CHAR NO-UNDO. */
/* def var ink-nam4    AS CHAR NO-UNDO. */
/* def var ink-nam5    AS CHAR NO-UNDO. */
/* def var ink-nam6    AS CHAR NO-UNDO. */
/* def var ink-nam7    AS CHAR NO-UNDO. */
/* def var ink-nam8    AS CHAR NO-UNDO. */
/* def var ink-nam9    AS CHAR NO-UNDO. */
/* def var ink-nam10   AS CHAR NO-UNDO. */
/* def var ink-nam11   AS CHAR NO-UNDO. */
/* DEF VAR ink-nam12   AS CHAR NO-UNDO. */
DEF VAR cJobNo         AS CHAR NO-UNDO.
DEF VAR cPo          LIKE oe-ordl.po-no NO-UNDO.
...
DEF VAR v-fgitm AS CHAR NO-UNDO.
