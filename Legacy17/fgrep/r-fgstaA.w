...
&Scoped-Define ENABLED-OBJECTS RECT-6 tb_cust-list btnCustList begin_cust ~
end_cust begin_i-no end_i-no rd-dest lv-ornt lines-per-page lv-font-no ~
td-show-parm tb_excel tb_runExcel fi_file btn-ok btn-cancel 
&Scoped-Define DISPLAYED-OBJECTS tb_cust-list begin_cust end_cust ~
begin_i-no end_i-no rd-dest lv-ornt lines-per-page lv-font-no lv-font-name ~
...
DEFINE VARIABLE fi_file AS CHARACTER FORMAT "X(30)" INITIAL "c:~\tmp~\r-fgstat.csv" 
...
DEFINE FRAME FRAME-A
     tb_cust-list AT ROW 2.86 COL 30.8 WIDGET-ID 6
     btnCustList AT ROW 2.91 COL 62.8 WIDGET-ID 8
     ...
     rd-dest AT ROW 8.86 COL 5 NO-LABEL
     lv-ornt AT ROW 8.86 COL 30 NO-LABEL
     lines-per-page AT ROW 8.86 COL 83 COLON-ALIGNED
     lv-font-no AT ROW 11 COL 34 COLON-ALIGNED
     lv-font-name AT ROW 11.95 COL 28 COLON-ALIGNED NO-LABEL
     td-show-parm AT ROW 13.38 COL 30
     tb_excel AT ROW 14.1 COL 71 RIGHT-ALIGNED
     tb_runExcel AT ROW 14.1 COL 93 RIGHT-ALIGNED
     fi_file AT ROW 15.05 COL 49 COLON-ALIGNED HELP
          "Enter File Name"
     ...
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 7.91 COL 2
...
------------------------------------------------------------------------------*/
  DISPLAY tb_cust-list begin_cust end_cust begin_i-no end_i-no rd-dest lv-ornt 
          lines-per-page lv-font-no lv-font-name td-show-parm tb_excel 
          tb_runExcel fi_file 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE RECT-6 tb_cust-list btnCustList begin_cust end_cust begin_i-no 
         end_i-no rd-dest lv-ornt lines-per-page lv-font-no td-show-parm 
