...
begin_cust end_cust list_class rd_sort rd-dest lv-ornt lines-per-page ~
lv-font-no td-show-parm tb_excel tb_runExcel fi_file btn-ok btn-cancel 
&Scoped-Define DISPLAYED-OBJECTS tb_cust-list begin_cust end_cust ~
list_class lbl_sort rd_sort rd-dest lv-ornt lines-per-page lv-font-no ~
...
DEFINE FRAME FRAME-A
     tb_cust-list AT ROW 2.57 COL 31.8 WIDGET-ID 6
     btnCustList AT ROW 2.57 COL 64.2 WIDGET-ID 8
     begin_cust AT ROW 3.91 COL 27 COLON-ALIGNED HELP
          "Enter Beginning Customer Number"
     end_cust AT ROW 3.91 COL 70 COLON-ALIGNED HELP
          "Enter Ending Customer Number"
     list_class AT ROW 5.81 COL 27 COLON-ALIGNED HELP
          "Enter Beginning Inventory Class"
     lbl_sort AT ROW 7.95 COL 25 COLON-ALIGNED NO-LABEL
     rd_sort AT ROW 7.95 COL 37 NO-LABEL
     rd-dest AT ROW 12.19 COL 6 NO-LABEL
     lv-ornt AT ROW 12.43 COL 31 NO-LABEL
     lines-per-page AT ROW 12.43 COL 85 COLON-ALIGNED
...
------------------------------------------------------------------------------*/
  DISPLAY tb_cust-list begin_cust end_cust list_class lbl_sort rd_sort rd-dest 
