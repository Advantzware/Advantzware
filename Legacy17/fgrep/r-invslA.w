...
tb_inc-cust rd_sort rd-dest lv-ornt lines-per-page lv-font-no td-show-parm ~
...
DEFINE FRAME FRAME-A
     tb_cust-list AT ROW 1.71 COL 30.4 WIDGET-ID 6
     btnCustList AT ROW 1.76 COL 62.4 WIDGET-ID 8
     ...
     tb_inc-zer AT ROW 6.48 COL 29
     tb_inc-cust AT ROW 7.43 COL 72 RIGHT-ALIGNED
     lbl_sort AT ROW 8.86 COL 22 COLON-ALIGNED NO-LABEL
     rd_sort AT ROW 8.86 COL 46 NO-LABEL
     ...
     td-show-parm AT ROW 16.95 COL 30
     tb_excel AT ROW 17.91 COL 66.2 RIGHT-ALIGNED
     tb_runExcel AT ROW 17.91 COL 90 RIGHT-ALIGNED
     fi_file AT ROW 19 COL 44 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 20.76 COL 20
...
------------------------------------------------------------------------------*/
  DISPLAY tb_cust-list begin_cust end_cust begin_cust-po end_cust-po begin_slm 
          end_slm tb_inc-zer tb_inc-cust lbl_sort rd_sort rd-dest lv-ornt 
          ...
          **/
          ...
          DO:
            ...
            DO:
              ...
              IF AVAIL sman THEN
              PUT "SALESREP: " tt-itemfg.sales-rep SPACE(2) sman.sname SKIP(1).
              ELSE
              PUT "SALESREP: " tt-itemfg.sales-rep SPACE(2) "UNKNOWN" SKIP(1).
              ASSIGN v-frst = NO.
            END.
            DISPLAY
