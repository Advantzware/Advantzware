...
begin_cust end_cust begin_i-no end_i-no sl_avail Btn_Def sl_selected ~
...
begin_i-no end_i-no sl_avail sl_selected rd-dest lv-ornt lines-per-page ~
...
DEFINE FRAME FRAME-A
     ...
     sl_avail AT ROW 6.29 COL 2.8 NO-LABEL WIDGET-ID 26
     Btn_Def AT ROW 6.43 COL 40.2 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 56
     sl_selected AT ROW 6.43 COL 60.8 NO-LABEL WIDGET-ID 28
     Btn_Add AT ROW 7.43 COL 40.2 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 32
     Btn_Remove AT ROW 8.48 COL 40.2 HELP
          "Remove Selected Table from Tables to Audit" WIDGET-ID 34
     btn_Up AT ROW 9.52 COL 40.2 WIDGET-ID 40
     btn_down AT ROW 10.57 COL 40.2 WIDGET-ID 42
     ...
     tb_excel AT ROW 18.38 COL 71 RIGHT-ALIGNED
     tb_runExcel AT ROW 18.38 COL 93 RIGHT-ALIGNED
     fi_file AT ROW 19.33 COL 49 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 20.76 COL 19
     btn-cancel AT ROW 20.76 COL 57
     "Available Columns" VIEW-AS TEXT
          SIZE 29 BY .62 AT ROW 5.57 COL 3.4 WIDGET-ID 38
     "Selected Columns(In Display Order)" VIEW-AS TEXT
          SIZE 34 BY .62 AT ROW 5.57 COL 60.4 WIDGET-ID 44
     "Selection Parameters" VIEW-AS TEXT
          SIZE 21 BY .71 AT ROW 1.24 COL 5
          BGCOLOR 2 
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 12.19 COL 2
     RECT-6 AT ROW 11.95 COL 1
     RECT-7 AT ROW 5.43 COL 1 WIDGET-ID 58
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-6 RECT-7 tb_cust-list btnCustList begin_cust end_cust begin_i-no 
         end_i-no sl_avail Btn_Def sl_selected Btn_Add Btn_Remove btn_Up 
