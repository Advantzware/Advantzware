...
DEF NEW SHARED VAR cDisplay AS cha NO-UNDO.
DEF NEW SHARED VAR cExcelDisplay AS cha NO-UNDO.
DEF NEW SHARED VAR hField AS HANDLE NO-UNDO.
DEF NEW SHARED VAR cTmpField AS CHA NO-UNDO.
DEF NEW SHARED VAR cVarValue AS cha NO-UNDO.
DEF NEW SHARED VAR cExcelVarValue AS cha NO-UNDO.
DEF NEW SHARED VAR cSelectedList AS cha NO-UNDO.
DEF NEW SHARED VAR cFieldName AS cha NO-UNDO.
DEF NEW SHARED VAR str-tit4 AS cha FORM "x(200)" NO-UNDO.
DEF NEW SHARED VAR str-tit5 AS cha FORM "x(200)" NO-UNDO.
DEF NEW SHARED VAR str-line AS cha FORM "x(300)" NO-UNDO.
DEF NEW SHARED VAR cslist AS cha NO-UNDO.


ASSIGN  cTextListToSelect = "CUSTOMER,ITEM #,CUST PART #,DESCRIPTION,WHSE,BIN,TAG #,JOB #," +
...
{sys/inc/ttRptSel.i}
ASSIGN cTextListToDefault  =  "CUSTOMER,ITEM #,DESCRIPTION,WHSE,BIN,TAG #,JOB #," +
...
&Scoped-Define ENABLED-OBJECTS RECT-6 RECT-7 RECT-8 as-of-date tb_cust-list ~
...
lbl_i-code rd_i-code lbl_sort rd_sort sl_avail sl_selected lv-ornt ~
...
DEFINE FRAME FRAME-A
     ...
     tb_cust-list AT ROW 3.19 COL 30.6 WIDGET-ID 6
     btnCustList AT ROW 3.24 COL 62.6 WIDGET-ID 8
     begin_cust-no AT ROW 4.38 COL 27 COLON-ALIGNED HELP
          "Enter Beginning Customer Number"
     end_cust-no AT ROW 4.38 COL 70 COLON-ALIGNED HELP
          "Enter Ending Customer Number"
     begin_whse AT ROW 5.33 COL 27 COLON-ALIGNED HELP
     ...
     begin_cat AT ROW 7.24 COL 27 COLON-ALIGNED HELP
          "Enter Beginning Category"
     end_cat AT ROW 7.24 COL 70 COLON-ALIGNED HELP
          "Enter Ending Order Number"
     lbl_i-code AT ROW 8.67 COL 3 COLON-ALIGNED NO-LABEL
     rd_i-code AT ROW 8.67 COL 17 NO-LABEL
     lbl_sort AT ROW 9.62 COL 8 COLON-ALIGNED NO-LABEL
     rd_sort AT ROW 9.62 COL 17 NO-LABEL
     sl_avail AT ROW 11.91 COL 3.6 NO-LABEL WIDGET-ID 26
     sl_selected AT ROW 11.91 COL 59 NO-LABEL WIDGET-ID 28
     Btn_Def AT ROW 12.14 COL 39.8 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 56
     Btn_Add AT ROW 13.14 COL 39.8 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 32
     Btn_Remove AT ROW 14.14 COL 39.8 HELP
          "Remove Selected Table from Tables to Audit" WIDGET-ID 34
     btn_Up AT ROW 15.19 COL 39.8 WIDGET-ID 40
     btn_down AT ROW 16.19 COL 39.8 WIDGET-ID 42
     lv-ornt AT ROW 18.67 COL 29.2 NO-LABEL
     lines-per-page AT ROW 18.67 COL 82.2 COLON-ALIGNED
     rd-dest AT ROW 19.05 COL 5 NO-LABEL
     lv-font-no AT ROW 19.95 COL 32.2 COLON-ALIGNED
     lv-font-name AT ROW 21.14 COL 26.2 COLON-ALIGNED NO-LABEL
     td-show-parm AT ROW 22.38 COL 28.2
     tb_excel AT ROW 23.81 COL 65.2 RIGHT-ALIGNED
     tb_runExcel AT ROW 23.81 COL 87.2 RIGHT-ALIGNED
     fi_file AT ROW 24.71 COL 43.2 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 26.48 COL 19
     btn-cancel AT ROW 26.48 COL 57
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 18.33 COL 3
     "Available Columns" VIEW-AS TEXT
          SIZE 29 BY .62 AT ROW 11.14 COL 4.4 WIDGET-ID 38
     "Selected Columns(In Display Order)" VIEW-AS TEXT
          SIZE 34 BY .62 AT ROW 11.14 COL 58.6 WIDGET-ID 44
     "Selection Parameters" VIEW-AS TEXT
          SIZE 21 BY .71 AT ROW 1.24 COL 5
          BGCOLOR 2 
     RECT-6 AT ROW 17.67 COL 1
     RECT-7 AT ROW 1 COL 1
     RECT-8 AT ROW 10.86 COL 1 WIDGET-ID 58
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-6 RECT-7 RECT-8 as-of-date tb_cust-list btnCustList begin_cust-no 
         end_cust-no begin_whse end_whse begin_i-no end_i-no begin_cat end_cat 
     ...
     DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
        cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
             CASE cTmpField:             
                  ...
                  WHEN "msf-oh"   THEN cVarValue = string(v-tot-msf[3],"->>>,>>9.999")  .
                  WHEN "qty-oh"   THEN cVarValue = string(v-tot-qty[3],"->>>,>>9")  .
                  WHEN "cst-uom"  THEN cVarValue = "".
                /*  WHEN "uom-cst"  THEN cVarValue = "". */
                  WHEN "dl-cst"   THEN cVarValue = IF v-prt-c THEN string(v-tot-cst[3],"->>>,>>9.99") ELSE "". 
                  WHEN "mat-cst"  THEN cVarValue = IF v-prt-p THEN string(v-tot-ext[3],"->>>,>>9.99") ELSE "". 
                  WHEN "gs-lbr"   THEN cVarValue = IF v-prt-c THEN string(v-tot-gsl[3],"->>>,>>9.99") ELSE "".  
                  WHEN "gs-mat"   THEN cVarValue = IF v-prt-c THEN string(v-tot-gsm[3],"->>>,>>9.99") ELSE "".  
