...
ASSIGN cTextListToSelect = "Item#,Customer Part#,Description,Re-Order Point,Release Po#,Total On-Hand," +
...
{sys/inc/ttRptSel.i}
ASSIGN cTextListToDefault  = "Item#,Customer Part#,Description,Re-Order Point,Release Po#,Total On-Hand," +
                           "Pallet/Count,Release Qty,Date Req" .
...
list_class lbl_sort rd_sort sl_avail sl_selected rd-dest lv-ornt ~
...
DEFINE VARIABLE fi_file AS CHARACTER FORMAT "X(30)" INITIAL "c:~\tmp~\r-cusinv.csv" 
...
DEFINE FRAME FRAME-A
     ...
     lbl_sort AT ROW 6.14 COL 25 COLON-ALIGNED NO-LABEL
     rd_sort AT ROW 6.14 COL 37 NO-LABEL
     sl_avail AT ROW 8.67 COL 4.6 NO-LABEL WIDGET-ID 26
     Btn_Def AT ROW 8.67 COL 40.6 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 56
     sl_selected AT ROW 8.67 COL 60 NO-LABEL WIDGET-ID 28
     Btn_Add AT ROW 9.67 COL 40.6 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 32
     Btn_Remove AT ROW 10.67 COL 40.6 HELP
          "Remove Selected Table from Tables to Audit" WIDGET-ID 34
     btn_Up AT ROW 11.71 COL 40.6 WIDGET-ID 40
     btn_down AT ROW 12.71 COL 40.6 WIDGET-ID 42
     rd-dest AT ROW 15.38 COL 6 NO-LABEL
     lv-ornt AT ROW 15.62 COL 31 NO-LABEL
     lines-per-page AT ROW 15.62 COL 85 COLON-ALIGNED
     ...
     tb_runExcel AT ROW 20 COL 93 RIGHT-ALIGNED
     fi_file AT ROW 20.91 COL 49 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 23.29 COL 20
     btn-cancel AT ROW 23.29 COL 58
     "Available Columns" VIEW-AS TEXT
          SIZE 29 BY .62 AT ROW 7.95 COL 5.4 WIDGET-ID 38
     "Selection Parameters" VIEW-AS TEXT
          SIZE 21 BY .71 AT ROW 1.48 COL 5
          BGCOLOR 2 
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 14.52 COL 3
     "Selected Columns(In Display Order)" VIEW-AS TEXT
          SIZE 34 BY .62 AT ROW 7.95 COL 60 WIDGET-ID 44
...
ON CLOSE OF THIS-PROCEDURE DO:
   RUN disable_UI.
   {Advantzware/WinKit/closewindow-nonadm.i} /* added by script _nonAdm1.p on 04.18.2017 @ 11:35:57 am */
END.
...
/* security check need {methods/prgsecur.i} in definition section */
  ...
  DO WITH FRAME {&FRAME-NAME}:
    {methods/setButton.i btn-cancel "Cancel"} /* added by script _nonAdm1Images2.p on 04.18.2017 @ 11:36:55 am */
    {methods/setButton.i btn-ok "OK"} /* added by script _nonAdm1Images2.p on 04.18.2017 @ 11:36:55 am */
    {custom/usrprint.i}
    RUN DisplaySelectionList2.
  ...
  IF ou-log AND ou-cust-int = 0 THEN do:
   ...
   END.
    ...
    {Advantzware/WinKit/embedfinalize-nonadm.i} /* added by script _nonAdm1.p on 04.18.2017 @ 11:35:57 am */
            ...
            DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
               cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                    CASE cTmpField:             
                         ...
                         WHEN "re-ord"  THEN cVarValue = STRING(itemfg.ord-level,"->,>>>,>>>,>>>") .
                         WHEN "rel-po"  THEN cVarValue = IF AVAIL oe-rel THEN STRING(oe-rel.po-no,"x(15)") ELSE "" .
                         WHEN "tot-hand"   THEN cVarValue = STRING(itemfg.q-onh,"->>>>,>>>,>>>") .
                         WHEN "pal-co"  THEN cVarValue = STRING(v-pal-cnt,"->>>,>>>,>>>") .
                         WHEN "rel-qty"   THEN cVarValue = STRING("___________") .
                         WHEN "date"  THEN cVarValue = IF AVAIL oe-ordl THEN STRING(oe-ordl.req-date,"99/99/99") ELSE "" .
