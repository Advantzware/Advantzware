...
{sys/inc/ttRptSel.i}
ASSIGN cTextListToDefault  =  "ITEM # ,ITEM NAME,WHSE,BIN,UNITS,COUNT,BIN QTY ITEMS TOTAL,TAG #" 
                            .
...
btn_Up btn_down lines-per-page rd-dest lv-ornt lv-font-no td-show-parm ~
...
tb_cust-whse tb_random sl_avail sl_selected lines-per-page rd-dest lv-ornt ~
...
DEFINE FRAME FRAME-A
     ...
     btnCustList AT ROW 3.1 COL 61.4 WIDGET-ID 8
     ...
     lbl_i-code AT ROW 7.62 COL 4 COLON-ALIGNED NO-LABEL
     rd_i-code AT ROW 7.62 COL 18 NO-LABEL
     ...
     lbl_sort AT ROW 9.33 COL 9 COLON-ALIGNED NO-LABEL
     rd_sort AT ROW 9.33 COL 18 NO-LABEL
     tb_rct-date AT ROW 9.33 COL 56
     tb_cust-whse AT ROW 9.76 COL 50
     lbl_msf AT ROW 10.29 COL 9 COLON-ALIGNED NO-LABEL
     rd_msf AT ROW 10.29 COL 18 NO-LABEL
     ...
     Btn_Def AT ROW 13.05 COL 39 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 56
     sl_selected AT ROW 13.05 COL 58.4 NO-LABEL WIDGET-ID 28
     tb_sell-pr AT ROW 13.48 COL 5
     lbl_price2 AT ROW 13.48 COL 22 COLON-ALIGNED NO-LABEL
     rd_price AT ROW 13.48 COL 30 NO-LABEL
     Btn_Add AT ROW 14.05 COL 39 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 32
     tb_subt AT ROW 14.57 COL 5
     Btn_Remove AT ROW 15.05 COL 39 HELP
          "Remove Selected Table from Tables to Audit" WIDGET-ID 34
     tb_po-num AT ROW 15.05 COL 56
     tb_cust-whse-2 AT ROW 15.52 COL 5
     tb_actrel AT ROW 15.52 COL 50
     btn_Up AT ROW 16.1 COL 39 WIDGET-ID 40
     tb_cost AT ROW 16.71 COL 5
     tb_cost-2 AT ROW 16.71 COL 20
     btn_down AT ROW 17.1 COL 39 WIDGET-ID 42
     lbl_po-type AT ROW 17.43 COL 53 COLON-ALIGNED NO-LABEL
     rd_po-type AT ROW 17.43 COL 73 NO-LABEL
     lines-per-page AT ROW 19.57 COL 84 COLON-ALIGNED
     rd-dest AT ROW 20.05 COL 5 NO-LABEL
     lv-ornt AT ROW 20.05 COL 31 NO-LABEL
     lv-font-no AT ROW 22.19 COL 34 COLON-ALIGNED
     lv-font-name AT ROW 23.14 COL 28 COLON-ALIGNED NO-LABEL
     td-show-parm AT ROW 24.33 COL 30
     tb_excel AT ROW 25.29 COL 68 RIGHT-ALIGNED
     tb_runExcel AT ROW 25.29 COL 92 RIGHT-ALIGNED
     fi_file AT ROW 26.38 COL 46 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 27.91 COL 20
     btn-cancel AT ROW 27.91 COL 57
     "Selected Columns(In Display Order)" VIEW-AS TEXT
          SIZE 34 BY .62 AT ROW 12.33 COL 58.4 WIDGET-ID 44
...
DEFINE FRAME FRAME-A
     ...
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 18.95 COL 3
     "Available Columns" VIEW-AS TEXT
          SIZE 29 BY .62 AT ROW 12.33 COL 3.8 WIDGET-ID 38
     RECT-6 AT ROW 18.62 COL 1
...
------------------------------------------------------------------------------*/
  DISPLAY as-of-date fi_days-old tb_cust-list begin_cust-no end_cust-no begin_whse end_whse begin_loc-bin 
          ...
          sl_avail sl_selected lines-per-page rd-dest lv-ornt lv-font-no 
            ...
            DO i = 1 TO NUM-ENTRIES(cSelectedlist):                             
               cTmpField = entry(getEntryNumber(INPUT cTextListToSelect, INPUT ENTRY(i,cSelectedList)), cFieldListToSelect).
                    CASE cTmpField:             
                         ...
                         WHEN "tot"   THEN cVarValue = STRING(v-tot-qty[3] ,"->>,>>>,>>>,>>>,>>9") .
