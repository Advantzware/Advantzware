...
end_date tb_by-invdt tb_detail begin_account end_account rd-dest lv-ornt ~
...
tb_by-invdt tb_detail begin_account end_account rd-dest lv-ornt ~
...
DEFINE VARIABLE tb_detail AS LOGICAL INITIAL no 
     LABEL "Invoice Line Detail Report?" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME FRAME-A
     ...
     tb_detail AT ROW 6.71 COL 26.2 WIDGET-ID 2
     begin_account AT ROW 7.67 COL 24.2 COLON-ALIGNED HELP
          "Enter Beginning General Ledger Account Number" WIDGET-ID 4
     end_account AT ROW 7.67 COL 66 COLON-ALIGNED HELP
          "Enter Ending General Ledger Account Number" WIDGET-ID 6
     rd-dest AT ROW 11.14 COL 7 NO-LABEL
     lv-ornt AT ROW 11.38 COL 31 NO-LABEL
     lines-per-page AT ROW 11.38 COL 84 COLON-ALIGNED
     ...
     tb_excel AT ROW 16.71 COL 50 RIGHT-ALIGNED
     tb_runExcel AT ROW 16.71 COL 71 RIGHT-ALIGNED
     fi_file AT ROW 17.52 COL 28 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 19.1 COL 26
     btn-cancel AT ROW 19.1 COL 56
     "Selection Parameters" VIEW-AS TEXT
          SIZE 21 BY .71 AT ROW 1.24 COL 5
          BGCOLOR 2 
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 10.19 COL 5
...
ON VALUE-CHANGED OF tb_detail IN FRAME FRAME-A /* Invoice Line Detail Report? */
DO:
  ASSIGN {&self-name}.
...
------------------------------------------------------------------------------*/
  DISPLAY begin_vend end_vend begin_date end_date tb_by-invdt tb_detail 
  ...
  ENABLE RECT-6 RECT-7 begin_vend end_vend begin_date end_date tb_by-invdt 
         tb_detail begin_account end_account rd-dest lv-ornt lines-per-page 
