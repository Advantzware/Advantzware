...
DEFINE BUTTON btn-update 
     LABEL "Load Highlighted Invoices" 
     SIZE 42 BY 1.67
     FONT 6.
...
ON CHOOSE OF btn-update IN FRAME F-Main /* Load Highlighted Invoices */
DO:
  DEF VAR char-hdl AS CHAR NO-UNDO.

  RUN get-link-handle IN adm-broker-hdl(THIS-PROCEDURE,"load-recurring-source",OUTPUT char-hdl).
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
    ...
    IF AVAIL oe-ord THEN
      btn-update:LABEL = IF INDEX("H",oe-ord.stat) GT 0 THEN "&Approve" ELSE "&Hold".
    ELSE DO:
