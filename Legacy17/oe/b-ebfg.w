...
&Scoped-Define ENABLED-OBJECTS Browser-Table btnSave 
...
DEFINE FRAME F-Main
     ...
     btnSave AT ROW 9.1 COL 1
     lv_i-col AT ROW 9.1 COL 15 COLON-ALIGNED HELP
          "Enter Number of Colors for this BLANK."
     lv_i-pass AT ROW 9.1 COL 27.8 COLON-ALIGNED HELP
          "Enter Number of Passes for this Blank."
     lv_i-coat AT ROW 9.1 COL 42 COLON-ALIGNED HELP
          "Enter Number of Coatings for this BLANK"
     lv_i-coat-p AT ROW 9.1 COL 54.8 COLON-ALIGNED HELP
...
------------------------------------------------------------------------------*/
  ...
  IF AVAIL oe-ordl THEN RUN ebfgBuild. /* found in custom/b-ebfg.i */
