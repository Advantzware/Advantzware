...
&Scoped-define QUERY-STRING-Query-Main FOR EACH itemfg WHERE itemfg.company eq eb.company and ~
itemfg.i-no    eq eb.stock-no ~
 NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH itemfg WHERE itemfg.company eq eb.company and ~
itemfg.i-no    eq eb.stock-no ~
 NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "ASI.itemfg WHERE ASI.eb ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _JoinCode[1]      = "itemfg.company eq eb.company and
itemfg.i-no    eq eb.stock-no
"
