...
&Scoped-Define ENABLED-OBJECTS RECT-5 btn-delete 
...
DO:
  ...
  RUN get-link-handle IN adm-broker-hdl(THIS-PROCEDURE,"delete-source",OUTPUT char-hdl).

  IF VALID-HANDLE(WIDGET-HANDLE(char-hdl)) THEN
    RUN hold-approve IN WIDGET-HANDLE(char-hdl) NO-ERROR.
  */    
...
/*       IF oe-ord.stat NE "W" THEN btn-print:HIDDEN = NO.                                */
/*     END.                                                                               */
/*     ELSE DO:                                                                           */
