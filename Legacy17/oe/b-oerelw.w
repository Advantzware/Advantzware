...
&Scoped-Define ENABLED-OBJECTS fi_rel-no fi_ord-no fi_cust-no fi_i-no ~
fi_po-no fi_job-no fi_job-no2 btn_go btn_prev Browser-Table RECT-1 
&Scoped-Define DISPLAYED-OBJECTS fi_rel-no fi_ord-no fi_cust-no fi_i-no ~
fi_po-no fi_job-no fi_job-no2 fi_sort-by 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      ...
      oe-relh.ship-id COLUMN-LABEL "Ship To" FORMAT "x(8)":U LABEL-BGCOLOR 14
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 138 BY 15.71.
...
"oe-relh.ship-id" "Ship To" ? "character" ? ? ? 14 ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > ASI.oe-rell.i-no
