...
&SCOPED-DEFINE dataGridInclude dataGrid\oe\b-oeretl.i
...
&Scoped-define INTERNAL-TABLES oe-retl

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table oe-retl.i-no oe-retl.i-name ~
oe-retl.ord-no oe-retl.tag oe-retl.tot-qty-return oe-retl.qty-return-inv 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH oe-retl WHERE oe-retl.company = oe-reth.company ~
  AND oe-retl.r-no = oe-reth.r-no NO-LOCK ~
    BY oe-retl.i-no
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH oe-retl WHERE oe-retl.company = oe-reth.company ~
  AND oe-retl.r-no = oe-reth.r-no NO-LOCK ~
    BY oe-retl.i-no.
&Scoped-define TABLES-IN-QUERY-br_table oe-retl
&Scoped-define FIRST-TABLE-IN-QUERY-br_table oe-retl
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "ASI.oe-retl WHERE ASI.oe-reth <external> ..."
     _Options          = "NO-LOCK KEY-PHRASE"
     _OrdList          = "ASI.oe-retl.i-no|yes"
     _JoinCode[1]      = "ASI.oe-retl.company = ASI.oe-reth.company
  AND ASI.oe-retl.r-no = ASI.oe-reth.r-no"
     _FldNameList[1]   = ASI.oe-retl.i-no
     _FldNameList[2]   = ASI.oe-retl.i-name
     _FldNameList[3]   > ASI.oe-retl.ord-no
"oe-retl.ord-no" "Order#" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > ASI.oe-retl.tag
"oe-retl.tag" ? "x(20)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > ASI.oe-retl.tot-qty-return
"oe-retl.tot-qty-return" "Cr Memo Qty" ? "decimal" ? ? ? ? ? ? no ? no no "18.2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   = ASI.oe-retl.qty-return-inv
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE refresh-main-browse B-table-Win 
PROCEDURE refresh-main-browse :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
DEF INPUT PARAMETER iprOeReth AS RECID NO-UNDO.  
...
DEF VAR iRetInvQty AS INT NO-UNDO.
DEF BUFFER bf-oe-boll FOR oe-boll.
DEF BUFFER bf-oe-retl FOR oe-retl.
DEF VAR char-hdl AS CHAR NO-UNDO.
DEF BUFFER bf-retl FOR oe-retl .
