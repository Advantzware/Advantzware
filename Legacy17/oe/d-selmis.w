...
&Scoped-define INTERNAL-TABLES tt-mis oe-ordm

/* Definitions for BROWSE BROWSE-2                                      */
&Scoped-define FIELDS-IN-QUERY-BROWSE-2 oe-ordm.charge oe-ordm.actnum oe-ordm.dscr oe-ordm.po-no oe-ordm.amt   
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-2   
&Scoped-define SELF-NAME BROWSE-2
&Scoped-define QUERY-STRING-BROWSE-2 FOR EACH tt-mis, ~
                FIRST oe-ordm WHERE ROWID(oe-ordm) EQ tt-mis.row-id NO-LOCK
&Scoped-define OPEN-QUERY-BROWSE-2 OPEN QUERY {&SELF-NAME}      FOR EACH tt-mis, ~
                FIRST oe-ordm WHERE ROWID(oe-ordm) EQ tt-mis.row-id NO-LOCK.
&Scoped-define TABLES-IN-QUERY-BROWSE-2 tt-mis oe-ordm
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-2 tt-mis
&Scoped-define SECOND-TABLE-IN-QUERY-BROWSE-2 oe-ordm
...
DEFINE FRAME D-Dialog
     ...
     SPACE(4.19) SKIP(1.28)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Select Misc Items to Invoice for Order#"
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Select Misc Items to Invoice for Order# */
DO:
...
DO:
  ...
  IF {&browse-name}:NUM-SELECTED-ROWS GT 0 THEN DO:
    MESSAGE "This will select all highlighted Miscellaneous Charges, " SKIP
...
IF AVAIL oe-ord THEN RUN build-table.
