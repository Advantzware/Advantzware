...
&Scoped-Define ENABLED-OBJECTS Btn-Update RECT-4 
...
ON CHOOSE OF Btn-Update IN FRAME F-Main /* Select Bins/Tags */
DO:
  DEF VAR lFieldsEnabled AS LOG NO-UNDO.
   RUN get-link-handle IN adm-broker-hdl(THIS-PROCEDURE,"fieldsEnabled-source",OUTPUT char-hdl).
   RUN return-fields-Enabled IN WIDGET-HANDLE(char-hdl) (OUTPUT lFieldsEnabled).
...
/* ***************************  Main Block  *************************** */
  ...
  {methods/setButton.i Btn-Update "Select Bins/Tags"} /* added by script c:\tmp\p64604__panelImages.ped */
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
    ENABLE btn-update.
    IF NOT AVAIL oe-bolh OR oe-bolh.posted THEN DISABLE btn-update.
  END.
