...
ASSIGN ls-image1 = IF ip-format BEGINS "f" THEN "images\frank.jpg"
       ...
       /*    v-printline = v-printline + 1 */
          ...
          if v-shipto then do:
            ...
            IF AVAIL shipto THEN DO:
                put oe-rel.po-no AT 2 shipto.ship-name AT 21 FORM "x(28)" lcnt AT 55 FORM ">>9" SPACE(1) ld-date SPACE(1) (IF oe-rel.link-no EQ 0 THEN oe-rel.tot-qty ELSE oe-rel.qty)  SKIP .
                v-printline = v-printline + 1.
                if v-printline ge lv-line-print then
                do:
                    PUT "<R59><C65>Page " string(PAGE-NUM - lv-pg-num,">>9") + " of " + string(lv-tot-pg) FORM "x(20)" .
