...
ELSE DO:
        ...
        PUT "<FArial><=4><R22><C28><P22><B>" tt-word-print.ship-add1 FORMAT "x(30)" "</B>" .
        PUT "<FArial><=4><R24><C28><P22><B>" STRING(tt-word-print.ship-city,"x(15)") " " tt-word-print.ship-state FORMAT "x(2)" " " tt-word-print.ship-zip "</B>" .
        
        PUT  SKIP(3) "<R29><C3><FROM><R29><C80><LINE>" SKIP .
        
        PUT "<R32><C3><#5><FROM><R32><C80><RECT><||3>" SKIP
            "<R37><C3><FROM><R37><C80><LINE><||3>" SKIP  
            "<R32><C3><FROM><R37><C3><LINE><||3>" SKIP
            "<R32><C80><FROM><R37><C80><LINE><||3>" SKIP.
        
        PUT "<FArial><=5><R-2><B><p14> Customer Name </B>" SKIP.
        PUT "<FArial><=5><R+1><B><P27>  " tt-word-print.cust-name FORMAT "x(30)" "</B>" SKIP.
        
        PUT "<R40><C3><#6><FROM><R40><C40><RECT><||3>" SKIP
            "<R44><C3><FROM><R44><C40><LINE><||3>" SKIP  
            "<R40><C3><FROM><R41><C3><LINE><||3>" SKIP
            "<R42><C3><FROM><R44><C3><LINE><||3>" SKIP
            "<R40><C40><FROM><R44><C40><LINE><||3>" SKIP.
        
        PUT "<FArial><=6><R-2><B><p14> PO# </B>" SKIP.
        PUT "<FArial><=6><R41><C4><B><P24>  " tt-word-print.po-no FORMAT ">>>>>>>>>" "</B>" SKIP.
        
        PUT "<R40><C45><#6><FROM><R40><C80><RECT><||3>" SKIP
            "<R44><C45><FROM><R44><C80><LINE><||3>" SKIP 
            "<R40><C45><FROM><R44><C45><LINE><||3>" SKIP
            "<R40><C80><FROM><R44><C80><LINE><||3>" SKIP.
        
        PUT "<FArial><=6><R-2><B><p14> Customer PO# </B>" SKIP.
        PUT "<FArial><=6><R41><C46><B><P24>  " tt-word-print.cust-po-no FORMAT "x(15)" "</B>" SKIP.
        
        
        PUT "<R47><C3><#7><FROM><R47><C80><RECT><||3>" SKIP
            "<R51><C3><FROM><R51><C80><LINE><||3>" SKIP  
            "<R47><C3><FROM><R51><C3><LINE><||3>" SKIP
            "<R47><C80><FROM><R51><C80><LINE><||3>" SKIP.
        
        PUT "<FArial><=7><R-2><B><P14> Item Name </B>" SKIP.
        PUT "<FArial><=7><R47.5><C2><B><P30>  " tt-word-print.i-name FORMAT "x(30)" "</B>" SKIP.
        
        PUT "<R54><C3><#8><FROM><R54><C80><RECT><||3>" SKIP
            "<R60><C3><FROM><R60><C80><LINE><||3>" SKIP  
            "<R54><C3><FROM><R60><C3><LINE><||3>" SKIP
            "<R54><C80><FROM><R60><C80><LINE><||3>" SKIP.
        
        PUT "<FArial><=8><R-2><B><P14> Customer Part# </B>" SKIP.
        PUT "<FArial><=8><R55.5><C2><B><P30>  " tt-word-print.cust-part-no FORMAT "x(15)" "</B>" SKIP.
        
        PUT "<R63><C3><#9><FROM><R63><C80><RECT><||3>" SKIP
            "<R67><C3><FROM><R67><C80><LINE><||3>" SKIP  
            "<R63><C3><FROM><R67><C3><LINE><||3>" SKIP
            "<R63><C80><FROM><R67><C80><LINE><||3>" SKIP.
        
        PUT "<FArial><=9><R-2><B><P14> Finished Goods Item# </B>" SKIP.
        PUT "<FArial><=9><R63.5><C2><B><P30>  " tt-word-print.i-no FORMAT "x(15)" "</B>" SKIP.
        
        PUT "<R70><C3><#10><FROM><R70><C18><RECT><||3>" SKIP
            "<R75><C3><FROM><R75><C18><LINE><||3>" SKIP  
            "<R70><C3><FROM><R75><C3><LINE><||3>" SKIP
            "<R70><C18><FROM><R75><C18><LINE><||3>" SKIP.
        
        PUT "<FArial><=10><R68><C4><B><P22> Qty </B>" SKIP.
        PUT "<FArial><=10><R71><C2><B><P24>  " tt-word-print.total-unit FORMAT ">,>>>,>>9" "</B>" SKIP.
        
        PUT "<R70><C20><#11><FROM><R70><C29><RECT><||3>" SKIP
            "<R75><C20><FROM><R75><C29><LINE><||3>" SKIP  
            "<R70><C20><FROM><R75><C20><LINE><||3>" SKIP
            "<R70><C29><FROM><R75><C29><LINE><||3>" SKIP.
        ...
        PUT "<R70><C35><#12><FROM><R70><C43><RECT><||3>" SKIP
            "<R75><C35><FROM><R75><C43><LINE><||3>" SKIP  
            "<R70><C35><FROM><R75><C35><LINE><||3>" SKIP
            "<R70><C43><FROM><R75><C43><LINE><||3>" SKIP.
        PUT "<FArial><=12><R71><C33.8><B><P24>  " tt-word-print.pcs "</B>" SKIP.
        
        
        PUT "<R70><C45><#13><FROM><R70><C62><RECT><||3>" SKIP
            "<R75><C45><FROM><R75><C62><LINE><||3>" SKIP  
            "<R70><C45><FROM><R75><C45><LINE><||3>" SKIP
            "<R70><C62><FROM><R75><C62><LINE><||3>" SKIP.
        ...
        PUT "<R70><C64><#14><FROM><R70><C80><RECT><||3>" SKIP
            "<R75><C64><FROM><R75><C80><LINE><||3>" SKIP  
            "<R70><C64><FROM><R75><C64><LINE><||3>" SKIP
            "<R70><C80><FROM><R75><C80><LINE><||3>" SKIP.
