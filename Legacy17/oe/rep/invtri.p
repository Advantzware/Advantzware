...
ELSE lv-comp-color = "BLACK".
   ...
   for each report where report.term-id eq v-term-id no-lock,
    ...
    PUT "<R54><C60><#8><FROM><R+5><C+20><RECT> " 
        ...
        "<=8><R+6><C64><P14><B> Thank  You!</B><P10>"
        "<=8><R+5><C65>Page "  string(PAGE-NUM - lv-pg-num,">>9") + " of " + string(lv-tot-pg) FORM "x(20)"
        "<R56><C1><FROM><R+5><C+58><RECT>"
        "<R56><C3><B>COMMENTS:</B>"
        "<R57><C3>" inv-head.bill-i[1] FORMAT "X(70)"
        "<R58><C3>" inv-head.bill-i[2] FORMAT "X(70)"
        "<R59><C3>" inv-head.bill-i[3] FORMAT "X(70)"
        "<R60><C3>" inv-head.bill-i[4] FORMAT "X(70)".
