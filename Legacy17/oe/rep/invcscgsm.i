...
PUT "<FArial><=4><R+1> Ship Date              BOL#                 Ship Via                          Terms                                              Sales Person                  FOB" SKIP
     ...
     inv-head.bol-no SPACE(1)
     v-shipvia FORM "x(14)" SPACE(1)
     xinv-head.terms-d FORM "x(28)" space(2) v-salesman FORM "x(20)" SPACE(1)
     v-fob FORM "x(7)"
    SKIP.
...
PUT "<|10><R25><C1><#5><FROM><R27><C80><RECT>" SKIP    
    ...
    "<R25><C38><FROM><R27><C38><LINE>" SKIP
    "<R25><C58.5><FROM><R27><C58.5><LINE>" SKIP
    "<R25><C67><FROM><R27><C67><LINE>" SKIP
    "<R25><C71><FROM><R27><C71><LINE>" SKIP.   
PUT "<FArial><=5><R+0>                                             Cust PO        Customer Part#" SKIP
