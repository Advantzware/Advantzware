...
ELSE DO:
        ...
        PUT  "<C1><#2>".
         ...
         PUT "<R22><C23><#4><FROM><R22><C80><RECT><||3>" SKIP
            "<R26><C23><FROM><R26><C80><LINE><||3>" SKIP  
            "<R22><C23><FROM><R26><C23><LINE><||3>" SKIP
            "<R22><C80><FROM><R26><C80><LINE><||3>" SKIP.
        
         PUT "<FArial><=4><R23><C3><B><P22> Customer: " "<C25>" tt-word-print.cust-name FORMAT "x(25)"  "</B>" SKIP.
        
         PUT "<R28><C23><#5><FROM><R28><C80><RECT><||3>" SKIP
            "<R32><C23><FROM><R32><C80><LINE><||3>" SKIP  
            "<R28><C23><FROM><R32><C23><LINE><||3>" SKIP
            "<R28><C80><FROM><R32><C80><LINE><||3>" SKIP.
        
         PUT "<FArial><=5><R29><C3><B><P22> MAX# " "<C25>" tt-word-print.cust-name FORMAT "x(25)"   "</B>" SKIP.
        
         PUT "<R34><C23><#6><FROM><R34><C80><RECT><||3>" SKIP
            "<R38><C23><FROM><R38><C80><LINE><||3>" SKIP  
            "<R34><C23><FROM><R38><C23><LINE><||3>" SKIP
            "<R34><C80><FROM><R38><C80><LINE><||3>" SKIP.
        
         PUT "<FArial><=6><R35><C3><B><P22> Size: " "<C25>" tt-word-print.cust-name FORMAT "x(25)"   "</B>" SKIP.
        
         PUT "<R40><C23><#7><FROM><R40><C80><RECT><||3>" SKIP
            "<R44><C23><FROM><R44><C80><LINE><||3>" SKIP  
            "<R40><C23><FROM><R44><C23><LINE><||3>" SKIP
            "<R40><C80><FROM><R44><C80><LINE><||3>" SKIP.
        
         PUT "<FArial><=7><R41><C3><B><P22> Part # " "<C25>" tt-word-print.cust-part FORMAT "x(15)"    "</B>" SKIP.
        
         PUT "<R46><C23><#8><FROM><R46><C80><RECT><||3>" SKIP
            "<R50><C23><FROM><R50><C80><LINE><||3>" SKIP  
            "<R46><C23><FROM><R50><C23><LINE><||3>" SKIP
            "<R46><C80><FROM><R50><C80><LINE><||3>" SKIP.
        
         PUT "<FArial><=8><R47><C3><B><P22> Cust PO# " "<C25>" tt-word-print.cust-po-no  FORMAT "x(15)"   "</B>" SKIP.
        
         PUT "<R52><C23><#9><FROM><R52><C80><RECT><||3>" SKIP
            "<R56><C23><FROM><R56><C80><LINE><||3>" SKIP  
            "<R52><C23><FROM><R56><C23><LINE><||3>" SKIP
            "<R52><C80><FROM><R56><C80><LINE><||3>" SKIP.
        
         PUT "<FArial><=9><R53><C3><B><P22> XPEDX PO: " "<C25>" tt-word-print.po-no FORMAT ">>>>>>>>>>"    "</B>" SKIP.
        
         PUT "<R58><C23><#10><FROM><R58><C80><RECT><||3>" SKIP
            "<R62><C23><FROM><R62><C80><LINE><||3>" SKIP  
            "<R58><C23><FROM><R62><C23><LINE><||3>" SKIP
            "<R58><C80><FROM><R62><C80><LINE><||3>" SKIP.
        
         PUT "<FArial><=10><R59><C3><B><P22> FG Item# " "<C25>"  tt-word-print.i-no FORMAT "x(15)"   "</B>" SKIP.
        
         PUT "<R64><C23><#11><FROM><R64><C80><RECT><||3>" SKIP
            "<R68><C23><FROM><R68><C80><LINE><||3>" SKIP  
            "<R64><C23><FROM><R68><C23><LINE><||3>" SKIP
            "<R64><C80><FROM><R68><C80><LINE><||3>" SKIP.
        
         PUT "<FArial><=11><R65><C3><B><P22> DATE: " "<C25>"  tt-word-print.due-date FORMAT "99/99/99"  "</B>" SKIP.
        
         PUT "<R70><C23><#12><FROM><R70><C80><RECT><||3>" SKIP
            "<R74><C23><FROM><R74><C80><LINE><||3>" SKIP  
            "<R70><C23><FROM><R74><C23><LINE><||3>" SKIP
            "<R70><C80><FROM><R74><C80><LINE><||3>" SKIP.
        
         PUT "<FArial><=12><R71><C3><B><P22> ORDER # " "<C25>" tt-word-print.ord-no FORMAT ">>>>>>>>>"   "</B>" SKIP.
        
         PUT "<R76><C23><#13><FROM><R76><C80><RECT><||3>" SKIP
            "<R80><C23><FROM><R80><C80><LINE><||3>" SKIP  
            "<R76><C23><FROM><R80><C23><LINE><||3>" SKIP
            "<R76><C80><FROM><R80><C80><LINE><||3>" SKIP.
