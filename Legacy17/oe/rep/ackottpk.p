/* ----------------------------------------------- oe/rep/ackottpk.p 06/05 YSK */
/* ORDER ACKNOLEDGEMENT   for OTT Packagings   Task# 06080506                         */
...
{oe/rep/ackottpk.i}
      ...
      for each oe-ordl
        ...
        put /*v-line FORM ">>>9" SPACE(3)*/
                v-part /*oe-ordl.i-no*/ AT 2  SPACE(4)             
       ...
       if v-printline ge lv-line-print then
        ...
        IF v-pdscr2 <> "" THEN do:
            PUT v-pdscr2 FORM "x(30)" AT 21  SKIP.
            v-printline = v-printline + 1.
        END.
        /*
        if v-printline ge lv-line-print then
...
*/
      ...
      PUT "<R55><C1><#10><P12><B> Comments </B> <P10> " 
        ...
        "<R62><C1>" SPACE(32) "<P9><B>THIS IS A CONFIRMATION OF YOUR ORDER,NOT AN INVOICE. "
        "<R63><C40><B>THANK YOU</B> " 
