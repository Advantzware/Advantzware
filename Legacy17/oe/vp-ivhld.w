...
&Scoped-Define ENABLED-OBJECTS RECT-1 btn_hold 
...
ASSIGN 
       btn_hold:PRIVATE-DATA IN FRAME F-Main     = 
                "panel-image".
...
&Scoped-define SELF-NAME btn_hold
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn_hold V-table-Win
ON CHOOSE OF btn_hold IN FRAME F-Main /* Hold */
DO:
    SESSION:SET-WAIT-STATE("general").
    DEF VAR char-hdl AS cha NO-UNDO.
    RUN get-link-handle IN adm-broker-hdl (THIS-PROCEDURE,"hold-target", OUTPUT char-hdl).
    RUN hold-invoice IN WIDGET-HANDLE(char-hdl).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE set-status-btn-lbl V-table-Win 
PROCEDURE set-status-btn-lbl :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
   DEFINE INPUT PARAMETER ip-status AS CHAR NO-UNDO.
