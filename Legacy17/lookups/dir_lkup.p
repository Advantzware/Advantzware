...
"dirname " ~
"Directory Lookup " ~
"{methods/lookups/ttbldir.i} ~{sys/inc/varasgn.i} " ~
"{methods/defines/ttbldir.i} ~{sys/inc/var.i new shared} " ~
" " ~
" " ~
*/
...
&Scoped-define top-include ~{methods/lookups/ttbldir.i} ~{sys/inc/varasgn.i}
&Scoped-define def-include ~{methods/defines/ttbldir.i} ~{sys/inc/var.i new shared}
