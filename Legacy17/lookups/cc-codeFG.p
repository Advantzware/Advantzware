...
"no " ~
"cc-code " ~
"FG Cycle Count Code Lookup " ~
"{custom/getcmpny.i} ~{methods/lookups/cc-code.i itemfg} ~{sys/inc/varasgn.i} " ~
"{custom/gcompany.i} ~{methods/defines/cc-code.i itemfg} ~{sys/inc/var.i new shared} " ~
" " ~
" " ~
*/
