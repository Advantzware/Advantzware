...
&SCOPED-DEFINE dataGridInclude dataGrid\jcinq\b-jmchqi.i
&SCOPED-DEFINE yellowColumnsName b-jmchqi
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _FREEFORM
  QUERY br_table NO-LOCK DISPLAY
      ...
      mch.run-std  COLUMN-LABEL "Std Run Qty" FORMAT ">>,>>>,>>9":U LABEL-BGCOLOR 14
      mch.run-act  COLUMN-LABEL "Act Run Qty" FORMAT ">>,>>>,>>9":U LABEL-BGCOLOR 14
      mch.run-var  COLUMN-LABEL "Run Qty Var" FORMAT "->>,>>>,>>9":U LABEL-BGCOLOR 14
      mch.mr-std   COLUMN-LABEL "Std MR Qty" FORMAT ">>,>>>,>>9":U LABEL-BGCOLOR 14
      mch.mr-act   COLUMN-LABEL "Act MR Qty" FORMAT ">>,>>>,>>9":U LABEL-BGCOLOR 14
      mch.mr-var   COLUMN-LABEL "MR Qty Var" FORMAT "->>,>>>,>>9":U LABEL-BGCOLOR 14
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 129 BY 13.57
         BGCOLOR 8 FONT 2
         TITLE BGCOLOR 8 "Machine Quantity Variance".
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* Machine Quantity Variance */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* Machine Quantity Variance */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON START-SEARCH OF br_table IN FRAME F-Main /* Machine Quantity Variance */
DO:
  RUN startSearch.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* Machine Quantity Variance */
DO:
