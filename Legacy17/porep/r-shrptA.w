...
rd_show select-mat rd_print tb_late tb_printNotes rd-dest lv-ornt ~
...
select-mat lbl_print rd_print tb_late mat-types tb_printNotes rd-dest ~
...
DEFINE FRAME FRAME-A
     ...
     lbl_show AT ROW 7.19 COL 1 COLON-ALIGNED NO-LABEL
     rd_show AT ROW 7.19 COL 11 NO-LABEL
     select-mat AT ROW 7.91 COL 66 NO-LABEL
     lbl_print AT ROW 8.38 COL 1 COLON-ALIGNED NO-LABEL
     rd_print AT ROW 8.38 COL 11 NO-LABEL
     tb_late AT ROW 9.57 COL 15
     mat-types AT ROW 9.81 COL 62 COLON-ALIGNED
     tb_printNotes AT ROW 10.52 COL 15
     ...
     td-show-parm AT ROW 18.62 COL 32
     tb_excel AT ROW 20.05 COL 52 RIGHT-ALIGNED
     tb_runExcel AT ROW 20.05 COL 73 RIGHT-ALIGNED
     fi_file AT ROW 20.86 COL 30 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 22.43 COL 26
     btn-cancel AT ROW 22.43 COL 56
     "Select/Deselect RM Types" VIEW-AS TEXT
          SIZE 31 BY 1 AT ROW 6.95 COL 64
          FONT 6
     "Output Destination" VIEW-AS TEXT
          SIZE 18 BY .62 AT ROW 13.38 COL 4
...
------------------------------------------------------------------------------*/
  DISPLAY begin_vend-no end_vend-no begin_due-date end_due-date begin_procat 
          end_procat begin_cat end_cat lbl_show rd_show select-mat lbl_print 
          rd_print tb_late mat-types tb_printNotes rd-dest lv-ornt 
  ...
  ENABLE RECT-6 RECT-7 begin_vend-no end_vend-no begin_due-date end_due-date 
         begin_procat end_procat begin_cat end_cat rd_show select-mat rd_print 
         tb_late tb_printNotes rd-dest lv-ornt lines-per-page lv-font-no 
...
IF tb_excel THEN DO:
  ...
  ELSE IF v-sort EQ "I" THEN
     excelheader = "ITEM NO,ITEM NAME,VEND NO,P/O#,"
                 + "P/O DATE,UOM,QTY ORDER,QTY RECEIVED,REQ DATE,CARRIER,"
                 + "JOB NO".
  ELSE
     excelheader = "VENDOR NO,VENDOR NAME,ITEM NO,ITEM NAME,P/O#,"
                 + "P/O DATE,QTY ORDER,QTY RECEIVED,REQ DATE,MSF,CARRIER,"
                 + "JOB NO".
