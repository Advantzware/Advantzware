...
&Scoped-define FIELDS-IN-QUERY-BROWSE-1 job-mat.rm-i-no item.i-name ~
job-mat.blank-no job-mat.frm item.i-code 
...
and job-mat.job-no2 = job.job-no2 NO-LOCK, ~
      EACH item OF job-mat NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-BROWSE-1 job-mat item
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-1 Dialog-Frame _STRUCTURED
  QUERY BROWSE-1 NO-LOCK DISPLAY
      job-mat.rm-i-no FORMAT "x(10)":U
      item.i-name FORMAT "x(30)":U
      job-mat.blank-no FORMAT ">9":U
      job-mat.frm FORMAT ">>9":U
      item.i-code FORMAT "X":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE BROWSE-1
     _TblList          = "ASI.job-mat,ASI.item OF ASI.job-mat"
...
and job-mat.job-no2 = job.job-no2"
     ...
     _FldNameList[3]   = ASI.job-mat.blank-no
     _FldNameList[4]   = ASI.job-mat.frm
     _FldNameList[5]   = ASI.item.i-code
     _Query            is OPENED
*/  /* BROWSE BROWSE-1 */
&ANALYZE-RESUME
