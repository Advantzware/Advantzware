...
ON END-ERROR OF W-Win /* Fix Cash Receipt Dates */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Fix Cash Receipt Dates */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE add-the-links W-Win 
PROCEDURE add-the-links :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
  ...
  IF NOT VALID-HANDLE(WIDGET-HANDLE(char-hdl)) THEN
          RUN add-link IN adm-broker-hdl (ip-handle, "record", h_chkdatef-2).
  op-handle = h_chkdatef-2.
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_chkdatef-2 ).
       RUN set-position IN h_chkdatef-2 ( 1.00 , 2.00 ) NO-ERROR.
       RUN set-size IN h_chkdatef-2 ( 7.86 , 54.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'viewers/chkdatef.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_chkdatef ).
       RUN set-position IN h_chkdatef ( 2.67 , 57.00 ) NO-ERROR.
