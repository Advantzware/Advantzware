...
(item.mat-type = ip-mat-type or ip-mat-type = "") NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
DEFINE FRAME Dialog-Frame
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         TITLE "~"Raw Materials Information (~" + ip-mat-type + )".
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* "Raw Materials Information (" + ip-mat-type + ) */
DO:
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  FIND FIRST mat WHERE mat.mat EQ ip-mat-type NO-LOCK NO-ERROR.
  lv-type-dscr = IF AVAIL mat AND ip-mat-type NE "" THEN mat.dscr ELSE "ALL".
