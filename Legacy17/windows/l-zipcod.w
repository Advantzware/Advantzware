...
&scoped-define fld-name-2 zipcode.city  
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-1 zipcode.zipcode zipcode.city ~
zipcode.state 
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Zipcode Lookup */
DO:
...
DO: 
    ASSIGN
    op-char-val = zipcode.zipcode 
    op-city-val = zipcode.city 
    op-state-val = zipcode.state.
