...
&SCOPED-DEFINE h_Browse01 h_scores
...
DEFINE VARIABLE h_scores AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'add-item':U , h_scores ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updsav ,
             h_folder , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_scores ,
             h_p-updsav , 'AFTER':U ).
    END. /* Page 1 */
