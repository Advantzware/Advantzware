...
def input parameter ip-po as cha no-undo.
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-1 po-ordl.i-no po-ordl.i-name ~
po-ordl.job-no po-ordl.job-no2 po-ordl.s-wid po-ordl.s-len 
...
po-ordl.po-no = integer(ip-po) and ~
po-ordl.i-no = ip-cur-val NO-LOCK ~
    ~{&SORTBY-PHRASE}
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* PO Job Information */
DO:
