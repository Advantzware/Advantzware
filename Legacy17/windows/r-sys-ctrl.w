...
&Scoped-Define ENABLED-OBJECTS RECT-7 RECT-8 begin_prep end_prep rd-dest ~
lv-ornt lines-per-page lv-font-no td-show-parm btn-cancel btn-ok 
&Scoped-Define DISPLAYED-OBJECTS begin_prep end_prep rd-dest lv-ornt ~
...
------------------------------------------------------------------------------*/
  DISPLAY begin_prep end_prep rd-dest lv-ornt lines-per-page lv-font-no 
          lv-font-name td-show-parm 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE RECT-7 RECT-8 begin_prep end_prep rd-dest lv-ornt lines-per-page 
         lv-font-no td-show-parm btn-cancel btn-ok 
      WITH FRAME FRAME-A IN WINDOW C-Win.
...
display "" with frame r-top.
 ...
 FOR EACH prep WHERE prep.company = g_company
  ...
  prep.actnum WITH FRAME prep DOWN WIDTH 150.
