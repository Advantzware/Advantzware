...
DEF BUFFER bf-comp FOR usercomp.
...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES usercomp users
&Scoped-define FIRST-EXTERNAL-TABLE usercomp


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR usercomp, users.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS usercomp.company usercomp.company_default 
...
&Scoped-Define DISPLAYED-FIELDS usercomp.company usercomp.company_default 
...
DEFINE FRAME F-Main
     usercomp.company AT ROW 1.24 COL 12 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 7 BY 1
          BGCOLOR 15 FONT 4
     usercomp.company_default AT ROW 1.24 COL 24
          LABEL "Default"
          VIEW-AS TOGGLE-BOX
          SIZE 12 BY 1
     F1 AT ROW 1 COL 21 NO-LABEL
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: ASI.usercomp,NOSWEAT.users
...
/* SETTINGS FOR TOGGLE-BOX usercomp.company_default IN FRAME F-Main
   EXP-LABEL                                                            */
...
------------------------------------------------------------------------------*/
  ...
  IF usercomp.company_default THEN 
     FOR EACH bf-comp WHERE bf-comp.USER_id = users.user_id AND
                            bf-comp.loc = "" AND
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute AFTER standard behavior.    */
  {methods/viewers/create/usrcmp-c.i}
  ...
  /* Code placed here will execute PRIOR to standard behavior. */
    IF usercomp.company_default:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "yes" THEN DO:
      ...
      FIND FIRST bf-comp WHERE bf-comp.USER_id = users.USER_id AND
                           ...
                           RECID(bf-comp) <> RECID (usercomp)
                           NO-LOCK NO-ERROR.
     IF AVAIL bf-comp THEN DO:
        MESSAGE "Are you sure you want to reset the default company to " 
           usercomp.company:SCREEN-VALUE IN FRAME {&FRAME-NAME}
