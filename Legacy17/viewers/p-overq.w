...
&Scoped-Define ENABLED-OBJECTS RECT-25 btn-override-qty 
...
DEFINE BUTTON btn-override-qty 
     LABEL "&Override Qtys" 
     SIZE 16 BY 1.67.
...
DEFINE FRAME F-Main
     btn-override-qty AT ROW 1.19 COL 1.6
...
&Scoped-define SELF-NAME btn-override-qty
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn-override-qty V-table-Win
ON CHOOSE OF btn-override-qty IN FRAME F-Main /* Override Qtys */
DO:
...
/* ***************************  Main Block  *************************** */
  ...
  {methods/setButton.i btn-override-qty "Override Qtys"} /* added by script c:\tmp\p64604__panelImages.ped */
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
    IF NOT v-can-update THEN btn-override-qty:SENSITIVE = NO.
  END.
