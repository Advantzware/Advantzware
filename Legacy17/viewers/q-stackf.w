...
&Scoped-define QUERY-STRING-Query-Main FOR EACH stack-flute WHERE stack-flute.company  = gcompany ~
AND  stack-flute.loc  = gloc ~
  AND stack-flute.code = flute.code NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH stack-flute WHERE stack-flute.company  = gcompany ~
AND  stack-flute.loc  = gloc ~
  AND stack-flute.code = flute.code NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main stack-flute
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main stack-flute
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "ASI.stack-flute Where ASI.reftable ... ... ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _JoinCode[1]      = "ASI.stack-flute.company  = gcompany
...
------------------------------------------------------------------------------*/
  ...
  DO WHILE ROWID(stack-flute) NE ip-rowid:
