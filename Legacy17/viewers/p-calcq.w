...
DEFINE FRAME F-Main
     btn-recalc-qty AT ROW 1.19 COL 1.6
...
DO:
  ...
  IF VALID-HANDLE(WIDGET-HANDLE(char-hdl)) THEN DO:
    RUN check-security IN WIDGET-HANDLE(char-hdl) (3, OUTPUT ll-secure).
    IF NOT ll-secure THEN RETURN NO-APPLY.
  END.

  run get-link-handle in adm-broker-hdl (this-procedure, "calc-qty-source", output char-hdl).
  run calc-qty in widget-handle(char-hdl).
...
/* ***************************  Main Block  *************************** */
  ...
  {methods/setButton.i btn-recalc-qty "Recalc Qtys"} /* added by script c:\tmp\p64604__panelImages.ped */
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute AFTER standard behavior.    */
   DO WITH FRAME {&FRAME-NAME}:
    IF NOT v-can-update THEN btn-recalc-qty:SENSITIVE = NO.
  END.
END PROCEDURE.
