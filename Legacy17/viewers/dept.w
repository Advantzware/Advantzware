...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES dept
&Scoped-define FIRST-EXTERNAL-TABLE dept
...
&Scoped-define ADM-CREATE-FIELDS dept.code 
...
DEFINE FRAME F-Main
     dept.code AT ROW 1.24 COL 15 COLON-ALIGNED
          LABEL "Department"
          VIEW-AS FILL-IN 
          SIZE 4.4 BY 1
          BGCOLOR 15 FONT 4
     dept.dscr AT ROW 2.43 COL 15 COLON-ALIGNED
          ...
          SIZE 32 BY 1
          BGCOLOR 15 FONT 4
     dept.fc AT ROW 3.62 COL 15 COLON-ALIGNED
          LABEL "Sequence"
          VIEW-AS FILL-IN 
          SIZE 4.4 BY 1
...
/* SETTINGS FOR FILL-IN dept.code IN FRAME F-Main
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "dept"}

  /* Get the record ROWID's from the RECORD-SOURCE.                  */
  {src/adm/template/row-get.i}

  /* FIND each record specified by the RECORD-SOURCE.                */
  {src/adm/template/row-find.i "dept"}
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  def var lv-old-fc like dept.fc no-undo.
  ...
  if dept.fc ne lv-old-fc then do: 
    assign
     lv-new-fc = dept.fc
     i         = lv-new-fc.
