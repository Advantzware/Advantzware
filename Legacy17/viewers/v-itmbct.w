...
&Scoped-Define ENABLED-OBJECTS RECT-40 btn-set-base-cost 
...
DEFINE BUTTON btn-set-base-cost 
     LABEL "&Update Base Cost" 
...
DEFINE FRAME F-Main
     btn-set-base-cost AT ROW 1.24 COL 1.8 HELP
          "Set all Base Cost from FG Item Average Cost"
...
&Scoped-define SELF-NAME btn-set-base-cost
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn-set-base-cost V-table-Win
ON CHOOSE OF btn-set-base-cost IN FRAME F-Main /* Update Base Cost */
DO:
...
/* ***************************  Main Block  *************************** */
  ...
  {methods/setButton.i btn-set-base-cost "Update Base Cost"} /* added by script c:\tmp\p64604__panelImages.ped */
