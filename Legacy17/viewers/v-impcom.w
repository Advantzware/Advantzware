...
ASSIGN 
       btn-excel:PRIVATE-DATA IN FRAME F-Main     = 
                "panel-image".
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn-excel V-table-Win
ON CHOOSE OF btn-excel IN FRAME F-Main /* Import Excel */
DO:
...
/* ***************************  Main Block  *************************** */
  ...
  {methods/setButton.i btn-excel "Import Excel"} /* added by script c:\tmp\p64604__panelImages.ped */
