...
&Scoped-Define ENABLED-FIELDS quotehd.q-no quotehd.quo-date 
...
DEFINE FRAME F-Main
     quotehd.q-no AT ROW 1.71 COL 19 COLON-ALIGNED FORMAT ">>>>>9"
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
     quotehd.quo-date AT ROW 1.71 COL 52 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
