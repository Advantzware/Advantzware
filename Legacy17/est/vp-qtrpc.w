...
&Scoped-Define ENABLED-OBJECTS RECT-1 btn_reprice 
...
ASSIGN 
       btn_reprice:PRIVATE-DATA IN FRAME F-Main     = 
                "panel-image".
...
&Scoped-define SELF-NAME btn_reprice
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn_reprice V-table-Win
...
/* ***************************  Main Block  *************************** */
  ...
  {methods/setButton.i btn_reprice "Reprice"} /* added by script c:\tmp\p64604__panelImages.ped */
...
------------------------------------------------------------------------------*/
  ...
  IF NOT v-can-update THEN btn_reprice:SENSITIVE IN FRAME {&FRAME-NAME} = NO.
