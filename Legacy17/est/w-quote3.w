...
DEFINE VARIABLE h_b-ord AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b-ordl AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_p-orditm AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v-ordl AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Brws Order|View Order|Items|Misc. Chgs|Release|Estimate|Order Total' + ',
                     FOLDER-TAB-TYPE = 2':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-ord ).
       RUN set-position IN h_b-ord ( 4.81 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 19.52 , 145.00 ) */

       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('2,4') NO-ERROR.

       /* Links to SmartNavBrowser h_b-ord. */
       RUN add-link IN adm-broker-hdl ( h_p-navico , 'Navigation':U , h_b-ord ).
       RUN add-link IN adm-broker-hdl ( h_p-navico-2 , 'Navigation':U , h_b-ord ).
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = Yes':U ,
             OUTPUT h_v-ord ).
       RUN set-position IN h_v-ord ( 4.81 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 16.67 , 143.00 ) */
       ...
       RUN add-link IN adm-broker-hdl ( h_b-ord , 'Record':U , h_v-ord ).
       RUN add-link IN adm-broker-hdl ( h_p-updsav , 'TableIO':U , h_v-ord ).
    ...
    WHEN 3 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-ordl ).
       RUN set-position IN h_b-ordl ( 6.24 , 3.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = Yes':U ,
             OUTPUT h_v-ordl ).
       RUN set-position IN h_v-ordl ( 10.52 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 14.05 , 128.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-orditm ).
       RUN set-position IN h_p-orditm ( 11.48 , 134.00 ) NO-ERROR.
       RUN set-size IN h_p-orditm ( 11.67 , 14.00 ) NO-ERROR.
       ...
       /* Links to SmartBrowser h_b-ordl. */
       RUN add-link IN adm-broker-hdl ( h_v-ord , 'Record':U , h_b-ordl ).

       /* Links to SmartViewer h_v-ordl. */
       RUN add-link IN adm-broker-hdl ( h_b-ordl , 'Record':U , h_v-ordl ).
       RUN add-link IN adm-broker-hdl ( h_p-orditm , 'TableIO':U , h_v-ordl ).
    ...
    WHEN 4 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     Right-to-Left = First-On-Left':U ,
             OUTPUT h_p-navico-2 ).
       RUN set-position IN h_p-navico-2 ( 16.48 , 15.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updsav-2 ).
       RUN set-position IN h_p-updsav-2 ( 16.48 , 72.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_p-updsav-2 , 'TableIO':U , h_b-ordm ).
    ...
    WHEN 5 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-ordrel ).
       RUN set-position IN h_b-ordrel ( 10.29 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.00 , 132.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updsav-4 ).
       RUN set-position IN h_p-updsav-4 ( 21.24 , 43.00 ) NO-ERROR.
       RUN set-size IN h_p-updsav-4 ( 1.76 , 56.00 ) NO-ERROR.

       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('3') NO-ERROR.

       /* Links to SmartViewer h_vi-ordl. */
       RUN add-link IN adm-broker-hdl ( h_b-ordl , 'Record':U , h_vi-ordl ).

       /* Links to SmartBrowser h_b-ordrel. */
       RUN add-link IN adm-broker-hdl ( h_b-ordl , 'Record':U , h_b-ordrel ).
       RUN add-link IN adm-broker-hdl ( h_p-updsav-4 , 'TableIO':U , h_b-ordrel ).
