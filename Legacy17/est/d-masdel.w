...
def output param ls-del-what as cha no-undo.
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Delete Option */
DO:  
...
ON CHOOSE OF Btn_est IN FRAME D-Dialog /* Estimate */
DO:
    assign ls-del-what = "est".
    apply "window-close" to this-procedure.
END.
...
&Scoped-define SELF-NAME Btn_frm
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Btn_frm D-Dialog
ON CHOOSE OF Btn_frm IN FRAME D-Dialog /* Form */
DO:
    assign ls-del-what = "form".
    apply "window-close" to this-procedure.
END.
