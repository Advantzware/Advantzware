...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD GetCESample V-table-Win 
FUNCTION GetCESample RETURNS CHARACTER
...
DO:
    ...
    RUN get-link-handle IN adm-broker-hdl(THIS-PROCEDURE,"specprt-target",OUTPUT char-hdl).
    IF VALID-HANDLE(WIDGET-HANDLE(char-hdl)) THEN
       RUN print-spec IN WIDGET-HANDLE(char-hdl).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION GetCESample V-table-Win 
FUNCTION GetCESample RETURNS CHARACTER
