...
ON CHOOSE OF print-box IN FRAME F-Main /* Print Box */
DO:
    DEF VAR char-hdl AS cha NO-UNDO.

    RUN get-link-handle IN adm-broker-hdl(THIS-PROCEDURE,"boxprt-target",OUTPUT char-hdl).
...
/* ***************************  Main Block  *************************** */
  ...
  {methods/setButton.i print-box "Print Box"} /* added by script c:\tmp\p64604__panelImages.ped */
