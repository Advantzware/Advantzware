/* ------------------------------------------- cec/quote/quosoulemed.p 04/09 GDM */
...
IF (not ch-multi) THEN DO:
    ...
    {cec/quote/quosoule2med.i}

    {cec/quote/quosoulemed.i 1}
...
PROCEDURE verBage:
    ...
    PUT 
     ...
     " <P13><B>*</B><P10> <B>Visit our Website at www.soulemedical.com</B>"                              SKIP   
     .


    PUT "<|5><R57><C1><#5><FROM><R64><C80><RECT>" SKIP    
        "<C2><R57.5><#6><P12><B>CUSTOMER ACCEPTANCE: </B><P9>" SKIP
        "<=6><R59>"
        "Signature below by an authorized representative of Customer authorizes Soule Medical Company (and its designated affiliates)" SKIP
        "<=6><R60>"
        ...
        " " SKIP
        "          4322 Pet Lane Lutz, Florida 33559-6349 " "     Phone  813-907-6051    Fax  (813) 907-6092         <B>www.soulemedical.com</B>"
        .
