...
&Global-define FLDNAME1 tt-bank
&Global-define FORMAT-1 x(8)
&Global-define SORTBY-1 BY {&FLDNAME1} BY tt-date BY tt-type BY tt-number
&Global-define IDXNAME1 
&Global-define DESCRIP1 Bank
&Global-define FLDNAME2 tt-number
&Global-define FORMAT-2 x(20)
&Global-define SORTBY-2 BY {&FLDNAME2} {&SORTBY-1}
&Global-define IDXNAME2 
&Global-define DESCRIP2 Check/Journal#
&Global-define FLDNAME3 tt-vend
