/* tt-prdd.i   temp-table for tt-prdd
"ASI" "tt-prdd"
"job-no" "Job#" ""
"m-code" "Machine#" ""
"i-no" "Item#" ""
...
&Global-define FLDNAME1 tt-prdd.m-code
&Global-define FORMAT-1 X(6)
&Global-define SORTBY-1 BY tt-prdd.m-code BY tt-prdd.startx BY tt-prdd.stopx
&Global-define IDXNAME1 
&Global-define DESCRIP1 Machine#
&Global-define FLDNAME2 tt-prdd.startx 
&Global-define FORMAT-2 99:99
&Global-define SORTBY-2 BY tt-prdd.startx BY tt-prdd.stopx {&SORTBY-1}
&Global-define IDXNAME2 
&Global-define DESCRIP2 Time
&Global-define FLDNAME3 tt-prdd.i-no
&Global-define FORMAT-3 X(15)
&Global-define SORTBY-3 BY tt-prdd.i-no {&SORTBY-1}
