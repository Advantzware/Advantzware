...
&Global-define FLDNAME1 rm-rdtl.loc
&Global-define FORMAT-1 X(5)
&Global-define SORTBY-1 
&Global-define IDXNAME1 
&Global-define DESCRIP1 Warehouse
&Global-define FLDNAME2 rm-rdtl.loc-bin
&Global-define FORMAT-2 X(8)
&Global-define SORTBY-2 
&Global-define IDXNAME2 
&Global-define DESCRIP2 Primary Bin Loc.
&Global-define FLDNAME3 rm-rdtl.tag
&Global-define FORMAT-3 X(8)
&Global-define SORTBY-3 
&Global-define IDXNAME3 
&Global-define DESCRIP3 
&Global-define FLDNAME4 rm-rdtl.qty
&Global-define DATATYP4 DECIMAL
&Global-define FORMAT-4 ->>>>>>9.9<<
