...
"no"
*/
&Global-define FLDNAME1 pc-prdd.job-no
&Global-define FORMAT-1 X(6)
&Global-define SORTBY-1 BY pc-prdd.job-no BY pc-prdd.job-no2 BY pc-prdd.start BY pc-prdd.stopp
&Global-define IDXNAME1 
&Global-define DESCRIP1 Job#
&Global-define FLDNAME2 pc-prdd.startx
&Global-define FORMAT-2 99:99
&Global-define SORTBY-2 BY pc-prdd.start BY pc-prdd.stopp {&SORTBY-1}
&Global-define IDXNAME2 
&Global-define DESCRIP2 Time
&Global-define FLDNAME3 pc-prdd.i-no
&Global-define FORMAT-3 X(15)
&Global-define SORTBY-3 BY pc-prdd.i-no {&SORTBY-1}
