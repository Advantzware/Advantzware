...
&Global-define SORTBY-1 BY {&FLDNAME1} BY ATTACH.est-no
&Global-define IDXNAME1 
&Global-define DESCRIP1 Attached File
&Global-define FLDNAME2 attach.file-type
&Global-define FORMAT-2 X(8)
&Global-define SORTBY-2 BY {&FLDNAME2}
&Global-define IDXNAME2 
&Global-define DESCRIP2 File Type
&Global-define FLDNAME3 STRING(ATTACH.creat-date)
&Global-define FORMAT-3 99/99/9999
&Global-define SORTBY-3 BY {&FLDNAME3} DESC {&SORTBY-2} 
&Global-define IDXNAME3 
&Global-define DESCRIP3 Created Date
&Global-define FLDNAME4 ATTACH.est-no
&GLOBAL-DEFINE FORMAT-4 X(10)
&Global-define SORTBY-4 BY {&FLDNAME4}
&Global-define IDXNAME4 
&Global-define DESCRIP4 Invoice #
