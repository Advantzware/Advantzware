...
&Global-define FLDNAME1 ap-pay.bank-code
&Global-define FORMAT-1 X(8)
&Global-define SORTBY-1 BY ap-pay.bank-code BY ap-pay.check-no
&Global-define IDXNAME1 
&Global-define DESCRIP1 Bank Code
&Global-define FLDNAME2 ap-pay.check-no
&Global-define DATATYP2 INTEGER
&Global-define FORMAT-2 99999999
&Global-define SORTBY-2 BY ap-pay.check-no {&SORTBY-1}
&Global-define IDXNAME2 
&Global-define DESCRIP2 Check No
&Global-define FLDNAME3 ap-pay.vend-no
&Global-define FORMAT-3 X(8)
&Global-define SORTBY-3 BY ap-pay.vend-no {&SORTBY-2}
&Global-define IDXNAME3 
&Global-define DESCRIP3 Vendor
