...
&{&DEFINETYPE}-define TABLENAME fgcat
&{&DEFINETYPE}-define DBFIELD1 fgcat.procat
...
&{&DEFINETYPE}-define DBFIELD2 fgcat.dscr
&{&DEFINETYPE}-define BEGINFLD2 begin_fgcat_dscr
&{&DEFINETYPE}-define BEGIN-DEFAULT-2 yes
&{&DEFINETYPE}-define ENDFLD2 end_fgcat_dscr
...
&{&DEFINETYPE}-define SAVENAME fgcat
