...
tb_detailed rd-dest lv-ornt lines-per-page lv-font-no td-show-parm tb_excel ~
...
DEFINE FRAME FRAME-A
     begin_carr-no AT ROW 4.1 COL 27 COLON-ALIGNED HELP
          "Enter Beginning Carrier Number"
     end_carr-no AT ROW 4.1 COL 64 COLON-ALIGNED HELP
          "Enter Ending Carrier Number"
     tb_detailed AT ROW 6.24 COL 44
     rd-dest AT ROW 10.52 COL 7 NO-LABEL
     ...
     td-show-parm AT ROW 14.57 COL 30.4
     tb_excel AT ROW 16.48 COL 50.2 RIGHT-ALIGNED
     tb_runExcel AT ROW 16.48 COL 71.2 RIGHT-ALIGNED
     fi_file AT ROW 17.29 COL 28.2 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 19.57 COL 21
...
DO:
   apply "close" to this-procedure.
    {Advantzware/WinKit/winkit-panel-triggerend.i} /* added by script _nonAdm1.p on 04.18.2017 @ 11:35:49 am */
END.
...
ON CLOSE OF THIS-PROCEDURE DO:
   RUN disable_UI.
   {Advantzware/WinKit/closewindow-nonadm.i} /* added by script _nonAdm1.p on 04.18.2017 @ 11:35:49 am */
END.
...
/* security check need {methods/prgsecur.i} in definition section */
  ...
  DO WITH FRAME {&FRAME-NAME}:
    {methods/setButton.i btn-cancel "Cancel"} /* added by script _nonAdm1Images2.p on 04.18.2017 @ 11:36:50 am */
    {methods/setButton.i btn-ok "OK"} /* added by script _nonAdm1Images2.p on 04.18.2017 @ 11:36:50 am */
    {custom/usrprint.i}
    APPLY "entry" TO begin_carr-no.
  END.

    {Advantzware/WinKit/embedfinalize-nonadm.i} /* added by script _nonAdm1.p on 04.18.2017 @ 11:35:49 am */
...
------------------------------------------------------------------------------*/
  DISPLAY begin_carr-no end_carr-no tb_detailed rd-dest lv-ornt lines-per-page 
          lv-font-no lv-font-name td-show-parm tb_excel tb_runExcel fi_file 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE RECT-6 RECT-7 begin_carr-no end_carr-no tb_detailed rd-dest lv-ornt 
...
for each carrier
  ...
  for each carr-mtx
      ...
      no-lock with frame carrier:

      {custom/statusMsg.i " 'Processing Carrier/Zon#  '  + carrier.carrier + '/' + carr-mtx.del-zip "}
    ...
    DO:
       ...
       ASSIGN 
          ...
          carr-mtrx-printed = YES.
    END.

    do i = 1 to 10:
      if i eq 1 then
        put "          Weight (lbs.) UP TO           Rate / 100lbs."
            skip.
