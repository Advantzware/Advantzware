...
ASSIGN cTextListToSelect = "Customer,Cust Name,Cust Address1,Cust Address2,Cust City,C State,Cust Zip," +
...
{sys/inc/ttRptSel.i}
ASSIGN cTextListToDefault  = "Customer,Cust Name,Cust Address1,Cust Address2,Cust City,C State,Cust Zip," +
                           "Ship To,Shipto Name,Shipto Address1,Shipto Address2,Shipto City,S State,Shipto Zip," +
                           "Phone,Fax,Contact,Email,Rep,Sales Rep Name,Terr." .
...
lv-ornt lines-per-page lv-font-no tb_show-parm tb_excel tb_runExcel fi_file ~
btn-ok btn-cancel 
...
rd-dest lv-ornt lines-per-page lv-font-no lv-font-name tb_show-parm ~
...
DEFINE FRAME FRAME-A
     tb_cust-list AT ROW 1.71 COL 36 WIDGET-ID 6
     btnCustList AT ROW 1.76 COL 68.4 WIDGET-ID 8
     begin_cust-no AT ROW 3.05 COL 27 COLON-ALIGNED HELP
          "Enter Beginning Customer Number"
     end_cust-no AT ROW 3.05 COL 70 COLON-ALIGNED HELP
          "Enter Ending Customer Number"
     begin_cust-type AT ROW 4 COL 27 COLON-ALIGNED HELP
          "Enter Beginning Customer Type"
     end_cust-type AT ROW 4 COL 70 COLON-ALIGNED HELP
          "Enter Ending Customer Type"
     begin_slsmn AT ROW 4.95 COL 27 COLON-ALIGNED HELP
          "Enter Beginning Sales Rep Number"
     end_slsmn AT ROW 4.95 COL 70 COLON-ALIGNED HELP
          "Enter Ending Sales Rep Number"
     begin_date AT ROW 5.91 COL 27 COLON-ALIGNED HELP
          "Enter Beginning Since Date"
     end_date AT ROW 5.91 COL 70 COLON-ALIGNED HELP
          "Enter Ending Since Date"
     tb_active AT ROW 7.1 COL 56 RIGHT-ALIGNED
     tb_inactive AT ROW 8.1 COL 57 RIGHT-ALIGNED
     price-level AT ROW 9.1 COL 36 COLON-ALIGNED
     lbl_sort AT ROW 10.05 COL 29 COLON-ALIGNED NO-LABEL
     rd_sort AT ROW 10.1 COL 38 NO-LABEL
     sl_avail AT ROW 12.24 COL 4.8 NO-LABEL WIDGET-ID 26
     Btn_Def AT ROW 12.24 COL 40.8 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 56
     sl_selected AT ROW 12.24 COL 60.2 NO-LABEL WIDGET-ID 28
     Btn_Add AT ROW 13.24 COL 40.8 HELP
          "Add Selected Table to Tables to Audit" WIDGET-ID 32
     Btn_Remove AT ROW 14.24 COL 40.8 HELP
          "Remove Selected Table from Tables to Audit" WIDGET-ID 34
     btn_Up AT ROW 15.29 COL 40.8 WIDGET-ID 40
     btn_down AT ROW 16.29 COL 40.8 WIDGET-ID 42
     rd-dest AT ROW 18.33 COL 8 NO-LABEL
     lv-ornt AT ROW 18.81 COL 32 NO-LABEL
     lines-per-page AT ROW 18.81 COL 85 COLON-ALIGNED
     lv-font-no AT ROW 20.24 COL 35 COLON-ALIGNED
     lv-font-name AT ROW 21.19 COL 29 COLON-ALIGNED NO-LABEL
     tb_show-parm AT ROW 22.29 COL 31
     tb_excel AT ROW 23.48 COL 51 RIGHT-ALIGNED
     tb_runExcel AT ROW 23.48 COL 53
     fi_file AT ROW 24.81 COL 29 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 26.67 COL 24
     btn-cancel AT ROW 26.67 COL 56
     "Selected Columns(In Display Order)" VIEW-AS TEXT
          SIZE 34 BY .62 AT ROW 11.52 COL 60.2 WIDGET-ID 44
     "Available Columns" VIEW-AS TEXT
          SIZE 29 BY .62 AT ROW 11.52 COL 5.6 WIDGET-ID 38
     "(99 for all)" VIEW-AS TEXT
          SIZE 10 BY 1 AT ROW 9.1 COL 43
...
------------------------------------------------------------------------------*/
  DISPLAY tb_cust-list begin_cust-no end_cust-no begin_cust-type end_cust-type 
          ...
          price-level lbl_sort rd_sort sl_avail sl_selected rd-dest lv-ornt 
