...
rd_showCode rd-dest lv-ornt lines-per-page lv-font-no tb_show-parm tb_excel ~
...
tb_active tb_inactive price-level lbl_sort rd_sort rd_showCode rd-dest ~
...
DEFINE VARIABLE rd_showCode AS CHARACTER INITIAL "Both" 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "Customer", "Customer",
"ShipTo", "ShipTo",
...
DEFINE FRAME FRAME-A
     tb_cust-list AT ROW 2.14 COL 38.6 WIDGET-ID 6
     btnCustList AT ROW 2.19 COL 71 WIDGET-ID 8
     begin_cust-no AT ROW 3.48 COL 27 COLON-ALIGNED HELP
          "Enter Beginning Customer Number"
     end_cust-no AT ROW 3.48 COL 70 COLON-ALIGNED HELP
          "Enter Ending Customer Number"
     begin_cust-type AT ROW 4.43 COL 27 COLON-ALIGNED HELP
          "Enter Beginning Customer Type"
     end_cust-type AT ROW 4.43 COL 70 COLON-ALIGNED HELP
          "Enter Ending Customer Type"
     begin_slsmn AT ROW 5.38 COL 27 COLON-ALIGNED HELP
          "Enter Beginning Sales Rep Number"
     end_slsmn AT ROW 5.38 COL 70 COLON-ALIGNED HELP
          "Enter Ending Sales Rep Number"
     begin_date AT ROW 6.33 COL 27 COLON-ALIGNED HELP
          "Enter Beginning Since Date"
     end_date AT ROW 6.33 COL 70 COLON-ALIGNED HELP
          "Enter Ending Since Date"
     tb_active AT ROW 7.76 COL 56 RIGHT-ALIGNED
     tb_inactive AT ROW 8.76 COL 57 RIGHT-ALIGNED
     price-level AT ROW 9.76 COL 36 COLON-ALIGNED
     lbl_sort AT ROW 10.71 COL 29 COLON-ALIGNED NO-LABEL
     rd_sort AT ROW 10.76 COL 38 NO-LABEL
     rd_showCode AT ROW 11.81 COL 38 NO-LABEL
     ...
     tb_show-parm AT ROW 18.52 COL 31
     tb_excel AT ROW 19.71 COL 51 RIGHT-ALIGNED
     tb_runExcel AT ROW 19.71 COL 53
     fi_file AT ROW 21.05 COL 29 COLON-ALIGNED HELP
          "Enter File Name"
     btn-ok AT ROW 22.52 COL 24
     btn-cancel AT ROW 22.52 COL 56
     "Show:" VIEW-AS TEXT
          SIZE 7 BY .95 AT ROW 11.81 COL 31
     ...
     "(99 for all)" VIEW-AS TEXT
          SIZE 10 BY 1 AT ROW 9.76 COL 43
...
DO:
   apply "close" to this-procedure.
    {Advantzware/WinKit/winkit-panel-triggerend.i} /* added by script _nonAdm1.p on 04.07.2017 @  2:06:24 pm */
END.
...
&Scoped-define SELF-NAME rd_showCode
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL rd_showCode C-Win
ON VALUE-CHANGED OF rd_showCode IN FRAME FRAME-A
DO:
  assign {&self-name}.
END.
...
ON CLOSE OF THIS-PROCEDURE DO:
   RUN disable_UI.
   {Advantzware/WinKit/closewindow-nonadm.i} /* added by script _nonAdm1.p on 04.07.2017 @  2:06:24 pm */
END.
...
/* security check need {methods/prgsecur.i} in definition section */
  ...
  DO WITH FRAME {&FRAME-NAME}:
    {methods/setButton.i btn-cancel "Cancel"} /* added by script _nonAdm1Images2.p on 04.07.2017 @  2:07:24 pm */
    {methods/setButton.i btn-ok "OK"} /* added by script _nonAdm1Images2.p on 04.07.2017 @  2:07:24 pm */
    {custom/usrprint.i}
  ...
  ELSE
   ...
   END.
    ...
    {Advantzware/WinKit/embedfinalize-nonadm.i} /* added by script _nonAdm1.p on 04.07.2017 @  2:06:24 pm */
...
------------------------------------------------------------------------------*/
  DISPLAY tb_cust-list begin_cust-no end_cust-no begin_cust-type end_cust-type 
          ...
          price-level lbl_sort rd_sort rd_showCode rd-dest lv-ornt 
  ...
  ENABLE RECT-6 RECT-7 tb_cust-list btnCustList begin_cust-no end_cust-no 
         ...
         end_date tb_active tb_inactive price-level rd_sort rd_showCode rd-dest 
         lv-ornt lines-per-page lv-font-no tb_show-parm tb_excel tb_runExcel 
...
if rd_sort EQ "Customer#"     then {ar/rep/custship.i "cust-no" "use-index cust"}
else
if rd_sort EQ "Customer Name" then {ar/rep/custship.i "name" "use-index name"}
else                               {ar/rep/custship.i "date-field[1]"}
