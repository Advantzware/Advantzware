/* --------------------------------------------- cec/rep/jobtick6.p 08/05 ysk */
/*  factory ticket   fOR ARTIOS PER BLANK   FROM JOBTICK2.P                   */
/* -------------------------------------------------------------------------- */
...
DEF SHARED VAR v-adder-1 AS CHAR FORMAT "X(10)" NO-UNDO.
DEF SHARED VAR v-adder-2 AS CHAR FORMAT "X(10)" NO-UNDO.
DEF SHARED VAR v-adder-3 AS CHAR FORMAT "X(10)" NO-UNDO.
DEF SHARED VAR v-adder-4 AS CHAR FORMAT "X(10)" NO-UNDO.
DEF SHARED VAR v-adder-5 AS CHAR FORMAT "X(10)" NO-UNDO.
DEF SHARED VAR v-adder-6 AS CHAR FORMAT "X(10)" NO-UNDO.
...
if avail xest then do:
  ...
  if avail xef then do:
    ...
    ASSIGN
       ...
       v-adder-1 = xef.adder[1]
       v-adder-2 = xef.adder[2]
       v-adder-3 = xef.adder[3]
       v-adder-4 = xef.adder[4]
       v-adder-5 = xef.adder[5]
       v-adder-6 = xef.adder[6]
