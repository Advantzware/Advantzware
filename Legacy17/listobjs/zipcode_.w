...
{methods/defines/s-pref.i &NEW="NEW GLOBAL"}
...
&Scoped-Define ENABLED-OBJECTS RECT-1 list-order RECT-2 begin_zipcode ~
end_zipcode 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_zipcode ~
begin_zipcode_city end_zipcode end_zipcode_city F1 F-2 F-3 F-4 
...
DEFINE VARIABLE begin_zipcode AS CHARACTER FORMAT "X(10)" 
     LABEL "Beginning  Zipcode" 
     VIEW-AS FILL-IN 
     SIZE 15.6 BY 1.

DEFINE VARIABLE begin_zipcode_city AS CHARACTER FORMAT "X(30)" 
     LABEL "Beginning City" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE end_zipcode AS CHARACTER FORMAT "X(10)" 
     LABEL "Ending Zipcode" 
     VIEW-AS FILL-IN 
     SIZE 15.6 BY 1.

DEFINE VARIABLE end_zipcode_city AS CHARACTER FORMAT "X(30)" 
     LABEL "Ending City" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.
...
DEFINE FRAME F-Main
     ...
     begin_zipcode AT ROW 4.81 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Zipcode"
     begin_zipcode_city AT ROW 6 COL 45 COLON-ALIGNED HELP
          "Enter Beginning City"
     end_zipcode AT ROW 8.14 COL 45 COLON-ALIGNED HELP
          "Enter Ending Zipcode"
     end_zipcode_city AT ROW 9.33 COL 45 COLON-ALIGNED HELP
          "Enter Ending City"
...
/* SETTINGS FOR FILL-IN begin_zipcode_city IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN end_zipcode_city IN FRAME F-Main
   NO-ENABLE                                                            */
