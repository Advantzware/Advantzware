...
&Scoped-Define ENABLED-OBJECTS RECT-1 list-order RECT-2 begin_statecod ~
end_statecod 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_statecod ~
begin_statecod_description end_statecod end_statecod_description F1 F-2 F-3 ~
F-4 
...
DEFINE VARIABLE begin_statecod AS CHARACTER FORMAT "X(10)" 
     LABEL "Beginning  State Abbreviation" 
     VIEW-AS FILL-IN 
     SIZE 7 BY 1.

DEFINE VARIABLE begin_statecod_description AS CHARACTER FORMAT "X(30)" 
     LABEL "Beginning State Name" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.

DEFINE VARIABLE end_statecod AS CHARACTER FORMAT "X(10)" 
     LABEL "Ending State Abbreviation" 
     VIEW-AS FILL-IN 
     SIZE 7 BY 1.

DEFINE VARIABLE end_statecod_description AS CHARACTER FORMAT "X(30)" 
     LABEL "Ending State Name" 
     VIEW-AS FILL-IN 
     SIZE 44 BY 1.
...
DEFINE FRAME F-Main
     ...
     begin_statecod AT ROW 4.81 COL 45 COLON-ALIGNED HELP
          "Enter Beginning State Abbreviation"
     begin_statecod_description AT ROW 6 COL 45 COLON-ALIGNED HELP
          "Enter Beginning State Name"
     end_statecod AT ROW 8.14 COL 45 COLON-ALIGNED HELP
          "Enter Ending State Abbreviation"
     end_statecod_description AT ROW 9.33 COL 45 COLON-ALIGNED HELP
          "Enter Ending State Name"
     F1 AT ROW 4.81 COL 54 NO-LABEL
     F-2 AT ROW 6 COL 91 NO-LABEL
     F-3 AT ROW 8.14 COL 54 NO-LABEL
...
/* SETTINGS FOR FILL-IN begin_statecod_description IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN end_statecod_description IN FRAME F-Main
   NO-ENABLE                                                            */
