...
begin_due-date end_due-date rd-dest lv-ornt lines-per-page lv-font-no ~
td-show-parm tb_excel tb_runExcel fi_file btn-ok btn-cancel 
&Scoped-Define DISPLAYED-OBJECTS begin_cust-no end_cust-no begin_due-date ~
end_due-date rd-dest lv-ornt lines-per-page lv-font-no lv-font-name ~
...
DEFINE FRAME FRAME-A
     begin_cust-no AT ROW 4.33 COL 27 COLON-ALIGNED HELP
          "Enter Beginning Customer Number"
     end_cust-no AT ROW 4.33 COL 70 COLON-ALIGNED HELP
     ...
     td-show-parm AT ROW 15.19 COL 31
     tb_excel AT ROW 17.24 COL 51 RIGHT-ALIGNED
     tb_runExcel AT ROW 17.24 COL 72 RIGHT-ALIGNED
     fi_file AT ROW 18.05 COL 29 COLON-ALIGNED HELP
          "Enter File Name"
...
------------------------------------------------------------------------------*/
  DISPLAY begin_cust-no end_cust-no begin_due-date end_due-date rd-dest lv-ornt 
    ...
    for each tt-report,
      ...
      IF tb_excel THEN
         PUT STREAM excel UNFORMATTED
             '"' (IF v-date NE ? THEN STRING(v-date) ELSE "")    '",'
