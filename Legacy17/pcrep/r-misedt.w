...
end_job-no end_job-no2 begin_date end_date rd-dest lv-ornt lines-per-page ~
lv-font-no td-show-parm tb_excel tb_runExcel fi_file btn-ok btn-cancel 
&Scoped-Define DISPLAYED-OBJECTS begin_job-no begin_job-no2 end_job-no ~
end_job-no2 begin_date end_date rd-dest lv-ornt lines-per-page lv-font-no ~
...
DEFINE FRAME FRAME-A
     ...
     lv-font-name AT ROW 14.33 COL 30 COLON-ALIGNED NO-LABEL
     td-show-parm AT ROW 16.24 COL 31
     tb_excel AT ROW 17.62 COL 51 RIGHT-ALIGNED WIDGET-ID 4
     tb_runExcel AT ROW 17.62 COL 72 RIGHT-ALIGNED WIDGET-ID 6
     fi_file AT ROW 18.43 COL 29 COLON-ALIGNED HELP
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Miscellaneous Edit Report"
         HEIGHT             = 21.81
         WIDTH              = 95.8
         MAX-HEIGHT         = 33.29
         MAX-WIDTH          = 204.8
...
ON END-ERROR OF C-Win /* Miscellaneous Edit Report */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Miscellaneous Edit Report */
DO:
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
 ...
 ASSIGN
  ...
  {methods/nowait.i}
   ...
   APPLY "entry" TO Begin_job-no IN FRAME {&FRAME-NAME}.
...
display "" with frame r-top.
 {sys/form/s-top.f}            
   ...
   for each pc-misc where
       pc-misc.company = cocode and
       pc-misc.opn       = yes and
       pc-misc.misc-date GE v-date[1] and
       pc-misc.misc-date LE v-date[2]
       no-lock
       ...
       IF tb_excel THEN
          PUT STREAM excel UNFORMATTED
            '"' (IF pc-misc.misc-date NE ? THEN
                    STRING(pc-misc.misc-date) ELSE "")       '",'
            '"' pc-misc.ml                                   '",'
            '"' (pc-misc.job-no + "-" + STRING(pc-misc.job-no2)) '",'
            '"' pc-misc.frm                                  '",'
            '"' pc-misc.blank-no                             '",'
            '"' pc-misc.i-no                                 '",'
            '"' pc-misc.m-code                               '",'
            ...
            '"' pc-misc.cost-type                            '",'
            '"' pc-misc.dept                                 '",'
            '"' STRING(pc-misc.cost,"->>,>>9.99")            '",'
            '"' STRING(pc-misc.cost-m,"->,>>9.9999")         '",'
            SKIP.
   end.
