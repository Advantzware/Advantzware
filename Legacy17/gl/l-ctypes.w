...
DEF TEMP-TABLE tt-type FIELD c-dscr AS cha FORM "x(15)".
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-1 tt-type.c-dscr   
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-1 Dialog-Frame _FREEFORM
  QUERY BROWSE-1 NO-LOCK DISPLAY
      tt-type.c-dscr LABEL "Column Type"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE BROWSE-1
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH tt-type
     _END_FREEFORM
     _Options          = "NO-LOCK"
...
------------------------------------------------------------------------------*/
  ...
  DEF var c-t-dscr   as ch format "x(13)" NO-UNDO initial
      "Curr Per,Curr QTD,Curr YTD,Budg Per,Budg QTD,Budg YTD,L.Y. Per,L.Y. QTD,L.Y. YTD,Variance,All Per & YTD".

  DO li-cnt = 1 TO NUM-ENTRIES(c-t-dscr):
      CREATE tt-type.
      ASSIGN tt-type.c-dscr = ENTRY(li-cnt,c-t-dscr).
  END.
