...
&Scoped-define QUERY-STRING-Browser-Table FOR EACH pc-prdd WHERE ~{&KEY-PHRASE} ~
      AND pc-prdd.company = g_company NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Browser-Table OPEN QUERY Browser-Table FOR EACH pc-prdd WHERE ~{&KEY-PHRASE} ~
      AND pc-prdd.company = g_company NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      ...
      pc-prdd.m-code COLUMN-LABEL "Machine" FORMAT "x(6)":U WIDTH 10.4
            LABEL-BGCOLOR 14
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE Browser-Table
     _TblList          = "ASI.pc-prdd"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = "USED,"
     _Where[1]         = "pc-prdd.company = g_company"
     _FldNameList[1]   > ASI.pc-prdd.job-no
"pc-prdd.job-no" ? ? "character" ? ? ? 14 ? ? no ? no no "14.2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"pc-prdd.pass" "P" ? "integer" ? ? ? 14 ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > ASI.pc-prdd.i-no
"pc-prdd.i-no" "Item#" ? "character" ? ? ? 14 ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > ASI.pc-prdd.i-name
"pc-prdd.i-name" ? ? "character" ? ? ? 14 ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > ASI.pc-prdd.m-code
"pc-prdd.m-code" "Machine" ? "character" ? ? ? 14 ? ? no ? no no "10.4" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
ON ENTRY OF pc-prdd.pass IN BROWSE Browser-Table /* P */
DO:
