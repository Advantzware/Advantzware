...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'oe/b-oebolh.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-oebolh ).
       RUN set-position IN h_b-oebolh ( 4.81 , 5.00 ) NO-ERROR.
       RUN set-size IN h_b-oebolh ( 19.52 , 145.00 ) NO-ERROR.

       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('2') NO-ERROR.

       /* Links to SmartNavBrowser h_b-oebolh. */
       RUN add-link IN adm-broker-hdl ( h_p-navico , 'Navigation':U , h_b-oebolh ).
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-oebolh ).
       RUN set-position IN h_v-oebolh ( 4.57 , 6.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-navico ).
       RUN set-position IN h_p-navico ( 13.14 , 8.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-oebolh ).
       RUN set-position IN h_p-oebolh ( 13.14 , 66.00 ) NO-ERROR.
       RUN set-size IN h_p-oebolh ( 1.52 , 82.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-oeboll ).
       RUN set-position IN h_b-oeboll ( 15.05 , 4.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updsav-2 ).
       RUN set-position IN h_p-updsav-2 ( 22.91 , 38.00 ) NO-ERROR.
       RUN set-size IN h_p-updsav-2 ( 1.76 , 80.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_p-updsav-2 , 'TableIO':U , h_b-oeboll ).
    ...
    WHEN 3 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updcan ).
       RUN set-position IN h_p-updcan ( 15.29 , 52.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_b-oebolh , 'Record':U , h_v-bolhs ).
