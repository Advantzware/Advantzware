/* EDDoc.p - generated 01/10/2001 - 13:00:00 by nosweat */
...
DO:
  PUT STREAM s-audit-rpt UNFORMATTED "Added: " AT 3 ttbl_EDDoc1.AddDate FORMAT "99/99/99" " (AddDate)".
  IF action = "UPDATE" THEN
  DO:
    IF ttbl_EDDoc1.AddDate NE ttbl_EDDoc2.AddDate THEN
    PUT STREAM s-audit-rpt UNFORMATTED "*" AT 1.
    PUT STREAM s-audit-rpt UNFORMATTED "Added: " AT 3 ttbl_EDDoc2.AddDate FORMAT "99/99/99".
  END.
END.
...
DO:
  PUT STREAM s-audit-rpt UNFORMATTED "?: " AT 3 ttbl_EDDoc1.C-FADate FORMAT "99/99/99" " (C-FADate)".
  IF action = "UPDATE" THEN
  DO:
    IF ttbl_EDDoc1.C-FADate NE ttbl_EDDoc2.C-FADate THEN
    PUT STREAM s-audit-rpt UNFORMATTED "*" AT 1.
    PUT STREAM s-audit-rpt UNFORMATTED "?: " AT 3 ttbl_EDDoc2.C-FADate FORMAT "99/99/99".
  END.
END.
...
DO:
  PUT STREAM s-audit-rpt UNFORMATTED "Changed: " AT 3 ttbl_EDDoc1.ChgDate FORMAT "99/99/99" " (ChgDate)".
  IF action = "UPDATE" THEN
  DO:
    IF ttbl_EDDoc1.ChgDate NE ttbl_EDDoc2.ChgDate THEN
    PUT STREAM s-audit-rpt UNFORMATTED "*" AT 1.
    PUT STREAM s-audit-rpt UNFORMATTED "Changed: " AT 3 ttbl_EDDoc2.ChgDate FORMAT "99/99/99".
  END.
END.
...
DO:
  PUT STREAM s-audit-rpt UNFORMATTED "?: " AT 3 ttbl_EDDoc1.FGDate FORMAT "99/99/99" " (FGDate)".
  IF action = "UPDATE" THEN
  DO:
    IF ttbl_EDDoc1.FGDate NE ttbl_EDDoc2.FGDate THEN
    PUT STREAM s-audit-rpt UNFORMATTED "*" AT 1.
    PUT STREAM s-audit-rpt UNFORMATTED "?: " AT 3 ttbl_EDDoc2.FGDate FORMAT "99/99/99".
  END.
END.
...
DO:
  PUT STREAM s-audit-rpt UNFORMATTED "?: " AT 3 ttbl_EDDoc1.InterpDate FORMAT "99/99/99" " (InterpDate)".
  IF action = "UPDATE" THEN
  DO:
    IF ttbl_EDDoc1.InterpDate NE ttbl_EDDoc2.InterpDate THEN
    PUT STREAM s-audit-rpt UNFORMATTED "*" AT 1.
    PUT STREAM s-audit-rpt UNFORMATTED "?: " AT 3 ttbl_EDDoc2.InterpDate FORMAT "99/99/99".
  END.
END.
...
DO:
  PUT STREAM s-audit-rpt UNFORMATTED "?: " AT 3 ttbl_EDDoc1.P-FADate FORMAT "99/99/99" " (P-FADate)".
  IF action = "UPDATE" THEN
  DO:
    IF ttbl_EDDoc1.P-FADate NE ttbl_EDDoc2.P-FADate THEN
    PUT STREAM s-audit-rpt UNFORMATTED "*" AT 1.
    PUT STREAM s-audit-rpt UNFORMATTED "?: " AT 3 ttbl_EDDoc2.P-FADate FORMAT "99/99/99".
  END.
END.
