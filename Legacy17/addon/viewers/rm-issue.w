...
&Scoped-Define ENABLED-FIELDS rm-rcpt.job-no rm-rcpt.job-no2 ~
rm-rcpt.trans-date rm-rcpt.i-no 
...
&Scoped-Define ENABLED-OBJECTS RECT-1 BUTTON-1 rm-rcpt_i-name 
&Scoped-Define DISPLAYED-FIELDS rm-rcpt.job-no rm-rcpt.job-no2 ~
rm-rcpt.trans-date rm-rcpt.i-no 
&Scoped-Define DISPLAYED-OBJECTS rm-rcpt_i-name F1 
...
DEFINE FRAME F-Main
     ...
     rm-rcpt.job-no AT ROW 1.48 COL 15 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9.2 BY 1
          BGCOLOR 15 FONT 4
     rm-rcpt.job-no2 AT ROW 1.48 COL 26 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 4.4 BY 1
          BGCOLOR 15 FONT 4
     rm-rcpt.trans-date AT ROW 1.48 COL 95 COLON-ALIGNED
          LABEL "Issue Date"
          VIEW-AS FILL-IN 
          SIZE 11.6 BY 1
          BGCOLOR 15 FONT 4
     rm-rcpt.i-no AT ROW 2.67 COL 15 COLON-ALIGNED
          LABEL "Item #"
          VIEW-AS FILL-IN 
          SIZE 14 BY 1
          BGCOLOR 15 FONT 4
     rm-rcpt_i-name AT ROW 2.67 COL 37 COLON-ALIGNED NO-LABEL
     F1 AT ROW 2.67 COL 31 NO-LABEL
     "-" VIEW-AS TEXT
          SIZE 1.2 BY .62 AT ROW 1.67 COL 26.6
