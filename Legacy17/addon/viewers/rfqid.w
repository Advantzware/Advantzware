...
&Scoped-Define ENABLED-FIELDS rfq.rfq-no rfq.cust-no rfq.ship-name 
...
&Scoped-Define DISPLAYED-FIELDS rfq.rfq-no rfq.cust-no rfq.ship-name 
...
DEFINE FRAME F-Main
     rfq.rfq-no AT ROW 1.71 COL 16 COLON-ALIGNED
           VIEW-AS TEXT 
          SIZE 14 BY .62
     rfq.cust-no AT ROW 1.71 COL 44 COLON-ALIGNED
           VIEW-AS TEXT 
          SIZE 11.6 BY .62
     rfq.ship-name AT ROW 1.71 COL 57 COLON-ALIGNED NO-LABEL
           VIEW-AS TEXT 
          SIZE 38 BY .62
