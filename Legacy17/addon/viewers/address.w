...
&Scoped-Define ENABLED-FIELDS address.name1 address.name2 address.address1 ~
address.address2 address.zipcode address.zipcode_4 address.address_type 
...
&Scoped-Define DISPLAYED-FIELDS address.name1 address.name2 ~
address.address1 address.address2 address.zipcode address.zipcode_4 ~
address.pref_type address.pref# address.address_type 
...
DEFINE FRAME F-Main
     ...
     address.zipcode_4 AT ROW 7.19 COL 91 COLON-ALIGNED
          ...
          SIZE 7 BY 1
          BGCOLOR 15 FONT 4
     address.pref_type AT ROW 7.19 COL 75 NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 3.2 BY 1
          FONT 4
...
&Scoped-define SELF-NAME address.zipcode
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL address.zipcode V-table-Win
ON LEAVE OF address.zipcode IN FRAME F-Main /* Zip/Postal Code */
DO:
  ASSIGN
    address.pref_type:SCREEN-VALUE = s-pref_type
    address.pref#:SCREEN-VALUE = STRING(s-pref#,"99").
  {methods/dispflds.i}
END.
...
------------------------------------------------------------------------------*/
  ...
  {methods/viewers/create/address.i}
