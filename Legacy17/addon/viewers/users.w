...
&Scoped-define FIELD-PAIRS~
 ~{&FP1}user_name ~{&FP2}user_name ~{&FP3}~
 ~{&FP1}image_filename ~{&FP2}image_filename ~{&FP3}
...
users.developer users.image_filename 
&Scoped-Define DISPLAYED-OBJECTS F-2 
...
DEFINE FRAME F-Main
     ...
     users.user_name AT ROW 1.24 COL 48 COLON-ALIGNED
          ...
          SIZE 38 BY 1
          BGCOLOR 15 FONT 4
     users.track_usage AT ROW 2.91 COL 23
          VIEW-AS TOGGLE-BOX
          SIZE 19.8 BY 1
     users.use_colors AT ROW 4.1 COL 23
          VIEW-AS TOGGLE-BOX
          SIZE 27 BY 1
     users.use_fonts AT ROW 5.29 COL 23
          VIEW-AS TOGGLE-BOX
          SIZE 26.2 BY 1
     users.use_ctrl_keys AT ROW 6.48 COL 23
          VIEW-AS TOGGLE-BOX
          SIZE 38.4 BY 1
     users.developer AT ROW 7.67 COL 23
          VIEW-AS TOGGLE-BOX
          SIZE 16.8 BY 1
     users.image_filename AT ROW 8.86 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 50 BY 1
          BGCOLOR 15 FONT 4
     F-2 AT ROW 8.86 COL 73 NO-LABEL
...
&Scoped-define SELF-NAME users.image_filename
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL users.image_filename V-table-Win
ON HELP OF users.image_filename IN FRAME F-Main /* Image File Name */
DO:
  DEFINE VARIABLE image-name AS CHARACTER NO-UNDO.
  ...
  RETURN NO-APPLY.
  {&SELF-NAME}:SCREEN-VALUE = image-name.
END.
