...
zipcode.time_zone zipcode.fips_code zipcode.dst 
&Scoped-define FIELD-PAIRS~
 ~{&FP1}pref_type ~{&FP2}pref_type ~{&FP3}~
 ~{&FP1}pref# ~{&FP2}pref# ~{&FP3}~
 ~{&FP1}city ~{&FP2}city ~{&FP3}~
 ~{&FP1}state ~{&FP2}state ~{&FP3}~
 ~{&FP1}country ~{&FP2}country ~{&FP3}~
 ~{&FP1}county ~{&FP2}county ~{&FP3}~
 ~{&FP1}area_code ~{&FP2}area_code ~{&FP3}~
 ~{&FP1}time_zone ~{&FP2}time_zone ~{&FP3}~
...
zipcode.area_code zipcode.time_zone zipcode.fips_code zipcode.dst 
...
DEFINE FRAME F-Main
     ...
     zipcode.pref# AT ROW 1.24 COL 77 COLON-ALIGNED
          ...
          SIZE 4.4 BY 1
          BGCOLOR 15 FONT 4
     zipcode.city AT ROW 2.67 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 26 BY 1
          BGCOLOR 15 FONT 4
