...
{Advantzware\WinKit\admBrowserUsing.i} /* added by script _admBrowsers.p on 04.18.2017 @ 11:37:23 am */
...
&SCOPED-DEFINE dataGridInclude dataGrid\addon\ap\b-apinv.i
...
&SCOPED-DEFINE browse2 ap/j-apinv.i
...
&Scoped-define QUERY-STRING-Browser-Table FOR EACH ap-inv WHERE ~{&KEY-PHRASE} ~
      AND ap-inv.company = g_company ~
and ap-inv.posted = no NO-LOCK ~
    ~{&SORTBY-PHRASE}
...
DEFINE QUERY Browser-Table FOR 
      ap-inv
    FIELDS(ap-inv.inv-no
      ap-inv.vend-no
      ap-inv.inv-date
      ap-inv.due-date
      ap-inv.net
      ap-inv.paid
      ap-inv.due) SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      ap-inv.inv-no FORMAT "x(12)":U WIDTH 18.2
      ap-inv.vend-no FORMAT "x(8)":U WIDTH 17.2
