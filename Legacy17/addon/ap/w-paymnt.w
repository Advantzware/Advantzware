...
DEFINE VARIABLE h_b-selven AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Vendor Invoices Selected for Payment"
         HEIGHT             = 24
         WIDTH              = 149.6
         MAX-HEIGHT         = 33.29
         MAX-WIDTH          = 204.8
...
ON END-ERROR OF W-Win /* Vendor Invoices Selected for Payment */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Vendor Invoices Selected for Payment */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Payments' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = Yes':U ,
             OUTPUT h_b-selven ).
       RUN set-position IN h_b-selven ( 4.57 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-selven ( 16.91 , 29.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-addupd ).
       RUN set-position IN h_p-addupd ( 21.48 , 3.00 ) NO-ERROR.
       RUN set-size IN h_p-addupd ( 3.10 , 29.00 ) NO-ERROR.

       /* Links to SmartBrowser h_b-selven. */
       RUN add-link IN adm-broker-hdl ( h_p-addupd , 'TableIO':U , h_b-selven ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'add-vend':U , h_b-selven ).
