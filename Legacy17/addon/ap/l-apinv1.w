...
&Scoped-Define ENABLED-OBJECTS BROWSE-1 rd-sort Btn_Select bt-clear ~
lv-search bt-ok bt-cancel Btn_Deselect RECT-1 
...
DEFINE FRAME Dialog-Frame
     ...
     bt-cancel AT ROW 14.1 COL 80
     Btn_Deselect AT ROW 14.1 COL 93
     RECT-1 AT ROW 12.43 COL 1
     "Sort By:" VIEW-AS TEXT
          SIZE 8 BY .62 AT ROW 12.91 COL 4
     SPACE(94.19) SKIP(1.84)
...
------------------------------------------------------------------------------*/
  ...
  ENABLE BROWSE-1 rd-sort Btn_Select bt-clear lv-search bt-ok bt-cancel 
         Btn_Deselect RECT-1 
      WITH FRAME Dialog-Frame.
