...
&SCOPED-DEFINE key-phrase ap-pay.company EQ cocode AND ap-pay.reconciled = no AND ap-pay.check-amt <> 0 AND ap-pay.check-no < 90000000
...
&SCOPED-DEFINE sortby-log                                                                                                                                      ~
    ...
    IF lv-sort-by EQ "bank-code" THEN string(ap-pay.bank-code)                                                                                                          ELSE ~
    IF lv-sort-by EQ "check-amt" THEN string(ap-pay.check-amt,"-9999999999.99999")                                                                                                           ELSE ~
    IF lv-sort-by EQ "man-check" THEN string(ap-pay.man-check)                                                                                                           ELSE ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD display-voided B-table-Win 
...
------------------------------------------------------------------------------*/
  ...
  RUN pDataGridInit. /* added by script _admBrowsers.p on 04.18.2017 @ 11:37:24 am */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION display-voided B-table-Win 
FUNCTION display-voided RETURNS LOGICAL
  ( /* parameter-definitions */ ) :
/*------------------------------------------------------------------------------
  Purpose:  
