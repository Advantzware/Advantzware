...
ASSIGN cTextListToSelect = "Emp ID,Name,Machine,Start Date,Started,End Date,Shift,Ended,Type,Posted,Total,Rate,Rate Usage"
       cFieldListToSelect = "machemp.employee,name,machtran.machine,machemp.start_date,strd-dt,machemp.end_date,machemp.shift,ended,machemp.ratetype,machemp.posted,total,machemp.rate,rate_usage"
    .

{sys/inc/ttRptSel.i}

    ASSIGN cTextListToDefault  = "Emp ID,Name,Machine,Start Date,Started,End Date,Shift,Ended,Type,Posted,Total,Rate,Rate Usage" .
...
FOR EACH machemp WHERE machemp.posted = no 
