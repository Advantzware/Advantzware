...
/* ***************************  Definitions  ************************** */
&SCOPED-DEFINE dataGridInclude dataGrid\addon\browsers\machemp2.i
...
&Scoped-define QUERY-STRING-Browser-Table FOR EACH machemp WHERE ~{&KEY-PHRASE} ~
      AND machemp.posted = yes NO-LOCK, ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      ...
      machemp.shift FORMAT "X":U LABEL-BGCOLOR 14
...
"machemp.shift" ? ? "character" ? ? ? 14 ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
