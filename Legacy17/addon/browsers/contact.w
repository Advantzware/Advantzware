...
&SCOPED-DEFINE dataGridInclude dataGrid\addon\browsers\contact.i
...
contact.first-name contact.cust-no contact.cust-name contact.ship-id ~
contact.contact-title contact.type contact.phone contact.extension 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      contact.last-name FORMAT "X(20)":U
      contact.first-name FORMAT "X(10)":U
      contact.cust-no COLUMN-LABEL "Customer" FORMAT "X(8)":U
      contact.cust-name FORMAT "X(30)":U
      contact.ship-id FORMAT "X(8)":U
      contact.contact-title FORMAT "X(25)":U
      contact.type FORMAT "X(5)":U
      contact.phone FORMAT "XXX-XXX-XXXX":U
      contact.extension COLUMN-LABEL "Ext." FORMAT "XXXXX":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME F-Main
     ...
     auto_find AT ROW 19.33 COL 93 COLON-ALIGNED HELP
