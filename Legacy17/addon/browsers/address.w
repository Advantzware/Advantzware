...
&SCOPED-DEFINE dataGridInclude dataGrid\addon\browsers\address.i
...
&Scoped-define INTERNAL-TABLES address
...
address.address1 address.name1 address.address_type 
...
&Scoped-define OPEN-QUERY-Browser-Table OPEN QUERY Browser-Table FOR EACH address WHERE ~{&KEY-PHRASE} ~
      AND address.table_rec_key = ip-rec_key NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Browser-Table address
...
DEFINE QUERY Browser-Table FOR 
    ...
    FIELDS(address.zipcode
      address.address1
      address.name1
      address.address_type) SCROLLING.
&ANALYZE-RESUME
...
DEFINE FRAME F-Main
     ...
     auto_find AT ROW 9.1 COL 69 COLON-ALIGNED HELP
