...
&SCOPED-DEFINE dataGridInclude dataGrid\addon\browsers\account.i
...
account.type account.cyr-open account.lyr-open 
&Scoped-define ENABLED-FIELDS-IN-QUERY-Browser-Table 
&Scoped-define QUERY-STRING-Browser-Table FOR EACH account WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Browser-Table OPEN QUERY Browser-Table FOR EACH account WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      ...
      account.dscr FORMAT "x(30)":U
      account.type FORMAT "X":U
      account.cyr-open FORMAT "->>>,>>>,>>>,>>9.99":U
      account.lyr-open FORMAT "->>>,>>>,>>>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"account.dscr" ? "x(30)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[3]   = ASI.account.type
     _FldNameList[4]   = ASI.account.cyr-open
     _FldNameList[5]   = ASI.account.lyr-open
