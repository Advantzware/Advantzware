...
prgrms.prgtitle prgrms.dir_group prgrms.prgm_ver prgrms.menu_item ~
prgrms.track_usage prgrms.popup 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Browser-Table B-table-Win _STRUCTURED
  QUERY Browser-Table NO-LOCK DISPLAY
      ...
      prgrms.prgtitle
      prgrms.dir_group
      prgrms.prgm_ver COLUMN-LABEL "Version"
      prgrms.menu_item
      prgrms.track_usage
      prgrms.popup
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 94 BY 15.71
         FONT 4.
...
DEFINE FRAME F-Main
     ...
     auto_find AT ROW 16.95 COL 56 COLON-ALIGNED HELP
          "Enter Auto Find Value"
     Btn_Clear_Find AT ROW 16.95 COL 81 HELP
...
/* Query rebuild information for BROWSE Browser-Table
     ...
     _FldNameList[4]   > NOSWEAT.prgrms.prgm_ver
"prgrms.prgm_ver" "Version" ? "character" ? ? ? ? ? ? no ?
     _FldNameList[5]   = NOSWEAT.prgrms.menu_item
     _FldNameList[6]   = NOSWEAT.prgrms.track_usage
     _FldNameList[7]   = NOSWEAT.prgrms.popup
