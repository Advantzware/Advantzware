...
&{&DEFINETYPE}-define TABLENAME ?
&{&DEFINETYPE}-define DBFIELD1 
&{&DEFINETYPE}-define BEGINFLD1 
&{&DEFINETYPE}-define BEGIN-DEFAULT-1 no
&{&DEFINETYPE}-define ENDFLD1 
&{&DEFINETYPE}-define END-DEFAULT-1 no
...
&{&DEFINETYPE}-define SAVENAME track
