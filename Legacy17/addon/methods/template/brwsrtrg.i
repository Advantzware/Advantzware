...
ON ALT-INS OF {&BROWSE-NAME} IN FRAME {&FRAME-NAME}
DO:
  APPLY 'DEFAULT-ACTION' TO {&BROWSE-NAME}.
  {methods/run_link.i "CONTAINER-SOURCE" "Set_Viewer_Mode"
      "(THIS-PROCEDURE:HANDLE,'add')"}
END.

ON CTRL-INS OF {&BROWSE-NAME} IN FRAME {&FRAME-NAME}
DO:
  APPLY 'DEFAULT-ACTION' TO {&BROWSE-NAME}.
  {methods/run_link.i "CONTAINER-SOURCE" "Set_Viewer_Mode"
      "(THIS-PROCEDURE:HANDLE,'copy')"}
END.
