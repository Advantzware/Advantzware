...
&Global-define FLDNAME1 vend-code-cust-xref.vendor-code
&Global-define FORMAT-1 X(8)
&Global-define SORTBY-1 BY {&FLDNAME1} {&SORTBY-1}
&Global-define IDXNAME1 
&Global-define DESCRIP1 Suppliers A/R Code
&Global-define FLDNAME2 vend-code-cust-xref.cust-no
&Global-define FORMAT-2 X(8)
&Global-define SORTBY-2 BY {&FLDNAME2} {&SORTBY-2}
&Global-define IDXNAME2 
&Global-define DESCRIP2 Customers A/P Code 
&Global-define FLDNAME3 vend-code-cust-xref.cust-name
&Global-define FORMAT-3 X(30)
&Global-define SORTBY-3 BY {&FLDNAME3} {&SORTBY-3}
&Global-define IDXNAME3 
&Global-define DESCRIP3 Customers A/P Description 
