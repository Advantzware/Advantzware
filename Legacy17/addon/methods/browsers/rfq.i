/* rfq.i  manually overwrighted by YSK for joining 2 tables  09/26/01 
"rfq" "rfq"
"rfq-no" "RFQ#" ""
"cust-no" "Cust.#" ""
"est-no" "Estimate#" ""
...
&Global-define SORTBY-1 BY {&FLDNAME1} DESC 
&Global-define IDXNAME1    
&Global-define DESCRIP1 RFQ#
&Global-define FLDNAME2 rfq.cust-no
&Global-define FORMAT-2 X(8)
&Global-define SORTBY-2 BY {&FLDNAME2} BY {&fldname1} DESC
&Global-define IDXNAME2 
&Global-define DESCRIP2 Cust.#
&Global-define FLDNAME3 rfqitem.est-no
&Global-define FORMAT-3 X(5)
&Global-define SORTBY-3 BY {&fldname3} BY {&fldname1} DESC   
&Global-define IDXNAME3 
&Global-define DESCRIP3 Estimate#
