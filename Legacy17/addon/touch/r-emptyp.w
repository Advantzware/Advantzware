...
lv-font-no td-show-parm rd-dest begin_emp_type end_emp_type RECT-2 RECT-6 ~
tb_excel tb_runExcel fi_file 
&Scoped-Define DISPLAYED-OBJECTS lv-ornt lines-per-page lv-font-no ~
td-show-parm lv-font-name rd-dest begin_emp_type end_emp_type tb_excel ~
tb_runExcel fi_file 
...
DEFINE VARIABLE fi_file AS CHARACTER FORMAT "X(30)" INITIAL "c:~\tmp~\r-emptyp.csv" 
...
DEFINE FRAME FRAME-A
     ...
     td-show-parm AT ROW 14.19 COL 51
     lv-font-name AT ROW 15.05 COL 27 COLON-ALIGNED NO-LABEL
     rd-dest AT ROW 11.95 COL 6 NO-LABEL
     begin_emp_type AT ROW 3.62 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Employee Type"
     end_emp_type AT ROW 5.05 COL 45 COLON-ALIGNED HELP
          "Enter Ending Employee Type"
     tb_excel AT ROW 16.52 COL 47.6
     tb_runExcel AT ROW 16.48 COL 90.8 RIGHT-ALIGNED
     fi_file AT ROW 17.86 COL 43.8 COLON-ALIGNED HELP
          "Enter File Name"
...
------------------------------------------------------------------------------*/
  DISPLAY lv-ornt lines-per-page lv-font-no td-show-parm lv-font-name rd-dest 
          begin_emp_type end_emp_type tb_excel tb_runExcel fi_file 
      WITH FRAME FRAME-A IN WINDOW C-Win.
  ENABLE btn-ok btn-cancel lv-ornt lines-per-page lv-font-no td-show-parm 
         rd-dest begin_emp_type end_emp_type RECT-2 RECT-6 tb_excel tb_runExcel 
         fi_file 
      WITH FRAME FRAME-A IN WINDOW C-Win.
