...
&Scoped-Define DISPLAYED-FIELDS shifts.shift shifts.description 
...
DEFINE FRAME F-Main
     shifts.shift AT ROW 1.24 COL 13 COLON-ALIGNED FORMAT "XX"
          VIEW-AS FILL-IN 
          SIZE 4.2 BY 1
     shifts.description AT ROW 1.24 COL 19 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 35 BY 1
...
/* SETTINGS FOR FILL-IN shifts.description IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN shifts.shift IN FRAME F-Main
