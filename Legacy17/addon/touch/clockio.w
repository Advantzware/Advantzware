...
&Scoped-Define ENABLED-OBJECTS RECT-11 btn-clock-in btn-clock-out 
...
DEFINE FRAME DEFAULT-FRAME
     btn-clock-in AT ROW 1.24 COL 2
     btn-clock-out AT ROW 8.14 COL 2
...
/* SETTINGS FOR FRAME DEFAULT-FRAME
                                                                        */
ASSIGN
       btn-clock-in:PRIVATE-DATA IN FRAME DEFAULT-FRAME     = 
                "ribbon-button".


ASSIGN
       btn-clock-out:PRIVATE-DATA IN FRAME DEFAULT-FRAME     = 
                "ribbon-button".
...
ON END-ERROR OF C-Win /* Clock In/Out */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Clock In/Out */
DO:
...
&Scoped-define SELF-NAME btn-clock-in
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn-clock-in C-Win
ON CHOOSE OF btn-clock-in IN FRAME DEFAULT-FRAME /* Clock In */
DO:
...
&Scoped-define SELF-NAME btn-clock-out
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn-clock-out C-Win
ON CHOOSE OF btn-clock-out IN FRAME DEFAULT-FRAME /* Clock Out */
DO:
...
/*  ASSIGN
  ...
  RUN enable_UI.
  {methods/nowait.i}
  APPLY "entry" TO btn-clock-in.
    {methods/setButton.i btn-clock-in "FILE"} /* added by script _nonAdm1Images1.p on 04.18.2017 @ 11:36:36 am */
    {methods/setButton.i btn-clock-out "FILE"} /* added by script _nonAdm1Images1.p on 04.18.2017 @ 11:36:36 am */
...
------------------------------------------------------------------------------*/
  ENABLE RECT-11 btn-clock-in btn-clock-out 
