...
&Scoped-Define ENABLED-OBJECTS RECT-2 RECT-1 list-order begin_emp_type ~
end_emp_type 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_emp_type ~
begin_emp_type_description end_emp_type end_emp_type_description F1 F-2 F-3 ~
F-4 
...
DEFINE VARIABLE begin_emp_type_description AS CHARACTER FORMAT "X(30)" 
...
DEFINE VARIABLE end_emp_type_description AS CHARACTER FORMAT "X(30)" 
...
DEFINE FRAME F-Main
     ...
     begin_emp_type AT ROW 4.81 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Employee Type"
     begin_emp_type_description AT ROW 6 COL 45 COLON-ALIGNED HELP
          "Enter Beginning Description"
     end_emp_type AT ROW 8.14 COL 45 COLON-ALIGNED HELP
          "Enter Ending Employee Type"
     end_emp_type_description AT ROW 9.33 COL 45 COLON-ALIGNED HELP
          "Enter Ending Description"
     F1 AT ROW 4.81 COL 57 NO-LABEL
     F-2 AT ROW 6 COL 91 NO-LABEL
     F-3 AT ROW 8.14 COL 57 NO-LABEL
...
/* SETTINGS FOR FILL-IN begin_emp_type_description IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN end_emp_type_description IN FRAME F-Main
   NO-ENABLE                                                            */
