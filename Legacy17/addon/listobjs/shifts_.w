...
&Scoped-Define ENABLED-OBJECTS RECT-2 RECT-1 list-order begin_shift ~
end_shift 
&Scoped-Define DISPLAYED-OBJECTS list-order selected-company begin_shift ~
begin_shifts_description end_shift end_shifts_description F1 F-2 F-3 F-4 
...
DEFINE VARIABLE begin_shifts_description AS CHARACTER FORMAT "X(30)" 
...
DEFINE VARIABLE end_shifts_description AS CHARACTER FORMAT "X(30)" 
...
DEFINE FRAME F-Main
     ...
     selected-company AT ROW 3.86 COL 49 COLON-ALIGNED
     begin_shift AT ROW 6 COL 49 COLON-ALIGNED HELP
          "Enter Beginning Shift"
     begin_shifts_description AT ROW 7.19 COL 49 COLON-ALIGNED HELP
          "Enter Beginning Description"
     end_shift AT ROW 9.33 COL 49 COLON-ALIGNED HELP
          "Enter Ending Shift"
     end_shifts_description AT ROW 10.52 COL 49 COLON-ALIGNED HELP
          "Enter Ending Description"
     F1 AT ROW 6 COL 67 NO-LABEL
     F-2 AT ROW 7.19 COL 95 NO-LABEL
     F-3 AT ROW 9.33 COL 67 NO-LABEL
     F-4 AT ROW 10.52 COL 95 NO-LABEL
...
/* SETTINGS FOR FILL-IN begin_shifts_description IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN end_shifts_description IN FRAME F-Main
   NO-ENABLE                                                            */
