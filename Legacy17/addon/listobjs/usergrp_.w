...
&Scoped-Define ENABLED-OBJECTS RECT-1 list-order RECT-2 begin_usergrps ~
end_usergrps 
&Scoped-Define DISPLAYED-OBJECTS list-order begin_usergrps end_usergrps F1 ~
F-3 
...
DEFINE VARIABLE begin_usergrps AS CHARACTER FORMAT "X(10)" 
     LABEL "Beginning  User Groups" 
     VIEW-AS FILL-IN 
     SIZE 22 BY 1.

DEFINE VARIABLE end_usergrps AS CHARACTER FORMAT "X(10)" 
     LABEL "Ending User Groups" 
     VIEW-AS FILL-IN 
     SIZE 22 BY 1.
...
DEFINE FRAME F-Main
     ...
     begin_usergrps AT ROW 5.52 COL 48 COLON-ALIGNED HELP
          "Enter Beginning User Groups"
     end_usergrps AT ROW 7.43 COL 48 COLON-ALIGNED HELP
          "Enter Ending User Groups"
     F1 AT ROW 5.52 COL 72 NO-LABEL
     F-3 AT ROW 7.43 COL 72 NO-LABEL
