...
"lkupprgm " ~
"Lookup Programs " ~
"{methods/lookups/lkupprgm.i} ~{custom/getcmpny.i} ~{sys/inc/varasgn.i} " ~
"{methods/defines/lkupprgm.i} ~{custom/gcompany.i} ~{sys/inc/var.i new shared} " ~
" " ~
" " ~
*/
...
&Scoped-define top-include ~{methods/lookups/lkupprgm.i} ~{custom/getcmpny.i} ~{sys/inc/varasgn.i}
&Scoped-define def-include ~{methods/defines/lkupprgm.i} ~{custom/gcompany.i} ~{sys/inc/var.i new shared}
