...
&Scoped-define FIELDS-IN-QUERY-BROWSE-1 vend-plant.cust-no ~
vend-plant.plant-id vend-plant.vendor-dept-code vend-plant.plant-name ~
vend-plant.ship-id vend-plant.vendor-code 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-1 
&Scoped-define QUERY-STRING-BROWSE-1 FOR EACH vend-plant WHERE ~{&KEY-PHRASE} ~
      AND vend-plant.company = ip-company ~
 AND vend-plant.cust-no = ip-cur-val NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-BROWSE-1 OPEN QUERY BROWSE-1 FOR EACH vend-plant WHERE ~{&KEY-PHRASE} ~
      AND vend-plant.company = ip-company ~
 AND vend-plant.cust-no = ip-cur-val NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-BROWSE-1 vend-plant
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-1 vend-plant
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-1 Dialog-Frame _STRUCTURED
  QUERY BROWSE-1 NO-LOCK DISPLAY
      vend-plant.cust-no FORMAT "x(8)":U WIDTH 13.2
      vend-plant.plant-id FORMAT "x(8)":U WIDTH 13.2
      vend-plant.vendor-dept-code FORMAT "x(8)":U WIDTH 13.2
      vend-plant.plant-name COLUMN-LABEL "Customers!Plant Name" FORMAT "x(30)":U
            WIDTH 49.2
      vend-plant.ship-id FORMAT "x(8)":U WIDTH 13.2
      vend-plant.vendor-code FORMAT "x(8)":U WIDTH 12
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
