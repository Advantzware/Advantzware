...
&scoped-define fld-name-2 contact.last-name
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-1 contact.first-name ~
contact.middle-initial contact.last-name contact.cust-no contact.cust-name ~
contact.addr1 contact.city contact.state contact.zip 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-1 
&Scoped-define FIELD-PAIRS-IN-QUERY-BROWSE-1
&Scoped-define OPEN-QUERY-BROWSE-1 OPEN QUERY BROWSE-1 FOR EACH contact WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-BROWSE-1 contact
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-1 contact
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Contact Information */
DO:
...
DO:
   op-char-val = string(recid(contact))
                 .
