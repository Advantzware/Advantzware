...
/*------------------------------------------------------------------------
  ...
  Description: Mulich's Ruler to gadge size of browsers and other objects
  ...
  Author: Ron Stark (inspired by Michele Mulich)
...
ON END-ERROR OF C-Win /* Mulich's Ruler */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Mulich's Ruler */
DO:
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  ldummy = SESSION:SET-WAIT-STATE("").
    {methods/setButton.i Btn_Close "Close"} /* added by script _nonAdm1Images1.p on 04.07.2017 @  2:07:11 pm */
