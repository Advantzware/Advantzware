...
Btn-Cancel Btn-build Btn-ucopy 
...
DEFINE FRAME Panel-Frame
     ...
     Btn-build AT ROW 1.29 COL 47
     Btn-ucopy AT ROW 1.29 COL 59
...
ASSIGN 
       Btn-build:PRIVATE-DATA IN FRAME Panel-Frame     = 
                "panel-image".

ASSIGN 
       Btn-ucopy:PRIVATE-DATA IN FRAME Panel-Frame     = 
                "panel-image".
...
ON CHOOSE OF Btn-build IN FRAME Panel-Frame /* Build Menu */
DO:
...
&Scoped-define SELF-NAME Btn-ucopy
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Btn-ucopy C-WIn
ON CHOOSE OF Btn-ucopy IN FRAME Panel-Frame /* Copy Menu */
DO:
    def var char-hdl as cha no-undo.
    run get-link-handle in adm-broker-hdl (this-procedure, "tableio-target", output char-hdl).
...
/* ***************************  Main Block  *************************** */
  ...
  {methods/setButton.i Btn-build "Build Menu"} /* added by script c:\tmp\p64604__panelImages.ped */
  {methods/setButton.i Btn-ucopy "Copy Menu"} /* added by script c:\tmp\p64604__panelImages.ped */
