...
&Scoped-Define ENABLED-OBJECTS Btn-Add Btn-Cancel 
...
/* SETTINGS FOR BUTTON Btn-Save IN FRAME Panel-Frame
   NO-ENABLE                                                            */
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  btn-save:LABEL IN FRAME {&FRAME-NAME} = "&Save" .
  DISABLE btn-save WITH FRAME {&FRAME-NAME}.
END PROCEDURE.
...
------------------------------------------------------------------------------*/
  btn-save:LABEL IN FRAME {&FRAME-NAME} = "&Save" .
  enable btn-save WITH FRAME {&FRAME-NAME}.
